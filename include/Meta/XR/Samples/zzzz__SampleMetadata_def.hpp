...
/// @brief Method Awake, addr 0x2985148, size 0x1c, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::Meta::XR::Samples::SampleMetadata* New_ctor() ;

/// @brief Method OnDestroy, addr 0x29854dc, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SendEvent, addr 0x29851d8, size 0x304, virtual false, abstract: false, final false
inline void SendEvent(int32_t  eventType) ;

/// @brief Method Start, addr 0x2985164, size 0x74, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x29854e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
