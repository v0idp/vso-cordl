...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x28723cc, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::NetSyncSetSessionPropertyResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetNetSyncSetSessionPropertyResult, addr 0x2872390, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2872338, size 0x58, virtual false, abstract: false, final false
