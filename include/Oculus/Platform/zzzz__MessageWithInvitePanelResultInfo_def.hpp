...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2871394, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::InvitePanelResultInfo* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetInvitePanelResultInfo, addr 0x2871358, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d9cc, size 0x58, virtual false, abstract: false, final false
