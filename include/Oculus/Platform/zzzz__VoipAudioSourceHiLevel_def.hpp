...
/// @brief Method Awake, addr 0x2882c10, size 0x84, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::Oculus::Platform::VoipAudioSourceHiLevel_FilterReadDelegate* New_ctor() ;

/// @brief Method OnAudioFilterRead, addr 0x2882c94, size 0x4e0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2883174, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x2882598, size 0x2a4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CreatePCMSource, addr 0x2882858, size 0x58, virtual true, abstract: false, final false
inline void CreatePCMSource() ;

/// @brief Method MSToElements, addr 0x28828b8, size 0x68, virtual false, abstract: false, final false
static inline int32_t MSToElements(int32_t  ms) ;

static inline ::Oculus::Platform::VoipAudioSourceHiLevel* New_ctor() ;

/// @brief Method SampleRateToEnum, addr 0x2882554, size 0x44, virtual false, abstract: false, final false
inline ::Oculus::Platform::VoipSampleRate SampleRateToEnum(int32_t  rate) ;

/// @brief Method Start, addr 0x288283c, size 0x1c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Stop, addr 0x2882550, size 0x4, virtual false, abstract: false, final false
inline void Stop() ;

/// @brief Method Update, addr 0x2882920, size 0x2e8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x2882c08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method set_senderID, addr 0x28824a4, size 0xac, virtual false, abstract: false, final false
