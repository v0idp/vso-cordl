...
public:
// Declarations
/// @brief Method GetAppDownloadResult, addr 0x286faa4, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AppDownloadResult* GetAppDownloadResult() ;

/// @brief Method GetDataFromMessage, addr 0x286fae0, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d23c, size 0x58, virtual false, abstract: false, final false
