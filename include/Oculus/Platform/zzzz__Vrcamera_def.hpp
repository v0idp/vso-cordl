...
public:
// Declarations
/// @brief Method SetGetDataChannelMessageUpdateNotificationCallback, addr 0x2881408, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method SetGetSurfaceUpdateNotificationCallback, addr 0x288147c, size 0x74, virtual false, abstract: false, final false
