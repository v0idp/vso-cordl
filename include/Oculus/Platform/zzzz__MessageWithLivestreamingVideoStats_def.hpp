...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2871f0c, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LivestreamingVideoStats* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLivestreamingVideoStats, addr 0x2871ed0, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2871e78, size 0x58, virtual false, abstract: false, final false
