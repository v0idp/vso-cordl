...
/// @brief Method AddServiceProvider, addr 0x28819c0, size 0x68, virtual false, abstract: false, final false
inline void AddServiceProvider(::Oculus::Platform::ServiceProvider  value) ;

/// @brief Method ClearServiceProviders, addr 0x2882310, size 0x58, virtual false, abstract: false, final false
inline void ClearServiceProviders() ;

/// @brief Method Finalize, addr 0x28823d0, size 0xd4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::UserOptions* New_ctor() ;

/// @brief Method SetMaxUsers, addr 0x28822a8, size 0x68, virtual false, abstract: false, final false
inline void SetMaxUsers(uint32_t  value) ;

/// @brief Method SetTimeWindow, addr 0x2882368, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x288195c, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x2881a28, size 0xc, virtual false, abstract: false, final false
