...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x28734d4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::UserCapabilityList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetUserCapabilityList, addr 0x2873498, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e36c, size 0x58, virtual false, abstract: false, final false
