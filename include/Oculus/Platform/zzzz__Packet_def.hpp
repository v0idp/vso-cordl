...
/// @brief Method Dispose, addr 0x2874140, size 0x88, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Finalize, addr 0x28740ac, size 0x94, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::Packet* New_ctor(::System::IntPtr  packetHandle) ;

/// @brief Method ReadBytes, addr 0x2873f10, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2873e90, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  packetHandle) ;

/// @brief Method get_SenderID, addr 0x287404c, size 0x58, virtual false, abstract: false, final false
inline uint64_t get_SenderID() ;

/// @brief Method get_Size, addr 0x28740a4, size 0x8, virtual false, abstract: false, final false
