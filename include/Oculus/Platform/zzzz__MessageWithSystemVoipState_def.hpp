...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2873194, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::SystemVoipState* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetSystemVoipState, addr 0x2873158, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e20c, size 0x58, virtual false, abstract: false, final false
