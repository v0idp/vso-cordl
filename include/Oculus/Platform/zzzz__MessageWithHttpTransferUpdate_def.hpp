...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2873904, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::HttpTransferUpdate* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetHttpTransferUpdate, addr 0x28738c8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e474, size 0x58, virtual false, abstract: false, final false
