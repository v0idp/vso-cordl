...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2872c24, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::Purchase* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetPurchase, addr 0x2872be8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286dfa4, size 0x58, virtual false, abstract: false, final false
