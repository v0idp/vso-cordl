...
/// @brief Method .ctor, addr 0x28822a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_OculusPlatformTestUserAccessToken, addr 0x2882254, size 0x48, virtual false, abstract: false, final false
static inline ::StringW get_OculusPlatformTestUserAccessToken() ;

/// @brief Method get_OculusPlatformTestUserEmail, addr 0x28821bc, size 0x48, virtual false, abstract: false, final false
static inline ::StringW get_OculusPlatformTestUserEmail() ;

/// @brief Method get_OculusPlatformTestUserPassword, addr 0x2882208, size 0x48, virtual false, abstract: false, final false
static inline ::StringW get_OculusPlatformTestUserPassword() ;

/// @brief Method set_OculusPlatformTestUserAccessToken, addr 0x288229c, size 0x4, virtual false, abstract: false, final false
static inline void set_OculusPlatformTestUserAccessToken(::StringW  value) ;

/// @brief Method set_OculusPlatformTestUserEmail, addr 0x2882204, size 0x4, virtual false, abstract: false, final false
static inline void set_OculusPlatformTestUserEmail(::StringW  value) ;

/// @brief Method set_OculusPlatformTestUserPassword, addr 0x2882250, size 0x4, virtual false, abstract: false, final false
