...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x28835fc, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x2883698, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x28835e8, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x288355c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method AsyncInitialize, addr 0x2874904, size 0x100, virtual false, abstract: false, final false
inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* AsyncInitialize(::StringW  appId) ;

/// @brief Method CPPLogCallback, addr 0x288347c, size 0xd8, virtual false, abstract: false, final false
inline void CPPLogCallback(::System::IntPtr  tag, ::System::IntPtr  message) ;

/// @brief Method Initialize, addr 0x2875128, size 0xb8, virtual false, abstract: false, final false
inline bool Initialize(::StringW  appId) ;

static inline ::Oculus::Platform::WindowsPlatform* New_ctor() ;

/// @brief Method .ctor, addr 0x28748fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method getCallbackPointer, addr 0x2883554, size 0x8, virtual false, abstract: false, final false
