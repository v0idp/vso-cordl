...
public:
// Declarations
/// @brief Method GetAbuseReportRecording, addr 0x286f11c, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AbuseReportRecording* GetAbuseReportRecording() ;

/// @brief Method GetDataFromMessage, addr 0x286f158, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286f0c4, size 0x58, virtual false, abstract: false, final false
