...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x287386c, size 0x5c, virtual true, abstract: false, final false
inline bool GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLeaderboardDidUpdate, addr 0x2873830, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286dc34, size 0x58, virtual false, abstract: false, final false
