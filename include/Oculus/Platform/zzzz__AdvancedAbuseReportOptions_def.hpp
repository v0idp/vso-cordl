...
/// @brief Method AddSuggestedUser, addr 0x284ba64, size 0x68, virtual false, abstract: false, final false
inline void AddSuggestedUser(uint64_t  userID) ;

/// @brief Method ClearDeveloperDefinedContext, addr 0x284b79c, size 0x58, virtual false, abstract: false, final false
inline void ClearDeveloperDefinedContext() ;

/// @brief Method ClearSuggestedUsers, addr 0x284bb50, size 0x58, virtual false, abstract: false, final false
inline void ClearSuggestedUsers() ;

/// @brief Method Finalize, addr 0x284bd1c, size 0xd4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::AdvancedAbuseReportOptions* New_ctor() ;

/// @brief Method SetDeveloperDefinedContext, addr 0x284b66c, size 0x70, virtual false, abstract: false, final false
inline void SetDeveloperDefinedContext(::StringW  key, ::StringW  value) ;

/// @brief Method SetObjectType, addr 0x284b870, size 0x68, virtual false, abstract: false, final false
inline void SetObjectType(::StringW  value) ;

/// @brief Method SetReportType, addr 0x284b978, size 0x68, virtual false, abstract: false, final false
inline void SetReportType(::Oculus::Platform::AbuseReportType  value) ;

/// @brief Method SetVideoMode, addr 0x284bc24, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x284b5a0, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x284bd10, size 0xc, virtual false, abstract: false, final false
