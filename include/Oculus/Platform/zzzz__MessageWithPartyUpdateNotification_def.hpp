...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x28729b4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::PartyUpdateNotification* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetPartyUpdateNotification, addr 0x2872978, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286de9c, size 0x58, virtual false, abstract: false, final false
