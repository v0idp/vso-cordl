...
public:
// Declarations
/// @brief Method GetAssetFileDeleteResult, addr 0x28704d0, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AssetFileDeleteResult* GetAssetFileDeleteResult() ;

/// @brief Method GetDataFromMessage, addr 0x287050c, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d3f4, size 0x58, virtual false, abstract: false, final false
