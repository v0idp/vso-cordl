...
public:
// Declarations
/// @brief Method GetAchievementProgressList, addr 0x286f52c, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AchievementProgressList* GetAchievementProgressList() ;

/// @brief Method GetDataFromMessage, addr 0x286f568, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d134, size 0x58, virtual false, abstract: false, final false
