...
/// @brief Method GetPCM, addr 0x2883384, size 0x8c, virtual true, abstract: false, final true
...
/// @brief Method PeekSizeElements, addr 0x2883418, size 0x60, virtual true, abstract: false, final true
inline int32_t PeekSizeElements() ;

/// @brief Method SetSenderID, addr 0x2883410, size 0x8, virtual true, abstract: false, final true
inline void SetSenderID(uint64_t  senderID) ;

/// @brief Method Update, addr 0x2883478, size 0x4, virtual true, abstract: false, final true
inline void Update() ;
...
/// @brief Method .ctor, addr 0x28828b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
