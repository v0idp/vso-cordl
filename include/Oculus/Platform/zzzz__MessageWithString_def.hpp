...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2873104, size 0x54, virtual true, abstract: false, final false
inline ::StringW GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetString, addr 0x28730c8, size 0x3c, virtual true, abstract: false, final false
inline ::StringW GetString() ;

static inline ::Oculus::Platform::MessageWithString* New_ctor(::System::IntPtr  c_message) ;

/// @brief Method .ctor, addr 0x286e1b4, size 0x58, virtual false, abstract: false, final false
