...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x28739d4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::PlatformInitialize* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetPlatformInitialize, addr 0x2873998, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e4cc, size 0x58, virtual false, abstract: false, final false
