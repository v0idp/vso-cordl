...
public:
// Declarations
/// @brief Method GetAchievementDefinitions, addr 0x286f25c, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AchievementDefinitionList* GetAchievementDefinitions() ;

/// @brief Method GetDataFromMessage, addr 0x286f298, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d0dc, size 0x58, virtual false, abstract: false, final false
