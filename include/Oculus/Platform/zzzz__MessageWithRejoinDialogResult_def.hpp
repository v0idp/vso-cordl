...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2872dc4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::RejoinDialogResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetRejoinDialogResult, addr 0x2872d88, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e054, size 0x58, virtual false, abstract: false, final false
