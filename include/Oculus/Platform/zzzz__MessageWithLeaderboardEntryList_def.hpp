...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x287199c, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LeaderboardEntryList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLeaderboardEntryList, addr 0x2871960, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286dbdc, size 0x58, virtual false, abstract: false, final false
