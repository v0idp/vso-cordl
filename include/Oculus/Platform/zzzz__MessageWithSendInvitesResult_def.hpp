...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2872f64, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::SendInvitesResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetSendInvitesResult, addr 0x2872f28, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e104, size 0x58, virtual false, abstract: false, final false
