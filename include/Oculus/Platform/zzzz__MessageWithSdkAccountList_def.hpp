...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2872e94, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::SdkAccountList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetSdkAccountList, addr 0x2872e58, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e0ac, size 0x58, virtual false, abstract: false, final false
