...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2873034, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::ShareMediaResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetShareMediaResult, addr 0x2872ff8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e15c, size 0x58, virtual false, abstract: false, final false
