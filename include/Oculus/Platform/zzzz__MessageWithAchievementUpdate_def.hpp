...
public:
// Declarations
/// @brief Method GetAchievementUpdate, addr 0x286f7fc, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AchievementUpdate* GetAchievementUpdate() ;

/// @brief Method GetDataFromMessage, addr 0x286f838, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d18c, size 0x58, virtual false, abstract: false, final false
