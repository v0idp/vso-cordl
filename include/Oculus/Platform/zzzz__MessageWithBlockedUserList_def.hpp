...
public:
// Declarations
/// @brief Method GetBlockedUserList, addr 0x28708e0, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::BlockedUserList* GetBlockedUserList() ;

/// @brief Method GetDataFromMessage, addr 0x287091c, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d5ac, size 0x58, virtual false, abstract: false, final false
