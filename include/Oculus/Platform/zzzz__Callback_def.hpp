...
template<typename T>
class Callback_RequestCallback_1;
}
namespace Oculus::Platform {
...
/// @brief Method HandleMessage, addr 0x284d3f8, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x284d3f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x284ccb8, size 0x28, virtual false, abstract: false, final false
...
template<typename T>
using RequestCallback_1 = ::Oculus::Platform::Callback_RequestCallback_1<T>;
...
/// @brief Field notificationCallbacks, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_notificationCallbacks, put=setStaticF_notificationCallbacks)) ::System::Collections::Generic::Dictionary_2<::Oculus::Platform::Message_MessageType,::Oculus::Platform::Callback_RequestCallback*>*  notificationCallbacks;

/// @brief Field requestIDsToRequests, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_requestIDsToRequests, put=setStaticF_requestIDsToRequests)) ::System::Collections::Generic::Dictionary_2<uint64_t,::Oculus::Platform::Request*>*  requestIDsToRequests;

/// @brief Method AddRequest, addr 0x284cce0, size 0xdc, virtual false, abstract: false, final false
static inline void AddRequest(::Oculus::Platform::Request*  request) ;

/// @brief Method FlushJoinIntentNotificationQueue, addr 0x284d270, size 0xa0, virtual false, abstract: false, final false
static inline void FlushJoinIntentNotificationQueue() ;

/// @brief Method HandleMessage, addr 0x284cefc, size 0x248, virtual false, abstract: false, final false
static inline void HandleMessage(::Oculus::Platform::Message*  msg) ;

/// @brief Method OnApplicationQuit, addr 0x284d1cc, size 0xa4, virtual false, abstract: false, final false
static inline void OnApplicationQuit() ;

/// @brief Method RunCallbacks, addr 0x284cdbc, size 0x6c, virtual false, abstract: false, final false
static inline void RunCallbacks() ;

/// @brief Method RunLimitedCallbacks, addr 0x284d144, size 0x88, virtual false, abstract: false, final false
...
template<typename T>
static inline void SetNotificationCallback(::Oculus::Platform::Message_MessageType  type, ::Oculus::Platform::Message_1_Callback<T>*  callback) ;

/// @brief Method SetNotificationCallback, addr 0x284cbac, size 0x10c, virtual false, abstract: false, final false
