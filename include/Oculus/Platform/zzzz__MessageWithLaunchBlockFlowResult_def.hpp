...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2871464, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LaunchBlockFlowResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLaunchBlockFlowResult, addr 0x2871428, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286da24, size 0x58, virtual false, abstract: false, final false
