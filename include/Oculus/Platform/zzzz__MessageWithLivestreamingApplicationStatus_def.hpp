...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2871bec, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LivestreamingApplicationStatus* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLivestreamingApplicationStatus, addr 0x2871bb0, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2871b58, size 0x58, virtual false, abstract: false, final false
