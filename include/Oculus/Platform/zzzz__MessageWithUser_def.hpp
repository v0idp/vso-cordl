...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2873264, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::User* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetUser, addr 0x2873228, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::User* GetUser() ;

static inline ::Oculus::Platform::MessageWithUser* New_ctor(::System::IntPtr  c_message) ;

/// @brief Method .ctor, addr 0x286e264, size 0x58, virtual false, abstract: false, final false
