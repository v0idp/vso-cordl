...
/// @brief Method Finalize, addr 0x28832b0, size 0xd4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::VoipOptions* New_ctor() ;

/// @brief Method SetBitrateForNewConnections, addr 0x28831e0, size 0x68, virtual false, abstract: false, final false
inline void SetBitrateForNewConnections(::Oculus::Platform::VoipBitrate  value) ;

/// @brief Method SetCreateNewConnectionUseDtx, addr 0x2883248, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x288317c, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x2877fd0, size 0xc, virtual false, abstract: false, final false
