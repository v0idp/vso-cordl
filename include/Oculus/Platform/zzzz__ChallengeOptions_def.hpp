...
/// @brief Method Finalize, addr 0x286ac14, size 0xd4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::ChallengeOptions* New_ctor() ;

/// @brief Method SetDescription, addr 0x286a7f8, size 0x68, virtual false, abstract: false, final false
inline void SetDescription(::StringW  value) ;

/// @brief Method SetEndDate, addr 0x286a860, size 0x68, virtual false, abstract: false, final false
inline void SetEndDate(::System::DateTime  value) ;

/// @brief Method SetIncludeActiveChallenges, addr 0x286a8c8, size 0x68, virtual false, abstract: false, final false
inline void SetIncludeActiveChallenges(bool  value) ;

/// @brief Method SetIncludeFutureChallenges, addr 0x286a930, size 0x68, virtual false, abstract: false, final false
inline void SetIncludeFutureChallenges(bool  value) ;

/// @brief Method SetIncludePastChallenges, addr 0x286a998, size 0x68, virtual false, abstract: false, final false
inline void SetIncludePastChallenges(bool  value) ;

/// @brief Method SetLeaderboardName, addr 0x286aa00, size 0x68, virtual false, abstract: false, final false
inline void SetLeaderboardName(::StringW  value) ;

/// @brief Method SetStartDate, addr 0x286aa68, size 0x68, virtual false, abstract: false, final false
inline void SetStartDate(::System::DateTime  value) ;

/// @brief Method SetTitle, addr 0x286aad0, size 0x68, virtual false, abstract: false, final false
inline void SetTitle(::StringW  value) ;

/// @brief Method SetViewerFilter, addr 0x286ab38, size 0x68, virtual false, abstract: false, final false
inline void SetViewerFilter(::Oculus::Platform::ChallengeViewerFilter  value) ;

/// @brief Method SetVisibility, addr 0x286aba0, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286a794, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x286ac08, size 0xc, virtual false, abstract: false, final false
