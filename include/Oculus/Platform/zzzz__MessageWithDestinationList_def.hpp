...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2870ffc, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::DestinationList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetDestinationList, addr 0x2870fc0, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d8c4, size 0x58, virtual false, abstract: false, final false
