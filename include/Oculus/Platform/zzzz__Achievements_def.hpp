...
public:
// Declarations
/// @brief Method AddCount, addr 0x2879a18, size 0x168, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementUpdate*>* AddCount(::StringW  name, uint64_t  count) ;

/// @brief Method AddFields, addr 0x2879b80, size 0x168, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementUpdate*>* AddFields(::StringW  name, ::StringW  fields) ;

/// @brief Method GetAllDefinitions, addr 0x2879ce8, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementDefinitionList*>* GetAllDefinitions() ;

/// @brief Method GetAllProgress, addr 0x2879e38, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AchievementProgressList*>* GetAllProgress() ;

/// @brief Method GetDefinitionsByName, addr 0x2879f88, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method GetNextAchievementDefinitionListPage, addr 0x287a3c8, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method GetNextAchievementProgressListPage, addr 0x287a5a0, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method GetProgressByName, addr 0x287a0fc, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method Unlock, addr 0x287a270, size 0x158, virtual false, abstract: false, final false
