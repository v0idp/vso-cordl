...
public:
// Declarations
/// @brief Method GetChallengeList, addr 0x2870a80, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::ChallengeList* GetChallengeList() ;

/// @brief Method GetDataFromMessage, addr 0x2870abc, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d65c, size 0x58, virtual false, abstract: false, final false
