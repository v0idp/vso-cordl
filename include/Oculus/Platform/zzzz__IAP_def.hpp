...
public:
// Declarations
/// @brief Method ConsumePurchase, addr 0x287ed34, size 0x144, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* ConsumePurchase(::StringW  sku) ;

/// @brief Method GetNextProductListPage, addr 0x287f45c, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method GetNextPurchaseListPage, addr 0x287f634, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method GetProductsBySKU, addr 0x287ee78, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method GetViewerPurchases, addr 0x287efec, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PurchaseList*>* GetViewerPurchases() ;

/// @brief Method GetViewerPurchasesDurableCache, addr 0x287f13c, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PurchaseList*>* GetViewerPurchasesDurableCache() ;

/// @brief Method LaunchCheckoutFlow, addr 0x287f28c, size 0x1d0, virtual false, abstract: false, final false
