...
public:
// Declarations
/// @brief Method SetConnectionStatusChangedNotificationCallback, addr 0x287fc98, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method SetSessionsChangedNotificationCallback, addr 0x287fd0c, size 0x74, virtual false, abstract: false, final false
