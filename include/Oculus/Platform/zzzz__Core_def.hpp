...
/// @brief Method AsyncInitialize, addr 0x2874a04, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method AsyncInitialize, addr 0x287449c, size 0x31c, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* AsyncInitialize(::StringW  appId) ;

/// @brief Method ForceInitialized, addr 0x2874220, size 0x5c, virtual false, abstract: false, final false
static inline void ForceInitialized() ;

/// @brief Method GetAppIDFromConfig, addr 0x287441c, size 0x80, virtual false, abstract: false, final false
static inline ::StringW GetAppIDFromConfig() ;

/// @brief Method Initialize, addr 0x2874db4, size 0x374, virtual false, abstract: false, final false
static inline void Initialize(::StringW  appId) ;

/// @brief Method IsInitialized, addr 0x28741c8, size 0x58, virtual false, abstract: false, final false
static inline bool IsInitialized() ;

static inline ::Oculus::Platform::Core* New_ctor() ;

/// @brief Method .ctor, addr 0x2875218, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method getAppID, addr 0x287427c, size 0x1a0, virtual false, abstract: false, final false
