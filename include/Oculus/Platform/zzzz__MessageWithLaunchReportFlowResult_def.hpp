...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x287172c, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LaunchReportFlowResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLaunchReportFlowResult, addr 0x28716f0, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2871698, size 0x58, virtual false, abstract: false, final false
