...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x28712c4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::InstalledApplicationList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetInstalledApplicationList, addr 0x2871288, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2871230, size 0x58, virtual false, abstract: false, final false
