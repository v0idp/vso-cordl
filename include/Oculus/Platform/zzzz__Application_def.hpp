...
public:
// Declarations
/// @brief Method CancelAppDownload, addr 0x287a778, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AppDownloadResult*>* CancelAppDownload() ;

/// @brief Method CheckAppDownloadProgress, addr 0x287a8c8, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AppDownloadProgressResult*>* CheckAppDownloadProgress() ;

/// @brief Method GetVersion, addr 0x287aa18, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::ApplicationVersion*>* GetVersion() ;

/// @brief Method InstallAppUpdateAndRelaunch, addr 0x287ab68, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method LaunchOtherApp, addr 0x287acc8, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method StartAppDownload, addr 0x287ae38, size 0x150, virtual false, abstract: false, final false
