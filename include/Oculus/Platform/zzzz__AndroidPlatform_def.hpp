...
public:
// Declarations
/// @brief Method AsyncInitialize, addr 0x284bfb0, size 0xfc, virtual false, abstract: false, final false
inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::PlatformInitialize*>* AsyncInitialize(::StringW  appId) ;

/// @brief Method Initialize, addr 0x284be6c, size 0xac, virtual false, abstract: false, final false
inline bool Initialize(::StringW  appId) ;

static inline ::Oculus::Platform::AndroidPlatform* New_ctor() ;

/// @brief Method .ctor, addr 0x284c140, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
