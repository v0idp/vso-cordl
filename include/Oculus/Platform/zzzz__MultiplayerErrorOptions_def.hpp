...
/// @brief Method Finalize, addr 0x2873b40, size 0xd4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::MultiplayerErrorOptions* New_ctor() ;

/// @brief Method SetErrorKey, addr 0x2873acc, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2873a68, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x2873b34, size 0xc, virtual false, abstract: false, final false
