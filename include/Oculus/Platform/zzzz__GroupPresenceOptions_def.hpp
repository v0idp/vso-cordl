...
/// @brief Method Finalize, addr 0x286af60, size 0xd4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::GroupPresenceOptions* New_ctor() ;

/// @brief Method SetDeeplinkMessageOverride, addr 0x286ad4c, size 0x68, virtual false, abstract: false, final false
inline void SetDeeplinkMessageOverride(::StringW  value) ;

/// @brief Method SetDestinationApiName, addr 0x286adb4, size 0x68, virtual false, abstract: false, final false
inline void SetDestinationApiName(::StringW  value) ;

/// @brief Method SetIsJoinable, addr 0x286ae1c, size 0x68, virtual false, abstract: false, final false
inline void SetIsJoinable(bool  value) ;

/// @brief Method SetLobbySessionId, addr 0x286ae84, size 0x68, virtual false, abstract: false, final false
inline void SetLobbySessionId(::StringW  value) ;

/// @brief Method SetMatchSessionId, addr 0x286aeec, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286ace8, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x286af54, size 0xc, virtual false, abstract: false, final false
