...
/// @brief Method HandleMessage, addr 0x2881cdc, size 0x68, virtual true, abstract: false, final false
inline void HandleMessage(::Oculus::Platform::Message*  msg) ;

static inline ::Oculus::Platform::Request* New_ctor(uint64_t  requestID) ;

/// @brief Method OnComplete, addr 0x2881c70, size 0x6c, virtual false, abstract: false, final false
inline ::Oculus::Platform::Request* OnComplete(::Oculus::Platform::Message_Callback*  callback) ;

/// @brief Method RunCallbacks, addr 0x284d580, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2876bac, size 0x28, virtual false, abstract: false, final false
inline void _ctor(uint64_t  requestID) ;

/// @brief Method get_RequestID, addr 0x2881c60, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_RequestID() ;

/// @brief Method set_RequestID, addr 0x2881c68, size 0x8, virtual false, abstract: false, final false
