...
public:
// Declarations
/// @brief Method GetApplicationInviteList, addr 0x286fbe4, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::ApplicationInviteList* GetApplicationInviteList() ;

/// @brief Method GetDataFromMessage, addr 0x286fc20, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d294, size 0x58, virtual false, abstract: false, final false
