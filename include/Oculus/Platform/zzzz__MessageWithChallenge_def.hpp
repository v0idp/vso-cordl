...
public:
// Declarations
/// @brief Method GetChallenge, addr 0x28709b0, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::Challenge* GetChallenge() ;

/// @brief Method GetDataFromMessage, addr 0x28709ec, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d604, size 0x58, virtual false, abstract: false, final false
