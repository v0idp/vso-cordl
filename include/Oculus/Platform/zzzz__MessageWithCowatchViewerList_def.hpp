...
public:
// Declarations
/// @brief Method GetCowatchViewerList, addr 0x2870c20, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::CowatchViewerList* GetCowatchViewerList() ;

/// @brief Method GetDataFromMessage, addr 0x2870c5c, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d70c, size 0x58, virtual false, abstract: false, final false
