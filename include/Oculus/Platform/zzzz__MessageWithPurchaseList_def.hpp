...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2872cf4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::PurchaseList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetPurchaseList, addr 0x2872cb8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286dffc, size 0x58, virtual false, abstract: false, final false
