...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2870f64, size 0x5c, virtual true, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetDataStore, addr 0x2870f28, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d86c, size 0x58, virtual false, abstract: false, final false
