...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2873404, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::UserList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetUserList, addr 0x28733c8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e314, size 0x58, virtual false, abstract: false, final false
