...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2872a84, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::PidList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetPidList, addr 0x2872a48, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286def4, size 0x58, virtual false, abstract: false, final false
