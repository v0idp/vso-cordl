...
/// @brief Method Finalize, addr 0x2873dbc, size 0xd4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::NetSyncOptions* New_ctor() ;

/// @brief Method SetVoipGroup, addr 0x2873c78, size 0x68, virtual false, abstract: false, final false
inline void SetVoipGroup(::StringW  value) ;

/// @brief Method SetVoipStreamDefault, addr 0x2873ce0, size 0x68, virtual false, abstract: false, final false
inline void SetVoipStreamDefault(::Oculus::Platform::NetSyncVoipStreamMode  value) ;

/// @brief Method SetZoneId, addr 0x2873d48, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2873c14, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x2873db0, size 0xc, virtual false, abstract: false, final false
