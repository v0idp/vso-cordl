...
/// @brief Method Awake, addr 0x284d478, size 0x100, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::Oculus::Platform::CallbackRunner* New_ctor() ;

/// @brief Method OnApplicationQuit, addr 0x284d5ec, size 0x4c, virtual false, abstract: false, final false
inline void OnApplicationQuit() ;

/// @brief Method OnDestroy, addr 0x284d5e8, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Update, addr 0x284d578, size 0x8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x284d638, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method ovr_UnityResetTestPlatform, addr 0x284d414, size 0x64, virtual false, abstract: false, final false
