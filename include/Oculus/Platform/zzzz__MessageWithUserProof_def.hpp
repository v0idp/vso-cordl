...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2873674, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::UserProof* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetUserProof, addr 0x2873638, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e41c, size 0x58, virtual false, abstract: false, final false
