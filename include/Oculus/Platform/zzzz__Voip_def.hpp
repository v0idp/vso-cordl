...
public:
// Declarations
/// @brief Method Accept, addr 0x2877804, size 0xc4, virtual false, abstract: false, final false
static inline void Accept(uint64_t  userID) ;

/// @brief Method GetIsConnectionUsingDtx, addr 0x2877cac, size 0xc8, virtual false, abstract: false, final false
static inline ::Oculus::Platform::VoipDtxState GetIsConnectionUsingDtx(uint64_t  peerID) ;

/// @brief Method GetLocalBitrate, addr 0x2877d74, size 0xc8, virtual false, abstract: false, final false
static inline ::Oculus::Platform::VoipBitrate GetLocalBitrate(uint64_t  peerID) ;

/// @brief Method GetMicrophoneAvailability, addr 0x2877fdc, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::MicrophoneAvailabilityState*>* GetMicrophoneAvailability() ;

/// @brief Method GetRemoteBitrate, addr 0x2877e3c, size 0xc8, virtual false, abstract: false, final false
static inline ::Oculus::Platform::VoipBitrate GetRemoteBitrate(uint64_t  peerID) ;

/// @brief Method GetSystemVoipMicrophoneMuted, addr 0x2877b2c, size 0xc0, virtual false, abstract: false, final false
static inline ::Oculus::Platform::VoipMuteState GetSystemVoipMicrophoneMuted() ;

/// @brief Method GetSystemVoipStatus, addr 0x2877bec, size 0xc0, virtual false, abstract: false, final false
static inline ::Oculus::Platform::SystemVoipStatus GetSystemVoipStatus() ;

/// @brief Method SetMicrophoneAvailabilityStateUpdateNotificationCallback, addr 0x2878284, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method SetMicrophoneFilterCallback, addr 0x287798c, size 0xdc, virtual false, abstract: false, final false
static inline void SetMicrophoneFilterCallback(::Oculus::Platform::CAPI_FilterCallback*  callback) ;

/// @brief Method SetMicrophoneMuted, addr 0x2877a68, size 0xc4, virtual false, abstract: false, final false
static inline void SetMicrophoneMuted(::Oculus::Platform::VoipMuteState  state) ;

/// @brief Method SetNewConnectionOptions, addr 0x2877f04, size 0xcc, virtual false, abstract: false, final false
static inline void SetNewConnectionOptions(::Oculus::Platform::VoipOptions*  voipOptions) ;

/// @brief Method SetSystemVoipStateNotificationCallback, addr 0x28782f8, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method SetSystemVoipSuppressed, addr 0x287812c, size 0x158, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::SystemVoipState*>* SetSystemVoipSuppressed(bool  suppressed) ;

/// @brief Method Start, addr 0x2877740, size 0xc4, virtual false, abstract: false, final false
static inline void Start(uint64_t  userID) ;

/// @brief Method Stop, addr 0x28778c8, size 0xc4, virtual false, abstract: false, final false
