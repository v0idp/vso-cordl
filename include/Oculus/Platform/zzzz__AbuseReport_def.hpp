...
public:
// Declarations
/// @brief Method ReportRequestHandled, addr 0x2879860, size 0x144, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* ReportRequestHandled(::Oculus::Platform::ReportRequestResponse  response) ;

/// @brief Method SetReportButtonPressedNotificationCallback, addr 0x28799a4, size 0x74, virtual false, abstract: false, final false
