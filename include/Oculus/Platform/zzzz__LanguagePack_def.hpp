...
public:
// Declarations
/// @brief Method GetCurrent, addr 0x287f80c, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::AssetDetails*>* GetCurrent() ;

/// @brief Method SetCurrent, addr 0x287f95c, size 0x158, virtual false, abstract: false, final false
