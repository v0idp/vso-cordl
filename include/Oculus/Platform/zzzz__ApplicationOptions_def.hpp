...
/// @brief Method Finalize, addr 0x284c72c, size 0xd4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::ApplicationOptions* New_ctor() ;

/// @brief Method SetDeeplinkMessage, addr 0x284c214, size 0x68, virtual false, abstract: false, final false
inline void SetDeeplinkMessage(::StringW  value) ;

/// @brief Method SetDestinationApiName, addr 0x284c31c, size 0x68, virtual false, abstract: false, final false
inline void SetDestinationApiName(::StringW  value) ;

/// @brief Method SetLobbySessionId, addr 0x284c424, size 0x68, virtual false, abstract: false, final false
inline void SetLobbySessionId(::StringW  value) ;

/// @brief Method SetMatchSessionId, addr 0x284c52c, size 0x68, virtual false, abstract: false, final false
inline void SetMatchSessionId(::StringW  value) ;

/// @brief Method SetRoomId, addr 0x284c634, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x284c148, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x284c720, size 0xc, virtual false, abstract: false, final false
