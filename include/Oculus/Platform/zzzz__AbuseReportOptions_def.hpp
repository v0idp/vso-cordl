...
/// @brief Method Finalize, addr 0x284b450, size 0xd4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::AbuseReportOptions* New_ctor() ;

/// @brief Method SetPreventPeopleChooser, addr 0x284b26c, size 0x68, virtual false, abstract: false, final false
inline void SetPreventPeopleChooser(bool  value) ;

/// @brief Method SetReportType, addr 0x284b358, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x284b1a0, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x284b444, size 0xc, virtual false, abstract: false, final false
