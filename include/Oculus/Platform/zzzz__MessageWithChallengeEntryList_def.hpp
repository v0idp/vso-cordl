...
public:
// Declarations
/// @brief Method GetChallengeEntryList, addr 0x2870b50, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::ChallengeEntryList* GetChallengeEntryList() ;

/// @brief Method GetDataFromMessage, addr 0x2870b8c, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d6b4, size 0x58, virtual false, abstract: false, final false
