...
public:
// Declarations
/// @brief Method GetCurrent, addr 0x287fec4, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Party*>* GetCurrent() ;

/// @brief Method SetPartyUpdateNotificationCallback, addr 0x2880014, size 0x74, virtual false, abstract: false, final false
