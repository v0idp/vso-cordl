...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2871de4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LivestreamingStatus* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLivestreamingStatus, addr 0x2871da8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286dc8c, size 0x58, virtual false, abstract: false, final false
