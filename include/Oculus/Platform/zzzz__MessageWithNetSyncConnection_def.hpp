...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x28720ac, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::NetSyncConnection* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetNetSyncConnection, addr 0x2872070, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286dd3c, size 0x58, virtual false, abstract: false, final false
