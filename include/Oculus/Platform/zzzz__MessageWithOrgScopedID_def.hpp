...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x28725c4, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::OrgScopedID* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetOrgScopedID, addr 0x2872588, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286ddec, size 0x58, virtual false, abstract: false, final false
