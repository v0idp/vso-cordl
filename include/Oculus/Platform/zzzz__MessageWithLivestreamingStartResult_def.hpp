...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2871d14, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LivestreamingStartResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLivestreamingStartResult, addr 0x2871cd8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2871c80, size 0x58, virtual false, abstract: false, final false
