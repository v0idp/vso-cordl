...
public:
// Declarations
/// @brief Method Get, addr 0x2880644, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::UserAccountAgeCategory*>* Get() ;

/// @brief Method Report, addr 0x2880794, size 0x144, virtual false, abstract: false, final false
