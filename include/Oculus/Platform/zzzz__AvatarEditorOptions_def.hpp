...
/// @brief Method Finalize, addr 0x284ca5c, size 0xd4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::Oculus::Platform::AvatarEditorOptions* New_ctor() ;

/// @brief Method SetSourceOverride, addr 0x284c948, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x284c87c, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x284ca50, size 0xc, virtual false, abstract: false, final false
