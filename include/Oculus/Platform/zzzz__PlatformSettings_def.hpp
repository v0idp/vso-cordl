...
/// @brief Method .ctor, addr 0x2881c08, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityW<::Oculus::Platform::PlatformSettings> getStaticF_instance() ;

/// @brief Method get_AppID, addr 0x28751fc, size 0x1c, virtual false, abstract: false, final false
static inline ::StringW get_AppID() ;

/// @brief Method get_Instance, addr 0x2881a34, size 0x124, virtual false, abstract: false, final false
static inline ::UnityW<::Oculus::Platform::PlatformSettings> get_Instance() ;

/// @brief Method get_MobileAppID, addr 0x28751e0, size 0x1c, virtual false, abstract: false, final false
static inline ::StringW get_MobileAppID() ;

/// @brief Method get_UseStandalonePlatform, addr 0x28747b8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method set_AppID, addr 0x2881b58, size 0x20, virtual false, abstract: false, final false
static inline void set_AppID(::StringW  value) ;

/// @brief Method set_Instance, addr 0x2881bbc, size 0x4c, virtual false, abstract: false, final false
static inline void set_Instance(::Oculus::Platform::PlatformSettings*  value) ;

/// @brief Method set_MobileAppID, addr 0x2881b78, size 0x20, virtual false, abstract: false, final false
static inline void set_MobileAppID(::StringW  value) ;

/// @brief Method set_UseStandalonePlatform, addr 0x2881b98, size 0x24, virtual false, abstract: false, final false
