...
public:
// Declarations
/// @brief Method GetAppDownloadProgressResult, addr 0x286f94c, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AppDownloadProgressResult* GetAppDownloadProgressResult() ;

/// @brief Method GetDataFromMessage, addr 0x286f988, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d1e4, size 0x58, virtual false, abstract: false, final false
