...
public:
// Declarations
/// @brief Method Clear, addr 0x287d78c, size 0x13c, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* Clear() ;

/// @brief Method GetInvitableUsers, addr 0x287d8c8, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method GetNextApplicationInviteListPage, addr 0x287eb5c, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method GetSentInvites, addr 0x287da28, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::ApplicationInviteList*>* GetSentInvites() ;

/// @brief Method LaunchInvitePanel, addr 0x287db78, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method LaunchMultiplayerErrorDialog, addr 0x287dcd8, size 0x14c, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* LaunchMultiplayerErrorDialog(::Oculus::Platform::MultiplayerErrorOptions*  options) ;

/// @brief Method LaunchRejoinDialog, addr 0x287de24, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method LaunchRosterPanel, addr 0x287df94, size 0x14c, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* LaunchRosterPanel(::Oculus::Platform::RosterOptions*  options) ;

/// @brief Method SendInvites, addr 0x287e0ec, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method Set, addr 0x287e260, size 0x14c, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* Set(::Oculus::Platform::GroupPresenceOptions*  groupPresenceOptions) ;

/// @brief Method SetDeeplinkMessageOverride, addr 0x287e3ac, size 0x144, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* SetDeeplinkMessageOverride(::StringW  deeplink_message) ;

/// @brief Method SetDestination, addr 0x287e4f0, size 0x144, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* SetDestination(::StringW  api_name) ;

/// @brief Method SetInvitationsSentNotificationCallback, addr 0x287ea00, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method SetIsJoinable, addr 0x287e634, size 0x144, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* SetIsJoinable(bool  is_joinable) ;

/// @brief Method SetJoinIntentReceivedNotificationCallback, addr 0x287ea74, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method SetLeaveIntentReceivedNotificationCallback, addr 0x287eae8, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method SetLobbySession, addr 0x287e778, size 0x144, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* SetLobbySession(::StringW  id) ;

/// @brief Method SetMatchSession, addr 0x287e8bc, size 0x144, virtual false, abstract: false, final false
