...
public:
// Declarations
/// @brief Method GetCowatchingState, addr 0x2870dc0, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::CowatchingState* GetCowatchingState() ;

/// @brief Method GetDataFromMessage, addr 0x2870dfc, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d7bc, size 0x58, virtual false, abstract: false, final false
