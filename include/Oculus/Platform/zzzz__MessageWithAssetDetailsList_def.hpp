...
public:
// Declarations
/// @brief Method GetAssetDetailsList, addr 0x287021c, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AssetDetailsList* GetAssetDetailsList() ;

/// @brief Method GetDataFromMessage, addr 0x2870258, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d39c, size 0x58, virtual false, abstract: false, final false
