...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2872b54, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::ProductList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetProductList, addr 0x2872b18, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286df4c, size 0x58, virtual false, abstract: false, final false
