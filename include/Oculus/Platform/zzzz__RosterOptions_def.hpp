...
/// @brief Method AddSuggestedUser, addr 0x2881ee0, size 0x68, virtual false, abstract: false, final false
inline void AddSuggestedUser(uint64_t  userID) ;

/// @brief Method ClearSuggestedUsers, addr 0x2881f48, size 0x58, virtual false, abstract: false, final false
inline void ClearSuggestedUsers() ;

/// @brief Method Finalize, addr 0x2881fa0, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2881e7c, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method op_Explicit, addr 0x287e0e0, size 0xc, virtual false, abstract: false, final false
