...
public:
// Declarations
/// @brief Method GetAvatarEditorResult, addr 0x2870810, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AvatarEditorResult* GetAvatarEditorResult() ;

/// @brief Method GetDataFromMessage, addr 0x287084c, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d554, size 0x58, virtual false, abstract: false, final false
