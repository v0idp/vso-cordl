...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2873334, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::UserAccountAgeCategory* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetUserAccountAgeCategory, addr 0x28732f8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286e2bc, size 0x58, virtual false, abstract: false, final false
