...
public:
// Declarations
/// @brief Method GetAssetFileDownloadCancelResult, addr 0x28705a0, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AssetFileDownloadCancelResult* GetAssetFileDownloadCancelResult() ;

/// @brief Method GetDataFromMessage, addr 0x28705dc, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d44c, size 0x58, virtual false, abstract: false, final false
