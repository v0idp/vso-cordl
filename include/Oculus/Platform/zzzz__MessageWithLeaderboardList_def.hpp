...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x28718cc, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LeaderboardList* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLeaderboardList, addr 0x2871890, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286db84, size 0x58, virtual false, abstract: false, final false
