...
public:
// Declarations
/// @brief Method GetAssetDetails, addr 0x2870030, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::AssetDetails* GetAssetDetails() ;

/// @brief Method GetDataFromMessage, addr 0x287006c, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d344, size 0x58, virtual false, abstract: false, final false
