...
/// @brief Method .ctor, addr 0x28873f4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(uint64_t  id, ::System::Nullable_1<uint64_t>  pingTimeUsec) ;

/// @brief Method get_ID, addr 0x2887430, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_ID() ;

/// @brief Method get_IsTimeout, addr 0x28874ac, size 0x44, virtual false, abstract: false, final false
inline bool get_IsTimeout() ;

/// @brief Method get_PingTimeUsec, addr 0x2887440, size 0x6c, virtual false, abstract: false, final false
inline uint64_t get_PingTimeUsec() ;

/// @brief Method set_ID, addr 0x2887438, size 0x8, virtual false, abstract: false, final false
