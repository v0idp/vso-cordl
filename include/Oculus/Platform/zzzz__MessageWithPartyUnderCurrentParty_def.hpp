...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x28727bc, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::Party* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetParty, addr 0x2872780, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286de44, size 0x58, virtual false, abstract: false, final false
