...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x287119c, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::GroupPresenceLeaveIntent* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetGroupPresenceLeaveIntent, addr 0x2871160, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d974, size 0x58, virtual false, abstract: false, final false
