...
public:
// Declarations
/// @brief Method GetApplicationVersion, addr 0x286feb4, size 0x3c, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::ApplicationVersion* GetApplicationVersion() ;

/// @brief Method GetDataFromMessage, addr 0x286fef0, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286d2ec, size 0x58, virtual false, abstract: false, final false
