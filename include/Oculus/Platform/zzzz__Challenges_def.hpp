...
public:
// Declarations
/// @brief Method Create, addr 0x28767a0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method DeclineInvite, addr 0x2876910, size 0x158, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* DeclineInvite(uint64_t  challengeID) ;

/// @brief Method Delete, addr 0x2876a68, size 0x144, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* Delete(uint64_t  challengeID) ;

/// @brief Method Get, addr 0x2876bd4, size 0x158, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Get(uint64_t  challengeID) ;

/// @brief Method GetEntries, addr 0x2876d2c, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method GetEntriesAfterRank, addr 0x2876eac, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method GetEntriesByIds, addr 0x287701c, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method GetList, addr 0x28771b0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method GetNextChallenges, addr 0x28764b0, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method GetNextEntries, addr 0x28761c0, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method GetPreviousChallenges, addr 0x2876628, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method GetPreviousEntries, addr 0x2876338, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method Join, addr 0x2877320, size 0x158, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Join(uint64_t  challengeID) ;

/// @brief Method Leave, addr 0x2877478, size 0x158, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::Challenge*>* Leave(uint64_t  challengeID) ;

/// @brief Method UpdateInfo, addr 0x28775d0, size 0x170, virtual false, abstract: false, final false
