...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2871534, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::LaunchFriendRequestFlowResult* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetLaunchFriendRequestFlowResult, addr 0x28714f8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286da7c, size 0x58, virtual false, abstract: false, final false
