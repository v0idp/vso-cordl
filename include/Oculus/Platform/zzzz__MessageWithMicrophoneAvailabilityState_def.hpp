...
public:
// Declarations
/// @brief Method GetDataFromMessage, addr 0x2871fdc, size 0x94, virtual true, abstract: false, final false
inline ::Oculus::Platform::Models::MicrophoneAvailabilityState* GetDataFromMessage(::System::IntPtr  c_message) ;

/// @brief Method GetMicrophoneAvailabilityState, addr 0x2871fa0, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x286dce4, size 0x58, virtual false, abstract: false, final false
