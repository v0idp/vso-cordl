...
public:
// Declarations
/// @brief Method GetLaunchDetails, addr 0x2875284, size 0x88, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Models::LaunchDetails* GetLaunchDetails() ;

/// @brief Method LogDeeplinkResult, addr 0x287530c, size 0x64, virtual false, abstract: false, final false
static inline void LogDeeplinkResult(::StringW  trackingID, ::Oculus::Platform::LaunchResult  result) ;

/// @brief Method SetLaunchIntentChangedNotificationCallback, addr 0x2875370, size 0x74, virtual false, abstract: false, final false
