...
public:
// Declarations
/// @brief Method Clear, addr 0x2880088, size 0x13c, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request* Clear() ;

/// @brief Method GetDestinations, addr 0x28801c4, size 0x150, virtual false, abstract: false, final false
static inline ::Oculus::Platform::Request_1<::Oculus::Platform::Models::DestinationList*>* GetDestinations() ;

/// @brief Method GetNextDestinationListPage, addr 0x288046c, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method Set, addr 0x2880314, size 0x14c, virtual false, abstract: false, final false
