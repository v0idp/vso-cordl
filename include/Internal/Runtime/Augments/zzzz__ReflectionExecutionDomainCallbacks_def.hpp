...
public:
// Declarations
/// @brief Method CreateMissingMetadataException, addr 0x25e3a68, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25e3a60, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
