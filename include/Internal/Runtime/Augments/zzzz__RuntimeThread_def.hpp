...
/// @brief Method Create, addr 0x25e3ae4, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method GetCurrentProcessorId, addr 0x25e3be0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Sleep, addr 0x25e3bb8, size 0x8, virtual false, abstract: false, final false
static inline void Sleep(int32_t  millisecondsTimeout) ;

/// @brief Method SpinWait, addr 0x25e3bc8, size 0x18, virtual false, abstract: false, final false
static inline bool SpinWait(int32_t  iterations) ;

/// @brief Method Start, addr 0x25e3b9c, size 0x1c, virtual false, abstract: false, final false
inline void Start(::System::Object*  state) ;

/// @brief Method Yield, addr 0x25e3bc0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25e3abc, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method set_IsBackground, addr 0x25e3b7c, size 0x20, virtual false, abstract: false, final false
