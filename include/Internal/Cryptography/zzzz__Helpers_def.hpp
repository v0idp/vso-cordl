...
public:
// Declarations
/// @brief Method CloneByteArray, addr 0x25e3c34, size 0x78, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> CloneByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  src) ;

/// @brief Method NibbleToHex, addr 0x25e3d98, size 0x1c, virtual false, abstract: false, final false
static inline char16_t NibbleToHex(uint8_t  b) ;

/// @brief Method ToHexArrayUpper, addr 0x25e3cac, size 0xec, virtual false, abstract: false, final false
static inline ::ArrayW<char16_t,::Array<char16_t>*> ToHexArrayUpper(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method ToHexStringUpper, addr 0x25e3db4, size 0x10, virtual false, abstract: false, final false
