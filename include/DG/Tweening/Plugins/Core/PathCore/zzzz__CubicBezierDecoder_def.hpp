#pragma once
// IWYU pragma private; include "DG/Tweening/Plugins/Core/PathCore/CubicBezierDecoder.hpp"
...
#include <cmath>
#include <cstdint>
CORDL_MODULE_EXPORT(CubicBezierDecoder)
...
// Write type traits
MARK_REF_PTR_T(::DG::Tweening::Plugins::Core::PathCore::CubicBezierDecoder);
// Dependencies DG.Tweening.Plugins.Core.PathCore.ABSPathDecoder
namespace DG::Tweening::Plugins::Core::PathCore {
// Is value type: false
// CS Name: DG.Tweening.Plugins.Core.PathCore.CubicBezierDecoder
class CORDL_TYPE CubicBezierDecoder : public ::DG::Tweening::Plugins::Core::PathCore::ABSPathDecoder {
public:
// Declarations
...
/// @brief Method FinalizePath, addr 0x18e0dec, size 0x4d0, virtual true, abstract: false, final false
...
/// @brief Method GetPoint, addr 0x18e17ec, size 0x188, virtual true, abstract: false, final false
...
static inline ::DG::Tweening::Plugins::Core::PathCore::CubicBezierDecoder* New_ctor() ;

/// @brief Method SetTimeToLengthTables, addr 0x18e12cc, size 0x1f0, virtual false, abstract: false, final false
inline void SetTimeToLengthTables(::DG::Tweening::Plugins::Core::PathCore::Path*  p, int32_t  subdivisions) ;

/// @brief Method SetWaypointsLengths, addr 0x18e14bc, size 0x330, virtual false, abstract: false, final false
inline void SetWaypointsLengths(::DG::Tweening::Plugins::Core::PathCore::Path*  p, int32_t  subdivisions) ;

/// @brief Method .ctor, addr 0x18e1974, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
constexpr CubicBezierDecoder() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "CubicBezierDecoder", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
CubicBezierDecoder(CubicBezierDecoder && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "CubicBezierDecoder", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
CubicBezierDecoder(CubicBezierDecoder const& ) = delete;
...
static_assert(::cordl_internals::size_check_v<::DG::Tweening::Plugins::Core::PathCore::CubicBezierDecoder, 0x10>, "Size mismatch!");
