#pragma once
// IWYU pragma private; include "RSG/Tuple_3.hpp"
...
// Write type traits
MARK_GEN_REF_PTR_T(::RSG::Tuple_3);
// Dependencies System.Object
namespace RSG {
// cpp template
template<typename T1,typename T2,typename T3>
// Is value type: false
// CS Name: RSG.Tuple`3<T1,T2,T3>
...
static inline ::RSG::Tuple_3<T1,T2,T3>* New_ctor(T1  item1, T2  item2, T3  item3) ;
