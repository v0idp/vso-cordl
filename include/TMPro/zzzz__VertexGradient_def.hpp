...
public:
// Declarations
/// @brief Method .ctor, addr 0x2ecab70, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Color  color) ;

/// @brief Method .ctor, addr 0x2ecab94, size 0x1c, virtual false, abstract: false, final false
