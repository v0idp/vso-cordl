...
public:
// Declarations
/// @brief Method .ctor, addr 0x2edbab8, size 0x10, virtual false, abstract: false, final false
inline void _ctor(uint32_t  firstGlyphIndex, uint32_t  secondGlyphIndex) ;

/// @brief Method .ctor, addr 0x2ed3738, size 0x28, virtual false, abstract: false, final false
