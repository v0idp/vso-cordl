...
/// @brief Method .ctor, addr 0x2edba04, size 0x54, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord  adjustmentRecord) ;

/// @brief Method .ctor, addr 0x2ed92e0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(uint32_t  glyphIndex, ::TMPro::TMP_GlyphValueRecord  glyphValueRecord) ;

/// @brief Method get_glyphIndex, addr 0x2edb9dc, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_glyphIndex() ;

/// @brief Method get_glyphValueRecord, addr 0x2edb9ec, size 0xc, virtual false, abstract: false, final false
inline ::TMPro::TMP_GlyphValueRecord get_glyphValueRecord() ;

/// @brief Method set_glyphIndex, addr 0x2edb9e4, size 0x8, virtual false, abstract: false, final false
inline void set_glyphIndex(uint32_t  value) ;

/// @brief Method set_glyphValueRecord, addr 0x2edb9f8, size 0xc, virtual false, abstract: false, final false
