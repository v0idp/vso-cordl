...
public:
// Declarations
/// @brief Method ToString, addr 0x2f112b4, size 0x188, virtual true, abstract: false, final false
...
public:
// Declarations
/// @brief Method ToString, addr 0x2f1143c, size 0xac, virtual true, abstract: false, final false
inline ::StringW ToString() ;
...
/// @brief Method .ctor, addr 0x2f114e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x2f112ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
