...
public:
// Declarations
/// @brief Method GetLinkID, addr 0x2ecad8c, size 0xa8, virtual false, abstract: false, final false
inline ::StringW GetLinkID() ;

/// @brief Method GetLinkText, addr 0x2ecac84, size 0x108, virtual false, abstract: false, final false
inline ::StringW GetLinkText() ;

/// @brief Method SetLinkID, addr 0x2ecabb0, size 0xd4, virtual false, abstract: false, final false
