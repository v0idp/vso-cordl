...
/// @brief Method GetStyle, addr 0x2f08d64, size 0x88, virtual false, abstract: false, final false
inline ::TMPro::TMP_Style* GetStyle(int32_t  hashCode) ;

/// @brief Method GetStyle, addr 0x2f08dec, size 0xb8, virtual false, abstract: false, final false
inline ::TMPro::TMP_Style* GetStyle(::StringW  name) ;

/// @brief Method LoadStyleDictionaryInternal, addr 0x2f08a64, size 0x300, virtual false, abstract: false, final false
inline void LoadStyleDictionaryInternal() ;

static inline ::TMPro::TMP_StyleSheet* New_ctor() ;

/// @brief Method RefreshStyles, addr 0x2f08ea4, size 0x4, virtual false, abstract: false, final false
inline void RefreshStyles() ;

/// @brief Method Reset, addr 0x2f08a60, size 0x4, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x2f08ea8, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_styles, addr 0x2f08a58, size 0x8, virtual false, abstract: false, final false
