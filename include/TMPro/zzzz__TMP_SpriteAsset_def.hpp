...
/// @brief Method <SortCharacterTable>b__41_0, addr 0x2f082d4, size 0x18, virtual false, abstract: false, final false
inline uint32_t _SortCharacterTable_b__41_0(::TMPro::TMP_SpriteCharacter*  c) ;

/// @brief Method <SortGlyphTable>b__40_0, addr 0x2f082bc, size 0x18, virtual false, abstract: false, final false
inline uint32_t _SortGlyphTable_b__40_0(::TMPro::TMP_SpriteGlyph*  item) ;

/// @brief Method .ctor, addr 0x2f082b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Awake, addr 0x2f06c9c, size 0x88, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetDefaultSpriteMaterial, addr 0x2f071b4, size 0xe8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetDefaultSpriteMaterial() ;

/// @brief Method GetSpriteIndexFromHashcode, addr 0x2f0729c, size 0x88, virtual false, abstract: false, final false
inline int32_t GetSpriteIndexFromHashcode(int32_t  hashCode) ;

/// @brief Method GetSpriteIndexFromName, addr 0x2f073b8, size 0x74, virtual false, abstract: false, final false
inline int32_t GetSpriteIndexFromName(::StringW  name) ;

/// @brief Method GetSpriteIndexFromUnicode, addr 0x2f07324, size 0x94, virtual false, abstract: false, final false
inline int32_t GetSpriteIndexFromUnicode(uint32_t  unicode) ;

static inline ::TMPro::TMP_SpriteAsset* New_ctor() ;

/// @brief Method SearchForSpriteByHashCode, addr 0x2f0790c, size 0x31c, virtual false, abstract: false, final false
...
/// @brief Method SearchForSpriteByHashCodeInternal, addr 0x2f07dc8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method SearchForSpriteByHashCodeInternal, addr 0x2f07c28, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method SearchForSpriteByUnicode, addr 0x2f07498, size 0x224, virtual false, abstract: false, final false
...
/// @brief Method SearchForSpriteByUnicodeInternal, addr 0x2f0785c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method SearchForSpriteByUnicodeInternal, addr 0x2f076bc, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method SortCharacterTable, addr 0x2f07fa8, size 0x134, virtual false, abstract: false, final false
inline void SortCharacterTable() ;

/// @brief Method SortGlyphAndCharacterTables, addr 0x2f080dc, size 0x18, virtual false, abstract: false, final false
inline void SortGlyphAndCharacterTables() ;

/// @brief Method SortGlyphTable, addr 0x2f07e78, size 0x130, virtual false, abstract: false, final false
inline void SortGlyphTable() ;

/// @brief Method UpdateLookupTables, addr 0x2f0675c, size 0x4fc, virtual false, abstract: false, final false
inline void UpdateLookupTables() ;

/// @brief Method UpgradeSpriteAsset, addr 0x2f06d24, size 0x490, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f08194, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::HashSet_1<int32_t>* getStaticF_k_searchedSpriteAssets() ;

/// @brief Method get_faceInfo, addr 0x2f06734, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::FaceInfo get_faceInfo() ;

/// @brief Method get_spriteCharacterLookupTable, addr 0x2f06c60, size 0x24, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<uint32_t,::TMPro::TMP_SpriteCharacter*>* get_spriteCharacterLookupTable() ;

/// @brief Method get_spriteCharacterTable, addr 0x2f066b8, size 0x24, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::TMPro::TMP_SpriteCharacter*>* get_spriteCharacterTable() ;

/// @brief Method get_spriteGlyphTable, addr 0x2f06c8c, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::TMPro::TMP_SpriteGlyph*>* get_spriteGlyphTable() ;

/// @brief Method get_version, addr 0x2f06724, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_version() ;

static inline void setStaticF_k_searchedSpriteAssets(::System::Collections::Generic::HashSet_1<int32_t>*  value) ;

/// @brief Method set_faceInfo, addr 0x2f06744, size 0x18, virtual false, abstract: false, final false
inline void set_faceInfo(::UnityEngine::TextCore::FaceInfo  value) ;

/// @brief Method set_spriteCharacterLookupTable, addr 0x2f06c84, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_spriteCharacterTable, addr 0x2f06c58, size 0x8, virtual false, abstract: false, final false
inline void set_spriteCharacterTable(::System::Collections::Generic::List_1<::TMPro::TMP_SpriteCharacter*>*  value) ;

/// @brief Method set_spriteGlyphTable, addr 0x2f06c94, size 0x8, virtual false, abstract: false, final false
inline void set_spriteGlyphTable(::System::Collections::Generic::List_1<::TMPro::TMP_SpriteGlyph*>*  value) ;

/// @brief Method set_version, addr 0x2f0672c, size 0x8, virtual false, abstract: false, final false
