...
/// @brief Method .ctor, addr 0x2ecbb20, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2ecbbbc, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Color  color) ;

/// @brief Method .ctor, addr 0x2ecbc28, size 0xa4, virtual false, abstract: false, final false
