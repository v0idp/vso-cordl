...
/// @brief Method .ctor, addr 0x2edb95c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::TMPro::GlyphValueRecord_Legacy  valueRecord) ;

/// @brief Method .ctor, addr 0x2edb968, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphValueRecord  valueRecord) ;

/// @brief Method .ctor, addr 0x2ed92d4, size 0xc, virtual false, abstract: false, final false
inline void _ctor(float_t  xPlacement, float_t  yPlacement, float_t  xAdvance, float_t  yAdvance) ;

/// @brief Method get_xAdvance, addr 0x2edb93c, size 0x8, virtual false, abstract: false, final false
inline float_t get_xAdvance() ;

/// @brief Method get_xPlacement, addr 0x2edb91c, size 0x8, virtual false, abstract: false, final false
inline float_t get_xPlacement() ;

/// @brief Method get_yAdvance, addr 0x2edb94c, size 0x8, virtual false, abstract: false, final false
inline float_t get_yAdvance() ;

/// @brief Method get_yPlacement, addr 0x2edb92c, size 0x8, virtual false, abstract: false, final false
inline float_t get_yPlacement() ;

/// @brief Method op_Addition, addr 0x2edb9c8, size 0x14, virtual false, abstract: false, final false
static inline ::TMPro::TMP_GlyphValueRecord op_Addition(::TMPro::TMP_GlyphValueRecord  a, ::TMPro::TMP_GlyphValueRecord  b) ;

/// @brief Method set_xAdvance, addr 0x2edb944, size 0x8, virtual false, abstract: false, final false
inline void set_xAdvance(float_t  value) ;

/// @brief Method set_xPlacement, addr 0x2edb924, size 0x8, virtual false, abstract: false, final false
inline void set_xPlacement(float_t  value) ;

/// @brief Method set_yAdvance, addr 0x2edb954, size 0x8, virtual false, abstract: false, final false
inline void set_yAdvance(float_t  value) ;

/// @brief Method set_yPlacement, addr 0x2edb934, size 0x8, virtual false, abstract: false, final false
