...
/// @brief Method AddColorGradientPreset, addr 0x2ebab10, size 0x30, virtual false, abstract: false, final false
static inline void AddColorGradientPreset(int32_t  hashCode, ::TMPro::TMP_ColorGradient*  spriteAsset) ;

/// @brief Method AddColorGradientPreset_Internal, addr 0x2ebab40, size 0xa4, virtual false, abstract: false, final false
inline void AddColorGradientPreset_Internal(int32_t  hashCode, ::TMPro::TMP_ColorGradient*  spriteAsset) ;

/// @brief Method AddFontAsset, addr 0x2eba7ac, size 0x20, virtual false, abstract: false, final false
static inline void AddFontAsset(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method AddFontAssetInternal, addr 0x2eba7cc, size 0xc4, virtual false, abstract: false, final false
inline void AddFontAssetInternal(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method AddFontMaterial, addr 0x2ebaa78, size 0x30, virtual false, abstract: false, final false
static inline void AddFontMaterial(int32_t  hashCode, ::UnityEngine::Material*  material) ;

/// @brief Method AddFontMaterialInternal, addr 0x2ebaaa8, size 0x68, virtual false, abstract: false, final false
inline void AddFontMaterialInternal(int32_t  hashCode, ::UnityEngine::Material*  material) ;

/// @brief Method AddSpriteAsset, addr 0x2eba974, size 0x30, virtual false, abstract: false, final false
static inline void AddSpriteAsset(int32_t  hashCode, ::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method AddSpriteAsset, addr 0x2eba890, size 0x20, virtual false, abstract: false, final false
static inline void AddSpriteAsset(::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method AddSpriteAssetInternal, addr 0x2eba9a4, size 0xd4, virtual false, abstract: false, final false
inline void AddSpriteAssetInternal(int32_t  hashCode, ::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method AddSpriteAssetInternal, addr 0x2eba8b0, size 0xc4, virtual false, abstract: false, final false
inline void AddSpriteAssetInternal(::TMPro::TMP_SpriteAsset*  spriteAsset) ;

/// @brief Method Contains, addr 0x2ebabe4, size 0x5c, virtual false, abstract: false, final false
inline bool Contains(::TMPro::TMP_FontAsset*  font) ;

/// @brief Method Contains, addr 0x2ebac40, size 0x5c, virtual false, abstract: false, final false
inline bool Contains(::TMPro::TMP_SpriteAsset*  sprite) ;

static inline ::TMPro::MaterialReferenceManager* New_ctor() ;

/// @brief Method TryGetColorGradientPreset, addr 0x2ebadd4, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetColorGradientPreset(int32_t  hashCode, ::ByRef<::TMPro::TMP_ColorGradient*>  gradientPreset) ;

/// @brief Method TryGetColorGradientPresetInternal, addr 0x2ebae04, size 0x6c, virtual false, abstract: false, final false
inline bool TryGetColorGradientPresetInternal(int32_t  hashCode, ::ByRef<::TMPro::TMP_ColorGradient*>  gradientPreset) ;

/// @brief Method TryGetFontAsset, addr 0x2ebac9c, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetFontAsset(int32_t  hashCode, ::ByRef<::TMPro::TMP_FontAsset*>  fontAsset) ;

/// @brief Method TryGetFontAssetInternal, addr 0x2ebaccc, size 0x6c, virtual false, abstract: false, final false
inline bool TryGetFontAssetInternal(int32_t  hashCode, ::ByRef<::TMPro::TMP_FontAsset*>  fontAsset) ;

/// @brief Method TryGetMaterial, addr 0x2ebae70, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetMaterial(int32_t  hashCode, ::ByRef<::UnityEngine::Material*>  material) ;

/// @brief Method TryGetMaterialInternal, addr 0x2ebaea0, size 0x6c, virtual false, abstract: false, final false
inline bool TryGetMaterialInternal(int32_t  hashCode, ::ByRef<::UnityEngine::Material*>  material) ;

/// @brief Method TryGetSpriteAsset, addr 0x2ebad38, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetSpriteAsset(int32_t  hashCode, ::ByRef<::TMPro::TMP_SpriteAsset*>  spriteAsset) ;

/// @brief Method TryGetSpriteAssetInternal, addr 0x2ebad68, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2eba658, size 0x154, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::TMPro::MaterialReferenceManager* getStaticF_s_Instance() ;

/// @brief Method get_instance, addr 0x2eba5e4, size 0x74, virtual false, abstract: false, final false
