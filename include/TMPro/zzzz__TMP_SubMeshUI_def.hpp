...
/// @brief Method AddSubTextObject, addr 0x2f0a81c, size 0x3b0, virtual false, abstract: false, final false
...
/// @brief Method CreateMaterialInstance, addr 0x2f0b4b4, size 0xc0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> CreateMaterialInstance(::UnityEngine::Material*  source) ;

/// @brief Method Cull, addr 0x2f0b2d4, size 0x4, virtual true, abstract: false, final false
inline void Cull(::UnityEngine::Rect  clipRect, bool  validRect) ;

/// @brief Method GetMaterial, addr 0x2f0b4ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetMaterial() ;

/// @brief Method GetMaterial, addr 0x2f0a238, size 0xf4, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetMaterial(::UnityEngine::Material*  mat) ;

/// @brief Method GetModifiedMaterial, addr 0x2f0aee4, size 0x100, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetModifiedMaterial(::UnityEngine::Material*  baseMaterial) ;

/// @brief Method GetPaddingForMaterial, addr 0x2f0a414, size 0x74, virtual false, abstract: false, final false
inline float_t GetPaddingForMaterial() ;

/// @brief Method GetPaddingForMaterial, addr 0x2f0afe4, size 0x74, virtual false, abstract: false, final false
inline float_t GetPaddingForMaterial(::UnityEngine::Material*  mat) ;

/// @brief Method GetRootCanvasTransform, addr 0x2f0b234, size 0xa0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> GetRootCanvasTransform() ;

/// @brief Method GetSharedMaterial, addr 0x2f0b574, size 0x20, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetSharedMaterial() ;

static inline ::TMPro::TMP_SubMeshUI* New_ctor() ;

/// @brief Method OnDestroy, addr 0x2f0ace4, size 0x1ac, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x2f0ac3c, size 0xa8, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x2f0abcc, size 0x70, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x2f0ae90, size 0x54, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method Rebuild, addr 0x2f0b2dc, size 0x38, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  update) ;

/// @brief Method RecalculateClipping, addr 0x2f0b4a4, size 0x8, virtual true, abstract: false, final false
inline void RecalculateClipping() ;

/// @brief Method RefreshMaterial, addr 0x2f0b314, size 0x10, virtual false, abstract: false, final false
inline void RefreshMaterial() ;

/// @brief Method SetAllDirty, addr 0x2f0b0cc, size 0x4, virtual true, abstract: false, final false
inline void SetAllDirty() ;

/// @brief Method SetLayoutDirty, addr 0x2f0b184, size 0x4, virtual true, abstract: false, final false
inline void SetLayoutDirty() ;

/// @brief Method SetMaterialDirty, addr 0x2f0b188, size 0x44, virtual true, abstract: false, final false
inline void SetMaterialDirty() ;

/// @brief Method SetPivotDirty, addr 0x2f0b1cc, size 0x68, virtual false, abstract: false, final false
inline void SetPivotDirty() ;

/// @brief Method SetSharedMaterial, addr 0x2f0a4c0, size 0x30, virtual false, abstract: false, final false
inline void SetSharedMaterial(::UnityEngine::Material*  mat) ;

/// @brief Method SetVerticesDirty, addr 0x2f0b0d0, size 0xb4, virtual true, abstract: false, final false
inline void SetVerticesDirty() ;

/// @brief Method UpdateGeometry, addr 0x2f0b2d8, size 0x4, virtual true, abstract: false, final false
inline void UpdateGeometry() ;

/// @brief Method UpdateMaterial, addr 0x2f0b324, size 0x180, virtual true, abstract: false, final false
inline void UpdateMaterial() ;

/// @brief Method UpdateMeshPadding, addr 0x2f0b058, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f0b594, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_fallbackMaterial, addr 0x2f0a4f0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_fallbackMaterial() ;

/// @brief Method get_fallbackSourceMaterial, addr 0x2f0a640, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_fallbackSourceMaterial() ;

/// @brief Method get_fontAsset, addr 0x2f0a154, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::TMPro::TMP_FontAsset> get_fontAsset() ;

/// @brief Method get_isDefaultMaterial, addr 0x2f0a6ac, size 0x8, virtual false, abstract: false, final false
inline bool get_isDefaultMaterial() ;

/// @brief Method get_mainTexture, addr 0x2f0a174, size 0xbc, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_mainTexture() ;

/// @brief Method get_material, addr 0x2f0a230, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_material() ;

/// @brief Method get_materialForRendering, addr 0x2f0a650, size 0x5c, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_materialForRendering() ;

/// @brief Method get_mesh, addr 0x2f0a6d0, size 0xb0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_mesh() ;

/// @brief Method get_padding, addr 0x2f0a6c0, size 0x8, virtual false, abstract: false, final false
inline float_t get_padding() ;

/// @brief Method get_sharedMaterial, addr 0x2f0a488, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_sharedMaterial() ;

/// @brief Method get_spriteAsset, addr 0x2f0a164, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::TMPro::TMP_SpriteAsset> get_spriteAsset() ;

/// @brief Method get_textComponent, addr 0x2f0a788, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::TMPro::TMP_Text> get_textComponent() ;

/// @brief Method set_fallbackMaterial, addr 0x2f0a4f8, size 0x148, virtual false, abstract: false, final false
inline void set_fallbackMaterial(::UnityEngine::Material*  value) ;

/// @brief Method set_fallbackSourceMaterial, addr 0x2f0a648, size 0x8, virtual false, abstract: false, final false
inline void set_fallbackSourceMaterial(::UnityEngine::Material*  value) ;

/// @brief Method set_fontAsset, addr 0x2f0a15c, size 0x8, virtual false, abstract: false, final false
inline void set_fontAsset(::TMPro::TMP_FontAsset*  value) ;

/// @brief Method set_isDefaultMaterial, addr 0x2f0a6b4, size 0xc, virtual false, abstract: false, final false
inline void set_isDefaultMaterial(bool  value) ;

/// @brief Method set_material, addr 0x2f0a32c, size 0xe8, virtual true, abstract: false, final false
inline void set_material(::UnityEngine::Material*  value) ;

/// @brief Method set_mesh, addr 0x2f0a780, size 0x8, virtual false, abstract: false, final false
inline void set_mesh(::UnityEngine::Mesh*  value) ;

/// @brief Method set_padding, addr 0x2f0a6c8, size 0x8, virtual false, abstract: false, final false
inline void set_padding(float_t  value) ;

/// @brief Method set_sharedMaterial, addr 0x2f0a490, size 0x30, virtual false, abstract: false, final false
inline void set_sharedMaterial(::UnityEngine::Material*  value) ;

/// @brief Method set_spriteAsset, addr 0x2f0a16c, size 0x8, virtual false, abstract: false, final false
