...
public:
// Declarations
/// @brief Method Equals, addr 0x2ecb9fc, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2ecba7c, size 0xa4, virtual false, abstract: false, final false
inline bool Equals(::TMPro::HighlightState  other) ;

/// @brief Method GetHashCode, addr 0x2ecb990, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x2ecb86c, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Color32  color, ::TMPro::TMP_Offset  padding) ;

/// @brief Method op_Equality, addr 0x2ecb87c, size 0xcc, virtual false, abstract: false, final false
static inline bool op_Equality(::TMPro::HighlightState  lhs, ::TMPro::HighlightState  rhs) ;

/// @brief Method op_Inequality, addr 0x2ecb948, size 0x48, virtual false, abstract: false, final false
