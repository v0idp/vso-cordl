...
public:
// Declarations
/// @brief Method Add, addr 0x2f0ca04, size 0xfc, virtual false, abstract: false, final false
inline uint8_t Add(::TMPro::FontStyles  style) ;

/// @brief Method Clear, addr 0x2f0c9f8, size 0xc, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Remove, addr 0x2f0cb00, size 0x144, virtual false, abstract: false, final false
