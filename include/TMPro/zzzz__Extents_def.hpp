...
/// @brief Method ToString, addr 0x2ecaf48, size 0x1a0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2ecaf3c, size 0xc, virtual false, abstract: false, final false
