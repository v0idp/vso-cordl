...
/// @brief Method .ctor, addr 0x2ed92f0, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ed88a4, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord  glyphPairAdjustmentRecord) ;

/// @brief Method get_featureLookupFlags, addr 0x2edbaa8, size 0x8, virtual false, abstract: false, final false
inline ::TMPro::FontFeatureLookupFlags get_featureLookupFlags() ;

/// @brief Method get_firstAdjustmentRecord, addr 0x2edba58, size 0x14, virtual false, abstract: false, final false
inline ::TMPro::TMP_GlyphAdjustmentRecord get_firstAdjustmentRecord() ;

/// @brief Method get_secondAdjustmentRecord, addr 0x2edba80, size 0x14, virtual false, abstract: false, final false
inline ::TMPro::TMP_GlyphAdjustmentRecord get_secondAdjustmentRecord() ;

/// @brief Method set_featureLookupFlags, addr 0x2edbab0, size 0x8, virtual false, abstract: false, final false
inline void set_featureLookupFlags(::TMPro::FontFeatureLookupFlags  value) ;

/// @brief Method set_firstAdjustmentRecord, addr 0x2edba6c, size 0x14, virtual false, abstract: false, final false
inline void set_firstAdjustmentRecord(::TMPro::TMP_GlyphAdjustmentRecord  value) ;

/// @brief Method set_secondAdjustmentRecord, addr 0x2edba94, size 0x14, virtual false, abstract: false, final false
