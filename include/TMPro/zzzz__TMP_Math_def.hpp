...
/// @brief Method Approximately, addr 0x2ecaac0, size 0x30, virtual false, abstract: false, final false
static inline bool Approximately(float_t  a, float_t  b) ;

/// @brief Method Mod, addr 0x2ecaaf0, size 0x14, virtual false, abstract: false, final false
