...
/// @brief Method .ctor, addr 0x2ecb358, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2ecb3d4, size 0x60, virtual false, abstract: false, final false
inline void _ctor(uint32_t  unicode, ::TMPro::TMP_FontAsset*  fontAsset, ::UnityEngine::TextCore::Glyph*  glyph) ;

/// @brief Method .ctor, addr 0x2ecb380, size 0x54, virtual false, abstract: false, final false
inline void _ctor(uint32_t  unicode, ::UnityEngine::TextCore::Glyph*  glyph) ;

/// @brief Method .ctor, addr 0x2ecb434, size 0x40, virtual false, abstract: false, final false
