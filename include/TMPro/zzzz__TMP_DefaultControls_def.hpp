...
/// @brief Method CreateButton, addr 0x2ecc82c, size 0x2c0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateButton(::TMPro::TMP_DefaultControls_Resources  resources) ;

/// @brief Method CreateDropdown, addr 0x2ecd390, size 0xde0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateDropdown(::TMPro::TMP_DefaultControls_Resources  resources) ;

/// @brief Method CreateInputField, addr 0x2eccb8c, size 0x660, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateInputField(::TMPro::TMP_DefaultControls_Resources  resources) ;

/// @brief Method CreateScrollbar, addr 0x2ecc560, size 0x2cc, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateScrollbar(::TMPro::TMP_DefaultControls_Resources  resources) ;

/// @brief Method CreateText, addr 0x2eccaec, size 0xa0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateText(::TMPro::TMP_DefaultControls_Resources  resources) ;

/// @brief Method CreateUIElementRoot, addr 0x2ecc12c, size 0xa8, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateUIElementRoot(::StringW  name, ::UnityEngine::Vector2  size) ;

/// @brief Method CreateUIObject, addr 0x2ecc1d4, size 0xc0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> CreateUIObject(::StringW  name, ::UnityEngine::GameObject*  parent) ;

/// @brief Method SetDefaultColorTransitionValues, addr 0x2ecc41c, size 0x60, virtual false, abstract: false, final false
static inline void SetDefaultColorTransitionValues(::UnityEngine::UI::Selectable*  slider) ;

/// @brief Method SetDefaultTextValues, addr 0x2ecc394, size 0x88, virtual false, abstract: false, final false
static inline void SetDefaultTextValues(::TMPro::TMP_Text*  lbl) ;

/// @brief Method SetLayerRecursively, addr 0x2ecc47c, size 0xe4, virtual false, abstract: false, final false
static inline void SetLayerRecursively(::UnityEngine::GameObject*  go, int32_t  layer) ;

/// @brief Method SetParentAndAlign, addr 0x2ecc294, size 0x100, virtual false, abstract: false, final false
