...
public:
// Declarations
/// @brief Method ToString, addr 0x2ecb188, size 0x1a0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2ecb17c, size 0xc, virtual false, abstract: false, final false
