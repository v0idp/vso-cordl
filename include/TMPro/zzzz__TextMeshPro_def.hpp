...
/// @brief Method Awake, addr 0x2ebd7bc, size 0x3a0, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method CalculateLayoutInputHorizontal, addr 0x2ebd7b4, size 0x4, virtual true, abstract: false, final true
inline void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical, addr 0x2ebd7b8, size 0x4, virtual true, abstract: false, final true
inline void CalculateLayoutInputVertical() ;

/// @brief Method ClearMesh, addr 0x2ebd1f4, size 0xc0, virtual true, abstract: false, final false
inline void ClearMesh(bool  updateMesh) ;

/// @brief Method ComputeMarginSize, addr 0x2ec13ec, size 0xdc, virtual true, abstract: false, final false
inline void ComputeMarginSize() ;

/// @brief Method CreateMaterialInstance, addr 0x2ebe890, size 0xc4, virtual false, abstract: false, final false
inline void CreateMaterialInstance() ;

/// @brief Method DestroySubMeshObjects, addr 0x2ec1d18, size 0xdc, virtual true, abstract: false, final false
inline void DestroySubMeshObjects() ;

/// @brief Method DisableMasking, addr 0x2ebe79c, size 0xf4, virtual false, abstract: false, final false
inline void DisableMasking() ;

/// @brief Method EnableMasking, addr 0x2ebe624, size 0xf8, virtual false, abstract: false, final false
inline void EnableMasking() ;

/// @brief Method ForceMeshUpdate, addr 0x2ebd174, size 0x14, virtual true, abstract: false, final false
inline void ForceMeshUpdate(bool  ignoreActiveState, bool  forceTextReparsing) ;

/// @brief Method GenerateTextMesh, addr 0x2eaba8c, size 0x7260, virtual true, abstract: false, final false
inline void GenerateTextMesh() ;

/// @brief Method GetCompoundBounds, addr 0x2ec1df4, size 0x1f0, virtual true, abstract: false, final false
inline ::UnityEngine::Bounds GetCompoundBounds() ;

/// @brief Method GetMaterial, addr 0x2ebe954, size 0x110, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetMaterial(::UnityEngine::Material*  mat) ;

/// @brief Method GetMaterials, addr 0x2ebea64, size 0x1a8, virtual true, abstract: false, final false
...
/// @brief Method GetSharedMaterials, addr 0x2ebec44, size 0x190, virtual true, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Material>,::Array<::UnityW<::UnityEngine::Material>>*> GetSharedMaterials() ;

/// @brief Method GetTextContainerLocalCorners, addr 0x2ec19b0, size 0x98, virtual true, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*> GetTextContainerLocalCorners() ;

/// @brief Method GetTextInfo, addr 0x2ebd188, size 0x6c, virtual true, abstract: false, final false
inline ::TMPro::TMP_TextInfo* GetTextInfo(::StringW  text) ;

/// @brief Method InternalUpdate, addr 0x2ec1668, size 0x9c, virtual true, abstract: false, final false
inline void InternalUpdate() ;

/// @brief Method LoadFontAsset, addr 0x2ebddd0, size 0x5e0, virtual true, abstract: false, final false
inline void LoadFontAsset() ;

static inline ::TMPro::TextMeshPro* New_ctor() ;

/// @brief Method OnDestroy, addr 0x2ebdd04, size 0xcc, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x2ec14c8, size 0x1c, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x2ebdc58, size 0xac, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x2ebdb5c, size 0xfc, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPreRenderObject, addr 0x2ebccf8, size 0x248, virtual false, abstract: false, final false
inline void OnPreRenderObject() ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x2ec1514, size 0x154, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnTransformParentChanged, addr 0x2ec14e4, size 0x30, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method Rebuild, addr 0x2ebcc10, size 0xe8, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  update) ;

/// @brief Method SetActiveSubMeshes, addr 0x2ec1c08, size 0x110, virtual true, abstract: false, final false
inline void SetActiveSubMeshes(bool  state) ;

/// @brief Method SetActiveSubTextObjectRenderers, addr 0x2ec1880, size 0x130, virtual false, abstract: false, final false
inline void SetActiveSubTextObjectRenderers(bool  state) ;

/// @brief Method SetAllDirty, addr 0x2ebcbcc, size 0x44, virtual true, abstract: false, final false
inline void SetAllDirty() ;

/// @brief Method SetArraySizes, addr 0x2ebf8c0, size 0x1b2c, virtual true, abstract: false, final false
inline int32_t SetArraySizes(::ArrayW<::TMPro::TMP_Text_UnicodeChar,::Array<::TMPro::TMP_Text_UnicodeChar>*>  unicodeChars) ;

/// @brief Method SetCulling, addr 0x2ebf5a0, size 0x29c, virtual true, abstract: false, final false
inline void SetCulling() ;

/// @brief Method SetFaceColor, addr 0x2ebf268, size 0x128, virtual true, abstract: false, final false
inline void SetFaceColor(::UnityEngine::Color32  color) ;

/// @brief Method SetLayoutDirty, addr 0x2ebcaec, size 0xd0, virtual true, abstract: false, final false
inline void SetLayoutDirty() ;

/// @brief Method SetMask, addr 0x2ebc6bc, size 0x148, virtual false, abstract: false, final false
inline void SetMask(::TMPro::MaskingTypes  maskType) ;

/// @brief Method SetMask, addr 0x2ebc804, size 0x48, virtual false, abstract: false, final false
inline void SetMask(::TMPro::MaskingTypes  type, ::UnityEngine::Vector4  maskCoords) ;

/// @brief Method SetMask, addr 0x2ebc8ec, size 0x60, virtual false, abstract: false, final false
inline void SetMask(::TMPro::MaskingTypes  type, ::UnityEngine::Vector4  maskCoords, float_t  softnessX, float_t  softnessY) ;

/// @brief Method SetMaskCoordinates, addr 0x2ebc84c, size 0xa0, virtual false, abstract: false, final false
inline void SetMaskCoordinates(::UnityEngine::Vector4  coords) ;

/// @brief Method SetMaskCoordinates, addr 0x2ebc94c, size 0xf0, virtual false, abstract: false, final false
inline void SetMaskCoordinates(::UnityEngine::Vector4  coords, float_t  softX, float_t  softY) ;

/// @brief Method SetMaterialDirty, addr 0x2ebcbbc, size 0x10, virtual true, abstract: false, final false
inline void SetMaterialDirty() ;

/// @brief Method SetMeshFilters, addr 0x2ec1a48, size 0x1c0, virtual false, abstract: false, final false
inline void SetMeshFilters(bool  state) ;

/// @brief Method SetOutlineColor, addr 0x2ebf390, size 0x128, virtual true, abstract: false, final false
inline void SetOutlineColor(::UnityEngine::Color32  color) ;

/// @brief Method SetOutlineThickness, addr 0x2ebf13c, size 0x12c, virtual true, abstract: false, final false
inline void SetOutlineThickness(float_t  thickness) ;

/// @brief Method SetPerspectiveCorrection, addr 0x2ebf83c, size 0x84, virtual false, abstract: false, final false
inline void SetPerspectiveCorrection() ;

/// @brief Method SetShaderDepth, addr 0x2ebf4b8, size 0xe8, virtual true, abstract: false, final false
inline void SetShaderDepth() ;

/// @brief Method SetSharedMaterial, addr 0x2ebec0c, size 0x38, virtual true, abstract: false, final false
inline void SetSharedMaterial(::UnityEngine::Material*  mat) ;

/// @brief Method SetSharedMaterials, addr 0x2ebedd4, size 0x368, virtual true, abstract: false, final false
inline void SetSharedMaterials(::ArrayW<::UnityEngine::Material*,::Array<::UnityEngine::Material*>*>  materials) ;

/// @brief Method SetVerticesDirty, addr 0x2ebca3c, size 0xb0, virtual true, abstract: false, final false
inline void SetVerticesDirty() ;

/// @brief Method UpdateEnvMapMatrix, addr 0x2ebe3b0, size 0x274, virtual false, abstract: false, final false
inline void UpdateEnvMapMatrix() ;

/// @brief Method UpdateFontAsset, addr 0x2ebd7a4, size 0x10, virtual false, abstract: false, final false
inline void UpdateFontAsset() ;

/// @brief Method UpdateGeometry, addr 0x2ebd41c, size 0x18, virtual true, abstract: false, final false
inline void UpdateGeometry(::UnityEngine::Mesh*  mesh, int32_t  index) ;

/// @brief Method UpdateMask, addr 0x2ebe71c, size 0x80, virtual false, abstract: false, final false
inline void UpdateMask() ;

/// @brief Method UpdateMaterial, addr 0x2ebcf40, size 0x134, virtual true, abstract: false, final false
inline void UpdateMaterial() ;

/// @brief Method UpdateMeshPadding, addr 0x2ebd074, size 0x100, virtual true, abstract: false, final false
inline void UpdateMeshPadding() ;

/// @brief Method UpdateSDFScale, addr 0x2ec1704, size 0x17c, virtual false, abstract: false, final false
inline void UpdateSDFScale(float_t  scaleDelta) ;

/// @brief Method UpdateSubMeshSortingLayerID, addr 0x2ebc05c, size 0x10c, virtual false, abstract: false, final false
inline void UpdateSubMeshSortingLayerID(int32_t  id) ;

/// @brief Method UpdateSubMeshSortingOrder, addr 0x2ebc2b0, size 0x10c, virtual false, abstract: false, final false
inline void UpdateSubMeshSortingOrder(int32_t  order) ;

/// @brief Method UpdateVertexData, addr 0x2ebd5d4, size 0x1d0, virtual true, abstract: false, final false
inline void UpdateVertexData() ;

/// @brief Method UpdateVertexData, addr 0x2ebd434, size 0x1a0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ec1fe4, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_OnPreRenderText, addr 0x2ebd2b4, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method get_autoSizeTextContainer, addr 0x2ebc3bc, size 0x8, virtual true, abstract: false, final false
inline bool get_autoSizeTextContainer() ;

/// @brief Method get_maskType, addr 0x2ebc6ac, size 0x8, virtual false, abstract: false, final false
inline ::TMPro::MaskingTypes get_maskType() ;

/// @brief Method get_mesh, addr 0x2ebc500, size 0xb0, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_mesh() ;

/// @brief Method get_meshFilter, addr 0x2ebc5b0, size 0xfc, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::MeshFilter> get_meshFilter() ;

/// @brief Method get_renderer, addr 0x2ebbf14, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Renderer> get_renderer() ;

/// @brief Method get_sortingLayerID, addr 0x2ebbe80, size 0x94, virtual false, abstract: false, final false
inline int32_t get_sortingLayerID() ;

/// @brief Method get_sortingOrder, addr 0x2ebc168, size 0x94, virtual false, abstract: false, final false
inline int32_t get_sortingOrder() ;

/// @brief Method get_textContainer, addr 0x2ebc464, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::TMPro::TextContainer> get_textContainer() ;

/// @brief Method get_transform, addr 0x2ebc46c, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_transform() ;

/// @brief Convert to "::UnityEngine::UI::ILayoutElement"
constexpr ::UnityEngine::UI::ILayoutElement* i___UnityEngine__UI__ILayoutElement() noexcept;

/// @brief Method remove_OnPreRenderText, addr 0x2ebd368, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method set_autoSizeTextContainer, addr 0x2ebc3c4, size 0xa0, virtual true, abstract: false, final false
inline void set_autoSizeTextContainer(bool  value) ;

/// @brief Method set_maskType, addr 0x2ebc6b4, size 0x8, virtual false, abstract: false, final false
inline void set_maskType(::TMPro::MaskingTypes  value) ;

/// @brief Method set_sortingLayerID, addr 0x2ebbfa8, size 0xb4, virtual false, abstract: false, final false
inline void set_sortingLayerID(int32_t  value) ;

/// @brief Method set_sortingOrder, addr 0x2ebc1fc, size 0xb4, virtual false, abstract: false, final false
