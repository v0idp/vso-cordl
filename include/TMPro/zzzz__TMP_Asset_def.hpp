...
/// @brief Method .ctor, addr 0x2ecb350, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_instanceID, addr 0x2ecb328, size 0x28, virtual false, abstract: false, final false
