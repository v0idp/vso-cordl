...
public:
// Declarations
/// @brief Method .ctor, addr 0x2ed9b68, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphValueRecord  valueRecord) ;

/// @brief Method op_Addition, addr 0x2ed9bc8, size 0x14, virtual false, abstract: false, final false
