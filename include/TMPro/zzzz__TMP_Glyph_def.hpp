...
public:
// Declarations
/// @brief Method Clone, addr 0x2ed9a00, size 0x7c, virtual false, abstract: false, final false
static inline ::TMPro::TMP_Glyph* Clone(::TMPro::TMP_Glyph*  source) ;

static inline ::TMPro::TMP_Glyph* New_ctor() ;

/// @brief Method .ctor, addr 0x2ed9a7c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
