...
/// @brief Method .ctor, addr 0x2f08368, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_elementType, addr 0x2f0b878, size 0x8, virtual false, abstract: false, final false
inline ::TMPro::TextElementType get_elementType() ;

/// @brief Method get_glyph, addr 0x2f0b8a0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Glyph* get_glyph() ;

/// @brief Method get_glyphIndex, addr 0x2f0b8b0, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_glyphIndex() ;

/// @brief Method get_scale, addr 0x2f0b8c0, size 0x8, virtual false, abstract: false, final false
inline float_t get_scale() ;

/// @brief Method get_textAsset, addr 0x2f0b890, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::TMPro::TMP_Asset> get_textAsset() ;

/// @brief Method get_unicode, addr 0x2f0b880, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_unicode() ;

/// @brief Method set_glyph, addr 0x2f0b8a8, size 0x8, virtual false, abstract: false, final false
inline void set_glyph(::UnityEngine::TextCore::Glyph*  value) ;

/// @brief Method set_glyphIndex, addr 0x2f0b8b8, size 0x8, virtual false, abstract: false, final false
inline void set_glyphIndex(uint32_t  value) ;

/// @brief Method set_scale, addr 0x2f0b8c8, size 0x8, virtual false, abstract: false, final false
inline void set_scale(float_t  value) ;

/// @brief Method set_textAsset, addr 0x2f0b898, size 0x8, virtual false, abstract: false, final false
inline void set_textAsset(::TMPro::TMP_Asset*  value) ;

/// @brief Method set_unicode, addr 0x2f0b888, size 0x8, virtual false, abstract: false, final false
