...
/// @brief Method Clear, addr 0x2f023e8, size 0xa4, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Clear, addr 0x2f0248c, size 0x138, virtual false, abstract: false, final false
inline void Clear(bool  uploadChanges) ;

/// @brief Method ClearUnusedVertices, addr 0x2f025c4, size 0x3c, virtual false, abstract: false, final false
inline void ClearUnusedVertices() ;

/// @brief Method ClearUnusedVertices, addr 0x2f02600, size 0x34, virtual false, abstract: false, final false
inline void ClearUnusedVertices(int32_t  startIndex) ;

/// @brief Method ClearUnusedVertices, addr 0x2f02634, size 0xc4, virtual false, abstract: false, final false
inline void ClearUnusedVertices(int32_t  startIndex, bool  updateMesh) ;

/// @brief Method ResizeMeshInfo, addr 0x2f0169c, size 0x474, virtual false, abstract: false, final false
inline void ResizeMeshInfo(int32_t  size) ;

/// @brief Method ResizeMeshInfo, addr 0x2f01b10, size 0x8d8, virtual false, abstract: false, final false
inline void ResizeMeshInfo(int32_t  size, bool  isVolumetric) ;

/// @brief Method SortGeometry, addr 0x2f026f8, size 0xb4, virtual false, abstract: false, final false
inline void SortGeometry(::TMPro::VertexSortingOrder  order) ;

/// @brief Method SortGeometry, addr 0x2f02d38, size 0x1f8, virtual false, abstract: false, final false
inline void SortGeometry(::System::Collections::Generic::IList_1<int32_t>*  sortingOrder) ;

/// @brief Method SwapVertexData, addr 0x2f027ac, size 0x58c, virtual false, abstract: false, final false
inline void SwapVertexData(int32_t  src, int32_t  dst) ;

/// @brief Method .ctor, addr 0x2f00a24, size 0x4f4, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Mesh*  mesh, int32_t  size) ;

/// @brief Method .ctor, addr 0x2f00f18, size 0x784, virtual false, abstract: false, final false
