...
/// @brief Field s_FontAssetReferenceLookup, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_FontAssetReferenceLookup, put=setStaticF_s_FontAssetReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::TMPro::TMP_FontAsset>>*  s_FontAssetReferenceLookup;
...
/// @brief Method AddFontAsset, addr 0x2f031c4, size 0x150, virtual false, abstract: false, final false
static inline void AddFontAsset(::TMPro::TMP_FontAsset*  fontAsset) ;

/// @brief Method GetTextSettings, addr 0x2f030b4, size 0x110, virtual false, abstract: false, final false
static inline ::UnityW<::TMPro::TMP_Settings> GetTextSettings() ;

static inline ::TMPro::TMP_ResourceManager* New_ctor() ;

/// @brief Method RebuildFontAssetCache, addr 0x2f033a8, size 0x118, virtual false, abstract: false, final false
static inline void RebuildFontAssetCache(int32_t  instanceID) ;

/// @brief Method TryGetFontAsset, addr 0x2f03314, size 0x94, virtual false, abstract: false, final false
static inline bool TryGetFontAsset(int32_t  hashcode, ::ByRef<::TMPro::TMP_FontAsset*>  fontAsset) ;

/// @brief Method .ctor, addr 0x2f030ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
