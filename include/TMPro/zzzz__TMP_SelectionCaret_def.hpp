...
public:
// Declarations
/// @brief Method Cull, addr 0x2f0361c, size 0xd0, virtual true, abstract: false, final false
inline void Cull(::UnityEngine::Rect  clipRect, bool  validRect) ;

static inline ::TMPro::TMP_SelectionCaret* New_ctor() ;

/// @brief Method UpdateGeometry, addr 0x2f036ec, size 0x4, virtual true, abstract: false, final false
inline void UpdateGeometry() ;

/// @brief Method .ctor, addr 0x2f036f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
