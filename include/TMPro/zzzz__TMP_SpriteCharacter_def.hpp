...
/// @brief Method .ctor, addr 0x2f080fc, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2f08370, size 0x54, virtual false, abstract: false, final false
inline void _ctor(uint32_t  unicode, ::TMPro::TMP_SpriteGlyph*  glyph) ;

/// @brief Method .ctor, addr 0x2f08424, size 0x40, virtual false, abstract: false, final false
inline void _ctor(uint32_t  unicode, uint32_t  glyphIndex) ;

/// @brief Method .ctor, addr 0x2f083c4, size 0x60, virtual false, abstract: false, final false
inline void _ctor(uint32_t  unicode, ::TMPro::TMP_SpriteAsset*  spriteAsset, ::TMPro::TMP_SpriteGlyph*  glyph) ;

/// @brief Method get_hashCode, addr 0x2f08360, size 0x8, virtual false, abstract: false, final false
inline int32_t get_hashCode() ;

/// @brief Method get_name, addr 0x2f082ec, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method set_name, addr 0x2f0811c, size 0x78, virtual false, abstract: false, final false
