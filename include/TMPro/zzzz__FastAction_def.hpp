...
/// @brief Method Add, addr 0x2eba308, size 0xc0, virtual false, abstract: false, final false
inline void Add(::System::Action*  rhs) ;

/// @brief Method Call, addr 0x2eba488, size 0x98, virtual false, abstract: false, final false
inline void Call() ;

static inline ::TMPro::FastAction* New_ctor() ;

/// @brief Method Remove, addr 0x2eba3c8, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2eba520, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;
