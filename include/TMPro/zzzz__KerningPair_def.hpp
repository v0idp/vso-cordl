...
/// @brief Method ConvertLegacyKerningData, addr 0x2ed9d00, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ed9c1c, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2ed9c80, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ed9c40, size 0x40, virtual false, abstract: false, final false
inline void _ctor(uint32_t  left, uint32_t  right, float_t  offset) ;

static inline ::TMPro::KerningPair* getStaticF_empty() ;

/// @brief Method get_firstGlyph, addr 0x2ed9bdc, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_firstGlyph() ;

/// @brief Method get_firstGlyphAdjustments, addr 0x2ed9bec, size 0xc, virtual false, abstract: false, final false
inline ::TMPro::GlyphValueRecord_Legacy get_firstGlyphAdjustments() ;

/// @brief Method get_ignoreSpacingAdjustments, addr 0x2ed9c14, size 0x8, virtual false, abstract: false, final false
inline bool get_ignoreSpacingAdjustments() ;

/// @brief Method get_secondGlyph, addr 0x2ed9bf8, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_secondGlyph() ;

/// @brief Method get_secondGlyphAdjustments, addr 0x2ed9c08, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_firstGlyph, addr 0x2ed9be4, size 0x8, virtual false, abstract: false, final false
inline void set_firstGlyph(uint32_t  value) ;

/// @brief Method set_secondGlyph, addr 0x2ed9c00, size 0x8, virtual false, abstract: false, final false
