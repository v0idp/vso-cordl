...
/// @brief Method Equals, addr 0x2ecb704, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2ecb77c, size 0xa8, virtual false, abstract: false, final false
inline bool Equals(::TMPro::TMP_Offset  other) ;

/// @brief Method GetHashCode, addr 0x2ecb6a0, size 0x64, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x2ecb5a8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(float_t  horizontal, float_t  vertical) ;

/// @brief Method .ctor, addr 0x2ecb59c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_bottom, addr 0x2ecb510, size 0x8, virtual false, abstract: false, final false
inline float_t get_bottom() ;

/// @brief Method get_horizontal, addr 0x2ecb520, size 0x8, virtual false, abstract: false, final false
inline float_t get_horizontal() ;

/// @brief Method get_left, addr 0x2ecb4e0, size 0x8, virtual false, abstract: false, final false
inline float_t get_left() ;

/// @brief Method get_right, addr 0x2ecb4f0, size 0x8, virtual false, abstract: false, final false
inline float_t get_right() ;

/// @brief Method get_top, addr 0x2ecb500, size 0x8, virtual false, abstract: false, final false
inline float_t get_top() ;

/// @brief Method get_vertical, addr 0x2ecb530, size 0x8, virtual false, abstract: false, final false
inline float_t get_vertical() ;

/// @brief Method get_zero, addr 0x2ecb540, size 0x5c, virtual false, abstract: false, final false
static inline ::TMPro::TMP_Offset get_zero() ;

/// @brief Method op_Equality, addr 0x2ecb5b4, size 0x28, virtual false, abstract: false, final false
static inline bool op_Equality(::TMPro::TMP_Offset  lhs, ::TMPro::TMP_Offset  rhs) ;

/// @brief Method op_Inequality, addr 0x2ecb5dc, size 0xb0, virtual false, abstract: false, final false
static inline bool op_Inequality(::TMPro::TMP_Offset  lhs, ::TMPro::TMP_Offset  rhs) ;

/// @brief Method op_Multiply, addr 0x2ecb68c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method set_bottom, addr 0x2ecb518, size 0x8, virtual false, abstract: false, final false
inline void set_bottom(float_t  value) ;

/// @brief Method set_horizontal, addr 0x2ecb528, size 0x8, virtual false, abstract: false, final false
inline void set_horizontal(float_t  value) ;

/// @brief Method set_left, addr 0x2ecb4e8, size 0x8, virtual false, abstract: false, final false
inline void set_left(float_t  value) ;

/// @brief Method set_right, addr 0x2ecb4f8, size 0x8, virtual false, abstract: false, final false
inline void set_right(float_t  value) ;

/// @brief Method set_top, addr 0x2ecb508, size 0x8, virtual false, abstract: false, final false
inline void set_top(float_t  value) ;

/// @brief Method set_vertical, addr 0x2ecb538, size 0x8, virtual false, abstract: false, final false
