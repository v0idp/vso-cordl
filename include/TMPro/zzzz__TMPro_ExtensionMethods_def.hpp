...
public:
// Declarations
/// @brief Method ArrayToString, addr 0x2eca32c, size 0xe8, virtual false, abstract: false, final false
static inline ::StringW ArrayToString(::ArrayW<char16_t,::Array<char16_t>*>  chars) ;

/// @brief Method Compare, addr 0x2eca6cc, size 0x28, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::Color  a, ::UnityEngine::Color  b) ;

/// @brief Method Compare, addr 0x2eca6ac, size 0x10, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::Color32  a, ::UnityEngine::Color32  b) ;

/// @brief Method Compare, addr 0x2ecaa00, size 0xc0, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::Quaternion  q1, ::UnityEngine::Quaternion  q2, int32_t  accuracy) ;

/// @brief Method Compare, addr 0x2eca96c, size 0x94, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::Vector3  v1, ::UnityEngine::Vector3  v2, int32_t  accuracy) ;

/// @brief Method CompareRGB, addr 0x2eca6f4, size 0x20, virtual false, abstract: false, final false
static inline bool CompareRGB(::UnityEngine::Color  a, ::UnityEngine::Color  b) ;

/// @brief Method CompareRGB, addr 0x2eca6bc, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method IntToString, addr 0x2eca414, size 0xb0, virtual false, abstract: false, final false
static inline ::StringW IntToString(::ArrayW<int32_t,::Array<int32_t>*>  unicodes) ;

/// @brief Method IntToString, addr 0x2eca59c, size 0x110, virtual false, abstract: false, final false
static inline ::StringW IntToString(::ArrayW<int32_t,::Array<int32_t>*>  unicodes, int32_t  start, int32_t  length) ;

/// @brief Method MinAlpha, addr 0x2eca960, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::Color MinAlpha(::UnityEngine::Color  c1, ::UnityEngine::Color  c2) ;

/// @brief Method Multiply, addr 0x2eca714, size 0xb8, virtual false, abstract: false, final false
static inline ::UnityEngine::Color32 Multiply(::UnityEngine::Color32  c1, ::UnityEngine::Color32  c2) ;

/// @brief Method Tint, addr 0x2eca7cc, size 0xb8, virtual false, abstract: false, final false
static inline ::UnityEngine::Color32 Tint(::UnityEngine::Color32  c1, ::UnityEngine::Color32  c2) ;

/// @brief Method Tint, addr 0x2eca884, size 0xdc, virtual false, abstract: false, final false
static inline ::UnityEngine::Color32 Tint(::UnityEngine::Color32  c1, float_t  tint) ;

/// @brief Method ToIntArray, addr 0x2eca278, size 0xb4, virtual false, abstract: false, final false
static inline ::ArrayW<int32_t,::Array<int32_t>*> ToIntArray(::StringW  text) ;

/// @brief Method UintToString, addr 0x2eca4c4, size 0xd8, virtual false, abstract: false, final false
