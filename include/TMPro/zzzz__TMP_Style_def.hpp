...
/// @brief Method RefreshStyle, addr 0x2f08860, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f08698, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_NormalStyle, addr 0x2f085e4, size 0xb4, virtual false, abstract: false, final false
static inline ::TMPro::TMP_Style* get_NormalStyle() ;

/// @brief Method get_hashCode, addr 0x2f08768, size 0x8, virtual false, abstract: false, final false
inline int32_t get_hashCode() ;

/// @brief Method get_name, addr 0x2f08728, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_styleClosingDefinition, addr 0x2f0878c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_styleClosingDefinition() ;

/// @brief Method get_styleClosingTagArray, addr 0x2f0879c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_styleClosingTagArray() ;

/// @brief Method get_styleOpeningDefinition, addr 0x2f08784, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_styleOpeningDefinition() ;

/// @brief Method get_styleOpeningTagArray, addr 0x2f08794, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_hashCode, addr 0x2f08770, size 0x14, virtual false, abstract: false, final false
inline void set_hashCode(int32_t  value) ;

/// @brief Method set_name, addr 0x2f08730, size 0x38, virtual false, abstract: false, final false
