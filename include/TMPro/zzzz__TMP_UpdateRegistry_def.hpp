...
/// @brief Method InternalRegisterCanvasElementForGraphicRebuild, addr 0x2f10ca8, size 0x158, virtual false, abstract: false, final false
inline bool InternalRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalRegisterCanvasElementForLayoutRebuild, addr 0x2f10b30, size 0x158, virtual false, abstract: false, final false
inline bool InternalRegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalUnRegisterCanvasElementForGraphicRebuild, addr 0x2f111d0, size 0xdc, virtual false, abstract: false, final false
inline void InternalUnRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalUnRegisterCanvasElementForLayoutRebuild, addr 0x2f110f4, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method PerformUpdateForCanvasRendererObjects, addr 0x2f10e00, size 0x25c, virtual false, abstract: false, final false
inline void PerformUpdateForCanvasRendererObjects() ;

/// @brief Method PerformUpdateForMeshRendererObjects, addr 0x2f1105c, size 0x68, virtual false, abstract: false, final false
inline void PerformUpdateForMeshRendererObjects() ;

/// @brief Method RegisterCanvasElementForGraphicRebuild, addr 0x2f10c88, size 0x20, virtual false, abstract: false, final false
static inline void RegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method RegisterCanvasElementForLayoutRebuild, addr 0x2f10b10, size 0x20, virtual false, abstract: false, final false
static inline void RegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method UnRegisterCanvasElementForRebuild, addr 0x2f110c4, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f109c4, size 0x14c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::TMPro::TMP_UpdateRegistry* getStaticF_s_Instance() ;

/// @brief Method get_instance, addr 0x2f10950, size 0x74, virtual false, abstract: false, final false
