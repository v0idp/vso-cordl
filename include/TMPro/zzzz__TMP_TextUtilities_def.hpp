...
public:
// Declarations
/// @brief Method .ctor, addr 0x2f0fad0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method DistanceToLine, addr 0x2f0db88, size 0xc8, virtual false, abstract: false, final false
static inline float_t DistanceToLine(::UnityEngine::Vector3  a, ::UnityEngine::Vector3  b, ::UnityEngine::Vector3  point) ;

/// @brief Method FindIntersectingCharacter, addr 0x2f0dd6c, size 0x208, virtual false, abstract: false, final false
...
/// @brief Method FindIntersectingLine, addr 0x2f0e948, size 0x158, virtual false, abstract: false, final false
static inline int32_t FindIntersectingLine(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method FindIntersectingLink, addr 0x2f0eaa0, size 0x340, virtual false, abstract: false, final false
static inline int32_t FindIntersectingLink(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method FindIntersectingWord, addr 0x2f0df74, size 0x410, virtual false, abstract: false, final false
static inline int32_t FindIntersectingWord(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method FindNearestCharacter, addr 0x2f0cdb0, size 0x328, virtual false, abstract: false, final false
...
/// @brief Method FindNearestCharacterOnLine, addr 0x2f0d75c, size 0x36c, virtual false, abstract: false, final false
...
/// @brief Method FindNearestLine, addr 0x2f0d5dc, size 0x180, virtual false, abstract: false, final false
static inline int32_t FindNearestLine(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method FindNearestLink, addr 0x2f0ede0, size 0x714, virtual false, abstract: false, final false
static inline int32_t FindNearestLink(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method FindNearestWord, addr 0x2f0e384, size 0x5c4, virtual false, abstract: false, final false
static inline int32_t FindNearestWord(::TMPro::TMP_Text*  text, ::UnityEngine::Vector3  position, ::UnityEngine::Camera*  camera) ;

/// @brief Method GetCursorIndexFromPosition, addr 0x2f0cc4c, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method GetCursorIndexFromPosition, addr 0x2f0d3fc, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x2f0f7c0, size 0xbc, virtual false, abstract: false, final false
static inline int32_t GetHashCode(::StringW  s) ;

/// @brief Method GetSimpleHashCode, addr 0x2f0742c, size 0x6c, virtual false, abstract: false, final false
static inline int32_t GetSimpleHashCode(::StringW  s) ;

/// @brief Method GetSimpleHashCodeLowercase, addr 0x2f0f87c, size 0xbc, virtual false, abstract: false, final false
static inline uint32_t GetSimpleHashCodeLowercase(::StringW  s) ;

/// @brief Method HexToInt, addr 0x2f0f938, size 0x2c, virtual false, abstract: false, final false
static inline int32_t HexToInt(char16_t  hex) ;

/// @brief Method IntersectLinePlane, addr 0x2f0f4f4, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method IsIntersectingRectTransform, addr 0x2f0dc50, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method PointIntersectRectangle, addr 0x2f0dac8, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method ScreenPointToWorldPointInRectangle, addr 0x2f0d0d8, size 0x324, virtual false, abstract: false, final false
...
/// @brief Method StringHexToInt, addr 0x2f0f964, size 0x104, virtual false, abstract: false, final false
static inline int32_t StringHexToInt(::StringW  s) ;

/// @brief Method ToLowerFast, addr 0x2f0f664, size 0x74, virtual false, abstract: false, final false
static inline char16_t ToLowerFast(char16_t  c) ;

/// @brief Method ToUpperASCIIFast, addr 0x2f0f74c, size 0x74, virtual false, abstract: false, final false
static inline uint32_t ToUpperASCIIFast(uint32_t  c) ;

/// @brief Method ToUpperFast, addr 0x2f0f6d8, size 0x74, virtual false, abstract: false, final false
