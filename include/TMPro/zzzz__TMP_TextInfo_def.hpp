...
/// @brief Method Clear, addr 0x2f0bc90, size 0x5c, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ClearAllData, addr 0x2f0bcec, size 0x12c, virtual false, abstract: false, final false
inline void ClearAllData() ;

/// @brief Method ClearAllMeshInfo, addr 0x2f0bed0, size 0xb0, virtual false, abstract: false, final false
inline void ClearAllMeshInfo() ;

/// @brief Method ClearLineInfo, addr 0x2f0c0ec, size 0x180, virtual false, abstract: false, final false
inline void ClearLineInfo() ;

/// @brief Method ClearMeshInfo, addr 0x2f0be18, size 0xb8, virtual false, abstract: false, final false
inline void ClearMeshInfo(bool  updateMesh) ;

/// @brief Method ClearPageInfo, addr 0x2f0c26c, size 0x98, virtual false, abstract: false, final false
inline void ClearPageInfo() ;

/// @brief Method ClearUnusedVertices, addr 0x2f0c03c, size 0xb0, virtual false, abstract: false, final false
inline void ClearUnusedVertices(::ArrayW<::TMPro::MaterialReference,::Array<::TMPro::MaterialReference>*>  materials) ;

/// @brief Method CopyMeshInfoVertexData, addr 0x2f0c304, size 0x3c0, virtual false, abstract: false, final false
...
/// @brief Method ResetVertexLayout, addr 0x2f0bf80, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f0b8d0, size 0x128, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2f0b9f8, size 0x12c, virtual false, abstract: false, final false
inline void _ctor(int32_t  characterCount) ;

/// @brief Method .ctor, addr 0x2f0bb24, size 0x16c, virtual false, abstract: false, final false
