...
public:
// Declarations
/// @brief Method GetMessage, addr 0x25e3264, size 0x5c, virtual false, abstract: false, final false
static inline ::StringW GetMessage(int32_t  hr) ;

/// @brief Method MakeHRFromErrorCode, addr 0x25e32c0, size 0xc, virtual false, abstract: false, final false
