...
public:
// Declarations
/// @brief Method CloseProcess, addr 0x2a16470, size 0x4, virtual false, abstract: false, final false
static inline bool CloseProcess(::System::IntPtr  handle) ;

/// @brief Method DuplicateHandle, addr 0x2a16204, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method GetCurrentProcess, addr 0x2a1636c, size 0x4, virtual false, abstract: false, final false
static inline ::System::IntPtr GetCurrentProcess() ;

/// @brief Method GetCurrentProcessId, addr 0x2a1646c, size 0x4, virtual false, abstract: false, final false
static inline int32_t GetCurrentProcessId() ;

/// @brief Method GetExitCodeProcess, addr 0x2a16374, size 0xf8, virtual false, abstract: false, final false
static inline bool GetExitCodeProcess(::Microsoft::Win32::SafeHandles::SafeProcessHandle*  processHandle, ::ByRef<int32_t>  exitCode) ;

/// @brief Method GetExitCodeProcess, addr 0x2a16370, size 0x4, virtual false, abstract: false, final false
