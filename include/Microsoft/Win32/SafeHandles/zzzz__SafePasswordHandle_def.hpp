...
/// @brief Method CreateHandle, addr 0x25e32cc, size 0x58, virtual false, abstract: false, final false
inline ::System::IntPtr CreateHandle(::StringW  password) ;

/// @brief Method Dispose, addr 0x25e3400, size 0x70, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method FreeHandle, addr 0x25e3324, size 0x5c, virtual false, abstract: false, final false
inline void FreeHandle() ;

/// @brief Method Mono_DangerousGetString, addr 0x25e3498, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method ReleaseHandle, addr 0x25e33bc, size 0x44, virtual true, abstract: false, final false
inline bool ReleaseHandle() ;

/// @brief Method .ctor, addr 0x25e3380, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  password) ;

/// @brief Method get_IsInvalid, addr 0x25e3470, size 0x28, virtual true, abstract: false, final false
