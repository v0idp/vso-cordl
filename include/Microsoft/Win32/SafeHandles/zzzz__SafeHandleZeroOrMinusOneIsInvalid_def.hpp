...
/// @brief Method .ctor, addr 0x25e3504, size 0x10, virtual false, abstract: false, final false
inline void _ctor(bool  ownsHandle) ;

/// @brief Method get_IsInvalid, addr 0x25e360c, size 0x5c, virtual true, abstract: false, final false
