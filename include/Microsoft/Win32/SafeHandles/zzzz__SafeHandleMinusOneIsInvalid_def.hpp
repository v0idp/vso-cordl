...
/// @brief Method .ctor, addr 0x25e3668, size 0x44, virtual false, abstract: false, final false
inline void _ctor(bool  ownsHandle) ;

/// @brief Method get_IsInvalid, addr 0x25e36ac, size 0x40, virtual true, abstract: false, final false
