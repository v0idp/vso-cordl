...
#include "Unity/Collections/LowLevel/Unsafe/zzzz__BurstLike_def.hpp"
template<typename T>
inline void Unity::Collections::LowLevel::Unsafe::BurstLike_SharedStatic_1<T>::_ctor(::cordl_internals::Ptr<void>  buffer)  {
...
template<typename T>
constexpr ::Unity::Collections::LowLevel::Unsafe::BurstLike_SharedStatic_1<T>::BurstLike_SharedStatic_1(::cordl_internals::Ptr<void>  _buffer) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::cordl_internals::Ptr<void> (*)(int64_t, int64_t, uint32_t, uint32_t)>(&::Unity::Collections::LowLevel::Unsafe::BurstLike_SharedStatic::GetOrCreateSharedStaticInternal)> {
...
inline ::cordl_internals::Ptr<void> Unity::Collections::LowLevel::Unsafe::BurstLike_SharedStatic::GetOrCreateSharedStaticInternal(int64_t  getHashCode64, int64_t  getSubHashCode64, uint32_t  sizeOf, uint32_t  alignment)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::LowLevel::Unsafe::BurstLike_SharedStatic*>::get(),
                        "GetOrCreateSharedStaticInternal",
                        std::span<const Il2CppClass* const, 0>(),
