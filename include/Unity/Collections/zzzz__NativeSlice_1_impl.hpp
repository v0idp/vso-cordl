...
// Ctor Parameters [CppParam { name: "m_Buffer", ty: "::cordl_internals::Ptr<uint8_t>", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Stride", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Length", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
template<typename T>
...
template<typename T>
inline void Unity::Collections::NativeSlice_1_Enumerator<T>::_ctor(::ByRef<::Unity::Collections::NativeSlice_1<T>>  array)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Collections::NativeSlice_1_Enumerator<T>>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
