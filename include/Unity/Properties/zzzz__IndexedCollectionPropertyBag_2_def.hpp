...
// Dependencies Unity.Properties.IConstructor, Unity.Properties.IConstructorWithCount`1<T>, Unity.Properties.IPropertyBag, Unity.Properties.IPropertyBag`1<TContainer>, Unity.Properties.PropertyBag`1<TContainer>
namespace Unity::Properties {
// cpp template
template<typename TList,typename TElement>
// Is value type: false
