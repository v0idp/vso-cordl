...
/// @brief Method CombineDependencies, addr 0x2f5abec, size 0x28, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle CombineDependencies(::Unity::Jobs::JobHandle  job0, ::Unity::Jobs::JobHandle  job1) ;

/// @brief Method CombineDependencies, addr 0x2f5ac70, size 0x60, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle CombineDependencies(::Unity::Collections::NativeArray_1<::Unity::Jobs::JobHandle>  jobs) ;

/// @brief Method CombineDependencies, addr 0x2f5ad2c, size 0x98, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle CombineDependencies(::Unity::Collections::NativeSlice_1<::Unity::Jobs::JobHandle>  jobs) ;

/// @brief Method CombineDependenciesInternal2, addr 0x2f5ac14, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method CombineDependenciesInternal2_Injected, addr 0x2f5adc4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method CombineDependenciesInternalPtr, addr 0x2f5acd0, size 0x5c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle CombineDependenciesInternalPtr(::cordl_internals::Ptr<void>  jobs, int32_t  count) ;

/// @brief Method CombineDependenciesInternalPtr_Injected, addr 0x2f5ae18, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method Complete, addr 0x2f5aac0, size 0x50, virtual false, abstract: false, final false
inline void Complete() ;

/// @brief Method Equals, addr 0x2f5ae6c, size 0x10, virtual true, abstract: false, final true
inline bool Equals(::Unity::Jobs::JobHandle  other) ;

/// @brief Method ScheduleBatchedJobs, addr 0x2f5abc4, size 0x28, virtual false, abstract: false, final false
static inline void ScheduleBatchedJobs() ;

/// @brief Method ScheduleBatchedJobsAndComplete, addr 0x2f5ab10, size 0x3c, virtual false, abstract: false, final false
static inline void ScheduleBatchedJobsAndComplete(::ByRef<::Unity::Jobs::JobHandle>  job) ;

/// @brief Method ScheduleBatchedJobsAndIsCompleted, addr 0x2f5ab88, size 0x3c, virtual false, abstract: false, final false
static inline bool ScheduleBatchedJobsAndIsCompleted(::ByRef<::Unity::Jobs::JobHandle>  job) ;

/// @brief Method get_IsCompleted, addr 0x2f5ab4c, size 0x3c, virtual false, abstract: false, final false
