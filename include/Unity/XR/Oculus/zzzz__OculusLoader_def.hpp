...
/// @brief Method CheckUnityVersionCompatibility, addr 0x2f3a078, size 0x318, virtual false, abstract: false, final false
inline bool CheckUnityVersionCompatibility() ;

/// @brief Method Deinitialize, addr 0x2f3a5d8, size 0x7c, virtual true, abstract: false, final false
inline bool Deinitialize() ;

/// @brief Method GetSettings, addr 0x2f3a934, size 0x48, virtual false, abstract: false, final false
inline ::UnityW<::Unity::XR::Oculus::OculusSettings> GetSettings() ;

/// @brief Method Initialize, addr 0x2f39d08, size 0x370, virtual true, abstract: false, final false
inline bool Initialize() ;

/// @brief Method IsDeviceSupported, addr 0x2f39bac, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method RuntimeLoadOVRPlugin, addr 0x2f3a724, size 0x1a4, virtual false, abstract: false, final false
static inline void RuntimeLoadOVRPlugin() ;

/// @brief Method Start, addr 0x2f3a4e0, size 0x7c, virtual true, abstract: false, final false
inline bool Start() ;

/// @brief Method Stop, addr 0x2f3a55c, size 0x7c, virtual true, abstract: false, final false
inline bool Stop() ;

/// @brief Method .ctor, addr 0x2f3a97c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_displaySubsystem, addr 0x2f39c40, size 0x64, virtual false, abstract: false, final false
inline Il2CppObject* get_displaySubsystem() ;

/// @brief Method get_inputSubsystem, addr 0x2f39ca4, size 0x64, virtual false, abstract: false, final false
