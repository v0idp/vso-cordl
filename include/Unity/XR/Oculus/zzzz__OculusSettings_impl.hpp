...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint16_t (::Unity::XR::Oculus::OculusSettings::*)()>(&::Unity::XR::Oculus::OculusSettings::GetStereoRenderingMode)> {
  ...
  constexpr static std::size_t addrs = 0x2f3a390;
...
//  Writing Method size for method: ::Unity::XR::Oculus::OculusSettings.IsEyeTrackingRequested
template<>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Unity::XR::Oculus::OculusSettings::*)()>(&::Unity::XR::Oculus::OculusSettings::IsEyeTrackingRequested)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x2f3e6a0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::XR::Oculus::OculusSettings*>::get(),
                        "IsEyeTrackingRequested",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::span<const Il2CppType* const, 0>()
                    )));
    return ___internal_method;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Unity::XR::Oculus::OculusSettings::*)()>(&::Unity::XR::Oculus::OculusSettings::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x2f3e6b0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Unity::XR::Oculus::OculusSettings::*)()>(&::Unity::XR::Oculus::OculusSettings::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2f3e6fc;
...
constexpr bool& Unity::XR::Oculus::OculusSettings::__cordl_internal_get_TargetQuest3()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___TargetQuest3;
}
constexpr bool const& Unity::XR::Oculus::OculusSettings::__cordl_internal_get_TargetQuest3() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___TargetQuest3;
}
constexpr void Unity::XR::Oculus::OculusSettings::__cordl_internal_set_TargetQuest3(bool  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
this->___TargetQuest3 = value;
}
...
constexpr bool& Unity::XR::Oculus::OculusSettings::__cordl_internal_get_UseStickControlThumbsticks()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___UseStickControlThumbsticks;
}
constexpr bool const& Unity::XR::Oculus::OculusSettings::__cordl_internal_get_UseStickControlThumbsticks() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___UseStickControlThumbsticks;
}
constexpr void Unity::XR::Oculus::OculusSettings::__cordl_internal_set_UseStickControlThumbsticks(bool  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
this->___UseStickControlThumbsticks = value;
}
...
inline bool Unity::XR::Oculus::OculusSettings::IsEyeTrackingRequested()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::XR::Oculus::OculusSettings*>::get(),
                        "IsEyeTrackingRequested",
                        std::span<const Il2CppClass* const, 0>(),
