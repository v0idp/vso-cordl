...
// Dependencies Unity.XR.Oculus.OculusSettings::FoveationMethod, Unity.XR.Oculus.OculusSettings::StereoRenderingModeAndroid, Unity.XR.Oculus.OculusSettings::StereoRenderingModeDesktop, UnityEngine.ScriptableObject
namespace Unity::XR::Oculus {
// Is value type: false
...
/// @brief Field FoveatedRenderingMethod, offset 0x28, size 0x4 
 __declspec(property(get=__cordl_internal_get_FoveatedRenderingMethod, put=__cordl_internal_set_FoveatedRenderingMethod)) ::Unity::XR::Oculus::OculusSettings_FoveationMethod  FoveatedRenderingMethod;
...
/// @brief Field TargetQuest2, offset 0x30, size 0x1 
 __declspec(property(get=__cordl_internal_get_TargetQuest2, put=__cordl_internal_set_TargetQuest2)) bool  TargetQuest2;

/// @brief Field TargetQuest3, offset 0x32, size 0x1 
 __declspec(property(get=__cordl_internal_get_TargetQuest3, put=__cordl_internal_set_TargetQuest3)) bool  TargetQuest3;

/// @brief Field TargetQuestPro, offset 0x31, size 0x1 
 __declspec(property(get=__cordl_internal_get_TargetQuestPro, put=__cordl_internal_set_TargetQuestPro)) bool  TargetQuestPro;

/// @brief Field UseStickControlThumbsticks, offset 0x40, size 0x1 
 __declspec(property(get=__cordl_internal_get_UseStickControlThumbsticks, put=__cordl_internal_set_UseStickControlThumbsticks)) bool  UseStickControlThumbsticks;

/// @brief Field m_StereoRenderingModeAndroid, offset 0x1c, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_StereoRenderingModeAndroid, put=__cordl_internal_set_m_StereoRenderingModeAndroid)) ::Unity::XR::Oculus::OculusSettings_StereoRenderingModeAndroid  m_StereoRenderingModeAndroid;

/// @brief Field m_StereoRenderingModeDesktop, offset 0x18, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_StereoRenderingModeDesktop, put=__cordl_internal_set_m_StereoRenderingModeDesktop)) ::Unity::XR::Oculus::OculusSettings_StereoRenderingModeDesktop  m_StereoRenderingModeDesktop;
...
/// @brief Method Awake, addr 0x2f3e6b0, size 0x4c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetStereoRenderingMode, addr 0x2f3a390, size 0x8, virtual false, abstract: false, final false
inline uint16_t GetStereoRenderingMode() ;

/// @brief Method IsEyeTrackingRequested, addr 0x2f3e6a0, size 0x10, virtual false, abstract: false, final false
inline bool IsEyeTrackingRequested() ;
...
constexpr bool const& __cordl_internal_get_TargetQuest3() const;

constexpr bool& __cordl_internal_get_TargetQuest3() ;

constexpr bool const& __cordl_internal_get_TargetQuestPro() const;

constexpr bool& __cordl_internal_get_TargetQuestPro() ;

constexpr bool const& __cordl_internal_get_UseStickControlThumbsticks() const;

constexpr bool& __cordl_internal_get_UseStickControlThumbsticks() ;
...
constexpr void __cordl_internal_set_TargetQuest3(bool  value) ;

constexpr void __cordl_internal_set_TargetQuestPro(bool  value) ;

constexpr void __cordl_internal_set_UseStickControlThumbsticks(bool  value) ;
...
/// @brief Method .ctor, addr 0x2f3e6fc, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field kUseStickControlThumbsticksDefine offset 0xffffffff size 0x8
static constexpr ::ConstString  kUseStickControlThumbsticksDefine{u"META_USE_STICK_CONTROL_THUMBSTICKS"};
...
/// @brief Field TargetQuest2, offset: 0x30, size: 0x1, def value: None
 bool  ___TargetQuest2;

/// @brief Field TargetQuestPro, offset: 0x31, size: 0x1, def value: None
 bool  ___TargetQuestPro;

/// @brief Field TargetQuest3, offset: 0x32, size: 0x1, def value: None
...
/// @brief Field UseStickControlThumbsticks, offset: 0x40, size: 0x1, def value: None
...
static_assert(offsetof(::Unity::XR::Oculus::OculusSettings, ___TargetQuest2) == 0x30, "Offset mismatch!");

static_assert(offsetof(::Unity::XR::Oculus::OculusSettings, ___TargetQuestPro) == 0x31, "Offset mismatch!");

static_assert(offsetof(::Unity::XR::Oculus::OculusSettings, ___TargetQuest3) == 0x32, "Offset mismatch!");

static_assert(offsetof(::Unity::XR::Oculus::OculusSettings, ___SystemSplashScreen) == 0x38, "Offset mismatch!");

static_assert(offsetof(::Unity::XR::Oculus::OculusSettings, ___UseStickControlThumbsticks) == 0x40, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::Unity::XR::Oculus::OculusSettings, 0x48>, "Size mismatch!");
