...
/// @brief Method FinishSetup, addr 0x2f3f3b4, size 0x148, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f3f4fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_devicePosition, addr 0x2f3f394, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_devicePosition() ;

/// @brief Method get_deviceRotation, addr 0x2f3f3a4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_deviceRotation() ;

/// @brief Method get_isTracked, addr 0x2f3f384, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_isTracked() ;

/// @brief Method get_trackingState, addr 0x2f3f374, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_trackingState() ;

/// @brief Method set_devicePosition, addr 0x2f3f39c, size 0x8, virtual false, abstract: false, final false
inline void set_devicePosition(::UnityEngine::InputSystem::Controls::Vector3Control*  value) ;

/// @brief Method set_deviceRotation, addr 0x2f3f3ac, size 0x8, virtual false, abstract: false, final false
inline void set_deviceRotation(::UnityEngine::InputSystem::Controls::QuaternionControl*  value) ;

/// @brief Method set_isTracked, addr 0x2f3f38c, size 0x8, virtual false, abstract: false, final false
inline void set_isTracked(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_trackingState, addr 0x2f3f37c, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::Unity::XR::Oculus::Input::OculusTrackingReference, ____trackingState_k__BackingField) == 0x188, "Offset mismatch!");

static_assert(offsetof(::Unity::XR::Oculus::Input::OculusTrackingReference, ____isTracked_k__BackingField) == 0x190, "Offset mismatch!");

static_assert(offsetof(::Unity::XR::Oculus::Input::OculusTrackingReference, ____devicePosition_k__BackingField) == 0x198, "Offset mismatch!");

static_assert(offsetof(::Unity::XR::Oculus::Input::OculusTrackingReference, ____deviceRotation_k__BackingField) == 0x1a0, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::Unity::XR::Oculus::Input::OculusTrackingReference, 0x1a8>, "Size mismatch!");
