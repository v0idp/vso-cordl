...
/// @brief Method .ctor, addr 0x2f3f624, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::Unity::XR::Oculus::Input::OculusGoController, 0x210>, "Size mismatch!");
