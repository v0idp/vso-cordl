...
public:
// Declarations
/// @brief Field <back>k__BackingField, offset 0x290, size 0x8 
...
/// @brief Field <touchpad>k__BackingField, offset 0x298, size 0x8 
...
/// @brief Method FinishSetup, addr 0x2f3f654, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f3f710, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_back, addr 0x2f3f634, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_back() ;

/// @brief Method get_touchpad, addr 0x2f3f644, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::Vector2Control* get_touchpad() ;

/// @brief Method set_back, addr 0x2f3f63c, size 0x8, virtual false, abstract: false, final false
inline void set_back(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_touchpad, addr 0x2f3f64c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field <back>k__BackingField, offset: 0x290, size: 0x8, def value: None
 ::UnityEngine::InputSystem::Controls::ButtonControl*  ____back_k__BackingField;

/// @brief Field <touchpad>k__BackingField, offset: 0x298, size: 0x8, def value: None
 ::UnityEngine::InputSystem::Controls::Vector2Control*  ____touchpad_k__BackingField;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::Unity::XR::Oculus::Input::OculusHMDExtended, ____back_k__BackingField) == 0x290, "Offset mismatch!");

static_assert(offsetof(::Unity::XR::Oculus::Input::OculusHMDExtended, ____touchpad_k__BackingField) == 0x298, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::Unity::XR::Oculus::Input::OculusHMDExtended, 0x2a0>, "Size mismatch!");
