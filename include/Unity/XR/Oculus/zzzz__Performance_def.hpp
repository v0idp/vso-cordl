...
/// @brief Method TryGetAvailableDisplayRefreshRates, addr 0x2f3ab68, size 0x19c, virtual false, abstract: false, final false
static inline bool TryGetAvailableDisplayRefreshRates(::ByRef<::ArrayW<float_t,::Array<float_t>*>>  refreshRates) ;

/// @brief Method TryGetDisplayRefreshRate, addr 0x2f3ae00, size 0x4, virtual false, abstract: false, final false
static inline bool TryGetDisplayRefreshRate(::ByRef<float_t>  refreshRate) ;

/// @brief Method TrySetCPULevel, addr 0x2f3aa60, size 0x18, virtual false, abstract: false, final false
static inline bool TrySetCPULevel(int32_t  level) ;

/// @brief Method TrySetDisplayRefreshRate, addr 0x2f3ad84, size 0x4, virtual false, abstract: false, final false
static inline bool TrySetDisplayRefreshRate(float_t  refreshRate) ;

/// @brief Method TrySetGPULevel, addr 0x2f3aae4, size 0x18, virtual false, abstract: false, final false
