...
/// @brief Method Dispose, addr 0x2f5b68c, size 0x60, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x2f5b5f0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method Auto, addr 0x2f5b598, size 0x58, virtual false, abstract: false, final false
inline ::Unity::Profiling::ProfilerMarker_AutoScope Auto() ;

/// @brief Method .ctor, addr 0x2f5b538, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::Unity::Profiling::ProfilerCategory  category, ::StringW  name) ;

/// @brief Method .ctor, addr 0x2f5b488, size 0x54, virtual false, abstract: false, final false
