...
/// @brief Method FinalizeSnapshot, addr 0x2f5bcf4, size 0x84, virtual false, abstract: false, final false
static inline void FinalizeSnapshot(::StringW  path, bool  result) ;

/// @brief Method PrepareMetadata, addr 0x2f5b97c, size 0x1fc, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> PrepareMetadata() ;

/// @brief Method SaveScreenshotToDisk, addr 0x2f5bd78, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method WriteIntToByteArray, addr 0x2f5bb78, size 0x8c, virtual false, abstract: false, final false
static inline int32_t WriteIntToByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  array, int32_t  offset, int32_t  value) ;

/// @brief Method WriteStringToByteArray, addr 0x2f5bc04, size 0x9c, virtual false, abstract: false, final false
