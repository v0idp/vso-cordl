...
/// @brief Method .ctor, addr 0x2f5b974, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Data, addr 0x2f5b96c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Data() ;

/// @brief Method get_Description, addr 0x2f5b95c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Description() ;

/// @brief Method set_Description, addr 0x2f5b964, size 0x8, virtual false, abstract: false, final false
