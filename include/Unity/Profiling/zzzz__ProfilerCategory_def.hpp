...
/// @brief Method ToString, addr 0x2f5b478, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f5b274, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint16_t  category) ;

/// @brief Method get_Name, addr 0x2f5b27c, size 0x80, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Scripts, addr 0x2f5b47c, size 0x8, virtual false, abstract: false, final false
static inline ::Unity::Profiling::ProfilerCategory get_Scripts() ;

/// @brief Method op_Implicit, addr 0x2f5b484, size 0x4, virtual false, abstract: false, final false
