...
/// @brief Method set_Height, addr 0x2f5b740, size 0x8, virtual false, abstract: false, final false
inline void set_Height(int32_t  value) ;

/// @brief Method set_ImageFormat, addr 0x2f5b730, size 0x8, virtual false, abstract: false, final false
inline void set_ImageFormat(::UnityEngine::TextureFormat  value) ;

/// @brief Method set_RawImageDataReference, addr 0x2f5b728, size 0x8, virtual false, abstract: false, final false
inline void set_RawImageDataReference(::Unity::Collections::NativeArray_1<uint8_t>  value) ;

/// @brief Method set_Width, addr 0x2f5b738, size 0x8, virtual false, abstract: false, final false
