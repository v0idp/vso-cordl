...
/// @brief Method Equals, addr 0x281cf74, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x281cff4, size 0xfc, virtual false, abstract: false, final false
inline bool Equals(::Newtonsoft::Json::Serialization::NamingStrategy*  other) ;

/// @brief Method GetDictionaryKey, addr 0x281ce78, size 0x1c, virtual true, abstract: false, final false
inline ::StringW GetDictionaryKey(::StringW  key) ;

/// @brief Method GetExtensionDataName, addr 0x281ce5c, size 0x1c, virtual true, abstract: false, final false
inline ::StringW GetExtensionDataName(::StringW  name) ;

/// @brief Method GetHashCode, addr 0x281ce94, size 0xe0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetPropertyName, addr 0x281ce3c, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x281cd98, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_OverrideSpecifiedNames, addr 0x281ce28, size 0x8, virtual false, abstract: false, final false
inline bool get_OverrideSpecifiedNames() ;

/// @brief Method get_ProcessDictionaryKeys, addr 0x281ce00, size 0x8, virtual false, abstract: false, final false
inline bool get_ProcessDictionaryKeys() ;

/// @brief Method get_ProcessExtensionDataNames, addr 0x281ce14, size 0x8, virtual false, abstract: false, final false
inline bool get_ProcessExtensionDataNames() ;

/// @brief Method set_OverrideSpecifiedNames, addr 0x281ce30, size 0xc, virtual false, abstract: false, final false
inline void set_OverrideSpecifiedNames(bool  value) ;

/// @brief Method set_ProcessDictionaryKeys, addr 0x281ce08, size 0xc, virtual false, abstract: false, final false
inline void set_ProcessDictionaryKeys(bool  value) ;

/// @brief Method set_ProcessExtensionDataNames, addr 0x281ce1c, size 0xc, virtual false, abstract: false, final false
