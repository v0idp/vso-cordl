...
/// @brief Method CreateTemporaryDictionary, addr 0x2805e70, size 0x274, virtual false, abstract: false, final false
inline ::System::Collections::IDictionary* CreateTemporaryDictionary() ;

/// @brief Method CreateWrapper, addr 0x2805be8, size 0x288, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2805238, size 0x9b0, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  underlyingType) ;

/// @brief Method get_DictionaryKeyResolver, addr 0x280509c, size 0x8, virtual false, abstract: false, final false
inline ::System::Func_2<::StringW,::StringW>* get_DictionaryKeyResolver() ;

/// @brief Method get_DictionaryKeyType, addr 0x28050ac, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_DictionaryKeyType() ;

/// @brief Method get_DictionaryValueType, addr 0x28050b4, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_DictionaryValueType() ;

/// @brief Method get_HasParameterizedCreator, addr 0x28051a4, size 0x8, virtual false, abstract: false, final false
inline bool get_HasParameterizedCreator() ;

/// @brief Method get_HasParameterizedCreatorInternal, addr 0x28051b8, size 0x80, virtual false, abstract: false, final false
inline bool get_HasParameterizedCreatorInternal() ;

/// @brief Method get_KeyContract, addr 0x28050bc, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::JsonContract* get_KeyContract() ;

/// @brief Method get_OverrideCreator, addr 0x2805194, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_OverrideCreator() ;

/// @brief Method get_ParameterizedCreator, addr 0x28050d4, size 0xc0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_ParameterizedCreator() ;

/// @brief Method get_ShouldCreateWrapper, addr 0x28050cc, size 0x8, virtual false, abstract: false, final false
inline bool get_ShouldCreateWrapper() ;

/// @brief Method set_DictionaryKeyResolver, addr 0x28050a4, size 0x8, virtual false, abstract: false, final false
inline void set_DictionaryKeyResolver(::System::Func_2<::StringW,::StringW>*  value) ;

/// @brief Method set_HasParameterizedCreator, addr 0x28051ac, size 0xc, virtual false, abstract: false, final false
inline void set_HasParameterizedCreator(bool  value) ;

/// @brief Method set_KeyContract, addr 0x28050c4, size 0x8, virtual false, abstract: false, final false
inline void set_KeyContract(::Newtonsoft::Json::Serialization::JsonContract*  value) ;

/// @brief Method set_OverrideCreator, addr 0x280519c, size 0x8, virtual false, abstract: false, final false
