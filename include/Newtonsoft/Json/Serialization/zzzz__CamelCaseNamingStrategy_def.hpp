...
/// @brief Method ResolvePropertyName, addr 0x27f972c, size 0x8, virtual true, abstract: false, final false
inline ::StringW ResolvePropertyName(::StringW  name) ;

/// @brief Method .ctor, addr 0x27eded0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x27f96a8, size 0x38, virtual false, abstract: false, final false
inline void _ctor(bool  processDictionaryKeys, bool  overrideSpecifiedNames) ;

/// @brief Method .ctor, addr 0x27f96e0, size 0x4c, virtual false, abstract: false, final false
