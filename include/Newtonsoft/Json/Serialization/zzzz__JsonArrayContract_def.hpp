...
/// @brief Method CreateTemporaryCollection, addr 0x2803aec, size 0x258, virtual false, abstract: false, final false
inline ::System::Collections::IList* CreateTemporaryCollection() ;

/// @brief Method CreateWrapper, addr 0x2803728, size 0x3c4, virtual false, abstract: false, final false
...
/// @brief Method StoreFSharpListCreatorIfNecessary, addr 0x280361c, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2802768, size 0xd00, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  underlyingType) ;

/// @brief Method get_CanDeserialize, addr 0x28025e8, size 0x8, virtual false, abstract: false, final false
inline bool get_CanDeserialize() ;

/// @brief Method get_CollectionItemType, addr 0x28025c8, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_CollectionItemType() ;

/// @brief Method get_HasParameterizedCreator, addr 0x28026d4, size 0x8, virtual false, abstract: false, final false
inline bool get_HasParameterizedCreator() ;

/// @brief Method get_HasParameterizedCreatorInternal, addr 0x28026e8, size 0x80, virtual false, abstract: false, final false
inline bool get_HasParameterizedCreatorInternal() ;

/// @brief Method get_IsArray, addr 0x28025d8, size 0x8, virtual false, abstract: false, final false
inline bool get_IsArray() ;

/// @brief Method get_IsMultidimensionalArray, addr 0x28025d0, size 0x8, virtual false, abstract: false, final false
inline bool get_IsMultidimensionalArray() ;

/// @brief Method get_OverrideCreator, addr 0x28026bc, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_OverrideCreator() ;

/// @brief Method get_ParameterizedCreator, addr 0x28025fc, size 0xc0, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_ParameterizedCreator() ;

/// @brief Method get_ShouldCreateWrapper, addr 0x28025e0, size 0x8, virtual false, abstract: false, final false
inline bool get_ShouldCreateWrapper() ;

/// @brief Method set_CanDeserialize, addr 0x28025f0, size 0xc, virtual false, abstract: false, final false
inline void set_CanDeserialize(bool  value) ;

/// @brief Method set_HasParameterizedCreator, addr 0x28026dc, size 0xc, virtual false, abstract: false, final false
inline void set_HasParameterizedCreator(bool  value) ;

/// @brief Method set_OverrideCreator, addr 0x28026c4, size 0x10, virtual false, abstract: false, final false
