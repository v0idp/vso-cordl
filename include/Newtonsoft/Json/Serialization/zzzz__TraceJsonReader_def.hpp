...
/// @brief Method Close, addr 0x281db84, size 0x24, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method GetDeserializedJsonMessage, addr 0x281d7d4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method Newtonsoft.Json.IJsonLineInfo.HasLineInfo, addr 0x281dba8, size 0xb4, virtual true, abstract: false, final true
inline bool Newtonsoft_Json_IJsonLineInfo_HasLineInfo() ;

/// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LineNumber, addr 0x281dc5c, size 0xb8, virtual true, abstract: false, final true
inline int32_t Newtonsoft_Json_IJsonLineInfo_get_LineNumber() ;

/// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LinePosition, addr 0x281dd14, size 0xb8, virtual true, abstract: false, final true
inline int32_t Newtonsoft_Json_IJsonLineInfo_get_LinePosition() ;

/// @brief Method Read, addr 0x281d7f4, size 0x40, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadAsBoolean, addr 0x281d9f8, size 0x44, virtual true, abstract: false, final false
inline ::System::Nullable_1<bool> ReadAsBoolean() ;

/// @brief Method ReadAsBytes, addr 0x281d8ec, size 0x44, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadAsBytes() ;

/// @brief Method ReadAsDateTime, addr 0x281da3c, size 0x4c, virtual true, abstract: false, final false
inline ::System::Nullable_1<::System::DateTime> ReadAsDateTime() ;

/// @brief Method ReadAsDateTimeOffset, addr 0x281da88, size 0x5c, virtual true, abstract: false, final false
inline ::System::Nullable_1<::System::DateTimeOffset> ReadAsDateTimeOffset() ;

/// @brief Method ReadAsDecimal, addr 0x281d930, size 0x7c, virtual true, abstract: false, final false
inline ::System::Nullable_1<::System::Decimal> ReadAsDecimal() ;

/// @brief Method ReadAsDouble, addr 0x281d9ac, size 0x4c, virtual true, abstract: false, final false
inline ::System::Nullable_1<double_t> ReadAsDouble() ;

/// @brief Method ReadAsInt32, addr 0x281d86c, size 0x40, virtual true, abstract: false, final false
inline ::System::Nullable_1<int32_t> ReadAsInt32() ;

/// @brief Method ReadAsString, addr 0x281d8ac, size 0x40, virtual true, abstract: false, final false
inline ::StringW ReadAsString() ;

/// @brief Method WriteCurrentToken, addr 0x281d834, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x281d694, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::JsonReader*  innerReader) ;

/// @brief Method get_Depth, addr 0x281dae4, size 0x20, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_Path, addr 0x281db04, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_Path() ;

/// @brief Method get_TokenType, addr 0x281db24, size 0x20, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::JsonToken get_TokenType() ;

/// @brief Method get_Value, addr 0x281db44, size 0x20, virtual true, abstract: false, final false
inline ::System::Object* get_Value() ;

/// @brief Method get_ValueType, addr 0x281db64, size 0x20, virtual true, abstract: false, final false
