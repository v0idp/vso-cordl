...
/// @brief Method BindToName, addr 0x2802434, size 0x68, virtual true, abstract: false, final false
inline void BindToName(::System::Type*  serializedType, ::ByRef<::StringW>  assemblyName, ::ByRef<::StringW>  typeName) ;

/// @brief Method BindToType, addr 0x28023b8, size 0x7c, virtual true, abstract: false, final false
inline ::System::Type* BindToType(::StringW  assemblyName, ::StringW  typeName) ;

/// @brief Method GetGenericTypeFromTypeName, addr 0x2802090, size 0x2c0, virtual false, abstract: false, final false
inline ::System::Type* GetGenericTypeFromTypeName(::StringW  typeName, ::System::Reflection::Assembly*  assembly) ;

/// @brief Method GetTypeByName, addr 0x2802350, size 0x68, virtual false, abstract: false, final false
inline ::System::Type* GetTypeByName(::Newtonsoft::Json::Utilities::StructMultiKey_2<::StringW,::StringW>  typeNameKey) ;

/// @brief Method GetTypeFromTypeNameKey, addr 0x2801c98, size 0x3f8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2801bc8, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;
