...
// Declarations
 ...
 __declspec(property(get=get_Handled)) bool  Handled;
...
/// @brief Method .ctor, addr 0x28024f4, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  originalObject, ::System::Object*  member, ::StringW  path, ::System::Exception*  error) ;

/// @brief Method get_Error, addr 0x2802548, size 0x8, virtual false, abstract: false, final false
inline ::System::Exception* get_Error() ;

/// @brief Method get_Handled, addr 0x2802550, size 0x8, virtual false, abstract: false, final false
inline bool get_Handled() ;

/// @brief Method get_Traced, addr 0x2802534, size 0x8, virtual false, abstract: false, final false
inline bool get_Traced() ;

/// @brief Method set_Traced, addr 0x280253c, size 0xc, virtual false, abstract: false, final false
