...
public:
// Declarations
 __declspec(property(put=set_Name)) ::Newtonsoft::Json::Bson::BsonString*  Name;

 __declspec(property(put=set_Value)) ::Newtonsoft::Json::Bson::BsonToken*  Value;
...
/// @brief Method .ctor, addr 0x284a7d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_Name, addr 0x284a9c8, size 0x8, virtual false, abstract: false, final false
inline void set_Name(::Newtonsoft::Json::Bson::BsonString*  value) ;

/// @brief Method set_Value, addr 0x284a9d0, size 0x8, virtual false, abstract: false, final false
