...
/// @brief Field _type, offset 0x20, size 0x1 
...
/// @brief Method .ctor, addr 0x284a8d0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  value, ::Newtonsoft::Json::Bson::BsonType  type) ;

/// @brief Method get_Type, addr 0x284a900, size 0x8, virtual true, abstract: false, final false
...
/// @brief Field _type, offset: 0x20, size: 0x1, def value: None
 ::Newtonsoft::Json::Bson::BsonType  ____type;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::Newtonsoft::Json::Bson::BsonValue, ____value) == 0x18, "Offset mismatch!");

static_assert(offsetof(::Newtonsoft::Json::Bson::BsonValue, ____type) == 0x20, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::Newtonsoft::Json::Bson::BsonValue, 0x28>, "Size mismatch!");
