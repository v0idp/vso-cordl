...
/// @brief Method .ctor, addr 0x284a918, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::StringW  pattern, ::StringW  options) ;

/// @brief Method get_Type, addr 0x284a9c0, size 0x8, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Bson::BsonType get_Type() ;

/// @brief Method set_Options, addr 0x284a910, size 0x8, virtual false, abstract: false, final false
inline void set_Options(::Newtonsoft::Json::Bson::BsonString*  value) ;

/// @brief Method set_Pattern, addr 0x284a908, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::Newtonsoft::Json::Bson::BsonRegex, 0x28>, "Size mismatch!");
