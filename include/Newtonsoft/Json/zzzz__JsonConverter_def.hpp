...
/// @brief Method .ctor, addr 0x27cce08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CanRead, addr 0x27ccdf8, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanWrite, addr 0x27cce00, size 0x8, virtual true, abstract: false, final false
