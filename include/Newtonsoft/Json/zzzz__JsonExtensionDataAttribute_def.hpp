...
public:
// Declarations
 __declspec(property(get=get_ReadData)) bool  ReadData;

 __declspec(property(get=get_WriteData)) bool  WriteData;
...
/// @brief Method get_ReadData, addr 0x27cd020, size 0x8, virtual false, abstract: false, final false
inline bool get_ReadData() ;

/// @brief Method get_WriteData, addr 0x27cd018, size 0x8, virtual false, abstract: false, final false
