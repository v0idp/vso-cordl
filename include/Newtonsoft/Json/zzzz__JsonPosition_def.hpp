...
/// @brief Method BuildPath, addr 0x27cd364, size 0x304, virtual false, abstract: false, final false
...
/// @brief Method CalculateLength, addr 0x27cd0c4, size 0x94, virtual false, abstract: false, final false
inline int32_t CalculateLength() ;

/// @brief Method FormatMessage, addr 0x27cd668, size 0x32c, virtual false, abstract: false, final false
static inline ::StringW FormatMessage(::Newtonsoft::Json::IJsonLineInfo*  lineInfo, ::StringW  path, ::StringW  message) ;

/// @brief Method TypeHasIndex, addr 0x27cd0b4, size 0x10, virtual false, abstract: false, final false
static inline bool TypeHasIndex(::Newtonsoft::Json::JsonContainerType  type) ;

/// @brief Method WriteTo, addr 0x27cd158, size 0x20c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27cd038, size 0x7c, virtual false, abstract: false, final false
