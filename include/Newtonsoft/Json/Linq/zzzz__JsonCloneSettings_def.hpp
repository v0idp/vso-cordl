...
/// @brief Method .ctor, addr 0x2828d88, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::Newtonsoft::Json::Linq::JsonCloneSettings* getStaticF_SkipCopyAnnotations() ;

/// @brief Method get_CopyAnnotations, addr 0x2828da8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_CopyAnnotations, addr 0x2828db0, size 0xc, virtual false, abstract: false, final false
