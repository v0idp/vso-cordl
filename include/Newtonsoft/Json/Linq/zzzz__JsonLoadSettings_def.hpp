...
public:
// Declarations
 __declspec(property(get=get_CommentHandling)) ::Newtonsoft::Json::Linq::CommentHandling  CommentHandling;

 __declspec(property(get=get_DuplicatePropertyNameHandling)) ::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling  DuplicatePropertyNameHandling;

 __declspec(property(get=get_LineInfoHandling)) ::Newtonsoft::Json::Linq::LineInfoHandling  LineInfoHandling;
...
/// @brief Method get_CommentHandling, addr 0x2828e1c, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::CommentHandling get_CommentHandling() ;

/// @brief Method get_DuplicatePropertyNameHandling, addr 0x2828e2c, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::DuplicatePropertyNameHandling get_DuplicatePropertyNameHandling() ;

/// @brief Method get_LineInfoHandling, addr 0x2828e24, size 0x8, virtual false, abstract: false, final false
