...
/// @brief Method GetEndToken, addr 0x2830d00, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method Newtonsoft.Json.IJsonLineInfo.HasLineInfo, addr 0x2830e70, size 0xb4, virtual true, abstract: false, final true
inline bool Newtonsoft_Json_IJsonLineInfo_HasLineInfo() ;

/// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LineNumber, addr 0x2830f24, size 0xb8, virtual true, abstract: false, final true
inline int32_t Newtonsoft_Json_IJsonLineInfo_get_LineNumber() ;

/// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LinePosition, addr 0x2830fdc, size 0xb8, virtual true, abstract: false, final true
inline int32_t Newtonsoft_Json_IJsonLineInfo_get_LinePosition() ;

/// @brief Method Read, addr 0x283047c, size 0xd0, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadInto, addr 0x283054c, size 0x68, virtual false, abstract: false, final false
inline bool ReadInto(::Newtonsoft::Json::Linq::JContainer*  c) ;

/// @brief Method ReadOver, addr 0x28305b4, size 0xb4, virtual false, abstract: false, final false
inline bool ReadOver(::Newtonsoft::Json::Linq::JToken*  t) ;

/// @brief Method ReadToEnd, addr 0x2830c5c, size 0x20, virtual false, abstract: false, final false
inline bool ReadToEnd() ;

/// @brief Method SafeToString, addr 0x2830e50, size 0x20, virtual false, abstract: false, final false
inline ::StringW SafeToString(::System::Object*  value) ;

/// @brief Method SetEnd, addr 0x2830c7c, size 0x84, virtual false, abstract: false, final false
inline bool SetEnd(::Newtonsoft::Json::Linq::JContainer*  c) ;

/// @brief Method SetToken, addr 0x2830668, size 0x5f4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x282ea28, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::Linq::JToken*  token) ;

/// @brief Method get_CurrentToken, addr 0x2830474, size 0x8, virtual false, abstract: false, final false
inline ::Newtonsoft::Json::Linq::JToken* get_CurrentToken() ;

/// @brief Method get_Path, addr 0x2831094, size 0xe4, virtual true, abstract: false, final false
