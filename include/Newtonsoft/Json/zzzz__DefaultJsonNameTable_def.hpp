...
/// @brief Method .ctor, addr 0x27cbd4c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Add, addr 0x27cba90, size 0x1b4, virtual false, abstract: false, final false
inline ::StringW Add(::StringW  key) ;

/// @brief Method AddEntry, addr 0x27cbc44, size 0x108, virtual false, abstract: false, final false
inline ::StringW AddEntry(::StringW  str, int32_t  hashCode) ;

/// @brief Method Get, addr 0x27cb840, size 0x194, virtual true, abstract: false, final false
inline ::StringW Get(::ArrayW<char16_t,::Array<char16_t>*>  key, int32_t  start, int32_t  length) ;

/// @brief Method Grow, addr 0x27cbd8c, size 0x12c, virtual false, abstract: false, final false
inline void Grow() ;

static inline ::Newtonsoft::Json::DefaultJsonNameTable* New_ctor() ;

/// @brief Method TextEquals, addr 0x27cb9d4, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27cb7d0, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;
