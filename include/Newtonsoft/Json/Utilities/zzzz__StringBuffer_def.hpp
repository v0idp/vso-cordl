...
/// @brief Method Append, addr 0x27f8688, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Append, addr 0x27f85b0, size 0x78, virtual false, abstract: false, final false
inline void Append(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, char16_t  value) ;

/// @brief Method Clear, addr 0x27f8708, size 0x2c, virtual false, abstract: false, final false
inline void Clear(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool) ;

/// @brief Method EnsureSize, addr 0x27f8628, size 0x60, virtual false, abstract: false, final false
inline void EnsureSize(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, int32_t  appendLength) ;

/// @brief Method ToString, addr 0x27f8734, size 0x18, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x27f874c, size 0x1c, virtual false, abstract: false, final false
inline ::StringW ToString(int32_t  start, int32_t  length) ;

/// @brief Method .ctor, addr 0x27f85a4, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<char16_t,::Array<char16_t>*>  buffer) ;

/// @brief Method .ctor, addr 0x27f8580, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, int32_t  initalSize) ;

/// @brief Method get_InternalBuffer, addr 0x27f8768, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<char16_t,::Array<char16_t>*> get_InternalBuffer() ;

/// @brief Method get_IsEmpty, addr 0x27f8570, size 0x10, virtual false, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_Position, addr 0x27f8560, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Position() ;

/// @brief Method set_Position, addr 0x27f8568, size 0x8, virtual false, abstract: false, final false
