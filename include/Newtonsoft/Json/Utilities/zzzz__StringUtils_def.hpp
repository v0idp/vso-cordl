...
/// @brief Method CreateStringWriter, addr 0x27f1b98, size 0xc8, virtual false, abstract: false, final false
static inline ::System::IO::StringWriter* CreateStringWriter(int32_t  capacity) ;

/// @brief Method EndsWith, addr 0x27f909c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method FormatWith, addr 0x27e3c38, size 0xa8, virtual false, abstract: false, final false
static inline ::StringW FormatWith(::StringW  format, ::System::IFormatProvider*  provider, ::System::Object*  arg0) ;

/// @brief Method FormatWith, addr 0x27e4e54, size 0xdc, virtual false, abstract: false, final false
static inline ::StringW FormatWith(::StringW  format, ::System::IFormatProvider*  provider, ::System::Object*  arg0, ::System::Object*  arg1) ;

/// @brief Method FormatWith, addr 0x27f87f4, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method FormatWith, addr 0x27f88fc, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method FormatWith, addr 0x27f8788, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method IndexOf, addr 0x27f2ccc, size 0x14, virtual false, abstract: false, final false
static inline int32_t IndexOf(::StringW  s, char16_t  c) ;

/// @brief Method IsHighSurrogate, addr 0x27f8fa8, size 0x58, virtual false, abstract: false, final false
static inline bool IsHighSurrogate(char16_t  c) ;

/// @brief Method IsLowSurrogate, addr 0x27f9000, size 0x58, virtual false, abstract: false, final false
static inline bool IsLowSurrogate(char16_t  c) ;

/// @brief Method IsNullOrEmpty, addr 0x27e98c8, size 0x8, virtual false, abstract: false, final false
static inline bool IsNullOrEmpty(::StringW  value) ;

/// @brief Method StartsWith, addr 0x27f9058, size 0x44, virtual false, abstract: false, final false
static inline bool StartsWith(::StringW  source, char16_t  value) ;

/// @brief Method ToCamelCase, addr 0x27f8a38, size 0x1e8, virtual false, abstract: false, final false
static inline ::StringW ToCamelCase(::StringW  s) ;

/// @brief Method ToCharAsUnicode, addr 0x27f18b8, size 0xbc, virtual false, abstract: false, final false
static inline void ToCharAsUnicode(char16_t  c, ::ArrayW<char16_t,::Array<char16_t>*>  buffer) ;

/// @brief Method ToKebabCase, addr 0x27f8fa0, size 0x8, virtual false, abstract: false, final false
static inline ::StringW ToKebabCase(::StringW  s) ;

/// @brief Method ToLower, addr 0x27f8c20, size 0x90, virtual false, abstract: false, final false
static inline char16_t ToLower(char16_t  c) ;

/// @brief Method ToSeparatedCase, addr 0x27f8cb8, size 0x2e8, virtual false, abstract: false, final false
static inline ::StringW ToSeparatedCase(::StringW  s, char16_t  separator) ;

/// @brief Method ToSnakeCase, addr 0x27f8cb0, size 0x8, virtual false, abstract: false, final false
static inline ::StringW ToSnakeCase(::StringW  s) ;

/// @brief Method Trim, addr 0x27f7168, size 0x1b4, virtual false, abstract: false, final false
