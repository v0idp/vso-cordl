...
/// @brief Method ToString, addr 0x27e98d0, size 0x14, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x27e9c84, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  startIndex, int32_t  length) ;

/// @brief Method get_Chars, addr 0x27f8770, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<char16_t,::Array<char16_t>*> get_Chars() ;

/// @brief Method get_Item, addr 0x27e95a8, size 0x30, virtual false, abstract: false, final false
inline char16_t get_Item(int32_t  i) ;

/// @brief Method get_Length, addr 0x27f8780, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Length() ;

/// @brief Method get_StartIndex, addr 0x27f8778, size 0x8, virtual false, abstract: false, final false
