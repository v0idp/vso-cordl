...
public:
// Declarations
/// @brief Method IsEndToken, addr 0x27f225c, size 0x10, virtual false, abstract: false, final false
static inline bool IsEndToken(::Newtonsoft::Json::JsonToken  token) ;

/// @brief Method IsPrimitiveToken, addr 0x27f227c, size 0x24, virtual false, abstract: false, final false
static inline bool IsPrimitiveToken(::Newtonsoft::Json::JsonToken  token) ;

/// @brief Method IsStartToken, addr 0x27f226c, size 0x10, virtual false, abstract: false, final false
