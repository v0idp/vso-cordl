...
public:
// Declarations
/// @brief Method ByteArrayCompare, addr 0x27f2b40, size 0xb0, virtual false, abstract: false, final false
static inline int32_t ByteArrayCompare(::ArrayW<uint8_t,::Array<uint8_t>*>  a1, ::ArrayW<uint8_t,::Array<uint8_t>*>  a2) ;

/// @brief Method CreateArgumentOutOfRangeException, addr 0x27e8318, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method GetLocalName, addr 0x27f2ca8, size 0x24, virtual false, abstract: false, final false
static inline ::StringW GetLocalName(::StringW  qualifiedName) ;

/// @brief Method GetPrefix, addr 0x27f2bf0, size 0x24, virtual false, abstract: false, final false
static inline ::StringW GetPrefix(::StringW  qualifiedName) ;

/// @brief Method GetQualifiedNameParts, addr 0x27f2c14, size 0x94, virtual false, abstract: false, final false
static inline void GetQualifiedNameParts(::StringW  qualifiedName, ::ByRef<::StringW>  prefix, ::ByRef<::StringW>  localName) ;

/// @brief Method GetRegexOptions, addr 0x27f2ce0, size 0xa8, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexOptions GetRegexOptions(::StringW  optionsText) ;

/// @brief Method ToString, addr 0x27f2a90, size 0xb0, virtual false, abstract: false, final false
static inline ::StringW ToString(::System::Object*  value) ;

/// @brief Method ValueEquals, addr 0x27f2780, size 0x310, virtual false, abstract: false, final false
