...
public:
// Declarations
/// @brief Method EndsWith, addr 0x27e9698, size 0xc4, virtual false, abstract: false, final false
static inline bool EndsWith(::Newtonsoft::Json::Utilities::StringReference  s, ::StringW  text) ;

/// @brief Method IndexOf, addr 0x27ea4f0, size 0x84, virtual false, abstract: false, final false
static inline int32_t IndexOf(::Newtonsoft::Json::Utilities::StringReference  s, char16_t  c, int32_t  startIndex, int32_t  length) ;

/// @brief Method StartsWith, addr 0x27e95d8, size 0xc0, virtual false, abstract: false, final false
