...
public:
// Declarations
/// @brief Method EnsureBufferSize, addr 0x27f0370, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method RentBuffer, addr 0x27f01f8, size 0xc8, virtual false, abstract: false, final false
static inline ::ArrayW<char16_t,::Array<char16_t>*> RentBuffer(::Newtonsoft::Json::IArrayPool_1<char16_t>*  bufferPool, int32_t  minSize) ;

/// @brief Method ReturnBuffer, addr 0x27f02c0, size 0xb0, virtual false, abstract: false, final false
