...
/// @brief Method VisitConditional, addr 0x27ec6d0, size 0xec, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* VisitConditional(::System::Linq::Expressions::ConditionalExpression*  node) ;

/// @brief Method .ctor, addr 0x27ec548, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
