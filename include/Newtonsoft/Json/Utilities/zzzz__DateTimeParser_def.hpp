...
/// @brief Method Parse, addr 0x27e7754, size 0xf0, virtual false, abstract: false, final false
inline bool Parse(::ArrayW<char16_t,::Array<char16_t>*>  text, int32_t  startIndex, int32_t  length) ;

/// @brief Method Parse2Digit, addr 0x27e7bc4, size 0x9c, virtual false, abstract: false, final false
inline bool Parse2Digit(int32_t  start, ::ByRef<int32_t>  num) ;

/// @brief Method Parse4Digit, addr 0x27e7ad4, size 0xf0, virtual false, abstract: false, final false
inline bool Parse4Digit(int32_t  start, ::ByRef<int32_t>  num) ;

/// @brief Method ParseChar, addr 0x27e79ec, size 0x4c, virtual false, abstract: false, final false
inline bool ParseChar(int32_t  start, char16_t  ch) ;

/// @brief Method ParseDate, addr 0x27e7844, size 0x1a8, virtual false, abstract: false, final false
inline bool ParseDate(int32_t  start) ;

/// @brief Method ParseTime, addr 0x27e7c60, size 0x2dc, virtual false, abstract: false, final false
inline bool ParseTime(::ByRef<int32_t>  start) ;

/// @brief Method ParseTimeAndZoneAndWhitespace, addr 0x27e7a38, size 0x9c, virtual false, abstract: false, final false
inline bool ParseTimeAndZoneAndWhitespace(int32_t  start) ;

/// @brief Method ParseZone, addr 0x27e7f3c, size 0x208, virtual false, abstract: false, final false
