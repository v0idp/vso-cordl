...
/// @brief Method .ctor, addr 0x2841050, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XText*  text) ;

/// @brief Method get_ParentNode, addr 0x2841094, size 0x44, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode() ;

/// @brief Method get_Text, addr 0x2840fd8, size 0x78, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XText* get_Text() ;

/// @brief Method get_Value, addr 0x2841078, size 0x1c, virtual true, abstract: false, final false
