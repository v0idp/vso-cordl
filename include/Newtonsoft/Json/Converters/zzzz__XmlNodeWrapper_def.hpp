...
/// @brief Method AppendChild, addr 0x283fcd8, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method WrapNode, addr 0x283f5c8, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x283e6c4, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNode*  node) ;

/// @brief Method get_Attributes, addr 0x283f73c, size 0x428, virtual true, abstract: false, final true
inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_Attributes() ;

/// @brief Method get_ChildNodes, addr 0x283f198, size 0x430, virtual true, abstract: false, final true
inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes() ;

/// @brief Method get_HasAttributes, addr 0x283fb64, size 0xb4, virtual false, abstract: false, final false
inline bool get_HasAttributes() ;

/// @brief Method get_LocalName, addr 0x283f174, size 0x24, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NamespaceUri, addr 0x283fd7c, size 0x24, virtual true, abstract: false, final true
inline ::StringW get_NamespaceUri() ;

/// @brief Method get_NodeType, addr 0x283f154, size 0x20, virtual true, abstract: false, final true
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_ParentNode, addr 0x283fc18, size 0xa0, virtual true, abstract: false, final true
inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode() ;

/// @brief Method get_Value, addr 0x283fcb8, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_Value() ;

/// @brief Method get_WrappedNode, addr 0x283f14c, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_WrappedNode() ;

/// @brief Convert to "::Newtonsoft::Json::Converters::IXmlNode"
constexpr ::Newtonsoft::Json::Converters::IXmlNode* i___Newtonsoft__Json__Converters__IXmlNode() noexcept;

/// @brief Method set_Value, addr 0x283edb8, size 0x20, virtual true, abstract: false, final true
