...
/// @brief Method AppendChild, addr 0x28423e4, size 0x28, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Converters::IXmlNode* AppendChild(::Newtonsoft::Json::Converters::IXmlNode*  newChild) ;

/// @brief Method GetPrefixOfNamespace, addr 0x28423a4, size 0x40, virtual true, abstract: false, final true
inline ::StringW GetPrefixOfNamespace(::StringW  namespaceUri) ;

/// @brief Method HasImplicitNamespaceAttribute, addr 0x2841ef8, size 0x4ac, virtual false, abstract: false, final false
...
/// @brief Method SetAttributeNode, addr 0x284190c, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2840b58, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XElement*  element) ;

/// @brief Method get_Attributes, addr 0x28419b0, size 0x548, virtual true, abstract: false, final false
inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_Attributes() ;

/// @brief Method get_Element, addr 0x2841894, size 0x78, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XElement* get_Element() ;

/// @brief Method get_IsEmpty, addr 0x2842470, size 0x1c, virtual true, abstract: false, final true
inline bool get_IsEmpty() ;

/// @brief Method get_LocalName, addr 0x2842428, size 0x24, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NamespaceUri, addr 0x284244c, size 0x24, virtual true, abstract: false, final false
inline ::StringW get_NamespaceUri() ;

/// @brief Method get_Value, addr 0x284240c, size 0x1c, virtual true, abstract: false, final false
