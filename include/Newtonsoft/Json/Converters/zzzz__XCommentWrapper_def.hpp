...
/// @brief Method .ctor, addr 0x2841458, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XComment*  text) ;

/// @brief Method get_ParentNode, addr 0x284149c, size 0x44, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode() ;

/// @brief Method get_Text, addr 0x28413e0, size 0x78, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XComment* get_Text() ;

/// @brief Method get_Value, addr 0x2841480, size 0x1c, virtual true, abstract: false, final false
