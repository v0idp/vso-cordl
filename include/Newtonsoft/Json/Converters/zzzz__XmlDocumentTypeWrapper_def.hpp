...
/// @brief Method .ctor, addr 0x283eb0c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlDocumentType*  documentType) ;

/// @brief Method get_InternalSubset, addr 0x283f0f0, size 0x1c, virtual true, abstract: false, final true
inline ::StringW get_InternalSubset() ;

/// @brief Method get_LocalName, addr 0x283f10c, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x283f098, size 0x20, virtual true, abstract: false, final true
inline ::StringW get_Name() ;

/// @brief Method get_Public, addr 0x283f0d4, size 0x1c, virtual true, abstract: false, final true
inline ::StringW get_Public() ;

/// @brief Method get_System, addr 0x283f0b8, size 0x1c, virtual true, abstract: false, final true
