...
/// @brief Method .ctor, addr 0x2840ce0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XAttribute*  attribute) ;

/// @brief Method get_Attribute, addr 0x2841774, size 0x78, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XAttribute* get_Attribute() ;

/// @brief Method get_LocalName, addr 0x2841808, size 0x24, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NamespaceUri, addr 0x284182c, size 0x24, virtual true, abstract: false, final false
inline ::StringW get_NamespaceUri() ;

/// @brief Method get_ParentNode, addr 0x2841850, size 0x44, virtual true, abstract: false, final false
inline ::Newtonsoft::Json::Converters::IXmlNode* get_ParentNode() ;

/// @brief Method get_Value, addr 0x28417ec, size 0x1c, virtual true, abstract: false, final false
