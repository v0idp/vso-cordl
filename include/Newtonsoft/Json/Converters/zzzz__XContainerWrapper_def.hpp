...
/// @brief Method AppendChild, addr 0x2840f08, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method WrapNode, addr 0x28410d8, size 0x308, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x283ffcc, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XContainer*  container) ;

/// @brief Method get_ChildNodes, addr 0x2840164, size 0x404, virtual true, abstract: false, final false
inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Converters::IXmlNode*>* get_ChildNodes() ;

/// @brief Method get_Container, addr 0x2841590, size 0x78, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XContainer* get_Container() ;

/// @brief Method get_HasChildNodes, addr 0x28405a4, size 0x28, virtual true, abstract: false, final false
inline bool get_HasChildNodes() ;

/// @brief Method get_ParentNode, addr 0x2841608, size 0x44, virtual true, abstract: false, final false
