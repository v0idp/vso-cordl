...
public:
// Declarations
/// @brief Method CanConvert, addr 0x283850c, size 0x174, virtual true, abstract: false, final false
inline bool CanConvert(::System::Type*  objectType) ;

static inline ::Newtonsoft::Json::Converters::DateTimeConverterBase* New_ctor() ;

/// @brief Method .ctor, addr 0x2838680, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
