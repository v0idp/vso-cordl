...
/// @brief Method .ctor, addr 0x2840a8c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XProcessingInstruction*  processingInstruction) ;

/// @brief Method get_LocalName, addr 0x2841558, size 0x1c, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_ProcessingInstruction, addr 0x28414e0, size 0x78, virtual false, abstract: false, final false
inline ::System::Xml::Linq::XProcessingInstruction* get_ProcessingInstruction() ;

/// @brief Method get_Value, addr 0x2841574, size 0x1c, virtual true, abstract: false, final false
