...
/// @brief Method .ctor, addr 0x283fe54, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XDocumentType*  documentType) ;

/// @brief Method get_InternalSubset, addr 0x283fed0, size 0x1c, virtual true, abstract: false, final true
inline ::StringW get_InternalSubset() ;

/// @brief Method get_LocalName, addr 0x283feec, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x283fe7c, size 0x1c, virtual true, abstract: false, final true
inline ::StringW get_Name() ;

/// @brief Method get_Public, addr 0x283feb4, size 0x1c, virtual true, abstract: false, final true
inline ::StringW get_Public() ;

/// @brief Method get_System, addr 0x283fe98, size 0x1c, virtual true, abstract: false, final true
