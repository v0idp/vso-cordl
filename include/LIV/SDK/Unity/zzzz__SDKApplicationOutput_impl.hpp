...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::LIV::SDK::Unity::SDKApplicationOutput (*)()>(&::LIV::SDK::Unity::SDKApplicationOutput::get_empty)> {
  ...
  constexpr static std::size_t addrs = 0x180adf0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::LIV::SDK::Unity::SDKApplicationOutput::*)()>(&::LIV::SDK::Unity::SDKApplicationOutput::ToString)> {
  ...
  constexpr static std::size_t addrs = 0x180ae70;
...
// Ctor Parameters [CppParam { name: "supportedFeatures", ty: "::LIV::SDK::Unity::FEATURES", modifiers: "", def_value: Some("{}") }, CppParam { name: "engineName", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "engineVersion", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "applicationName", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "applicationVersion", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "xrDeviceName", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "graphicsAPI", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "sdkID", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "sdkVersion", ty: "::StringW", modifiers: "", def_value: Some("{}") }]
