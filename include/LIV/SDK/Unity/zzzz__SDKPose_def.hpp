...
public:
// Declarations
/// @brief Method ToString, addr 0x180c650, size 0x278, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x180b1d0, size 0xb8, virtual false, abstract: false, final false
