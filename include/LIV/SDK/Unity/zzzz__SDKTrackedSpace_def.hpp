...
public:
// Declarations
/// @brief Method ToString, addr 0x180b8a8, size 0x244, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x180b6e0, size 0x104, virtual false, abstract: false, final false
