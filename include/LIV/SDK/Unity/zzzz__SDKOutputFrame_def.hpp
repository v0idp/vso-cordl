...
public:
// Declarations
/// @brief Method ToString, addr 0x180b7e4, size 0xc4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x180b69c, size 0x44, virtual false, abstract: false, final false
