...
public:
// Declarations
/// @brief Method ToString, addr 0x180ab84, size 0x26c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x180ab78, size 0xc, virtual false, abstract: false, final false
