...
public:
// Declarations
/// @brief Method ToString, addr 0x180bf8c, size 0x1dc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x180b288, size 0x44, virtual false, abstract: false, final false
