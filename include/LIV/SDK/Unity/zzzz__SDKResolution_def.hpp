...
public:
// Declarations
/// @brief Method ToString, addr 0x1809bf4, size 0xa0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_zero, addr 0x1806700, size 0x8, virtual false, abstract: false, final false
