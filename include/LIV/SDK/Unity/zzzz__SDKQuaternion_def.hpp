...
public:
// Declarations
/// @brief Method Euler, addr 0x1809e04, size 0xb4, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKQuaternion Euler(float_t  pitch, float_t  yaw, float_t  roll) ;

/// @brief Method ToString, addr 0x1809fd0, size 0x1ac, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_identity, addr 0x1809dec, size 0x14, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKQuaternion get_identity() ;

/// @brief Method op_Implicit, addr 0x180953c, size 0x4, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKQuaternion op_Implicit___LIV__SDK__Unity__SDKQuaternion(::UnityEngine::Quaternion  v) ;

/// @brief Method op_Implicit, addr 0x1809e00, size 0x4, virtual false, abstract: false, final false
static inline ::UnityEngine::Quaternion op_Implicit___UnityEngine__Quaternion(::LIV::SDK::Unity::SDKQuaternion  v) ;

/// @brief Method op_Multiply, addr 0x1809eb8, size 0x74, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKQuaternion op_Multiply(::LIV::SDK::Unity::SDKQuaternion  lhs, ::LIV::SDK::Unity::SDKQuaternion  rhs) ;

/// @brief Method op_Multiply, addr 0x1809f2c, size 0xa4, virtual false, abstract: false, final false
