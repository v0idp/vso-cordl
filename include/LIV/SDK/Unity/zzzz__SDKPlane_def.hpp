...
public:
// Declarations
/// @brief Method ToString, addr 0x180aab4, size 0xc4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x180aa84, size 0x30, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKPlane get_empty() ;

/// @brief Method op_Implicit, addr 0x180aa48, size 0x3c, virtual false, abstract: false, final false
