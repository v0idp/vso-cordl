...
public:
// Declarations
/// @brief Method ToString, addr 0x1809d28, size 0xc4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_forward, addr 0x1809cb4, size 0x10, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKVector3 get_forward() ;

/// @brief Method get_one, addr 0x1809ca4, size 0x10, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKVector3 get_one() ;

/// @brief Method get_right, addr 0x1809cd4, size 0x10, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKVector3 get_right() ;

/// @brief Method get_up, addr 0x1809cc4, size 0x10, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKVector3 get_up() ;

/// @brief Method get_zero, addr 0x1809c94, size 0x10, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKVector3 get_zero() ;

/// @brief Method op_Addition, addr 0x1809ce8, size 0x10, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKVector3 op_Addition(::LIV::SDK::Unity::SDKVector3  lhs, ::LIV::SDK::Unity::SDKVector3  rhs) ;

/// @brief Method op_Implicit, addr 0x1809538, size 0x4, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKVector3 op_Implicit___LIV__SDK__Unity__SDKVector3(::UnityEngine::Vector3  v) ;

/// @brief Method op_Implicit, addr 0x1809ce4, size 0x4, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 op_Implicit___UnityEngine__Vector3(::LIV::SDK::Unity::SDKVector3  v) ;

/// @brief Method op_Multiply, addr 0x1809d08, size 0x10, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKVector3 op_Multiply(::LIV::SDK::Unity::SDKVector3  lhs, ::LIV::SDK::Unity::SDKVector3  rhs) ;

/// @brief Method op_Multiply, addr 0x1809d18, size 0x10, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKVector3 op_Multiply(::LIV::SDK::Unity::SDKVector3  lhs, float_t  rhs) ;

/// @brief Method op_Subtraction, addr 0x1809cf8, size 0x10, virtual false, abstract: false, final false
