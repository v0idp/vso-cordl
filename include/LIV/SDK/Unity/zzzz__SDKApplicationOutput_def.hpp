...
public:
// Declarations
/// @brief Method ToString, addr 0x180ae70, size 0x244, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x180adf0, size 0x80, virtual false, abstract: false, final false
