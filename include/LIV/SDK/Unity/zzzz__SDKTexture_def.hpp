...
public:
// Declarations
/// @brief Method ToString, addr 0x180bb00, size 0x3a4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x180baec, size 0x14, virtual false, abstract: false, final false
