...
/// @brief Method MoveNext, addr 0x1805814, size 0xf0, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::LIV::SDK::Unity::LIV__WaitForUnityEndOfFrame_d__68* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x18059d0, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x18059d8, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1805a10, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x1805810, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x1805000, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method CreateAssets, addr 0x1805308, size 0x68, virtual false, abstract: false, final false
inline void CreateAssets() ;

/// @brief Method DestroyAssets, addr 0x18053d8, size 0x20, virtual false, abstract: false, final false
inline void DestroyAssets() ;

/// @brief Method Invalidate, addr 0x1804e90, size 0x108, virtual false, abstract: false, final false
inline void Invalidate() ;

static inline ::LIV::SDK::Unity::LIV* New_ctor() ;

/// @brief Method OnDisable, addr 0x1804f98, size 0x8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x1804e28, size 0xc, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnSDKActivate, addr 0x1805034, size 0xac, virtual false, abstract: false, final false
inline void OnSDKActivate() ;

/// @brief Method OnSDKDeactivate, addr 0x18050e0, size 0xb4, virtual false, abstract: false, final false
inline void OnSDKDeactivate() ;

/// @brief Method OnSDKReadyChanged, addr 0x1805028, size 0xc, virtual false, abstract: false, final false
inline void OnSDKReadyChanged(bool  value) ;

/// @brief Method StartRenderCoroutine, addr 0x1805370, size 0x44, virtual false, abstract: false, final false
inline void StartRenderCoroutine() ;

/// @brief Method StopRenderCoroutine, addr 0x18053b4, size 0x24, virtual false, abstract: false, final false
inline void StopRenderCoroutine() ;

/// @brief Method SubmitSDKOutput, addr 0x1805194, size 0x174, virtual false, abstract: false, final false
inline void SubmitSDKOutput() ;

/// @brief Method Update, addr 0x1804e78, size 0x18, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateSDKReady, addr 0x1804e34, size 0x44, virtual false, abstract: false, final false
inline void UpdateSDKReady() ;

/// @brief Method WaitForUnityEndOfFrame, addr 0x1804fa0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x18056e8, size 0x128, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HMDCamera, addr 0x1804994, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_HMDCamera() ;

/// @brief Method get_MRCameraPrefab, addr 0x1804a94, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_MRCameraPrefab() ;

/// @brief Method get__isReady, addr 0x1804d14, size 0x74, virtual false, abstract: false, final false
inline bool get__isReady() ;

/// @brief Method get_disableStandardAssets, addr 0x1804b2c, size 0x8, virtual false, abstract: false, final false
inline bool get_disableStandardAssets() ;

/// @brief Method get_excludeBehaviours, addr 0x1804b50, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_excludeBehaviours() ;

/// @brief Method get_fixPostEffectsAlpha, addr 0x1804b90, size 0x8, virtual false, abstract: false, final false
inline bool get_fixPostEffectsAlpha() ;

/// @brief Method get_isActive, addr 0x1804d0c, size 0x8, virtual false, abstract: false, final false
inline bool get_isActive() ;

/// @brief Method get_isValid, addr 0x1804ba4, size 0x168, virtual false, abstract: false, final false
inline bool get_isValid() ;

/// @brief Method get_render, addr 0x1804e20, size 0x8, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKRender* get_render() ;

/// @brief Method get_spectatorLayerMask, addr 0x1804b40, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_spectatorLayerMask() ;

/// @brief Method get_stage, addr 0x1804614, size 0x90, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stage() ;

/// @brief Method get_stageLocalToWorldMatrix, addr 0x18047a4, size 0xf0, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_stageLocalToWorldMatrix() ;

/// @brief Method get_stageTransform, addr 0x1804984, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stageTransform() ;

/// @brief Method get_stageWorldToLocalMatrix, addr 0x1804894, size 0xf0, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_stageWorldToLocalMatrix() ;

/// @brief Method get_trackedSpaceOrigin, addr 0x180479c, size 0x4, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_trackedSpaceOrigin() ;

/// @brief Method set_HMDCamera, addr 0x180499c, size 0xf8, virtual false, abstract: false, final false
inline void set_HMDCamera(::UnityEngine::Camera*  value) ;

/// @brief Method set_MRCameraPrefab, addr 0x1804a9c, size 0x90, virtual false, abstract: false, final false
inline void set_MRCameraPrefab(::UnityEngine::Camera*  value) ;

/// @brief Method set_disableStandardAssets, addr 0x1804b34, size 0xc, virtual false, abstract: false, final false
inline void set_disableStandardAssets(bool  value) ;

/// @brief Method set_excludeBehaviours, addr 0x1804b58, size 0x38, virtual false, abstract: false, final false
inline void set_excludeBehaviours(::ArrayW<::StringW,::Array<::StringW>*>  value) ;

/// @brief Method set_fixPostEffectsAlpha, addr 0x1804b98, size 0xc, virtual false, abstract: false, final false
inline void set_fixPostEffectsAlpha(bool  value) ;

/// @brief Method set_spectatorLayerMask, addr 0x1804b48, size 0x8, virtual false, abstract: false, final false
inline void set_spectatorLayerMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_stage, addr 0x18046a4, size 0xf8, virtual false, abstract: false, final false
inline void set_stage(::UnityEngine::Transform*  value) ;

/// @brief Method set_stageTransform, addr 0x180498c, size 0x8, virtual false, abstract: false, final false
inline void set_stageTransform(::UnityEngine::Transform*  value) ;

/// @brief Method set_trackedSpaceOrigin, addr 0x18047a0, size 0x4, virtual false, abstract: false, final false
