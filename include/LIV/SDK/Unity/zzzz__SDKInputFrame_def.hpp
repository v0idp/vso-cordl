...
public:
// Declarations
/// @brief Method ObtainControl, addr 0x180b354, size 0x14, virtual false, abstract: false, final false
inline void ObtainControl() ;

/// @brief Method ReleaseControl, addr 0x180b344, size 0x10, virtual false, abstract: false, final false
inline void ReleaseControl() ;

/// @brief Method ToString, addr 0x180b368, size 0x334, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x180b0b4, size 0x11c, virtual false, abstract: false, final false
