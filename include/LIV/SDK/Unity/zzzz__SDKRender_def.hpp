...
public:
// Declarations
 __declspec(property(get=get_BackgroundRenderTexture)) ::UnityW<::UnityEngine::RenderTexture>  BackgroundRenderTexture;
...
/// @brief Field _applyTextureEvent, offset 0x44, size 0x4 
 __declspec(property(get=__cordl_internal_get__applyTextureEvent, put=__cordl_internal_set__applyTextureEvent)) ::UnityEngine::Rendering::CameraEvent  _applyTextureEvent;

/// @brief Field _backgroundRenderTexture, offset 0x98, size 0x8 
...
/// @brief Field _cameraInstance, offset 0x2d0, size 0x8 
...
/// @brief Field _captureTextureEvent, offset 0x40, size 0x4 
 __declspec(property(get=__cordl_internal_get__captureTextureEvent, put=__cordl_internal_set__captureTextureEvent)) ::UnityEngine::Rendering::CameraEvent  _captureTextureEvent;
...
/// @brief Field _clipPlaneCombineAlphaCameraEvent, offset 0x3c, size 0x4 
 __declspec(property(get=__cordl_internal_get__clipPlaneCombineAlphaCameraEvent, put=__cordl_internal_set__clipPlaneCombineAlphaCameraEvent)) ::UnityEngine::Rendering::CameraEvent  _clipPlaneCombineAlphaCameraEvent;
...
/// @brief Field _clipPlaneComplexDebugMaterial, offset 0x70, size 0x8 
...
/// @brief Field _clipPlaneComplexMaterial, offset 0x68, size 0x8 
...
/// @brief Field _clipPlaneMesh, offset 0x50, size 0x8 
...
/// @brief Field _clipPlaneSimpleDebugMaterial, offset 0x60, size 0x8 
...
/// @brief Field _clipPlaneSimpleMaterial, offset 0x58, size 0x8 
...
/// @brief Field _combineAlphaMaterial, offset 0x80, size 0x8 
...
/// @brief Field _complexClipPlaneRenderTexture, offset 0xb0, size 0x8 
...
/// @brief Field _forceForwardRenderingMaterial, offset 0x90, size 0x8 
...
/// @brief Field _foregroundRenderTexture, offset 0xa0, size 0x8 
...
/// @brief Field _inputFrame, offset 0x170, size 0x158 
...
/// @brief Field _optimizedRenderingCameraEvent, offset 0x48, size 0x4 
...
/// @brief Field _outputFrame, offset 0xc0, size 0xac 
...
/// @brief Field _requestedPose, offset 0x2d8, size 0x70 
...
/// @brief Field _requestedPoseFrameIndex, offset 0x348, size 0x4 
...
/// @brief Field _resolution, offset 0x2c8, size 0x8 
...
/// @brief Field _writeMaterial, offset 0x88, size 0x8 
...
/// @brief Field _writeOpaqueToAlphaMaterial, offset 0x78, size 0x8 
...
/// @brief Method CreateAssets, addr 0x1806aec, size 0x6d8, virtual false, abstract: false, final false
inline void CreateAssets() ;

/// @brief Method CreateBackgroundTexture, addr 0x18098cc, size 0x98, virtual false, abstract: false, final false
inline void CreateBackgroundTexture() ;

/// @brief Method CreateComplexClipPlaneTexture, addr 0x1809a94, size 0x98, virtual false, abstract: false, final false
inline void CreateComplexClipPlaneTexture() ;

/// @brief Method CreateForegroundTexture, addr 0x1809964, size 0x98, virtual false, abstract: false, final false
inline void CreateForegroundTexture() ;

/// @brief Method CreateOptimizedTexture, addr 0x18099fc, size 0x98, virtual false, abstract: false, final false
inline void CreateOptimizedTexture() ;

/// @brief Method DestroyAssets, addr 0x1808ed4, size 0x184, virtual false, abstract: false, final false
inline void DestroyAssets() ;

/// @brief Method Dispose, addr 0x18054d0, size 0x48, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetClipPlaneMaterial, addr 0x1806710, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method GetGroundClipPlaneMaterial, addr 0x1806814, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method InvokePostRenderBackground, addr 0x1808c30, size 0x38, virtual false, abstract: false, final false
inline void InvokePostRenderBackground() ;

/// @brief Method InvokePostRenderForeground, addr 0x1808dcc, size 0x38, virtual false, abstract: false, final false
inline void InvokePostRenderForeground() ;

/// @brief Method InvokePreRender, addr 0x1807614, size 0x38, virtual false, abstract: false, final false
inline void InvokePreRender() ;

/// @brief Method InvokePreRenderBackground, addr 0x1808afc, size 0x38, virtual false, abstract: false, final false
inline void InvokePreRenderBackground() ;

/// @brief Method InvokePreRenderForeground, addr 0x1808d94, size 0x38, virtual false, abstract: false, final false
inline void InvokePreRenderForeground() ;

/// @brief Method IvokePostRender, addr 0x1808960, size 0x38, virtual false, abstract: false, final false
inline void IvokePostRender() ;

static inline ::LIV::SDK::Unity::SDKRender* New_ctor(::LIV::SDK::Unity::LIV*  liv) ;

/// @brief Method ReleaseBridgePoseControl, addr 0x1809058, size 0x64, virtual false, abstract: false, final false
inline void ReleaseBridgePoseControl() ;

/// @brief Method Render, addr 0x1805904, size 0xcc, virtual false, abstract: false, final false
inline void Render() ;

/// @brief Method RenderBackground, addr 0x180764c, size 0x320, virtual false, abstract: false, final false
inline void RenderBackground() ;

/// @brief Method RenderForeground, addr 0x180796c, size 0xa7c, virtual false, abstract: false, final false
inline void RenderForeground() ;

/// @brief Method RenderOptimized, addr 0x18083e8, size 0x578, virtual false, abstract: false, final false
inline void RenderOptimized() ;

/// @brief Method SendTextureToBridge, addr 0x1808b34, size 0xfc, virtual false, abstract: false, final false
inline void SendTextureToBridge(::UnityEngine::RenderTexture*  texture, ::LIV::SDK::Unity::TEXTURE_ID  id) ;

/// @brief Method SetGroundPlane, addr 0x1809584, size 0x18c, virtual false, abstract: false, final false
inline void SetGroundPlane(float_t  distance, ::UnityEngine::Vector3  normal, bool  useLocalSpace) ;

/// @brief Method SetGroundPlane, addr 0x1809710, size 0x1c, virtual false, abstract: false, final false
inline void SetGroundPlane(::UnityEngine::Plane  plane, bool  useLocalSpace) ;

/// @brief Method SetGroundPlane, addr 0x180972c, size 0x1a0, virtual false, abstract: false, final false
inline void SetGroundPlane(::UnityEngine::Transform*  transform, bool  useLocalSpace) ;

/// @brief Method SetPose, addr 0x1809254, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method UpdateBridgeInputFrame, addr 0x1807218, size 0x13c, virtual false, abstract: false, final false
inline void UpdateBridgeInputFrame() ;

/// @brief Method UpdateBridgeResolution, addr 0x18071c4, size 0x54, virtual false, abstract: false, final false
inline void UpdateBridgeResolution() ;

/// @brief Method UpdateTextures, addr 0x1807354, size 0x2c0, virtual false, abstract: false, final false
...
constexpr ::UnityEngine::Rendering::CameraEvent const& __cordl_internal_get__applyTextureEvent() const;

constexpr ::UnityEngine::Rendering::CameraEvent& __cordl_internal_get__applyTextureEvent() ;
...
constexpr ::UnityEngine::Rendering::CameraEvent const& __cordl_internal_get__captureTextureEvent() const;

constexpr ::UnityEngine::Rendering::CameraEvent& __cordl_internal_get__captureTextureEvent() ;
...
constexpr ::UnityEngine::Rendering::CameraEvent const& __cordl_internal_get__clipPlaneCombineAlphaCameraEvent() const;

constexpr ::UnityEngine::Rendering::CameraEvent& __cordl_internal_get__clipPlaneCombineAlphaCameraEvent() ;
...
constexpr void __cordl_internal_set__applyTextureEvent(::UnityEngine::Rendering::CameraEvent  value) ;
...
constexpr void __cordl_internal_set__captureTextureEvent(::UnityEngine::Rendering::CameraEvent  value) ;

constexpr void __cordl_internal_set__clipPlaneCameraEvent(::UnityEngine::Rendering::CameraEvent  value) ;

constexpr void __cordl_internal_set__clipPlaneCombineAlphaCameraEvent(::UnityEngine::Rendering::CameraEvent  value) ;
...
/// @brief Method .ctor, addr 0x18053f8, size 0xd8, virtual false, abstract: false, final false
inline void _ctor(::LIV::SDK::Unity::LIV*  liv) ;

/// @brief Method get_BackgroundRenderTexture, addr 0x1806708, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_BackgroundRenderTexture() ;

/// @brief Method get_cameraInstance, addr 0x18090ec, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_cameraInstance() ;

/// @brief Method get_cameraReference, addr 0x1808e48, size 0x8c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_cameraReference() ;

/// @brief Method get_canRenderBackground, addr 0x180690c, size 0xa4, virtual false, abstract: false, final false
inline bool get_canRenderBackground() ;

/// @brief Method get_canRenderForeground, addr 0x18069b0, size 0xb8, virtual false, abstract: false, final false
inline bool get_canRenderForeground() ;

/// @brief Method get_canRenderOptimized, addr 0x1806a68, size 0x84, virtual false, abstract: false, final false
inline bool get_canRenderOptimized() ;

/// @brief Method get_canSetPose, addr 0x1809234, size 0x20, virtual false, abstract: false, final false
inline bool get_canSetPose() ;

/// @brief Method get_disableStandardAssets, addr 0x1808cf0, size 0x1c, virtual false, abstract: false, final false
inline bool get_disableStandardAssets() ;

/// @brief Method get_hmdCamera, addr 0x18090f4, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_hmdCamera() ;

/// @brief Method get_inputFrame, addr 0x18090d4, size 0x10, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKInputFrame get_inputFrame() ;

/// @brief Method get_interlacedRendering, addr 0x18068fc, size 0x10, virtual false, abstract: false, final false
inline bool get_interlacedRendering() ;

/// @brief Method get_liv, addr 0x18090bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::LIV::SDK::Unity::LIV> get_liv() ;

/// @brief Method get_localToWorldMatrix, addr 0x1808998, size 0xbc, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_localToWorldMatrix() ;

/// @brief Method get_outputFrame, addr 0x18090c4, size 0x10, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKOutputFrame get_outputFrame() ;

/// @brief Method get_resolution, addr 0x18090e4, size 0x8, virtual false, abstract: false, final false
inline ::LIV::SDK::Unity::SDKResolution get_resolution() ;

/// @brief Method get_spectatorLayerMask, addr 0x1808a54, size 0x20, virtual false, abstract: false, final false
inline int32_t get_spectatorLayerMask() ;

/// @brief Method get_stage, addr 0x1809110, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stage() ;

/// @brief Method get_stageLocalToWorldMatrix, addr 0x1809144, size 0xf0, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_stageLocalToWorldMatrix() ;

/// @brief Method get_stageTransform, addr 0x1809128, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_stageTransform() ;

/// @brief Method get_useDeferredRendering, addr 0x18068b0, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Field _clipPlaneCombineAlphaCameraEvent, offset: 0x3c, size: 0x4, def value: None
 ::UnityEngine::Rendering::CameraEvent  ____clipPlaneCombineAlphaCameraEvent;

/// @brief Field _captureTextureEvent, offset: 0x40, size: 0x4, def value: None
 ::UnityEngine::Rendering::CameraEvent  ____captureTextureEvent;

/// @brief Field _applyTextureEvent, offset: 0x44, size: 0x4, def value: None
 ::UnityEngine::Rendering::CameraEvent  ____applyTextureEvent;

/// @brief Field _optimizedRenderingCameraEvent, offset: 0x48, size: 0x4, def value: None
 ::UnityEngine::Rendering::CameraEvent  ____optimizedRenderingCameraEvent;

/// @brief Field _clipPlaneMesh, offset: 0x50, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Mesh>  ____clipPlaneMesh;

/// @brief Field _clipPlaneSimpleMaterial, offset: 0x58, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Material>  ____clipPlaneSimpleMaterial;

/// @brief Field _clipPlaneSimpleDebugMaterial, offset: 0x60, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Material>  ____clipPlaneSimpleDebugMaterial;

/// @brief Field _clipPlaneComplexMaterial, offset: 0x68, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Material>  ____clipPlaneComplexMaterial;

/// @brief Field _clipPlaneComplexDebugMaterial, offset: 0x70, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Material>  ____clipPlaneComplexDebugMaterial;

/// @brief Field _writeOpaqueToAlphaMaterial, offset: 0x78, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Material>  ____writeOpaqueToAlphaMaterial;

/// @brief Field _combineAlphaMaterial, offset: 0x80, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Material>  ____combineAlphaMaterial;

/// @brief Field _writeMaterial, offset: 0x88, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Material>  ____writeMaterial;

/// @brief Field _forceForwardRenderingMaterial, offset: 0x90, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Material>  ____forceForwardRenderingMaterial;

/// @brief Field _backgroundRenderTexture, offset: 0x98, size: 0x8, def value: None
 ::UnityW<::UnityEngine::RenderTexture>  ____backgroundRenderTexture;

/// @brief Field _foregroundRenderTexture, offset: 0xa0, size: 0x8, def value: None
 ::UnityW<::UnityEngine::RenderTexture>  ____foregroundRenderTexture;

/// @brief Field _optimizedRenderTexture, offset: 0xa8, size: 0x8, def value: None
 ::UnityW<::UnityEngine::RenderTexture>  ____optimizedRenderTexture;

/// @brief Field _complexClipPlaneRenderTexture, offset: 0xb0, size: 0x8, def value: None
 ::UnityW<::UnityEngine::RenderTexture>  ____complexClipPlaneRenderTexture;

/// @brief Field _liv, offset: 0xb8, size: 0x8, def value: None
 ::UnityW<::LIV::SDK::Unity::LIV>  ____liv;

/// @brief Field _outputFrame, offset: 0xc0, size: 0xac, def value: None
 ::LIV::SDK::Unity::SDKOutputFrame  ____outputFrame;

/// @brief Field _inputFrame, offset: 0x170, size: 0x158, def value: None
 ::LIV::SDK::Unity::SDKInputFrame  ____inputFrame;

/// @brief Field _resolution, offset: 0x2c8, size: 0x8, def value: None
 ::LIV::SDK::Unity::SDKResolution  ____resolution;

/// @brief Field _cameraInstance, offset: 0x2d0, size: 0x8, def value: None
 ::UnityW<::UnityEngine::Camera>  ____cameraInstance;

/// @brief Field _requestedPose, offset: 0x2d8, size: 0x70, def value: None
 ::LIV::SDK::Unity::SDKPose  ____requestedPose;

/// @brief Field _requestedPoseFrameIndex, offset: 0x348, size: 0x4, def value: None
...
static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____clipPlaneCombineAlphaCameraEvent) == 0x3c, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____captureTextureEvent) == 0x40, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____applyTextureEvent) == 0x44, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____optimizedRenderingCameraEvent) == 0x48, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____clipPlaneMesh) == 0x50, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____clipPlaneSimpleMaterial) == 0x58, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____clipPlaneSimpleDebugMaterial) == 0x60, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____clipPlaneComplexMaterial) == 0x68, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____clipPlaneComplexDebugMaterial) == 0x70, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____writeOpaqueToAlphaMaterial) == 0x78, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____combineAlphaMaterial) == 0x80, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____writeMaterial) == 0x88, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____forceForwardRenderingMaterial) == 0x90, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____backgroundRenderTexture) == 0x98, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____foregroundRenderTexture) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____optimizedRenderTexture) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____complexClipPlaneRenderTexture) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____liv) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____outputFrame) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____inputFrame) == 0x170, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____resolution) == 0x2c8, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____cameraInstance) == 0x2d0, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____requestedPose) == 0x2d8, "Offset mismatch!");

static_assert(offsetof(::LIV::SDK::Unity::SDKRender, ____requestedPoseFrameIndex) == 0x348, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::LIV::SDK::Unity::SDKRender, 0x350>, "Size mismatch!");
