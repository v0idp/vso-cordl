...
public:
// Declarations
/// @brief Method ToString, addr 0x180c2e8, size 0x368, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_empty, addr 0x180c168, size 0x180, virtual false, abstract: false, final false
