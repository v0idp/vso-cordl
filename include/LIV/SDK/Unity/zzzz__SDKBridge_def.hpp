...
/// @brief Method AddObjectToChannel, addr 0x1805a78, size 0x8, virtual false, abstract: false, final false
static inline int32_t AddObjectToChannel(int32_t  slot, ::System::IntPtr  obj, int32_t  objectsize, uint64_t  tag) ;

/// @brief Method AddObjectToCompositorChannel, addr 0x1805a50, size 0x8, virtual false, abstract: false, final false
static inline int32_t AddObjectToCompositorChannel(int32_t  slot, ::System::IntPtr  obj, int32_t  objectsize, uint64_t  tag) ;

/// @brief Method AddObjectToFrame, addr 0x1805a58, size 0x8, virtual false, abstract: false, final false
static inline int32_t AddObjectToFrame(::System::IntPtr  obj, int32_t  objectsize, uint64_t  tag) ;

/// @brief Method AddString, addr 0x1805b04, size 0xfc, virtual false, abstract: false, final false
static inline void AddString(::StringW  tag, ::StringW  value, int32_t  slot) ;

/// @brief Method AddStringToChannel, addr 0x1805a18, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AddTexture, addr 0x1806200, size 0x130, virtual false, abstract: false, final false
static inline void AddTexture(::LIV::SDK::Unity::SDKTexture  texture) ;

/// @brief Method AddTexture, addr 0x1805c00, size 0xc4, virtual false, abstract: false, final false
static inline void AddTexture(::LIV::SDK::Unity::SDKTexture  texture, uint64_t  tag) ;

/// @brief Method CreateFrame, addr 0x1806330, size 0x160, virtual false, abstract: false, final false
static inline void CreateFrame(::LIV::SDK::Unity::SDKOutputFrame  frame) ;

/// @brief Method GetChannelObject, addr 0x1805a70, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetChannelObject(int32_t  slot, uint64_t  tag, uint64_t  timestamp) ;

/// @brief Method GetCompositorChannelObject, addr 0x1805a48, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetCompositorChannelObject(int32_t  slot, uint64_t  tag, uint64_t  timestamp) ;

/// @brief Method GetCurrentTime, addr 0x1805d20, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t GetCurrentTime() ;

/// @brief Method GetCurrentTimeTicks, addr 0x1805a30, size 0x8, virtual false, abstract: false, final false
static inline uint64_t GetCurrentTimeTicks() ;

/// @brief Method GetIsCaptureActive, addr 0x1805a38, size 0x8, virtual false, abstract: false, final false
static inline bool GetIsCaptureActive() ;

/// @brief Method GetObjectTime, addr 0x1805cc4, size 0x5c, virtual false, abstract: false, final false
static inline uint64_t GetObjectTime(::System::IntPtr  objectptr) ;

/// @brief Method GetObjectTimeStamp, addr 0x1805a28, size 0x8, virtual false, abstract: false, final false
static inline uint64_t GetObjectTimeStamp(::System::IntPtr  obj) ;

/// @brief Method GetRenderEventFunc, addr 0x1805a40, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetRenderEventFunc() ;

/// @brief Method GetResolution, addr 0x1806530, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method GetViewfinderTexture, addr 0x1806080, size 0x180, virtual false, abstract: false, final false
static inline ::LIV::SDK::Unity::SDKTexture GetViewfinderTexture() ;

/// @brief Method GetViewportTexture, addr 0x1805a68, size 0x8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetViewportTexture() ;

/// @brief Method IssuePluginEvent, addr 0x1805d7c, size 0x80, virtual false, abstract: false, final false
static inline void IssuePluginEvent() ;

/// @brief Method SetGroundPlane, addr 0x1806490, size 0xa0, virtual false, abstract: false, final false
static inline void SetGroundPlane(::LIV::SDK::Unity::SDKPlane  groundPlane) ;

/// @brief Method SubmitApplicationOutput, addr 0x1805518, size 0x1d0, virtual false, abstract: false, final false
static inline void SubmitApplicationOutput(::LIV::SDK::Unity::SDKApplicationOutput  applicationOutput) ;

/// @brief Method Tag, addr 0x1805a80, size 0x84, virtual false, abstract: false, final false
static inline uint64_t Tag(::StringW  str) ;

/// @brief Method UpdateInputFrame, addr 0x1805dfc, size 0x284, virtual false, abstract: false, final false
static inline bool UpdateInputFrame(::ByRef<::LIV::SDK::Unity::SDKInputFrame>  setframe) ;

/// @brief Method addtexture, addr 0x1805a20, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_IsActive, addr 0x1804d88, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method updatinputframe, addr 0x1805a60, size 0x8, virtual false, abstract: false, final false
