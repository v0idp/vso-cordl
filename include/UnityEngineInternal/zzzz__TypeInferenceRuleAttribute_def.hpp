...
/// @brief Method ToString, addr 0x2f5aab0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f5aa88, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  rule) ;

/// @brief Method .ctor, addr 0x2f5aa04, size 0x84, virtual false, abstract: false, final false
