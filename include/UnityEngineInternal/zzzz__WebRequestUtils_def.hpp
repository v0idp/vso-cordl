...
/// @brief Method MakeInitialUrl, addr 0x3192e20, size 0x370, virtual false, abstract: false, final false
static inline ::StringW MakeInitialUrl(::StringW  targetUrl, ::StringW  localUrl) ;

/// @brief Method MakeUriString, addr 0x3193190, size 0x3dc, virtual false, abstract: false, final false
static inline ::StringW MakeUriString(::System::Uri*  targetUri, ::StringW  targetUrl, bool  prependProtocol) ;

/// @brief Method RedirectTo, addr 0x3192d34, size 0xec, virtual false, abstract: false, final false
static inline ::StringW RedirectTo(::StringW  baseUri, ::StringW  redirectUri) ;

/// @brief Method URLDecode, addr 0x319356c, size 0xa4, virtual false, abstract: false, final false
