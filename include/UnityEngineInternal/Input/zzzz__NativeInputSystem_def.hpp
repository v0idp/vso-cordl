...
/// @brief Method AllocateDeviceId, addr 0x2fbf824, size 0x28, virtual false, abstract: false, final false
static inline int32_t AllocateDeviceId() ;

/// @brief Method IOCTL, addr 0x2fbf888, size 0x5c, virtual false, abstract: false, final false
static inline int64_t IOCTL(int32_t  deviceId, int32_t  code, ::System::IntPtr  data, int32_t  sizeInBytes) ;

/// @brief Method NotifyBeforeUpdate, addr 0x2fbf59c, size 0x7c, virtual false, abstract: false, final false
static inline void NotifyBeforeUpdate(::UnityEngineInternal::Input::NativeInputUpdateType  updateType) ;

/// @brief Method NotifyDeviceDiscovered, addr 0x2fbf6b4, size 0x90, virtual false, abstract: false, final false
static inline void NotifyDeviceDiscovered(int32_t  deviceId, ::StringW  deviceDescriptor) ;

/// @brief Method NotifyUpdate, addr 0x2fbf618, size 0x9c, virtual false, abstract: false, final false
static inline void NotifyUpdate(::UnityEngineInternal::Input::NativeInputUpdateType  updateType, ::System::IntPtr  eventBuffer) ;

/// @brief Method QueueInputEvent, addr 0x2fbf84c, size 0x3c, virtual false, abstract: false, final false
static inline void QueueInputEvent(::System::IntPtr  inputEvent) ;

/// @brief Method SetPollingFrequency, addr 0x2fbf8e4, size 0x38, virtual false, abstract: false, final false
static inline void SetPollingFrequency(float_t  hertz) ;

/// @brief Method ShouldRunUpdate, addr 0x2fbf744, size 0x90, virtual false, abstract: false, final false
static inline void ShouldRunUpdate(::UnityEngineInternal::Input::NativeInputUpdateType  updateType, ::ByRef<bool>  retval) ;

/// @brief Method Update, addr 0x2fbf91c, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_currentTime, addr 0x2fbf7d4, size 0x28, virtual false, abstract: false, final false
static inline double_t get_currentTime() ;

/// @brief Method get_currentTimeOffsetToRealtimeSinceStartup, addr 0x2fbf7fc, size 0x28, virtual false, abstract: false, final false
static inline double_t get_currentTimeOffsetToRealtimeSinceStartup() ;

/// @brief Method get_onDeviceDiscovered, addr 0x2fbf454, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method set_hasDeviceDiscoveredCallback, addr 0x2fbf530, size 0x3c, virtual false, abstract: false, final false
static inline void set_hasDeviceDiscoveredCallback(bool  value) ;

/// @brief Method set_onDeviceDiscovered, addr 0x2fbf4ac, size 0x84, virtual false, abstract: false, final false
