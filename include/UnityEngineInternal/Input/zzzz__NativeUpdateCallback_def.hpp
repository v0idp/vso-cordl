...
public:
// Declarations
/// @brief Method Invoke, addr 0x2fbf440, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fbf3b4, size 0x8c, virtual false, abstract: false, final false
