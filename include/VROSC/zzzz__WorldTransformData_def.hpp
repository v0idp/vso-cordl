...
CORDL_MODULE_EXPORT(WorldTransformData)
...
// Write type traits
MARK_REF_PTR_T(::VROSC::WorldTransformData);
// Dependencies System.Object, UnityEngine.Quaternion, UnityEngine.Vector3
namespace VROSC {
// Is value type: false
// CS Name: VROSC.WorldTransformData
class CORDL_TYPE WorldTransformData : public ::System::Object {
public:
// Declarations
...
static inline ::VROSC::WorldTransformData* New_ctor(::UnityEngine::Transform*  transform) ;

/// @brief Method ResetTransform, addr 0x173855c, size 0x58, virtual false, abstract: false, final false
inline void ResetTransform() ;

/// @brief Method Update, addr 0x1738470, size 0x5c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x17380dc, size 0x128, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Transform*  transform) ;

protected:
// Ctor Parameters []
// @brief default ctor
constexpr WorldTransformData() ;
public:

// Ctor Parameters [CppParam { name: "", ty: "WorldTransformData", modifiers: "&&", def_value: None }]
// @brief delete move ctor to prevent accidental deref moves
WorldTransformData(WorldTransformData && ) = delete;

// Ctor Parameters [CppParam { name: "", ty: "WorldTransformData", modifiers: "const&", def_value: None }]
// @brief delete copy ctor to prevent accidental deref copies
WorldTransformData(WorldTransformData const& ) = delete;
...
static_assert(offsetof(::VROSC::WorldTransformData, ___Transform) == 0x10, "Offset mismatch!");

static_assert(offsetof(::VROSC::WorldTransformData, ___Position) == 0x18, "Offset mismatch!");

static_assert(offsetof(::VROSC::WorldTransformData, ___Rotation) == 0x24, "Offset mismatch!");

static_assert(offsetof(::VROSC::WorldTransformData, ___LocalScale) == 0x34, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::VROSC::WorldTransformData, 0x40>, "Size mismatch!");
