...
public:
// Declarations
/// @brief Method Unpack, addr 0x29839c4, size 0x24, virtual false, abstract: false, final false
inline void Unpack(::ByRef<::OVR::OpenVR::RenderModel_t>  unpacked) ;

/// @brief Method .ctor, addr 0x2983998, size 0x2c, virtual false, abstract: false, final false
