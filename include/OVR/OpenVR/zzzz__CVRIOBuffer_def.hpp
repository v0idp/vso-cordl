...
/// @brief Method Close, addr 0x298316c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method Open, addr 0x2983144, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method PropertyContainer, addr 0x29831dc, size 0x24, virtual false, abstract: false, final false
inline uint64_t PropertyContainer(uint64_t  ulBuffer) ;

/// @brief Method Read, addr 0x2983190, size 0x28, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EIOBufferError Read(uint64_t  ulBuffer, ::System::IntPtr  pDst, uint32_t  unBytes, ::ByRef<uint32_t>  punRead) ;

/// @brief Method Write, addr 0x29831b8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2983030, size 0x114, virtual false, abstract: false, final false
