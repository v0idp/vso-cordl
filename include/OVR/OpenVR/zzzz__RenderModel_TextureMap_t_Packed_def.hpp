...
public:
// Declarations
/// @brief Method Unpack, addr 0x298397c, size 0x1c, virtual false, abstract: false, final false
inline void Unpack(::ByRef<::OVR::OpenVR::RenderModel_TextureMap_t>  unpacked) ;

/// @brief Method .ctor, addr 0x2983968, size 0x14, virtual false, abstract: false, final false
