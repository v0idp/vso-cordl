...
/// @brief Method CommitWorkingCopy, addr 0x297fea4, size 0x24, virtual false, abstract: false, final false
inline bool CommitWorkingCopy(::OVR::OpenVR::EChaperoneConfigFile  configFile) ;

/// @brief Method ExportLiveToBuffer, addr 0x298035c, size 0x28, virtual false, abstract: false, final false
inline bool ExportLiveToBuffer(::System::Text::StringBuilder*  pBuffer, ::ByRef<uint32_t>  pnBufferLength) ;

/// @brief Method GetLiveCollisionBoundsInfo, addr 0x297ffe4, size 0xa8, virtual false, abstract: false, final false
inline bool GetLiveCollisionBoundsInfo(::ByRef<::ArrayW<::OVR::OpenVR::HmdQuad_t,::Array<::OVR::OpenVR::HmdQuad_t>*>>  pQuadsBuffer) ;

/// @brief Method GetLiveCollisionBoundsTagsInfo, addr 0x29801e0, size 0xa8, virtual false, abstract: false, final false
inline bool GetLiveCollisionBoundsTagsInfo(::ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  pTagsBuffer) ;

/// @brief Method GetLivePhysicalBoundsInfo, addr 0x29802b4, size 0xa8, virtual false, abstract: false, final false
inline bool GetLivePhysicalBoundsInfo(::ByRef<::ArrayW<::OVR::OpenVR::HmdQuad_t,::Array<::OVR::OpenVR::HmdQuad_t>*>>  pQuadsBuffer) ;

/// @brief Method GetLiveSeatedZeroPoseToRawTrackingPose, addr 0x2980190, size 0x24, virtual false, abstract: false, final false
inline bool GetLiveSeatedZeroPoseToRawTrackingPose(::ByRef<::OVR::OpenVR::HmdMatrix34_t>  pmatSeatedZeroPoseToRawTrackingPose) ;

/// @brief Method GetWorkingCollisionBoundsInfo, addr 0x297ff3c, size 0xa8, virtual false, abstract: false, final false
inline bool GetWorkingCollisionBoundsInfo(::ByRef<::ArrayW<::OVR::OpenVR::HmdQuad_t,::Array<::OVR::OpenVR::HmdQuad_t>*>>  pQuadsBuffer) ;

/// @brief Method GetWorkingPlayAreaRect, addr 0x297ff18, size 0x24, virtual false, abstract: false, final false
inline bool GetWorkingPlayAreaRect(::ByRef<::OVR::OpenVR::HmdQuad_t>  rect) ;

/// @brief Method GetWorkingPlayAreaSize, addr 0x297feec, size 0x2c, virtual false, abstract: false, final false
inline bool GetWorkingPlayAreaSize(::ByRef<float_t>  pSizeX, ::ByRef<float_t>  pSizeZ) ;

/// @brief Method GetWorkingSeatedZeroPoseToRawTrackingPose, addr 0x298008c, size 0x24, virtual false, abstract: false, final false
inline bool GetWorkingSeatedZeroPoseToRawTrackingPose(::ByRef<::OVR::OpenVR::HmdMatrix34_t>  pmatSeatedZeroPoseToRawTrackingPose) ;

/// @brief Method GetWorkingStandingZeroPoseToRawTrackingPose, addr 0x29800b0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method ImportFromBufferToWorking, addr 0x2980384, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method ReloadFromDisk, addr 0x298016c, size 0x24, virtual false, abstract: false, final false
inline void ReloadFromDisk(::OVR::OpenVR::EChaperoneConfigFile  configFile) ;

/// @brief Method RevertWorkingCopy, addr 0x297fec8, size 0x24, virtual false, abstract: false, final false
inline void RevertWorkingCopy() ;

/// @brief Method SetWorkingCollisionBoundsInfo, addr 0x29800f8, size 0x2c, virtual false, abstract: false, final false
inline void SetWorkingCollisionBoundsInfo(::ArrayW<::OVR::OpenVR::HmdQuad_t,::Array<::OVR::OpenVR::HmdQuad_t>*>  pQuadsBuffer) ;

/// @brief Method SetWorkingCollisionBoundsTagsInfo, addr 0x29801b4, size 0x2c, virtual false, abstract: false, final false
inline void SetWorkingCollisionBoundsTagsInfo(::ArrayW<uint8_t,::Array<uint8_t>*>  pTagsBuffer) ;

/// @brief Method SetWorkingPhysicalBoundsInfo, addr 0x2980288, size 0x2c, virtual false, abstract: false, final false
inline bool SetWorkingPhysicalBoundsInfo(::ArrayW<::OVR::OpenVR::HmdQuad_t,::Array<::OVR::OpenVR::HmdQuad_t>*>  pQuadsBuffer) ;

/// @brief Method SetWorkingPlayAreaSize, addr 0x29800d4, size 0x24, virtual false, abstract: false, final false
inline void SetWorkingPlayAreaSize(float_t  sizeX, float_t  sizeZ) ;

/// @brief Method SetWorkingSeatedZeroPoseToRawTrackingPose, addr 0x2980124, size 0x24, virtual false, abstract: false, final false
inline void SetWorkingSeatedZeroPoseToRawTrackingPose(::ByRef<::OVR::OpenVR::HmdMatrix34_t>  pMatSeatedZeroPoseToRawTrackingPose) ;

/// @brief Method SetWorkingStandingZeroPoseToRawTrackingPose, addr 0x2980148, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x297fd90, size 0x114, virtual false, abstract: false, final false
