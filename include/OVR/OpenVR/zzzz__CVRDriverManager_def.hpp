...
/// @brief Method GetDriverCount, addr 0x2982be4, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetDriverCount() ;

/// @brief Method GetDriverHandle, addr 0x2982c2c, size 0x24, virtual false, abstract: false, final false
inline uint64_t GetDriverHandle(::StringW  pchDriverName) ;

/// @brief Method GetDriverName, addr 0x2982c08, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2982ad0, size 0x114, virtual false, abstract: false, final false
