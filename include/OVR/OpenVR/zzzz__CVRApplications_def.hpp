...
/// @brief Method AddApplicationManifest, addr 0x297f624, size 0x28, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRApplicationError AddApplicationManifest(::StringW  pchApplicationManifestFullPath, bool  bTemporary) ;

/// @brief Method CancelApplicationLaunch, addr 0x297f798, size 0x24, virtual false, abstract: false, final false
inline bool CancelApplicationLaunch(::StringW  pchAppKey) ;

/// @brief Method GetApplicationAutoLaunch, addr 0x297f91c, size 0x24, virtual false, abstract: false, final false
inline bool GetApplicationAutoLaunch(::StringW  pchAppKey) ;

/// @brief Method GetApplicationCount, addr 0x297f694, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetApplicationCount() ;

/// @brief Method GetApplicationKeyByIndex, addr 0x297f6b8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetApplicationKeyByProcessId, addr 0x297f6dc, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetApplicationLaunchArguments, addr 0x297f9d0, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetApplicationLaunchArguments(uint32_t  unHandle, ::System::Text::StringBuilder*  pchArgs, uint32_t  unArgs) ;

/// @brief Method GetApplicationProcessId, addr 0x297f7e0, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetApplicationProcessId(::StringW  pchAppKey) ;

/// @brief Method GetApplicationPropertyBool, addr 0x297f8ac, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetApplicationPropertyString, addr 0x297f888, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetApplicationPropertyUint64, addr 0x297f8d0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetApplicationSupportedMimeTypes, addr 0x297f988, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetApplicationsErrorNameFromEnum, addr 0x297f804, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetApplicationsErrorNameFromEnum(::OVR::OpenVR::EVRApplicationError  error) ;

/// @brief Method GetApplicationsThatSupportMimeType, addr 0x297f9ac, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetApplicationsTransitionStateNameFromEnum, addr 0x297fa60, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetApplicationsTransitionStateNameFromEnum(::OVR::OpenVR::EVRApplicationTransitionState  state) ;

/// @brief Method GetCurrentSceneProcessId, addr 0x297fb2c, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetCurrentSceneProcessId() ;

/// @brief Method GetDefaultApplicationForMimeType, addr 0x297f964, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetStartingApplication, addr 0x297f9f4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetTransitionState, addr 0x297fa18, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRApplicationTransitionState GetTransitionState() ;

/// @brief Method IdentifyApplication, addr 0x297f7bc, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRApplicationError IdentifyApplication(uint32_t  unProcessId, ::StringW  pchAppKey) ;

/// @brief Method IsApplicationInstalled, addr 0x297f670, size 0x24, virtual false, abstract: false, final false
inline bool IsApplicationInstalled(::StringW  pchAppKey) ;

/// @brief Method IsQuitUserPromptRequested, addr 0x297fae4, size 0x24, virtual false, abstract: false, final false
inline bool IsQuitUserPromptRequested() ;

/// @brief Method LaunchApplication, addr 0x297f700, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRApplicationError LaunchApplication(::StringW  pchAppKey) ;

/// @brief Method LaunchApplicationFromMimeType, addr 0x297f750, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRApplicationError LaunchApplicationFromMimeType(::StringW  pchMimeType, ::StringW  pchArgs) ;

/// @brief Method LaunchDashboardOverlay, addr 0x297f774, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRApplicationError LaunchDashboardOverlay(::StringW  pchAppKey) ;

/// @brief Method LaunchInternalProcess, addr 0x297fb08, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method LaunchTemplateApplication, addr 0x297f724, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method PerformApplicationPrelaunchCheck, addr 0x297fa3c, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRApplicationError PerformApplicationPrelaunchCheck(::StringW  pchAppKey) ;

/// @brief Method RemoveApplicationManifest, addr 0x297f64c, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRApplicationError RemoveApplicationManifest(::StringW  pchApplicationManifestFullPath) ;

/// @brief Method SetApplicationAutoLaunch, addr 0x297f8f4, size 0x28, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRApplicationError SetApplicationAutoLaunch(::StringW  pchAppKey, bool  bAutoLaunch) ;

/// @brief Method SetDefaultApplicationForMimeType, addr 0x297f940, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x297f510, size 0x114, virtual false, abstract: false, final false
