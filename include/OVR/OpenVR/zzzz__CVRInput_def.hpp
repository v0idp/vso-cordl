...
/// @brief Method DecompressSkeletalBoneData, addr 0x2982f18, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method GetActionHandle, addr 0x2982db0, size 0x28, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRInputError GetActionHandle(::StringW  pchActionName, ::ByRef<uint64_t>  pHandle) ;

/// @brief Method GetActionOrigins, addr 0x2982f68, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method GetActionSetHandle, addr 0x2982d88, size 0x28, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRInputError GetActionSetHandle(::StringW  pchActionSetName, ::ByRef<uint64_t>  pHandle) ;

/// @brief Method GetAnalogActionData, addr 0x2982e50, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetDigitalActionData, addr 0x2982e2c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetInputSourceHandle, addr 0x2982dd8, size 0x28, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRInputError GetInputSourceHandle(::StringW  pchInputSourcePath, ::ByRef<uint64_t>  pHandle) ;

/// @brief Method GetOriginLocalizedName, addr 0x2982f94, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetOriginTrackedDeviceInfo, addr 0x2982fb8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetPoseActionData, addr 0x2982e74, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetSkeletalActionData, addr 0x2982e98, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetSkeletalBoneData, addr 0x2982ebc, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetSkeletalBoneDataCompressed, addr 0x2982eec, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method SetActionManifestPath, addr 0x2982d64, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRInputError SetActionManifestPath(::StringW  pchActionManifestPath) ;

/// @brief Method ShowActionOrigins, addr 0x2982fdc, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRInputError ShowActionOrigins(uint64_t  actionSetHandle, uint64_t  ulActionHandle) ;

/// @brief Method ShowBindingsForActionSet, addr 0x2983000, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method TriggerHapticVibrationAction, addr 0x2982f44, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method UpdateActionState, addr 0x2982e00, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2982c50, size 0x114, virtual false, abstract: false, final false
