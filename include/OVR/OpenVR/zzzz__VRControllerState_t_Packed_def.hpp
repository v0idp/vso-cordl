...
public:
// Declarations
/// @brief Method Unpack, addr 0x297e68c, size 0x3c, virtual false, abstract: false, final false
inline void Unpack(::ByRef<::OVR::OpenVR::VRControllerState_t>  unpacked) ;

/// @brief Method .ctor, addr 0x297e648, size 0x44, virtual false, abstract: false, final false
