...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x297eb94, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x297ec4c, size 0x2c, virtual true, abstract: false, final false
inline bool EndInvoke(::ByRef<::OVR::OpenVR::VREvent_t_Packed>  pEvent, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x297eb80, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x297eae0, size 0xa0, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x297ed18, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x297ede8, size 0x2c, virtual true, abstract: false, final false
inline bool EndInvoke(::ByRef<::OVR::OpenVR::VRControllerState_t_Packed>  pControllerState, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x297ed04, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x297ec78, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  object, ::System::IntPtr  method) ;
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x297eeb4, size 0x13c, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x297eff0, size 0x34, virtual true, abstract: false, final false
...
/// @brief Method Invoke, addr 0x297eea0, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x297ee14, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  object, ::System::IntPtr  method) ;
...
/// @brief Method AcknowledgeQuit_Exiting, addr 0x297ea98, size 0x24, virtual false, abstract: false, final false
inline void AcknowledgeQuit_Exiting() ;

/// @brief Method AcknowledgeQuit_UserPrompt, addr 0x297eabc, size 0x24, virtual false, abstract: false, final false
inline void AcknowledgeQuit_UserPrompt() ;

/// @brief Method ApplyTransform, addr 0x297dfe4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method ComputeDistortion, addr 0x297dd58, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method DriverDebugRequest, addr 0x297ea50, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetArrayTrackedDeviceProperty, addr 0x297e170, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetBoolTrackedDeviceProperty, addr 0x297e098, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetButtonIdNameFromEnum, addr 0x297e8b8, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetButtonIdNameFromEnum(::OVR::OpenVR::EVRButtonId  eButtonId) ;

/// @brief Method GetControllerAxisTypeNameFromEnum, addr 0x297e93c, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetControllerAxisTypeNameFromEnum(::OVR::OpenVR::EVRControllerAxisType  eAxisType) ;

/// @brief Method GetControllerRoleForTrackedDeviceIndex, addr 0x297e02c, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::ETrackedControllerRole GetControllerRoleForTrackedDeviceIndex(uint32_t  unDeviceIndex) ;

/// @brief Method GetControllerState, addr 0x297e49c, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method GetControllerStateWithPose, addr 0x297e6c8, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method GetD3D9AdapterIndex, addr 0x297ddf0, size 0x24, virtual false, abstract: false, final false
inline int32_t GetD3D9AdapterIndex() ;

/// @brief Method GetDXGIOutputInfo, addr 0x297de14, size 0x28, virtual false, abstract: false, final false
inline void GetDXGIOutputInfo(::ByRef<int32_t>  pnAdapterIndex) ;

/// @brief Method GetDeviceToAbsoluteTrackingPose, addr 0x297deb0, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method GetEventTypeNameFromEnum, addr 0x297e3f4, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetEventTypeNameFromEnum(::OVR::OpenVR::EVREventType  eType) ;

/// @brief Method GetEyeToHeadTransform, addr 0x297dd7c, size 0x48, virtual false, abstract: false, final false
inline ::OVR::OpenVR::HmdMatrix34_t GetEyeToHeadTransform(::OVR::OpenVR::EVREye  eEye) ;

/// @brief Method GetFloatTrackedDeviceProperty, addr 0x297e0bc, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetHiddenAreaMesh, addr 0x297e478, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::HiddenAreaMesh_t GetHiddenAreaMesh(::OVR::OpenVR::EVREye  eEye, ::OVR::OpenVR::EHiddenAreaMeshType  type) ;

/// @brief Method GetInt32TrackedDeviceProperty, addr 0x297e0e0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetMatrix34TrackedDeviceProperty, addr 0x297e128, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method GetOutputDevice, addr 0x297de3c, size 0x28, virtual false, abstract: false, final false
inline void GetOutputDevice(::ByRef<uint64_t>  pnDevice, ::OVR::OpenVR::ETextureType  textureType, ::System::IntPtr  pInstance) ;

/// @brief Method GetProjectionMatrix, addr 0x297dcdc, size 0x48, virtual false, abstract: false, final false
inline ::OVR::OpenVR::HmdMatrix44_t GetProjectionMatrix(::OVR::OpenVR::EVREye  eEye, float_t  fNearZ, float_t  fFarZ) ;

/// @brief Method GetProjectionRaw, addr 0x297dd24, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method GetPropErrorNameFromEnum, addr 0x297e1b8, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetPropErrorNameFromEnum(::OVR::OpenVR::ETrackedPropertyError  error) ;

/// @brief Method GetRawZeroPoseToStandingAbsoluteTrackingPose, addr 0x297df48, size 0x48, virtual false, abstract: false, final false
inline ::OVR::OpenVR::HmdMatrix34_t GetRawZeroPoseToStandingAbsoluteTrackingPose() ;

/// @brief Method GetRecommendedRenderTargetSize, addr 0x297dcb0, size 0x2c, virtual false, abstract: false, final false
inline void GetRecommendedRenderTargetSize(::ByRef<uint32_t>  pnWidth, ::ByRef<uint32_t>  pnHeight) ;

/// @brief Method GetSeatedZeroPoseToStandingAbsoluteTrackingPose, addr 0x297df00, size 0x48, virtual false, abstract: false, final false
inline ::OVR::OpenVR::HmdMatrix34_t GetSeatedZeroPoseToStandingAbsoluteTrackingPose() ;

/// @brief Method GetSortedTrackedDeviceIndicesOfClass, addr 0x297df90, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetStringTrackedDeviceProperty, addr 0x297e194, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetTimeSinceLastVsync, addr 0x297ddc4, size 0x2c, virtual false, abstract: false, final false
inline bool GetTimeSinceLastVsync(::ByRef<float_t>  pfSecondsSinceLastVsync, ::ByRef<uint64_t>  pulFrameCounter) ;

/// @brief Method GetTrackedDeviceActivityLevel, addr 0x297dfc0, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EDeviceActivityLevel GetTrackedDeviceActivityLevel(uint32_t  unDeviceId) ;

/// @brief Method GetTrackedDeviceClass, addr 0x297e050, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::ETrackedDeviceClass GetTrackedDeviceClass(uint32_t  unDeviceIndex) ;

/// @brief Method GetTrackedDeviceIndexForControllerRole, addr 0x297e008, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetTrackedDeviceIndexForControllerRole(::OVR::OpenVR::ETrackedControllerRole  unDeviceType) ;

/// @brief Method GetUint64TrackedDeviceProperty, addr 0x297e104, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method IsDisplayOnDesktop, addr 0x297de64, size 0x24, virtual false, abstract: false, final false
inline bool IsDisplayOnDesktop() ;

/// @brief Method IsInputAvailable, addr 0x297e9c0, size 0x24, virtual false, abstract: false, final false
inline bool IsInputAvailable() ;

/// @brief Method IsSteamVRDrawingControllers, addr 0x297e9e4, size 0x24, virtual false, abstract: false, final false
inline bool IsSteamVRDrawingControllers() ;

/// @brief Method IsTrackedDeviceConnected, addr 0x297e074, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method PerformFirmwareUpdate, addr 0x297ea74, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRFirmwareError PerformFirmwareUpdate(uint32_t  unDeviceIndex) ;

/// @brief Method PollNextEvent, addr 0x297e23c, size 0x174, virtual false, abstract: false, final false
inline bool PollNextEvent(::ByRef<::OVR::OpenVR::VREvent_t>  pEvent, uint32_t  uncbVREvent) ;

/// @brief Method PollNextEventWithPose, addr 0x297e3d0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method ResetSeatedZeroPose, addr 0x297dedc, size 0x24, virtual false, abstract: false, final false
inline void ResetSeatedZeroPose() ;

/// @brief Method SetDisplayVisibility, addr 0x297de88, size 0x28, virtual false, abstract: false, final false
inline bool SetDisplayVisibility(bool  bIsVisibleOnDesktop) ;

/// @brief Method ShouldApplicationPause, addr 0x297ea08, size 0x24, virtual false, abstract: false, final false
inline bool ShouldApplicationPause() ;

/// @brief Method ShouldApplicationReduceRenderingWork, addr 0x297ea2c, size 0x24, virtual false, abstract: false, final false
inline bool ShouldApplicationReduceRenderingWork() ;

/// @brief Method TriggerHapticPulse, addr 0x297e894, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x297db9c, size 0x114, virtual false, abstract: false, final false
