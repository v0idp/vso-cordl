...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x2978804, size 0x164, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x2978968, size 0x34, virtual true, abstract: false, final false
...
/// @brief Method Invoke, addr 0x29787ec, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2978760, size 0x8c, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x2978a3c, size 0x84, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(uint32_t  notificationId, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x2978ac0, size 0x28, virtual true, abstract: false, final false
inline ::OVR::OpenVR::EVRNotificationError EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x2978a28, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x297899c, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  object, ::System::IntPtr  method) ;
...
// Ctor Parameters [CppParam { name: "CreateNotification", ty: "::OVR::OpenVR::IVRNotifications__CreateNotification*", modifiers: "", def_value: None }, CppParam { name: "RemoveNotification", ty: "::OVR::OpenVR::IVRNotifications__RemoveNotification*", modifiers: "", def_value: None }]
