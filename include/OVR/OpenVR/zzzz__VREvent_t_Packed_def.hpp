...
public:
// Declarations
/// @brief Method Unpack, addr 0x297e3b0, size 0x20, virtual false, abstract: false, final false
inline void Unpack(::ByRef<::OVR::OpenVR::VREvent_t>  unpacked) ;

/// @brief Method .ctor, addr 0x298392c, size 0x3c, virtual false, abstract: false, final false
