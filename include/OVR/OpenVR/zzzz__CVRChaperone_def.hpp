...
/// @brief Method AreBoundsVisible, addr 0x297fd44, size 0x24, virtual false, abstract: false, final false
inline bool AreBoundsVisible() ;

/// @brief Method ForceBoundsVisible, addr 0x297fd68, size 0x28, virtual false, abstract: false, final false
inline void ForceBoundsVisible(bool  bForce) ;

/// @brief Method GetBoundsColor, addr 0x297fd20, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetCalibrationState, addr 0x297fc64, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::ChaperoneCalibrationState GetCalibrationState() ;

/// @brief Method GetPlayAreaRect, addr 0x297fcb4, size 0x24, virtual false, abstract: false, final false
inline bool GetPlayAreaRect(::ByRef<::OVR::OpenVR::HmdQuad_t>  rect) ;

/// @brief Method GetPlayAreaSize, addr 0x297fc88, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method ReloadInfo, addr 0x297fcd8, size 0x24, virtual false, abstract: false, final false
inline void ReloadInfo() ;

/// @brief Method SetSceneColor, addr 0x297fcfc, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x297fb50, size 0x114, virtual false, abstract: false, final false
