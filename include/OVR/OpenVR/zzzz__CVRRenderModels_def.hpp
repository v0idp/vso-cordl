...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x2982198, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x2982298, size 0x34, virtual true, abstract: false, final false
...
/// @brief Method Invoke, addr 0x2982184, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29820e4, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method FreeRenderModel, addr 0x2981ce8, size 0x24, virtual false, abstract: false, final false
inline void FreeRenderModel(::System::IntPtr  pRenderModel) ;

/// @brief Method FreeTexture, addr 0x2981d30, size 0x24, virtual false, abstract: false, final false
inline void FreeTexture(::System::IntPtr  pTexture) ;

/// @brief Method FreeTextureD3D11, addr 0x2981d9c, size 0x24, virtual false, abstract: false, final false
inline void FreeTextureD3D11(::System::IntPtr  pD3D11Texture2D) ;

/// @brief Method GetComponentButtonMask, addr 0x2981e50, size 0x24, virtual false, abstract: false, final false
inline uint64_t GetComponentButtonMask(::StringW  pchRenderModelName, ::StringW  pchComponentName) ;

/// @brief Method GetComponentCount, addr 0x2981e08, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetComponentCount(::StringW  pchRenderModelName) ;

/// @brief Method GetComponentName, addr 0x2981e2c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetComponentRenderModelName, addr 0x2981e74, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetComponentState, addr 0x2981ebc, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method GetComponentStateForDevicePath, addr 0x2981e98, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetRenderModelCount, addr 0x2981de4, size 0x24, virtual false, abstract: false, final false
inline uint32_t GetRenderModelCount() ;

/// @brief Method GetRenderModelErrorNameFromEnum, addr 0x2982060, size 0x84, virtual false, abstract: false, final false
inline ::StringW GetRenderModelErrorNameFromEnum(::OVR::OpenVR::EVRRenderModelError  error) ;

/// @brief Method GetRenderModelName, addr 0x2981dc0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetRenderModelOriginalPath, addr 0x298203c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method GetRenderModelThumbnailURL, addr 0x2982018, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method LoadIntoTextureD3D11_Async, addr 0x2981d78, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRRenderModelError LoadIntoTextureD3D11_Async(int32_t  textureId, ::System::IntPtr  pDstTexture) ;

/// @brief Method LoadRenderModel_Async, addr 0x2981cc4, size 0x24, virtual false, abstract: false, final false
inline ::OVR::OpenVR::EVRRenderModelError LoadRenderModel_Async(::StringW  pchRenderModelName, ::ByRef<::System::IntPtr>  ppRenderModel) ;

/// @brief Method LoadTextureD3D11_Async, addr 0x2981d54, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method LoadTexture_Async, addr 0x2981d0c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method RenderModelHasComponent, addr 0x2981ff4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2981bb0, size 0x114, virtual false, abstract: false, final false
