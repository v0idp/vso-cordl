...
// Write type traits
MARK_REF_PTR_T(::Firebase::Firestore::Converters::UInt16Converter);
// Dependencies Firebase.Firestore.Converters.IntegerConverterBase
namespace Firebase::Firestore::Converters {
// Is value type: false
// CS Name: Firebase.Firestore.Converters.UInt16Converter
class CORDL_TYPE UInt16Converter : public ::Firebase::Firestore::Converters::IntegerConverterBase {
public:
// Declarations
/// @brief Method DeserializeInteger, addr 0x190f800, size 0x78, virtual true, abstract: false, final false
inline ::System::Object* DeserializeInteger(::Firebase::Firestore::DeserializationContext*  context, int64_t  value) ;

static inline ::Firebase::Firestore::Converters::UInt16Converter* New_ctor() ;

/// @brief Method Serialize, addr 0x190f790, size 0x70, virtual true, abstract: false, final false
inline ::Firebase::Firestore::FieldValueProxy* Serialize(::Firebase::Firestore::SerializationContext*  context, ::System::Object*  value) ;

/// @brief Method .ctor, addr 0x190f700, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::Firebase::Firestore::Converters::UInt16Converter, 0x18>, "Size mismatch!");
