...
// Write type traits
MARK_REF_PTR_T(::Firebase::Firestore::Converters::BooleanConverter);
// Dependencies Firebase.Firestore.Converters.ConverterBase
namespace Firebase::Firestore::Converters {
// Is value type: false
// CS Name: Firebase.Firestore.Converters.BooleanConverter
class CORDL_TYPE BooleanConverter : public ::Firebase::Firestore::Converters::ConverterBase {
public:
// Declarations
/// @brief Method DeserializeBoolean, addr 0x19102ac, size 0x5c, virtual true, abstract: false, final false
inline ::System::Object* DeserializeBoolean(::Firebase::Firestore::DeserializationContext*  context, bool  value) ;

static inline ::Firebase::Firestore::Converters::BooleanConverter* New_ctor() ;

/// @brief Method Serialize, addr 0x191023c, size 0x70, virtual true, abstract: false, final false
inline ::Firebase::Firestore::FieldValueProxy* Serialize(::Firebase::Firestore::SerializationContext*  context, ::System::Object*  value) ;

/// @brief Method .ctor, addr 0x19101ac, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::Firebase::Firestore::Converters::BooleanConverter, 0x18>, "Size mismatch!");
