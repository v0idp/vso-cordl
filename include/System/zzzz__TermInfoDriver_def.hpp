...
/// @brief Method AddStringMapping, addr 0x279b96c, size 0x4c, virtual false, abstract: false, final false
inline void AddStringMapping(::System::TermInfoStrings  s) ;

/// @brief Method AddToBuffer, addr 0x27984f4, size 0xec, virtual false, abstract: false, final false
inline void AddToBuffer(int32_t  b) ;

/// @brief Method AdjustBuffer, addr 0x2798700, size 0x14, virtual false, abstract: false, final false
inline void AdjustBuffer() ;

/// @brief Method CheckWindowDimensions, addr 0x27985e0, size 0x120, virtual false, abstract: false, final false
inline void CheckWindowDimensions() ;

/// @brief Method CreateKeyInfoFromInt, addr 0x27982c4, size 0x184, virtual false, abstract: false, final false
inline ::System::ConsoleKeyInfo CreateKeyInfoFromInt(int32_t  n, bool  alt) ;

/// @brief Method CreateKeyMap, addr 0x2799a64, size 0x1e98, virtual false, abstract: false, final false
inline void CreateKeyMap() ;

/// @brief Method Echo, addr 0x2799308, size 0x54, virtual false, abstract: false, final false
inline void Echo(::System::ConsoleKeyInfo  key) ;

/// @brief Method EchoFlush, addr 0x279935c, size 0x34, virtual false, abstract: false, final false
inline void EchoFlush() ;

/// @brief Method GetCursorPosition, addr 0x2797c90, size 0x290, virtual false, abstract: false, final false
inline void GetCursorPosition() ;

/// @brief Method GetKeyFromBuffer, addr 0x2798714, size 0x2bc, virtual false, abstract: false, final false
inline ::System::Object* GetKeyFromBuffer(bool  cooked) ;

/// @brief Method IncrementX, addr 0x2797f20, size 0x6c, virtual false, abstract: false, final false
inline void IncrementX() ;

/// @brief Method Init, addr 0x27973e4, size 0x7bc, virtual true, abstract: false, final true
inline void Init() ;

/// @brief Method InitKeys, addr 0x27990a4, size 0x168, virtual false, abstract: false, final false
inline void InitKeys() ;

/// @brief Method InputPending, addr 0x279920c, size 0x34, virtual false, abstract: false, final false
inline bool InputPending() ;

/// @brief Method IsSpecialKey, addr 0x27984cc, size 0x28, virtual false, abstract: false, final false
inline bool IsSpecialKey(char16_t  c) ;

/// @brief Method IsSpecialKey, addr 0x2798448, size 0x84, virtual false, abstract: false, final false
inline bool IsSpecialKey(::System::ConsoleKeyInfo  key) ;

static inline ::System::TermInfoDriver* New_ctor(::StringW  term) ;

/// @brief Method QueueEcho, addr 0x2799240, size 0xc8, virtual false, abstract: false, final false
inline void QueueEcho(char16_t  c) ;

/// @brief Method Read, addr 0x2799390, size 0x320, virtual false, abstract: false, final false
inline int32_t Read(::ByRef<::ArrayW<char16_t,::Array<char16_t>*>>  dest, int32_t  index, int32_t  count) ;

/// @brief Method ReadKey, addr 0x27996b0, size 0x64, virtual true, abstract: false, final true
inline ::System::ConsoleKeyInfo ReadKey(bool  intercept) ;

/// @brief Method ReadKeyInternal, addr 0x2798ee4, size 0x1c0, virtual false, abstract: false, final false
inline ::System::ConsoleKeyInfo ReadKeyInternal(::ByRef<bool>  fresh) ;

/// @brief Method ReadLine, addr 0x2799714, size 0x8, virtual true, abstract: false, final true
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x27998f8, size 0x8, virtual false, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method ReadUntilConditionInternal, addr 0x279971c, size 0x1dc, virtual false, abstract: false, final false
inline ::StringW ReadUntilConditionInternal(bool  haltOnNewLine) ;

/// @brief Method SearchTerminfo, addr 0x2796ef4, size 0x174, virtual false, abstract: false, final false
static inline ::StringW SearchTerminfo(::StringW  term) ;

/// @brief Method SetCursorPosition, addr 0x27980f8, size 0x1a4, virtual true, abstract: false, final true
inline void SetCursorPosition(int32_t  left, int32_t  top) ;

/// @brief Method TryTermInfoDir, addr 0x2796dc8, size 0x12c, virtual false, abstract: false, final false
static inline ::StringW TryTermInfoDir(::StringW  dir, ::StringW  term) ;

/// @brief Method WriteConsole, addr 0x2797068, size 0x28, virtual false, abstract: false, final false
inline void WriteConsole(::StringW  str) ;

/// @brief Method WriteSpecialKey, addr 0x279829c, size 0x28, virtual false, abstract: false, final false
inline void WriteSpecialKey(char16_t  c) ;

/// @brief Method WriteSpecialKey, addr 0x2797fe4, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x278e868, size 0x340, virtual false, abstract: false, final false
...
/// @brief Method get_Initialized, addr 0x27973dc, size 0x8, virtual true, abstract: false, final true
inline bool get_Initialized() ;

/// @brief Method get_WindowHeight, addr 0x2797fb8, size 0x2c, virtual true, abstract: false, final true
inline int32_t get_WindowHeight() ;

/// @brief Method get_WindowWidth, addr 0x2797f8c, size 0x2c, virtual true, abstract: false, final true
