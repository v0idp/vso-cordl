...
/// @brief Method PopulateDefaultValues, addr 0x278a348, size 0x4, virtual false, abstract: false, final false
static inline void PopulateDefaultValues() ;

/// @brief Method TryGetSwitchOverride, addr 0x278a34c, size 0xc, virtual false, abstract: false, final false
