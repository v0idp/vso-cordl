...
public:
// Declarations
/// @brief Method EatWhiteSpace, addr 0x2755ac8, size 0xcc, virtual false, abstract: false, final false
static inline void EatWhiteSpace(::System::ReadOnlySpan_1<char16_t>  s, ::ByRef<int32_t>  i) ;

/// @brief Method GrabInts, addr 0x275615c, size 0x220, virtual false, abstract: false, final false
static inline int32_t GrabInts(int32_t  radix, ::System::ReadOnlySpan_1<char16_t>  s, ::ByRef<int32_t>  i, bool  isUnsigned) ;

/// @brief Method GrabLongs, addr 0x2755b94, size 0x1f4, virtual false, abstract: false, final false
static inline int64_t GrabLongs(int32_t  radix, ::System::ReadOnlySpan_1<char16_t>  s, ::ByRef<int32_t>  i, bool  isUnsigned) ;

/// @brief Method IsDigit, addr 0x275683c, size 0x54, virtual false, abstract: false, final false
static inline bool IsDigit(char16_t  c, int32_t  radix, ::ByRef<int32_t>  result) ;

/// @brief Method LongToString, addr 0x275637c, size 0x3a0, virtual false, abstract: false, final false
static inline ::StringW LongToString(int64_t  n, int32_t  radix, int32_t  width, char16_t  paddingChar, int32_t  flags) ;

/// @brief Method StringToInt, addr 0x2755d88, size 0x18, virtual false, abstract: false, final false
static inline int32_t StringToInt(::System::ReadOnlySpan_1<char16_t>  s, int32_t  radix, int32_t  flags) ;

/// @brief Method StringToInt, addr 0x2755da0, size 0x3bc, virtual false, abstract: false, final false
static inline int32_t StringToInt(::System::ReadOnlySpan_1<char16_t>  s, int32_t  radix, int32_t  flags, ::ByRef<int32_t>  currPos) ;

/// @brief Method StringToLong, addr 0x275574c, size 0x18, virtual false, abstract: false, final false
static inline int64_t StringToLong(::System::ReadOnlySpan_1<char16_t>  s, int32_t  radix, int32_t  flags) ;

/// @brief Method StringToLong, addr 0x2755764, size 0x364, virtual false, abstract: false, final false
static inline int64_t StringToLong(::System::ReadOnlySpan_1<char16_t>  s, int32_t  radix, int32_t  flags, ::ByRef<int32_t>  currPos) ;

/// @brief Method ThrowOverflowInt32Exception, addr 0x27567ac, size 0x48, virtual false, abstract: false, final false
static inline void ThrowOverflowInt32Exception() ;

/// @brief Method ThrowOverflowInt64Exception, addr 0x275671c, size 0x48, virtual false, abstract: false, final false
static inline void ThrowOverflowInt64Exception() ;

/// @brief Method ThrowOverflowUInt32Exception, addr 0x27567f4, size 0x48, virtual false, abstract: false, final false
static inline void ThrowOverflowUInt32Exception() ;

/// @brief Method ThrowOverflowUInt64Exception, addr 0x2756764, size 0x48, virtual false, abstract: false, final false
