...
public:
// Declarations
/// @brief Method Invoke, addr 0x278e6a0, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x278e614, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method DoWindowsConsoleCancelEvent, addr 0x278e518, size 0x60, virtual false, abstract: false, final false
static inline bool DoWindowsConsoleCancelEvent(int32_t  keyCode) ;

/// @brief Method GetConsoleCP, addr 0x278e444, size 0x68, virtual false, abstract: false, final false
static inline int32_t GetConsoleCP() ;

/// @brief Method GetConsoleOutputCP, addr 0x278e4ac, size 0x6c, virtual false, abstract: false, final false
static inline int32_t GetConsoleOutputCP() ;

/// @brief Method GetInputCodePage, addr 0x278d55c, size 0x4c, virtual false, abstract: false, final false
static inline int32_t GetInputCodePage() ;

/// @brief Method GetOutputCodePage, addr 0x278d5a8, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method DoConsoleCancelEvent, addr 0x278e24c, size 0x1f8, virtual false, abstract: false, final false
static inline void DoConsoleCancelEvent() ;

/// @brief Method Open, addr 0x278dc8c, size 0x150, virtual false, abstract: false, final false
static inline ::System::IO::Stream* Open(::System::IntPtr  handle, ::System::IO::FileAccess  access, int32_t  bufferSize) ;

/// @brief Method OpenStandardError, addr 0x278dbfc, size 0x90, virtual false, abstract: false, final false
static inline ::System::IO::Stream* OpenStandardError(int32_t  bufferSize) ;

/// @brief Method OpenStandardInput, addr 0x278dadc, size 0x90, virtual false, abstract: false, final false
static inline ::System::IO::Stream* OpenStandardInput(int32_t  bufferSize) ;

/// @brief Method OpenStandardOutput, addr 0x278db6c, size 0x90, virtual false, abstract: false, final false
static inline ::System::IO::Stream* OpenStandardOutput(int32_t  bufferSize) ;

/// @brief Method ReadKey, addr 0x278e0c0, size 0x58, virtual false, abstract: false, final false
static inline ::System::ConsoleKeyInfo ReadKey() ;

/// @brief Method ReadKey, addr 0x278e118, size 0x5c, virtual false, abstract: false, final false
static inline ::System::ConsoleKeyInfo ReadKey(bool  intercept) ;

/// @brief Method SetError, addr 0x278dddc, size 0xe0, virtual false, abstract: false, final false
static inline void SetError(::System::IO::TextWriter*  newError) ;

/// @brief Method SetOut, addr 0x278debc, size 0xe0, virtual false, abstract: false, final false
static inline void SetOut(::System::IO::TextWriter*  newOut) ;

/// @brief Method SetupStreams, addr 0x278d5f4, size 0x3a8, virtual false, abstract: false, final false
static inline void SetupStreams(::System::Text::Encoding*  inputEncoding, ::System::Text::Encoding*  outputEncoding) ;

/// @brief Method WriteLine, addr 0x278df9c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method get_InputEncoding, addr 0x278e010, size 0x58, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* get_InputEncoding() ;

/// @brief Method get_OutputEncoding, addr 0x278e068, size 0x58, virtual false, abstract: false, final false
