...
/// @brief Method EnglishEraNames, addr 0x26f964c, size 0xd4, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> EnglishEraNames() ;

/// @brief Method EraNames, addr 0x26f9578, size 0xd4, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> EraNames() ;

/// @brief Method GetDayOfMonth, addr 0x26fe558, size 0x18, virtual true, abstract: false, final false
inline int32_t GetDayOfMonth(::System::DateTime  time) ;

/// @brief Method GetDayOfWeek, addr 0x26fe570, size 0x18, virtual true, abstract: false, final false
inline ::System::DayOfWeek GetDayOfWeek(::System::DateTime  time) ;

/// @brief Method GetDaysInMonth, addr 0x26fe528, size 0x18, virtual true, abstract: false, final false
inline int32_t GetDaysInMonth(int32_t  year, int32_t  month, int32_t  era) ;

/// @brief Method GetDaysInYear, addr 0x26fe540, size 0x18, virtual true, abstract: false, final false
inline int32_t GetDaysInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetDefaultInstance, addr 0x26fe2b8, size 0xb0, virtual false, abstract: false, final false
static inline ::System::Globalization::Calendar* GetDefaultInstance() ;

/// @brief Method GetEra, addr 0x26fe5ac, size 0x18, virtual true, abstract: false, final false
inline int32_t GetEra(::System::DateTime  time) ;

/// @brief Method GetEraInfo, addr 0x26fde58, size 0x458, virtual false, abstract: false, final false
static inline ::ArrayW<::System::Globalization::EraInfo*,::Array<::System::Globalization::EraInfo*>*> GetEraInfo() ;

/// @brief Method GetErasFromRegistry, addr 0x26fe2b0, size 0x8, virtual false, abstract: false, final false
static inline ::ArrayW<::System::Globalization::EraInfo*,::Array<::System::Globalization::EraInfo*>*> GetErasFromRegistry() ;

/// @brief Method GetMonth, addr 0x26fe5c4, size 0x18, virtual true, abstract: false, final false
inline int32_t GetMonth(::System::DateTime  time) ;

/// @brief Method GetMonthsInYear, addr 0x26fe588, size 0x24, virtual true, abstract: false, final false
inline int32_t GetMonthsInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetYear, addr 0x26fe5dc, size 0x18, virtual true, abstract: false, final false
inline int32_t GetYear(::System::DateTime  time) ;

/// @brief Method IsLeapYear, addr 0x26fe5f4, size 0x18, virtual true, abstract: false, final false
inline bool IsLeapYear(int32_t  year, int32_t  era) ;

/// @brief Method IsValidYear, addr 0x26fe790, size 0x28, virtual true, abstract: false, final false
inline bool IsValidYear(int32_t  year, int32_t  era) ;

static inline ::System::Globalization::JapaneseCalendar* New_ctor() ;

/// @brief Method ToDateTime, addr 0x26fe60c, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method ToFourDigitYear, addr 0x26fe62c, size 0x14c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26fe368, size 0x1b8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Eras, addr 0x26fe778, size 0x18, virtual true, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_Eras() ;

/// @brief Method get_ID, addr 0x26fe520, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ID() ;

/// @brief Method get_MaxSupportedDateTime, addr 0x26fde00, size 0x58, virtual true, abstract: false, final false
inline ::System::DateTime get_MaxSupportedDateTime() ;

/// @brief Method get_MinSupportedDateTime, addr 0x26fdda8, size 0x58, virtual true, abstract: false, final false
inline ::System::DateTime get_MinSupportedDateTime() ;

/// @brief Method get_TwoDigitYearMax, addr 0x26fe7b8, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method set_TwoDigitYearMax, addr 0x26fe7fc, size 0x138, virtual true, abstract: false, final false
