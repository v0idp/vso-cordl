...
/// @brief Method CheckTicksRange, addr 0x26fb6c4, size 0x1e4, virtual false, abstract: false, final false
inline void CheckTicksRange(int64_t  ticks) ;

/// @brief Method DateToTicks, addr 0x26fba98, size 0x80, virtual false, abstract: false, final false
static inline int64_t DateToTicks(int32_t  year, int32_t  month, int32_t  day) ;

/// @brief Method GetAbsoluteDate, addr 0x26fb8a8, size 0x1f0, virtual false, abstract: false, final false
static inline int64_t GetAbsoluteDate(int32_t  year, int32_t  month, int32_t  day) ;

/// @brief Method GetDatePart, addr 0x26fb4b4, size 0x210, virtual true, abstract: false, final false
inline int32_t GetDatePart(int64_t  ticks, int32_t  part) ;

/// @brief Method GetDayOfMonth, addr 0x26fbcc8, size 0x80, virtual false, abstract: false, final false
inline int32_t GetDayOfMonth(::System::DateTime  time) ;

/// @brief Method GetDayOfWeek, addr 0x26fbd48, size 0xcc, virtual false, abstract: false, final false
inline ::System::DayOfWeek GetDayOfWeek(::System::DateTime  time) ;

/// @brief Method GetDaysInMonth, addr 0x26fbe14, size 0x19c, virtual false, abstract: false, final false
inline int32_t GetDaysInMonth(int32_t  year, int32_t  month, int32_t  era) ;

/// @brief Method GetDaysInYear, addr 0x26fbfb0, size 0x6c, virtual false, abstract: false, final false
inline int32_t GetDaysInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetEra, addr 0x26fc01c, size 0x108, virtual false, abstract: false, final false
inline int32_t GetEra(::System::DateTime  time) ;

/// @brief Method GetGregorianYear, addr 0x26fb47c, size 0x1c, virtual false, abstract: false, final false
inline int32_t GetGregorianYear(int32_t  year, int32_t  era) ;

/// @brief Method GetMonth, addr 0x26fc214, size 0x80, virtual false, abstract: false, final false
inline int32_t GetMonth(::System::DateTime  time) ;

/// @brief Method GetMonthsInYear, addr 0x26fc294, size 0x18, virtual false, abstract: false, final false
inline int32_t GetMonthsInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetYear, addr 0x26fc2ac, size 0x128, virtual false, abstract: false, final false
inline int32_t GetYear(::System::DateTime  time) ;

/// @brief Method GetYearOffset, addr 0x26fb194, size 0x2e8, virtual false, abstract: false, final false
inline int32_t GetYearOffset(int32_t  year, int32_t  era, bool  throwOnError) ;

/// @brief Method IsLeapYear, addr 0x26fc3d4, size 0x70, virtual false, abstract: false, final false
inline bool IsLeapYear(int32_t  year, int32_t  era) ;

/// @brief Method IsValidYear, addr 0x26fb498, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method TimeToTicks, addr 0x26fbb18, size 0x1b0, virtual false, abstract: false, final false
static inline int64_t TimeToTicks(int32_t  hour, int32_t  minute, int32_t  second, int32_t  millisecond) ;

/// @brief Method ToDateTime, addr 0x26fc444, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method ToFourDigitYear, addr 0x26fc548, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26fb11c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method get_Eras, addr 0x26fc124, size 0xf0, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_Eras() ;

/// @brief Method get_MaxYear, addr 0x26fb114, size 0x8, virtual false, abstract: false, final false
