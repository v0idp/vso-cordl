...
/// @brief Method GetGlobalizationInvariantMode, addr 0x26f717c, size 0x8, virtual false, abstract: false, final false
static inline bool GetGlobalizationInvariantMode() ;

static inline bool getStaticF__Invariant_k__BackingField() ;

/// @brief Method get_Invariant, addr 0x26f7124, size 0x58, virtual false, abstract: false, final false
