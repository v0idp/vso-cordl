...
public:
// Declarations
/// @brief Method IsInvalidFraction, addr 0x26f4428, size 0x60, virtual false, abstract: false, final false
inline bool IsInvalidFraction() ;

/// @brief Method .ctor, addr 0x26f4400, size 0x14, virtual false, abstract: false, final false
inline void _ctor(int32_t  number) ;

/// @brief Method .ctor, addr 0x26f4414, size 0x14, virtual false, abstract: false, final false
inline void _ctor(int32_t  number, int32_t  leadingZeroes) ;

/// @brief Method .ctor, addr 0x26f43e0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Globalization::TimeSpanParse_TTT  type) ;

/// @brief Method .ctor, addr 0x26f43f0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method BackOne, addr 0x26f4748, size 0x14, virtual false, abstract: false, final false
inline void BackOne() ;

/// @brief Method GetNextToken, addr 0x26f44a0, size 0x25c, virtual false, abstract: false, final false
inline ::System::Globalization::TimeSpanParse_TimeSpanToken GetNextToken() ;

/// @brief Method .ctor, addr 0x26f4488, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::ReadOnlySpan_1<char16_t>  input) ;

/// @brief Method .ctor, addr 0x26f4494, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::ReadOnlySpan_1<char16_t>  input, int32_t  startPosition) ;

/// @brief Method get_EOL, addr 0x26f46fc, size 0x4c, virtual false, abstract: false, final false
inline bool get_EOL() ;

/// @brief Method get_NextChar, addr 0x26f475c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method AddNum, addr 0x26f6958, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method AddSep, addr 0x26f684c, size 0x10c, virtual false, abstract: false, final false
inline bool AddSep(::System::ReadOnlySpan_1<char16_t>  sep, ::ByRef<::System::Globalization::TimeSpanParse_TimeSpanResult>  result) ;

/// @brief Method FullAppCompatMatch, addr 0x26f49fc, size 0x3b0, virtual false, abstract: false, final false
inline bool FullAppCompatMatch(::System::Globalization::TimeSpanFormat_FormatLiterals  pattern) ;

/// @brief Method FullDHMMatch, addr 0x26f5948, size 0x314, virtual false, abstract: false, final false
inline bool FullDHMMatch(::System::Globalization::TimeSpanFormat_FormatLiterals  pattern) ;

/// @brief Method FullDHMSMatch, addr 0x26f5f70, size 0x3bc, virtual false, abstract: false, final false
inline bool FullDHMSMatch(::System::Globalization::TimeSpanFormat_FormatLiterals  pattern) ;

/// @brief Method FullDMatch, addr 0x26f5518, size 0x1c4, virtual false, abstract: false, final false
inline bool FullDMatch(::System::Globalization::TimeSpanFormat_FormatLiterals  pattern) ;

/// @brief Method FullHMMatch, addr 0x26f56dc, size 0x26c, virtual false, abstract: false, final false
inline bool FullHMMatch(::System::Globalization::TimeSpanFormat_FormatLiterals  pattern) ;

/// @brief Method FullHMSFMatch, addr 0x26f632c, size 0x3bc, virtual false, abstract: false, final false
inline bool FullHMSFMatch(::System::Globalization::TimeSpanFormat_FormatLiterals  pattern) ;

/// @brief Method FullHMSMatch, addr 0x26f5c5c, size 0x314, virtual false, abstract: false, final false
inline bool FullHMSMatch(::System::Globalization::TimeSpanFormat_FormatLiterals  pattern) ;

/// @brief Method FullMatch, addr 0x26f50b4, size 0x464, virtual false, abstract: false, final false
inline bool FullMatch(::System::Globalization::TimeSpanFormat_FormatLiterals  pattern) ;

/// @brief Method Init, addr 0x26f66e8, size 0x54, virtual false, abstract: false, final false
inline void Init(::System::Globalization::DateTimeFormatInfo*  dtfi) ;

/// @brief Method PartialAppCompatMatch, addr 0x26f4dac, size 0x308, virtual false, abstract: false, final false
inline bool PartialAppCompatMatch(::System::Globalization::TimeSpanFormat_FormatLiterals  pattern) ;

/// @brief Method ProcessToken, addr 0x26f673c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method get_NegativeInvariant, addr 0x26f4824, size 0x6c, virtual false, abstract: false, final false
inline ::System::Globalization::TimeSpanFormat_FormatLiterals get_NegativeInvariant() ;

/// @brief Method get_NegativeLocalized, addr 0x26f4944, size 0xb8, virtual false, abstract: false, final false
inline ::System::Globalization::TimeSpanFormat_FormatLiterals get_NegativeLocalized() ;

/// @brief Method get_PositiveInvariant, addr 0x26f47bc, size 0x68, virtual false, abstract: false, final false
inline ::System::Globalization::TimeSpanFormat_FormatLiterals get_PositiveInvariant() ;

/// @brief Method get_PositiveLocalized, addr 0x26f4890, size 0xb4, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method SetFailure, addr 0x26f6a68, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26f6b90, size 0x10, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method NextChar, addr 0x26f6ba0, size 0x4c, virtual false, abstract: false, final false
inline void NextChar() ;

/// @brief Method NextNonDigit, addr 0x26f6bec, size 0x5c, virtual false, abstract: false, final false
inline char16_t NextNonDigit() ;

/// @brief Method ParseInt, addr 0x26f700c, size 0x118, virtual false, abstract: false, final false
inline bool ParseInt(int32_t  max, ::ByRef<int32_t>  i, ::ByRef<::System::Globalization::TimeSpanParse_TimeSpanResult>  result) ;

/// @brief Method ParseTime, addr 0x26f6e4c, size 0x1c0, virtual false, abstract: false, final false
inline bool ParseTime(::ByRef<int64_t>  time, ::ByRef<::System::Globalization::TimeSpanParse_TimeSpanResult>  result) ;

/// @brief Method SkipBlanks, addr 0x26f6e1c, size 0x30, virtual false, abstract: false, final false
inline void SkipBlanks() ;

/// @brief Method TryParse, addr 0x26f6c48, size 0x1d4, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x26f16e8, size 0x58, virtual false, abstract: false, final false
static inline ::System::TimeSpan Parse(::System::ReadOnlySpan_1<char16_t>  input, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method ParseExactDigits, addr 0x26f4034, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method ParseExactDigits, addr 0x26f4004, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method ParseExactLiteral, addr 0x26f40f8, size 0x2e8, virtual false, abstract: false, final false
...
/// @brief Method Pow10, addr 0x26f1200, size 0x90, virtual false, abstract: false, final false
static inline int64_t Pow10(int32_t  pow) ;

/// @brief Method ProcessTerminalState, addr 0x26f1b00, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method ProcessTerminal_D, addr 0x26f1c3c, size 0x290, virtual false, abstract: false, final false
...
/// @brief Method ProcessTerminal_DHMSF, addr 0x26f3684, size 0x294, virtual false, abstract: false, final false
...
/// @brief Method ProcessTerminal_HM, addr 0x26f1ecc, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method ProcessTerminal_HMS_F_D, addr 0x26f2be4, size 0xaa0, virtual false, abstract: false, final false
...
/// @brief Method ProcessTerminal_HM_S_D, addr 0x26f2164, size 0xa80, virtual false, abstract: false, final false
...
/// @brief Method TryParseByFormat, addr 0x26f3950, size 0x6b4, virtual false, abstract: false, final false
...
/// @brief Method TryParseExact, addr 0x26f18e0, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method TryParseExactTimeSpan, addr 0x26f1974, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method TryParseTimeSpan, addr 0x26f1740, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method TryParseTimeSpanConstant, addr 0x26f3918, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method TryTimeToTicks, addr 0x26f1588, size 0x160, virtual false, abstract: false, final false
