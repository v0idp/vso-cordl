...
/// @brief Method GetObjectData, addr 0x26e8814, size 0x164, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26e85b8, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x26e8658, size 0x1bc, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x26e8644, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::StringW  paramName, ::StringW  message) ;

/// @brief Method get_DefaultMessage, addr 0x26e8604, size 0x40, virtual false, abstract: false, final false
static inline ::StringW get_DefaultMessage() ;

/// @brief Method get_FormatedInvalidCultureId, addr 0x26e8988, size 0x13c, virtual false, abstract: false, final false
inline ::StringW get_FormatedInvalidCultureId() ;

/// @brief Method get_InvalidCultureId, addr 0x26e8978, size 0x8, virtual true, abstract: false, final false
inline ::System::Nullable_1<int32_t> get_InvalidCultureId() ;

/// @brief Method get_InvalidCultureName, addr 0x26e8980, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_InvalidCultureName() ;

/// @brief Method get_Message, addr 0x26e8ac4, size 0xbc, virtual true, abstract: false, final false
