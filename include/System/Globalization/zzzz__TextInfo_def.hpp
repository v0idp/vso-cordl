...
/// @brief Method AddNonLetter, addr 0x2701b1c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method AddTitlecaseLetter, addr 0x27019a8, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method ChangeCase, addr 0x2701c44, size 0x140, virtual false, abstract: false, final false
inline void ChangeCase(::System::ReadOnlySpan_1<char16_t>  source, ::System::Span_1<char16_t>  destination, bool  toUpper) ;

/// @brief Method Clone, addr 0x2700740, size 0x88, virtual true, abstract: false, final false
inline ::System::Object* Clone() ;

/// @brief Method Equals, addr 0x270155c, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x27015fc, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IsAscii, addr 0x2700830, size 0x10, virtual false, abstract: false, final false
static inline bool IsAscii(char16_t  c) ;

/// @brief Method IsLetterCategory, addr 0x2701af4, size 0xc, virtual false, abstract: false, final false
static inline bool IsLetterCategory(::System::Globalization::UnicodeCategory  uc) ;

/// @brief Method IsWordSeparator, addr 0x2701b00, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnDeserialized, addr 0x27005c8, size 0xec, virtual false, abstract: false, final false
inline void OnDeserialized() ;

/// @brief Method OnDeserialized, addr 0x27006b4, size 0x4, virtual false, abstract: false, final false
inline void OnDeserialized(::System::Runtime::Serialization::StreamingContext  ctx) ;

/// @brief Method OnDeserializing, addr 0x27005c0, size 0x8, virtual false, abstract: false, final false
inline void OnDeserializing(::System::Runtime::Serialization::StreamingContext  ctx) ;

/// @brief Method OnSerializing, addr 0x27006b8, size 0x80, virtual false, abstract: false, final false
inline void OnSerializing(::System::Runtime::Serialization::StreamingContext  ctx) ;

/// @brief Method SetReadOnlyState, addr 0x27007c8, size 0xc, virtual false, abstract: false, final false
inline void SetReadOnlyState(bool  readOnly) ;

/// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization, addr 0x2701bb8, size 0x4, virtual true, abstract: false, final true
inline void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::System::Object*  sender) ;

/// @brief Method ToLower, addr 0x2700de0, size 0x54, virtual true, abstract: false, final false
inline ::StringW ToLower(::StringW  str) ;

/// @brief Method ToLower, addr 0x27007d4, size 0x5c, virtual true, abstract: false, final false
inline char16_t ToLower(char16_t  c) ;

/// @brief Method ToLowerAsciiInvariant, addr 0x2700944, size 0x18, virtual false, abstract: false, final false
static inline char16_t ToLowerAsciiInvariant(char16_t  c) ;

/// @brief Method ToLowerInternal, addr 0x2700e34, size 0xe4, virtual false, abstract: false, final false
inline ::StringW ToLowerInternal(::StringW  str) ;

/// @brief Method ToLowerInternal, addr 0x270095c, size 0x484, virtual false, abstract: false, final false
inline char16_t ToLowerInternal(char16_t  c) ;

/// @brief Method ToString, addr 0x270161c, size 0x58, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToTitleCase, addr 0x2701674, size 0x334, virtual false, abstract: false, final false
inline ::StringW ToTitleCase(::StringW  str) ;

/// @brief Method ToUpper, addr 0x2701424, size 0x54, virtual true, abstract: false, final false
inline ::StringW ToUpper(::StringW  str) ;

/// @brief Method ToUpper, addr 0x2700f18, size 0x5c, virtual true, abstract: false, final false
inline char16_t ToUpper(char16_t  c) ;

/// @brief Method ToUpperAsciiInvariant, addr 0x2700f74, size 0x18, virtual false, abstract: false, final false
static inline char16_t ToUpperAsciiInvariant(char16_t  c) ;

/// @brief Method ToUpperAsciiInvariant, addr 0x2701bbc, size 0x88, virtual false, abstract: false, final false
inline void ToUpperAsciiInvariant(::System::ReadOnlySpan_1<char16_t>  source, ::System::Span_1<char16_t>  destination) ;

/// @brief Method ToUpperInternal, addr 0x2701478, size 0xe4, virtual false, abstract: false, final false
inline ::StringW ToUpperInternal(::StringW  str) ;

/// @brief Method ToUpperInternal, addr 0x2700f8c, size 0x498, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2701d84, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2700584, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method get_CultureName, addr 0x2700738, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_CultureName() ;

/// @brief Method get_Invariant, addr 0x27001e4, size 0x94, virtual false, abstract: false, final false
static inline ::System::Globalization::TextInfo* get_Invariant() ;

/// @brief Method get_IsAsciiCasingSameAsInvariant, addr 0x2700840, size 0x104, virtual false, abstract: false, final false
