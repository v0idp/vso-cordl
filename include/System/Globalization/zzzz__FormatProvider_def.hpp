...
/// @brief Method get_digits, addr 0x2b27c94, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method FindSection, addr 0x2b27488, size 0x14c, virtual false, abstract: false, final false
static inline int32_t FindSection(::System::ReadOnlySpan_1<char16_t>  format, int32_t  section) ;

/// @brief Method FormatCurrency, addr 0x2b25d98, size 0x260, virtual false, abstract: false, final false
static inline void FormatCurrency(::ByRef<::System::Text::ValueStringBuilder>  sb, ::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, int32_t  nMinDigits, int32_t  nMaxDigits, ::System::Globalization::NumberFormatInfo*  info) ;

/// @brief Method FormatExponent, addr 0x2b27198, size 0x2f0, virtual false, abstract: false, final false
...
/// @brief Method FormatFixed, addr 0x2b25ff8, size 0x50c, virtual false, abstract: false, final false
static inline void FormatFixed(::ByRef<::System::Text::ValueStringBuilder>  sb, ::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, int32_t  nMinDigits, int32_t  nMaxDigits, ::System::Globalization::NumberFormatInfo*  info, ::ArrayW<int32_t,::Array<int32_t>*>  groupDigits, ::StringW  sDecimal, ::StringW  sGroup) ;

/// @brief Method FormatGeneral, addr 0x2b26988, size 0x388, virtual false, abstract: false, final false
static inline void FormatGeneral(::ByRef<::System::Text::ValueStringBuilder>  sb, ::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, int32_t  nMinDigits, int32_t  nMaxDigits, ::System::Globalization::NumberFormatInfo*  info, char16_t  expChar, bool  bSuppressScientific) ;

/// @brief Method FormatNumber, addr 0x2b26504, size 0x248, virtual false, abstract: false, final false
static inline void FormatNumber(::ByRef<::System::Text::ValueStringBuilder>  sb, ::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, int32_t  nMinDigits, int32_t  nMaxDigits, ::System::Globalization::NumberFormatInfo*  info) ;

/// @brief Method FormatPercent, addr 0x2b26d10, size 0x260, virtual false, abstract: false, final false
static inline void FormatPercent(::ByRef<::System::Text::ValueStringBuilder>  sb, ::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, int32_t  nMinDigits, int32_t  nMaxDigits, ::System::Globalization::NumberFormatInfo*  info) ;

/// @brief Method FormatScientific, addr 0x2b2674c, size 0x23c, virtual false, abstract: false, final false
static inline void FormatScientific(::ByRef<::System::Text::ValueStringBuilder>  sb, ::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, int32_t  nMinDigits, int32_t  nMaxDigits, ::System::Globalization::NumberFormatInfo*  info, char16_t  expChar) ;

/// @brief Method Int32ToDecChars, addr 0x2b25c6c, size 0x5c, virtual false, abstract: false, final false
static inline void Int32ToDecChars(::cordl_internals::Ptr<char16_t>  buffer, ::ByRef<int32_t>  index, uint32_t  value, int32_t  digits) ;

/// @brief Method IsWhite, addr 0x2b25390, size 0x28, virtual false, abstract: false, final false
static inline bool IsWhite(char16_t  ch) ;

/// @brief Method MatchChars, addr 0x2b253b8, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method MatchChars, addr 0x2b2547c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method NumberToString, addr 0x2b23c68, size 0x558, virtual false, abstract: false, final false
static inline void NumberToString(::ByRef<::System::Text::ValueStringBuilder>  sb, ::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, char16_t  format, int32_t  nMaxDigits, ::System::Globalization::NumberFormatInfo*  info, bool  isDecimal) ;

/// @brief Method NumberToStringFormat, addr 0x2b241c0, size 0x1098, virtual false, abstract: false, final false
static inline void NumberToStringFormat(::ByRef<::System::Text::ValueStringBuilder>  sb, ::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, ::System::ReadOnlySpan_1<char16_t>  format, ::System::Globalization::NumberFormatInfo*  info) ;

/// @brief Method ParseFormatSpecifier, addr 0x2b23b24, size 0x144, virtual false, abstract: false, final false
static inline char16_t ParseFormatSpecifier(::System::ReadOnlySpan_1<char16_t>  format, ::ByRef<int32_t>  digits) ;

/// @brief Method ParseNumber, addr 0x2b254d8, size 0x704, virtual false, abstract: false, final false
static inline bool ParseNumber(::ByRef<::cordl_internals::Ptr<char16_t>>  str, ::cordl_internals::Ptr<char16_t>  strEnd, ::System::Globalization::NumberStyles  options, ::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, ::System::Text::StringBuilder*  sb, ::System::Globalization::NumberFormatInfo*  numfmt, bool  parseDecimal) ;

/// @brief Method RoundNumber, addr 0x2b25cc8, size 0xd0, virtual false, abstract: false, final false
static inline void RoundNumber(::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, int32_t  pos) ;

/// @brief Method TrailingZeros, addr 0x2b25bdc, size 0x90, virtual false, abstract: false, final false
static inline bool TrailingZeros(::System::ReadOnlySpan_1<char16_t>  s, int32_t  index) ;

/// @brief Method TryStringToNumber, addr 0x2b25258, size 0x138, virtual false, abstract: false, final false
static inline bool TryStringToNumber(::System::ReadOnlySpan_1<char16_t>  str, ::System::Globalization::NumberStyles  options, ::ByRef<::System::Globalization::Number_FormatProvider_NumberBuffer>  number, ::System::Text::StringBuilder*  sb, ::System::Globalization::NumberFormatInfo*  numfmt, bool  parseDecimal) ;
...
/// @brief Method wcslen, addr 0x2b26f70, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method FormatBigInteger, addr 0x2b239c0, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method TryStringToBigInteger, addr 0x2b22020, size 0xf4, virtual false, abstract: false, final false
