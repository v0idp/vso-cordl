...
/// @brief Method Convert, addr 0x27105e8, size 0x1f8, virtual false, abstract: false, final false
inline ::StringW Convert(::StringW  input, int32_t  index, int32_t  count, bool  toAscii) ;

/// @brief Method Equals, addr 0x2710424, size 0x8c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetAscii, addr 0x27104c0, size 0x60, virtual false, abstract: false, final false
inline ::StringW GetAscii(::StringW  unicode) ;

/// @brief Method GetAscii, addr 0x2710520, size 0xc8, virtual false, abstract: false, final false
inline ::StringW GetAscii(::StringW  unicode, int32_t  index, int32_t  count) ;

/// @brief Method GetHashCode, addr 0x27104b0, size 0x10, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetUnicode, addr 0x2711530, size 0x60, virtual false, abstract: false, final false
inline ::StringW GetUnicode(::StringW  ascii) ;

/// @brief Method GetUnicode, addr 0x2711590, size 0xc8, virtual false, abstract: false, final false
inline ::StringW GetUnicode(::StringW  ascii, int32_t  index, int32_t  count) ;

/// @brief Method NamePrep, addr 0x2710be0, size 0x144, virtual false, abstract: false, final false
inline ::StringW NamePrep(::StringW  s, int32_t  offset) ;

static inline ::System::Globalization::IdnMapping* New_ctor() ;

/// @brief Method ToAscii, addr 0x27107e0, size 0x234, virtual false, abstract: false, final false
inline ::StringW ToAscii(::StringW  s, int32_t  offset) ;

/// @brief Method ToUnicode, addr 0x2710a14, size 0x1cc, virtual false, abstract: false, final false
inline ::StringW ToUnicode(::StringW  s, int32_t  offset) ;

/// @brief Method VerifyLength, addr 0x2711234, size 0xc4, virtual false, abstract: false, final false
inline void VerifyLength(::StringW  s, int32_t  offset) ;

/// @brief Method VerifyProhibitedCharacters, addr 0x27112f8, size 0x238, virtual false, abstract: false, final false
inline void VerifyProhibitedCharacters(::StringW  s, int32_t  offset) ;

/// @brief Method VerifyStd3AsciiRules, addr 0x2710d24, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x271035c, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
