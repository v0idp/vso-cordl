...
/// @brief Method Adapt, addr 0x27119b4, size 0x78, virtual false, abstract: false, final false
inline int32_t Adapt(int32_t  delta, int32_t  numPoints, bool  firstTime) ;

/// @brief Method Decode, addr 0x2711658, size 0x2d8, virtual false, abstract: false, final false
inline ::StringW Decode(::StringW  s, int32_t  offset) ;

/// @brief Method DecodeDigit, addr 0x2711a2c, size 0x40, virtual false, abstract: false, final false
inline int32_t DecodeDigit(char16_t  c) ;

/// @brief Method Encode, addr 0x2710eec, size 0x348, virtual false, abstract: false, final false
inline ::StringW Encode(::StringW  s, int32_t  offset) ;

/// @brief Method EncodeDigit, addr 0x271199c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2711930, size 0x6c, virtual false, abstract: false, final false
