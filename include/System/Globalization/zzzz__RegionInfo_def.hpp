...
/// @brief Method ClearCachedData, addr 0x2712194, size 0x48, virtual false, abstract: false, final false
static inline void ClearCachedData() ;

/// @brief Method Equals, addr 0x2712090, size 0xc8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetByTerritory, addr 0x2711dc4, size 0xa8, virtual false, abstract: false, final false
inline bool GetByTerritory(::System::Globalization::CultureInfo*  ci) ;

/// @brief Method GetHashCode, addr 0x2712158, size 0x2c, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x2712184, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2711b2c, size 0x194, virtual false, abstract: false, final false
inline void _ctor(::System::Globalization::CultureInfo*  ci) ;

/// @brief Method .ctor, addr 0x2711cc0, size 0x104, virtual false, abstract: false, final false
inline void _ctor(int32_t  culture) ;

/// @brief Method .ctor, addr 0x2711e6c, size 0x134, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method construct_internal_region_from_name, addr 0x2711fa0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_CurrencyEnglishName, addr 0x2711fa4, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_CurrencyEnglishName() ;

/// @brief Method get_CurrencyNativeName, addr 0x2712068, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_CurrencyNativeName() ;

/// @brief Method get_CurrencySymbol, addr 0x2711fac, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_CurrencySymbol() ;

/// @brief Method get_CurrentRegion, addr 0x2711a6c, size 0xc0, virtual false, abstract: false, final false
static inline ::System::Globalization::RegionInfo* get_CurrentRegion() ;

/// @brief Method get_DisplayName, addr 0x2711fb4, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_DisplayName() ;

/// @brief Method get_EnglishName, addr 0x2711fbc, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_EnglishName() ;

/// @brief Method get_GeoId, addr 0x2711fc4, size 0x8, virtual true, abstract: false, final false
inline int32_t get_GeoId() ;

/// @brief Method get_ISOCurrencySymbol, addr 0x2712058, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_ISOCurrencySymbol() ;

/// @brief Method get_IsMetric, addr 0x2711fcc, size 0x8c, virtual true, abstract: false, final false
inline bool get_IsMetric() ;

/// @brief Method get_Name, addr 0x2712070, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NativeName, addr 0x2712060, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_NativeName() ;

/// @brief Method get_ThreeLetterISORegionName, addr 0x2712078, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_ThreeLetterISORegionName() ;

/// @brief Method get_ThreeLetterWindowsRegionName, addr 0x2712080, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_ThreeLetterWindowsRegionName() ;

/// @brief Method get_TwoLetterISORegionName, addr 0x2712088, size 0x8, virtual true, abstract: false, final false
