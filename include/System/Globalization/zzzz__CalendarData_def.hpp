...
/// @brief Method CalendarIdToCultureName, addr 0x26f9720, size 0xcc, virtual false, abstract: false, final false
static inline ::StringW CalendarIdToCultureName(int32_t  calendarId) ;

/// @brief Method GetCalendarData, addr 0x26f7430, size 0xa4, virtual false, abstract: false, final false
static inline ::System::Globalization::CalendarData* GetCalendarData(int32_t  calendarId) ;

/// @brief Method GetJapaneseEnglishEraNames, addr 0x26f93b0, size 0xe4, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> GetJapaneseEnglishEraNames() ;

/// @brief Method GetJapaneseEraNames, addr 0x26f9494, size 0xe4, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> GetJapaneseEraNames() ;

/// @brief Method InitializeAbbreviatedEraNames, addr 0x26f90f4, size 0x2bc, virtual false, abstract: false, final false
inline void InitializeAbbreviatedEraNames(::StringW  localeName, int32_t  calendarId) ;

/// @brief Method InitializeEraNames, addr 0x26f8d28, size 0x3cc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26f7b1c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x26f8774, size 0x4f4, virtual false, abstract: false, final false
inline void _ctor(::StringW  localeName, int32_t  calendarId, bool  bUseUserOverrides) ;

/// @brief Method fill_calendar_data, addr 0x26f9900, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method nativeGetCalendarData, addr 0x26f8c68, size 0xb8, virtual false, abstract: false, final false
static inline bool nativeGetCalendarData(::System::Globalization::CalendarData*  data, ::StringW  localeName, int32_t  calendarId) ;

/// @brief Method nativeGetTwoDigitYearMax, addr 0x26f7b14, size 0x8, virtual false, abstract: false, final false
