...
/// @brief Field m_flags, offset 0x28, size 0x4 
 __declspec(property(get=__cordl_internal_get_m_flags, put=__cordl_internal_set_m_flags)) uint32_t  m_flags;

/// @brief Field m_headerName, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_headerName, put=__cordl_internal_set_m_headerName)) ::StringW  m_headerName;
...
/// @brief Method CreateString, addr 0x2704ddc, size 0xb4, virtual false, abstract: false, final false
...
constexpr ::StringW const& __cordl_internal_get_m_headerName() const;

constexpr ::StringW& __cordl_internal_get_m_headerName() ;
...
constexpr void __cordl_internal_set_m_headerName(::StringW  value) ;
...
/// @brief Method .ctor, addr 0x2704d38, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(int32_t  dataIndex) ;

static inline ::ArrayW<char16_t,::Array<char16_t>*> getStaticF_sep() ;

/// @brief Method get_HeaderName, addr 0x2704f4c, size 0xbc, virtual false, abstract: false, final false
inline ::StringW get_HeaderName() ;

/// @brief Method get_WebName, addr 0x2704e90, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Field m_headerName, offset: 0x20, size: 0x8, def value: None
 ::StringW  ___m_headerName;
...
static_assert(offsetof(::System::Globalization::CodePageDataItem, ___m_headerName) == 0x20, "Offset mismatch!");

static_assert(offsetof(::System::Globalization::CodePageDataItem, ___m_flags) == 0x28, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::System::Globalization::CodePageDataItem, 0x30>, "Size mismatch!");
