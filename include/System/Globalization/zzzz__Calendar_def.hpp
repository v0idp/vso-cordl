...
/// @brief Method Clone, addr 0x26f72a4, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method GetSystemTwoDigitYearSetting, addr 0x26f7ac0, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method IsLeapYear, addr 0x26f74d4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method IsValidDay, addr 0x26f776c, size 0x80, virtual true, abstract: false, final false
inline bool IsValidDay(int32_t  year, int32_t  month, int32_t  day, int32_t  era) ;

/// @brief Method IsValidMonth, addr 0x26f76f4, size 0x78, virtual true, abstract: false, final false
inline bool IsValidMonth(int32_t  year, int32_t  month, int32_t  era) ;

/// @brief Method IsValidYear, addr 0x26f7670, size 0x84, virtual true, abstract: false, final false
inline bool IsValidYear(int32_t  year, int32_t  era) ;

static inline ::System::Globalization::Calendar* New_ctor() ;

/// @brief Method SetReadOnlyState, addr 0x26f7398, size 0xc, virtual false, abstract: false, final false
inline void SetReadOnlyState(bool  readOnly) ;

/// @brief Method TimeToTicks, addr 0x26f7910, size 0x1b0, virtual false, abstract: false, final false
static inline int64_t TimeToTicks(int32_t  hour, int32_t  minute, int32_t  second, int32_t  millisecond) ;

/// @brief Method ToDateTime, addr 0x26f74e8, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method ToFourDigitYear, addr 0x26f7818, size 0xf8, virtual true, abstract: false, final false
inline int32_t ToFourDigitYear(int32_t  year) ;

/// @brief Method TryToDateTime, addr 0x26f7510, size 0x160, virtual true, abstract: false, final false
...
/// @brief Method VerifyWritable, addr 0x26f732c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26f727c, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BaseCalendarID, addr 0x26f7298, size 0xc, virtual true, abstract: false, final false
inline int32_t get_BaseCalendarID() ;

/// @brief Method get_CurrentEraValue, addr 0x26f73a4, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method get_ID, addr 0x26f7290, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ID() ;

/// @brief Method get_MaxSupportedDateTime, addr 0x26f7224, size 0x58, virtual true, abstract: false, final false
inline ::System::DateTime get_MaxSupportedDateTime() ;

/// @brief Method get_MinSupportedDateTime, addr 0x26f71cc, size 0x58, virtual true, abstract: false, final false
inline ::System::DateTime get_MinSupportedDateTime() ;

/// @brief Method get_TwoDigitYearMax, addr 0x26f77ec, size 0x8, virtual true, abstract: false, final false
inline int32_t get_TwoDigitYearMax() ;

/// @brief Convert to "::System::ICloneable"
constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

/// @brief Method set_TwoDigitYearMax, addr 0x26f77f4, size 0x24, virtual true, abstract: false, final false
