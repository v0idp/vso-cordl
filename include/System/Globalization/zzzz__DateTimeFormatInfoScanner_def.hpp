...
/// @brief Method AddDateWordOrPostfix, addr 0x26eeafc, size 0x2bc, virtual false, abstract: false, final false
inline void AddDateWordOrPostfix(::StringW  formatPostfix, ::StringW  str) ;

/// @brief Method AddDateWords, addr 0x26eef08, size 0x1e0, virtual false, abstract: false, final false
inline int32_t AddDateWords(::StringW  pattern, int32_t  index, ::StringW  formatPostfix) ;

/// @brief Method AddIgnorableSymbols, addr 0x26eedb8, size 0x150, virtual false, abstract: false, final false
inline void AddIgnorableSymbols(::StringW  text) ;

/// @brief Method ArrayElementsBeginWithDigit, addr 0x26ef458, size 0x25c, virtual false, abstract: false, final false
static inline bool ArrayElementsBeginWithDigit(::ArrayW<::StringW,::Array<::StringW>*>  array) ;

/// @brief Method ArrayElementsHaveSpace, addr 0x26ef6b4, size 0xf8, virtual false, abstract: false, final false
static inline bool ArrayElementsHaveSpace(::ArrayW<::StringW,::Array<::StringW>*>  array) ;

/// @brief Method EqualStringArrays, addr 0x26ef3a8, size 0xb0, virtual false, abstract: false, final false
static inline bool EqualStringArrays(::ArrayW<::StringW,::Array<::StringW>*>  array1, ::ArrayW<::StringW,::Array<::StringW>*>  array2) ;

/// @brief Method GetDateWordsOfDTFI, addr 0x26ed454, size 0x290, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> GetDateWordsOfDTFI(::System::Globalization::DateTimeFormatInfo*  dtfi) ;

/// @brief Method GetFormatFlagGenitiveMonth, addr 0x26eb874, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method GetFormatFlagUseHebrewCalendar, addr 0x26eb9a4, size 0x10, virtual false, abstract: false, final false
static inline ::System::Globalization::FORMATFLAGS GetFormatFlagUseHebrewCalendar(int32_t  calID) ;

/// @brief Method GetFormatFlagUseSpaceInDayNames, addr 0x26eb974, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetFormatFlagUseSpaceInMonthNames, addr 0x26eb8b4, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method ScanDateWord, addr 0x26ef16c, size 0x23c, virtual false, abstract: false, final false
inline void ScanDateWord(::StringW  pattern) ;

/// @brief Method ScanRepeatChar, addr 0x26ef0e8, size 0x84, virtual false, abstract: false, final false
static inline int32_t ScanRepeatChar(::StringW  pattern, char16_t  ch, int32_t  index, ::ByRef<int32_t>  count) ;

/// @brief Method SkipWhiteSpacesAndNonLetter, addr 0x26eea00, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26ed3d8, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>* getStaticF_s_knownWords() ;

/// @brief Method get_KnownWords, addr 0x26ee618, size 0x3e8, virtual false, abstract: false, final false
