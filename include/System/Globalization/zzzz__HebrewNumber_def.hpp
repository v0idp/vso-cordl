...
public:
// Declarations
/// @brief Method .ctor, addr 0x26efcec, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field s_hebrewValues, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_hebrewValues, put=setStaticF_s_hebrewValues)) ::ArrayW<::System::Globalization::HebrewNumber_HebrewValue,::Array<::System::Globalization::HebrewNumber_HebrewValue>*>  s_hebrewValues;
...
/// @brief Field s_numberPasingState, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_numberPasingState, put=setStaticF_s_numberPasingState)) ::ArrayW<::System::Globalization::HebrewNumber_HS,::Array<::System::Globalization::HebrewNumber_HS>*>  s_numberPasingState;

/// @brief Method IsDigit, addr 0x26ed980, size 0xd0, virtual false, abstract: false, final false
static inline bool IsDigit(char16_t  ch) ;

/// @brief Method ParseByChar, addr 0x26eda5c, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x26ef7b8, size 0x284, virtual false, abstract: false, final false
