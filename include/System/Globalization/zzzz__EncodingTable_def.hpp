...
/// @brief Method ENC, addr 0x27050f0, size 0x8, virtual false, abstract: false, final false
static inline ::System::Globalization::InternalEncodingDataItem ENC(::StringW  name, uint16_t  cp) ;

/// @brief Method GetCodePageDataItem, addr 0x270aa8c, size 0x2bc, virtual false, abstract: false, final false
static inline ::System::Globalization::CodePageDataItem* GetCodePageDataItem(int32_t  codepage) ;

/// @brief Method GetCodePageFromName, addr 0x270a810, size 0x27c, virtual false, abstract: false, final false
static inline int32_t GetCodePageFromName(::StringW  name) ;

/// @brief Method GetNumEncodingItems, addr 0x270508c, size 0x64, virtual false, abstract: false, final false
static inline int32_t GetNumEncodingItems() ;

/// @brief Method MapCodePageDataItem, addr 0x27050f8, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method internalGetCodePageFromName, addr 0x270a5bc, size 0x254, virtual false, abstract: false, final false
