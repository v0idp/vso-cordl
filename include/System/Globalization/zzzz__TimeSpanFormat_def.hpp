...
/// @brief Method Init, addr 0x26f0e84, size 0x37c, virtual false, abstract: false, final false
inline void Init(::System::ReadOnlySpan_1<char16_t>  format, bool  useInvariantFieldLengths) ;

/// @brief Method InitInvariant, addr 0x26f1428, size 0x160, virtual false, abstract: false, final false
static inline ::System::Globalization::TimeSpanFormat_FormatLiterals InitInvariant(bool  isNegative) ;

/// @brief Method get_DayHourSep, addr 0x26f12b8, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_DayHourSep() ;

/// @brief Method get_End, addr 0x26f1368, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_End() ;

/// @brief Method get_HourMinuteSep, addr 0x26f12e4, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_HourMinuteSep() ;

/// @brief Method get_MinuteSecondSep, addr 0x26f1310, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_MinuteSecondSep() ;

/// @brief Method get_SecondFractionSep, addr 0x26f133c, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_SecondFractionSep() ;

/// @brief Method get_Start, addr 0x26f1290, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method AppendNonNegativeInt32, addr 0x26efcf8, size 0xf8, virtual false, abstract: false, final false
static inline void AppendNonNegativeInt32(::System::Text::StringBuilder*  sb, int32_t  n, int32_t  digits) ;

/// @brief Method Format, addr 0x26efdf0, size 0xb8, virtual false, abstract: false, final false
static inline ::StringW Format(::System::TimeSpan  value, ::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method FormatCustomized, addr 0x26f0764, size 0x720, virtual false, abstract: false, final false
...
/// @brief Method FormatStandard, addr 0x26f02a0, size 0x4c4, virtual false, abstract: false, final false
...
/// @brief Method FormatToBuilder, addr 0x26efea8, size 0x2d8, virtual false, abstract: false, final false
...
/// @brief Method TryFormat, addr 0x26f0180, size 0x120, virtual false, abstract: false, final false
