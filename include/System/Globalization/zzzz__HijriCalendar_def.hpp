...
/// @brief Method CheckEraRange, addr 0x26fcc44, size 0xcc, virtual false, abstract: false, final false
static inline void CheckEraRange(int32_t  era) ;

/// @brief Method CheckTicksRange, addr 0x26fca64, size 0x1e0, virtual false, abstract: false, final false
static inline void CheckTicksRange(int64_t  ticks) ;

/// @brief Method CheckYearMonthRange, addr 0x26fce64, size 0x184, virtual false, abstract: false, final false
static inline void CheckYearMonthRange(int32_t  year, int32_t  month, int32_t  era) ;

/// @brief Method CheckYearRange, addr 0x26fcd10, size 0x154, virtual false, abstract: false, final false
static inline void CheckYearRange(int32_t  year, int32_t  era) ;

/// @brief Method DaysUpToHijriYear, addr 0x26fc938, size 0xbc, virtual false, abstract: false, final false
inline int64_t DaysUpToHijriYear(int32_t  HijriYear) ;

/// @brief Method GetAbsoluteDateHijri, addr 0x26fc870, size 0xc8, virtual false, abstract: false, final false
inline int64_t GetAbsoluteDateHijri(int32_t  y, int32_t  m, int32_t  d) ;

/// @brief Method GetAdvanceHijriDate, addr 0x26fca5c, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetAdvanceHijriDate() ;

/// @brief Method GetDatePart, addr 0x26fcfe8, size 0x270, virtual true, abstract: false, final false
inline int32_t GetDatePart(int64_t  ticks, int32_t  part) ;

/// @brief Method GetDayOfMonth, addr 0x26fd258, size 0x84, virtual true, abstract: false, final false
inline int32_t GetDayOfMonth(::System::DateTime  time) ;

/// @brief Method GetDayOfWeek, addr 0x26fd2dc, size 0xa8, virtual true, abstract: false, final false
inline ::System::DayOfWeek GetDayOfWeek(::System::DateTime  time) ;

/// @brief Method GetDaysInMonth, addr 0x26fd384, size 0xcc, virtual true, abstract: false, final false
inline int32_t GetDaysInMonth(int32_t  year, int32_t  month, int32_t  era) ;

/// @brief Method GetDaysInYear, addr 0x26fd450, size 0x94, virtual true, abstract: false, final false
inline int32_t GetDaysInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetEra, addr 0x26fd4e4, size 0x9c, virtual true, abstract: false, final false
inline int32_t GetEra(::System::DateTime  time) ;

/// @brief Method GetMonth, addr 0x26fd61c, size 0x84, virtual true, abstract: false, final false
inline int32_t GetMonth(::System::DateTime  time) ;

/// @brief Method GetMonthsInYear, addr 0x26fd6a0, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetMonthsInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetYear, addr 0x26fd70c, size 0x84, virtual true, abstract: false, final false
inline int32_t GetYear(::System::DateTime  time) ;

/// @brief Method IsLeapYear, addr 0x26fd790, size 0xa0, virtual true, abstract: false, final false
inline bool IsLeapYear(int32_t  year, int32_t  era) ;

static inline ::System::Globalization::HijriCalendar* New_ctor() ;

/// @brief Method ToDateTime, addr 0x26fd830, size 0x1d4, virtual true, abstract: false, final false
...
/// @brief Method ToFourDigitYear, addr 0x26fdb5c, size 0x138, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26fc84c, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Eras, addr 0x26fd580, size 0x9c, virtual true, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_Eras() ;

/// @brief Method get_HijriAdjustment, addr 0x26fc9f4, size 0x68, virtual false, abstract: false, final false
inline int32_t get_HijriAdjustment() ;

/// @brief Method get_ID, addr 0x26fc868, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ID() ;

/// @brief Method get_MaxSupportedDateTime, addr 0x26fc7f4, size 0x58, virtual true, abstract: false, final false
inline ::System::DateTime get_MaxSupportedDateTime() ;

/// @brief Method get_MinSupportedDateTime, addr 0x26fc79c, size 0x58, virtual true, abstract: false, final false
inline ::System::DateTime get_MinSupportedDateTime() ;

/// @brief Method get_TwoDigitYearMax, addr 0x26fda04, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method set_TwoDigitYearMax, addr 0x26fda48, size 0x114, virtual true, abstract: false, final false
