...
/// @brief Method Compare, addr 0x275c2d0, size 0x10, virtual true, abstract: false, final false
inline int32_t Compare(::StringW  x, ::StringW  y) ;

/// @brief Method Equals, addr 0x275c2e0, size 0x10, virtual true, abstract: false, final false
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode, addr 0x275c2f0, size 0x28, virtual true, abstract: false, final false
inline int32_t GetHashCode(::StringW  obj) ;

/// @brief Method GetObjectData, addr 0x275c318, size 0xb4, virtual true, abstract: false, final true
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

static inline ::System::OrdinalCaseSensitiveComparer* New_ctor() ;

/// @brief Method .ctor, addr 0x275ba3c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
