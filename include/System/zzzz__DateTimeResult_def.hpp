...
public:
// Declarations
/// @brief Method Init, addr 0x273ed50, size 0x24, virtual false, abstract: false, final false
inline void Init(::System::ReadOnlySpan_1<char16_t>  originalDateTimeString) ;

/// @brief Method SetBadDateTimeFailure, addr 0x273ee78, size 0x50, virtual false, abstract: false, final false
inline void SetBadDateTimeFailure() ;

/// @brief Method SetBadFormatSpecifierFailure, addr 0x273ed80, size 0x94, virtual false, abstract: false, final false
inline void SetBadFormatSpecifierFailure() ;

/// @brief Method SetBadFormatSpecifierFailure, addr 0x273ee14, size 0x64, virtual false, abstract: false, final false
inline void SetBadFormatSpecifierFailure(::System::ReadOnlySpan_1<char16_t>  failedFormatSpecifier) ;

/// @brief Method SetDate, addr 0x273ed74, size 0xc, virtual false, abstract: false, final false
inline void SetDate(int32_t  year, int32_t  month, int32_t  day) ;

/// @brief Method SetFailure, addr 0x273eec8, size 0xc, virtual false, abstract: false, final false
inline void SetFailure(::System::ParseFailureKind  failure, ::StringW  failureMessageID) ;

/// @brief Method SetFailure, addr 0x273eed4, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method SetFailure, addr 0x273eee0, size 0x10, virtual false, abstract: false, final false
