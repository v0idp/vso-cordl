...
/// @brief Method .ctor, addr 0x26cef7c, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x26cefd8, size 0x8, virtual false, abstract: false, final false
...
static constexpr uint32_t  __IL2CPP_TYPE_DEFINITION_INDEX{2032};
