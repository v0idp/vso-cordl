...
/// @brief Method GetArrayRank, addr 0x268d394, size 0x8, virtual true, abstract: false, final true
inline int32_t GetArrayRank() ;

/// @brief Method IsArrayImpl, addr 0x268d364, size 0x8, virtual true, abstract: false, final true
inline bool IsArrayImpl() ;

/// @brief Method IsByRefImpl, addr 0x268d36c, size 0x8, virtual true, abstract: false, final true
inline bool IsByRefImpl() ;

/// @brief Method IsPointerImpl, addr 0x268d374, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x268d304, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::System::Reflection::SignatureType*  elementType, int32_t  rank, bool  isMultiDim) ;

/// @brief Method get_IsSZArray, addr 0x268d37c, size 0x10, virtual true, abstract: false, final true
inline bool get_IsSZArray() ;

/// @brief Method get_IsVariableBoundArray, addr 0x268d38c, size 0x8, virtual true, abstract: false, final true
inline bool get_IsVariableBoundArray() ;

/// @brief Method get_Suffix, addr 0x268d39c, size 0xc8, virtual true, abstract: false, final true
