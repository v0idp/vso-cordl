...
/// @brief Method .ctor, addr 0x2689bf8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  memberName) ;

/// @brief Method get_MemberName, addr 0x2689c20, size 0x8, virtual false, abstract: false, final false
