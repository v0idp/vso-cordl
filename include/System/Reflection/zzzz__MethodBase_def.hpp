...
/// @brief Method ConstructParameters, addr 0x268b8d8, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x26899e0, size 0x8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method FormatNameAndSig, addr 0x268b7b4, size 0x124, virtual true, abstract: false, final false
inline ::StringW FormatNameAndSig(bool  serialization) ;

/// @brief Method GetGenericArguments, addr 0x268b6c4, size 0x4c, virtual true, abstract: false, final false
inline ::ArrayW<::System::Type*,::Array<::System::Type*>*> GetGenericArguments() ;

/// @brief Method GetHashCode, addr 0x26899f0, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetMethodFromHandle, addr 0x268bbe8, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method GetParameterTypes, addr 0x268bad0, size 0x108, virtual true, abstract: false, final false
...
/// @brief Method GetParametersCount, addr 0x268b78c, size 0x28, virtual true, abstract: false, final false
inline int32_t GetParametersCount() ;

/// @brief Method GetParametersInternal, addr 0x268b77c, size 0x10, virtual true, abstract: false, final false
inline ::ArrayW<::System::Reflection::ParameterInfo*,::Array<::System::Reflection::ParameterInfo*>*> GetParametersInternal() ;

/// @brief Method GetParametersNoCopy, addr 0x268bbd8, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method Invoke, addr 0x2689ea4, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x26899a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_CallingConvention, addr 0x268b580, size 0x8, virtual true, abstract: false, final false
inline ::System::Reflection::CallingConventions get_CallingConvention() ;

/// @brief Method get_ContainsGenericParameters, addr 0x268b710, size 0x8, virtual true, abstract: false, final false
inline bool get_ContainsGenericParameters() ;

/// @brief Method get_IsAbstract, addr 0x268b588, size 0x20, virtual true, abstract: false, final true
inline bool get_IsAbstract() ;

/// @brief Method get_IsConstructor, addr 0x268b5a8, size 0xa4, virtual true, abstract: false, final true
inline bool get_IsConstructor() ;

/// @brief Method get_IsGenericMethod, addr 0x268b6b4, size 0x8, virtual true, abstract: false, final false
inline bool get_IsGenericMethod() ;

/// @brief Method get_IsGenericMethodDefinition, addr 0x268b6bc, size 0x8, virtual true, abstract: false, final false
inline bool get_IsGenericMethodDefinition() ;

/// @brief Method get_IsPublic, addr 0x268b68c, size 0x28, virtual true, abstract: false, final true
inline bool get_IsPublic() ;

/// @brief Method get_IsSecurityCritical, addr 0x268b718, size 0x28, virtual true, abstract: false, final false
inline bool get_IsSecurityCritical() ;

/// @brief Method get_IsSpecialName, addr 0x268b64c, size 0x20, virtual true, abstract: false, final true
inline bool get_IsSpecialName() ;

/// @brief Method get_IsStatic, addr 0x268a0c0, size 0x20, virtual true, abstract: false, final true
inline bool get_IsStatic() ;

/// @brief Method get_IsVirtual, addr 0x268b66c, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method op_Equality, addr 0x268b364, size 0x1b4, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Reflection::MethodBase*  left, ::System::Reflection::MethodBase*  right) ;

/// @brief Method op_Inequality, addr 0x268b34c, size 0x18, virtual false, abstract: false, final false
