...
/// @brief Method ToString, addr 0x2696024, size 0x2c4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x269601c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
