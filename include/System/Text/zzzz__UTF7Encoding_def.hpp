...
/// @brief Method Reset, addr 0x25f7b8c, size 0x28, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x25f7980, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Text::UTF7Encoding*  encoding) ;

/// @brief Method get_HasState, addr 0x25f7bb4, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x25f7bc4, size 0x24, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x25f79e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Text::UTF7Encoding*  encoding) ;

/// @brief Method get_HasState, addr 0x25f7be8, size 0x20, virtual true, abstract: false, final false
inline bool get_HasState() ;
...
/// @brief Method CreateFallbackBuffer, addr 0x25f7c08, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::DecoderFallbackBuffer* CreateFallbackBuffer() ;

/// @brief Method Equals, addr 0x25f7c7c, size 0x5c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetHashCode, addr 0x25f7cd8, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::System::Text::UTF7Encoding_DecoderUTF7Fallback* New_ctor() ;

/// @brief Method .ctor, addr 0x25f6180, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_MaxCharCount, addr 0x25f7c74, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Fallback, addr 0x25f7ce0, size 0x3c, virtual true, abstract: false, final false
inline bool Fallback(::ArrayW<uint8_t,::Array<uint8_t>*>  bytesUnknown, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x25f7d1c, size 0x20, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method InternalFallback, addr 0x25f7d58, size 0x74, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x25f7d48, size 0x10, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x25f7c64, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Text::UTF7Encoding_DecoderUTF7Fallback*  fallback) ;

/// @brief Method get_Remaining, addr 0x25f7d3c, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method Equals, addr 0x25f6188, size 0xd0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetByteCount, addr 0x25f62c4, size 0x178, virtual true, abstract: false, final false
inline int32_t GetByteCount(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  index, int32_t  count) ;

/// @brief Method GetByteCount, addr 0x25f64c8, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  count) ;

/// @brief Method GetByteCount, addr 0x25f729c, size 0x1c, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  count, ::System::Text::EncoderNLS*  baseEncoder) ;

/// @brief Method GetByteCount, addr 0x25f643c, size 0x8c, virtual true, abstract: false, final false
inline int32_t GetByteCount(::StringW  s) ;

/// @brief Method GetBytes, addr 0x25f67e0, size 0x264, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x25f6a44, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x25f72b8, size 0x39c, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x25f6598, size 0x248, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x25f6b3c, size 0x178, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x25f6cb4, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x25f7654, size 0x1c, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count, ::System::Text::DecoderNLS*  baseDecoder) ;

/// @brief Method GetChars, addr 0x25f6d84, size 0x264, virtual true, abstract: false, final false
inline int32_t GetChars(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  byteIndex, int32_t  byteCount, ::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  charIndex) ;

/// @brief Method GetChars, addr 0x25f6fe8, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetChars, addr 0x25f7670, size 0x2b4, virtual true, abstract: false, final false
...
/// @brief Method GetDecoder, addr 0x25f7924, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::Decoder* GetDecoder() ;

/// @brief Method GetEncoder, addr 0x25f7988, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::Encoder* GetEncoder() ;

/// @brief Method GetHashCode, addr 0x25f6258, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetMaxByteCount, addr 0x25f79ec, size 0xc0, virtual true, abstract: false, final false
inline int32_t GetMaxByteCount(int32_t  charCount) ;

/// @brief Method GetMaxCharCount, addr 0x25f7aac, size 0x74, virtual true, abstract: false, final false
inline int32_t GetMaxCharCount(int32_t  byteCount) ;

/// @brief Method GetString, addr 0x25f70e0, size 0x1bc, virtual true, abstract: false, final false
inline ::StringW GetString(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method MakeTables, addr 0x25f5e50, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method SetDefaultFallbacks, addr 0x25f60d4, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f5dfc, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25f5e20, size 0x30, virtual false, abstract: false, final false
