...
/// @brief Method AddFC, addr 0x2cee880, size 0xac, virtual false, abstract: false, final false
inline bool AddFC(::System::Text::RegularExpressions::RegexFC*  fc, bool  concatenate) ;

/// @brief Method GetFirstChars, addr 0x2cedc14, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cee92c, size 0xf8, virtual false, abstract: false, final false
inline void _ctor(char16_t  ch, bool  _cordl_not, bool  nullable, bool  caseInsensitive) ;

/// @brief Method .ctor, addr 0x2ceea24, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::StringW  charClass, bool  nullable, bool  caseInsensitive) ;

/// @brief Method .ctor, addr 0x2cee808, size 0x78, virtual false, abstract: false, final false
inline void _ctor(bool  nullable) ;

/// @brief Method get_CaseInsensitive, addr 0x2ceeabc, size 0x8, virtual false, abstract: false, final false
inline bool get_CaseInsensitive() ;

/// @brief Method set_CaseInsensitive, addr 0x2ceeac4, size 0xc, virtual false, abstract: false, final false
