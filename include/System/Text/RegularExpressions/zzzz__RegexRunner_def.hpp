...
/// @brief Method Capture, addr 0x2cf0d04, size 0x60, virtual false, abstract: false, final false
inline void Capture(int32_t  capnum, int32_t  start, int32_t  end) ;

/// @brief Method CheckTimeout, addr 0x2cf0bc0, size 0x10, virtual false, abstract: false, final false
inline void CheckTimeout() ;

/// @brief Method Crawl, addr 0x2cf8ee4, size 0x5c, virtual false, abstract: false, final false
inline void Crawl(int32_t  i) ;

/// @brief Method Crawlpos, addr 0x2cf0d94, size 0x24, virtual false, abstract: false, final false
inline int32_t Crawlpos() ;

/// @brief Method DoCheckTimeout, addr 0x2cf8c38, size 0xcc, virtual false, abstract: false, final false
inline void DoCheckTimeout() ;

/// @brief Method DoubleCrawl, addr 0x2cf8e44, size 0xa0, virtual false, abstract: false, final false
inline void DoubleCrawl() ;

/// @brief Method DoubleStack, addr 0x2cf8d04, size 0xa0, virtual false, abstract: false, final false
inline void DoubleStack() ;

/// @brief Method DoubleTrack, addr 0x2cf8da4, size 0xa0, virtual false, abstract: false, final false
inline void DoubleTrack() ;

/// @brief Method EnsureStorage, addr 0x2ceec20, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method InitMatch, addr 0x2cf8a20, size 0x1d4, virtual false, abstract: false, final false
...
/// @brief Method IsBoundary, addr 0x2cf0db8, size 0x100, virtual false, abstract: false, final false
inline bool IsBoundary(int32_t  index, int32_t  startpos, int32_t  endpos) ;

/// @brief Method IsECMABoundary, addr 0x2cf0eb8, size 0x100, virtual false, abstract: false, final false
inline bool IsECMABoundary(int32_t  index, int32_t  startpos, int32_t  endpos) ;

/// @brief Method IsMatched, addr 0x2cf0bd0, size 0x20, virtual false, abstract: false, final false
inline bool IsMatched(int32_t  cap) ;

/// @brief Method MatchIndex, addr 0x2cf0fb8, size 0x20, virtual false, abstract: false, final false
inline int32_t MatchIndex(int32_t  cap) ;

/// @brief Method MatchLength, addr 0x2cf0fd8, size 0x20, virtual false, abstract: false, final false
inline int32_t MatchLength(int32_t  cap) ;

static inline ::System::Text::RegularExpressions::RegexRunner* New_ctor() ;

/// @brief Method Popcrawl, addr 0x2cf8f40, size 0x3c, virtual false, abstract: false, final false
inline int32_t Popcrawl() ;

/// @brief Method Scan, addr 0x2cf86bc, size 0x330, virtual false, abstract: false, final false
...
/// @brief Method StartTimeoutWatch, addr 0x2cf89ec, size 0x34, virtual false, abstract: false, final false
inline void StartTimeoutWatch() ;

/// @brief Method TidyMatch, addr 0x2cf8bf4, size 0x44, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::Match* TidyMatch(bool  quick) ;

/// @brief Method TransferCapture, addr 0x2cf0bf0, size 0x114, virtual false, abstract: false, final false
inline void TransferCapture(int32_t  capnum, int32_t  uncapnum, int32_t  start, int32_t  end) ;

/// @brief Method Uncapture, addr 0x2cf0d64, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ceeafc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
