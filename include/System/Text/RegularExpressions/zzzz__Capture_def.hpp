...
/// @brief Method GetLeftSubstring, addr 0x2cdf3cc, size 0x88, virtual false, abstract: false, final false
inline ::System::ReadOnlySpan_1<char16_t> GetLeftSubstring() ;

/// @brief Method GetRightSubstring, addr 0x2cdf454, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2cdf3c8, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cdf338, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  text, int32_t  index, int32_t  length) ;

/// @brief Method get_Index, addr 0x2cdf374, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Index() ;

/// @brief Method get_Length, addr 0x2cdf384, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Length() ;

/// @brief Method get_Text, addr 0x2cdf394, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Text() ;

/// @brief Method get_Value, addr 0x2cdf3a4, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Index, addr 0x2cdf37c, size 0x8, virtual false, abstract: false, final false
inline void set_Index(int32_t  value) ;

/// @brief Method set_Length, addr 0x2cdf38c, size 0x8, virtual false, abstract: false, final false
inline void set_Length(int32_t  value) ;

/// @brief Method set_Text, addr 0x2cdf39c, size 0x8, virtual false, abstract: false, final false
