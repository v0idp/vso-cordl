...
/// @brief Method AddChild, addr 0x2cf21ec, size 0x108, virtual false, abstract: false, final false
inline void AddChild(::System::Text::RegularExpressions::RegexNode*  newChild) ;

/// @brief Method Child, addr 0x2cedee0, size 0x58, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* Child(int32_t  i) ;

/// @brief Method ChildCount, addr 0x2cede94, size 0x4c, virtual false, abstract: false, final false
inline int32_t ChildCount() ;

/// @brief Method MakeQuantifier, addr 0x2cf20d4, size 0x118, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* MakeQuantifier(bool  lazy, int32_t  min, int32_t  max) ;

/// @brief Method MakeRep, addr 0x2cf1560, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Reduce, addr 0x2cf1578, size 0x68, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* Reduce() ;

/// @brief Method ReduceAlternation, addr 0x2cf15e0, size 0x3d4, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReduceAlternation() ;

/// @brief Method ReduceConcatenation, addr 0x2cf19b4, size 0x39c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReduceConcatenation() ;

/// @brief Method ReduceGroup, addr 0x2cf1ed8, size 0x2c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReduceGroup() ;

/// @brief Method ReduceRep, addr 0x2cf1d50, size 0x188, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReduceRep() ;

/// @brief Method ReduceSet, addr 0x2cf1f04, size 0x11c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReduceSet() ;

/// @brief Method ReverseLeft, addr 0x2cf14e4, size 0x7c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* ReverseLeft() ;

/// @brief Method StripEnation, addr 0x2cf2020, size 0xb4, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexNode* StripEnation(int32_t  emptyType) ;

/// @brief Method Type, addr 0x2cf22f4, size 0x8, virtual false, abstract: false, final false
inline int32_t Type() ;

/// @brief Method UseOptionR, addr 0x2cf14d8, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cf13a4, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::System::Text::RegularExpressions::RegexOptions  options) ;

/// @brief Method .ctor, addr 0x2cf13d4, size 0x40, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::System::Text::RegularExpressions::RegexOptions  options, char16_t  ch) ;

/// @brief Method .ctor, addr 0x2cf1454, size 0x40, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::System::Text::RegularExpressions::RegexOptions  options, int32_t  m) ;

/// @brief Method .ctor, addr 0x2cf1494, size 0x44, virtual false, abstract: false, final false
inline void _ctor(int32_t  type, ::System::Text::RegularExpressions::RegexOptions  options, int32_t  m, int32_t  n) ;

/// @brief Method .ctor, addr 0x2cf1414, size 0x40, virtual false, abstract: false, final false
