...
public:
// Declarations
/// @brief Method Dispose, addr 0x2cf962c, size 0x54, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Emit, addr 0x2cfa24c, size 0xc8, virtual false, abstract: false, final false
inline void Emit(int32_t  op) ;

/// @brief Method Emit, addr 0x2cf9680, size 0x130, virtual false, abstract: false, final false
inline void Emit(int32_t  op, int32_t  opd1) ;

/// @brief Method Emit, addr 0x2cfa314, size 0x190, virtual false, abstract: false, final false
inline void Emit(int32_t  op, int32_t  opd1, int32_t  opd2) ;

/// @brief Method EmitFragment, addr 0x2cf97b0, size 0xa38, virtual false, abstract: false, final false
inline void EmitFragment(int32_t  nodetype, ::System::Text::RegularExpressions::RegexNode*  node, int32_t  curIndex) ;

/// @brief Method MapCapnum, addr 0x2cfa5ec, size 0xb4, virtual false, abstract: false, final false
inline int32_t MapCapnum(int32_t  capnum) ;

/// @brief Method PatchJump, addr 0x2cfa1e8, size 0x64, virtual false, abstract: false, final false
inline void PatchJump(int32_t  offset, int32_t  jumpDest) ;

/// @brief Method RegexCodeFromRegexTree, addr 0x2cf91a4, size 0x488, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexCode* RegexCodeFromRegexTree(::System::Text::RegularExpressions::RegexTree*  tree) ;

/// @brief Method StringCode, addr 0x2cfa4a4, size 0x148, virtual false, abstract: false, final false
inline int32_t StringCode(::StringW  str) ;

/// @brief Method Write, addr 0x2cf90c0, size 0xe4, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexCode* Write(::System::Text::RegularExpressions::RegexTree*  tree) ;

/// @brief Method .ctor, addr 0x2cf8f7c, size 0x144, virtual false, abstract: false, final false
