...
/// @brief Method IsMatch, addr 0x2ce5e94, size 0x6c, virtual false, abstract: false, final false
inline bool IsMatch(::StringW  text, int32_t  index, int32_t  beglimit, int32_t  endlimit) ;

/// @brief Method MatchPattern, addr 0x2ce5d70, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method Scan, addr 0x2ce5f00, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ce58dc, size 0x494, virtual false, abstract: false, final false
