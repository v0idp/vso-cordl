...
/// @brief Method Advance, addr 0x2ceeb24, size 0x64, virtual false, abstract: false, final false
inline void Advance(int32_t  i) ;

/// @brief Method Backtrack, addr 0x2ceef4c, size 0xf4, virtual false, abstract: false, final false
inline void Backtrack() ;

/// @brief Method Backwardnext, addr 0x2cef640, size 0x30, virtual false, abstract: false, final false
inline void Backwardnext() ;

/// @brief Method Bump, addr 0x2cef268, size 0x14, virtual false, abstract: false, final false
inline int32_t Bump() ;

/// @brief Method CharAt, addr 0x2cef670, size 0x1c, virtual false, abstract: false, final false
inline char16_t CharAt(int32_t  j) ;

/// @brief Method FindFirstChar, addr 0x2cef68c, size 0x39c, virtual true, abstract: false, final false
inline bool FindFirstChar() ;

/// @brief Method Forwardcharnext, addr 0x2cef2a8, size 0x90, virtual false, abstract: false, final false
inline char16_t Forwardcharnext() ;

/// @brief Method Forwardchars, addr 0x2cef27c, size 0x2c, virtual false, abstract: false, final false
inline int32_t Forwardchars() ;

/// @brief Method Go, addr 0x2cefa28, size 0x1198, virtual true, abstract: false, final false
inline void Go() ;

/// @brief Method Goto, addr 0x2ceeba8, size 0x78, virtual false, abstract: false, final false
inline void Goto(int32_t  newpos) ;

/// @brief Method InitTrackCount, addr 0x2ceeb04, size 0x20, virtual true, abstract: false, final false
inline void InitTrackCount() ;

/// @brief Method Leftchars, addr 0x2cef248, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Operand, addr 0x2cef204, size 0x44, virtual false, abstract: false, final false
inline int32_t Operand(int32_t  i) ;

/// @brief Method Operator, addr 0x2cef1fc, size 0x8, virtual false, abstract: false, final false
inline int32_t Operator() ;

/// @brief Method Refmatch, addr 0x2cef4a4, size 0x19c, virtual false, abstract: false, final false
inline bool Refmatch(int32_t  index, int32_t  len) ;

/// @brief Method Rightchars, addr 0x2cef258, size 0x10, virtual false, abstract: false, final false
inline int32_t Rightchars() ;

/// @brief Method SetOperator, addr 0x2ceeb88, size 0x20, virtual false, abstract: false, final false
inline void SetOperator(int32_t  op) ;

/// @brief Method StackPeek, addr 0x2cef188, size 0x38, virtual false, abstract: false, final false
inline int32_t StackPeek() ;

/// @brief Method StackPeek, addr 0x2cef1c0, size 0x3c, virtual false, abstract: false, final false
inline int32_t StackPeek(int32_t  i) ;

/// @brief Method StackPop, addr 0x2cef168, size 0x10, virtual false, abstract: false, final false
inline void StackPop() ;

/// @brief Method StackPop, addr 0x2cef178, size 0x10, virtual false, abstract: false, final false
inline void StackPop(int32_t  framesize) ;

/// @brief Method StackPush, addr 0x2cef0d4, size 0x3c, virtual false, abstract: false, final false
inline void StackPush(int32_t  I1) ;

/// @brief Method StackPush, addr 0x2cef110, size 0x58, virtual false, abstract: false, final false
inline void StackPush(int32_t  I1, int32_t  I2) ;

/// @brief Method Stringmatch, addr 0x2cef338, size 0x16c, virtual false, abstract: false, final false
inline bool Stringmatch(::StringW  str) ;

/// @brief Method Textpos, addr 0x2ceec9c, size 0x8, virtual false, abstract: false, final false
inline int32_t Textpos() ;

/// @brief Method Textstart, addr 0x2ceec94, size 0x8, virtual false, abstract: false, final false
inline int32_t Textstart() ;

/// @brief Method Textto, addr 0x2ceec68, size 0x8, virtual false, abstract: false, final false
inline void Textto(int32_t  newpos) ;

/// @brief Method TrackPeek, addr 0x2cef060, size 0x38, virtual false, abstract: false, final false
inline int32_t TrackPeek() ;

/// @brief Method TrackPeek, addr 0x2cef098, size 0x3c, virtual false, abstract: false, final false
inline int32_t TrackPeek(int32_t  i) ;

/// @brief Method TrackPop, addr 0x2cef040, size 0x10, virtual false, abstract: false, final false
inline void TrackPop() ;

/// @brief Method TrackPop, addr 0x2cef050, size 0x10, virtual false, abstract: false, final false
inline void TrackPop(int32_t  framesize) ;

/// @brief Method TrackPush, addr 0x2ceecc8, size 0x40, virtual false, abstract: false, final false
inline void TrackPush() ;

/// @brief Method TrackPush, addr 0x2ceed08, size 0x5c, virtual false, abstract: false, final false
inline void TrackPush(int32_t  I1) ;

/// @brief Method TrackPush, addr 0x2ceed64, size 0x78, virtual false, abstract: false, final false
inline void TrackPush(int32_t  I1, int32_t  I2) ;

/// @brief Method TrackPush, addr 0x2ceeddc, size 0x94, virtual false, abstract: false, final false
inline void TrackPush(int32_t  I1, int32_t  I2, int32_t  I3) ;

/// @brief Method TrackPush2, addr 0x2ceee70, size 0x60, virtual false, abstract: false, final false
inline void TrackPush2(int32_t  I1) ;

/// @brief Method TrackPush2, addr 0x2ceeed0, size 0x7c, virtual false, abstract: false, final false
inline void TrackPush2(int32_t  I1, int32_t  I2) ;

/// @brief Method Trackpos, addr 0x2ceeca4, size 0x24, virtual false, abstract: false, final false
inline int32_t Trackpos() ;

/// @brief Method Trackto, addr 0x2ceec70, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ceead0, size 0x2c, virtual false, abstract: false, final false
