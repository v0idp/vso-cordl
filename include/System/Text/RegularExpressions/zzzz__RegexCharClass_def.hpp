...
public:
// Declarations
/// @brief Method .ctor, addr 0x2ced620, size 0x10, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method .ctor, addr 0x2ced700, size 0xc, virtual false, abstract: false, final false
...
// Dependencies System.Collections.Generic.IComparer`1<T>, System.Object, System.Text.RegularExpressions.RegexCharClass::SingleRange
namespace System::Text::RegularExpressions {
// Is value type: false
...
/// @brief Method Compare, addr 0x2ced638, size 0x6c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2ced630, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field s_lcTable, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_lcTable, put=setStaticF_s_lcTable)) ::ArrayW<::System::Text::RegularExpressions::RegexCharClass_LowerCaseMapping,::Array<::System::Text::RegularExpressions::RegexCharClass_LowerCaseMapping>*>  s_lcTable;
...
/// @brief Method AddCategory, addr 0x2ce6d70, size 0x1c, virtual false, abstract: false, final false
inline void AddCategory(::StringW  category) ;

/// @brief Method AddCategoryFromName, addr 0x2ce687c, size 0x210, virtual false, abstract: false, final false
inline void AddCategoryFromName(::StringW  categoryName, bool  invert, bool  caseInsensitive, ::StringW  pattern) ;

/// @brief Method AddChar, addr 0x2ce6314, size 0x8, virtual false, abstract: false, final false
inline void AddChar(char16_t  c) ;

/// @brief Method AddCharClass, addr 0x2ce6438, size 0x170, virtual false, abstract: false, final false
inline void AddCharClass(::System::Text::RegularExpressions::RegexCharClass*  cc) ;

/// @brief Method AddDigit, addr 0x2ce72f0, size 0xb4, virtual false, abstract: false, final false
inline void AddDigit(bool  ecma, bool  negate, ::StringW  pattern) ;

/// @brief Method AddLowercase, addr 0x2ce6d8c, size 0x13c, virtual false, abstract: false, final false
inline void AddLowercase(::System::Globalization::CultureInfo*  culture) ;

/// @brief Method AddLowercaseRange, addr 0x2ce6ec8, size 0x230, virtual false, abstract: false, final false
inline void AddLowercaseRange(char16_t  chMin, char16_t  chMax, ::System::Globalization::CultureInfo*  culture) ;

/// @brief Method AddRange, addr 0x2ce631c, size 0x11c, virtual false, abstract: false, final false
inline void AddRange(char16_t  first, char16_t  last) ;

/// @brief Method AddSet, addr 0x2ce6650, size 0x224, virtual false, abstract: false, final false
inline void AddSet(::StringW  set) ;

/// @brief Method AddSpace, addr 0x2ce71f4, size 0xfc, virtual false, abstract: false, final false
inline void AddSpace(bool  ecma, bool  negate) ;

/// @brief Method AddSubtraction, addr 0x2ce6874, size 0x8, virtual false, abstract: false, final false
inline void AddSubtraction(::System::Text::RegularExpressions::RegexCharClass*  sub) ;

/// @brief Method AddWord, addr 0x2ce70f8, size 0xfc, virtual false, abstract: false, final false
inline void AddWord(bool  ecma, bool  negate) ;

/// @brief Method Canonicalize, addr 0x2ce8200, size 0x238, virtual false, abstract: false, final false
inline void Canonicalize() ;

/// @brief Method CharInCategory, addr 0x2ce7b3c, size 0x188, virtual false, abstract: false, final false
static inline bool CharInCategory(char16_t  ch, ::StringW  set, int32_t  start, int32_t  mySetLength, int32_t  myCategoryLength) ;

/// @brief Method CharInCategoryGroup, addr 0x2ce7cc4, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method CharInClass, addr 0x2ce7820, size 0x68, virtual false, abstract: false, final false
static inline bool CharInClass(char16_t  ch, ::StringW  set) ;

/// @brief Method CharInClassInternal, addr 0x2ce7a2c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method CharInClassRecursive, addr 0x2ce7904, size 0x128, virtual false, abstract: false, final false
static inline bool CharInClassRecursive(char16_t  ch, ::StringW  set, int32_t  start) ;

/// @brief Method GetRangeAt, addr 0x2ce65f0, size 0x60, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexCharClass_SingleRange GetRangeAt(int32_t  i) ;

/// @brief Method IsECMAWordChar, addr 0x2ce77b4, size 0x6c, virtual false, abstract: false, final false
static inline bool IsECMAWordChar(char16_t  ch) ;

/// @brief Method IsEmpty, addr 0x2ce74d8, size 0xc0, virtual false, abstract: false, final false
static inline bool IsEmpty(::StringW  charClass) ;

/// @brief Method IsMergeable, addr 0x2ce73bc, size 0x9c, virtual false, abstract: false, final false
static inline bool IsMergeable(::StringW  charClass) ;

/// @brief Method IsNegated, addr 0x2ce7458, size 0x28, virtual false, abstract: false, final false
static inline bool IsNegated(::StringW  set) ;

/// @brief Method IsSingleton, addr 0x2ce7598, size 0x10c, virtual false, abstract: false, final false
static inline bool IsSingleton(::StringW  set) ;

/// @brief Method IsSingletonInverse, addr 0x2ce76a4, size 0x110, virtual false, abstract: false, final false
static inline bool IsSingletonInverse(::StringW  set) ;

/// @brief Method IsSubtraction, addr 0x2ce7480, size 0x58, virtual false, abstract: false, final false
static inline bool IsSubtraction(::StringW  charClass) ;

/// @brief Method IsWordChar, addr 0x2ce7888, size 0x7c, virtual false, abstract: false, final false
static inline bool IsWordChar(char16_t  ch) ;

/// @brief Method NegateCategory, addr 0x2ce6a8c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x2ce7d94, size 0x58, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexCharClass* Parse(::StringW  charClass) ;

/// @brief Method ParseRecursive, addr 0x2ce7dec, size 0x278, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexCharClass* ParseRecursive(::StringW  charClass, int32_t  start) ;

/// @brief Method RangeCount, addr 0x2ce65a8, size 0x48, virtual false, abstract: false, final false
inline int32_t RangeCount() ;

/// @brief Method SetFromProperty, addr 0x2ce6b14, size 0x25c, virtual false, abstract: false, final false
static inline ::StringW SetFromProperty(::StringW  capname, bool  invert, ::StringW  pattern) ;

/// @brief Method SingletonChar, addr 0x2ce73a4, size 0x18, virtual false, abstract: false, final false
static inline char16_t SingletonChar(::StringW  set) ;

/// @brief Method ToStringClass, addr 0x2ce8064, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ce61e4, size 0xb8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2ce629c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method get_CanMerge, addr 0x2ce62e8, size 0x20, virtual false, abstract: false, final false
...
static inline void setStaticF_s_lcTable(::ArrayW<::System::Text::RegularExpressions::RegexCharClass_LowerCaseMapping,::Array<::System::Text::RegularExpressions::RegexCharClass_LowerCaseMapping>*>  value) ;
...
/// @brief Method set_Negate, addr 0x2ce6308, size 0xc, virtual false, abstract: false, final false
