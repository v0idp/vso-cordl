...
/// @brief Method Equals, addr 0x2ce578c, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2ce581c, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::System::Text::RegularExpressions::Regex_CachedCodeEntryKey  other) ;

/// @brief Method GetHashCode, addr 0x2ce5884, size 0x58, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x2ce5668, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2ce3400, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ce3a98, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method FillCacheDictionary, addr 0x2ce3b10, size 0x104, virtual false, abstract: false, final false
inline void FillCacheDictionary() ;

/// @brief Method GetCachedCode, addr 0x2ce3308, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method GetCachedCodeEntryInternal, addr 0x2ce3430, size 0x4a4, virtual false, abstract: false, final false
...
/// @brief Method GroupNameFromNumber, addr 0x2ce0a60, size 0x140, virtual false, abstract: false, final false
inline ::StringW GroupNameFromNumber(int32_t  i) ;

/// @brief Method GroupNumberFromName, addr 0x2ce066c, size 0x140, virtual false, abstract: false, final false
inline int32_t GroupNumberFromName(::StringW  name) ;

/// @brief Method InitDefaultMatchTimeout, addr 0x2ce51b4, size 0x230, virtual false, abstract: false, final false
static inline ::System::TimeSpan InitDefaultMatchTimeout() ;

/// @brief Method InitializeReferences, addr 0x2ce5674, size 0xfc, virtual false, abstract: false, final false
inline void InitializeReferences() ;

/// @brief Method IsMatch, addr 0x2ce4290, size 0x6c, virtual false, abstract: false, final false
inline bool IsMatch(::StringW  input) ;

/// @brief Method IsMatch, addr 0x2ce3e10, size 0x74, virtual false, abstract: false, final false
static inline bool IsMatch(::StringW  input, ::StringW  pattern) ;

/// @brief Method IsMatch, addr 0x2ce3e84, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method IsMatch, addr 0x2ce4308, size 0x7c, virtual false, abstract: false, final false
inline bool IsMatch(::StringW  input, int32_t  startat) ;

/// @brief Method LookupCachedAndPromote, addr 0x2ce38d4, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method Match, addr 0x2ce4484, size 0x6c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::Match* Match(::StringW  input) ;

/// @brief Method Match, addr 0x2ce4384, size 0x74, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::Match* Match(::StringW  input, ::StringW  pattern) ;

/// @brief Method Match, addr 0x2ce43f8, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Match, addr 0x2ce44f0, size 0x70, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::Match* Match(::StringW  input, int32_t  startat) ;

/// @brief Method Matches, addr 0x2ce4560, size 0x6c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::MatchCollection* Matches(::StringW  input) ;

/// @brief Method Matches, addr 0x2ce45cc, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method Replace, addr 0x2ce4694, size 0x7c, virtual false, abstract: false, final false
static inline ::StringW Replace(::StringW  input, ::StringW  pattern, ::StringW  replacement) ;

/// @brief Method Replace, addr 0x2ce47a4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method Replace, addr 0x2ce4710, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method Replace, addr 0x2ce482c, size 0x70, virtual false, abstract: false, final false
inline ::StringW Replace(::StringW  input, ::StringW  replacement) ;

/// @brief Method Replace, addr 0x2ce489c, size 0xd8, virtual false, abstract: false, final false
inline ::StringW Replace(::StringW  input, ::StringW  replacement, int32_t  count, int32_t  startat) ;

/// @brief Method Run, addr 0x2ce1890, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method Split, addr 0x2ce4974, size 0x70, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> Split(::StringW  input) ;

/// @brief Method Split, addr 0x2ce49e4, size 0xc0, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> Split(::StringW  input, int32_t  count, int32_t  startat) ;

/// @brief Method Split, addr 0x2ce4aa4, size 0x5d4, virtual false, abstract: false, final false
...
/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x2ce5630, size 0x38, virtual true, abstract: false, final true
...
/// @brief Method ToString, addr 0x2ce5778, size 0x8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetCacheValue, addr 0x2ce3c14, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method TryGetCacheValueSmall, addr 0x2ce3d30, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method UseOptionInvariant, addr 0x2ce5780, size 0xc, virtual false, abstract: false, final false
inline bool UseOptionInvariant() ;

/// @brief Method UseOptionR, addr 0x2ce42fc, size 0xc, virtual false, abstract: false, final false
inline bool UseOptionR() ;

/// @brief Method ValidateMatchTimeout, addr 0x2ce53e4, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ce553c, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::StringW  pattern) ;

/// @brief Method .ctor, addr 0x2ce55b4, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::StringW  pattern, ::System::Text::RegularExpressions::RegexOptions  options) ;

/// @brief Method .ctor, addr 0x2ce3f10, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method get_Options, addr 0x2ce5770, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexOptions get_Options() ;

/// @brief Method get_RightToLeft, addr 0x2ce5078, size 0xc, virtual false, abstract: false, final false
