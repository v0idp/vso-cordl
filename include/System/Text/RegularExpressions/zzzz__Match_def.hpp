...
/// @brief Method AddMatch, addr 0x2ce1cd4, size 0x1e0, virtual true, abstract: false, final false
inline void AddMatch(int32_t  cap, int32_t  start, int32_t  len) ;

/// @brief Method BalanceMatch, addr 0x2ce1eb4, size 0xd8, virtual true, abstract: false, final false
inline void BalanceMatch(int32_t  cap) ;

/// @brief Method GroupToStringImpl, addr 0x2ce1b14, size 0x198, virtual true, abstract: false, final false
inline ::System::ReadOnlySpan_1<char16_t> GroupToStringImpl(int32_t  groupnum) ;

/// @brief Method IsMatched, addr 0x2ce1fc4, size 0x90, virtual true, abstract: false, final false
inline bool IsMatched(int32_t  cap) ;

/// @brief Method LastGroupToStringImpl, addr 0x2ce1cac, size 0x28, virtual false, abstract: false, final false
inline ::System::ReadOnlySpan_1<char16_t> LastGroupToStringImpl() ;

/// @brief Method MatchIndex, addr 0x2ce2054, size 0x8c, virtual true, abstract: false, final false
inline int32_t MatchIndex(int32_t  cap) ;

/// @brief Method MatchLength, addr 0x2ce20e0, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method NextMatch, addr 0x2ce1860, size 0x30, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::Match* NextMatch() ;

/// @brief Method RemoveMatch, addr 0x2ce1f8c, size 0x38, virtual true, abstract: false, final false
inline void RemoveMatch(int32_t  cap) ;

/// @brief Method Reset, addr 0x2ce1794, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method Tidy, addr 0x2ce216c, size 0x170, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ce236c, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2ce15f4, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method get_Empty, addr 0x2ce173c, size 0x58, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::Match* get_Empty() ;

/// @brief Method get_Groups, addr 0x2ce17f8, size 0x68, virtual true, abstract: false, final false
