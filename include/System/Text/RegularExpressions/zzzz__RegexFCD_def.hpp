...
public:
// Declarations
/// @brief Method AnchorFromType, addr 0x2cee068, size 0x70, virtual false, abstract: false, final false
static inline int32_t AnchorFromType(int32_t  type) ;

/// @brief Method Anchors, addr 0x2cedf38, size 0x130, virtual false, abstract: false, final false
static inline int32_t Anchors(::System::Text::RegularExpressions::RegexTree*  tree) ;

/// @brief Method CalculateFC, addr 0x2cee400, size 0x3fc, virtual false, abstract: false, final false
inline void CalculateFC(int32_t  NodeType, ::System::Text::RegularExpressions::RegexNode*  node, int32_t  CurIndex) ;

/// @brief Method Dispose, addr 0x2cedbcc, size 0x48, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method FCIsEmpty, addr 0x2cee2d0, size 0x50, virtual false, abstract: false, final false
inline bool FCIsEmpty() ;

/// @brief Method FirstChars, addr 0x2ced8e0, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method IntIsEmpty, addr 0x2cee18c, size 0x44, virtual false, abstract: false, final false
inline bool IntIsEmpty() ;

/// @brief Method PopFC, addr 0x2cee320, size 0x7c, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexFC* PopFC() ;

/// @brief Method PopInt, addr 0x2cee1d0, size 0x5c, virtual false, abstract: false, final false
inline int32_t PopInt() ;

/// @brief Method Prefix, addr 0x2cedc5c, size 0x238, virtual false, abstract: false, final false
static inline ::System::Text::RegularExpressions::RegexPrefix Prefix(::System::Text::RegularExpressions::RegexTree*  tree) ;

/// @brief Method PushFC, addr 0x2cee22c, size 0xa4, virtual false, abstract: false, final false
inline void PushFC(::System::Text::RegularExpressions::RegexFC*  fc) ;

/// @brief Method PushInt, addr 0x2cee0d8, size 0xb4, virtual false, abstract: false, final false
inline void PushInt(int32_t  i) ;

/// @brief Method RegexFCFromRegexTree, addr 0x2ceda34, size 0x198, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexFC* RegexFCFromRegexTree(::System::Text::RegularExpressions::RegexTree*  tree) ;

/// @brief Method SkipChild, addr 0x2cee7fc, size 0xc, virtual false, abstract: false, final false
inline void SkipChild() ;

/// @brief Method TopFC, addr 0x2cee39c, size 0x64, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::RegexFC* TopFC() ;

/// @brief Method .ctor, addr 0x2ced80c, size 0xd4, virtual false, abstract: false, final false
