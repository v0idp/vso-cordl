...
public:
// Declarations
 __declspec(property(get=get_Captures)) ::System::Text::RegularExpressions::CaptureCollection*  Captures;
...
/// @brief Method .ctor, addr 0x2ce0444, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2ce0230, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method get_Captures, addr 0x2ce02dc, size 0x64, virtual false, abstract: false, final false
inline ::System::Text::RegularExpressions::CaptureCollection* get_Captures() ;

/// @brief Method get_Success, addr 0x2ce02cc, size 0x10, virtual false, abstract: false, final false
