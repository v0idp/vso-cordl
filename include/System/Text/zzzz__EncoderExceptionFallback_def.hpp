...
/// @brief Method CreateFallbackBuffer, addr 0x27ca0a0, size 0x54, virtual true, abstract: false, final false
inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer() ;

/// @brief Method Equals, addr 0x27ca104, size 0x5c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetHashCode, addr 0x27ca160, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::System::Text::EncoderExceptionFallback* New_ctor() ;

/// @brief Method .ctor, addr 0x27ca098, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_MaxCharCount, addr 0x27ca0fc, size 0x8, virtual true, abstract: false, final false
