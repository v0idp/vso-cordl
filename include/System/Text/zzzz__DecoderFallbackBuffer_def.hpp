...
/// @brief Method InternalFallback, addr 0x27c7b68, size 0x18c, virtual true, abstract: false, final false
...
/// @brief Method InternalFallback, addr 0x27c7cf4, size 0x16c, virtual true, abstract: false, final false
inline int32_t InternalFallback(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, ::cordl_internals::Ptr<uint8_t>  pBytes) ;

/// @brief Method InternalInitialize, addr 0x27c60d8, size 0x8, virtual false, abstract: false, final false
inline void InternalInitialize(::cordl_internals::Ptr<uint8_t>  byteStart, ::cordl_internals::Ptr<char16_t>  charEnd) ;

/// @brief Method InternalReset, addr 0x27c6368, size 0x10, virtual false, abstract: false, final false
inline void InternalReset() ;

static inline ::System::Text::DecoderFallbackBuffer* New_ctor() ;

/// @brief Method Reset, addr 0x27c7b40, size 0x28, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ThrowLastBytesRecursive, addr 0x27c7e60, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27c7528, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
