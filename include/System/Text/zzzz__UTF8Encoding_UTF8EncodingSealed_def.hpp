...
/// @brief Method .ctor, addr 0x25fb0d4, size 0x78, virtual false, abstract: false, final false
inline void _ctor(bool  encoderShouldEmitUTF8Identifier) ;

/// @brief Method get_Preamble, addr 0x25fb14c, size 0xe4, virtual true, abstract: false, final false
