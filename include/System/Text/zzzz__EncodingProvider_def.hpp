...
/// @brief Method GetEncoding, addr 0x25ee850, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method GetEncodingFromProvider, addr 0x25ee94c, size 0xdc, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* GetEncodingFromProvider(int32_t  codepage) ;

/// @brief Method GetEncodingFromProvider, addr 0x25eeb04, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method GetEncodingFromProvider, addr 0x25eea28, size 0xdc, virtual false, abstract: false, final false
