...
public:
// Declarations
/// @brief Method GetByteCount, addr 0x25ed7c0, size 0x178, virtual true, abstract: false, final false
inline int32_t GetByteCount(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  index, int32_t  count) ;

/// @brief Method GetByteCount, addr 0x25ed9c4, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  count) ;

/// @brief Method GetByteCount, addr 0x25ed938, size 0x8c, virtual true, abstract: false, final false
inline int32_t GetByteCount(::StringW  s) ;

/// @brief Method GetBytes, addr 0x25edcdc, size 0x264, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x25edf40, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x25eda94, size 0x248, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x25ee038, size 0x178, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x25ee1b0, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count) ;

/// @brief Method GetChars, addr 0x25ee280, size 0x264, virtual true, abstract: false, final false
inline int32_t GetChars(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  byteIndex, int32_t  byteCount, ::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  charIndex) ;

/// @brief Method GetChars, addr 0x25ee4e4, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetDecoder, addr 0x25ee798, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::Decoder* GetDecoder() ;

/// @brief Method GetEncoder, addr 0x25ee7f4, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::Encoder* GetEncoder() ;

/// @brief Method GetString, addr 0x25ee5dc, size 0x1bc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25ed7b8, size 0x8, virtual false, abstract: false, final false
