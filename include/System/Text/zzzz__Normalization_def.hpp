...
/// @brief Method CharMapIdx, addr 0x2604018, size 0x94, virtual false, abstract: false, final false
static inline int32_t CharMapIdx(int32_t  cp) ;

/// @brief Method Combine, addr 0x26044b0, size 0x13c, virtual false, abstract: false, final false
static inline ::System::Text::StringBuilder* Combine(::StringW  source, int32_t  start, int32_t  checkType) ;

/// @brief Method Combine, addr 0x26045ec, size 0x110, virtual false, abstract: false, final false
static inline void Combine(::System::Text::StringBuilder*  sb, int32_t  i, int32_t  checkType) ;

/// @brief Method CombineHangul, addr 0x2604830, size 0x1c4, virtual false, abstract: false, final false
static inline int32_t CombineHangul(::System::Text::StringBuilder*  sb, ::StringW  s, int32_t  current) ;

/// @brief Method Compose, addr 0x26042a4, size 0xdc, virtual false, abstract: false, final false
static inline ::StringW Compose(::StringW  source, int32_t  checkType) ;

/// @brief Method Decompose, addr 0x2604d7c, size 0x8c, virtual false, abstract: false, final false
static inline ::StringW Decompose(::StringW  source, int32_t  checkType) ;

/// @brief Method Decompose, addr 0x2604380, size 0x130, virtual false, abstract: false, final false
static inline void Decompose(::StringW  source, ::ByRef<::System::Text::StringBuilder*>  sb, int32_t  checkType) ;

/// @brief Method DecomposeChar, addr 0x2604e08, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method Fetch, addr 0x2604c28, size 0x3c, virtual false, abstract: false, final false
static inline int32_t Fetch(::System::Text::StringBuilder*  sb, ::StringW  s, int32_t  i) ;

/// @brief Method GetCanonical, addr 0x2605250, size 0x1b8, virtual false, abstract: false, final false
static inline int32_t GetCanonical(int32_t  c, ::ArrayW<int32_t,::Array<int32_t>*>  buf, int32_t  bufIdx, int32_t  checkType) ;

/// @brief Method GetCanonicalHangul, addr 0x2605408, size 0xec, virtual false, abstract: false, final false
static inline int32_t GetCanonicalHangul(int32_t  s, ::ArrayW<int32_t,::Array<int32_t>*>  buf, int32_t  bufIdx) ;

/// @brief Method GetCombiningClass, addr 0x26040ac, size 0xa8, virtual false, abstract: false, final false
static inline uint8_t GetCombiningClass(int32_t  c) ;

/// @brief Method GetPrimaryCompositeFromMapIndex, addr 0x2604154, size 0xa8, virtual false, abstract: false, final false
static inline int32_t GetPrimaryCompositeFromMapIndex(int32_t  src) ;

/// @brief Method GetPrimaryCompositeHelperIndex, addr 0x26041fc, size 0xa8, virtual false, abstract: false, final false
static inline int32_t GetPrimaryCompositeHelperIndex(int32_t  cp) ;

/// @brief Method Normalize, addr 0x26054f4, size 0xbc, virtual false, abstract: false, final false
static inline ::StringW Normalize(::StringW  source, ::System::Text::NormalizationForm  normalizationForm) ;

/// @brief Method Normalize, addr 0x26055b0, size 0xa0, virtual false, abstract: false, final false
static inline ::StringW Normalize(::StringW  source, int32_t  type) ;

/// @brief Method PropValue, addr 0x2603f84, size 0x94, virtual false, abstract: false, final false
static inline uint32_t PropValue(int32_t  cp) ;

/// @brief Method QuickCheck, addr 0x26046fc, size 0x134, virtual false, abstract: false, final false
static inline ::System::Text::NormalizationCheck QuickCheck(char16_t  c, int32_t  type) ;

/// @brief Method ReorderCanonical, addr 0x2604fe0, size 0x270, virtual false, abstract: false, final false
static inline void ReorderCanonical(::StringW  src, ::ByRef<::System::Text::StringBuilder*>  sb, int32_t  start) ;

/// @brief Method TryCompose, addr 0x2604c64, size 0x118, virtual false, abstract: false, final false
static inline int32_t TryCompose(int32_t  i, int32_t  starter, int32_t  candidate) ;

/// @brief Method TryComposeWithPreviousStarter, addr 0x26049f4, size 0x234, virtual false, abstract: false, final false
...
/// @brief Method load_normalization_resource, addr 0x2605650, size 0x4, virtual false, abstract: false, final false
