...
/// @brief Method GetBestFitUnicodeToBytesData, addr 0x25ef580, size 0x58, virtual true, abstract: false, final false
inline ::ArrayW<char16_t,::Array<char16_t>*> GetBestFitUnicodeToBytesData() ;

/// @brief Method GetByteCount, addr 0x25eeda8, size 0x1f8, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  charCount, ::System::Text::EncoderNLS*  encoder) ;

/// @brief Method GetBytes, addr 0x25eefa0, size 0x358, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x25ef2f8, size 0x8, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count, ::System::Text::DecoderNLS*  decoder) ;

/// @brief Method GetChars, addr 0x25ef300, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method GetMaxByteCount, addr 0x25ef384, size 0x100, virtual true, abstract: false, final false
inline int32_t GetMaxByteCount(int32_t  charCount) ;

/// @brief Method GetMaxCharCount, addr 0x25ef484, size 0xfc, virtual true, abstract: false, final false
...
/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x25eecc0, size 0xe8, virtual true, abstract: false, final true
inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x25eec68, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25eec74, size 0x4c, virtual false, abstract: false, final false
