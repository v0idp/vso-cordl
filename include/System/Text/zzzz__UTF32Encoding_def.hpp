...
/// @brief Method Reset, addr 0x25f5dcc, size 0x20, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x25f5690, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Text::UTF32Encoding*  encoding) ;

/// @brief Method get_HasState, addr 0x25f5dec, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method Equals, addr 0x25f5b54, size 0xc4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetByteCount, addr 0x25f3864, size 0x178, virtual true, abstract: false, final false
inline int32_t GetByteCount(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  index, int32_t  count) ;

/// @brief Method GetByteCount, addr 0x25f3a68, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  count) ;

/// @brief Method GetByteCount, addr 0x25f483c, size 0x2cc, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  count, ::System::Text::EncoderNLS*  encoder) ;

/// @brief Method GetByteCount, addr 0x25f39dc, size 0x8c, virtual true, abstract: false, final false
inline int32_t GetByteCount(::StringW  s) ;

/// @brief Method GetBytes, addr 0x25f3d80, size 0x264, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x25f3fe4, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x25f4b08, size 0x3c4, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x25f3b38, size 0x248, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x25f40dc, size 0x178, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x25f4254, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x25f4ee8, size 0x338, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count, ::System::Text::DecoderNLS*  baseDecoder) ;

/// @brief Method GetChars, addr 0x25f4324, size 0x264, virtual true, abstract: false, final false
inline int32_t GetChars(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  byteIndex, int32_t  byteCount, ::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  charIndex) ;

/// @brief Method GetChars, addr 0x25f4588, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetChars, addr 0x25f5220, size 0x3f4, virtual true, abstract: false, final false
...
/// @brief Method GetDecoder, addr 0x25f5634, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::Decoder* GetDecoder() ;

/// @brief Method GetEncoder, addr 0x25f5698, size 0x5c, virtual true, abstract: false, final false
inline ::System::Text::Encoder* GetEncoder() ;

/// @brief Method GetHashCode, addr 0x25f5c18, size 0x7c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetHighSurrogate, addr 0x25f5614, size 0x14, virtual false, abstract: false, final false
inline char16_t GetHighSurrogate(uint32_t  iChar) ;

/// @brief Method GetLowSurrogate, addr 0x25f5628, size 0xc, virtual false, abstract: false, final false
inline char16_t GetLowSurrogate(uint32_t  iChar) ;

/// @brief Method GetMaxByteCount, addr 0x25f56f4, size 0x100, virtual true, abstract: false, final false
inline int32_t GetMaxByteCount(int32_t  charCount) ;

/// @brief Method GetMaxCharCount, addr 0x25f57f4, size 0xcc, virtual true, abstract: false, final false
inline int32_t GetMaxCharCount(int32_t  byteCount) ;

/// @brief Method GetPreamble, addr 0x25f58c0, size 0x114, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreamble() ;

/// @brief Method GetString, addr 0x25f4680, size 0x1bc, virtual true, abstract: false, final false
inline ::StringW GetString(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method GetSurrogate, addr 0x25f4ecc, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method SetDefaultFallbacks, addr 0x25f37a4, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25f36d4, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25f3768, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(bool  bigEndian, bool  byteOrderMark) ;

/// @brief Method .ctor, addr 0x25f36fc, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method get_Preamble, addr 0x25f59d4, size 0x180, virtual true, abstract: false, final false
