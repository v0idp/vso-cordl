...
/// @brief Method Fallback, addr 0x25ed3a8, size 0x150, virtual true, abstract: false, final false
inline bool Fallback(char16_t  charUnknown, int32_t  index) ;

/// @brief Method Fallback, addr 0x25ed4f8, size 0x220, virtual true, abstract: false, final false
inline bool Fallback(char16_t  charUnknownHigh, char16_t  charUnknownLow, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x25ed718, size 0x50, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method MovePrevious, addr 0x25ed768, size 0x30, virtual true, abstract: false, final false
inline bool MovePrevious() ;

static inline ::System::Text::EncoderReplacementFallbackBuffer* New_ctor(::System::Text::EncoderReplacementFallback*  fallback) ;

/// @brief Method Reset, addr 0x25ed7a4, size 0x14, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x25ed2a4, size 0x48, virtual false, abstract: false, final false
inline void _ctor(::System::Text::EncoderReplacementFallback*  fallback) ;

/// @brief Method get_Remaining, addr 0x25ed798, size 0xc, virtual true, abstract: false, final false
