...
/// @brief Method .ctor, addr 0x27ca69c, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x27ca214, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, char16_t  charUnknown, int32_t  index) ;

/// @brief Method .ctor, addr 0x27ca494, size 0x1f0, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, char16_t  charUnknownHigh, char16_t  charUnknownLow, int32_t  index) ;

/// @brief Method .ctor, addr 0x27ca6f8, size 0x8, virtual false, abstract: false, final false
