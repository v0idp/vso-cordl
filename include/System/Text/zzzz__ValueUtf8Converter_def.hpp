...
public:
// Declarations
/// @brief Method ConvertAndTerminateString, addr 0x25ff25c, size 0x1f0, virtual false, abstract: false, final false
inline ::System::Span_1<uint8_t> ConvertAndTerminateString(::System::ReadOnlySpan_1<char16_t>  value) ;

/// @brief Method Dispose, addr 0x25ff4f0, size 0xf4, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method .ctor, addr 0x25ff250, size 0xc, virtual false, abstract: false, final false
