...
/// @brief Method ClearMustFlush, addr 0x27cb508, size 0x168, virtual false, abstract: false, final false
inline void ClearMustFlush() ;

/// @brief Method Convert, addr 0x27cb080, size 0x2b4, virtual true, abstract: false, final false
...
/// @brief Method Convert, addr 0x27cb334, size 0x1b4, virtual true, abstract: false, final false
...
/// @brief Method GetByteCount, addr 0x27caa2c, size 0x1cc, virtual true, abstract: false, final false
inline int32_t GetByteCount(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  index, int32_t  count, bool  flush) ;

/// @brief Method GetByteCount, addr 0x27cabf8, size 0xf0, virtual true, abstract: false, final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  count, bool  flush) ;

/// @brief Method GetBytes, addr 0x27cace8, size 0x280, virtual true, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x27caf68, size 0x118, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x27caa0c, size 0x20, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x27c6668, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::System::Text::Encoding*  encoding) ;

/// @brief Method get_Encoding, addr 0x27cb4e8, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::Encoding* get_Encoding() ;

/// @brief Method get_HasState, addr 0x27cb4f8, size 0x10, virtual true, abstract: false, final false
inline bool get_HasState() ;

/// @brief Method get_MustFlush, addr 0x27cb4f0, size 0x8, virtual false, abstract: false, final false
