...
/// @brief Method InternalFallback, addr 0x27ca7d8, size 0x1a8, virtual true, abstract: false, final false
inline bool InternalFallback(char16_t  ch, ::ByRef<::cordl_internals::Ptr<char16_t>>  chars) ;

/// @brief Method InternalGetNextChar, addr 0x27c5ae4, size 0x30, virtual false, abstract: false, final false
inline char16_t InternalGetNextChar() ;

/// @brief Method InternalInitialize, addr 0x27c5ac8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method InternalReset, addr 0x27ca7c0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x27ca798, size 0x28, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ThrowLastCharRecursive, addr 0x27ca980, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27c9d28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
