...
/// @brief Method Fallback, addr 0x27c77e4, size 0x8, virtual true, abstract: false, final false
inline bool Fallback(::ArrayW<uint8_t,::Array<uint8_t>*>  bytesUnknown, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x27c79b8, size 0x8, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

static inline ::System::Text::DecoderExceptionFallbackBuffer* New_ctor() ;

/// @brief Method Throw, addr 0x27c77ec, size 0x1cc, virtual false, abstract: false, final false
inline void Throw(::ArrayW<uint8_t,::Array<uint8_t>*>  bytesUnknown, int32_t  index) ;

/// @brief Method .ctor, addr 0x27c7770, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Remaining, addr 0x27c79c0, size 0x8, virtual true, abstract: false, final false
