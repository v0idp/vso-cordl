...
/// @brief Method Append, addr 0x25fe97c, size 0x7c, virtual false, abstract: false, final false
inline void Append(char16_t  c) ;

/// @brief Method Append, addr 0x25fee94, size 0x128, virtual false, abstract: false, final false
inline void Append(char16_t  c, int32_t  count) ;

/// @brief Method Append, addr 0x25fea78, size 0xac, virtual false, abstract: false, final false
inline void Append(::StringW  s) ;

/// @brief Method Append, addr 0x25fefbc, size 0xe0, virtual false, abstract: false, final false
inline void Append(::cordl_internals::Ptr<char16_t>  value, int32_t  length) ;

/// @brief Method AppendSlow, addr 0x25feb24, size 0x12c, virtual false, abstract: false, final false
inline void AppendSlow(::StringW  s) ;

/// @brief Method AppendSpan, addr 0x25ff09c, size 0xbc, virtual false, abstract: false, final false
inline ::System::Span_1<char16_t> AppendSpan(int32_t  length) ;

/// @brief Method Dispose, addr 0x25ff158, size 0xf8, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method Grow, addr 0x25fec50, size 0x244, virtual false, abstract: false, final false
inline void Grow(int32_t  requiredAdditionalCapacity) ;

/// @brief Method GrowAndAppend, addr 0x25fe9f8, size 0x80, virtual false, abstract: false, final false
inline void GrowAndAppend(char16_t  c) ;

/// @brief Method ToString, addr 0x25fe7c8, size 0xcc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryCopyTo, addr 0x25fe894, size 0xe8, virtual false, abstract: false, final false
inline bool TryCopyTo(::System::Span_1<char16_t>  destination, ::ByRef<int32_t>  charsWritten) ;

/// @brief Method .ctor, addr 0x25fe78c, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::Span_1<char16_t>  initialBuffer) ;

/// @brief Method get_Item, addr 0x25fe7a4, size 0x24, virtual false, abstract: false, final false
inline ::ByRef<char16_t> get_Item(int32_t  index) ;

/// @brief Method get_Length, addr 0x25fe79c, size 0x8, virtual false, abstract: false, final false
