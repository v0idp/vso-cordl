...
/// @brief Method .ctor, addr 0x27c79f8, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x27c79c8, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::ArrayW<uint8_t,::Array<uint8_t>*>  bytesUnknown, int32_t  index) ;

/// @brief Method .ctor, addr 0x27c7a54, size 0x8, virtual false, abstract: false, final false
