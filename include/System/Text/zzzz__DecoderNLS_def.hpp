...
/// @brief Method ClearMustFlush, addr 0x27c8b64, size 0x8, virtual false, abstract: false, final false
inline void ClearMustFlush() ;

/// @brief Method Convert, addr 0x27c86e4, size 0x2b8, virtual true, abstract: false, final false
...
/// @brief Method Convert, addr 0x27c899c, size 0x1b8, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x27c8070, size 0x10, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method GetCharCount, addr 0x27c8080, size 0x1cc, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count, bool  flush) ;

/// @brief Method GetCharCount, addr 0x27c824c, size 0xf0, virtual true, abstract: false, final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count, bool  flush) ;

/// @brief Method GetChars, addr 0x27c833c, size 0x10, virtual true, abstract: false, final false
inline int32_t GetChars(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  byteIndex, int32_t  byteCount, ::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  charIndex) ;

/// @brief Method GetChars, addr 0x27c834c, size 0x280, virtual true, abstract: false, final false
...
/// @brief Method GetChars, addr 0x27c85cc, size 0x118, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x27c8058, size 0x18, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x27c65cc, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::System::Text::Encoding*  encoding) ;

/// @brief Method get_HasState, addr 0x27c8b5c, size 0x8, virtual true, abstract: false, final false
inline bool get_HasState() ;

/// @brief Method get_MustFlush, addr 0x27c8b54, size 0x8, virtual false, abstract: false, final false
