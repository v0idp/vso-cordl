...
/// @brief Method Convert, addr 0x27c6d10, size 0x2dc, virtual true, abstract: false, final false
...
/// @brief Method Convert, addr 0x27c6fec, size 0x220, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x27c68ac, size 0xc, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count, bool  flush) ;

/// @brief Method GetCharCount, addr 0x27c68b8, size 0x15c, virtual true, abstract: false, final false
...
/// @brief Method GetChars, addr 0x27c6a14, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method GetChars, addr 0x27c6c30, size 0xe0, virtual true, abstract: false, final false
inline int32_t GetChars(::System::ReadOnlySpan_1<uint8_t>  bytes, ::System::Span_1<char16_t>  chars, bool  flush) ;

/// @brief Method GetChars, addr 0x27c6a20, size 0x210, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x27c6794, size 0x118, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x27c6774, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Fallback, addr 0x27c677c, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::DecoderFallback* get_Fallback() ;

/// @brief Method get_FallbackBuffer, addr 0x27c609c, size 0x3c, virtual false, abstract: false, final false
inline ::System::Text::DecoderFallbackBuffer* get_FallbackBuffer() ;

/// @brief Method get_InternalHasFallbackBuffer, addr 0x27c6784, size 0x10, virtual false, abstract: false, final false
