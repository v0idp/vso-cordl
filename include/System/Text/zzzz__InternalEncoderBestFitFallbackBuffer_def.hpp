...
/// @brief Method Fallback, addr 0x27c9d30, size 0x30, virtual true, abstract: false, final false
inline bool Fallback(char16_t  charUnknown, int32_t  index) ;

/// @brief Method Fallback, addr 0x27c9e34, size 0x1d8, virtual true, abstract: false, final false
inline bool Fallback(char16_t  charUnknownHigh, char16_t  charUnknownLow, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x27ca00c, size 0x40, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method MovePrevious, addr 0x27ca04c, size 0x2c, virtual true, abstract: false, final false
...
/// @brief Method Reset, addr 0x27ca084, size 0x14, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method TryBestFit, addr 0x27c9d60, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27c9a80, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method get_InternalSyncObject, addr 0x27c9c94, size 0x94, virtual false, abstract: false, final false
static inline ::System::Object* get_InternalSyncObject() ;

/// @brief Method get_Remaining, addr 0x27ca078, size 0xc, virtual true, abstract: false, final false
