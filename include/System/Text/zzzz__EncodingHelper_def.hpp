...
/// @brief Method GetDefaultEncoding, addr 0x26026d8, size 0x17c, virtual false, abstract: false, final false
static inline ::System::Text::Encoding* GetDefaultEncoding() ;

/// @brief Method InternalCodePage, addr 0x2605a2c, size 0x4, virtual false, abstract: false, final false
static inline ::StringW InternalCodePage(::ByRef<int32_t>  code_page) ;

/// @brief Method InvokeI18N, addr 0x2600b0c, size 0x714, virtual false, abstract: false, final false
...
/// @brief Method get_UTF8Unmarked, addr 0x2605848, size 0x1e4, virtual false, abstract: false, final false
