...
/// @brief Method CreateFallbackBuffer, addr 0x25ed24c, size 0x58, virtual true, abstract: false, final false
inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer() ;

/// @brief Method Equals, addr 0x25ed308, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetHashCode, addr 0x25ed388, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x25ed1e8, size 0x5c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x25ecef4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25ed0e4, size 0x104, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x25ecf3c, size 0x1a8, virtual false, abstract: false, final false
inline void _ctor(::StringW  replacement) ;

/// @brief Method get_DefaultString, addr 0x25ed244, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_DefaultString() ;

/// @brief Method get_MaxCharCount, addr 0x25ed2ec, size 0x1c, virtual true, abstract: false, final false
