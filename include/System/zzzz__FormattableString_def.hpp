...
/// @brief Method System.IFormattable.ToString, addr 0x272fba0, size 0x14, virtual true, abstract: false, final true
inline ::StringW System_IFormattable_ToString(::StringW  ignored, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method ToString, addr 0x272fbb4, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x272fc1c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
