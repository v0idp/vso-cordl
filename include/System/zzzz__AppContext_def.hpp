...
/// @brief Method InitializeDefaultSwitchValues, addr 0x276dda4, size 0x174, virtual false, abstract: false, final false
static inline void InitializeDefaultSwitchValues() ;

/// @brief Method TryGetSwitch, addr 0x276df18, size 0x408, virtual false, abstract: false, final false
