...
public:
// Declarations
/// @brief Method get_ansi, addr 0x2790ff4, size 0x70, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_ansi() ;

/// @brief Method get_linux, addr 0x2790f14, size 0x70, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_linux() ;

/// @brief Method get_xterm, addr 0x2790f84, size 0x70, virtual false, abstract: false, final false
