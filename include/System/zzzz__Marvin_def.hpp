...
/// @brief Method Block, addr 0x2747068, size 0x88, virtual false, abstract: false, final false
static inline void Block(::ByRef<uint32_t>  rp0, ::ByRef<uint32_t>  rp1) ;

/// @brief Method ComputeHash32, addr 0x2746c78, size 0x3f0, virtual false, abstract: false, final false
static inline int32_t ComputeHash32(::ByRef<uint8_t>  data, int32_t  count, uint64_t  seed) ;

/// @brief Method ComputeHash32, addr 0x2746bcc, size 0xac, virtual false, abstract: false, final false
static inline int32_t ComputeHash32(::System::ReadOnlySpan_1<uint8_t>  data, uint64_t  seed) ;

/// @brief Method GenerateSeed, addr 0x2747154, size 0xc, virtual false, abstract: false, final false
static inline uint64_t GenerateSeed() ;

/// @brief Method _rotl, addr 0x27470f0, size 0xc, virtual false, abstract: false, final false
static inline uint32_t _rotl(uint32_t  value, int32_t  shift) ;

static inline uint64_t getStaticF__DefaultSeed_k__BackingField() ;

/// @brief Method get_DefaultSeed, addr 0x27470fc, size 0x58, virtual false, abstract: false, final false
