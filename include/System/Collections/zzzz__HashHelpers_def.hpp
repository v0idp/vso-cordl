...
/// @brief Method ExpandPrime, addr 0x2714e20, size 0x84, virtual false, abstract: false, final false
static inline int32_t ExpandPrime(int32_t  oldSize) ;

/// @brief Method GetPrime, addr 0x2714c98, size 0x188, virtual false, abstract: false, final false
static inline int32_t GetPrime(int32_t  min) ;

/// @brief Method IsPrime, addr 0x2714be0, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method get_SerializationInfoTable, addr 0x2714ea4, size 0xd8, virtual false, abstract: false, final false
