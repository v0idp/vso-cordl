...
/// @brief Method Clone, addr 0x271cb64, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* Clone() ;

/// @brief Method MoveNext, addr 0x271cb6c, size 0x1a8, virtual true, abstract: false, final false
inline bool MoveNext() ;

static inline ::System::Collections::BitArray_BitArrayEnumeratorSimple* New_ctor(::System::Collections::BitArray*  bitarray) ;

/// @brief Method Reset, addr 0x271ce68, size 0x78, virtual true, abstract: false, final true
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x271cb24, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::BitArray*  bitarray) ;

/// @brief Method get_Current, addr 0x271cd14, size 0x154, virtual true, abstract: false, final false
...
/// @brief Method Clone, addr 0x271ca70, size 0x58, virtual true, abstract: false, final true
inline ::System::Object* Clone() ;

/// @brief Method CopyTo, addr 0x271c4ec, size 0x504, virtual true, abstract: false, final true
inline void CopyTo(::System::Array*  array, int32_t  index) ;

/// @brief Method Get, addr 0x271c144, size 0xd8, virtual false, abstract: false, final false
inline bool Get(int32_t  index) ;

/// @brief Method GetArrayLength, addr 0x271c02c, size 0x1c, virtual false, abstract: false, final false
static inline int32_t GetArrayLength(int32_t  n, int32_t  div) ;

/// @brief Method GetEnumerator, addr 0x271cac8, size 0x5c, virtual true, abstract: false, final true
...
/// @brief Method Set, addr 0x271c224, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x271c048, size 0xf8, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::BitArray*  bits) ;

/// @brief Method .ctor, addr 0x271becc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  length) ;

/// @brief Method .ctor, addr 0x271bed4, size 0x158, virtual false, abstract: false, final false
inline void _ctor(int32_t  length, bool  defaultValue) ;

/// @brief Method get_Count, addr 0x271c9f0, size 0x8, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsSynchronized, addr 0x271ca68, size 0x8, virtual true, abstract: false, final true
inline bool get_IsSynchronized() ;

/// @brief Method get_Item, addr 0x271c140, size 0x4, virtual false, abstract: false, final false
inline bool get_Item(int32_t  index) ;

/// @brief Method get_Length, addr 0x271c31c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Length() ;

/// @brief Method get_SyncRoot, addr 0x271c9f8, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method set_Item, addr 0x271c21c, size 0x8, virtual false, abstract: false, final false
inline void set_Item(int32_t  index, bool  value) ;

/// @brief Method set_Length, addr 0x271c324, size 0x1c8, virtual false, abstract: false, final false
