...
public:
// Declarations
/// @brief Method Equals, addr 0x2724b74, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2724970, size 0x10, virtual true, abstract: false, final false
inline bool Equals(uint8_t  x, uint8_t  y) ;

/// @brief Method GetHashCode, addr 0x2724bec, size 0x34, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetHashCode, addr 0x2724980, size 0x1c, virtual true, abstract: false, final false
inline int32_t GetHashCode(uint8_t  b) ;

/// @brief Method IndexOf, addr 0x272499c, size 0x180, virtual true, abstract: false, final false
inline int32_t IndexOf(::ArrayW<uint8_t,::Array<uint8_t>*>  array, uint8_t  value, int32_t  startIndex, int32_t  count) ;

/// @brief Method LastIndexOf, addr 0x2724b1c, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2724c20, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
