...
public:
// Declarations
/// @brief Method Equals, addr 0x2724c88, size 0x30, virtual true, abstract: false, final false
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode, addr 0x2724c68, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode(::StringW  obj) ;

/// @brief Method IndexOf, addr 0x2724cb8, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2724d20, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
