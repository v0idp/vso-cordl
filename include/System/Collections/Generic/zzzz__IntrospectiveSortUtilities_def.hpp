...
public:
// Declarations
/// @brief Method FloorLog2PlusOne, addr 0x27248e8, size 0x28, virtual false, abstract: false, final false
static inline int32_t FloorLog2PlusOne(int32_t  n) ;

/// @brief Method ThrowOrIgnoreBadComparer, addr 0x2724910, size 0x60, virtual false, abstract: false, final false
