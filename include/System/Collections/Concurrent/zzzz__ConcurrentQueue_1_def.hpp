...
/// @brief Field InitialSegmentLength offset 0xffffffff size 0x4
static constexpr int32_t  InitialSegmentLength{static_cast<int32_t>(0x20)};

/// @brief Field MaxSegmentLength offset 0xffffffff size 0x4
static constexpr int32_t  MaxSegmentLength{static_cast<int32_t>(0x100000)};
