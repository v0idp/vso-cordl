...
/// @brief Method CreateMask, addr 0x2d46474, size 0x8, virtual false, abstract: false, final false
static inline int32_t CreateMask() ;

/// @brief Method CreateMask, addr 0x2d4647c, size 0x6c, virtual false, abstract: false, final false
static inline int32_t CreateMask(int32_t  previous) ;

/// @brief Method Equals, addr 0x2d464e8, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method GetHashCode, addr 0x2d46560, size 0x64, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x2d46694, size 0x8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2d465c4, size 0xd0, virtual false, abstract: false, final false
static inline ::StringW ToString(::System::Collections::Specialized::BitVector32  value) ;

/// @brief Method get_Item, addr 0x2d46448, size 0x10, virtual false, abstract: false, final false
inline bool get_Item(int32_t  bit) ;

/// @brief Method set_Item, addr 0x2d46458, size 0x1c, virtual false, abstract: false, final false
