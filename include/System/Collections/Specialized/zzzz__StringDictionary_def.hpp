...
/// @brief Method Add, addr 0x2d493a0, size 0x94, virtual true, abstract: false, final false
inline void Add(::StringW  key, ::StringW  value) ;

/// @brief Method GetEnumerator, addr 0x2d49434, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d49340, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
