...
public:
// Declarations
/// @brief Method Add, addr 0x2d4a4c8, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d4a4c4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
