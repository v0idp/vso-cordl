...
public:
// Declarations
/// @brief Method Invoke, addr 0x27642d8, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27641d4, size 0x104, virtual false, abstract: false, final false
