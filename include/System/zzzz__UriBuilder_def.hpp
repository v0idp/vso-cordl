...
/// @brief Method Equals, addr 0x2cd8c1c, size 0x5c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  rparam) ;

/// @brief Method GetHashCode, addr 0x2cd8c78, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Init, addr 0x2cd8748, size 0x174, virtual false, abstract: false, final false
inline void Init(::System::Uri*  uri) ;

static inline ::System::UriBuilder* New_ctor(::System::Uri*  uri) ;

/// @brief Method SetFieldsFromUri, addr 0x2cd88bc, size 0x164, virtual false, abstract: false, final false
inline void SetFieldsFromUri(::System::Uri*  uri) ;

/// @brief Method ToString, addr 0x2cd8c98, size 0x428, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cd85d8, size 0x170, virtual false, abstract: false, final false
inline void _ctor(::System::Uri*  uri) ;

/// @brief Method get_Uri, addr 0x2cd8b8c, size 0x90, virtual false, abstract: false, final false
inline ::System::Uri* get_Uri() ;

/// @brief Method set_Path, addr 0x2cd8a20, size 0xb4, virtual false, abstract: false, final false
inline void set_Path(::StringW  value) ;

/// @brief Method set_Query, addr 0x2cd8ad4, size 0xb8, virtual false, abstract: false, final false
