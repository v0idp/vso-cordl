...
/// @brief Method GenerateGlobalSeed, addr 0x2756d90, size 0x24, virtual false, abstract: false, final false
static inline int32_t GenerateGlobalSeed() ;

/// @brief Method GenerateSeed, addr 0x2756974, size 0x1c0, virtual false, abstract: false, final false
static inline int32_t GenerateSeed() ;

/// @brief Method GetSampleForLargeRange, addr 0x2756db8, size 0x4c, virtual false, abstract: false, final false
inline double_t GetSampleForLargeRange() ;

/// @brief Method InternalSample, addr 0x2756d04, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Next, addr 0x2756db4, size 0x4, virtual true, abstract: false, final false
inline int32_t Next() ;

/// @brief Method Next, addr 0x2756f1c, size 0xc4, virtual true, abstract: false, final false
inline int32_t Next(int32_t  maxValue) ;

/// @brief Method Next, addr 0x2756e04, size 0x118, virtual true, abstract: false, final false
inline int32_t Next(int32_t  minValue, int32_t  maxValue) ;

/// @brief Method Sample, addr 0x2756ce4, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2756918, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2756b34, size 0x1b0, virtual false, abstract: false, final false
