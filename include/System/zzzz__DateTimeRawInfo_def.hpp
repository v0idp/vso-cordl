...
public:
// Declarations
/// @brief Method AddNumber, addr 0x273ed2c, size 0x18, virtual false, abstract: false, final false
inline void AddNumber(int32_t  value) ;

/// @brief Method GetNumber, addr 0x273ed44, size 0xc, virtual false, abstract: false, final false
inline int32_t GetNumber(int32_t  index) ;

/// @brief Method Init, addr 0x273ed0c, size 0x20, virtual false, abstract: false, final false
...
constexpr DateTimeRawInfo(::cordl_internals::Ptr<int32_t>  num, int32_t  numCount, int32_t  month, int32_t  year, int32_t  dayOfWeek, int32_t  era, ::System::DateTimeParse_TM  timeMark, double_t  fraction, bool  hasSameDateAndTimeSeparators) noexcept;
