...
/// @brief Method Finalize, addr 0x276e3e4, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x276e3bc, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::LocalDataStore*  store) ;

/// @brief Method get_Store, addr 0x276e49c, size 0x8, virtual false, abstract: false, final false
