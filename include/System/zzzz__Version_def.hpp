...
/// @brief Method Clone, addr 0x2764eac, size 0x58, virtual true, abstract: false, final true
inline ::System::Object* Clone() ;

/// @brief Method CompareTo, addr 0x2764ff0, size 0x68, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Version*  value) ;

/// @brief Method CompareTo, addr 0x2764f24, size 0xb8, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  version) ;

/// @brief Method Equals, addr 0x2765058, size 0x64, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x27650bc, size 0x60, virtual true, abstract: false, final true
inline bool Equals(::System::Version*  obj) ;

/// @brief Method GetHashCode, addr 0x276511c, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method Parse, addr 0x2764db4, size 0x98, virtual false, abstract: false, final false
static inline ::System::Version* Parse(::StringW  input) ;

/// @brief Method ParseVersion, addr 0x27655dc, size 0x44c, virtual false, abstract: false, final false
static inline ::System::Version* ParseVersion(::System::ReadOnlySpan_1<char16_t>  input, bool  throwOnFailure) ;

/// @brief Method System.ISpanFormattable.TryFormat, addr 0x27655b0, size 0x2c, virtual true, abstract: false, final true
...
/// @brief Method ToCachedStringBuilder, addr 0x2765214, size 0x248, virtual false, abstract: false, final false
inline ::System::Text::StringBuilder* ToCachedStringBuilder(int32_t  fieldCount) ;

/// @brief Method ToString, addr 0x2765138, size 0x28, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2765188, size 0x8c, virtual false, abstract: false, final false
inline ::StringW ToString(int32_t  fieldCount) ;

/// @brief Method TryFormat, addr 0x276545c, size 0x2c, virtual false, abstract: false, final false
inline bool TryFormat(::System::Span_1<char16_t>  destination, ::ByRef<int32_t>  charsWritten) ;

/// @brief Method TryFormat, addr 0x2765488, size 0x128, virtual false, abstract: false, final false
inline bool TryFormat(::System::Span_1<char16_t>  destination, int32_t  fieldCount, ::ByRef<int32_t>  charsWritten) ;

/// @brief Method TryParse, addr 0x2765a28, size 0x6c, virtual false, abstract: false, final false
static inline bool TryParse(::StringW  input, ::ByRef<::System::Version*>  result) ;

/// @brief Method TryParseComponent, addr 0x2765abc, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2764e4c, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2764cb8, size 0xb8, virtual false, abstract: false, final false
inline void _ctor(int32_t  major, int32_t  minor) ;

/// @brief Method .ctor, addr 0x2764bcc, size 0xec, virtual false, abstract: false, final false
inline void _ctor(int32_t  major, int32_t  minor, int32_t  build) ;

/// @brief Method .ctor, addr 0x2764ab8, size 0x114, virtual false, abstract: false, final false
inline void _ctor(int32_t  major, int32_t  minor, int32_t  build, int32_t  revision) ;

/// @brief Method .ctor, addr 0x2764d70, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::StringW  version) ;

/// @brief Method .ctor, addr 0x2764e70, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::System::Version*  version) ;

/// @brief Method get_Build, addr 0x2764f14, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Build() ;

/// @brief Method get_DefaultFormatFieldCount, addr 0x2765160, size 0x28, virtual false, abstract: false, final false
inline int32_t get_DefaultFormatFieldCount() ;

/// @brief Method get_Major, addr 0x2764f04, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Major() ;

/// @brief Method get_Minor, addr 0x2764f0c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Minor() ;

/// @brief Method get_Revision, addr 0x2764f1c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2764fdc, size 0x14, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Version*  v1, ::System::Version*  v2) ;

/// @brief Method op_GreaterThan, addr 0x2765c94, size 0x10, virtual false, abstract: false, final false
static inline bool op_GreaterThan(::System::Version*  v1, ::System::Version*  v2) ;

/// @brief Method op_GreaterThanOrEqual, addr 0x2765ca4, size 0x10, virtual false, abstract: false, final false
static inline bool op_GreaterThanOrEqual(::System::Version*  v1, ::System::Version*  v2) ;

/// @brief Method op_Inequality, addr 0x2765a94, size 0x28, virtual false, abstract: false, final false
static inline bool op_Inequality(::System::Version*  v1, ::System::Version*  v2) ;

/// @brief Method op_LessThan, addr 0x2765bd0, size 0x60, virtual false, abstract: false, final false
static inline bool op_LessThan(::System::Version*  v1, ::System::Version*  v2) ;

/// @brief Method op_LessThanOrEqual, addr 0x2765c30, size 0x64, virtual false, abstract: false, final false
