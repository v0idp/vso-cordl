...
/// @brief Method .ctor, addr 0x2cdaf28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x2cdaf30, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AllowIdnStatic, addr 0x2cac7b8, size 0xc8, virtual false, abstract: false, final false
inline bool AllowIdnStatic(::System::UriParser*  syntax, ::System::Uri_Flags  flags) ;

/// @brief Method CalculateCaseInsensitiveHashCode, addr 0x2cb1d44, size 0xa0, virtual false, abstract: false, final false
static inline int32_t CalculateCaseInsensitiveHashCode(::StringW  text) ;

/// @brief Method CheckAuthorityHelper, addr 0x2cb366c, size 0xe28, virtual false, abstract: false, final false
inline uint16_t CheckAuthorityHelper(::cordl_internals::Ptr<char16_t>  pString, uint16_t  idx, uint16_t  length, ::ByRef<::System::ParsingError>  err, ::ByRef<::System::Uri_Flags>  flags, ::System::UriParser*  syntax, ::ByRef<::StringW>  newHost) ;

/// @brief Method CheckAuthorityHelperHandleAnyHostIri, addr 0x2cb7430, size 0x2c4, virtual false, abstract: false, final false
inline void CheckAuthorityHelperHandleAnyHostIri(::cordl_internals::Ptr<char16_t>  pString, int32_t  startInput, int32_t  end, bool  iriParsing, bool  hasUnicode, ::System::UriParser*  syntax, ::ByRef<::System::Uri_Flags>  flags, ::ByRef<::StringW>  newHost, ::ByRef<::System::ParsingError>  err) ;

/// @brief Method CheckAuthorityHelperHandleDnsIri, addr 0x2cb70dc, size 0x354, virtual false, abstract: false, final false
inline void CheckAuthorityHelperHandleDnsIri(::cordl_internals::Ptr<char16_t>  pString, uint16_t  start, int32_t  end, int32_t  startInput, bool  iriParsing, bool  hasUnicode, ::System::UriParser*  syntax, ::StringW  userInfoString, ::ByRef<::System::Uri_Flags>  flags, ::ByRef<bool>  justNormalized, ::ByRef<::StringW>  newHost, ::ByRef<::System::ParsingError>  err) ;

/// @brief Method CheckCanonical, addr 0x2cb4b74, size 0x3fc, virtual false, abstract: false, final false
inline ::System::Uri_Check CheckCanonical(::cordl_internals::Ptr<char16_t>  str, ::ByRef<uint16_t>  idx, uint16_t  end, char16_t  delim) ;

/// @brief Method CheckForColonInFirstPathSegment, addr 0x2cb2730, size 0xb8, virtual false, abstract: false, final false
static inline bool CheckForColonInFirstPathSegment(::StringW  uriString) ;

/// @brief Method CheckForConfigLoad, addr 0x2cb8088, size 0xe4, virtual false, abstract: false, final false
inline bool CheckForConfigLoad(::StringW  data) ;

/// @brief Method CheckForEscapedUnreserved, addr 0x2cb8294, size 0x1c4, virtual false, abstract: false, final false
inline bool CheckForEscapedUnreserved(::StringW  data) ;

/// @brief Method CheckForUnicode, addr 0x2cb816c, size 0x128, virtual false, abstract: false, final false
inline bool CheckForUnicode(::StringW  data) ;

/// @brief Method CheckKnownSchemes, addr 0x2cb6b60, size 0x57c, virtual false, abstract: false, final false
static inline bool CheckKnownSchemes(::cordl_internals::Ptr<int64_t>  lptr, uint16_t  nChars, ::ByRef<::System::UriParser*>  syntax) ;

/// @brief Method CheckSchemeSyntax, addr 0x2caeec8, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method CombineUri, addr 0x2caf028, size 0x924, virtual false, abstract: false, final false
static inline ::StringW CombineUri(::System::Uri*  basePart, ::StringW  relativePart, ::System::UriFormat  uriFormat) ;

/// @brief Method Compress, addr 0x2cb0f0c, size 0x4d4, virtual false, abstract: false, final false
...
/// @brief Method CreateHelper, addr 0x2cb8458, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method CreateHostString, addr 0x2cadb38, size 0x3f4, virtual false, abstract: false, final false
inline void CreateHostString() ;

/// @brief Method CreateHostStringHelper, addr 0x2cb4998, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method CreateThis, addr 0x2cadfac, size 0x1b8, virtual false, abstract: false, final false
inline void CreateThis(::StringW  uri, bool  dontEscape, ::System::UriKind  uriKind) ;

/// @brief Method CreateThisFromUri, addr 0x2cae95c, size 0x120, virtual false, abstract: false, final false
inline void CreateThisFromUri(::System::Uri*  otherUri) ;

/// @brief Method CreateUri, addr 0x2cae2b8, size 0x188, virtual false, abstract: false, final false
inline void CreateUri(::System::Uri*  baseUri, ::StringW  relativeUri, bool  dontEscape) ;

/// @brief Method CreateUriInfo, addr 0x2cac950, size 0x588, virtual false, abstract: false, final false
inline void CreateUriInfo(::System::Uri_Flags  cF) ;

/// @brief Method EnsureHostString, addr 0x2cadad8, size 0x60, virtual false, abstract: false, final false
inline void EnsureHostString(bool  allowDnsOptimization) ;

/// @brief Method EnsureParseRemaining, addr 0x2caced8, size 0x10, virtual false, abstract: false, final false
inline void EnsureParseRemaining() ;

/// @brief Method EnsureUriInfo, addr 0x2cac92c, size 0x24, virtual false, abstract: false, final false
inline ::System::Uri_UriInfo* EnsureUriInfo() ;

/// @brief Method Equals, addr 0x2cb20f8, size 0x584, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method EscapeUnescapeIri, addr 0x2cb6b10, size 0x50, virtual false, abstract: false, final false
inline ::StringW EscapeUnescapeIri(::StringW  input, int32_t  start, int32_t  end, ::System::UriComponents  component) ;

/// @brief Method FindEndOfComponent, addr 0x2cb6abc, size 0x54, virtual false, abstract: false, final false
inline void FindEndOfComponent(::StringW  input, ::ByRef<uint16_t>  idx, uint16_t  end, char16_t  delim) ;

/// @brief Method FindEndOfComponent, addr 0x2cb7854, size 0x98, virtual false, abstract: false, final false
inline void FindEndOfComponent(::cordl_internals::Ptr<char16_t>  str, ::ByRef<uint16_t>  idx, uint16_t  end, char16_t  delim) ;

/// @brief Method FromHex, addr 0x2cb1b64, size 0xac, virtual false, abstract: false, final false
static inline int32_t FromHex(char16_t  digit) ;

/// @brief Method GetCanonicalPath, addr 0x2cb644c, size 0x670, virtual false, abstract: false, final false
...
/// @brief Method GetCombinedString, addr 0x2caec88, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method GetComponents, addr 0x2cb4f70, size 0x1c8, virtual false, abstract: false, final false
inline ::StringW GetComponents(::System::UriComponents  components, ::System::UriFormat  format) ;

/// @brief Method GetComponentsHelper, addr 0x2cb1eb0, size 0x214, virtual false, abstract: false, final false
inline ::StringW GetComponentsHelper(::System::UriComponents  uriComponents, ::System::UriFormat  uriFormat) ;

/// @brief Method GetEscapedParts, addr 0x2cb5138, size 0xc8, virtual false, abstract: false, final false
inline ::StringW GetEscapedParts(::System::UriComponents  uriParts) ;

/// @brief Method GetException, addr 0x2caf94c, size 0x1a0, virtual false, abstract: false, final false
static inline ::System::UriFormatException* GetException(::System::ParsingError  err) ;

/// @brief Method GetHashCode, addr 0x2cb1c10, size 0x134, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetHostViaCustomSyntax, addr 0x2cb4568, size 0x430, virtual false, abstract: false, final false
inline void GetHostViaCustomSyntax() ;

/// @brief Method GetLocalPath, addr 0x2caff9c, size 0x5ec, virtual false, abstract: false, final false
inline ::StringW GetLocalPath() ;

/// @brief Method GetObjectData, addr 0x2cafbf0, size 0xd8, virtual false, abstract: false, final false
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  serializationInfo, ::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method GetParts, addr 0x2cafcc8, size 0x4, virtual false, abstract: false, final false
inline ::StringW GetParts(::System::UriComponents  uriParts, ::System::UriFormat  formatAs) ;

/// @brief Method GetRelativeSerializationString, addr 0x2cb8904, size 0x21c, virtual false, abstract: false, final false
inline ::StringW GetRelativeSerializationString(::System::UriFormat  format) ;

/// @brief Method GetUnescapedParts, addr 0x2cb13e0, size 0xd0, virtual false, abstract: false, final false
inline ::StringW GetUnescapedParts(::System::UriComponents  uriParts, ::System::UriFormat  formatAs) ;

/// @brief Method GetUriPartsFromUserString, addr 0x2cb5200, size 0x598, virtual false, abstract: false, final false
inline ::StringW GetUriPartsFromUserString(::System::UriComponents  uriParts) ;

/// @brief Method InFact, addr 0x2cac910, size 0x10, virtual false, abstract: false, final false
inline bool InFact(::System::Uri_Flags  flags) ;

/// @brief Method InitializeUri, addr 0x2cb7bc0, size 0x4c8, virtual false, abstract: false, final false
inline void InitializeUri(::System::ParsingError  err, ::System::UriKind  uriKind, ::ByRef<::System::UriFormatException*>  e) ;

/// @brief Method InitializeUriConfig, addr 0x2cb0d70, size 0x19c, virtual false, abstract: false, final false
static inline void InitializeUriConfig() ;

/// @brief Method InternalEscapeString, addr 0x2cb27e8, size 0xdc, virtual false, abstract: false, final false
static inline ::StringW InternalEscapeString(::StringW  rawString) ;

/// @brief Method InternalIsWellFormedOriginalString, addr 0x2cb8b64, size 0x468, virtual false, abstract: false, final false
inline bool InternalIsWellFormedOriginalString() ;

/// @brief Method IriParsingStatic, addr 0x2cac660, size 0x8c, virtual false, abstract: false, final false
static inline bool IriParsingStatic(::System::UriParser*  syntax) ;

/// @brief Method IsAsciiLetter, addr 0x2cb3640, size 0x2c, virtual false, abstract: false, final false
static inline bool IsAsciiLetter(char16_t  character) ;

/// @brief Method IsAsciiLetterOrDigit, addr 0x2cb7b14, size 0x7c, virtual false, abstract: false, final false
static inline bool IsAsciiLetterOrDigit(char16_t  character) ;

/// @brief Method IsBaseOf, addr 0x2cb9248, size 0xb4, virtual false, abstract: false, final false
inline bool IsBaseOf(::System::Uri*  uri) ;

/// @brief Method IsBaseOfHelper, addr 0x2cb92fc, size 0x1ec, virtual false, abstract: false, final false
inline bool IsBaseOfHelper(::System::Uri*  uriLink) ;

/// @brief Method IsBidiControlCharacter, addr 0x2cb7b90, size 0x30, virtual false, abstract: false, final false
static inline bool IsBidiControlCharacter(char16_t  ch) ;

/// @brief Method IsGenDelim, addr 0x2cb1af8, size 0x30, virtual false, abstract: false, final false
static inline bool IsGenDelim(char16_t  ch) ;

/// @brief Method IsHexDigit, addr 0x2cb1b28, size 0x3c, virtual false, abstract: false, final false
static inline bool IsHexDigit(char16_t  character) ;

/// @brief Method IsIntranet, addr 0x2cac88c, size 0x8, virtual false, abstract: false, final false
inline bool IsIntranet(::StringW  schemeHost) ;

/// @brief Method IsLWS, addr 0x2cb3608, size 0x38, virtual false, abstract: false, final false
static inline bool IsLWS(char16_t  ch) ;

/// @brief Method IsWellFormedOriginalString, addr 0x2cb8b20, size 0x44, virtual false, abstract: false, final false
inline bool IsWellFormedOriginalString() ;

/// @brief Method IsWellFormedUriString, addr 0x2cb8fcc, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method NotAny, addr 0x2cac7a8, size 0x10, virtual false, abstract: false, final false
inline bool NotAny(::System::Uri_Flags  flags) ;

/// @brief Method ParseMinimal, addr 0x2cb2ef4, size 0x80, virtual false, abstract: false, final false
inline ::System::UriFormatException* ParseMinimal() ;

/// @brief Method ParseRemaining, addr 0x2cacee8, size 0xbf0, virtual false, abstract: false, final false
inline void ParseRemaining() ;

/// @brief Method ParseScheme, addr 0x2cb28c4, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method ParseSchemeCheckImplicitFile, addr 0x2cb2998, size 0x55c, virtual false, abstract: false, final false
static inline uint16_t ParseSchemeCheckImplicitFile(::cordl_internals::Ptr<char16_t>  uriString, uint16_t  length, ::ByRef<::System::ParsingError>  err, ::ByRef<::System::Uri_Flags>  flags, ::ByRef<::System::UriParser*>  syntax) ;

/// @brief Method PrivateParseMinimal, addr 0x2cb2f74, size 0x694, virtual false, abstract: false, final false
inline ::System::ParsingError PrivateParseMinimal() ;

/// @brief Method PrivateParseMinimalIri, addr 0x2cb4494, size 0xd4, virtual false, abstract: false, final false
inline void PrivateParseMinimalIri(::StringW  newHost, uint16_t  idx) ;

/// @brief Method ReCreateParts, addr 0x2cb5798, size 0xcb4, virtual false, abstract: false, final false
inline ::StringW ReCreateParts(::System::UriComponents  parts, uint16_t  nonCanonical, ::System::UriFormat  formatAs) ;

/// @brief Method ResolveHelper, addr 0x2cae440, size 0x4d4, virtual false, abstract: false, final false
...
/// @brief Method SetUserDrivenParsing, addr 0x2cac8a0, size 0x14, virtual false, abstract: false, final false
inline void SetUserDrivenParsing() ;

/// @brief Method StaticInFact, addr 0x2cac920, size 0xc, virtual false, abstract: false, final false
static inline bool StaticInFact(::System::Uri_Flags  allFlags, ::System::Uri_Flags  checkFlags) ;

/// @brief Method StaticIsFile, addr 0x2cb0c8c, size 0x18, virtual false, abstract: false, final false
static inline bool StaticIsFile(::System::UriParser*  syntax) ;

/// @brief Method StaticNotAny, addr 0x2cac880, size 0xc, virtual false, abstract: false, final false
static inline bool StaticNotAny(::System::Uri_Flags  allFlags, ::System::Uri_Flags  checkFlags) ;

/// @brief Method StripBidiControlCharacter, addr 0x2cb76f4, size 0x160, virtual false, abstract: false, final false
static inline ::StringW StripBidiControlCharacter(::cordl_internals::Ptr<char16_t>  strToClean, int32_t  start, int32_t  length) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x2cafbec, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method ToString, addr 0x2cb1de4, size 0xcc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryCreate, addr 0x2cb86b8, size 0xd0, virtual false, abstract: false, final false
static inline bool TryCreate(::System::Uri*  baseUri, ::StringW  relativeUri, ::ByRef<::System::Uri*>  result) ;

/// @brief Method TryCreate, addr 0x2cb8788, size 0x17c, virtual false, abstract: false, final false
static inline bool TryCreate(::System::Uri*  baseUri, ::System::Uri*  relativeUri, ::ByRef<::System::Uri*>  result) ;

/// @brief Method TryCreate, addr 0x2cb267c, size 0xb4, virtual false, abstract: false, final false
static inline bool TryCreate(::StringW  uriString, ::System::UriKind  uriKind, ::ByRef<::System::Uri*>  result) ;

/// @brief Method UnescapeDataString, addr 0x2cb9068, size 0x1a0, virtual false, abstract: false, final false
static inline ::StringW UnescapeDataString(::StringW  stringToUnescape) ;

/// @brief Method UnescapeOnly, addr 0x2cb78ec, size 0x21c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cae1e8, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Uri*  baseUri, ::StringW  relativeUri) ;

/// @brief Method .ctor, addr 0x2caea7c, size 0x20c, virtual false, abstract: false, final false
inline void _ctor(::System::Uri*  baseUri, ::System::Uri*  relativeUri) ;

/// @brief Method .ctor, addr 0x2cb9208, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::Uri_Flags  flags, ::System::UriParser*  uriParser, ::StringW  uri) ;

/// @brief Method .ctor, addr 0x2cafaec, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  serializationInfo, ::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method .ctor, addr 0x2cadf2c, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  uriString) ;

/// @brief Method .ctor, addr 0x2cae164, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method get_AbsolutePath, addr 0x2cafccc, size 0xc0, virtual false, abstract: false, final false
inline ::StringW get_AbsolutePath() ;

/// @brief Method get_AbsoluteUri, addr 0x2cafe34, size 0xfc, virtual false, abstract: false, final false
inline ::StringW get_AbsoluteUri() ;

/// @brief Method get_AllowIdn, addr 0x2cac6ec, size 0xbc, virtual false, abstract: false, final false
inline bool get_AllowIdn() ;

/// @brief Method get_Authority, addr 0x2cb0588, size 0x74, virtual false, abstract: false, final false
inline ::StringW get_Authority() ;

/// @brief Method get_DnsSafeHost, addr 0x2cb182c, size 0x24c, virtual false, abstract: false, final false
inline ::StringW get_DnsSafeHost() ;

/// @brief Method get_Fragment, addr 0x2cb1674, size 0x100, virtual false, abstract: false, final false
inline ::StringW get_Fragment() ;

/// @brief Method get_HasAuthority, addr 0x2cb7b08, size 0xc, virtual false, abstract: false, final false
inline bool get_HasAuthority() ;

/// @brief Method get_Host, addr 0x2cb0c18, size 0x74, virtual false, abstract: false, final false
inline ::StringW get_Host() ;

/// @brief Method get_HostNameType, addr 0x2cb05fc, size 0xf8, virtual false, abstract: false, final false
inline ::System::UriHostNameType get_HostNameType() ;

/// @brief Method get_HostType, addr 0x2cac63c, size 0xc, virtual false, abstract: false, final false
inline ::System::Uri_Flags get_HostType() ;

/// @brief Method get_InitializeLock, addr 0x2cb0ca4, size 0xcc, virtual false, abstract: false, final false
static inline ::System::Object* get_InitializeLock() ;

/// @brief Method get_IsAbsoluteUri, addr 0x2cae2a8, size 0x10, virtual false, abstract: false, final false
inline bool get_IsAbsoluteUri() ;

/// @brief Method get_IsDefaultPort, addr 0x2cb06f4, size 0xa8, virtual false, abstract: false, final false
inline bool get_IsDefaultPort() ;

/// @brief Method get_IsDosPath, addr 0x2cac624, size 0xc, virtual false, abstract: false, final false
inline bool get_IsDosPath() ;

/// @brief Method get_IsFile, addr 0x2cb079c, size 0xc0, virtual false, abstract: false, final false
inline bool get_IsFile() ;

/// @brief Method get_IsImplicitFile, addr 0x2cac608, size 0xc, virtual false, abstract: false, final false
inline bool get_IsImplicitFile() ;

/// @brief Method get_IsLoopback, addr 0x2cb085c, size 0x80, virtual false, abstract: false, final false
inline bool get_IsLoopback() ;

/// @brief Method get_IsNotAbsoluteUri, addr 0x2cac650, size 0x10, virtual false, abstract: false, final false
inline bool get_IsNotAbsoluteUri() ;

/// @brief Method get_IsUnc, addr 0x2cb0ba4, size 0x74, virtual false, abstract: false, final false
inline bool get_IsUnc() ;

/// @brief Method get_IsUncOrDosPath, addr 0x2cac614, size 0x10, virtual false, abstract: false, final false
inline bool get_IsUncOrDosPath() ;

/// @brief Method get_IsUncPath, addr 0x2cac630, size 0xc, virtual false, abstract: false, final false
inline bool get_IsUncPath() ;

/// @brief Method get_LocalPath, addr 0x2caff30, size 0x6c, virtual false, abstract: false, final false
inline ::StringW get_LocalPath() ;

/// @brief Method get_OriginalString, addr 0x2caf000, size 0x28, virtual false, abstract: false, final false
inline ::StringW get_OriginalString() ;

/// @brief Method get_OriginalStringSwitched, addr 0x2cb17e4, size 0x48, virtual false, abstract: false, final false
inline bool get_OriginalStringSwitched() ;

/// @brief Method get_PathAndQuery, addr 0x2cb08dc, size 0xc8, virtual false, abstract: false, final false
inline ::StringW get_PathAndQuery() ;

/// @brief Method get_Port, addr 0x2cb14b0, size 0xc4, virtual false, abstract: false, final false
inline int32_t get_Port() ;

/// @brief Method get_PrivateAbsolutePath, addr 0x2cafd8c, size 0xa8, virtual false, abstract: false, final false
inline ::StringW get_PrivateAbsolutePath() ;

/// @brief Method get_Query, addr 0x2cb1574, size 0x100, virtual false, abstract: false, final false
inline ::StringW get_Query() ;

/// @brief Method get_Scheme, addr 0x2cb1774, size 0x70, virtual false, abstract: false, final false
inline ::StringW get_Scheme() ;

/// @brief Method get_SecuredPathIndex, addr 0x2cac8b4, size 0x5c, virtual false, abstract: false, final false
inline uint16_t get_SecuredPathIndex() ;

/// @brief Method get_Segments, addr 0x2cb09a4, size 0x200, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_Segments() ;

/// @brief Method get_Syntax, addr 0x2cac648, size 0x8, virtual false, abstract: false, final false
inline ::System::UriParser* get_Syntax() ;

/// @brief Method get_UserDrivenParsing, addr 0x2cac894, size 0xc, virtual false, abstract: false, final false
inline bool get_UserDrivenParsing() ;

/// @brief Method get_UserEscaped, addr 0x2cb1a78, size 0xc, virtual false, abstract: false, final false
inline bool get_UserEscaped() ;

/// @brief Method get_UserInfo, addr 0x2cb1a84, size 0x74, virtual false, abstract: false, final false
inline ::StringW get_UserInfo() ;

/// @brief Convert to "::System::Runtime::Serialization::ISerializable"
constexpr ::System::Runtime::Serialization::ISerializable* i___System__Runtime__Serialization__ISerializable() noexcept;

/// @brief Method op_Equality, addr 0x2cb20c4, size 0x34, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Uri*  uri1, ::System::Uri*  uri2) ;

/// @brief Method op_Inequality, addr 0x2cae914, size 0x48, virtual false, abstract: false, final false
