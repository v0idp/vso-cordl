...
/// @brief Method GetObjectData, addr 0x2788bfc, size 0x1d0, virtual true, abstract: false, final false
...
/// @brief Method SetMessageField, addr 0x2788950, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27888b0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2788a4c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  className, ::StringW  assemblyName) ;

/// @brief Method .ctor, addr 0x2788a58, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::StringW  className, ::StringW  assemblyName, ::StringW  messageArg, int32_t  resourceId) ;

/// @brief Method .ctor, addr 0x2788ab8, size 0x144, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x2788910, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method get_Message, addr 0x2788938, size 0x18, virtual true, abstract: false, final false
