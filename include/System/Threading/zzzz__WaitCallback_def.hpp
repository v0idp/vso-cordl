...
public:
// Declarations
/// @brief Method Invoke, addr 0x27b0f4c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27af6c4, size 0x100, virtual false, abstract: false, final false
