...
/// @brief Method .ctor, addr 0x2a010b0, size 0x84, virtual false, abstract: false, final false
inline void _ctor(int32_t  millisecondsTimeout) ;

/// @brief Method get_IsExpired, addr 0x2a0155c, size 0x18, virtual false, abstract: false, final false
inline bool get_IsExpired() ;

/// @brief Method get_RemainingMilliseconds, addr 0x2a01f00, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method ClearUpgraderWaiting, addr 0x2a02070, size 0x10, virtual false, abstract: false, final false
inline void ClearUpgraderWaiting() ;

/// @brief Method ClearWriterAcquired, addr 0x2a01d0c, size 0x10, virtual false, abstract: false, final false
inline void ClearWriterAcquired() ;

/// @brief Method ClearWritersWaiting, addr 0x2a02060, size 0x10, virtual false, abstract: false, final false
inline void ClearWritersWaiting() ;

/// @brief Method Dispose, addr 0x2a0218c, size 0x8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x2a02194, size 0x140, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EnterMyLock, addr 0x2a02080, size 0x34, virtual false, abstract: false, final false
inline void EnterMyLock() ;

/// @brief Method EnterMyLockSpin, addr 0x2a020b4, size 0xd8, virtual false, abstract: false, final false
inline void EnterMyLockSpin() ;

/// @brief Method EnterUpgradeableReadLock, addr 0x2a0182c, size 0x8, virtual false, abstract: false, final false
inline void EnterUpgradeableReadLock() ;

/// @brief Method EnterWriteLock, addr 0x2a0107c, size 0x8, virtual false, abstract: false, final false
inline void EnterWriteLock() ;

/// @brief Method ExitAndWakeUpAppropriateReadWaiters, addr 0x2a01fcc, size 0x94, virtual false, abstract: false, final false
inline void ExitAndWakeUpAppropriateReadWaiters() ;

/// @brief Method ExitAndWakeUpAppropriateWaiters, addr 0x2a01d1c, size 0x2c, virtual false, abstract: false, final false
inline void ExitAndWakeUpAppropriateWaiters() ;

/// @brief Method ExitAndWakeUpAppropriateWaitersPreferringWriters, addr 0x2a01f48, size 0x84, virtual false, abstract: false, final false
inline void ExitAndWakeUpAppropriateWaitersPreferringWriters() ;

/// @brief Method ExitMyLock, addr 0x2a01518, size 0x18, virtual false, abstract: false, final false
inline void ExitMyLock() ;

/// @brief Method ExitUpgradeableReadLock, addr 0x2a01d48, size 0x198, virtual false, abstract: false, final false
inline void ExitUpgradeableReadLock() ;

/// @brief Method ExitWriteLock, addr 0x2a01bc4, size 0x148, virtual false, abstract: false, final false
inline void ExitWriteLock() ;

/// @brief Method GetNumReaders, addr 0x2a01550, size 0xc, virtual false, abstract: false, final false
inline uint32_t GetNumReaders() ;

/// @brief Method GetThreadRWCount, addr 0x2a00f50, size 0x12c, virtual false, abstract: false, final false
inline ::System::Threading::ReaderWriterCount* GetThreadRWCount(bool  dontAllocate) ;

/// @brief Method InitializeThreadCounts, addr 0x2a00e54, size 0xc, virtual false, abstract: false, final false
inline void InitializeThreadCounts() ;

/// @brief Method IsRWEntryEmpty, addr 0x2a00eec, size 0x40, virtual false, abstract: false, final false
static inline bool IsRWEntryEmpty(::System::Threading::ReaderWriterCount*  rwc) ;

/// @brief Method IsRwHashEntryChanged, addr 0x2a00f2c, size 0x24, virtual false, abstract: false, final false
inline bool IsRwHashEntryChanged(::System::Threading::ReaderWriterCount*  lrwc) ;

/// @brief Method IsWriterAcquired, addr 0x2a01530, size 0x10, virtual false, abstract: false, final false
inline bool IsWriterAcquired() ;

/// @brief Method LazyCreateEvent, addr 0x2a0160c, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method SetUpgraderWaiting, addr 0x2a01ef0, size 0x10, virtual false, abstract: false, final false
inline void SetUpgraderWaiting() ;

/// @brief Method SetWriterAcquired, addr 0x2a01540, size 0x10, virtual false, abstract: false, final false
inline void SetWriterAcquired() ;

/// @brief Method SetWritersWaiting, addr 0x2a01ee0, size 0x10, virtual false, abstract: false, final false
inline void SetWritersWaiting() ;

/// @brief Method SpinWait, addr 0x2a01574, size 0x98, virtual false, abstract: false, final false
static inline void SpinWait(int32_t  SpinCount) ;

/// @brief Method TryEnterUpgradeableReadLock, addr 0x2a01834, size 0x2c, virtual false, abstract: false, final false
inline bool TryEnterUpgradeableReadLock(int32_t  millisecondsTimeout) ;

/// @brief Method TryEnterUpgradeableReadLock, addr 0x2a01860, size 0x4, virtual false, abstract: false, final false
inline bool TryEnterUpgradeableReadLock(::System::Threading::ReaderWriterLockSlim_TimeoutTracker  timeout) ;

/// @brief Method TryEnterUpgradeableReadLockCore, addr 0x2a01864, size 0x360, virtual false, abstract: false, final false
inline bool TryEnterUpgradeableReadLockCore(::System::Threading::ReaderWriterLockSlim_TimeoutTracker  timeout) ;

/// @brief Method TryEnterWriteLock, addr 0x2a01084, size 0x2c, virtual false, abstract: false, final false
inline bool TryEnterWriteLock(int32_t  millisecondsTimeout) ;

/// @brief Method TryEnterWriteLock, addr 0x2a01134, size 0x4, virtual false, abstract: false, final false
inline bool TryEnterWriteLock(::System::Threading::ReaderWriterLockSlim_TimeoutTracker  timeout) ;

/// @brief Method TryEnterWriteLockCore, addr 0x2a01138, size 0x3e0, virtual false, abstract: false, final false
inline bool TryEnterWriteLockCore(::System::Threading::ReaderWriterLockSlim_TimeoutTracker  timeout) ;

/// @brief Method WaitOnEvent, addr 0x2a01708, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a00e60, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2a00e68, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method get_IsReadLockHeld, addr 0x2a022d4, size 0x18, virtual false, abstract: false, final false
inline bool get_IsReadLockHeld() ;

/// @brief Method get_IsUpgradeableReadLockHeld, addr 0x2a022ec, size 0x18, virtual false, abstract: false, final false
inline bool get_IsUpgradeableReadLockHeld() ;

/// @brief Method get_IsWriteLockHeld, addr 0x2a02304, size 0x18, virtual false, abstract: false, final false
inline bool get_IsWriteLockHeld() ;

/// @brief Method get_RecursiveReadCount, addr 0x2a0231c, size 0x80, virtual false, abstract: false, final false
inline int32_t get_RecursiveReadCount() ;

/// @brief Method get_RecursiveUpgradeCount, addr 0x2a0239c, size 0xb0, virtual false, abstract: false, final false
inline int32_t get_RecursiveUpgradeCount() ;

/// @brief Method get_RecursiveWriteCount, addr 0x2a0244c, size 0xb0, virtual false, abstract: false, final false
inline int32_t get_RecursiveWriteCount() ;

/// @brief Method get_WaitingReadCount, addr 0x2a024fc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_WaitingReadCount() ;

/// @brief Method get_WaitingUpgradeCount, addr 0x2a02504, size 0x8, virtual false, abstract: false, final false
inline int32_t get_WaitingUpgradeCount() ;

/// @brief Method get_WaitingWriteCount, addr 0x2a0250c, size 0x8, virtual false, abstract: false, final false
