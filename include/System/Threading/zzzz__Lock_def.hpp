...
/// @brief Method Acquire, addr 0x27ab0c8, size 0x8, virtual false, abstract: false, final false
inline void Acquire() ;

static inline ::System::Threading::Lock* New_ctor() ;

/// @brief Method Release, addr 0x27ab0ec, size 0x8, virtual false, abstract: false, final false
inline void Release() ;
...
/// @brief Method .ctor, addr 0x27ab0fc, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
