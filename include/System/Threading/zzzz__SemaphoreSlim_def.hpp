...
/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x27ac594, size 0x4c, virtual true, abstract: false, final true
inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem() ;

/// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted, addr 0x27ac5e0, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x27abe84, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x27ac5e4, size 0x804, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x27acde8, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Method CancellationTokenCanceledEventHandler, addr 0x27ac360, size 0x110, virtual false, abstract: false, final false
static inline void CancellationTokenCanceledEventHandler(::System::Object*  obj) ;

/// @brief Method CheckDispose, addr 0x27ab814, size 0x7c, virtual false, abstract: false, final false
inline void CheckDispose() ;

/// @brief Method CreateAndAddAsyncWaiter, addr 0x27abce8, size 0x84, virtual false, abstract: false, final false
inline ::System::Threading::SemaphoreSlim_TaskNode* CreateAndAddAsyncWaiter() ;

/// @brief Method Dispose, addr 0x27ac298, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x27ac304, size 0x5c, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetResourceString, addr 0x27ab2e0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method QueueWaiterTask, addr 0x27ac28c, size 0xc, virtual false, abstract: false, final false
static inline void QueueWaiterTask(::System::Threading::SemaphoreSlim_TaskNode*  waiterTask) ;

/// @brief Method Release, addr 0x27abf4c, size 0x8, virtual false, abstract: false, final false
inline int32_t Release() ;

/// @brief Method Release, addr 0x27abf54, size 0x2e4, virtual false, abstract: false, final false
inline int32_t Release(int32_t  releaseCount) ;

/// @brief Method RemoveAsyncWaiter, addr 0x27abecc, size 0x80, virtual false, abstract: false, final false
inline bool RemoveAsyncWaiter(::System::Threading::SemaphoreSlim_TaskNode*  task) ;

/// @brief Method Wait, addr 0x27ab2f4, size 0x520, virtual false, abstract: false, final false
inline bool Wait(int32_t  millisecondsTimeout, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method Wait, addr 0x27ab2e8, size 0xc, virtual false, abstract: false, final false
inline void Wait() ;

/// @brief Method WaitAsync, addr 0x27abcdc, size 0xc, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* WaitAsync() ;

/// @brief Method WaitAsync, addr 0x27ab890, size 0x324, virtual false, abstract: false, final false
...
/// @brief Method WaitUntilCountOrTimeout, addr 0x27abbb4, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method WaitUntilCountOrTimeoutAsync, addr 0x27abd6c, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27ab15c, size 0x184, virtual false, abstract: false, final false
