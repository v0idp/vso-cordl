...
/// @brief Method CancellationTokenCallback, addr 0x27a8f9c, size 0x11c, virtual false, abstract: false, final false
static inline void CancellationTokenCallback(::System::Object*  obj) ;

/// @brief Method Dispose, addr 0x27a8e40, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x27a8eac, size 0xf0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EnsureLockObjectCreated, addr 0x27a84f8, size 0x80, virtual false, abstract: false, final false
inline void EnsureLockObjectCreated() ;

/// @brief Method ExtractStatePortion, addr 0x27a8030, size 0x8, virtual false, abstract: false, final false
static inline int32_t ExtractStatePortion(int32_t  state, int32_t  mask) ;

/// @brief Method ExtractStatePortionAndShiftRight, addr 0x27a818c, size 0xc, virtual false, abstract: false, final false
static inline int32_t ExtractStatePortionAndShiftRight(int32_t  state, int32_t  mask, int32_t  rightBitShiftCount) ;

/// @brief Method Initialize, addr 0x27a8330, size 0xb0, virtual false, abstract: false, final false
inline void Initialize(bool  initialState, int32_t  spinCount) ;

/// @brief Method LazyInitializeEvent, addr 0x27a7e5c, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method Set, addr 0x27a85f4, size 0x8, virtual false, abstract: false, final false
inline void Set() ;

/// @brief Method Set, addr 0x27a85fc, size 0x1ac, virtual false, abstract: false, final false
inline void Set(bool  duringCancellation) ;

/// @brief Method ThrowIfDisposed, addr 0x27a7dfc, size 0x60, virtual false, abstract: false, final false
inline void ThrowIfDisposed() ;

/// @brief Method UpdateStateAtomically, addr 0x27a8058, size 0xd8, virtual false, abstract: false, final false
inline void UpdateStateAtomically(int32_t  newBits, int32_t  updateBitsMask) ;

/// @brief Method Wait, addr 0x27a87fc, size 0x500, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27a82b4, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(bool  initialState) ;

/// @brief Method .ctor, addr 0x27a83e0, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method get_IsSet, addr 0x27a7fd4, size 0x5c, virtual false, abstract: false, final false
inline bool get_IsSet() ;

/// @brief Method get_SpinCount, addr 0x27a8130, size 0x5c, virtual false, abstract: false, final false
inline int32_t get_SpinCount() ;

/// @brief Method get_WaitHandle, addr 0x27a7dc0, size 0x3c, virtual false, abstract: false, final false
inline ::System::Threading::WaitHandle* get_WaitHandle() ;

/// @brief Method get_Waiters, addr 0x27a81cc, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method set_IsSet, addr 0x27a8038, size 0x20, virtual false, abstract: false, final false
inline void set_IsSet(bool  value) ;

/// @brief Method set_SpinCount, addr 0x27a8198, size 0x34, virtual false, abstract: false, final false
inline void set_SpinCount(int32_t  value) ;

/// @brief Method set_Waiters, addr 0x27a8228, size 0x8c, virtual false, abstract: false, final false
