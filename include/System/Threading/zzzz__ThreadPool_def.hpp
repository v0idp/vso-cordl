...
/// @brief Method EnsureVMInitialized, addr 0x27b3a08, size 0x94, virtual false, abstract: false, final false
static inline void EnsureVMInitialized() ;

/// @brief Method InitializeVMTp, addr 0x27b3bc0, size 0x4, virtual false, abstract: false, final false
static inline void InitializeVMTp(::ByRef<bool>  enableWorkerTracking) ;

/// @brief Method NotifyWorkItemComplete, addr 0x27b3bc4, size 0x4, virtual false, abstract: false, final false
static inline bool NotifyWorkItemComplete() ;

/// @brief Method NotifyWorkItemProgress, addr 0x27b3bd0, size 0x10, virtual false, abstract: false, final false
static inline void NotifyWorkItemProgress() ;

/// @brief Method NotifyWorkItemProgressNative, addr 0x27b3be0, size 0x4, virtual false, abstract: false, final false
static inline void NotifyWorkItemProgressNative() ;

/// @brief Method NotifyWorkItemQueued, addr 0x27b3be4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method QueueUserWorkItem, addr 0x27b39dc, size 0x2c, virtual false, abstract: false, final false
static inline bool QueueUserWorkItem(::System::Threading::WaitCallback*  callBack) ;

/// @brief Method QueueUserWorkItem, addr 0x27b36c0, size 0x28, virtual false, abstract: false, final false
static inline bool QueueUserWorkItem(::System::Threading::WaitCallback*  callBack, ::System::Object*  state) ;

/// @brief Method QueueUserWorkItemHelper, addr 0x27b38c0, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method RegisterWaitForSingleObject, addr 0x27b3710, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method RegisterWaitForSingleObject, addr 0x27b3448, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method RegisterWaitForSingleObject, addr 0x27b3790, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method ReportThreadStatus, addr 0x27b3bc8, size 0x8, virtual false, abstract: false, final false
static inline void ReportThreadStatus(bool  isWorking) ;

/// @brief Method RequestWorkerThread, addr 0x27b3bbc, size 0x4, virtual false, abstract: false, final false
static inline bool RequestWorkerThread() ;

/// @brief Method TryPopCustomWorkItem, addr 0x27b3b1c, size 0xa0, virtual false, abstract: false, final false
static inline bool TryPopCustomWorkItem(::System::Threading::IThreadPoolWorkItem*  workItem) ;

/// @brief Method UnsafeQueueCustomWorkItem, addr 0x27b3a9c, size 0x80, virtual false, abstract: false, final false
static inline void UnsafeQueueCustomWorkItem(::System::Threading::IThreadPoolWorkItem*  workItem, bool  forceGlobal) ;

/// @brief Method UnsafeQueueUserWorkItem, addr 0x27b36e8, size 0x28, virtual false, abstract: false, final false
static inline bool UnsafeQueueUserWorkItem(::System::Threading::WaitCallback*  callBack, ::System::Object*  state) ;

/// @brief Method get_IsThreadPoolThread, addr 0x27b3be8, size 0x20, virtual false, abstract: false, final false
