...
/// @brief Method Close, addr 0x27b4bb0, size 0x70, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Dispose, addr 0x27b4c68, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x27b4c20, size 0x48, virtual true, abstract: false, final false
inline void Dispose(bool  explicitDisposing) ;

/// @brief Method Init, addr 0x27b3c24, size 0x6c, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method InternalWaitOne, addr 0x27b4098, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method SetHandleInternal, addr 0x27b3e28, size 0x34, virtual false, abstract: false, final false
inline void SetHandleInternal(::Microsoft::Win32::SafeHandles::SafeWaitHandle*  handle) ;

/// @brief Method ThrowAbandonedMutexException, addr 0x27b4348, size 0x38, virtual false, abstract: false, final false
static inline void ThrowAbandonedMutexException() ;

/// @brief Method ThrowAbandonedMutexException, addr 0x27b4a38, size 0x4c, virtual false, abstract: false, final false
static inline void ThrowAbandonedMutexException(int32_t  location, ::System::Threading::WaitHandle*  handle) ;

/// @brief Method WaitAny, addr 0x27b4380, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method WaitAny, addr 0x27b4a84, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method WaitMultiple, addr 0x27b4664, size 0x3d4, virtual false, abstract: false, final false
...
/// @brief Method WaitOne, addr 0x27b4064, size 0x14, virtual true, abstract: false, final false
inline bool WaitOne() ;

/// @brief Method WaitOne, addr 0x27b4078, size 0x10, virtual true, abstract: false, final false
inline bool WaitOne(int32_t  millisecondsTimeout) ;

/// @brief Method WaitOne, addr 0x27b3e5c, size 0x80, virtual true, abstract: false, final false
inline bool WaitOne(int32_t  millisecondsTimeout, bool  exitContext) ;

/// @brief Method WaitOne, addr 0x27b4088, size 0x10, virtual true, abstract: false, final false
inline bool WaitOne(::System::TimeSpan  timeout) ;

/// @brief Method WaitOne, addr 0x27b3f5c, size 0x108, virtual true, abstract: false, final false
inline bool WaitOne(::System::TimeSpan  timeout, bool  exitContext) ;

/// @brief Method WaitOne, addr 0x27b3edc, size 0x80, virtual false, abstract: false, final false
inline bool WaitOne(int64_t  timeout, bool  exitContext) ;

/// @brief Method WaitOneNative, addr 0x27b4184, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method Wait_internal, addr 0x27b4cd8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27b3c08, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::IntPtr getStaticF_InvalidHandle() ;

/// @brief Method get_SafeWaitHandle, addr 0x27b3d78, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_Handle, addr 0x27b3c90, size 0xe8, virtual true, abstract: false, final false
