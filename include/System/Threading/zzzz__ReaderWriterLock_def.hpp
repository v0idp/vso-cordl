...
/// @brief Method AcquireReaderLock, addr 0x27b543c, size 0x8, virtual false, abstract: false, final false
inline void AcquireReaderLock(int32_t  millisecondsTimeout) ;

/// @brief Method AcquireReaderLock, addr 0x27b5444, size 0x394, virtual false, abstract: false, final false
inline void AcquireReaderLock(int32_t  millisecondsTimeout, int32_t  initialLockCount) ;

/// @brief Method AcquireWriterLock, addr 0x27b59ac, size 0x8, virtual false, abstract: false, final false
inline void AcquireWriterLock(int32_t  millisecondsTimeout) ;

/// @brief Method AcquireWriterLock, addr 0x27b580c, size 0x1a0, virtual false, abstract: false, final false
inline void AcquireWriterLock(int32_t  millisecondsTimeout, int32_t  initialLockCount) ;

/// @brief Method Finalize, addr 0x27b5434, size 0x8, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method HasWriterLock, addr 0x27b57d8, size 0x34, virtual false, abstract: false, final false
inline bool HasWriterLock() ;

static inline ::System::Threading::ReaderWriterLock* New_ctor() ;

/// @brief Method ReleaseReaderLock, addr 0x27b59b4, size 0x1e4, virtual false, abstract: false, final false
inline void ReleaseReaderLock() ;

/// @brief Method ReleaseReaderLock, addr 0x27b5cc0, size 0x120, virtual false, abstract: false, final false
inline void ReleaseReaderLock(int32_t  currentCount, int32_t  releaseCount) ;

/// @brief Method ReleaseWriterLock, addr 0x27b5b98, size 0x128, virtual false, abstract: false, final false
inline void ReleaseWriterLock() ;

/// @brief Method ReleaseWriterLock, addr 0x27b5de0, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27b5364, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;
