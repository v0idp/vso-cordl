...
/// @brief Method Dispose, addr 0x27ab0d0, size 0x1c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Hold, addr 0x27ab0a4, size 0x24, virtual false, abstract: false, final false
