...
public:
// Declarations
/// @brief Method Undo, addr 0x27adee4, size 0x88, virtual false, abstract: false, final false
inline void Undo() ;

/// @brief Method UndoNoThrow, addr 0x27ade5c, size 0x88, virtual false, abstract: false, final false
