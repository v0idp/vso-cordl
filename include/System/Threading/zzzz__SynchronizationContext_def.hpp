...
/// @brief Method CreateCopy, addr 0x27afb38, size 0x54, virtual true, abstract: false, final false
inline ::System::Threading::SynchronizationContext* CreateCopy() ;

/// @brief Method GetThreadLocalContext, addr 0x27af964, size 0x4c, virtual false, abstract: false, final false
static inline ::System::Threading::SynchronizationContext* GetThreadLocalContext() ;

/// @brief Method IsWaitNotificationRequired, addr 0x27af60c, size 0xc, virtual false, abstract: false, final false
inline bool IsWaitNotificationRequired() ;

static inline ::System::Threading::SynchronizationContext* New_ctor() ;

/// @brief Method OperationCompleted, addr 0x27af7c8, size 0x4, virtual true, abstract: false, final false
inline void OperationCompleted() ;

/// @brief Method OperationStarted, addr 0x27af7c4, size 0x4, virtual true, abstract: false, final false
inline void OperationStarted() ;

/// @brief Method Post, addr 0x27af640, size 0x84, virtual true, abstract: false, final false
inline void Post(::System::Threading::SendOrPostCallback*  d, ::System::Object*  state) ;

/// @brief Method Send, addr 0x27af618, size 0x28, virtual true, abstract: false, final false
inline void Send(::System::Threading::SendOrPostCallback*  d, ::System::Object*  state) ;

/// @brief Method SetSynchronizationContext, addr 0x27af8b8, size 0x28, virtual false, abstract: false, final false
static inline void SetSynchronizationContext(::System::Threading::SynchronizationContext*  syncContext) ;

/// @brief Method Wait, addr 0x27af7cc, size 0x64, virtual true, abstract: false, final false
inline int32_t Wait(::ArrayW<::System::IntPtr,::Array<::System::IntPtr>*>  waitHandles, bool  waitAll, int32_t  millisecondsTimeout) ;

/// @brief Method WaitHelper, addr 0x27af830, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27af604, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Current, addr 0x27a762c, size 0x30, virtual false, abstract: false, final false
static inline ::System::Threading::SynchronizationContext* get_Current() ;

/// @brief Method get_CurrentExplicit, addr 0x27afb8c, size 0x4, virtual false, abstract: false, final false
static inline ::System::Threading::SynchronizationContext* get_CurrentExplicit() ;

/// @brief Method get_CurrentNoFlow, addr 0x27af9b0, size 0x30, virtual false, abstract: false, final false
