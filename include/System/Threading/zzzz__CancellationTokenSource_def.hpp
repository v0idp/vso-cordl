...
/// @brief Method <.cctor>b__4_0, addr 0x27aadb4, size 0x84, virtual false, abstract: false, final false
inline void __cctor_b__4_0(::System::Object*  s) ;

/// @brief Method .ctor, addr 0x27aadac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Cancel, addr 0x27a99ec, size 0x1c, virtual false, abstract: false, final false
inline void Cancel() ;

/// @brief Method Cancel, addr 0x27a9a08, size 0x28, virtual false, abstract: false, final false
inline void Cancel(bool  throwOnFirstException) ;

/// @brief Method CancelAfter, addr 0x27a9ae0, size 0x1e8, virtual false, abstract: false, final false
inline void CancelAfter(int32_t  millisecondsDelay) ;

/// @brief Method CancellationCallbackCoreWork, addr 0x27aa484, size 0xbc, virtual false, abstract: false, final false
inline void CancellationCallbackCoreWork(::System::Threading::CancellationCallbackCoreWorkArguments  args) ;

/// @brief Method CancellationCallbackCoreWork_OnSyncContext, addr 0x27aa540, size 0x78, virtual false, abstract: false, final false
inline void CancellationCallbackCoreWork_OnSyncContext(::System::Object*  obj) ;

/// @brief Method CreateLinkedTokenSource, addr 0x27aa9e0, size 0xcc, virtual false, abstract: false, final false
static inline ::System::Threading::CancellationTokenSource* CreateLinkedTokenSource(::System::Threading::CancellationToken  token) ;

/// @brief Method CreateLinkedTokenSource, addr 0x27aa6ac, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x27a9de0, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x27a9e4c, size 0x90, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method ExecuteCallbackHandlers, addr 0x27a9fbc, size 0x4bc, virtual false, abstract: false, final false
inline void ExecuteCallbackHandlers(bool  throwOnFirstException) ;

/// @brief Method InternalRegister, addr 0x27a76ac, size 0x2bc, virtual false, abstract: false, final false
...
/// @brief Method NotifyCancellation, addr 0x27a9a30, size 0xb0, virtual false, abstract: false, final false
inline void NotifyCancellation(bool  throwOnFirstException) ;

/// @brief Method ThrowIfDisposed, addr 0x27a994c, size 0x54, virtual false, abstract: false, final false
inline void ThrowIfDisposed() ;

/// @brief Method ThrowObjectDisposedException, addr 0x27a9edc, size 0x50, virtual false, abstract: false, final false
static inline void ThrowObjectDisposedException() ;

/// @brief Method TimerCallbackLogic, addr 0x27a9cc8, size 0x118, virtual false, abstract: false, final false
static inline void TimerCallbackLogic(::System::Object*  obj) ;

/// @brief Method WaitForCallbackToComplete, addr 0x27a96e4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27a99b8, size 0x34, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ExecutingCallback, addr 0x27a99a0, size 0x18, virtual false, abstract: false, final false
inline ::System::Threading::CancellationCallbackInfo* get_ExecutingCallback() ;

/// @brief Method get_IsCancellationCompleted, addr 0x27a96b0, size 0x1c, virtual false, abstract: false, final false
inline bool get_IsCancellationCompleted() ;

/// @brief Method get_IsCancellationRequested, addr 0x27a72a4, size 0x1c, virtual false, abstract: false, final false
inline bool get_IsCancellationRequested() ;

/// @brief Method get_IsDisposed, addr 0x27a9908, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDisposed() ;

/// @brief Method get_ThreadIDExecutingCallbacks, addr 0x27a96cc, size 0x18, virtual false, abstract: false, final false
inline int32_t get_ThreadIDExecutingCallbacks() ;

/// @brief Method get_Token, addr 0x27a9934, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method set_ThreadIDExecutingCallbacks, addr 0x27a9910, size 0x24, virtual false, abstract: false, final false
