...
/// @brief Method <.cctor>b__26_0, addr 0x27a7d54, size 0x6c, virtual false, abstract: false, final false
inline void __cctor_b__26_0(::System::Object*  obj) ;

/// @brief Method .ctor, addr 0x27a7d4c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Equals, addr 0x27a7978, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x27a7968, size 0x10, virtual false, abstract: false, final false
inline bool Equals(::System::Threading::CancellationToken  other) ;

/// @brief Method GetHashCode, addr 0x27a7a20, size 0x74, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method InternalRegisterWithoutEC, addr 0x27a7590, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method Register, addr 0x27a736c, size 0xf8, virtual false, abstract: false, final false
inline ::System::Threading::CancellationTokenRegistration Register(::System::Action*  callback) ;

/// @brief Method Register, addr 0x27a7464, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method ThrowIfCancellationRequested, addr 0x27a7b5c, size 0x78, virtual false, abstract: false, final false
inline void ThrowIfCancellationRequested() ;

/// @brief Method ThrowOperationCanceledException, addr 0x27a7bd4, size 0x58, virtual false, abstract: false, final false
inline void ThrowOperationCanceledException() ;

/// @brief Method .ctor, addr 0x27a72d8, size 0x94, virtual false, abstract: false, final false
inline void _ctor(bool  canceled) ;

/// @brief Method .ctor, addr 0x27a72d0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_CanBeCanceled, addr 0x27a72c0, size 0x10, virtual false, abstract: false, final false
inline bool get_CanBeCanceled() ;

/// @brief Method get_IsCancellationRequested, addr 0x27a7278, size 0x2c, virtual false, abstract: false, final false
inline bool get_IsCancellationRequested() ;

/// @brief Method get_None, addr 0x27a7270, size 0x8, virtual false, abstract: false, final false
static inline ::System::Threading::CancellationToken get_None() ;

/// @brief Method op_Equality, addr 0x27a7a94, size 0x64, virtual false, abstract: false, final false
static inline bool op_Equality(::System::Threading::CancellationToken  left, ::System::Threading::CancellationToken  right) ;

/// @brief Method op_Inequality, addr 0x27a7af8, size 0x64, virtual false, abstract: false, final false
