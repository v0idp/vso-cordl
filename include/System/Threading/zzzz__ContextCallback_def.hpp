...
public:
// Declarations
/// @brief Method Invoke, addr 0x27ade48, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27aae38, size 0x100, virtual false, abstract: false, final false
