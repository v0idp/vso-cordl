...
/// @brief Method GetAwaiter, addr 0x27b8f20, size 0x8, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::ForceAsyncAwaiter GetAwaiter() ;

/// @brief Method GetResult, addr 0x27b8f30, size 0x28, virtual false, abstract: false, final false
inline void GetResult() ;

/// @brief Method OnCompleted, addr 0x27b8f58, size 0x58, virtual true, abstract: false, final true
inline void OnCompleted(::System::Action*  action) ;

/// @brief Method UnsafeOnCompleted, addr 0x27b8fb0, size 0x58, virtual true, abstract: false, final true
inline void UnsafeOnCompleted(::System::Action*  action) ;

/// @brief Method .ctor, addr 0x27b8f18, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Threading::Tasks::Task*  task) ;

/// @brief Method get_IsCompleted, addr 0x27b8f28, size 0x8, virtual false, abstract: false, final false
