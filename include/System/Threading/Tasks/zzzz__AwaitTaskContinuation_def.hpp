...
/// @brief Method CreateTask, addr 0x27c25bc, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method GetInvokeActionCallback, addr 0x27c2ab4, size 0xa0, virtual false, abstract: false, final false
static inline ::System::Threading::ContextCallback* GetInvokeActionCallback() ;

/// @brief Method InvokeAction, addr 0x27c2a48, size 0x6c, virtual false, abstract: false, final false
static inline void InvokeAction(::System::Object*  state) ;

/// @brief Method MarkAborted, addr 0x27c2b54, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method Run, addr 0x27c24a8, size 0x114, virtual true, abstract: false, final false
inline void Run(::System::Threading::Tasks::Task*  ignored, bool  canInlineContinuationTask) ;

/// @brief Method RunCallback, addr 0x27c1e10, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method RunOrScheduleAction, addr 0x27be814, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem, addr 0x27c2924, size 0x124, virtual true, abstract: false, final true
inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem() ;

/// @brief Method ThrowAsyncIfNecessary, addr 0x27c2798, size 0x58, virtual false, abstract: false, final false
static inline void ThrowAsyncIfNecessary(::System::Exception*  exc) ;

/// @brief Method UnsafeScheduleAction, addr 0x27bd89c, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27c1c2c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_IsValidLocationForInlining, addr 0x27c27f0, size 0x134, virtual false, abstract: false, final false
