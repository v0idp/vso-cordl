...
/// @brief Method InnerInvoke, addr 0x27c1884, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27bed78, size 0xb4, virtual false, abstract: false, final false
