...
/// @brief Method EndInliningScope, addr 0x27c1870, size 0x14, virtual false, abstract: false, final false
inline void EndInliningScope() ;

static inline ::System::Threading::Tasks::StackGuard* New_ctor() ;

/// @brief Method TryBeginInliningScope, addr 0x27c1830, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27baf0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
