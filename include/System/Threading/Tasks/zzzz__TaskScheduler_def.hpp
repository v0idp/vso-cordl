...
/// @brief Field s_activeTaskSchedulers, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_activeTaskSchedulers, put=setStaticF_s_activeTaskSchedulers)) ::System::Runtime::CompilerServices::ConditionalWeakTable_2<::System::Threading::Tasks::TaskScheduler*,::System::Object*>*  s_activeTaskSchedulers;
...
/// @brief Method FromCurrentSynchronizationContext, addr 0x27c3cec, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method NotifyWorkItemProgress, addr 0x27c3c80, size 0x4, virtual true, abstract: false, final false
inline void NotifyWorkItemProgress() ;

/// @brief Method PublishUnobservedTaskException, addr 0x27c2dc4, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method TryDequeue, addr 0x27c3c78, size 0x8, virtual true, abstract: false, final false
inline bool TryDequeue(::System::Threading::Tasks::Task*  task) ;

/// @brief Method TryExecuteTask, addr 0x27c3df0, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method TryRunInline, addr 0x27be0fc, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27c3c8c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Current, addr 0x27bea64, size 0xa0, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskScheduler* get_Current() ;

/// @brief Method get_Default, addr 0x27c3c94, size 0x58, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskScheduler* get_Default() ;

/// @brief Method get_Id, addr 0x27be2f0, size 0x94, virtual false, abstract: false, final false
inline int32_t get_Id() ;

/// @brief Method get_InternalCurrent, addr 0x27bd734, size 0xa4, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::TaskScheduler* get_InternalCurrent() ;

/// @brief Method get_RequiresAtomicStartTransition, addr 0x27c3c84, size 0x8, virtual true, abstract: false, final false
