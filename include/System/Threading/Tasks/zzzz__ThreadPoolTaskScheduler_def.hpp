...
/// @brief Method <.cctor>b__10_0, addr 0x27c45cc, size 0x84, virtual false, abstract: false, final false
inline void __cctor_b__10_0(::System::Object*  s) ;

/// @brief Method .ctor, addr 0x27c45c4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method NotifyWorkItemProgress, addr 0x27c448c, size 0x10, virtual true, abstract: false, final false
inline void NotifyWorkItemProgress() ;

/// @brief Method QueueTask, addr 0x27c41dc, size 0x1c8, virtual true, abstract: false, final false
inline void QueueTask(::System::Threading::Tasks::Task*  task) ;

/// @brief Method TryDequeue, addr 0x27c4484, size 0x8, virtual true, abstract: false, final false
inline bool TryDequeue(::System::Threading::Tasks::Task*  task) ;

/// @brief Method TryExecuteTaskInline, addr 0x27c43a4, size 0xe0, virtual true, abstract: false, final false
inline bool TryExecuteTaskInline(::System::Threading::Tasks::Task*  task, bool  taskWasPreviouslyQueued) ;

/// @brief Method .ctor, addr 0x27c3f0c, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Threading::ParameterizedThreadStart* getStaticF_s_longRunningThreadWork() ;

/// @brief Method get_RequiresAtomicStartTransition, addr 0x27c449c, size 0x8, virtual true, abstract: false, final false
