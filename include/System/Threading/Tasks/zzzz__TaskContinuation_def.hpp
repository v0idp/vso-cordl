...
public:
// Declarations
/// @brief Method InlineIfPossibleOrElseQueue, addr 0x27c1954, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27c1a94, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
