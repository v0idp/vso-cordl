...
/// @brief Method Add, addr 0x27bb994, size 0xc, virtual false, abstract: false, final false
inline void Add(::System::Object*  exceptionObject, bool  representsCancellation) ;

/// @brief Method AddFaultException, addr 0x27c2fb4, size 0x510, virtual false, abstract: false, final false
inline void AddFaultException(::System::Object*  exceptionObject) ;

/// @brief Method CreateExceptionObject, addr 0x27bb9a0, size 0x1ac, virtual false, abstract: false, final false
inline ::System::AggregateException* CreateExceptionObject(bool  calledFromFinalizer, ::System::Exception*  includeThisException) ;

/// @brief Method Finalize, addr 0x27c2b60, size 0x1f8, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetCancellationExceptionDispatchInfo, addr 0x27c3534, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* GetCancellationExceptionDispatchInfo() ;

/// @brief Method GetExceptionDispatchInfos, addr 0x27bbc64, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method MarkAsHandled, addr 0x27bb75c, size 0x7c, virtual false, abstract: false, final false
inline void MarkAsHandled(bool  calledFromFinalizer) ;

/// @brief Method MarkAsUnhandled, addr 0x27c34c4, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method SetCancellationException, addr 0x27c2ef8, size 0xbc, virtual false, abstract: false, final false
inline void SetCancellationException(::System::Object*  exceptionObject) ;

/// @brief Method ShouldFailFastOnUnobservedException, addr 0x27c2b58, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27bb96c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Threading::Tasks::Task*  task) ;

static inline bool getStaticF_s_failFastOnUnobservedException() ;

/// @brief Method get_ContainsFaultList, addr 0x27bb588, size 0x1c, virtual false, abstract: false, final false
