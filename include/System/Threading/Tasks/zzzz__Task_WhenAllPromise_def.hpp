...
/// @brief Method Invoke, addr 0x27c1284, size 0x2d0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x27c01b4, size 0x174, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::System::Threading::Tasks::Task*,::Array<::System::Threading::Tasks::Task*>*>  tasks) ;

/// @brief Method get_InvokeMayRunArbitraryCode, addr 0x27c15c8, size 0x8, virtual true, abstract: false, final true
inline bool get_InvokeMayRunArbitraryCode() ;

/// @brief Method get_ShouldNotifyDebuggerOfWaitCompletion, addr 0x27c1554, size 0x74, virtual true, abstract: false, final false
