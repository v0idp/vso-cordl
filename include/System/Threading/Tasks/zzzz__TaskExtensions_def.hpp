...
public:
// Declarations
/// @brief Method Unwrap, addr 0x2a02514, size 0x260, virtual false, abstract: false, final false
static inline ::System::Threading::Tasks::Task* Unwrap(::System::Threading::Tasks::Task_1<::System::Threading::Tasks::Task*>*  task) ;
