...
/// @brief Method AddToActiveTasks, addr 0x27b9024, size 0x94, virtual false, abstract: false, final false
static inline void AddToActiveTasks(::System::Threading::Tasks::Task*  task) ;

/// @brief Method AddToActiveTasksNonInlined, addr 0x27b90b8, size 0x158, virtual false, abstract: false, final false
static inline void AddToActiveTasksNonInlined(::System::Threading::Tasks::Task*  task) ;

/// @brief Method RemoveFromActiveTasks, addr 0x27b92a0, size 0x94, virtual false, abstract: false, final false
static inline void RemoveFromActiveTasks(::System::Threading::Tasks::Task*  task) ;

/// @brief Method RemoveFromActiveTasksNonInlined, addr 0x27b9334, size 0x158, virtual false, abstract: false, final false
static inline void RemoveFromActiveTasksNonInlined(::System::Threading::Tasks::Task*  task) ;

/// @brief Method TraceOperationCompletion, addr 0x27b9014, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method TraceOperationCreation, addr 0x27b9010, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method TraceOperationRelation, addr 0x27b9018, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method TraceSynchronousWorkCompletion, addr 0x27b9020, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method TraceSynchronousWorkStart, addr 0x27b901c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_LoggingOn, addr 0x27b9008, size 0x8, virtual false, abstract: false, final false
