...
/// @brief Method ContinueTryEnter, addr 0x27acfa0, size 0x4d4, virtual false, abstract: false, final false
inline void ContinueTryEnter(int32_t  millisecondsTimeout, ::ByRef<bool>  lockTaken) ;

/// @brief Method ContinueTryEnterWithThreadTracking, addr 0x27ad5b0, size 0x168, virtual false, abstract: false, final false
inline void ContinueTryEnterWithThreadTracking(int32_t  millisecondsTimeout, uint32_t  startTime, ::ByRef<bool>  lockTaken) ;

/// @brief Method DecrementWaiters, addr 0x27ad718, size 0xa4, virtual false, abstract: false, final false
inline void DecrementWaiters() ;

/// @brief Method Enter, addr 0x27ace9c, size 0xb4, virtual false, abstract: false, final false
inline void Enter(::ByRef<bool>  lockTaken) ;

/// @brief Method Exit, addr 0x27ad8e8, size 0x88, virtual false, abstract: false, final false
inline void Exit(bool  useMemoryBarrier) ;

/// @brief Method ExitSlowPath, addr 0x27ad970, size 0x110, virtual false, abstract: false, final false
inline void ExitSlowPath(bool  useMemoryBarrier) ;

/// @brief Method TryEnter, addr 0x27ad474, size 0xd0, virtual false, abstract: false, final false
inline void TryEnter(int32_t  millisecondsTimeout, ::ByRef<bool>  lockTaken) ;

/// @brief Method .ctor, addr 0x27ace64, size 0x38, virtual false, abstract: false, final false
inline void _ctor(bool  enableThreadOwnerTracking) ;

static inline int32_t getStaticF_MAXIMUM_WAITERS() ;

/// @brief Method get_IsHeldByCurrentThread, addr 0x27ada80, size 0xd0, virtual false, abstract: false, final false
inline bool get_IsHeldByCurrentThread() ;

/// @brief Method get_IsThreadOwnerTrackingEnabled, addr 0x27ad594, size 0x1c, virtual false, abstract: false, final false
