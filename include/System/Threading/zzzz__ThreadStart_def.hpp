...
public:
// Declarations
/// @brief Method Invoke, addr 0x27a70dc, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;

static inline ::System::Threading::ThreadStart* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x27a7054, size 0x88, virtual false, abstract: false, final false
