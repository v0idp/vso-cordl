...
/// @brief Method Compare, addr 0x27b6dec, size 0x70, virtual true, abstract: false, final true
inline int32_t Compare(::System::Threading::Timer*  tx, ::System::Threading::Timer*  ty) ;

/// @brief Method System.Collections.IComparer.Compare, addr 0x27b6d54, size 0x98, virtual true, abstract: false, final true
...
/// @brief Method Add, addr 0x27b7528, size 0xec, virtual false, abstract: false, final false
inline void Add(::System::Threading::Timer*  timer) ;

/// @brief Method Change, addr 0x27b6bc4, size 0x18c, virtual false, abstract: false, final false
inline void Change(::System::Threading::Timer*  timer, int64_t  new_next_run) ;

/// @brief Method FireTimer, addr 0x27b768c, size 0xc4, virtual false, abstract: false, final false
inline void FireTimer(::System::Threading::Timer*  timer) ;

/// @brief Method InitScheduler, addr 0x27b6e5c, size 0xfc, virtual false, abstract: false, final false
inline void InitScheduler() ;

/// @brief Method InternalRemove, addr 0x27b74f8, size 0x30, virtual false, abstract: false, final false
inline void InternalRemove(::System::Threading::Timer*  timer) ;

static inline ::System::Threading::Timer_Scheduler* New_ctor() ;

/// @brief Method Remove, addr 0x27b6af4, size 0xcc, virtual false, abstract: false, final false
inline void Remove(::System::Threading::Timer*  timer) ;

/// @brief Method RunSchedulerLoop, addr 0x27b70a4, size 0x360, virtual false, abstract: false, final false
inline int32_t RunSchedulerLoop() ;

/// @brief Method SchedulerThread, addr 0x27b6f74, size 0x130, virtual false, abstract: false, final false
inline void SchedulerThread() ;

/// @brief Method TimerCB, addr 0x27b7614, size 0x78, virtual false, abstract: false, final false
static inline void TimerCB(::System::Object*  o) ;

/// @brief Method WakeupScheduler, addr 0x27b6f58, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27b745c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Threading::Timer_Scheduler* getStaticF_instance() ;

/// @brief Method get_Instance, addr 0x27b7404, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method Change, addr 0x27b6a04, size 0xb8, virtual false, abstract: false, final false
inline bool Change(::System::TimeSpan  dueTime, ::System::TimeSpan  period) ;

/// @brief Method Change, addr 0x27b69e4, size 0x20, virtual false, abstract: false, final false
inline bool Change(int32_t  dueTime, int32_t  period) ;

/// @brief Method Change, addr 0x27b681c, size 0x1c8, virtual false, abstract: false, final false
inline bool Change(int64_t  dueTime, int64_t  period, bool  first) ;

/// @brief Method Dispose, addr 0x27b6abc, size 0x38, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetTimeMonotonic, addr 0x27b6bc0, size 0x4, virtual false, abstract: false, final false
static inline int64_t GetTimeMonotonic() ;

/// @brief Method Init, addr 0x27b66d8, size 0x70, virtual false, abstract: false, final false
inline void Init(::System::Threading::TimerCallback*  callback, ::System::Object*  state, int64_t  dueTime, int64_t  period) ;

/// @brief Method KeepRootedWhileScheduled, addr 0x27b6d50, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27b6748, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27b668c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::System::Threading::TimerCallback*  callback, ::System::Object*  state, int32_t  dueTime, int32_t  period) ;

/// @brief Method get_scheduler, addr 0x27b6604, size 0x88, virtual false, abstract: false, final false
