...
public:
// Declarations
/// @brief Method GetTime, addr 0x27a8cfc, size 0x8, virtual false, abstract: false, final false
static inline uint32_t GetTime() ;

/// @brief Method UpdateTimeOut, addr 0x27a8dfc, size 0x3c, virtual false, abstract: false, final false
