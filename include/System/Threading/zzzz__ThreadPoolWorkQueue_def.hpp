...
/// @brief Method LocalFindAndPop, addr 0x27b1b50, size 0x320, virtual false, abstract: false, final false
inline bool LocalFindAndPop(::System::Threading::IThreadPoolWorkItem*  obj) ;

/// @brief Method LocalPop, addr 0x27b2038, size 0x2d0, virtual false, abstract: false, final false
inline bool LocalPop(::ByRef<::System::Threading::IThreadPoolWorkItem*>  obj) ;

/// @brief Method LocalPush, addr 0x27b1578, size 0x4b0, virtual false, abstract: false, final false
...
/// @brief Method TrySteal, addr 0x27b2488, size 0x8, virtual false, abstract: false, final false
inline bool TrySteal(::ByRef<::System::Threading::IThreadPoolWorkItem*>  obj, ::ByRef<bool>  missedSteal) ;

/// @brief Method TrySteal, addr 0x27b2988, size 0x2a8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27b2c30, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CompareExchangeIndexes, addr 0x27b2ce4, size 0x6c, virtual false, abstract: false, final false
inline bool CompareExchangeIndexes(::ByRef<int32_t>  prevUpper, int32_t  newUpper, ::ByRef<int32_t>  prevLower, int32_t  newLower) ;

/// @brief Method GetIndexes, addr 0x27b2cb0, size 0x34, virtual false, abstract: false, final false
inline void GetIndexes(::ByRef<int32_t>  upper, ::ByRef<int32_t>  lower) ;

/// @brief Method IsUsedUp, addr 0x27b2444, size 0x44, virtual false, abstract: false, final false
inline bool IsUsedUp() ;

static inline ::System::Threading::ThreadPoolWorkQueue_QueueSegment* New_ctor() ;

/// @brief Method TryDequeue, addr 0x27b2308, size 0x13c, virtual false, abstract: false, final false
inline bool TryDequeue(::ByRef<::System::Threading::IThreadPoolWorkItem*>  node) ;

/// @brief Method TryEnqueue, addr 0x27b1a28, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27b1168, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Dequeue, addr 0x27b1e70, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method Dispatch, addr 0x27b2490, size 0x468, virtual false, abstract: false, final false
static inline bool Dispatch() ;

/// @brief Method Enqueue, addr 0x27b1444, size 0x134, virtual false, abstract: false, final false
inline void Enqueue(::System::Threading::IThreadPoolWorkItem*  callback, bool  forceGlobal) ;

/// @brief Method EnsureCurrentThreadHasQueue, addr 0x27b11c4, size 0x84, virtual false, abstract: false, final false
inline ::System::Threading::ThreadPoolWorkQueueThreadLocals* EnsureCurrentThreadHasQueue() ;

/// @brief Method EnsureThreadRequested, addr 0x27b1358, size 0xa0, virtual false, abstract: false, final false
inline void EnsureThreadRequested() ;

/// @brief Method LocalFindAndPop, addr 0x27b1ae0, size 0x70, virtual false, abstract: false, final false
inline bool LocalFindAndPop(::System::Threading::IThreadPoolWorkItem*  callback) ;

/// @brief Method MarkThreadRequestSatisfied, addr 0x27b13f8, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27b10fc, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;
