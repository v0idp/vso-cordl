...
public:
// Declarations
/// @brief Method Invoke, addr 0x27b1064, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x27b0f60, size 0x104, virtual false, abstract: false, final false
