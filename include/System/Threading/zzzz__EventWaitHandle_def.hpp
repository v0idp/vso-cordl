...
/// @brief Method Reset, addr 0x27abc80, size 0x5c, virtual false, abstract: false, final false
inline bool Reset() ;

/// @brief Method Set, addr 0x27a8598, size 0x5c, virtual false, abstract: false, final false
inline bool Set() ;

/// @brief Method .ctor, addr 0x27a6b7c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(bool  initialState, ::System::Threading::EventResetMode  mode) ;

/// @brief Method .ctor, addr 0x27adb9c, size 0x2ac, virtual false, abstract: false, final false
