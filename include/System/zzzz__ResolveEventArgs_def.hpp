...
/// @brief Method .ctor, addr 0x27570d8, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method .ctor, addr 0x2757144, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::System::Reflection::Assembly*  requestingAssembly) ;

/// @brief Method get_Name, addr 0x27571b4, size 0x8, virtual false, abstract: false, final false
