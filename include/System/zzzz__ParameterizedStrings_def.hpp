...
/// @brief Method .ctor, addr 0x279cd78, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  intValue, ::StringW  stringValue) ;

/// @brief Method .ctor, addr 0x279cd6c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  value) ;

/// @brief Method get_Int32, addr 0x279cd84, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Int32() ;

/// @brief Method get_Object, addr 0x279c67c, size 0x5c, virtual false, abstract: false, final false
inline ::System::Object* get_Object() ;

/// @brief Method get_String, addr 0x279c628, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_String() ;

/// @brief Method op_Implicit, addr 0x2799900, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Clear, addr 0x279bd10, size 0x28, virtual false, abstract: false, final false
inline void Clear() ;

static inline ::System::ParameterizedStrings_LowLevelStack* New_ctor() ;

/// @brief Method Pop, addr 0x279c598, size 0x90, virtual false, abstract: false, final false
inline ::System::ParameterizedStrings_FormatParam Pop() ;

/// @brief Method Push, addr 0x279c8f8, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x279bcc0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AsBool, addr 0x279cae4, size 0xc, virtual false, abstract: false, final false
static inline bool AsBool(int32_t  i) ;

/// @brief Method AsInt, addr 0x279cadc, size 0x8, virtual false, abstract: false, final false
static inline int32_t AsInt(bool  b) ;

/// @brief Method Evaluate, addr 0x279990c, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method EvaluateInternal, addr 0x279bd38, size 0x860, virtual false, abstract: false, final false
...
/// @brief Method FormatPrintF, addr 0x279c6d8, size 0x220, virtual false, abstract: false, final false
static inline ::StringW FormatPrintF(::StringW  format, ::System::Object*  arg) ;

/// @brief Method GetDynamicOrStaticVariables, addr 0x279c9d0, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method StringFromAsciiBytes, addr 0x279caf0, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method snprintf, addr 0x279cbe8, size 0xcc, virtual false, abstract: false, final false
static inline int32_t snprintf(::cordl_internals::Ptr<uint8_t>  str, ::System::IntPtr  size, ::StringW  format, ::StringW  arg1) ;

/// @brief Method snprintf, addr 0x279ccb4, size 0xb8, virtual false, abstract: false, final false
