...
/// @brief Method CreateObjRef, addr 0x27910d4, size 0x38, virtual true, abstract: false, final false
inline ::System::Runtime::Remoting::ObjRef* CreateObjRef(::System::Type*  requestedType) ;

/// @brief Method InitializeLifetimeService, addr 0x279110c, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x278a408, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ObjectIdentity, addr 0x2791064, size 0x38, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::ServerIdentity* get_ObjectIdentity() ;

/// @brief Method set_ObjectIdentity, addr 0x279109c, size 0x38, virtual false, abstract: false, final false
