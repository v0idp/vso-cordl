...
/// @brief Method CommonInit, addr 0x2688e98, size 0x58, virtual false, abstract: false, final false
inline void CommonInit() ;

/// @brief Method Dispose, addr 0x2688ef0, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x2683348, size 0xb4, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetCaseInsensitiveObjectInternal, addr 0x26893a8, size 0x2cc, virtual false, abstract: false, final false
inline ::System::Object* GetCaseInsensitiveObjectInternal(::StringW  name) ;

/// @brief Method GetEnumerator, addr 0x2688f00, size 0x4, virtual true, abstract: false, final false
inline ::System::Collections::IDictionaryEnumerator* GetEnumerator() ;

/// @brief Method GetEnumeratorHelper, addr 0x2688f04, size 0x7c, virtual false, abstract: false, final false
inline ::System::Collections::IDictionaryEnumerator* GetEnumeratorHelper() ;

/// @brief Method GetObject, addr 0x2689674, size 0x4, virtual true, abstract: false, final false
inline ::System::Object* GetObject(::StringW  name) ;

/// @brief Method GetObject, addr 0x2689678, size 0x40, virtual true, abstract: false, final false
inline ::System::Object* GetObject(::StringW  name, bool  ignoreCase) ;

/// @brief Method GetObjectInternal, addr 0x26890e4, size 0xc8, virtual false, abstract: false, final false
inline ::System::Object* GetObjectInternal(::StringW  name) ;

/// @brief Method GetString, addr 0x2688f84, size 0x160, virtual true, abstract: false, final false
inline ::StringW GetString(::StringW  name) ;

/// @brief Method GetString, addr 0x26891ac, size 0x1fc, virtual true, abstract: false, final false
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2688f80, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2688e7c, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2682fec, size 0x8, virtual false, abstract: false, final false
