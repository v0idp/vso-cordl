...
/// @brief Method Compare, addr 0x2684b60, size 0x10, virtual true, abstract: false, final true
inline int32_t Compare(::StringW  a, ::StringW  b) ;

/// @brief Method Compare, addr 0x2684ac4, size 0x9c, virtual true, abstract: false, final true
inline int32_t Compare(::System::Object*  a, ::System::Object*  b) ;

/// @brief Method CompareOrdinal, addr 0x2684c1c, size 0xb8, virtual false, abstract: false, final false
static inline int32_t CompareOrdinal(::StringW  a, ::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  bCharLength) ;

/// @brief Method CompareOrdinal, addr 0x2684d48, size 0x90, virtual false, abstract: false, final false
static inline int32_t CompareOrdinal(::cordl_internals::Ptr<uint8_t>  a, int32_t  byteLen, ::StringW  b) ;

/// @brief Method CompareOrdinal, addr 0x2684cd4, size 0x74, virtual false, abstract: false, final false
static inline int32_t CompareOrdinal(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  aCharLength, ::StringW  b) ;

/// @brief Method Equals, addr 0x2684b70, size 0x10, virtual true, abstract: false, final true
inline bool Equals(::StringW  a, ::StringW  b) ;

/// @brief Method Equals, addr 0x2684b80, size 0x9c, virtual true, abstract: false, final true
inline bool Equals(::System::Object*  a, ::System::Object*  b) ;

/// @brief Method GetHashCode, addr 0x2684a70, size 0x54, virtual true, abstract: false, final true
inline int32_t GetHashCode(::StringW  key) ;

/// @brief Method GetHashCode, addr 0x2684978, size 0x8c, virtual true, abstract: false, final true
inline int32_t GetHashCode(::System::Object*  key) ;

/// @brief Method HashFunction, addr 0x2684a04, size 0x6c, virtual false, abstract: false, final false
static inline int32_t HashFunction(::StringW  key) ;

static inline ::System::Resources::FastResourceComparer* New_ctor() ;

/// @brief Method .ctor, addr 0x2684dd8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
