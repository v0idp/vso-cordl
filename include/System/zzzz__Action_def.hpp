...
public:
// Declarations
/// @brief Method Invoke, addr 0x26cf068, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;

static inline ::System::Action* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x26cefe0, size 0x88, virtual false, abstract: false, final false
