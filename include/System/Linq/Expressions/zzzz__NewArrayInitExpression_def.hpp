...
/// @brief Method .ctor, addr 0x29b5e8c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_NodeType, addr 0x29b5ed0, size 0x8, virtual true, abstract: false, final true
