...
/// @brief Method .ctor, addr 0x29a884c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x29a8a38, size 0x8, virtual true, abstract: false, final true
