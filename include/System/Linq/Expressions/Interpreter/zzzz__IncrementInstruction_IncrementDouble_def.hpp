...
/// @brief Method Run, addr 0x29c75c4, size 0xac, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29c701c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
