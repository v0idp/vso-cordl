...
public:
// Declarations
/// @brief Method ConvertNull, addr 0x29f3028, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29f2eb0, size 0x28, virtual false, abstract: false, final false
