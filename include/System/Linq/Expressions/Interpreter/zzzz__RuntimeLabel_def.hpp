...
public:
// Declarations
/// @brief Method ToString, addr 0x29bb804, size 0xfc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x29bb7f8, size 0xc, virtual false, abstract: false, final false
