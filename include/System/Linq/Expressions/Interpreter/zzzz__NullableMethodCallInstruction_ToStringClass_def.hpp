...
/// @brief Method Run, addr 0x29f2600, size 0x80, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29f233c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
