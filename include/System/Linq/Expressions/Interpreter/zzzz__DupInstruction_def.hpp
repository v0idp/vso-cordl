...
/// @brief Method Run, addr 0x29efbb8, size 0x24, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29efb68, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Linq::Expressions::Interpreter::DupInstruction* getStaticF_Instance() ;

/// @brief Method get_InstructionName, addr 0x29efb78, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x29efb70, size 0x8, virtual true, abstract: false, final false
