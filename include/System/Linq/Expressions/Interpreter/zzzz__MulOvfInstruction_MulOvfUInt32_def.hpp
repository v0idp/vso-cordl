...
/// @brief Method Run, addr 0x29e7a1c, size 0x1cc, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29e7150, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
