...
public:
// Declarations
/// @brief Method ToString, addr 0x29d1c58, size 0x78, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x29ce35c, size 0x8, virtual false, abstract: false, final false
