...
/// @brief Method Run, addr 0x29e9a4c, size 0xe4, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29e99e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
