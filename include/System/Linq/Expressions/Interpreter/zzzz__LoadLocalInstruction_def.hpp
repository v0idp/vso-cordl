...
/// @brief Method BoxIfIndexMatches, addr 0x29e2d60, size 0x78, virtual true, abstract: false, final true
...
/// @brief Method Run, addr 0x29e2cd8, size 0x88, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29e2c68, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  index) ;

/// @brief Method get_InstructionName, addr 0x29e2c98, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x29e2c90, size 0x8, virtual true, abstract: false, final false
