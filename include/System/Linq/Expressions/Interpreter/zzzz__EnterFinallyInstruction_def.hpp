...
/// @brief Field s_cache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_cache, put=setStaticF_s_cache)) ::ArrayW<::System::Linq::Expressions::Interpreter::EnterFinallyInstruction*,::Array<::System::Linq::Expressions::Interpreter::EnterFinallyInstruction*>*>  s_cache;

/// @brief Method Create, addr 0x29be800, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x29be8f4, size 0x6c, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29be788, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_ConsumedContinuations, addr 0x29be7f8, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedContinuations() ;

/// @brief Method get_InstructionName, addr 0x29be7b0, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x29be7f0, size 0x8, virtual true, abstract: false, final false
