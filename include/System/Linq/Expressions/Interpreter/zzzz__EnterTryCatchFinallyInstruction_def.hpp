...
/// @brief Method CreateTryCatch, addr 0x29bdef0, size 0x60, virtual false, abstract: false, final false
static inline ::System::Linq::Expressions::Interpreter::EnterTryCatchFinallyInstruction* CreateTryCatch() ;

/// @brief Method CreateTryFinally, addr 0x29bde8c, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method Run, addr 0x29bdf50, size 0x4b0, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method SetTryHandler, addr 0x29bde44, size 0x8, virtual false, abstract: false, final false
inline void SetTryHandler(::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler*  tryHandler) ;

/// @brief Method ToString, addr 0x29be46c, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29bde5c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(int32_t  targetIndex, bool  hasFinally) ;

/// @brief Method get_Handler, addr 0x29bde4c, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler* get_Handler() ;

/// @brief Method get_InstructionName, addr 0x29be400, size 0x6c, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedContinuations, addr 0x29bde54, size 0x8, virtual true, abstract: false, final false
