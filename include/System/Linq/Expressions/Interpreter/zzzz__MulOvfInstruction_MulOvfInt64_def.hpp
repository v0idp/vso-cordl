...
/// @brief Method Run, addr 0x29e75c0, size 0x1fc, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29e7140, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
