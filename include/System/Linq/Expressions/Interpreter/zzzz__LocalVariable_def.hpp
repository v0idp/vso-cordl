...
/// @brief Method ToString, addr 0x29e4824, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29e47ec, size 0x38, virtual false, abstract: false, final false
inline void _ctor(int32_t  index, bool  closure) ;

/// @brief Method get_InClosure, addr 0x29df4c0, size 0xc, virtual false, abstract: false, final false
inline bool get_InClosure() ;

/// @brief Method get_IsBoxed, addr 0x29df4cc, size 0xc, virtual false, abstract: false, final false
inline bool get_IsBoxed() ;

/// @brief Method set_IsBoxed, addr 0x29e47dc, size 0x10, virtual false, abstract: false, final false
