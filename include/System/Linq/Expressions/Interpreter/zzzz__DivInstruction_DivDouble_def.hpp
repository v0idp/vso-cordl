...
/// @brief Method Run, addr 0x29c0d68, size 0x148, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29c0478, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
