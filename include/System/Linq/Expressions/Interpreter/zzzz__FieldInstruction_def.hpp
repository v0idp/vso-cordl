...
/// @brief Method ToString, addr 0x29c3e4c, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29c3e1c, size 0x28, virtual false, abstract: false, final false
