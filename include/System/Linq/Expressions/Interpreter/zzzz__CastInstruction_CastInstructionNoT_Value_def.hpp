...
public:
// Declarations
/// @brief Method ConvertNull, addr 0x29f3044, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29f2e88, size 0x28, virtual false, abstract: false, final false
