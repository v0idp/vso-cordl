...
/// @brief Method Run, addr 0x29baffc, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29baf7c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  elementType, int32_t  elementCount) ;

/// @brief Method get_ConsumedStack, addr 0x29bafac, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x29bafbc, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x29bafb4, size 0x8, virtual true, abstract: false, final false
