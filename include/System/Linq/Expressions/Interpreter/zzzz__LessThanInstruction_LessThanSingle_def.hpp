...
/// @brief Method Run, addr 0x29d05b0, size 0xe4, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29cfda4, size 0x28, virtual false, abstract: false, final false
