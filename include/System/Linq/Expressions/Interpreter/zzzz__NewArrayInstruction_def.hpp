...
/// @brief Method Run, addr 0x29bb0fc, size 0x90, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29bb084, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  elementType) ;

/// @brief Method get_ConsumedStack, addr 0x29bb0ac, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x29bb0bc, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x29bb0b4, size 0x8, virtual true, abstract: false, final false
