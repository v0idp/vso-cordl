...
/// @brief Method Run, addr 0x29c4f44, size 0xdc, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29c4c24, size 0x28, virtual false, abstract: false, final false
