...
/// @brief Method Run, addr 0x29beeac, size 0x8, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29bee5c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Linq::Expressions::Interpreter::LeaveExceptionFilterInstruction* getStaticF_Instance() ;

/// @brief Method get_ConsumedStack, addr 0x29beea4, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x29bee64, size 0x40, virtual true, abstract: false, final false
