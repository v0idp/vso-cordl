...
/// @brief Method UndefineTemps, addr 0x29df2a4, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29df27c, size 0x28, virtual false, abstract: false, final false
