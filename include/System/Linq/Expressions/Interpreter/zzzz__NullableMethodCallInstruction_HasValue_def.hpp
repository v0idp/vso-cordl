...
/// @brief Method Run, addr 0x29f23c8, size 0x3c, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29f22d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
