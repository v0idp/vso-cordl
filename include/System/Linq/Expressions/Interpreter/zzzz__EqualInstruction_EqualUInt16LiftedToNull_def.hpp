...
/// @brief Method Run, addr 0x29c29d0, size 0xe8, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29c1804, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
