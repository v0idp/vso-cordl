...
/// @brief Method System.Collections.Generic.IComparer<System.Linq.Expressions.Interpreter.DebugInfo>.Compare, addr 0x29d1c24, size 0x34, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x29d1c1c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetMatchingDebugInfo, addr 0x29cd7dc, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x29d1998, size 0x214, virtual true, abstract: false, final false
