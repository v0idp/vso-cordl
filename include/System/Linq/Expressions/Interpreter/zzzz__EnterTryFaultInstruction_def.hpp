...
/// @brief Method Run, addr 0x29be58c, size 0x1fc, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method SetTryHandler, addr 0x29be584, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29be50c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  targetIndex) ;

/// @brief Method get_Handler, addr 0x29be57c, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Interpreter::TryFaultHandler* get_Handler() ;

/// @brief Method get_InstructionName, addr 0x29be534, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedContinuations, addr 0x29be574, size 0x8, virtual true, abstract: false, final false
