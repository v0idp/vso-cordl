...
/// @brief Method Run, addr 0x29ea420, size 0xec, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29e9a3c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
