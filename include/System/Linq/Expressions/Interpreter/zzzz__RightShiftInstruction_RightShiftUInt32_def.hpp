...
/// @brief Method Run, addr 0x29ef400, size 0x10c, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29eee20, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
