...
/// @brief Method AddBranch, addr 0x29bbae0, size 0x128, virtual false, abstract: false, final false
inline void AddBranch(::System::Linq::Expressions::Interpreter::InstructionList*  instructions, int32_t  branchIndex) ;

/// @brief Method FixupBranch, addr 0x29bbab4, size 0x2c, virtual false, abstract: false, final false
inline void FixupBranch(::System::Linq::Expressions::Interpreter::InstructionList*  instructions, int32_t  branchIndex) ;

/// @brief Method Mark, addr 0x29bb938, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method ToRuntimeLabel, addr 0x29bb92c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29bbc08, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasRuntimeLabel, addr 0x29bb910, size 0x14, virtual false, abstract: false, final false
inline bool get_HasRuntimeLabel() ;

/// @brief Method get_LabelIndex, addr 0x29bb900, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LabelIndex() ;

/// @brief Method get_TargetIndex, addr 0x29bb924, size 0x8, virtual false, abstract: false, final false
inline int32_t get_TargetIndex() ;

/// @brief Method set_LabelIndex, addr 0x29bb908, size 0x8, virtual false, abstract: false, final false
