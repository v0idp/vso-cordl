...
/// @brief Method <ValidateJump>b__9_0, addr 0x29cf2f8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29cf2f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddDefinition, addr 0x29ced14, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method Define, addr 0x29ceab0, size 0x204, virtual false, abstract: false, final false
inline void Define(::System::Linq::Expressions::Interpreter::LabelScopeInfo*  block) ;

/// @brief Method DefinedIn, addr 0x29cef68, size 0xc0, virtual false, abstract: false, final false
inline bool DefinedIn(::System::Linq::Expressions::Interpreter::LabelScopeInfo*  scope) ;

/// @brief Method EnsureLabel, addr 0x29ce718, size 0x30, virtual false, abstract: false, final false
inline void EnsureLabel(::System::Linq::Expressions::Interpreter::LightCompiler*  compiler) ;

/// @brief Method FirstDefinition, addr 0x29cf028, size 0x1d0, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Interpreter::LabelScopeInfo* FirstDefinition() ;

/// @brief Method GetLabel, addr 0x29ce700, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Reference, addr 0x29ce748, size 0xbc, virtual false, abstract: false, final false
inline void Reference(::System::Linq::Expressions::Interpreter::LabelScopeInfo*  block) ;

/// @brief Method ValidateFinish, addr 0x29cf208, size 0x8c, virtual false, abstract: false, final false
inline void ValidateFinish() ;

/// @brief Method ValidateJump, addr 0x29ce814, size 0x29c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29ce678, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::LabelTarget*  node) ;

/// @brief Method get_HasDefinitions, addr 0x29ce804, size 0x10, virtual false, abstract: false, final false
inline bool get_HasDefinitions() ;

/// @brief Method get_HasMultipleDefinitions, addr 0x29ceeec, size 0x7c, virtual false, abstract: false, final false
