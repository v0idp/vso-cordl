...
/// @brief Method Run, addr 0x29f1200, size 0x1e4, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29f0d80, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
