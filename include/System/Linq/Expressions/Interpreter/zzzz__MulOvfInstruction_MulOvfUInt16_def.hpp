...
/// @brief Method Run, addr 0x29e77bc, size 0x260, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29e7148, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
