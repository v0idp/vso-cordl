...
/// @brief Method UndefineTemps, addr 0x29df634, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method Update, addr 0x29df528, size 0x10c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29df4d8, size 0x50, virtual false, abstract: false, final false
