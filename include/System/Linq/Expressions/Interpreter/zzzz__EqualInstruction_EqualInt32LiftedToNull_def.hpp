...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::EqualInstruction_EqualInt32LiftedToNull);
...
/// @brief Method Run, addr 0x29c2718, size 0xe8, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29c17ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::EqualInstruction_EqualInt32LiftedToNull, 0x10>, "Size mismatch!");

} // namespace end def GlobalNamespace
NEED_NO_BOX(::GlobalNamespace::EqualInstruction_EqualInt32LiftedToNull);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::EqualInstruction_EqualInt32LiftedToNull*, "System.Linq.Expressions.Interpreter", "EqualInstruction/EqualInt32LiftedToNull");
