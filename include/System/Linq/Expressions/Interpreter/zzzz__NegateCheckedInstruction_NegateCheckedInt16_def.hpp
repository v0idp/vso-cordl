...
/// @brief Method Run, addr 0x29e874c, size 0x13c, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29e8614, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
