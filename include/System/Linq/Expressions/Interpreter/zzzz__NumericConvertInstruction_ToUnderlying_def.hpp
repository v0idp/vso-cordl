...
/// @brief Method Convert, addr 0x29eda64, size 0x25c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29eda34, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::TypeCode  to, bool  isLiftedToNull) ;

/// @brief Method get_InstructionName, addr 0x29ed9f4, size 0x40, virtual true, abstract: false, final false
