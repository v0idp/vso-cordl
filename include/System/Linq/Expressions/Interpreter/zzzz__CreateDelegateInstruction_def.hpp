...
/// @brief Method Run, addr 0x29f1a28, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29f1994, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::Interpreter::LightDelegateCreator*  delegateCreator) ;

/// @brief Method get_ConsumedStack, addr 0x29f19bc, size 0x24, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x29f19e8, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x29f19e0, size 0x8, virtual true, abstract: false, final false
