...
/// @brief Method Run, addr 0x29c67c8, size 0xdc, virtual true, abstract: false, final false
inline int32_t Run(::System::Linq::Expressions::Interpreter::InterpretedFrame*  frame) ;

/// @brief Method .ctor, addr 0x29c61d8, size 0x28, virtual false, abstract: false, final false
