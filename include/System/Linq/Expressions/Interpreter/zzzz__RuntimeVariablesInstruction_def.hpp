...
/// @brief Method Run, addr 0x29e4650, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29e45d8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  count) ;

/// @brief Method get_ConsumedStack, addr 0x29e4608, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ConsumedStack() ;

/// @brief Method get_InstructionName, addr 0x29e4610, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_InstructionName() ;

/// @brief Method get_ProducedStack, addr 0x29e4600, size 0x8, virtual true, abstract: false, final false
