...
/// @brief Method GetArgument, addr 0x29b46e4, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method Rewrite, addr 0x29b4784, size 0x10c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29b46c0, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::System::Reflection::MethodInfo*  method, ::System::Linq::Expressions::Expression*  arg0) ;

/// @brief Method get_ArgumentCount, addr 0x29b477c, size 0x8, virtual true, abstract: false, final false
