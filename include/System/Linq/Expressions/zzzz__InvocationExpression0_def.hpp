...
/// @brief Method GetArgument, addr 0x29b2fc4, size 0x4c, virtual true, abstract: false, final false
...
/// @brief Method Rewrite, addr 0x29b3018, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29b2fc0, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::Expression*  lambda, ::System::Type*  returnType) ;

/// @brief Method get_ArgumentCount, addr 0x29b3010, size 0x8, virtual true, abstract: false, final false
