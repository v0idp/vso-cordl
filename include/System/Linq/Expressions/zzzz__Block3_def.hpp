...
/// @brief Method GetExpression, addr 0x29a6ff0, size 0xa4, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* GetExpression(int32_t  index) ;

/// @brief Method GetOrMakeExpressions, addr 0x29a709c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Rewrite, addr 0x29a70a4, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29a6fb8, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method get_ExpressionCount, addr 0x29a7094, size 0x8, virtual true, abstract: false, final false
