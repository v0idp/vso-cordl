...
/// @brief Method get_Document, addr 0x29a8be8, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::SymbolDocumentInfo* get_Document() ;

/// @brief Method get_EndLine, addr 0x29a8bc0, size 0x28, virtual true, abstract: false, final false
inline int32_t get_EndLine() ;

/// @brief Method get_IsClear, addr 0x29a8bf0, size 0x28, virtual true, abstract: false, final false
inline bool get_IsClear() ;

/// @brief Method get_StartLine, addr 0x29a8b98, size 0x28, virtual true, abstract: false, final false
