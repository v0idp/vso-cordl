...
/// @brief Method Accept, addr 0x298f448, size 0x28, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor*  visitor) ;

/// @brief Method GetBinaryOpFromAssignmentOp, addr 0x298ea4c, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method GetConversion, addr 0x298f2b0, size 0x8, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::LambdaExpression* GetConversion() ;

/// @brief Method GetMethod, addr 0x298d048, size 0x8, virtual true, abstract: false, final false
inline ::System::Reflection::MethodInfo* GetMethod() ;

/// @brief Method IsOpAssignment, addr 0x298d01c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Reduce, addr 0x298e060, size 0x78, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Reduce() ;

/// @brief Method ReduceIndex, addr 0x298e4ec, size 0x45c, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceIndex() ;

/// @brief Method ReduceMember, addr 0x298e0d8, size 0x414, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceMember() ;

/// @brief Method ReduceUserdefinedLifted, addr 0x298f5d8, size 0x668, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceUserdefinedLifted() ;

/// @brief Method ReduceVariable, addr 0x298e948, size 0x104, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceVariable() ;

/// @brief Method Update, addr 0x298d050, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x298cf80, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::Expression*  left, ::System::Linq::Expressions::Expression*  right) ;

/// @brief Method get_CanReduce, addr 0x298cff8, size 0x24, virtual true, abstract: false, final false
inline bool get_CanReduce() ;

/// @brief Method get_Conversion, addr 0x298d1b4, size 0xc, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::LambdaExpression* get_Conversion() ;

/// @brief Method get_IsLifted, addr 0x298f2b8, size 0x190, virtual false, abstract: false, final false
inline bool get_IsLifted() ;

/// @brief Method get_IsLiftedLogical, addr 0x298f470, size 0x168, virtual false, abstract: false, final false
inline bool get_IsLiftedLogical() ;

/// @brief Method get_IsLiftedToNull, addr 0x298d5a4, size 0x8c, virtual false, abstract: false, final false
inline bool get_IsLiftedToNull() ;

/// @brief Method get_IsReferenceComparison, addr 0x298d1c0, size 0xd4, virtual false, abstract: false, final false
inline bool get_IsReferenceComparison() ;

/// @brief Method get_Left, addr 0x298d034, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Left() ;

/// @brief Method get_Method, addr 0x298d03c, size 0xc, virtual false, abstract: false, final false
inline ::System::Reflection::MethodInfo* get_Method() ;

/// @brief Method get_Right, addr 0x298d02c, size 0x8, virtual false, abstract: false, final false
