...
/// @brief Method GetExpression, addr 0x29a7818, size 0x7c, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* GetExpression(int32_t  index) ;

/// @brief Method GetOrMakeExpressions, addr 0x29a789c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Rewrite, addr 0x29a78a4, size 0xdc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29a77c8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29a77f0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_ExpressionCount, addr 0x29a7894, size 0x8, virtual true, abstract: false, final false
