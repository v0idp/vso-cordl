...
/// @brief Method get_Body, addr 0x29b6800, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Body() ;

/// @brief Method get_TestValues, addr 0x29b67f8, size 0x8, virtual false, abstract: false, final false
