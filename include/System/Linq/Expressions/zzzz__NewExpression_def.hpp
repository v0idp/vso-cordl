...
/// @brief Method GetArgument, addr 0x29b5ee8, size 0xa8, virtual true, abstract: false, final true
...
/// @brief Method get_Constructor, addr 0x29b5ee0, size 0x8, virtual false, abstract: false, final false
