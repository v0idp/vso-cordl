...
/// @brief Method GetParameter, addr 0x29b3c94, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method System.Linq.Expressions.IParameterProvider.GetParameter, addr 0x29b3c84, size 0x10, virtual true, abstract: false, final true
inline ::System::Linq::Expressions::ParameterExpression* System_Linq_Expressions_IParameterProvider_GetParameter(int32_t  index) ;

/// @brief Method System.Linq.Expressions.IParameterProvider.get_ParameterCount, addr 0x29b3cbc, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x29b3b44, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::System::Linq::Expressions::Expression*  body) ;

/// @brief Method get_Body, addr 0x29b3bdc, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Body() ;

/// @brief Method get_Name, addr 0x29b3bc4, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameCore, addr 0x29b3bd4, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_NameCore() ;

/// @brief Method get_NodeType, addr 0x29b3bbc, size 0x8, virtual true, abstract: false, final true
inline ::System::Linq::Expressions::ExpressionType get_NodeType() ;

/// @brief Method get_ParameterCount, addr 0x29b3ccc, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method get_ReturnType, addr 0x29b3be4, size 0x88, virtual false, abstract: false, final false
inline ::System::Type* get_ReturnType() ;

/// @brief Method get_TailCall, addr 0x29b3c6c, size 0x10, virtual false, abstract: false, final false
inline bool get_TailCall() ;

/// @brief Method get_TailCallCore, addr 0x29b3c7c, size 0x8, virtual true, abstract: false, final false
inline bool get_TailCallCore() ;

/// @brief Method get_Type, addr 0x29b3bb0, size 0xc, virtual true, abstract: false, final true
