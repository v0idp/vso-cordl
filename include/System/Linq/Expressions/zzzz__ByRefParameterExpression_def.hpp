...
public:
// Declarations
/// @brief Method GetIsByRef, addr 0x29b6778, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29b6678, size 0x28, virtual false, abstract: false, final false
