...
/// @brief Method .ctor, addr 0x29b66a0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  type, ::StringW  name) ;

/// @brief Method get_Type, addr 0x29b6780, size 0x8, virtual true, abstract: false, final true
