...
/// @brief Method Accept, addr 0x29b6e4c, size 0x2c, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Accept(::System::Linq::Expressions::ExpressionVisitor*  visitor) ;

/// @brief Method FunctionalOp, addr 0x29b7cd0, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method Reduce, addr 0x29b6e9c, size 0x70, virtual true, abstract: false, final false
inline ::System::Linq::Expressions::Expression* Reduce() ;

/// @brief Method ReduceIndex, addr 0x29b6f0c, size 0x5d4, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceIndex() ;

/// @brief Method ReduceMember, addr 0x29b74e0, size 0x4e4, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceMember() ;

/// @brief Method ReduceVariable, addr 0x29b79c4, size 0x2c8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* ReduceVariable() ;

/// @brief Method Update, addr 0x29b280c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29b6af4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method get_CanReduce, addr 0x29b6e78, size 0x24, virtual true, abstract: false, final false
inline bool get_CanReduce() ;

/// @brief Method get_IsLifted, addr 0x29b6b9c, size 0x224, virtual false, abstract: false, final false
inline bool get_IsLifted() ;

/// @brief Method get_IsLiftedToNull, addr 0x29b6dc0, size 0x8c, virtual false, abstract: false, final false
inline bool get_IsLiftedToNull() ;

/// @brief Method get_IsPrefix, addr 0x29b7c8c, size 0x44, virtual false, abstract: false, final false
inline bool get_IsPrefix() ;

/// @brief Method get_Method, addr 0x29b6b94, size 0x8, virtual false, abstract: false, final false
inline ::System::Reflection::MethodInfo* get_Method() ;

/// @brief Method get_NodeType, addr 0x29b6b84, size 0x8, virtual true, abstract: false, final true
inline ::System::Linq::Expressions::ExpressionType get_NodeType() ;

/// @brief Method get_Operand, addr 0x29b6b8c, size 0x8, virtual false, abstract: false, final false
inline ::System::Linq::Expressions::Expression* get_Operand() ;

/// @brief Method get_Type, addr 0x29b6b7c, size 0x8, virtual true, abstract: false, final true
