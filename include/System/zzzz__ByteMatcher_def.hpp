...
/// @brief Method AddMapping, addr 0x279b9b8, size 0x120, virtual false, abstract: false, final false
inline void AddMapping(::System::TermInfoStrings  key, ::ArrayW<uint8_t,::Array<uint8_t>*>  val) ;

/// @brief Method Match, addr 0x2798a58, size 0x48c, virtual false, abstract: false, final false
...
/// @brief Method Sort, addr 0x279bad8, size 0x4, virtual false, abstract: false, final false
inline void Sort() ;

/// @brief Method StartsWith, addr 0x27989d0, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x279b8fc, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
