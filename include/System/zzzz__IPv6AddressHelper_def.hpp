...
public:
// Declarations
/// @brief Method FindCompressionRange, addr 0x2cd6ff8, size 0xe0, virtual false, abstract: false, final false
static inline ::System::ValueTuple_2<int32_t,int32_t> FindCompressionRange(::System::ReadOnlySpan_1<uint16_t>  numbers) ;

/// @brief Method InternalIsValid, addr 0x2cd800c, size 0x2c4, virtual false, abstract: false, final false
...
/// @brief Method IsLoopback, addr 0x2cd7f2c, size 0xe0, virtual false, abstract: false, final false
static inline bool IsLoopback(::System::ReadOnlySpan_1<uint16_t>  numbers) ;

/// @brief Method IsValid, addr 0x2cd82d0, size 0x8, virtual false, abstract: false, final false
static inline bool IsValid(::cordl_internals::Ptr<char16_t>  name, int32_t  start, ::ByRef<int32_t>  end) ;

/// @brief Method IsValidStrict, addr 0x2cd71a8, size 0x330, virtual false, abstract: false, final false
static inline bool IsValidStrict(::cordl_internals::Ptr<char16_t>  name, int32_t  start, ::ByRef<int32_t>  end) ;

/// @brief Method Parse, addr 0x2cd74d8, size 0x4a8, virtual false, abstract: false, final false
...
/// @brief Method ParseCanonicalName, addr 0x2cd7980, size 0x5ac, virtual false, abstract: false, final false
static inline ::StringW ParseCanonicalName(::StringW  str, int32_t  start, ::ByRef<bool>  isLoopback, ::ByRef<::StringW>  scopeId) ;

/// @brief Method ShouldHaveIpv4Embedded, addr 0x2cd70d8, size 0xd0, virtual false, abstract: false, final false
