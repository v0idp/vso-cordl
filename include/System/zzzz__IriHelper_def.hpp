...
public:
// Declarations
/// @brief Method CheckIriUnicodeRange, addr 0x2cd982c, size 0x630, virtual false, abstract: false, final false
static inline bool CheckIriUnicodeRange(char16_t  highSurr, char16_t  lowSurr, ::ByRef<bool>  surrogatePair, bool  isQuery) ;

/// @brief Method CheckIriUnicodeRange, addr 0x2cd97d4, size 0x58, virtual false, abstract: false, final false
static inline bool CheckIriUnicodeRange(char16_t  unicode, bool  isQuery) ;

/// @brief Method CheckIsReserved, addr 0x2cd9e5c, size 0x144, virtual false, abstract: false, final false
static inline bool CheckIsReserved(char16_t  ch, ::System::UriComponents  component) ;

/// @brief Method EscapeUnescapeIri, addr 0x2cd9fa0, size 0x85c, virtual false, abstract: false, final false
