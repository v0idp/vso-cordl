...
/// @brief Method Dispose, addr 0x276e480, size 0x1c, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method FreeData, addr 0x276eaec, size 0x48, virtual false, abstract: false, final false
inline void FreeData(int32_t  slot, int64_t  cookie) ;

/// @brief Method GetData, addr 0x276e658, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method PopulateElement, addr 0x276e878, size 0x274, virtual false, abstract: false, final false
inline ::System::LocalDataStoreElement* PopulateElement(::System::LocalDataStoreSlot*  slot) ;

/// @brief Method SetData, addr 0x276e79c, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x276e4e4, size 0x70, virtual false, abstract: false, final false
