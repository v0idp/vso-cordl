...
/// @brief Method Equals, addr 0x2b0a334, size 0x84, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2b0a3b8, size 0x20, virtual true, abstract: false, final true
inline bool Equals(::System::Drawing::Size  other) ;

/// @brief Method GetHashCode, addr 0x2b0a3d8, size 0x60, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x2b0a438, size 0x108, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_Height, addr 0x2b0a32c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Height() ;

/// @brief Method get_Width, addr 0x2b0a324, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2b0a304, size 0x20, virtual false, abstract: false, final false
