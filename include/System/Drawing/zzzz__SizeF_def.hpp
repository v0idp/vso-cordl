...
/// @brief Method Equals, addr 0x2b0a568, size 0x84, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2b0a5ec, size 0x1c, virtual true, abstract: false, final true
inline bool Equals(::System::Drawing::SizeF  other) ;

/// @brief Method GetHashCode, addr 0x2b0a608, size 0x98, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x2b0a6a0, size 0x108, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_Height, addr 0x2b0a560, size 0x8, virtual false, abstract: false, final false
inline float_t get_Height() ;

/// @brief Method get_Width, addr 0x2b0a558, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2b0a540, size 0x18, virtual false, abstract: false, final false
