...
public:
// Declarations
/// @brief Method IdnEquivalent, addr 0x2cddbe4, size 0x28c, virtual false, abstract: false, final false
...
/// @brief Method IdnEquivalent, addr 0x2cdde70, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method IsASCIILetterOrDigit, addr 0x2cdd944, size 0x4c, virtual false, abstract: false, final false
static inline bool IsASCIILetterOrDigit(char16_t  character, ::ByRef<bool>  notCanonical) ;

/// @brief Method IsIdnAce, addr 0x2cde0b0, size 0x98, virtual false, abstract: false, final false
static inline bool IsIdnAce(::StringW  input, int32_t  index) ;

/// @brief Method IsIdnAce, addr 0x2cde064, size 0x4c, virtual false, abstract: false, final false
static inline bool IsIdnAce(::cordl_internals::Ptr<char16_t>  input, int32_t  index) ;

/// @brief Method IsValid, addr 0x2cdd7c4, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method IsValidByIri, addr 0x2cdd9f4, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method IsValidDomainLabelCharacter, addr 0x2cdd990, size 0x64, virtual false, abstract: false, final false
static inline bool IsValidDomainLabelCharacter(char16_t  character, ::ByRef<bool>  notCanonical) ;

/// @brief Method ParseCanonicalName, addr 0x2cdd62c, size 0x198, virtual false, abstract: false, final false
static inline ::StringW ParseCanonicalName(::StringW  str, int32_t  start, int32_t  end, ::ByRef<bool>  loopback) ;

/// @brief Method UnicodeEquivalent, addr 0x2cde264, size 0x45c, virtual false, abstract: false, final false
...
/// @brief Method UnicodeEquivalent, addr 0x2cde148, size 0x11c, virtual false, abstract: false, final false
