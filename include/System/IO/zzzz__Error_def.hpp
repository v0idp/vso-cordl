...
public:
// Declarations
/// @brief Method GetEndOfFile, addr 0x269f0f8, size 0x78, virtual false, abstract: false, final false
static inline ::System::Exception* GetEndOfFile() ;

/// @brief Method GetReadNotSupported, addr 0x269f170, size 0x6c, virtual false, abstract: false, final false
static inline ::System::Exception* GetReadNotSupported() ;

/// @brief Method GetStreamIsClosed, addr 0x269f088, size 0x70, virtual false, abstract: false, final false
static inline ::System::Exception* GetStreamIsClosed() ;

/// @brief Method GetWriteNotSupported, addr 0x269f1dc, size 0x6c, virtual false, abstract: false, final false
