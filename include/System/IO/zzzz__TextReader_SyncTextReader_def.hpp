...
/// @brief Method Close, addr 0x26a9b20, size 0x20, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Dispose, addr 0x26a9b40, size 0xb4, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::GlobalNamespace::TextReader_SyncTextReader* New_ctor(::System::IO::TextReader*  t) ;

/// @brief Method Peek, addr 0x26a9bf4, size 0x20, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x26a9c14, size 0x20, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x26a9c34, size 0x20, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadLine, addr 0x26a9c54, size 0x24, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x26a9c78, size 0x24, virtual true, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method ReadToEndAsync, addr 0x26a9c9c, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26a99e0, size 0x6c, virtual false, abstract: false, final false
