...
/// @brief Method Close, addr 0x26bb048, size 0x10, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Dispose, addr 0x26bb058, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x26bb384, size 0x20, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Write, addr 0x26bb12c, size 0x174, virtual true, abstract: false, final false
inline void Write(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Write, addr 0x26bb2a0, size 0x34, virtual true, abstract: false, final false
inline void Write(::StringW  value) ;

/// @brief Method Write, addr 0x26bb104, size 0x28, virtual true, abstract: false, final false
inline void Write(char16_t  value) ;

/// @brief Method WriteAsync, addr 0x26bb2d4, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26badf8, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x26baf6c, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::System::IFormatProvider*  formatProvider) ;

/// @brief Method .ctor, addr 0x26bafd8, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Text::StringBuilder*  sb) ;

/// @brief Method .ctor, addr 0x26bae8c, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_Encoding, addr 0x26bb060, size 0xa4, virtual true, abstract: false, final false
