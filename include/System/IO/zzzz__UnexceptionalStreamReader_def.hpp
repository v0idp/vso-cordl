...
/// @brief Method CheckEOL, addr 0x26dfef0, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method Peek, addr 0x26dfb58, size 0x88, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x26dfbe0, size 0x88, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x26dfc68, size 0x288, virtual true, abstract: false, final false
inline int32_t Read(::ByRef<::ArrayW<char16_t,::Array<char16_t>*>>  dest_buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadLine, addr 0x26e0088, size 0x88, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x26e0110, size 0x88, virtual true, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method .ctor, addr 0x26dfae8, size 0x70, virtual false, abstract: false, final false
