...
/// @brief Method Read, addr 0x26a9b10, size 0x8, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadLine, addr 0x26a9b18, size 0x8, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method .ctor, addr 0x26a9ab8, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
