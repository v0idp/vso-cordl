...
public:
// Declarations
/// @brief Method Invoke, addr 0x2d4ed98, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d4e5bc, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method ReleaseHandle, addr 0x2d4edbc, size 0x88, virtual true, abstract: false, final false
inline bool ReleaseHandle() ;

/// @brief Method .ctor, addr 0x2d4ed84, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsInvalid, addr 0x2d4edac, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method CheckResult, addr 0x2d4e7e8, size 0x12c, virtual false, abstract: false, final false
inline void CheckResult(int32_t  result, ::StringW  where) ;

/// @brief Method CloseZStream, addr 0x2d4ed94, size 0x4, virtual false, abstract: false, final false
static inline int32_t CloseZStream(::System::IntPtr  stream) ;

/// @brief Method Create, addr 0x2d4ce98, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method CreateZStream, addr 0x2d4e648, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x2d4d14c, size 0x104, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x2d4e6ec, size 0x98, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method Flush, addr 0x2d4e784, size 0x64, virtual false, abstract: false, final false
static inline int32_t Flush(::System::IO::Compression::DeflateStreamNative_SafeDeflateStreamHandle*  stream) ;

/// @brief Method Flush, addr 0x2d4d81c, size 0x54, virtual false, abstract: false, final false
inline void Flush() ;

static inline ::System::IO::Compression::DeflateStreamNative* New_ctor() ;

/// @brief Method ReadZStream, addr 0x2d4d298, size 0x78, virtual false, abstract: false, final false
inline int32_t ReadZStream(::System::IntPtr  buffer, int32_t  length) ;

/// @brief Method ReadZStream, addr 0x2d4e914, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method UnmanagedRead, addr 0x2d4ea0c, size 0x1a4, virtual false, abstract: false, final false
inline int32_t UnmanagedRead(::System::IntPtr  buffer, int32_t  length) ;

/// @brief Method UnmanagedRead, addr 0x2d4e43c, size 0xbc, virtual false, abstract: false, final false
static inline int32_t UnmanagedRead(::System::IntPtr  buffer, int32_t  length, ::System::IntPtr  data) ;

/// @brief Method UnmanagedWrite, addr 0x2d4ebb0, size 0x1d4, virtual false, abstract: false, final false
inline int32_t UnmanagedWrite(::System::IntPtr  buffer, int32_t  length) ;

/// @brief Method UnmanagedWrite, addr 0x2d4e4f8, size 0xbc, virtual false, abstract: false, final false
static inline int32_t UnmanagedWrite(::System::IntPtr  buffer, int32_t  length, ::System::IntPtr  data) ;

/// @brief Method WriteZStream, addr 0x2d4e990, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method WriteZStream, addr 0x2d4d524, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d4e5b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
