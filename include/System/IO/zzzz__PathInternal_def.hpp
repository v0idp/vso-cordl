...
/// @brief Method EndsInDirectorySeparator, addr 0x26a2514, size 0x80, virtual false, abstract: false, final false
static inline bool EndsInDirectorySeparator(::System::ReadOnlySpan_1<char16_t>  path) ;

/// @brief Method GetIsCaseSensitive, addr 0x26a2904, size 0x30c, virtual false, abstract: false, final false
static inline bool GetIsCaseSensitive() ;

/// @brief Method GetRootLength, addr 0x26a2488, size 0x7c, virtual false, abstract: false, final false
static inline int32_t GetRootLength(::System::ReadOnlySpan_1<char16_t>  path) ;

/// @brief Method IsDirectorySeparator, addr 0x26a2504, size 0x10, virtual false, abstract: false, final false
static inline bool IsDirectorySeparator(char16_t  c) ;

/// @brief Method IsPartiallyQualified, addr 0x26a2c10, size 0x8, virtual false, abstract: false, final false
static inline bool IsPartiallyQualified(::StringW  path) ;

/// @brief Method IsRoot, addr 0x26a2750, size 0x7c, virtual false, abstract: false, final false
static inline bool IsRoot(::System::ReadOnlySpan_1<char16_t>  path) ;

/// @brief Method StartsWithDirectorySeparator, addr 0x26a2594, size 0x7c, virtual false, abstract: false, final false
static inline bool StartsWithDirectorySeparator(::System::ReadOnlySpan_1<char16_t>  path) ;

/// @brief Method TrimEndingDirectorySeparator, addr 0x26a2610, size 0x140, virtual false, abstract: false, final false
static inline ::StringW TrimEndingDirectorySeparator(::StringW  path) ;

/// @brief Method TrimEndingDirectorySeparator, addr 0x26a27cc, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_IsCaseSensitive, addr 0x26a28ac, size 0x58, virtual false, abstract: false, final false
