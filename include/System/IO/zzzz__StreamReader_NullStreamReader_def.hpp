...
/// @brief Method Dispose, addr 0x26a4fac, size 0x4, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::GlobalNamespace::StreamReader_NullStreamReader* New_ctor() ;

/// @brief Method Peek, addr 0x26a4fb0, size 0x8, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x26a4fb8, size 0x8, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x26a4fc0, size 0x8, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadBuffer, addr 0x26a5018, size 0x8, virtual true, abstract: false, final false
inline int32_t ReadBuffer() ;

/// @brief Method ReadLine, addr 0x26a4fc8, size 0x8, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x26a4fd0, size 0x48, virtual true, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method .ctor, addr 0x26a4eb8, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BaseStream, addr 0x26a4f4c, size 0x58, virtual true, abstract: false, final false
inline ::System::IO::Stream* get_BaseStream() ;

/// @brief Method get_CurrentEncoding, addr 0x26a4fa4, size 0x8, virtual true, abstract: false, final false
