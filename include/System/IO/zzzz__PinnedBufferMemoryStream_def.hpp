...
/// @brief Method Dispose, addr 0x26a2e60, size 0x48, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x26a2dbc, size 0xa4, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::System::IO::PinnedBufferMemoryStream* New_ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  array) ;

/// @brief Method Read, addr 0x26a2dac, size 0x8, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<uint8_t>  buffer) ;

/// @brief Method Write, addr 0x26a2db4, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26a2cf0, size 0xbc, virtual false, abstract: false, final false
