...
/// @brief Method EnsureStatInitialized, addr 0x26b21c0, size 0xc0, virtual false, abstract: false, final false
inline void EnsureStatInitialized(::System::ReadOnlySpan_1<char16_t>  path, bool  continueOnError) ;

/// @brief Method GetAttributes, addr 0x26b2280, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method GetExists, addr 0x26b2368, size 0x44, virtual false, abstract: false, final false
inline bool GetExists(::System::ReadOnlySpan_1<char16_t>  path) ;

/// @brief Method GetLastWriteTime, addr 0x26b2544, size 0x9c, virtual false, abstract: false, final false
inline ::System::DateTimeOffset GetLastWriteTime(::System::ReadOnlySpan_1<char16_t>  path, bool  continueOnError) ;

/// @brief Method Initialize, addr 0x26b20bc, size 0x14, virtual false, abstract: false, final false
static inline void Initialize(::ByRef<::System::IO::FileStatus>  status, bool  isDirectory) ;

/// @brief Method IsReadOnly, addr 0x26b20d0, size 0xf0, virtual false, abstract: false, final false
inline bool IsReadOnly(::System::ReadOnlySpan_1<char16_t>  path, bool  continueOnError) ;

/// @brief Method Refresh, addr 0x26b23ac, size 0x198, virtual false, abstract: false, final false
inline void Refresh(::System::ReadOnlySpan_1<char16_t>  path) ;

/// @brief Method SetAccessWriteTimes, addr 0x26b27d0, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method SetLastWriteTime, addr 0x26b2690, size 0x140, virtual false, abstract: false, final false
inline void SetLastWriteTime(::StringW  path, ::System::DateTimeOffset  time) ;

/// @brief Method UnixTimeToDateTimeOffset, addr 0x26b25e0, size 0xb0, virtual false, abstract: false, final false
inline ::System::DateTimeOffset UnixTimeToDateTimeOffset(int64_t  seconds, int64_t  nanoseconds) ;

/// @brief Method get_InitiallyDirectory, addr 0x26b20a8, size 0x8, virtual false, abstract: false, final false
inline bool get_InitiallyDirectory() ;

/// @brief Method set_InitiallyDirectory, addr 0x26b20b0, size 0xc, virtual false, abstract: false, final false
