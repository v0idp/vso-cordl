...
/// @brief Method Write, addr 0x26aad28, size 0x4, virtual true, abstract: false, final false
inline void Write(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Write, addr 0x26aad2c, size 0x4, virtual true, abstract: false, final false
inline void Write(::StringW  value) ;

/// @brief Method Write, addr 0x26aad38, size 0x4, virtual true, abstract: false, final false
inline void Write(char16_t  value) ;

/// @brief Method WriteLine, addr 0x26aad30, size 0x4, virtual true, abstract: false, final false
inline void WriteLine() ;

/// @brief Method WriteLine, addr 0x26aad34, size 0x4, virtual true, abstract: false, final false
inline void WriteLine(::StringW  value) ;

/// @brief Method .ctor, addr 0x26aac94, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Encoding, addr 0x26aad20, size 0x8, virtual true, abstract: false, final false
