...
/// @brief Method CopyTo, addr 0x26a12a8, size 0x150, virtual true, abstract: false, final false
inline void CopyTo(::System::IO::Stream*  destination, int32_t  bufferSize) ;

/// @brief Method Dispose, addr 0x26a0164, size 0x1c, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EnsureCapacity, addr 0x26a0180, size 0xb4, virtual false, abstract: false, final false
inline bool EnsureCapacity(int32_t  value) ;

/// @brief Method EnsureNotClosed, addr 0x26a00f4, size 0x34, virtual false, abstract: false, final false
inline void EnsureNotClosed() ;

/// @brief Method EnsureWriteable, addr 0x26a0128, size 0x3c, virtual false, abstract: false, final false
inline void EnsureWriteable() ;

/// @brief Method Flush, addr 0x26a0234, size 0x4, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushAsync, addr 0x26a0238, size 0x1a0, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method GetBuffer, addr 0x26a03d8, size 0x60, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetBuffer() ;

/// @brief Method InternalEmulateRead, addr 0x26a0500, size 0x3c, virtual false, abstract: false, final false
inline int32_t InternalEmulateRead(int32_t  count) ;

/// @brief Method InternalGetBuffer, addr 0x26a0438, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> InternalGetBuffer() ;

/// @brief Method InternalGetPosition, addr 0x26a0440, size 0x8, virtual false, abstract: false, final false
inline int32_t InternalGetPosition() ;

/// @brief Method InternalReadInt32, addr 0x26a0448, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x26a07e0, size 0x1e4, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method Read, addr 0x26a09c4, size 0x1d0, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<uint8_t>  buffer) ;

/// @brief Method ReadAsync, addr 0x26a0b94, size 0x384, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method ReadAsync, addr 0x26a0f18, size 0x338, virtual true, abstract: false, final false
...
/// @brief Method ReadByte, addr 0x26a1250, size 0x58, virtual true, abstract: false, final false
inline int32_t ReadByte() ;

/// @brief Method Seek, addr 0x26a161c, size 0x14c, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  loc) ;

/// @brief Method SetLength, addr 0x26a1768, size 0xdc, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method ToArray, addr 0x26a1844, size 0xec, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ToArray() ;

/// @brief Method Write, addr 0x26a1930, size 0x284, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method Write, addr 0x26a1bb4, size 0x22c, virtual true, abstract: false, final false
inline void Write(::System::ReadOnlySpan_1<uint8_t>  buffer) ;

/// @brief Method WriteAsync, addr 0x26a1de0, size 0x334, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method WriteAsync, addr 0x26a2114, size 0x2b8, virtual true, abstract: false, final false
...
/// @brief Method WriteByte, addr 0x26a23cc, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x269fca0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x269fe14, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer) ;

/// @brief Method .ctor, addr 0x269ff08, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method .ctor, addr 0x269ff14, size 0x1c8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count, bool  writable, bool  publiclyVisible) ;

/// @brief Method .ctor, addr 0x269fe1c, size 0xec, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, bool  writable) ;

/// @brief Method .ctor, addr 0x269fca8, size 0x16c, virtual false, abstract: false, final false
inline void _ctor(int32_t  capacity) ;

/// @brief Method get_CanRead, addr 0x26a00dc, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x26a00e4, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanWrite, addr 0x26a00ec, size 0x8, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Capacity, addr 0x26a053c, size 0x20, virtual true, abstract: false, final false
inline int32_t get_Capacity() ;

/// @brief Method get_Length, addr 0x26a06d4, size 0x24, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x26a06f8, size 0x20, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method set_Capacity, addr 0x26a055c, size 0x178, virtual true, abstract: false, final false
inline void set_Capacity(int32_t  value) ;

/// @brief Method set_Position, addr 0x26a0718, size 0xc8, virtual true, abstract: false, final false
...
/// @brief Field MemStreamMaxLength offset 0xffffffff size 0x4
static constexpr int32_t  MemStreamMaxLength{static_cast<int32_t>(0x7fffffff)};
