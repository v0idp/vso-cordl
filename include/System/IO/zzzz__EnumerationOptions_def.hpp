...
/// @brief Method FromSearchOption, addr 0x26af500, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26afa48, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AttributesToSkip, addr 0x26afa98, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::FileAttributes get_AttributesToSkip() ;

/// @brief Method get_Compatible, addr 0x26af940, size 0x58, virtual false, abstract: false, final false
static inline ::System::IO::EnumerationOptions* get_Compatible() ;

/// @brief Method get_CompatibleRecursive, addr 0x26af998, size 0x58, virtual false, abstract: false, final false
static inline ::System::IO::EnumerationOptions* get_CompatibleRecursive() ;

/// @brief Method get_Default, addr 0x26af9f0, size 0x58, virtual false, abstract: false, final false
static inline ::System::IO::EnumerationOptions* get_Default() ;

/// @brief Method get_IgnoreInaccessible, addr 0x26afa84, size 0x8, virtual false, abstract: false, final false
inline bool get_IgnoreInaccessible() ;

/// @brief Method get_MatchCasing, addr 0x26afab8, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::MatchCasing get_MatchCasing() ;

/// @brief Method get_MatchType, addr 0x26afaa8, size 0x8, virtual false, abstract: false, final false
inline ::System::IO::MatchType get_MatchType() ;

/// @brief Method get_RecurseSubdirectories, addr 0x26afa70, size 0x8, virtual false, abstract: false, final false
inline bool get_RecurseSubdirectories() ;

/// @brief Method get_ReturnSpecialDirectories, addr 0x26afac0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_AttributesToSkip, addr 0x26afaa0, size 0x8, virtual false, abstract: false, final false
inline void set_AttributesToSkip(::System::IO::FileAttributes  value) ;

/// @brief Method set_IgnoreInaccessible, addr 0x26afa8c, size 0xc, virtual false, abstract: false, final false
inline void set_IgnoreInaccessible(bool  value) ;

/// @brief Method set_MatchType, addr 0x26afab0, size 0x8, virtual false, abstract: false, final false
inline void set_MatchType(::System::IO::MatchType  value) ;

/// @brief Method set_RecurseSubdirectories, addr 0x26afa78, size 0xc, virtual false, abstract: false, final false
