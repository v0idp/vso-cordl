...
/// @brief Method MoveNext, addr 0x26a5020, size 0x308, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x26a5328, size 0x7c, virtual true, abstract: false, final true
...
static_assert(::cordl_internals::size_check_v<::System::IO::StreamReader__ReadToEndAsyncInternal_d__63, 0x40>, "Size mismatch!");

} // namespace end def System::IO
// Dependencies System.Memory`1<T>, System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder`1<TResult>, System.Runtime.CompilerServices.ConfiguredTaskAwaitable`1::ConfiguredTaskAwaiter<TResult>, System.Runtime.CompilerServices.ConfiguredValueTaskAwaitable`1::ConfiguredValueTaskAwaiter<TResult>, System.Runtime.CompilerServices.IAsyncStateMachine, System.Threading.CancellationToken
namespace System::IO {
// Is value type: true
...
/// @brief Method MoveNext, addr 0x26a53a4, size 0xa88, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x26a5e2c, size 0x58, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method MoveNext, addr 0x26a5e84, size 0x600, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x26a6484, size 0x7c, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method CheckAsyncTaskInProgress, addr 0x26a2ea8, size 0x64, virtual false, abstract: false, final false
inline void CheckAsyncTaskInProgress() ;

/// @brief Method Close, addr 0x26a3630, size 0x10, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method CompressBuffer, addr 0x26a4244, size 0x44, virtual false, abstract: false, final false
inline void CompressBuffer(int32_t  n) ;

/// @brief Method DataAvailable, addr 0x26a4e3c, size 0x10, virtual false, abstract: false, final false
inline bool DataAvailable() ;

/// @brief Method DetectEncoding, addr 0x26a4288, size 0x2b4, virtual false, abstract: false, final false
inline void DetectEncoding() ;

/// @brief Method Dispose, addr 0x26a3640, size 0x114, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Init, addr 0x26a3620, size 0x10, virtual false, abstract: false, final false
inline void Init(::System::IO::Stream*  stream) ;

/// @brief Method Init, addr 0x26a3244, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method IsPreamble, addr 0x26a453c, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method Peek, addr 0x26a380c, size 0xc4, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x26a38d0, size 0xc4, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x26a3994, size 0x18c, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Read, addr 0x26a3d38, size 0xe4, virtual true, abstract: false, final false
inline int32_t Read(::System::Span_1<char16_t>  buffer) ;

/// @brief Method ReadAsyncInternal, addr 0x26a4c1c, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method ReadBuffer, addr 0x26a4654, size 0x16c, virtual true, abstract: false, final false
inline int32_t ReadBuffer() ;

/// @brief Method ReadBuffer, addr 0x26a3e1c, size 0x310, virtual false, abstract: false, final false
inline int32_t ReadBuffer(::System::Span_1<char16_t>  userBuffer, ::ByRef<bool>  readToUserBuffer) ;

/// @brief Method ReadBufferAsync, addr 0x26a4d4c, size 0xf0, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadBufferAsync() ;

/// @brief Method ReadLine, addr 0x26a47c0, size 0x25c, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadSpan, addr 0x26a3b20, size 0x218, virtual false, abstract: false, final false
inline int32_t ReadSpan(::System::Span_1<char16_t>  buffer) ;

/// @brief Method ReadToEnd, addr 0x26a412c, size 0x118, virtual true, abstract: false, final false
inline ::StringW ReadToEnd() ;

/// @brief Method ReadToEndAsync, addr 0x26a4a1c, size 0x124, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::StringW>* ReadToEndAsync() ;

/// @brief Method ReadToEndAsyncInternal, addr 0x26a4b40, size 0xdc, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::StringW>* ReadToEndAsyncInternal() ;

/// @brief Method ThrowAsyncIOInProgress, addr 0x26a2f0c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26a2f58, size 0xbc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x26a336c, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::StringW  path) ;

/// @brief Method .ctor, addr 0x26a33a4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, bool  detectEncodingFromByteOrderMarks) ;

/// @brief Method .ctor, addr 0x26a3614, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::System::Text::Encoding*  encoding, bool  detectEncodingFromByteOrderMarks) ;

/// @brief Method .ctor, addr 0x26a33e0, size 0x234, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::System::Text::Encoding*  encoding, bool  detectEncodingFromByteOrderMarks, int32_t  bufferSize) ;

/// @brief Method .ctor, addr 0x26a3014, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x26a3234, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Text::Encoding*  encoding, bool  detectEncodingFromByteOrderMarks) ;

/// @brief Method .ctor, addr 0x26a3024, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method get_BaseStream, addr 0x26a376c, size 0x8, virtual true, abstract: false, final false
inline ::System::IO::Stream* get_BaseStream() ;

/// @brief Method get_CurrentEncoding, addr 0x26a3764, size 0x8, virtual true, abstract: false, final false
inline ::System::Text::Encoding* get_CurrentEncoding() ;

/// @brief Method get_EndOfStream, addr 0x26a3774, size 0x98, virtual false, abstract: false, final false
inline bool get_EndOfStream() ;

/// @brief Method get_LeaveOpen, addr 0x26a3754, size 0x10, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::System::IO::StreamReader__ReadToEndAsyncInternal_d__63, "System.IO", "StreamReader/<ReadToEndAsyncInternal>d__63");
