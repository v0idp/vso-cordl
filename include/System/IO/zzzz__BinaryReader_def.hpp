...
/// @brief Method Close, addr 0x26b862c, size 0x10, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Dispose, addr 0x26b8680, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x26b863c, size 0x44, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method FillBuffer, addr 0x26b99bc, size 0x11c, virtual true, abstract: false, final false
inline void FillBuffer(int32_t  numBytes) ;

/// @brief Method InternalReadChars, addr 0x26b926c, size 0x2f8, virtual false, abstract: false, final false
inline int32_t InternalReadChars(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method InternalReadOneChar, addr 0x26b86a8, size 0x268, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x26b8690, size 0x18, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x26b96c0, size 0x170, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Read7BitEncodedInt, addr 0x26b91cc, size 0xa0, virtual false, abstract: false, final false
inline int32_t Read7BitEncodedInt() ;

/// @brief Method ReadBoolean, addr 0x26b8910, size 0x48, virtual true, abstract: false, final false
inline bool ReadBoolean() ;

/// @brief Method ReadByte, addr 0x26b8958, size 0x34, virtual true, abstract: false, final false
inline uint8_t ReadByte() ;

/// @brief Method ReadBytes, addr 0x26b9830, size 0x18c, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadBytes(int32_t  count) ;

/// @brief Method ReadChar, addr 0x26b89cc, size 0x24, virtual true, abstract: false, final false
inline char16_t ReadChar() ;

/// @brief Method ReadChars, addr 0x26b9564, size 0x15c, virtual true, abstract: false, final false
inline ::ArrayW<char16_t,::Array<char16_t>*> ReadChars(int32_t  count) ;

/// @brief Method ReadDecimal, addr 0x26b8da4, size 0x198, virtual true, abstract: false, final false
inline ::System::Decimal ReadDecimal() ;

/// @brief Method ReadDouble, addr 0x26b8d74, size 0x30, virtual true, abstract: false, final false
inline double_t ReadDouble() ;

/// @brief Method ReadInt16, addr 0x26b89f0, size 0x48, virtual true, abstract: false, final false
inline int16_t ReadInt16() ;

/// @brief Method ReadInt32, addr 0x26b8a80, size 0xf4, virtual true, abstract: false, final false
inline int32_t ReadInt32() ;

/// @brief Method ReadInt64, addr 0x26b8be4, size 0xb0, virtual true, abstract: false, final false
inline int64_t ReadInt64() ;

/// @brief Method ReadSByte, addr 0x26b898c, size 0x40, virtual true, abstract: false, final false
inline int8_t ReadSByte() ;

/// @brief Method ReadSingle, addr 0x26b8d44, size 0x30, virtual true, abstract: false, final false
inline float_t ReadSingle() ;

/// @brief Method ReadString, addr 0x26b8f3c, size 0x290, virtual true, abstract: false, final false
inline ::StringW ReadString() ;

/// @brief Method ReadUInt16, addr 0x26b8a38, size 0x48, virtual true, abstract: false, final false
inline uint16_t ReadUInt16() ;

/// @brief Method ReadUInt32, addr 0x26b8b74, size 0x70, virtual true, abstract: false, final false
inline uint32_t ReadUInt32() ;

/// @brief Method ReadUInt64, addr 0x26b8c94, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26b833c, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input) ;

/// @brief Method .ctor, addr 0x26b861c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x26b83ac, size 0x270, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  input, ::System::Text::Encoding*  encoding, bool  leaveOpen) ;

/// @brief Method get_BaseStream, addr 0x26b8624, size 0x8, virtual true, abstract: false, final false
