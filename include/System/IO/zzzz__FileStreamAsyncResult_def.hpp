...
/// @brief Method CBWrapper, addr 0x26c00e4, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26bf108, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(::System::AsyncCallback*  cb, ::System::Object*  state) ;

/// @brief Method get_AsyncState, addr 0x26c0178, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle, addr 0x26c0188, size 0x8, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously, addr 0x26c0180, size 0x8, virtual true, abstract: false, final true
inline bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted, addr 0x26c0190, size 0x8, virtual true, abstract: false, final true
