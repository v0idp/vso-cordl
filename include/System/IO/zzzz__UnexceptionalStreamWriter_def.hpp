...
public:
// Declarations
/// @brief Method Flush, addr 0x26e0210, size 0x84, virtual true, abstract: false, final false
inline void Flush() ;

static inline ::System::IO::UnexceptionalStreamWriter* New_ctor(::System::IO::Stream*  stream, ::System::Text::Encoding*  encoding) ;

/// @brief Method Write, addr 0x26e0294, size 0x84, virtual true, abstract: false, final false
inline void Write(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Write, addr 0x26e039c, size 0x84, virtual true, abstract: false, final false
inline void Write(::ArrayW<char16_t,::Array<char16_t>*>  value) ;

/// @brief Method Write, addr 0x26e0420, size 0x84, virtual true, abstract: false, final false
inline void Write(::StringW  value) ;

/// @brief Method Write, addr 0x26e0318, size 0x84, virtual true, abstract: false, final false
inline void Write(char16_t  value) ;

/// @brief Method .ctor, addr 0x26e0198, size 0x78, virtual false, abstract: false, final false
