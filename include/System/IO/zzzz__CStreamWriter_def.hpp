...
/// @brief Method InternalWriteChar, addr 0x26e0fd8, size 0x84, virtual false, abstract: false, final false
inline void InternalWriteChar(char16_t  val) ;

/// @brief Method InternalWriteChars, addr 0x26e10e0, size 0x8c, virtual false, abstract: false, final false
inline void InternalWriteChars(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  n) ;

/// @brief Method InternalWriteString, addr 0x26e105c, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method Write, addr 0x26e0b08, size 0x348, virtual true, abstract: false, final false
inline void Write(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Write, addr 0x26e116c, size 0x28, virtual true, abstract: false, final false
inline void Write(::ArrayW<char16_t,::Array<char16_t>*>  val) ;

/// @brief Method Write, addr 0x26e1194, size 0xcc, virtual true, abstract: false, final false
inline void Write(::StringW  val) ;

/// @brief Method Write, addr 0x26e0e50, size 0x188, virtual true, abstract: false, final false
inline void Write(char16_t  val) ;

/// @brief Method WriteLine, addr 0x26e1260, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26e09e0, size 0x128, virtual false, abstract: false, final false
