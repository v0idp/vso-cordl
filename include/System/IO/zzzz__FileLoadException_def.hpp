...
/// @brief Method FormatFileLoadExceptionMessage, addr 0x269f2c8, size 0x74, virtual false, abstract: false, final false
static inline ::StringW FormatFileLoadExceptionMessage(::StringW  fileName, int32_t  hResult) ;

/// @brief Method GetObjectData, addr 0x269f5e0, size 0x118, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x269f34c, size 0x1e4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x269f248, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x269f530, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x2693a94, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method get_FileName, addr 0x269f33c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_FileName() ;

/// @brief Method get_FusionLog, addr 0x269f344, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_FusionLog() ;

/// @brief Method get_Message, addr 0x269f2a4, size 0x24, virtual true, abstract: false, final false
