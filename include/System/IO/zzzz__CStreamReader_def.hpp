...
/// @brief Method Peek, addr 0x26e05b8, size 0x88, virtual true, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x26e0640, size 0xd0, virtual true, abstract: false, final false
inline int32_t Read() ;

/// @brief Method Read, addr 0x26e0710, size 0x1a0, virtual true, abstract: false, final false
inline int32_t Read(::ByRef<::ArrayW<char16_t,::Array<char16_t>*>>  dest, int32_t  index, int32_t  count) ;

/// @brief Method ReadLine, addr 0x26e08b0, size 0x98, virtual true, abstract: false, final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd, addr 0x26e0948, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26e04a4, size 0x114, virtual false, abstract: false, final false
