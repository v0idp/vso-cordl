...
public:
// Declarations
 __declspec(property(get=get_Parent)) ::System::IO::DirectoryInfo*  Parent;

/// @brief Method EnumerateFileSystemInfos, addr 0x26af638, size 0x10, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::System::IO::FileSystemInfo*>* EnumerateFileSystemInfos(::StringW  searchPattern, ::System::IO::EnumerationOptions*  enumerationOptions) ;

/// @brief Method EnumerateFileSystemInfos, addr 0x26af484, size 0x7c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::System::IO::FileSystemInfo*>* EnumerateFileSystemInfos(::StringW  searchPattern, ::System::IO::SearchOption  searchOption) ;

/// @brief Method Init, addr 0x26aebd0, size 0x290, virtual false, abstract: false, final false
inline void Init(::StringW  originalPath, ::StringW  fullPath, ::StringW  fileName, bool  isNormalized) ;

/// @brief Method InternalEnumerateInfos, addr 0x26af648, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26af800, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x26ae018, size 0x48, virtual false, abstract: false, final false
inline void _ctor(::StringW  originalPath, ::StringW  fullPath, ::StringW  fileName, bool  isNormalized) ;

/// @brief Method .ctor, addr 0x26aeadc, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  path) ;

/// @brief Method get_Parent, addr 0x26aefa4, size 0x150, virtual false, abstract: false, final false
inline ::System::IO::DirectoryInfo* get_Parent() ;
