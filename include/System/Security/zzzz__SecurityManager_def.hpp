...
public:
// Declarations
/// @brief Method EnsureElevatedPermissions, addr 0x2609d04, size 0x4, virtual false, abstract: false, final false
static inline void EnsureElevatedPermissions() ;

/// @brief Method get_SecurityEnabled, addr 0x260680c, size 0x8, virtual false, abstract: false, final false
