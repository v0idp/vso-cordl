...
/// @brief Method Alloc, addr 0x2607dec, size 0x180, virtual false, abstract: false, final false
inline void Alloc(int32_t  length, bool  realloc) ;

/// @brief Method Decrypt, addr 0x2608148, size 0x4, virtual false, abstract: false, final false
inline void Decrypt() ;

/// @brief Method Dispose, addr 0x2608110, size 0x38, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Encrypt, addr 0x26080ac, size 0x4, virtual false, abstract: false, final false
inline void Encrypt() ;

/// @brief Method GetBuffer, addr 0x260814c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2607dc8, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2607f6c, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::cordl_internals::Ptr<char16_t>  value, int32_t  length) ;

/// @brief Method get_Length, addr 0x26080b0, size 0x60, virtual false, abstract: false, final false
