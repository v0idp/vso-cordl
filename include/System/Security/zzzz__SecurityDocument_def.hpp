...
/// @brief Method AddString, addr 0x2605bcc, size 0x14c, virtual false, abstract: false, final false
inline void AddString(::StringW  str, ::ByRef<int32_t>  position) ;

/// @brief Method AddToken, addr 0x26062e0, size 0x5c, virtual false, abstract: false, final false
inline void AddToken(uint8_t  b, ::ByRef<int32_t>  position) ;

/// @brief Method AppendString, addr 0x2605d18, size 0x8c, virtual false, abstract: false, final false
inline void AppendString(::StringW  str, ::ByRef<int32_t>  position) ;

/// @brief Method EncodedStringSize, addr 0x2605da4, size 0x20, virtual false, abstract: false, final false
static inline int32_t EncodedStringSize(::StringW  str) ;

/// @brief Method GetElement, addr 0x2606358, size 0x1c, virtual false, abstract: false, final false
inline ::System::Security::SecurityElement* GetElement(int32_t  position, bool  bCreate) ;

/// @brief Method GetRootElement, addr 0x260633c, size 0x1c, virtual false, abstract: false, final false
inline ::System::Security::SecurityElement* GetRootElement() ;

/// @brief Method GetString, addr 0x2605dc4, size 0x300, virtual false, abstract: false, final false
inline ::StringW GetString(::ByRef<int32_t>  position, bool  bCreate) ;

/// @brief Method GuaranteeSize, addr 0x2605b28, size 0xa4, virtual false, abstract: false, final false
inline void GuaranteeSize(int32_t  size) ;

/// @brief Method InternalGetElement, addr 0x2606374, size 0x1fc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2605ac0, size 0x68, virtual false, abstract: false, final false
