...
/// @brief Method DetermineFormat, addr 0x260a268, size 0x18c, virtual false, abstract: false, final false
inline int32_t DetermineFormat(::System::Security::Util::TokenizerStream*  stream) ;

/// @brief Method GetRequiredSizes, addr 0x2609d30, size 0x440, virtual false, abstract: false, final false
inline void GetRequiredSizes(::System::Security::Util::TokenizerStream*  stream, ::ByRef<int32_t>  index) ;

/// @brief Method GetTopElement, addr 0x2609d08, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method ParseContents, addr 0x260ae48, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x260b314, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::StringW  input) ;

/// @brief Method .ctor, addr 0x260b270, size 0xa4, virtual false, abstract: false, final false
