...
/// @brief Method CompareStringAndChars, addr 0x260b7e0, size 0xa0, virtual false, abstract: false, final false
inline bool CompareStringAndChars(::StringW  str, ::ArrayW<char16_t,::Array<char16_t>*>  a, int32_t  l) ;

/// @brief Method HashCharArray, addr 0x260b6f0, size 0x5c, virtual false, abstract: false, final false
static inline uint32_t HashCharArray(::ArrayW<char16_t,::Array<char16_t>*>  a, int32_t  l) ;

/// @brief Method HashString, addr 0x260b684, size 0x6c, virtual false, abstract: false, final false
static inline uint32_t HashString(::StringW  str) ;

/// @brief Method MakeString, addr 0x26060c4, size 0x21c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x260b74c, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Read, addr 0x260b880, size 0x3c, virtual true, abstract: false, final false
inline int32_t Read() ;
...
/// @brief Method .ctor, addr 0x260b494, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::StreamReader*  input) ;

/// @brief Method get_NumCharEncountered, addr 0x260b8bc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method BasicInitialization, addr 0x260b3c4, size 0x78, virtual false, abstract: false, final false
inline void BasicInitialization() ;

/// @brief Method ChangeFormat, addr 0x260ac28, size 0x220, virtual false, abstract: false, final false
inline void ChangeFormat(::System::Text::Encoding*  encoding) ;

/// @brief Method GetStringToken, addr 0x260b5a4, size 0x18, virtual false, abstract: false, final false
inline ::StringW GetStringToken() ;

/// @brief Method GetTokens, addr 0x260a3f4, size 0x7d4, virtual false, abstract: false, final false
...
/// @brief Method Recycle, addr 0x260b43c, size 0x58, virtual false, abstract: false, final false
inline void Recycle() ;
...
/// @brief Method .ctor, addr 0x260b37c, size 0x48, virtual false, abstract: false, final false
