...
/// @brief Method AddString, addr 0x260b5bc, size 0xc8, virtual false, abstract: false, final false
inline void AddString(::StringW  str) ;

/// @brief Method AddToken, addr 0x260b4c0, size 0xe4, virtual false, abstract: false, final false
inline void AddToken(int16_t  token) ;

/// @brief Method GetNextFullToken, addr 0x260b200, size 0x70, virtual false, abstract: false, final false
inline int16_t GetNextFullToken() ;

/// @brief Method GetNextString, addr 0x260a1fc, size 0x6c, virtual false, abstract: false, final false
inline ::StringW GetNextString() ;

/// @brief Method GetNextToken, addr 0x260a170, size 0x14, virtual false, abstract: false, final false
inline int16_t GetNextToken() ;

/// @brief Method GetTokenCount, addr 0x260b974, size 0x8, virtual false, abstract: false, final false
inline int32_t GetTokenCount() ;

/// @brief Method GoToPosition, addr 0x260abc8, size 0x60, virtual false, abstract: false, final false
inline void GoToPosition(int32_t  position) ;

static inline ::System::Security::Util::TokenizerStream* New_ctor() ;

/// @brief Method Reset, addr 0x260b1e4, size 0x1c, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method TagLastToken, addr 0x260a188, size 0x74, virtual false, abstract: false, final false
inline void TagLastToken(int16_t  tag) ;

/// @brief Method ThrowAwayNextString, addr 0x260a184, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x260b140, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;
