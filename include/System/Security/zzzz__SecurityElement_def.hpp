...
/// @brief Method .ctor, addr 0x2608a10, size 0x15c, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  value) ;

/// @brief Method get_Name, addr 0x2609a30, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Value, addr 0x2609a38, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AddAttribute, addr 0x2606578, size 0x194, virtual false, abstract: false, final false
inline void AddAttribute(::StringW  name, ::StringW  value) ;

/// @brief Method AddChild, addr 0x260670c, size 0xcc, virtual false, abstract: false, final false
inline void AddChild(::System::Security::SecurityElement*  child) ;

/// @brief Method Escape, addr 0x2608b6c, size 0x208, virtual false, abstract: false, final false
static inline ::StringW Escape(::StringW  str) ;

/// @brief Method GetAttribute, addr 0x260870c, size 0x304, virtual false, abstract: false, final false
inline ::System::Security::SecurityElement_SecurityAttribute* GetAttribute(::StringW  name) ;

/// @brief Method IsValidAttributeName, addr 0x2608d74, size 0x7c, virtual false, abstract: false, final false
static inline bool IsValidAttributeName(::StringW  name) ;

/// @brief Method IsValidAttributeValue, addr 0x2608df0, size 0x7c, virtual false, abstract: false, final false
static inline bool IsValidAttributeValue(::StringW  value) ;

/// @brief Method IsValidTag, addr 0x2608340, size 0x7c, virtual false, abstract: false, final false
static inline bool IsValidTag(::StringW  tag) ;

/// @brief Method IsValidText, addr 0x26084c0, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method SearchForChildByTag, addr 0x2608e6c, size 0x124, virtual false, abstract: false, final false
inline ::System::Security::SecurityElement* SearchForChildByTag(::StringW  tag) ;

/// @brief Method SearchForTextOfLocalName, addr 0x2609670, size 0x240, virtual false, abstract: false, final false
inline ::StringW SearchForTextOfLocalName(::StringW  strLocalName) ;

/// @brief Method ToString, addr 0x2608f90, size 0x84, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToXml, addr 0x2609014, size 0x654, virtual false, abstract: false, final false
inline void ToXml(::ByRef<::System::Text::StringBuilder*>  s, int32_t  level) ;

/// @brief Method Unescape, addr 0x260853c, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2606570, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  tag) ;

/// @brief Method .ctor, addr 0x26081fc, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method get_Children, addr 0x26084b0, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_Children() ;

/// @brief Method get_Tag, addr 0x26084b8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Text, addr 0x26083bc, size 0xf4, virtual false, abstract: false, final false
inline void set_Text(::StringW  value) ;

/// @brief Method set_m_strText, addr 0x2609668, size 0x8, virtual false, abstract: false, final false
