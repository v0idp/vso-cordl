...
/// @brief Method .ctor, addr 0x261130c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x261137c, size 0x34, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwTypeIn) ;

/// @brief Method .ctor, addr 0x2611338, size 0x44, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwTypeIn, ::StringW  strProviderNameIn, ::StringW  strContainerNameIn) ;

/// @brief Method .ctor, addr 0x26113b0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_Flags, addr 0x2611220, size 0x8, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::CspProviderFlags get_Flags() ;

/// @brief Method set_Flags, addr 0x2611228, size 0xe4, virtual false, abstract: false, final false
