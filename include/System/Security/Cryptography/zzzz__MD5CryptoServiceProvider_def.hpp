...
/// @brief Method AddLength, addr 0x26267dc, size 0xf0, virtual false, abstract: false, final false
inline void AddLength(uint64_t  length, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  position) ;

/// @brief Method Dispose, addr 0x26256fc, size 0x70, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x262565c, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method HashCore, addr 0x262576c, size 0x100, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal, addr 0x26264e4, size 0xd8, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> HashFinal() ;

/// @brief Method Initialize, addr 0x2626768, size 0x74, virtual true, abstract: false, final false
inline void Initialize() ;

static inline ::System::Security::Cryptography::MD5CryptoServiceProvider* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x262586c, size 0xc78, virtual false, abstract: false, final false
inline void ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  inputBuffer, int32_t  inputOffset) ;

/// @brief Method ProcessFinalBlock, addr 0x26265bc, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2623070, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;
