...
/// @brief Method Create, addr 0x2614f5c, size 0x54, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::RandomNumberGenerator* Create() ;

/// @brief Method Dispose, addr 0x2614fb0, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x261501c, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2614f54, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
