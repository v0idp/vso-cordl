...
/// @brief Method SetHashAlgorithm, addr 0x2612f8c, size 0xc8, virtual true, abstract: false, final false
inline void SetHashAlgorithm(::StringW  strName) ;

/// @brief Method SetKey, addr 0x2612ea4, size 0xe8, virtual true, abstract: false, final false
inline void SetKey(::System::Security::Cryptography::AsymmetricAlgorithm*  key) ;

/// @brief Method VerifySignature, addr 0x2613054, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2612d34, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2612db4, size 0xf0, virtual false, abstract: false, final false
