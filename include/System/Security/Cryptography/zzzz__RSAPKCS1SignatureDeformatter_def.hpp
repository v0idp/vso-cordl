...
/// @brief Method SetHashAlgorithm, addr 0x2627d04, size 0x5c, virtual true, abstract: false, final false
inline void SetHashAlgorithm(::StringW  strName) ;

/// @brief Method SetKey, addr 0x2627d60, size 0xe8, virtual true, abstract: false, final false
inline void SetKey(::System::Security::Cryptography::AsymmetricAlgorithm*  key) ;

/// @brief Method VerifySignature, addr 0x2627e48, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2623118, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2627cd0, size 0x34, virtual false, abstract: false, final false
