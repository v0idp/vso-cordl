...
public:
// Declarations
/// @brief Method Create, addr 0x261a580, size 0x6c, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::RSA* Create() ;

/// @brief Method EncryptValue, addr 0x261a618, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method FromXmlString, addr 0x261a670, size 0x54c, virtual true, abstract: false, final false
...
/// @brief Method ToXmlString, addr 0x261abbc, size 0x430, virtual true, abstract: false, final false
inline ::StringW ToXmlString(bool  includePrivateParameters) ;

/// @brief Method .ctor, addr 0x261a578, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
