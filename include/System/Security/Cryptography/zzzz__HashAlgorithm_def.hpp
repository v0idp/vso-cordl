...
/// @brief Method CaptureHashCodeAndReinitialize, addr 0x26105b0, size 0xa8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> CaptureHashCodeAndReinitialize() ;

/// @brief Method Clear, addr 0x2610824, size 0x94, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ComputeHash, addr 0x261050c, size 0xa4, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ComputeHash(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer) ;

/// @brief Method ComputeHash, addr 0x2610658, size 0x160, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ComputeHash(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method Create, addr 0x2610350, size 0x80, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::HashAlgorithm* Create(::StringW  hashName) ;

/// @brief Method Dispose, addr 0x26107b8, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x26108b8, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method TransformBlock, addr 0x26108e0, size 0x9c, virtual true, abstract: false, final true
...
/// @brief Method TransformFinalBlock, addr 0x2610ac0, size 0x134, virtual true, abstract: false, final true
...
/// @brief Method ValidateTransformBlock, addr 0x261097c, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2610348, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CanTransformMultipleBlocks, addr 0x26108d8, size 0x8, virtual true, abstract: false, final false
inline bool get_CanTransformMultipleBlocks() ;

/// @brief Method get_Hash, addr 0x26103d8, size 0xec, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Hash() ;

/// @brief Method get_HashSize, addr 0x26103d0, size 0x8, virtual true, abstract: false, final false
inline int32_t get_HashSize() ;

/// @brief Method get_InputBlockSize, addr 0x26108c8, size 0x8, virtual true, abstract: false, final false
inline int32_t get_InputBlockSize() ;

/// @brief Method get_OutputBlockSize, addr 0x26108d0, size 0x8, virtual true, abstract: false, final false
