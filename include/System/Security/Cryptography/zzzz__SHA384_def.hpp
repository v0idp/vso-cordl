...
public:
// Declarations
/// @brief Method Create, addr 0x261d024, size 0x50, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::SHA384* Create() ;

static inline ::System::Security::Cryptography::SHA384* New_ctor() ;

/// @brief Method .ctor, addr 0x261d004, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
