...
public:
// Declarations
/// @brief Method Create, addr 0x2614f00, size 0x54, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::MD5* Create() ;

static inline ::System::Security::Cryptography::MD5* New_ctor() ;

/// @brief Method .ctor, addr 0x2614ee0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
