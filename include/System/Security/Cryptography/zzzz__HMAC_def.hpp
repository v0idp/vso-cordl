...
/// @brief Method Create, addr 0x26134ec, size 0x68, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::HMAC* Create() ;

/// @brief Method Dispose, addr 0x2613790, size 0x148, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method HashCore, addr 0x26135c4, size 0x88, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb, int32_t  ib, int32_t  cb) ;

/// @brief Method HashFinal, addr 0x261364c, size 0x144, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> HashFinal() ;

/// @brief Method Initialize, addr 0x261357c, size 0x48, virtual true, abstract: false, final false
inline void Initialize() ;

/// @brief Method InitializeKey, addr 0x2613334, size 0xd4, virtual false, abstract: false, final false
inline void InitializeKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

static inline ::System::Security::Cryptography::HMAC* New_ctor() ;

/// @brief Method UpdateIOPadBuffers, addr 0x26131c8, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2613920, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BlockSizeValue, addr 0x26131b8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_BlockSizeValue() ;

/// @brief Method get_Key, addr 0x2613408, size 0x78, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Key() ;

/// @brief Method set_BlockSizeValue, addr 0x26131c0, size 0x8, virtual false, abstract: false, final false
inline void set_BlockSizeValue(int32_t  value) ;

/// @brief Method set_Key, addr 0x2613480, size 0x6c, virtual true, abstract: false, final false
