...
/// @brief Method HashCore, addr 0x261bb6c, size 0x4, virtual true, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal, addr 0x261bcf0, size 0x4, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> HashFinal() ;

/// @brief Method Initialize, addr 0x261bb28, size 0x44, virtual true, abstract: false, final false
inline void Initialize() ;

/// @brief Method InitializeState, addr 0x261baa4, size 0x84, virtual false, abstract: false, final false
inline void InitializeState() ;

static inline ::System::Security::Cryptography::SHA1Managed* New_ctor() ;

/// @brief Method SHAExpand, addr 0x261c290, size 0x3c, virtual false, abstract: false, final false
static inline void SHAExpand(::cordl_internals::Ptr<uint32_t>  x) ;

/// @brief Method SHATransform, addr 0x261bea0, size 0x3f0, virtual false, abstract: false, final false
...
/// @brief Method _EndHash, addr 0x261bcf4, size 0x1ac, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> _EndHash() ;

/// @brief Method _HashData, addr 0x261bb70, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2613cc8, size 0x11c, virtual false, abstract: false, final false
inline void _ctor() ;
