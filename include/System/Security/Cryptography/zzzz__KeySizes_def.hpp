...
/// @brief Method IsLegal, addr 0x2610fe8, size 0x4c, virtual false, abstract: false, final false
inline bool IsLegal(int32_t  keySize) ;

/// @brief Method IsLegalKeySize, addr 0x2611034, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2610d94, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(int32_t  minSize, int32_t  maxSize, int32_t  skipSize) ;

/// @brief Method get_MaxSize, addr 0x2610fd8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxSize() ;

/// @brief Method get_MinSize, addr 0x2610fd0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MinSize() ;

/// @brief Method get_SkipSize, addr 0x2610fe0, size 0x8, virtual false, abstract: false, final false
