...
/// @brief Method Common, addr 0x2625190, size 0x1f8, virtual false, abstract: false, final false
inline void Common(int32_t  dwKeySize, bool  parameters) ;

/// @brief Method Dispose, addr 0x2625584, size 0x54, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method ExportParameters, addr 0x2625464, size 0xac, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::DSAParameters ExportParameters(bool  includePrivateParameters) ;

/// @brief Method Finalize, addr 0x2625388, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method ImportParameters, addr 0x2625510, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method OnKeyGenerated, addr 0x26255d8, size 0x84, virtual false, abstract: false, final false
inline void OnKeyGenerated(::System::Object*  sender, ::System::EventArgs*  e) ;

/// @brief Method VerifySignature, addr 0x2625564, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2623044, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2625158, size 0x38, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwKeySize) ;

static inline bool getStaticF_useMachineKeyStore() ;

/// @brief Method get_KeySize, addr 0x2625428, size 0x20, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Method get_PublicOnly, addr 0x2625448, size 0x1c, virtual false, abstract: false, final false
