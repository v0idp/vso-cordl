...
/// @brief Method ECB, addr 0x2629424, size 0x120, virtual true, abstract: false, final false
inline void ECB(::ArrayW<uint8_t,::Array<uint8_t>*>  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method GetStrongKey, addr 0x2629380, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2620530, size 0x300, virtual false, abstract: false, final false
