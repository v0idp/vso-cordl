...
public:
// Declarations
/// @brief Method Create, addr 0x2618a24, size 0x50, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::RIPEMD160* Create() ;

static inline ::System::Security::Cryptography::RIPEMD160* New_ctor() ;

/// @brief Method .ctor, addr 0x2618a04, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
