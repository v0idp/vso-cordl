...
/// @brief Method AddLength, addr 0x2629188, size 0xf0, virtual false, abstract: false, final false
inline void AddLength(uint64_t  length, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  position) ;

/// @brief Method FillBuff, addr 0x2629004, size 0x184, virtual false, abstract: false, final false
static inline void FillBuff(::ArrayW<uint32_t,::Array<uint32_t>*>  buff) ;

/// @brief Method HashCore, addr 0x26280bc, size 0x100, virtual false, abstract: false, final false
inline void HashCore(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal, addr 0x26286d0, size 0xd8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> HashFinal() ;

/// @brief Method InitialiseBuff, addr 0x2628964, size 0x6a0, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x2628034, size 0x88, virtual false, abstract: false, final false
inline void Initialize() ;

static inline ::System::Security::Cryptography::SHA1Internal* New_ctor() ;

/// @brief Method ProcessBlock, addr 0x26281bc, size 0x514, virtual false, abstract: false, final false
inline void ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  inputBuffer, uint32_t  inputOffset) ;

/// @brief Method ProcessFinalBlock, addr 0x26287a8, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2627f98, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;
