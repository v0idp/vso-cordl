...
/// @brief Method Common, addr 0x261b0e0, size 0x1f8, virtual false, abstract: false, final false
inline void Common(int32_t  dwKeySize, bool  parameters) ;

/// @brief Method Common, addr 0x261b2d8, size 0x11c, virtual false, abstract: false, final false
inline void Common(::System::Security::Cryptography::CspParameters*  p) ;

/// @brief Method Dispose, addr 0x261b958, size 0x54, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EncryptValue, addr 0x261b4d0, size 0x20, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncryptValue(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb) ;

/// @brief Method ExportParameters, addr 0x261b4f0, size 0x130, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::RSAParameters ExportParameters(bool  includePrivateParameters) ;

/// @brief Method Finalize, addr 0x261b3f4, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetHashNameFromOID, addr 0x261b674, size 0x1c4, virtual false, abstract: false, final false
inline ::StringW GetHashNameFromOID(::StringW  oid) ;

/// @brief Method ImportParameters, addr 0x261b620, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method OnKeyGenerated, addr 0x261b9ac, size 0x84, virtual false, abstract: false, final false
inline void OnKeyGenerated(::System::Object*  sender, ::System::EventArgs*  e) ;

/// @brief Method VerifyHash, addr 0x261b838, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x261a5ec, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x261b040, size 0x38, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwKeySize) ;

/// @brief Method .ctor, addr 0x261b084, size 0x5c, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwKeySize, ::System::Security::Cryptography::CspParameters*  parameters) ;

/// @brief Method .ctor, addr 0x261b078, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_KeySize, addr 0x261b494, size 0x20, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Method get_PublicOnly, addr 0x261b4b4, size 0x1c, virtual false, abstract: false, final false
inline bool get_PublicOnly() ;

/// @brief Method get_UseMachineKeyStore, addr 0x261afec, size 0x54, virtual false, abstract: false, final false
