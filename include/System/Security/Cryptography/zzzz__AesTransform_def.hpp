...
/// @brief Method Decrypt128, addr 0x2988bec, size 0x1df4, virtual false, abstract: false, final false
...
/// @brief Method ECB, addr 0x2986dac, size 0x14, virtual true, abstract: false, final false
inline void ECB(::ArrayW<uint8_t,::Array<uint8_t>*>  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method Encrypt128, addr 0x2986dc0, size 0x1e2c, virtual false, abstract: false, final false
...
/// @brief Method SubByte, addr 0x2986ce8, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29863ac, size 0x6f4, virtual false, abstract: false, final false
