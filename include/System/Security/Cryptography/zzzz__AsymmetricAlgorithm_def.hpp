...
/// @brief Method Clear, addr 0x2610ddc, size 0x6c, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Dispose, addr 0x2610dd8, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x2610e48, size 0x4, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method FromXmlString, addr 0x2610f50, size 0x38, virtual true, abstract: false, final false
inline void FromXmlString(::StringW  xmlString) ;

static inline ::System::Security::Cryptography::AsymmetricAlgorithm* New_ctor() ;

/// @brief Method ToXmlString, addr 0x2610f88, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2610dd0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_KeySize, addr 0x2610e4c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_KeySize, addr 0x2610e54, size 0xd4, virtual true, abstract: false, final false
