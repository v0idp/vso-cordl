...
/// @brief Method Clear, addr 0x2614a6c, size 0x10, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Dispose, addr 0x2614a7c, size 0xc0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Flush, addr 0x2614c64, size 0x4, virtual true, abstract: false, final false
inline void Flush() ;

static inline ::System::Security::Cryptography::TailStream* New_ctor(int32_t  bufferSize) ;

/// @brief Method Read, addr 0x2614d18, size 0x58, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method Seek, addr 0x2614c68, size 0x58, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x2614cc0, size 0x58, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method Write, addr 0x2614d70, size 0x170, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2614738, size 0x90, virtual false, abstract: false, final false
inline void _ctor(int32_t  bufferSize) ;

/// @brief Method get_Buffer, addr 0x261490c, size 0x78, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Buffer() ;

/// @brief Method get_CanRead, addr 0x2614b3c, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x2614b44, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanWrite, addr 0x2614b4c, size 0x10, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Length, addr 0x2614b5c, size 0x58, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x2614bb4, size 0x58, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method set_Position, addr 0x2614c0c, size 0x58, virtual true, abstract: false, final false
