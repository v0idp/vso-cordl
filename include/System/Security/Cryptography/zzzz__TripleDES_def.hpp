...
/// @brief Method Create, addr 0x261ffd8, size 0x50, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::TripleDES* Create() ;

/// @brief Method EqualBytes, addr 0x2620174, size 0x198, virtual false, abstract: false, final false
static inline bool EqualBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  rgbKey, int32_t  start1, int32_t  start2, int32_t  count) ;

/// @brief Method IsLegalKeySize, addr 0x2620088, size 0x24, virtual false, abstract: false, final false
static inline bool IsLegalKeySize(::ArrayW<uint8_t,::Array<uint8_t>*>  rgbKey) ;

/// @brief Method IsWeakKey, addr 0x261fcd0, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x261fb80, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Key, addr 0x261fc08, size 0xc8, virtual true, abstract: false, final false
...
/// @brief Method set_Key, addr 0x261fe04, size 0x1d4, virtual true, abstract: false, final false
