...
public:
// Declarations
/// @brief Method Create, addr 0x261c2ec, size 0x50, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::SHA256* Create() ;

static inline ::System::Security::Cryptography::SHA256* New_ctor() ;

/// @brief Method .ctor, addr 0x261c2cc, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
