...
/// @brief Method .ctor, addr 0x261edfc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_DeformatterAlgorithm, addr 0x261ee1c, size 0x8, virtual false, abstract: false, final false
inline void set_DeformatterAlgorithm(::StringW  value) ;

/// @brief Method set_DigestAlgorithm, addr 0x261ee0c, size 0x8, virtual false, abstract: false, final false
inline void set_DigestAlgorithm(::StringW  value) ;

/// @brief Method set_FormatterAlgorithm, addr 0x261ee14, size 0x8, virtual false, abstract: false, final false
inline void set_FormatterAlgorithm(::StringW  value) ;

/// @brief Method set_KeyAlgorithm, addr 0x261ee04, size 0x8, virtual false, abstract: false, final false
