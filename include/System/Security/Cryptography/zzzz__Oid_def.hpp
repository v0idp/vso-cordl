...
/// @brief Method FromOidValue, addr 0x2d0168c, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d0154c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2d01554, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid) ;

/// @brief Method .ctor, addr 0x2d0160c, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::Oid*  oid) ;

/// @brief Method .ctor, addr 0x2d015e0, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  value, ::StringW  friendlyName) ;

/// @brief Method .ctor, addr 0x2d017b8, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  value, ::StringW  friendlyName, ::System::Security::Cryptography::OidGroup  group) ;

/// @brief Method get_FriendlyName, addr 0x2d01804, size 0x84, virtual false, abstract: false, final false
inline ::StringW get_FriendlyName() ;

/// @brief Method get_Value, addr 0x2d017f4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x2d017fc, size 0x8, virtual false, abstract: false, final false
