...
public:
// Declarations
/// @brief Method Create, addr 0x261dd9c, size 0x50, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::SHA512* Create() ;

static inline ::System::Security::Cryptography::SHA512* New_ctor() ;

/// @brief Method .ctor, addr 0x261dd7c, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
