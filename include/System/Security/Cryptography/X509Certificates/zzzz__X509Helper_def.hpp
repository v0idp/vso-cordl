...
public:
// Declarations
/// @brief Method GetInvalidContextException, addr 0x262a780, size 0x80, virtual false, abstract: false, final false
static inline ::System::Exception* GetInvalidContextException() ;

/// @brief Method Import, addr 0x26297cc, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method Import, addr 0x262ab8c, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method InitFromCertificate, addr 0x2629a0c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method InitFromCertificate, addr 0x262991c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x262a420, size 0x14, virtual false, abstract: false, final false
static inline bool IsValid(::System::Security::Cryptography::X509Certificates::X509CertificateImpl*  impl) ;

/// @brief Method ThrowIfContextInvalid, addr 0x262a704, size 0x40, virtual false, abstract: false, final false
static inline void ThrowIfContextInvalid(::System::Security::Cryptography::X509Certificates::X509CertificateImpl*  impl) ;

/// @brief Method get_CertificateProvider, addr 0x262aac4, size 0xc8, virtual false, abstract: false, final false
