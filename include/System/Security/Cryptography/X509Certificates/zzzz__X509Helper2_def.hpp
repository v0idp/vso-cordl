...
public:
// Declarations
/// @brief Method CreateChainImpl, addr 0x2d0babc, size 0x58, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::X509Certificates::X509ChainImpl* CreateChainImpl(bool  useMachineContext) ;

/// @brief Method GetInvalidChainContextException, addr 0x2d0ca50, size 0x80, virtual false, abstract: false, final false
static inline ::System::Exception* GetInvalidChainContextException() ;

/// @brief Method GetMonoCertificate, addr 0x2d0ef30, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x2d11104, size 0x14, virtual false, abstract: false, final false
static inline bool IsValid(::System::Security::Cryptography::X509Certificates::X509ChainImpl*  impl) ;

/// @brief Method ThrowIfContextInvalid, addr 0x2d0ba28, size 0x40, virtual false, abstract: false, final false
