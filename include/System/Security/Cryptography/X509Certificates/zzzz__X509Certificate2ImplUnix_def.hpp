...
/// @brief Method AppendPrivateKeyInfo, addr 0x2d0ad50, size 0x94, virtual true, abstract: false, final true
inline void AppendPrivateKeyInfo(::System::Text::StringBuilder*  sb) ;

/// @brief Method EnsureCertData, addr 0x2d0a908, size 0x80, virtual false, abstract: false, final false
inline void EnsureCertData() ;

/// @brief Method GetNameInfo, addr 0x2d0ac44, size 0x34, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2d09458, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Extensions, addr 0x2d0ac78, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method get_Issuer, addr 0x2d0aa74, size 0x28, virtual true, abstract: false, final true
inline ::StringW get_Issuer() ;

/// @brief Method get_IssuerName, addr 0x2d0aa34, size 0x18, virtual true, abstract: false, final true
inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_IssuerName() ;

/// @brief Method get_KeyAlgorithm, addr 0x2d0a988, size 0x18, virtual true, abstract: false, final true
inline ::StringW get_KeyAlgorithm() ;

/// @brief Method get_KeyAlgorithmParameters, addr 0x2d0a9a0, size 0x18, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_KeyAlgorithmParameters() ;

/// @brief Method get_NotAfter, addr 0x2d0ac90, size 0x60, virtual true, abstract: false, final true
inline ::System::DateTime get_NotAfter() ;

/// @brief Method get_NotBefore, addr 0x2d0acf0, size 0x60, virtual true, abstract: false, final true
inline ::System::DateTime get_NotBefore() ;

/// @brief Method get_PublicKeyValue, addr 0x2d0a9b8, size 0x18, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_PublicKeyValue() ;

/// @brief Method get_RawData, addr 0x2d0aa9c, size 0x18, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_RawData() ;

/// @brief Method get_SerialNumber, addr 0x2d0a9d0, size 0x18, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_SerialNumber() ;

/// @brief Method get_SignatureAlgorithm, addr 0x2d0a9e8, size 0x18, virtual true, abstract: false, final true
inline ::StringW get_SignatureAlgorithm() ;

/// @brief Method get_Subject, addr 0x2d0aa4c, size 0x28, virtual true, abstract: false, final true
inline ::StringW get_Subject() ;

/// @brief Method get_SubjectName, addr 0x2d0aa1c, size 0x18, virtual true, abstract: false, final true
inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_SubjectName() ;

/// @brief Method get_Thumbprint, addr 0x2d0aab4, size 0x190, virtual true, abstract: false, final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Thumbprint() ;

/// @brief Method get_Version, addr 0x2d0aa00, size 0x1c, virtual true, abstract: false, final true
