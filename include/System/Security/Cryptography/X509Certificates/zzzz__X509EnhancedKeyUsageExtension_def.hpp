...
/// @brief Method CopyFrom, addr 0x2d107a4, size 0x1c8, virtual true, abstract: false, final false
inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData*  asnEncodedData) ;

/// @brief Method Decode, addr 0x2d1032c, size 0x240, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  extension) ;

/// @brief Method Encode, addr 0x2d106e8, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2d1096c, size 0x2d0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d072e4, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2d03120, size 0xd4, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::AsnEncodedData*  encodedEnhancedKeyUsages, bool  critical) ;

/// @brief Method .ctor, addr 0x2d1056c, size 0x17c, virtual false, abstract: false, final false
