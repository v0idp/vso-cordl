...
/// @brief Method CopyFrom, addr 0x2d10c74, size 0x120, virtual true, abstract: false, final false
inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData*  asnEncodedData) ;

/// @brief Method FormatUnkownData, addr 0x2d0513c, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d04778, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2d10c3c, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid, ::ArrayW<uint8_t,::Array<uint8_t>*>  rawData, bool  critical) ;

/// @brief Method get_Critical, addr 0x2d10c60, size 0x8, virtual false, abstract: false, final false
inline bool get_Critical() ;

/// @brief Method set_Critical, addr 0x2d10c68, size 0xc, virtual false, abstract: false, final false
