...
/// @brief Method Add, addr 0x2d0c590, size 0x80, virtual false, abstract: false, final false
inline void Add(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method Clear, addr 0x2d0c610, size 0x24, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x2d0c634, size 0x108, virtual false, abstract: false, final false
inline bool Contains(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method GetEnumerator, addr 0x2d0c424, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method System.Collections.ICollection.CopyTo, addr 0x2d0c400, size 0x24, virtual true, abstract: false, final true
inline void System_Collections_ICollection_CopyTo(::System::Array*  array, int32_t  index) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2d0c534, size 0x5c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2d0c298, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Count, addr 0x2d0c2fc, size 0x24, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsSynchronized, addr 0x2d0c320, size 0x24, virtual true, abstract: false, final true
inline bool get_IsSynchronized() ;

/// @brief Method get_Item, addr 0x2d0c344, size 0x98, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainElement* get_Item(int32_t  index) ;

/// @brief Method get_SyncRoot, addr 0x2d0c3dc, size 0x24, virtual true, abstract: false, final true
