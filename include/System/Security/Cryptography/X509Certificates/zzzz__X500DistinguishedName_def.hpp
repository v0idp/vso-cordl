...
/// @brief Method AreEqual, addr 0x2d044f4, size 0x1e4, virtual false, abstract: false, final false
...
/// @brief Method Canonize, addr 0x2d04318, size 0x1dc, virtual false, abstract: false, final false
static inline ::StringW Canonize(::StringW  s) ;

/// @brief Method Decode, addr 0x2d040f4, size 0x150, virtual false, abstract: false, final false
inline ::StringW Decode(::System::Security::Cryptography::X509Certificates::X500DistinguishedNameFlags  flag) ;

/// @brief Method DecodeRawData, addr 0x2d04008, size 0xe4, virtual false, abstract: false, final false
inline void DecodeRawData() ;

/// @brief Method Format, addr 0x2d042bc, size 0x5c, virtual true, abstract: false, final false
inline ::StringW Format(bool  multiLine) ;

/// @brief Method GetSeparator, addr 0x2d04244, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d03f04, size 0x104, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  encodedDistinguishedName) ;

/// @brief Method get_Name, addr 0x2d040ec, size 0x8, virtual false, abstract: false, final false
