...
/// @brief Method Clone, addr 0x2d096a4, size 0x64, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* Clone() ;

/// @brief Method GetDSAPrivateKey, addr 0x2d09d8c, size 0x8c, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::DSA* GetDSAPrivateKey() ;

/// @brief Method GetRSAPrivateKey, addr 0x2d09d00, size 0x8c, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::RSA* GetRSAPrivateKey() ;

/// @brief Method GetRawCertData, addr 0x2d09724, size 0x38, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetRawCertData() ;

/// @brief Method ImportPkcs12, addr 0x2d0964c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method ImportPkcs12, addr 0x2d09e18, size 0x7a8, virtual false, abstract: false, final false
...
/// @brief Method Verify, addr 0x2d0a710, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d09430, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::X509::X509Certificate*  cert) ;

/// @brief Method .ctor, addr 0x2d09460, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplMono*  other) ;

/// @brief Method .ctor, addr 0x2d094fc, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_Cert, addr 0x2d09708, size 0x1c, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_Cert() ;

/// @brief Method get_HasPrivateKey, addr 0x2d0975c, size 0x24, virtual true, abstract: false, final false
inline bool get_HasPrivateKey() ;

/// @brief Method get_IntermediateCertificates, addr 0x2d0a838, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection* get_IntermediateCertificates() ;

/// @brief Method get_IsValid, addr 0x2d09420, size 0x10, virtual true, abstract: false, final false
inline bool get_IsValid() ;

/// @brief Method get_MonoCertificate, addr 0x2d0a840, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_MonoCertificate() ;

/// @brief Method get_PrivateKey, addr 0x2d09780, size 0x3f8, virtual true, abstract: false, final false
...
/// @brief Method set_PrivateKey, addr 0x2d09b78, size 0x188, virtual true, abstract: false, final false
