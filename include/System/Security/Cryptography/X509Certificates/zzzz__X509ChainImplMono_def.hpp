...
/// @brief Method AddStatus, addr 0x2d0cc60, size 0x4, virtual true, abstract: false, final false
inline void AddStatus(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags  error) ;

/// @brief Method Build, addr 0x2d0cc64, size 0x5bc, virtual true, abstract: false, final false
inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method BuildChainFrom, addr 0x2d0d220, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method CheckCrls, addr 0x2d0fd64, size 0x380, virtual false, abstract: false, final false
static inline ::Mono::Security::X509::X509Crl* CheckCrls(::StringW  subject, ::StringW  ski, ::Mono::Security::X509::X509Store*  store) ;

/// @brief Method CheckRevocation, addr 0x2d0f308, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method CheckRevocation, addr 0x2d0f3d4, size 0x1d4, virtual false, abstract: false, final false
...
/// @brief Method CheckRevocationOnChain, addr 0x2d0ecbc, size 0x1e8, virtual false, abstract: false, final false
inline void CheckRevocationOnChain(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags  flag) ;

/// @brief Method FindCrl, addr 0x2d0f5a8, size 0x174, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Crl* FindCrl(::System::Security::Cryptography::X509Certificates::X509Certificate2*  caCertificate) ;

/// @brief Method FindParent, addr 0x2d0e330, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method GetAuthorityKeyIdentifier, addr 0x2d0e698, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method GetAuthorityKeyIdentifier, addr 0x2d0f27c, size 0x8c, virtual false, abstract: false, final false
static inline ::StringW GetAuthorityKeyIdentifier(::Mono::Security::X509::X509Crl*  crl) ;

/// @brief Method GetAuthorityKeyIdentifier, addr 0x2d0f118, size 0x164, virtual false, abstract: false, final false
static inline ::StringW GetAuthorityKeyIdentifier(::Mono::Security::X509::X509Extension*  ext) ;

/// @brief Method GetSubjectKeyIdentifier, addr 0x2d0e72c, size 0xb4, virtual false, abstract: false, final false
inline ::StringW GetSubjectKeyIdentifier(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method IsChainComplete, addr 0x2d0e444, size 0xc8, virtual false, abstract: false, final false
inline bool IsChainComplete(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method IsSelfIssued, addr 0x2d0e7e0, size 0x48, virtual false, abstract: false, final false
inline bool IsSelfIssued(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method IsSignedWith, addr 0x2d0eff8, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method PrepareForNextCertificate, addr 0x2d0ead0, size 0x1ec, virtual false, abstract: false, final false
inline void PrepareForNextCertificate(int32_t  n) ;

/// @brief Method Process, addr 0x2d0e828, size 0x2a8, virtual false, abstract: false, final false
inline void Process(int32_t  n) ;

/// @brief Method ProcessCertificateExtensions, addr 0x2d0f030, size 0xe8, virtual false, abstract: false, final false
inline void ProcessCertificateExtensions(::System::Security::Cryptography::X509Certificates::X509ChainElement*  element) ;

/// @brief Method ProcessCrlEntryExtensions, addr 0x2d0f71c, size 0x308, virtual false, abstract: false, final false
inline bool ProcessCrlEntryExtensions(::Mono::Security::X509::X509Crl_X509CrlEntry*  entry) ;

/// @brief Method ProcessCrlExtensions, addr 0x2d0fa24, size 0x340, virtual false, abstract: false, final false
inline bool ProcessCrlExtensions(::Mono::Security::X509::X509Crl*  crl) ;

/// @brief Method Reset, addr 0x2d0d43c, size 0xfc, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method SelectBestFromCollection, addr 0x2d0e50c, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method ValidateChain, addr 0x2d0d308, size 0x114, virtual false, abstract: false, final false
inline void ValidateChain(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags  flag) ;

/// @brief Method WrapUp, addr 0x2d0eea4, size 0x8c, virtual false, abstract: false, final false
inline void WrapUp() ;
...
/// @brief Method .ctor, addr 0x2d0cb7c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_CertificateAuthorities, addr 0x2d0d868, size 0xbc, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_CertificateAuthorities() ;

/// @brief Method get_CertificateCollection, addr 0x2d0e008, size 0xc8, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_CertificateCollection() ;

/// @brief Method get_ChainElements, addr 0x2d0cc50, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements() ;

/// @brief Method get_ChainPolicy, addr 0x2d0cc58, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy() ;

/// @brief Method get_IsValid, addr 0x2d0cc48, size 0x8, virtual true, abstract: false, final false
inline bool get_IsValid() ;

/// @brief Method get_LMCAStore, addr 0x2d0d924, size 0xec, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Store* get_LMCAStore() ;

/// @brief Method get_LMRootStore, addr 0x2d0d610, size 0xec, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Store* get_LMRootStore() ;

/// @brief Method get_Roots, addr 0x2d0d554, size 0xbc, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Collection* get_Roots() ;

/// @brief Method get_UserCAStore, addr 0x2d0da10, size 0xec, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Store* get_UserCAStore() ;

/// @brief Method get_UserRootStore, addr 0x2d0d6fc, size 0xec, virtual false, abstract: false, final false
