...
/// @brief Method Dispose, addr 0x2d0bc94, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x2d0cad0, size 0x4, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x2d0cad4, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method ThrowIfContextInvalid, addr 0x2d0ca14, size 0x3c, virtual false, abstract: false, final false
inline void ThrowIfContextInvalid() ;

/// @brief Method .ctor, addr 0x2d0cb74, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
