...
/// @brief Method CopyFrom, addr 0x2d127ec, size 0x1cc, virtual true, abstract: false, final false
inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData*  asnEncodedData) ;

/// @brief Method Decode, addr 0x2d11de0, size 0x164, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  extension) ;

/// @brief Method Encode, addr 0x2d120ec, size 0x74, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encode() ;

/// @brief Method FromHex, addr 0x2d122b8, size 0xf4, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> FromHex(::StringW  hex) ;

/// @brief Method FromHexChar, addr 0x2d129b8, size 0x44, virtual false, abstract: false, final false
static inline uint8_t FromHexChar(char16_t  c) ;

/// @brief Method FromHexChars, addr 0x2d129fc, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2d12a98, size 0x240, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d11c74, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2d11d10, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::AsnEncodedData*  encodedSubjectKeyIdentifier, bool  critical) ;

/// @brief Method .ctor, addr 0x2d123b8, size 0x3b0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d123ac, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::X509Certificates::PublicKey*  key, bool  critical) ;

/// @brief Method .ctor, addr 0x2d11f44, size 0x1a8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  subjectKeyIdentifier, bool  critical) ;

/// @brief Method .ctor, addr 0x2d12160, size 0x158, virtual false, abstract: false, final false
inline void _ctor(::StringW  subjectKeyIdentifier, bool  critical) ;

/// @brief Method get_SubjectKeyIdentifier, addr 0x2d12768, size 0x84, virtual false, abstract: false, final false
