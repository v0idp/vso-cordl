...
/// @brief Method Create, addr 0x2611a8c, size 0x50, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::DES* Create() ;

/// @brief Method IsLegalKeySize, addr 0x2611b9c, size 0x20, virtual false, abstract: false, final false
static inline bool IsLegalKeySize(::ArrayW<uint8_t,::Array<uint8_t>*>  rgbKey) ;

/// @brief Method IsSemiWeakKey, addr 0x2611684, size 0x20c, virtual false, abstract: false, final false
static inline bool IsSemiWeakKey(::ArrayW<uint8_t,::Array<uint8_t>*>  rgbKey) ;

/// @brief Method IsWeakKey, addr 0x2611564, size 0x120, virtual false, abstract: false, final false
static inline bool IsWeakKey(::ArrayW<uint8_t,::Array<uint8_t>*>  rgbKey) ;

static inline ::System::Security::Cryptography::DES* New_ctor() ;

/// @brief Method QuadWordFromBigEndian, addr 0x2611bbc, size 0x98, virtual false, abstract: false, final false
static inline uint64_t QuadWordFromBigEndian(::ArrayW<uint8_t,::Array<uint8_t>*>  block) ;

/// @brief Method .ctor, addr 0x2611400, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Key, addr 0x261147c, size 0xe8, virtual true, abstract: false, final false
...
/// @brief Method set_Key, addr 0x2611890, size 0x1fc, virtual true, abstract: false, final false
