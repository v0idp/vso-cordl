...
public:
// Declarations
/// @brief Method Create, addr 0x261ba50, size 0x54, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::SHA1* Create() ;

static inline ::System::Security::Cryptography::SHA1* New_ctor() ;

/// @brief Method .ctor, addr 0x261ba30, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
