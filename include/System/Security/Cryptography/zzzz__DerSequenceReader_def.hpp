...
/// @brief Method <ReadT61String>b__45_0, addr 0x2d013e0, size 0x5c, virtual false, abstract: false, final false
inline ::System::Text::Encoding* _ReadT61String_b__45_0() ;

/// @brief Method <ReadT61String>b__45_1, addr 0x2d0143c, size 0x44, virtual false, abstract: false, final false
inline ::System::Text::Encoding* _ReadT61String_b__45_1() ;

/// @brief Method <ReadTime>b__51_0, addr 0x2d01480, size 0xcc, virtual false, abstract: false, final false
inline ::System::Globalization::DateTimeFormatInfo* _ReadTime_b__51_0() ;

/// @brief Method .ctor, addr 0x2d013d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CheckTag, addr 0x2d00b28, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method EatLength, addr 0x2cfffe8, size 0x3c, virtual false, abstract: false, final false
inline int32_t EatLength() ;

/// @brief Method EatTag, addr 0x2cfff68, size 0x80, virtual false, abstract: false, final false
...
static inline ::System::Security::Cryptography::DerSequenceReader* New_ctor(::System::Security::Cryptography::DerSequenceReader_DerTag  tagToEat, ::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset, int32_t  length) ;

/// @brief Method PeekTag, addr 0x2d00034, size 0x94, virtual false, abstract: false, final false
inline uint8_t PeekTag() ;

/// @brief Method ReadBMPString, addr 0x2d012fc, size 0x80, virtual false, abstract: false, final false
inline ::StringW ReadBMPString() ;

/// @brief Method ReadBitString, addr 0x2d00540, size 0x144, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadBitString() ;

/// @brief Method ReadBoolean, addr 0x2d002f4, size 0xc8, virtual false, abstract: false, final false
inline bool ReadBoolean() ;

/// @brief Method ReadCollectionWithTag, addr 0x2d00a64, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method ReadContentAsBytes, addr 0x2d0048c, size 0xb4, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadContentAsBytes() ;

/// @brief Method ReadGeneralizedTime, addr 0x2d01070, size 0x4c, virtual false, abstract: false, final false
inline ::System::DateTime ReadGeneralizedTime() ;

/// @brief Method ReadIA5String, addr 0x2d00c4c, size 0x80, virtual false, abstract: false, final false
inline ::StringW ReadIA5String() ;

/// @brief Method ReadInteger, addr 0x2d003bc, size 0xb4, virtual false, abstract: false, final false
inline int32_t ReadInteger() ;

/// @brief Method ReadIntegerBytes, addr 0x2d00470, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadIntegerBytes() ;

/// @brief Method ReadNextEncodedValue, addr 0x2d00118, size 0xb8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadNextEncodedValue() ;

/// @brief Method ReadOctetString, addr 0x2d00684, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadOctetString() ;

/// @brief Method ReadOidAsString, addr 0x2d006a0, size 0x2c8, virtual false, abstract: false, final false
inline ::StringW ReadOidAsString() ;

/// @brief Method ReadPrintableString, addr 0x2d00bcc, size 0x80, virtual false, abstract: false, final false
inline ::StringW ReadPrintableString() ;

/// @brief Method ReadSequence, addr 0x2d00bbc, size 0x8, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::DerSequenceReader* ReadSequence() ;

/// @brief Method ReadSet, addr 0x2d00bc4, size 0x8, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::DerSequenceReader* ReadSet() ;

/// @brief Method ReadT61String, addr 0x2d00ccc, size 0x2d8, virtual false, abstract: false, final false
inline ::StringW ReadT61String() ;

/// @brief Method ReadTime, addr 0x2d010bc, size 0x240, virtual false, abstract: false, final false
inline ::System::DateTime ReadTime(::System::Security::Cryptography::DerSequenceReader_DerTag  timeTag, ::StringW  formatString) ;

/// @brief Method ReadUtcTime, addr 0x2d01024, size 0x4c, virtual false, abstract: false, final false
inline ::System::DateTime ReadUtcTime() ;

/// @brief Method ReadUtf8String, addr 0x2d00968, size 0x80, virtual false, abstract: false, final false
inline ::StringW ReadUtf8String() ;

/// @brief Method ReadX509Date, addr 0x2d00fa4, size 0x80, virtual false, abstract: false, final false
inline ::System::DateTime ReadX509Date() ;

/// @brief Method ScanContentLength, addr 0x2d001d0, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method SkipValue, addr 0x2d000c8, size 0x50, virtual false, abstract: false, final false
inline void SkipValue() ;

/// @brief Method TrimTrailingNulls, addr 0x2d009e8, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cffe40, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method .ctor, addr 0x2cffe64, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset, int32_t  length) ;

/// @brief Method .ctor, addr 0x2cffe78, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method get_HasData, addr 0x2d00024, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_ContentLength, addr 0x2cffe38, size 0x8, virtual false, abstract: false, final false
