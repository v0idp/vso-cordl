...
/// @brief Method CloseToken, addr 0x262b55c, size 0x4, virtual false, abstract: false, final false
static inline bool CloseToken(::System::IntPtr  token) ;

/// @brief Method Dispose, addr 0x262b488, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method DuplicateToken, addr 0x262b480, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method RevertToSelf, addr 0x262b558, size 0x4, virtual false, abstract: false, final false
static inline bool RevertToSelf() ;

/// @brief Method SetCurrentToken, addr 0x262b484, size 0x4, virtual false, abstract: false, final false
static inline bool SetCurrentToken(::System::IntPtr  token) ;

/// @brief Method Undo, addr 0x262b498, size 0xc0, virtual false, abstract: false, final false
inline void Undo() ;
...
/// @brief Method .ctor, addr 0x262af04, size 0x88, virtual false, abstract: false, final false
