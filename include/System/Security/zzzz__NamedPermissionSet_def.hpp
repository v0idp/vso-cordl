...
/// @brief Method Equals, addr 0x26071fc, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x2607428, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method ToXml, addr 0x2606d0c, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2606adc, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2606cfc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method .ctor, addr 0x2606b94, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::System::Security::Permissions::PermissionState  state) ;

/// @brief Method get_Name, addr 0x2606d04, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method set_Name, addr 0x2606c44, size 0xb8, virtual false, abstract: false, final false
