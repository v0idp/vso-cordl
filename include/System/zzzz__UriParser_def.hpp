...
/// @brief Method FindOrFetchAsUnknownV1Syntax, addr 0x2cdd2d0, size 0x2d0, virtual false, abstract: false, final false
static inline ::System::UriParser* FindOrFetchAsUnknownV1Syntax(::StringW  lwrCaseScheme) ;

/// @brief Method GetComponents, addr 0x2cdc7cc, size 0x218, virtual true, abstract: false, final false
inline ::StringW GetComponents(::System::Uri*  uri, ::System::UriComponents  components, ::System::UriFormat  format) ;

/// @brief Method GetSyntax, addr 0x2cd90c8, size 0xd0, virtual false, abstract: false, final false
static inline ::System::UriParser* GetSyntax(::StringW  lwrCaseScheme) ;

/// @brief Method InFact, addr 0x2cd9198, size 0x1c, virtual false, abstract: false, final false
inline bool InFact(::System::UriSyntaxFlags  flags) ;

/// @brief Method InitializeAndValidate, addr 0x2cdc5ac, size 0x28, virtual true, abstract: false, final false
inline void InitializeAndValidate(::System::Uri*  uri, ::ByRef<::System::UriFormatException*>  parsingError) ;

/// @brief Method InternalGetComponents, addr 0x2cdd614, size 0xc, virtual false, abstract: false, final false
inline ::StringW InternalGetComponents(::System::Uri*  thisUri, ::System::UriComponents  uriComponents, ::System::UriFormat  uriFormat) ;

/// @brief Method InternalIsBaseOf, addr 0x2cdd608, size 0xc, virtual false, abstract: false, final false
inline bool InternalIsBaseOf(::System::Uri*  thisBaseUri, ::System::Uri*  uriLink) ;

/// @brief Method InternalIsWellFormedOriginalString, addr 0x2cdd620, size 0xc, virtual false, abstract: false, final false
inline bool InternalIsWellFormedOriginalString(::System::Uri*  thisUri) ;

/// @brief Method InternalOnNewUri, addr 0x2cdd5ac, size 0x44, virtual false, abstract: false, final false
inline ::System::UriParser* InternalOnNewUri() ;

/// @brief Method InternalResolve, addr 0x2cdd5fc, size 0xc, virtual false, abstract: false, final false
inline ::StringW InternalResolve(::System::Uri*  thisBaseUri, ::System::Uri*  uriLink, ::ByRef<::System::UriFormatException*>  parsingError) ;

/// @brief Method InternalValidate, addr 0x2cdd5f0, size 0xc, virtual false, abstract: false, final false
inline void InternalValidate(::System::Uri*  thisUri, ::ByRef<::System::UriFormatException*>  parsingError) ;

/// @brief Method IsAllSet, addr 0x2cdd25c, size 0x8, virtual false, abstract: false, final false
inline bool IsAllSet(::System::UriSyntaxFlags  flags) ;

/// @brief Method IsBaseOf, addr 0x2cdc7b0, size 0x1c, virtual true, abstract: false, final false
inline bool IsBaseOf(::System::Uri*  baseUri, ::System::Uri*  relativeUri) ;

/// @brief Method IsFullMatch, addr 0x2cdd200, size 0x5c, virtual false, abstract: false, final false
inline bool IsFullMatch(::System::UriSyntaxFlags  flags, ::System::UriSyntaxFlags  expected) ;

/// @brief Method IsWellFormedOriginalString, addr 0x2cdc9e4, size 0x18, virtual true, abstract: false, final false
inline bool IsWellFormedOriginalString(::System::Uri*  uri) ;

static inline ::System::UriParser* New_ctor(::System::UriSyntaxFlags  flags) ;

/// @brief Method NotAny, addr 0x2cd91b4, size 0x8, virtual false, abstract: false, final false
inline bool NotAny(::System::UriSyntaxFlags  flags) ;

/// @brief Method OnNewUri, addr 0x2cdc5a8, size 0x4, virtual true, abstract: false, final false
inline ::System::UriParser* OnNewUri() ;

/// @brief Method Resolve, addr 0x2cdc5d4, size 0x1dc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cdd264, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method get_DefaultPort, addr 0x2cdc5a0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_DefaultPort() ;

/// @brief Method get_Flags, addr 0x2cdd1f8, size 0x8, virtual false, abstract: false, final false
inline ::System::UriSyntaxFlags get_Flags() ;

/// @brief Method get_IsSimple, addr 0x2cdd5a0, size 0xc, virtual false, abstract: false, final false
inline bool get_IsSimple() ;

/// @brief Method get_SchemeName, addr 0x2cdc598, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SchemeName() ;

/// @brief Method get_ShouldUseLegacyV2Quirks, addr 0x2cdc408, size 0x60, virtual false, abstract: false, final false
