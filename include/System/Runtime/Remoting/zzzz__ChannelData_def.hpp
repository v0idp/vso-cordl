...
/// @brief Method CopyFrom, addr 0x2633a90, size 0x938, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2639120, size 0xac, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ClientProviders, addr 0x2634b2c, size 0x64, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_ClientProviders() ;

/// @brief Method get_CustomProperties, addr 0x26391cc, size 0x64, virtual false, abstract: false, final false
inline ::System::Collections::Hashtable* get_CustomProperties() ;

/// @brief Method get_ServerProviders, addr 0x26343c8, size 0x64, virtual false, abstract: false, final false
