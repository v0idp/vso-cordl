...
/// @brief Method TrackLifetime, addr 0x263f2c8, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method get_LeaseManagerPollTime, addr 0x2646200, size 0x58, virtual false, abstract: false, final false
static inline ::System::TimeSpan get_LeaseManagerPollTime() ;

/// @brief Method get_LeaseTime, addr 0x2646258, size 0x58, virtual false, abstract: false, final false
static inline ::System::TimeSpan get_LeaseTime() ;

/// @brief Method get_RenewOnCallTime, addr 0x264630c, size 0x58, virtual false, abstract: false, final false
static inline ::System::TimeSpan get_RenewOnCallTime() ;

/// @brief Method get_SponsorshipTimeout, addr 0x26463c0, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method set_LeaseManagerPollTime, addr 0x26390ac, size 0x74, virtual false, abstract: false, final false
static inline void set_LeaseManagerPollTime(::System::TimeSpan  value) ;

/// @brief Method set_LeaseTime, addr 0x26462b0, size 0x5c, virtual false, abstract: false, final false
static inline void set_LeaseTime(::System::TimeSpan  value) ;

/// @brief Method set_RenewOnCallTime, addr 0x2646364, size 0x5c, virtual false, abstract: false, final false
static inline void set_RenewOnCallTime(::System::TimeSpan  value) ;

/// @brief Method set_SponsorshipTimeout, addr 0x2646418, size 0x5c, virtual false, abstract: false, final false
