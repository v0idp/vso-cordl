...
/// @brief Method ManageLeases, addr 0x2645a20, size 0x260, virtual false, abstract: false, final false
inline void ManageLeases(::System::Object*  state) ;

static inline ::System::Runtime::Remoting::Lifetime::LeaseManager* New_ctor() ;

/// @brief Method SetPollTime, addr 0x264568c, size 0xf4, virtual false, abstract: false, final false
inline void SetPollTime(::System::TimeSpan  timeSpan) ;

/// @brief Method StartManager, addr 0x26458b0, size 0x154, virtual false, abstract: false, final false
inline void StartManager() ;

/// @brief Method StopManager, addr 0x2645a04, size 0x1c, virtual false, abstract: false, final false
inline void StopManager() ;

/// @brief Method TrackLifetime, addr 0x2645780, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2645c80, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
