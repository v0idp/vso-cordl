...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x264544c, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x2645650, size 0x28, virtual true, abstract: false, final false
inline ::System::TimeSpan EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x2645678, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x264534c, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Activate, addr 0x2644d98, size 0xc, virtual false, abstract: false, final false
inline void Activate() ;

/// @brief Method CheckNextSponsor, addr 0x264510c, size 0x240, virtual false, abstract: false, final false
inline void CheckNextSponsor() ;

static inline ::System::Runtime::Remoting::Lifetime::Lease* New_ctor() ;

/// @brief Method ProcessSponsorResponse, addr 0x264546c, size 0x1e4, virtual false, abstract: false, final false
inline void ProcessSponsorResponse(::System::Object*  state, bool  timedOut) ;

/// @brief Method Renew, addr 0x2644dac, size 0x8c, virtual true, abstract: false, final true
inline ::System::TimeSpan Renew(::System::TimeSpan  renewalTime) ;

/// @brief Method Unregister, addr 0x2644e38, size 0x144, virtual true, abstract: false, final true
inline void Unregister(::System::Runtime::Remoting::Lifetime::ISponsor*  obj) ;

/// @brief Method UpdateState, addr 0x2644f7c, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x263f170, size 0x158, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CurrentLeaseTime, addr 0x2644d28, size 0x68, virtual true, abstract: false, final true
inline ::System::TimeSpan get_CurrentLeaseTime() ;

/// @brief Method get_CurrentState, addr 0x2644d90, size 0x8, virtual true, abstract: false, final true
inline ::System::Runtime::Remoting::Lifetime::LeaseState get_CurrentState() ;

/// @brief Method get_RenewOnCallTime, addr 0x2644da4, size 0x8, virtual true, abstract: false, final true
