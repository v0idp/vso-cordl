...
/// @brief Method ToString, addr 0x2641294, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2639484, size 0x128, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName, ::StringW  assemblyName, ::StringW  objectUrl) ;

/// @brief Method get_ApplicationUrl, addr 0x264127c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ApplicationUrl() ;

/// @brief Method get_ObjectType, addr 0x2641284, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_ObjectType() ;

/// @brief Method get_ObjectUrl, addr 0x264128c, size 0x8, virtual false, abstract: false, final false
