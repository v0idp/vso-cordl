...
/// @brief Method .ctor, addr 0x2640ee8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CodeXmlNamespaceForClrTypeNamespace, addr 0x2640814, size 0x198, virtual false, abstract: false, final false
static inline ::StringW CodeXmlNamespaceForClrTypeNamespace(::StringW  typeNamespace, ::StringW  assemblyName) ;

/// @brief Method EncodeNs, addr 0x26409ac, size 0xe4, virtual false, abstract: false, final false
static inline ::StringW EncodeNs(::StringW  ns) ;

/// @brief Method GetAssemblyName, addr 0x2640af8, size 0x134, virtual false, abstract: false, final false
static inline ::StringW GetAssemblyName(::System::Reflection::MethodBase*  mb) ;

/// @brief Method GetNameKey, addr 0x2640a90, size 0x68, virtual false, abstract: false, final false
static inline ::StringW GetNameKey(::StringW  name, ::StringW  namspace) ;

/// @brief Method GetXmlElementForInteropType, addr 0x2640c2c, size 0xd0, virtual false, abstract: false, final false
static inline bool GetXmlElementForInteropType(::System::Type*  type, ::ByRef<::StringW>  xmlElement, ::ByRef<::StringW>  xmlNamespace) ;

/// @brief Method GetXmlNamespaceForMethodCall, addr 0x2640cfc, size 0x94, virtual false, abstract: false, final false
static inline ::StringW GetXmlNamespaceForMethodCall(::System::Reflection::MethodBase*  mb) ;

/// @brief Method GetXmlNamespaceForMethodResponse, addr 0x2640d90, size 0x94, virtual false, abstract: false, final false
static inline ::StringW GetXmlNamespaceForMethodResponse(::System::Reflection::MethodBase*  mb) ;

/// @brief Method GetXmlTypeForInteropType, addr 0x2640e24, size 0xc4, virtual false, abstract: false, final false
static inline bool GetXmlTypeForInteropType(::System::Type*  type, ::ByRef<::StringW>  xmlType, ::ByRef<::StringW>  xmlTypeNamespace) ;

/// @brief Method PreLoad, addr 0x2639ebc, size 0xbc, virtual false, abstract: false, final false
static inline void PreLoad(::System::Reflection::Assembly*  assembly) ;

/// @brief Method PreLoad, addr 0x26399f8, size 0x4c4, virtual false, abstract: false, final false
static inline void PreLoad(::System::Type*  type) ;

/// @brief Method RegisterInteropXmlElement, addr 0x26396e0, size 0x18c, virtual false, abstract: false, final false
static inline void RegisterInteropXmlElement(::StringW  xmlElement, ::StringW  xmlNamespace, ::System::Type*  type) ;

/// @brief Method RegisterInteropXmlType, addr 0x263986c, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method get_XmlNsForClrTypeWithAssembly, addr 0x2640754, size 0x40, virtual false, abstract: false, final false
static inline ::StringW get_XmlNsForClrTypeWithAssembly() ;

/// @brief Method get_XmlNsForClrTypeWithNs, addr 0x2640794, size 0x40, virtual false, abstract: false, final false
static inline ::StringW get_XmlNsForClrTypeWithNs() ;

/// @brief Method get_XmlNsForClrTypeWithNsAndAssembly, addr 0x26407d4, size 0x40, virtual false, abstract: false, final false
