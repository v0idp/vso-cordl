...
/// @brief Method Activate, addr 0x264c4d0, size 0x32c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x264b9b4, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Remoting::Activation::IActivator*  next) ;

/// @brief Method get_NextActivator, addr 0x264c4c8, size 0x8, virtual true, abstract: false, final true
