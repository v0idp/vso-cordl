...
/// @brief Method Activate, addr 0x264c3d8, size 0xf0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x264b7b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_NextActivator, addr 0x264c3d0, size 0x8, virtual true, abstract: false, final true
