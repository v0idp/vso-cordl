...
/// @brief Method Activate, addr 0x264bf0c, size 0x4c4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x264b988, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  activationUrl, ::System::Runtime::Remoting::Activation::IActivator*  next) ;

/// @brief Method get_NextActivator, addr 0x264bf04, size 0x8, virtual true, abstract: false, final true
