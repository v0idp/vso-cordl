...
/// @brief Method GetPropertiesForNewContext, addr 0x264c82c, size 0x3e8, virtual true, abstract: false, final true
inline void GetPropertiesForNewContext(::System::Runtime::Remoting::Activation::IConstructionCallMessage*  ctor) ;

/// @brief Method IsContextOK, addr 0x264c824, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x264c7fc, size 0x28, virtual false, abstract: false, final false
