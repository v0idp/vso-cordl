...
/// @brief Method AllocateDataSlot, addr 0x26482d0, size 0x64, virtual false, abstract: false, final false
static inline ::System::LocalDataStoreSlot* AllocateDataSlot() ;

/// @brief Method AllocateNamedDataSlot, addr 0x2648334, size 0x6c, virtual false, abstract: false, final false
static inline ::System::LocalDataStoreSlot* AllocateNamedDataSlot(::StringW  name) ;

/// @brief Method CreateEnvoySink, addr 0x263f558, size 0x204, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::Messaging::IMessageSink* CreateEnvoySink(::System::MarshalByRefObject*  serverObject) ;

/// @brief Method CreateNewContext, addr 0x26477a8, size 0x840, virtual false, abstract: false, final false
...
/// @brief Method CreateServerObjectSinkChain, addr 0x263fbbc, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method DoCallBack, addr 0x2647fe8, size 0x168, virtual false, abstract: false, final false
inline void DoCallBack(::System::Runtime::Remoting::Contexts::CrossContextDelegate*  deleg) ;

/// @brief Method Finalize, addr 0x2646500, size 0xd0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method FreeNamedDataSlot, addr 0x26483a0, size 0x6c, virtual false, abstract: false, final false
static inline void FreeNamedDataSlot(::StringW  name) ;

/// @brief Method Freeze, addr 0x26473d8, size 0x1ac, virtual true, abstract: false, final false
inline void Freeze() ;

/// @brief Method GetClientContextSinkChain, addr 0x2644178, size 0x204, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::Messaging::IMessageSink* GetClientContextSinkChain() ;

/// @brief Method GetData, addr 0x2648478, size 0x30, virtual false, abstract: false, final false
static inline ::System::Object* GetData(::System::LocalDataStoreSlot*  slot) ;

/// @brief Method GetDynamicPropertyCollection, addr 0x26467b4, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method GetNamedDataSlot, addr 0x264840c, size 0x6c, virtual false, abstract: false, final false
static inline ::System::LocalDataStoreSlot* GetNamedDataSlot(::StringW  name) ;

/// @brief Method GetProperty, addr 0x2647040, size 0x1f8, virtual true, abstract: false, final false
inline ::System::Runtime::Remoting::Contexts::IContextProperty* GetProperty(::StringW  name) ;

/// @brief Method GetServerContextSinkChain, addr 0x26475e0, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method NotifyDynamicSinks, addr 0x2646f7c, size 0x84, virtual false, abstract: false, final false
inline void NotifyDynamicSinks(bool  start, ::System::Runtime::Remoting::Messaging::IMessage*  req_msg, bool  client_site, bool  async) ;

/// @brief Method NotifyGlobalDynamicSinks, addr 0x2646dd8, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method RegisterContext, addr 0x2646474, size 0x4, virtual false, abstract: false, final false
static inline void RegisterContext(::System::Runtime::Remoting::Contexts::Context*  ctx) ;

/// @brief Method RegisterDynamicProperty, addr 0x264673c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method ReleaseContext, addr 0x2646478, size 0x4, virtual false, abstract: false, final false
static inline void ReleaseContext(::System::Runtime::Remoting::Contexts::Context*  ctx) ;

/// @brief Method SetData, addr 0x26484a8, size 0x40, virtual false, abstract: false, final false
static inline void SetData(::System::LocalDataStoreSlot*  slot, ::System::Object*  data) ;

/// @brief Method SetProperty, addr 0x2647238, size 0x1a0, virtual true, abstract: false, final false
inline void SetProperty(::System::Runtime::Remoting::Contexts::IContextProperty*  prop) ;

/// @brief Method SwitchToContext, addr 0x26477a0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2647584, size 0x5c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UnregisterDynamicProperty, addr 0x2646bf4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x264647c, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ContextID, addr 0x26465d0, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ContextID() ;

/// @brief Method get_ContextProperties, addr 0x26465d8, size 0x74, virtual true, abstract: false, final false
...
/// @brief Method get_DefaultContext, addr 0x263e39c, size 0x8, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::Contexts::Context* get_DefaultContext() ;

/// @brief Method get_HasDynamicSinks, addr 0x2647000, size 0x40, virtual false, abstract: false, final false
inline bool get_HasDynamicSinks() ;

/// @brief Method get_HasExitSinks, addr 0x26440c0, size 0xb8, virtual false, abstract: false, final false
inline bool get_HasExitSinks() ;

/// @brief Method get_HasGlobalDynamicSinks, addr 0x2646ed8, size 0xa4, virtual false, abstract: false, final false
static inline bool get_HasGlobalDynamicSinks() ;

/// @brief Method get_IsDefaultContext, addr 0x264664c, size 0x10, virtual false, abstract: false, final false
inline bool get_IsDefaultContext() ;

/// @brief Method get_MyLocalStore, addr 0x264815c, size 0x174, virtual false, abstract: false, final false
inline ::System::LocalDataStore* get_MyLocalStore() ;

/// @brief Method get_NeedsContextSink, addr 0x264665c, size 0xe0, virtual false, abstract: false, final false
