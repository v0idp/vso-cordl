...
/// @brief Method .ctor, addr 0x26486bc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method FindProperty, addr 0x2648558, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method NotifyMessage, addr 0x262f8ac, size 0x658, virtual false, abstract: false, final false
inline void NotifyMessage(bool  start, ::System::Runtime::Remoting::Messaging::IMessage*  msg, bool  client_site, bool  async) ;

/// @brief Method RegisterDynamicProperty, addr 0x2646910, size 0x2e4, virtual false, abstract: false, final false
inline bool RegisterDynamicProperty(::System::Runtime::Remoting::Contexts::IDynamicProperty*  prop) ;

/// @brief Method UnregisterDynamicProperty, addr 0x2646c6c, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x262f758, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasProperties, addr 0x262f7f8, size 0x30, virtual false, abstract: false, final false
