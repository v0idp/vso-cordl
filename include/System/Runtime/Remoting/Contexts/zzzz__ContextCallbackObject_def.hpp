...
public:
// Declarations
/// @brief Method DoCallBack, addr 0x2648158, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2648150, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
