...
/// @brief Method get_AssemblyName, addr 0x2640fe0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_AssemblyName() ;

/// @brief Method get_TypeName, addr 0x2640ff0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_TypeName() ;

/// @brief Method set_AssemblyName, addr 0x2640fe8, size 0x8, virtual false, abstract: false, final false
inline void set_AssemblyName(::StringW  value) ;

/// @brief Method set_TypeName, addr 0x2640ff8, size 0x8, virtual false, abstract: false, final false
