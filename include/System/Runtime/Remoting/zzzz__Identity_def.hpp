...
/// @brief Method NotifyClientDynamicSinks, addr 0x262f828, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method NotifyServerDynamicSinks, addr 0x262ff04, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x262f684, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  objectUri) ;

/// @brief Method get_ChannelSink, addr 0x262f6ac, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::Messaging::IMessageSink* get_ChannelSink() ;

/// @brief Method get_ClientDynamicProperties, addr 0x262f6f8, size 0x60, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::Contexts::DynamicPropertyCollection* get_ClientDynamicProperties() ;

/// @brief Method get_Disposed, addr 0x262f6e4, size 0x8, virtual false, abstract: false, final false
inline bool get_Disposed() ;

/// @brief Method get_EnvoySink, addr 0x262f6bc, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Remoting::Messaging::IMessageSink* get_EnvoySink() ;

/// @brief Method get_HasServerDynamicSinks, addr 0x262f7b8, size 0x40, virtual false, abstract: false, final false
inline bool get_HasServerDynamicSinks() ;

/// @brief Method get_IsConnected, addr 0x262f6d4, size 0x10, virtual false, abstract: false, final false
inline bool get_IsConnected() ;

/// @brief Method get_ObjectUri, addr 0x262f6c4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ObjectUri() ;

/// @brief Method set_ChannelSink, addr 0x262f6b4, size 0x8, virtual false, abstract: false, final false
inline void set_ChannelSink(::System::Runtime::Remoting::Messaging::IMessageSink*  value) ;

/// @brief Method set_Disposed, addr 0x262f6ec, size 0xc, virtual false, abstract: false, final false
inline void set_Disposed(bool  value) ;

/// @brief Method set_ObjectUri, addr 0x262f6cc, size 0x8, virtual false, abstract: false, final false
