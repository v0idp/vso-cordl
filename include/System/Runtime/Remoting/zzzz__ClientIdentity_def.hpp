...
/// @brief Method CreateObjRef, addr 0x2630180, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x262ff88, size 0x108, virtual false, abstract: false, final false
inline void _ctor(::StringW  objectUri, ::System::Runtime::Remoting::ObjRef*  objRef) ;

/// @brief Method get_ClientProxy, addr 0x2630090, size 0x88, virtual false, abstract: false, final false
inline ::System::MarshalByRefObject* get_ClientProxy() ;

/// @brief Method get_TargetUri, addr 0x2630188, size 0x20, virtual false, abstract: false, final false
inline ::StringW get_TargetUri() ;

/// @brief Method set_ClientProxy, addr 0x2630118, size 0x68, virtual false, abstract: false, final false
