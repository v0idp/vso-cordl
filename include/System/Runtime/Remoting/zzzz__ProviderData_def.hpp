...
/// @brief Method CopyFrom, addr 0x263442c, size 0x700, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2639234, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
