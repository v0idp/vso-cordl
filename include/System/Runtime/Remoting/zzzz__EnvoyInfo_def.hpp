...
/// @brief Method .ctor, addr 0x262f654, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Remoting::Messaging::IMessageSink*  sinks) ;

/// @brief Method get_EnvoySinks, addr 0x262f67c, size 0x8, virtual true, abstract: false, final true
