...
// Dependencies System.Object, System.Runtime.Remoting.Messaging.IInternalMessage, System.Runtime.Remoting.Messaging.IMessage, System.Runtime.Remoting.Messaging.IMethodMessage, System.Runtime.Remoting.Messaging.IMethodReturnMessage
namespace System::Runtime::Remoting::Messaging {
// Is value type: false
...
/// @brief Method GetArg, addr 0x265a80c, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_TargetIdentity, addr 0x265a8e4, size 0x8, virtual true, abstract: false, final true
inline ::System::Runtime::Remoting::Identity* System_Runtime_Remoting_Messaging_IInternalMessage_get_TargetIdentity() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_Uri, addr 0x265a7fc, size 0x8, virtual true, abstract: false, final true
inline ::StringW System_Runtime_Remoting_Messaging_IInternalMessage_get_Uri() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_TargetIdentity, addr 0x265a8ec, size 0x8, virtual true, abstract: false, final true
inline void System_Runtime_Remoting_Messaging_IInternalMessage_set_TargetIdentity(::System::Runtime::Remoting::Identity*  value) ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_Uri, addr 0x265a804, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x265a3d0, size 0x148, virtual false, abstract: false, final false
inline void _ctor(::System::Exception*  e, ::System::Runtime::Remoting::Messaging::IMethodCallMessage*  mcm) ;

/// @brief Method .ctor, addr 0x265a268, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method get_ArgCount, addr 0x265a518, size 0x1c, virtual true, abstract: false, final true
inline int32_t get_ArgCount() ;

/// @brief Method get_Args, addr 0x265a534, size 0x8, virtual true, abstract: false, final true
inline ::ArrayW<::System::Object*,::Array<::System::Object*>*> get_Args() ;

/// @brief Method get_Exception, addr 0x265a83c, size 0x8, virtual true, abstract: false, final true
inline ::System::Exception* get_Exception() ;

/// @brief Method get_LogicalCallContext, addr 0x265a53c, size 0x64, virtual true, abstract: false, final true
inline ::System::Runtime::Remoting::Messaging::LogicalCallContext* get_LogicalCallContext() ;

/// @brief Method get_MethodBase, addr 0x265a5a0, size 0x8, virtual true, abstract: false, final true
inline ::System::Reflection::MethodBase* get_MethodBase() ;

/// @brief Method get_MethodName, addr 0x265a5a8, size 0x50, virtual true, abstract: false, final true
inline ::StringW get_MethodName() ;

/// @brief Method get_MethodSignature, addr 0x265a5f8, size 0x12c, virtual true, abstract: false, final true
inline ::System::Object* get_MethodSignature() ;

/// @brief Method get_OutArgs, addr 0x265a844, size 0x98, virtual true, abstract: false, final true
inline ::ArrayW<::System::Object*,::Array<::System::Object*>*> get_OutArgs() ;

/// @brief Method get_Properties, addr 0x265a724, size 0x64, virtual true, abstract: false, final false
inline ::System::Collections::IDictionary* get_Properties() ;

/// @brief Method get_ReturnValue, addr 0x265a8dc, size 0x8, virtual true, abstract: false, final false
inline ::System::Object* get_ReturnValue() ;

/// @brief Method get_TypeName, addr 0x265a788, size 0x64, virtual true, abstract: false, final true
inline ::StringW get_TypeName() ;

/// @brief Method get_Uri, addr 0x265a7ec, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_Uri, addr 0x265a7f4, size 0x8, virtual false, abstract: false, final false
