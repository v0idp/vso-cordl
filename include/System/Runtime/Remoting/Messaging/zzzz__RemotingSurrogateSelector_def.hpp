...
/// @brief Method GetSurrogate, addr 0x2659fcc, size 0x19c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2659fc4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
