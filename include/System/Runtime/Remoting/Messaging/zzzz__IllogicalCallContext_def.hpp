...
/// @brief Method CreateCopy, addr 0x264d6e0, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x264d934, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Datastore, addr 0x264d640, size 0x64, virtual false, abstract: false, final false
inline ::System::Collections::Hashtable* get_Datastore() ;

/// @brief Method get_HasUserData, addr 0x264d6b4, size 0x2c, virtual false, abstract: false, final false
inline bool get_HasUserData() ;

/// @brief Method get_HostContext, addr 0x264d6a4, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_HostContext() ;

/// @brief Method set_HostContext, addr 0x264d6ac, size 0x8, virtual false, abstract: false, final false
