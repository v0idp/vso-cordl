...
/// @brief Method GetArg, addr 0x26552ec, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x26551ec, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ArgCount, addr 0x265523c, size 0x8, virtual true, abstract: false, final true
inline int32_t get_ArgCount() ;

/// @brief Method get_Args, addr 0x2655244, size 0x8, virtual true, abstract: false, final true
inline ::ArrayW<::System::Object*,::Array<::System::Object*>*> get_Args() ;

/// @brief Method get_LogicalCallContext, addr 0x26552f4, size 0x8, virtual true, abstract: false, final true
inline ::System::Runtime::Remoting::Messaging::LogicalCallContext* get_LogicalCallContext() ;

/// @brief Method get_MethodBase, addr 0x265524c, size 0x8, virtual true, abstract: false, final true
inline ::System::Reflection::MethodBase* get_MethodBase() ;

/// @brief Method get_MethodName, addr 0x2655254, size 0x40, virtual true, abstract: false, final true
inline ::StringW get_MethodName() ;

/// @brief Method get_MethodSignature, addr 0x2655294, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_MethodSignature() ;

/// @brief Method get_Properties, addr 0x265529c, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::IDictionary* get_Properties() ;

/// @brief Method get_TypeName, addr 0x26552a4, size 0x40, virtual true, abstract: false, final true
inline ::StringW get_TypeName() ;

/// @brief Method get_Uri, addr 0x26552e4, size 0x8, virtual true, abstract: false, final true
