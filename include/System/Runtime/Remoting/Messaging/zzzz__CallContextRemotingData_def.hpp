...
/// @brief Method Clone, addr 0x264ea88, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x264ef40, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasInfo, addr 0x264ede8, size 0x10, virtual false, abstract: false, final false
inline bool get_HasInfo() ;

/// @brief Method get_LogicalCallID, addr 0x264ef30, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_LogicalCallID() ;

/// @brief Convert to "::System::ICloneable"
constexpr ::System::ICloneable* i___System__ICloneable() noexcept;

/// @brief Method set_LogicalCallID, addr 0x264ef38, size 0x8, virtual false, abstract: false, final false
