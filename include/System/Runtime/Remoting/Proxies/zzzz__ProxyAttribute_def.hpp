...
/// @brief Method CreateInstance, addr 0x2641410, size 0xf8, virtual true, abstract: false, final false
inline ::System::MarshalByRefObject* CreateInstance(::System::Type*  serverType) ;

/// @brief Method CreateProxy, addr 0x2641508, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method GetPropertiesForNewContext, addr 0x264155c, size 0x4, virtual true, abstract: false, final true
inline void GetPropertiesForNewContext(::System::Runtime::Remoting::Activation::IConstructionCallMessage*  msg) ;

/// @brief Method IsContextOK, addr 0x2641560, size 0x8, virtual true, abstract: false, final true
