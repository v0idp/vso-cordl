...
/// @brief Method CreateMessageSink, addr 0x264a7e0, size 0x178, virtual true, abstract: false, final false
...
/// @brief Method RegisterCrossAppDomainChannel, addr 0x263ea44, size 0x134, virtual false, abstract: false, final false
static inline void RegisterCrossAppDomainChannel() ;

/// @brief Method StartListening, addr 0x264a7dc, size 0x4, virtual true, abstract: false, final false
inline void StartListening(::System::Object*  data) ;

/// @brief Method .ctor, addr 0x264a728, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Object* getStaticF_s_lock() ;

/// @brief Method get_ChannelData, addr 0x264a778, size 0x64, virtual true, abstract: false, final false
inline ::System::Object* get_ChannelData() ;

/// @brief Method get_ChannelName, addr 0x264a730, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_ChannelName() ;

/// @brief Method get_ChannelPriority, addr 0x264a770, size 0x8, virtual true, abstract: false, final false
