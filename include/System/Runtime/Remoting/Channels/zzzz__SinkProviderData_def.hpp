...
/// @brief Method .ctor, addr 0x2638c38, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method get_Children, addr 0x264b714, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::IList* get_Children() ;

/// @brief Method get_Properties, addr 0x264b71c, size 0x8, virtual false, abstract: false, final false
