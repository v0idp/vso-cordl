...
/// @brief Method .ctor, addr 0x26308e8, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(int32_t  domainId) ;

/// @brief Method get_DomainID, addr 0x264a718, size 0x8, virtual false, abstract: false, final false
inline int32_t get_DomainID() ;

/// @brief Method get_ProcessID, addr 0x264a720, size 0x8, virtual false, abstract: false, final false
