...
/// @brief Method ToString, addr 0x262f644, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x262f51c, size 0x120, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName, ::StringW  assemblyName) ;

/// @brief Method get_ObjectType, addr 0x262f63c, size 0x8, virtual false, abstract: false, final false
