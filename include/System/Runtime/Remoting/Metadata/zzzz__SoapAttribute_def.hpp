...
/// @brief Method SetReflectionObject, addr 0x264d0dc, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x264d0c4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_UseAttribute, addr 0x264d0cc, size 0x8, virtual true, abstract: false, final false
inline bool get_UseAttribute() ;

/// @brief Method get_XmlNamespace, addr 0x264d0d4, size 0x8, virtual true, abstract: false, final false
