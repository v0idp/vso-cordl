...
/// @brief Method SetReflectionObject, addr 0x264d3cc, size 0x220, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x264d38c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsInteropXmlElement, addr 0x264d3bc, size 0x8, virtual false, abstract: false, final false
inline bool get_IsInteropXmlElement() ;

/// @brief Method get_IsInteropXmlType, addr 0x264d3c4, size 0x8, virtual false, abstract: false, final false
inline bool get_IsInteropXmlType() ;

/// @brief Method get_UseAttribute, addr 0x264d394, size 0x8, virtual true, abstract: false, final false
inline bool get_UseAttribute() ;

/// @brief Method get_XmlElementName, addr 0x264d39c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_XmlElementName() ;

/// @brief Method get_XmlNamespace, addr 0x264d3a4, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_XmlNamespace() ;

/// @brief Method get_XmlTypeName, addr 0x264d3ac, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_XmlTypeName() ;

/// @brief Method get_XmlTypeNamespace, addr 0x264d3b4, size 0x8, virtual false, abstract: false, final false
