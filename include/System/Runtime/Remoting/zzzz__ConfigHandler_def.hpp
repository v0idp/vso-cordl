...
/// @brief Method CheckPath, addr 0x26361a4, size 0xe0, virtual false, abstract: false, final false
inline bool CheckPath(::StringW  path) ;

/// @brief Method ExtractAssembly, addr 0x26393c4, size 0xc0, virtual false, abstract: false, final false
inline ::StringW ExtractAssembly(::ByRef<::StringW>  type) ;

/// @brief Method GetNotNull, addr 0x2639294, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method OnChars, addr 0x2639f78, size 0x4, virtual true, abstract: false, final true
inline void OnChars(::StringW  ch) ;

/// @brief Method OnEndElement, addr 0x2638bb8, size 0x80, virtual true, abstract: false, final true
inline void OnEndElement(::StringW  name) ;

/// @brief Method OnEndParsing, addr 0x2639f7c, size 0xf4, virtual true, abstract: false, final true
inline void OnEndParsing(::Mono::Xml::SmallXmlParser*  parser) ;

/// @brief Method OnIgnorableWhitespace, addr 0x263628c, size 0x4, virtual true, abstract: false, final true
inline void OnIgnorableWhitespace(::StringW  s) ;

/// @brief Method OnProcessingInstruction, addr 0x2636288, size 0x4, virtual true, abstract: false, final true
inline void OnProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method OnStartElement, addr 0x2636290, size 0x1b0, virtual true, abstract: false, final true
inline void OnStartElement(::StringW  name, ::Mono::Xml::SmallXmlParser_IAttrList*  attrs) ;

/// @brief Method OnStartParsing, addr 0x2636284, size 0x4, virtual true, abstract: false, final true
inline void OnStartParsing(::Mono::Xml::SmallXmlParser*  parser) ;

/// @brief Method ParseElement, addr 0x2636440, size 0xe64, virtual false, abstract: false, final false
inline void ParseElement(::StringW  name, ::Mono::Xml::SmallXmlParser_IAttrList*  attrs) ;

/// @brief Method ParseTime, addr 0x2638cd8, size 0x3d4, virtual false, abstract: false, final false
inline ::System::TimeSpan ParseTime(::StringW  s) ;

/// @brief Method ReadChannel, addr 0x2637b50, size 0x3b0, virtual false, abstract: false, final false
inline void ReadChannel(::Mono::Xml::SmallXmlParser_IAttrList*  attrs, bool  isTemplate) ;

/// @brief Method ReadClientActivated, addr 0x26385a4, size 0x13c, virtual false, abstract: false, final false
inline void ReadClientActivated(::Mono::Xml::SmallXmlParser_IAttrList*  attrs) ;

/// @brief Method ReadClientWellKnown, addr 0x26382dc, size 0xec, virtual false, abstract: false, final false
inline void ReadClientWellKnown(::Mono::Xml::SmallXmlParser_IAttrList*  attrs) ;

/// @brief Method ReadCustomProviderData, addr 0x26372ac, size 0x35c, virtual false, abstract: false, final false
inline void ReadCustomProviderData(::StringW  name, ::Mono::Xml::SmallXmlParser_IAttrList*  attrs) ;

/// @brief Method ReadInteropXml, addr 0x26387a4, size 0x19c, virtual false, abstract: false, final false
inline void ReadInteropXml(::Mono::Xml::SmallXmlParser_IAttrList*  attrs, bool  isElement) ;

/// @brief Method ReadLifetine, addr 0x2637608, size 0x548, virtual false, abstract: false, final false
inline void ReadLifetine(::Mono::Xml::SmallXmlParser_IAttrList*  attrs) ;

/// @brief Method ReadPreload, addr 0x2638940, size 0x278, virtual false, abstract: false, final false
inline void ReadPreload(::Mono::Xml::SmallXmlParser_IAttrList*  attrs) ;

/// @brief Method ReadProvider, addr 0x2637f00, size 0x3dc, virtual false, abstract: false, final false
...
/// @brief Method ReadServiceActivated, addr 0x26386e0, size 0xc4, virtual false, abstract: false, final false
inline void ReadServiceActivated(::Mono::Xml::SmallXmlParser_IAttrList*  attrs) ;

/// @brief Method ReadServiceWellKnown, addr 0x26383c8, size 0x1dc, virtual false, abstract: false, final false
inline void ReadServiceWellKnown(::Mono::Xml::SmallXmlParser_IAttrList*  attrs) ;

/// @brief Method ValidatePath, addr 0x26360c8, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2631f0c, size 0xac, virtual false, abstract: false, final false
