...
/// @brief Method .ctor, addr 0x265ce18, size 0x144, virtual false, abstract: false, final false
inline void _ctor(int64_t  containerID, ::System::Reflection::FieldInfo*  member, ::ArrayW<int32_t,::Array<int32_t>*>  parentIndex) ;

/// @brief Method get_ContainerID, addr 0x265cf5c, size 0x8, virtual false, abstract: false, final false
inline int64_t get_ContainerID() ;

/// @brief Method get_ParentField, addr 0x265cf64, size 0x8, virtual false, abstract: false, final false
inline ::System::Reflection::FieldInfo* get_ParentField() ;

/// @brief Method get_ParentIndex, addr 0x265cf6c, size 0x8, virtual false, abstract: false, final false
