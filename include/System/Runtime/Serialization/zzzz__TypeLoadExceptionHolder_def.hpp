...
/// @brief Method .ctor, addr 0x2663dec, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName) ;

/// @brief Method get_TypeName, addr 0x2663e14, size 0x8, virtual false, abstract: false, final false
