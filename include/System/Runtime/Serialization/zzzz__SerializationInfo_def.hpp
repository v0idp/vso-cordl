...
/// @brief Method AddValue, addr 0x2665aa0, size 0xd4, virtual false, abstract: false, final false
inline void AddValue(::StringW  name, ::System::DateTime  value) ;

/// @brief Method AddValue, addr 0x264e2c4, size 0xb8, virtual false, abstract: false, final false
inline void AddValue(::StringW  name, ::System::Object*  value) ;

/// @brief Method AddValue, addr 0x266455c, size 0x7c, virtual false, abstract: false, final false
inline void AddValue(::StringW  name, ::System::Object*  value, ::System::Type*  type) ;

/// @brief Method AddValue, addr 0x264e37c, size 0xd8, virtual false, abstract: false, final false
inline void AddValue(::StringW  name, bool  value) ;

/// @brief Method AddValue, addr 0x26659c4, size 0xdc, virtual false, abstract: false, final false
inline void AddValue(::StringW  name, float_t  value) ;

/// @brief Method AddValue, addr 0x2665748, size 0xd4, virtual false, abstract: false, final false
inline void AddValue(::StringW  name, int16_t  value) ;

/// @brief Method AddValue, addr 0x2659e9c, size 0xd4, virtual false, abstract: false, final false
inline void AddValue(::StringW  name, int32_t  value) ;

/// @brief Method AddValue, addr 0x266581c, size 0xd4, virtual false, abstract: false, final false
inline void AddValue(::StringW  name, int64_t  value) ;

/// @brief Method AddValue, addr 0x26658f0, size 0xd4, virtual false, abstract: false, final false
inline void AddValue(::StringW  name, uint64_t  value) ;

/// @brief Method AddValue, addr 0x2665674, size 0xd4, virtual false, abstract: false, final false
inline void AddValue(::StringW  name, uint8_t  value) ;

/// @brief Method AddValueInternal, addr 0x26654c0, size 0x1b4, virtual false, abstract: false, final false
inline void AddValueInternal(::StringW  name, ::System::Object*  value, ::System::Type*  type) ;

/// @brief Method Compare, addr 0x26651c8, size 0x94, virtual false, abstract: false, final false
static inline bool Compare(::ArrayW<uint8_t,::Array<uint8_t>*>  a, ::ArrayW<uint8_t,::Array<uint8_t>*>  b) ;

/// @brief Method DemandForUnsafeAssemblyNameAssignments, addr 0x26651c4, size 0x4, virtual false, abstract: false, final false
static inline void DemandForUnsafeAssemblyNameAssignments(::StringW  originalAssemblyName, ::StringW  newAssemblyName) ;

/// @brief Method ExpandArrays, addr 0x26653b0, size 0x110, virtual false, abstract: false, final false
inline void ExpandArrays() ;

/// @brief Method FindElement, addr 0x2665b74, size 0xc4, virtual false, abstract: false, final false
inline int32_t FindElement(::StringW  name) ;

/// @brief Method GetBoolean, addr 0x2665db0, size 0x180, virtual false, abstract: false, final false
inline bool GetBoolean(::StringW  name) ;

/// @brief Method GetElement, addr 0x2665c38, size 0xfc, virtual false, abstract: false, final false
inline ::System::Object* GetElement(::StringW  name, ::ByRef<::System::Type*>  foundType) ;

/// @brief Method GetElementNoThrow, addr 0x2665d34, size 0x7c, virtual false, abstract: false, final false
inline ::System::Object* GetElementNoThrow(::StringW  name, ::ByRef<::System::Type*>  foundType) ;

/// @brief Method GetEnumerator, addr 0x264dc24, size 0x94, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::SerializationInfoEnumerator* GetEnumerator() ;

/// @brief Method GetInt32, addr 0x2665f30, size 0x174, virtual false, abstract: false, final false
inline int32_t GetInt32(::StringW  name) ;

/// @brief Method GetInt64, addr 0x26660a4, size 0x174, virtual false, abstract: false, final false
inline int64_t GetInt64(::StringW  name) ;

/// @brief Method GetSingle, addr 0x2666218, size 0x174, virtual false, abstract: false, final false
inline float_t GetSingle(::StringW  name) ;

/// @brief Method GetString, addr 0x266638c, size 0x16c, virtual false, abstract: false, final false
inline ::StringW GetString(::StringW  name) ;

/// @brief Method GetValue, addr 0x26641d0, size 0x208, virtual false, abstract: false, final false
inline ::System::Object* GetValue(::StringW  name, ::System::Type*  type) ;

/// @brief Method GetValueNoThrow, addr 0x26640c8, size 0x108, virtual false, abstract: false, final false
inline ::System::Object* GetValueNoThrow(::StringW  name, ::System::Type*  type) ;

/// @brief Method IsAssemblyNameAssignmentSafe, addr 0x266525c, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method SetType, addr 0x264e190, size 0x134, virtual false, abstract: false, final false
inline void SetType(::System::Type*  type) ;

/// @brief Method UpdateValue, addr 0x2661a78, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2664fd0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  type, ::System::Runtime::Serialization::IFormatterConverter*  converter) ;

/// @brief Method .ctor, addr 0x2664fd8, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method get_AssemblyName, addr 0x26651bc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_AssemblyName() ;

/// @brief Method get_FullTypeName, addr 0x26651b4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_FullTypeName() ;

/// @brief Method get_IsAssemblyNameSetExplicit, addr 0x26653a8, size 0x8, virtual false, abstract: false, final false
inline bool get_IsAssemblyNameSetExplicit() ;

/// @brief Method get_IsFullTypeNameSetExplicit, addr 0x26653a0, size 0x8, virtual false, abstract: false, final false
inline bool get_IsFullTypeNameSetExplicit() ;

/// @brief Method get_MemberCount, addr 0x2665390, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MemberCount() ;

/// @brief Method get_ObjectType, addr 0x2665398, size 0x8, virtual false, abstract: false, final false
