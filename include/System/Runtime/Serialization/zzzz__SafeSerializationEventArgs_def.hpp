...
/// @brief Method .ctor, addr 0x2663e1c, size 0xb8, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method get_SerializedStates, addr 0x2663ed4, size 0x8, virtual false, abstract: false, final false
