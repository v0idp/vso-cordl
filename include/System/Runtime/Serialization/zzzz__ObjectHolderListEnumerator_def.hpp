...
/// @brief Method MoveNext, addr 0x2662cfc, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2663d94, size 0x48, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::ObjectHolderList*  list, bool  isFixupEnumerator) ;

/// @brief Method get_Current, addr 0x2662ca4, size 0x3c, virtual false, abstract: false, final false
