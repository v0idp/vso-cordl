...
/// @brief Method AddObjectHolder, addr 0x2660040, size 0xf8, virtual false, abstract: false, final false
inline void AddObjectHolder(::System::Runtime::Serialization::ObjectHolder*  holder) ;

/// @brief Method AddOnDeserialization, addr 0x2663574, size 0x80, virtual true, abstract: false, final false
inline void AddOnDeserialization(::System::Runtime::Serialization::DeserializationEventHandler*  handler) ;

/// @brief Method AddOnDeserialized, addr 0x26635f4, size 0x90, virtual true, abstract: false, final false
inline void AddOnDeserialized(::System::Object*  obj) ;

/// @brief Method CanCallGetType, addr 0x265fe98, size 0x8, virtual false, abstract: false, final false
inline bool CanCallGetType(::System::Object*  obj) ;

/// @brief Method CompleteISerializableObject, addr 0x26608cc, size 0x27c, virtual false, abstract: false, final false
...
/// @brief Method CompleteObject, addr 0x2661458, size 0x614, virtual false, abstract: false, final false
inline void CompleteObject(::System::Runtime::Serialization::ObjectHolder*  holder, bool  bObjectFullyComplete) ;

/// @brief Method DoFixups, addr 0x2662954, size 0x2f4, virtual true, abstract: false, final false
inline void DoFixups() ;

/// @brief Method DoNewlyRegisteredObjectFixups, addr 0x26610f4, size 0xd8, virtual false, abstract: false, final false
inline void DoNewlyRegisteredObjectFixups(::System::Runtime::Serialization::ObjectHolder*  holder) ;

/// @brief Method DoValueTypeFixup, addr 0x2660bac, size 0x548, virtual false, abstract: false, final false
...
/// @brief Method FindObjectHolder, addr 0x265ff1c, size 0x58, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::ObjectHolder* FindObjectHolder(int64_t  objectID) ;

/// @brief Method FindOrCreateObjectHolder, addr 0x265ff74, size 0x98, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::ObjectHolder* FindOrCreateObjectHolder(int64_t  objectID) ;

/// @brief Method FixupSpecialObject, addr 0x2660438, size 0x230, virtual false, abstract: false, final false
inline void FixupSpecialObject(::System::Runtime::Serialization::ObjectHolder*  holder) ;

/// @brief Method GetCompletionInfo, addr 0x2660138, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method GetConstructor, addr 0x2662824, size 0x130, virtual false, abstract: false, final false
static inline ::System::Reflection::RuntimeConstructorInfo* GetConstructor(::System::RuntimeType*  t) ;

/// @brief Method GetObject, addr 0x2661c88, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method RaiseDeserializationEvent, addr 0x2663528, size 0x4c, virtual true, abstract: false, final false
inline void RaiseDeserializationEvent() ;

/// @brief Method RaiseOnDeserializedEvent, addr 0x2663684, size 0x84, virtual true, abstract: false, final false
inline void RaiseOnDeserializedEvent(::System::Object*  obj) ;

/// @brief Method RaiseOnDeserializingEvent, addr 0x2663708, size 0x84, virtual false, abstract: false, final false
inline void RaiseOnDeserializingEvent(::System::Object*  obj) ;

/// @brief Method RecordArrayElementFixup, addr 0x26633d4, size 0x154, virtual true, abstract: false, final false
inline void RecordArrayElementFixup(int64_t  arrayToBeFixed, ::ArrayW<int32_t,::Array<int32_t>*>  indices, int64_t  objectRequired) ;

/// @brief Method RecordDelayedFixup, addr 0x2663280, size 0x154, virtual true, abstract: false, final false
inline void RecordDelayedFixup(int64_t  objectToBeFixed, ::StringW  memberName, int64_t  objectRequired) ;

/// @brief Method RecordFixup, addr 0x2662fc0, size 0x284, virtual true, abstract: false, final false
inline void RecordFixup(int64_t  objectToBeFixed, ::System::Reflection::MemberInfo*  member, int64_t  objectRequired) ;

/// @brief Method RegisterFixup, addr 0x2662db8, size 0xd8, virtual false, abstract: false, final false
inline void RegisterFixup(::System::Runtime::Serialization::FixupHolder*  fixup, int64_t  objectToBeFixed, int64_t  objectRequired) ;

/// @brief Method RegisterObject, addr 0x2661f0c, size 0x5a8, virtual false, abstract: false, final false
...
/// @brief Method RegisterString, addr 0x2661d38, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method ResolveObjectReference, addr 0x26611cc, size 0x27c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x265fe18, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_SpecialFixupObjects, addr 0x265feb0, size 0x64, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::ObjectHolderList* get_SpecialFixupObjects() ;

/// @brief Method get_TopObject, addr 0x265fea8, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_TopObject() ;

/// @brief Method set_TopObject, addr 0x265fea0, size 0x8, virtual false, abstract: false, final false
