...
public:
// Declarations
/// @brief Method BindToName, addr 0x265c1f4, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x265c200, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
