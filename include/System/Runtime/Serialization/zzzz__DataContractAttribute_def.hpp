...
/// @brief Field isReference, offset 0x19, size 0x1 
...
/// @brief Method .ctor, addr 0x2b28468, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsReference, addr 0x2b28470, size 0x8, virtual false, abstract: false, final false
inline bool get_IsReference() ;

/// @brief Method set_Name, addr 0x2b28478, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field isReference, offset: 0x19, size: 0x1, def value: None
 bool  ___isReference;
...
static_assert(offsetof(::System::Runtime::Serialization::DataContractAttribute, ___isNameSetExplicitly) == 0x18, "Offset mismatch!");

static_assert(offsetof(::System::Runtime::Serialization::DataContractAttribute, ___isReference) == 0x19, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::System::Runtime::Serialization::DataContractAttribute, 0x20>, "Size mismatch!");
