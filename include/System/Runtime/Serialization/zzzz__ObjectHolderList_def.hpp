...
/// @brief Method Add, addr 0x2663c98, size 0x74, virtual true, abstract: false, final false
inline void Add(::System::Runtime::Serialization::ObjectHolder*  value) ;

/// @brief Method EnlargeArray, addr 0x2663d0c, size 0x88, virtual false, abstract: false, final false
inline void EnlargeArray() ;

/// @brief Method GetFixupEnumerator, addr 0x2662c48, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x265ff14, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2663c2c, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(int32_t  startingSize) ;

/// @brief Method get_Count, addr 0x2663de4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Version, addr 0x2663ddc, size 0x8, virtual false, abstract: false, final false
