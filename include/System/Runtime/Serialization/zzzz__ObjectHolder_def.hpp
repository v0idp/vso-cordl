...
/// @brief Method AddDependency, addr 0x2662f4c, size 0x74, virtual false, abstract: false, final false
inline void AddDependency(int64_t  dependentObject) ;

/// @brief Method AddFixup, addr 0x2662e90, size 0xbc, virtual false, abstract: false, final false
inline void AddFixup(::System::Runtime::Serialization::FixupHolder*  fixup, ::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method DecrementFixupsRemaining, addr 0x2661b5c, size 0x24, virtual false, abstract: false, final false
inline void DecrementFixupsRemaining(::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method IncrementDescendentFixups, addr 0x266378c, size 0x10, virtual false, abstract: false, final false
inline void IncrementDescendentFixups(int32_t  amount) ;

/// @brief Method MarkForCompletionWhenAvailable, addr 0x2661bfc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method RemoveDependency, addr 0x2661b80, size 0x18, virtual false, abstract: false, final false
inline void RemoveDependency(int64_t  id) ;

/// @brief Method SetFlags, addr 0x2660814, size 0xb8, virtual false, abstract: false, final false
inline void SetFlags() ;

/// @brief Method SetObjectValue, addr 0x266071c, size 0xf8, virtual false, abstract: false, final false
inline void SetObjectValue(::System::Object*  obj, ::System::Runtime::Serialization::ObjectManager*  manager) ;

/// @brief Method UpdateData, addr 0x2662694, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method UpdateDescendentDependencyChain, addr 0x266379c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2661e30, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x26624b4, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x266000c, size 0x34, virtual false, abstract: false, final false
inline void _ctor(int64_t  objID) ;

/// @brief Method get_CanObjectValueChange, addr 0x266040c, size 0x20, virtual false, abstract: false, final false
inline bool get_CanObjectValueChange() ;

/// @brief Method get_CanSurrogatedObjectValueChange, addr 0x2660674, size 0xa8, virtual false, abstract: false, final false
inline bool get_CanSurrogatedObjectValueChange() ;

/// @brief Method get_CompletelyFixed, addr 0x26603e8, size 0x24, virtual false, abstract: false, final false
inline bool get_CompletelyFixed() ;

/// @brief Method get_ContainerID, addr 0x2663890, size 0x18, virtual false, abstract: false, final false
inline int64_t get_ContainerID() ;

/// @brief Method get_DependentObjects, addr 0x266397c, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::LongList* get_DependentObjects() ;

/// @brief Method get_DirectlyDependentObjects, addr 0x2663930, size 0x8, virtual false, abstract: false, final false
inline int32_t get_DirectlyDependentObjects() ;

/// @brief Method get_HasISerializable, addr 0x2661a6c, size 0xc, virtual false, abstract: false, final false
inline bool get_HasISerializable() ;

/// @brief Method get_HasSurrogate, addr 0x2660668, size 0xc, virtual false, abstract: false, final false
inline bool get_HasSurrogate() ;

/// @brief Method get_IsIncompleteObjectReference, addr 0x266042c, size 0xc, virtual false, abstract: false, final false
inline bool get_IsIncompleteObjectReference() ;

/// @brief Method get_ObjectValue, addr 0x266395c, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_ObjectValue() ;

/// @brief Method get_Reachable, addr 0x2663938, size 0x8, virtual false, abstract: false, final false
inline bool get_Reachable() ;

/// @brief Method get_RequiresDelayedFixup, addr 0x2662684, size 0x10, virtual false, abstract: false, final false
inline bool get_RequiresDelayedFixup() ;

/// @brief Method get_RequiresSerInfoFixup, addr 0x2662ce0, size 0x1c, virtual false, abstract: false, final false
inline bool get_RequiresSerInfoFixup() ;

/// @brief Method get_RequiresValueTypeFixup, addr 0x2660b68, size 0xc, virtual false, abstract: false, final false
inline bool get_RequiresValueTypeFixup() ;

/// @brief Method get_SerializationInfo, addr 0x2663964, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::SerializationInfo* get_SerializationInfo() ;

/// @brief Method get_Surrogate, addr 0x2663974, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::ISerializationSurrogate* get_Surrogate() ;

/// @brief Method get_TotalDependentObjects, addr 0x2662818, size 0xc, virtual false, abstract: false, final false
inline int32_t get_TotalDependentObjects() ;

/// @brief Method get_TypeLoadException, addr 0x266394c, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::TypeLoadExceptionHolder* get_TypeLoadException() ;

/// @brief Method get_TypeLoadExceptionReachable, addr 0x2661b98, size 0x10, virtual false, abstract: false, final false
inline bool get_TypeLoadExceptionReachable() ;

/// @brief Method get_ValueFixup, addr 0x266398c, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::ValueTypeFixupInfo* get_ValueFixup() ;

/// @brief Method get_ValueTypeFixupPerformed, addr 0x2660b74, size 0x38, virtual false, abstract: false, final false
inline bool get_ValueTypeFixupPerformed() ;

/// @brief Method set_DependentObjects, addr 0x2663984, size 0x8, virtual false, abstract: false, final false
inline void set_DependentObjects(::System::Runtime::Serialization::LongList*  value) ;

/// @brief Method set_IsIncompleteObjectReference, addr 0x2661448, size 0x10, virtual false, abstract: false, final false
inline void set_IsIncompleteObjectReference(bool  value) ;

/// @brief Method set_Reachable, addr 0x2663940, size 0xc, virtual false, abstract: false, final false
inline void set_Reachable(bool  value) ;

/// @brief Method set_RequiresSerInfoFixup, addr 0x2660b48, size 0x20, virtual false, abstract: false, final false
inline void set_RequiresSerInfoFixup(bool  value) ;

/// @brief Method set_SerializationInfo, addr 0x266396c, size 0x8, virtual false, abstract: false, final false
inline void set_SerializationInfo(::System::Runtime::Serialization::SerializationInfo*  value) ;

/// @brief Method set_TypeLoadException, addr 0x2663954, size 0x8, virtual false, abstract: false, final false
inline void set_TypeLoadException(::System::Runtime::Serialization::TypeLoadExceptionHolder*  value) ;

/// @brief Method set_ValueTypeFixupPerformed, addr 0x2661ba8, size 0x14, virtual false, abstract: false, final false
