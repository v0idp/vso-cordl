...
/// @brief Method Dump, addr 0x266a400, size 0x4, virtual false, abstract: false, final false
inline void Dump() ;

static inline ::System::Runtime::Serialization::Formatters::Binary::MemberPrimitiveUnTyped* New_ctor() ;

/// @brief Method Read, addr 0x266a3d4, size 0x2c, virtual true, abstract: false, final true
inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser*  input) ;

/// @brief Method Set, addr 0x266a3a8, size 0x8, virtual false, abstract: false, final false
inline void Set(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  typeInformation) ;

/// @brief Method Set, addr 0x266a39c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Write, addr 0x266a3b0, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x266a394, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
