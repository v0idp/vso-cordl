...
/// @brief Method Dump, addr 0x266a5d0, size 0x4, virtual false, abstract: false, final false
inline void Dump() ;

static inline ::System::Runtime::Serialization::Formatters::Binary::ObjectNull* New_ctor() ;

/// @brief Method Read, addr 0x266a55c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method SetNullCount, addr 0x266a4a8, size 0x8, virtual false, abstract: false, final false
inline void SetNullCount(int32_t  nullCount) ;

/// @brief Method Write, addr 0x266a4b0, size 0xac, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x266a4a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
