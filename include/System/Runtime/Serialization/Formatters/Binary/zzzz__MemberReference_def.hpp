...
/// @brief Method Dump, addr 0x266a49c, size 0x4, virtual false, abstract: false, final false
inline void Dump() ;

static inline ::System::Runtime::Serialization::Formatters::Binary::MemberReference* New_ctor() ;

/// @brief Method Read, addr 0x266a468, size 0x34, virtual true, abstract: false, final true
inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser*  input) ;

/// @brief Method Set, addr 0x266a40c, size 0x8, virtual false, abstract: false, final false
inline void Set(int32_t  idRef) ;

/// @brief Method Write, addr 0x266a414, size 0x54, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x266a404, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
