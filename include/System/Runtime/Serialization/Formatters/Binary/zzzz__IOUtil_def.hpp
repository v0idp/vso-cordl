...
public:
// Declarations
/// @brief Method FlagTest, addr 0x2667b58, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method WriteStringWithCode, addr 0x2667b64, size 0x74, virtual false, abstract: false, final false
static inline void WriteStringWithCode(::StringW  value, ::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter*  sout) ;

/// @brief Method WriteWithCode, addr 0x2667bd8, size 0x12c, virtual false, abstract: false, final false
