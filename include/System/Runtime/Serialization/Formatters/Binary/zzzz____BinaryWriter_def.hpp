...
/// @brief Method InternalWriteItemNull, addr 0x266e9e4, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method WriteArrayAsBytes, addr 0x266ef60, size 0x140, virtual false, abstract: false, final false
inline void WriteArrayAsBytes(::System::Array*  array, int32_t  typeLength) ;

/// @brief Method WriteAssembly, addr 0x266f708, size 0xd4, virtual false, abstract: false, final false
inline void WriteAssembly(::System::Type*  type, ::StringW  assemblyString, int32_t  assemId, bool  isNew) ;

/// @brief Method WriteBegin, addr 0x266df8c, size 0x4, virtual false, abstract: false, final false
inline void WriteBegin() ;

/// @brief Method WriteBoolean, addr 0x266dfb0, size 0x24, virtual false, abstract: false, final false
inline void WriteBoolean(bool  value) ;

/// @brief Method WriteByte, addr 0x266719c, size 0x20, virtual false, abstract: false, final false
inline void WriteByte(uint8_t  value) ;

/// @brief Method WriteBytes, addr 0x266dff4, size 0x20, virtual false, abstract: false, final false
inline void WriteBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  byteA, int32_t  offset, int32_t  size) ;

/// @brief Method WriteBytes, addr 0x266dfd4, size 0x20, virtual false, abstract: false, final false
inline void WriteBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method WriteChar, addr 0x266e014, size 0x20, virtual false, abstract: false, final false
inline void WriteChar(char16_t  value) ;

/// @brief Method WriteChars, addr 0x266e034, size 0x24, virtual false, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t,::Array<char16_t>*>  value) ;

/// @brief Method WriteDateTime, addr 0x266e26c, size 0x78, virtual false, abstract: false, final false
inline void WriteDateTime(::System::DateTime  value) ;

/// @brief Method WriteDecimal, addr 0x266e058, size 0xec, virtual false, abstract: false, final false
inline void WriteDecimal(::System::Decimal  value) ;

/// @brief Method WriteDelayedNullItem, addr 0x266f6c4, size 0x10, virtual false, abstract: false, final false
inline void WriteDelayedNullItem() ;

/// @brief Method WriteDouble, addr 0x266e168, size 0x24, virtual false, abstract: false, final false
inline void WriteDouble(double_t  value) ;

/// @brief Method WriteEnd, addr 0x266df90, size 0x20, virtual false, abstract: false, final false
inline void WriteEnd() ;

/// @brief Method WriteInt16, addr 0x266e18c, size 0x24, virtual false, abstract: false, final false
inline void WriteInt16(int16_t  value) ;

/// @brief Method WriteInt32, addr 0x26671e0, size 0x24, virtual false, abstract: false, final false
inline void WriteInt32(int32_t  value) ;

/// @brief Method WriteInt64, addr 0x266e1b0, size 0x24, virtual false, abstract: false, final false
inline void WriteInt64(int64_t  value) ;

/// @brief Method WriteItem, addr 0x266f674, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method WriteItemEnd, addr 0x266f6d4, size 0x4, virtual false, abstract: false, final false
inline void WriteItemEnd() ;

/// @brief Method WriteItemObjectRef, addr 0x266f6d8, size 0x30, virtual false, abstract: false, final false
inline void WriteItemObjectRef(::System::Runtime::Serialization::Formatters::Binary::NameInfo*  nameInfo, int32_t  idRef) ;

/// @brief Method WriteJaggedArray, addr 0x266f0a0, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method WriteMember, addr 0x266f3d8, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method WriteMemberNested, addr 0x266f610, size 0x1c, virtual false, abstract: false, final false
inline void WriteMemberNested(::System::Runtime::Serialization::Formatters::Binary::NameInfo*  memberNameInfo) ;

/// @brief Method WriteMemberObjectRef, addr 0x266f57c, size 0x94, virtual false, abstract: false, final false
inline void WriteMemberObjectRef(::System::Runtime::Serialization::Formatters::Binary::NameInfo*  memberNameInfo, int32_t  idRef) ;

/// @brief Method WriteMemberString, addr 0x266f62c, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method WriteMethodCall, addr 0x266e444, size 0x70, virtual false, abstract: false, final false
inline void WriteMethodCall() ;

/// @brief Method WriteMethodReturn, addr 0x266e4b4, size 0x70, virtual false, abstract: false, final false
inline void WriteMethodReturn() ;

/// @brief Method WriteNullItem, addr 0x266f6b4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method WriteNullMember, addr 0x266f4e0, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method WriteObject, addr 0x266e524, size 0x4c0, virtual false, abstract: false, final false
...
/// @brief Method WriteObjectByteArray, addr 0x266f378, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method WriteObjectEnd, addr 0x266e350, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method WriteObjectString, addr 0x266ebf0, size 0x90, virtual false, abstract: false, final false
inline void WriteObjectString(int32_t  objectId, ::StringW  value) ;

/// @brief Method WriteRectangleArray, addr 0x266f220, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method WriteSByte, addr 0x266e1d4, size 0x20, virtual false, abstract: false, final false
inline void WriteSByte(int8_t  value) ;

/// @brief Method WriteSerializationHeader, addr 0x266e3b4, size 0x90, virtual false, abstract: false, final false
inline void WriteSerializationHeader(int32_t  topId, int32_t  headerId, int32_t  minorVersion, int32_t  majorVersion) ;

/// @brief Method WriteSerializationHeaderEnd, addr 0x266e354, size 0x60, virtual false, abstract: false, final false
inline void WriteSerializationHeaderEnd() ;

/// @brief Method WriteSingle, addr 0x266e144, size 0x24, virtual false, abstract: false, final false
inline void WriteSingle(float_t  value) ;

/// @brief Method WriteSingleArray, addr 0x266ec80, size 0x2e0, virtual false, abstract: false, final false
...
/// @brief Method WriteString, addr 0x26671bc, size 0x24, virtual false, abstract: false, final false
inline void WriteString(::StringW  value) ;

/// @brief Method WriteTimeSpan, addr 0x266e1f4, size 0x78, virtual false, abstract: false, final false
inline void WriteTimeSpan(::System::TimeSpan  value) ;

/// @brief Method WriteUInt16, addr 0x266e2e4, size 0x24, virtual false, abstract: false, final false
inline void WriteUInt16(uint16_t  value) ;

/// @brief Method WriteUInt32, addr 0x266e308, size 0x24, virtual false, abstract: false, final false
inline void WriteUInt32(uint32_t  value) ;

/// @brief Method WriteUInt64, addr 0x266e32c, size 0x24, virtual false, abstract: false, final false
inline void WriteUInt64(uint64_t  value) ;

/// @brief Method WriteValue, addr 0x2667d04, size 0x758, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x266d804, size 0xb0, virtual false, abstract: false, final false
