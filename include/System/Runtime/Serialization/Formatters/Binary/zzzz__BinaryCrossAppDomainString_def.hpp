...
/// @brief Method Dump, addr 0x2668fb0, size 0x4, virtual false, abstract: false, final false
inline void Dump() ;

static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainString* New_ctor() ;

/// @brief Method Read, addr 0x2668f54, size 0x5c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2668f4c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
