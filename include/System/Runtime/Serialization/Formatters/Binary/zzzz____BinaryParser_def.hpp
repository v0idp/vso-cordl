...
/// @brief Method GetOp, addr 0x2678f18, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method PutOp, addr 0x2678b38, size 0x90, virtual false, abstract: false, final false
inline void PutOp(::System::Runtime::Serialization::Formatters::Binary::ObjectProgress*  op) ;

/// @brief Method ReadArray, addr 0x2677bd0, size 0x570, virtual false, abstract: false, final false
inline void ReadArray(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum  binaryHeaderEnum) ;

/// @brief Method ReadArrayAsBytes, addr 0x2679804, size 0x258, virtual false, abstract: false, final false
inline void ReadArrayAsBytes(::System::Runtime::Serialization::Formatters::Binary::ParseRecord*  pr) ;

/// @brief Method ReadAssembly, addr 0x2676e64, size 0x250, virtual false, abstract: false, final false
inline void ReadAssembly(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum  binaryHeaderEnum) ;

/// @brief Method ReadBegin, addr 0x2676da8, size 0x4, virtual false, abstract: false, final false
inline void ReadBegin() ;

/// @brief Method ReadBoolean, addr 0x2678bc8, size 0x20, virtual false, abstract: false, final false
inline bool ReadBoolean() ;

/// @brief Method ReadByte, addr 0x26673d8, size 0x20, virtual false, abstract: false, final false
inline uint8_t ReadByte() ;

/// @brief Method ReadBytes, addr 0x26688b0, size 0x24, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadBytes(int32_t  length) ;

/// @brief Method ReadBytes, addr 0x2678be8, size 0x7c, virtual false, abstract: false, final false
inline void ReadBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  byteA, int32_t  offset, int32_t  size) ;

/// @brief Method ReadChar, addr 0x2678c64, size 0x20, virtual false, abstract: false, final false
inline char16_t ReadChar() ;

/// @brief Method ReadChars, addr 0x2678c84, size 0x24, virtual false, abstract: false, final false
inline ::ArrayW<char16_t,::Array<char16_t>*> ReadChars(int32_t  length) ;

/// @brief Method ReadCrossAppDomainMap, addr 0x267740c, size 0x1a4, virtual false, abstract: false, final false
inline void ReadCrossAppDomainMap() ;

/// @brief Method ReadDateTime, addr 0x2678e30, size 0x7c, virtual false, abstract: false, final false
inline ::System::DateTime ReadDateTime() ;

/// @brief Method ReadDecimal, addr 0x2678ca8, size 0xb4, virtual false, abstract: false, final false
inline ::System::Decimal ReadDecimal() ;

/// @brief Method ReadDouble, addr 0x2678d80, size 0x24, virtual false, abstract: false, final false
inline double_t ReadDouble() ;

/// @brief Method ReadEnd, addr 0x26788e4, size 0x4, virtual false, abstract: false, final false
inline void ReadEnd() ;

/// @brief Method ReadInt16, addr 0x2678da4, size 0x24, virtual false, abstract: false, final false
inline int16_t ReadInt16() ;

/// @brief Method ReadInt32, addr 0x266741c, size 0x24, virtual false, abstract: false, final false
inline int32_t ReadInt32() ;

/// @brief Method ReadInt64, addr 0x2678dc8, size 0x24, virtual false, abstract: false, final false
inline int64_t ReadInt64() ;

/// @brief Method ReadMemberPrimitiveTyped, addr 0x2678140, size 0x320, virtual false, abstract: false, final false
inline void ReadMemberPrimitiveTyped() ;

/// @brief Method ReadMemberPrimitiveUnTyped, addr 0x26788e8, size 0x250, virtual false, abstract: false, final false
inline void ReadMemberPrimitiveUnTyped() ;

/// @brief Method ReadMemberReference, addr 0x2678460, size 0x194, virtual false, abstract: false, final false
inline void ReadMemberReference() ;

/// @brief Method ReadMessageEnd, addr 0x2678794, size 0x150, virtual false, abstract: false, final false
inline void ReadMessageEnd() ;

/// @brief Method ReadObject, addr 0x26770b4, size 0x358, virtual false, abstract: false, final false
inline void ReadObject() ;

/// @brief Method ReadObjectNull, addr 0x26785f4, size 0x1a0, virtual false, abstract: false, final false
inline void ReadObjectNull(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum  binaryHeaderEnum) ;

/// @brief Method ReadObjectString, addr 0x26776c0, size 0x510, virtual false, abstract: false, final false
inline void ReadObjectString(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum  binaryHeaderEnum) ;

/// @brief Method ReadObjectWithMap, addr 0x26775b0, size 0x8c, virtual false, abstract: false, final false
inline void ReadObjectWithMap(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum  binaryHeaderEnum) ;

/// @brief Method ReadObjectWithMap, addr 0x2678fc0, size 0x410, virtual false, abstract: false, final false
inline void ReadObjectWithMap(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap*  record) ;

/// @brief Method ReadObjectWithMapTyped, addr 0x267763c, size 0x84, virtual false, abstract: false, final false
inline void ReadObjectWithMapTyped(::System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum  binaryHeaderEnum) ;

/// @brief Method ReadObjectWithMapTyped, addr 0x26793d0, size 0x434, virtual false, abstract: false, final false
inline void ReadObjectWithMapTyped(::System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped*  record) ;

/// @brief Method ReadSByte, addr 0x2678dec, size 0x20, virtual false, abstract: false, final false
inline int8_t ReadSByte() ;

/// @brief Method ReadSerializationHeaderRecord, addr 0x2676dac, size 0xb8, virtual false, abstract: false, final false
inline void ReadSerializationHeaderRecord() ;

/// @brief Method ReadSingle, addr 0x2678d5c, size 0x24, virtual false, abstract: false, final false
inline float_t ReadSingle() ;

/// @brief Method ReadString, addr 0x26673f8, size 0x24, virtual false, abstract: false, final false
inline ::StringW ReadString() ;

/// @brief Method ReadTimeSpan, addr 0x2678e0c, size 0x24, virtual false, abstract: false, final false
inline ::System::TimeSpan ReadTimeSpan() ;

/// @brief Method ReadUInt16, addr 0x2678eac, size 0x24, virtual false, abstract: false, final false
inline uint16_t ReadUInt16() ;

/// @brief Method ReadUInt32, addr 0x2678ed0, size 0x24, virtual false, abstract: false, final false
inline uint32_t ReadUInt32() ;

/// @brief Method ReadUInt64, addr 0x2678ef4, size 0x24, virtual false, abstract: false, final false
inline uint64_t ReadUInt64() ;

/// @brief Method ReadValue, addr 0x26690b4, size 0x424, virtual false, abstract: false, final false
inline ::System::Object* ReadValue(::System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE  code) ;

/// @brief Method Run, addr 0x2671c18, size 0x568, virtual false, abstract: false, final false
inline void Run() ;
...
/// @brief Method .ctor, addr 0x266d11c, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method get_AssemIdToAssemblyTable, addr 0x2676cdc, size 0x68, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::Formatters::Binary::SizedArray* get_AssemIdToAssemblyTable() ;

/// @brief Method get_ObjectMapIdTable, addr 0x2676c78, size 0x64, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::Formatters::Binary::SizedArray* get_ObjectMapIdTable() ;

/// @brief Method get_SystemAssemblyInfo, addr 0x2676bd8, size 0xa0, virtual false, abstract: false, final false
inline ::System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo* get_SystemAssemblyInfo() ;

/// @brief Method get_prs, addr 0x2676d44, size 0x64, virtual false, abstract: false, final false
