...
/// @brief Method Fixup, addr 0x267aab0, size 0x304, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x267aa38, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::System::Array*  arrayObj, ::ArrayW<int32_t,::Array<int32_t>*>  indexMap) ;

/// @brief Method .ctor, addr 0x267aa6c, size 0x44, virtual false, abstract: false, final false
