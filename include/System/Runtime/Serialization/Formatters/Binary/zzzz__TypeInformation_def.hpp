...
/// @brief Method .ctor, addr 0x266dec4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  fullTypeName, ::StringW  assemblyString, bool  hasTypeForwardedFrom) ;

/// @brief Method get_AssemblyString, addr 0x2671b70, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_AssemblyString() ;

/// @brief Method get_FullTypeName, addr 0x2671b68, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_FullTypeName() ;

/// @brief Method get_HasTypeForwardedFrom, addr 0x2671b78, size 0x8, virtual false, abstract: false, final false
