...
public:
// Declarations
/// @brief Method Finalize, addr 0x267fa98, size 0x8, virtual true, abstract: false, final false
inline void Finalize() ;

static inline ::System::Runtime::ConstrainedExecution::CriticalFinalizerObject* New_ctor() ;

/// @brief Method .ctor, addr 0x267cafc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
