...
public:
// Declarations
/// @brief Method GetHashCode, addr 0x2682db0, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetHashCode(::System::Object*  o) ;

/// @brief Method GetObjectValue, addr 0x2682db8, size 0x4, virtual false, abstract: false, final false
static inline ::System::Object* GetObjectValue(::System::Object*  obj) ;

/// @brief Method InitializeArray, addr 0x2682d3c, size 0x4, virtual false, abstract: false, final false
static inline void InitializeArray(::System::Array*  array, ::System::IntPtr  fldHandle) ;

/// @brief Method InitializeArray, addr 0x2682d40, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method PrepareConstrainedRegions, addr 0x2682dc4, size 0x4, virtual false, abstract: false, final false
static inline void PrepareConstrainedRegions() ;

/// @brief Method SufficientExecutionStack, addr 0x2682dbc, size 0x4, virtual false, abstract: false, final false
static inline bool SufficientExecutionStack() ;

/// @brief Method TryEnsureSufficientExecutionStack, addr 0x2682dc0, size 0x4, virtual false, abstract: false, final false
static inline bool TryEnsureSufficientExecutionStack() ;

/// @brief Method get_OffsetToStringData, addr 0x267e734, size 0x4, virtual false, abstract: false, final false
