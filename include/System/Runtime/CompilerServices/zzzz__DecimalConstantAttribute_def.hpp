...
/// @brief Method .ctor, addr 0x267ffdc, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(uint8_t  scale, uint8_t  sign, uint32_t  hi, uint32_t  mid, uint32_t  low) ;

/// @brief Method get_Value, addr 0x2680078, size 0xc, virtual false, abstract: false, final false
