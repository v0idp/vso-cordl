...
/// @brief Method .ctor, addr 0x27cb700, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  _cordl_fixed_empty_name_whitespace) ;

/// @brief Method .ctor, addr 0x27cb680, size 0x80, virtual false, abstract: false, final false
