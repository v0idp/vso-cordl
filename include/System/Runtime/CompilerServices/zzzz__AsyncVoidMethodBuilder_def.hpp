...
/// @brief Method Create, addr 0x2681268, size 0x40, virtual false, abstract: false, final false
static inline ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder Create() ;

/// @brief Method NotifySynchronizationContextOfCompletion, addr 0x268142c, size 0xa4, virtual false, abstract: false, final false
inline void NotifySynchronizationContextOfCompletion() ;

/// @brief Method SetException, addr 0x26814d0, size 0x130, virtual false, abstract: false, final false
inline void SetException(::System::Exception*  exception) ;

/// @brief Method SetResult, addr 0x268136c, size 0x5c, virtual false, abstract: false, final false
inline void SetResult() ;

/// @brief Method SetStateMachine, addr 0x26812a8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_Task, addr 0x26813c8, size 0x64, virtual false, abstract: false, final false
