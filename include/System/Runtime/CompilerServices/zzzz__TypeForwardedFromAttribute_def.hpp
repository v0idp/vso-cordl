...
/// @brief Method .ctor, addr 0x26805c4, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  assemblyFullName) ;

/// @brief Method get_AssemblyFullName, addr 0x2680644, size 0x8, virtual false, abstract: false, final false
