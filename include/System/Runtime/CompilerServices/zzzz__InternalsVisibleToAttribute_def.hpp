...
/// @brief Method .ctor, addr 0x2682c84, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  assemblyName) ;

/// @brief Method set_AllInternalsVisible, addr 0x2682cb4, size 0xc, virtual false, abstract: false, final false
