...
/// @brief Method .ctor, addr 0x2682c54, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::CompilerServices::CompilationRelaxations  relaxations) ;

/// @brief Method .ctor, addr 0x2682c2c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  relaxations) ;

/// @brief Method get_CompilationRelaxations, addr 0x2682c7c, size 0x8, virtual false, abstract: false, final false
