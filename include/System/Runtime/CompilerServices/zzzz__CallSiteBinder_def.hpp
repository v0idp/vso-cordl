...
/// @brief Method .ctor, addr 0x29f4b10, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Linq::Expressions::LabelTarget* getStaticF__UpdateLabel_k__BackingField() ;

/// @brief Method get_UpdateLabel, addr 0x29f4b18, size 0x58, virtual false, abstract: false, final false
