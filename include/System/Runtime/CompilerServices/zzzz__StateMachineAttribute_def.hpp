...
/// @brief Method .ctor, addr 0x267faf0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  stateMachineType) ;

/// @brief Method get_StateMachineType, addr 0x2680540, size 0x8, virtual false, abstract: false, final false
