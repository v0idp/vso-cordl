...
/// @brief Method .ctor, addr 0x29f4ae0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::CompilerServices::CallSiteBinder*  binder) ;

/// @brief Method get_Binder, addr 0x29f4b08, size 0x8, virtual false, abstract: false, final false
