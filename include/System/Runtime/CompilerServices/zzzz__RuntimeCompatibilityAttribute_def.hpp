...
/// @brief Method .ctor, addr 0x2680278, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_WrapNonExceptionThrows, addr 0x2680280, size 0xc, virtual false, abstract: false, final false
