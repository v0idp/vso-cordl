...
/// @brief Method <OutputWaitEtwEvents>b__0, addr 0x2681094, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x268108c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetResult, addr 0x2680cb4, size 0x8, virtual false, abstract: false, final false
inline void GetResult() ;

/// @brief Method HandleNonSuccessAndDebuggerNotification, addr 0x2680d08, size 0x60, virtual false, abstract: false, final false
static inline void HandleNonSuccessAndDebuggerNotification(::System::Threading::Tasks::Task*  task) ;

/// @brief Method OnCompleted, addr 0x2680898, size 0x10, virtual true, abstract: false, final true
inline void OnCompleted(::System::Action*  continuation) ;

/// @brief Method OnCompletedInternal, addr 0x2680c04, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method OutputWaitEtwEvents, addr 0x2680eb4, size 0x1d8, virtual false, abstract: false, final false
static inline ::System::Action* OutputWaitEtwEvents(::System::Threading::Tasks::Task*  task, ::System::Action*  continuation) ;

/// @brief Method ThrowForNonSuccess, addr 0x2680d68, size 0x14c, virtual false, abstract: false, final false
static inline void ThrowForNonSuccess(::System::Threading::Tasks::Task*  task) ;

/// @brief Method UnsafeOnCompleted, addr 0x2680a34, size 0x10, virtual true, abstract: false, final true
inline void UnsafeOnCompleted(::System::Action*  continuation) ;

/// @brief Method ValidateEnd, addr 0x2680cbc, size 0x4c, virtual false, abstract: false, final false
static inline void ValidateEnd(::System::Threading::Tasks::Task*  task) ;

/// @brief Method .ctor, addr 0x2680be0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Threading::Tasks::Task*  task) ;

/// @brief Method get_IsCompleted, addr 0x2680be8, size 0x1c, virtual false, abstract: false, final false
