...
/// @brief Method .ctor, addr 0x268008c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  elementType, int32_t  length) ;

/// @brief Method get_ElementType, addr 0x26800bc, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_ElementType() ;

/// @brief Method get_Length, addr 0x26800c4, size 0x8, virtual false, abstract: false, final false
