...
/// @brief Method .ctor, addr 0x265b810, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  frameworkName) ;

/// @brief Method set_FrameworkDisplayName, addr 0x265b884, size 0x8, virtual false, abstract: false, final false
