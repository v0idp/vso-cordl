...
public:
// Declarations
/// @brief Method Memmove, addr 0x262ed94, size 0x4, virtual false, abstract: false, final false
static inline void Memmove(::cordl_internals::Ptr<uint8_t>  dest, ::cordl_internals::Ptr<uint8_t>  src, uint32_t  len) ;

/// @brief Method Memmove_wbarrier, addr 0x262ed98, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method RhZeroMemory, addr 0x262ed8c, size 0x4, virtual false, abstract: false, final false
static inline void RhZeroMemory(::ByRef<uint8_t>  b, uint64_t  byteLength) ;

/// @brief Method ZeroMemory, addr 0x262ed90, size 0x4, virtual false, abstract: false, final false
