...
/// @brief Method ToString, addr 0x267c448, size 0x1e0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x267c43c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x267c440, size 0x8, virtual false, abstract: false, final false
