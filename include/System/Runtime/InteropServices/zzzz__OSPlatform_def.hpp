...
/// @brief Method Create, addr 0x267be1c, size 0x20, virtual false, abstract: false, final false
static inline ::System::Runtime::InteropServices::OSPlatform Create(::StringW  osPlatform) ;

/// @brief Method Equals, addr 0x267beb8, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x267bea8, size 0x10, virtual false, abstract: false, final false
inline bool Equals(::StringW  other) ;

/// @brief Method Equals, addr 0x267be3c, size 0x6c, virtual true, abstract: false, final true
inline bool Equals(::System::Runtime::InteropServices::OSPlatform  other) ;

/// @brief Method GetHashCode, addr 0x267bf60, size 0x18, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x267bf78, size 0x54, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x267bd68, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method get_Linux, addr 0x267bc60, size 0x58, virtual false, abstract: false, final false
static inline ::System::Runtime::InteropServices::OSPlatform get_Linux() ;

/// @brief Method get_OSX, addr 0x267bcb8, size 0x58, virtual false, abstract: false, final false
static inline ::System::Runtime::InteropServices::OSPlatform get_OSX() ;

/// @brief Method get_Windows, addr 0x267bd10, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x267bfcc, size 0x6c, virtual false, abstract: false, final false
