...
/// @brief Method Close, addr 0x267cbc0, size 0x10, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method DangerousAddRef, addr 0x267c25c, size 0xc4, virtual false, abstract: false, final false
inline void DangerousAddRef(::ByRef<bool>  success) ;

/// @brief Method DangerousGetHandle, addr 0x267cbac, size 0x8, virtual false, abstract: false, final false
inline ::System::IntPtr DangerousGetHandle() ;

/// @brief Method DangerousRelease, addr 0x267c3c8, size 0x8, virtual false, abstract: false, final false
inline void DangerousRelease() ;

/// @brief Method DangerousReleaseInternal, addr 0x267cd34, size 0x160, virtual false, abstract: false, final false
inline void DangerousReleaseInternal(bool  dispose) ;

/// @brief Method Dispose, addr 0x267cbd0, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x267cbe0, size 0x1c, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x267cb04, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method InternalDispose, addr 0x267cbfc, size 0xa0, virtual false, abstract: false, final false
inline void InternalDispose() ;

/// @brief Method InternalFinalize, addr 0x267cc9c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method SetHandle, addr 0x267cba4, size 0x8, virtual false, abstract: false, final false
inline void SetHandle(::System::IntPtr  handle) ;

/// @brief Method SetHandleAsInvalid, addr 0x267ccb0, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x267ca64, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  invalidHandleValue, bool  ownsHandle) ;

/// @brief Method get_IsClosed, addr 0x267cbb4, size 0xc, virtual false, abstract: false, final false
