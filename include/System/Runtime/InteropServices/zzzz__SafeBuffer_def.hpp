...
/// @brief Method AcquirePointer, addr 0x267c120, size 0xd0, virtual false, abstract: false, final false
inline void AcquirePointer(::ByRef<::cordl_internals::Ptr<uint8_t>>  pointer) ;

/// @brief Method NotInitialized, addr 0x267c1f0, size 0x6c, virtual false, abstract: false, final false
static inline ::System::InvalidOperationException* NotInitialized() ;

/// @brief Method ReleasePointer, addr 0x267c320, size 0xa8, virtual false, abstract: false, final false
