...
/// @brief Method .ctor, addr 0x2755110, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2755130, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x275515c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, bool  error) ;

/// @brief Method get_IsError, addr 0x2755194, size 0x8, virtual false, abstract: false, final false
inline bool get_IsError() ;

/// @brief Method get_Message, addr 0x275518c, size 0x8, virtual false, abstract: false, final false
