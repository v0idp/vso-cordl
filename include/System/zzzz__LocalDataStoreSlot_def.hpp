...
/// @brief Method Finalize, addr 0x276eba8, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x276eb50, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::System::LocalDataStoreMgr*  mgr, int32_t  slot, int64_t  cookie) ;

/// @brief Method get_Cookie, addr 0x276eba0, size 0x8, virtual false, abstract: false, final false
inline int64_t get_Cookie() ;

/// @brief Method get_Manager, addr 0x276eb90, size 0x8, virtual false, abstract: false, final false
inline ::System::LocalDataStoreMgr* get_Manager() ;

/// @brief Method get_Slot, addr 0x276eb98, size 0x8, virtual false, abstract: false, final false
