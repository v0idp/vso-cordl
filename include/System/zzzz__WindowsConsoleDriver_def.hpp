...
/// @brief Method GetConsoleScreenBufferInfo, addr 0x279f53c, size 0x94, virtual false, abstract: false, final false
static inline bool GetConsoleScreenBufferInfo(::System::IntPtr  handle, ::ByRef<::System::ConsoleScreenBufferInfo>  info) ;

/// @brief Method GetStdHandle, addr 0x279f4b8, size 0x84, virtual false, abstract: false, final false
static inline ::System::IntPtr GetStdHandle(::System::Handles  handle) ;

/// @brief Method IsModifierKey, addr 0x279f810, size 0x34, virtual false, abstract: false, final false
static inline bool IsModifierKey(int16_t  virtualKeyCode) ;

static inline ::System::WindowsConsoleDriver* New_ctor() ;

/// @brief Method ReadConsoleInput, addr 0x279f708, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method ReadKey, addr 0x279f5d0, size 0x138, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x279f464, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;
