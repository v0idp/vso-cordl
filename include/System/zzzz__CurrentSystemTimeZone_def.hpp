...
/// @brief Method GetTimeZoneData, addr 0x2725508, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2725418, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;
