...
/// @brief Method ReadKey, addr 0x27958b8, size 0x5c, virtual true, abstract: false, final true
inline ::System::ConsoleKeyInfo ReadKey(bool  intercept) ;

/// @brief Method .ctor, addr 0x278e864, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
