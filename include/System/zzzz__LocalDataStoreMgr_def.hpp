...
/// @brief Method AllocateDataSlot, addr 0x276ef9c, size 0x234, virtual false, abstract: false, final false
inline ::System::LocalDataStoreSlot* AllocateDataSlot() ;

/// @brief Method AllocateNamedDataSlot, addr 0x276f1d0, size 0x11c, virtual false, abstract: false, final false
inline ::System::LocalDataStoreSlot* AllocateNamedDataSlot(::StringW  name) ;

/// @brief Method CreateLocalDataStore, addr 0x276edec, size 0x1b0, virtual false, abstract: false, final false
inline ::System::LocalDataStoreHolder* CreateLocalDataStore() ;

/// @brief Method DeleteLocalDataStore, addr 0x276e554, size 0x104, virtual false, abstract: false, final false
inline void DeleteLocalDataStore(::System::LocalDataStore*  store) ;

/// @brief Method FreeDataSlot, addr 0x276ec54, size 0x198, virtual false, abstract: false, final false
inline void FreeDataSlot(int32_t  slot, int64_t  cookie) ;

/// @brief Method FreeNamedDataSlot, addr 0x276f408, size 0x104, virtual false, abstract: false, final false
inline void FreeNamedDataSlot(::StringW  name) ;

/// @brief Method GetNamedDataSlot, addr 0x276f2ec, size 0x11c, virtual false, abstract: false, final false
inline ::System::LocalDataStoreSlot* GetNamedDataSlot(::StringW  name) ;

/// @brief Method GetSlotTableLength, addr 0x276eb34, size 0x1c, virtual false, abstract: false, final false
inline int32_t GetSlotTableLength() ;

static inline ::System::LocalDataStoreMgr* New_ctor() ;

/// @brief Method ValidateSlot, addr 0x276e728, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x276f50c, size 0xe8, virtual false, abstract: false, final false
inline void _ctor() ;
