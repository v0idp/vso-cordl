...
public:
// Declarations
/// @brief Method AppendArgument, addr 0x2cd8334, size 0x1dc, virtual false, abstract: false, final false
static inline void AppendArgument(::System::Text::StringBuilder*  stringBuilder, ::StringW  argument) ;

/// @brief Method ContainsNoWhitespaceOrQuotes, addr 0x2cd8510, size 0xc8, virtual false, abstract: false, final false
