...
/// @brief Method Compare, addr 0x275c3cc, size 0x18, virtual true, abstract: false, final false
inline int32_t Compare(::StringW  x, ::StringW  y) ;

/// @brief Method Equals, addr 0x275c3e4, size 0x18, virtual true, abstract: false, final false
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode, addr 0x275c3fc, size 0x64, virtual true, abstract: false, final false
inline int32_t GetHashCode(::StringW  obj) ;

/// @brief Method GetObjectData, addr 0x275c460, size 0xb4, virtual true, abstract: false, final true
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

static inline ::System::OrdinalIgnoreCaseComparer* New_ctor() ;

/// @brief Method .ctor, addr 0x275ba44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
