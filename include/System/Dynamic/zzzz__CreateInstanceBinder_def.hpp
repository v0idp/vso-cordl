...
public:
// Declarations
/// @brief Method Bind, addr 0x29f5f6c, size 0xc0, virtual true, abstract: false, final true
...
/// @brief Method FallbackCreateInstance, addr 0x29f5f5c, size 0x10, virtual false, abstract: false, final false
