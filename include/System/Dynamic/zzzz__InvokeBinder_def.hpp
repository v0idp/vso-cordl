...
public:
// Declarations
/// @brief Method Bind, addr 0x29fbd68, size 0xb8, virtual true, abstract: false, final true
...
/// @brief Method FallbackInvoke, addr 0x29fbd58, size 0x10, virtual false, abstract: false, final false
