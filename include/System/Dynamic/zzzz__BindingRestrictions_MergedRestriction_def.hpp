...
/// @brief Method GetExpression, addr 0x29f56d0, size 0x14c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29f4e48, size 0x70, virtual false, abstract: false, final false
