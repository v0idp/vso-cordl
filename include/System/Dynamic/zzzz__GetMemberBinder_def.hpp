...
/// @brief Method Bind, addr 0x29fbc74, size 0xa8, virtual true, abstract: false, final true
...
/// @brief Method FallbackGetMember, addr 0x29fa82c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29fbb84, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  ignoreCase) ;

/// @brief Method get_IgnoreCase, addr 0x29fbc6c, size 0x8, virtual false, abstract: false, final false
inline bool get_IgnoreCase() ;

/// @brief Method get_IsStandardBinder, addr 0x29fbd50, size 0x8, virtual true, abstract: false, final true
inline bool get_IsStandardBinder() ;

/// @brief Method get_Name, addr 0x29fbc64, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_ReturnType, addr 0x29fbbf8, size 0x6c, virtual true, abstract: false, final true
