...
public:
// Declarations
/// @brief Method GetParamName, addr 0x29fc380, size 0x94, virtual false, abstract: false, final false
static inline ::StringW GetParamName(::StringW  paramName, int32_t  index) ;

/// @brief Method Requires, addr 0x29fbd1c, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method RequiresNotNull, addr 0x29f9a98, size 0x4c, virtual false, abstract: false, final false
static inline void RequiresNotNull(::System::Object*  value, ::StringW  paramName) ;

/// @brief Method RequiresNotNull, addr 0x29fc328, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_Unreachable, addr 0x29fc2bc, size 0x6c, virtual false, abstract: false, final false
