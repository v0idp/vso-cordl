...
/// @brief Method FindNewClass, addr 0x29f7610, size 0x3c0, virtual false, abstract: false, final false
inline ::System::Dynamic::ExpandoClass* FindNewClass(::StringW  newKey) ;

/// @brief Method GetTransitionList, addr 0x29f79d0, size 0x12c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::System::WeakReference*>* GetTransitionList(int32_t  hashCode) ;

/// @brief Method GetValueIndex, addr 0x29f7afc, size 0x10, virtual false, abstract: false, final false
inline int32_t GetValueIndex(::StringW  name, bool  caseInsensitive, ::System::Dynamic::ExpandoObject*  obj) ;

/// @brief Method GetValueIndexCaseInsensitive, addr 0x29f7b0c, size 0x17c, virtual false, abstract: false, final false
inline int32_t GetValueIndexCaseInsensitive(::StringW  name, ::System::Dynamic::ExpandoObject*  obj) ;

/// @brief Method GetValueIndexCaseSensitive, addr 0x29f7c88, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29f7538, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x29f75e0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_Keys, addr 0x29f7da4, size 0x8, virtual false, abstract: false, final false
