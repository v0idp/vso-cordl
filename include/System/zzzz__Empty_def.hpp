...
/// @brief Method GetObjectData, addr 0x27783e4, size 0x68, virtual true, abstract: false, final true
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

static inline ::System::Empty* New_ctor() ;

/// @brief Method ToString, addr 0x277839c, size 0x48, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2778394, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
