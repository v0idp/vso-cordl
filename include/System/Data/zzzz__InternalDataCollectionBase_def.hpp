...
/// @brief Method CopyTo, addr 0x2a4d65c, size 0x48, virtual true, abstract: false, final false
inline void CopyTo(::System::Array*  ar, int32_t  index) ;

/// @brief Method GetEnumerator, addr 0x2a4d6a4, size 0x2c, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method NamesEqual, addr 0x2a4d6d8, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a4d790, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::ComponentModel::CollectionChangeEventArgs* getStaticF_s_refreshEventArgs() ;

/// @brief Method get_Count, addr 0x2a4d630, size 0x2c, virtual true, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsSynchronized, addr 0x2a4d6d0, size 0x8, virtual true, abstract: false, final true
inline bool get_IsSynchronized() ;

/// @brief Method get_List, addr 0x2a4d788, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* get_List() ;

/// @brief Method get_SyncRoot, addr 0x2a4d784, size 0x4, virtual true, abstract: false, final true
