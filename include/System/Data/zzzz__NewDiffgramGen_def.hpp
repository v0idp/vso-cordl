...
/// @brief Method CreateTableHierarchy, addr 0x2aafce4, size 0x384, virtual false, abstract: false, final false
inline void CreateTableHierarchy(::System::Data::DataTable*  dt) ;

/// @brief Method DoAssignments, addr 0x2aaf994, size 0x264, virtual false, abstract: false, final false
inline void DoAssignments(::System::Collections::ArrayList*  tables) ;

/// @brief Method EmptyData, addr 0x2ab0068, size 0xf4, virtual false, abstract: false, final false
inline bool EmptyData() ;

/// @brief Method GenerateColumn, addr 0x2ab10c4, size 0xa00, virtual false, abstract: false, final false
inline void GenerateColumn(::System::Data::DataRow*  row, ::System::Data::DataColumn*  col, ::System::Data::DataRowVersion  version) ;

/// @brief Method GenerateRow, addr 0x2ab0b24, size 0x5a0, virtual false, abstract: false, final false
inline void GenerateRow(::System::Data::DataRow*  row) ;

/// @brief Method GenerateTable, addr 0x2ab0568, size 0x7c, virtual false, abstract: false, final false
inline void GenerateTable(::System::Data::DataTable*  table) ;

/// @brief Method GenerateTableErrors, addr 0x2ab05e4, size 0x540, virtual false, abstract: false, final false
...
/// @brief Method QualifiedName, addr 0x2aaf81c, size 0x68, virtual false, abstract: false, final false
static inline ::StringW QualifiedName(::StringW  prefix, ::StringW  name) ;

/// @brief Method Save, addr 0x2ab015c, size 0x8, virtual false, abstract: false, final false
inline void Save(::System::Xml::XmlWriter*  xmlw) ;

/// @brief Method Save, addr 0x2ab0164, size 0x404, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2aaf884, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  ds) ;

/// @brief Method .ctor, addr 0x2aafbf8, size 0xec, virtual false, abstract: false, final false
