...
/// @brief Method IsArithmetical, addr 0x2a6f728, size 0x24, virtual false, abstract: false, final false
static inline bool IsArithmetical(int32_t  op) ;

/// @brief Method IsLogical, addr 0x2a6f6fc, size 0x2c, virtual false, abstract: false, final false
static inline bool IsLogical(int32_t  op) ;

/// @brief Method IsRelational, addr 0x2a6f6ec, size 0x10, virtual false, abstract: false, final false
static inline bool IsRelational(int32_t  op) ;

/// @brief Method Priority, addr 0x2a73348, size 0xac, virtual false, abstract: false, final false
static inline int32_t Priority(int32_t  op) ;

/// @brief Method ToString, addr 0x2a73288, size 0xc0, virtual false, abstract: false, final false
