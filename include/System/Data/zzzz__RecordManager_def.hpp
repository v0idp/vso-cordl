...
/// @brief Method Clear, addr 0x2a7cfc8, size 0x1ec, virtual false, abstract: false, final false
inline void Clear(bool  clearAll) ;

/// @brief Method CopyRecord, addr 0x2a7d1ec, size 0x314, virtual false, abstract: false, final false
inline int32_t CopyRecord(::System::Data::DataTable*  src, int32_t  record, int32_t  copy) ;

/// @brief Method FreeRecord, addr 0x2a7ce14, size 0x150, virtual false, abstract: false, final false
inline void FreeRecord(::ByRef<int32_t>  record) ;

/// @brief Method GrowRecordCapacity, addr 0x2a7cb0c, size 0x104, virtual false, abstract: false, final false
inline void GrowRecordCapacity() ;

/// @brief Method ImportRecord, addr 0x2a7d1e4, size 0x8, virtual false, abstract: false, final false
inline int32_t ImportRecord(::System::Data::DataTable*  src, int32_t  record) ;

/// @brief Method NewCapacity, addr 0x2a7cc10, size 0x14, virtual false, abstract: false, final false
static inline int32_t NewCapacity(int32_t  capacity) ;

/// @brief Method NewRecordBase, addr 0x2a7cd48, size 0xcc, virtual false, abstract: false, final false
inline int32_t NewRecordBase() ;

static inline ::System::Data::RecordManager* New_ctor(::System::Data::DataTable*  table) ;

/// @brief Method NormalizedMinimumCapacity, addr 0x2a7cc24, size 0x38, virtual false, abstract: false, final false
inline int32_t NormalizedMinimumCapacity(int32_t  capacity) ;

/// @brief Method SetRowCache, addr 0x2a7d500, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a7ca48, size 0xc4, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table) ;

/// @brief Method get_Item, addr 0x2a7d1b4, size 0x30, virtual false, abstract: false, final false
inline ::System::Data::DataRow* get_Item(int32_t  record) ;

/// @brief Method get_LastFreeRecord, addr 0x2a7ccec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LastFreeRecord() ;

/// @brief Method get_MinimumCapacity, addr 0x2a7ccf4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MinimumCapacity() ;

/// @brief Method get_RecordCapacity, addr 0x2a7cd40, size 0x8, virtual false, abstract: false, final false
inline int32_t get_RecordCapacity() ;

/// @brief Method set_Item, addr 0x2a7cf64, size 0x64, virtual false, abstract: false, final false
inline void set_Item(int32_t  record, ::System::Data::DataRow*  value) ;

/// @brief Method set_MinimumCapacity, addr 0x2a7ccfc, size 0x44, virtual false, abstract: false, final false
inline void set_MinimumCapacity(int32_t  value) ;

/// @brief Method set_RecordCapacity, addr 0x2a7cc5c, size 0x90, virtual false, abstract: false, final false
