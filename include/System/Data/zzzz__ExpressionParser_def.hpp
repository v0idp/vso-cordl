...
public:
// Declarations
/// @brief Method .ctor, addr 0x2a7409c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method BuildExpression, addr 0x2a727d8, size 0x228, virtual false, abstract: false, final false
inline void BuildExpression(int32_t  pri) ;

/// @brief Method CheckToken, addr 0x2a72cac, size 0x44, virtual false, abstract: false, final false
inline void CheckToken(::System::Data::Tokens  token) ;

/// @brief Method IsAlpha, addr 0x2a73d90, size 0x2c, virtual false, abstract: false, final false
inline bool IsAlpha(char16_t  ch) ;

/// @brief Method IsAlphaNumeric, addr 0x2a73c4c, size 0x3c, virtual false, abstract: false, final false
inline bool IsAlphaNumeric(char16_t  ch) ;

/// @brief Method IsDigit, addr 0x2a73a58, size 0x14, virtual false, abstract: false, final false
inline bool IsDigit(char16_t  ch) ;

/// @brief Method IsWhiteSpace, addr 0x2a73e0c, size 0x14, virtual false, abstract: false, final false
inline bool IsWhiteSpace(char16_t  ch) ;

/// @brief Method LoadExpression, addr 0x2a70ecc, size 0xc4, virtual false, abstract: false, final false
inline void LoadExpression(::StringW  data) ;

static inline ::System::Data::ExpressionParser* New_ctor(::System::Data::DataTable*  table) ;

/// @brief Method NodePeek, addr 0x2a72e50, size 0x44, virtual false, abstract: false, final false
inline ::System::Data::ExpressionNode* NodePeek() ;

/// @brief Method NodePop, addr 0x2a72ed4, size 0x3c, virtual false, abstract: false, final false
inline ::System::Data::ExpressionNode* NodePop() ;

/// @brief Method NodePush, addr 0x2a72dbc, size 0x94, virtual false, abstract: false, final false
inline void NodePush(::System::Data::ExpressionNode*  node) ;

/// @brief Method Parse, addr 0x2a71004, size 0xc98, virtual false, abstract: false, final false
inline ::System::Data::ExpressionNode* Parse() ;

/// @brief Method ParseAggregateArgument, addr 0x2a72f10, size 0x2a8, virtual false, abstract: false, final false
inline ::System::Data::ExpressionNode* ParseAggregateArgument(::System::Data::FunctionId  aggregate) ;

/// @brief Method Scan, addr 0x2a723ac, size 0x3a0, virtual false, abstract: false, final false
inline ::System::Data::Tokens Scan() ;

/// @brief Method ScanBinaryConstant, addr 0x2a73a54, size 0x4, virtual false, abstract: false, final false
inline void ScanBinaryConstant() ;

/// @brief Method ScanDate, addr 0x2a736ac, size 0xa0, virtual false, abstract: false, final false
inline void ScanDate() ;

/// @brief Method ScanName, addr 0x2a73c88, size 0x68, virtual false, abstract: false, final false
inline void ScanName() ;

/// @brief Method ScanName, addr 0x2a7381c, size 0x10c, virtual false, abstract: false, final false
inline void ScanName(char16_t  chEnd, char16_t  esc, ::StringW  charsToEscape) ;

/// @brief Method ScanNumeric, addr 0x2a73928, size 0x12c, virtual false, abstract: false, final false
inline void ScanNumeric() ;

/// @brief Method ScanReserved, addr 0x2a73a6c, size 0x1e0, virtual false, abstract: false, final false
inline void ScanReserved() ;

/// @brief Method ScanString, addr 0x2a7374c, size 0xd0, virtual false, abstract: false, final false
inline void ScanString(char16_t  escape) ;

/// @brief Method ScanToken, addr 0x2a72a90, size 0x28, virtual false, abstract: false, final false
inline void ScanToken(::System::Data::Tokens  token) ;

/// @brief Method ScanWhite, addr 0x2a73654, size 0x58, virtual false, abstract: false, final false
inline void ScanWhite() ;

/// @brief Method StartScan, addr 0x2a722e0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a70e28, size 0xa4, virtual false, abstract: false, final false
