...
/// @brief Method Add, addr 0x2a529f4, size 0xc, virtual false, abstract: false, final false
inline void Add(::System::Data::DataColumn*  column) ;

/// @brief Method AddAt, addr 0x2a52a00, size 0x25c, virtual false, abstract: false, final false
inline void AddAt(int32_t  index, ::System::Data::DataColumn*  column) ;

/// @brief Method AddColumnsImplementingIChangeTrackingList, addr 0x2a54370, size 0xcc, virtual false, abstract: false, final false
inline void AddColumnsImplementingIChangeTrackingList(::System::Data::DataColumn*  dataColumn) ;

/// @brief Method ArrayAdd, addr 0x2a52f9c, size 0x6c, virtual false, abstract: false, final false
inline void ArrayAdd(::System::Data::DataColumn*  column) ;

/// @brief Method ArrayAdd, addr 0x2a52f5c, size 0x40, virtual false, abstract: false, final false
inline void ArrayAdd(int32_t  index, ::System::Data::DataColumn*  column) ;

/// @brief Method ArrayRemove, addr 0x2a53364, size 0x130, virtual false, abstract: false, final false
inline void ArrayRemove(::System::Data::DataColumn*  column) ;

/// @brief Method AssignName, addr 0x2a53598, size 0x94, virtual false, abstract: false, final false
inline ::StringW AssignName() ;

/// @brief Method BaseAdd, addr 0x2a52c84, size 0x2d8, virtual false, abstract: false, final false
inline void BaseAdd(::System::Data::DataColumn*  column) ;

/// @brief Method BaseGroupSwitch, addr 0x2a53960, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method BaseRemove, addr 0x2a53b40, size 0xb8, virtual false, abstract: false, final false
inline void BaseRemove(::System::Data::DataColumn*  column) ;

/// @brief Method CanRegisterName, addr 0x2a54998, size 0x64, virtual false, abstract: false, final false
inline bool CanRegisterName(::StringW  name) ;

/// @brief Method CanRemove, addr 0x2a53bf8, size 0x668, virtual false, abstract: false, final false
inline bool CanRemove(::System::Data::DataColumn*  column, bool  fThrowException) ;

/// @brief Method CheckIChangeTracking, addr 0x2a5331c, size 0x48, virtual false, abstract: false, final false
inline void CheckIChangeTracking(::System::Data::DataColumn*  column) ;

/// @brief Method Clear, addr 0x2a5443c, size 0x2d4, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x2a54710, size 0x94, virtual false, abstract: false, final false
inline bool Contains(::StringW  name) ;

/// @brief Method Contains, addr 0x2a547a4, size 0x9c, virtual false, abstract: false, final false
inline bool Contains(::StringW  name, bool  caseSensitive) ;

/// @brief Method IndexOf, addr 0x2a54840, size 0x100, virtual false, abstract: false, final false
inline int32_t IndexOf(::StringW  columnName) ;

/// @brief Method IndexOfCaseInsensitive, addr 0x2a52800, size 0x150, virtual false, abstract: false, final false
inline int32_t IndexOfCaseInsensitive(::StringW  name) ;

/// @brief Method MakeName, addr 0x2a5362c, size 0xb8, virtual false, abstract: false, final false
inline ::StringW MakeName(int32_t  index) ;

static inline ::System::Data::DataColumnCollection* New_ctor(::System::Data::DataTable*  table) ;

/// @brief Method OnCollectionChanged, addr 0x2a53008, size 0xa4, virtual false, abstract: false, final false
inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method OnCollectionChanging, addr 0x2a52c5c, size 0x28, virtual false, abstract: false, final false
inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method OnColumnPropertyChanged, addr 0x2a54940, size 0x58, virtual false, abstract: false, final false
inline void OnColumnPropertyChanged(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method RegisterColumnName, addr 0x2a536e4, size 0x1c0, virtual false, abstract: false, final false
inline void RegisterColumnName(::StringW  name, ::System::Data::DataColumn*  column) ;

/// @brief Method Remove, addr 0x2a549fc, size 0x10c, virtual false, abstract: false, final false
inline void Remove(::System::Data::DataColumn*  column) ;

/// @brief Method RemoveColumnsImplementingIChangeTrackingList, addr 0x2a53494, size 0x104, virtual false, abstract: false, final false
inline void RemoveColumnsImplementingIChangeTrackingList(::System::Data::DataColumn*  dataColumn) ;

/// @brief Method UnregisterName, addr 0x2a538a4, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a52420, size 0x148, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table) ;

/// @brief Method add_CollectionChanged, addr 0x2a530ac, size 0x9c, virtual false, abstract: false, final false
inline void add_CollectionChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method add_ColumnPropertyChanged, addr 0x2a531e4, size 0x9c, virtual false, abstract: false, final false
inline void add_ColumnPropertyChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method get_ColumnsImplementingIChangeTracking, addr 0x2a52570, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ColumnsImplementingIChangeTracking() ;

/// @brief Method get_ColumnsImplementingIChangeTrackingCount, addr 0x2a52578, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ColumnsImplementingIChangeTrackingCount() ;

/// @brief Method get_ColumnsImplementingIRevertibleChangeTrackingCount, addr 0x2a52580, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ColumnsImplementingIRevertibleChangeTrackingCount() ;

/// @brief Method get_Item, addr 0x2a52588, size 0x130, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x2a526b8, size 0x148, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* get_Item(::StringW  name) ;

/// @brief Method get_Item, addr 0x2a52950, size 0xa4, virtual false, abstract: false, final false
inline ::System::Data::DataColumn* get_Item(::StringW  name, ::StringW  ns) ;

/// @brief Method get_List, addr 0x2a52568, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* get_List() ;

/// @brief Method remove_CollectionChanged, addr 0x2a53148, size 0x9c, virtual false, abstract: false, final false
inline void remove_CollectionChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method remove_ColumnPropertyChanged, addr 0x2a53280, size 0x9c, virtual false, abstract: false, final false
