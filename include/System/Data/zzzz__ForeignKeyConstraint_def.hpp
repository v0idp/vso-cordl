...
/// @brief Method CanBeRemovedFromCollection, addr 0x2a76728, size 0x8, virtual true, abstract: false, final false
inline bool CanBeRemovedFromCollection(::System::Data::ConstraintCollection*  constraints, bool  fThrowException) ;

/// @brief Method CanEnableConstraint, addr 0x2a76cac, size 0x16c, virtual true, abstract: false, final false
inline bool CanEnableConstraint() ;

/// @brief Method CascadeCommit, addr 0x2a76e18, size 0x150, virtual false, abstract: false, final false
inline void CascadeCommit(::System::Data::DataRow*  row) ;

/// @brief Method CascadeDelete, addr 0x2a76f78, size 0x4a0, virtual false, abstract: false, final false
inline void CascadeDelete(::System::Data::DataRow*  row) ;

/// @brief Method CascadeRollback, addr 0x2a7747c, size 0x1ec, virtual false, abstract: false, final false
inline void CascadeRollback(::System::Data::DataRow*  row) ;

/// @brief Method CascadeUpdate, addr 0x2a77668, size 0x464, virtual false, abstract: false, final false
inline void CascadeUpdate(::System::Data::DataRow*  row) ;

/// @brief Method CheckCanAddToCollection, addr 0x2a76600, size 0x128, virtual true, abstract: false, final false
inline void CheckCanAddToCollection(::System::Data::ConstraintCollection*  constraints) ;

/// @brief Method CheckCanClearParentTable, addr 0x2a77acc, size 0xdc, virtual false, abstract: false, final false
inline void CheckCanClearParentTable(::System::Data::DataTable*  table) ;

/// @brief Method CheckCanRemoveParentRow, addr 0x2a77ba8, size 0xac, virtual false, abstract: false, final false
inline void CheckCanRemoveParentRow(::System::Data::DataRow*  row) ;

/// @brief Method CheckCascade, addr 0x2a77c70, size 0x100, virtual false, abstract: false, final false
inline void CheckCascade(::System::Data::DataRow*  row, ::System::Data::DataRowAction  action) ;

/// @brief Method CheckConstraint, addr 0x2a77d70, size 0x2d4, virtual true, abstract: false, final false
inline void CheckConstraint(::System::Data::DataRow*  childRow, ::System::Data::DataRowAction  action) ;

/// @brief Method CheckState, addr 0x2a782a4, size 0x4, virtual true, abstract: false, final false
inline void CheckState() ;

/// @brief Method Clone, addr 0x2a78360, size 0x10, virtual true, abstract: false, final false
inline ::System::Data::Constraint* Clone(::System::Data::DataSet*  destination) ;

/// @brief Method Clone, addr 0x2a78370, size 0x738, virtual true, abstract: false, final false
inline ::System::Data::Constraint* Clone(::System::Data::DataSet*  destination, bool  ignorNSforTableLookup) ;

/// @brief Method Clone, addr 0x2a78ac4, size 0x604, virtual false, abstract: false, final false
inline ::System::Data::ForeignKeyConstraint* Clone(::System::Data::DataTable*  destination) ;

/// @brief Method ContainsColumn, addr 0x2a78318, size 0x48, virtual true, abstract: false, final false
inline bool ContainsColumn(::System::Data::DataColumn*  column) ;

/// @brief Method Create, addr 0x2a763b8, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x2a79138, size 0xf0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  key) ;

/// @brief Method FindParentRelation, addr 0x2a79250, size 0xc8, virtual false, abstract: false, final false
inline ::System::Data::DataRelation* FindParentRelation() ;

/// @brief Method GetHashCode, addr 0x2a79228, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IsConstraintViolated, addr 0x2a767f4, size 0x1f8, virtual true, abstract: false, final false
inline bool IsConstraintViolated() ;

/// @brief Method IsKeyNull, addr 0x2a76730, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method NonVirtualCheckState, addr 0x2a78044, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a7636c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a76520, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a7632c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_AcceptRejectRule, addr 0x2a782a8, size 0x1c, virtual true, abstract: false, final false
inline ::System::Data::AcceptRejectRule get_AcceptRejectRule() ;

/// @brief Method get_ChildColumnNames, addr 0x2a765f4, size 0xc, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_ChildColumnNames() ;

/// @brief Method get_ChildKey, addr 0x2a7658c, size 0x1c, virtual false, abstract: false, final false
inline ::System::Data::DataKey get_ChildKey() ;

/// @brief Method get_Columns, addr 0x2a765a8, size 0x20, virtual true, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_Columns() ;

/// @brief Method get_DeleteRule, addr 0x2a790c8, size 0x1c, virtual true, abstract: false, final false
inline ::System::Data::Rule get_DeleteRule() ;

/// @brief Method get_ParentColumnNames, addr 0x2a765e8, size 0xc, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_ParentColumnNames() ;

/// @brief Method get_ParentKey, addr 0x2a77c54, size 0x1c, virtual false, abstract: false, final false
inline ::System::Data::DataKey get_ParentKey() ;

/// @brief Method get_RelatedColumns, addr 0x2a79230, size 0x20, virtual true, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_RelatedColumns() ;

/// @brief Method get_RelatedColumnsReference, addr 0x2a78aa8, size 0x1c, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_RelatedColumnsReference() ;

/// @brief Method get_RelatedTable, addr 0x2a79318, size 0x20, virtual true, abstract: false, final false
inline ::System::Data::DataTable* get_RelatedTable() ;

/// @brief Method get_Table, addr 0x2a765c8, size 0x20, virtual true, abstract: false, final false
inline ::System::Data::DataTable* get_Table() ;

/// @brief Method get_UpdateRule, addr 0x2a79338, size 0x1c, virtual true, abstract: false, final false
inline ::System::Data::Rule get_UpdateRule() ;

/// @brief Method set_AcceptRejectRule, addr 0x2a782c4, size 0x54, virtual true, abstract: false, final false
inline void set_AcceptRejectRule(::System::Data::AcceptRejectRule  value) ;

/// @brief Method set_DeleteRule, addr 0x2a790e4, size 0x54, virtual true, abstract: false, final false
inline void set_DeleteRule(::System::Data::Rule  value) ;

/// @brief Method set_UpdateRule, addr 0x2a79354, size 0x54, virtual true, abstract: false, final false
