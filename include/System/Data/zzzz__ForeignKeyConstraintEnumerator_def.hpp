...
public:
// Declarations
/// @brief Method GetForeignKeyConstraint, addr 0x2a52014, size 0x78, virtual false, abstract: false, final false
inline ::System::Data::ForeignKeyConstraint* GetForeignKeyConstraint() ;

/// @brief Method IsValidCandidate, addr 0x2a51f9c, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a51f98, size 0x4, virtual false, abstract: false, final false
