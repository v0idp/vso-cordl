...
/// @brief Method GetSrcKey, addr 0x2a7b86c, size 0x148, virtual false, abstract: false, final false
inline ::System::Data::DataKey GetSrcKey(::System::Data::DataTable*  src, ::System::Data::DataTable*  dst) ;

/// @brief Method MergeConstraints, addr 0x2a7a744, size 0x70, virtual false, abstract: false, final false
inline void MergeConstraints(::System::Data::DataSet*  source) ;

/// @brief Method MergeConstraints, addr 0x2a7c0c4, size 0x2b0, virtual false, abstract: false, final false
inline void MergeConstraints(::System::Data::DataTable*  table) ;

/// @brief Method MergeDataSet, addr 0x2a795d0, size 0x10ec, virtual false, abstract: false, final false
inline void MergeDataSet(::System::Data::DataSet*  source) ;

/// @brief Method MergeExtendedProperties, addr 0x2a7af44, size 0x254, virtual false, abstract: false, final false
inline void MergeExtendedProperties(::System::Data::PropertyCollection*  src, ::System::Data::PropertyCollection*  dst) ;

/// @brief Method MergeRelation, addr 0x2a7a7b4, size 0x790, virtual false, abstract: false, final false
inline void MergeRelation(::System::Data::DataRelation*  relation) ;

/// @brief Method MergeSchema, addr 0x2a7b9b4, size 0x710, virtual false, abstract: false, final false
inline ::System::Data::DataTable* MergeSchema(::System::Data::DataTable*  table) ;

/// @brief Method MergeTable, addr 0x2a7b198, size 0x22c, virtual false, abstract: false, final false
inline void MergeTable(::System::Data::DataTable*  src) ;

/// @brief Method MergeTable, addr 0x2a7b3c4, size 0x4a8, virtual false, abstract: false, final false
inline void MergeTable(::System::Data::DataTable*  src, ::System::Data::DataTable*  dst) ;

/// @brief Method MergeTableData, addr 0x2a7a6bc, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a79538, size 0x48, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  dataSet, bool  preserveChanges, ::System::Data::MissingSchemaAction  missingSchemaAction) ;

/// @brief Method .ctor, addr 0x2a79580, size 0x50, virtual false, abstract: false, final false
