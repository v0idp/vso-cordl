...
/// @brief Method Bind, addr 0x2a71c9c, size 0xe8, virtual false, abstract: false, final false
inline void Bind(::System::Data::DataTable*  table) ;

/// @brief Method DependsOn, addr 0x2a6787c, size 0x1c, virtual false, abstract: false, final false
inline bool DependsOn(::System::Data::DataColumn*  column) ;

/// @brief Method Evaluate, addr 0x2a71de4, size 0xc, virtual false, abstract: false, final false
inline ::System::Object* Evaluate() ;

/// @brief Method Evaluate, addr 0x2a71df0, size 0x1f4, virtual false, abstract: false, final false
inline ::System::Object* Evaluate(::System::Data::DataRow*  row, ::System::Data::DataRowVersion  version) ;

/// @brief Method GetDependency, addr 0x2a721e0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> GetDependency() ;

/// @brief Method HasLocalAggregate, addr 0x2a72258, size 0x18, virtual false, abstract: false, final false
inline bool HasLocalAggregate() ;

/// @brief Method HasRemoteAggregate, addr 0x2a72270, size 0x18, virtual false, abstract: false, final false
inline bool HasRemoteAggregate() ;

/// @brief Method Invoke, addr 0x2a72070, size 0xdc, virtual true, abstract: false, final true
inline bool Invoke(::System::Data::DataRow*  row, ::System::Data::DataRowVersion  version) ;

/// @brief Method IsTableAggregate, addr 0x2a721e8, size 0x18, virtual false, abstract: false, final false
inline bool IsTableAggregate() ;

/// @brief Method IsUnknown, addr 0x2a72200, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method ToBoolean, addr 0x2a6e914, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a64fe4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table, ::StringW  expression) ;

/// @brief Method .ctor, addr 0x2a70c84, size 0x1a4, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table, ::StringW  expression, ::System::Type*  type) ;

/// @brief Method get_Expression, addr 0x2a71d84, size 0x50, virtual false, abstract: false, final false
inline ::StringW get_Expression() ;

/// @brief Method get_HasValue, addr 0x2a71dd4, size 0x10, virtual false, abstract: false, final false
