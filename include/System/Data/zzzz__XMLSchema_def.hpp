...
public:
// Declarations
/// @brief Method FEqualIdentity, addr 0x2a844f8, size 0x74, virtual false, abstract: false, final false
static inline bool FEqualIdentity(::System::Xml::XmlNode*  node, ::StringW  name, ::StringW  ns) ;

/// @brief Method GenUniqueColumnName, addr 0x2a8629c, size 0x124, virtual false, abstract: false, final false
static inline ::StringW GenUniqueColumnName(::StringW  proposedName, ::System::Data::DataTable*  table) ;

/// @brief Method GetBooleanAttribute, addr 0x2a8a28c, size 0x150, virtual false, abstract: false, final false
static inline bool GetBooleanAttribute(::System::Xml::XmlElement*  element, ::StringW  attrName, ::StringW  attrNS, bool  defVal) ;

/// @brief Method GetConverter, addr 0x2a8a234, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method SetProperties, addr 0x2a866f8, size 0x44c, virtual false, abstract: false, final false
static inline void SetProperties(::System::Object*  instance, ::System::Xml::XmlAttributeCollection*  attrs) ;

/// @brief Method .ctor, addr 0x2a842e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
