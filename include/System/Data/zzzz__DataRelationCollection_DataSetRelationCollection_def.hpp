...
/// @brief Method AddCore, addr 0x2a5ba00, size 0x534, virtual true, abstract: false, final false
inline void AddCore(::System::Data::DataRelation*  relation) ;

/// @brief Method Clear, addr 0x2a5b7d8, size 0x34, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method GetDataSet, addr 0x2a5b80c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method RemoveCore, addr 0x2a5bf34, size 0x230, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a5b740, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  dataSet) ;

/// @brief Method get_Item, addr 0x2a5b814, size 0x100, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x2a5b914, size 0xec, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(::StringW  name) ;

/// @brief Method get_List, addr 0x2a5b7d0, size 0x8, virtual true, abstract: false, final false
