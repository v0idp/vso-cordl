...
/// @brief Method BindTable, addr 0x2a72298, size 0x8, virtual false, abstract: false, final false
inline void BindTable(::System::Data::DataTable*  table) ;

/// @brief Method DependsOn, addr 0x2a722a0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method IsFloat, addr 0x2a722a8, size 0x10, virtual false, abstract: false, final false
static inline bool IsFloat(::System::Data::Common::StorageType  type) ;

/// @brief Method IsFloatSql, addr 0x2a722b8, size 0x28, virtual false, abstract: false, final false
static inline bool IsFloatSql(::System::Data::Common::StorageType  type) ;

/// @brief Method IsInteger, addr 0x2a6f76c, size 0x10, virtual false, abstract: false, final false
static inline bool IsInteger(::System::Data::Common::StorageType  type) ;

/// @brief Method IsIntegerSql, addr 0x2a6f388, size 0x2c, virtual false, abstract: false, final false
static inline bool IsIntegerSql(::System::Data::Common::StorageType  type) ;

/// @brief Method IsNumeric, addr 0x2a6f74c, size 0x20, virtual false, abstract: false, final false
static inline bool IsNumeric(::System::Data::Common::StorageType  type) ;

/// @brief Method IsNumericSql, addr 0x2a6f87c, size 0x2c, virtual false, abstract: false, final false
static inline bool IsNumericSql(::System::Data::Common::StorageType  type) ;

/// @brief Method IsSigned, addr 0x2a6f5bc, size 0x30, virtual false, abstract: false, final false
static inline bool IsSigned(::System::Data::Common::StorageType  type) ;

/// @brief Method IsSignedSql, addr 0x2a6f698, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method IsUnsigned, addr 0x2a6f5ec, size 0x20, virtual false, abstract: false, final false
static inline bool IsUnsigned(::System::Data::Common::StorageType  type) ;

/// @brief Method IsUnsignedSql, addr 0x2a6f6c4, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a66e1c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table) ;

/// @brief Method get_FormatProvider, addr 0x2a6e8a8, size 0x6c, virtual false, abstract: false, final false
inline ::System::IFormatProvider* get_FormatProvider() ;

/// @brief Method get_IsSqlColumn, addr 0x2a72288, size 0x8, virtual true, abstract: false, final false
inline bool get_IsSqlColumn() ;

/// @brief Method get_table, addr 0x2a72290, size 0x8, virtual false, abstract: false, final false
