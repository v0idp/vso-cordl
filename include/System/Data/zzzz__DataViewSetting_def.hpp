...
/// @brief Method SetDataTable, addr 0x2a6681c, size 0x14, virtual false, abstract: false, final false
inline void SetDataTable(::System::Data::DataTable*  table) ;

/// @brief Method SetDataViewManager, addr 0x2a66808, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a667a0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ApplyDefaultSort, addr 0x2a66800, size 0x8, virtual false, abstract: false, final false
inline bool get_ApplyDefaultSort() ;

/// @brief Method get_RowFilter, addr 0x2a66830, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_RowFilter() ;

/// @brief Method get_RowStateFilter, addr 0x2a66838, size 0x8, virtual false, abstract: false, final false
inline ::System::Data::DataViewRowState get_RowStateFilter() ;

/// @brief Method get_Sort, addr 0x2a66840, size 0x8, virtual false, abstract: false, final false
