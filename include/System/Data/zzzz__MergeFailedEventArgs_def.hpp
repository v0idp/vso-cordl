...
/// @brief Method .ctor, addr 0x2a793a8, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table, ::StringW  conflict) ;

/// @brief Method get_Conflict, addr 0x2a79418, size 0x8, virtual false, abstract: false, final false
