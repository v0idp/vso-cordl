...
/// @brief Method SqlTypeExceptionSerialization, addr 0x2acd380, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2acd2ac, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2acc04c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x2acd30c, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::System::Exception*  e) ;

/// @brief Method .ctor, addr 0x2acd330, size 0x50, virtual false, abstract: false, final false
