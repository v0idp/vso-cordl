...
/// @brief Method SqlNullValueExceptionSerialization, addr 0x2acd500, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2aca2dc, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2acd478, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x2acd454, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::System::Exception*  e) ;

/// @brief Method .ctor, addr 0x2acd4a0, size 0x60, virtual false, abstract: false, final false
