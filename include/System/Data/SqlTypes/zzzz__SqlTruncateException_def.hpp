...
/// @brief Method SqlTruncateExceptionSerialization, addr 0x2acd6b8, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2acd5d4, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2acd630, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  message) ;

/// @brief Method .ctor, addr 0x2acd60c, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::System::Exception*  e) ;

/// @brief Method .ctor, addr 0x2acd658, size 0x60, virtual false, abstract: false, final false
