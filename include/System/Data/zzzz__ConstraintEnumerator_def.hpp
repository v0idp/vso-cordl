...
/// @brief Method GetConstraint, addr 0x2a51f80, size 0x8, virtual false, abstract: false, final false
inline ::System::Data::Constraint* GetConstraint() ;

/// @brief Method GetNext, addr 0x2a51ca0, size 0x2e0, virtual false, abstract: false, final false
inline bool GetNext() ;

/// @brief Method IsValidCandidate, addr 0x2a51f88, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a51c4c, size 0x54, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  dataSet) ;

/// @brief Method get_CurrentObject, addr 0x2a51f90, size 0x8, virtual false, abstract: false, final false
