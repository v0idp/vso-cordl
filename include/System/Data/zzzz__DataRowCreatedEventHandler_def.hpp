...
public:
// Declarations
/// @brief Method Invoke, addr 0x2a600d0, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a5ffcc, size 0x104, virtual false, abstract: false, final false
