...
/// @brief Method Add, addr 0x2a61250, size 0x29c, virtual false, abstract: false, final false
inline void Add(::System::Data::DataTable*  table) ;

/// @brief Method ArrayAdd, addr 0x2a616d0, size 0x24, virtual false, abstract: false, final false
inline void ArrayAdd(::System::Data::DataTable*  table) ;

/// @brief Method AssignName, addr 0x2a617c4, size 0x48, virtual false, abstract: false, final false
inline ::StringW AssignName() ;

/// @brief Method BaseAdd, addr 0x2a615bc, size 0x114, virtual false, abstract: false, final false
inline void BaseAdd(::System::Data::DataTable*  table) ;

/// @brief Method BaseGroupSwitch, addr 0x2a61b3c, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method BaseRemove, addr 0x2a61cb4, size 0x78, virtual false, abstract: false, final false
inline void BaseRemove(::System::Data::DataTable*  table) ;

/// @brief Method CanRemove, addr 0x2a61d2c, size 0x464, virtual false, abstract: false, final false
inline bool CanRemove(::System::Data::DataTable*  table, bool  fThrowException) ;

/// @brief Method Clear, addr 0x2a6229c, size 0x2c8, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x2a618c4, size 0x18, virtual false, abstract: false, final false
inline bool Contains(::StringW  name) ;

/// @brief Method Contains, addr 0x2a626d8, size 0x128, virtual false, abstract: false, final false
inline bool Contains(::StringW  name, bool  caseSensitive) ;

/// @brief Method Contains, addr 0x2a62564, size 0x174, virtual false, abstract: false, final false
inline bool Contains(::StringW  name, ::StringW  tableNamespace, bool  checkProperty, bool  caseSensitive) ;

/// @brief Method GetTable, addr 0x2a60ff8, size 0x11c, virtual false, abstract: false, final false
inline ::System::Data::DataTable* GetTable(::StringW  name, ::StringW  ns) ;

/// @brief Method GetTableSmart, addr 0x2a61114, size 0x13c, virtual false, abstract: false, final false
inline ::System::Data::DataTable* GetTableSmart(::StringW  name, ::StringW  ns) ;

/// @brief Method IndexOf, addr 0x2a62800, size 0xe4, virtual false, abstract: false, final false
inline int32_t IndexOf(::System::Data::DataTable*  table) ;

/// @brief Method IndexOf, addr 0x2a628e4, size 0x18, virtual false, abstract: false, final false
inline int32_t IndexOf(::StringW  tableName) ;

/// @brief Method IndexOf, addr 0x2a628fc, size 0x60, virtual false, abstract: false, final false
inline int32_t IndexOf(::StringW  tableName, ::StringW  tableNamespace, bool  chekforNull) ;

/// @brief Method InternalIndexOf, addr 0x2a60ca4, size 0x1c8, virtual false, abstract: false, final false
inline int32_t InternalIndexOf(::StringW  tableName) ;

/// @brief Method InternalIndexOf, addr 0x2a60e6c, size 0x18c, virtual false, abstract: false, final false
inline int32_t InternalIndexOf(::StringW  tableName, ::StringW  tableNamespace) ;

/// @brief Method MakeName, addr 0x2a6180c, size 0xb8, virtual false, abstract: false, final false
inline ::StringW MakeName(int32_t  index) ;

static inline ::System::Data::DataTableCollection* New_ctor(::System::Data::DataSet*  dataSet) ;

/// @brief Method OnCollectionChanged, addr 0x2a616f4, size 0xd0, virtual false, abstract: false, final false
inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method OnCollectionChanging, addr 0x2a614ec, size 0xd0, virtual false, abstract: false, final false
inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method RegisterName, addr 0x2a618dc, size 0x260, virtual false, abstract: false, final false
inline void RegisterName(::StringW  name, ::StringW  tbNamespace) ;

/// @brief Method Remove, addr 0x2a629ac, size 0x1fc, virtual false, abstract: false, final false
inline void Remove(::System::Data::DataTable*  table) ;

/// @brief Method ReplaceFromInference, addr 0x2a6295c, size 0x50, virtual false, abstract: false, final false
inline void ReplaceFromInference(::System::Collections::Generic::List_1<::System::Data::DataTable*>*  tableList) ;

/// @brief Method UnregisterName, addr 0x2a62190, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a60920, size 0x150, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataSet*  dataSet) ;

static inline int32_t getStaticF_s_objectTypeCount() ;

/// @brief Method get_Item, addr 0x2a60a80, size 0x130, virtual false, abstract: false, final false
inline ::System::Data::DataTable* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x2a60bb0, size 0xf4, virtual false, abstract: false, final false
inline ::System::Data::DataTable* get_Item(::StringW  name) ;

/// @brief Method get_Item, addr 0x2a597b4, size 0x108, virtual false, abstract: false, final false
inline ::System::Data::DataTable* get_Item(::StringW  name, ::StringW  tableNamespace) ;

/// @brief Method get_List, addr 0x2a60a70, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* get_List() ;

/// @brief Method get_ObjectID, addr 0x2a60a78, size 0x8, virtual false, abstract: false, final false
