...
/// @brief Method CheckConstraint, addr 0x2a4f388, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method CheckStateForProperty, addr 0x2a4f3dc, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2a4f4dc, size 0xc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a4f4e8, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ConstraintName, addr 0x2a4ee2c, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_ConstraintName() ;

/// @brief Method get_ExtendedProperties, addr 0x2a4f324, size 0x64, virtual false, abstract: false, final false
inline ::System::Data::PropertyCollection* get_ExtendedProperties() ;

/// @brief Method get_InCollection, addr 0x2a4f2d8, size 0x8, virtual true, abstract: false, final false
inline bool get_InCollection() ;

/// @brief Method get_SchemaName, addr 0x2a4f270, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method get__DataSet, addr 0x2a4f4d4, size 0x8, virtual true, abstract: false, final false
inline ::System::Data::DataSet* get__DataSet() ;

/// @brief Method set_ConstraintName, addr 0x2a4ee34, size 0x1d4, virtual true, abstract: false, final false
inline void set_ConstraintName(::StringW  value) ;

/// @brief Method set_InCollection, addr 0x2a4f2e0, size 0x44, virtual true, abstract: false, final false
inline void set_InCollection(bool  value) ;

/// @brief Method set_SchemaName, addr 0x2a4f2a8, size 0x30, virtual false, abstract: false, final false
