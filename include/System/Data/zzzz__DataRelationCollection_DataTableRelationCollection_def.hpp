...
/// @brief Method AddCache, addr 0x2a5b4a4, size 0x48, virtual false, abstract: false, final false
inline void AddCache(::System::Data::DataRelation*  relation) ;

/// @brief Method AddCore, addr 0x2a5b4ec, size 0xc0, virtual true, abstract: false, final false
inline void AddCore(::System::Data::DataRelation*  relation) ;

/// @brief Method EnsureDataSet, addr 0x2a5b118, size 0x44, virtual false, abstract: false, final false
inline void EnsureDataSet() ;

/// @brief Method GetDataSet, addr 0x2a5b15c, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method RemoveCache, addr 0x2a5b5ac, size 0xd4, virtual false, abstract: false, final false
inline void RemoveCache(::System::Data::DataRelation*  relation) ;

/// @brief Method RemoveCore, addr 0x2a5b680, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a5b06c, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataTable*  table, bool  fParentCollection) ;

/// @brief Method add_RelationPropertyChanged, addr 0x2a5b36c, size 0x9c, virtual false, abstract: false, final false
inline void add_RelationPropertyChanged(::System::ComponentModel::CollectionChangeEventHandler*  value) ;

/// @brief Method get_Item, addr 0x2a5b180, size 0x100, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x2a5b280, size 0xec, virtual true, abstract: false, final false
inline ::System::Data::DataRelation* get_Item(::StringW  name) ;

/// @brief Method get_List, addr 0x2a5b110, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* get_List() ;

/// @brief Method remove_RelationPropertyChanged, addr 0x2a5b408, size 0x9c, virtual false, abstract: false, final false
