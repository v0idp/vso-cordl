...
/// @brief Method EnterScope, addr 0x2a4ece8, size 0xc4, virtual false, abstract: false, final false
inline int64_t EnterScope(::StringW  message) ;

/// @brief Method ExitScope, addr 0x2a4edac, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Trace, addr 0x2a4ecd8, size 0x10, virtual false, abstract: false, final false
inline void Trace(::StringW  message) ;

/// @brief Method .ctor, addr 0x2a4edbc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
