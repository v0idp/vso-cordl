...
/// @brief Method CheckNull, addr 0x2a7ca10, size 0x38, virtual false, abstract: false, final false
inline void CheckNull() ;

/// @brief Method .ctor, addr 0x2a7c9c4, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(int32_t  min, int32_t  max) ;

/// @brief Method get_Count, addr 0x2a77418, size 0x20, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsNull, addr 0x2a76f68, size 0x10, virtual false, abstract: false, final false
inline bool get_IsNull() ;

/// @brief Method get_Min, addr 0x2a77438, size 0x18, virtual false, abstract: false, final false
