...
/// @brief Method CanBeRemovedFromCollection, addr 0x2a831a0, size 0x16c, virtual true, abstract: false, final false
inline bool CanBeRemovedFromCollection(::System::Data::ConstraintCollection*  constraints, bool  fThrowException) ;

/// @brief Method CanEnableConstraint, addr 0x2a8330c, size 0x4c, virtual true, abstract: false, final false
inline bool CanEnableConstraint() ;

/// @brief Method CheckCanAddToCollection, addr 0x2a8319c, size 0x4, virtual true, abstract: false, final false
inline void CheckCanAddToCollection(::System::Data::ConstraintCollection*  constraints) ;

/// @brief Method CheckConstraint, addr 0x2a835b8, size 0xf8, virtual true, abstract: false, final false
inline void CheckConstraint(::System::Data::DataRow*  row, ::System::Data::DataRowAction  action) ;

/// @brief Method CheckState, addr 0x2a83184, size 0xc, virtual true, abstract: false, final false
inline void CheckState() ;

/// @brief Method Clone, addr 0x2a836c4, size 0x10, virtual true, abstract: false, final false
inline ::System::Data::Constraint* Clone(::System::Data::DataSet*  destination) ;

/// @brief Method Clone, addr 0x2a836d4, size 0x550, virtual true, abstract: false, final false
inline ::System::Data::Constraint* Clone(::System::Data::DataSet*  destination, bool  ignorNSforTableLookup) ;

/// @brief Method Clone, addr 0x2a83c24, size 0x4b4, virtual false, abstract: false, final false
inline ::System::Data::UniqueConstraint* Clone(::System::Data::DataTable*  table) ;

/// @brief Method ConstraintIndexClear, addr 0x2a8312c, size 0x20, virtual false, abstract: false, final false
inline void ConstraintIndexClear() ;

/// @brief Method ConstraintIndexInitialize, addr 0x2a8314c, size 0x38, virtual false, abstract: false, final false
inline void ConstraintIndexInitialize() ;

/// @brief Method ContainsColumn, addr 0x2a836b8, size 0xc, virtual true, abstract: false, final false
inline bool ContainsColumn(::System::Data::DataColumn*  column) ;

/// @brief Method Create, addr 0x2a82f48, size 0xec, virtual false, abstract: false, final false
inline void Create(::StringW  constraintName, ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*>  columns) ;

/// @brief Method Equals, addr 0x2a84128, size 0xb8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  key2) ;

/// @brief Method GetHashCode, addr 0x2a841e0, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IsConstraintViolated, addr 0x2a83358, size 0x260, virtual true, abstract: false, final false
...
/// @brief Method NonVirtualCheckState, addr 0x2a83190, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a82e98, size 0xb0, virtual false, abstract: false, final false
inline void _ctor(::System::Data::DataColumn*  column) ;

/// @brief Method .ctor, addr 0x2a83068, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*>  columns) ;

/// @brief Method .ctor, addr 0x2a83098, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::ArrayW<::StringW,::Array<::StringW>*>  columnNames, bool  isPrimaryKey) ;

/// @brief Method .ctor, addr 0x2a83034, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*>  columns) ;

/// @brief Method .ctor, addr 0x2a830d4, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*>  columns, bool  isPrimaryKey) ;

/// @brief Method get_ColumnNames, addr 0x2a83118, size 0xc, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_ColumnNames() ;

/// @brief Method get_Columns, addr 0x2a840d8, size 0xc, virtual true, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_Columns() ;

/// @brief Method get_ColumnsReference, addr 0x2a836b0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ColumnsReference() ;

/// @brief Method get_ConstraintIndex, addr 0x2a83124, size 0x8, virtual false, abstract: false, final false
inline ::System::Data::Index* get_ConstraintIndex() ;

/// @brief Method get_IsPrimaryKey, addr 0x2a840e4, size 0x44, virtual false, abstract: false, final false
inline bool get_IsPrimaryKey() ;

/// @brief Method get_Key, addr 0x2a84238, size 0x8, virtual false, abstract: false, final false
inline ::System::Data::DataKey get_Key() ;

/// @brief Method get_Table, addr 0x2a84240, size 0x34, virtual true, abstract: false, final false
inline ::System::Data::DataTable* get_Table() ;

/// @brief Method set_InCollection, addr 0x2a841e8, size 0x50, virtual true, abstract: false, final false
