...
/// @brief Method CheckNamespaceValidityForNestedRelations, addr 0x2a56fe0, size 0x3a4, virtual false, abstract: false, final false
inline void CheckNamespaceValidityForNestedRelations(::StringW  ns) ;

/// @brief Method CheckNestedRelations, addr 0x2a57384, size 0x410, virtual false, abstract: false, final false
inline void CheckNestedRelations() ;

/// @brief Method CheckState, addr 0x2a58f28, size 0x23c, virtual false, abstract: false, final false
inline void CheckState() ;

/// @brief Method CheckStateForProperty, addr 0x2a56a44, size 0xec, virtual false, abstract: false, final false
inline void CheckStateForProperty() ;

/// @brief Method Clone, addr 0x2a59164, size 0x650, virtual false, abstract: false, final false
inline ::System::Data::DataRelation* Clone(::System::Data::DataSet*  destination) ;

/// @brief Method Create, addr 0x2a5649c, size 0x2fc, virtual false, abstract: false, final false
...
/// @brief Method GetChildRows, addr 0x2a56c4c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method GetParentRow, addr 0x2a56da0, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method GetParentRows, addr 0x2a56d08, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method IsAutoGenerated, addr 0x2a59998, size 0x1d4, virtual false, abstract: false, final false
inline bool IsAutoGenerated(::System::Data::DataColumn*  col) ;

/// @brief Method IsKeyNull, addr 0x2a56b88, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method OnPropertyChanging, addr 0x2a598bc, size 0xd0, virtual false, abstract: false, final false
inline void OnPropertyChanging(::System::ComponentModel::PropertyChangedEventArgs*  pcevent) ;

/// @brief Method RaisePropertyChanging, addr 0x2a58d28, size 0x6c, virtual false, abstract: false, final false
inline void RaisePropertyChanging(::StringW  name) ;

/// @brief Method SetChildKeyConstraint, addr 0x2a58f20, size 0x8, virtual false, abstract: false, final false
inline void SetChildKeyConstraint(::System::Data::ForeignKeyConstraint*  value) ;

/// @brief Method SetDataSet, addr 0x2a56f7c, size 0x14, virtual false, abstract: false, final false
inline void SetDataSet(::System::Data::DataSet*  dataSet) ;

/// @brief Method SetParentKeyConstraint, addr 0x2a58e88, size 0x8, virtual false, abstract: false, final false
inline void SetParentKeyConstraint(::System::Data::UniqueConstraint*  value) ;

/// @brief Method ToString, addr 0x2a5998c, size 0xc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ValidateMultipleNestedRelations, addr 0x2a58858, size 0x4d0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a562a4, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a56798, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a567a0, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a56868, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a56940, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method get_CheckMultipleNested, addr 0x2a58f0c, size 0x8, virtual false, abstract: false, final false
inline bool get_CheckMultipleNested() ;

/// @brief Method get_ChildColumnNames, addr 0x2a56b80, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_ChildColumnNames() ;

/// @brief Method get_ChildColumns, addr 0x2a56a2c, size 0x18, virtual true, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ChildColumns() ;

/// @brief Method get_ChildColumnsReference, addr 0x2a56b30, size 0x18, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ChildColumnsReference() ;

/// @brief Method get_ChildKey, addr 0x2a54340, size 0x18, virtual false, abstract: false, final false
inline ::System::Data::DataKey get_ChildKey() ;

/// @brief Method get_ChildKeyConstraint, addr 0x2a58e90, size 0x18, virtual true, abstract: false, final false
inline ::System::Data::ForeignKeyConstraint* get_ChildKeyConstraint() ;

/// @brief Method get_ChildTable, addr 0x2a56b48, size 0x18, virtual true, abstract: false, final false
inline ::System::Data::DataTable* get_ChildTable() ;

/// @brief Method get_DataSet, addr 0x2a56b60, size 0x18, virtual true, abstract: false, final false
inline ::System::Data::DataSet* get_DataSet() ;

/// @brief Method get_ExtendedProperties, addr 0x2a58ea8, size 0x64, virtual false, abstract: false, final false
inline ::System::Data::PropertyCollection* get_ExtendedProperties() ;

/// @brief Method get_Nested, addr 0x2a57794, size 0x18, virtual true, abstract: false, final false
inline bool get_Nested() ;

/// @brief Method get_ObjectID, addr 0x2a59b6c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ObjectID() ;

/// @brief Method get_ParentColumnNames, addr 0x2a56b78, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_ParentColumnNames() ;

/// @brief Method get_ParentColumns, addr 0x2a56f90, size 0x18, virtual true, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ParentColumns() ;

/// @brief Method get_ParentColumnsReference, addr 0x2a56fa8, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::System::Data::DataColumn*,::Array<::System::Data::DataColumn*>*> get_ParentColumnsReference() ;

/// @brief Method get_ParentKey, addr 0x2a54358, size 0x18, virtual false, abstract: false, final false
inline ::System::Data::DataKey get_ParentKey() ;

/// @brief Method get_ParentKeyConstraint, addr 0x2a58e70, size 0x18, virtual true, abstract: false, final false
inline ::System::Data::UniqueConstraint* get_ParentKeyConstraint() ;

/// @brief Method get_ParentTable, addr 0x2a56fb0, size 0x18, virtual true, abstract: false, final false
inline ::System::Data::DataTable* get_ParentTable() ;

/// @brief Method get_RelationName, addr 0x2a56fc8, size 0x18, virtual true, abstract: false, final false
inline ::StringW get_RelationName() ;

static inline void setStaticF_s_objectTypeCount(int32_t  value) ;

/// @brief Method set_CheckMultipleNested, addr 0x2a58f14, size 0xc, virtual false, abstract: false, final false
inline void set_CheckMultipleNested(bool  value) ;

/// @brief Method set_Nested, addr 0x2a577ac, size 0x10ac, virtual true, abstract: false, final false
