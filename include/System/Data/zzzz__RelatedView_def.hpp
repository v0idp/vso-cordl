...
/// @brief Field _parentKey, offset 0xb0, size 0x10 
...
/// @brief Field _parentRowView, offset 0xc8, size 0x8 
...
/// @brief Method AddNew, addr 0x2a7d968, size 0x60, virtual true, abstract: false, final false
inline ::System::Data::DataRowView* AddNew() ;

/// @brief Method GetFilter, addr 0x2a7d964, size 0x4, virtual true, abstract: false, final false
inline ::System::Data::IFilter* GetFilter() ;

/// @brief Method GetParentValues, addr 0x2a7d744, size 0x98, virtual false, abstract: false, final false
inline ::ArrayW<::System::Object*,::Array<::System::Object*>*> GetParentValues() ;

/// @brief Method Invoke, addr 0x2a7d7dc, size 0x188, virtual true, abstract: false, final true
...
/// @brief Method SetIndex, addr 0x2a7d9c8, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a7d524, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a7d63c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Field _parentKey, offset: 0xb0, size: 0x10, def value: None
 ::System::Nullable_1<::System::Data::DataKey>  ____parentKey;

/// @brief Field _childKey, offset: 0xc0, size: 0x8, def value: None
 ::System::Data::DataKey  ____childKey;

/// @brief Field _parentRowView, offset: 0xc8, size: 0x8, def value: None
 ::System::Data::DataRowView*  ____parentRowView;

/// @brief Field _filterValues, offset: 0xd0, size: 0x8, def value: None
 ::ArrayW<::System::Object*,::Array<::System::Object*>*>  ____filterValues;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::System::Data::RelatedView, ____parentKey) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::System::Data::RelatedView, ____childKey) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::System::Data::RelatedView, ____parentRowView) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::System::Data::RelatedView, ____filterValues) == 0xd0, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::System::Data::RelatedView, 0xd8>, "Size mismatch!");
