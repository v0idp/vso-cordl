...
/// @brief Method Add, addr 0x2a59b7c, size 0x288, virtual false, abstract: false, final false
inline void Add(::System::Data::DataRelation*  relation) ;

/// @brief Method AddCore, addr 0x2a59e04, size 0x2a8, virtual true, abstract: false, final false
inline void AddCore(::System::Data::DataRelation*  relation) ;

/// @brief Method AssignName, addr 0x2a5a29c, size 0x24, virtual false, abstract: false, final false
inline ::StringW AssignName() ;

/// @brief Method Clear, addr 0x2a5a378, size 0x244, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x2a5a5bc, size 0x18, virtual true, abstract: false, final false
...
/// @brief Method InternalIndexOf, addr 0x2a5a5d4, size 0x178, virtual false, abstract: false, final false
inline int32_t InternalIndexOf(::StringW  name) ;

/// @brief Method MakeName, addr 0x2a5a2c0, size 0xb8, virtual false, abstract: false, final false
inline ::StringW MakeName(int32_t  index) ;

static inline ::System::Data::DataRelationCollection* New_ctor() ;

/// @brief Method OnCollectionChanged, addr 0x2a5a74c, size 0xd0, virtual true, abstract: false, final false
inline void OnCollectionChanged(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method OnCollectionChanging, addr 0x2a5a81c, size 0xd0, virtual true, abstract: false, final false
inline void OnCollectionChanging(::System::ComponentModel::CollectionChangeEventArgs*  ccevent) ;

/// @brief Method RegisterName, addr 0x2a5a8ec, size 0x1bc, virtual false, abstract: false, final false
inline void RegisterName(::StringW  name) ;

/// @brief Method Remove, addr 0x2a5aaa8, size 0x1ac, virtual false, abstract: false, final false
inline void Remove(::System::Data::DataRelation*  relation) ;

/// @brief Method RemoveAt, addr 0x2a5ac54, size 0x74, virtual false, abstract: false, final false
inline void RemoveAt(int32_t  index) ;

/// @brief Method RemoveCore, addr 0x2a5acc8, size 0x1e8, virtual true, abstract: false, final false
inline void RemoveCore(::System::Data::DataRelation*  relation) ;

/// @brief Method UnregisterName, addr 0x2a5aeb0, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a5afdc, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_CollectionChanged, addr 0x2a5a0ac, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method get_ObjectID, addr 0x2a59b74, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ObjectID() ;

/// @brief Method remove_CollectionChanged, addr 0x2a5a1a4, size 0xf8, virtual false, abstract: false, final false
