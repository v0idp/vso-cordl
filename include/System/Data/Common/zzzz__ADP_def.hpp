...
/// @brief Method Argument, addr 0x2ad4d18, size 0x90, virtual false, abstract: false, final false
static inline ::System::ArgumentException* Argument(::StringW  error) ;

/// @brief Method ArgumentOutOfRange, addr 0x2ad4da8, size 0x98, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* ArgumentOutOfRange(::StringW  message, ::StringW  parameterName) ;

/// @brief Method ArgumentOutOfRange, addr 0x2acc890, size 0x90, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* ArgumentOutOfRange(::StringW  parameterName) ;

/// @brief Method InvalidAcceptRejectRule, addr 0x2ad51b0, size 0xb0, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidAcceptRejectRule(::System::Data::AcceptRejectRule  value) ;

/// @brief Method InvalidEnumerationValue, addr 0x2ad50a4, size 0x10c, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidEnumerationValue(::System::Type*  type, int32_t  value) ;

/// @brief Method InvalidMissingSchemaAction, addr 0x2ad5260, size 0xb0, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidMissingSchemaAction(::System::Data::MissingSchemaAction  value) ;

/// @brief Method InvalidOperation, addr 0x2ad4830, size 0x90, virtual false, abstract: false, final false
static inline ::System::InvalidOperationException* InvalidOperation(::StringW  error) ;

/// @brief Method InvalidRule, addr 0x2ad5310, size 0xb0, virtual false, abstract: false, final false
static inline ::System::ArgumentOutOfRangeException* InvalidRule(::System::Data::Rule  value) ;

/// @brief Method InvalidSeekOrigin, addr 0x2ace900, size 0x6c, virtual false, abstract: false, final false
static inline ::System::Exception* InvalidSeekOrigin(::StringW  parameterName) ;

/// @brief Method IsCatchableExceptionType, addr 0x2acdc70, size 0x20c, virtual false, abstract: false, final false
static inline bool IsCatchableExceptionType(::System::Exception*  e) ;

/// @brief Method IsCatchableOrSecurityExceptionType, addr 0x2ad4ed0, size 0x1d4, virtual false, abstract: false, final false
static inline bool IsCatchableOrSecurityExceptionType(::System::Exception*  e) ;

/// @brief Method NotSupported, addr 0x2ad4e40, size 0x90, virtual false, abstract: false, final false
static inline ::System::NotSupportedException* NotSupported(::StringW  error) ;

/// @brief Method TraceException, addr 0x2ad4ba8, size 0x98, virtual false, abstract: false, final false
static inline void TraceException(::StringW  trace, ::System::Exception*  e) ;

/// @brief Method TraceExceptionAsReturnValue, addr 0x2ad4c40, size 0x6c, virtual false, abstract: false, final false
static inline void TraceExceptionAsReturnValue(::System::Exception*  e) ;

/// @brief Method TraceExceptionWithoutRethrow, addr 0x2ad4cac, size 0x6c, virtual false, abstract: false, final false
static inline void TraceExceptionWithoutRethrow(::System::Exception*  e) ;

/// @brief Method WrongType, addr 0x2acb4c0, size 0xc4, virtual false, abstract: false, final false
