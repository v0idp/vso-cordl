...
/// @brief Method Aggregate, addr 0x2ad779c, size 0x14, virtual true, abstract: false, final false
inline ::System::Object* Aggregate(::ArrayW<int32_t,::Array<int32_t>*>  recordNos, ::System::Data::AggregateType  kind) ;

/// @brief Method AggregateCount, addr 0x2ada1a0, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method CompareBits, addr 0x2ad59b4, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method ConvertObjectToXml, addr 0x2ada2d8, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method ConvertValue, addr 0x2ada26c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ConvertXmlToObject, addr 0x2ada298, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method CopyBits, addr 0x2ad6bd0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method CopyValueInternal, addr 0x2adb9b4, size 0x10, virtual false, abstract: false, final false
inline void CopyValueInternal(int32_t  record, ::System::Object*  store, ::System::Collections::BitArray*  nullbits, int32_t  storeIndex) ;

/// @brief Method CreateStorage, addr 0x2ada314, size 0x780, virtual false, abstract: false, final false
...
/// @brief Method DetermineIfValueType, addr 0x2ada148, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method GetBits, addr 0x2ad6ccc, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method GetEmptyStorageInternal, addr 0x2adb9a4, size 0x10, virtual false, abstract: false, final false
inline ::System::Object* GetEmptyStorageInternal(int32_t  recordCount) ;

/// @brief Method GetQualifiedName, addr 0x2adb9dc, size 0x70, virtual false, abstract: false, final false
static inline ::StringW GetQualifiedName(::System::Type*  type) ;

/// @brief Method GetStorageType, addr 0x2acf230, size 0x11c, virtual false, abstract: false, final false
static inline ::System::Data::Common::StorageType GetStorageType(::System::Type*  dataType) ;

/// @brief Method GetStringLength, addr 0x2ada274, size 0x8, virtual true, abstract: false, final false
inline int32_t GetStringLength(int32_t  record) ;

/// @brief Method GetType, addr 0x2ad16b8, size 0x138, virtual false, abstract: false, final false
static inline ::System::Type* GetType(::StringW  value) ;

/// @brief Method GetTypeStorage, addr 0x2adb2ec, size 0x7c, virtual false, abstract: false, final false
static inline ::System::Type* GetTypeStorage(::System::Data::Common::StorageType  storageType) ;

/// @brief Method HasValue, addr 0x2ad5b4c, size 0x28, virtual false, abstract: false, final false
inline bool HasValue(int32_t  recordNo) ;

/// @brief Method ImplementsINullableValue, addr 0x2adb77c, size 0xd4, virtual false, abstract: false, final false
static inline bool ImplementsINullableValue(::System::Data::Common::StorageType  typeCode, ::System::Type*  dataType) ;

/// @brief Method ImplementsInterfaces, addr 0x2adb470, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method InspectTypeForInterfaces, addr 0x2adb5c4, size 0x1b8, virtual false, abstract: false, final false
static inline ::System::Tuple_4<bool,bool,bool,bool>* InspectTypeForInterfaces(::System::Type*  dataType) ;

/// @brief Method IsNull, addr 0x2ada27c, size 0x1c, virtual true, abstract: false, final false
inline bool IsNull(int32_t  recordNo) ;

/// @brief Method IsObjectNull, addr 0x2adb850, size 0xa0, virtual false, abstract: false, final false
static inline bool IsObjectNull(::System::Object*  value) ;

/// @brief Method IsObjectSqlNull, addr 0x2adb8f0, size 0xb4, virtual false, abstract: false, final false
static inline bool IsObjectSqlNull(::System::Object*  value) ;

/// @brief Method IsSqlType, addr 0x2adb374, size 0xfc, virtual false, abstract: false, final false
static inline bool IsSqlType(::System::Type*  dataType) ;

/// @brief Method IsSqlType, addr 0x2adb368, size 0xc, virtual false, abstract: false, final false
static inline bool IsSqlType(::System::Data::Common::StorageType  storageType) ;

/// @brief Method IsTypeCustomType, addr 0x2ad4124, size 0x78, virtual false, abstract: false, final false
static inline bool IsTypeCustomType(::System::Type*  type) ;

/// @brief Method IsTypeCustomType, addr 0x2ada124, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method SetCapacity, addr 0x2ad6f10, size 0x7c, virtual true, abstract: false, final false
inline void SetCapacity(int32_t  capacity) ;

/// @brief Method SetNullBit, addr 0x2ad6e30, size 0x20, virtual false, abstract: false, final false
inline void SetNullBit(int32_t  recordNo, bool  flag) ;

/// @brief Method SetNullStorage, addr 0x2adb9d4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method SetStorageInternal, addr 0x2adb9c4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2acf34c, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ada118, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ad57d8, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method get_DateTimeMode, addr 0x2ada184, size 0x1c, virtual false, abstract: false, final false
inline ::System::Data::DataSetDateTime get_DateTimeMode() ;

/// @brief Method get_FormatProvider, addr 0x2acffac, size 0x1c, virtual false, abstract: false, final false
