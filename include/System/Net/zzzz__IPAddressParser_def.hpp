...
public:
// Declarations
/// @brief Method AppendHex, addr 0x2d53a98, size 0x68, virtual false, abstract: false, final false
static inline void AppendHex(uint16_t  value, ::System::Text::StringBuilder*  buffer) ;

/// @brief Method AppendSections, addr 0x2d538b0, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method ExtractIPv4Address, addr 0x2d53a64, size 0x34, virtual false, abstract: false, final false
static inline uint32_t ExtractIPv4Address(::ArrayW<uint16_t,::Array<uint16_t>*>  address) ;

/// @brief Method FormatIPv4AddressNumber, addr 0x2d536d8, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method IPv4AddressToString, addr 0x2d52a80, size 0x60, virtual false, abstract: false, final false
static inline ::StringW IPv4AddressToString(uint32_t  address) ;

/// @brief Method IPv4AddressToString, addr 0x2d53668, size 0x70, virtual false, abstract: false, final false
static inline void IPv4AddressToString(uint32_t  address, ::System::Text::StringBuilder*  destination) ;

/// @brief Method IPv4AddressToStringHelper, addr 0x2d535cc, size 0x9c, virtual false, abstract: false, final false
static inline int32_t IPv4AddressToStringHelper(uint32_t  address, ::cordl_internals::Ptr<char16_t>  addressString) ;

/// @brief Method IPv6AddressToString, addr 0x2d52a6c, size 0x14, virtual false, abstract: false, final false
static inline ::StringW IPv6AddressToString(::ArrayW<uint16_t,::Array<uint16_t>*>  address, uint32_t  scopeId) ;

/// @brief Method IPv6AddressToStringHelper, addr 0x2d53790, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method Ipv4StringToAddress, addr 0x2d5351c, size 0xb0, virtual false, abstract: false, final false
static inline bool Ipv4StringToAddress(::System::ReadOnlySpan_1<char16_t>  ipSpan, ::ByRef<int64_t>  address) ;

/// @brief Method Ipv6StringToAddress, addr 0x2d533a8, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x2d523e4, size 0x1c4, virtual false, abstract: false, final false
static inline ::System::Net::IPAddress* Parse(::System::ReadOnlySpan_1<char16_t>  ipSpan, bool  tryParse) ;

/// @brief Method Reverse, addr 0x2d53b00, size 0xc, virtual false, abstract: false, final false
