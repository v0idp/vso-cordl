...
/// @brief Method <PipelineCallback>b__0, addr 0x2d5ac00, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d57b70, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AbortConnect, addr 0x2d56530, size 0x8c, virtual false, abstract: false, final false
inline void AbortConnect() ;

/// @brief Method AcceptCallback, addr 0x2d565bc, size 0x354, virtual false, abstract: false, final false
static inline void AcceptCallback(::System::IAsyncResult*  asyncResult) ;

/// @brief Method BuildCommandsList, addr 0x2d58bb4, size 0xe00, virtual true, abstract: false, final false
...
/// @brief Method CheckValid, addr 0x2d5a718, size 0x3bc, virtual true, abstract: false, final false
inline bool CheckValid(::System::Net::ResponseDescription*  response, ::ByRef<int32_t>  validThrough, ::ByRef<int32_t>  completeLength) ;

/// @brief Method ClearState, addr 0x2d572a4, size 0x90, virtual true, abstract: false, final false
inline void ClearState() ;

/// @brief Method ConnectCallback, addr 0x2d569b8, size 0x1b0, virtual false, abstract: false, final false
static inline void ConnectCallback(::System::IAsyncResult*  asyncResult) ;

/// @brief Method CreateFtpDataSocket, addr 0x2d5a374, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method CreateFtpListenerSocket, addr 0x2d59c78, size 0x174, virtual false, abstract: false, final false
inline void CreateFtpListenerSocket(::System::Net::FtpWebRequest*  request) ;

/// @brief Method FormatAddress, addr 0x2d5a480, size 0x128, virtual false, abstract: false, final false
inline ::StringW FormatAddress(::System::Net::IPAddress*  address, int32_t  Port) ;

/// @brief Method FormatAddressV6, addr 0x2d5a5a8, size 0x110, virtual false, abstract: false, final false
inline ::StringW FormatAddressV6(::System::Net::IPAddress*  address, int32_t  port) ;

/// @brief Method FormatFtpCommand, addr 0x2d599b4, size 0xf8, virtual false, abstract: false, final false
inline ::StringW FormatFtpCommand(::StringW  command, ::StringW  parameter) ;

/// @brief Method GetContentLengthFrom213Response, addr 0x2d5864c, size 0x138, virtual false, abstract: false, final false
inline int64_t GetContentLengthFrom213Response(::StringW  responseString) ;

/// @brief Method GetLastModifiedFrom213Response, addr 0x2d58784, size 0x380, virtual false, abstract: false, final false
inline ::System::DateTime GetLastModifiedFrom213Response(::StringW  str) ;

/// @brief Method GetLoginDirectory, addr 0x2d58b04, size 0xb0, virtual false, abstract: false, final false
inline ::StringW GetLoginDirectory(::StringW  str) ;

/// @brief Method GetPathInfo, addr 0x2d59ad8, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method GetPortCommandLine, addr 0x2d59dec, size 0x1e8, virtual false, abstract: false, final false
inline ::StringW GetPortCommandLine(::System::Net::FtpWebRequest*  request) ;

/// @brief Method GetPortV4, addr 0x2d59fd4, size 0x1e8, virtual false, abstract: false, final false
inline int32_t GetPortV4(::StringW  responseString) ;

/// @brief Method GetPortV6, addr 0x2d5a1bc, size 0x1b8, virtual false, abstract: false, final false
inline int32_t GetPortV6(::StringW  responseString) ;

/// @brief Method IsFtpDataStreamWriteable, addr 0x2d56fb4, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method PipelineCallback, addr 0x2d57334, size 0x83c, virtual true, abstract: false, final false
...
/// @brief Method QueueOrCreateDataConection, addr 0x2d57b78, size 0x678, virtual false, abstract: false, final false
...
/// @brief Method QueueOrCreateFtpDataStream, addr 0x2d56d2c, size 0x288, virtual false, abstract: false, final false
inline ::System::Net::CommandStream_PipelineInstruction QueueOrCreateFtpDataStream(::ByRef<::System::IO::Stream*>  stream) ;

/// @brief Method SSLHandshakeCallback, addr 0x2d56b68, size 0x1c4, virtual false, abstract: false, final false
static inline void SSLHandshakeCallback(::System::IAsyncResult*  asyncResult) ;

/// @brief Method TryUpdateContentLength, addr 0x2d581f0, size 0xec, virtual false, abstract: false, final false
inline void TryUpdateContentLength(::StringW  str) ;

/// @brief Method TryUpdateResponseUri, addr 0x2d582e8, size 0x348, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d564a4, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method get_BannerMessage, addr 0x2d5a6d0, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_BannerMessage() ;

/// @brief Method get_ContentLength, addr 0x2d5a6b8, size 0x8, virtual false, abstract: false, final false
inline int64_t get_ContentLength() ;

/// @brief Method get_Credentials, addr 0x2d5637c, size 0xa8, virtual false, abstract: false, final false
inline ::System::Net::NetworkCredential* get_Credentials() ;

/// @brief Method get_ExitMessage, addr 0x2d5a700, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_ExitMessage() ;

/// @brief Method get_LastModified, addr 0x2d5a6c0, size 0x8, virtual false, abstract: false, final false
inline ::System::DateTime get_LastModified() ;

/// @brief Method get_ResponseUri, addr 0x2d5a6c8, size 0x8, virtual false, abstract: false, final false
inline ::System::Uri* get_ResponseUri() ;

/// @brief Method get_WelcomeMessage, addr 0x2d5a6e8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method set_Credentials, addr 0x2d56424, size 0x80, virtual false, abstract: false, final false
