...
/// @brief Method .ctor, addr 0x2d6e290, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  durationMilliseconds) ;

/// @brief Method get_Duration, addr 0x2d6e2b8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x2d6e308, size 0xc, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method .ctor, addr 0x2d6e2c0, size 0x34, virtual false, abstract: false, final false
inline void _ctor(int32_t  durationMilliseconds) ;

/// @brief Method get_Expiration, addr 0x2d6e2fc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_StartTime, addr 0x2d6e2f4, size 0x8, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Invoke, addr 0x2d6e418, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d6e314, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method CreateTimer, addr 0x2d6e45c, size 0x1e0, virtual true, abstract: false, final false
inline ::System::Net::TimerThread_Timer* CreateTimer(::System::Net::TimerThread_Callback*  callback, ::System::Object*  context) ;

/// @brief Method Fire, addr 0x2d6df9c, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d6ccdc, size 0x90, virtual false, abstract: false, final false
inline void _ctor(int32_t  durationMilliseconds) ;
...
public:
// Declarations
/// @brief Method CreateTimer, addr 0x2d6e904, size 0x68, virtual true, abstract: false, final false
inline ::System::Net::TimerThread_Timer* CreateTimer(::System::Net::TimerThread_Callback*  callback, ::System::Object*  context) ;

static inline ::System::Net::TimerThread_InfiniteTimerQueue* New_ctor() ;

/// @brief Method .ctor, addr 0x2d6ccbc, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Cancel, addr 0x2d6e9c8, size 0x120, virtual true, abstract: false, final false
inline bool Cancel() ;

/// @brief Method Fire, addr 0x2d6e694, size 0x270, virtual false, abstract: false, final false
inline bool Fire() ;
...
/// @brief Method .ctor, addr 0x2d6e42c, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2d6e63c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method get_HasExpired, addr 0x2d6e998, size 0x10, virtual true, abstract: false, final false
inline bool get_HasExpired() ;

/// @brief Method get_Next, addr 0x2d6e9a8, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::TimerThread_TimerNode* get_Next() ;

/// @brief Method get_Prev, addr 0x2d6e9b8, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::TimerThread_TimerNode* get_Prev() ;

/// @brief Method set_Next, addr 0x2d6e9b0, size 0x8, virtual false, abstract: false, final false
inline void set_Next(::System::Net::TimerThread_TimerNode*  value) ;

/// @brief Method set_Prev, addr 0x2d6e9c0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Cancel, addr 0x2d6eaf0, size 0x24, virtual true, abstract: false, final false
inline bool Cancel() ;
...
/// @brief Method .ctor, addr 0x2d6e96c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasExpired, addr 0x2d6eae8, size 0x8, virtual true, abstract: false, final false
inline bool get_HasExpired() ;
...
/// @brief Method CreateQueue, addr 0x2d68f88, size 0x23c, virtual false, abstract: false, final false
static inline ::System::Net::TimerThread_Queue* CreateQueue(int32_t  durationMilliseconds) ;

/// @brief Method GetOrCreateQueue, addr 0x2d6cd6c, size 0x958, virtual false, abstract: false, final false
static inline ::System::Net::TimerThread_Queue* GetOrCreateQueue(int32_t  durationMilliseconds) ;

/// @brief Method IsTickBetween, addr 0x2d6e12c, size 0x24, virtual false, abstract: false, final false
static inline bool IsTickBetween(int32_t  start, int32_t  end, int32_t  comparand) ;

/// @brief Method OnDomainUnload, addr 0x2d6e1cc, size 0xc4, virtual false, abstract: false, final false
static inline void OnDomainUnload(::System::Object*  sender, ::System::EventArgs*  e) ;

/// @brief Method Prod, addr 0x2d6d6c4, size 0x110, virtual false, abstract: false, final false
static inline void Prod() ;

/// @brief Method StopTimerThread, addr 0x2d6e150, size 0x7c, virtual false, abstract: false, final false
static inline void StopTimerThread() ;

/// @brief Method ThreadProc, addr 0x2d6d7d4, size 0x7c8, virtual false, abstract: false, final false
