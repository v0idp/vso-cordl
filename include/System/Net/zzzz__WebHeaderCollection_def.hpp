...
// Dependencies System.Collections.Specialized.NameValueCollection, System.Net.WebHeaderCollectionType, System.Runtime.Serialization.ISerializable
namespace System::Net {
// Is value type: false
...
/// @brief Method Add, addr 0x2d65db0, size 0x2d0, virtual false, abstract: false, final false
inline void Add(::StringW  header) ;

/// @brief Method Add, addr 0x2d65c00, size 0x1b0, virtual true, abstract: false, final false
inline void Add(::StringW  name, ::StringW  value) ;

/// @brief Method AddInternal, addr 0x2d654fc, size 0x54, virtual false, abstract: false, final false
inline void AddInternal(::StringW  name, ::StringW  value) ;

/// @brief Method AllowMultiValues, addr 0x2d65320, size 0xac, virtual false, abstract: false, final false
static inline bool AllowMultiValues(::StringW  name) ;

/// @brief Method ChangeInternal, addr 0x2d65550, size 0x54, virtual false, abstract: false, final false
inline void ChangeInternal(::StringW  name, ::StringW  value) ;

/// @brief Method CheckBadChars, addr 0x2d65678, size 0x390, virtual false, abstract: false, final false
static inline ::StringW CheckBadChars(::StringW  name, bool  isHeaderValue) ;

/// @brief Method CheckUpdate, addr 0x2d65600, size 0x78, virtual false, abstract: false, final false
inline void CheckUpdate(::StringW  name, ::StringW  value) ;

/// @brief Method ContainsNonAsciiChars, addr 0x2d65a08, size 0x84, virtual false, abstract: false, final false
static inline bool ContainsNonAsciiChars(::StringW  token) ;

/// @brief Method Get, addr 0x2d6730c, size 0x40, virtual true, abstract: false, final false
inline ::StringW Get(int32_t  index) ;

/// @brief Method Get, addr 0x2d66f3c, size 0x32c, virtual true, abstract: false, final false
inline ::StringW Get(::StringW  name) ;

/// @brief Method GetAsString, addr 0x2d6685c, size 0x2ac, virtual false, abstract: false, final false
static inline ::StringW GetAsString(::System::Collections::Specialized::NameValueCollection*  cc, bool  winInetCompat, bool  forTrace) ;

/// @brief Method GetEnumerator, addr 0x2d67268, size 0x74, virtual true, abstract: false, final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method GetKey, addr 0x2d6734c, size 0x40, virtual true, abstract: false, final false
inline ::StringW GetKey(int32_t  index) ;

/// @brief Method GetObjectData, addr 0x2d66db0, size 0x180, virtual true, abstract: false, final false
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  serializationInfo, ::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method GetValues, addr 0x2d665fc, size 0x204, virtual true, abstract: false, final false
...
/// @brief Method NormalizeCommonHeaders, addr 0x2d65184, size 0x100, virtual false, abstract: false, final false
inline void NormalizeCommonHeaders() ;

/// @brief Method OnDeserialization, addr 0x2d66dac, size 0x4, virtual true, abstract: false, final false
inline void OnDeserialization(::System::Object*  sender) ;

/// @brief Method Remove, addr 0x2d6540c, size 0xf0, virtual false, abstract: false, final false
inline void Remove(::System::Net::HttpRequestHeader  header) ;

/// @brief Method Remove, addr 0x2d664c4, size 0x138, virtual true, abstract: false, final false
inline void Remove(::StringW  name) ;

/// @brief Method RemoveInternal, addr 0x2d655a4, size 0x5c, virtual false, abstract: false, final false
inline void RemoveInternal(::StringW  name) ;

/// @brief Method Set, addr 0x2d66080, size 0x228, virtual true, abstract: false, final false
inline void Set(::StringW  name, ::StringW  value) ;

/// @brief Method SetInternal, addr 0x2d662a8, size 0x21c, virtual false, abstract: false, final false
inline void SetInternal(::StringW  name, ::StringW  value) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData, addr 0x2d66f30, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method ThrowOnRestrictedHeader, addr 0x2d65a8c, size 0x174, virtual false, abstract: false, final false
inline void ThrowOnRestrictedHeader(::StringW  headerName) ;

/// @brief Method ToString, addr 0x2d66800, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d6111c, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2d66bec, size 0x1c0, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  serializationInfo, ::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method .ctor, addr 0x2d66b08, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method get_AllKeys, addr 0x2d6738c, size 0x30, virtual true, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_AllKeys() ;

/// @brief Method get_AllowHttpRequestHeader, addr 0x2d653cc, size 0x40, virtual false, abstract: false, final false
inline bool get_AllowHttpRequestHeader() ;

/// @brief Method get_Count, addr 0x2d672dc, size 0x30, virtual true, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_InnerCollection, addr 0x2d65284, size 0x9c, virtual false, abstract: false, final false
