...
/// @brief Method CallEndPointDelegate, addr 0x2d8b9e4, size 0x1a4, virtual false, abstract: false, final false
inline bool CallEndPointDelegate(::System::Net::Sockets::Socket*  sock, ::System::Net::IPEndPoint*  remote) ;

/// @brief Method FreeServicePoint, addr 0x2d8b96c, size 0x10, virtual false, abstract: false, final false
inline void FreeServicePoint() ;

/// @brief Method KeepAliveSetup, addr 0x2d8b270, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method PutBytes, addr 0x2d8b324, size 0x80, virtual false, abstract: false, final false
static inline void PutBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, uint32_t  v, int32_t  offset) ;

/// @brief Method SendRequest, addr 0x2d83578, size 0x170, virtual false, abstract: false, final false
inline void SendRequest(::System::Net::WebOperation*  operation, ::StringW  groupName) ;

/// @brief Method SetTcpKeepAlive, addr 0x2d8b1c0, size 0xb0, virtual false, abstract: false, final false
inline void SetTcpKeepAlive(bool  enabled, int32_t  keepAliveTime, int32_t  keepAliveInterval) ;

/// @brief Method SetVersion, addr 0x2d8b87c, size 0x8, virtual false, abstract: false, final false
inline void SetVersion(::System::Version*  version) ;

/// @brief Method UpdateClientCertificate, addr 0x2d8b9b0, size 0x34, virtual false, abstract: false, final false
inline void UpdateClientCertificate(::System::Security::Cryptography::X509Certificates::X509Certificate*  certificate) ;

/// @brief Method UpdateServerCertificate, addr 0x2d8b97c, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d8aeb4, size 0xdc, virtual false, abstract: false, final false
inline void _ctor(::System::Net::ServicePointManager_SPKey*  key, ::System::Uri*  uri, int32_t  connectionLimit, int32_t  maxIdleTime) ;

/// @brief Method get_Address, addr 0x2d8b17c, size 0x8, virtual false, abstract: false, final false
inline ::System::Uri* get_Address() ;

/// @brief Method get_ConnectionLimit, addr 0x2d8b184, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ConnectionLimit() ;

/// @brief Method get_HasTimedOut, addr 0x2d8b3cc, size 0x12c, virtual false, abstract: false, final false
inline bool get_HasTimedOut() ;

/// @brief Method get_HostEntry, addr 0x2d8b4f8, size 0x384, virtual false, abstract: false, final false
inline ::System::Net::IPHostEntry* get_HostEntry() ;

/// @brief Method get_Key, addr 0x2d8b164, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::ServicePointManager_SPKey* get_Key() ;

/// @brief Method get_ProtocolVersion, addr 0x2d8b18c, size 0x8, virtual true, abstract: false, final false
inline ::System::Version* get_ProtocolVersion() ;

/// @brief Method get_Scheduler, addr 0x2d8b16c, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::ServicePointScheduler* get_Scheduler() ;

/// @brief Method get_SendContinue, addr 0x2d84da4, size 0x9c, virtual false, abstract: false, final false
inline bool get_SendContinue() ;

/// @brief Method get_UseConnect, addr 0x2d8b3b8, size 0x8, virtual false, abstract: false, final false
inline bool get_UseConnect() ;

/// @brief Method get_UseNagleAlgorithm, addr 0x2d8b1a0, size 0x8, virtual false, abstract: false, final false
inline bool get_UseNagleAlgorithm() ;

/// @brief Method get_UsesProxy, addr 0x2d8b3a4, size 0x8, virtual false, abstract: false, final false
inline bool get_UsesProxy() ;

/// @brief Method set_Expect100Continue, addr 0x2d8b194, size 0xc, virtual false, abstract: false, final false
inline void set_Expect100Continue(bool  value) ;

/// @brief Method set_Scheduler, addr 0x2d8b174, size 0x8, virtual false, abstract: false, final false
inline void set_Scheduler(::System::Net::ServicePointScheduler*  value) ;

/// @brief Method set_SendContinue, addr 0x2d8b1b4, size 0xc, virtual false, abstract: false, final false
inline void set_SendContinue(bool  value) ;

/// @brief Method set_UseConnect, addr 0x2d8b3c0, size 0xc, virtual false, abstract: false, final false
inline void set_UseConnect(bool  value) ;

/// @brief Method set_UseNagleAlgorithm, addr 0x2d8b1a8, size 0xc, virtual false, abstract: false, final false
inline void set_UseNagleAlgorithm(bool  value) ;

/// @brief Method set_UsesProxy, addr 0x2d8b3ac, size 0xc, virtual false, abstract: false, final false
