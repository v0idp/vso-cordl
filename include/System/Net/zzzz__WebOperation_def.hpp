...
// Dependencies System.Runtime.CompilerServices.AsyncVoidMethodBuilder, System.Runtime.CompilerServices.ConfiguredTaskAwaitable::ConfiguredTaskAwaiter, System.Runtime.CompilerServices.ConfiguredTaskAwaitable`1::ConfiguredTaskAwaiter<TResult>, System.Runtime.CompilerServices.IAsyncStateMachine
namespace System::Net {
// Is value type: true
...
/// @brief Method MoveNext, addr 0x2d94ff4, size 0x598, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x2d9558c, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method Abort, addr 0x2d84144, size 0x40, virtual false, abstract: false, final false
inline void Abort() ;

/// @brief Method CheckDisposed, addr 0x2d94e08, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method CheckThrowDisposed, addr 0x2d94e90, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method Close, addr 0x2d94cb8, size 0xac, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method CompleteRequestWritten, addr 0x2d94f50, size 0x80, virtual false, abstract: false, final false
inline void CompleteRequestWritten(::System::Net::WebRequestStream*  stream, ::System::Exception*  error) ;

/// @brief Method Finish, addr 0x2d873cc, size 0x23c, virtual false, abstract: false, final false
inline void Finish(bool  ok, ::System::Exception*  error) ;

/// @brief Method GetRequestStreamInternal, addr 0x2d8732c, size 0x50, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::System::Net::WebRequestStream*>* GetRequestStreamInternal() ;

/// @brief Method GetResponseStream, addr 0x2d8737c, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method RegisterRequest, addr 0x2d903a0, size 0x260, virtual false, abstract: false, final false
inline void RegisterRequest(::System::Net::ServicePoint*  servicePoint, ::System::Net::WebConnection*  connection) ;

/// @brief Method Run, addr 0x2d90600, size 0x90, virtual false, abstract: false, final false
inline void Run() ;

/// @brief Method SetCanceled, addr 0x2d94bf0, size 0xc8, virtual false, abstract: false, final false
inline void SetCanceled() ;

/// @brief Method SetDisposed, addr 0x2d94b08, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method SetError, addr 0x2d94d64, size 0xa4, virtual false, abstract: false, final false
inline void SetError(::System::Exception*  error) ;

/// @brief Method SetPriorityRequest, addr 0x2d855d0, size 0x17c, virtual false, abstract: false, final false
inline void SetPriorityRequest(::System::Net::WebOperation*  operation) ;

/// @brief Method ThrowIfClosedOrDisposed, addr 0x2d927d8, size 0x60, virtual false, abstract: false, final false
inline void ThrowIfClosedOrDisposed() ;

/// @brief Method ThrowIfClosedOrDisposed, addr 0x2d92114, size 0x88, virtual false, abstract: false, final false
inline void ThrowIfClosedOrDisposed(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method ThrowIfDisposed, addr 0x2d94ee8, size 0x60, virtual false, abstract: false, final false
inline void ThrowIfDisposed() ;

/// @brief Method ThrowIfDisposed, addr 0x2d91290, size 0x80, virtual false, abstract: false, final false
inline void ThrowIfDisposed(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method <RegisterRequest>b__48_0, addr 0x2d94fd0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d833e4, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method get_Aborted, addr 0x2d8d9a4, size 0x60, virtual false, abstract: false, final false
inline bool get_Aborted() ;

/// @brief Method get_Closed, addr 0x2d94adc, size 0x2c, virtual false, abstract: false, final false
inline bool get_Closed() ;

/// @brief Method get_Connection, addr 0x2d94aac, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::WebConnection* get_Connection() ;

/// @brief Method get_Finished, addr 0x2d94f48, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::WebCompletionSource_1<::System::ValueTuple_2<bool,::System::Net::WebOperation*>>* get_Finished() ;

/// @brief Method get_IsNtlmChallenge, addr 0x2d94ad4, size 0x8, virtual false, abstract: false, final false
inline bool get_IsNtlmChallenge() ;

/// @brief Method get_Request, addr 0x2d94aa4, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::HttpWebRequest* get_Request() ;

/// @brief Method get_ServicePoint, addr 0x2d94abc, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::ServicePoint* get_ServicePoint() ;

/// @brief Method get_WriteBuffer, addr 0x2d94acc, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::BufferOffsetSize* get_WriteBuffer() ;

/// @brief Method get_WriteStream, addr 0x2d87314, size 0x18, virtual false, abstract: false, final false
inline ::System::Net::WebRequestStream* get_WriteStream() ;

/// @brief Method set_Connection, addr 0x2d94ab4, size 0x8, virtual false, abstract: false, final false
inline void set_Connection(::System::Net::WebConnection*  value) ;

/// @brief Method set_ServicePoint, addr 0x2d94ac4, size 0x8, virtual false, abstract: false, final false
