...
/// @brief Method .ctor, addr 0x2d632fc, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::StringW  token) ;

/// @brief Method .ctor, addr 0x2d633a0, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::StringW  token, bool  finished) ;

/// @brief Method get_Complete, addr 0x2d6343c, size 0x8, virtual false, abstract: false, final false
inline bool get_Complete() ;

/// @brief Method get_Message, addr 0x2d63434, size 0x8, virtual false, abstract: false, final false
