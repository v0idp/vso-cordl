...
public:
// Declarations
/// @brief Method get_DefaultCredentials, addr 0x2d63444, size 0x58, virtual false, abstract: false, final false
static inline ::System::Net::ICredentials* get_DefaultCredentials() ;

/// @brief Method get_DefaultNetworkCredentials, addr 0x2d6349c, size 0x58, virtual false, abstract: false, final false
