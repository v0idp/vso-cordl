...
/// @brief Method BeginConnect, addr 0x2cd2a34, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method Close, addr 0x2cd2d8c, size 0xa4, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method Connect, addr 0x2cd22a4, size 0x690, virtual false, abstract: false, final false
inline void Connect(::StringW  hostname, int32_t  port) ;

/// @brief Method Connect, addr 0x2cd2934, size 0x100, virtual false, abstract: false, final false
inline void Connect(::System::Net::IPEndPoint*  remoteEP) ;

/// @brief Method ConnectAsync, addr 0x2cd2ae8, size 0x16c, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* ConnectAsync(::StringW  host, int32_t  port) ;

/// @brief Method Dispose, addr 0x2cd2fc4, size 0x10, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x2cd2e30, size 0x194, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndConnect, addr 0x2cd2aa0, size 0x48, virtual false, abstract: false, final false
inline void EndConnect(::System::IAsyncResult*  asyncResult) ;

/// @brief Method Finalize, addr 0x2cd2fd4, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetStream, addr 0x2cd2c54, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cd209c, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2cd2234, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::Socket*  acceptedSocket) ;

/// @brief Method .ctor, addr 0x2cd20bc, size 0x10c, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::AddressFamily  family) ;

/// @brief Method get_Client, addr 0x2cd2278, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::Sockets::Socket* get_Client() ;

/// @brief Method get_Connected, addr 0x2cd2288, size 0x1c, virtual false, abstract: false, final false
inline bool get_Connected() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method initialize, addr 0x2cd21c8, size 0x6c, virtual false, abstract: false, final false
inline void initialize() ;

/// @brief Method set_Client, addr 0x2cd2280, size 0x8, virtual false, abstract: false, final false
