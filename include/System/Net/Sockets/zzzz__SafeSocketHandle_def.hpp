...
/// @brief Method RegisterForBlockingSyscall, addr 0x2cd482c, size 0x13c, virtual false, abstract: false, final false
inline void RegisterForBlockingSyscall() ;

/// @brief Method ReleaseHandle, addr 0x2cd4278, size 0x5b4, virtual true, abstract: false, final false
inline bool ReleaseHandle() ;

/// @brief Method UnRegisterForBlockingSyscall, addr 0x2cd4968, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cd41b4, size 0xc4, virtual false, abstract: false, final false
