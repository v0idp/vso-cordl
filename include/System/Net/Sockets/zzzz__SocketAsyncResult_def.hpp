...
/// @brief Method <Complete>b__27_0, addr 0x2cd5440, size 0x78, virtual false, abstract: false, final false
inline void _Complete_b__27_0(::System::Object*  state) ;

/// @brief Method .ctor, addr 0x2cd5438, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CheckIfThrowDelayedException, addr 0x2cd5118, size 0xa0, virtual false, abstract: false, final false
inline void CheckIfThrowDelayedException() ;

/// @brief Method Complete, addr 0x2cd51bc, size 0x1e8, virtual false, abstract: false, final false
inline void Complete() ;

/// @brief Method Complete, addr 0x2cd1d98, size 0x8, virtual false, abstract: false, final false
inline void Complete(::System::Exception*  e) ;

/// @brief Method Complete, addr 0x2cd53b8, size 0x10, virtual false, abstract: false, final false
inline void Complete(::System::Exception*  e, bool  synch) ;

/// @brief Method Complete, addr 0x2cd53c8, size 0x8, virtual false, abstract: false, final false
inline void Complete(::System::Net::Sockets::Socket*  s) ;

/// @brief Method Complete, addr 0x2cd53d0, size 0xc, virtual false, abstract: false, final false
inline void Complete(::System::Net::Sockets::Socket*  s, int32_t  total) ;

/// @brief Method Complete, addr 0x2cd53a4, size 0xc, virtual false, abstract: false, final false
inline void Complete(bool  synch) ;

/// @brief Method Complete, addr 0x2cd53b0, size 0x8, virtual false, abstract: false, final false
inline void Complete(int32_t  total) ;

/// @brief Method CompleteDisposed, addr 0x2cd51b8, size 0x4, virtual true, abstract: false, final false
inline void CompleteDisposed() ;

/// @brief Method Init, addr 0x2cd4fac, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cd4cd0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2cd5060, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method get_ErrorCode, addr 0x2cd5098, size 0x80, virtual false, abstract: false, final false
inline ::System::Net::Sockets::SocketError get_ErrorCode() ;

/// @brief Method get_Handle, addr 0x2cd4f98, size 0x14, virtual false, abstract: false, final false
