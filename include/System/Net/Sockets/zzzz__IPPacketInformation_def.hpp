...
public:
// Declarations
/// @brief Method Equals, addr 0x2cd1f74, size 0x9c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method GetHashCode, addr 0x2cd2010, size 0x44, virtual true, abstract: false, final false
