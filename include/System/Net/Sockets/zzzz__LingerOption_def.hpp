...
/// @brief Method .ctor, addr 0x2cd2054, size 0x34, virtual false, abstract: false, final false
inline void _ctor(bool  enable, int32_t  seconds) ;

/// @brief Method set_Enabled, addr 0x2cd2088, size 0xc, virtual false, abstract: false, final false
inline void set_Enabled(bool  value) ;

/// @brief Method set_LingerTime, addr 0x2cd2094, size 0x8, virtual false, abstract: false, final false
