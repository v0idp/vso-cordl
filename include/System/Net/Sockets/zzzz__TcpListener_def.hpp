...
/// @brief Method BeginAcceptTcpClient, addr 0x2cd3484, size 0xac, virtual false, abstract: false, final false
inline ::System::IAsyncResult* BeginAcceptTcpClient(::System::AsyncCallback*  callback, ::System::Object*  state) ;

/// @brief Method EndAcceptTcpClient, addr 0x2cd3530, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x2cd3238, size 0x8, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Start, addr 0x2cd3240, size 0x180, virtual false, abstract: false, final false
inline void Start(int32_t  backlog) ;

/// @brief Method Stop, addr 0x2cd33c0, size 0xc4, virtual false, abstract: false, final false
inline void Stop() ;
...
/// @brief Method .ctor, addr 0x2cd3074, size 0x194, virtual false, abstract: false, final false
inline void _ctor(::System::Net::IPAddress*  localaddr, int32_t  port) ;

/// @brief Method get_LocalEndpoint, addr 0x2cd3208, size 0x30, virtual false, abstract: false, final false
