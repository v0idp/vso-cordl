...
/// @brief Method ToString, addr 0x2d7b920, size 0x7c, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method CreateSecureString, addr 0x2d7c148, size 0x9c, virtual false, abstract: false, final false
static inline ::System::Security::SecureString* CreateSecureString(::StringW  plainString) ;

/// @brief Method CreateString, addr 0x2d7bfd4, size 0x174, virtual false, abstract: false, final false
