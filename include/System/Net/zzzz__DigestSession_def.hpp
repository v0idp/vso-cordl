...
/// @brief Method Authenticate, addr 0x2d7eeb4, size 0x5c4, virtual false, abstract: false, final false
inline ::System::Net::Authorization* Authenticate(::System::Net::WebRequest*  webRequest, ::System::Net::ICredentials*  credentials) ;

/// @brief Method HA1, addr 0x2d7eb60, size 0x124, virtual false, abstract: false, final false
inline ::StringW HA1(::StringW  username, ::StringW  password) ;

/// @brief Method HA2, addr 0x2d7ec84, size 0xd0, virtual false, abstract: false, final false
inline ::StringW HA2(::System::Net::HttpWebRequest*  webRequest) ;

/// @brief Method HashToHexString, addr 0x2d7ea0c, size 0x154, virtual false, abstract: false, final false
inline ::StringW HashToHexString(::StringW  toBeHashed) ;

static inline ::System::Net::DigestSession* New_ctor() ;

/// @brief Method Parse, addr 0x2d7e930, size 0xdc, virtual false, abstract: false, final false
inline bool Parse(::StringW  challenge) ;

/// @brief Method Response, addr 0x2d7ed54, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d7e754, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Security::Cryptography::RandomNumberGenerator* getStaticF_rng() ;

/// @brief Method get_Algorithm, addr 0x2d7e7c4, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_Algorithm() ;

/// @brief Method get_CNonce, addr 0x2d7e83c, size 0xf4, virtual false, abstract: false, final false
inline ::StringW get_CNonce() ;

/// @brief Method get_LastUse, addr 0x2d7f478, size 0x8, virtual false, abstract: false, final false
inline ::System::DateTime get_LastUse() ;

/// @brief Method get_Nonce, addr 0x2d7e7f4, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_Nonce() ;

/// @brief Method get_Opaque, addr 0x2d7e80c, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_Opaque() ;

/// @brief Method get_QOP, addr 0x2d7e824, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_QOP() ;

/// @brief Method get_Realm, addr 0x2d7e7dc, size 0x18, virtual false, abstract: false, final false
