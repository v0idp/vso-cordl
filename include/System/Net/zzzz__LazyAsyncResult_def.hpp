...
/// @brief Method .ctor, addr 0x2d6bd00, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Cleanup, addr 0x2d6c494, size 0x4, virtual true, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Complete, addr 0x2d6c260, size 0x188, virtual true, abstract: false, final false
inline void Complete(::System::IntPtr  userToken) ;

/// @brief Method InternalWaitForCompletion, addr 0x2d6c498, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* InternalWaitForCompletion() ;

/// @brief Method InvokeCallback, addr 0x2d6c254, size 0xc, virtual false, abstract: false, final false
inline void InvokeCallback() ;

/// @brief Method InvokeCallback, addr 0x2d6c24c, size 0x8, virtual false, abstract: false, final false
inline void InvokeCallback(::System::Object*  result) ;

/// @brief Method LazilyCreateEvent, addr 0x2d6be48, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method ProtectedInvokeCallback, addr 0x2d6c078, size 0x1d4, virtual false, abstract: false, final false
inline void ProtectedInvokeCallback(::System::Object*  result, ::System::IntPtr  userToken) ;

/// @brief Method WaitForCompletion, addr 0x2d6c4a0, size 0x2a8, virtual false, abstract: false, final false
inline ::System::Object* WaitForCompletion(bool  snap) ;

/// @brief Method WorkerThreadComplete, addr 0x2d6c3e8, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d6bd08, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_AsyncCallback, addr 0x2d6bda8, size 0x8, virtual false, abstract: false, final false
inline ::System::AsyncCallback* get_AsyncCallback() ;

/// @brief Method get_AsyncObject, addr 0x2d6bd98, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_AsyncObject() ;

/// @brief Method get_AsyncState, addr 0x2d6bda0, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle, addr 0x2d6bdb0, size 0x98, virtual true, abstract: false, final true
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously, addr 0x2d6c004, size 0x30, virtual true, abstract: false, final true
inline bool get_CompletedSynchronously() ;

/// @brief Method get_CurrentThreadContext, addr 0x2d6bc74, size 0x8c, virtual false, abstract: false, final false
static inline ::System::Net::LazyAsyncResult_ThreadContext* get_CurrentThreadContext() ;

/// @brief Method get_EndCalled, addr 0x2d6c064, size 0x8, virtual false, abstract: false, final false
inline bool get_EndCalled() ;

/// @brief Method get_InternalPeekCompleted, addr 0x2d6bff4, size 0x10, virtual false, abstract: false, final false
inline bool get_InternalPeekCompleted() ;

/// @brief Method get_IsCompleted, addr 0x2d6c034, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method set_EndCalled, addr 0x2d6c06c, size 0xc, virtual false, abstract: false, final false
