...
/// @brief Method Cleanup, addr 0x2d8d120, size 0xec, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CreateOrReuseConnection, addr 0x2d8d20c, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method EnqueueOperation, addr 0x2d8d800, size 0x58, virtual false, abstract: false, final false
inline void EnqueueOperation(::System::Net::WebOperation*  operation) ;

/// @brief Method FindIdleConnection, addr 0x2d8da04, size 0x31c, virtual false, abstract: false, final false
inline ::System::Net::WebConnection* FindIdleConnection(::System::Net::WebOperation*  operation) ;

/// @brief Method GetNextOperation, addr 0x2d8d3dc, size 0xe8, virtual false, abstract: false, final false
inline ::System::Net::WebOperation* GetNextOperation() ;

/// @brief Method IsEmpty, addr 0x2d8c8ac, size 0x74, virtual false, abstract: false, final false
inline bool IsEmpty() ;
...
/// @brief Method RemoveConnection, addr 0x2d8cfcc, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d8c22c, size 0x108, virtual false, abstract: false, final false
inline void _ctor(::System::Net::ServicePointScheduler*  scheduler, ::StringW  name) ;

static inline int32_t getStaticF_nextId() ;

/// @brief Method get_Scheduler, addr 0x2d8d984, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <Set>b__4_0, addr 0x2d8e420, size 0x9c, virtual false, abstract: false, final false
inline bool _Set_b__4_0(::System::Object*  s) ;

/// @brief Method .ctor, addr 0x2d8e418, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Reset, addr 0x2d8caac, size 0xc0, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Set, addr 0x2d8c3f8, size 0x22c, virtual false, abstract: false, final false
inline void Set() ;

/// @brief Method WaitAsync, addr 0x2d8e368, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d8c18c, size 0xa0, virtual false, abstract: false, final false
...
// Dependencies System.Runtime.CompilerServices.AsyncTaskMethodBuilder, System.Runtime.CompilerServices.ConfiguredTaskAwaitable`1::ConfiguredTaskAwaiter<TResult>, System.Runtime.CompilerServices.IAsyncStateMachine
namespace System::Net {
// Is value type: true
...
/// @brief Method MoveNext, addr 0x2d8e4bc, size 0xb48, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x2d8f004, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method MoveNext, addr 0x2d8f06c, size 0x4a0, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x2d8f50c, size 0x7c, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
/// @brief Method Cleanup, addr 0x2d8c6ec, size 0x1c0, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CloseIdleConnection, addr 0x2d8d3a4, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method FinalCleanup, addr 0x2d8d590, size 0x80, virtual false, abstract: false, final false
inline void FinalCleanup() ;

/// @brief Method GetConnectionGroup, addr 0x2d8d610, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method OnConnectionClosed, addr 0x2d8d864, size 0x1c, virtual false, abstract: false, final false
inline void OnConnectionClosed(::System::Net::WebConnection*  connection) ;

/// @brief Method OnConnectionCreated, addr 0x2d8d858, size 0xc, virtual false, abstract: false, final false
inline void OnConnectionCreated(::System::Net::WebConnection*  connection) ;

/// @brief Method OperationCompleted, addr 0x2d8cc4c, size 0x220, virtual false, abstract: false, final false
inline bool OperationCompleted(::System::Net::ServicePointScheduler_ConnectionGroup*  group, ::System::Net::WebOperation*  operation) ;

/// @brief Method RemoveIdleConnection, addr 0x2d8d054, size 0xcc, virtual false, abstract: false, final false
inline void RemoveIdleConnection(::System::Net::WebConnection*  connection) ;

/// @brief Method RemoveOperation, addr 0x2d8d4c4, size 0xcc, virtual false, abstract: false, final false
inline void RemoveOperation(::System::Net::WebOperation*  operation) ;

/// @brief Method Run, addr 0x2d8c334, size 0xc4, virtual false, abstract: false, final false
inline void Run() ;

/// @brief Method RunScheduler, addr 0x2d8c624, size 0xc8, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* RunScheduler() ;

/// @brief Method RunSchedulerIteration, addr 0x2d8c920, size 0x18c, virtual false, abstract: false, final false
inline void RunSchedulerIteration() ;

/// @brief Method SchedulerIteration, addr 0x2d8cb6c, size 0xe0, virtual false, abstract: false, final false
inline bool SchedulerIteration(::System::Net::ServicePointScheduler_ConnectionGroup*  group) ;

/// @brief Method SendRequest, addr 0x2d8b884, size 0xe8, virtual false, abstract: false, final false
inline void SendRequest(::System::Net::WebOperation*  operation, ::StringW  groupName) ;

/// @brief Method WaitAsync, addr 0x2d8d880, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method <Run>b__31_0, addr 0x2d8d980, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d8af90, size 0x1d4, virtual false, abstract: false, final false
inline void _ctor(::System::Net::ServicePoint*  servicePoint, int32_t  connectionLimit, int32_t  maxIdleTime) ;

static inline int32_t getStaticF_nextId() ;

/// @brief Method get_MaxIdleTime, addr 0x2d8c184, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxIdleTime() ;

/// @brief Method get_ServicePoint, addr 0x2d8c174, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::ServicePoint* get_ServicePoint() ;

static inline void setStaticF_nextId(int32_t  value) ;

/// @brief Method set_ServicePoint, addr 0x2d8c17c, size 0x8, virtual false, abstract: false, final false
