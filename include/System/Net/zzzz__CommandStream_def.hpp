...
/// @brief Method HasFlag, addr 0x2d54f04, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d56258, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  command) ;

/// @brief Method .ctor, addr 0x2d56280, size 0x30, virtual false, abstract: false, final false
...
/// @brief Field _commands, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__commands, put=__cordl_internal_set__commands)) ::ArrayW<::System::Net::CommandStream_PipelineEntry*,::Array<::System::Net::CommandStream_PipelineEntry*>*>  _commands;
...
/// @brief Method Abort, addr 0x2d543bc, size 0x1e4, virtual true, abstract: false, final false
inline void Abort(::System::Exception*  e) ;

/// @brief Method BuildCommandsList, addr 0x2d54cf4, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method CheckContinuePipeline, addr 0x2d54e48, size 0xb4, virtual false, abstract: false, final false
inline void CheckContinuePipeline() ;

/// @brief Method CheckValid, addr 0x2d560e8, size 0x8, virtual true, abstract: false, final false
inline bool CheckValid(::System::Net::ResponseDescription*  response, ::ByRef<int32_t>  validThrough, ::ByRef<int32_t>  completeLength) ;

/// @brief Method ClearState, addr 0x2d54ce4, size 0x10, virtual true, abstract: false, final false
inline void ClearState() ;

/// @brief Method ContinueCommandPipeline, addr 0x2d54818, size 0x4cc, virtual false, abstract: false, final false
inline ::System::IO::Stream* ContinueCommandPipeline() ;

/// @brief Method Dispose, addr 0x2d545d0, size 0x94, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GenerateException, addr 0x2d54d88, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method GenerateException, addr 0x2d54cfc, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method InitCommandPipeline, addr 0x2d54784, size 0x94, virtual false, abstract: false, final false
inline void InitCommandPipeline(::System::Net::WebRequest*  request, ::ArrayW<::System::Net::CommandStream_PipelineEntry*,::Array<::System::Net::CommandStream_PipelineEntry*>*>  commands, bool  isAsync) ;

/// @brief Method InvokeRequestCallback, addr 0x2d54664, size 0x70, virtual false, abstract: false, final false
inline void InvokeRequestCallback(::System::Object*  obj) ;

/// @brief Method MarkAsRecoverableFailure, addr 0x2d546ec, size 0x18, virtual false, abstract: false, final false
inline void MarkAsRecoverableFailure() ;

static inline ::System::Net::CommandStream* New_ctor(::System::Net::Sockets::TcpClient*  client) ;

/// @brief Method PipelineCallback, addr 0x2d555ac, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method PostReadCommandProcessing, addr 0x2d55388, size 0x210, virtual false, abstract: false, final false
inline bool PostReadCommandProcessing(::ByRef<::System::IO::Stream*>  stream) ;

/// @brief Method PostSendCommandProcessing, addr 0x2d54f14, size 0x130, virtual false, abstract: false, final false
inline bool PostSendCommandProcessing(::ByRef<::System::IO::Stream*>  stream) ;

/// @brief Method ReadCallback, addr 0x2d555b4, size 0x2c4, virtual false, abstract: false, final false
static inline void ReadCallback(::System::IAsyncResult*  asyncResult) ;

/// @brief Method ReceiveCommandResponse, addr 0x2d55044, size 0x344, virtual false, abstract: false, final false
inline ::System::Net::ResponseDescription* ReceiveCommandResponse() ;

/// @brief Method ReceiveCommandResponseCallback, addr 0x2d558b0, size 0x544, virtual false, abstract: false, final false
inline void ReceiveCommandResponseCallback(::System::Net::ReceiveState*  state, int32_t  bytesRead) ;

/// @brief Method SubmitRequest, addr 0x2d54704, size 0x80, virtual false, abstract: false, final false
inline ::System::IO::Stream* SubmitRequest(::System::Net::WebRequest*  request, bool  isAsync, bool  readInitalResponseOnConnect) ;

/// @brief Method WriteCallback, addr 0x2d55df4, size 0x2b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d542a4, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method get_Encoding, addr 0x2d560a8, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::Encoding* get_Encoding() ;

/// @brief Method get_RecoverableFailure, addr 0x2d546e4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Encoding, addr 0x2d560b0, size 0x38, virtual false, abstract: false, final false
