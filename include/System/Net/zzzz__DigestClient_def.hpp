...
/// @brief Method Authenticate, addr 0x2d7fe3c, size 0x298, virtual true, abstract: false, final true
...
/// @brief Method CheckExpired, addr 0x2d7f5e4, size 0x858, virtual false, abstract: false, final false
static inline void CheckExpired(int32_t  count) ;

static inline ::System::Net::DigestClient* New_ctor() ;

/// @brief Method PreAuthenticate, addr 0x2d800d4, size 0x180, virtual true, abstract: false, final true
inline ::System::Net::Authorization* PreAuthenticate(::System::Net::WebRequest*  webRequest, ::System::Net::ICredentials*  credentials) ;

/// @brief Method .ctor, addr 0x2d7c72c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Hashtable* getStaticF_cache() ;

/// @brief Method get_AuthenticationType, addr 0x2d80254, size 0x40, virtual true, abstract: false, final true
inline ::StringW get_AuthenticationType() ;

/// @brief Method get_Cache, addr 0x2d7f480, size 0x164, virtual false, abstract: false, final false
