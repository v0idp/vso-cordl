...
/// @brief Method Authenticate, addr 0x2d7d2d0, size 0xac, virtual true, abstract: false, final true
...
/// @brief Method GetBytes, addr 0x2d7d67c, size 0x9c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetBytes(::StringW  str) ;

/// @brief Method InternalAuthenticate, addr 0x2d7d37c, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method PreAuthenticate, addr 0x2d7d718, size 0xc, virtual true, abstract: false, final true
inline ::System::Net::Authorization* PreAuthenticate(::System::Net::WebRequest*  webRequest, ::System::Net::ICredentials*  credentials) ;

/// @brief Method .ctor, addr 0x2d7c734, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AuthenticationType, addr 0x2d7d724, size 0x40, virtual true, abstract: false, final true
