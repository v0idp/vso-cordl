...
public:
// Declarations
/// @brief Method GetWebStatusCodeString, addr 0x2d6c868, size 0x1e0, virtual false, abstract: false, final false
static inline ::StringW GetWebStatusCodeString(::System::Net::FtpStatusCode  statusCode, ::StringW  statusDescription) ;

/// @brief Method GetWebStatusString, addr 0x2d6c748, size 0xc0, virtual false, abstract: false, final false
static inline ::StringW GetWebStatusString(::StringW  Res, ::System::Net::WebExceptionStatus  Status) ;

/// @brief Method GetWebStatusString, addr 0x2d6c808, size 0x60, virtual false, abstract: false, final false
