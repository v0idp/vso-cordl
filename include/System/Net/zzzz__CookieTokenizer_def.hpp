...
/// @brief Method IsEqualTo, addr 0x2d70f8c, size 0x24, virtual false, abstract: false, final false
inline bool IsEqualTo(::StringW  value) ;

/// @brief Method .ctor, addr 0x2d712c0, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::System::Net::CookieToken  token) ;

/// @brief Method get_Token, addr 0x2d712cc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Extract, addr 0x2d7093c, size 0x88, virtual false, abstract: false, final false
inline ::StringW Extract() ;

/// @brief Method FindNext, addr 0x2d709c4, size 0x2a0, virtual false, abstract: false, final false
...
/// @brief Method Next, addr 0x2d70c64, size 0x104, virtual false, abstract: false, final false
inline ::System::Net::CookieToken Next(bool  first, bool  parseResponseCookies) ;

/// @brief Method Reset, addr 0x2d70d68, size 0x68, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method TokenFromName, addr 0x2d70dd0, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d7089c, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method get_EndOfCookie, addr 0x2d708d4, size 0x8, virtual false, abstract: false, final false
inline bool get_EndOfCookie() ;

/// @brief Method get_Eof, addr 0x2d708e8, size 0x10, virtual false, abstract: false, final false
inline bool get_Eof() ;

/// @brief Method get_Name, addr 0x2d708f8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Quoted, addr 0x2d70908, size 0x8, virtual false, abstract: false, final false
inline bool get_Quoted() ;

/// @brief Method get_Token, addr 0x2d7091c, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::CookieToken get_Token() ;

/// @brief Method get_Value, addr 0x2d7092c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_EndOfCookie, addr 0x2d708dc, size 0xc, virtual false, abstract: false, final false
inline void set_EndOfCookie(bool  value) ;

/// @brief Method set_Name, addr 0x2d70900, size 0x8, virtual false, abstract: false, final false
inline void set_Name(::StringW  value) ;

/// @brief Method set_Quoted, addr 0x2d70910, size 0xc, virtual false, abstract: false, final false
inline void set_Quoted(bool  value) ;

/// @brief Method set_Token, addr 0x2d70924, size 0x8, virtual false, abstract: false, final false
inline void set_Token(::System::Net::CookieToken  value) ;

/// @brief Method set_Value, addr 0x2d70934, size 0x8, virtual false, abstract: false, final false
