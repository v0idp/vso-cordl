...
public:
// Declarations
/// @brief Method Get, addr 0x2d4f970, size 0x4, virtual false, abstract: false, final false
static inline ::StringW Get(::System::Net::HttpStatusCode  code) ;

/// @brief Method Get, addr 0x2d4f974, size 0x698, virtual false, abstract: false, final false
