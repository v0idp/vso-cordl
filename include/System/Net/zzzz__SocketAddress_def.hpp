...
/// @brief Method Equals, addr 0x2d648f0, size 0xec, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method GetHashCode, addr 0x2d649dc, size 0x130, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetIPAddress, addr 0x2d6470c, size 0x1e4, virtual false, abstract: false, final false
inline ::System::Net::IPAddress* GetIPAddress() ;

/// @brief Method GetIPEndPoint, addr 0x2d54060, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2d64b0c, size 0x238, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d64398, size 0x11c, virtual false, abstract: false, final false
inline void _ctor(::System::Net::Sockets::AddressFamily  family, int32_t  size) ;

/// @brief Method .ctor, addr 0x2d644b4, size 0x258, virtual false, abstract: false, final false
inline void _ctor(::System::Net::IPAddress*  ipAddress) ;

/// @brief Method .ctor, addr 0x2d53df0, size 0x5c, virtual false, abstract: false, final false
inline void _ctor(::System::Net::IPAddress*  ipaddress, int32_t  port) ;

/// @brief Method get_Family, addr 0x2d54030, size 0x30, virtual false, abstract: false, final false
inline ::System::Net::Sockets::AddressFamily get_Family() ;

/// @brief Method get_Item, addr 0x2d64324, size 0x74, virtual false, abstract: false, final false
inline uint8_t get_Item(int32_t  offset) ;

/// @brief Method get_Size, addr 0x2d6431c, size 0x8, virtual false, abstract: false, final false
