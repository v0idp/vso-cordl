...
/// @brief Method Create, addr 0x2d61a14, size 0x58, virtual true, abstract: false, final true
inline ::System::Net::WebRequest* Create(::System::Uri*  uri) ;

static inline ::System::Net::FtpWebRequestCreator* New_ctor() ;

/// @brief Method .ctor, addr 0x2d61a0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
