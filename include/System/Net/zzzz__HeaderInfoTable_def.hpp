...
/// @brief Method ParseMultiValue, addr 0x2d6a178, size 0x204, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> ParseMultiValue(::StringW  value) ;

/// @brief Method ParseSingleValue, addr 0x2d6a114, size 0x64, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> ParseSingleValue(::StringW  value) ;

/// @brief Method .ctor, addr 0x2d6bc6c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Item, addr 0x2d6bb90, size 0xdc, virtual false, abstract: false, final false
