...
/// @brief Method DomainCharsTest, addr 0x2d6fad4, size 0xb4, virtual false, abstract: false, final false
static inline bool DomainCharsTest(::StringW  name) ;

/// @brief Method Equals, addr 0x2d702d0, size 0xd0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method GetComparer, addr 0x2d70278, size 0x58, virtual false, abstract: false, final false
static inline ::System::Collections::IComparer* GetComparer() ;

/// @brief Method GetHashCode, addr 0x2d703a0, size 0x160, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method InternalSetName, addr 0x2d6ee94, size 0x104, virtual false, abstract: false, final false
inline bool InternalSetName(::StringW  value) ;

/// @brief Method IsDomainEqualToHost, addr 0x2d6f0a8, size 0x58, virtual false, abstract: false, final false
static inline bool IsDomainEqualToHost(::StringW  domain, ::StringW  host) ;

static inline ::System::Net::Cookie* New_ctor() ;

/// @brief Method ToString, addr 0x2d70500, size 0x24c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method VerifySetDefaults, addr 0x2d6f100, size 0x9cc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d6eb14, size 0xe0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Comment, addr 0x2d6ebf4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Comment() ;

/// @brief Method get_Domain, addr 0x2d6ec74, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Domain() ;

/// @brief Method get_DomainKey, addr 0x2d700d4, size 0x1c, virtual false, abstract: false, final false
inline ::StringW get_DomainKey() ;

/// @brief Method get_Expired, addr 0x2d6edcc, size 0xb8, virtual false, abstract: false, final false
inline bool get_Expired() ;

/// @brief Method get_Name, addr 0x2d6ee8c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Path, addr 0x2d6ef98, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Path() ;

/// @brief Method get_Plain, addr 0x2d6edbc, size 0x10, virtual false, abstract: false, final false
inline bool get_Plain() ;

/// @brief Method get_PortList, addr 0x2d6ff78, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_PortList() ;

/// @brief Method get_Secure, addr 0x2d70048, size 0x8, virtual false, abstract: false, final false
inline bool get_Secure() ;

/// @brief Method get_Value, addr 0x2d7005c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_Variant, addr 0x2d700cc, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::CookieVariant get_Variant() ;

/// @brief Method get_Version, addr 0x2d700f0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Version() ;

/// @brief Method get__Domain, addr 0x2d6ecf0, size 0xcc, virtual false, abstract: false, final false
inline ::StringW get__Domain() ;

/// @brief Method get__Path, addr 0x2d6f00c, size 0x9c, virtual false, abstract: false, final false
inline ::StringW get__Path() ;

/// @brief Method get__Port, addr 0x2d6ff80, size 0xc8, virtual false, abstract: false, final false
inline ::StringW get__Port() ;

/// @brief Method get__Version, addr 0x2d7016c, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method set_Comment, addr 0x2d6ebfc, size 0x58, virtual false, abstract: false, final false
inline void set_Comment(::StringW  value) ;

/// @brief Method set_CommentUri, addr 0x2d6ec54, size 0x8, virtual false, abstract: false, final false
inline void set_CommentUri(::System::Uri*  value) ;

/// @brief Method set_Discard, addr 0x2d6ec68, size 0xc, virtual false, abstract: false, final false
inline void set_Discard(bool  value) ;

/// @brief Method set_Domain, addr 0x2d6ec7c, size 0x74, virtual false, abstract: false, final false
inline void set_Domain(::StringW  value) ;

/// @brief Method set_Expires, addr 0x2d6ee84, size 0x8, virtual false, abstract: false, final false
inline void set_Expires(::System::DateTime  value) ;

/// @brief Method set_HttpOnly, addr 0x2d6ec5c, size 0xc, virtual false, abstract: false, final false
inline void set_HttpOnly(bool  value) ;

/// @brief Method set_Path, addr 0x2d6efa0, size 0x6c, virtual false, abstract: false, final false
inline void set_Path(::StringW  value) ;

/// @brief Method set_Port, addr 0x2d6fc4c, size 0x32c, virtual false, abstract: false, final false
inline void set_Port(::StringW  value) ;

/// @brief Method set_Secure, addr 0x2d70050, size 0xc, virtual false, abstract: false, final false
inline void set_Secure(bool  value) ;

/// @brief Method set_Value, addr 0x2d70064, size 0x68, virtual false, abstract: false, final false
inline void set_Value(::StringW  value) ;

/// @brief Method set_Version, addr 0x2d700f8, size 0x74, virtual false, abstract: false, final false
