...
public:
// Declarations
/// @brief Method Invoke, addr 0x2cd5c30, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cd5b94, size 0x9c, virtual false, abstract: false, final false
