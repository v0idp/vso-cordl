...
/// @brief Method <SetAndVerifySelectionCallback>b__0, addr 0x2cd68b4, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cd6150, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AuthenticateAsClient, addr 0x2cd6158, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method AuthenticateAsClientAsync, addr 0x2cd622c, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method BeginAuthenticateAsClient, addr 0x2cd61ac, size 0x74, virtual true, abstract: false, final false
...
/// @brief Method BeginRead, addr 0x2cd6788, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x2cd683c, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method CheckDisposed, addr 0x2cd5c5c, size 0x5c, virtual false, abstract: false, final false
inline void CheckDisposed() ;

/// @brief Method Dispose, addr 0x2cd657c, size 0xac, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndAuthenticateAsClient, addr 0x2cd6220, size 0xc, virtual true, abstract: false, final false
inline void EndAuthenticateAsClient(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EndRead, addr 0x2cd67f4, size 0x48, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  asyncResult) ;

/// @brief Method EndWrite, addr 0x2cd68a8, size 0xc, virtual true, abstract: false, final false
inline void EndWrite(::System::IAsyncResult*  asyncResult) ;

/// @brief Method Flush, addr 0x2cd6558, size 0x24, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushAsync, addr 0x2cd6534, size 0x24, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method GetProvider, addr 0x2cd5cdc, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x2cd6628, size 0x54, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadAsync, addr 0x2cd66d0, size 0x5c, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count, ::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method Seek, addr 0x2cd64dc, size 0x58, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetAndVerifySelectionCallback, addr 0x2cd5ec0, size 0x16c, virtual false, abstract: false, final false
inline void SetAndVerifySelectionCallback(::System::Net::Security::LocalCertificateSelectionCallback*  callback) ;

/// @brief Method SetAndVerifyValidationCallback, addr 0x2cd5de8, size 0xd8, virtual false, abstract: false, final false
inline void SetAndVerifyValidationCallback(::System::Net::Security::RemoteCertificateValidationCallback*  callback) ;

/// @brief Method SetLength, addr 0x2cd64a0, size 0x3c, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method Write, addr 0x2cd667c, size 0x54, virtual true, abstract: false, final false
inline void Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteAsync, addr 0x2cd672c, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cd602c, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cd5d4c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cd5d58, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method get_CanRead, addr 0x2cd62d8, size 0x18, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x2cd62d0, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanTimeout, addr 0x2cd62f0, size 0x20, virtual true, abstract: false, final false
inline bool get_CanTimeout() ;

/// @brief Method get_CanWrite, addr 0x2cd6310, size 0x18, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Impl, addr 0x2cd5c44, size 0x18, virtual false, abstract: false, final false
inline ::Mono::Net::Security::MobileAuthenticatedStream* get_Impl() ;

/// @brief Method get_InternalTargetHost, addr 0x2cd5cb8, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_InternalTargetHost() ;

/// @brief Method get_IsAuthenticated, addr 0x2cd6280, size 0x2c, virtual true, abstract: false, final false
inline bool get_IsAuthenticated() ;

/// @brief Method get_Length, addr 0x2cd63f8, size 0x28, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_LocalCertificate, addr 0x2cd62ac, size 0x24, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalCertificate() ;

/// @brief Method get_Position, addr 0x2cd6420, size 0x28, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method get_ReadTimeout, addr 0x2cd6328, size 0x2c, virtual true, abstract: false, final false
inline int32_t get_ReadTimeout() ;

/// @brief Method get_WriteTimeout, addr 0x2cd6390, size 0x2c, virtual true, abstract: false, final false
inline int32_t get_WriteTimeout() ;

/// @brief Method set_Position, addr 0x2cd6448, size 0x58, virtual true, abstract: false, final false
inline void set_Position(int64_t  value) ;

/// @brief Method set_ReadTimeout, addr 0x2cd6354, size 0x3c, virtual true, abstract: false, final false
inline void set_ReadTimeout(int32_t  value) ;

/// @brief Method set_WriteTimeout, addr 0x2cd63bc, size 0x3c, virtual true, abstract: false, final false
