...
/// @brief Method AsyncReadCallback, addr 0x2d5b5d8, size 0x2b0, virtual false, abstract: false, final false
inline void AsyncReadCallback(::System::IAsyncResult*  ar) ;

/// @brief Method BeginRead, addr 0x2d5b888, size 0x198, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x2d5bbc0, size 0xf4, virtual true, abstract: false, final false
...
/// @brief Method CheckError, addr 0x2d5b25c, size 0x40, virtual false, abstract: false, final false
inline void CheckError() ;

/// @brief Method Dispose, addr 0x2d5acf8, size 0x188, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EndRead, addr 0x2d5ba20, size 0x1a0, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  ar) ;

/// @brief Method EndWrite, addr 0x2d5bcb4, size 0xa0, virtual true, abstract: false, final false
inline void EndWrite(::System::IAsyncResult*  asyncResult) ;

/// @brief Method Flush, addr 0x2d5bd54, size 0x24, virtual true, abstract: false, final false
inline void Flush() ;
...
/// @brief Method Read, addr 0x2d5b3fc, size 0x104, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method Seek, addr 0x2d5b330, size 0xcc, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  offset, ::System::IO::SeekOrigin  origin) ;

/// @brief Method SetLength, addr 0x2d5bd78, size 0x24, virtual true, abstract: false, final false
inline void SetLength(int64_t  value) ;

/// @brief Method SetSocketTimeoutOption, addr 0x2d5be4c, size 0x50, virtual false, abstract: false, final false
inline void SetSocketTimeoutOption(int32_t  timeout) ;

/// @brief Method System.Net.ICloseEx.CloseEx, addr 0x2d5ae80, size 0x3dc, virtual true, abstract: false, final true
inline void System_Net_ICloseEx_CloseEx(::System::Net::CloseExState  closeState) ;

/// @brief Method Write, addr 0x2d5b500, size 0xd8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d57038, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method get_CanRead, addr 0x2d5b29c, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRead() ;

/// @brief Method get_CanSeek, addr 0x2d5b2a4, size 0x20, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanTimeout, addr 0x2d5bd9c, size 0x20, virtual true, abstract: false, final false
inline bool get_CanTimeout() ;

/// @brief Method get_CanWrite, addr 0x2d5b2c4, size 0x8, virtual true, abstract: false, final false
inline bool get_CanWrite() ;

/// @brief Method get_Length, addr 0x2d5b2cc, size 0x20, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Position, addr 0x2d5b2ec, size 0x20, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method get_ReadTimeout, addr 0x2d5bdbc, size 0x24, virtual true, abstract: false, final false
inline int32_t get_ReadTimeout() ;

/// @brief Method get_WriteTimeout, addr 0x2d5be04, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method set_Position, addr 0x2d5b30c, size 0x24, virtual true, abstract: false, final false
inline void set_Position(int64_t  value) ;

/// @brief Method set_ReadTimeout, addr 0x2d5bde0, size 0x24, virtual true, abstract: false, final false
inline void set_ReadTimeout(int32_t  value) ;

/// @brief Method set_WriteTimeout, addr 0x2d5be28, size 0x24, virtual true, abstract: false, final false
