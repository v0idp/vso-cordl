...
/// @brief Method GetCredential, addr 0x2d642f0, size 0x4, virtual true, abstract: false, final true
inline ::System::Net::NetworkCredential* GetCredential(::System::Uri*  uri, ::StringW  authType) ;

/// @brief Method InternalGetDomain, addr 0x2d642e8, size 0x8, virtual false, abstract: false, final false
inline ::StringW InternalGetDomain() ;

/// @brief Method InternalGetPassword, addr 0x2d642d4, size 0xc, virtual false, abstract: false, final false
inline ::StringW InternalGetPassword() ;

/// @brief Method InternalGetUserName, addr 0x2d642e0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d5cd98, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::StringW  userName, ::StringW  password) ;

/// @brief Method .ctor, addr 0x2d6158c, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(::StringW  userName, ::StringW  password, ::StringW  domain) ;

/// @brief Method get_Domain, addr 0x2d59ab4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Domain() ;

/// @brief Method get_Password, addr 0x2d59abc, size 0xc, virtual false, abstract: false, final false
inline ::StringW get_Password() ;

/// @brief Method get_UserName, addr 0x2d59aac, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_UserName() ;

/// @brief Convert to "::System::Net::ICredentials"
constexpr ::System::Net::ICredentials* i___System__Net__ICredentials() noexcept;

/// @brief Method set_Domain, addr 0x2d6427c, size 0x58, virtual false, abstract: false, final false
inline void set_Domain(::StringW  value) ;

/// @brief Method set_Password, addr 0x2d6425c, size 0x20, virtual false, abstract: false, final false
inline void set_Password(::StringW  value) ;

/// @brief Method set_UserName, addr 0x2d64204, size 0x58, virtual false, abstract: false, final false
