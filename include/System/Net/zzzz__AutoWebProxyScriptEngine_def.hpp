...
public:
// Declarations
/// @brief Method GetProxies, addr 0x2d7b0bc, size 0xc, virtual false, abstract: false, final false
inline bool GetProxies(::System::Uri*  destination, ::ByRef<::System::Collections::Generic::IList_1<::StringW>*>  proxyList) ;

/// @brief Method GetProxies, addr 0x2d7b468, size 0xc, virtual false, abstract: false, final false
