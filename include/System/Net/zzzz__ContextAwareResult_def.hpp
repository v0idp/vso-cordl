...
/// @brief Method <Complete>b__17_0, addr 0x2d4f8f0, size 0x80, virtual false, abstract: false, final false
inline void _Complete_b__17_0(::System::Object*  s) ;

/// @brief Method .ctor, addr 0x2d4f8e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CaptureOrComplete, addr 0x2d4f054, size 0x3f8, virtual false, abstract: false, final false
inline bool CaptureOrComplete(::ByRef<::System::Threading::ExecutionContext*>  cachedContext, bool  returnContext) ;

/// @brief Method Cleanup, addr 0x2d4f44c, size 0xa8, virtual true, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CleanupInternal, addr 0x2d4ee48, size 0x4, virtual false, abstract: false, final false
inline void CleanupInternal() ;

/// @brief Method Complete, addr 0x2d4f4f4, size 0x2e4, virtual true, abstract: false, final false
inline void Complete(::System::IntPtr  userToken) ;

/// @brief Method CompleteCallback, addr 0x2d4f7d8, size 0xb4, virtual false, abstract: false, final false
inline void CompleteCallback() ;

/// @brief Method FinishPostingAsyncOp, addr 0x2d4f014, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method SafeCaptureIdentity, addr 0x2d4ee44, size 0x4, virtual false, abstract: false, final false
inline void SafeCaptureIdentity() ;

/// @brief Method StartPostingAsyncOp, addr 0x2d4ef1c, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* StartPostingAsyncOp() ;

/// @brief Method StartPostingAsyncOp, addr 0x2d4ef24, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d4ee54, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d4eea4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d4ee4c, size 0x8, virtual false, abstract: false, final false
