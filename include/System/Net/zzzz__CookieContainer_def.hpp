...
/// @brief Method Add, addr 0x2d72cdc, size 0x80c, virtual false, abstract: false, final false
inline void Add(::System::Net::Cookie*  cookie, bool  throwOnError) ;

/// @brief Method AddRemoveDomain, addr 0x2d72bb8, size 0x124, virtual false, abstract: false, final false
inline void AddRemoveDomain(::StringW  key, ::System::Net::PathList*  value) ;

/// @brief Method AgeCookies, addr 0x2d73b18, size 0x1538, virtual false, abstract: false, final false
inline bool AgeCookies(::StringW  domain) ;

/// @brief Method BuildCookieCollectionFromDomainMatches, addr 0x2d76014, size 0x820, virtual false, abstract: false, final false
...
/// @brief Method CookieCutter, addr 0x2d754ac, size 0x6d8, virtual false, abstract: false, final false
inline ::System::Net::CookieCollection* CookieCutter(::System::Uri*  uri, ::StringW  headerName, ::StringW  setCookieHeader, bool  isThrow) ;

/// @brief Method ExpireCollection, addr 0x2d7507c, size 0x16c, virtual false, abstract: false, final false
inline int32_t ExpireCollection(::System::Net::CookieCollection*  cc) ;

/// @brief Method GetCookieHeader, addr 0x2d76a64, size 0xcc, virtual false, abstract: false, final false
inline ::StringW GetCookieHeader(::System::Uri*  uri) ;

/// @brief Method GetCookieHeader, addr 0x2d76b30, size 0x398, virtual false, abstract: false, final false
inline ::StringW GetCookieHeader(::System::Uri*  uri, ::ByRef<::StringW>  optCookie2) ;

/// @brief Method InternalGetCookies, addr 0x2d75b84, size 0x490, virtual false, abstract: false, final false
inline ::System::Net::CookieCollection* InternalGetCookies(::System::Uri*  uri) ;

/// @brief Method IsLocalDomain, addr 0x2d7520c, size 0x2a0, virtual false, abstract: false, final false
inline bool IsLocalDomain(::StringW  host) ;

/// @brief Method MergeUpdateCollections, addr 0x2d76858, size 0x20c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d72ac0, size 0xf8, virtual false, abstract: false, final false
inline void _ctor() ;
