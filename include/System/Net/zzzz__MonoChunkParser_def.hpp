...
/// @brief Method Read, addr 0x2d89434, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d89f04, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method GetChunkSize, addr 0x2d895f0, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method InternalWrite, addr 0x2d894b4, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x2d89118, size 0x4, virtual false, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method ReadBody, addr 0x2d898e8, size 0x134, virtual false, abstract: false, final false
inline ::System::Net::MonoChunkParser_State ReadBody(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, ::ByRef<int32_t>  offset, int32_t  size) ;

/// @brief Method ReadCRLF, addr 0x2d89a1c, size 0x100, virtual false, abstract: false, final false
inline ::System::Net::MonoChunkParser_State ReadCRLF(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, ::ByRef<int32_t>  offset, int32_t  size) ;

/// @brief Method ReadFromChunks, addr 0x2d8911c, size 0x318, virtual false, abstract: false, final false
inline int32_t ReadFromChunks(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method ReadTrailer, addr 0x2d89b1c, size 0x2b8, virtual false, abstract: false, final false
...
/// @brief Method RemoveChunkExtension, addr 0x2d89f7c, size 0x48, virtual false, abstract: false, final false
static inline ::StringW RemoveChunkExtension(::StringW  input) ;

/// @brief Method ThrowProtocolViolation, addr 0x2d89f2c, size 0x50, virtual false, abstract: false, final false
static inline void ThrowProtocolViolation(::StringW  message) ;

/// @brief Method Write, addr 0x2d89494, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d8906c, size 0xac, virtual false, abstract: false, final false
inline void _ctor(::System::Net::WebHeaderCollection*  headers) ;

/// @brief Method get_ChunkLeft, addr 0x2d89ef8, size 0xc, virtual false, abstract: false, final false
inline int32_t get_ChunkLeft() ;

/// @brief Method get_DataAvailable, addr 0x2d89df8, size 0x100, virtual false, abstract: false, final false
inline bool get_DataAvailable() ;

/// @brief Method get_WantMore, addr 0x2d89dd4, size 0x24, virtual false, abstract: false, final false
