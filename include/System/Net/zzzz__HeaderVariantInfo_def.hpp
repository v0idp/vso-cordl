...
/// @brief Method .ctor, addr 0x2d72aa4, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::System::Net::CookieVariant  variant) ;

/// @brief Method get_Name, addr 0x2d72ab0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_Variant, addr 0x2d72ab8, size 0x8, virtual false, abstract: false, final false
