...
/// @brief Method GetKey, addr 0x2d7e54c, size 0x90, virtual false, abstract: false, final false
inline ::StringW GetKey() ;

/// @brief Method GetKeywordAndValue, addr 0x2d7e33c, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x2d7e1a4, size 0x198, virtual false, abstract: false, final false
inline bool Parse() ;

/// @brief Method SkipWhitespace, addr 0x2d7e4cc, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d7e018, size 0xb4, virtual false, abstract: false, final false
inline void _ctor(::StringW  header) ;

static inline ::ArrayW<::StringW,::Array<::StringW>*> getStaticF_keywords() ;

/// @brief Method get_Algorithm, addr 0x2d7e14c, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_Algorithm() ;

/// @brief Method get_Nonce, addr 0x2d7e120, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_Nonce() ;

/// @brief Method get_Opaque, addr 0x2d7e0f4, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_Opaque() ;

/// @brief Method get_QOP, addr 0x2d7e178, size 0x2c, virtual false, abstract: false, final false
inline ::StringW get_QOP() ;

/// @brief Method get_Realm, addr 0x2d7e0cc, size 0x28, virtual false, abstract: false, final false
