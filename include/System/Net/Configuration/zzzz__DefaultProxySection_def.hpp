...
/// @brief Method Reset, addr 0x2cd6ab8, size 0x38, virtual true, abstract: false, final false
inline void Reset(::System::Configuration::ConfigurationElement*  parentElement) ;

/// @brief Method .ctor, addr 0x2cd6a48, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Properties, addr 0x2cd6a80, size 0x38, virtual true, abstract: false, final false
