...
/// @brief Method .ctor, addr 0x2cc1ba4, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Net::Configuration::SettingsSectionInternal* getStaticF_instance() ;

/// @brief Method get_Ipv6Enabled, addr 0x2cc1b9c, size 0x8, virtual false, abstract: false, final false
inline bool get_Ipv6Enabled() ;

/// @brief Method get_Section, addr 0x2cc1b44, size 0x58, virtual false, abstract: false, final false
