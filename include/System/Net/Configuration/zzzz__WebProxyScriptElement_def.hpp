...
/// @brief Method .ctor, addr 0x2cd6e38, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Properties, addr 0x2cd6e70, size 0x38, virtual true, abstract: false, final false
