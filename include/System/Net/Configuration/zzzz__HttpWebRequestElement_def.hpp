...
/// @brief Method .ctor, addr 0x2cd6b60, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Properties, addr 0x2cd6b98, size 0x38, virtual true, abstract: false, final false
