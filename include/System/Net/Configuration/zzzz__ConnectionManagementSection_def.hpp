...
/// @brief Method .ctor, addr 0x2cd69d8, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Properties, addr 0x2cd6a10, size 0x38, virtual true, abstract: false, final false
