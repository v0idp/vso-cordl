...
/// @brief Method Equals, addr 0x2d52cdc, size 0x8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  comparand) ;

/// @brief Method Equals, addr 0x2d52ba8, size 0x134, virtual false, abstract: false, final false
inline bool Equals(::System::Object*  comparandObj, bool  compareScopeId) ;

/// @brief Method GetAddressBytes, addr 0x2d52824, size 0x148, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetAddressBytes() ;

/// @brief Method GetHashCode, addr 0x2d52ce4, size 0x3f0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IsLoopback, addr 0x2d52ae0, size 0xc8, virtual false, abstract: false, final false
static inline bool IsLoopback(::System::Net::IPAddress*  address) ;

/// @brief Method MapToIPv6, addr 0x2d530d4, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x2d525a8, size 0x98, virtual false, abstract: false, final false
static inline ::System::Net::IPAddress* Parse(::StringW  ipString) ;

/// @brief Method ThrowAddressNullException, addr 0x2d520c4, size 0x4c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ThrowAddressNullException() ;

/// @brief Method ToString, addr 0x2d529d4, size 0x98, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryParse, addr 0x2d52378, size 0x6c, virtual false, abstract: false, final false
static inline bool TryParse(::StringW  ipString, ::ByRef<::System::Net::IPAddress*>  address) ;

/// @brief Method TryWriteBytes, addr 0x2d52640, size 0x10c, virtual false, abstract: false, final false
inline bool TryWriteBytes(::System::Span_1<uint8_t>  destination, ::ByRef<int32_t>  bytesWritten) ;

/// @brief Method WriteIPv4Bytes, addr 0x2d527d8, size 0x4c, virtual false, abstract: false, final false
inline void WriteIPv4Bytes(::System::Span_1<uint8_t>  destination) ;

/// @brief Method WriteIPv6Bytes, addr 0x2d5274c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d52048, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  address, int64_t  scopeid) ;

/// @brief Method .ctor, addr 0x2d52110, size 0x17c, virtual false, abstract: false, final false
inline void _ctor(::System::ReadOnlySpan_1<uint8_t>  address, int64_t  scopeid) ;

/// @brief Method .ctor, addr 0x2d51fc8, size 0x80, virtual false, abstract: false, final false
inline void _ctor(int64_t  newAddress) ;

/// @brief Method .ctor, addr 0x2d52344, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint16_t,::Array<uint16_t>*>  numbers, uint32_t  scopeid) ;

/// @brief Method .ctor, addr 0x2d5228c, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method get_AddressFamily, addr 0x2d5296c, size 0x18, virtual false, abstract: false, final false
inline ::System::Net::Sockets::AddressFamily get_AddressFamily() ;

/// @brief Method get_IsIPv4, addr 0x2d51f78, size 0x10, virtual false, abstract: false, final false
inline bool get_IsIPv4() ;

/// @brief Method get_IsIPv6, addr 0x2d51f88, size 0x10, virtual false, abstract: false, final false
inline bool get_IsIPv6() ;

/// @brief Method get_PrivateAddress, addr 0x2d51f98, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_PrivateAddress() ;

/// @brief Method get_PrivateScopeId, addr 0x2d51fb0, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_PrivateScopeId() ;

/// @brief Method get_ScopeId, addr 0x2d52984, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method set_PrivateAddress, addr 0x2d51fa0, size 0x10, virtual false, abstract: false, final false
inline void set_PrivateAddress(uint32_t  value) ;

/// @brief Method set_PrivateScopeId, addr 0x2d51fb8, size 0x10, virtual false, abstract: false, final false
