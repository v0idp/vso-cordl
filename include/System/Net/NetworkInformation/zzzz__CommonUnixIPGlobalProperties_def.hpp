...
/// @brief Method .ctor, addr 0x2cc16d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_DomainName, addr 0x2cc154c, size 0x18c, virtual true, abstract: false, final false
inline ::StringW get_DomainName() ;

/// @brief Method getdomainname, addr 0x2cc14c0, size 0x8c, virtual false, abstract: false, final false
