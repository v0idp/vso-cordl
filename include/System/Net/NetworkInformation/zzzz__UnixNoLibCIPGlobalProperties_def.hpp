...
/// @brief Method .ctor, addr 0x2cc1730, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_DomainName, addr 0x2cc16e8, size 0x48, virtual true, abstract: false, final false
