...
/// @brief Method CheckBadHeaderValueChars, addr 0x2d5000c, size 0x1e4, virtual false, abstract: false, final false
static inline ::StringW CheckBadHeaderValueChars(::StringW  value) ;

/// @brief Method IsInvalidMethodOrHeaderString, addr 0x2d501f0, size 0x100, virtual false, abstract: false, final false
