...
/// @brief Method BeginRead, addr 0x2d92838, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method BeginWrite, addr 0x2d92b18, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method Close, addr 0x2d9309c, size 0x14, virtual true, abstract: false, final false
inline void Close() ;
...
/// @brief Method EndRead, addr 0x2d929f8, size 0x120, virtual true, abstract: false, final false
inline int32_t EndRead(::System::IAsyncResult*  r) ;

/// @brief Method EndWrite, addr 0x2d92cd8, size 0xf4, virtual true, abstract: false, final false
inline void EndWrite(::System::IAsyncResult*  r) ;

/// @brief Method Flush, addr 0x2d92fb4, size 0x4, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushAsync, addr 0x2d92fb8, size 0xe4, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* FlushAsync(::System::Threading::CancellationToken  cancellationToken) ;

/// @brief Method GetException, addr 0x2d923e4, size 0x160, virtual false, abstract: false, final false
inline ::System::Exception* GetException(::System::Exception*  e) ;

/// @brief Method InternalClose, addr 0x2d86124, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Read, addr 0x2d92544, size 0x294, virtual true, abstract: false, final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method Seek, addr 0x2d930b0, size 0x4c, virtual true, abstract: false, final false
inline int64_t Seek(int64_t  a, ::System::IO::SeekOrigin  b) ;

/// @brief Method SetLength, addr 0x2d930fc, size 0x4c, virtual true, abstract: false, final false
...
/// @brief Method Write, addr 0x2d92dcc, size 0x1e8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d92218, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::System::Net::WebConnection*  cnc, ::System::Net::WebOperation*  operation) ;

/// @brief Method get_CanSeek, addr 0x2d93148, size 0x8, virtual true, abstract: false, final false
inline bool get_CanSeek() ;

/// @brief Method get_CanTimeout, addr 0x2d9230c, size 0x8, virtual true, abstract: false, final false
inline bool get_CanTimeout() ;

/// @brief Method get_Connection, addr 0x2d922e0, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::WebConnection* get_Connection() ;

/// @brief Method get_Length, addr 0x2d93150, size 0x4c, virtual true, abstract: false, final false
inline int64_t get_Length() ;

/// @brief Method get_Operation, addr 0x2d922e8, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::WebOperation* get_Operation() ;

/// @brief Method get_Position, addr 0x2d9319c, size 0x4c, virtual true, abstract: false, final false
inline int64_t get_Position() ;

/// @brief Method get_ReadTimeout, addr 0x2d92314, size 0x8, virtual true, abstract: false, final false
inline int32_t get_ReadTimeout() ;

/// @brief Method get_Request, addr 0x2d922d8, size 0x8, virtual false, abstract: false, final false
inline ::System::Net::HttpWebRequest* get_Request() ;

/// @brief Method get_ServicePoint, addr 0x2d922f0, size 0x1c, virtual false, abstract: false, final false
inline ::System::Net::ServicePoint* get_ServicePoint() ;

/// @brief Method get_WriteTimeout, addr 0x2d9237c, size 0x8, virtual true, abstract: false, final false
inline int32_t get_WriteTimeout() ;

/// @brief Method set_Position, addr 0x2d931e8, size 0x4c, virtual true, abstract: false, final false
inline void set_Position(int64_t  value) ;

/// @brief Method set_ReadTimeout, addr 0x2d9231c, size 0x60, virtual true, abstract: false, final false
inline void set_ReadTimeout(int32_t  value) ;

/// @brief Method set_WriteTimeout, addr 0x2d92384, size 0x60, virtual true, abstract: false, final false
