...
/// @brief Method AddModifier, addr 0x279e934, size 0xec, virtual false, abstract: false, final false
inline void AddModifier(::System::ModifierSpec*  md) ;

/// @brief Method AddName, addr 0x279e818, size 0x118, virtual false, abstract: false, final false
inline void AddName(::StringW  type_name) ;

/// @brief Method BoundCheck, addr 0x279ead0, size 0x84, virtual false, abstract: false, final false
static inline void BoundCheck(int32_t  idx, ::StringW  s) ;

/// @brief Method GetDisplayFullName, addr 0x279d610, size 0x46c, virtual false, abstract: false, final false
inline ::StringW GetDisplayFullName(::System::TypeSpec_DisplayNameFormat  flags) ;

/// @brief Method GetModifierString, addr 0x279daa4, size 0x1f4, virtual false, abstract: false, final false
inline ::System::Text::StringBuilder* GetModifierString(::System::Text::StringBuilder*  sb) ;

static inline ::System::TypeSpec* New_ctor() ;

/// @brief Method Parse, addr 0x279dc98, size 0xb80, virtual false, abstract: false, final false
static inline ::System::TypeSpec* Parse(::StringW  name, ::ByRef<int32_t>  p, bool  is_recurse, bool  allow_aqn) ;

/// @brief Method Parse, addr 0x278c8f0, size 0xd0, virtual false, abstract: false, final false
static inline ::System::TypeSpec* Parse(::StringW  typeName) ;

/// @brief Method ParsedTypeIdentifier, addr 0x279e930, size 0x4, virtual false, abstract: false, final false
static inline ::System::TypeIdentifier* ParsedTypeIdentifier(::StringW  displayName) ;

/// @brief Method Resolve, addr 0x278c9c0, size 0x8e4, virtual false, abstract: false, final false
...
/// @brief Method SkipSpace, addr 0x279ea20, size 0xb0, virtual false, abstract: false, final false
static inline void SkipSpace(::StringW  name, ::ByRef<int32_t>  pos) ;

/// @brief Method UnescapeInternalName, addr 0x279d290, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x279eb54, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_DisplayFullName, addr 0x279da7c, size 0x28, virtual false, abstract: false, final false
inline ::StringW get_DisplayFullName() ;

/// @brief Method get_HasModifiers, addr 0x279d600, size 0x10, virtual false, abstract: false, final false
