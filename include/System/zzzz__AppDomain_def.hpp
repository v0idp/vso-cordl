...
/// @brief Method DoAssemblyLoad, addr 0x278a7bc, size 0x90, virtual false, abstract: false, final false
inline void DoAssemblyLoad(::System::Reflection::Assembly*  assembly) ;

/// @brief Method DoAssemblyResolve, addr 0x278a84c, size 0x2fc, virtual false, abstract: false, final false
...
/// @brief Method DoDomainUnload, addr 0x278ae14, size 0x24, virtual false, abstract: false, final false
inline void DoDomainUnload() ;

/// @brief Method DoTypeResolve, addr 0x278ab48, size 0x2cc, virtual false, abstract: false, final false
inline ::System::Reflection::Assembly* DoTypeResolve(::StringW  name) ;

/// @brief Method GetAssemblies, addr 0x278a420, size 0x8, virtual true, abstract: false, final true
inline ::ArrayW<::System::Reflection::Assembly*,::Array<::System::Reflection::Assembly*>*> GetAssemblies() ;

/// @brief Method GetAssemblies, addr 0x278a418, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::System::Reflection::Assembly*,::Array<::System::Reflection::Assembly*>*> GetAssemblies(bool  refOnly) ;

/// @brief Method GetData, addr 0x278a428, size 0x4, virtual true, abstract: false, final true
inline ::System::Object* GetData(::StringW  name) ;

/// @brief Method GetMarshalledDomainObjRef, addr 0x278ae38, size 0xd8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetMarshalledDomainObjRef() ;

/// @brief Method GetProcessGuid, addr 0x278a710, size 0x88, virtual false, abstract: false, final false
static inline ::StringW GetProcessGuid() ;

/// @brief Method InitializeLifetimeService, addr 0x278a42c, size 0x8, virtual true, abstract: false, final false
inline ::System::Object* InitializeLifetimeService() ;

/// @brief Method InternalGetContext, addr 0x278a574, size 0x4, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::Contexts::Context* InternalGetContext() ;

/// @brief Method InternalGetDefaultContext, addr 0x278a578, size 0x4, virtual false, abstract: false, final false
static inline ::System::Runtime::Remoting::Contexts::Context* InternalGetDefaultContext() ;

/// @brief Method InternalGetProcessGuid, addr 0x278a57c, size 0x4, virtual false, abstract: false, final false
static inline ::StringW InternalGetProcessGuid(::StringW  newguid) ;

/// @brief Method InternalIsFinalizingForUnload, addr 0x278a798, size 0x4, virtual false, abstract: false, final false
static inline bool InternalIsFinalizingForUnload(int32_t  domain_id) ;

/// @brief Method InternalPopDomainRef, addr 0x278a56c, size 0x4, virtual false, abstract: false, final false
static inline void InternalPopDomainRef() ;

/// @brief Method InternalPushDomainRefByID, addr 0x278a568, size 0x4, virtual false, abstract: false, final false
static inline void InternalPushDomainRefByID(int32_t  domain_id) ;

/// @brief Method InternalSetContext, addr 0x278a570, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method InternalSetDomain, addr 0x278a564, size 0x4, virtual false, abstract: false, final false
static inline ::System::AppDomain* InternalSetDomain(::System::AppDomain*  context) ;

/// @brief Method InternalSetDomainByID, addr 0x278a560, size 0x4, virtual false, abstract: false, final false
static inline ::System::AppDomain* InternalSetDomainByID(int32_t  domain_id) ;

/// @brief Method InvokeInDomainByID, addr 0x278a580, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method IsAppXModel, addr 0x278a3fc, size 0x8, virtual false, abstract: false, final false
static inline bool IsAppXModel() ;

/// @brief Method IsFinalizingForUnload, addr 0x278a79c, size 0x14, virtual false, abstract: false, final false
inline bool IsFinalizingForUnload() ;

/// @brief Method Load, addr 0x278a43c, size 0x24, virtual true, abstract: false, final true
inline ::System::Reflection::Assembly* Load(::StringW  assemblyString) ;

/// @brief Method Load, addr 0x278a460, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method LoadAssembly, addr 0x278a434, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ProcessMessageInDomain, addr 0x278af10, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x278a7b8, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x278a404, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_AssemblyResolve, addr 0x278b038, size 0x98, virtual true, abstract: false, final true
inline void add_AssemblyResolve(::System::ResolveEventHandler*  value) ;

/// @brief Method add_DomainUnload, addr 0x278b424, size 0x98, virtual true, abstract: false, final true
inline void add_DomainUnload(::System::EventHandler*  value) ;

/// @brief Method add_UnhandledException, addr 0x278b554, size 0x98, virtual true, abstract: false, final true
inline void add_UnhandledException(::System::UnhandledExceptionEventHandler*  value) ;

/// @brief Method getCurDomain, addr 0x278a410, size 0x4, virtual false, abstract: false, final false
static inline ::System::AppDomain* getCurDomain() ;

/// @brief Method getDomainID, addr 0x278a7b0, size 0x8, virtual false, abstract: false, final false
inline int32_t getDomainID() ;

/// @brief Method getFriendlyName, addr 0x278a40c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_CurrentDomain, addr 0x278a414, size 0x4, virtual false, abstract: false, final false
static inline ::System::AppDomain* get_CurrentDomain() ;

/// @brief Method get_IsFullyTrusted, addr 0x278b68c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsFullyTrusted() ;

/// @brief Method get_IsHomogenous, addr 0x278b684, size 0x8, virtual false, abstract: false, final false
inline bool get_IsHomogenous() ;

/// @brief Method remove_AssemblyResolve, addr 0x278b230, size 0x98, virtual true, abstract: false, final true
inline void remove_AssemblyResolve(::System::ResolveEventHandler*  value) ;

/// @brief Method remove_DomainUnload, addr 0x278b4bc, size 0x98, virtual true, abstract: false, final true
inline void remove_DomainUnload(::System::EventHandler*  value) ;

/// @brief Method remove_UnhandledException, addr 0x278b5ec, size 0x98, virtual true, abstract: false, final true
