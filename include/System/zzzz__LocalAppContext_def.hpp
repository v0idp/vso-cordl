...
/// @brief Method .ctor, addr 0x2a2f054, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_DisableCaching>b__6_0, addr 0x2a2f05c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method GetCachedSwitchValue, addr 0x2a2ee34, size 0x20, virtual false, abstract: false, final false
static inline bool GetCachedSwitchValue(::StringW  switchName, ::ByRef<int32_t>  switchValue) ;

/// @brief Method GetCachedSwitchValueInternal, addr 0x2a2ee54, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method get_DisableCaching, addr 0x2a2eee8, size 0x110, virtual false, abstract: false, final false
