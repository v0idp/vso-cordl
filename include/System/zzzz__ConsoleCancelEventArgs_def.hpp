...
/// @brief Method .ctor, addr 0x2765e40, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2765dcc, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::System::ConsoleSpecialKey  type) ;

/// @brief Method get_Cancel, addr 0x2765e38, size 0x8, virtual false, abstract: false, final false
