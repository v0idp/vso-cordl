...
/// @brief Method GetObjectData, addr 0x2754e68, size 0x108, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2754cdc, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2754de0, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method .ctor, addr 0x2754d74, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::StringW  objectName) ;

/// @brief Method .ctor, addr 0x2754d3c, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::StringW  objectName, ::StringW  message) ;

/// @brief Method get_Message, addr 0x275503c, size 0xd4, virtual true, abstract: false, final false
inline ::StringW get_Message() ;

/// @brief Method get_ObjectName, addr 0x2754f70, size 0x54, virtual false, abstract: false, final false
