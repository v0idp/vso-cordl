...
/// @brief Method .ctor, addr 0x2787f14, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TypeHandle, addr 0x2787f6c, size 0x50, virtual true, abstract: false, final false
