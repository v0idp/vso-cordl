...
/// @brief Method DetermineVersion, addr 0x279ce80, size 0xa8, virtual false, abstract: false, final false
inline void DetermineVersion(int16_t  magic) ;

/// @brief Method Get, addr 0x2797ba0, size 0x90, virtual false, abstract: false, final false
inline ::StringW Get(::System::TermInfoStrings  tstr) ;

/// @brief Method Get, addr 0x2797c30, size 0x60, virtual false, abstract: false, final false
inline int32_t Get(::System::TermInfoNumbers  number) ;

/// @brief Method GetInt16, addr 0x279cf28, size 0x50, virtual false, abstract: false, final false
inline int16_t GetInt16(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset) ;

/// @brief Method GetString, addr 0x279cf78, size 0x7c, virtual false, abstract: false, final false
inline ::StringW GetString(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset) ;

/// @brief Method GetStringBytes, addr 0x279cff4, size 0xb8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetStringBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset) ;

/// @brief Method GetStringBytes, addr 0x279badc, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method ReadHeader, addr 0x279cd8c, size 0xc0, virtual false, abstract: false, final false
inline void ReadHeader(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, ::ByRef<int32_t>  position) ;

/// @brief Method ReadNames, addr 0x279ce4c, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2797354, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::StringW  term, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer) ;

/// @brief Method .ctor, addr 0x2797090, size 0x2c4, virtual false, abstract: false, final false
