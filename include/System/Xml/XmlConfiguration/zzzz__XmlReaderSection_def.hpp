...
public:
// Declarations
/// @brief Method CreateDefaultResolver, addr 0x2c85e90, size 0x54, virtual false, abstract: false, final false
static inline ::System::Xml::XmlResolver* CreateDefaultResolver() ;

/// @brief Method get_CollapseWhiteSpaceIntoEmptyString, addr 0x2c85ee4, size 0x8, virtual false, abstract: false, final false
static inline bool get_CollapseWhiteSpaceIntoEmptyString() ;

/// @brief Method get_ProhibitDefaultUrlResolver, addr 0x2c85e88, size 0x8, virtual false, abstract: false, final false
