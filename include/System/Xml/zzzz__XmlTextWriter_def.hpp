...
public:
// Declarations
/// @brief Method Init, addr 0x2c0d240, size 0x6c, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Set, addr 0x2c11890, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method AddNamespace, addr 0x2c116f8, size 0x198, virtual false, abstract: false, final false
inline void AddNamespace(::StringW  prefix, ::StringW  ns, bool  declared) ;

/// @brief Method AddToNamespaceHashtable, addr 0x2c118a8, size 0xe8, virtual false, abstract: false, final false
inline void AddToNamespaceHashtable(int32_t  namespaceIndex) ;

/// @brief Method AutoComplete, addr 0x2c0e1dc, size 0x4fc, virtual false, abstract: false, final false
inline void AutoComplete(::System::Xml::XmlTextWriter_Token  token) ;

/// @brief Method AutoCompleteAll, addr 0x2c0dba0, size 0x54, virtual false, abstract: false, final false
inline void AutoCompleteAll() ;

/// @brief Method Close, addr 0x2c10d30, size 0x138, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method FindPrefix, addr 0x2c0ec54, size 0xd0, virtual false, abstract: false, final false
inline ::StringW FindPrefix(::StringW  ns) ;

/// @brief Method Flush, addr 0x2c10e68, size 0x20, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushEncoders, addr 0x2c113f0, size 0x24, virtual false, abstract: false, final false
inline void FlushEncoders() ;

/// @brief Method GeneratePrefix, addr 0x2c0fb54, size 0x114, virtual false, abstract: false, final false
inline ::StringW GeneratePrefix() ;

/// @brief Method HandleSpecialAttribute, addr 0x2c114e8, size 0x210, virtual false, abstract: false, final false
inline void HandleSpecialAttribute() ;

/// @brief Method Indent, addr 0x2c10f88, size 0xd0, virtual false, abstract: false, final false
inline void Indent(bool  beforeEndElement) ;

/// @brief Method InternalWriteEndElement, addr 0x2c0f0b8, size 0x2dc, virtual false, abstract: false, final false
inline void InternalWriteEndElement(bool  longFormat) ;

/// @brief Method InternalWriteProcessingInstruction, addr 0x2c102fc, size 0xfc, virtual false, abstract: false, final false
inline void InternalWriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method LookupNamespace, addr 0x2c0eb78, size 0xdc, virtual false, abstract: false, final false
inline int32_t LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupNamespaceInCurrentScope, addr 0x2c0fa28, size 0x12c, virtual false, abstract: false, final false
inline int32_t LookupNamespaceInCurrentScope(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x2c10e88, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method PopNamespaces, addr 0x2c11414, size 0xd4, virtual false, abstract: false, final false
inline void PopNamespaces(int32_t  indexFrom, int32_t  indexTo) ;

/// @brief Method PushNamespace, addr 0x2c0ed24, size 0x22c, virtual false, abstract: false, final false
inline void PushNamespace(::StringW  prefix, ::StringW  ns, bool  declared) ;

/// @brief Method PushStack, addr 0x2c0eaa8, size 0xd0, virtual false, abstract: false, final false
inline void PushStack() ;

/// @brief Method StartDocument, addr 0x2c0d644, size 0x390, virtual false, abstract: false, final false
inline void StartDocument(int32_t  standalone) ;

/// @brief Method ValidateName, addr 0x2c0e024, size 0x1b8, virtual false, abstract: false, final false
inline void ValidateName(::StringW  name, bool  isNCName) ;

/// @brief Method VerifyPrefixXml, addr 0x2c0ef50, size 0x160, virtual false, abstract: false, final false
inline void VerifyPrefixXml(::StringW  prefix, ::StringW  ns) ;

/// @brief Method WriteBase64, addr 0x2c10af4, size 0x148, virtual true, abstract: false, final false
inline void WriteBase64(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteBinHex, addr 0x2c10c3c, size 0xd0, virtual true, abstract: false, final false
inline void WriteBinHex(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteCData, addr 0x2c0fd08, size 0x1c4, virtual true, abstract: false, final false
inline void WriteCData(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x2c104c4, size 0xc0, virtual true, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteChars, addr 0x2c10884, size 0xd8, virtual true, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteComment, addr 0x2c0fecc, size 0x200, virtual true, abstract: false, final false
inline void WriteComment(::StringW  text) ;

/// @brief Method WriteDocType, addr 0x2c0dbf4, size 0x430, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteEndAttribute, addr 0x2c0fc68, size 0xa0, virtual true, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndAttributeQuote, addr 0x2c11058, size 0x4c, virtual false, abstract: false, final false
inline void WriteEndAttributeQuote() ;

/// @brief Method WriteEndDocument, addr 0x2c0d9e8, size 0x1b8, virtual true, abstract: false, final false
inline void WriteEndDocument() ;

/// @brief Method WriteEndElement, addr 0x2c0f0b0, size 0x8, virtual true, abstract: false, final false
inline void WriteEndElement() ;

/// @brief Method WriteEndStartTag, addr 0x2c110a4, size 0x34c, virtual false, abstract: false, final false
inline void WriteEndStartTag(bool  empty) ;

/// @brief Method WriteEntityRef, addr 0x2c103f8, size 0xcc, virtual true, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteFullEndElement, addr 0x2c0f394, size 0x8, virtual true, abstract: false, final false
inline void WriteFullEndElement() ;

/// @brief Method WriteProcessingInstruction, addr 0x2c100cc, size 0x230, virtual true, abstract: false, final false
inline void WriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method WriteRaw, addr 0x2c1095c, size 0xd8, virtual true, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw, addr 0x2c10a34, size 0xc0, virtual true, abstract: false, final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteStartAttribute, addr 0x2c0f39c, size 0x68c, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartDocument, addr 0x2c0d63c, size 0x8, virtual true, abstract: false, final false
inline void WriteStartDocument() ;

/// @brief Method WriteStartDocument, addr 0x2c0d9d4, size 0x14, virtual true, abstract: false, final false
inline void WriteStartDocument(bool  standalone) ;

/// @brief Method WriteStartElement, addr 0x2c0e6d8, size 0x3d0, virtual true, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteString, addr 0x2c106f0, size 0xcc, virtual true, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x2c107bc, size 0xc8, virtual true, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteWhitespace, addr 0x2c10584, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c0d11c, size 0x124, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2c0d378, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  filename, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x2c0d2ac, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  w, ::System::Text::Encoding*  encoding) ;

/// @brief Method .ctor, addr 0x2c0d3f8, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method get_BaseStream, addr 0x2c0d48c, size 0x9c, virtual false, abstract: false, final false
inline ::System::IO::Stream* get_BaseStream() ;

/// @brief Method get_WriteState, addr 0x2c10d0c, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method set_Formatting, addr 0x2c0d59c, size 0x14, virtual false, abstract: false, final false
inline void set_Formatting(::System::Xml::Formatting  value) ;

/// @brief Method set_Namespaces, addr 0x2c0d528, size 0x74, virtual false, abstract: false, final false
inline void set_Namespaces(bool  value) ;

/// @brief Method set_QuoteChar, addr 0x2c0d5b0, size 0x8c, virtual false, abstract: false, final false
