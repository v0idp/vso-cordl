...
/// @brief Method GetPreamble, addr 0x2c522c4, size 0x78, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreamble() ;

static inline ::System::Xml::Ucs4Encoding1234* New_ctor() ;

/// @brief Method .ctor, addr 0x2c520b8, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_EncodingName, addr 0x2c52284, size 0x40, virtual true, abstract: false, final false
