...
/// @brief Method PeekBit, addr 0x2b349bc, size 0xc, virtual false, abstract: false, final false
inline bool PeekBit() ;

/// @brief Method PopBit, addr 0x2b34950, size 0x28, virtual false, abstract: false, final false
inline bool PopBit() ;

/// @brief Method PopCurr, addr 0x2b34978, size 0x44, virtual false, abstract: false, final false
inline void PopCurr() ;

/// @brief Method PushBit, addr 0x2b34848, size 0x38, virtual false, abstract: false, final false
inline void PushBit(bool  bit) ;

/// @brief Method PushCurr, addr 0x2b34880, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b34828, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
