...
/// @brief Method BreakDownXsdDate, addr 0x2b2a9b0, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method BreakDownXsdDateTime, addr 0x2b2a7e0, size 0x1d0, virtual false, abstract: false, final false
...
/// @brief Method BreakDownXsdTime, addr 0x2b2ab20, size 0x108, virtual false, abstract: false, final false
static inline void BreakDownXsdTime(int64_t  val, ::ByRef<int32_t>  hr, ::ByRef<int32_t>  min, ::ByRef<int32_t>  sec, ::ByRef<int32_t>  ms) ;

/// @brief Method GetFractions, addr 0x2b2bae4, size 0x114, virtual false, abstract: false, final false
static inline int32_t GetFractions(::System::DateTime  dt) ;

/// @brief Method GetFractions, addr 0x2b2bff8, size 0x13c, virtual false, abstract: false, final false
static inline int32_t GetFractions(::System::DateTimeOffset  dt) ;

/// @brief Method GetKatmaiDateTicks, addr 0x2b2b2fc, size 0x74, virtual false, abstract: false, final false
static inline int64_t GetKatmaiDateTicks(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::ByRef<int32_t>  pos) ;

/// @brief Method GetKatmaiTimeTicks, addr 0x2b2b400, size 0x228, virtual false, abstract: false, final false
static inline int64_t GetKatmaiTimeTicks(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::ByRef<int32_t>  pos) ;

/// @brief Method GetKatmaiTimeZoneTicks, addr 0x2b2b798, size 0x54, virtual false, abstract: false, final false
static inline int64_t GetKatmaiTimeZoneTicks(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  pos) ;

/// @brief Method SqlDateTimeToDateTime, addr 0x2b2b024, size 0xf4, virtual false, abstract: false, final false
static inline ::System::DateTime SqlDateTimeToDateTime(int32_t  dateticks, uint32_t  timeticks) ;

/// @brief Method SqlDateTimeToString, addr 0x2b2aee8, size 0x13c, virtual false, abstract: false, final false
static inline ::StringW SqlDateTimeToString(int32_t  dateticks, uint32_t  timeticks) ;

/// @brief Method SqlSmallDateTimeToDateTime, addr 0x2b2b208, size 0x74, virtual false, abstract: false, final false
static inline ::System::DateTime SqlSmallDateTimeToDateTime(int16_t  dateticks, uint16_t  timeticks) ;

/// @brief Method SqlSmallDateTimeToString, addr 0x2b2b118, size 0xf0, virtual false, abstract: false, final false
static inline ::StringW SqlSmallDateTimeToString(int16_t  dateticks, uint16_t  timeticks) ;

/// @brief Method Write2Dig, addr 0x2b2a0d0, size 0x5c, virtual false, abstract: false, final false
static inline void Write2Dig(::System::Text::StringBuilder*  sb, int32_t  val) ;

/// @brief Method Write3Dec, addr 0x2b2a1d0, size 0xac, virtual false, abstract: false, final false
static inline void Write3Dec(::System::Text::StringBuilder*  sb, int32_t  val) ;

/// @brief Method Write4DigNeg, addr 0x2b2a12c, size 0xa4, virtual false, abstract: false, final false
static inline void Write4DigNeg(::System::Text::StringBuilder*  sb, int32_t  val) ;

/// @brief Method WriteDate, addr 0x2b2a27c, size 0xb4, virtual false, abstract: false, final false
static inline void WriteDate(::System::Text::StringBuilder*  sb, int32_t  yr, int32_t  mnth, int32_t  day) ;

/// @brief Method WriteTime, addr 0x2b2a330, size 0xec, virtual false, abstract: false, final false
static inline void WriteTime(::System::Text::StringBuilder*  sb, int32_t  hr, int32_t  min, int32_t  sec, int32_t  ms) ;

/// @brief Method WriteTimeFullPrecision, addr 0x2b2a41c, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method WriteTimeZone, addr 0x2b2a70c, size 0xd4, virtual false, abstract: false, final false
static inline void WriteTimeZone(::System::Text::StringBuilder*  sb, bool  negTimeZone, int32_t  hr, int32_t  min) ;

/// @brief Method WriteTimeZone, addr 0x2b2a610, size 0xfc, virtual false, abstract: false, final false
static inline void WriteTimeZone(::System::Text::StringBuilder*  sb, ::System::TimeSpan  zone) ;

/// @brief Method XsdDateTimeToString, addr 0x2b2ac28, size 0x108, virtual false, abstract: false, final false
static inline ::StringW XsdDateTimeToString(int64_t  val) ;

/// @brief Method XsdDateToString, addr 0x2b2ad30, size 0xe4, virtual false, abstract: false, final false
static inline ::StringW XsdDateToString(int64_t  val) ;

/// @brief Method XsdKatmaiDateOffsetToDateTimeOffset, addr 0x2b2b68c, size 0x64, virtual false, abstract: false, final false
static inline ::System::DateTimeOffset XsdKatmaiDateOffsetToDateTimeOffset(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdKatmaiDateOffsetToString, addr 0x2b2bd24, size 0x138, virtual false, abstract: false, final false
static inline ::StringW XsdKatmaiDateOffsetToString(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdKatmaiDateTimeOffsetToDateTimeOffset, addr 0x2b2b6f0, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method XsdKatmaiDateTimeOffsetToString, addr 0x2b2be5c, size 0x19c, virtual false, abstract: false, final false
static inline ::StringW XsdKatmaiDateTimeOffsetToString(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdKatmaiDateTimeToDateTime, addr 0x2b2b370, size 0x90, virtual false, abstract: false, final false
static inline ::System::DateTime XsdKatmaiDateTimeToDateTime(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdKatmaiDateTimeToString, addr 0x2b2b968, size 0x17c, virtual false, abstract: false, final false
static inline ::StringW XsdKatmaiDateTimeToString(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdKatmaiDateToDateTime, addr 0x2b2b27c, size 0x80, virtual false, abstract: false, final false
static inline ::System::DateTime XsdKatmaiDateToDateTime(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdKatmaiDateToString, addr 0x2b2b850, size 0x118, virtual false, abstract: false, final false
static inline ::StringW XsdKatmaiDateToString(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdKatmaiTimeOffsetToDateTimeOffset, addr 0x2b2b7ec, size 0x64, virtual false, abstract: false, final false
static inline ::System::DateTimeOffset XsdKatmaiTimeOffsetToDateTimeOffset(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdKatmaiTimeOffsetToString, addr 0x2b2c134, size 0x14c, virtual false, abstract: false, final false
static inline ::StringW XsdKatmaiTimeOffsetToString(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdKatmaiTimeToDateTime, addr 0x2b2b628, size 0x64, virtual false, abstract: false, final false
static inline ::System::DateTime XsdKatmaiTimeToDateTime(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdKatmaiTimeToString, addr 0x2b2bbf8, size 0x12c, virtual false, abstract: false, final false
static inline ::StringW XsdKatmaiTimeToString(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method XsdTimeToString, addr 0x2b2ae14, size 0xd4, virtual false, abstract: false, final false
