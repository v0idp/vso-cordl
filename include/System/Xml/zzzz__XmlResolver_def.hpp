...
/// @brief Method GetEntityAsync, addr 0x2c55d4c, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method ResolveUri, addr 0x2c55a3c, size 0x1cc, virtual true, abstract: false, final false
inline ::System::Uri* ResolveUri(::System::Uri*  baseUri, ::StringW  relativeUri) ;

/// @brief Method SupportsType, addr 0x2c55c08, size 0x144, virtual true, abstract: false, final false
inline bool SupportsType(::System::Uri*  absoluteUri, ::System::Type*  type) ;

/// @brief Method .ctor, addr 0x2c55d84, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
