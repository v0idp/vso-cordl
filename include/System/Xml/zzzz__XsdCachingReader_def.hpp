...
/// @brief Method AddAttribute, addr 0x2c21104, size 0x15c, virtual false, abstract: false, final false
inline ::System::Xml::ValidatingReaderNodeData* AddAttribute(int32_t  attIndex) ;

/// @brief Method AddContent, addr 0x2c1fe10, size 0x174, virtual false, abstract: false, final false
inline ::System::Xml::ValidatingReaderNodeData* AddContent(::System::Xml::XmlNodeType  nodeType) ;

/// @brief Method ClearAttributesInfo, addr 0x2c20afc, size 0x10, virtual false, abstract: false, final false
inline void ClearAttributesInfo() ;

/// @brief Method Close, addr 0x2c20df0, size 0x34, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method CreateDummyTextNode, addr 0x2c2100c, size 0x88, virtual false, abstract: false, final false
inline ::System::Xml::ValidatingReaderNodeData* CreateDummyTextNode(::StringW  attributeValue, int32_t  depth) ;

/// @brief Method GetAttribute, addr 0x2c205a0, size 0x90, virtual true, abstract: false, final false
inline ::StringW GetAttribute(int32_t  i) ;

/// @brief Method GetAttribute, addr 0x2c202ac, size 0x8c, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetAttribute, addr 0x2c20488, size 0x118, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name, ::StringW  namespaceURI) ;

/// @brief Method GetAttributeIndexWithPrefix, addr 0x2c203e8, size 0xa0, virtual false, abstract: false, final false
inline int32_t GetAttributeIndexWithPrefix(::StringW  name) ;

/// @brief Method GetAttributeIndexWithoutPrefix, addr 0x2c20338, size 0xb0, virtual false, abstract: false, final false
inline int32_t GetAttributeIndexWithoutPrefix(::StringW  name) ;

/// @brief Method GetCoreReader, addr 0x2c210f4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlReader* GetCoreReader() ;

/// @brief Method GetLineInfo, addr 0x2c210fc, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::IXmlLineInfo* GetLineInfo() ;

/// @brief Method Init, addr 0x2c1fcc0, size 0x150, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method LookupNamespace, addr 0x2c20f64, size 0x24, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method MoveToAttribute, addr 0x2c20630, size 0x90, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x2c206c0, size 0x90, virtual true, abstract: false, final false
inline void MoveToAttribute(int32_t  i) ;

/// @brief Method MoveToElement, addr 0x2c207e4, size 0x54, virtual true, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstAttribute, addr 0x2c20750, size 0x40, virtual true, abstract: false, final false
inline bool MoveToFirstAttribute() ;

/// @brief Method MoveToNextAttribute, addr 0x2c20790, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method Read, addr 0x2c20838, size 0x2c4, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadAttributeValue, addr 0x2c20fc0, size 0x4c, virtual true, abstract: false, final false
inline bool ReadAttributeValue() ;

/// @brief Method RecordAttributes, addr 0x2c1ff84, size 0x178, virtual false, abstract: false, final false
inline void RecordAttributes() ;

/// @brief Method RecordEndElementNode, addr 0x2c20c84, size 0x130, virtual false, abstract: false, final false
inline void RecordEndElementNode() ;

/// @brief Method RecordTextNode, addr 0x2c20b0c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x2c200fc, size 0x8, virtual false, abstract: false, final false
inline void Reset(::System::Xml::XmlReader*  reader) ;

/// @brief Method ResolveEntity, addr 0x2c20f88, size 0x38, virtual true, abstract: false, final false
inline void ResolveEntity() ;

/// @brief Method SetToReplayMode, addr 0x2c210d4, size 0x20, virtual false, abstract: false, final false
inline void SetToReplayMode() ;

/// @brief Method Skip, addr 0x2c20e48, size 0x114, virtual true, abstract: false, final false
inline void Skip() ;

/// @brief Method SwitchTextNodeAndEndElement, addr 0x2c20b84, size 0x100, virtual false, abstract: false, final false
inline void SwitchTextNodeAndEndElement(::StringW  textValue, ::StringW  originalStringValue) ;

/// @brief Method System.Xml.IXmlLineInfo.HasLineInfo, addr 0x2c21094, size 0x8, virtual true, abstract: false, final true
inline bool System_Xml_IXmlLineInfo_HasLineInfo() ;

/// @brief Method System.Xml.IXmlLineInfo.get_LineNumber, addr 0x2c2109c, size 0x1c, virtual true, abstract: false, final true
inline int32_t System_Xml_IXmlLineInfo_get_LineNumber() ;

/// @brief Method System.Xml.IXmlLineInfo.get_LinePosition, addr 0x2c210b8, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2c1fc04, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method get_AttributeCount, addr 0x2c202a4, size 0x8, virtual true, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x2c20204, size 0x24, virtual true, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_Depth, addr 0x2c201e8, size 0x1c, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_EOF, addr 0x2c20db4, size 0x3c, virtual true, abstract: false, final false
inline bool get_EOF() ;

/// @brief Method get_IsDefault, addr 0x2c20230, size 0x8, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsEmptyElement, addr 0x2c20228, size 0x8, virtual true, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_LocalName, addr 0x2c20164, size 0x1c, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x2c20140, size 0x24, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameTable, addr 0x2c20f5c, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x2c20180, size 0x1c, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x2c20124, size 0x1c, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x2c2019c, size 0x1c, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_QuoteChar, addr 0x2c20238, size 0x24, virtual true, abstract: false, final false
inline char16_t get_QuoteChar() ;

/// @brief Method get_ReadState, addr 0x2c20e24, size 0x24, virtual true, abstract: false, final false
inline ::System::Xml::ReadState get_ReadState() ;

/// @brief Method get_Settings, addr 0x2c20104, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::XmlReaderSettings* get_Settings() ;

/// @brief Method get_Value, addr 0x2c201b8, size 0x30, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_XmlLang, addr 0x2c20280, size 0x24, virtual true, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x2c2025c, size 0x24, virtual true, abstract: false, final false
