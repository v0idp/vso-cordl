...
/// @brief Method GetPreamble, addr 0x2c52380, size 0x74, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreamble() ;

static inline ::System::Xml::Ucs4Encoding4321* New_ctor() ;

/// @brief Method .ctor, addr 0x2c52008, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_EncodingName, addr 0x2c52340, size 0x40, virtual true, abstract: false, final false
