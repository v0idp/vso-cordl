...
/// @brief Method GetInvalidNameException, addr 0x2c483ec, size 0x1c0, virtual false, abstract: false, final false
static inline ::System::Exception* GetInvalidNameException(::StringW  s, int32_t  offsetStartChar, int32_t  offsetBadChar) ;

/// @brief Method IsNameNoNamespaces, addr 0x2c47c6c, size 0x80, virtual false, abstract: false, final false
static inline bool IsNameNoNamespaces(::StringW  s) ;

/// @brief Method ParseNCName, addr 0x2c47e08, size 0x58, virtual false, abstract: false, final false
static inline int32_t ParseNCName(::StringW  s) ;

/// @brief Method ParseNCName, addr 0x2c47cec, size 0x11c, virtual false, abstract: false, final false
static inline int32_t ParseNCName(::StringW  s, int32_t  offset) ;

/// @brief Method ParseNameNoNamespaces, addr 0x2c47b14, size 0x158, virtual false, abstract: false, final false
static inline int32_t ParseNameNoNamespaces(::StringW  s, int32_t  offset) ;

/// @brief Method ParseNmtoken, addr 0x2c47968, size 0xc8, virtual false, abstract: false, final false
static inline int32_t ParseNmtoken(::StringW  s, int32_t  offset) ;

/// @brief Method ParseNmtokenNoNamespaces, addr 0x2c47a30, size 0xe4, virtual false, abstract: false, final false
static inline int32_t ParseNmtokenNoNamespaces(::StringW  s, int32_t  offset) ;

/// @brief Method ParseQName, addr 0x2c47e60, size 0xdc, virtual false, abstract: false, final false
static inline int32_t ParseQName(::StringW  s, int32_t  offset, ::ByRef<int32_t>  colonOffset) ;

/// @brief Method ParseQNameThrow, addr 0x2c47f3c, size 0x10c, virtual false, abstract: false, final false
static inline void ParseQNameThrow(::StringW  s, ::ByRef<::StringW>  prefix, ::ByRef<::StringW>  localName) ;

/// @brief Method SplitQName, addr 0x2c485ac, size 0x148, virtual false, abstract: false, final false
static inline void SplitQName(::StringW  name, ::ByRef<::StringW>  prefix, ::ByRef<::StringW>  lname) ;

/// @brief Method ThrowInvalidName, addr 0x2c48048, size 0x168, virtual false, abstract: false, final false
