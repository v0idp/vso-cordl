...
/// @brief Method Encode, addr 0x2b286c4, size 0x348, virtual false, abstract: false, final false
inline void Encode(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Flush, addr 0x2b28a0c, size 0xa8, virtual false, abstract: false, final false
inline void Flush() ;
...
/// @brief Method .ctor, addr 0x2b28668, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
