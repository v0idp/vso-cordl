...
public:
// Declarations
/// @brief Method GetFullChars, addr 0x2c529f0, size 0x208, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c5233c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
