...
public:
// Declarations
/// @brief Method ToDecimal, addr 0x2b29f80, size 0x64, virtual false, abstract: false, final false
inline ::System::Decimal ToDecimal() ;

/// @brief Method ToString, addr 0x2b29fe4, size 0xec, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2b29f6c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  v) ;

/// @brief Method .ctor, addr 0x2b29f78, size 0x8, virtual false, abstract: false, final false
