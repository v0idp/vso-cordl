...
/// @brief Method FindElement, addr 0x2c7dcb8, size 0x6fc, virtual false, abstract: false, final false
...
/// @brief Method SetChoice, addr 0x2c8267c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c82650, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ChoiceMember, addr 0x2c8265c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ChoiceMember() ;

/// @brief Method get_ChoiceTypeData, addr 0x2c8266c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::TypeData* get_ChoiceTypeData() ;

/// @brief Method get_ElementInfo, addr 0x2c7c88c, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* get_ElementInfo() ;

/// @brief Method get_IsXmlTextCollector, addr 0x2c8268c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsXmlTextCollector() ;

/// @brief Method set_ChoiceMember, addr 0x2c82664, size 0x8, virtual false, abstract: false, final false
inline void set_ChoiceMember(::StringW  value) ;

/// @brief Method set_ChoiceTypeData, addr 0x2c82674, size 0x8, virtual false, abstract: false, final false
inline void set_ChoiceTypeData(::System::Xml::Serialization::TypeData*  value) ;

/// @brief Method set_ElementInfo, addr 0x2c82654, size 0x8, virtual false, abstract: false, final false
inline void set_ElementInfo(::System::Xml::Serialization::XmlTypeMapElementInfoList*  value) ;

/// @brief Method set_IsXmlTextCollector, addr 0x2c82694, size 0xc, virtual false, abstract: false, final false
