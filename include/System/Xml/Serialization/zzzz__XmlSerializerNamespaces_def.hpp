...
/// @brief Method Add, addr 0x2c59590, size 0xb4, virtual false, abstract: false, final false
inline void Add(::StringW  prefix, ::StringW  ns) ;

/// @brief Method AddInternal, addr 0x2c59644, size 0x3c, virtual false, abstract: false, final false
inline void AddInternal(::StringW  prefix, ::StringW  ns) ;

static inline ::System::Xml::Serialization::XmlSerializerNamespaces* New_ctor() ;

/// @brief Method ToArray, addr 0x2c596e4, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c59588, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Count, addr 0x2c59c20, size 0x24, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_NamespaceList, addr 0x2c597ec, size 0x434, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_NamespaceList() ;

/// @brief Method get_Namespaces, addr 0x2c59680, size 0x64, virtual false, abstract: false, final false
inline ::System::Collections::Hashtable* get_Namespaces() ;

/// @brief Method set_Namespaces, addr 0x2c59c44, size 0x8, virtual false, abstract: false, final false
