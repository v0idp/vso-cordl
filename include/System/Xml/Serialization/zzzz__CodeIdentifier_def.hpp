...
/// @brief Method IsValid, addr 0x2c59438, size 0x7c, virtual false, abstract: false, final false
static inline bool IsValid(char16_t  c) ;

/// @brief Method IsValidStart, addr 0x2c594b4, size 0x64, virtual false, abstract: false, final false
static inline bool IsValidStart(char16_t  c) ;

/// @brief Method MakePascal, addr 0x2c59104, size 0x1b0, virtual false, abstract: false, final false
static inline ::StringW MakePascal(::StringW  identifier) ;

/// @brief Method MakeValid, addr 0x2c592b4, size 0x184, virtual false, abstract: false, final false
