...
/// @brief Method FromEnum, addr 0x2c63ac8, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method FromXmlNCName, addr 0x2c63da4, size 0x58, virtual false, abstract: false, final false
static inline ::StringW FromXmlNCName(::StringW  ncName) ;

/// @brief Method FromXmlName, addr 0x2c63d4c, size 0x58, virtual false, abstract: false, final false
static inline ::StringW FromXmlName(::StringW  name) ;

/// @brief Method FromXmlString, addr 0x2c63dfc, size 0xb1c, virtual false, abstract: false, final false
static inline ::System::Object* FromXmlString(::System::Xml::Serialization::TypeData*  type, ::StringW  value) ;

/// @brief Method ToXmlString, addr 0x2c6270c, size 0xdb4, virtual false, abstract: false, final false
