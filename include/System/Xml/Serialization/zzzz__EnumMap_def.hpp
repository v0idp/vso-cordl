...
/// @brief Method .ctor, addr 0x2c85e34, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  xmlName, ::StringW  enumName, int64_t  value) ;

/// @brief Method get_EnumName, addr 0x2c85e78, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_EnumName() ;

/// @brief Method get_Value, addr 0x2c85e80, size 0x8, virtual false, abstract: false, final false
inline int64_t get_Value() ;

/// @brief Method get_XmlName, addr 0x2c85e70, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetEnumName, addr 0x2c85b58, size 0x2dc, virtual false, abstract: false, final false
inline ::StringW GetEnumName(::StringW  typeName, ::StringW  xmlName) ;

/// @brief Method GetXmlName, addr 0x2c7fd58, size 0x374, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c859e8, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_EnumNames, addr 0x2c85b40, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_EnumNames() ;

/// @brief Method get_IsFlags, addr 0x2c85b38, size 0x8, virtual false, abstract: false, final false
inline bool get_IsFlags() ;

/// @brief Method get_Values, addr 0x2c85b50, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<int64_t,::Array<int64_t>*> get_Values() ;

/// @brief Method get_XmlNames, addr 0x2c85b48, size 0x8, virtual false, abstract: false, final false
