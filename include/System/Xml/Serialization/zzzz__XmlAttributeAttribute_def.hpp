...
/// @brief Method AddKeyHash, addr 0x2c61364, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c6127c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  attributeName) ;

/// @brief Method get_AttributeName, addr 0x2c612a4, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_AttributeName() ;

/// @brief Method get_DataType, addr 0x2c612f8, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_DataType() ;

/// @brief Method get_Form, addr 0x2c61354, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaForm get_Form() ;

/// @brief Method get_Namespace, addr 0x2c6135c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method set_DataType, addr 0x2c6134c, size 0x8, virtual false, abstract: false, final false
