...
/// @brief Method Equals, addr 0x2c85874, size 0x164, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method FindElement, addr 0x2c8526c, size 0x31c, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfo* FindElement(::StringW  elementName, ::StringW  ns) ;

/// @brief Method FindElement, addr 0x2c7f094, size 0x860, virtual false, abstract: false, final false
...
/// @brief Method FindTextElement, addr 0x2c85588, size 0x2ec, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfo* FindTextElement() ;

/// @brief Method GetArrayType, addr 0x2c7ee8c, size 0x208, virtual false, abstract: false, final false
inline void GetArrayType(int32_t  itemCount, ::ByRef<::StringW>  localName, ::ByRef<::StringW>  ns) ;

/// @brief Method GetHashCode, addr 0x2c859d8, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c859e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ItemInfo, addr 0x2c8525c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlTypeMapElementInfoList* get_ItemInfo() ;

/// @brief Method set_ChoiceMember, addr 0x2c85254, size 0x8, virtual false, abstract: false, final false
inline void set_ChoiceMember(::StringW  value) ;

/// @brief Method set_ItemInfo, addr 0x2c85264, size 0x8, virtual false, abstract: false, final false
