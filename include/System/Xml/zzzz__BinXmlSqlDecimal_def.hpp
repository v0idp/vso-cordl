...
/// @brief Method ChFromDigit, addr 0x2b29a50, size 0x8, virtual false, abstract: false, final false
static inline char16_t ChFromDigit(uint32_t  uiDigit) ;

/// @brief Method MpDiv1, addr 0x2b29920, size 0xd8, virtual false, abstract: false, final false
static inline void MpDiv1(::ArrayW<uint32_t,::Array<uint32_t>*>  rgulU, ::ByRef<int32_t>  ciulU, uint32_t  iulD, ::ByRef<uint32_t>  iulR) ;

/// @brief Method MpNormalize, addr 0x2b299f8, size 0x58, virtual false, abstract: false, final false
static inline void MpNormalize(::ArrayW<uint32_t,::Array<uint32_t>*>  rgulU, ::ByRef<int32_t>  ciulU) ;

/// @brief Method ToDecimal, addr 0x2b29a58, size 0x118, virtual false, abstract: false, final false
inline ::System::Decimal ToDecimal() ;

/// @brief Method ToString, addr 0x2b29b70, size 0x2c4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TrimTrailingZeros, addr 0x2b29758, size 0x1c8, virtual false, abstract: false, final false
inline void TrimTrailingZeros() ;

/// @brief Method UIntFromByteArray, addr 0x2b296e4, size 0x74, virtual false, abstract: false, final false
static inline uint32_t UIntFromByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset) ;

/// @brief Method .ctor, addr 0x2b29448, size 0x29c, virtual false, abstract: false, final false
...
/// @brief Method get_IsPositive, addr 0x2b29438, size 0x10, virtual false, abstract: false, final false
