...
public:
// Declarations
/// @brief Method Invoke, addr 0x2bfef18, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bfee78, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x2bfec04, size 0x18, virtual true, abstract: false, final true
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode, addr 0x2bfec1c, size 0x9c, virtual true, abstract: false, final true
inline int32_t GetHashCode(::StringW  key) ;

/// @brief Method GetHashCodeDelegate, addr 0x2bfecb8, size 0x154, virtual false, abstract: false, final false
static inline ::System::Xml::SecureStringHasher_HashCodeOfStringDelegate* GetHashCodeDelegate() ;

/// @brief Method GetHashCodeOfString, addr 0x2bfee0c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bfebe0, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;
