...
/// @brief Method Clear, addr 0x2c85eec, size 0xc, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ConcatNoDelimiter, addr 0x2c85ff4, size 0x2ac, virtual false, abstract: false, final false
inline void ConcatNoDelimiter(::StringW  s) ;

/// @brief Method GetResult, addr 0x2c85f00, size 0xf4, virtual false, abstract: false, final false
inline ::StringW GetResult() ;

/// @brief Method get_Count, addr 0x2c85ef8, size 0x8, virtual false, abstract: false, final false
