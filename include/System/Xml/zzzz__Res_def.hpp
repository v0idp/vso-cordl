...
public:
// Declarations
/// @brief Method GetString, addr 0x2c4ad18, size 0x4, virtual false, abstract: false, final false
static inline ::StringW GetString(::StringW  name) ;

/// @brief Method GetString, addr 0x2c4895c, size 0x10, virtual false, abstract: false, final false
