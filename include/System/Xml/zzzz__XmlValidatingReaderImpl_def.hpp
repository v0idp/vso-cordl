...
/// @brief Method AddHandler, addr 0x2c15d30, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method System.Xml.IValidationEventHandling.SendEvent, addr 0x2c16f0c, size 0x11c, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IValidationEventHandling.get_EventHandler, addr 0x2c16f04, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2c15d08, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method AddDefaultAttribute, addr 0x2c16d84, size 0x1c, virtual false, abstract: false, final false
inline bool AddDefaultAttribute(::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method Close, addr 0x2c16758, size 0x34, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method GetAttribute, addr 0x2c16264, size 0x24, virtual true, abstract: false, final false
inline ::StringW GetAttribute(int32_t  i) ;

/// @brief Method GetAttribute, addr 0x2c16240, size 0x24, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  localName, ::StringW  namespaceURI) ;

/// @brief Method GetAttribute, addr 0x2c1621c, size 0x24, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetNamespacesInScope, addr 0x2c16aec, size 0xa8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IDictionary_2<::StringW,::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope  scope) ;

/// @brief Method GetResolver, addr 0x2c15c34, size 0xd4, virtual false, abstract: false, final false
inline ::System::Xml::XmlResolver* GetResolver() ;

/// @brief Method HasLineInfo, addr 0x2c16910, size 0x8, virtual true, abstract: false, final true
inline bool HasLineInfo() ;

/// @brief Method LookupNamespace, addr 0x2c1678c, size 0x24, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x2c16ba8, size 0xac, virtual false, abstract: false, final false
inline ::StringW LookupPrefix(::StringW  namespaceName) ;

/// @brief Method MoveOffEntityReference, addr 0x2c16844, size 0xb0, virtual false, abstract: false, final false
inline void MoveOffEntityReference() ;

/// @brief Method MoveToAttribute, addr 0x2c16288, size 0x38, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x2c162c0, size 0x30, virtual true, abstract: false, final false
inline void MoveToAttribute(int32_t  i) ;

/// @brief Method MoveToElement, addr 0x2c16360, size 0x38, virtual true, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstAttribute, addr 0x2c162f0, size 0x38, virtual true, abstract: false, final false
inline bool MoveToFirstAttribute() ;

/// @brief Method MoveToNextAttribute, addr 0x2c16328, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method ParseDtdFromParserContext, addr 0x2c1655c, size 0x174, virtual false, abstract: false, final false
inline void ParseDtdFromParserContext() ;

/// @brief Method ProcessCoreReaderEvent, addr 0x2c16470, size 0xec, virtual false, abstract: false, final false
inline void ProcessCoreReaderEvent() ;

/// @brief Method Read, addr 0x2c16398, size 0xd8, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadAttributeValue, addr 0x2c167b0, size 0x58, virtual true, abstract: false, final false
inline bool ReadAttributeValue() ;

/// @brief Method ReadString, addr 0x2c168f4, size 0x1c, virtual true, abstract: false, final false
inline ::StringW ReadString() ;

/// @brief Method ResolveEntity, addr 0x2c16810, size 0x34, virtual true, abstract: false, final false
inline void ResolveEntity() ;

/// @brief Method ResolveEntityInternally, addr 0x2c166d0, size 0x88, virtual false, abstract: false, final false
inline void ResolveEntityInternally() ;

/// @brief Method SetupValidation, addr 0x2c15db0, size 0x13c, virtual false, abstract: false, final false
inline void SetupValidation(::System::Xml::ValidationType  valType) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x2c16ae8, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x2c16b94, size 0x10, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW  prefix) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x2c16ba4, size 0x4, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW  namespaceName) ;

/// @brief Method ValidateDefaultAttributeOnUse, addr 0x2c16dc4, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method ValidateDtd, addr 0x2c16c64, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c158f4, size 0x340, virtual false, abstract: false, final false
...
/// @brief Method get_AttributeCount, addr 0x2c161f8, size 0x24, virtual true, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x2c1609c, size 0x24, virtual true, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_CanResolveEntity, addr 0x2c16808, size 0x8, virtual true, abstract: false, final false
inline bool get_CanResolveEntity() ;

/// @brief Method get_Depth, addr 0x2c1607c, size 0x20, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_DtdInfo, addr 0x2c16da0, size 0x24, virtual true, abstract: false, final false
inline ::System::Xml::IDtdInfo* get_DtdInfo() ;

/// @brief Method get_EOF, addr 0x2c161b0, size 0x24, virtual true, abstract: false, final false
inline bool get_EOF() ;

/// @brief Method get_IsDefault, addr 0x2c160e4, size 0x24, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsEmptyElement, addr 0x2c160c0, size 0x24, virtual true, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_LineNumber, addr 0x2c16918, size 0xe8, virtual true, abstract: false, final true
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x2c16a00, size 0xe8, virtual true, abstract: false, final true
inline int32_t get_LinePosition() ;

/// @brief Method get_LocalName, addr 0x2c15ffc, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x2c15fdc, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameTable, addr 0x2c161d4, size 0x24, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceManager, addr 0x2c16cf0, size 0x24, virtual true, abstract: false, final false
inline ::System::Xml::XmlNamespaceManager* get_NamespaceManager() ;

/// @brief Method get_NamespaceURI, addr 0x2c1601c, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_Namespaces, addr 0x2c158d8, size 0x1c, virtual false, abstract: false, final false
inline bool get_Namespaces() ;

/// @brief Method get_NodeType, addr 0x2c15fbc, size 0x20, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x2c1603c, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_QuoteChar, addr 0x2c16108, size 0x24, virtual true, abstract: false, final false
inline char16_t get_QuoteChar() ;

/// @brief Method get_ReadState, addr 0x2c16174, size 0x3c, virtual true, abstract: false, final false
inline ::System::Xml::ReadState get_ReadState() ;

/// @brief Method get_Schemas, addr 0x2c16c5c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaCollection* get_Schemas() ;

/// @brief Method get_Settings, addr 0x2c15eec, size 0xd0, virtual true, abstract: false, final false
inline ::System::Xml::XmlReaderSettings* get_Settings() ;

/// @brief Method get_StandAlone, addr 0x2c16d14, size 0x1c, virtual false, abstract: false, final false
inline bool get_StandAlone() ;

/// @brief Method get_TypedValueObject, addr 0x2c16d4c, size 0x1c, virtual false, abstract: false, final false
inline ::System::Object* get_TypedValueObject() ;

/// @brief Method get_ValidationType, addr 0x2c16c54, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::ValidationType get_ValidationType() ;

/// @brief Method get_Validator, addr 0x2c16ce0, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::BaseValidator* get_Validator() ;

/// @brief Method get_Value, addr 0x2c1605c, size 0x20, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_XmlLang, addr 0x2c16150, size 0x24, virtual true, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x2c1612c, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method set_SchemaTypeObject, addr 0x2c16d30, size 0x1c, virtual false, abstract: false, final false
inline void set_SchemaTypeObject(::System::Object*  value) ;

/// @brief Method set_TypedValueObject, addr 0x2c16d68, size 0x1c, virtual false, abstract: false, final false
inline void set_TypedValueObject(::System::Object*  value) ;

/// @brief Method set_Validator, addr 0x2c16ce8, size 0x8, virtual false, abstract: false, final false
