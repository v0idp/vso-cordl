...
/// @brief Method Equals, addr 0x2c33cc8, size 0x3dc, virtual true, abstract: false, final false
...
/// @brief Method SetIsDefault, addr 0x2c33b38, size 0x20, virtual false, abstract: false, final false
inline void SetIsDefault(bool  value) ;

/// @brief Method SetIsNil, addr 0x2c33b58, size 0x20, virtual false, abstract: false, final false
inline void SetIsNil(bool  value) ;

/// @brief Method SetValidity, addr 0x2c33b24, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c334cc, size 0x3d8, virtual false, abstract: false, final false
...
/// @brief Method get_IsDefault, addr 0x2c33ba8, size 0xc, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsNil, addr 0x2c33bb4, size 0xc, virtual true, abstract: false, final false
inline bool get_IsNil() ;

/// @brief Method get_MemberType, addr 0x2c33bc0, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_MemberType() ;

/// @brief Method get_SchemaAttribute, addr 0x2c33c4c, size 0x7c, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAttribute* get_SchemaAttribute() ;

/// @brief Method get_SchemaElement, addr 0x2c33bd0, size 0x7c, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaElement* get_SchemaElement() ;

/// @brief Method get_SchemaType, addr 0x2c33bc8, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaType* get_SchemaType() ;

/// @brief Method get_Validity, addr 0x2c33b78, size 0x30, virtual true, abstract: false, final false
