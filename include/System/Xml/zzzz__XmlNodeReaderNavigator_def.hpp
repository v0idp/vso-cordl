...
/// @brief Field decNodeAttributes, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_decNodeAttributes, put=__cordl_internal_set_decNodeAttributes)) ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute,::Array<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>*>  decNodeAttributes;
...
/// @brief Field docTypeNodeAttributes, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_docTypeNodeAttributes, put=__cordl_internal_set_docTypeNodeAttributes)) ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute,::Array<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>*>  docTypeNodeAttributes;
...
/// @brief Method CheckIndexCondition, addr 0x2c38964, size 0x68, virtual false, abstract: false, final false
inline void CheckIndexCondition(int32_t  attributeIndex) ;

/// @brief Method DefaultLookupNamespace, addr 0x2c39f7c, size 0x138, virtual false, abstract: false, final false
inline ::StringW DefaultLookupNamespace(::StringW  prefix) ;

/// @brief Method GetAttribute, addr 0x2c39128, size 0x1a8, virtual false, abstract: false, final false
inline ::StringW GetAttribute(int32_t  attributeIndex) ;

/// @brief Method GetAttribute, addr 0x2c38d74, size 0x19c, virtual false, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetAttribute, addr 0x2c38f58, size 0x1d0, virtual false, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name, ::StringW  ns) ;

/// @brief Method GetAttributeFromElement, addr 0x2c38d30, size 0x44, virtual false, abstract: false, final false
inline ::StringW GetAttributeFromElement(::System::Xml::XmlElement*  elem, ::StringW  name) ;

/// @brief Method GetAttributeFromElement, addr 0x2c38f10, size 0x48, virtual false, abstract: false, final false
inline ::StringW GetAttributeFromElement(::System::Xml::XmlElement*  elem, ::StringW  name, ::StringW  ns) ;

/// @brief Method GetDecAttrInd, addr 0x2c38b00, size 0x98, virtual false, abstract: false, final false
inline int32_t GetDecAttrInd(::StringW  name) ;

/// @brief Method GetDeclarationAttr, addr 0x2c389cc, size 0xe0, virtual false, abstract: false, final false
inline ::StringW GetDeclarationAttr(::System::Xml::XmlDeclaration*  decl, ::StringW  name) ;

/// @brief Method GetDeclarationAttr, addr 0x2c38aac, size 0x54, virtual false, abstract: false, final false
inline ::StringW GetDeclarationAttr(int32_t  i) ;

/// @brief Method GetDocTypeAttrInd, addr 0x2c38c98, size 0x98, virtual false, abstract: false, final false
inline int32_t GetDocTypeAttrInd(::StringW  name) ;

/// @brief Method GetDocumentTypeAttr, addr 0x2c38b98, size 0xac, virtual false, abstract: false, final false
inline ::StringW GetDocumentTypeAttr(::System::Xml::XmlDocumentType*  docType, ::StringW  name) ;

/// @brief Method GetDocumentTypeAttr, addr 0x2c38c44, size 0x54, virtual false, abstract: false, final false
inline ::StringW GetDocumentTypeAttr(int32_t  i) ;

/// @brief Method GetNamespacesInScope, addr 0x2c3a47c, size 0x4d4, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IDictionary_2<::StringW,::StringW>* GetNamespacesInScope(::System::Xml::XmlNamespaceScope  scope) ;

/// @brief Method InitDecAttr, addr 0x2c38428, size 0x134, virtual false, abstract: false, final false
inline void InitDecAttr() ;

/// @brief Method InitDocTypeAttr, addr 0x2c38890, size 0xd4, virtual false, abstract: false, final false
inline void InitDocTypeAttr() ;

/// @brief Method IsLocalNameEmpty, addr 0x2c380ac, size 0x24, virtual false, abstract: false, final false
inline bool IsLocalNameEmpty(::System::Xml::XmlNodeType  nt) ;

/// @brief Method LogMove, addr 0x2c392d0, size 0x24, virtual false, abstract: false, final false
inline void LogMove(int32_t  level) ;

/// @brief Method LookupNamespace, addr 0x2c39cd8, size 0x2a4, virtual false, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method LookupPrefix, addr 0x2c3a0b4, size 0x3c8, virtual false, abstract: false, final false
inline ::StringW LookupPrefix(::StringW  namespaceName) ;

/// @brief Method MoveToAttribute, addr 0x2c3958c, size 0x60, virtual false, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x2c395ec, size 0x158, virtual false, abstract: false, final false
inline bool MoveToAttribute(::StringW  name, ::StringW  namespaceURI) ;

/// @brief Method MoveToAttribute, addr 0x2c397fc, size 0x184, virtual false, abstract: false, final false
inline void MoveToAttribute(int32_t  attributeIndex) ;

/// @brief Method MoveToAttributeFromElement, addr 0x2c39744, size 0xb8, virtual false, abstract: false, final false
inline bool MoveToAttributeFromElement(::System::Xml::XmlElement*  elem, ::StringW  name, ::StringW  ns) ;

/// @brief Method MoveToElement, addr 0x2c39c58, size 0x80, virtual false, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstChild, addr 0x2c39b84, size 0x48, virtual false, abstract: false, final false
inline bool MoveToFirstChild() ;

/// @brief Method MoveToNext, addr 0x2c39c18, size 0x40, virtual false, abstract: false, final false
inline bool MoveToNext() ;

/// @brief Method MoveToNextAttribute, addr 0x2c39980, size 0x1c4, virtual false, abstract: false, final false
inline bool MoveToNextAttribute(::ByRef<int32_t>  level) ;

/// @brief Method MoveToNextSibling, addr 0x2c39bcc, size 0x4c, virtual false, abstract: false, final false
inline bool MoveToNextSibling(::System::Xml::XmlNode*  node) ;

/// @brief Method MoveToParent, addr 0x2c39b44, size 0x40, virtual false, abstract: false, final false
inline bool MoveToParent() ;

static inline ::System::Xml::XmlNodeReaderNavigator* New_ctor(::System::Xml::XmlNode*  node) ;

/// @brief Method ReadAttributeValue, addr 0x2c3a950, size 0x1c0, virtual false, abstract: false, final false
inline bool ReadAttributeValue(::ByRef<int32_t>  level, ::ByRef<bool>  bResolveEntity, ::ByRef<::System::Xml::XmlNodeType>  nt) ;

/// @brief Method ResetMove, addr 0x2c393ec, size 0x1a0, virtual false, abstract: false, final false
inline void ResetMove(::ByRef<int32_t>  level, ::ByRef<::System::Xml::XmlNodeType>  nt) ;

/// @brief Method ResetToAttribute, addr 0x2c39358, size 0x94, virtual false, abstract: false, final false
inline void ResetToAttribute(::ByRef<int32_t>  level) ;

/// @brief Method RollBackMove, addr 0x2c392f4, size 0x2c, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute,::Array<::System::Xml::XmlNodeReaderNavigator_VirtualAttribute>*> const& __cordl_internal_get_docTypeNodeAttributes() const;
...
/// @brief Method .ctor, addr 0x2c37d7c, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNode*  node) ;

/// @brief Method get_AttributeCount, addr 0x2c38754, size 0x13c, virtual false, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x2c3855c, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_CreatedOnAttribute, addr 0x2c3817c, size 0x8, virtual false, abstract: false, final false
inline bool get_CreatedOnAttribute() ;

/// @brief Method get_Document, addr 0x2c3ab10, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlDocument* get_Document() ;

/// @brief Method get_IsDefault, addr 0x2c38674, size 0xb4, virtual false, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsEmptyElement, addr 0x2c385c8, size 0xac, virtual false, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_IsOnDeclOrDocType, addr 0x2c39320, size 0x38, virtual false, abstract: false, final false
inline bool get_IsOnDeclOrDocType() ;

/// @brief Method get_LocalName, addr 0x2c380d0, size 0xac, virtual false, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x2c37fbc, size 0xf0, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameTable, addr 0x2c3874c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x2c37f98, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x2c37f54, size 0x44, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x2c38184, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SchemaInfo, addr 0x2c38728, size 0x24, virtual false, abstract: false, final false
inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo() ;

/// @brief Method get_Value, addr 0x2c381a8, size 0x280, virtual false, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_XmlLang, addr 0x2c385a4, size 0x24, virtual false, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x2c38580, size 0x24, virtual false, abstract: false, final false
