...
/// @brief Method GetPreamble, addr 0x2c52438, size 0x78, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPreamble() ;

static inline ::System::Xml::Ucs4Encoding2143* New_ctor() ;

/// @brief Method .ctor, addr 0x2c52168, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_EncodingName, addr 0x2c523f8, size 0x40, virtual true, abstract: false, final false
