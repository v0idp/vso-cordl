...
/// @brief Method Close, addr 0x2c3bb5c, size 0xc, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method FinishReadBinary, addr 0x2c3b25c, size 0x24, virtual false, abstract: false, final false
inline void FinishReadBinary() ;

/// @brief Method GetAttribute, addr 0x2c3b128, size 0x6c, virtual true, abstract: false, final false
inline ::StringW GetAttribute(int32_t  attributeIndex) ;

/// @brief Method GetAttribute, addr 0x2c3b064, size 0x30, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetAttribute, addr 0x2c3b094, size 0x94, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name, ::StringW  namespaceURI) ;

/// @brief Method IsInReadingStates, addr 0x2c3abfc, size 0x10, virtual false, abstract: false, final false
inline bool IsInReadingStates() ;

/// @brief Method LookupNamespace, addr 0x2c3bc5c, size 0x38, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method MoveToAttribute, addr 0x2c3b194, size 0xc8, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x2c3b280, size 0x1d8, virtual true, abstract: false, final false
inline void MoveToAttribute(int32_t  attributeIndex) ;

/// @brief Method MoveToElement, addr 0x2c3b610, size 0xe0, virtual true, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstAttribute, addr 0x2c3b458, size 0xd8, virtual true, abstract: false, final false
inline bool MoveToFirstAttribute() ;

/// @brief Method MoveToNextAttribute, addr 0x2c3b530, size 0xe0, virtual true, abstract: false, final false
inline bool MoveToNextAttribute() ;

static inline ::System::Xml::XmlNodeReader* New_ctor(::System::Xml::XmlNode*  node) ;

/// @brief Method ReSetReadingMarks, addr 0x2c3b9a8, size 0x24, virtual false, abstract: false, final false
inline void ReSetReadingMarks() ;

/// @brief Method Read, addr 0x2c3b6f0, size 0x8, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method Read, addr 0x2c3b6f8, size 0x104, virtual false, abstract: false, final false
inline bool Read(bool  fSkipChildren) ;

/// @brief Method ReadAtZeroLevel, addr 0x2c3bac8, size 0x70, virtual false, abstract: false, final false
inline bool ReadAtZeroLevel(bool  fSkipChildren) ;

/// @brief Method ReadAttributeValue, addr 0x2c3bd18, size 0x4c, virtual true, abstract: false, final false
inline bool ReadAttributeValue() ;

/// @brief Method ReadForward, addr 0x2c3b9cc, size 0xe4, virtual false, abstract: false, final false
inline bool ReadForward(bool  fSkipChildren) ;

/// @brief Method ReadNextNode, addr 0x2c3b7fc, size 0x1ac, virtual false, abstract: false, final false
inline bool ReadNextNode(bool  fSkipChildren) ;

/// @brief Method ReadString, addr 0x2c3bb78, size 0xa4, virtual true, abstract: false, final false
inline ::StringW ReadString() ;

/// @brief Method ResolveEntity, addr 0x2c3bc94, size 0x84, virtual true, abstract: false, final false
inline void ResolveEntity() ;

/// @brief Method SetEndOfFile, addr 0x2c3bab0, size 0x18, virtual false, abstract: false, final false
inline void SetEndOfFile() ;

/// @brief Method Skip, addr 0x2c3bb70, size 0x8, virtual true, abstract: false, final false
inline void Skip() ;

/// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x2c3bd64, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace, addr 0x2c3bd94, size 0x5c, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW  prefix) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x2c3bd7c, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2c3ab18, size 0xe4, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNode*  node) ;

/// @brief Method get_AttributeCount, addr 0x2c3b028, size 0x3c, virtual true, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x2c3ae88, size 0x2c, virtual true, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_CanResolveEntity, addr 0x2c3aeb4, size 0x8, virtual true, abstract: false, final false
inline bool get_CanResolveEntity() ;

/// @brief Method get_Depth, addr 0x2c3ae80, size 0x8, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_DtdInfo, addr 0x2c3bdf0, size 0x24, virtual true, abstract: false, final false
inline ::System::Xml::IDtdInfo* get_DtdInfo() ;

/// @brief Method get_EOF, addr 0x2c3bb38, size 0x24, virtual true, abstract: false, final false
inline bool get_EOF() ;

/// @brief Method get_HasAttributes, addr 0x2c3bc1c, size 0x24, virtual true, abstract: false, final false
inline bool get_HasAttributes() ;

/// @brief Method get_IsDefault, addr 0x2c3aeec, size 0x30, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsEmptyElement, addr 0x2c3aebc, size 0x30, virtual true, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_LocalName, addr 0x2c3ac98, size 0x70, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Name, addr 0x2c3ac28, size 0x70, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameTable, addr 0x2c3bc40, size 0x1c, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x2c3ad08, size 0x84, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x2c3ac0c, size 0x1c, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x2c3ad8c, size 0x84, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_ReadState, addr 0x2c3bb68, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::ReadState get_ReadState() ;

/// @brief Method get_SchemaInfo, addr 0x2c3afe4, size 0x44, virtual true, abstract: false, final false
inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo() ;

/// @brief Method get_Value, addr 0x2c3ae10, size 0x70, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_XmlLang, addr 0x2c3af60, size 0x84, virtual true, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x2c3af1c, size 0x44, virtual true, abstract: false, final false
