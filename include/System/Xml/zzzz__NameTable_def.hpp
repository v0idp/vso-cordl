...
/// @brief Method .ctor, addr 0x2c3d9d0, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method Add, addr 0x2c3d630, size 0x180, virtual true, abstract: false, final false
inline ::StringW Add(::ArrayW<char16_t,::Array<char16_t>*>  key, int32_t  start, int32_t  len) ;

/// @brief Method Add, addr 0x2c3d3b4, size 0x178, virtual true, abstract: false, final false
inline ::StringW Add(::StringW  key) ;

/// @brief Method AddEntry, addr 0x2c3d52c, size 0x104, virtual false, abstract: false, final false
inline ::StringW AddEntry(::StringW  str, int32_t  hashCode) ;

/// @brief Method Get, addr 0x2c3d86c, size 0x164, virtual true, abstract: false, final false
inline ::StringW Get(::StringW  value) ;

/// @brief Method Grow, addr 0x2c3da10, size 0x128, virtual false, abstract: false, final false
inline void Grow() ;

static inline ::System::Xml::NameTable* New_ctor() ;

/// @brief Method TextEquals, addr 0x2c3d7b0, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c3d344, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
