...
/// @brief Method AmpEntity, addr 0x2c148dc, size 0x20, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> AmpEntity(::cordl_internals::Ptr<uint8_t>  pDst) ;

/// @brief Method CarriageReturnEntity, addr 0x2c1495c, size 0x20, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> CarriageReturnEntity(::cordl_internals::Ptr<uint8_t>  pDst) ;

/// @brief Method CharEntity, addr 0x2c14e44, size 0xac, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> CharEntity(::cordl_internals::Ptr<uint8_t>  pDst, char16_t  ch) ;

/// @brief Method CharToUTF8, addr 0x2c14fcc, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method Close, addr 0x2c145c0, size 0x164, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method EncodeChar, addr 0x2c14ef0, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method EncodeMultibyteUTF8, addr 0x2c14be0, size 0x40, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> EncodeMultibyteUTF8(int32_t  ch, ::cordl_internals::Ptr<uint8_t>  pDst) ;

/// @brief Method EncodeSurrogate, addr 0x2c1499c, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method Flush, addr 0x2c14728, size 0x3c, virtual true, abstract: false, final false
inline void Flush() ;

/// @brief Method FlushBuffer, addr 0x2c14764, size 0x178, virtual true, abstract: false, final false
inline void FlushBuffer() ;

/// @brief Method FlushEncoder, addr 0x2c14724, size 0x4, virtual false, abstract: false, final false
inline void FlushEncoder() ;

/// @brief Method GtEntity, addr 0x2c1490c, size 0x10, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> GtEntity(::cordl_internals::Ptr<uint8_t>  pDst) ;

/// @brief Method InvalidXmlChar, addr 0x2c14b2c, size 0xb4, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<uint8_t> InvalidXmlChar(int32_t  ch, ::cordl_internals::Ptr<uint8_t>  pDst, bool  entitize) ;

/// @brief Method IsSurrogateByte, addr 0x2c14e34, size 0x10, virtual false, abstract: false, final false
static inline bool IsSurrogateByte(uint8_t  b) ;

/// @brief Method LineFeedEntity, addr 0x2c1497c, size 0x20, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> LineFeedEntity(::cordl_internals::Ptr<uint8_t>  pDst) ;

/// @brief Method LtEntity, addr 0x2c148fc, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method QuoteEntity, addr 0x2c1491c, size 0x20, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> QuoteEntity(::cordl_internals::Ptr<uint8_t>  pDst) ;

/// @brief Method RawEndCData, addr 0x2c14df0, size 0x1c, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> RawEndCData(::cordl_internals::Ptr<uint8_t>  pDst) ;

/// @brief Method RawStartCData, addr 0x2c14e0c, size 0x28, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> RawStartCData(::cordl_internals::Ptr<uint8_t>  pDst) ;

/// @brief Method RawText, addr 0x2c14c74, size 0x17c, virtual false, abstract: false, final false
inline void RawText(::cordl_internals::Ptr<char16_t>  pSrcBegin, ::cordl_internals::Ptr<char16_t>  pSrcEnd) ;

/// @brief Method RawText, addr 0x2c124b4, size 0x3c, virtual false, abstract: false, final false
inline void RawText(::StringW  s) ;

/// @brief Method StartElementContent, addr 0x2c127fc, size 0x48, virtual true, abstract: false, final false
inline void StartElementContent() ;

/// @brief Method TabEntity, addr 0x2c1493c, size 0x20, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<uint8_t> TabEntity(::cordl_internals::Ptr<uint8_t>  pDst) ;

/// @brief Method ValidateContentChars, addr 0x2c11edc, size 0x340, virtual false, abstract: false, final false
inline void ValidateContentChars(::StringW  chars, ::StringW  propertyName, bool  allowOnlyWhitespace) ;

/// @brief Method WriteAttributeTextBlock, addr 0x2c13b7c, size 0x2e8, virtual false, abstract: false, final false
inline void WriteAttributeTextBlock(::cordl_internals::Ptr<char16_t>  pSrc, ::cordl_internals::Ptr<char16_t>  pSrcEnd) ;

/// @brief Method WriteCData, addr 0x2c12d84, size 0x25c, virtual true, abstract: false, final false
inline void WriteCData(::StringW  text) ;

/// @brief Method WriteCDataSection, addr 0x2c12fe0, size 0x334, virtual false, abstract: false, final false
inline void WriteCDataSection(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x2c13960, size 0x1cc, virtual true, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteChars, addr 0x2c142b8, size 0x40, virtual true, abstract: false, final false
inline void WriteChars(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteComment, addr 0x2c13314, size 0x158, virtual true, abstract: false, final false
inline void WriteComment(::StringW  text) ;

/// @brief Method WriteCommentOrPi, addr 0x2c1346c, size 0x32c, virtual false, abstract: false, final false
inline void WriteCommentOrPi(::StringW  text, int32_t  stopChar) ;

/// @brief Method WriteDocType, addr 0x2c12568, size 0x1f0, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteElementTextBlock, addr 0x2c13e64, size 0x2b8, virtual false, abstract: false, final false
inline void WriteElementTextBlock(::cordl_internals::Ptr<char16_t>  pSrc, ::cordl_internals::Ptr<char16_t>  pSrcEnd) ;

/// @brief Method WriteEndAttribute, addr 0x2c12b9c, size 0x4c, virtual true, abstract: false, final false
inline void WriteEndAttribute() ;

/// @brief Method WriteEndElement, addr 0x2c12844, size 0x158, virtual true, abstract: false, final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteEndNamespaceDeclaration, addr 0x2c12d38, size 0x4c, virtual true, abstract: false, final false
inline void WriteEndNamespaceDeclaration() ;

/// @brief Method WriteEntityRef, addr 0x2c138c0, size 0xa0, virtual true, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteFullEndElement, addr 0x2c1299c, size 0xf4, virtual true, abstract: false, final false
inline void WriteFullEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteNamespaceDeclaration, addr 0x2c12be8, size 0x54, virtual true, abstract: false, final false
inline void WriteNamespaceDeclaration(::StringW  prefix, ::StringW  namespaceName) ;

/// @brief Method WriteNewLine, addr 0x2c14c20, size 0x54, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<uint8_t> WriteNewLine(::cordl_internals::Ptr<uint8_t>  pDst) ;

/// @brief Method WriteProcessingInstruction, addr 0x2c13798, size 0x128, virtual true, abstract: false, final false
inline void WriteProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method WriteRaw, addr 0x2c142f8, size 0x40, virtual true, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw, addr 0x2c14578, size 0x48, virtual true, abstract: false, final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteRawWithCharChecking, addr 0x2c14338, size 0x240, virtual false, abstract: false, final false
inline void WriteRawWithCharChecking(::cordl_internals::Ptr<char16_t>  pSrcBegin, ::cordl_internals::Ptr<char16_t>  pSrcEnd) ;

/// @brief Method WriteStartAttribute, addr 0x2c12a90, size 0x10c, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartElement, addr 0x2c12758, size 0xa4, virtual true, abstract: false, final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartNamespaceDeclaration, addr 0x2c12c44, size 0xf4, virtual true, abstract: false, final false
inline void WriteStartNamespaceDeclaration(::StringW  prefix) ;

/// @brief Method WriteString, addr 0x2c1411c, size 0x50, virtual true, abstract: false, final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x2c1416c, size 0x14c, virtual true, abstract: false, final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteWhitespace, addr 0x2c13b2c, size 0x50, virtual true, abstract: false, final false
inline void WriteWhitespace(::StringW  ws) ;

/// @brief Method WriteXmlDeclaration, addr 0x2c12360, size 0x154, virtual true, abstract: false, final false
inline void WriteXmlDeclaration(::System::Xml::XmlStandalone  standalone) ;

/// @brief Method WriteXmlDeclaration, addr 0x2c124f0, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c11e00, size 0xdc, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method .ctor, addr 0x2c1221c, size 0x144, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method get_SupportsNamespaceDeclarationInChunks, addr 0x2c12c3c, size 0x8, virtual true, abstract: false, final false
