...
public:
// Declarations
/// @brief Method Encode, addr 0x2b292f8, size 0x140, virtual false, abstract: false, final false
static inline ::StringW Encode(::ArrayW<uint8_t,::Array<uint8_t>*>  inArray, int32_t  offsetIn, int32_t  count) ;

/// @brief Method Encode, addr 0x2b291d4, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method Encode, addr 0x2b29038, size 0x19c, virtual false, abstract: false, final false
