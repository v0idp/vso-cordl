...
public:
// Declarations
/// @brief Method Set, addr 0x2c3d33c, size 0x8, virtual false, abstract: false, final false
inline void Set(int32_t  lineNo, int32_t  linePos) ;

/// @brief Method .ctor, addr 0x2c3d334, size 0x8, virtual false, abstract: false, final false
