...
/// @brief Method FlushBuffer, addr 0x2b36c70, size 0x2c, virtual true, abstract: false, final false
inline void FlushBuffer() ;

/// @brief Method Init, addr 0x2b36850, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method StartElementContent, addr 0x2b36af4, size 0x70, virtual true, abstract: false, final false
inline void StartElementContent() ;

/// @brief Method WriteDocType, addr 0x2b368c4, size 0x1c, virtual true, abstract: false, final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteEndElement, addr 0x2b36b64, size 0x98, virtual true, abstract: false, final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteIndent, addr 0x2b36aa4, size 0x50, virtual false, abstract: false, final false
inline void WriteIndent() ;

/// @brief Method WriteStartAttribute, addr 0x2b36bfc, size 0x74, virtual true, abstract: false, final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartElement, addr 0x2b368e0, size 0x1c4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b36878, size 0x4c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method .ctor, addr 0x2b36804, size 0x4c, virtual false, abstract: false, final false
