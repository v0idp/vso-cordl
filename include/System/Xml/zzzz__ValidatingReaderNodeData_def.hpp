...
/// @brief Method Clear, addr 0x2bff4f4, size 0x80, virtual false, abstract: false, final false
inline void Clear(::System::Xml::XmlNodeType  nodeType) ;

/// @brief Method GetAtomizedNameWPrefix, addr 0x2bff5d0, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method SetItemData, addr 0x2bff7cc, size 0x7c, virtual false, abstract: false, final false
inline void SetItemData(::StringW  localName, ::StringW  prefix, ::StringW  ns, int32_t  depth) ;

/// @brief Method SetItemData, addr 0x2bff848, size 0x8, virtual false, abstract: false, final false
inline void SetItemData(::StringW  value) ;

/// @brief Method SetItemData, addr 0x2bff850, size 0x8, virtual false, abstract: false, final false
inline void SetItemData(::StringW  value, ::StringW  originalStringValue) ;

/// @brief Method SetLineInfo, addr 0x2bff6c4, size 0x108, virtual false, abstract: false, final false
inline void SetLineInfo(::System::Xml::IXmlLineInfo*  lineInfo) ;

/// @brief Method SetLineInfo, addr 0x2bff6bc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bff4d4, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2bff574, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNodeType  nodeType) ;

/// @brief Method get_AttInfo, addr 0x2bff69c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::AttributePSVIInfo* get_AttInfo() ;

/// @brief Method get_Depth, addr 0x2bff664, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_LineNumber, addr 0x2bff6ac, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x2bff6b4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LinePosition() ;

/// @brief Method get_LocalName, addr 0x2bff5a0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_Namespace, addr 0x2bff5b0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method get_NodeType, addr 0x2bff68c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_OriginalStringValue, addr 0x2bff684, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_OriginalStringValue() ;

/// @brief Method get_Prefix, addr 0x2bff5c0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_RawValue, addr 0x2bff674, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_RawValue() ;

/// @brief Method set_AttInfo, addr 0x2bff6a4, size 0x8, virtual false, abstract: false, final false
inline void set_AttInfo(::System::Xml::AttributePSVIInfo*  value) ;

/// @brief Method set_Depth, addr 0x2bff66c, size 0x8, virtual false, abstract: false, final false
inline void set_Depth(int32_t  value) ;

/// @brief Method set_LocalName, addr 0x2bff5a8, size 0x8, virtual false, abstract: false, final false
inline void set_LocalName(::StringW  value) ;

/// @brief Method set_Namespace, addr 0x2bff5b8, size 0x8, virtual false, abstract: false, final false
inline void set_Namespace(::StringW  value) ;

/// @brief Method set_NodeType, addr 0x2bff694, size 0x8, virtual false, abstract: false, final false
inline void set_NodeType(::System::Xml::XmlNodeType  value) ;

/// @brief Method set_Prefix, addr 0x2bff5c8, size 0x8, virtual false, abstract: false, final false
inline void set_Prefix(::StringW  value) ;

/// @brief Method set_RawValue, addr 0x2bff67c, size 0x8, virtual false, abstract: false, final false
