...
/// @brief Method Decode, addr 0x2b28e60, size 0x1d8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Decode(::ArrayW<char16_t,::Array<char16_t>*>  chars, bool  allowOddChars) ;

/// @brief Method Decode, addr 0x2b28b4c, size 0x14c, virtual true, abstract: false, final false
inline int32_t Decode(::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  startPos, int32_t  len) ;

/// @brief Method Decode, addr 0x2b28c98, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method get_IsFull, addr 0x2b28b3c, size 0x10, virtual true, abstract: false, final false
