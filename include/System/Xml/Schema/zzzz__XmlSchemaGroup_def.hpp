...
/// @brief Method Clone, addr 0x2bb13a0, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObject* Clone() ;

/// @brief Method Clone, addr 0x2bab3c4, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method SetQualifiedName, addr 0x2bb1398, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bb13a8, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CanonicalParticle, addr 0x2bb1358, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaParticle* get_CanonicalParticle() ;

/// @brief Method get_Name, addr 0x2bb1330, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameAttribute, addr 0x2bb1388, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_NameAttribute() ;

/// @brief Method get_Particle, addr 0x2bb1340, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaGroupBase* get_Particle() ;

/// @brief Method get_QualifiedName, addr 0x2bb1350, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_QualifiedName() ;

/// @brief Method get_Redefined, addr 0x2bb1368, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaGroup* get_Redefined() ;

/// @brief Method get_SelfReferenceCount, addr 0x2bb1378, size 0x8, virtual false, abstract: false, final false
inline int32_t get_SelfReferenceCount() ;

/// @brief Method set_CanonicalParticle, addr 0x2bb1360, size 0x8, virtual false, abstract: false, final false
inline void set_CanonicalParticle(::System::Xml::Schema::XmlSchemaParticle*  value) ;

/// @brief Method set_Name, addr 0x2bb1338, size 0x8, virtual false, abstract: false, final false
inline void set_Name(::StringW  value) ;

/// @brief Method set_NameAttribute, addr 0x2bb1390, size 0x8, virtual true, abstract: false, final false
inline void set_NameAttribute(::StringW  value) ;

/// @brief Method set_Particle, addr 0x2bb1348, size 0x8, virtual false, abstract: false, final false
inline void set_Particle(::System::Xml::Schema::XmlSchemaGroupBase*  value) ;

/// @brief Method set_Redefined, addr 0x2bb1370, size 0x8, virtual false, abstract: false, final false
inline void set_Redefined(::System::Xml::Schema::XmlSchemaGroup*  value) ;

/// @brief Method set_SelfReferenceCount, addr 0x2bb1380, size 0x8, virtual false, abstract: false, final false
