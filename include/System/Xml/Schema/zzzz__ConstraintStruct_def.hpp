...
/// @brief Method .ctor, addr 0x2c8b230, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::CompiledIdentityConstraint*  constraint) ;

/// @brief Method get_TableDim, addr 0x2c8b228, size 0x8, virtual false, abstract: false, final false
