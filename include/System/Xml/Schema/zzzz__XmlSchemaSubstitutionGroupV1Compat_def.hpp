...
/// @brief Method .ctor, addr 0x2bbc54c, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Choice, addr 0x2bbc544, size 0x8, virtual false, abstract: false, final false
