...
/// @brief Method Parse, addr 0x2bef008, size 0xb44, virtual false, abstract: false, final false
inline bool Parse(::StringW  text, ::System::Xml::Schema::XsdDateTimeFlags  kinds) ;

/// @brief Method Parse2Dig, addr 0x2bf2234, size 0xa8, virtual false, abstract: false, final false
inline bool Parse2Dig(int32_t  start, ::ByRef<int32_t>  num) ;

/// @brief Method Parse4Dig, addr 0x2bf210c, size 0x128, virtual false, abstract: false, final false
inline bool Parse4Dig(int32_t  start, ::ByRef<int32_t>  num) ;

/// @brief Method ParseChar, addr 0x2bf1d24, size 0x44, virtual false, abstract: false, final false
inline bool ParseChar(int32_t  start, char16_t  ch) ;

/// @brief Method ParseDate, addr 0x2bf1b08, size 0x21c, virtual false, abstract: false, final false
inline bool ParseDate(int32_t  start) ;

/// @brief Method ParseTime, addr 0x2bf22dc, size 0x378, virtual false, abstract: false, final false
inline bool ParseTime(::ByRef<int32_t>  start) ;

/// @brief Method ParseTimeAndWhitespace, addr 0x2bf2070, size 0x9c, virtual false, abstract: false, final false
inline bool ParseTimeAndWhitespace(int32_t  start) ;

/// @brief Method ParseTimeAndZoneAndWhitespace, addr 0x2bf1d68, size 0x9c, virtual false, abstract: false, final false
inline bool ParseTimeAndZoneAndWhitespace(int32_t  start) ;

/// @brief Method ParseZoneAndWhitespace, addr 0x2bf1e04, size 0x26c, virtual false, abstract: false, final false
inline bool ParseZoneAndWhitespace(int32_t  start) ;

/// @brief Method Test, addr 0x2bf1afc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method InitiateXsdDateTime, addr 0x2befb4c, size 0xbc, virtual false, abstract: false, final false
inline void InitiateXsdDateTime(::System::Xml::Schema::XsdDateTime_Parser  parser) ;

/// @brief Method IntToCharArray, addr 0x2bf14dc, size 0x68, virtual false, abstract: false, final false
inline void IntToCharArray(::ArrayW<char16_t,::Array<char16_t>*>  text, int32_t  start, int32_t  value, int32_t  digits) ;

/// @brief Method PrintDate, addr 0x2bf1144, size 0x144, virtual false, abstract: false, final false
inline void PrintDate(::System::Text::StringBuilder*  sb) ;

/// @brief Method PrintTime, addr 0x2bf1288, size 0x254, virtual false, abstract: false, final false
inline void PrintTime(::System::Text::StringBuilder*  sb) ;

/// @brief Method PrintZone, addr 0x2bf15ac, size 0x1a0, virtual false, abstract: false, final false
inline void PrintZone(::System::Text::StringBuilder*  sb) ;

/// @brief Method ShortToCharArray, addr 0x2bf1544, size 0x68, virtual false, abstract: false, final false
inline void ShortToCharArray(::ArrayW<char16_t,::Array<char16_t>*>  text, int32_t  start, int32_t  value) ;

/// @brief Method ToString, addr 0x2bf0d00, size 0x444, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryParse, addr 0x2befc9c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2befd5c, size 0x1c4, virtual false, abstract: false, final false
inline void _ctor(::System::DateTime  dateTime, ::System::Xml::Schema::XsdDateTimeFlags  kinds) ;

/// @brief Method .ctor, addr 0x2beff20, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::DateTimeOffset  dateTimeOffset) ;

/// @brief Method .ctor, addr 0x2beff90, size 0x190, virtual false, abstract: false, final false
inline void _ctor(::System::DateTimeOffset  dateTimeOffset, ::System::Xml::Schema::XsdDateTimeFlags  kinds) ;

/// @brief Method .ctor, addr 0x2befc08, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XsdDateTime_Parser  parser) ;

/// @brief Method .ctor, addr 0x2beee60, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method get_Day, addr 0x2bf01e0, size 0x58, virtual false, abstract: false, final false
inline int32_t get_Day() ;

/// @brief Method get_Fraction, addr 0x2bf0340, size 0x118, virtual false, abstract: false, final false
inline int32_t get_Fraction() ;

/// @brief Method get_Hour, addr 0x2bf0238, size 0x58, virtual false, abstract: false, final false
inline int32_t get_Hour() ;

/// @brief Method get_InternalKind, addr 0x2bf0128, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XsdDateTime_XsdDateTimeKind get_InternalKind() ;

/// @brief Method get_InternalTypeCode, addr 0x2bf0120, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XsdDateTime_DateTimeTypeCode get_InternalTypeCode() ;

/// @brief Method get_Minute, addr 0x2bf0290, size 0x58, virtual false, abstract: false, final false
inline int32_t get_Minute() ;

/// @brief Method get_Month, addr 0x2bf0188, size 0x58, virtual false, abstract: false, final false
inline int32_t get_Month() ;

/// @brief Method get_Second, addr 0x2bf02e8, size 0x58, virtual false, abstract: false, final false
inline int32_t get_Second() ;

/// @brief Method get_Year, addr 0x2bf0130, size 0x58, virtual false, abstract: false, final false
inline int32_t get_Year() ;

/// @brief Method get_ZoneHour, addr 0x2bf0458, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ZoneHour() ;

/// @brief Method get_ZoneMinute, addr 0x2bf0460, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ZoneMinute() ;

/// @brief Method op_Implicit, addr 0x2bf0468, size 0x53c, virtual false, abstract: false, final false
static inline ::System::DateTime op_Implicit___System__DateTime(::System::Xml::Schema::XsdDateTime  xdt) ;

/// @brief Method op_Implicit, addr 0x2bf09a4, size 0x35c, virtual false, abstract: false, final false
