...
/// @brief Method Equal, addr 0x2c86588, size 0x7c, virtual false, abstract: false, final false
static inline bool Equal(::StringW  thisname, ::StringW  thisURN, ::StringW  name, ::StringW  URN) ;

/// @brief Method MoveToAttribute, addr 0x2c86a30, size 0x174, virtual false, abstract: false, final false
inline bool MoveToAttribute(::StringW  name, ::StringW  URN, int32_t  depth) ;

/// @brief Method MoveToChild, addr 0x2c868f0, size 0x140, virtual false, abstract: false, final false
inline bool MoveToChild(::StringW  name, ::StringW  URN, int32_t  depth) ;

/// @brief Method MoveToParent, addr 0x2c867a8, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x2c86768, size 0x40, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method Push, addr 0x2c866d4, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c86630, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::ForwardAxis*  faxis, ::System::Xml::Schema::ActiveAxis*  parent) ;

/// @brief Method get_Length, addr 0x2c8660c, size 0x24, virtual false, abstract: false, final false
inline int32_t get_Length() ;

/// @brief Method get_Subtree, addr 0x2c86604, size 0x8, virtual false, abstract: false, final false
