...
/// @brief Method .ctor, addr 0x2c8e1d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsNullable, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline bool get_IsNullable() ;

/// @brief Method get_IsRangeNode, addr 0x2c8e1d0, size 0x8, virtual true, abstract: false, final false
