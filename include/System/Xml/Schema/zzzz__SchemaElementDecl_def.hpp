...
/// @brief Method AddAttDef, addr 0x2b84af0, size 0x150, virtual false, abstract: false, final false
inline void AddAttDef(::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method CheckAttributes, addr 0x2b84cd0, size 0x298, virtual false, abstract: false, final false
inline void CheckAttributes(::System::Collections::Hashtable*  presence, bool  standalone) ;

/// @brief Method Clone, addr 0x2b849e8, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaElementDecl* Clone() ;

/// @brief Method CreateAnyTypeElementDecl, addr 0x2b84838, size 0xc4, virtual false, abstract: false, final false
static inline ::System::Xml::Schema::SchemaElementDecl* CreateAnyTypeElementDecl() ;

/// @brief Method GetAttDef, addr 0x2b84c40, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method System.Xml.IDtdAttributeListInfo.LookupAttribute, addr 0x2b84904, size 0xb4, virtual true, abstract: false, final true
inline ::System::Xml::IDtdAttributeInfo* System_Xml_IDtdAttributeListInfo_LookupAttribute(::StringW  prefix, ::StringW  localName) ;

/// @brief Method System.Xml.IDtdAttributeListInfo.LookupDefaultAttributes, addr 0x2b849b8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IDtdAttributeListInfo.get_HasNonCDataAttributes, addr 0x2b848fc, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2b84598, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2b84658, size 0x108, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaDatatype*  dtype) ;

/// @brief Method .ctor, addr 0x2b84760, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method get_AnyAttribute, addr 0x2b84ac0, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAnyAttribute* get_AnyAttribute() ;

/// @brief Method get_AttDefs, addr 0x2b84cc0, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::Schema::SchemaAttDef*>* get_AttDefs() ;

/// @brief Method get_Block, addr 0x2b84a74, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaDerivationMethod get_Block() ;

/// @brief Method get_Constraints, addr 0x2b84ad0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_ContentValidator, addr 0x2b84ab0, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::ContentValidator* get_ContentValidator() ;

/// @brief Method get_DefaultAttDefs, addr 0x2b84cb8, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IList_1<::System::Xml::IDtdDefaultAttributeInfo*>* get_DefaultAttDefs() ;

/// @brief Method get_HasDefaultAttribute, addr 0x2b84a98, size 0x10, virtual false, abstract: false, final false
inline bool get_HasDefaultAttribute() ;

/// @brief Method get_HasNonCDataAttribute, addr 0x2b849d4, size 0x8, virtual false, abstract: false, final false
inline bool get_HasNonCDataAttribute() ;

/// @brief Method get_HasRequiredAttribute, addr 0x2b84aa8, size 0x8, virtual false, abstract: false, final false
inline bool get_HasRequiredAttribute() ;

/// @brief Method get_IsAbstract, addr 0x2b84a4c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsAbstract() ;

/// @brief Method get_IsIdDeclared, addr 0x2b849c0, size 0x8, virtual false, abstract: false, final false
inline bool get_IsIdDeclared() ;

/// @brief Method get_IsNillable, addr 0x2b84a60, size 0x8, virtual false, abstract: false, final false
inline bool get_IsNillable() ;

/// @brief Method get_IsNotationDeclared, addr 0x2b84a84, size 0x8, virtual false, abstract: false, final false
inline bool get_IsNotationDeclared() ;

/// @brief Method get_ProhibitedAttributes, addr 0x2b84cc8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_SchemaElement, addr 0x2b84ae0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_AnyAttribute, addr 0x2b84ac8, size 0x8, virtual false, abstract: false, final false
inline void set_AnyAttribute(::System::Xml::Schema::XmlSchemaAnyAttribute*  value) ;

/// @brief Method set_Block, addr 0x2b84a7c, size 0x8, virtual false, abstract: false, final false
inline void set_Block(::System::Xml::Schema::XmlSchemaDerivationMethod  value) ;

/// @brief Method set_Constraints, addr 0x2b84ad8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_ContentValidator, addr 0x2b84ab8, size 0x8, virtual false, abstract: false, final false
inline void set_ContentValidator(::System::Xml::Schema::ContentValidator*  value) ;

/// @brief Method set_HasNonCDataAttribute, addr 0x2b849dc, size 0xc, virtual false, abstract: false, final false
inline void set_HasNonCDataAttribute(bool  value) ;

/// @brief Method set_IsAbstract, addr 0x2b84a54, size 0xc, virtual false, abstract: false, final false
inline void set_IsAbstract(bool  value) ;

/// @brief Method set_IsIdDeclared, addr 0x2b849c8, size 0xc, virtual false, abstract: false, final false
inline void set_IsIdDeclared(bool  value) ;

/// @brief Method set_IsNillable, addr 0x2b84a68, size 0xc, virtual false, abstract: false, final false
inline void set_IsNillable(bool  value) ;

/// @brief Method set_IsNotationDeclared, addr 0x2b84a8c, size 0xc, virtual false, abstract: false, final false
inline void set_IsNotationDeclared(bool  value) ;

/// @brief Method set_SchemaElement, addr 0x2b84ae8, size 0x8, virtual false, abstract: false, final false
