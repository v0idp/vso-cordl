...
/// @brief Method MoveToChild, addr 0x2c863f0, size 0x164, virtual false, abstract: false, final false
inline bool MoveToChild(::StringW  name, ::StringW  URN, int32_t  depth, ::System::Xml::Schema::ForwardAxis*  parent) ;

/// @brief Method MoveToParent, addr 0x2c862e4, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method SetDepth, addr 0x2c862dc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c862a8, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::DoubleLinkAxis*  node, int32_t  depth) ;

/// @brief Method get_CurNode, addr 0x2c862a0, size 0x8, virtual false, abstract: false, final false
