...
/// @brief Method ChangeType, addr 0x2be2910, size 0x250, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2be289c, size 0x4, virtual false, abstract: false, final false
