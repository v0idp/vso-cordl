...
/// @brief Method SetUnhandledAttributes, addr 0x2baba90, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2baba98, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Id, addr 0x2baba68, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Id() ;

/// @brief Method get_IdAttribute, addr 0x2baba80, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_IdAttribute() ;

/// @brief Method get_Items, addr 0x2baba78, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Items() ;

/// @brief Method set_Id, addr 0x2baba70, size 0x8, virtual false, abstract: false, final false
inline void set_Id(::StringW  value) ;

/// @brief Method set_IdAttribute, addr 0x2baba88, size 0x8, virtual true, abstract: false, final false
