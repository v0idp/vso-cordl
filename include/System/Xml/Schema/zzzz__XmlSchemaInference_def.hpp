...
/// @brief Method AddAttribute, addr 0x2b56d80, size 0x7d0, virtual false, abstract: false, final false
...
/// @brief Method AddElement, addr 0x2b553c8, size 0x5d8, virtual false, abstract: false, final false
...
/// @brief Method CheckSimpleContentExtension, addr 0x2b5a288, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method CreateNewElementforChoice, addr 0x2b5bc58, size 0x1c8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaElement* CreateNewElementforChoice(::System::Xml::Schema::XmlSchemaElement*  copyElement) ;

/// @brief Method CreateXmlSchema, addr 0x2b595bc, size 0x90, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* CreateXmlSchema(::StringW  targetNS) ;

/// @brief Method DateTime, addr 0x2b5d590, size 0x114, virtual false, abstract: false, final false
static inline int32_t DateTime(::StringW  s, bool  bDate, bool  bTime) ;

/// @brief Method FindAttribute, addr 0x2b57918, size 0x384, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaAttribute* FindAttribute(::System::Collections::ICollection*  attributes, ::StringW  attrName) ;

/// @brief Method FindAttributeRef, addr 0x2b57550, size 0x3c8, virtual false, abstract: false, final false
...
/// @brief Method FindElement, addr 0x2b5b9c8, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method FindElementRef, addr 0x2b5baf8, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method FindGlobalElement, addr 0x2b5964c, size 0x388, virtual false, abstract: false, final false
...
/// @brief Method FindMatchingElement, addr 0x2b5a850, size 0xfec, virtual false, abstract: false, final false
...
/// @brief Method GetEffectiveSchemaType, addr 0x2b599d4, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method GetSchemaType, addr 0x2b58de8, size 0x7d4, virtual false, abstract: false, final false
static inline int32_t GetSchemaType(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method InferElement, addr 0x2b559a0, size 0x13e0, virtual false, abstract: false, final false
...
/// @brief Method InferSchema, addr 0x2b5494c, size 0x74, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSet* InferSchema(::System::Xml::XmlReader*  instanceDocument) ;

/// @brief Method InferSchema1, addr 0x2b549c0, size 0x9d4, virtual false, abstract: false, final false
...
/// @brief Method InferSimpleType, addr 0x2b5bfe8, size 0x15a8, virtual false, abstract: false, final false
static inline int32_t InferSimpleType(::StringW  s, ::ByRef<bool>  bNeedsRangeCheck) ;

/// @brief Method MakeExistingAttributesOptional, addr 0x2b5a1f8, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method MoveAttributes, addr 0x2b5a3c0, size 0x3f4, virtual false, abstract: false, final false
...
/// @brief Method MoveAttributes, addr 0x2b5a7b4, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method ProcessAttributes, addr 0x2b59b0c, size 0x6ec, virtual false, abstract: false, final false
...
/// @brief Method RefineSimpleType, addr 0x2b57c9c, size 0x114c, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* RefineSimpleType(::StringW  s, ::ByRef<int32_t>  iTypeFlags) ;

/// @brief Method SetMinMaxOccurs, addr 0x2b5b83c, size 0x18c, virtual false, abstract: false, final false
inline void SetMinMaxOccurs(::System::Xml::Schema::XmlSchemaElement*  el, bool  setMaxOccurs) ;

/// @brief Method SwitchUseToOptional, addr 0x2b5bec4, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b5483c, size 0x110, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Occurrence, addr 0x2b5482c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Occurrence, addr 0x2b54824, size 0x8, virtual false, abstract: false, final false
inline void set_Occurrence(::System::Xml::Schema::XmlSchemaInference_InferenceOption  value) ;

/// @brief Method set_TypeInference, addr 0x2b54834, size 0x8, virtual false, abstract: false, final false
