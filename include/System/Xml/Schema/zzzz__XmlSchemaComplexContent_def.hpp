...
/// @brief Method .ctor, addr 0x2badb90, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Content, addr 0x2badb78, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContent* get_Content() ;

/// @brief Method get_HasMixedAttribute, addr 0x2badb88, size 0x8, virtual false, abstract: false, final false
inline bool get_HasMixedAttribute() ;

/// @brief Method get_IsMixed, addr 0x2badb5c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsMixed() ;

/// @brief Method set_Content, addr 0x2badb80, size 0x8, virtual true, abstract: false, final false
inline void set_Content(::System::Xml::Schema::XmlSchemaContent*  value) ;

/// @brief Method set_IsMixed, addr 0x2badb64, size 0x14, virtual false, abstract: false, final false
