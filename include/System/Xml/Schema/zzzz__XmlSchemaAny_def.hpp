...
/// @brief Method Allows, addr 0x2bac1bc, size 0x28, virtual false, abstract: false, final false
inline bool Allows(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method BuildNamespaceList, addr 0x2bac09c, size 0x80, virtual false, abstract: false, final false
inline void BuildNamespaceList(::StringW  targetNamespace) ;

/// @brief Method BuildNamespaceListV1Compat, addr 0x2bac11c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bac1e4, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_NameString, addr 0x2babb84, size 0x518, virtual true, abstract: false, final false
inline ::StringW get_NameString() ;

/// @brief Method get_Namespace, addr 0x2babaf8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Namespace() ;

/// @brief Method get_NamespaceList, addr 0x2babb10, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::NamespaceList* get_NamespaceList() ;

/// @brief Method get_ProcessContentsCorrect, addr 0x2babb70, size 0x14, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContentProcessing get_ProcessContentsCorrect() ;

/// @brief Method get_ResolvedNamespace, addr 0x2babb18, size 0x58, virtual false, abstract: false, final false
inline ::StringW get_ResolvedNamespace() ;

/// @brief Method set_Namespace, addr 0x2babb00, size 0x8, virtual false, abstract: false, final false
inline void set_Namespace(::StringW  value) ;

/// @brief Method set_ProcessContents, addr 0x2babb08, size 0x8, virtual false, abstract: false, final false
