...
public:
// Declarations
/// @brief Method LookupNamespace, addr 0x2ca687c, size 0x8, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

static inline ::System::Xml::Schema::DtdValidator_NamespaceManager* New_ctor() ;

/// @brief Method .ctor, addr 0x2ca6874, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddID, addr 0x2ca5efc, size 0x90, virtual false, abstract: false, final false
inline void AddID(::StringW  name, ::System::Object*  node) ;

/// @brief Method CheckDefaultValue, addr 0x2ca63f0, size 0x414, virtual false, abstract: false, final false
...
/// @brief Method CheckForwardRefs, addr 0x2ca5bac, size 0x104, virtual false, abstract: false, final false
inline void CheckForwardRefs() ;

/// @brief Method CheckValue, addr 0x2ca537c, size 0x570, virtual false, abstract: false, final false
inline void CheckValue(::StringW  value, ::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method CompleteValidation, addr 0x2ca5ac0, size 0x48, virtual true, abstract: false, final false
inline void CompleteValidation() ;

/// @brief Method FindId, addr 0x2ca5f8c, size 0x1c, virtual true, abstract: false, final false
inline ::System::Object* FindId(::StringW  name) ;

/// @brief Method GenEntity, addr 0x2ca49d8, size 0x154, virtual false, abstract: false, final false
inline bool GenEntity(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method GetEntity, addr 0x2ca5fa8, size 0x94, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaEntity* GetEntity(::System::Xml::XmlQualifiedName*  qname, bool  fParameterEntity) ;

/// @brief Method Init, addr 0x2ca4380, size 0x130, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method MeetsStandAloneConstraint, addr 0x2ca4888, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x2ca5b08, size 0xa4, virtual false, abstract: false, final false
inline bool Pop() ;

/// @brief Method ProcessElement, addr 0x2ca4e14, size 0x10c, virtual false, abstract: false, final false
inline void ProcessElement() ;

/// @brief Method ProcessTokenizedType, addr 0x2ca5ce8, size 0x214, virtual false, abstract: false, final false
inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType  ttype, ::StringW  name) ;

/// @brief Method Push, addr 0x2ca44b0, size 0xd8, virtual false, abstract: false, final false
inline void Push(::System::Xml::XmlQualifiedName*  elementName) ;

/// @brief Method SetDefaultTypedValue, addr 0x2ca603c, size 0x3b4, virtual false, abstract: false, final false
static inline void SetDefaultTypedValue(::System::Xml::Schema::SchemaAttDef*  attdef, ::System::Xml::IDtdParserAdapter*  readerAdapter) ;

/// @brief Method Validate, addr 0x2ca4588, size 0x1f8, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method ValidateChildElement, addr 0x2ca4cd0, size 0x144, virtual false, abstract: false, final false
inline void ValidateChildElement() ;

/// @brief Method ValidateElement, addr 0x2ca4780, size 0x108, virtual false, abstract: false, final false
inline void ValidateElement() ;

/// @brief Method ValidateEndElement, addr 0x2ca4b2c, size 0x1a4, virtual false, abstract: false, final false
inline void ValidateEndElement() ;

/// @brief Method ValidateEndStartElement, addr 0x2ca58ec, size 0x1d4, virtual false, abstract: false, final false
inline void ValidateEndStartElement() ;

/// @brief Method ValidatePIComment, addr 0x2ca4928, size 0xb0, virtual false, abstract: false, final false
inline void ValidatePIComment() ;

/// @brief Method ValidateStartElement, addr 0x2ca4f20, size 0x45c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ca42e0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_PreserveWhitespace, addr 0x2ca5cb0, size 0x38, virtual true, abstract: false, final false
