...
/// @brief Method And, addr 0x2c8a5f8, size 0xbc, virtual false, abstract: false, final false
inline void And(::System::Xml::Schema::BitSet*  other) ;

/// @brief Method Clear, addr 0x2c8a41c, size 0x54, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Clone, addr 0x2c8a8ec, size 0xd4, virtual false, abstract: false, final false
inline ::System::Xml::Schema::BitSet* Clone() ;

/// @brief Method EnsureLength, addr 0x2c8a4cc, size 0x94, virtual false, abstract: false, final false
inline void EnsureLength(int32_t  nRequiredLength) ;

/// @brief Method Equals, addr 0x2c8a790, size 0x15c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Get, addr 0x2c8a3cc, size 0x50, virtual false, abstract: false, final false
inline bool Get(int32_t  index) ;

/// @brief Method GetHashCode, addr 0x2c8a758, size 0x38, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Intersects, addr 0x2c8aa28, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method NextSet, addr 0x2c8a560, size 0x98, virtual false, abstract: false, final false
inline int32_t NextSet(int32_t  startFrom) ;

/// @brief Method Or, addr 0x2c8a6b4, size 0xa4, virtual false, abstract: false, final false
inline void Or(::System::Xml::Schema::BitSet*  other) ;

/// @brief Method Set, addr 0x2c8a470, size 0x5c, virtual false, abstract: false, final false
inline void Set(int32_t  index) ;

/// @brief Method Subscript, addr 0x2c8a3b8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c8a340, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2c8a348, size 0x70, virtual false, abstract: false, final false
inline void _ctor(int32_t  count) ;

/// @brief Method get_Count, addr 0x2c8a3c0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_IsEmpty, addr 0x2c8a9c0, size 0x68, virtual false, abstract: false, final false
inline bool get_IsEmpty() ;

/// @brief Method get_Item, addr 0x2c8a3c8, size 0x4, virtual false, abstract: false, final false
