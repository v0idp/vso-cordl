...
/// @brief Method .ctor, addr 0x2b9ec70, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaException*  ex) ;

/// @brief Method .ctor, addr 0x2b9ece0, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaException*  ex, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method get_Exception, addr 0x2b9ed5c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaException* get_Exception() ;

/// @brief Method get_Severity, addr 0x2b9ed54, size 0x8, virtual false, abstract: false, final false
