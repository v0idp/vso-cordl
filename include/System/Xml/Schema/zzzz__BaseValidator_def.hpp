...
/// @brief Method CompleteValidation, addr 0x2c894d0, size 0x4, virtual true, abstract: false, final false
inline void CompleteValidation() ;

/// @brief Method CreateInstance, addr 0x2c8a1b4, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method FindId, addr 0x2c894d4, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ProcessEntity, addr 0x2c89fc0, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method ProcessEntity, addr 0x2c89e00, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method SaveTextValue, addr 0x2c8991c, size 0x74, virtual false, abstract: false, final false
inline void SaveTextValue(::StringW  value) ;

/// @brief Method SendValidationEvent, addr 0x2c89acc, size 0x60, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code) ;

/// @brief Method SendValidationEvent, addr 0x2c8974c, size 0xe8, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  arg) ;

/// @brief Method SendValidationEvent, addr 0x2c89834, size 0xe8, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::ArrayW<::StringW,::Array<::StringW>*>  args) ;

/// @brief Method SendValidationEvent, addr 0x2c89d0c, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method SendValidationEvent, addr 0x2c89c18, size 0xf4, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  msg, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method SendValidationEvent, addr 0x2c89b2c, size 0x8, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e) ;

/// @brief Method SendValidationEvent, addr 0x2c89b34, size 0xe4, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method Validate, addr 0x2c894cc, size 0x4, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method ValidateText, addr 0x2c894dc, size 0x270, virtual false, abstract: false, final false
inline void ValidateText() ;

/// @brief Method ValidateWhitespace, addr 0x2c89990, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c89260, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::BaseValidator*  other) ;

/// @brief Method .ctor, addr 0x2c87d7c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_BaseUri, addr 0x2c89304, size 0x8, virtual false, abstract: false, final false
inline ::System::Uri* get_BaseUri() ;

/// @brief Method get_EventHandler, addr 0x2c89314, size 0xd0, virtual false, abstract: false, final false
inline ::System::Xml::Schema::ValidationEventHandler* get_EventHandler() ;

/// @brief Method get_NameTable, addr 0x2c892e4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_PositionInfo, addr 0x2c892ec, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::PositionInfo* get_PositionInfo() ;

/// @brief Method get_PreserveWhitespace, addr 0x2c894c4, size 0x8, virtual true, abstract: false, final false
inline bool get_PreserveWhitespace() ;

/// @brief Method get_Reader, addr 0x2c892d4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlValidatingReaderImpl* get_Reader() ;

/// @brief Method get_SchemaCollection, addr 0x2c892dc, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaCollection* get_SchemaCollection() ;

/// @brief Method get_SchemaInfo, addr 0x2c893e4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_SchemaInfo() ;

/// @brief Method get_SchemaNames, addr 0x2c88260, size 0x8c, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaNames* get_SchemaNames() ;

/// @brief Method get_XmlResolver, addr 0x2c892f4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlResolver* get_XmlResolver() ;

/// @brief Method set_BaseUri, addr 0x2c8930c, size 0x8, virtual false, abstract: false, final false
inline void set_BaseUri(::System::Uri*  value) ;

/// @brief Method set_DtdInfo, addr 0x2c893ec, size 0xd8, virtual false, abstract: false, final false
inline void set_DtdInfo(::System::Xml::IDtdInfo*  value) ;

/// @brief Method set_XmlResolver, addr 0x2c892fc, size 0x8, virtual false, abstract: false, final false
