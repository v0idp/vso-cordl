...
/// @brief Method Add, addr 0x2bb6f44, size 0x1a4, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Add(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method Add, addr 0x2bb6ee8, size 0x5c, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Add(::StringW  targetNamespace, ::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method Add, addr 0x2bb4824, size 0x970, virtual false, abstract: false, final false
inline void Add(::System::Xml::Schema::XmlSchemaSet*  schemas) ;

/// @brief Method Add, addr 0x2bba404, size 0x3a0, virtual false, abstract: false, final false
inline void Add(::StringW  targetNamespace, ::System::Xml::XmlReader*  reader, ::System::Collections::Hashtable*  validatedNamespaces) ;

/// @brief Method AddSchemaToSet, addr 0x2bba090, size 0x374, virtual false, abstract: false, final false
inline void AddSchemaToSet(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method AddToTable, addr 0x2bbb438, size 0x2e0, virtual false, abstract: false, final false
...
/// @brief Method ClearTables, addr 0x2bb84c0, size 0x5c, virtual false, abstract: false, final false
inline void ClearTables() ;

/// @brief Method Compile, addr 0x2bb8010, size 0x4b0, virtual false, abstract: false, final false
inline void Compile() ;

/// @brief Method Contains, addr 0x2bb7f94, size 0x7c, virtual false, abstract: false, final false
inline bool Contains(::StringW  targetNamespace) ;

/// @brief Method CopyFromCompiledSet, addr 0x2bb5194, size 0x1ad4, virtual false, abstract: false, final false
inline void CopyFromCompiledSet(::System::Xml::Schema::XmlSchemaSet*  otherSet) ;

/// @brief Method CopyTo, addr 0x2bb9f08, size 0x164, virtual false, abstract: false, final false
inline void CopyTo(::ArrayW<::System::Xml::Schema::XmlSchema*,::Array<::System::Xml::Schema::XmlSchema*>*>  schemas, int32_t  index) ;

/// @brief Method FindSchemaByNSAndUrl, addr 0x2bb6c68, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method GetEventHandler, addr 0x2bbb8bc, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::ValidationEventHandler* GetEventHandler() ;

/// @brief Method GetResolver, addr 0x2bbb8a0, size 0x1c, virtual false, abstract: false, final false
inline ::System::Xml::XmlResolver* GetResolver() ;

/// @brief Method GetSchemaByUri, addr 0x2bbb8c4, size 0x140, virtual false, abstract: false, final false
inline bool GetSchemaByUri(::System::Uri*  schemaUri, ::ByRef<::System::Xml::Schema::XmlSchema*>  schema) ;

/// @brief Method GetSchemaNames, addr 0x2bbb718, size 0x98, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaNames* GetSchemaNames(::System::Xml::XmlNameTable*  nt) ;

/// @brief Method GetTargetNamespace, addr 0x2bb7b38, size 0x5c, virtual false, abstract: false, final false
inline ::StringW GetTargetNamespace(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method InternalValidationCallback, addr 0x2bbba0c, size 0x44, virtual false, abstract: false, final false
inline void InternalValidationCallback(::System::Object*  sender, ::System::Xml::Schema::ValidationEventArgs*  e) ;

/// @brief Method IsSchemaLoaded, addr 0x2bba7a4, size 0x27c, virtual false, abstract: false, final false
...
/// @brief Method ParseSchema, addr 0x2bbaa20, size 0x16c, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* ParseSchema(::StringW  targetNamespace, ::System::Xml::XmlReader*  reader) ;

/// @brief Method PreprocessSchema, addr 0x2bb9e14, size 0xf4, virtual false, abstract: false, final false
inline bool PreprocessSchema(::ByRef<::System::Xml::Schema::XmlSchema*>  schema, ::StringW  targetNamespace) ;

/// @brief Method ProcessNewSubstitutionGroups, addr 0x2bbab8c, size 0x4d8, virtual false, abstract: false, final false
inline void ProcessNewSubstitutionGroups(::System::Xml::Schema::XmlSchemaObjectTable*  substitutionGroupsTable, bool  resolve) ;

/// @brief Method Remove, addr 0x2bb7c34, size 0x360, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Remove(::System::Xml::Schema::XmlSchema*  schema, bool  forceCompile) ;

/// @brief Method RemoveRecursive, addr 0x2bb70e8, size 0xa50, virtual false, abstract: false, final false
inline bool RemoveRecursive(::System::Xml::Schema::XmlSchema*  schemaToRemove) ;

/// @brief Method RemoveSchemaFromCaches, addr 0x2bb96a8, size 0x608, virtual false, abstract: false, final false
inline void RemoveSchemaFromCaches(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method RemoveSchemaFromGlobalTables, addr 0x2bb8c18, size 0xa90, virtual false, abstract: false, final false
inline void RemoveSchemaFromGlobalTables(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method Reprocess, addr 0x2bb851c, size 0x6fc, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* Reprocess(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method ResolveSubstitutionGroup, addr 0x2bbb064, size 0x3d4, virtual false, abstract: false, final false
...
/// @brief Method Schemas, addr 0x2bba06c, size 0x24, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* Schemas() ;

/// @brief Method Schemas, addr 0x2bb9cb0, size 0x164, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* Schemas(::StringW  targetNamespace) ;

/// @brief Method SendValidationEvent, addr 0x2bb7b94, size 0xa0, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method VerifyTables, addr 0x2bbb7b0, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bb41cc, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2bb4228, size 0x270, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlNameTable*  nameTable) ;

/// @brief Method add_ValidationEventHandler, addr 0x2bb4498, size 0xc8, virtual false, abstract: false, final false
inline void add_ValidationEventHandler(::System::Xml::Schema::ValidationEventHandler*  value) ;

/// @brief Method get_CompilationSettings, addr 0x2bb4608, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaCompilationSettings* get_CompilationSettings() ;

/// @brief Method get_CompiledInfo, addr 0x2bbb890, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaInfo* get_CompiledInfo() ;

/// @brief Method get_Count, addr 0x2bb4618, size 0x24, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_GlobalAttributes, addr 0x2bb469c, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalAttributes() ;

/// @brief Method get_GlobalElements, addr 0x2bb463c, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalElements() ;

/// @brief Method get_GlobalTypes, addr 0x2bb46fc, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_GlobalTypes() ;

/// @brief Method get_InternalSyncObject, addr 0x2bb415c, size 0x70, virtual false, abstract: false, final false
inline ::System::Object* get_InternalSyncObject() ;

/// @brief Method get_IsCompiled, addr 0x2bb45e4, size 0x8, virtual false, abstract: false, final false
inline bool get_IsCompiled() ;

/// @brief Method get_ReaderSettings, addr 0x2bbb898, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlReaderSettings* get_ReaderSettings() ;

/// @brief Method get_SchemaLocations, addr 0x2bb47bc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Hashtable* get_SchemaLocations() ;

/// @brief Method get_SortedSchemas, addr 0x2bbba04, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::SortedList* get_SortedSchemas() ;

/// @brief Method get_SubstitutionGroups, addr 0x2bb475c, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_SubstitutionGroups() ;

/// @brief Method get_TypeExtensions, addr 0x2bb47c4, size 0x60, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectTable* get_TypeExtensions() ;

/// @brief Method remove_ValidationEventHandler, addr 0x2bb4560, size 0x84, virtual false, abstract: false, final false
inline void remove_ValidationEventHandler(::System::Xml::Schema::ValidationEventHandler*  value) ;

/// @brief Method set_CompilationSettings, addr 0x2bb4610, size 0x8, virtual false, abstract: false, final false
inline void set_CompilationSettings(::System::Xml::Schema::XmlSchemaCompilationSettings*  value) ;

/// @brief Method set_XmlResolver, addr 0x2bb45ec, size 0x1c, virtual false, abstract: false, final false
