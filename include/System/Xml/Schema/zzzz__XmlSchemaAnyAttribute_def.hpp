...
/// @brief Method Allows, addr 0x2bac390, size 0x28, virtual false, abstract: false, final false
inline bool Allows(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method BuildNamespaceList, addr 0x2bac270, size 0x80, virtual false, abstract: false, final false
inline void BuildNamespaceList(::StringW  targetNamespace) ;

/// @brief Method BuildNamespaceListV1Compat, addr 0x2bac2f0, size 0xa0, virtual false, abstract: false, final false
inline void BuildNamespaceListV1Compat(::StringW  targetNamespace) ;

/// @brief Method Intersection, addr 0x2bac3dc, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method IsSubset, addr 0x2bac3b8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method Union, addr 0x2bac494, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bac48c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_NamespaceList, addr 0x2bac254, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::NamespaceList* get_NamespaceList() ;

/// @brief Method get_ProcessContents, addr 0x2bac244, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContentProcessing get_ProcessContents() ;

/// @brief Method get_ProcessContentsCorrect, addr 0x2bac25c, size 0x14, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContentProcessing get_ProcessContentsCorrect() ;

/// @brief Method set_Namespace, addr 0x2bac23c, size 0x8, virtual false, abstract: false, final false
inline void set_Namespace(::StringW  value) ;

/// @brief Method set_ProcessContents, addr 0x2bac24c, size 0x8, virtual false, abstract: false, final false
