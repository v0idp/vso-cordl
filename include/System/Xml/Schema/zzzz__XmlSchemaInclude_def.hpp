...
/// @brief Method AddAnnotation, addr 0x2bb1734, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bb1714, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
