...
/// @brief Method .ctor, addr 0x2b8b220, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::XmlQualifiedName*  name) ;

/// @brief Method get_Name, addr 0x2b8b248, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_Name() ;

/// @brief Method get_Pubid, addr 0x2b8b260, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Pubid() ;

/// @brief Method get_SystemLiteral, addr 0x2b8b250, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SystemLiteral() ;

/// @brief Method set_Pubid, addr 0x2b8b268, size 0x8, virtual false, abstract: false, final false
inline void set_Pubid(::StringW  value) ;

/// @brief Method set_SystemLiteral, addr 0x2b8b258, size 0x8, virtual false, abstract: false, final false
