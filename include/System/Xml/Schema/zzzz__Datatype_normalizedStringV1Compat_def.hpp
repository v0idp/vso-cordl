...
/// @brief Method .ctor, addr 0x2c98404, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HasValueFacets, addr 0x2c9fa24, size 0x8, virtual true, abstract: false, final false
inline bool get_HasValueFacets() ;

/// @brief Method get_TypeCode, addr 0x2c9fa1c, size 0x8, virtual true, abstract: false, final false
