...
/// @brief Method BuildRefNamespaces, addr 0x2b64a8c, size 0x220, virtual false, abstract: false, final false
inline void BuildRefNamespaces(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method BuildSchemaList, addr 0x2b624a4, size 0x178, virtual false, abstract: false, final false
inline void BuildSchemaList(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method CheckRefinedAttributeGroup, addr 0x2b67f04, size 0x158, virtual false, abstract: false, final false
inline void CheckRefinedAttributeGroup(::System::Xml::Schema::XmlSchemaAttributeGroup*  attributeGroup) ;

/// @brief Method CheckRefinedComplexType, addr 0x2b6805c, size 0x314, virtual false, abstract: false, final false
inline void CheckRefinedComplexType(::System::Xml::Schema::XmlSchemaComplexType*  ctype) ;

/// @brief Method CheckRefinedGroup, addr 0x2b67e64, size 0xa0, virtual false, abstract: false, final false
inline void CheckRefinedGroup(::System::Xml::Schema::XmlSchemaGroup*  group) ;

/// @brief Method CheckRefinedSimpleType, addr 0x2b68370, size 0x10c, virtual false, abstract: false, final false
inline void CheckRefinedSimpleType(::System::Xml::Schema::XmlSchemaSimpleType*  stype) ;

/// @brief Method Cleanup, addr 0x2b642e0, size 0xd4, virtual false, abstract: false, final false
inline void Cleanup(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method CleanupRedefine, addr 0x2b6495c, size 0xa0, virtual false, abstract: false, final false
inline void CleanupRedefine(::System::Xml::Schema::XmlSchemaExternal*  include) ;

/// @brief Method CopyIncludedComponents, addr 0x2b652a0, size 0x12c4, virtual false, abstract: false, final false
inline void CopyIncludedComponents(::System::Xml::Schema::XmlSchema*  includedSchema, ::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method CountGroupSelfReference, addr 0x2b6847c, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x2b61260, size 0x4bc, virtual false, abstract: false, final false
inline bool Execute(::System::Xml::Schema::XmlSchema*  schema, ::StringW  targetNamespace, bool  loadExternals) ;

/// @brief Method GetBuildInSchema, addr 0x2b643b4, size 0x5a8, virtual false, abstract: false, final false
static inline ::System::Xml::Schema::XmlSchema* GetBuildInSchema() ;

/// @brief Method GetChameleonSchema, addr 0x2b6171c, size 0x130, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchema* GetChameleonSchema(::StringW  targetNamespace, ::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method GetIncludedSet, addr 0x2b67d38, size 0x12c, virtual false, abstract: false, final false
inline void GetIncludedSet(::System::Xml::Schema::XmlSchema*  schema, ::System::Collections::ArrayList*  includesList) ;

/// @brief Method GetParentSchema, addr 0x2b67ca4, size 0x94, virtual false, abstract: false, final false
static inline ::System::Xml::Schema::XmlSchema* GetParentSchema(::System::Xml::Schema::XmlSchemaObject*  currentSchemaObject) ;

/// @brief Method GetSchemaEntity, addr 0x2b64a64, size 0x28, virtual false, abstract: false, final false
inline ::System::Object* GetSchemaEntity(::System::Uri*  ruri) ;

/// @brief Method LoadExternals, addr 0x2b6184c, size 0xc58, virtual false, abstract: false, final false
...
/// @brief Method ParseUri, addr 0x2b64cac, size 0x144, virtual false, abstract: false, final false
inline void ParseUri(::StringW  uri, ::StringW  code, ::System::Xml::Schema::XmlSchemaObject*  sourceSchemaObject) ;

/// @brief Method Preprocess, addr 0x2b6261c, size 0x11c4, virtual false, abstract: false, final false
inline void Preprocess(::System::Xml::Schema::XmlSchema*  schema, ::StringW  targetNamespace, ::System::Collections::ArrayList*  imports) ;

/// @brief Method PreprocessAnnotation, addr 0x2b67c34, size 0x70, virtual false, abstract: false, final false
inline void PreprocessAnnotation(::System::Xml::Schema::XmlSchemaAnnotation*  annotation) ;

/// @brief Method PreprocessAnnotation, addr 0x2b64e08, size 0x8c, virtual false, abstract: false, final false
inline void PreprocessAnnotation(::System::Xml::Schema::XmlSchemaObject*  schemaObject) ;

/// @brief Method PreprocessAttribute, addr 0x2b66564, size 0x164, virtual false, abstract: false, final false
inline void PreprocessAttribute(::System::Xml::Schema::XmlSchemaAttribute*  attribute) ;

/// @brief Method PreprocessAttributeContent, addr 0x2b68a08, size 0x228, virtual false, abstract: false, final false
inline void PreprocessAttributeContent(::System::Xml::Schema::XmlSchemaAttribute*  attribute) ;

/// @brief Method PreprocessAttributeGroup, addr 0x2b666c8, size 0xf8, virtual false, abstract: false, final false
inline void PreprocessAttributeGroup(::System::Xml::Schema::XmlSchemaAttributeGroup*  attributeGroup) ;

/// @brief Method PreprocessAttributes, addr 0x2b69020, size 0x364, virtual false, abstract: false, final false
...
/// @brief Method PreprocessComplexType, addr 0x2b667c0, size 0x88c, virtual false, abstract: false, final false
inline void PreprocessComplexType(::System::Xml::Schema::XmlSchemaComplexType*  complexType, bool  local) ;

/// @brief Method PreprocessElement, addr 0x2b675d4, size 0x248, virtual false, abstract: false, final false
inline void PreprocessElement(::System::Xml::Schema::XmlSchemaElement*  element) ;

/// @brief Method PreprocessElementContent, addr 0x2b69384, size 0x324, virtual false, abstract: false, final false
inline void PreprocessElementContent(::System::Xml::Schema::XmlSchemaElement*  element) ;

/// @brief Method PreprocessGroup, addr 0x2b6781c, size 0x1c4, virtual false, abstract: false, final false
inline void PreprocessGroup(::System::Xml::Schema::XmlSchemaGroup*  group) ;

/// @brief Method PreprocessIdentityConstraint, addr 0x2b69a38, size 0x344, virtual false, abstract: false, final false
inline void PreprocessIdentityConstraint(::System::Xml::Schema::XmlSchemaIdentityConstraint*  constraint) ;

/// @brief Method PreprocessLocalAttribute, addr 0x2b68c30, size 0x1dc, virtual false, abstract: false, final false
inline void PreprocessLocalAttribute(::System::Xml::Schema::XmlSchemaAttribute*  attribute) ;

/// @brief Method PreprocessLocalElement, addr 0x2b696a8, size 0x390, virtual false, abstract: false, final false
inline void PreprocessLocalElement(::System::Xml::Schema::XmlSchemaElement*  element) ;

/// @brief Method PreprocessNotation, addr 0x2b679e0, size 0x254, virtual false, abstract: false, final false
inline void PreprocessNotation(::System::Xml::Schema::XmlSchemaNotation*  notation) ;

/// @brief Method PreprocessParticle, addr 0x2b69d7c, size 0x8cc, virtual false, abstract: false, final false
inline void PreprocessParticle(::System::Xml::Schema::XmlSchemaParticle*  particle) ;

/// @brief Method PreprocessRedefine, addr 0x2b637e0, size 0xb00, virtual false, abstract: false, final false
inline void PreprocessRedefine(::System::Xml::Schema::RedefineEntry*  redefineEntry) ;

/// @brief Method PreprocessSimpleType, addr 0x2b6704c, size 0x588, virtual false, abstract: false, final false
inline void PreprocessSimpleType(::System::Xml::Schema::XmlSchemaSimpleType*  simpleType, bool  local) ;

/// @brief Method ResolveSchemaLocationUri, addr 0x2b64a24, size 0x40, virtual false, abstract: false, final false
inline ::System::Uri* ResolveSchemaLocationUri(::System::Xml::Schema::XmlSchema*  enclosingSchema, ::StringW  location) ;

/// @brief Method SetParent, addr 0x2b64df0, size 0x18, virtual false, abstract: false, final false
inline void SetParent(::System::Xml::Schema::XmlSchemaObject*  child, ::System::Xml::Schema::XmlSchemaObject*  parent) ;

/// @brief Method SetSchemaDefaults, addr 0x2b65194, size 0x10c, virtual false, abstract: false, final false
inline void SetSchemaDefaults(::System::Xml::Schema::XmlSchema*  schema) ;

/// @brief Method ValidateIdAttribute, addr 0x2b64e94, size 0x300, virtual false, abstract: false, final false
inline void ValidateIdAttribute(::System::Xml::Schema::XmlSchemaObject*  xso) ;

/// @brief Method ValidateNameAttribute, addr 0x2b68760, size 0x2a8, virtual false, abstract: false, final false
inline void ValidateNameAttribute(::System::Xml::Schema::XmlSchemaObject*  xso) ;

/// @brief Method ValidateQNameAttribute, addr 0x2b68e0c, size 0x214, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b61180, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_RootSchema, addr 0x2b64a1c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_ChameleonSchemas, addr 0x2b64a14, size 0x8, virtual false, abstract: false, final false
inline void set_ChameleonSchemas(::System::Collections::Hashtable*  value) ;

/// @brief Method set_ReaderSettings, addr 0x2b64a04, size 0x8, virtual false, abstract: false, final false
inline void set_ReaderSettings(::System::Xml::XmlReaderSettings*  value) ;

/// @brief Method set_SchemaLocations, addr 0x2b64a0c, size 0x8, virtual false, abstract: false, final false
inline void set_SchemaLocations(::System::Collections::Hashtable*  value) ;

/// @brief Method set_XmlResolver, addr 0x2b649fc, size 0x8, virtual false, abstract: false, final false
