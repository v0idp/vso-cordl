...
/// @brief Method AddChoice, addr 0x2c8fe54, size 0xe0, virtual false, abstract: false, final false
inline void AddChoice() ;

/// @brief Method AddLeafNode, addr 0x2c8fcec, size 0xdc, virtual false, abstract: false, final false
inline void AddLeafNode(::System::Xml::Schema::SyntaxTreeNode*  node) ;

/// @brief Method AddLeafRange, addr 0x2c90278, size 0xe8, virtual false, abstract: false, final false
inline void AddLeafRange(::System::Decimal  min, ::System::Decimal  max) ;

/// @brief Method AddName, addr 0x2c8fc44, size 0xa8, virtual false, abstract: false, final false
inline void AddName(::System::Xml::XmlQualifiedName*  name, ::System::Object*  particle) ;

/// @brief Method AddNamespaceList, addr 0x2c8fdc8, size 0x8c, virtual false, abstract: false, final false
inline void AddNamespaceList(::System::Xml::Schema::NamespaceList*  namespaceList, ::System::Object*  particle) ;

/// @brief Method AddPlus, addr 0x2c901c0, size 0x5c, virtual false, abstract: false, final false
inline void AddPlus() ;

/// @brief Method AddQMark, addr 0x2c9021c, size 0x5c, virtual false, abstract: false, final false
inline void AddQMark() ;

/// @brief Method AddSequence, addr 0x2c8ff34, size 0xe0, virtual false, abstract: false, final false
inline void AddSequence() ;

/// @brief Method AddStar, addr 0x2c90014, size 0x5c, virtual false, abstract: false, final false
inline void AddStar() ;

/// @brief Method BuildTransitionTable, addr 0x2c90eb4, size 0x59c, virtual false, abstract: false, final false
...
/// @brief Method CalculateTotalFollowposForRangeNodes, addr 0x2c908b4, size 0x2a8, virtual false, abstract: false, final false
...
/// @brief Method CheckCMUPAWithLeafRangeNodes, addr 0x2c90ccc, size 0x160, virtual false, abstract: false, final false
inline void CheckCMUPAWithLeafRangeNodes(::System::Xml::Schema::BitSet*  curpos) ;

/// @brief Method CheckUniqueParticleAttribution, addr 0x2c914f0, size 0x1b4, virtual false, abstract: false, final false
inline void CheckUniqueParticleAttribution(::System::Xml::Schema::BitSet*  curpos) ;

/// @brief Method CheckUniqueParticleAttribution, addr 0x2c90e2c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method CloseGroup, addr 0x2c8fabc, size 0x150, virtual false, abstract: false, final false
inline void CloseGroup() ;

/// @brief Method Closure, addr 0x2c90070, size 0x150, virtual false, abstract: false, final false
inline void Closure(::System::Xml::Schema::InteriorNode*  node) ;

/// @brief Method CompleteValidation, addr 0x2c8f9ac, size 0x38, virtual true, abstract: false, final false
inline bool CompleteValidation(::System::Xml::Schema::ValidationState*  context) ;

/// @brief Method Exists, addr 0x2c8fc0c, size 0x38, virtual false, abstract: false, final false
inline bool Exists(::System::Xml::XmlQualifiedName*  name) ;

/// @brief Method Finish, addr 0x2c90360, size 0x554, virtual false, abstract: false, final false
inline ::System::Xml::Schema::ContentValidator* Finish(bool  useDFA) ;

/// @brief Method GetApplicableMinMaxFollowPos, addr 0x2c90b5c, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method InitValidation, addr 0x2c8f93c, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method OpenGroup, addr 0x2c8fa94, size 0x28, virtual false, abstract: false, final false
inline void OpenGroup() ;

/// @brief Method Start, addr 0x2c8f9e4, size 0xb0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method ValidateElement, addr 0x2c8f974, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c8f8b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaContentType  contentType) ;

/// @brief Method .ctor, addr 0x2c8f8bc, size 0x80, virtual false, abstract: false, final false
