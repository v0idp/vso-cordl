...
/// @brief Method .ctor, addr 0x2bacf38, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_RefName, addr 0x2bace98, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_RefName() ;

/// @brief Method set_RefName, addr 0x2bacea0, size 0x98, virtual false, abstract: false, final false
