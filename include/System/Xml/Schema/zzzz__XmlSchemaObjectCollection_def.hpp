...
/// @brief Method Add, addr 0x2bab544, size 0xb8, virtual false, abstract: false, final false
inline int32_t Add(::System::Xml::Schema::XmlSchemaObject*  item) ;

/// @brief Method Add, addr 0x2bb1f28, size 0x2c, virtual false, abstract: false, final false
inline void Add(::System::Xml::Schema::XmlSchemaObjectCollection*  collToAdd) ;

/// @brief Method Clone, addr 0x2baf038, size 0x80, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectCollection* Clone() ;

/// @brief Method GetEnumerator, addr 0x2bb1c78, size 0x80, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectEnumerator* GetEnumerator() ;

/// @brief Method Insert, addr 0x2bb1cf8, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method OnClear, addr 0x2bb1ef0, size 0x1c, virtual true, abstract: false, final false
inline void OnClear() ;

/// @brief Method OnInsert, addr 0x2bb1e78, size 0x1c, virtual true, abstract: false, final false
inline void OnInsert(int32_t  index, ::System::Object*  item) ;

/// @brief Method OnRemove, addr 0x2bb1f0c, size 0x1c, virtual true, abstract: false, final false
inline void OnRemove(int32_t  index, ::System::Object*  item) ;

/// @brief Method OnSet, addr 0x2bb1e94, size 0x5c, virtual true, abstract: false, final false
inline void OnSet(int32_t  index, ::System::Object*  oldValue, ::System::Object*  newValue) ;

/// @brief Method Remove, addr 0x2bb1dc0, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ba9fc8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Item, addr 0x2bb1ab0, size 0x100, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObject* get_Item(int32_t  index) ;

/// @brief Method set_Item, addr 0x2bb1bb0, size 0xc8, virtual true, abstract: false, final false
