...
/// @brief Method .ctor, addr 0x2c97b84, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TokenizedType, addr 0x2ca3340, size 0x8, virtual true, abstract: false, final false
