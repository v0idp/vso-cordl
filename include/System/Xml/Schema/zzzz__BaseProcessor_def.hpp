...
/// @brief Method AddToTable, addr 0x2c88498, size 0x460, virtual false, abstract: false, final false
...
/// @brief Method IsValidAttributeGroupRedefine, addr 0x2c888f8, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method IsValidGroupRedefine, addr 0x2c88b48, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method IsValidTypeRedefine, addr 0x2c88a20, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method SendValidationEvent, addr 0x2c88ef8, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method SendValidationEvent, addr 0x2c88c5c, size 0x88, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  msg, ::System::Xml::Schema::XmlSchemaObject*  source) ;

/// @brief Method SendValidationEvent, addr 0x2c8912c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method SendValidationEvent, addr 0x2c88e24, size 0xd4, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::StringW  msg1, ::StringW  msg2, ::System::Xml::Schema::XmlSchemaObject*  source) ;

/// @brief Method SendValidationEvent, addr 0x2c88fb4, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method SendValidationEvent, addr 0x2c88ce4, size 0x78, virtual false, abstract: false, final false
inline void SendValidationEvent(::StringW  code, ::System::Xml::Schema::XmlSchemaObject*  source) ;

/// @brief Method SendValidationEvent, addr 0x2c890a0, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method SendValidationEvent, addr 0x2c89124, size 0x8, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e) ;

/// @brief Method SendValidationEvent, addr 0x2c88d5c, size 0xc8, virtual false, abstract: false, final false
inline void SendValidationEvent(::System::Xml::Schema::XmlSchemaException*  e, ::System::Xml::Schema::XmlSeverityType  severity) ;

/// @brief Method SendValidationEventNoThrow, addr 0x2c891b8, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c882ec, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c88370, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method get_CompilationSettings, addr 0x2c88480, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaCompilationSettings* get_CompilationSettings() ;

/// @brief Method get_EventHandler, addr 0x2c88478, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::ValidationEventHandler* get_EventHandler() ;

/// @brief Method get_HasErrors, addr 0x2c88488, size 0x10, virtual false, abstract: false, final false
inline bool get_HasErrors() ;

/// @brief Method get_NameTable, addr 0x2c88404, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_SchemaNames, addr 0x2c8840c, size 0x6c, virtual false, abstract: false, final false
