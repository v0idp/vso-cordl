...
/// @brief Method .ctor, addr 0x2badb34, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_EnableUpaCheck, addr 0x2badb54, size 0x8, virtual false, abstract: false, final false
