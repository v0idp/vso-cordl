...
/// @brief Method ToString, addr 0x2bf3720, size 0x8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2bf3728, size 0x42c, virtual false, abstract: false, final false
inline ::StringW ToString(::System::Xml::Schema::XsdDuration_DurationType  durationType) ;

/// @brief Method ToTimeSpan, addr 0x2bf3218, size 0x8, virtual false, abstract: false, final false
inline ::System::TimeSpan ToTimeSpan() ;

/// @brief Method ToTimeSpan, addr 0x2bf3220, size 0x48, virtual false, abstract: false, final false
inline ::System::TimeSpan ToTimeSpan(::System::Xml::Schema::XsdDuration_DurationType  durationType) ;

/// @brief Method TryParse, addr 0x2bf2a98, size 0x738, virtual false, abstract: false, final false
...
/// @brief Method TryParse, addr 0x2bf3b54, size 0xc, virtual false, abstract: false, final false
static inline ::System::Exception* TryParse(::StringW  s, ::ByRef<::System::Xml::Schema::XsdDuration>  result) ;

/// @brief Method TryParseDigits, addr 0x2bf3b60, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method TryToTimeSpan, addr 0x2bf3268, size 0x4ac, virtual false, abstract: false, final false
...
/// @brief Method TryToTimeSpan, addr 0x2bf3714, size 0xc, virtual false, abstract: false, final false
inline ::System::Exception* TryToTimeSpan(::ByRef<::System::TimeSpan>  result) ;

/// @brief Method .ctor, addr 0x2bf26e8, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bf2a1c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  s) ;

/// @brief Method .ctor, addr 0x2bf2a24, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  s, ::System::Xml::Schema::XsdDuration_DurationType  durationType) ;

/// @brief Method .ctor, addr 0x2bf2844, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::TimeSpan  timeSpan) ;

/// @brief Method .ctor, addr 0x2bf284c, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor(::System::TimeSpan  timeSpan, ::System::Xml::Schema::XsdDuration_DurationType  durationType) ;

/// @brief Method get_Days, addr 0x2bf31f8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Days() ;

/// @brief Method get_Hours, addr 0x2bf3200, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Hours() ;

/// @brief Method get_IsNegative, addr 0x2bf31dc, size 0xc, virtual false, abstract: false, final false
inline bool get_IsNegative() ;

/// @brief Method get_Minutes, addr 0x2bf3208, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Minutes() ;

/// @brief Method get_Months, addr 0x2bf31f0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Months() ;

/// @brief Method get_Nanoseconds, addr 0x2bf31d0, size 0xc, virtual false, abstract: false, final false
inline int32_t get_Nanoseconds() ;

/// @brief Method get_Seconds, addr 0x2bf3210, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Seconds() ;

/// @brief Method get_Years, addr 0x2bf31e8, size 0x8, virtual false, abstract: false, final false
