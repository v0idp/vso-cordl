...
/// @brief Method Reactivate, addr 0x2c8b3dc, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c8b3ac, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::Asttree*  astfield, ::System::Xml::Schema::KeySequence*  ks, int32_t  column) ;

/// @brief Method get_Column, addr 0x2c8b3a4, size 0x8, virtual false, abstract: false, final false
