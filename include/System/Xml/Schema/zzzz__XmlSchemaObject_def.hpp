...
/// @brief Method AddAnnotation, addr 0x2bb1a0c, size 0x4, virtual true, abstract: false, final false
inline void AddAnnotation(::System::Xml::Schema::XmlSchemaAnnotation*  annotation) ;

/// @brief Method Clone, addr 0x2bb1a30, size 0x80, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObject* Clone() ;

static inline ::System::Xml::Schema::XmlSchemaObject* New_ctor() ;

/// @brief Method OnAdd, addr 0x2bb19f0, size 0x4, virtual true, abstract: false, final false
inline void OnAdd(::System::Xml::Schema::XmlSchemaObjectCollection*  container, ::System::Object*  item) ;

/// @brief Method OnClear, addr 0x2bb19f8, size 0x4, virtual true, abstract: false, final false
inline void OnClear(::System::Xml::Schema::XmlSchemaObjectCollection*  container) ;

/// @brief Method OnRemove, addr 0x2bb19f4, size 0x4, virtual true, abstract: false, final false
inline void OnRemove(::System::Xml::Schema::XmlSchemaObjectCollection*  container, ::System::Object*  item) ;

/// @brief Method SetUnhandledAttributes, addr 0x2bb1a08, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ba9fd0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IdAttribute, addr 0x2bb19fc, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_IdAttribute() ;

/// @brief Method get_IsProcessing, addr 0x2bb1a1c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsProcessing() ;

/// @brief Method get_LineNumber, addr 0x2bb19a8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x2bb19b8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LinePosition() ;

/// @brief Method get_NameAttribute, addr 0x2bb1a10, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_NameAttribute() ;

/// @brief Method get_Namespaces, addr 0x2baa828, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::Serialization::XmlSerializerNamespaces* get_Namespaces() ;

/// @brief Method get_Parent, addr 0x2bb19d8, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObject* get_Parent() ;

/// @brief Method get_SourceUri, addr 0x2bb19c8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SourceUri() ;

/// @brief Method set_IdAttribute, addr 0x2bb1a04, size 0x4, virtual true, abstract: false, final false
inline void set_IdAttribute(::StringW  value) ;

/// @brief Method set_IsProcessing, addr 0x2bb1a24, size 0xc, virtual false, abstract: false, final false
inline void set_IsProcessing(bool  value) ;

/// @brief Method set_LineNumber, addr 0x2bb19b0, size 0x8, virtual false, abstract: false, final false
inline void set_LineNumber(int32_t  value) ;

/// @brief Method set_LinePosition, addr 0x2bb19c0, size 0x8, virtual false, abstract: false, final false
inline void set_LinePosition(int32_t  value) ;

/// @brief Method set_NameAttribute, addr 0x2bb1a18, size 0x4, virtual true, abstract: false, final false
inline void set_NameAttribute(::StringW  value) ;

/// @brief Method set_Namespaces, addr 0x2bb19e8, size 0x8, virtual false, abstract: false, final false
inline void set_Namespaces(::System::Xml::Serialization::XmlSerializerNamespaces*  value) ;

/// @brief Method set_Parent, addr 0x2bb19e0, size 0x8, virtual false, abstract: false, final false
inline void set_Parent(::System::Xml::Schema::XmlSchemaObject*  value) ;

/// @brief Method set_SourceUri, addr 0x2bb19d0, size 0x8, virtual false, abstract: false, final false
