...
/// @brief Method AddID, addr 0x2bf8314, size 0x90, virtual false, abstract: false, final false
inline void AddID(::StringW  name, ::System::Object*  node) ;

/// @brief Method AddIdentityConstraints, addr 0x2bf83c0, size 0x3e0, virtual false, abstract: false, final false
inline void AddIdentityConstraints() ;

/// @brief Method AttributeIdentityConstraints, addr 0x2bf78cc, size 0x2dc, virtual false, abstract: false, final false
...
/// @brief Method CheckForwardRefs, addr 0x2bf47f8, size 0x104, virtual false, abstract: false, final false
inline void CheckForwardRefs() ;

/// @brief Method CheckValue, addr 0x2bf66d0, size 0x464, virtual false, abstract: false, final false
inline void CheckValue(::StringW  value, ::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method CompleteValidation, addr 0x2bf47f4, size 0x4, virtual true, abstract: false, final false
inline void CompleteValidation() ;

/// @brief Method ElementIdentityConstraints, addr 0x2bf87a0, size 0x348, virtual false, abstract: false, final false
inline void ElementIdentityConstraints() ;

/// @brief Method EndElementIdentityConstraints, addr 0x2bf6b44, size 0xc44, virtual false, abstract: false, final false
inline void EndElementIdentityConstraints() ;

/// @brief Method FastGetElementDecl, addr 0x2bf4d64, size 0xdc, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaElementDecl* FastGetElementDecl(::System::Object*  particle) ;

/// @brief Method FindId, addr 0x2bf83a4, size 0x1c, virtual true, abstract: false, final false
inline ::System::Object* FindId(::StringW  name) ;

/// @brief Method Init, addr 0x2bf3d40, size 0x338, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method IsXSDRoot, addr 0x2bf4ae8, size 0x50, virtual false, abstract: false, final false
inline bool IsXSDRoot(::StringW  localName, ::StringW  ns) ;

/// @brief Method LoadSchema, addr 0x2bf6510, size 0x1c0, virtual false, abstract: false, final false
inline void LoadSchema(::StringW  uri, ::StringW  url) ;

/// @brief Method LoadSchemaFromLocation, addr 0x2bf7ba8, size 0x530, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x2bf7788, size 0xc0, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method ProcessElement, addr 0x2bf4b38, size 0x22c, virtual false, abstract: false, final false
inline void ProcessElement(::System::Object*  particle) ;

/// @brief Method ProcessInlineSchema, addr 0x2bf4248, size 0x270, virtual false, abstract: false, final false
inline void ProcessInlineSchema() ;

/// @brief Method ProcessTokenizedType, addr 0x2bf8110, size 0x204, virtual false, abstract: false, final false
inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType  ttype, ::StringW  name) ;

/// @brief Method ProcessXsiAttributes, addr 0x2bf4e40, size 0x7e4, virtual false, abstract: false, final false
inline void ProcessXsiAttributes(::ByRef<::System::Xml::XmlQualifiedName*>  xsiType, ::ByRef<::StringW>  xsiNil) ;

/// @brief Method Push, addr 0x2bf409c, size 0xe4, virtual false, abstract: false, final false
inline void Push(::System::Xml::XmlQualifiedName*  elementName) ;

/// @brief Method ThoroughGetElementDecl, addr 0x2bf5624, size 0x3d0, virtual false, abstract: false, final false
...
/// @brief Method UnWrapUnion, addr 0x2bf7848, size 0x84, virtual false, abstract: false, final false
inline ::System::Object* UnWrapUnion(::System::Object*  typedValue) ;

/// @brief Method Validate, addr 0x2bf4180, size 0xb8, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method ValidateChildElement, addr 0x2bf48fc, size 0x1ec, virtual false, abstract: false, final false
inline ::System::Object* ValidateChildElement() ;

/// @brief Method ValidateElement, addr 0x2bf44b8, size 0x15c, virtual false, abstract: false, final false
inline void ValidateElement() ;

/// @brief Method ValidateEndElement, addr 0x2bf4614, size 0x1e0, virtual false, abstract: false, final false
inline void ValidateEndElement() ;

/// @brief Method ValidateEndStartElement, addr 0x2bf612c, size 0x3e4, virtual false, abstract: false, final false
inline void ValidateEndStartElement() ;

/// @brief Method ValidateStartElement, addr 0x2bf5a64, size 0x6c8, virtual false, abstract: false, final false
inline void ValidateStartElement() ;

/// @brief Method ValidateStartElementIdentityConstraints, addr 0x2bf5a18, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bf4078, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bf3d1c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method get_HasIdentityConstraints, addr 0x2bf6b34, size 0x10, virtual false, abstract: false, final false
inline bool get_HasIdentityConstraints() ;

/// @brief Method get_HasSchema, addr 0x2bf59f4, size 0x24, virtual false, abstract: false, final false
inline bool get_HasSchema() ;

/// @brief Method get_IsInlineSchemaStarted, addr 0x2bf4238, size 0x10, virtual false, abstract: false, final false
inline bool get_IsInlineSchemaStarted() ;

/// @brief Method get_PreserveWhitespace, addr 0x2bf80d8, size 0x38, virtual true, abstract: false, final false
