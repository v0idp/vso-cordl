...
/// @brief Method Clone, addr 0x2bbbf8c, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bbc03c, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BaseItemType, addr 0x2bbbf7c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_BaseItemType() ;

/// @brief Method get_ItemType, addr 0x2bbbf6c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_ItemType() ;

/// @brief Method get_ItemTypeName, addr 0x2bbbecc, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_ItemTypeName() ;

/// @brief Method set_BaseItemType, addr 0x2bbbf84, size 0x8, virtual false, abstract: false, final false
inline void set_BaseItemType(::System::Xml::Schema::XmlSchemaSimpleType*  value) ;

/// @brief Method set_ItemType, addr 0x2bbbf74, size 0x8, virtual false, abstract: false, final false
inline void set_ItemType(::System::Xml::Schema::XmlSchemaSimpleType*  value) ;

/// @brief Method set_ItemTypeName, addr 0x2bbbed4, size 0x98, virtual false, abstract: false, final false
