...
/// @brief Method Equals, addr 0x2c8c6f0, size 0xf0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetHashCode, addr 0x2c8c37c, size 0x374, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IsQualified, addr 0x2c8c31c, size 0x60, virtual false, abstract: false, final false
inline bool IsQualified() ;

static inline ::System::Xml::Schema::KeySequence* New_ctor(int32_t  dim, int32_t  line, int32_t  col) ;

/// @brief Method ToString, addr 0x2c8c7e0, size 0x12c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c8b7bc, size 0x88, virtual false, abstract: false, final false
inline void _ctor(int32_t  dim, int32_t  line, int32_t  col) ;

/// @brief Method get_Item, addr 0x2c8c1f4, size 0x30, virtual false, abstract: false, final false
inline ::System::Object* get_Item(int32_t  index) ;

/// @brief Method get_PosCol, addr 0x2c8c1ec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_PosCol() ;

/// @brief Method get_PosLine, addr 0x2c8c1e4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_PosLine() ;

/// @brief Method set_Item, addr 0x2c8c224, size 0xf8, virtual false, abstract: false, final false
