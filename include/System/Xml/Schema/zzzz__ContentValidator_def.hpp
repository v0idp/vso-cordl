...
/// @brief Method AddParticleToExpected, addr 0x2c8f534, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method AddParticleToExpected, addr 0x2c8f5a4, size 0x228, virtual false, abstract: false, final false
...
/// @brief Method CompleteValidation, addr 0x2c8f51c, size 0x8, virtual true, abstract: false, final false
inline bool CompleteValidation(::System::Xml::Schema::ValidationState*  context) ;

/// @brief Method ExpectedElements, addr 0x2c8f524, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::ArrayList* ExpectedElements(::System::Xml::Schema::ValidationState*  context, bool  isRequiredOnly) ;

/// @brief Method ExpectedParticles, addr 0x2c8f52c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method InitValidation, addr 0x2c8f4e8, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method ValidateElement, addr 0x2c8f4ec, size 0x30, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c8f41c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::XmlSchemaContentType  contentType) ;

/// @brief Method .ctor, addr 0x2c8f44c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method get_ContentType, addr 0x2c8f48c, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContentType get_ContentType() ;

/// @brief Method get_IsEmptiable, addr 0x2c8f4b0, size 0x8, virtual true, abstract: false, final false
inline bool get_IsEmptiable() ;

/// @brief Method get_IsOpen, addr 0x2c8f4b8, size 0x24, virtual false, abstract: false, final false
inline bool get_IsOpen() ;

/// @brief Method get_PreserveWhitespace, addr 0x2c8f494, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method set_IsOpen, addr 0x2c8f4dc, size 0xc, virtual false, abstract: false, final false
