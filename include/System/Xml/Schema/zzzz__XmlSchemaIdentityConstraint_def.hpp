...
/// @brief Method SetQualifiedName, addr 0x2bb14f4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bb151c, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CompiledConstraint, addr 0x2bb14fc, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::CompiledIdentityConstraint* get_CompiledConstraint() ;

/// @brief Method get_Fields, addr 0x2bb14e4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Fields() ;

/// @brief Method get_Name, addr 0x2bb14c4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NameAttribute, addr 0x2bb150c, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_NameAttribute() ;

/// @brief Method get_QualifiedName, addr 0x2bb14ec, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_QualifiedName() ;

/// @brief Method get_Selector, addr 0x2bb14d4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaXPath* get_Selector() ;

/// @brief Method set_CompiledConstraint, addr 0x2bb1504, size 0x8, virtual false, abstract: false, final false
inline void set_CompiledConstraint(::System::Xml::Schema::CompiledIdentityConstraint*  value) ;

/// @brief Method set_Name, addr 0x2bb14cc, size 0x8, virtual false, abstract: false, final false
inline void set_Name(::StringW  value) ;

/// @brief Method set_NameAttribute, addr 0x2bb1514, size 0x8, virtual true, abstract: false, final false
inline void set_NameAttribute(::StringW  value) ;

/// @brief Method set_Selector, addr 0x2bb14dc, size 0x8, virtual false, abstract: false, final false
