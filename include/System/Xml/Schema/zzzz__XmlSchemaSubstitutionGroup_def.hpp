...
/// @brief Method .ctor, addr 0x2bbc4a8, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Examplar, addr 0x2bbc498, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_Examplar() ;

/// @brief Method get_Members, addr 0x2bbc490, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_Members() ;

/// @brief Method set_Examplar, addr 0x2bbc4a0, size 0x8, virtual false, abstract: false, final false
