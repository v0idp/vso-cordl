...
/// @brief Method Allows, addr 0x2b5e454, size 0x84, virtual true, abstract: false, final false
inline bool Allows(::StringW  ns) ;

/// @brief Method Allows, addr 0x2b5e4d8, size 0x20, virtual false, abstract: false, final false
inline bool Allows(::System::Xml::XmlQualifiedName*  qname) ;

/// @brief Method Clone, addr 0x2b5e2b8, size 0x128, virtual false, abstract: false, final false
inline ::System::Xml::Schema::NamespaceList* Clone() ;

/// @brief Method CompareSetToOther, addr 0x2b5f37c, size 0x12c, virtual false, abstract: false, final false
inline ::System::Xml::Schema::NamespaceList* CompareSetToOther(::System::Xml::Schema::NamespaceList*  other) ;

/// @brief Method Intersection, addr 0x2b5f4a8, size 0x548, virtual false, abstract: false, final false
...
/// @brief Method IsSubset, addr 0x2b5ea00, size 0x3e4, virtual false, abstract: false, final false
...
/// @brief Method RemoveNamespace, addr 0x2b5f9f0, size 0x60, virtual false, abstract: false, final false
inline void RemoveNamespace(::StringW  tns) ;

/// @brief Method ToString, addr 0x2b5e4f8, size 0x508, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Union, addr 0x2b5ede4, size 0x598, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b5e014, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2b5e01c, size 0x29c, virtual false, abstract: false, final false
inline void _ctor(::StringW  namespaces, ::StringW  targetNamespace) ;

/// @brief Method get_Enumerate, addr 0x2b5e3f0, size 0x64, virtual false, abstract: false, final false
inline ::System::Collections::ICollection* get_Enumerate() ;

/// @brief Method get_Excluded, addr 0x2b5e3e8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Excluded() ;

/// @brief Method get_Type, addr 0x2b5e3e0, size 0x8, virtual false, abstract: false, final false
