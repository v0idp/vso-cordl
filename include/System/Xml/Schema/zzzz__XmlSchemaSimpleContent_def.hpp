...
/// @brief Method .ctor, addr 0x2bbba60, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Content, addr 0x2bbba50, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaContent* get_Content() ;

/// @brief Method set_Content, addr 0x2bbba58, size 0x8, virtual true, abstract: false, final false
