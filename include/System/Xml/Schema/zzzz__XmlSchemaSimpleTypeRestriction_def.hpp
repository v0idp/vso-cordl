...
/// @brief Method Clone, addr 0x2bbc15c, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bbc20c, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BaseType, addr 0x2bbc144, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaSimpleType* get_BaseType() ;

/// @brief Method get_BaseTypeName, addr 0x2bbc0a4, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* get_BaseTypeName() ;

/// @brief Method get_Facets, addr 0x2bbc154, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::Schema::XmlSchemaObjectCollection* get_Facets() ;

/// @brief Method set_BaseType, addr 0x2bbc14c, size 0x8, virtual false, abstract: false, final false
inline void set_BaseType(::System::Xml::Schema::XmlSchemaSimpleType*  value) ;

/// @brief Method set_BaseTypeName, addr 0x2bbc0ac, size 0x98, virtual false, abstract: false, final false
