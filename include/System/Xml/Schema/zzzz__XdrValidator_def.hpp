...
/// @brief Method AddID, addr 0x2ba885c, size 0x90, virtual false, abstract: false, final false
inline void AddID(::StringW  name, ::System::Object*  node) ;

/// @brief Method CheckDefaultValue, addr 0x2ba3fc0, size 0x45c, virtual false, abstract: false, final false
...
/// @brief Method CheckForwardRefs, addr 0x2ba89ac, size 0x100, virtual false, abstract: false, final false
inline void CheckForwardRefs() ;

/// @brief Method CheckValue, addr 0x2ba76f0, size 0x5ec, virtual false, abstract: false, final false
inline void CheckValue(::StringW  value, ::System::Xml::Schema::SchemaAttDef*  attdef) ;

/// @brief Method CompleteValidation, addr 0x2ba88ec, size 0xc0, virtual true, abstract: false, final false
inline void CompleteValidation() ;

/// @brief Method FindId, addr 0x2ba8b5c, size 0x1c, virtual true, abstract: false, final false
inline ::System::Object* FindId(::StringW  name) ;

/// @brief Method Init, addr 0x2ba615c, size 0x19c, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method LoadSchema, addr 0x2ba7d78, size 0x190, virtual false, abstract: false, final false
inline void LoadSchema(::StringW  uri) ;

/// @brief Method LoadSchemaFromLocation, addr 0x2ba7fac, size 0x5ac, virtual false, abstract: false, final false
...
/// @brief Method Pop, addr 0x2ba7cdc, size 0x9c, virtual false, abstract: false, final false
inline void Pop() ;

/// @brief Method ProcessElement, addr 0x2ba6bd8, size 0xa8, virtual false, abstract: false, final false
inline void ProcessElement() ;

/// @brief Method ProcessInlineSchema, addr 0x2ba652c, size 0x218, virtual false, abstract: false, final false
inline void ProcessInlineSchema() ;

/// @brief Method ProcessTokenizedType, addr 0x2ba8658, size 0x204, virtual false, abstract: false, final false
inline void ProcessTokenizedType(::System::Xml::XmlTokenizedType  ttype, ::StringW  name) ;

/// @brief Method Push, addr 0x2ba6390, size 0xd4, virtual false, abstract: false, final false
inline void Push(::System::Xml::XmlQualifiedName*  elementName) ;

/// @brief Method QualifiedName, addr 0x2ba7f08, size 0x98, virtual false, abstract: false, final false
inline ::System::Xml::XmlQualifiedName* QualifiedName(::StringW  name, ::StringW  ns) ;

/// @brief Method ThoroughGetElementDecl, addr 0x2ba6c8c, size 0x32c, virtual false, abstract: false, final false
inline ::System::Xml::Schema::SchemaElementDecl* ThoroughGetElementDecl() ;

/// @brief Method Validate, addr 0x2ba6464, size 0xb8, virtual true, abstract: false, final false
inline void Validate() ;

/// @brief Method ValidateChildElement, addr 0x2ba6a94, size 0x144, virtual false, abstract: false, final false
inline void ValidateChildElement() ;

/// @brief Method ValidateElement, addr 0x2ba6744, size 0x190, virtual false, abstract: false, final false
inline void ValidateElement() ;

/// @brief Method ValidateEndElement, addr 0x2ba68d4, size 0x1c0, virtual false, abstract: false, final false
inline void ValidateEndElement() ;

/// @brief Method ValidateEndStartElement, addr 0x2ba7394, size 0x35c, virtual false, abstract: false, final false
inline void ValidateEndStartElement() ;

/// @brief Method ValidateStartElement, addr 0x2ba6fb8, size 0x3dc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ba62f8, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ba60dc, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Schema::BaseValidator*  validator) ;

/// @brief Method get_HasSchema, addr 0x2ba85fc, size 0x24, virtual false, abstract: false, final false
inline bool get_HasSchema() ;

/// @brief Method get_IsInlineSchemaStarted, addr 0x2ba651c, size 0x10, virtual false, abstract: false, final false
inline bool get_IsInlineSchemaStarted() ;

/// @brief Method get_PreserveWhitespace, addr 0x2ba8620, size 0x38, virtual true, abstract: false, final false
