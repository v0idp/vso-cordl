...
/// @brief Method CanReplaceAt, addr 0x2b34dac, size 0x80, virtual false, abstract: false, final false
inline bool CanReplaceAt(int32_t  index) ;

/// @brief Method CreateFallbackBuffer, addr 0x2b34cb8, size 0x64, virtual true, abstract: false, final false
inline ::System::Text::EncoderFallbackBuffer* CreateFallbackBuffer() ;

static inline ::System::Xml::CharEntityEncoderFallback* New_ctor() ;

/// @brief Method Reset, addr 0x2b34da0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b34cb0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_MaxCharCount, addr 0x2b34d90, size 0x8, virtual true, abstract: false, final false
inline int32_t get_MaxCharCount() ;

/// @brief Method set_StartOffset, addr 0x2b34d98, size 0x8, virtual false, abstract: false, final false
