...
public:
// Declarations
/// @brief Method CheckPrefixNS, addr 0x2b313b0, size 0xf8, virtual false, abstract: false, final false
inline void CheckPrefixNS(::StringW  prefix, ::StringW  namespaceUri) ;

/// @brief Method Clear, addr 0x2b2c89c, size 0x54, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Equals, addr 0x2b34718, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method GetHashCode, addr 0x2b34684, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetNSHashCode, addr 0x2b346cc, size 0x4c, virtual false, abstract: false, final false
inline int32_t GetNSHashCode(::System::Xml::SecureStringHasher*  hasher) ;

/// @brief Method MatchNs, addr 0x2b30fcc, size 0x50, virtual false, abstract: false, final false
inline bool MatchNs(::StringW  lname, ::StringW  nsUri) ;

/// @brief Method MatchPrefix, addr 0x2b3101c, size 0x50, virtual false, abstract: false, final false
inline bool MatchPrefix(::StringW  prefix, ::StringW  lname) ;

/// @brief Method Set, addr 0x2b30538, size 0xc, virtual false, abstract: false, final false
inline void Set(::StringW  prefix, ::StringW  lname, ::StringW  nsUri) ;

/// @brief Method ToString, addr 0x2b32188, size 0x70, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2b31678, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  prefix, ::StringW  lname, ::StringW  nsUri) ;

/// @brief Method op_Equality, addr 0x2b347c8, size 0x60, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Clear, addr 0x2b32338, size 0x10, virtual false, abstract: false, final false
inline ::System::Xml::XmlSqlBinaryReader_NamespaceDecl* Clear() ;

/// @brief Method Set, addr 0x2b32f90, size 0x20, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method AdjustPosition, addr 0x2b30914, size 0x14, virtual false, abstract: false, final false
inline void AdjustPosition(int32_t  adj) ;

/// @brief Method GetLocalnameAndNamespaceUri, addr 0x2b32170, size 0x14, virtual false, abstract: false, final false
inline void GetLocalnameAndNamespaceUri(::ByRef<::StringW>  localname, ::ByRef<::StringW>  namespaceUri) ;

/// @brief Method GetLocalnameAndNamespaceUriAndHash, addr 0x2b321f8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method MatchHashNS, addr 0x2b32220, size 0x20, virtual false, abstract: false, final false
inline bool MatchHashNS(int32_t  hash, ::StringW  localname, ::StringW  namespaceUri) ;

/// @brief Method MatchNS, addr 0x2b32184, size 0x4, virtual false, abstract: false, final false
inline bool MatchNS(::StringW  localname, ::StringW  namespaceUri) ;

/// @brief Method Set, addr 0x2b31b54, size 0x1c, virtual false, abstract: false, final false
inline void Set(::System::Xml::XmlSqlBinaryReader_QName  n, int32_t  pos) ;

/// @brief Method Set, addr 0x2b31684, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b3000c, size 0x58, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Init, addr 0x2b2c7d8, size 0xc4, virtual false, abstract: false, final false
inline void Init() ;
...
/// @brief Method .ctor, addr 0x2b32fb0, size 0x44, virtual false, abstract: false, final false
...
// Dependencies System.Xml.BinXmlToken, System.Xml.DtdProcessing, System.Xml.IXmlNamespaceResolver, System.Xml.XmlCharType, System.Xml.XmlNodeType, System.Xml.XmlReader, System.Xml.XmlSqlBinaryReader::QName, System.Xml.XmlSqlBinaryReader::ScanState, System.Xml.XmlSqlBinaryReader::SymbolTables
namespace System::Xml {
// Is value type: false
...
/// @brief Method AddInitNamespace, addr 0x2b2c8f0, size 0xd4, virtual false, abstract: false, final false
inline void AddInitNamespace(::StringW  prefix, ::StringW  uri) ;

/// @brief Method AddName, addr 0x2b30064, size 0x10c, virtual false, abstract: false, final false
inline void AddName() ;

/// @brief Method AddQName, addr 0x2b30234, size 0x278, virtual false, abstract: false, final false
inline void AddQName() ;

/// @brief Method CDATAValue, addr 0x2b2d810, size 0x104, virtual false, abstract: false, final false
inline ::StringW CDATAValue() ;

/// @brief Method CheckAllowContent, addr 0x2b32f28, size 0x68, virtual false, abstract: false, final false
inline void CheckAllowContent() ;

/// @brief Method CheckText, addr 0x2b3309c, size 0x1c4, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType CheckText(bool  attr) ;

/// @brief Method CheckTextIsWS, addr 0x2b33260, size 0x98, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType CheckTextIsWS() ;

/// @brief Method CheckValueTokenBounds, addr 0x2b336f4, size 0x60, virtual false, abstract: false, final false
inline void CheckValueTokenBounds() ;

/// @brief Method ClearAttributes, addr 0x2b31178, size 0x10, virtual false, abstract: false, final false
inline void ClearAttributes() ;

/// @brief Method Close, addr 0x2b2ef78, size 0x6c, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Fill, addr 0x2b3064c, size 0x1c, virtual false, abstract: false, final false
inline void Fill(int32_t  require) ;

/// @brief Method FillAllowEOF, addr 0x2b306f4, size 0x220, virtual false, abstract: false, final false
inline bool FillAllowEOF() ;

/// @brief Method Fill_, addr 0x2b30928, size 0x78, virtual false, abstract: false, final false
inline void Fill_(int32_t  require) ;

/// @brief Method FinishCDATA, addr 0x2b32240, size 0xa4, virtual false, abstract: false, final false
inline void FinishCDATA() ;

/// @brief Method FinishEndElement, addr 0x2b322e4, size 0x54, virtual false, abstract: false, final false
inline void FinishEndElement() ;

/// @brief Method GenerateImpliedXmlnsAttrs, addr 0x2b3154c, size 0x12c, virtual false, abstract: false, final false
inline void GenerateImpliedXmlnsAttrs() ;

/// @brief Method GenerateTokenTypeMap, addr 0x2b2c9c4, size 0xa90, virtual false, abstract: false, final false
inline void GenerateTokenTypeMap() ;

/// @brief Method GetAttribute, addr 0x2b2e7c0, size 0x90, virtual true, abstract: false, final false
inline ::StringW GetAttribute(int32_t  i) ;

/// @brief Method GetAttribute, addr 0x2b2e674, size 0x6c, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name) ;

/// @brief Method GetAttribute, addr 0x2b2e4c4, size 0x128, virtual true, abstract: false, final false
inline ::StringW GetAttribute(::StringW  name, ::StringW  ns) ;

/// @brief Method GetAttributeText, addr 0x2b2e134, size 0x124, virtual false, abstract: false, final false
inline ::StringW GetAttributeText(int32_t  i) ;

/// @brief Method GetDouble, addr 0x2b34110, size 0xd4, virtual false, abstract: false, final false
inline double_t GetDouble(int32_t  offset) ;

/// @brief Method GetInt16, addr 0x2b33a20, size 0x44, virtual false, abstract: false, final false
inline int16_t GetInt16(int32_t  pos) ;

/// @brief Method GetInt32, addr 0x2b33a64, size 0x74, virtual false, abstract: false, final false
inline int32_t GetInt32(int32_t  pos) ;

/// @brief Method GetInt64, addr 0x2b33ad8, size 0xd0, virtual false, abstract: false, final false
inline int64_t GetInt64(int32_t  pos) ;

/// @brief Method GetSingle, addr 0x2b34098, size 0x78, virtual false, abstract: false, final false
inline float_t GetSingle(int32_t  offset) ;

/// @brief Method GetString, addr 0x2b2d6a4, size 0x16c, virtual false, abstract: false, final false
inline ::StringW GetString(int32_t  pos, int32_t  cch) ;

/// @brief Method GetStringAligned, addr 0x2b30fa0, size 0x2c, virtual false, abstract: false, final false
inline ::StringW GetStringAligned(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  offset, int32_t  cch) ;

/// @brief Method GetUInt16, addr 0x2b33ba8, size 0x44, virtual false, abstract: false, final false
inline uint16_t GetUInt16(int32_t  pos) ;

/// @brief Method GetUInt32, addr 0x2b33bec, size 0x74, virtual false, abstract: false, final false
inline uint32_t GetUInt32(int32_t  pos) ;

/// @brief Method GetUInt64, addr 0x2b33c60, size 0xd0, virtual false, abstract: false, final false
inline uint64_t GetUInt64(int32_t  pos) ;

/// @brief Method GetValueType, addr 0x2b2ee8c, size 0xec, virtual false, abstract: false, final false
inline ::System::Type* GetValueType(::System::Xml::BinXmlToken  token) ;

/// @brief Method GetXsdKatmaiTokenLength, addr 0x2b3360c, size 0xe8, virtual false, abstract: false, final false
inline int32_t GetXsdKatmaiTokenLength(::System::Xml::BinXmlToken  token) ;

/// @brief Method GrowAttributes, addr 0x2b310f4, size 0x84, virtual false, abstract: false, final false
inline void GrowAttributes() ;

/// @brief Method GrowElements, addr 0x2b3106c, size 0x88, virtual false, abstract: false, final false
inline void GrowElements() ;

/// @brief Method HashCheckForDuplicateAttributes, addr 0x2b31f34, size 0x23c, virtual false, abstract: false, final false
inline void HashCheckForDuplicateAttributes() ;

/// @brief Method ImplReadCDATA, addr 0x2b32954, size 0x34, virtual false, abstract: false, final false
inline void ImplReadCDATA() ;

/// @brief Method ImplReadComment, addr 0x2b32928, size 0x2c, virtual false, abstract: false, final false
inline void ImplReadComment() ;

/// @brief Method ImplReadData, addr 0x2b32dbc, size 0x16c, virtual false, abstract: false, final false
inline void ImplReadData(::System::Xml::BinXmlToken  tokenType) ;

/// @brief Method ImplReadDoctype, addr 0x2b32658, size 0x26c, virtual false, abstract: false, final false
inline void ImplReadDoctype() ;

/// @brief Method ImplReadElement, addr 0x2b32348, size 0x248, virtual false, abstract: false, final false
inline void ImplReadElement() ;

/// @brief Method ImplReadEndElement, addr 0x2b32590, size 0xc8, virtual false, abstract: false, final false
inline void ImplReadEndElement() ;

/// @brief Method ImplReadEndNest, addr 0x2b32a28, size 0x30, virtual false, abstract: false, final false
inline void ImplReadEndNest() ;

/// @brief Method ImplReadNest, addr 0x2b32988, size 0xa0, virtual false, abstract: false, final false
inline void ImplReadNest() ;

/// @brief Method ImplReadPI, addr 0x2b328c4, size 0x64, virtual false, abstract: false, final false
inline void ImplReadPI() ;

/// @brief Method ImplReadXmlText, addr 0x2b32a58, size 0x364, virtual false, abstract: false, final false
inline void ImplReadXmlText() ;

/// @brief Method LocateAttribute, addr 0x2b2e6e0, size 0xe0, virtual false, abstract: false, final false
inline int32_t LocateAttribute(::StringW  name) ;

/// @brief Method LocateAttribute, addr 0x2b2e5ec, size 0x88, virtual false, abstract: false, final false
inline int32_t LocateAttribute(::StringW  name, ::StringW  ns) ;

/// @brief Method LookupNamespace, addr 0x2b2efec, size 0xb4, virtual true, abstract: false, final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

/// @brief Method MoveToAttribute, addr 0x2b2e850, size 0x7c, virtual true, abstract: false, final false
inline bool MoveToAttribute(::StringW  name) ;

/// @brief Method MoveToAttribute, addr 0x2b2e9a8, size 0xa4, virtual true, abstract: false, final false
inline void MoveToAttribute(int32_t  i) ;

/// @brief Method MoveToElement, addr 0x2b2eb48, size 0xb8, virtual true, abstract: false, final false
inline bool MoveToElement() ;

/// @brief Method MoveToFirstAttribute, addr 0x2b2ea4c, size 0x78, virtual true, abstract: false, final false
inline bool MoveToFirstAttribute() ;

/// @brief Method MoveToNextAttribute, addr 0x2b2eac4, size 0x84, virtual true, abstract: false, final false
inline bool MoveToNextAttribute() ;

/// @brief Method NameFlush, addr 0x2b30544, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method NextToken, addr 0x2b30e5c, size 0x64, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken NextToken() ;

/// @brief Method NextToken1, addr 0x2b30de4, size 0x78, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken NextToken1() ;

/// @brief Method NextToken2, addr 0x2b30d6c, size 0x78, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken NextToken2(::System::Xml::BinXmlToken  token) ;

/// @brief Method ParseMB32, addr 0x2b30620, size 0x2c, virtual false, abstract: false, final false
inline int32_t ParseMB32() ;

/// @brief Method ParseMB32, addr 0x2b30b7c, size 0xec, virtual false, abstract: false, final false
inline int32_t ParseMB32(int32_t  pos) ;

/// @brief Method ParseMB32_, addr 0x2b30ae4, size 0x98, virtual false, abstract: false, final false
inline int32_t ParseMB32_(uint8_t  b) ;

/// @brief Method ParseMB64, addr 0x2b30c68, size 0x2c, virtual false, abstract: false, final false
inline int32_t ParseMB64() ;

/// @brief Method ParseText, addr 0x2b30170, size 0xc4, virtual false, abstract: false, final false
inline ::StringW ParseText() ;

/// @brief Method PeekNextToken, addr 0x2b30ec0, size 0x28, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken PeekNextToken() ;

/// @brief Method PeekToken, addr 0x2b30c94, size 0x68, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken PeekToken() ;

/// @brief Method PopNamespaces, addr 0x2b314a8, size 0xa4, virtual false, abstract: false, final false
inline void PopNamespaces(::System::Xml::XmlSqlBinaryReader_NamespaceDecl*  firstInScopeChain) ;

/// @brief Method PositionOnAttribute, addr 0x2b2e8e8, size 0xc0, virtual false, abstract: false, final false
inline void PositionOnAttribute(int32_t  i) ;

/// @brief Method PushNamespace, addr 0x2b31188, size 0x228, virtual false, abstract: false, final false
inline void PushNamespace(::StringW  prefix, ::StringW  ns, bool  implied) ;

/// @brief Method ReScanOverValue, addr 0x2b2ee80, size 0xc, virtual false, abstract: false, final false
inline void ReScanOverValue(::System::Xml::BinXmlToken  token) ;

/// @brief Method Read, addr 0x2b2f158, size 0x1c8, virtual true, abstract: false, final false
inline bool Read() ;

/// @brief Method ReadAttributeValue, addr 0x2b2ec10, size 0x188, virtual true, abstract: false, final false
inline bool ReadAttributeValue() ;

/// @brief Method ReadByte, addr 0x2b30a14, size 0x5c, virtual false, abstract: false, final false
inline uint8_t ReadByte() ;

/// @brief Method ReadDoc, addr 0x2b2f6dc, size 0x36c, virtual false, abstract: false, final false
inline bool ReadDoc() ;

/// @brief Method ReadInit, addr 0x2b2f320, size 0x3bc, virtual false, abstract: false, final false
inline bool ReadInit(bool  skipXmlDecl) ;

/// @brief Method ReadNameRef, addr 0x2b304ac, size 0x8c, virtual false, abstract: false, final false
inline int32_t ReadNameRef() ;

/// @brief Method ReadQNameRef, addr 0x2b30668, size 0x8c, virtual false, abstract: false, final false
inline int32_t ReadQNameRef() ;

/// @brief Method ReadToken, addr 0x2b30cfc, size 0x70, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken ReadToken() ;

/// @brief Method ReadUShort, addr 0x2b30a70, size 0x74, virtual false, abstract: false, final false
inline uint16_t ReadUShort() ;

/// @brief Method RescanNextToken, addr 0x2b2ed98, size 0xe8, virtual false, abstract: false, final false
inline ::System::Xml::BinXmlToken RescanNextToken() ;

/// @brief Method ResolveEntity, addr 0x2b2f0a0, size 0x38, virtual true, abstract: false, final false
inline void ResolveEntity() ;

/// @brief Method ScanAttributes, addr 0x2b316a0, size 0x4b4, virtual false, abstract: false, final false
inline void ScanAttributes() ;

/// @brief Method ScanOverAnyValue, addr 0x2b332f8, size 0x314, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType ScanOverAnyValue(::System::Xml::BinXmlToken  token, bool  attr, bool  checkChars) ;

/// @brief Method ScanOverValue, addr 0x2b31c3c, size 0x128, virtual false, abstract: false, final false
inline ::System::Xml::XmlNodeType ScanOverValue(::System::Xml::BinXmlToken  token, bool  attr, bool  checkChars) ;

/// @brief Method ScanText, addr 0x2b30ee8, size 0xb8, virtual false, abstract: false, final false
inline int32_t ScanText(::ByRef<int32_t>  start) ;

/// @brief Method SimpleCheckForDuplicateAttributes, addr 0x2b31de8, size 0x14c, virtual false, abstract: false, final false
inline void SimpleCheckForDuplicateAttributes() ;

/// @brief Method SkipExtn, addr 0x2b30594, size 0x8c, virtual false, abstract: false, final false
inline void SkipExtn() ;

/// @brief Method System.Xml.IXmlNamespaceResolver.GetNamespacesInScope, addr 0x2b2fa48, size 0x3a8, virtual true, abstract: false, final true
...
/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix, addr 0x2b2fdf0, size 0x19c, virtual true, abstract: false, final true
inline ::StringW System_Xml_IXmlNamespaceResolver_LookupPrefix(::StringW  namespaceName) ;

/// @brief Method ThrowNotSupported, addr 0x2b31d64, size 0x84, virtual false, abstract: false, final false
inline ::System::Exception* ThrowNotSupported(::StringW  res) ;

/// @brief Method ThrowUnexpectedToken, addr 0x2b2ffc4, size 0x48, virtual false, abstract: false, final false
inline ::System::Exception* ThrowUnexpectedToken(::System::Xml::BinXmlToken  token) ;

/// @brief Method ThrowXmlException, addr 0x2b309a0, size 0x74, virtual false, abstract: false, final false
inline ::System::Exception* ThrowXmlException(::StringW  res) ;

/// @brief Method ThrowXmlException, addr 0x2b31b70, size 0xcc, virtual false, abstract: false, final false
inline ::System::Exception* ThrowXmlException(::StringW  res, ::StringW  arg1, ::StringW  arg2) ;

/// @brief Method UpdateFromTextReader, addr 0x2b2e8cc, size 0x1c, virtual false, abstract: false, final false
inline bool UpdateFromTextReader(bool  needUpdate) ;

/// @brief Method UpdateFromTextReader, addr 0x2b32ff4, size 0xa8, virtual false, abstract: false, final false
inline void UpdateFromTextReader() ;

/// @brief Method ValueAsDateTimeString, addr 0x2b341e4, size 0x324, virtual false, abstract: false, final false
inline ::StringW ValueAsDateTimeString() ;

/// @brief Method ValueAsDecimal, addr 0x2b33e64, size 0x1e4, virtual false, abstract: false, final false
inline ::System::Decimal ValueAsDecimal() ;

/// @brief Method ValueAsDouble, addr 0x2b33d30, size 0x134, virtual false, abstract: false, final false
inline double_t ValueAsDouble() ;

/// @brief Method ValueAsLong, addr 0x2b33828, size 0x1f8, virtual false, abstract: false, final false
inline int64_t ValueAsLong() ;

/// @brief Method ValueAsString, addr 0x2b2da54, size 0x6e0, virtual false, abstract: false, final false
inline ::StringW ValueAsString(::System::Xml::BinXmlToken  token) ;

/// @brief Method ValueAsULong, addr 0x2b34048, size 0x50, virtual false, abstract: false, final false
inline uint64_t ValueAsULong() ;

/// @brief Method VerifyVersion, addr 0x2b2ff8c, size 0x38, virtual false, abstract: false, final false
inline void VerifyVersion(int32_t  requiredVersion, ::System::Xml::BinXmlToken  token) ;

/// @brief Method XmlDeclValue, addr 0x2b2d914, size 0x140, virtual false, abstract: false, final false
inline ::StringW XmlDeclValue() ;

/// @brief Method XsdKatmaiTimeScaleToValueLength, addr 0x2b33754, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b2c334, size 0x4a4, virtual false, abstract: false, final false
...
/// @brief Method get_AttributeCount, addr 0x2b2e470, size 0x54, virtual true, abstract: false, final false
inline int32_t get_AttributeCount() ;

/// @brief Method get_BaseURI, addr 0x2b2e2fc, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_BaseURI() ;

/// @brief Method get_Depth, addr 0x2b2e258, size 0xa4, virtual true, abstract: false, final false
inline int32_t get_Depth() ;

/// @brief Method get_EOF, addr 0x2b2ec00, size 0x10, virtual true, abstract: false, final false
inline bool get_EOF() ;

/// @brief Method get_IsEmptyElement, addr 0x2b2e304, size 0x24, virtual true, abstract: false, final false
inline bool get_IsEmptyElement() ;

/// @brief Method get_LocalName, addr 0x2b2d578, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NameTable, addr 0x2b2efe4, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x2b2d580, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x2b2d570, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x2b2d588, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_ReadState, addr 0x2b2f0d8, size 0x80, virtual true, abstract: false, final false
inline ::System::Xml::ReadState get_ReadState() ;

/// @brief Method get_Settings, addr 0x2b2d454, size 0x11c, virtual true, abstract: false, final false
inline ::System::Xml::XmlReaderSettings* get_Settings() ;

/// @brief Method get_Value, addr 0x2b2d590, size 0x114, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method get_ValueType, addr 0x2b2e468, size 0x8, virtual true, abstract: false, final false
inline ::System::Type* get_ValueType() ;

/// @brief Method get_XmlLang, addr 0x2b2e3a8, size 0xc0, virtual true, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x2b2e328, size 0x80, virtual true, abstract: false, final false
