...
public:
// Declarations
/// @brief Method Convert, addr 0x2c51e3c, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method GetCharCount, addr 0x2c51dc8, size 0x8, virtual true, abstract: false, final false
inline int32_t GetCharCount(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  index, int32_t  count) ;

/// @brief Method GetChars, addr 0x2c51dd0, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetChars(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  byteIndex, int32_t  byteCount, ::ArrayW<char16_t,::Array<char16_t>*>  chars, int32_t  charIndex) ;

static inline ::System::Xml::SafeAsciiDecoder* New_ctor() ;

/// @brief Method .ctor, addr 0x2c51dc0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
