...
/// @brief Method Count, addr 0x2b349c8, size 0x9c, virtual false, abstract: false, final false
static inline int32_t Count(uint32_t  num) ;

/// @brief Method LeastPosition, addr 0x2b34a64, size 0x6c, virtual false, abstract: false, final false
