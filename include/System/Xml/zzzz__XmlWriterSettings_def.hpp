...
/// @brief Method CheckReadOnly, addr 0x2c1f79c, size 0xb4, virtual false, abstract: false, final false
inline void CheckReadOnly(::StringW  propertyName) ;

/// @brief Method Clone, addr 0x2c1fa78, size 0xc8, virtual false, abstract: false, final false
inline ::System::Xml::XmlWriterSettings* Clone() ;

/// @brief Method CreateWriter, addr 0x2c1ee60, size 0x478, virtual false, abstract: false, final false
inline ::System::Xml::XmlWriter* CreateWriter(::System::IO::Stream*  output) ;

/// @brief Method CreateWriter, addr 0x2c1f340, size 0x2fc, virtual false, abstract: false, final false
inline ::System::Xml::XmlWriter* CreateWriter(::System::IO::TextWriter*  output) ;

/// @brief Method Initialize, addr 0x2c1f644, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c1eddc, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Async, addr 0x2c1f724, size 0x8, virtual false, abstract: false, final false
inline bool get_Async() ;

/// @brief Method get_AutoXmlDeclaration, addr 0x2c1fb78, size 0x8, virtual false, abstract: false, final false
inline bool get_AutoXmlDeclaration() ;

/// @brief Method get_CDataSectionElements, addr 0x2c1fb40, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::System::Xml::XmlQualifiedName*>* get_CDataSectionElements() ;

/// @brief Method get_CheckCharacters, addr 0x2c1f9a4, size 0x8, virtual false, abstract: false, final false
inline bool get_CheckCharacters() ;

/// @brief Method get_CloseOutput, addr 0x2c1f8e8, size 0x8, virtual false, abstract: false, final false
inline bool get_CloseOutput() ;

/// @brief Method get_ConformanceLevel, addr 0x2c1f8f0, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::ConformanceLevel get_ConformanceLevel() ;

/// @brief Method get_DoNotEscapeUriAttributes, addr 0x2c1fb48, size 0x8, virtual false, abstract: false, final false
inline bool get_DoNotEscapeUriAttributes() ;

/// @brief Method get_DocTypePublic, addr 0x2c1fb68, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_DocTypePublic() ;

/// @brief Method get_DocTypeSystem, addr 0x2c1fb60, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_DocTypeSystem() ;

/// @brief Method get_Encoding, addr 0x2c1f72c, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::Encoding* get_Encoding() ;

/// @brief Method get_Indent, addr 0x2c1f860, size 0x10, virtual false, abstract: false, final false
inline bool get_Indent() ;

/// @brief Method get_IndentChars, addr 0x2c1f8d8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_IndentChars() ;

/// @brief Method get_IndentInternal, addr 0x2c1fb80, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::TriState get_IndentInternal() ;

/// @brief Method get_IsQuerySpecific, addr 0x2c1fb88, size 0x70, virtual false, abstract: false, final false
inline bool get_IsQuerySpecific() ;

/// @brief Method get_MediaType, addr 0x2c1fb58, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_MediaType() ;

/// @brief Method get_MergeCDataSections, addr 0x2c1fb50, size 0x8, virtual false, abstract: false, final false
inline bool get_MergeCDataSections() ;

/// @brief Method get_NamespaceHandling, addr 0x2c1f9ac, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::NamespaceHandling get_NamespaceHandling() ;

/// @brief Method get_NewLineChars, addr 0x2c1f858, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_NewLineChars() ;

/// @brief Method get_NewLineHandling, addr 0x2c1f850, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::NewLineHandling get_NewLineHandling() ;

/// @brief Method get_NewLineOnAttributes, addr 0x2c1f8e0, size 0x8, virtual false, abstract: false, final false
inline bool get_NewLineOnAttributes() ;

/// @brief Method get_OmitXmlDeclaration, addr 0x2c1f734, size 0x8, virtual false, abstract: false, final false
inline bool get_OmitXmlDeclaration() ;

/// @brief Method get_OutputMethod, addr 0x2c1fa68, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlOutputMethod get_OutputMethod() ;

/// @brief Method get_Standalone, addr 0x2c1fb70, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XmlStandalone get_Standalone() ;

/// @brief Method get_WriteEndDocumentOnClose, addr 0x2c1fa60, size 0x8, virtual false, abstract: false, final false
inline bool get_WriteEndDocumentOnClose() ;

/// @brief Method set_ConformanceLevel, addr 0x2c1f8f8, size 0xac, virtual false, abstract: false, final false
inline void set_ConformanceLevel(::System::Xml::ConformanceLevel  value) ;

/// @brief Method set_Indent, addr 0x2c1f870, size 0x68, virtual false, abstract: false, final false
inline void set_Indent(bool  value) ;

/// @brief Method set_NamespaceHandling, addr 0x2c1f9b4, size 0xac, virtual false, abstract: false, final false
inline void set_NamespaceHandling(::System::Xml::NamespaceHandling  value) ;

/// @brief Method set_OmitXmlDeclaration, addr 0x2c1f73c, size 0x60, virtual false, abstract: false, final false
inline void set_OmitXmlDeclaration(bool  value) ;

/// @brief Method set_OutputMethod, addr 0x2c1fa70, size 0x8, virtual false, abstract: false, final false
inline void set_OutputMethod(::System::Xml::XmlOutputMethod  value) ;

/// @brief Method set_ReadOnly, addr 0x2c1fbf8, size 0xc, virtual false, abstract: false, final false
