...
/// @brief Method Finish, addr 0x2bfe998, size 0x13c, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method MoveToNextContentNode, addr 0x2bfead4, size 0xd8, virtual false, abstract: false, final false
inline bool MoveToNextContentNode(bool  moveIfOnContentNode) ;

/// @brief Method Reset, addr 0x2bfebac, size 0xc, virtual false, abstract: false, final false
inline void Reset() ;
