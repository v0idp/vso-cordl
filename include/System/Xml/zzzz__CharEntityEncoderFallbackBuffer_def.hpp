...
/// @brief Method Fallback, addr 0x2b34e2c, size 0x1f0, virtual true, abstract: false, final false
inline bool Fallback(char16_t  charUnknown, int32_t  index) ;

/// @brief Method Fallback, addr 0x2b3501c, size 0x280, virtual true, abstract: false, final false
inline bool Fallback(char16_t  charUnknownHigh, char16_t  charUnknownLow, int32_t  index) ;

/// @brief Method GetNextChar, addr 0x2b352ac, size 0x58, virtual true, abstract: false, final false
inline char16_t GetNextChar() ;

/// @brief Method MovePrevious, addr 0x2b35304, size 0x1c, virtual true, abstract: false, final false
inline bool MovePrevious() ;

static inline ::System::Xml::CharEntityEncoderFallbackBuffer* New_ctor(::System::Xml::CharEntityEncoderFallback*  parent) ;

/// @brief Method Reset, addr 0x2b35354, size 0xc, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method SurrogateCharToUtf32, addr 0x2b3529c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b34d1c, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::CharEntityEncoderFallback*  parent) ;

/// @brief Method get_Remaining, addr 0x2b35320, size 0x34, virtual true, abstract: false, final false
