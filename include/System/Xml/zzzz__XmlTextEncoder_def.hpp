...
/// @brief Method EndAttribute, addr 0x2c0a3d8, size 0x38, virtual false, abstract: false, final false
inline void EndAttribute() ;

static inline ::System::Xml::XmlTextEncoder* New_ctor(::System::IO::TextWriter*  textWriter) ;

/// @brief Method StartAttribute, addr 0x2c0a340, size 0x98, virtual false, abstract: false, final false
inline void StartAttribute(bool  cacheAttrValue) ;

/// @brief Method Write, addr 0x2c0a538, size 0x420, virtual false, abstract: false, final false
inline void Write(::ArrayW<char16_t,::Array<char16_t>*>  array, int32_t  offset, int32_t  count) ;

/// @brief Method Write, addr 0x2c0abd0, size 0x43c, virtual false, abstract: false, final false
inline void Write(::StringW  text) ;

/// @brief Method WriteCharEntity, addr 0x2c0b3d0, size 0x13c, virtual false, abstract: false, final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteCharEntityImpl, addr 0x2c0a958, size 0x7c, virtual false, abstract: false, final false
inline void WriteCharEntityImpl(char16_t  ch) ;

/// @brief Method WriteCharEntityImpl, addr 0x2c0b50c, size 0x98, virtual false, abstract: false, final false
inline void WriteCharEntityImpl(::StringW  strVal) ;

/// @brief Method WriteEntityRef, addr 0x2c0b5a4, size 0x6c, virtual false, abstract: false, final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteEntityRefImpl, addr 0x2c0a9d4, size 0x70, virtual false, abstract: false, final false
inline void WriteEntityRefImpl(::StringW  name) ;

/// @brief Method WriteRaw, addr 0x2c0b2a4, size 0x12c, virtual false, abstract: false, final false
inline void WriteRaw(::ArrayW<char16_t,::Array<char16_t>*>  array, int32_t  offset, int32_t  count) ;

/// @brief Method WriteRawWithSurrogateChecking, addr 0x2c0b0b4, size 0x1f0, virtual false, abstract: false, final false
inline void WriteRawWithSurrogateChecking(::StringW  text) ;

/// @brief Method WriteStringFragment, addr 0x2c0b00c, size 0xa8, virtual false, abstract: false, final false
inline void WriteStringFragment(::StringW  str, int32_t  offset, int32_t  count, ::ArrayW<char16_t,::Array<char16_t>*>  helperBuffer) ;

/// @brief Method WriteSurrogateChar, addr 0x2c0a484, size 0xb4, virtual false, abstract: false, final false
inline void WriteSurrogateChar(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteSurrogateCharEntity, addr 0x2c0aa44, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2c0a2fc, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::System::IO::TextWriter*  textWriter) ;

/// @brief Method get_AttributeValue, addr 0x2c0a410, size 0x74, virtual false, abstract: false, final false
inline ::StringW get_AttributeValue() ;

/// @brief Method set_QuoteChar, addr 0x2c0a338, size 0x8, virtual false, abstract: false, final false
