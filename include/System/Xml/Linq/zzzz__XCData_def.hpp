...
/// @brief Method CloneNode, addr 0x2b39330, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method WriteTo, addr 0x2b392c0, size 0x70, virtual true, abstract: false, final false
inline void WriteTo(::System::Xml::XmlWriter*  writer) ;

/// @brief Method .ctor, addr 0x2b3923c, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XCData*  other) ;

/// @brief Method .ctor, addr 0x2b391c4, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::StringW  value) ;

/// @brief Method get_NodeType, addr 0x2b392b8, size 0x8, virtual true, abstract: false, final false
