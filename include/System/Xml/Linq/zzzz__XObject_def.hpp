...
/// @brief Method AddAnnotation, addr 0x2b3e7a8, size 0x218, virtual false, abstract: false, final false
...
/// @brief Method AnnotationForSealedType, addr 0x2b40530, size 0x14c, virtual false, abstract: false, final false
inline ::System::Object* AnnotationForSealedType(::System::Type*  type) ;

/// @brief Method GetSaveOptionsFromAnnotations, addr 0x2b3ff58, size 0xe0, virtual false, abstract: false, final false
inline ::System::Xml::Linq::SaveOptions GetSaveOptionsFromAnnotations() ;

static inline ::System::Xml::Linq::XObject* New_ctor() ;

/// @brief Method NotifyChanged, addr 0x2b3aae0, size 0xa8, virtual false, abstract: false, final false
inline bool NotifyChanged(::System::Object*  sender, ::System::Xml::Linq::XObjectChangeEventArgs*  e) ;

/// @brief Method NotifyChanging, addr 0x2b3aa38, size 0xa8, virtual false, abstract: false, final false
inline bool NotifyChanging(::System::Object*  sender, ::System::Xml::Linq::XObjectChangeEventArgs*  e) ;

/// @brief Method SetBaseUri, addr 0x2b3c808, size 0x6c, virtual false, abstract: false, final false
inline void SetBaseUri(::StringW  baseUri) ;

/// @brief Method SetLineInfo, addr 0x2b3c874, size 0x70, virtual false, abstract: false, final false
inline void SetLineInfo(int32_t  lineNumber, int32_t  linePosition) ;

/// @brief Method SkipNotify, addr 0x2b39d7c, size 0x70, virtual false, abstract: false, final false
inline bool SkipNotify() ;

/// @brief Method System.Xml.IXmlLineInfo.HasLineInfo, addr 0x2b4067c, size 0x54, virtual true, abstract: false, final true
inline bool System_Xml_IXmlLineInfo_HasLineInfo() ;

/// @brief Method System.Xml.IXmlLineInfo.get_LineNumber, addr 0x2b406d0, size 0x54, virtual true, abstract: false, final true
inline int32_t System_Xml_IXmlLineInfo_get_LineNumber() ;

/// @brief Method System.Xml.IXmlLineInfo.get_LinePosition, addr 0x2b40724, size 0x54, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2b382e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BaseUri, addr 0x2b3c9a8, size 0x8c, virtual false, abstract: false, final false
inline ::StringW get_BaseUri() ;

/// @brief Method get_HasBaseUri, addr 0x2b3c954, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method get_Parent, addr 0x2b404b4, size 0x7c, virtual false, abstract: false, final false
