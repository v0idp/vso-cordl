...
/// @brief Method CloneNode, addr 0x2b40a70, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method ValidateName, addr 0x2b40898, size 0xd8, virtual false, abstract: false, final false
static inline void ValidateName(::StringW  name) ;

/// @brief Method WriteTo, addr 0x2b40a00, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b40970, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XProcessingInstruction*  other) ;

/// @brief Method .ctor, addr 0x2b3c6f8, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::StringW  target, ::StringW  data) ;

/// @brief Method get_Data, addr 0x2b409e8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Data() ;

/// @brief Method get_NodeType, addr 0x2b409f0, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Target, addr 0x2b409f8, size 0x8, virtual false, abstract: false, final false
