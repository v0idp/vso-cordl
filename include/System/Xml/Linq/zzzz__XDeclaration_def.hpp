...
/// @brief Method ToString, addr 0x2b3cc84, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2b3cbec, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::System::Xml::Linq::XDeclaration*  other) ;

/// @brief Method .ctor, addr 0x2b3cbb0, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  version, ::StringW  encoding, ::StringW  standalone) ;

/// @brief Method get_Encoding, addr 0x2b3cc6c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Encoding() ;

/// @brief Method get_Standalone, addr 0x2b3cc74, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Standalone() ;

/// @brief Method get_Version, addr 0x2b3cc7c, size 0x8, virtual false, abstract: false, final false
