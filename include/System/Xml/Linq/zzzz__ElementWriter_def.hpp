...
public:
// Declarations
/// @brief Method GetPrefixOfNamespace, addr 0x2b3ef70, size 0xfc, virtual false, abstract: false, final false
inline ::StringW GetPrefixOfNamespace(::System::Xml::Linq::XNamespace*  ns, bool  allowDefaultNamespace) ;

/// @brief Method PushAncestors, addr 0x2b3ec90, size 0x128, virtual false, abstract: false, final false
inline void PushAncestors(::System::Xml::Linq::XElement*  e) ;

/// @brief Method PushElement, addr 0x2b3f1e0, size 0xd4, virtual false, abstract: false, final false
inline void PushElement(::System::Xml::Linq::XElement*  e) ;

/// @brief Method WriteElement, addr 0x2b3dae0, size 0x1a0, virtual false, abstract: false, final false
inline void WriteElement(::System::Xml::Linq::XElement*  e) ;

/// @brief Method WriteEndElement, addr 0x2b3ef18, size 0x2c, virtual false, abstract: false, final false
inline void WriteEndElement() ;

/// @brief Method WriteFullEndElement, addr 0x2b3ef44, size 0x2c, virtual false, abstract: false, final false
inline void WriteFullEndElement() ;

/// @brief Method WriteStartElement, addr 0x2b3edb8, size 0x160, virtual false, abstract: false, final false
inline void WriteStartElement(::System::Xml::Linq::XElement*  e) ;

/// @brief Method .ctor, addr 0x2b3dad4, size 0xc, virtual false, abstract: false, final false
