...
/// @brief Method CalcBufferSize, addr 0x2c0952c, size 0x84, virtual false, abstract: false, final false
static inline int32_t CalcBufferSize(::System::IO::Stream*  input) ;

/// @brief Method Close, addr 0x2c07a0c, size 0x4, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Create, addr 0x2c08e30, size 0x90, virtual false, abstract: false, final false
static inline ::System::Xml::XmlReader* Create(::System::IO::Stream*  input, ::System::Xml::XmlReaderSettings*  settings, ::StringW  baseUri) ;

/// @brief Method Create, addr 0x2c09068, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method CreateSqlReader, addr 0x2c09214, size 0x318, virtual false, abstract: false, final false
...
/// @brief Method CreateWriterForInnerOuterXml, addr 0x2c085dc, size 0x74, virtual false, abstract: false, final false
inline ::System::Xml::XmlWriter* CreateWriterForInnerOuterXml(::System::IO::StringWriter*  sw) ;

/// @brief Method Dispose, addr 0x2c00770, size 0x14, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x2c08c98, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method HasValueInternal, addr 0x2c08ce4, size 0x64, virtual false, abstract: false, final false
static inline bool HasValueInternal(::System::Xml::XmlNodeType  nodeType) ;

/// @brief Method IsStartElement, addr 0x2c082a0, size 0x84, virtual true, abstract: false, final false
inline bool IsStartElement(::StringW  localname, ::StringW  ns) ;

/// @brief Method IsTextualNode, addr 0x2c07d54, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method MoveToAttribute, addr 0x2c07940, size 0xcc, virtual true, abstract: false, final false
inline void MoveToAttribute(int32_t  i) ;

/// @brief Method MoveToContent, addr 0x2c07db8, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method ReadElementString, addr 0x2c07f30, size 0x27c, virtual true, abstract: false, final false
inline ::StringW ReadElementString() ;

/// @brief Method ReadEndElement, addr 0x2c081ac, size 0xf4, virtual true, abstract: false, final false
inline void ReadEndElement() ;

/// @brief Method ReadInnerXml, addr 0x2c08324, size 0x2b8, virtual true, abstract: false, final false
inline ::StringW ReadInnerXml() ;

/// @brief Method ReadStartElement, addr 0x2c07e3c, size 0xf4, virtual true, abstract: false, final false
inline void ReadStartElement() ;

/// @brief Method ReadString, addr 0x2c07b80, size 0x1d4, virtual true, abstract: false, final false
inline ::StringW ReadString() ;

/// @brief Method ReadValueChunk, addr 0x2c07b28, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method SetNamespacesFlag, addr 0x2c08b6c, size 0xec, virtual false, abstract: false, final false
inline void SetNamespacesFlag(::System::Xml::XmlTextWriter*  xtw) ;

/// @brief Method Skip, addr 0x2c07a10, size 0x34, virtual true, abstract: false, final false
inline void Skip() ;

/// @brief Method SkipSubtree, addr 0x2c07a44, size 0xd4, virtual false, abstract: false, final false
inline bool SkipSubtree() ;

/// @brief Method WriteAttributeValue, addr 0x2c08650, size 0xd4, virtual false, abstract: false, final false
inline void WriteAttributeValue(::System::Xml::XmlWriter*  xtw) ;

/// @brief Method WriteNode, addr 0x2c08724, size 0x448, virtual false, abstract: false, final false
inline void WriteNode(::System::Xml::XmlWriter*  xtw, bool  defattr) ;

/// @brief Method .ctor, addr 0x2bffd14, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_CanReadValueChunk, addr 0x2c07b20, size 0x8, virtual true, abstract: false, final false
inline bool get_CanReadValueChunk() ;

/// @brief Method get_CanResolveEntity, addr 0x2c07b18, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_DtdInfo, addr 0x2c08e28, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_HasAttributes, addr 0x2c08c74, size 0x24, virtual true, abstract: false, final false
inline bool get_HasAttributes() ;

/// @brief Method get_IsDefault, addr 0x2c0782c, size 0x8, virtual true, abstract: false, final false
inline bool get_IsDefault() ;

/// @brief Method get_IsDefaultInternal, addr 0x2c08d48, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method get_Name, addr 0x2c07748, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method get_NamespaceManager, addr 0x2c08cdc, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_QuoteChar, addr 0x2c07834, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_SchemaInfo, addr 0x2c0788c, size 0x48, virtual true, abstract: false, final false
inline ::System::Xml::Schema::IXmlSchemaInfo* get_SchemaInfo() ;

/// @brief Method get_Settings, addr 0x2c07740, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_ValueType, addr 0x2c078d4, size 0x6c, virtual true, abstract: false, final false
inline ::System::Type* get_ValueType() ;

/// @brief Method get_XmlLang, addr 0x2c07844, size 0x48, virtual true, abstract: false, final false
inline ::StringW get_XmlLang() ;

/// @brief Method get_XmlSpace, addr 0x2c0783c, size 0x8, virtual true, abstract: false, final false
