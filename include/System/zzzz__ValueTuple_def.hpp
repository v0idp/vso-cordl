...
// Dependencies System.Collections.IStructuralComparable, System.Collections.IStructuralEquatable, System.IComparable, System.IComparable`1<T>, System.IEquatable`1<T>, System.IValueTupleInternal, System.Runtime.CompilerServices.ITuple
namespace System {
// Is value type: true
...
/// @brief Method CombineHashCodes, addr 0x276467c, size 0x7c, virtual false, abstract: false, final false
static inline int32_t CombineHashCodes(int32_t  h1, int32_t  h2) ;

/// @brief Method CombineHashCodes, addr 0x27646f8, size 0x80, virtual false, abstract: false, final false
static inline int32_t CombineHashCodes(int32_t  h1, int32_t  h2, int32_t  h3) ;

/// @brief Method CombineHashCodes, addr 0x2764778, size 0x90, virtual false, abstract: false, final false
static inline int32_t CombineHashCodes(int32_t  h1, int32_t  h2, int32_t  h3, int32_t  h4) ;

/// @brief Method CombineHashCodes, addr 0x2764808, size 0x98, virtual false, abstract: false, final false
static inline int32_t CombineHashCodes(int32_t  h1, int32_t  h2, int32_t  h3, int32_t  h4, int32_t  h5) ;

/// @brief Method CombineHashCodes, addr 0x27648a0, size 0xa8, virtual false, abstract: false, final false
static inline int32_t CombineHashCodes(int32_t  h1, int32_t  h2, int32_t  h3, int32_t  h4, int32_t  h5, int32_t  h6) ;

/// @brief Method CombineHashCodes, addr 0x2764948, size 0xb0, virtual false, abstract: false, final false
static inline int32_t CombineHashCodes(int32_t  h1, int32_t  h2, int32_t  h3, int32_t  h4, int32_t  h5, int32_t  h6, int32_t  h7) ;

/// @brief Method CombineHashCodes, addr 0x27649f8, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method CompareTo, addr 0x27644c0, size 0x8, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::ValueTuple  other) ;

/// @brief Method Equals, addr 0x27642ec, size 0x5c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2764348, size 0x8, virtual true, abstract: false, final true
inline bool Equals(::System::ValueTuple  other) ;

/// @brief Method GetHashCode, addr 0x27645dc, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method System.Collections.IStructuralComparable.CompareTo, addr 0x27644c8, size 0x114, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IStructuralEquatable.Equals, addr 0x2764350, size 0x5c, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IStructuralEquatable.GetHashCode, addr 0x27645e4, size 0x8, virtual true, abstract: false, final true
inline int32_t System_Collections_IStructuralEquatable_GetHashCode(::System::Collections::IEqualityComparer*  comparer) ;

/// @brief Method System.IComparable.CompareTo, addr 0x27643ac, size 0x114, virtual true, abstract: false, final true
inline int32_t System_IComparable_CompareTo(::System::Object*  other) ;

/// @brief Method System.IValueTupleInternal.GetHashCode, addr 0x27645ec, size 0x8, virtual true, abstract: false, final true
inline int32_t System_IValueTupleInternal_GetHashCode(::System::Collections::IEqualityComparer*  comparer) ;

/// @brief Method System.IValueTupleInternal.ToStringEnd, addr 0x2764634, size 0x40, virtual true, abstract: false, final true
inline ::StringW System_IValueTupleInternal_ToStringEnd() ;

/// @brief Method System.Runtime.CompilerServices.ITuple.get_Length, addr 0x2764674, size 0x8, virtual true, abstract: false, final true
inline int32_t System_Runtime_CompilerServices_ITuple_get_Length() ;

/// @brief Method ToString, addr 0x27645f4, size 0x40, virtual true, abstract: false, final false
