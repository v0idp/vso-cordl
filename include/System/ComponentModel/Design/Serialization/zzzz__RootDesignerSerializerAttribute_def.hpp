...
/// @brief Method .ctor, addr 0x2d46378, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(::StringW  serializerTypeName, ::StringW  baseSerializerTypeName, bool  reloadable) ;

/// @brief Method get_SerializerBaseTypeName, addr 0x2d463b4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SerializerBaseTypeName() ;

/// @brief Method get_TypeId, addr 0x2d463bc, size 0x8c, virtual true, abstract: false, final false
