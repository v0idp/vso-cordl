...
/// @brief Method get_PropertyName, addr 0x2d267dc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_PropertyName() ;

/// @brief Method get_ReceiverTypeName, addr 0x2d267e4, size 0x8, virtual false, abstract: false, final false
