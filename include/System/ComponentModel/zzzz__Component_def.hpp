...
/// @brief Method Dispose, addr 0x2d29f68, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x2d29fd4, size 0x2fc, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x2d29eb8, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetService, addr 0x2d2a2d0, size 0xb4, virtual true, abstract: false, final false
inline ::System::Object* GetService(::System::Type*  service) ;

static inline ::System::ComponentModel::Component* New_ctor() ;

/// @brief Method ToString, addr 0x2d2a434, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d2a564, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Object* getStaticF_EventDisposed() ;

/// @brief Method get_CanRaiseEvents, addr 0x2d29f58, size 0x8, virtual true, abstract: false, final false
inline bool get_CanRaiseEvents() ;

/// @brief Method get_CanRaiseEventsInternal, addr 0x2d144d0, size 0xc, virtual false, abstract: false, final false
inline bool get_CanRaiseEventsInternal() ;

/// @brief Method get_DesignMode, addr 0x2d2a384, size 0xb0, virtual false, abstract: false, final false
inline bool get_DesignMode() ;

/// @brief Method get_Site, addr 0x2d29f60, size 0x8, virtual true, abstract: false, final false
