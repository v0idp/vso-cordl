...
/// @brief Method .ctor, addr 0x2d28f5c, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName) ;

/// @brief Method get_TypeName, addr 0x2d28fd0, size 0x8, virtual false, abstract: false, final false
