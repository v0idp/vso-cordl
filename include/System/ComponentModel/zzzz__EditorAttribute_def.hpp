...
/// @brief Method Equals, addr 0x2d1e6ec, size 0xa4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x2d1e790, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d1e5c0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::StringW  typeName, ::StringW  baseTypeName) ;

/// @brief Method get_EditorBaseTypeName, addr 0x2d1e650, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_EditorBaseTypeName() ;

/// @brief Method get_EditorTypeName, addr 0x2d1e658, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_EditorTypeName() ;

/// @brief Method get_TypeId, addr 0x2d1e660, size 0x8c, virtual true, abstract: false, final false
