...
public:
// Declarations
/// @brief Method ClearWithReferences, addr 0x275b200, size 0x150, virtual false, abstract: false, final false
static inline void ClearWithReferences(::ByRef<::System::IntPtr>  ip, uint64_t  pointerSizeLength) ;

/// @brief Method ClearWithoutReferences, addr 0x275b018, size 0x1e8, virtual false, abstract: false, final false
static inline void ClearWithoutReferences(::ByRef<uint8_t>  b, uint64_t  byteLength) ;

/// @brief Method EndsWithCultureHelper, addr 0x275acdc, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method EndsWithCultureIgnoreCaseHelper, addr 0x275ae14, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method EndsWithOrdinalIgnoreCaseHelper, addr 0x275af34, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method IndexOf, addr 0x2759d44, size 0x5f0, virtual false, abstract: false, final false
static inline int32_t IndexOf(::ByRef<char16_t>  searchSpace, char16_t  value, int32_t  length) ;

/// @brief Method IndexOf, addr 0x27593ec, size 0x2a8, virtual false, abstract: false, final false
...
/// @brief Method IndexOfAny, addr 0x275936c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method LastIndexOf, addr 0x275a334, size 0x5a4, virtual false, abstract: false, final false
static inline int32_t LastIndexOf(::ByRef<char16_t>  searchSpace, char16_t  value, int32_t  length) ;

/// @brief Method LocateFirstFoundChar, addr 0x275a8d8, size 0x1dc, virtual false, abstract: false, final false
static inline int32_t LocateFirstFoundChar(::System::Numerics::Vector_1<uint16_t>  match) ;

/// @brief Method LocateFirstFoundChar, addr 0x275aab4, size 0x20, virtual false, abstract: false, final false
static inline int32_t LocateFirstFoundChar(uint64_t  match) ;

/// @brief Method LocateLastFoundChar, addr 0x275aad4, size 0x1dc, virtual false, abstract: false, final false
static inline int32_t LocateLastFoundChar(::System::Numerics::Vector_1<uint16_t>  match) ;

/// @brief Method LocateLastFoundChar, addr 0x275acb0, size 0x2c, virtual false, abstract: false, final false
static inline int32_t LocateLastFoundChar(uint64_t  match) ;

/// @brief Method SequenceCompareTo, addr 0x2759804, size 0x540, virtual false, abstract: false, final false
...
/// @brief Method SequenceEqual, addr 0x2759694, size 0x170, virtual false, abstract: false, final false
