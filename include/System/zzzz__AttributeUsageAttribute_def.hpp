...
/// @brief Method .ctor, addr 0x26d13dc, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::System::AttributeTargets  validOn) ;

static inline ::System::AttributeUsageAttribute* getStaticF_Default() ;

/// @brief Method get_AllowMultiple, addr 0x26d1414, size 0x8, virtual false, abstract: false, final false
inline bool get_AllowMultiple() ;

/// @brief Method get_Inherited, addr 0x26d1428, size 0x8, virtual false, abstract: false, final false
inline bool get_Inherited() ;

static inline void setStaticF_Default(::System::AttributeUsageAttribute*  value) ;

/// @brief Method set_AllowMultiple, addr 0x26d141c, size 0xc, virtual false, abstract: false, final false
inline void set_AllowMultiple(bool  value) ;

/// @brief Method set_Inherited, addr 0x26d1430, size 0xc, virtual false, abstract: false, final false
