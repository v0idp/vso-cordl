...
public:
// Declarations
/// @brief Method DeserializeSection, addr 0x298560c, size 0x38, virtual true, abstract: false, final false
inline void DeserializeSection(::System::Xml::XmlReader*  reader) ;

/// @brief Method IsModified, addr 0x2985644, size 0x38, virtual true, abstract: false, final false
inline bool IsModified() ;

/// @brief Method ResetModified, addr 0x298567c, size 0x38, virtual true, abstract: false, final false
inline void ResetModified() ;

/// @brief Method SerializeSection, addr 0x29856b4, size 0x38, virtual true, abstract: false, final false
