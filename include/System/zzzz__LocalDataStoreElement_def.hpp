...
/// @brief Method .ctor, addr 0x276e4a4, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int64_t  cookie) ;

/// @brief Method get_Cookie, addr 0x276e4dc, size 0x8, virtual false, abstract: false, final false
inline int64_t get_Cookie() ;

/// @brief Method get_Value, addr 0x276e4cc, size 0x8, virtual false, abstract: false, final false
inline ::System::Object* get_Value() ;

/// @brief Method set_Value, addr 0x276e4d4, size 0x8, virtual false, abstract: false, final false
