...
public:
// Declarations
/// @brief Method BlockCopy, addr 0x2772968, size 0x1a8, virtual false, abstract: false, final false
static inline void BlockCopy(::System::Array*  src, int32_t  srcOffset, ::System::Array*  dst, int32_t  dstOffset, int32_t  count) ;

/// @brief Method ByteLength, addr 0x27728d4, size 0x94, virtual false, abstract: false, final false
static inline int32_t ByteLength(::System::Array*  array) ;

/// @brief Method IndexOfByte, addr 0x2772620, size 0x118, virtual false, abstract: false, final false
static inline int32_t IndexOfByte(::cordl_internals::Ptr<uint8_t>  src, uint8_t  value, int32_t  index, int32_t  count) ;

/// @brief Method InternalBlockCopy, addr 0x277261c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method InternalMemcpy, addr 0x27728d0, size 0x4, virtual false, abstract: false, final false
static inline void InternalMemcpy(::cordl_internals::Ptr<uint8_t>  dest, ::cordl_internals::Ptr<uint8_t>  src, int32_t  count) ;

/// @brief Method Memcpy, addr 0x27727f0, size 0xe0, virtual false, abstract: false, final false
static inline void Memcpy(::cordl_internals::Ptr<uint8_t>  dest, ::cordl_internals::Ptr<uint8_t>  src, int32_t  len) ;

/// @brief Method Memcpy, addr 0x27727c0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method Memmove, addr 0x2772b9c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method MemoryCopy, addr 0x2772b10, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method ZeroMemory, addr 0x277273c, size 0x84, virtual false, abstract: false, final false
static inline void ZeroMemory(::cordl_internals::Ptr<uint8_t>  src, int64_t  len) ;

/// @brief Method _ByteLength, addr 0x2772738, size 0x4, virtual false, abstract: false, final false
static inline int32_t _ByteLength(::System::Array*  array) ;

/// @brief Method memcpy1, addr 0x2772cac, size 0x9c, virtual false, abstract: false, final false
static inline void memcpy1(::cordl_internals::Ptr<uint8_t>  dest, ::cordl_internals::Ptr<uint8_t>  src, int32_t  size) ;

/// @brief Method memcpy2, addr 0x2772c40, size 0x6c, virtual false, abstract: false, final false
static inline void memcpy2(::cordl_internals::Ptr<uint8_t>  dest, ::cordl_internals::Ptr<uint8_t>  src, int32_t  size) ;

/// @brief Method memcpy4, addr 0x2772bc4, size 0x7c, virtual false, abstract: false, final false
