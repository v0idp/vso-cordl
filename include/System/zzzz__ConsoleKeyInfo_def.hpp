...
/// @brief Method Equals, addr 0x2765fbc, size 0x34, virtual false, abstract: false, final false
inline bool Equals(::System::ConsoleKeyInfo  obj) ;

/// @brief Method Equals, addr 0x2765f24, size 0x98, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetHashCode, addr 0x2765ff0, size 0x14, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x2765e78, size 0x9c, virtual false, abstract: false, final false
inline void _ctor(char16_t  keyChar, ::System::ConsoleKey  key, bool  shift, bool  alt, bool  control) ;

/// @brief Method get_Key, addr 0x2765f1c, size 0x8, virtual false, abstract: false, final false
inline ::System::ConsoleKey get_Key() ;

/// @brief Method get_KeyChar, addr 0x2765f14, size 0x8, virtual false, abstract: false, final false
