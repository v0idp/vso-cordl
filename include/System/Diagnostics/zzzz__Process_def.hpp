...
constexpr Process_ProcInfo(::System::IntPtr  process_handle, int32_t  pid, ::ArrayW<::StringW,::Array<::StringW>*>  envVariables, ::StringW  UserName, ::StringW  Domain, ::System::IntPtr  Password, bool  LoadUserProfile) noexcept;
...
/// @brief Method Close, addr 0x2cfc840, size 0x158, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method CompletionCallback, addr 0x2cfc6c8, size 0x18, virtual false, abstract: false, final false
inline void CompletionCallback(::System::Object*  context, bool  wasSignaled) ;

/// @brief Method CreatePipe, addr 0x2cfee10, size 0x1b0, virtual false, abstract: false, final false
static inline void CreatePipe(::ByRef<::System::IntPtr>  read, ::ByRef<::System::IntPtr>  write, bool  writeDirection) ;

/// @brief Method CreateProcess_internal, addr 0x2cfec90, size 0x4, virtual false, abstract: false, final false
static inline bool CreateProcess_internal(::System::Diagnostics::ProcessStartInfo*  startInfo, ::System::IntPtr  stdin, ::System::IntPtr  stdout, ::System::IntPtr  stderr, ::ByRef<::System::Diagnostics::Process_ProcInfo>  procInfo) ;

/// @brief Method Dispose, addr 0x2cfc7f0, size 0x50, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EnsureState, addr 0x2cfb770, size 0x128, virtual false, abstract: false, final false
inline void EnsureState(::System::Diagnostics::Process_State  state) ;

/// @brief Method EnsureWatchingForExit, addr 0x2cfc9ac, size 0x20c, virtual false, abstract: false, final false
inline void EnsureWatchingForExit() ;

/// @brief Method FillUserInfo, addr 0x2cfece8, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method GetCurrentProcess, addr 0x2cfcd94, size 0x80, virtual false, abstract: false, final false
static inline ::System::Diagnostics::Process* GetCurrentProcess() ;

/// @brief Method GetProcessById, addr 0x2cfcbb8, size 0x48, virtual false, abstract: false, final false
static inline ::System::Diagnostics::Process* GetProcessById(int32_t  processId) ;

/// @brief Method GetProcessById, addr 0x2cfcc00, size 0x194, virtual false, abstract: false, final false
static inline ::System::Diagnostics::Process* GetProcessById(int32_t  processId, ::StringW  machineName) ;

/// @brief Method GetProcessHandle, addr 0x2cfd050, size 0x8, virtual false, abstract: false, final false
inline ::Microsoft::Win32::SafeHandles::SafeProcessHandle* GetProcessHandle(int32_t  access) ;

/// @brief Method GetProcessHandle, addr 0x2cfbbf4, size 0x490, virtual false, abstract: false, final false
inline ::Microsoft::Win32::SafeHandles::SafeProcessHandle* GetProcessHandle(int32_t  access, bool  throwIfExited) ;

/// @brief Method GetProcess_internal, addr 0x2cfebf8, size 0x4, virtual false, abstract: false, final false
static inline ::System::IntPtr GetProcess_internal(int32_t  pid) ;

/// @brief Method IsLocalMachine, addr 0x2cfebfc, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method OnExited, addr 0x2cfce14, size 0x23c, virtual false, abstract: false, final false
inline void OnExited() ;

/// @brief Method OpenProcessHandle, addr 0x2cfc1e8, size 0xb4, virtual false, abstract: false, final false
inline ::Microsoft::Win32::SafeHandles::SafeProcessHandle* OpenProcessHandle(int32_t  access) ;

/// @brief Method ProcessName_icall, addr 0x2cfeb04, size 0x4, virtual false, abstract: false, final false
static inline ::StringW ProcessName_icall(::System::IntPtr  handle) ;

/// @brief Method ProcessName_internal, addr 0x2cfeb08, size 0xf0, virtual false, abstract: false, final false
static inline ::StringW ProcessName_internal(::Microsoft::Win32::SafeHandles::SafeProcessHandle*  handle) ;

/// @brief Method RaiseOnExited, addr 0x2cfc0dc, size 0xdc, virtual false, abstract: false, final false
inline void RaiseOnExited() ;

/// @brief Method Refresh, addr 0x2cfc998, size 0x14, virtual false, abstract: false, final false
inline void Refresh() ;

/// @brief Method ReleaseProcessHandle, addr 0x2cfc6a0, size 0x28, virtual false, abstract: false, final false
inline void ReleaseProcessHandle(::Microsoft::Win32::SafeHandles::SafeProcessHandle*  handle) ;

/// @brief Method SetProcessHandle, addr 0x2cfd058, size 0x1c, virtual false, abstract: false, final false
inline void SetProcessHandle(::Microsoft::Win32::SafeHandles::SafeProcessHandle*  processHandle) ;

/// @brief Method SetProcessId, addr 0x2cfd074, size 0x10, virtual false, abstract: false, final false
inline void SetProcessId(int32_t  processId) ;

/// @brief Method ShellExecuteEx_internal, addr 0x2cfec8c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x2cfd084, size 0xf4, virtual false, abstract: false, final false
inline bool Start() ;

/// @brief Method StartWithCreateProcess, addr 0x2cfd53c, size 0x11ac, virtual false, abstract: false, final false
inline bool StartWithCreateProcess(::System::Diagnostics::ProcessStartInfo*  startInfo) ;

/// @brief Method StartWithShellExecuteEx, addr 0x2cfd1cc, size 0x370, virtual false, abstract: false, final false
inline bool StartWithShellExecuteEx(::System::Diagnostics::ProcessStartInfo*  startInfo) ;

/// @brief Method StopWatchingForExit, addr 0x2cfc6e0, size 0x110, virtual false, abstract: false, final false
inline void StopWatchingForExit() ;

/// @brief Method ToString, addr 0x2cfe6e8, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cfb500, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2cfea74, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::Microsoft::Win32::SafeHandles::SafeProcessHandle*  handle, int32_t  id) ;

/// @brief Method .ctor, addr 0x2cfb588, size 0xa0, virtual false, abstract: false, final false
inline void _ctor(::StringW  machineName, bool  isRemoteMachine, int32_t  processId, ::System::Diagnostics::ProcessInfo*  processInfo) ;

/// @brief Method get_Associated, addr 0x2cfb628, size 0x20, virtual false, abstract: false, final false
inline bool get_Associated() ;

/// @brief Method get_ExitCode, addr 0x2cfb648, size 0x128, virtual false, abstract: false, final false
inline int32_t get_ExitCode() ;

/// @brief Method get_Handle, addr 0x2cfc1b8, size 0x30, virtual false, abstract: false, final false
inline ::System::IntPtr get_Handle() ;

/// @brief Method get_HasExited, addr 0x2cfb898, size 0x35c, virtual false, abstract: false, final false
inline bool get_HasExited() ;

/// @brief Method get_IsWindows, addr 0x2cfefc0, size 0x34, virtual false, abstract: false, final false
static inline bool get_IsWindows() ;

/// @brief Method get_ProcessName, addr 0x2cfe854, size 0x220, virtual false, abstract: false, final false
inline ::StringW get_ProcessName() ;

/// @brief Method get_StandardError, addr 0x2cfc60c, size 0x94, virtual false, abstract: false, final false
inline ::System::IO::StreamReader* get_StandardError() ;

/// @brief Method get_StandardOutput, addr 0x2cfc578, size 0x94, virtual false, abstract: false, final false
inline ::System::IO::StreamReader* get_StandardOutput() ;

/// @brief Method get_StartInfo, addr 0x2cfc29c, size 0x64, virtual false, abstract: false, final false
inline ::System::Diagnostics::ProcessStartInfo* get_StartInfo() ;

/// @brief Method get_SynchronizingObject, addr 0x2cfc3d8, size 0x1a0, virtual false, abstract: false, final false
inline ::System::ComponentModel::ISynchronizeInvoke* get_SynchronizingObject() ;

/// @brief Method set_StartInfo, addr 0x2cfc37c, size 0x5c, virtual false, abstract: false, final false
