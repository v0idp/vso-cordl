...
/// @brief Method AddFrames, addr 0x2712d60, size 0x4b0, virtual false, abstract: false, final false
inline bool AddFrames(::System::Text::StringBuilder*  sb, bool  separator, ::ByRef<bool>  isAsync) ;

/// @brief Method ConvertAsyncStateMachineMethod, addr 0x271383c, size 0x45c, virtual false, abstract: false, final false
...
/// @brief Method GetAotId, addr 0x2712c98, size 0xc8, virtual false, abstract: false, final false
static inline ::StringW GetAotId() ;

/// @brief Method GetFrame, addr 0x2712c38, size 0x60, virtual true, abstract: false, final false
inline ::System::Diagnostics::StackFrame* GetFrame(int32_t  index) ;

/// @brief Method GetFullNameForStackTrace, addr 0x2713210, size 0x62c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2713c98, size 0x160, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2713df8, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2712894, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2712b2c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::Exception*  e, bool  fNeedFileInfo) ;

/// @brief Method .ctor, addr 0x2712b38, size 0xe8, virtual false, abstract: false, final false
inline void _ctor(::System::Exception*  e, int32_t  skipFrames, bool  fNeedFileInfo) ;

/// @brief Method .ctor, addr 0x2712ac0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(bool  fNeedFileInfo) ;

/// @brief Method .ctor, addr 0x2712af0, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method get_FrameCount, addr 0x2712c20, size 0x18, virtual true, abstract: false, final false
inline int32_t get_FrameCount() ;

/// @brief Method get_trace, addr 0x2712b24, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method init_frames, addr 0x27128b8, size 0x208, virtual false, abstract: false, final false
