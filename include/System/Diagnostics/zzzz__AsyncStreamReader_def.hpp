...
/// @brief Method CancelOperation, addr 0x2cfb4f4, size 0xc, virtual false, abstract: false, final false
inline void CancelOperation() ;

/// @brief Method Close, addr 0x2cfb174, size 0x10, virtual true, abstract: false, final false
inline void Close() ;

/// @brief Method Dispose, addr 0x2cfb184, size 0x370, virtual true, abstract: false, final false
