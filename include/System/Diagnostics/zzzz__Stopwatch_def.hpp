...
/// @brief Method GetTimestamp, addr 0x2cff978, size 0x4, virtual false, abstract: false, final false
static inline int64_t GetTimestamp() ;

static inline ::System::Diagnostics::Stopwatch* New_ctor() ;

/// @brief Method Restart, addr 0x2cffd10, size 0x60, virtual false, abstract: false, final false
inline void Restart() ;

/// @brief Method Start, addr 0x2cffc30, size 0x68, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Stop, addr 0x2cffc98, size 0x78, virtual false, abstract: false, final false
inline void Stop() ;
...
/// @brief Method .ctor, addr 0x2cff97c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Elapsed, addr 0x2cff984, size 0xf8, virtual false, abstract: false, final false
inline ::System::TimeSpan get_Elapsed() ;

/// @brief Method get_ElapsedMilliseconds, addr 0x2cffaec, size 0x144, virtual false, abstract: false, final false
inline int64_t get_ElapsedMilliseconds() ;

/// @brief Method get_ElapsedTicks, addr 0x2cffa7c, size 0x70, virtual false, abstract: false, final false
