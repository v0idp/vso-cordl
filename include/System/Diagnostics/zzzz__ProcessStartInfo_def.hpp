...
/// @brief Method .ctor, addr 0x2cff694, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2cfc300, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::System::Diagnostics::Process*  parent) ;

static inline ::ArrayW<::StringW,::Array<::StringW>*> getStaticF_empty() ;

/// @brief Method get_ArgumentList, addr 0x2cff520, size 0x78, virtual false, abstract: false, final false
inline ::System::Collections::ObjectModel::Collection_1<::StringW>* get_ArgumentList() ;

/// @brief Method get_Arguments, addr 0x2cff598, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_Arguments() ;

/// @brief Method get_Domain, addr 0x2cff640, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_Domain() ;

/// @brief Method get_EnvironmentVariables, addr 0x2cff004, size 0x51c, virtual false, abstract: false, final false
inline ::System::Collections::Specialized::StringDictionary* get_EnvironmentVariables() ;

/// @brief Method get_FileName, addr 0x2cfd178, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_FileName() ;

/// @brief Method get_HaveEnvVars, addr 0x2cfeff4, size 0x10, virtual false, abstract: false, final false
inline bool get_HaveEnvVars() ;

/// @brief Method get_LoadUserProfile, addr 0x2cff714, size 0x8, virtual false, abstract: false, final false
inline bool get_LoadUserProfile() ;

/// @brief Method get_Password, addr 0x2cff70c, size 0x8, virtual false, abstract: false, final false
inline ::System::Security::SecureString* get_Password() ;

/// @brief Method get_RedirectStandardError, addr 0x2cff6d4, size 0x8, virtual false, abstract: false, final false
inline bool get_RedirectStandardError() ;

/// @brief Method get_RedirectStandardInput, addr 0x2cff6ac, size 0x8, virtual false, abstract: false, final false
inline bool get_RedirectStandardInput() ;

/// @brief Method get_RedirectStandardOutput, addr 0x2cff6c0, size 0x8, virtual false, abstract: false, final false
inline bool get_RedirectStandardOutput() ;

/// @brief Method get_StandardErrorEncoding, addr 0x2cff6e8, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::Encoding* get_StandardErrorEncoding() ;

/// @brief Method get_StandardInputEncoding, addr 0x2cff898, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::Encoding* get_StandardInputEncoding() ;

/// @brief Method get_StandardOutputEncoding, addr 0x2cff6f0, size 0x8, virtual false, abstract: false, final false
inline ::System::Text::Encoding* get_StandardOutputEncoding() ;

/// @brief Method get_UseShellExecute, addr 0x2cff6f8, size 0x8, virtual false, abstract: false, final false
inline bool get_UseShellExecute() ;

/// @brief Method get_UserName, addr 0x2cfec94, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_UserName() ;

/// @brief Method get_WorkingDirectory, addr 0x2cff5ec, size 0x54, virtual false, abstract: false, final false
inline ::StringW get_WorkingDirectory() ;

static inline void setStaticF_empty(::ArrayW<::StringW,::Array<::StringW>*>  value) ;

/// @brief Method set_Arguments, addr 0x2cff6a4, size 0x8, virtual false, abstract: false, final false
inline void set_Arguments(::StringW  value) ;

/// @brief Method set_FileName, addr 0x2cff71c, size 0x8, virtual false, abstract: false, final false
inline void set_FileName(::StringW  value) ;

/// @brief Method set_RedirectStandardError, addr 0x2cff6dc, size 0xc, virtual false, abstract: false, final false
inline void set_RedirectStandardError(bool  value) ;

/// @brief Method set_RedirectStandardInput, addr 0x2cff6b4, size 0xc, virtual false, abstract: false, final false
inline void set_RedirectStandardInput(bool  value) ;

/// @brief Method set_RedirectStandardOutput, addr 0x2cff6c8, size 0xc, virtual false, abstract: false, final false
inline void set_RedirectStandardOutput(bool  value) ;

/// @brief Method set_UseShellExecute, addr 0x2cff700, size 0xc, virtual false, abstract: false, final false
inline void set_UseShellExecute(bool  value) ;

/// @brief Method set_WindowStyle, addr 0x2cff724, size 0x174, virtual false, abstract: false, final false
