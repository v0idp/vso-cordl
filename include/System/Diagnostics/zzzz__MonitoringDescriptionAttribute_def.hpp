...
/// @brief Method .ctor, addr 0x2cff908, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::StringW  description) ;

/// @brief Method get_Description, addr 0x2cff970, size 0x8, virtual true, abstract: false, final false
