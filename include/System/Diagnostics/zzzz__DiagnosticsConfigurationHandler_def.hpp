...
/// @brief Method Create, addr 0x2cd6f88, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2cd6f50, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;
