...
/// @brief Method set_DataPointer, addr 0x2714638, size 0x8, virtual false, abstract: false, final false
inline void set_DataPointer(::System::IntPtr  value) ;

/// @brief Method set_Reserved, addr 0x2714648, size 0x8, virtual false, abstract: false, final false
inline void set_Reserved(int32_t  value) ;

/// @brief Method set_Size, addr 0x2714640, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x2713f90, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x2713ffc, size 0x4, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x2713ed8, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method IsEnabled, addr 0x2713f80, size 0x8, virtual false, abstract: false, final false
inline bool IsEnabled() ;

/// @brief Method IsEnabled, addr 0x2713f88, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method WriteEvent, addr 0x27140c0, size 0x8c, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, ::StringW  arg1) ;

/// @brief Method WriteEvent, addr 0x2714548, size 0xec, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, ::StringW  arg1, ::StringW  arg2, ::StringW  arg3) ;

/// @brief Method WriteEvent, addr 0x2714000, size 0xbc, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, int32_t  arg1) ;

/// @brief Method WriteEvent, addr 0x271414c, size 0x104, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, int32_t  arg1, int32_t  arg2) ;

/// @brief Method WriteEvent, addr 0x2714250, size 0x14c, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, int32_t  arg1, int32_t  arg2, int32_t  arg3) ;

/// @brief Method WriteEvent, addr 0x271439c, size 0xbc, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, int64_t  arg1) ;

/// @brief Method WriteEvent, addr 0x2714458, size 0xf0, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, int64_t  arg1, ::StringW  arg2) ;

/// @brief Method WriteEvent, addr 0x27140bc, size 0x4, virtual false, abstract: false, final false
inline void WriteEvent(int32_t  eventId, ::ArrayW<::System::Object*,::Array<::System::Object*>*>  args) ;

/// @brief Method WriteEventCore, addr 0x2714634, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2713e4c, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2713eb0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Guid  eventSourceGuid, ::StringW  eventSourceName) ;

/// @brief Method .ctor, addr 0x2713e88, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  eventSourceName) ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_Name, addr 0x2713f78, size 0x8, virtual false, abstract: false, final false
