...
/// @brief Method GetFileLineNumber, addr 0x2712540, size 0x8, virtual true, abstract: false, final false
inline int32_t GetFileLineNumber() ;

/// @brief Method GetFileName, addr 0x2712548, size 0x8, virtual true, abstract: false, final false
inline ::StringW GetFileName() ;

/// @brief Method GetILOffset, addr 0x2712624, size 0x8, virtual true, abstract: false, final false
inline int32_t GetILOffset() ;

/// @brief Method GetInternalMethodName, addr 0x271264c, size 0x8, virtual false, abstract: false, final false
inline ::StringW GetInternalMethodName() ;

/// @brief Method GetMethod, addr 0x271262c, size 0x8, virtual true, abstract: false, final false
inline ::System::Reflection::MethodBase* GetMethod() ;

/// @brief Method GetMethodAddress, addr 0x271263c, size 0x8, virtual false, abstract: false, final false
inline int64_t GetMethodAddress() ;

/// @brief Method GetMethodIndex, addr 0x2712644, size 0x8, virtual false, abstract: false, final false
inline uint32_t GetMethodIndex() ;

/// @brief Method GetNativeOffset, addr 0x2712634, size 0x8, virtual true, abstract: false, final false
inline int32_t GetNativeOffset() ;

/// @brief Method GetSecureFileName, addr 0x2712550, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2712654, size 0x240, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2712490, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x27124e0, size 0x60, virtual false, abstract: false, final false
inline void _ctor(int32_t  skipFrames, bool  fNeedFileInfo) ;

/// @brief Method get_frame_info, addr 0x2712488, size 0x8, virtual false, abstract: false, final false
