...
/// @brief Method .ctor, addr 0x2cfa820, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::StringW  displayName, ::StringW  description) ;

/// @brief Method .ctor, addr 0x2cfa880, size 0x238, virtual false, abstract: false, final false
inline void _ctor(::StringW  displayName, ::StringW  description, ::StringW  defaultSwitchValue) ;

/// @brief Method _pruneCachedSwitches, addr 0x2cfaab8, size 0x4dc, virtual false, abstract: false, final false
