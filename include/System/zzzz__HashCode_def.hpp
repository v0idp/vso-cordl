...
/// @brief Method Add, addr 0x2741dac, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x27422e8, size 0x48, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GenerateGlobalSeed, addr 0x2741aa4, size 0x24, virtual false, abstract: false, final false
static inline uint32_t GenerateGlobalSeed() ;

/// @brief Method GetHashCode, addr 0x274227c, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Initialize, addr 0x2741ad4, size 0xb8, virtual false, abstract: false, final false
static inline void Initialize(::ByRef<uint32_t>  v1, ::ByRef<uint32_t>  v2, ::ByRef<uint32_t>  v3, ::ByRef<uint32_t>  v4) ;

/// @brief Method MixEmptyState, addr 0x2741d20, size 0x64, virtual false, abstract: false, final false
static inline uint32_t MixEmptyState() ;

/// @brief Method MixFinal, addr 0x2741d84, size 0x28, virtual false, abstract: false, final false
static inline uint32_t MixFinal(uint32_t  hash) ;

/// @brief Method MixState, addr 0x2741c7c, size 0xa4, virtual false, abstract: false, final false
static inline uint32_t MixState(uint32_t  v1, uint32_t  v2, uint32_t  v3, uint32_t  v4) ;

/// @brief Method QueueRound, addr 0x2741c04, size 0x78, virtual false, abstract: false, final false
static inline uint32_t QueueRound(uint32_t  hash, uint32_t  queuedValue) ;

/// @brief Method Rol, addr 0x2741ac8, size 0xc, virtual false, abstract: false, final false
static inline uint32_t Rol(uint32_t  value, int32_t  count) ;

/// @brief Method Round, addr 0x2741b8c, size 0x78, virtual false, abstract: false, final false
static inline uint32_t Round(uint32_t  hash, uint32_t  input) ;

/// @brief Method ToHashCode, addr 0x2742044, size 0x238, virtual false, abstract: false, final false
