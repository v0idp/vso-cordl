...
public:
// Declarations
/// @brief Method IsValid, addr 0x2a165cc, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method IsValidCanonical, addr 0x2a165fc, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x2a16c38, size 0x68, virtual false, abstract: false, final false
static inline bool Parse(::StringW  name, ::cordl_internals::Ptr<uint8_t>  numbers, int32_t  start, int32_t  end) ;

/// @brief Method ParseCanonical, addr 0x2a1653c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method ParseCanonicalName, addr 0x2a16a3c, size 0x1fc, virtual false, abstract: false, final false
static inline ::StringW ParseCanonicalName(::StringW  str, int32_t  start, int32_t  end, ::ByRef<bool>  isLoopback) ;

/// @brief Method ParseHostNumber, addr 0x2a1650c, size 0x30, virtual false, abstract: false, final false
static inline int32_t ParseHostNumber(::System::ReadOnlySpan_1<char16_t>  str, int32_t  start, int32_t  end) ;

/// @brief Method ParseNonCanonical, addr 0x2a16744, size 0x2f8, virtual false, abstract: false, final false
