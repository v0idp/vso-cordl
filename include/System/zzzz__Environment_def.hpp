...
/// @brief Method CreateVersionFromString, addr 0x278b968, size 0x21c, virtual false, abstract: false, final false
static inline ::System::Version* CreateVersionFromString(::StringW  info) ;

/// @brief Method Exit, addr 0x278bc68, size 0x4, virtual false, abstract: false, final false
static inline void Exit(int32_t  exitCode) ;

/// @brief Method FailFast, addr 0x278c79c, size 0x8, virtual false, abstract: false, final false
static inline void FailFast(::StringW  message, ::System::Exception*  exception) ;

/// @brief Method FailFast, addr 0x278c7a4, size 0x4, virtual false, abstract: false, final false
static inline void FailFast(::StringW  message, ::System::Exception*  exception, ::StringW  errorSource) ;

/// @brief Method GetCommandLineArgs, addr 0x278bc6c, size 0x4, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> GetCommandLineArgs() ;

/// @brief Method GetEnvironmentVariable, addr 0x278bd38, size 0x4, virtual false, abstract: false, final false
static inline ::StringW GetEnvironmentVariable(::StringW  variable) ;

/// @brief Method GetEnvironmentVariableNames, addr 0x278be08, size 0x4, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> GetEnvironmentVariableNames() ;

/// @brief Method GetEnvironmentVariables, addr 0x278bd3c, size 0xcc, virtual false, abstract: false, final false
static inline ::System::Collections::IDictionary* GetEnvironmentVariables() ;

/// @brief Method GetFolderPath, addr 0x278be0c, size 0x8, virtual false, abstract: false, final false
static inline ::StringW GetFolderPath(::System::Environment_SpecialFolder  folder) ;

/// @brief Method GetFolderPath, addr 0x278be14, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method GetIs64BitOperatingSystem, addr 0x278c7a8, size 0x4, virtual false, abstract: false, final false
static inline bool GetIs64BitOperatingSystem() ;

/// @brief Method GetMachineConfigPath, addr 0x278c7c4, size 0x4, virtual false, abstract: false, final false
static inline ::StringW GetMachineConfigPath() ;

/// @brief Method GetNewLine, addr 0x278b840, size 0x4, virtual false, abstract: false, final false
static inline ::StringW GetNewLine() ;

/// @brief Method GetOSVersionString, addr 0x278b8b0, size 0x4, virtual false, abstract: false, final false
static inline ::StringW GetOSVersionString() ;

/// @brief Method GetPageSize, addr 0x278c7c8, size 0x4, virtual false, abstract: false, final false
static inline int32_t GetPageSize() ;

/// @brief Method GetResourceString, addr 0x2787fbc, size 0x4, virtual false, abstract: false, final false
static inline ::StringW GetResourceString(::StringW  key) ;

/// @brief Method GetResourceString, addr 0x2789d78, size 0x70, virtual false, abstract: false, final false
static inline ::StringW GetResourceString(::StringW  key, ::ArrayW<::System::Object*,::Array<::System::Object*>*>  values) ;

/// @brief Method GetResourceStringEncodingName, addr 0x278b694, size 0x17c, virtual false, abstract: false, final false
static inline ::StringW GetResourceStringEncodingName(int32_t  codePage) ;

/// @brief Method GetStackTrace, addr 0x278c804, size 0x98, virtual false, abstract: false, final false
static inline ::StringW GetStackTrace(::System::Exception*  e, bool  needFileInfo) ;

/// @brief Method GetWindowsFolderPath, addr 0x278be48, size 0x4, virtual false, abstract: false, final false
static inline ::StringW GetWindowsFolderPath(int32_t  folder) ;

/// @brief Method ReadXdgUserDir, addr 0x278c324, size 0x474, virtual false, abstract: false, final false
static inline ::StringW ReadXdgUserDir(::StringW  config_dir, ::StringW  home_dir, ::StringW  key, ::StringW  fallback) ;

/// @brief Method UnixGetFolderPath, addr 0x278be64, size 0x4c0, virtual false, abstract: false, final false
...
/// @brief Method get_CurrentDirectory, addr 0x278b810, size 0x8, virtual false, abstract: false, final false
static inline ::StringW get_CurrentDirectory() ;

/// @brief Method get_CurrentManagedThreadId, addr 0x278b818, size 0x20, virtual false, abstract: false, final false
static inline int32_t get_CurrentManagedThreadId() ;

/// @brief Method get_HasShutdownStarted, addr 0x278b838, size 0x4, virtual false, abstract: false, final false
static inline bool get_HasShutdownStarted() ;

/// @brief Method get_Is64BitOperatingSystem, addr 0x278c7ac, size 0x4, virtual false, abstract: false, final false
static inline bool get_Is64BitOperatingSystem() ;

/// @brief Method get_Is64BitProcess, addr 0x278c7b0, size 0x8, virtual false, abstract: false, final false
static inline bool get_Is64BitProcess() ;

/// @brief Method get_IsRunningOnWindows, addr 0x278be4c, size 0x18, virtual false, abstract: false, final false
static inline bool get_IsRunningOnWindows() ;

/// @brief Method get_IsUnix, addr 0x278c7cc, size 0x38, virtual false, abstract: false, final false
static inline bool get_IsUnix() ;

/// @brief Method get_MachineName, addr 0x278b83c, size 0x4, virtual false, abstract: false, final false
static inline ::StringW get_MachineName() ;

/// @brief Method get_NewLine, addr 0x278b844, size 0x68, virtual false, abstract: false, final false
static inline ::StringW get_NewLine() ;

/// @brief Method get_OSVersion, addr 0x278b8b4, size 0xb4, virtual false, abstract: false, final false
static inline ::System::OperatingSystem* get_OSVersion() ;

/// @brief Method get_Platform, addr 0x278b8ac, size 0x4, virtual false, abstract: false, final false
static inline ::System::PlatformID get_Platform() ;

/// @brief Method get_ProcessorCount, addr 0x278c7c0, size 0x4, virtual false, abstract: false, final false
static inline int32_t get_ProcessorCount() ;

/// @brief Method get_StackTrace, addr 0x278bb84, size 0x6c, virtual false, abstract: false, final false
static inline ::StringW get_StackTrace() ;

/// @brief Method get_TickCount, addr 0x278bbf0, size 0x4, virtual false, abstract: false, final false
static inline int32_t get_TickCount() ;

/// @brief Method get_UserDomainName, addr 0x278bbf4, size 0x4, virtual false, abstract: false, final false
static inline ::StringW get_UserDomainName() ;

/// @brief Method get_UserName, addr 0x278bbf8, size 0x4, virtual false, abstract: false, final false
static inline ::StringW get_UserName() ;

/// @brief Method get_Version, addr 0x278bbfc, size 0x6c, virtual false, abstract: false, final false
static inline ::System::Version* get_Version() ;

/// @brief Method internalGetEnvironmentVariable, addr 0x278bc74, size 0xc4, virtual false, abstract: false, final false
static inline ::StringW internalGetEnvironmentVariable(::StringW  variable) ;

/// @brief Method internalGetEnvironmentVariable_native, addr 0x278bc70, size 0x4, virtual false, abstract: false, final false
static inline ::StringW internalGetEnvironmentVariable_native(::System::IntPtr  variable) ;

/// @brief Method internalGetHome, addr 0x278c798, size 0x4, virtual false, abstract: false, final false
