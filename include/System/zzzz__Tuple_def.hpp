...
public:
// Declarations
/// @brief Method CombineHashCodes, addr 0x275d630, size 0xc, virtual false, abstract: false, final false
static inline int32_t CombineHashCodes(int32_t  h1, int32_t  h2) ;

/// @brief Method CombineHashCodes, addr 0x275d63c, size 0x14, virtual false, abstract: false, final false
static inline int32_t CombineHashCodes(int32_t  h1, int32_t  h2, int32_t  h3) ;

/// @brief Method CombineHashCodes, addr 0x275d650, size 0x1c, virtual false, abstract: false, final false
