...
public:
// Declarations
/// @brief Method ReverseEndianness, addr 0x2725254, size 0x8, virtual false, abstract: false, final false
static inline int32_t ReverseEndianness(int32_t  value) ;

/// @brief Method ReverseEndianness, addr 0x272525c, size 0xc, virtual false, abstract: false, final false
static inline uint16_t ReverseEndianness(uint16_t  value) ;

/// @brief Method ReverseEndianness, addr 0x2725268, size 0x8, virtual false, abstract: false, final false
