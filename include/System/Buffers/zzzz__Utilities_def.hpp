...
public:
// Declarations
/// @brief Method GetMaxSizeForBucket, addr 0x2725248, size 0xc, virtual false, abstract: false, final false
static inline int32_t GetMaxSizeForBucket(int32_t  binIndex) ;

/// @brief Method SelectBucketIndex, addr 0x27251cc, size 0x7c, virtual false, abstract: false, final false
