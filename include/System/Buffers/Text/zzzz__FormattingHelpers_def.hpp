...
public:
// Declarations
/// @brief Method CountDigits, addr 0x272532c, size 0x6c, virtual false, abstract: false, final false
static inline int32_t CountDigits(uint32_t  value) ;

/// @brief Method CountDigits, addr 0x2725270, size 0xbc, virtual false, abstract: false, final false
static inline int32_t CountDigits(uint64_t  value) ;

/// @brief Method CountHexDigits, addr 0x2725398, size 0x48, virtual false, abstract: false, final false
