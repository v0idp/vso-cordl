...
/// @brief Method Advance, addr 0x273d250, size 0xb8, virtual false, abstract: false, final false
inline bool Advance(int32_t  count) ;

/// @brief Method AtEnd, addr 0x273d1d0, size 0x80, virtual false, abstract: false, final false
inline bool AtEnd() ;

/// @brief Method ConsumeSubString, addr 0x273eb9c, size 0xb0, virtual false, abstract: false, final false
inline void ConsumeSubString(::System::DTSubString  sub) ;

/// @brief Method GetChar, addr 0x273e2f0, size 0x28, virtual false, abstract: false, final false
inline char16_t GetChar() ;

/// @brief Method GetDigit, addr 0x273e318, size 0x2c, virtual false, abstract: false, final false
inline int32_t GetDigit() ;

/// @brief Method GetNext, addr 0x273d124, size 0xac, virtual false, abstract: false, final false
inline bool GetNext() ;

/// @brief Method GetNextDigit, addr 0x273e214, size 0xdc, virtual false, abstract: false, final false
inline bool GetNextDigit() ;

/// @brief Method GetRegularToken, addr 0x273d308, size 0x334, virtual false, abstract: false, final false
...
/// @brief Method GetRepeatCount, addr 0x273e138, size 0xdc, virtual false, abstract: false, final false
inline int32_t GetRepeatCount() ;

/// @brief Method GetSeparatorToken, addr 0x273d63c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method GetSubString, addr 0x273ea1c, size 0x180, virtual false, abstract: false, final false
inline ::System::DTSubString GetSubString() ;

/// @brief Method Match, addr 0x273df6c, size 0xd4, virtual false, abstract: false, final false
inline bool Match(char16_t  ch) ;

/// @brief Method Match, addr 0x273de1c, size 0x150, virtual false, abstract: false, final false
inline bool Match(::StringW  str) ;

/// @brief Method MatchLongestWords, addr 0x273e040, size 0xf8, virtual false, abstract: false, final false
inline int32_t MatchLongestWords(::ArrayW<::StringW,::Array<::StringW>*>  words, ::ByRef<int32_t>  maxMatchStrLen) ;

/// @brief Method MatchSpecifiedWord, addr 0x273d8ac, size 0x124, virtual false, abstract: false, final false
inline bool MatchSpecifiedWord(::StringW  target) ;

/// @brief Method MatchSpecifiedWords, addr 0x273d9d0, size 0x44c, virtual false, abstract: false, final false
inline bool MatchSpecifiedWords(::StringW  target, bool  checkWordBoundary, ::ByRef<int32_t>  matchLength) ;

/// @brief Method RemoveLeadingInQuoteSpaces, addr 0x273e78c, size 0x290, virtual false, abstract: false, final false
inline void RemoveLeadingInQuoteSpaces() ;

/// @brief Method RemoveTrailingInQuoteSpaces, addr 0x273e560, size 0x22c, virtual false, abstract: false, final false
inline void RemoveTrailingInQuoteSpaces() ;

/// @brief Method SkipWhiteSpaceCurrent, addr 0x273d744, size 0x168, virtual false, abstract: false, final false
inline bool SkipWhiteSpaceCurrent() ;

/// @brief Method SkipWhiteSpaces, addr 0x273e344, size 0xf8, virtual false, abstract: false, final false
inline void SkipWhiteSpaces() ;

/// @brief Method TrimTail, addr 0x273e43c, size 0x124, virtual false, abstract: false, final false
inline void TrimTail() ;

/// @brief Method .ctor, addr 0x273d058, size 0xc4, virtual false, abstract: false, final false
inline void _ctor(::System::ReadOnlySpan_1<char16_t>  str, ::System::Globalization::DateTimeFormatInfo*  dtfi) ;

/// @brief Method .ctor, addr 0x273cfcc, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method get_CompareInfo, addr 0x273d11c, size 0x8, virtual false, abstract: false, final false
inline ::System::Globalization::CompareInfo* get_CompareInfo() ;

/// @brief Method get_Length, addr 0x273cf90, size 0x3c, virtual false, abstract: false, final false
