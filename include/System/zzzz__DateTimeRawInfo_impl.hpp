...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::DateTimeRawInfo::*)(int32_t)>(&::System::DateTimeRawInfo::AddNumber)> {
  ...
  constexpr static std::size_t addrs = 0x273ed2c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::System::DateTimeRawInfo::*)(int32_t)>(&::System::DateTimeRawInfo::GetNumber)> {
  ...
  constexpr static std::size_t addrs = 0x273ed44;
...
// Ctor Parameters [CppParam { name: "num", ty: "::cordl_internals::Ptr<int32_t>", modifiers: "", def_value: Some("{}") }, CppParam { name: "numCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "month", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "year", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "dayOfWeek", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "era", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "timeMark", ty: "::System::DateTimeParse_TM", modifiers: "", def_value: Some("{}") }, CppParam { name: "fraction", ty: "double_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "hasSameDateAndTimeSeparators", ty: "bool", modifiers: "", def_value: Some("{}") }]
constexpr ::System::DateTimeRawInfo::DateTimeRawInfo(::cordl_internals::Ptr<int32_t>  num, int32_t  numCount, int32_t  month, int32_t  year, int32_t  dayOfWeek, int32_t  era, ::System::DateTimeParse_TM  timeMark, double_t  fraction, bool  hasSameDateAndTimeSeparators) noexcept  {
this->num = num;
