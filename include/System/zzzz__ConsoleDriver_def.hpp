...
/// @brief Method CreateNullConsoleDriver, addr 0x278e778, size 0x40, virtual false, abstract: false, final false
static inline ::System::IConsoleDriver* CreateNullConsoleDriver() ;

/// @brief Method CreateTermInfoDriver, addr 0x278e80c, size 0x58, virtual false, abstract: false, final false
static inline ::System::IConsoleDriver* CreateTermInfoDriver(::StringW  term) ;

/// @brief Method CreateWindowsConsoleDriver, addr 0x278e7b8, size 0x54, virtual false, abstract: false, final false
static inline ::System::IConsoleDriver* CreateWindowsConsoleDriver() ;

/// @brief Method InternalKeyAvailable, addr 0x278ebac, size 0x4, virtual false, abstract: false, final false
static inline int32_t InternalKeyAvailable(int32_t  ms_timeout) ;

/// @brief Method Isatty, addr 0x278eba8, size 0x4, virtual false, abstract: false, final false
static inline bool Isatty(::System::IntPtr  handle) ;

/// @brief Method ReadKey, addr 0x278e174, size 0xd8, virtual false, abstract: false, final false
static inline ::System::ConsoleKeyInfo ReadKey(bool  intercept) ;

/// @brief Method SetEcho, addr 0x278ebb4, size 0x8, virtual false, abstract: false, final false
static inline bool SetEcho(bool  wantEcho) ;

/// @brief Method TtySetup, addr 0x278ebb0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_IsConsole, addr 0x278d99c, size 0x140, virtual false, abstract: false, final false
