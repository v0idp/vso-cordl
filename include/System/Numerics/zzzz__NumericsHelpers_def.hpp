...
public:
// Declarations
/// @brief Method Abs, addr 0x2b1eb3c, size 0xc, virtual false, abstract: false, final false
static inline uint32_t Abs(int32_t  a) ;

/// @brief Method CbitHighZero, addr 0x2b1f8ec, size 0x78, virtual false, abstract: false, final false
static inline int32_t CbitHighZero(uint32_t  u) ;

/// @brief Method CbitHighZero, addr 0x2b23af8, size 0x24, virtual false, abstract: false, final false
static inline int32_t CbitHighZero(uint64_t  uu) ;

/// @brief Method CombineHash, addr 0x2b1dd10, size 0x8, virtual false, abstract: false, final false
static inline int32_t CombineHash(int32_t  n1, int32_t  n2) ;

/// @brief Method CombineHash, addr 0x2b23b1c, size 0x8, virtual false, abstract: false, final false
static inline uint32_t CombineHash(uint32_t  u1, uint32_t  u2) ;

/// @brief Method DangerousMakeTwosComplement, addr 0x2b1d868, size 0xb4, virtual false, abstract: false, final false
static inline void DangerousMakeTwosComplement(::ArrayW<uint32_t,::Array<uint32_t>*>  d) ;

/// @brief Method GetDoubleFromParts, addr 0x2b1f964, size 0xa8, virtual false, abstract: false, final false
static inline double_t GetDoubleFromParts(int32_t  sign, int32_t  exp, uint64_t  man) ;

/// @brief Method GetDoubleParts, addr 0x2b1d000, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method MakeUlong, addr 0x2b1dee8, size 0x10, virtual false, abstract: false, final false
