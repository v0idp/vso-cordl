...
public:
// Declarations
/// @brief Method GetByteWithAllBitsSet, addr 0x269ee50, size 0x8, virtual false, abstract: false, final false
static inline uint8_t GetByteWithAllBitsSet() ;

/// @brief Method GetDoubleWithAllBitsSet, addr 0x269ee9c, size 0x8, virtual false, abstract: false, final false
static inline double_t GetDoubleWithAllBitsSet() ;

/// @brief Method GetInt16WithAllBitsSet, addr 0x269ee68, size 0x8, virtual false, abstract: false, final false
static inline int16_t GetInt16WithAllBitsSet() ;

/// @brief Method GetInt32WithAllBitsSet, addr 0x269ee78, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetInt32WithAllBitsSet() ;

/// @brief Method GetInt64WithAllBitsSet, addr 0x269ee88, size 0x8, virtual false, abstract: false, final false
static inline int64_t GetInt64WithAllBitsSet() ;

/// @brief Method GetSByteWithAllBitsSet, addr 0x269ee58, size 0x8, virtual false, abstract: false, final false
static inline int8_t GetSByteWithAllBitsSet() ;

/// @brief Method GetSingleWithAllBitsSet, addr 0x269ee90, size 0xc, virtual false, abstract: false, final false
static inline float_t GetSingleWithAllBitsSet() ;

/// @brief Method GetUInt16WithAllBitsSet, addr 0x269ee60, size 0x8, virtual false, abstract: false, final false
static inline uint16_t GetUInt16WithAllBitsSet() ;

/// @brief Method GetUInt32WithAllBitsSet, addr 0x269ee70, size 0x8, virtual false, abstract: false, final false
static inline uint32_t GetUInt32WithAllBitsSet() ;

/// @brief Method GetUInt64WithAllBitsSet, addr 0x269ee80, size 0x8, virtual false, abstract: false, final false
