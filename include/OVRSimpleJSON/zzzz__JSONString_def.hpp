...
/// @brief Method Clear, addr 0x295fb80, size 0x48, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method Clone, addr 0x295f954, size 0x5c, virtual true, abstract: false, final false
inline ::OVRSimpleJSON::JSONNode* Clone() ;

/// @brief Method Equals, addr 0x295fa50, size 0x110, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetEnumerator, addr 0x295f930, size 0x14, virtual true, abstract: false, final false
inline ::OVRSimpleJSON::JSONNode_Enumerator GetEnumerator() ;

/// @brief Method GetHashCode, addr 0x295fb60, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::OVRSimpleJSON::JSONString* New_ctor(::StringW  aData) ;

/// @brief Method WriteToStringBuilder, addr 0x295f9b0, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29585b4, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::StringW  aData) ;

/// @brief Method get_IsString, addr 0x295f928, size 0x8, virtual true, abstract: false, final false
inline bool get_IsString() ;

/// @brief Method get_Tag, addr 0x295f920, size 0x8, virtual true, abstract: false, final false
inline ::OVRSimpleJSON::JSONNodeType get_Tag() ;

/// @brief Method get_Value, addr 0x295f944, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_Value, addr 0x295f94c, size 0x8, virtual true, abstract: false, final false
