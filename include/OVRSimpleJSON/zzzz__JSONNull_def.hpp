...
/// @brief Method Clone, addr 0x29605a8, size 0x4c, virtual true, abstract: false, final false
inline ::OVRSimpleJSON::JSONNode* Clone() ;

/// @brief Method CreateOrGet, addr 0x2958620, size 0x88, virtual false, abstract: false, final false
static inline ::OVRSimpleJSON::JSONNull* CreateOrGet() ;

/// @brief Method Equals, addr 0x29605f4, size 0x8c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetEnumerator, addr 0x2960544, size 0x14, virtual true, abstract: false, final false
inline ::OVRSimpleJSON::JSONNode_Enumerator GetEnumerator() ;

/// @brief Method GetHashCode, addr 0x2960680, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::OVRSimpleJSON::JSONNull* New_ctor() ;

/// @brief Method WriteToStringBuilder, addr 0x2960688, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29604dc, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AsBool, addr 0x296059c, size 0x8, virtual true, abstract: false, final false
inline bool get_AsBool() ;

/// @brief Method get_IsNull, addr 0x296053c, size 0x8, virtual true, abstract: false, final false
inline bool get_IsNull() ;

/// @brief Method get_Tag, addr 0x2960534, size 0x8, virtual true, abstract: false, final false
inline ::OVRSimpleJSON::JSONNodeType get_Tag() ;

/// @brief Method get_Value, addr 0x2960558, size 0x40, virtual true, abstract: false, final false
...
/// @brief Method set_AsBool, addr 0x29605a4, size 0x4, virtual true, abstract: false, final false
inline void set_AsBool(bool  value) ;

/// @brief Method set_Value, addr 0x2960598, size 0x4, virtual true, abstract: false, final false
