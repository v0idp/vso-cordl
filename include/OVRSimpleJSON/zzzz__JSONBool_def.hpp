...
/// @brief Method Clear, addr 0x29604d4, size 0x8, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method Clone, addr 0x2960330, size 0x5c, virtual true, abstract: false, final false
inline ::OVRSimpleJSON::JSONNode* Clone() ;

/// @brief Method Equals, addr 0x2960404, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetEnumerator, addr 0x29601bc, size 0x14, virtual true, abstract: false, final false
inline ::OVRSimpleJSON::JSONNode_Enumerator GetEnumerator() ;

/// @brief Method GetHashCode, addr 0x296047c, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method WriteToStringBuilder, addr 0x296038c, size 0x78, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29602b8, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::StringW  aData) ;

/// @brief Method .ctor, addr 0x2958f30, size 0x70, virtual false, abstract: false, final false
inline void _ctor(bool  aData) ;

/// @brief Method get_AsBool, addr 0x29602a4, size 0x8, virtual true, abstract: false, final false
inline bool get_AsBool() ;

/// @brief Method get_IsBoolean, addr 0x29601b4, size 0x8, virtual true, abstract: false, final false
inline bool get_IsBoolean() ;

/// @brief Method get_Tag, addr 0x29601ac, size 0x8, virtual true, abstract: false, final false
inline ::OVRSimpleJSON::JSONNodeType get_Tag() ;

/// @brief Method get_Value, addr 0x29601d0, size 0x58, virtual true, abstract: false, final false
inline ::StringW get_Value() ;

/// @brief Method set_AsBool, addr 0x29602ac, size 0xc, virtual true, abstract: false, final false
inline void set_AsBool(bool  value) ;

/// @brief Method set_Value, addr 0x2960228, size 0x7c, virtual true, abstract: false, final false
