...
/// @brief Method Awake, addr 0x293ac88, size 0x1e4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ComponentComposition, addr 0x293bed8, size 0x338, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> ComponentComposition(::UnityEngine::GameObject*  GO) ;

/// @brief Method InitUIComponents, addr 0x293af24, size 0x3b4, virtual false, abstract: false, final false
inline void InitUIComponents() ;

static inline ::GlobalNamespace::OVRDebugInfo* New_ctor() ;

/// @brief Method OnDestroy, addr 0x293b5a4, size 0x8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RiftPresentGUI, addr 0x293bd54, size 0x184, virtual false, abstract: false, final false
inline void RiftPresentGUI(::UnityEngine::GameObject*  guiMainOBj) ;

/// @brief Method Update, addr 0x293ae6c, size 0xb8, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateDeviceDetection, addr 0x293b2d8, size 0x34, virtual false, abstract: false, final false
inline void UpdateDeviceDetection() ;

/// @brief Method UpdateEyeDepthOffset, addr 0x293b8e4, size 0xc0, virtual false, abstract: false, final false
inline void UpdateEyeDepthOffset() ;

/// @brief Method UpdateEyeHeightOffset, addr 0x293b824, size 0xc0, virtual false, abstract: false, final false
inline void UpdateEyeHeightOffset() ;

/// @brief Method UpdateFOV, addr 0x293b9a4, size 0x100, virtual false, abstract: false, final false
inline void UpdateFOV() ;

/// @brief Method UpdateFPS, addr 0x293bc74, size 0xe0, virtual false, abstract: false, final false
inline void UpdateFPS() ;

/// @brief Method UpdateIPD, addr 0x293b758, size 0xcc, virtual false, abstract: false, final false
inline void UpdateIPD() ;

/// @brief Method UpdateLatencyValues, addr 0x293bc70, size 0x4, virtual false, abstract: false, final false
inline void UpdateLatencyValues() ;

/// @brief Method UpdateResolutionEyeTexture, addr 0x293baa4, size 0x1cc, virtual false, abstract: false, final false
inline void UpdateResolutionEyeTexture() ;

/// @brief Method UpdateStrings, addr 0x293b344, size 0x260, virtual false, abstract: false, final false
inline void UpdateStrings() ;

/// @brief Method UpdateVariable, addr 0x293b30c, size 0x38, virtual false, abstract: false, final false
inline void UpdateVariable() ;

/// @brief Method VariableObjectManager, addr 0x293b5ac, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x293c210, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
