...
/// @brief Method Awake, addr 0x291ba9c, size 0xd0, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Contains, addr 0x291b938, size 0x164, virtual false, abstract: false, final false
inline bool Contains(::StringW  label) ;

/// @brief Method IOVRSceneComponent.Initialize, addr 0x291bb7c, size 0x120, virtual true, abstract: false, final true
inline void IOVRSceneComponent_Initialize() ;

static inline ::GlobalNamespace::OVRSemanticClassification* New_ctor() ;

/// @brief Method ValidateAndUpgradeLabels, addr 0x291bc9c, size 0x494, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x291c130, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Labels, addr 0x291b930, size 0x8, virtual false, abstract: false, final false
