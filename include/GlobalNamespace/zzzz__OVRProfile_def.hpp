...
/// @brief Method .ctor, addr 0x290d4a8, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_eyeDepth, addr 0x290d434, size 0x50, virtual false, abstract: false, final false
inline float_t get_eyeDepth() ;

/// @brief Method get_eyeHeight, addr 0x290d3e4, size 0x50, virtual false, abstract: false, final false
inline float_t get_eyeHeight() ;

/// @brief Method get_id, addr 0x290d1f0, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_id() ;

/// @brief Method get_ipd, addr 0x290d2b0, size 0x134, virtual false, abstract: false, final false
inline float_t get_ipd() ;

/// @brief Method get_locale, addr 0x290d270, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_locale() ;

/// @brief Method get_neckHeight, addr 0x290d484, size 0x1c, virtual false, abstract: false, final false
inline float_t get_neckHeight() ;

/// @brief Method get_state, addr 0x290d4a0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRProfile_State get_state() ;

/// @brief Method get_userName, addr 0x290d230, size 0x40, virtual false, abstract: false, final false
