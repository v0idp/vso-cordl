...
/// @brief Method ClearPoseCache, addr 0x290dc78, size 0x10, virtual false, abstract: false, final false
inline void ClearPoseCache() ;

/// @brief Method GetSceneAnchors, addr 0x290e470, size 0xf4, virtual false, abstract: false, final false
static inline void GetSceneAnchors(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::OVRSceneAnchor>>*  anchors) ;

/// @brief Method Initialize, addr 0x290dc88, size 0x3c8, virtual false, abstract: false, final false
inline void Initialize(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method InitializeFrom, addr 0x290e38c, size 0xe4, virtual false, abstract: false, final false
inline void InitializeFrom(::GlobalNamespace::OVRSceneAnchor*  other) ;

/// @brief Method IsComponentEnabled, addr 0x290dbc4, size 0xb4, virtual false, abstract: false, final false
inline bool IsComponentEnabled(::GlobalNamespace::OVRPlugin_SpaceComponentType  spaceComponentType) ;

/// @brief Method IsComponentSupported, addr 0x290dae4, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x290e564, size 0x214, virtual false, abstract: false, final false
...
/// @brief Method TryUpdateTransform, addr 0x290e050, size 0x33c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x290e778, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Anchor, addr 0x290daa8, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRAnchor get_Anchor() ;

/// @brief Method get_IsTracked, addr 0x290dad0, size 0x8, virtual false, abstract: false, final false
inline bool get_IsTracked() ;

/// @brief Method get_Space, addr 0x290da84, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRSpace get_Space() ;

/// @brief Method get_Uuid, addr 0x290da94, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_Anchor, addr 0x290dabc, size 0x14, virtual false, abstract: false, final false
inline void set_Anchor(::GlobalNamespace::OVRAnchor  value) ;

/// @brief Method set_IsTracked, addr 0x290dad8, size 0xc, virtual false, abstract: false, final false
inline void set_IsTracked(bool  value) ;

/// @brief Method set_Space, addr 0x290da8c, size 0x8, virtual false, abstract: false, final false
inline void set_Space(::GlobalNamespace::OVRSpace  value) ;

/// @brief Method set_Uuid, addr 0x290daa0, size 0x8, virtual false, abstract: false, final false
