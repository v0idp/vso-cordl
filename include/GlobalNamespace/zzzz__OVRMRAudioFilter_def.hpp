...
/// @brief Method OnAudioFilterRead, addr 0x288c7a8, size 0x18, virtual false, abstract: false, final false
inline void OnAudioFilterRead(::ArrayW<float_t,::Array<float_t>*>  data, int32_t  channels) ;

/// @brief Method Start, addr 0x288c79c, size 0xc, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x288c7c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
