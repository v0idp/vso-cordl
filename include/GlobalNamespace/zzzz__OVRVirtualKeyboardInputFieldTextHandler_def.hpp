...
/// @brief Method AppendText, addr 0x2930690, size 0xa8, virtual true, abstract: false, final false
inline void AppendText(::StringW  s) ;

/// @brief Method ApplyBackspace, addr 0x2930738, size 0xec, virtual true, abstract: false, final false
inline void ApplyBackspace() ;

/// @brief Method MoveTextEnd, addr 0x2930824, size 0x84, virtual true, abstract: false, final false
inline void MoveTextEnd() ;

static inline ::GlobalNamespace::OVRVirtualKeyboardInputFieldTextHandler* New_ctor() ;

/// @brief Method ProxyOnValueChanged, addr 0x2930990, size 0x44, virtual false, abstract: false, final false
inline void ProxyOnValueChanged(::StringW  arg0) ;

/// @brief Method Start, addr 0x29308a8, size 0xe8, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Submit, addr 0x29305f0, size 0xa0, virtual true, abstract: false, final false
inline void Submit() ;
...
/// @brief Method .ctor, addr 0x29309d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_InputField, addr 0x2930438, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::InputField> get_InputField() ;

/// @brief Method get_IsFocused, addr 0x293056c, size 0x84, virtual true, abstract: false, final false
inline bool get_IsFocused() ;

/// @brief Method get_OnTextChanged, addr 0x2930440, size 0x8, virtual true, abstract: false, final false
inline ::System::Action_1<::StringW>* get_OnTextChanged() ;

/// @brief Method get_SubmitOnEnter, addr 0x29304e8, size 0x84, virtual true, abstract: false, final false
inline bool get_SubmitOnEnter() ;

/// @brief Method get_Text, addr 0x2930450, size 0x98, virtual true, abstract: false, final false
inline ::StringW get_Text() ;

/// @brief Method set_InputField, addr 0x2929d68, size 0x1ec, virtual false, abstract: false, final false
inline void set_InputField(::UnityEngine::UI::InputField*  value) ;

/// @brief Method set_OnTextChanged, addr 0x2930448, size 0x8, virtual true, abstract: false, final false
