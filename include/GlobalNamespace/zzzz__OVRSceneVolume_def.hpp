...
/// @brief Method Awake, addr 0x291ac8c, size 0xe4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method IOVRSceneComponent.Initialize, addr 0x291ad70, size 0x4, virtual true, abstract: false, final true
inline void IOVRSceneComponent_Initialize() ;

static inline ::GlobalNamespace::OVRSceneVolume* New_ctor() ;

/// @brief Method SetChildOffset, addr 0x291abac, size 0xe0, virtual false, abstract: false, final false
inline void SetChildOffset() ;

/// @brief Method SetChildScale, addr 0x291aa74, size 0xe0, virtual false, abstract: false, final false
inline void SetChildScale() ;

/// @brief Method UpdateTransform, addr 0x2913c1c, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x291ad74, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Depth, addr 0x291a9e8, size 0x8, virtual false, abstract: false, final false
inline float_t get_Depth() ;

/// @brief Method get_Dimensions, addr 0x291a9f8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_Dimensions() ;

/// @brief Method get_Height, addr 0x291a9d8, size 0x8, virtual false, abstract: false, final false
inline float_t get_Height() ;

/// @brief Method get_Offset, addr 0x291aa04, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_Offset() ;

/// @brief Method get_OffsetChildren, addr 0x291ab54, size 0x8, virtual false, abstract: false, final false
inline bool get_OffsetChildren() ;

/// @brief Method get_ScaleChildren, addr 0x291aa1c, size 0x8, virtual false, abstract: false, final false
inline bool get_ScaleChildren() ;

/// @brief Method get_Width, addr 0x291a9c8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Depth, addr 0x291a9f0, size 0x8, virtual false, abstract: false, final false
inline void set_Depth(float_t  value) ;

/// @brief Method set_Height, addr 0x291a9e0, size 0x8, virtual false, abstract: false, final false
inline void set_Height(float_t  value) ;

/// @brief Method set_Offset, addr 0x291aa10, size 0xc, virtual false, abstract: false, final false
inline void set_Offset(::UnityEngine::Vector3  value) ;

/// @brief Method set_OffsetChildren, addr 0x291ab5c, size 0x50, virtual false, abstract: false, final false
inline void set_OffsetChildren(bool  value) ;

/// @brief Method set_ScaleChildren, addr 0x291aa24, size 0x50, virtual false, abstract: false, final false
inline void set_ScaleChildren(bool  value) ;

/// @brief Method set_Width, addr 0x291a9d0, size 0x8, virtual false, abstract: false, final false
