...
/// @brief Method Awake, addr 0x28989b4, size 0xdc, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::OVRControllerDrivenHandPosesSample* New_ctor() ;

/// @brief Method OnDestroy, addr 0x2898d08, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x2898d10, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x2898d0c, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetControllerDrivenHandPosesTypeToControllerConforming, addr 0x2898b60, size 0xd4, virtual false, abstract: false, final false
inline void SetControllerDrivenHandPosesTypeToControllerConforming() ;

/// @brief Method SetControllerDrivenHandPosesTypeToNatural, addr 0x2898c34, size 0xd4, virtual false, abstract: false, final false
inline void SetControllerDrivenHandPosesTypeToNatural() ;

/// @brief Method SetControllerDrivenHandPosesTypeToNone, addr 0x2898a90, size 0xd0, virtual false, abstract: false, final false
inline void SetControllerDrivenHandPosesTypeToNone() ;

/// @brief Method Update, addr 0x2898d14, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateLineRenderer, addr 0x2898d18, size 0x50, virtual false, abstract: false, final false
inline void UpdateLineRenderer() ;

/// @brief Method UpdateLineRendererForHand, addr 0x2898d68, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x289904c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
