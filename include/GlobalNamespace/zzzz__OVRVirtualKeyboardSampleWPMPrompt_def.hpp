...
public:
// Declarations
/// @brief Method Awake, addr 0x293288c, size 0x58, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::OVRVirtualKeyboardSampleWPMPrompt* New_ctor() ;

/// @brief Method .ctor, addr 0x29328e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
