...
/// @brief Method Awake, addr 0x293c2f4, size 0x104, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method GetFaceExpression, addr 0x293c544, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::OVRFaceExpressions_FaceExpression GetFaceExpression(int32_t  blendShapeIndex) ;

/// @brief Method GetWeightValue, addr 0x293c54c, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method RetrieveSkinnedMeshRenderer, addr 0x293c2a4, size 0x48, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::SkinnedMeshRenderer> RetrieveSkinnedMeshRenderer() ;

/// @brief Method SearchFaceExpressions, addr 0x293c3f8, size 0x58, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRFaceExpressions> SearchFaceExpressions() ;

/// @brief Method Start, addr 0x29396d0, size 0x50, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x293c450, size 0xf4, virtual true, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x29398a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BlendShapeStrengthMultiplier, addr 0x293c294, size 0x8, virtual false, abstract: false, final false
inline float_t get_BlendShapeStrengthMultiplier() ;

/// @brief Method get_FaceExpressions, addr 0x293c284, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRFaceExpressions> get_FaceExpressions() ;

/// @brief Method get_SkinnedMesh, addr 0x293c2ec, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::SkinnedMeshRenderer> get_SkinnedMesh() ;

/// @brief Method set_BlendShapeStrengthMultiplier, addr 0x293c29c, size 0x8, virtual false, abstract: false, final false
inline void set_BlendShapeStrengthMultiplier(float_t  value) ;

/// @brief Method set_FaceExpressions, addr 0x293c28c, size 0x8, virtual false, abstract: false, final false
