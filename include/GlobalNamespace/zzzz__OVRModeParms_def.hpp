...
/// @brief Method Start, addr 0x294504c, size 0x9c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method TestPowerStateMode, addr 0x2945194, size 0xa4, virtual false, abstract: false, final false
inline void TestPowerStateMode() ;

/// @brief Method Update, addr 0x29450e8, size 0xac, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x2945238, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
