...
/// @brief Method ComputeWorldPosition, addr 0x288e6c0, size 0x29c, virtual false, abstract: false, final false
inline ::System::Nullable_1<::UnityEngine::Vector3> ComputeWorldPosition(::UnityEngine::Camera*  camera) ;

/// @brief Method ComputeWorldRotation, addr 0x288eed8, size 0x2e8, virtual false, abstract: false, final false
inline ::System::Nullable_1<::UnityEngine::Quaternion> ComputeWorldRotation(::UnityEngine::Camera*  camera) ;

/// @brief Method .ctor, addr 0x288e330, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method get_IsPositionTracked, addr 0x288e608, size 0x5c, virtual false, abstract: false, final false
inline bool get_IsPositionTracked() ;

/// @brief Method get_IsRotationTracked, addr 0x288e664, size 0x5c, virtual false, abstract: false, final false
inline bool get_IsRotationTracked() ;

/// @brief Method get_Position, addr 0x288e5e8, size 0xc, virtual false, abstract: false, final false
inline ::System::Nullable_1<::UnityEngine::Vector3> get_Position() ;

/// @brief Method get_Rotation, addr 0x288e5f4, size 0x14, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_Position_k__BackingField", ty: "::System::Nullable_1<::UnityEngine::Vector3>", modifiers: "", def_value: None }, CppParam { name: "_Rotation_k__BackingField", ty: "::System::Nullable_1<::UnityEngine::Quaternion>", modifiers: "", def_value: None }, CppParam { name: "_flags", ty: "::GlobalNamespace::OVRPlugin_SpaceLocationFlags", modifiers: "", def_value: None }]
constexpr OVRLocatable_TrackingSpacePose(::System::Nullable_1<::UnityEngine::Vector3>  _Position_k__BackingField, ::System::Nullable_1<::UnityEngine::Quaternion>  _Rotation_k__BackingField, ::GlobalNamespace::OVRPlugin_SpaceLocationFlags  _flags) noexcept;
...
/// @brief Method Equals, addr 0x288e03c, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x288def8, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::OVRLocatable  other) ;

/// @brief Method GetHashCode, addr 0x288e0cc, size 0x90, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IOVRAnchorComponent<OVRLocatable>.FromAnchor, addr 0x288dc1c, size 0x30, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRLocatable IOVRAnchorComponent_OVRLocatable__FromAnchor(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method IOVRAnchorComponent<OVRLocatable>.get_Handle, addr 0x288dbc8, size 0x54, virtual true, abstract: false, final true
inline uint64_t IOVRAnchorComponent_OVRLocatable__get_Handle() ;

/// @brief Method IOVRAnchorComponent<OVRLocatable>.get_Type, addr 0x288db70, size 0x50, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRLocatable__get_Type() ;

/// @brief Method SetEnabledAsync, addr 0x288ddf8, size 0x100, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRTask_1<bool> SetEnabledAsync(bool  enabled, double_t  timeout) ;

/// @brief Method ToString, addr 0x288e15c, size 0xa8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetSceneAnchorPose, addr 0x288e20c, size 0x11c, virtual false, abstract: false, final false
inline bool TryGetSceneAnchorPose(::ByRef<::GlobalNamespace::OVRLocatable_TrackingSpacePose>  pose) ;

/// @brief Method TryGetSpatialAnchorPose, addr 0x288e4bc, size 0x11c, virtual false, abstract: false, final false
inline bool TryGetSpatialAnchorPose(::ByRef<::GlobalNamespace::OVRLocatable_TrackingSpacePose>  pose) ;

/// @brief Method .ctor, addr 0x288dc4c, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRAnchor  anchor) ;

static inline ::GlobalNamespace::OVRLocatable getStaticF_Null() ;

/// @brief Method get_Handle, addr 0x288e204, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_Handle() ;

/// @brief Method get_IsEnabled, addr 0x288dd0c, size 0xec, virtual true, abstract: false, final true
inline bool get_IsEnabled() ;

/// @brief Method get_IsNull, addr 0x288dcb0, size 0x5c, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Type, addr 0x288dbc0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x288df60, size 0x6c, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRLocatable  lhs, ::GlobalNamespace::OVRLocatable  rhs) ;

/// @brief Method op_Inequality, addr 0x288dfcc, size 0x70, virtual false, abstract: false, final false
