...
public:
// Declarations
/// @brief Method Awake, addr 0x29303d8, size 0x58, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::OVRVirtualKeyboardHandInputHandler* New_ctor() ;

/// @brief Method .ctor, addr 0x2930430, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
