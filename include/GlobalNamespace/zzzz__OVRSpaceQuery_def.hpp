...
/// @brief Field ComponentTypes, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_ComponentTypes, put=setStaticF_ComponentTypes)) ::ArrayW<::GlobalNamespace::OVRPlugin_SpaceComponentType,::Array<::GlobalNamespace::OVRPlugin_SpaceComponentType>*>  ComponentTypes;
...
/// @brief Method ToQueryInfo, addr 0x291c700, size 0x36c, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_SpaceQueryInfo ToQueryInfo() ;

/// @brief Method TryQuerySpaces, addr 0x291ca6c, size 0xb8, virtual false, abstract: false, final false
inline bool TryQuerySpaces(::ByRef<uint64_t>  requestId) ;

/// @brief Method ValidateSingleFilter, addr 0x291c438, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x291c674, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method get_ActionType, addr 0x291c3b0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_SpaceQueryActionType get_ActionType() ;

/// @brief Method get_ComponentFilter, addr 0x291c3c0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_SpaceComponentType get_ComponentFilter() ;

/// @brief Method get_Location, addr 0x291c390, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRSpace_StorageLocation get_Location() ;

/// @brief Method get_MaxResults, addr 0x291c370, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxResults() ;

/// @brief Method get_QueryType, addr 0x291c3a0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_SpaceQueryType get_QueryType() ;

/// @brief Method get_Timeout, addr 0x291c380, size 0x8, virtual false, abstract: false, final false
inline double_t get_Timeout() ;

/// @brief Method get_UuidFilter, addr 0x291c490, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_ActionType, addr 0x291c3b8, size 0x8, virtual false, abstract: false, final false
inline void set_ActionType(::GlobalNamespace::OVRPlugin_SpaceQueryActionType  value) ;

/// @brief Method set_ComponentFilter, addr 0x291c3c8, size 0x70, virtual false, abstract: false, final false
inline void set_ComponentFilter(::GlobalNamespace::OVRPlugin_SpaceComponentType  value) ;

/// @brief Method set_Location, addr 0x291c398, size 0x8, virtual false, abstract: false, final false
inline void set_Location(::GlobalNamespace::OVRSpace_StorageLocation  value) ;

/// @brief Method set_MaxResults, addr 0x291c378, size 0x8, virtual false, abstract: false, final false
inline void set_MaxResults(int32_t  value) ;

/// @brief Method set_QueryType, addr 0x291c3a8, size 0x8, virtual false, abstract: false, final false
inline void set_QueryType(::GlobalNamespace::OVRPlugin_SpaceQueryType  value) ;

/// @brief Method set_Timeout, addr 0x291c388, size 0x8, virtual false, abstract: false, final false
inline void set_Timeout(double_t  value) ;

/// @brief Method set_UuidFilter, addr 0x291c498, size 0x1dc, virtual false, abstract: false, final false
