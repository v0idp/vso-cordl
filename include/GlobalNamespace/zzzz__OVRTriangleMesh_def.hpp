...
/// @brief Method Execute, addr 0x2893200, size 0xd4, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Execute, addr 0x28932d4, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method Execute, addr 0x28932f0, size 0x1c, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;
...
/// @brief Method Equals, addr 0x2892c48, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2892b04, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::OVRTriangleMesh  other) ;

/// @brief Method GetHashCode, addr 0x2892cd8, size 0x98, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IOVRAnchorComponent<OVRTriangleMesh>.FromAnchor, addr 0x28928d8, size 0x30, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRTriangleMesh IOVRAnchorComponent_OVRTriangleMesh__FromAnchor(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method IOVRAnchorComponent<OVRTriangleMesh>.SetEnabledAsync, addr 0x2892ab8, size 0x4c, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRTask_1<bool> IOVRAnchorComponent_OVRTriangleMesh__SetEnabledAsync(bool  enabled, double_t  timeout) ;

/// @brief Method IOVRAnchorComponent<OVRTriangleMesh>.get_Handle, addr 0x2892884, size 0x54, virtual true, abstract: false, final true
inline uint64_t IOVRAnchorComponent_OVRTriangleMesh__get_Handle() ;

/// @brief Method IOVRAnchorComponent<OVRTriangleMesh>.get_Type, addr 0x2892824, size 0x54, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRTriangleMesh__get_Type() ;

/// @brief Method ScheduleGetMeshJob, addr 0x2893078, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2892d70, size 0xa8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetCounts, addr 0x2892e20, size 0x98, virtual false, abstract: false, final false
inline bool TryGetCounts(::ByRef<int32_t>  vertexCount, ::ByRef<int32_t>  triangleCount) ;

/// @brief Method TryGetMesh, addr 0x2892f68, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method TryGetMeshRawUntransformed, addr 0x2892eb8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2892908, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRAnchor  anchor) ;

static inline ::GlobalNamespace::OVRTriangleMesh getStaticF_Null() ;

/// @brief Method get_Handle, addr 0x2892e18, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_Handle() ;

/// @brief Method get_IsEnabled, addr 0x28929c8, size 0xf0, virtual true, abstract: false, final true
inline bool get_IsEnabled() ;

/// @brief Method get_IsNull, addr 0x289296c, size 0x5c, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Type, addr 0x2892878, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2892b6c, size 0x6c, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRTriangleMesh  lhs, ::GlobalNamespace::OVRTriangleMesh  rhs) ;

/// @brief Method op_Inequality, addr 0x2892bd8, size 0x70, virtual false, abstract: false, final false
