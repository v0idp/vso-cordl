...
/// @brief Method Dispose, addr 0x2922e0c, size 0x68, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x2922d84, size 0x88, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method get_NameHandle, addr 0x2922d7c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2922e74, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
public:
// Declarations
/// @brief Method CreateMarkerHandle, addr 0x2922e8c, size 0xc, virtual true, abstract: false, final false
inline bool CreateMarkerHandle(::StringW  name, ::ByRef<int32_t>  nameHandle) ;

/// @brief Method DestroyMarkerHandle, addr 0x2922e98, size 0x8, virtual true, abstract: false, final false
inline bool DestroyMarkerHandle(int32_t  nameHandle) ;

/// @brief Method MarkerAnnotation, addr 0x2922e84, size 0x4, virtual true, abstract: false, final false
inline void MarkerAnnotation(int32_t  markerId, ::StringW  annotationKey, ::StringW  annotationValue, int32_t  instanceKey) ;

/// @brief Method MarkerEnd, addr 0x2922e88, size 0x4, virtual true, abstract: false, final false
inline void MarkerEnd(int32_t  markerId, ::GlobalNamespace::Qpl_OVRPlugin_ResultType  resultTypeId, int32_t  instanceKey, int64_t  timestampMs) ;

/// @brief Method MarkerPointCached, addr 0x2922e80, size 0x4, virtual true, abstract: false, final false
inline void MarkerPointCached(int32_t  markerId, int32_t  nameHandle, int32_t  instanceKey, int64_t  timestampMs) ;

/// @brief Method MarkerStart, addr 0x2922e7c, size 0x4, virtual true, abstract: false, final false
inline void MarkerStart(int32_t  markerId, int32_t  instanceKey, int64_t  timestampMs) ;

static inline ::GlobalNamespace::OVRTelemetry_NullTelemetryClient* New_ctor() ;

/// @brief Method .ctor, addr 0x2922d6c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
public:
// Declarations
/// @brief Method CreateMarkerHandle, addr 0x2922efc, size 0x10, virtual true, abstract: false, final false
inline bool CreateMarkerHandle(::StringW  name, ::ByRef<int32_t>  nameHandle) ;

/// @brief Method DestroyMarkerHandle, addr 0x2922f0c, size 0xc, virtual true, abstract: false, final false
inline bool DestroyMarkerHandle(int32_t  nameHandle) ;

/// @brief Method MarkerAnnotation, addr 0x2922ecc, size 0x18, virtual true, abstract: false, final false
inline void MarkerAnnotation(int32_t  markerId, ::StringW  annotationKey, ::StringW  annotationValue, int32_t  instanceKey) ;

/// @brief Method MarkerEnd, addr 0x2922ee4, size 0x18, virtual true, abstract: false, final false
inline void MarkerEnd(int32_t  markerId, ::GlobalNamespace::Qpl_OVRPlugin_ResultType  resultTypeId, int32_t  instanceKey, int64_t  timestampMs) ;

/// @brief Method MarkerPointCached, addr 0x2922eb4, size 0x18, virtual true, abstract: false, final false
inline void MarkerPointCached(int32_t  markerId, int32_t  nameHandle, int32_t  instanceKey, int64_t  timestampMs) ;

/// @brief Method MarkerStart, addr 0x2922ea0, size 0x14, virtual true, abstract: false, final false
inline void MarkerStart(int32_t  markerId, int32_t  instanceKey, int64_t  timestampMs) ;

static inline ::GlobalNamespace::OVRTelemetry_QPLTelemetryClient* New_ctor() ;

/// @brief Method .ctor, addr 0x2922d74, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddSDKVersionAnnotation, addr 0x2922b3c, size 0x134, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRTelemetryMarker AddSDKVersionAnnotation(::GlobalNamespace::OVRTelemetryMarker  marker) ;

/// @brief Method SendEvent, addr 0x2922924, size 0xb0, virtual false, abstract: false, final false
static inline void SendEvent(int32_t  markerId, ::GlobalNamespace::Qpl_OVRPlugin_ResultType  result) ;

/// @brief Method Start, addr 0x292286c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method get_Client, addr 0x29227ec, size 0x80, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRTelemetry_TelemetryClient* get_Client() ;

/// @brief Method get_IsActive, addr 0x29227cc, size 0x20, virtual false, abstract: false, final false
