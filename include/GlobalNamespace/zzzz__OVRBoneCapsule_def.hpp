...
/// @brief Method .ctor, addr 0x294fa1c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x29502d4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(int16_t  boneIndex, ::UnityEngine::Rigidbody*  capsuleRigidBody, ::UnityEngine::CapsuleCollider*  capsuleCollider) ;

/// @brief Method get_BoneIndex, addr 0x29502a4, size 0x8, virtual false, abstract: false, final false
inline int16_t get_BoneIndex() ;

/// @brief Method get_CapsuleCollider, addr 0x29502c4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::CapsuleCollider> get_CapsuleCollider() ;

/// @brief Method get_CapsuleRigidbody, addr 0x29502b4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rigidbody> get_CapsuleRigidbody() ;

/// @brief Method set_BoneIndex, addr 0x29502ac, size 0x8, virtual false, abstract: false, final false
inline void set_BoneIndex(int16_t  value) ;

/// @brief Method set_CapsuleCollider, addr 0x29502cc, size 0x8, virtual false, abstract: false, final false
inline void set_CapsuleCollider(::UnityEngine::CapsuleCollider*  value) ;

/// @brief Method set_CapsuleRigidbody, addr 0x29502bc, size 0x8, virtual false, abstract: false, final false
