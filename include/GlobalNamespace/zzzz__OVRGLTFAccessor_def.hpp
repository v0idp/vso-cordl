...
// Dependencies OVRGLTFAccessor::GLTFAccessor, OVRGLTFAccessor::GLTFBuffer, OVRGLTFAccessor::GLTFBufferView, System.IDisposable, System.Object
namespace GlobalNamespace {
// Is value type: false
...
/// @brief Method Dispose, addr 0x289f0e0, size 0x1c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetDataCount, addr 0x289f0fc, size 0x8, virtual false, abstract: false, final false
inline int32_t GetDataCount() ;

/// @brief Method GetMaxValueForType, addr 0x289e18c, size 0xf4, virtual false, abstract: false, final false
inline float_t GetMaxValueForType(::GlobalNamespace::OVRGLTFComponentType  type) ;

/// @brief Method GetStrideForType, addr 0x289ccf0, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method ReadAsFloat, addr 0x289d350, size 0x158, virtual false, abstract: false, final false
static inline float_t ReadAsFloat(::System::IO::BinaryReader*  reader, ::GlobalNamespace::OVRGLTFComponentType  type) ;

/// @brief Method ReadAsInt, addr 0x289d54c, size 0x164, virtual false, abstract: false, final false
static inline int32_t ReadAsInt(::System::IO::BinaryReader*  reader, ::GlobalNamespace::OVRGLTFComponentType  type) ;

/// @brief Method ReadBuffer, addr 0x289eff4, size 0xec, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadBuffer(int32_t  bufferViewIndex) ;

/// @brief Method ReadColor, addr 0x289dd8c, size 0x400, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*> ReadColor() ;

/// @brief Method ReadFloat, addr 0x289d1c4, size 0x18c, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> ReadFloat() ;

/// @brief Method ReadInt, addr 0x289d4a8, size 0xa4, virtual false, abstract: false, final false
inline ::ArrayW<int32_t,::Array<int32_t>*> ReadInt() ;

/// @brief Method ReadJoints, addr 0x289e674, size 0x1cc, virtual false, abstract: false, final false
inline void ReadJoints(::ByRef<::ArrayW<::UnityEngine::BoneWeight,::Array<::UnityEngine::BoneWeight>*>>  resultsBoneWeights) ;

/// @brief Method ReadMatrix4x4, addr 0x289eb7c, size 0x478, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*> ReadMatrix4x4(::UnityEngine::Vector3  conversionScale) ;

/// @brief Method ReadQuaterion, addr 0x289e840, size 0x33c, virtual false, abstract: false, final false
...
/// @brief Method ReadVector2, addr 0x289d6b0, size 0x1c0, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector2,::Array<::UnityEngine::Vector2>*> ReadVector2() ;

/// @brief Method ReadVector3, addr 0x289d870, size 0x278, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*> ReadVector3(::UnityEngine::Vector3  conversionScale) ;

/// @brief Method ReadVector4, addr 0x289dae8, size 0x2a4, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*> ReadVector4(::UnityEngine::Vector4  conversionScale) ;

/// @brief Method ReadWeights, addr 0x289e280, size 0x3f4, virtual false, abstract: false, final false
inline void ReadWeights(::ByRef<::ArrayW<::UnityEngine::BoneWeight,::Array<::UnityEngine::BoneWeight>*>>  resultsBoneWeights) ;

/// @brief Method Seek, addr 0x289cf48, size 0x1b0, virtual false, abstract: false, final false
inline void Seek(int32_t  accessorIndex, bool  onlyBufferView) ;

/// @brief Method SeekStride, addr 0x289d0f8, size 0xcc, virtual false, abstract: false, final false
inline void SeekStride(int32_t  strideIndex) ;

/// @brief Method ToOVRType, addr 0x289cde4, size 0x164, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRGLTFType ToOVRType(::StringW  type) ;

/// @brief Method TryCreate, addr 0x289ba20, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x289bbb8, size 0x1138, virtual false, abstract: false, final false
