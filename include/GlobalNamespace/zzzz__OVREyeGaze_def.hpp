...
/// @brief Method Awake, addr 0x289a568, size 0x7c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CalculateEyeRotation, addr 0x289aca8, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x289aaa4, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x289aa1c, size 0x88, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x289a86c, size 0x78, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPermissionGranted, addr 0x289a9bc, size 0x60, virtual false, abstract: false, final false
inline void OnPermissionGranted(::StringW  permissionId) ;

/// @brief Method PrepareHeadDirection, addr 0x289a5e8, size 0x284, virtual false, abstract: false, final false
inline void PrepareHeadDirection() ;

/// @brief Method Start, addr 0x289a5e4, size 0x4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartEyeTracking, addr 0x289a8e4, size 0xd8, virtual false, abstract: false, final false
inline bool StartEyeTracking() ;

/// @brief Method Update, addr 0x289aab0, size 0x1f8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x289ae68, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF__trackingInstanceCount() ;

/// @brief Method get_Confidence, addr 0x289a558, size 0x8, virtual false, abstract: false, final false
inline float_t get_Confidence() ;

/// @brief Method get_EyeTrackingEnabled, addr 0x289a508, size 0x50, virtual false, abstract: false, final false
inline bool get_EyeTrackingEnabled() ;

static inline void setStaticF__trackingInstanceCount(int32_t  value) ;

/// @brief Method set_Confidence, addr 0x289a560, size 0x8, virtual false, abstract: false, final false
