...
/// @brief Method RenderIntoCubemap, addr 0x2938970, size 0x560, virtual false, abstract: false, final false
static inline void RenderIntoCubemap(::UnityEngine::Camera*  ownerCamera, ::UnityEngine::Cubemap*  outCubemap) ;

/// @brief Method SaveCubemapCapture, addr 0x2938ed0, size 0x798, virtual false, abstract: false, final false
static inline bool SaveCubemapCapture(::UnityEngine::Cubemap*  cubemap, ::StringW  pathName) ;

/// @brief Method TriggerCubemapCapture, addr 0x29386c4, size 0x2ac, virtual false, abstract: false, final false
static inline void TriggerCubemapCapture(::UnityEngine::Vector3  capturePos, int32_t  cubemapSize, ::StringW  pathName) ;

/// @brief Method Update, addr 0x293861c, size 0xa8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x2939668, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;
