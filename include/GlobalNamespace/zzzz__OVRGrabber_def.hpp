...
/// @brief Method Awake, addr 0x293da00, size 0x140, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method CheckForGrabOrRelease, addr 0x293dff8, size 0x40, virtual false, abstract: false, final false
inline void CheckForGrabOrRelease(float_t  prevFlex) ;

/// @brief Method ForceRelease, addr 0x293d6d0, size 0xb0, virtual false, abstract: false, final false
inline void ForceRelease(::GlobalNamespace::OVRGrabbable*  grabbable) ;

/// @brief Method GrabBegin, addr 0x293e32c, size 0x6b0, virtual true, abstract: false, final false
inline void GrabBegin() ;

/// @brief Method GrabEnd, addr 0x293d798, size 0x268, virtual false, abstract: false, final false
inline void GrabEnd() ;

/// @brief Method GrabVolumeEnable, addr 0x293ec60, size 0xc0, virtual true, abstract: false, final false
inline void GrabVolumeEnable(bool  enabled) ;

/// @brief Method GrabbableRelease, addr 0x293ec0c, size 0x54, virtual false, abstract: false, final false
inline void GrabbableRelease(::UnityEngine::Vector3  linearVelocity, ::UnityEngine::Vector3  angularVelocity) ;

/// @brief Method MoveGrabbedObject, addr 0x293e9dc, size 0x230, virtual true, abstract: false, final false
...
/// @brief Method OffhandGrabbed, addr 0x293ed20, size 0xcc, virtual true, abstract: false, final false
inline void OffhandGrabbed(::GlobalNamespace::OVRGrabbable*  grabbable) ;

/// @brief Method OnDestroy, addr 0x293e038, size 0x78, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnTriggerEnter, addr 0x293e0b0, size 0x124, virtual false, abstract: false, final false
inline void OnTriggerEnter(::UnityEngine::Collider*  otherCollider) ;

/// @brief Method OnTriggerExit, addr 0x293e1d4, size 0x158, virtual false, abstract: false, final false
inline void OnTriggerExit(::UnityEngine::Collider*  otherCollider) ;

/// @brief Method OnUpdatedAnchors, addr 0x293ddd4, size 0x224, virtual false, abstract: false, final false
inline void OnUpdatedAnchors() ;

/// @brief Method SetPlayerIgnoreCollision, addr 0x293dc20, size 0x1a4, virtual false, abstract: false, final false
inline void SetPlayerIgnoreCollision(::UnityEngine::GameObject*  grabbable, bool  ignore) ;

/// @brief Method Start, addr 0x293db40, size 0xe0, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x293ddc4, size 0x10, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method <Awake>b__23_0, addr 0x293ee80, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x293edec, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_grabbedObject, addr 0x293d790, size 0x8, virtual false, abstract: false, final false
