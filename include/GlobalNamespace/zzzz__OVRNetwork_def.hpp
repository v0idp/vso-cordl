...
public:
// Declarations
/// @brief Method FromBytes, addr 0x2945470, size 0x130, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRNetwork_FrameHeader FromBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  arr) ;

/// @brief Method ToBytes, addr 0x2945350, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method Broadcast, addr 0x2946424, size 0x598, virtual false, abstract: false, final false
inline void Broadcast(int32_t  payloadType, ::ArrayW<uint8_t,::Array<uint8_t>*>  payload) ;

/// @brief Method DoAcceptTcpClientCallback, addr 0x2945c7c, size 0x540, virtual false, abstract: false, final false
inline void DoAcceptTcpClientCallback(::System::IAsyncResult*  ar) ;

/// @brief Method DoWriteDataCallback, addr 0x29469bc, size 0xf4, virtual false, abstract: false, final false
inline void DoWriteDataCallback(::System::IAsyncResult*  ar) ;

/// @brief Method HasConnectedClient, addr 0x29461bc, size 0x268, virtual false, abstract: false, final false
inline bool HasConnectedClient() ;

static inline ::GlobalNamespace::OVRNetwork_OVRNetworkTcpServer* New_ctor() ;

/// @brief Method StartListening, addr 0x29455a0, size 0x520, virtual false, abstract: false, final false
inline void StartListening(int32_t  listeningPort) ;

/// @brief Method StopListening, addr 0x2945ac0, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2946ab0, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Connect, addr 0x2946b94, size 0x178, virtual false, abstract: false, final false
inline void Connect(int32_t  listeningPort) ;

/// @brief Method ConnectCallback, addr 0x2946d0c, size 0x300, virtual false, abstract: false, final false
inline void ConnectCallback(::System::IAsyncResult*  ar) ;

/// @brief Method Disconnect, addr 0x294700c, size 0x238, virtual false, abstract: false, final false
inline void Disconnect() ;

static inline ::GlobalNamespace::OVRNetwork_OVRNetworkTcpClient* New_ctor() ;

/// @brief Method OnReadDataCallback, addr 0x2947458, size 0x4d8, virtual false, abstract: false, final false
inline void OnReadDataCallback(::System::IAsyncResult*  ar) ;

/// @brief Method Tick, addr 0x2947244, size 0x214, virtual false, abstract: false, final false
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x2947930, size 0xec, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Connected, addr 0x2946b80, size 0x14, virtual false, abstract: false, final false
inline bool get_Connected() ;

/// @brief Method get_connectionState, addr 0x2946b58, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2945348, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
