...
/// @brief Method Awake, addr 0x294c52c, size 0x1b4, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::OVRSceneSampleController* New_ctor() ;

/// @brief Method Start, addr 0x294c6e0, size 0x10c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x294c7ec, size 0xd4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateRecenterPose, addr 0x294c8c0, size 0xb0, virtual false, abstract: false, final false
inline void UpdateRecenterPose() ;

/// @brief Method UpdateSpeedAndRotationScaleMultiplier, addr 0x294ca2c, size 0xac, virtual false, abstract: false, final false
inline void UpdateSpeedAndRotationScaleMultiplier() ;

/// @brief Method UpdateVisionMode, addr 0x294c970, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x294cad8, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;
