...
/// @brief Method Dispose, addr 0x289ba1c, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method MoveNext, addr 0x289b960, size 0x1c, virtual true, abstract: false, final true
inline bool MoveNext() ;

/// @brief Method Reset, addr 0x289ba10, size 0xc, virtual true, abstract: false, final true
inline void Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x289b9b0, size 0x60, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method .ctor, addr 0x289b834, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<float_t,::Array<float_t>*>  array) ;

/// @brief Method get_Current, addr 0x289b97c, size 0x34, virtual true, abstract: false, final true
...
// Dependencies OVRFaceExpressions::WeightProvider, OVRPermissionsRequester::Permission, OVRPlugin::FaceState, System.Collections.Generic.IEnumerable`1<T>, System.Collections.Generic.IReadOnlyCollection`1<T>, System.Collections.IEnumerable, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
/// @brief Method Awake, addr 0x289aef8, size 0x7c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CheckValidity, addr 0x289b444, size 0x5c, virtual false, abstract: false, final false
inline void CheckValidity() ;

/// @brief Method CopyTo, addr 0x289b56c, size 0x244, virtual false, abstract: false, final false
inline void CopyTo(::ArrayW<float_t,::Array<float_t>*>  array, int32_t  startIndex) ;

/// @brief Method GetEnumerator, addr 0x289b814, size 0x20, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRFaceExpressions_FaceExpressionsEnumerator GetEnumerator() ;

/// @brief Method GetRequestedFaceTrackingDataSources, addr 0x289b164, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method GetWeight, addr 0x289b4a0, size 0x4, virtual true, abstract: false, final true
inline float_t GetWeight(::GlobalNamespace::OVRFaceExpressions_FaceExpression  expression) ;

static inline ::GlobalNamespace::OVRFaceExpressions* New_ctor() ;

/// @brief Method OnDestroy, addr 0x289b2a0, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x289b218, size 0x88, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x289af74, size 0x78, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPermissionGranted, addr 0x289b0e4, size 0x80, virtual false, abstract: false, final false
inline void OnPermissionGranted(::StringW  permissionId) ;

/// @brief Method StartFaceTracking, addr 0x289afec, size 0xf8, virtual false, abstract: false, final false
inline bool StartFaceTracking() ;

/// @brief Method System.Collections.Generic.IEnumerable<System.Single>.GetEnumerator, addr 0x289b858, size 0x74, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x289b8cc, size 0x74, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method ToArray, addr 0x289b7b0, size 0x64, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> ToArray() ;

/// @brief Method TryGetFaceExpressionWeight, addr 0x289b4a4, size 0x5c, virtual false, abstract: false, final false
inline bool TryGetFaceExpressionWeight(::GlobalNamespace::OVRFaceExpressions_FaceExpression  expression, ::ByRef<float_t>  weight) ;

/// @brief Method TryGetFaceTrackingDataSource, addr 0x289b55c, size 0x10, virtual false, abstract: false, final false
inline bool TryGetFaceTrackingDataSource(::ByRef<::GlobalNamespace::OVRFaceExpressions_FaceTrackingDataSource>  dataSource) ;

/// @brief Method TryGetWeightConfidence, addr 0x289b500, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x289b2ac, size 0x9c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x289b958, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF__trackingInstanceCount() ;

/// @brief Method get_Count, addr 0x289b940, size 0x18, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_EyeFollowingBlendshapesValid, addr 0x289aee4, size 0x8, virtual false, abstract: false, final false
inline bool get_EyeFollowingBlendshapesValid() ;

/// @brief Method get_FaceTrackingEnabled, addr 0x289ae80, size 0x50, virtual false, abstract: false, final false
inline bool get_FaceTrackingEnabled() ;

/// @brief Method get_Item, addr 0x289b348, size 0xfc, virtual false, abstract: false, final false
inline float_t get_Item(::GlobalNamespace::OVRFaceExpressions_FaceExpression  expression) ;

/// @brief Method get_ValidExpressions, addr 0x289aed0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_EyeFollowingBlendshapesValid, addr 0x289aeec, size 0xc, virtual false, abstract: false, final false
inline void set_EyeFollowingBlendshapesValid(bool  value) ;

/// @brief Method set_ValidExpressions, addr 0x289aed8, size 0xc, virtual false, abstract: false, final false
