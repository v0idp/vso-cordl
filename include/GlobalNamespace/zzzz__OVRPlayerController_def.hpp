...
/// @brief Method Awake, addr 0x2947ec0, size 0x1dc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetHaltUpdateMovement, addr 0x2949ae0, size 0xc, virtual false, abstract: false, final false
inline void GetHaltUpdateMovement(::ByRef<bool>  haltUpdateMovement) ;

/// @brief Method GetMoveScaleMultiplier, addr 0x2949aa0, size 0xc, virtual false, abstract: false, final false
inline void GetMoveScaleMultiplier(::ByRef<float_t>  moveScaleMultiplier) ;

/// @brief Method GetRotationScaleMultiplier, addr 0x2949ab4, size 0xc, virtual false, abstract: false, final false
inline void GetRotationScaleMultiplier(::ByRef<float_t>  rotationScaleMultiplier) ;

/// @brief Method GetSkipMouseRotation, addr 0x2949ac8, size 0xc, virtual false, abstract: false, final false
inline void GetSkipMouseRotation(::ByRef<bool>  skipMouseRotation) ;

/// @brief Method Jump, addr 0x2949974, size 0x84, virtual false, abstract: false, final false
inline bool Jump() ;

static inline ::GlobalNamespace::OVRPlayerController* New_ctor() ;

/// @brief Method OnDisable, addr 0x29480a0, size 0x194, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x294809c, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method ResetOrientation, addr 0x2949af8, size 0xc4, virtual false, abstract: false, final false
inline void ResetOrientation() ;

/// @brief Method SetHaltUpdateMovement, addr 0x2949aec, size 0xc, virtual false, abstract: false, final false
inline void SetHaltUpdateMovement(bool  haltUpdateMovement) ;

/// @brief Method SetMoveScaleMultiplier, addr 0x2949aac, size 0x8, virtual false, abstract: false, final false
inline void SetMoveScaleMultiplier(float_t  moveScaleMultiplier) ;

/// @brief Method SetRotationScaleMultiplier, addr 0x2949ac0, size 0x8, virtual false, abstract: false, final false
inline void SetRotationScaleMultiplier(float_t  rotationScaleMultiplier) ;

/// @brief Method SetSkipMouseRotation, addr 0x2949ad4, size 0xc, virtual false, abstract: false, final false
inline void SetSkipMouseRotation(bool  skipMouseRotation) ;

/// @brief Method Start, addr 0x2947dfc, size 0xc4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Stop, addr 0x29499f8, size 0xa8, virtual false, abstract: false, final false
inline void Stop() ;

/// @brief Method Update, addr 0x2948234, size 0x1ec, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateController, addr 0x2948420, size 0x728, virtual true, abstract: false, final false
inline void UpdateController() ;

/// @brief Method UpdateMovement, addr 0x2948b48, size 0xca4, virtual true, abstract: false, final false
inline void UpdateMovement() ;

/// @brief Method UpdateTransform, addr 0x29497ec, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2949bbc, size 0xb4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_CameraUpdated, addr 0x2947b7c, size 0x9c, virtual false, abstract: false, final false
inline void add_CameraUpdated(::System::Action*  value) ;

/// @brief Method add_PreCharacterMove, addr 0x2947cb4, size 0x9c, virtual false, abstract: false, final false
inline void add_PreCharacterMove(::System::Action*  value) ;

/// @brief Method add_TransformUpdated, addr 0x2947a1c, size 0xb0, virtual false, abstract: false, final false
inline void add_TransformUpdated(::System::Action_1<::UnityW<::UnityEngine::Transform>>*  value) ;

/// @brief Method get_InitialYRotation, addr 0x2947dec, size 0x8, virtual false, abstract: false, final false
inline float_t get_InitialYRotation() ;

/// @brief Method remove_CameraUpdated, addr 0x2947c18, size 0x9c, virtual false, abstract: false, final false
inline void remove_CameraUpdated(::System::Action*  value) ;

/// @brief Method remove_PreCharacterMove, addr 0x2947d50, size 0x9c, virtual false, abstract: false, final false
inline void remove_PreCharacterMove(::System::Action*  value) ;

/// @brief Method remove_TransformUpdated, addr 0x2947acc, size 0xb0, virtual false, abstract: false, final false
inline void remove_TransformUpdated(::System::Action_1<::UnityW<::UnityEngine::Transform>>*  value) ;

/// @brief Method set_InitialYRotation, addr 0x2947df4, size 0x8, virtual false, abstract: false, final false
