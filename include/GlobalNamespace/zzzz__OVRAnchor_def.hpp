...
/// @brief Field SupportedComponentsArray, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SupportedComponentsArray, put=setStaticF_SupportedComponentsArray)) ::ArrayW<::GlobalNamespace::OVRPlugin_SpaceComponentType,::Array<::GlobalNamespace::OVRPlugin_SpaceComponentType>*>  SupportedComponentsArray;
...
/// @brief Method CreateSpatialAnchorAsync, addr 0x288d0e8, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method CreateSpatialAnchorAsync, addr 0x288d248, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x288da50, size 0x80, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Equals, addr 0x288d774, size 0xb0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x288d6bc, size 0xb8, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::OVRAnchor  other) ;

/// @brief Method FetchAnchors, addr 0x288ca04, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method FetchAnchorsAsync, addr 0x288c960, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method FetchAnchorsAsync, addr 0x288cbf0, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x288d950, size 0x94, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetQueryInfo, addr 0x288c7d0, size 0xcc, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRPlugin_SpaceQueryInfo GetQueryInfo(::GlobalNamespace::OVRPlugin_SpaceComponentType  type, ::GlobalNamespace::OVRSpace_StorageLocation  location, int32_t  maxResults, double_t  timeout) ;

/// @brief Method GetQueryInfo, addr 0x288c89c, size 0xc4, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRPlugin_SpaceQueryInfo GetQueryInfo(::System::Collections::Generic::IEnumerable_1<::System::Guid>*  uuids, ::GlobalNamespace::OVRSpace_StorageLocation  location, double_t  timeout) ;

/// @brief Method GetSupportedComponents, addr 0x288d518, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method OnSpaceQueryCompleteData, addr 0x288ccf4, size 0x3e8, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x288d9e4, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x288d0dc, size 0xc, virtual false, abstract: false, final false
inline void _ctor(uint64_t  handle, ::System::Guid  uuid) ;

static inline ::GlobalNamespace::OVRAnchor getStaticF_Null() ;

static inline ::ArrayW<::GlobalNamespace::OVRPlugin_SpaceComponentType,::Array<::GlobalNamespace::OVRPlugin_SpaceComponentType>*> getStaticF_SupportedComponentsArray() ;

/// @brief Method get_Handle, addr 0x288d504, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_Handle() ;

/// @brief Method get_Uuid, addr 0x288d50c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x288d824, size 0x94, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRAnchor  lhs, ::GlobalNamespace::OVRAnchor  rhs) ;

/// @brief Method op_Inequality, addr 0x288d8b8, size 0x98, virtual false, abstract: false, final false
...
static inline void setStaticF_SupportedComponentsArray(::ArrayW<::GlobalNamespace::OVRPlugin_SpaceComponentType,::Array<::GlobalNamespace::OVRPlugin_SpaceComponentType>*>  value) ;
