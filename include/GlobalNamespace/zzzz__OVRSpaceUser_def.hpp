...
/// @brief Method Dispose, addr 0x2922768, size 0x64, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x2922700, size 0x68, virtual false, abstract: false, final false
inline void _ctor(uint64_t  spaceUserId) ;

/// @brief Method get_Id, addr 0x291f060, size 0x7c, virtual false, abstract: false, final false
inline uint64_t get_Id() ;

/// @brief Method get_Valid, addr 0x29226d8, size 0x28, virtual false, abstract: false, final false
