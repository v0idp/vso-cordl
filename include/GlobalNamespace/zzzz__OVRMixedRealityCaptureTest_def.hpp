...
/// @brief Method Initialize, addr 0x29442ac, size 0x224, virtual false, abstract: false, final false
inline void Initialize() ;

static inline ::GlobalNamespace::OVRMixedRealityCaptureTest* New_ctor() ;

/// @brief Method Start, addr 0x29441fc, size 0xb0, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x29448e0, size 0x764, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateDefaultExternalCamera, addr 0x29444d0, size 0x410, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2945044, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
