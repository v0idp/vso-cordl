...
/// @brief Method InitializeFromAudioFloatTrack, addr 0x28a87b4, size 0x334, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x28a8ae8, size 0x8, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method WriteSample, addr 0x28a828c, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28a808c, size 0x100, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x28a84d0, size 0x20c, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRHapticsClip*  a, ::GlobalNamespace::OVRHapticsClip*  b) ;

/// @brief Method .ctor, addr 0x28a86dc, size 0xd8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::AudioClip*  audioClip, int32_t  channel) ;

/// @brief Method .ctor, addr 0x28a81b4, size 0xd8, virtual false, abstract: false, final false
inline void _ctor(int32_t  capacity) ;

/// @brief Method .ctor, addr 0x28a840c, size 0xc4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  samples, int32_t  samplesCount) ;

/// @brief Method get_Capacity, addr 0x28a83ec, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Capacity() ;

/// @brief Method get_Count, addr 0x28a83dc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Samples, addr 0x28a83fc, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Samples() ;

/// @brief Method set_Capacity, addr 0x28a83f4, size 0x8, virtual false, abstract: false, final false
inline void set_Capacity(int32_t  value) ;

/// @brief Method set_Count, addr 0x28a83e4, size 0x8, virtual false, abstract: false, final false
inline void set_Count(int32_t  value) ;

/// @brief Method set_Samples, addr 0x28a8404, size 0x8, virtual false, abstract: false, final false
