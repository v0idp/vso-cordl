...
/// @brief Method Equals, addr 0x28913cc, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2891288, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::OVRSemanticLabels  other) ;

/// @brief Method GetHashCode, addr 0x289145c, size 0x94, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IOVRAnchorComponent<OVRSemanticLabels>.FromAnchor, addr 0x2891060, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method IOVRAnchorComponent<OVRSemanticLabels>.SetEnabledAsync, addr 0x289123c, size 0x4c, virtual true, abstract: false, final true
...
/// @brief Method IOVRAnchorComponent<OVRSemanticLabels>.get_Handle, addr 0x289100c, size 0x54, virtual true, abstract: false, final true
inline uint64_t IOVRAnchorComponent_OVRSemanticLabels__get_Handle() ;

/// @brief Method IOVRAnchorComponent<OVRSemanticLabels>.get_Type, addr 0x2890fb4, size 0x50, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRSemanticLabels__get_Type() ;

/// @brief Method ToString, addr 0x28914f0, size 0xa8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2891090, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRAnchor  anchor) ;

static inline ::GlobalNamespace::OVRSemanticLabels getStaticF_Null() ;

/// @brief Method get_Handle, addr 0x2891598, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_Handle() ;

/// @brief Method get_IsEnabled, addr 0x2891150, size 0xec, virtual true, abstract: false, final true
inline bool get_IsEnabled() ;

/// @brief Method get_IsNull, addr 0x28910f4, size 0x5c, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Labels, addr 0x28915a0, size 0xec, virtual false, abstract: false, final false
inline ::StringW get_Labels() ;

/// @brief Method get_Type, addr 0x2891004, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x28912f0, size 0x6c, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRSemanticLabels  lhs, ::GlobalNamespace::OVRSemanticLabels  rhs) ;

/// @brief Method op_Inequality, addr 0x289135c, size 0x70, virtual false, abstract: false, final false
