...
/// @brief Method InitializeControllerModels, addr 0x2933fbc, size 0x494, virtual false, abstract: false, final false
inline void InitializeControllerModels() ;

/// @brief Method InputFocusAquired, addr 0x2934cb8, size 0xc, virtual false, abstract: false, final false
inline void InputFocusAquired() ;

/// @brief Method InputFocusLost, addr 0x2934cc4, size 0x8, virtual false, abstract: false, final false
inline void InputFocusLost() ;

static inline ::GlobalNamespace::OVRControllerHelper* New_ctor() ;

/// @brief Method Start, addr 0x2933f4c, size 0x70, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x2934450, size 0x868, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x2934ccc, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
