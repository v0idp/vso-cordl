...
/// @brief Method Awake, addr 0x293c974, size 0x170, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Hide, addr 0x293cc78, size 0x11c, virtual false, abstract: false, final false
inline void Hide() ;

/// @brief Method LateUpdate, addr 0x293d0b0, size 0x178, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::OVRGazePointer* New_ctor() ;

/// @brief Method RequestHide, addr 0x293d228, size 0x2c, virtual false, abstract: false, final false
inline void RequestHide() ;

/// @brief Method RequestShow, addr 0x293d08c, size 0x20, virtual false, abstract: false, final false
inline void RequestShow() ;

/// @brief Method SetCursorRay, addr 0x293d0ac, size 0x4, virtual true, abstract: false, final false
inline void SetCursorRay(::UnityEngine::Transform*  ray) ;

/// @brief Method SetCursorStartDest, addr 0x293ceac, size 0x1e0, virtual true, abstract: false, final false
inline void SetCursorStartDest(::UnityEngine::Vector3  _, ::UnityEngine::Vector3  pos, ::UnityEngine::Vector3  normal) ;

/// @brief Method Show, addr 0x293cd94, size 0x118, virtual false, abstract: false, final false
inline void Show() ;

/// @brief Method Update, addr 0x293cae4, size 0x194, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x293d254, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityW<::GlobalNamespace::OVRGazePointer> getStaticF__instance() ;

/// @brief Method get_SelectionProgress, addr 0x293c87c, size 0x78, virtual false, abstract: false, final false
inline float_t get_SelectionProgress() ;

/// @brief Method get_currentScale, addr 0x293c5c4, size 0x8, virtual false, abstract: false, final false
inline float_t get_currentScale() ;

/// @brief Method get_hidden, addr 0x293c5b0, size 0x8, virtual false, abstract: false, final false
inline bool get_hidden() ;

/// @brief Method get_instance, addr 0x293c5d4, size 0x20c, virtual false, abstract: false, final false
static inline ::UnityW<::GlobalNamespace::OVRGazePointer> get_instance() ;

/// @brief Method get_visibilityStrength, addr 0x293c7e0, size 0x9c, virtual false, abstract: false, final false
inline float_t get_visibilityStrength() ;

static inline void setStaticF__instance(::UnityW<::GlobalNamespace::OVRGazePointer>  value) ;

/// @brief Method set_SelectionProgress, addr 0x293c8f4, size 0x80, virtual false, abstract: false, final false
inline void set_SelectionProgress(float_t  value) ;

/// @brief Method set_currentScale, addr 0x293c5cc, size 0x8, virtual false, abstract: false, final false
inline void set_currentScale(float_t  value) ;

/// @brief Method set_hidden, addr 0x293c5b8, size 0xc, virtual false, abstract: false, final false
