...
/// @brief Method Equals, addr 0x291c2bc, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x291c2ac, size 0x10, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::OVRSpace  other) ;

/// @brief Method GetHashCode, addr 0x291c334, size 0x20, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x291c228, size 0x84, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetUuid, addr 0x291c1b4, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method get_Handle, addr 0x291c1ac, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_Handle() ;

/// @brief Method get_Valid, addr 0x291bb6c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x291c354, size 0xc, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRSpace  lhs, ::GlobalNamespace::OVRSpace  rhs) ;

/// @brief Method op_Implicit, addr 0x291c36c, size 0x4, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRSpace op_Implicit___GlobalNamespace__OVRSpace(uint64_t  handle) ;

/// @brief Method op_Implicit, addr 0x291b034, size 0x4, virtual false, abstract: false, final false
static inline uint64_t op_Implicit_uint64_t(::GlobalNamespace::OVRSpace  space) ;

/// @brief Method op_Inequality, addr 0x291c360, size 0xc, virtual false, abstract: false, final false
