...
/// @brief Method ConvertRect, addr 0x2890610, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect ConvertRect(::GlobalNamespace::OVRPlugin_Rectf  openXrRect) ;

/// @brief Method Equals, addr 0x2890320, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x28901dc, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::OVRBounded2D  other) ;

/// @brief Method GetHashCode, addr 0x28903b0, size 0x94, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IOVRAnchorComponent<OVRBounded2D>.FromAnchor, addr 0x288ffb4, size 0x30, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRBounded2D IOVRAnchorComponent_OVRBounded2D__FromAnchor(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method IOVRAnchorComponent<OVRBounded2D>.SetEnabledAsync, addr 0x2890190, size 0x4c, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRTask_1<bool> IOVRAnchorComponent_OVRBounded2D__SetEnabledAsync(bool  enabled, double_t  timeout) ;

/// @brief Method IOVRAnchorComponent<OVRBounded2D>.get_Handle, addr 0x288ff60, size 0x54, virtual true, abstract: false, final true
inline uint64_t IOVRAnchorComponent_OVRBounded2D__get_Handle() ;

/// @brief Method IOVRAnchorComponent<OVRBounded2D>.get_Type, addr 0x288ff08, size 0x50, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRBounded2D__get_Type() ;

/// @brief Method ToString, addr 0x2890444, size 0xa8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetBoundaryPoints, addr 0x28906b8, size 0x168, virtual false, abstract: false, final false
inline bool TryGetBoundaryPoints(::Unity::Collections::NativeArray_1<::UnityEngine::Vector2>  positions) ;

/// @brief Method TryGetBoundaryPointsCount, addr 0x2890628, size 0x90, virtual false, abstract: false, final false
inline bool TryGetBoundaryPointsCount(::ByRef<int32_t>  count) ;

/// @brief Method .ctor, addr 0x288ffe4, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRAnchor  anchor) ;

static inline ::GlobalNamespace::OVRBounded2D getStaticF_Null() ;

/// @brief Method get_BoundingBox, addr 0x28904f4, size 0x11c, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_BoundingBox() ;

/// @brief Method get_Handle, addr 0x28904ec, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_Handle() ;

/// @brief Method get_IsEnabled, addr 0x28900a4, size 0xec, virtual true, abstract: false, final true
inline bool get_IsEnabled() ;

/// @brief Method get_IsNull, addr 0x2890048, size 0x5c, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Type, addr 0x288ff58, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2890244, size 0x6c, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRBounded2D  lhs, ::GlobalNamespace::OVRBounded2D  rhs) ;

/// @brief Method op_Inequality, addr 0x28902b0, size 0x70, virtual false, abstract: false, final false
