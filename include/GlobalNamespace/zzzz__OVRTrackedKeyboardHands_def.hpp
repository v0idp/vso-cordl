...
/// @brief Method Awake, addr 0x2926808, size 0x1dc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ComputeOpacity, addr 0x2927d1c, size 0x24, virtual false, abstract: false, final false
inline float_t ComputeOpacity(float_t  distance, float_t  innerThreshold, float_t  outerThreshold) ;

/// @brief Method DisableHandObjects, addr 0x2927680, size 0xec, virtual false, abstract: false, final false
inline void DisableHandObjects() ;

/// @brief Method GetHandDistanceToKeyboard, addr 0x292776c, size 0x2d0, virtual false, abstract: false, final false
inline float_t GetHandDistanceToKeyboard(::GlobalNamespace::OVRSkeleton*  handSkeleton) ;

/// @brief Method LateUpdate, addr 0x2926e94, size 0x7ec, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::OVRTrackedKeyboardHands* New_ctor() ;

/// @brief Method RetargetHandTrackingToHandPresence, addr 0x2926ce8, size 0x170, virtual false, abstract: false, final false
inline void RetargetHandTrackingToHandPresence() ;

/// @brief Method SetHandModelsEnabled, addr 0x2927b14, size 0x208, virtual false, abstract: false, final false
inline void SetHandModelsEnabled(bool  enableLeftModel, bool  enableRightModel) ;

/// @brief Method ShouldEnableModel, addr 0x2927aa8, size 0x6c, virtual false, abstract: false, final false
inline bool ShouldEnableModel(float_t  distance) ;

/// @brief Method ShouldEnablePassthrough, addr 0x2927a3c, size 0x6c, virtual false, abstract: false, final false
inline bool ShouldEnablePassthrough(float_t  distance) ;

/// @brief Method Start, addr 0x29269e4, size 0x304, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StopHandPresence, addr 0x2927d40, size 0x30, virtual false, abstract: false, final false
inline void StopHandPresence() ;

/// @brief Method TrackedKeyboardActiveUpdated, addr 0x2927d70, size 0xc, virtual false, abstract: false, final false
inline void TrackedKeyboardActiveUpdated(::GlobalNamespace::OVRTrackedKeyboard_TrackedKeyboardSetActiveEvent  e) ;

/// @brief Method TrackedKeyboardVisibilityChanged, addr 0x2927d7c, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2927f14, size 0x754, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AreControllersActive, addr 0x2926e58, size 0x3c, virtual false, abstract: false, final false
inline bool get_AreControllersActive() ;

/// @brief Method get_LeftHandOverKeyboard, addr 0x29267f4, size 0x8, virtual false, abstract: false, final false
inline bool get_LeftHandOverKeyboard() ;

/// @brief Method get_RightHandOverKeyboard, addr 0x29267e0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_LeftHandOverKeyboard, addr 0x29267fc, size 0xc, virtual false, abstract: false, final false
inline void set_LeftHandOverKeyboard(bool  value) ;

/// @brief Method set_RightHandOverKeyboard, addr 0x29267e8, size 0xc, virtual false, abstract: false, final false
