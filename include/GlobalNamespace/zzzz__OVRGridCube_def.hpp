...
/// @brief Method CreateCubeGrid, addr 0x293f0b4, size 0x3b8, virtual false, abstract: false, final false
inline void CreateCubeGrid() ;

/// @brief Method CubeGridSwitchColor, addr 0x293f46c, size 0x17c, virtual false, abstract: false, final false
inline void CubeGridSwitchColor(bool  CubeSwitchColor) ;

static inline ::GlobalNamespace::OVRGridCube* New_ctor() ;

/// @brief Method SetOVRCameraController, addr 0x293f0a8, size 0xc, virtual false, abstract: false, final false
inline void SetOVRCameraController(::ByRef<::GlobalNamespace::OVRCameraRig*>  cameraController) ;

/// @brief Method Update, addr 0x293ee84, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateCubeGrid, addr 0x293ee88, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x293f5e8, size 0x30, virtual false, abstract: false, final false
inline void _ctor() ;
