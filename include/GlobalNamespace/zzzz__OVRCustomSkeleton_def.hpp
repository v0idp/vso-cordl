...
/// @brief Method AllocateBones, addr 0x293ab3c, size 0xc4, virtual false, abstract: false, final false
inline void AllocateBones() ;

/// @brief Method GetBoneTransform, addr 0x293aadc, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method SetSkeletonType, addr 0x293ac00, size 0x80, virtual true, abstract: false, final false
inline void SetSkeletonType(::GlobalNamespace::OVRSkeleton_SkeletonType  skeletonType) ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x293ab38, size 0x4, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x293ab34, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x293ac80, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CustomBones, addr 0x293aad4, size 0x8, virtual false, abstract: false, final false
