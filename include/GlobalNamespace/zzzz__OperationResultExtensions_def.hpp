...
public:
// Declarations
/// @brief Method IsError, addr 0x29226c4, size 0x8, virtual false, abstract: false, final false
static inline bool IsError(::GlobalNamespace::OVRSpatialAnchor_OperationResult  res) ;

/// @brief Method IsSuccess, addr 0x29226b8, size 0xc, virtual false, abstract: false, final false
static inline bool IsSuccess(::GlobalNamespace::OVRSpatialAnchor_OperationResult  res) ;

/// @brief Method IsWarning, addr 0x29226cc, size 0xc, virtual false, abstract: false, final false
