...
/// @brief Method Awake, addr 0x2954b70, size 0x314, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method BuildMaterials, addr 0x2954638, size 0x3b0, virtual false, abstract: false, final false
inline void BuildMaterials() ;

/// @brief Method BuildMeshes, addr 0x2953fc0, size 0x678, virtual false, abstract: false, final false
inline void BuildMeshes() ;

/// @brief Method DisableRenderers, addr 0x2954b38, size 0x38, virtual false, abstract: false, final false
inline void DisableRenderers() ;

/// @brief Method EnableRenderers, addr 0x2955470, size 0x38, virtual false, abstract: false, final false
inline void EnableRenderers() ;

/// @brief Method GetTanFovAndOffsetForMonoEye, addr 0x295504c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method GetTanFovAndOffsetForStereoEye, addr 0x2954e84, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method GetTriangleCount, addr 0x2953f9c, size 0x24, virtual false, abstract: false, final false
inline int32_t GetTriangleCount() ;

static inline ::GlobalNamespace::OVRVignette* New_ctor() ;

/// @brief Method OnBeginCameraRendering, addr 0x29554b0, size 0x8c, virtual false, abstract: false, final false
inline void OnBeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext  context, ::UnityEngine::Camera*  camera) ;

/// @brief Method OnDisable, addr 0x2954a8c, size 0xac, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x29549e8, size 0xa4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPostRender, addr 0x29554ac, size 0x4, virtual false, abstract: false, final false
inline void OnPostRender() ;

/// @brief Method OnPreCull, addr 0x29554a8, size 0x4, virtual false, abstract: false, final false
inline void OnPreCull() ;

/// @brief Method Update, addr 0x295510c, size 0x364, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method VisibilityTest, addr 0x29550d8, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x295553c, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;
