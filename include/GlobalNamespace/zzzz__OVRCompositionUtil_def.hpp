...
public:
// Declarations
/// @brief Method BuildBoundaryMesh, addr 0x28893f8, size 0x484, virtual false, abstract: false, final false
...
/// @brief Method GetMaximumBoundaryDistance, addr 0x2888ddc, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method GetWorldPosition, addr 0x2888d48, size 0x94, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetWorldPosition(::UnityEngine::Camera*  camera, ::UnityEngine::Vector3  trackingSpacePosition) ;

/// @brief Method GetWorldPosition, addr 0x2888d0c, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method SafeDestroy, addr 0x2888c98, size 0x74, virtual false, abstract: false, final false
static inline void SafeDestroy(::ByRef<::UnityEngine::GameObject*>  obj) ;

/// @brief Method SafeDestroy, addr 0x2888bfc, size 0x9c, virtual false, abstract: false, final false
static inline void SafeDestroy(::UnityEngine::GameObject*  obj) ;

/// @brief Method .ctor, addr 0x288987c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
