...
/// @brief Method Awake, addr 0x2949c78, size 0x20, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::OVRProgressIndicator* New_ctor() ;

/// @brief Method Update, addr 0x2949c98, size 0x6c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x2949d04, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
