...
/// @brief Method Equals, addr 0x28924c8, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2892384, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::OVRAnchorContainer  other) ;

/// @brief Method FetchChildrenAsync, addr 0x2892780, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x2892558, size 0x94, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.FromAnchor, addr 0x289215c, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.SetEnabledAsync, addr 0x2892338, size 0x4c, virtual true, abstract: false, final true
...
/// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.get_Handle, addr 0x2892108, size 0x54, virtual true, abstract: false, final true
inline uint64_t IOVRAnchorComponent_OVRAnchorContainer__get_Handle() ;

/// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.get_Type, addr 0x28920b0, size 0x50, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRAnchorContainer__get_Type() ;

/// @brief Method ToString, addr 0x28925ec, size 0xa8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x289218c, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRAnchor  anchor) ;

static inline ::GlobalNamespace::OVRAnchorContainer getStaticF_Null() ;

/// @brief Method get_Handle, addr 0x2892694, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_Handle() ;

/// @brief Method get_IsEnabled, addr 0x289224c, size 0xec, virtual true, abstract: false, final true
inline bool get_IsEnabled() ;

/// @brief Method get_IsNull, addr 0x28921f0, size 0x5c, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Type, addr 0x2892100, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_SpaceComponentType get_Type() ;

/// @brief Method get_Uuids, addr 0x289269c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x28923ec, size 0x6c, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRAnchorContainer  lhs, ::GlobalNamespace::OVRAnchorContainer  rhs) ;

/// @brief Method op_Inequality, addr 0x2892458, size 0x70, virtual false, abstract: false, final false
