...
public:
// Declarations
/// @brief Method ApplyTo, addr 0x2942b7c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ReadFrom, addr 0x2942b80, size 0x1428, virtual false, abstract: false, final false
