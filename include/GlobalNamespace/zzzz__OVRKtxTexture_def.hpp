...
public:
// Declarations
/// @brief Method Load, addr 0x28bd6bc, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28bd910, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
