...
/// @brief Method Awake, addr 0x2918ee0, size 0x20c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetUuidsToQuery, addr 0x29191fc, size 0x6f4, virtual false, abstract: false, final false
inline void GetUuidsToQuery() ;

/// @brief Method IOVRSceneComponent.Initialize, addr 0x29190ec, size 0x110, virtual true, abstract: false, final true
inline void IOVRSceneComponent_Initialize() ;

/// @brief Method LoadRoom, addr 0x2911fb4, size 0x110, virtual false, abstract: false, final false
inline void LoadRoom() ;

static inline ::GlobalNamespace::OVRSceneRoom* New_ctor() ;

/// @brief Method OnDestroy, addr 0x291a5ac, size 0xb8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnFetchAnchorsCompleted, addr 0x29198f0, size 0x4a0, virtual false, abstract: false, final false
inline void OnFetchAnchorsCompleted(bool  success) ;

/// @brief Method OnLocalizationCompleted, addr 0x2919d90, size 0x3f0, virtual false, abstract: false, final false
inline void OnLocalizationCompleted(bool  success, ::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method UpdateRoomInformation, addr 0x291a180, size 0x42c, virtual false, abstract: false, final false
inline void UpdateRoomInformation(::GlobalNamespace::OVRScenePlane*  plane) ;

/// @brief Method <Awake>b__24_0, addr 0x291a8d4, size 0x60, virtual false, abstract: false, final false
inline int32_t _Awake_b__24_0(::GlobalNamespace::OVRScenePlane*  planeA, ::GlobalNamespace::OVRScenePlane*  planeB) ;

/// @brief Method <Awake>g__TryGetUuid|24_1, addr 0x291a934, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x291a664, size 0x194, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Ceiling, addr 0x2918ec0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRScenePlane> get_Ceiling() ;

/// @brief Method get_Floor, addr 0x2918eb0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRScenePlane> get_Floor() ;

/// @brief Method get_Walls, addr 0x2918ed0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Ceiling, addr 0x2918ec8, size 0x8, virtual false, abstract: false, final false
inline void set_Ceiling(::GlobalNamespace::OVRScenePlane*  value) ;

/// @brief Method set_Floor, addr 0x2918eb8, size 0x8, virtual false, abstract: false, final false
inline void set_Floor(::GlobalNamespace::OVRScenePlane*  value) ;

/// @brief Method set_Walls, addr 0x2918ed8, size 0x8, virtual false, abstract: false, final false
