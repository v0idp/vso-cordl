...
/// @brief Method GetKeyboardState, addr 0x29232b0, size 0x148, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRKeyboard_TrackedKeyboardState GetKeyboardState() ;

/// @brief Method GetSystemKeyboardInfo, addr 0x29233f8, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method StopKeyboardTracking, addr 0x29234e0, size 0x50, virtual false, abstract: false, final false
