...
/// @brief Method ToQueryOptions, addr 0x2920bc4, size 0x148, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRSpaceQuery_Options ToQueryOptions() ;

/// @brief Method get_MaxAnchorCount, addr 0x2921990, size 0x8, virtual false, abstract: false, final false
inline int32_t get_MaxAnchorCount() ;

/// @brief Method get_StorageLocation, addr 0x2921980, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRSpace_StorageLocation get_StorageLocation() ;

/// @brief Method get_Timeout, addr 0x29219a0, size 0x8, virtual false, abstract: false, final false
inline double_t get_Timeout() ;

/// @brief Method get_Uuids, addr 0x29219b0, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::System::Guid>* get_Uuids() ;

/// @brief Method set_MaxAnchorCount, addr 0x2921998, size 0x8, virtual false, abstract: false, final false
inline void set_MaxAnchorCount(int32_t  value) ;

/// @brief Method set_StorageLocation, addr 0x2921988, size 0x8, virtual false, abstract: false, final false
inline void set_StorageLocation(::GlobalNamespace::OVRSpace_StorageLocation  value) ;

/// @brief Method set_Timeout, addr 0x29219a8, size 0x8, virtual false, abstract: false, final false
inline void set_Timeout(double_t  value) ;

/// @brief Method set_Uuids, addr 0x29219b8, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method AddStorableAndShareableComponents, addr 0x29220a0, size 0x98, virtual false, abstract: false, final false
inline void AddStorableAndShareableComponents() ;

/// @brief Method BindTo, addr 0x2922138, size 0x334, virtual false, abstract: false, final false
inline void BindTo(::GlobalNamespace::OVRSpatialAnchor*  spatialAnchor) ;

/// @brief Method Localize, addr 0x2921d70, size 0xd4, virtual false, abstract: false, final false
inline void Localize(::System::Action_2<::GlobalNamespace::OVRSpatialAnchor_UnboundAnchor,bool>*  onComplete, double_t  timeout) ;

/// @brief Method LocalizeAsync, addr 0x2921e44, size 0xd8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTask_1<bool> LocalizeAsync(double_t  timeout) ;

/// @brief Method ValidateLocalization, addr 0x2921f1c, size 0x184, virtual false, abstract: false, final false
inline void ValidateLocalization() ;

/// @brief Method .ctor, addr 0x29217b8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRSpace  space, ::System::Guid  uuid) ;

/// @brief Method get_Localized, addr 0x2921b3c, size 0x88, virtual false, abstract: false, final false
inline bool get_Localized() ;

/// @brief Method get_Localizing, addr 0x2921bc4, size 0x90, virtual false, abstract: false, final false
inline bool get_Localizing() ;

/// @brief Method get_Pose, addr 0x2921c54, size 0x11c, virtual false, abstract: false, final false
inline ::UnityEngine::Pose get_Pose() ;

/// @brief Method get_Uuid, addr 0x2921b30, size 0xc, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method Log, addr 0x292246c, size 0x8c, virtual false, abstract: false, final false
static inline void Log(::StringW  message) ;

/// @brief Method LogError, addr 0x2922584, size 0x8c, virtual false, abstract: false, final false
static inline void LogError(::StringW  message) ;

/// @brief Method LogRequest, addr 0x2922610, size 0x4, virtual false, abstract: false, final false
static inline void LogRequest(uint64_t  requestId, ::StringW  message) ;

/// @brief Method LogRequestResult, addr 0x2922614, size 0x4, virtual false, abstract: false, final false
static inline void LogRequestResult(uint64_t  requestId, bool  result, ::StringW  successMessage, ::StringW  failureMessage) ;

/// @brief Method LogWarning, addr 0x29224f8, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method <GetListToStoreTheShareRequest>b__41_0, addr 0x292267c, size 0x3c, virtual false, abstract: false, final false
inline int32_t _GetListToStoreTheShareRequest_b__41_0(::GlobalNamespace::OVRSpaceUser  x, ::GlobalNamespace::OVRSpaceUser  y) ;

/// @brief Method .ctor, addr 0x2922674, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field ComponentTypeBuffer, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_ComponentTypeBuffer, put=setStaticF_ComponentTypeBuffer)) ::ArrayW<::GlobalNamespace::OVRPlugin_SpaceComponentType,::Array<::GlobalNamespace::OVRPlugin_SpaceComponentType>*>  ComponentTypeBuffer;
...
/// @brief Field UnboundAnchorBuffer, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_UnboundAnchorBuffer, put=setStaticF_UnboundAnchorBuffer)) ::System::Collections::Generic::List_1<::GlobalNamespace::OVRSpatialAnchor_UnboundAnchor>*  UnboundAnchorBuffer;
...
/// @brief Method AreSortedUserListsEqual, addr 0x291edcc, size 0x294, virtual false, abstract: false, final false
...
/// @brief Method CopyAnchorListIntoListFromPool, addr 0x291d95c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method CreateSpatialAnchor, addr 0x291f334, size 0x160, virtual false, abstract: false, final false
inline void CreateSpatialAnchor() ;

/// @brief Method Erase, addr 0x291f0ec, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method Erase, addr 0x291f0dc, size 0x10, virtual false, abstract: false, final false
inline void Erase(::System::Action_2<::UnityW<::GlobalNamespace::OVRSpatialAnchor>,bool>*  onComplete) ;

/// @brief Method EraseAsync, addr 0x291f270, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTask_1<bool> EraseAsync() ;

/// @brief Method EraseAsync, addr 0x291f19c, size 0xd4, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTask_1<bool> EraseAsync(::GlobalNamespace::OVRSpatialAnchor_EraseOptions  eraseOptions) ;

/// @brief Method FromOVRAnchor, addr 0x2920d0c, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method GetListToStoreTheShareRequest, addr 0x291ea88, size 0x344, virtual false, abstract: false, final false
...
/// @brief Method GetTrackingSpacePose, addr 0x291fa00, size 0xc4, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPose GetTrackingSpacePose() ;

/// @brief Method InitializeFromExisting, addr 0x291cdf4, size 0x200, virtual false, abstract: false, final false
inline void InitializeFromExisting(::GlobalNamespace::OVRSpace  space, ::System::Guid  uuid) ;

/// @brief Method InitializeOnLoad, addr 0x291fca4, size 0xf0, virtual false, abstract: false, final false
static inline void InitializeOnLoad() ;

/// @brief Method InitializeUnchecked, addr 0x291d11c, size 0x138, virtual false, abstract: false, final false
inline void InitializeUnchecked(::GlobalNamespace::OVRSpace  space, ::System::Guid  uuid) ;

/// @brief Method InvokeMultiAnchorDelegate, addr 0x29202e8, size 0x51c, virtual false, abstract: false, final false
...
/// @brief Method LateUpdate, addr 0x291f4a4, size 0x50, virtual false, abstract: false, final false
inline void LateUpdate() ;

/// @brief Method LoadUnboundAnchors, addr 0x29209a8, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method LoadUnboundAnchorsAsync, addr 0x2920aac, size 0x118, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x291f948, size 0xb8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnShareSpacesComplete, addr 0x292190c, size 0x68, virtual false, abstract: false, final false
static inline void OnShareSpacesComplete(uint64_t  requestId, ::GlobalNamespace::OVRSpatialAnchor_OperationResult  result) ;

/// @brief Method OnSpaceEraseComplete, addr 0x29209a4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnSpaceListSaveComplete, addr 0x29218a4, size 0x68, virtual false, abstract: false, final false
static inline void OnSpaceListSaveComplete(uint64_t  requestId, ::GlobalNamespace::OVRSpatialAnchor_OperationResult  result) ;

/// @brief Method OnSpaceQueryComplete, addr 0x292129c, size 0x51c, virtual false, abstract: false, final false
static inline void OnSpaceQueryComplete(uint64_t  requestId, bool  queryResult) ;

/// @brief Method OnSpaceSaveComplete, addr 0x29209a0, size 0x4, virtual false, abstract: false, final false
static inline void OnSpaceSaveComplete(uint64_t  requestId, ::GlobalNamespace::OVRSpace  space, bool  result, ::System::Guid  uuid) ;

/// @brief Method OnSpaceSetComponentStatusComplete, addr 0x29217c4, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method OnSpatialAnchorCreateComplete, addr 0x2920804, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method PopulateUnbound, addr 0x2920f7c, size 0x320, virtual false, abstract: false, final false
static inline void PopulateUnbound(::System::Guid  uuid, uint64_t  space) ;

/// @brief Method Save, addr 0x291d714, size 0x248, virtual false, abstract: false, final false
...
/// @brief Method Save, addr 0x291d254, size 0x10, virtual false, abstract: false, final false
inline void Save(::System::Action_2<::UnityW<::GlobalNamespace::OVRSpatialAnchor>,bool>*  onComplete) ;

/// @brief Method Save, addr 0x291d264, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method SaveAsync, addr 0x291d70c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTask_1<bool> SaveAsync() ;

/// @brief Method SaveAsync, addr 0x291d5ac, size 0x160, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTask_1<bool> SaveAsync(::GlobalNamespace::OVRSpatialAnchor_SaveOptions  saveOptions) ;

/// @brief Method SaveBatchAnchors, addr 0x291f4f4, size 0x1ec, virtual false, abstract: false, final false
static inline void SaveBatchAnchors() ;

/// @brief Method Share, addr 0x291e454, size 0x634, virtual false, abstract: false, final false
...
/// @brief Method Share, addr 0x291d9d4, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method Share, addr 0x291dc7c, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method Share, addr 0x291de4c, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method Share, addr 0x291e08c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method Share, addr 0x291e32c, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method ShareAsync, addr 0x291da74, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method ShareAsync, addr 0x291dd24, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method ShareAsync, addr 0x291df04, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method ShareAsync, addr 0x291e14c, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method ShareAsync, addr 0x291e3cc, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method ShareAsyncInternal, addr 0x291db44, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method ShareBatchAnchors, addr 0x291f6e0, size 0x268, virtual false, abstract: false, final false
static inline void ShareBatchAnchors() ;

/// @brief Method Start, addr 0x291f31c, size 0x18, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method ThrowIfBound, addr 0x291cff4, size 0x128, virtual false, abstract: false, final false
static inline void ThrowIfBound(::System::Guid  uuid) ;

/// @brief Method ToNativeArray, addr 0x291d314, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method TryGetPose, addr 0x291fac4, size 0x1e0, virtual false, abstract: false, final false
static inline bool TryGetPose(::GlobalNamespace::OVRSpace  space, ::ByRef<::GlobalNamespace::OVRPose>  pose) ;

/// @brief Method Update, addr 0x291f494, size 0x10, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateTransform, addr 0x291f278, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2921974, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_OnLocalize, addr 0x291cbc0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_Created, addr 0x291cd44, size 0x10, virtual false, abstract: false, final false
inline bool get_Created() ;

/// @brief Method get_Localized, addr 0x291cd64, size 0x90, virtual false, abstract: false, final false
inline bool get_Localized() ;

/// @brief Method get_PendingCreation, addr 0x291cd54, size 0x10, virtual false, abstract: false, final false
inline bool get_PendingCreation() ;

/// @brief Method get_Space, addr 0x291cd20, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRSpace get_Space() ;

/// @brief Method get_Uuid, addr 0x291cd30, size 0xc, virtual false, abstract: false, final false
inline ::System::Guid get_Uuid() ;

/// @brief Method remove_OnLocalize, addr 0x291cc70, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method set_Space, addr 0x291cd28, size 0x8, virtual false, abstract: false, final false
inline void set_Space(::GlobalNamespace::OVRSpace  value) ;

/// @brief Method set_Uuid, addr 0x291cd3c, size 0x8, virtual false, abstract: false, final false
