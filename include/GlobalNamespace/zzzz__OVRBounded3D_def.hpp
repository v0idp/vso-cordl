...
/// @brief Method ConvertBounds, addr 0x2890f60, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::Bounds ConvertBounds(::GlobalNamespace::OVRPlugin_Boundsf  openXrBounds) ;

/// @brief Method Equals, addr 0x2890c3c, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2890af8, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::OVRBounded3D  other) ;

/// @brief Method GetHashCode, addr 0x2890ccc, size 0x94, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IOVRAnchorComponent<OVRBounded3D>.FromAnchor, addr 0x28908d0, size 0x30, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRBounded3D IOVRAnchorComponent_OVRBounded3D__FromAnchor(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method IOVRAnchorComponent<OVRBounded3D>.SetEnabledAsync, addr 0x2890aac, size 0x4c, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRTask_1<bool> IOVRAnchorComponent_OVRBounded3D__SetEnabledAsync(bool  enabled, double_t  timeout) ;

/// @brief Method IOVRAnchorComponent<OVRBounded3D>.get_Handle, addr 0x289087c, size 0x54, virtual true, abstract: false, final true
inline uint64_t IOVRAnchorComponent_OVRBounded3D__get_Handle() ;

/// @brief Method IOVRAnchorComponent<OVRBounded3D>.get_Type, addr 0x2890824, size 0x50, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRBounded3D__get_Type() ;

/// @brief Method ToString, addr 0x2890d60, size 0xa8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2890900, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRAnchor  anchor) ;

static inline ::GlobalNamespace::OVRBounded3D getStaticF_Null() ;

/// @brief Method get_BoundingBox, addr 0x2890e10, size 0x150, virtual false, abstract: false, final false
inline ::UnityEngine::Bounds get_BoundingBox() ;

/// @brief Method get_Handle, addr 0x2890e08, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_Handle() ;

/// @brief Method get_IsEnabled, addr 0x28909c0, size 0xec, virtual true, abstract: false, final true
inline bool get_IsEnabled() ;

/// @brief Method get_IsNull, addr 0x2890964, size 0x5c, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Type, addr 0x2890874, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2890b60, size 0x6c, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRBounded3D  lhs, ::GlobalNamespace::OVRBounded3D  rhs) ;

/// @brief Method op_Inequality, addr 0x2890bcc, size 0x70, virtual false, abstract: false, final false
