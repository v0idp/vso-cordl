...
public:
// Declarations
/// @brief Method .ctor, addr 0x28d70c0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method GetStyleHandler, addr 0x28d742c, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method SetColorLutHandler, addr 0x28d441c, size 0x58, virtual false, abstract: false, final false
inline void SetColorLutHandler(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method SetInterpolatedColorLutHandler, addr 0x28d45a0, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method SetMonoToMonoHandler, addr 0x28d4a0c, size 0x5c, virtual false, abstract: false, final false
inline void SetMonoToMonoHandler(::ArrayW<uint8_t,::Array<uint8_t>*>  values) ;

/// @brief Method SetMonoToRgbaHandler, addr 0x28d4244, size 0x34, virtual false, abstract: false, final false
inline void SetMonoToRgbaHandler(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  values) ;

/// @brief Method SetStyleHandler, addr 0x28d4d70, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28d70e0, size 0x17c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyStyleSettings, addr 0x28d760c, size 0x4, virtual true, abstract: false, final true
inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x28d7614, size 0x4, virtual true, abstract: false, final true
inline void Clear() ;

static inline ::GlobalNamespace::OVRPassthroughLayer_NoneStyleHandler* New_ctor() ;

/// @brief Method Update, addr 0x28d7610, size 0x4, virtual true, abstract: false, final true
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;

/// @brief Method .ctor, addr 0x28d7384, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsValid, addr 0x28d7604, size 0x8, virtual true, abstract: false, final true
inline bool get_IsValid() ;
...
/// @brief Method AllocateColorMapData, addr 0x28d76c8, size 0x90, virtual true, abstract: false, final false
inline void AllocateColorMapData(uint32_t  size) ;

/// @brief Method ApplyStyleSettings, addr 0x28d7654, size 0x68, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x28d76bc, size 0xc, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method ComputeBrightnessContrastPosterizeMap, addr 0x28d7824, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method DeallocateColorMapData, addr 0x28d7758, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method Update, addr 0x28d7650, size 0x4, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;

/// @brief Method WriteColorToColorMap, addr 0x28d7780, size 0x6c, virtual false, abstract: false, final false
inline void WriteColorToColorMap(int32_t  colorIndex, ::ByRef<::UnityEngine::Color>  color) ;

/// @brief Method WriteFloatToColorMap, addr 0x28d77ec, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28d7620, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_IsValid, addr 0x28d7618, size 0x8, virtual true, abstract: false, final true
inline bool get_IsValid() ;
...
/// @brief Method AllocateColorMapData, addr 0x28d7a68, size 0x68, virtual true, abstract: false, final false
inline void AllocateColorMapData(uint32_t  size) ;

/// @brief Method DeallocateColorMapData, addr 0x28d7ad0, size 0x2c, virtual true, abstract: false, final false
inline void DeallocateColorMapData() ;
...
/// @brief Method Update, addr 0x28d79ac, size 0xbc, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;

/// @brief Method Update, addr 0x28d754c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28d73cc, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method get_MapSize, addr 0x28d79a4, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_MapSize() ;
...
/// @brief Method Update, addr 0x28d7b04, size 0x38, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;

/// @brief Method Update, addr 0x28d75c0, size 0x44, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  values) ;

/// @brief Method .ctor, addr 0x28d739c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method get_MapSize, addr 0x28d7afc, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_MapSize() ;
...
/// @brief Method Update, addr 0x28d7b44, size 0xb4, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;

/// @brief Method .ctor, addr 0x28d73fc, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method get_MapSize, addr 0x28d7b3c, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_MapSize() ;
...
/// @brief Method ApplyStyleSettings, addr 0x28d7c2c, size 0x28, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x28d7dfc, size 0x8, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method GetColorLutForTexture, addr 0x28d7ca8, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x28d7504, size 0x20, virtual false, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method Update, addr 0x28d7c54, size 0x54, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;
...
/// @brief Method .ctor, addr 0x28d738c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsValid, addr 0x28d7c18, size 0x8, virtual true, abstract: false, final true
inline bool get_IsValid() ;

/// @brief Method get_Lut, addr 0x28d7bf8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPassthroughColorLut* get_Lut() ;

/// @brief Method get_Weight, addr 0x28d7c08, size 0x8, virtual false, abstract: false, final false
inline float_t get_Weight() ;

/// @brief Convert to "::GlobalNamespace::OVRPassthroughLayer_IStyleHandler"
constexpr ::GlobalNamespace::OVRPassthroughLayer_IStyleHandler* i___GlobalNamespace__OVRPassthroughLayer_IStyleHandler() noexcept;

/// @brief Method set_IsValid, addr 0x28d7c20, size 0xc, virtual false, abstract: false, final false
inline void set_IsValid(bool  value) ;

/// @brief Method set_Lut, addr 0x28d7c00, size 0x8, virtual false, abstract: false, final false
inline void set_Lut(::GlobalNamespace::OVRPassthroughColorLut*  value) ;

/// @brief Method set_Weight, addr 0x28d7c10, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ApplyStyleSettings, addr 0x28d7e14, size 0x38, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x28d7ec8, size 0xc, virtual true, abstract: false, final false
inline void Clear() ;

static inline ::GlobalNamespace::OVRPassthroughLayer_InterpolatedColorLutHandler* New_ctor() ;

/// @brief Method Update, addr 0x28d7524, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x28d7e4c, size 0x7c, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;
...
/// @brief Method .ctor, addr 0x28d7394, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_LutTarget, addr 0x28d7e04, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPassthroughColorLut* get_LutTarget() ;

/// @brief Method set_LutTarget, addr 0x28d7e0c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <IsSurfaceGeometry>b__0, addr 0x28d7ed4, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28d3ff4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <RemoveSurfaceGeometry>b__0, addr 0x28d7f40, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28d3d44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddDeferredSurfaceGeometries, addr 0x28d4e40, size 0x248, virtual false, abstract: false, final false
inline void AddDeferredSurfaceGeometries() ;

/// @brief Method AddSurfaceGeometry, addr 0x28d392c, size 0x1f8, virtual false, abstract: false, final false
inline void AddSurfaceGeometry(::UnityEngine::GameObject*  obj, bool  updateTransform) ;

/// @brief Method Awake, addr 0x28d6548, size 0x224, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ClampWeight, addr 0x28d437c, size 0xa0, virtual false, abstract: false, final false
static inline float_t ClampWeight(float_t  weight) ;

/// @brief Method CreateAndAddMesh, addr 0x28d5088, size 0x2bc, virtual false, abstract: false, final false
...
/// @brief Method CreateNeutralColorMapGradient, addr 0x28d479c, size 0x1d0, virtual false, abstract: false, final false
static inline ::UnityEngine::Gradient* CreateNeutralColorMapGradient() ;

/// @brief Method CreateOvrPluginStyleObject, addr 0x28d68d8, size 0x128, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2 CreateOvrPluginStyleObject() ;

/// @brief Method DestroySurfaceGeometries, addr 0x28d5928, size 0x27c, virtual false, abstract: false, final false
inline void DestroySurfaceGeometries(bool  addBackToDeferredQueue) ;

/// @brief Method DisableColorMap, addr 0x28d4d60, size 0x8, virtual false, abstract: false, final false
inline void DisableColorMap() ;

/// @brief Method GetTransformMatrixForPassthroughSurfaceObject, addr 0x28d5344, size 0x320, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 GetTransformMatrixForPassthroughSurfaceObject(::UnityEngine::Matrix4x4  worldFromObj) ;

/// @brief Method HasControlsBasedColorMap, addr 0x28d6154, size 0x28, virtual false, abstract: false, final false
inline bool HasControlsBasedColorMap() ;

/// @brief Method IsSurfaceGeometry, addr 0x28d3edc, size 0x118, virtual false, abstract: false, final false
inline bool IsSurfaceGeometry(::UnityEngine::GameObject*  obj) ;

/// @brief Method IsUserDefinedAndDoesNotContainSurfaceGeometry, addr 0x28d64a8, size 0x8c, virtual false, abstract: false, final false
inline bool IsUserDefinedAndDoesNotContainSurfaceGeometry() ;

/// @brief Method LateUpdate, addr 0x28d6770, size 0x168, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::OVRPassthroughLayer* New_ctor() ;

/// @brief Method OnDestroy, addr 0x28d6e7c, size 0x8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x28d6dac, size 0xd0, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x28d6c14, size 0x198, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RemoveSurfaceGeometry, addr 0x28d3b24, size 0x220, virtual false, abstract: false, final false
inline void RemoveSurfaceGeometry(::UnityEngine::GameObject*  obj) ;

/// @brief Method SetBrightnessContrastSaturation, addr 0x28d4a68, size 0x4c, virtual false, abstract: false, final false
inline void SetBrightnessContrastSaturation(float_t  brightness, float_t  contrast, float_t  saturation) ;

/// @brief Method SetColorLut, addr 0x28d4278, size 0x104, virtual false, abstract: false, final false
inline void SetColorLut(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method SetColorLut, addr 0x28d4474, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method SetColorMap, addr 0x28d40d0, size 0x9c, virtual false, abstract: false, final false
inline void SetColorMap(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  values) ;

/// @brief Method SetColorMapControls, addr 0x28d4604, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method SetColorMapMonochromatic, addr 0x28d496c, size 0xa0, virtual false, abstract: false, final false
inline void SetColorMapMonochromatic(::ArrayW<uint8_t,::Array<uint8_t>*>  values) ;

/// @brief Method SetStyleDirty, addr 0x28d4e34, size 0xc, virtual false, abstract: false, final false
inline void SetStyleDirty() ;

/// @brief Method SyncToOverlay, addr 0x28d617c, size 0x32c, virtual false, abstract: false, final false
inline void SyncToOverlay() ;

/// @brief Method Update, addr 0x28d676c, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateColorMapFromControls, addr 0x28d4ab4, size 0x2ac, virtual false, abstract: false, final false
inline void UpdateColorMapFromControls(bool  forceUpdate) ;

/// @brief Method UpdateSurfaceGeometryTransform, addr 0x28d5ea4, size 0x1b0, virtual false, abstract: false, final false
inline void UpdateSurfaceGeometryTransform(uint64_t  instanceHandle, ::UnityEngine::Matrix4x4  localToWorld) ;

/// @brief Method UpdateSurfaceGeometryTransforms, addr 0x28d5ba4, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28d6e84, size 0x23c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_colorMapEditorType, addr 0x28d4d68, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPassthroughLayer_ColorMapEditorType get_colorMapEditorType() ;

/// @brief Method get_edgeColor, addr 0x28d4060, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_edgeColor() ;

/// @brief Method get_edgeRenderingEnabled, addr 0x28d4038, size 0x8, virtual false, abstract: false, final false
inline bool get_edgeRenderingEnabled() ;

/// @brief Method get_overlayShape, addr 0x28d6534, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVROverlay_OverlayShape get_overlayShape() ;

/// @brief Method get_textureOpacity, addr 0x28d3ffc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_colorMapEditorType, addr 0x28d416c, size 0xd8, virtual false, abstract: false, final false
inline void set_colorMapEditorType(::GlobalNamespace::OVRPassthroughLayer_ColorMapEditorType  value) ;

/// @brief Method set_edgeColor, addr 0x28d4070, size 0x60, virtual false, abstract: false, final false
inline void set_edgeColor(::UnityEngine::Color  value) ;

/// @brief Method set_edgeRenderingEnabled, addr 0x28d4040, size 0x20, virtual false, abstract: false, final false
inline void set_edgeRenderingEnabled(bool  value) ;

/// @brief Method set_textureOpacity, addr 0x28d4004, size 0x34, virtual false, abstract: false, final false
