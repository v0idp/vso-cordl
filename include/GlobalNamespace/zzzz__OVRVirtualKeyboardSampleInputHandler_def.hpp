...
/// @brief Method ApplyDeadzone, addr 0x293197c, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x2931d10, size 0xc4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x2931dd4, size 0x18, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateInteractionAnchor, addr 0x2931dec, size 0x2b0, virtual false, abstract: false, final false
inline void UpdateInteractionAnchor() ;

/// @brief Method UpdateLineRenderer, addr 0x293209c, size 0x68, virtual false, abstract: false, final false
inline void UpdateLineRenderer() ;

/// @brief Method UpdateLineRendererFromSource, addr 0x2932104, size 0x760, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2932884, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_AnalogStickX, addr 0x29319cc, size 0xc4, virtual false, abstract: false, final false
inline float_t get_AnalogStickX() ;

/// @brief Method get_AnalogStickY, addr 0x2931a90, size 0xc4, virtual false, abstract: false, final false
inline float_t get_AnalogStickY() ;

/// @brief Method get_InputRayPosition, addr 0x2931b54, size 0x24, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_InputRayPosition() ;

/// @brief Method get_InputRayRotation, addr 0x2931b78, size 0x198, virtual false, abstract: false, final false
