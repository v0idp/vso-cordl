...
/// @brief Method IsEmulationActivated, addr 0x28a8f58, size 0xc8, virtual false, abstract: false, final false
inline bool IsEmulationActivated() ;

/// @brief Method IsTweakingPitch, addr 0x28a9020, size 0x7c, virtual false, abstract: false, final false
inline bool IsTweakingPitch() ;

static inline ::GlobalNamespace::OVRHeadsetEmulator* New_ctor() ;

/// @brief Method Start, addr 0x28a8af0, size 0x4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x28a8af4, size 0x464, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x28a909c, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;
