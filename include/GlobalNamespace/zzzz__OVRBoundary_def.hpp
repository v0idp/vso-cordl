...
/// @brief Method GetConfigured, addr 0x2888f9c, size 0x98, virtual false, abstract: false, final false
inline bool GetConfigured() ;

/// @brief Method GetDimensions, addr 0x2893fa0, size 0xd0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetDimensions(::GlobalNamespace::OVRBoundary_BoundaryType  boundaryType) ;

/// @brief Method GetGeometry, addr 0x2889034, size 0x3c4, virtual false, abstract: false, final false
...
/// @brief Method GetVisible, addr 0x2894074, size 0x98, virtual false, abstract: false, final false
inline bool GetVisible() ;

static inline ::GlobalNamespace::OVRBoundary* New_ctor() ;

/// @brief Method SetVisible, addr 0x289410c, size 0x9c, virtual false, abstract: false, final false
inline void SetVisible(bool  value) ;

/// @brief Method TestNode, addr 0x2893da4, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method TestPoint, addr 0x2893e60, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28941a8, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
