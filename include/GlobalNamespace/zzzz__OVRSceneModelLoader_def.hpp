...
/// @brief Method MoveNext, addr 0x29164a8, size 0x98, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::GlobalNamespace::OVRSceneModelLoader__AttemptToLoadSceneModel_d__7* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2916540, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x2916548, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2916580, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x29164a4, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2916024, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method AttemptToLoadSceneModel, addr 0x2915fc4, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* AttemptToLoadSceneModel() ;

/// @brief Method LoadSceneModel, addr 0x2916050, size 0xf4, virtual false, abstract: false, final false
inline void LoadSceneModel() ;

static inline ::GlobalNamespace::OVRSceneModelLoader* New_ctor() ;

/// @brief Method OnNewSceneModelAvailable, addr 0x29162c8, size 0x9c, virtual true, abstract: false, final false
inline void OnNewSceneModelAvailable() ;

/// @brief Method OnNoSceneModelToLoad, addr 0x29161e0, size 0xe8, virtual true, abstract: false, final false
inline void OnNoSceneModelToLoad() ;

/// @brief Method OnSceneCaptureReturnedWithoutError, addr 0x2916364, size 0x9c, virtual true, abstract: false, final false
inline void OnSceneCaptureReturnedWithoutError() ;

/// @brief Method OnSceneModelLoadedSuccessfully, addr 0x2916144, size 0x9c, virtual true, abstract: false, final false
inline void OnSceneModelLoadedSuccessfully() ;

/// @brief Method OnStart, addr 0x291604c, size 0x4, virtual true, abstract: false, final false
inline void OnStart() ;

/// @brief Method OnUnexpectedErrorWithSceneCapture, addr 0x2916400, size 0x9c, virtual true, abstract: false, final false
inline void OnUnexpectedErrorWithSceneCapture() ;

/// @brief Method Start, addr 0x2915d40, size 0x284, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x291649c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_SceneManager, addr 0x2915d30, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRSceneManager> get_SceneManager() ;

/// @brief Method set_SceneManager, addr 0x2915d38, size 0x8, virtual false, abstract: false, final false
