...
/// @brief Method GetErrorMessage, addr 0x25c8940, size 0x64, virtual false, abstract: false, final false
inline ::StringW GetErrorMessage() ;

/// @brief Method ToString, addr 0x25c8b8c, size 0xd4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x25c8a0c, size 0x68, virtual false, abstract: false, final false
inline void _ctor(int32_t  _cordl_errno) ;

/// @brief Method .ctor, addr 0x25c8a78, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::Interop_Error  error) ;

/// @brief Method get_Error, addr 0x25c8a84, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::Interop_Error get_Error() ;

/// @brief Method get_RawErrno, addr 0x25c88d4, size 0x6c, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method GetName, addr 0x25c9534, size 0x124, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "Name", ty: "::cordl_internals::Ptr<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "NameLength", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "InodeType", ty: "::GlobalNamespace::Sys_Interop_NodeType", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "ASec", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "AUSec", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "MSec", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "MUSec", ty: "int64_t", modifiers: "", def_value: None }]
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::Sys_Interop_TimeValPair, 0x20>, "Size mismatch!");
...
/// @brief Method CloseDir, addr 0x25c8ca0, size 0x1c, virtual false, abstract: false, final false
static inline int32_t CloseDir(::System::IntPtr  dir) ;

/// @brief Method ConvertErrorPalToPlatform, addr 0x25c8a8c, size 0x4, virtual false, abstract: false, final false
static inline int32_t ConvertErrorPalToPlatform(::GlobalNamespace::Interop_Error  error) ;

/// @brief Method ConvertErrorPlatformToPal, addr 0x25c8a74, size 0x4, virtual false, abstract: false, final false
static inline ::GlobalNamespace::Interop_Error ConvertErrorPlatformToPal(int32_t  platformErrno) ;

/// @brief Method CopyFile, addr 0x25c8fec, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method DoubleToString, addr 0x25c94dc, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method GetEGid, addr 0x25c90a0, size 0x4, virtual false, abstract: false, final false
static inline uint32_t GetEGid() ;

/// @brief Method GetEUid, addr 0x25c90a4, size 0x4, virtual false, abstract: false, final false
static inline uint32_t GetEUid() ;

/// @brief Method GetLastErrorInfo, addr 0x25c8758, size 0x68, virtual false, abstract: false, final false
static inline ::GlobalNamespace::Interop_ErrorInfo GetLastErrorInfo() ;

/// @brief Method GetNonCryptographicallySecureRandomBytes, addr 0x25c8a08, size 0x4, virtual false, abstract: false, final false
static inline void GetNonCryptographicallySecureRandomBytes(::cordl_internals::Ptr<uint8_t>  buffer, int32_t  length) ;

/// @brief Method GetReadDirRBufferSize, addr 0x25c8c98, size 0x4, virtual false, abstract: false, final false
static inline int32_t GetReadDirRBufferSize() ;

/// @brief Method LChflagsCanSetHiddenFlag, addr 0x25c90a8, size 0x4, virtual false, abstract: false, final false
static inline int32_t LChflagsCanSetHiddenFlag() ;

/// @brief Method LStat, addr 0x25c9318, size 0x1c, virtual false, abstract: false, final false
static inline int32_t LStat(::ByRef<uint8_t>  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method LStat, addr 0x25c8f5c, size 0x3c, virtual false, abstract: false, final false
static inline int32_t LStat(::StringW  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method LStat, addr 0x25c9334, size 0x138, virtual false, abstract: false, final false
static inline int32_t LStat(::System::ReadOnlySpan_1<char16_t>  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method Link, addr 0x25c90ac, size 0x54, virtual false, abstract: false, final false
static inline int32_t Link(::StringW  source, ::StringW  link) ;

/// @brief Method MkDir, addr 0x25c9100, size 0x3c, virtual false, abstract: false, final false
static inline int32_t MkDir(::StringW  path, int32_t  mode) ;

/// @brief Method OpenDir, addr 0x25c8c64, size 0x34, virtual false, abstract: false, final false
static inline ::System::IntPtr OpenDir(::StringW  path) ;

/// @brief Method ReadDirR, addr 0x25c8c9c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ReadLink, addr 0x25c8d08, size 0x218, virtual false, abstract: false, final false
static inline ::StringW ReadLink(::StringW  path) ;

/// @brief Method ReadLink, addr 0x25c8cbc, size 0x4c, virtual false, abstract: false, final false
static inline int32_t ReadLink(::StringW  path, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  bufferSize) ;

/// @brief Method Rename, addr 0x25c913c, size 0x54, virtual false, abstract: false, final false
static inline int32_t Rename(::StringW  oldPath, ::StringW  newPath) ;

/// @brief Method RmDir, addr 0x25c9190, size 0x34, virtual false, abstract: false, final false
static inline int32_t RmDir(::StringW  path) ;

/// @brief Method Stat, addr 0x25c91c4, size 0x1c, virtual false, abstract: false, final false
static inline int32_t Stat(::ByRef<uint8_t>  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method Stat, addr 0x25c8f20, size 0x3c, virtual false, abstract: false, final false
static inline int32_t Stat(::StringW  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method Stat, addr 0x25c91e0, size 0x138, virtual false, abstract: false, final false
static inline int32_t Stat(::System::ReadOnlySpan_1<char16_t>  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method StrError, addr 0x25c8a90, size 0xfc, virtual false, abstract: false, final false
static inline ::StringW StrError(int32_t  platformErrno) ;

/// @brief Method StrErrorR, addr 0x25c8c60, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method Symlink, addr 0x25c8f98, size 0x54, virtual false, abstract: false, final false
static inline int32_t Symlink(::StringW  target, ::StringW  linkPath) ;

/// @brief Method UTimes, addr 0x25c946c, size 0x3c, virtual false, abstract: false, final false
static inline int32_t UTimes(::StringW  path, ::ByRef<::GlobalNamespace::Sys_Interop_TimeValPair>  times) ;

/// @brief Method Unlink, addr 0x25c94a8, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method CheckIo, addr 0x25c87c0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method CheckIo, addr 0x25c86e0, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method GetExceptionForIoErrno, addr 0x25c81f4, size 0x4ec, virtual false, abstract: false, final false
...
/// @brief Method GetIOException, addr 0x25c8850, size 0x84, virtual false, abstract: false, final false
static inline ::System::Exception* GetIOException(::GlobalNamespace::Interop_ErrorInfo  errorInfo) ;

/// @brief Method GetRandomBytes, addr 0x25c89a4, size 0x64, virtual false, abstract: false, final false
static inline void GetRandomBytes(::cordl_internals::Ptr<uint8_t>  buffer, int32_t  length) ;

/// @brief Method ThrowExceptionForIoErrno, addr 0x25c819c, size 0x58, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::Sys_Interop_TimeValPair, "", "Interop/Sys/TimeValPair");
