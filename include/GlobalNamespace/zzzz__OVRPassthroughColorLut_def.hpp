...
/// @brief Method Execute, addr 0x29572a4, size 0xa0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x29575dc, size 0x18, virtual false, abstract: false, final false
inline void _ctor(int32_t  width, int32_t  height, int32_t  resolution, int32_t  slicesPerRow, int32_t  channelCount, bool  flipY) ;

/// @brief Method get_ChannelCount, addr 0x29576b4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ChannelCount() ;

/// @brief Method get_FlipY, addr 0x29576bc, size 0x8, virtual false, abstract: false, final false
inline bool get_FlipY() ;

/// @brief Method get_Height, addr 0x295769c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Height() ;

/// @brief Method get_Resolution, addr 0x29576a4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Resolution() ;

/// @brief Method get_SlicesPerRow, addr 0x29576ac, size 0x8, virtual false, abstract: false, final false
inline int32_t get_SlicesPerRow() ;

/// @brief Method get_Width, addr 0x2957694, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Execute, addr 0x29575f4, size 0xa0, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;
...
// Ctor Parameters [CppParam { name: "settings", ty: "::GlobalNamespace::ColorLutTextureConverter_OVRPassthroughColorLut_TextureSettings", modifiers: "", def_value: None }, CppParam { name: "target", ty: "::Unity::Collections::NativeArray_1<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "source", ty: "::Unity::Collections::NativeArray_1<uint8_t>", modifiers: "", def_value: None }]
...
/// @brief Method GetTextureSettings, addr 0x2957344, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method MapColorValues, addr 0x2957440, size 0x19c, virtual false, abstract: false, final false
static inline void MapColorValues(::GlobalNamespace::ColorLutTextureConverter_OVRPassthroughColorLut_TextureSettings  settings, ::Unity::Collections::NativeArray_1<uint8_t>  source, ::ArrayW<uint8_t,::Array<uint8_t>*>  target) ;

/// @brief Method TextureToColorByteMap, addr 0x29567a0, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method TryGetTextureLayout, addr 0x2956c88, size 0x224, virtual false, abstract: false, final false
...
// Dependencies OVRPassthroughColorLut::ColorChannels, OVRPassthroughColorLut::CreateState, OVRPlugin::PassthroughColorLutData, System.IDisposable, System.Object, System.Runtime.InteropServices.GCHandle
namespace GlobalNamespace {
// Is value type: false
...
/// @brief Method ChannelsToCount, addr 0x2957024, size 0x10, virtual false, abstract: false, final false
static inline int32_t ChannelsToCount(::GlobalNamespace::OVRPassthroughColorLut_ColorChannels  channels) ;

/// @brief Method Create, addr 0x2955b94, size 0x14c, virtual false, abstract: false, final false
inline void Create(::GlobalNamespace::OVRPlugin_PassthroughColorLutData  lutData) ;

/// @brief Method CreateLutData, addr 0x295717c, size 0x94, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_PassthroughColorLutData CreateLutData(::ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  colorBytes) ;

/// @brief Method CreateLutDataFromArray, addr 0x2955d7c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method CreateLutDataFromArray, addr 0x2955e64, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method CreateLutDataFromArray, addr 0x295601c, size 0x58, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_PassthroughColorLutData CreateLutDataFromArray(::ArrayW<uint8_t,::Array<uint8_t>*>  colors) ;

/// @brief Method CreateLutDataFromTexture, addr 0x2955b3c, size 0x58, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_PassthroughColorLutData CreateLutDataFromTexture(::UnityEngine::Texture2D*  lut, bool  flipY) ;

/// @brief Method Destroy, addr 0x2956998, size 0x114, virtual false, abstract: false, final false
inline void Destroy() ;

/// @brief Method Dispose, addr 0x2956854, size 0x144, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Finalize, addr 0x2957210, size 0x94, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method FreeAllocHandle, addr 0x2956aac, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method GetChannelsForTextureFormat, addr 0x295585c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method GetResolutionFromSize, addr 0x2956eac, size 0xb4, virtual false, abstract: false, final false
static inline uint32_t GetResolutionFromSize(int32_t  size) ;

/// @brief Method GetTextureSize, addr 0x2955780, size 0xdc, virtual false, abstract: false, final false
static inline int32_t GetTextureSize(::UnityEngine::Texture2D*  texture) ;

/// @brief Method GetTextureSizeFromByteArray, addr 0x2955f0c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method InternalCreate, addr 0x2957054, size 0xf0, virtual false, abstract: false, final false
inline void InternalCreate() ;

/// @brief Method IsPowerOfTwo, addr 0x2957034, size 0x20, virtual false, abstract: false, final false
static inline bool IsPowerOfTwo(uint32_t  x) ;

/// @brief Method IsResolutionAccepted, addr 0x2956f60, size 0xc4, virtual false, abstract: false, final false
static inline bool IsResolutionAccepted(uint32_t  resolution, int32_t  size, ::ByRef<::StringW>  errorMessage) ;

/// @brief Method IsTextureSupported, addr 0x2956adc, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method IsValidUpdateResolution, addr 0x295667c, size 0x124, virtual false, abstract: false, final false
inline bool IsValidUpdateResolution(int32_t  lutSize, int32_t  elementByteSize) ;

static inline ::GlobalNamespace::OVRPassthroughColorLut* New_ctor(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  initialColorLut, ::GlobalNamespace::OVRPassthroughColorLut_ColorChannels  channels) ;

static inline ::GlobalNamespace::OVRPassthroughColorLut* New_ctor(::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>  initialColorLut, ::GlobalNamespace::OVRPassthroughColorLut_ColorChannels  channels) ;
...
/// @brief Method Recreate, addr 0x2957164, size 0x18, virtual false, abstract: false, final false
inline void Recreate() ;

/// @brief Method RefreshIfInitialized, addr 0x2957144, size 0x20, virtual false, abstract: false, final false
inline void RefreshIfInitialized(bool  isInitialized) ;

/// @brief Method UpdateFrom, addr 0x2956074, size 0xc0, virtual false, abstract: false, final false
inline void UpdateFrom(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  colors) ;

/// @brief Method UpdateFrom, addr 0x295636c, size 0xc0, virtual false, abstract: false, final false
inline void UpdateFrom(::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>  colors) ;

/// @brief Method UpdateFrom, addr 0x29564f8, size 0xcc, virtual false, abstract: false, final false
inline void UpdateFrom(::ArrayW<uint8_t,::Array<uint8_t>*>  colors) ;

/// @brief Method UpdateFrom, addr 0x29565c4, size 0xb8, virtual false, abstract: false, final false
inline void UpdateFrom(::UnityEngine::Texture2D*  lutTexture, bool  flipY) ;

/// @brief Method WriteColorsAsBytes, addr 0x2956134, size 0x238, virtual false, abstract: false, final false
...
/// @brief Method WriteColorsAsBytes, addr 0x295642c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2955ce0, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2955dc8, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2955eb0, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29556ec, size 0x94, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture2D*  initialLutTexture, bool  flipY) ;

/// @brief Method .ctor, addr 0x29558f4, size 0x248, virtual false, abstract: false, final false
inline void _ctor(int32_t  size, ::GlobalNamespace::OVRPassthroughColorLut_ColorChannels  channels) ;

/// @brief Method get_Channels, addr 0x29556bc, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPassthroughColorLut_ColorChannels get_Channels() ;

/// @brief Method get_IsInitialized, addr 0x29556cc, size 0x10, virtual false, abstract: false, final false
inline bool get_IsInitialized() ;

/// @brief Method get_IsValid, addr 0x29556dc, size 0x10, virtual false, abstract: false, final false
inline bool get_IsValid() ;

/// @brief Method get_Resolution, addr 0x29556ac, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_Resolution() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method set_Channels, addr 0x29556c4, size 0x8, virtual false, abstract: false, final false
inline void set_Channels(::GlobalNamespace::OVRPassthroughColorLut_ColorChannels  value) ;

/// @brief Method set_Resolution, addr 0x29556b4, size 0x8, virtual false, abstract: false, final false
