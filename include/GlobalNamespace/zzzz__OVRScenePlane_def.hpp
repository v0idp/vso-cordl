...
/// @brief Method Execute, addr 0x291733c, size 0x94, virtual true, abstract: false, final true
inline void Execute() ;
...
/// @brief Method Execute, addr 0x2917488, size 0xb8, virtual true, abstract: false, final true
inline void Execute() ;

/// @brief Method HasBoundaryChanged, addr 0x29173d0, size 0xa4, virtual false, abstract: false, final false
inline bool HasBoundaryChanged() ;

/// @brief Method SetNaN, addr 0x2917474, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Awake, addr 0x29168f0, size 0xe4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method IOVRSceneComponent.Initialize, addr 0x29169d8, size 0x4, virtual true, abstract: false, final true
inline void IOVRSceneComponent_Initialize() ;

static inline ::GlobalNamespace::OVRScenePlane* New_ctor() ;

/// @brief Method OnDisable, addr 0x29171e0, size 0xd8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method RequestBoundary, addr 0x2913bec, size 0x30, virtual false, abstract: false, final false
inline void RequestBoundary() ;

/// @brief Method ScheduleGetLengthJob, addr 0x29169dc, size 0x194, virtual false, abstract: false, final false
inline void ScheduleGetLengthJob() ;

/// @brief Method SetChildOffset, addr 0x29167c4, size 0x12c, virtual false, abstract: false, final false
inline void SetChildOffset() ;

/// @brief Method SetChildScale, addr 0x2916628, size 0x144, virtual false, abstract: false, final false
inline void SetChildScale() ;

/// @brief Method Start, addr 0x29169d4, size 0x4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x2916b70, size 0x640, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateTransform, addr 0x2913a64, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x29172b8, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Boundary, addr 0x29165c8, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::UnityEngine::Vector2>* get_Boundary() ;

/// @brief Method get_Dimensions, addr 0x29165c0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_Dimensions() ;

/// @brief Method get_Height, addr 0x29165a0, size 0x8, virtual false, abstract: false, final false
inline float_t get_Height() ;

/// @brief Method get_Offset, addr 0x29165b0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_Offset() ;

/// @brief Method get_OffsetChildren, addr 0x291676c, size 0x8, virtual false, abstract: false, final false
inline bool get_OffsetChildren() ;

/// @brief Method get_ScaleChildren, addr 0x29165d0, size 0x8, virtual false, abstract: false, final false
inline bool get_ScaleChildren() ;

/// @brief Method get_Width, addr 0x2916590, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Height, addr 0x29165a8, size 0x8, virtual false, abstract: false, final false
inline void set_Height(float_t  value) ;

/// @brief Method set_Offset, addr 0x29165b8, size 0x8, virtual false, abstract: false, final false
inline void set_Offset(::UnityEngine::Vector2  value) ;

/// @brief Method set_OffsetChildren, addr 0x2916774, size 0x50, virtual false, abstract: false, final false
inline void set_OffsetChildren(bool  value) ;

/// @brief Method set_ScaleChildren, addr 0x29165d8, size 0x50, virtual false, abstract: false, final false
inline void set_ScaleChildren(bool  value) ;

/// @brief Method set_Width, addr 0x2916598, size 0x8, virtual false, abstract: false, final false
