...
// Dependencies OVRHand::Hand, OVRHand::TrackingConfidence, OVRInput::InputDeviceShowState, OVRMesh::IOVRMeshDataProvider, OVRMeshRenderer::IOVRMeshRendererDataProvider, OVRPlugin::HandState, OVRSkeleton::IOVRSkeletonDataProvider, OVRSkeletonRenderer::IOVRSkeletonRendererDataProvider, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
// CS Name: OVRHand
...
/// @brief Method Awake, addr 0x293f6c0, size 0xcc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method FixedUpdate, addr 0x293f9fc, size 0x74, virtual false, abstract: false, final false
inline void FixedUpdate() ;

/// @brief Method GetFingerConfidence, addr 0x293fab0, size 0x44, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRHand_TrackingConfidence GetFingerConfidence(::GlobalNamespace::OVRHand_HandFinger  finger) ;

/// @brief Method GetFingerIsPinching, addr 0x2932864, size 0x20, virtual false, abstract: false, final false
inline bool GetFingerIsPinching(::GlobalNamespace::OVRHand_HandFinger  finger) ;

/// @brief Method GetFingerPinchStrength, addr 0x293fa70, size 0x40, virtual false, abstract: false, final false
inline float_t GetFingerPinchStrength(::GlobalNamespace::OVRHand_HandFinger  finger) ;

/// @brief Method GetHandState, addr 0x293f78c, size 0x268, virtual false, abstract: false, final false
inline void GetHandState(::GlobalNamespace::OVRPlugin_Step  step) ;

static inline ::GlobalNamespace::OVRHand* New_ctor() ;

/// @brief Method OVRMeshRenderer.IOVRMeshRendererDataProvider.GetMeshRendererData, addr 0x293fc38, size 0x48, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRMeshRenderer_MeshRendererData OVRMeshRenderer_IOVRMeshRendererDataProvider_GetMeshRendererData() ;

/// @brief Method OVRMesh.IOVRMeshDataProvider.GetMeshType, addr 0x293fc20, size 0x18, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRMesh_MeshType OVRMesh_IOVRMeshDataProvider_GetMeshType() ;

/// @brief Method OVRSkeletonRenderer.IOVRSkeletonRendererDataProvider.GetSkeletonRendererData, addr 0x293fbcc, size 0x54, virtual true, abstract: false, final true
...
/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonPoseData, addr 0x293fb0c, size 0xc0, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRSkeleton_SkeletonPoseData OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonPoseData() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonType, addr 0x293faf4, size 0x18, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRSkeleton_SkeletonType OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonType() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.get_enabled, addr 0x293fdf8, size 0x8, virtual true, abstract: false, final true
inline bool OVRSkeleton_IOVRSkeletonDataProvider_get_enabled() ;

/// @brief Method OnValidate, addr 0x293fc80, size 0x160, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method Update, addr 0x293f9f4, size 0x8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x293fde0, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_HandConfidence, addr 0x293f69c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRHand_TrackingConfidence get_HandConfidence() ;

/// @brief Method get_HandScale, addr 0x293f68c, size 0x8, virtual false, abstract: false, final false
inline float_t get_HandScale() ;

/// @brief Method get_IsDataHighConfidence, addr 0x293f62c, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDataHighConfidence() ;

/// @brief Method get_IsDataValid, addr 0x293f618, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDataValid() ;

/// @brief Method get_IsDominantHand, addr 0x293f6ac, size 0x8, virtual false, abstract: false, final false
inline bool get_IsDominantHand() ;

/// @brief Method get_IsPointerPoseValid, addr 0x293f668, size 0x8, virtual false, abstract: false, final false
inline bool get_IsPointerPoseValid() ;

/// @brief Method get_IsSystemGestureInProgress, addr 0x293f654, size 0x8, virtual false, abstract: false, final false
inline bool get_IsSystemGestureInProgress() ;

/// @brief Method get_IsTracked, addr 0x293f640, size 0x8, virtual false, abstract: false, final false
inline bool get_IsTracked() ;

/// @brief Method get_PointerPose, addr 0x293f67c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_HandConfidence, addr 0x293f6a4, size 0x8, virtual false, abstract: false, final false
inline void set_HandConfidence(::GlobalNamespace::OVRHand_TrackingConfidence  value) ;

/// @brief Method set_HandScale, addr 0x293f694, size 0x8, virtual false, abstract: false, final false
inline void set_HandScale(float_t  value) ;

/// @brief Method set_IsDataHighConfidence, addr 0x293f634, size 0xc, virtual false, abstract: false, final false
inline void set_IsDataHighConfidence(bool  value) ;

/// @brief Method set_IsDataValid, addr 0x293f620, size 0xc, virtual false, abstract: false, final false
inline void set_IsDataValid(bool  value) ;

/// @brief Method set_IsDominantHand, addr 0x293f6b4, size 0xc, virtual false, abstract: false, final false
inline void set_IsDominantHand(bool  value) ;

/// @brief Method set_IsPointerPoseValid, addr 0x293f670, size 0xc, virtual false, abstract: false, final false
inline void set_IsPointerPoseValid(bool  value) ;

/// @brief Method set_IsSystemGestureInProgress, addr 0x293f65c, size 0xc, virtual false, abstract: false, final false
inline void set_IsSystemGestureInProgress(bool  value) ;

/// @brief Method set_IsTracked, addr 0x293f648, size 0xc, virtual false, abstract: false, final false
inline void set_IsTracked(bool  value) ;

/// @brief Method set_PointerPose, addr 0x293f684, size 0x8, virtual false, abstract: false, final false
