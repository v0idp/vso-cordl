...
/// @brief Method CacheAudioData, addr 0x288c650, size 0x138, virtual false, abstract: false, final false
inline void CacheAudioData(::ArrayW<float_t,::Array<float_t>*>  data, int32_t  channels) ;

/// @brief Method CastMrcFrame, addr 0x288b114, size 0x1e4, virtual false, abstract: false, final false
inline int32_t CastMrcFrame(int32_t  castTextureIndex) ;

/// @brief Method Cleanup, addr 0x288c46c, size 0x1e4, virtual true, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CleanupAudioFilter, addr 0x288afd0, size 0x144, virtual false, abstract: false, final false
inline void CleanupAudioFilter() ;

/// @brief Method CompositionMethod, addr 0x288988c, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::OVRManager_CompositionMethod CompositionMethod() ;

/// @brief Method DisplayRefreshRateChanged, addr 0x288c788, size 0x14, virtual false, abstract: false, final false
inline void DisplayRefreshRateChanged(float_t  fromRefreshRate, float_t  toRefreshRate) ;

/// @brief Method GetAndResetAudioData, addr 0x288b2f8, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method RefreshAudioFilter, addr 0x288aa00, size 0x5d0, virtual false, abstract: false, final false
inline void RefreshAudioFilter(::UnityEngine::Camera*  mainCamera) ;

/// @brief Method RefreshCameraObjects, addr 0x2889e8c, size 0xb74, virtual false, abstract: false, final false
...
/// @brief Method SetCameraTargetTexture, addr 0x288b4d4, size 0x1e0, virtual false, abstract: false, final false
inline void SetCameraTargetTexture(int32_t  drawTextureIndex) ;

/// @brief Method Update, addr 0x288b6b4, size 0xca4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2889894, size 0x5a8, virtual false, abstract: false, final false
