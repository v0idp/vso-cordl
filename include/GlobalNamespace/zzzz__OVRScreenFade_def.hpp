...
/// @brief Method MoveNext, addr 0x294d504, size 0x114, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::GlobalNamespace::OVRScreenFade__Fade_d__25* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x294d618, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x294d620, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x294d658, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x294d500, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x294d4ac, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method Fade, addr 0x294d150, size 0x74, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* Fade(float_t  startAlpha, float_t  endAlpha) ;

/// @brief Method FadeIn, addr 0x294d128, size 0x28, virtual false, abstract: false, final false
inline void FadeIn() ;

/// @brief Method FadeOut, addr 0x294d1c4, size 0x28, virtual false, abstract: false, final false
inline void FadeOut() ;

static inline ::GlobalNamespace::OVRScreenFade* New_ctor() ;

/// @brief Method OnDestroy, addr 0x294d22c, size 0x154, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnEnable, addr 0x294d214, size 0x18, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnLevelFinishedLoading, addr 0x294d1ec, size 0x28, virtual false, abstract: false, final false
inline void OnLevelFinishedLoading(int32_t  level) ;

/// @brief Method SetExplicitFade, addr 0x294d4a4, size 0x8, virtual false, abstract: false, final false
inline void SetExplicitFade(float_t  level) ;

/// @brief Method SetMaterialAlpha, addr 0x294d39c, size 0x108, virtual false, abstract: false, final false
inline void SetMaterialAlpha() ;

/// @brief Method SetUIFade, addr 0x294d380, size 0x1c, virtual false, abstract: false, final false
inline void SetUIFade(float_t  level) ;

/// @brief Method Start, addr 0x294cc90, size 0x498, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x294d4d4, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityW<::GlobalNamespace::OVRScreenFade> getStaticF__instance_k__BackingField() ;

/// @brief Method get_currentAlpha, addr 0x294cbd8, size 0xb8, virtual false, abstract: false, final false
inline float_t get_currentAlpha() ;

/// @brief Method get_instance, addr 0x294cb44, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method set_instance, addr 0x294cb8c, size 0x4c, virtual false, abstract: false, final false
