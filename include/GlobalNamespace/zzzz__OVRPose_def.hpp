...
public:
// Declarations
/// @brief Method Equals, addr 0x28983a8, size 0xf0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x289851c, size 0xa8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Inverse, addr 0x288c358, size 0x84, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPose Inverse() ;

/// @brief Method Rotate180AlongX, addr 0x2898690, size 0xe0, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPose Rotate180AlongX() ;

/// @brief Method ToPosef, addr 0x288c3dc, size 0x28, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_Posef ToPosef() ;

/// @brief Method ToPosef_Legacy, addr 0x2898674, size 0x1c, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_Posef ToPosef_Legacy() ;

/// @brief Method flipZ, addr 0x2898648, size 0x2c, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPose flipZ() ;

/// @brief Method get_identity, addr 0x288e95c, size 0x98, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRPose get_identity() ;

/// @brief Method op_Equality, addr 0x2898498, size 0x84, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRPose  x, ::GlobalNamespace::OVRPose  y) ;

/// @brief Method op_Inequality, addr 0x28985c4, size 0x84, virtual false, abstract: false, final false
static inline bool op_Inequality(::GlobalNamespace::OVRPose  x, ::GlobalNamespace::OVRPose  y) ;

/// @brief Method op_Multiply, addr 0x2888b18, size 0xe4, virtual false, abstract: false, final false
