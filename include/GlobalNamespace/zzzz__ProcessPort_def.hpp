...
/// @brief Method GetProcessesByPort, addr 0x2932eac, size 0xae4, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::GlobalNamespace::ProcessPort*>* GetProcessesByPort(::StringW  targetPort) ;

/// @brief Method LookupProcess, addr 0x2932de0, size 0xcc, virtual false, abstract: false, final false
static inline ::StringW LookupProcess(int32_t  pid) ;

static inline ::GlobalNamespace::ProcessPort* New_ctor() ;

/// @brief Method ToString, addr 0x2932c38, size 0x168, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2933990, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_portNumber, addr 0x2932dc0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_portNumber() ;

/// @brief Method get_processId, addr 0x2932db0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_processId() ;

/// @brief Method get_processName, addr 0x2932da0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_processName() ;

/// @brief Method get_protocol, addr 0x2932dd0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_protocol() ;

/// @brief Method set_portNumber, addr 0x2932dc8, size 0x8, virtual false, abstract: false, final false
inline void set_portNumber(::StringW  value) ;

/// @brief Method set_processId, addr 0x2932db8, size 0x8, virtual false, abstract: false, final false
inline void set_processId(int32_t  value) ;

/// @brief Method set_processName, addr 0x2932da8, size 0x8, virtual false, abstract: false, final false
inline void set_processName(::StringW  value) ;

/// @brief Method set_protocol, addr 0x2932dd8, size 0x8, virtual false, abstract: false, final false
