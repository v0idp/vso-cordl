...
/// @brief Method Equals, addr 0x2891aa8, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2891964, size 0x68, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::OVRRoomLayout  other) ;

/// @brief Method FetchLayoutAnchorsAsync, addr 0x2891c7c, size 0x314, virtual false, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x2891b38, size 0x94, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method IOVRAnchorComponent<OVRRoomLayout>.FromAnchor, addr 0x289173c, size 0x30, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRRoomLayout IOVRAnchorComponent_OVRRoomLayout__FromAnchor(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method IOVRAnchorComponent<OVRRoomLayout>.SetEnabledAsync, addr 0x2891918, size 0x4c, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRTask_1<bool> IOVRAnchorComponent_OVRRoomLayout__SetEnabledAsync(bool  enabled, double_t  timeout) ;

/// @brief Method IOVRAnchorComponent<OVRRoomLayout>.get_Handle, addr 0x28916e8, size 0x54, virtual true, abstract: false, final true
inline uint64_t IOVRAnchorComponent_OVRRoomLayout__get_Handle() ;

/// @brief Method IOVRAnchorComponent<OVRRoomLayout>.get_Type, addr 0x2891690, size 0x50, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRRoomLayout__get_Type() ;

/// @brief Method ToString, addr 0x2891bcc, size 0xa8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetRoomLayout, addr 0x2891f90, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x289176c, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRAnchor  anchor) ;

static inline ::GlobalNamespace::OVRRoomLayout getStaticF_Null() ;

/// @brief Method get_Handle, addr 0x2891c74, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_Handle() ;

/// @brief Method get_IsEnabled, addr 0x289182c, size 0xec, virtual true, abstract: false, final true
inline bool get_IsEnabled() ;

/// @brief Method get_IsNull, addr 0x28917d0, size 0x5c, virtual true, abstract: false, final true
inline bool get_IsNull() ;

/// @brief Method get_Type, addr 0x28916e0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x28919cc, size 0x6c, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::OVRRoomLayout  lhs, ::GlobalNamespace::OVRRoomLayout  rhs) ;

/// @brief Method op_Inequality, addr 0x2891a38, size 0x70, virtual false, abstract: false, final false
