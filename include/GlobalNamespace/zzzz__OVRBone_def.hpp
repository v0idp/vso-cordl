...
/// @brief Method .ctor, addr 0x294f0c4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2950264, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRSkeleton_BoneId  id, int16_t  parentBoneIndex, ::UnityEngine::Transform*  trans) ;

/// @brief Method get_Id, addr 0x2950234, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRSkeleton_BoneId get_Id() ;

/// @brief Method get_ParentBoneIndex, addr 0x2950244, size 0x8, virtual false, abstract: false, final false
inline int16_t get_ParentBoneIndex() ;

/// @brief Method get_Transform, addr 0x2950254, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_Transform() ;

/// @brief Method set_Id, addr 0x295023c, size 0x8, virtual false, abstract: false, final false
inline void set_Id(::GlobalNamespace::OVRSkeleton_BoneId  value) ;

/// @brief Method set_ParentBoneIndex, addr 0x295024c, size 0x8, virtual false, abstract: false, final false
inline void set_ParentBoneIndex(int16_t  value) ;

/// @brief Method set_Transform, addr 0x295025c, size 0x8, virtual false, abstract: false, final false
