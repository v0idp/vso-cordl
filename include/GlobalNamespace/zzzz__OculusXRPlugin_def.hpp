...
public:
// Declarations
/// @brief Method SetAppSpacePosition, addr 0x2932a94, size 0x90, virtual false, abstract: false, final false
static inline void SetAppSpacePosition(float_t  x, float_t  y, float_t  z) ;

/// @brief Method SetAppSpaceRotation, addr 0x2932b24, size 0x98, virtual false, abstract: false, final false
static inline void SetAppSpaceRotation(float_t  x, float_t  y, float_t  z, float_t  w) ;

/// @brief Method SetColorOffset, addr 0x2932984, size 0x94, virtual false, abstract: false, final false
static inline void SetColorOffset(float_t  x, float_t  y, float_t  z, float_t  w) ;

/// @brief Method SetColorScale, addr 0x29328ec, size 0x98, virtual false, abstract: false, final false
static inline void SetColorScale(float_t  x, float_t  y, float_t  z, float_t  w) ;

/// @brief Method SetDepthSubmission, addr 0x2932bbc, size 0x7c, virtual false, abstract: false, final false
static inline void SetDepthSubmission(bool  enable) ;

/// @brief Method SetSpaceWarp, addr 0x2932a18, size 0x7c, virtual false, abstract: false, final false
