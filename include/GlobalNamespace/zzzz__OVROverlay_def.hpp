...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x28ced3c, size 0x20, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x28ced5c, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x28ced28, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;

static inline ::GlobalNamespace::OVROverlay_ExternalSurfaceObjectCreated* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x28ceca0, size 0x88, virtual false, abstract: false, final false
...
constexpr OVROverlay_LayerTexture(::UnityW<::UnityEngine::Texture>  appTexture, ::System::IntPtr  appTexturePtr, ::ArrayW<::UnityW<::UnityEngine::Texture>,::Array<::UnityW<::UnityEngine::Texture>>*>  swapChain, ::ArrayW<::System::IntPtr,::Array<::System::IntPtr>*>  swapChainPtr) noexcept;
...
// Dependencies OVRManager::XRDevice, OVROverlay::OverlayShape, OVROverlay::OverlayType, OVRPlugin::EyeTextureFormat, OVRPlugin::LayerDesc, OVRPlugin::TextureRectMatrixf, System.IntPtr, System.Runtime.InteropServices.GCHandle, UnityEngine.MonoBehaviour, UnityEngine.Rect, UnityEngine.Vector2, UnityEngine.Vector4
namespace GlobalNamespace {
// Is value type: false
// CS Name: OVROverlay
...
/// @brief Field OpenVRMouseScale, offset 0x1f8, size 0x8 
...
/// @brief Field OpenVROverlayHandle, offset 0x1e0, size 0x8 
...
/// @brief Field OpenVRUVOffsetAndScale, offset 0x1e8, size 0x10 
...
/// @brief Field <isOverlayVisible>k__BackingField, offset 0x1d8, size 0x1 
...
/// @brief Field constructedOverlayXRDevice, offset 0x200, size 0x4 
...
/// @brief Field layerTextures, offset 0x128, size 0x8 
 __declspec(property(get=__cordl_internal_get_layerTextures, put=__cordl_internal_set_layerTextures)) ::ArrayW<::GlobalNamespace::OVROverlay_LayerTexture,::Array<::GlobalNamespace::OVROverlay_LayerTexture>*>  layerTextures;
...
/// @brief Field xrDeviceConstructed, offset 0x204, size 0x1 
...
/// @brief Method Awake, addr 0x28cd538, size 0x314, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method BlitSubImage, addr 0x28cc6bc, size 0x324, virtual false, abstract: false, final false
inline void BlitSubImage(::UnityEngine::Texture*  src, ::UnityEngine::RenderTexture*  dst, ::UnityEngine::Material*  mat, ::UnityEngine::Rect  rect, bool  invertRect) ;

/// @brief Method ComputePoseAndScale, addr 0x28cdc04, size 0x374, virtual false, abstract: false, final false
...
/// @brief Method ComputeSubmit, addr 0x28cdf78, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method CreateLayer, addr 0x28cae70, size 0x428, virtual false, abstract: false, final false
...
/// @brief Method CreateLayerTextures, addr 0x28cb298, size 0x518, virtual false, abstract: false, final false
inline bool CreateLayerTextures(bool  useMipmaps, ::GlobalNamespace::OVRPlugin_Sizei  size, bool  isHdr) ;

/// @brief Method DestroyLayer, addr 0x28cb8d4, size 0x298, virtual false, abstract: false, final false
inline void DestroyLayer() ;

/// @brief Method DestroyLayerTextures, addr 0x28cb7b0, size 0x124, virtual false, abstract: false, final false
inline void DestroyLayerTextures() ;

/// @brief Method GetBlitRect, addr 0x28cc654, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::Rect GetBlitRect(int32_t  eyeId) ;

/// @brief Method GetCurrentLayerDesc, addr 0x28cc17c, size 0x4d8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_LayerDesc GetCurrentLayerDesc() ;

/// @brief Method InitOVROverlay, addr 0x28cd95c, size 0x16c, virtual false, abstract: false, final false
inline void InitOVROverlay() ;

/// @brief Method IsPassthroughShape, addr 0x28cae18, size 0x58, virtual false, abstract: false, final false
static inline bool IsPassthroughShape(::GlobalNamespace::OVROverlay_OverlayShape  shape) ;

/// @brief Method LatchLayerTextures, addr 0x28cbd4c, size 0x430, virtual false, abstract: false, final false
inline bool LatchLayerTextures() ;

/// @brief Method LateUpdate, addr 0x28ce52c, size 0x1c, virtual false, abstract: false, final false
inline void LateUpdate() ;

/// @brief Method NeedsTexturesForShape, addr 0x28cadb8, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x28cdbec, size 0x18, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x28cdac8, size 0x124, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x28cd8ec, size 0x70, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OpenVROverlayUpdate, addr 0x28ce228, size 0x304, virtual false, abstract: false, final false
inline bool OpenVROverlayUpdate(::UnityEngine::Vector3  scale, ::GlobalNamespace::OVRPose  pose) ;

/// @brief Method OverrideOverlayTextureInfo, addr 0x28cabf0, size 0xbc, virtual false, abstract: false, final false
inline void OverrideOverlayTextureInfo(::UnityEngine::Texture*  srcTexture, ::System::IntPtr  nativePtr, ::UnityEngine::XR::XRNode  node) ;

/// @brief Method PopulateLayer, addr 0x28cc9e0, size 0x70c, virtual false, abstract: false, final false
...
/// @brief Method ResetEditorPreview, addr 0x28cd52c, size 0xc, virtual false, abstract: false, final false
inline void ResetEditorPreview() ;

/// @brief Method SetPerLayerColorScaleAndOffset, addr 0x28cbd38, size 0x14, virtual false, abstract: false, final false
inline void SetPerLayerColorScaleAndOffset(::UnityEngine::Vector4  scale, ::UnityEngine::Vector4  offset) ;

/// @brief Method SetSrcDestRects, addr 0x28cbb6c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method SetupEditorPreview, addr 0x28cabec, size 0x4, virtual false, abstract: false, final false
inline void SetupEditorPreview() ;

/// @brief Method SubmitLayer, addr 0x28cd0ec, size 0x440, virtual false, abstract: false, final false
...
/// @brief Method TrySubmitLayer, addr 0x28ce548, size 0x544, virtual false, abstract: false, final false
inline bool TrySubmitLayer() ;

/// @brief Method UpdateTextureRectMatrix, addr 0x28cbb8c, size 0x1ac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28cea8c, size 0x1ac, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_OpenVROverlayKey, addr 0x28cd84c, size 0xa0, virtual false, abstract: false, final false
static inline ::StringW get_OpenVROverlayKey() ;

/// @brief Method get_isOverlayVisible, addr 0x28cad88, size 0x8, virtual false, abstract: false, final false
inline bool get_isOverlayVisible() ;

/// @brief Method get_layerId, addr 0x28cacac, size 0x8, virtual false, abstract: false, final false
inline int32_t get_layerId() ;

/// @brief Method get_layout, addr 0x28cacbc, size 0xcc, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_LayerLayout get_layout() ;

/// @brief Method get_previewInEditor, addr 0x28cabcc, size 0x8, virtual false, abstract: false, final false
inline bool get_previewInEditor() ;

/// @brief Method get_texturesPerStage, addr 0x28cad9c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method set_isOverlayVisible, addr 0x28cad90, size 0xc, virtual false, abstract: false, final false
inline void set_isOverlayVisible(bool  value) ;

/// @brief Method set_layerId, addr 0x28cacb4, size 0x8, virtual false, abstract: false, final false
inline void set_layerId(int32_t  value) ;

/// @brief Method set_previewInEditor, addr 0x28cabd4, size 0x18, virtual false, abstract: false, final false
...
/// @brief Field <isOverlayVisible>k__BackingField, offset: 0x1d8, size: 0x1, def value: None
 bool  ____isOverlayVisible_k__BackingField;

/// @brief Field OpenVROverlayHandle, offset: 0x1e0, size: 0x8, def value: None
 uint64_t  ___OpenVROverlayHandle;

/// @brief Field OpenVRUVOffsetAndScale, offset: 0x1e8, size: 0x10, def value: None
 ::UnityEngine::Vector4  ___OpenVRUVOffsetAndScale;

/// @brief Field OpenVRMouseScale, offset: 0x1f8, size: 0x8, def value: None
 ::UnityEngine::Vector2  ___OpenVRMouseScale;

/// @brief Field constructedOverlayXRDevice, offset: 0x200, size: 0x4, def value: None
 ::GlobalNamespace::OVRManager_XRDevice  ___constructedOverlayXRDevice;

/// @brief Field xrDeviceConstructed, offset: 0x204, size: 0x1, def value: None
...
static_assert(offsetof(::GlobalNamespace::OVROverlay, ____isOverlayVisible_k__BackingField) == 0x1d8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVROverlay, ___OpenVROverlayHandle) == 0x1e0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVROverlay, ___OpenVRUVOffsetAndScale) == 0x1e8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVROverlay, ___OpenVRMouseScale) == 0x1f8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVROverlay, ___constructedOverlayXRDevice) == 0x200, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVROverlay, ___xrDeviceConstructed) == 0x204, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::OVROverlay, 0x208>, "Size mismatch!");
