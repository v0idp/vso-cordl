...
// Dependencies OVRPlugin::Vector2f, OVRPlugin::Vector3f, OVRPlugin::Vector4f, OVRPlugin::Vector4s, Unity.Collections.NativeArray`1<T>, Unity.Jobs.IJobParallelFor, UnityEngine.BoneWeight, UnityEngine.Vector2, UnityEngine.Vector3
namespace GlobalNamespace {
// Is value type: true
...
/// @brief Method Execute, addr 0x2941f84, size 0x180, virtual true, abstract: false, final true
...
/// @brief Method Execute, addr 0x2942104, size 0x20, virtual true, abstract: false, final true
inline void Execute(int32_t  index) ;
...
/// @brief Method .ctor, addr 0x2941f7c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
