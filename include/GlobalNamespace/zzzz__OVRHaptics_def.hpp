...
/// @brief Method Load, addr 0x28a6504, size 0x200, virtual false, abstract: false, final false
...
/// @brief Method get_MaximumBufferSamplesCount, addr 0x28a7868, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_MaximumBufferSamplesCount() ;

/// @brief Method get_MinimumBufferSamplesCount, addr 0x28a7700, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_MinimumBufferSamplesCount() ;

/// @brief Method get_MinimumSafeSamplesQueued, addr 0x28a764c, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_MinimumSafeSamplesQueued() ;

/// @brief Method get_OptimalBufferSamplesCount, addr 0x28a77b4, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_OptimalBufferSamplesCount() ;

/// @brief Method get_SampleRateHz, addr 0x28a74e4, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_SampleRateHz() ;

/// @brief Method get_SampleSizeInBytes, addr 0x28a7598, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method set_MaximumBufferSamplesCount, addr 0x28a78c0, size 0x5c, virtual false, abstract: false, final false
static inline void set_MaximumBufferSamplesCount(int32_t  value) ;

/// @brief Method set_MinimumBufferSamplesCount, addr 0x28a7758, size 0x5c, virtual false, abstract: false, final false
static inline void set_MinimumBufferSamplesCount(int32_t  value) ;

/// @brief Method set_MinimumSafeSamplesQueued, addr 0x28a76a4, size 0x5c, virtual false, abstract: false, final false
static inline void set_MinimumSafeSamplesQueued(int32_t  value) ;

/// @brief Method set_OptimalBufferSamplesCount, addr 0x28a780c, size 0x5c, virtual false, abstract: false, final false
static inline void set_OptimalBufferSamplesCount(int32_t  value) ;

/// @brief Method set_SampleRateHz, addr 0x28a753c, size 0x5c, virtual false, abstract: false, final false
static inline void set_SampleRateHz(int32_t  value) ;

/// @brief Method set_SampleSizeInBytes, addr 0x28a75f0, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method Clear, addr 0x28a8004, size 0x18, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Mix, addr 0x28a7b48, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Preempt, addr 0x28a7920, size 0x18, virtual false, abstract: false, final false
inline void Preempt(::GlobalNamespace::OVRHapticsClip*  clip) ;

/// @brief Method Queue, addr 0x28a7a50, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28a6898, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28a818c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::OVRHapticsClip*  clip) ;

/// @brief Method get_Clip, addr 0x28a83cc, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRHapticsClip* get_Clip() ;

/// @brief Method get_ReadCount, addr 0x28a83bc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_ReadCount() ;

/// @brief Method set_Clip, addr 0x28a83d4, size 0x8, virtual false, abstract: false, final false
inline void set_Clip(::GlobalNamespace::OVRHapticsClip*  value) ;

/// @brief Method set_ReadCount, addr 0x28a83c4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Clear, addr 0x28a801c, size 0x70, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Mix, addr 0x28a7b60, size 0x4a4, virtual false, abstract: false, final false
inline void Mix(::GlobalNamespace::OVRHapticsClip*  clip) ;

static inline ::GlobalNamespace::OVRHaptics_OVRHapticsOutput* New_ctor(uint32_t  controller) ;

/// @brief Method Preempt, addr 0x28a7938, size 0x118, virtual false, abstract: false, final false
inline void Preempt(::GlobalNamespace::OVRHapticsClip*  clip) ;

/// @brief Method Process, addr 0x28a6a0c, size 0xad8, virtual false, abstract: false, final false
inline void Process() ;

/// @brief Method Queue, addr 0x28a7a68, size 0xe0, virtual false, abstract: false, final false
inline void Queue(::GlobalNamespace::OVRHapticsClip*  clip) ;
...
constexpr ::GlobalNamespace::OVRHapticsClip* const& __cordl_internal_get_m_paddingClip() const;
...
/// @brief Method .ctor, addr 0x28a6704, size 0x194, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::OVRHaptics_OVRHapticsOutput, ___m_paddingEnabled) == 0x11, "Offset mismatch!");
...
static_assert(offsetof(::GlobalNamespace::OVRHaptics_OVRHapticsOutput, ___m_paddingClip) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRHaptics_OVRHapticsOutput, ___PrevSampleRateHz) == 0x48, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::OVRHaptics_OVRHapticsOutput, 0x50>, "Size mismatch!");
...
/// @brief Method Process, addr 0x28a6930, size 0xdc, virtual false, abstract: false, final false
