...
/// @brief Method Awake, addr 0x293d4a0, size 0x148, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GrabBegin, addr 0x293d350, size 0x7c, virtual true, abstract: false, final false
inline void GrabBegin(::GlobalNamespace::OVRGrabber*  hand, ::UnityEngine::Collider*  grabPoint) ;

/// @brief Method GrabEnd, addr 0x293d3cc, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x293d64c, size 0x84, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x293d5e8, size 0x64, virtual true, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x293d780, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowOffhandGrab, addr 0x293d288, size 0x8, virtual false, abstract: false, final false
inline bool get_allowOffhandGrab() ;

/// @brief Method get_grabPoints, addr 0x293d348, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::UnityEngine::Collider>,::Array<::UnityW<::UnityEngine::Collider>>*> get_grabPoints() ;

/// @brief Method get_grabbedBy, addr 0x293d308, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRGrabber> get_grabbedBy() ;

/// @brief Method get_grabbedRigidbody, addr 0x293d32c, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rigidbody> get_grabbedRigidbody() ;

/// @brief Method get_grabbedTransform, addr 0x293d310, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_grabbedTransform() ;

/// @brief Method get_isGrabbed, addr 0x293d290, size 0x60, virtual false, abstract: false, final false
inline bool get_isGrabbed() ;

/// @brief Method get_snapOffset, addr 0x293d300, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_snapOffset() ;

/// @brief Method get_snapOrientation, addr 0x293d2f8, size 0x8, virtual false, abstract: false, final false
inline bool get_snapOrientation() ;

/// @brief Method get_snapPosition, addr 0x293d2f0, size 0x8, virtual false, abstract: false, final false
