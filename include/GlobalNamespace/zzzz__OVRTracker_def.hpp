...
/// @brief Method GetFrustum, addr 0x29290f8, size 0xa4, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRTracker_Frustum GetFrustum(int32_t  tracker) ;

/// @brief Method GetPose, addr 0x292919c, size 0x2b0, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPose GetPose(int32_t  tracker) ;

/// @brief Method GetPoseValid, addr 0x292944c, size 0x11c, virtual false, abstract: false, final false
inline bool GetPoseValid(int32_t  tracker) ;

/// @brief Method GetPresent, addr 0x2928fdc, size 0x11c, virtual false, abstract: false, final false
inline bool GetPresent(int32_t  tracker) ;

static inline ::GlobalNamespace::OVRTracker* New_ctor() ;

/// @brief Method .ctor, addr 0x2929568, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_count, addr 0x2928fa0, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_count() ;

/// @brief Method get_isEnabled, addr 0x2928e7c, size 0x90, virtual false, abstract: false, final false
inline bool get_isEnabled() ;

/// @brief Method get_isPositionTracked, addr 0x2928e2c, size 0x50, virtual false, abstract: false, final false
inline bool get_isPositionTracked() ;

/// @brief Method get_isPresent, addr 0x2928d9c, size 0x90, virtual false, abstract: false, final false
inline bool get_isPresent() ;

/// @brief Method set_isEnabled, addr 0x2928f0c, size 0x94, virtual false, abstract: false, final false
