...
/// @brief Method ConfigureEyeDesc, addr 0x289a2b4, size 0x254, virtual false, abstract: false, final false
inline void ConfigureEyeDesc(::UnityEngine::XR::XRNode  eye) ;

/// @brief Method GetEyeRenderDesc, addr 0x2899f10, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method RecenterPose, addr 0x2899a08, size 0x78, virtual false, abstract: false, final false
inline void RecenterPose() ;

/// @brief Method Update, addr 0x2899744, size 0x18c, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateTextures, addr 0x2899724, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28996ac, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_RecenteredPose, addr 0x28998d0, size 0x9c, virtual false, abstract: false, final false
inline void add_RecenteredPose(::System::Action*  value) ;

/// @brief Method get_acceleration, addr 0x2899a80, size 0x124, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_acceleration() ;

/// @brief Method get_angularAcceleration, addr 0x2899ba4, size 0x124, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_angularAcceleration() ;

/// @brief Method get_angularVelocity, addr 0x2899dec, size 0x124, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_angularVelocity() ;

/// @brief Method get_appFramerate, addr 0x289a118, size 0x90, virtual false, abstract: false, final false
inline float_t get_appFramerate() ;

/// @brief Method get_displayFrequenciesAvailable, addr 0x289a204, size 0x50, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> get_displayFrequenciesAvailable() ;

/// @brief Method get_displayFrequency, addr 0x2889e3c, size 0x50, virtual false, abstract: false, final false
inline float_t get_displayFrequency() ;

/// @brief Method get_latency, addr 0x2899f48, size 0x1d0, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRDisplay_LatencyData get_latency() ;

/// @brief Method get_recommendedMSAALevel, addr 0x289a1a8, size 0x5c, virtual false, abstract: false, final false
inline int32_t get_recommendedMSAALevel() ;

/// @brief Method get_velocity, addr 0x2899cc8, size 0x124, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_velocity() ;

/// @brief Method remove_RecenteredPose, addr 0x289996c, size 0x9c, virtual false, abstract: false, final false
inline void remove_RecenteredPose(::System::Action*  value) ;

/// @brief Method set_displayFrequency, addr 0x289a254, size 0x60, virtual false, abstract: false, final false
