...
/// @brief Method GetContactPair, addr 0x2fc5840, size 0x4, virtual false, abstract: false, final false
inline ::ByRef<::UnityEngine::ContactPair> GetContactPair(int32_t  index) ;

/// @brief Method GetContactPair_Internal, addr 0x2fc7844, size 0x80, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<::UnityEngine::ContactPair> GetContactPair_Internal(int32_t  index) ;

/// @brief Method get_Body, addr 0x2fc5854, size 0x78, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Component> get_Body() ;

/// @brief Method get_HasRemovedBody, addr 0x2fc5830, size 0x10, virtual false, abstract: false, final false
inline bool get_HasRemovedBody() ;

/// @brief Method get_OtherBody, addr 0x2fc58cc, size 0x78, virtual false, abstract: false, final false
