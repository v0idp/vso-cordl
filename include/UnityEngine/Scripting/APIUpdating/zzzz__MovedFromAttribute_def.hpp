...
/// @brief Method .ctor, addr 0x2f99730, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(bool  autoUpdateAPI, ::StringW  sourceNamespace, ::StringW  sourceAssembly, ::StringW  sourceClassName) ;

/// @brief Method .ctor, addr 0x2f9979c, size 0x44, virtual false, abstract: false, final false
