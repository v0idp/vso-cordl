...
/// @brief Method .ctor, addr 0x2fcd6a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2fcd6ac, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method set_GenerateProxy, addr 0x2fcd6e8, size 0xc, virtual false, abstract: false, final false
inline void set_GenerateProxy(bool  value) ;

/// @brief Method set_Name, addr 0x2fcd6d4, size 0x8, virtual false, abstract: false, final false
inline void set_Name(::StringW  value) ;

/// @brief Method set_Optional, addr 0x2fcd6dc, size 0xc, virtual false, abstract: false, final false
