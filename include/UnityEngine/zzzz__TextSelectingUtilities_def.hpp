...
/// @brief Method ClampTextIndex, addr 0x2fbcff4, size 0x24, virtual false, abstract: false, final false
inline int32_t ClampTextIndex(int32_t  index) ;

/// @brief Method ClassifyChar, addr 0x2fbcee8, size 0x10c, virtual false, abstract: false, final false
inline ::UnityEngine::TextSelectingUtilities_CharacterType ClassifyChar(int32_t  index) ;

/// @brief Method ClearCursorPos, addr 0x2fba9bc, size 0x10, virtual false, abstract: false, final false
inline void ClearCursorPos() ;

/// @brief Method Copy, addr 0x2fbaac4, size 0xb4, virtual false, abstract: false, final false
inline void Copy() ;

/// @brief Method DblClickSnap, addr 0x2fbcb5c, size 0x8, virtual false, abstract: false, final false
inline void DblClickSnap(::UnityEngine::TextEditor_DblClickSnapping  snapping) ;

/// @brief Method EnsureValidCodePointIndex, addr 0x2fbaed0, size 0x58, virtual false, abstract: false, final false
inline int32_t EnsureValidCodePointIndex(int32_t  index) ;

/// @brief Method ExpandSelectGraphicalLineEnd, addr 0x2fbbf34, size 0xf0, virtual false, abstract: false, final false
inline void ExpandSelectGraphicalLineEnd() ;

/// @brief Method ExpandSelectGraphicalLineStart, addr 0x2fbbe44, size 0xf0, virtual false, abstract: false, final false
inline void ExpandSelectGraphicalLineStart() ;

/// @brief Method FindEndOfClassification, addr 0x2fbc770, size 0x144, virtual false, abstract: false, final false
inline int32_t FindEndOfClassification(int32_t  p, ::UnityEngine::TextSelectingUtilities_Direction  dir) ;

/// @brief Method FindEndOfPreviousWord, addr 0x2fba554, size 0xdc, virtual false, abstract: false, final false
inline int32_t FindEndOfPreviousWord(int32_t  p) ;

/// @brief Method FindNextSeperator, addr 0x2fbc9a4, size 0x84, virtual false, abstract: false, final false
inline int32_t FindNextSeperator(int32_t  startPos) ;

/// @brief Method FindPrevSeperator, addr 0x2fbca28, size 0x9c, virtual false, abstract: false, final false
inline int32_t FindPrevSeperator(int32_t  startPos) ;

/// @brief Method FindStartOfNextWord, addr 0x2fba630, size 0x1c4, virtual false, abstract: false, final false
inline int32_t FindStartOfNextWord(int32_t  p) ;

/// @brief Method GetGraphicalLineEnd, addr 0x2fbc554, size 0xcc, virtual false, abstract: false, final false
inline int32_t GetGraphicalLineEnd(int32_t  p) ;

/// @brief Method GetGraphicalLineStart, addr 0x2fbc490, size 0xc4, virtual false, abstract: false, final false
inline int32_t GetGraphicalLineStart(int32_t  p) ;

/// @brief Method HandleKeyEvent, addr 0x2fbb080, size 0x180, virtual false, abstract: false, final false
inline bool HandleKeyEvent(::UnityEngine::Event*  e) ;

/// @brief Method IndexOfEndOfLine, addr 0x2fbc620, size 0x40, virtual false, abstract: false, final false
inline int32_t IndexOfEndOfLine(int32_t  startIndex) ;

/// @brief Method InitKeyActions, addr 0x2fbb200, size 0x404, virtual false, abstract: false, final false
inline void InitKeyActions() ;

/// @brief Method IsValidCodePointIndex, addr 0x2fbd018, size 0xd0, virtual false, abstract: false, final false
inline bool IsValidCodePointIndex(int32_t  index) ;

/// @brief Method MapKey, addr 0x2fbc3b8, size 0x8c, virtual false, abstract: false, final false
static inline void MapKey(::StringW  key, ::UnityEngine::TextSelectOp  action) ;

/// @brief Method MouseDragSelectsWholeWords, addr 0x2fbcac4, size 0x98, virtual false, abstract: false, final false
inline void MouseDragSelectsWholeWords(bool  on) ;

/// @brief Method MoveCursorToPosition_Internal, addr 0x2fbcb64, size 0x9c, virtual false, abstract: false, final false
inline void MoveCursorToPosition_Internal(::UnityEngine::Vector2  cursorPosition, bool  shift) ;

/// @brief Method MoveDown, addr 0x2fb9278, size 0x140, virtual false, abstract: false, final false
inline void MoveDown() ;

/// @brief Method MoveGraphicalLineEnd, addr 0x2fb9d94, size 0xb4, virtual false, abstract: false, final false
inline void MoveGraphicalLineEnd() ;

/// @brief Method MoveGraphicalLineStart, addr 0x2fb9ce0, size 0xb4, virtual false, abstract: false, final false
inline void MoveGraphicalLineStart() ;

/// @brief Method MoveLeft, addr 0x2fb8f24, size 0x10c, virtual false, abstract: false, final false
inline void MoveLeft() ;

/// @brief Method MoveLineEnd, addr 0x2fb94ec, size 0x14c, virtual false, abstract: false, final false
inline void MoveLineEnd() ;

/// @brief Method MoveLineStart, addr 0x2fb93b8, size 0x134, virtual false, abstract: false, final false
inline void MoveLineStart() ;

/// @brief Method MoveParagraphBackward, addr 0x2fb9b90, size 0x150, virtual false, abstract: false, final false
inline void MoveParagraphBackward() ;

/// @brief Method MoveParagraphForward, addr 0x2fb9a84, size 0x10c, virtual false, abstract: false, final false
inline void MoveParagraphForward() ;

/// @brief Method MoveRight, addr 0x2fb9030, size 0x114, virtual false, abstract: false, final false
inline void MoveRight() ;

/// @brief Method MoveTextEnd, addr 0x2fb9a0c, size 0x78, virtual false, abstract: false, final false
inline void MoveTextEnd() ;

/// @brief Method MoveTextStart, addr 0x2fb99b0, size 0x5c, virtual false, abstract: false, final false
inline void MoveTextStart() ;

/// @brief Method MoveToEndOfPreviousWord, addr 0x2fb97f0, size 0xc8, virtual false, abstract: false, final false
inline void MoveToEndOfPreviousWord() ;

/// @brief Method MoveToStartOfNextWord, addr 0x2fb9728, size 0xc8, virtual false, abstract: false, final false
inline void MoveToStartOfNextWord() ;

/// @brief Method MoveUp, addr 0x2fb9144, size 0x134, virtual false, abstract: false, final false
inline void MoveUp() ;

/// @brief Method MoveWordLeft, addr 0x2fb98b8, size 0xf8, virtual false, abstract: false, final false
inline void MoveWordLeft() ;

/// @brief Method MoveWordRight, addr 0x2fb9638, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method NextCodePointIndex, addr 0x2fba7f4, size 0xe0, virtual false, abstract: false, final false
inline int32_t NextCodePointIndex(int32_t  index) ;

/// @brief Method OnFocus, addr 0x2fbc444, size 0x4c, virtual false, abstract: false, final false
inline void OnFocus(bool  selectAll) ;

/// @brief Method PerformOperation, addr 0x2fbb604, size 0x1f0, virtual false, abstract: false, final false
inline bool PerformOperation(::UnityEngine::TextSelectOp  operation) ;

/// @brief Method PreviousCodePointIndex, addr 0x2fba8d4, size 0xd8, virtual false, abstract: false, final false
inline int32_t PreviousCodePointIndex(int32_t  index) ;

/// @brief Method SelectAll, addr 0x2fbc34c, size 0x6c, virtual false, abstract: false, final false
inline void SelectAll() ;

/// @brief Method SelectCurrentParagraph, addr 0x2fbc8b4, size 0xf0, virtual false, abstract: false, final false
inline void SelectCurrentParagraph() ;

/// @brief Method SelectCurrentWord, addr 0x2fbc660, size 0x110, virtual false, abstract: false, final false
inline void SelectCurrentWord() ;

/// @brief Method SelectDown, addr 0x2fbba58, size 0x6c, virtual false, abstract: false, final false
inline void SelectDown() ;

/// @brief Method SelectGraphicalLineEnd, addr 0x2fbc2f0, size 0x5c, virtual false, abstract: false, final false
inline void SelectGraphicalLineEnd() ;

/// @brief Method SelectGraphicalLineStart, addr 0x2fbc294, size 0x5c, virtual false, abstract: false, final false
inline void SelectGraphicalLineStart() ;

/// @brief Method SelectLeft, addr 0x2fbb7f4, size 0xfc, virtual false, abstract: false, final false
inline void SelectLeft() ;

/// @brief Method SelectNone, addr 0x2fbac30, size 0x4c, virtual false, abstract: false, final false
inline void SelectNone() ;

/// @brief Method SelectParagraphBackward, addr 0x2fbc138, size 0x15c, virtual false, abstract: false, final false
inline void SelectParagraphBackward() ;

/// @brief Method SelectParagraphForward, addr 0x2fbc024, size 0x114, virtual false, abstract: false, final false
inline void SelectParagraphForward() ;

/// @brief Method SelectRight, addr 0x2fbb8f0, size 0xfc, virtual false, abstract: false, final false
inline void SelectRight() ;

/// @brief Method SelectTextEnd, addr 0x2fbbe04, size 0x40, virtual false, abstract: false, final false
inline void SelectTextEnd() ;

/// @brief Method SelectTextStart, addr 0x2fbbddc, size 0x28, virtual false, abstract: false, final false
inline void SelectTextStart() ;

/// @brief Method SelectToEndOfPreviousWord, addr 0x2fbbd24, size 0x5c, virtual false, abstract: false, final false
inline void SelectToEndOfPreviousWord() ;

/// @brief Method SelectToPosition, addr 0x2fbcc00, size 0x2e8, virtual false, abstract: false, final false
inline void SelectToPosition(::UnityEngine::Vector2  cursorPosition) ;

/// @brief Method SelectToStartOfNextWord, addr 0x2fbbd80, size 0x5c, virtual false, abstract: false, final false
inline void SelectToStartOfNextWord() ;

/// @brief Method SelectUp, addr 0x2fbb9ec, size 0x6c, virtual false, abstract: false, final false
inline void SelectUp() ;

/// @brief Method SelectWordLeft, addr 0x2fbbbf4, size 0x130, virtual false, abstract: false, final false
inline void SelectWordLeft() ;

/// @brief Method SelectWordRight, addr 0x2fbbac4, size 0x130, virtual false, abstract: false, final false
inline void SelectWordRight() ;

/// @brief Method SetCursorIndexWithoutNotify, addr 0x2fba9ac, size 0x8, virtual false, abstract: false, final false
inline void SetCursorIndexWithoutNotify(int32_t  index) ;

/// @brief Method SetSelectIndexWithoutNotify, addr 0x2fba9b4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fbb038, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method get_characterCount, addr 0x2fbae14, size 0x94, virtual false, abstract: false, final false
inline int32_t get_characterCount() ;

/// @brief Method get_cursorIndex, addr 0x2fb7e6c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_cursorIndex() ;

/// @brief Method get_hasSelection, addr 0x2fb7da0, size 0x38, virtual false, abstract: false, final false
inline bool get_hasSelection() ;

/// @brief Method get_m_CharacterCount, addr 0x2fbadec, size 0x28, virtual false, abstract: false, final false
inline int32_t get_m_CharacterCount() ;

/// @brief Method get_m_TextElementInfos, addr 0x2fbaea8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_revealCursor, addr 0x2fbade4, size 0x8, virtual false, abstract: false, final false
inline bool get_revealCursor() ;

/// @brief Method get_selectIndex, addr 0x2fb7f00, size 0x8, virtual false, abstract: false, final false
inline int32_t get_selectIndex() ;

/// @brief Method get_selectedText, addr 0x2fbaf28, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method set_cursorIndex, addr 0x2fb7eb8, size 0x2c, virtual false, abstract: false, final false
inline void set_cursorIndex(int32_t  value) ;

/// @brief Method set_revealCursor, addr 0x2fb7e20, size 0x30, virtual false, abstract: false, final false
inline void set_revealCursor(bool  value) ;

/// @brief Method set_selectIndex, addr 0x2fb7f4c, size 0x2c, virtual false, abstract: false, final false
