...
/// @brief Method Destroy, addr 0x2fcd7b0, size 0x88, virtual true, abstract: false, final true
inline void Destroy() ;

/// @brief Method IsRunning, addr 0x2fcda3c, size 0x3c, virtual false, abstract: false, final false
inline bool IsRunning() ;

static inline ::UnityEngine::IntegratedSubsystem* New_ctor() ;

/// @brief Method SetHandle, addr 0x2fcd6f4, size 0x44, virtual false, abstract: false, final false
inline void SetHandle(::UnityEngine::IntegratedSubsystem*  subsystem) ;

/// @brief Method Start, addr 0x2fcd738, size 0x3c, virtual true, abstract: false, final true
inline void Start() ;

/// @brief Method Stop, addr 0x2fcd774, size 0x3c, virtual true, abstract: false, final true
inline void Stop() ;
...
/// @brief Method .ctor, addr 0x2fcda78, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_running, addr 0x2fcd9cc, size 0x60, virtual true, abstract: false, final true
inline bool get_running() ;

/// @brief Method get_valid, addr 0x2fcda2c, size 0x10, virtual false, abstract: false, final false
