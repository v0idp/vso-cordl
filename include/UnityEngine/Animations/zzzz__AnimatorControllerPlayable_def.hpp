...
/// @brief Method Equals, addr 0x2f56c2c, size 0x9c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Animations::AnimatorControllerPlayable  other) ;

/// @brief Method GetHandle, addr 0x2f56c20, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableHandle GetHandle() ;

/// @brief Method SetHandle, addr 0x2f56adc, size 0x144, virtual false, abstract: false, final false
inline void SetHandle(::UnityEngine::Playables::PlayableHandle  handle) ;

/// @brief Method .ctor, addr 0x2f56a40, size 0x9c, virtual false, abstract: false, final false
