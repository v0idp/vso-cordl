...
/// @brief Method Equals, addr 0x2f5619c, size 0xb4, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Animations::AnimationPosePlayable  other) ;

/// @brief Method GetHandle, addr 0x2f56190, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableHandle GetHandle() ;

/// @brief Method .ctor, addr 0x2f560a0, size 0xf0, virtual false, abstract: false, final false
