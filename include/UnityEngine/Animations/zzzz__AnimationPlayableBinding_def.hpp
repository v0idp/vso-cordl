...
public:
// Declarations
/// @brief Method Create, addr 0x2f53c80, size 0x12c, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::PlayableBinding Create(::StringW  name, ::UnityEngine::Object*  key) ;

/// @brief Method CreateAnimationOutput, addr 0x2f53dac, size 0x40, virtual false, abstract: false, final false
