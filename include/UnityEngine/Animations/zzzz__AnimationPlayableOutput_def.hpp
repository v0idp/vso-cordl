...
/// @brief Method Create, addr 0x2f53dec, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method GetHandle, addr 0x2f55f54, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle() ;

/// @brief Method GetTarget, addr 0x2f55fe4, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Animator> GetTarget() ;

/// @brief Method InternalGetTarget, addr 0x2f56020, size 0x3c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Animator> InternalGetTarget(::ByRef<::UnityEngine::Playables::PlayableOutputHandle>  handle) ;

/// @brief Method InternalSetTarget, addr 0x2f5605c, size 0x44, virtual false, abstract: false, final false
static inline void InternalSetTarget(::ByRef<::UnityEngine::Playables::PlayableOutputHandle>  handle, ::UnityEngine::Animator*  target) ;

/// @brief Method SetTarget, addr 0x2f55f10, size 0x44, virtual false, abstract: false, final false
inline void SetTarget(::UnityEngine::Animator*  value) ;

/// @brief Method .ctor, addr 0x2f55e20, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle  handle) ;

/// @brief Method get_Null, addr 0x2f55da4, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method op_Explicit, addr 0x2f55f60, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x2f53e94, size 0x30, virtual false, abstract: false, final false
