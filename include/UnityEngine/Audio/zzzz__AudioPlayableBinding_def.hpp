...
public:
// Declarations
/// @brief Method Create, addr 0x2f5a3b0, size 0x12c, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::PlayableBinding Create(::StringW  name, ::UnityEngine::Object*  key) ;

/// @brief Method CreateAudioOutput, addr 0x2f5a4dc, size 0x40, virtual false, abstract: false, final false
