...
/// @brief Method Create, addr 0x2f5a51c, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method GetHandle, addr 0x2f5a7f8, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle() ;

/// @brief Method InternalSetEvaluateOnSeek, addr 0x2f5a910, size 0x44, virtual false, abstract: false, final false
static inline void InternalSetEvaluateOnSeek(::ByRef<::UnityEngine::Playables::PlayableOutputHandle>  output, bool  value) ;

/// @brief Method InternalSetTarget, addr 0x2f5a888, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method SetEvaluateOnSeek, addr 0x2f5a8cc, size 0x44, virtual false, abstract: false, final false
inline void SetEvaluateOnSeek(bool  value) ;

/// @brief Method SetTarget, addr 0x2f5a7b4, size 0x44, virtual false, abstract: false, final false
inline void SetTarget(::UnityEngine::AudioSource*  value) ;

/// @brief Method .ctor, addr 0x2f5a6c4, size 0xf0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle  handle) ;

/// @brief Method get_Null, addr 0x2f5a648, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method op_Explicit, addr 0x2f5a804, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x2f5a5c4, size 0x30, virtual false, abstract: false, final false
