...
/// @brief Method Equals, addr 0x2f7e964, size 0x174, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x2f7ead8, size 0x108, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Matrix4x4  other) ;

/// @brief Method GetColumn, addr 0x2f7e890, size 0xd4, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 GetColumn(int32_t  index) ;

/// @brief Method GetHashCode, addr 0x2f7e6e8, size 0x1a8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetLossyScale, addr 0x2f7df68, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetLossyScale() ;

/// @brief Method GetLossyScale_Injected, addr 0x2f7dfc4, size 0x44, virtual false, abstract: false, final false
static inline void GetLossyScale_Injected(::ByRef<::UnityEngine::Matrix4x4>  _unity_self, ::ByRef<::UnityEngine::Vector3>  ret) ;

/// @brief Method GetRotation, addr 0x2f7decc, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion GetRotation() ;

/// @brief Method GetRotation_Injected, addr 0x2f7df24, size 0x44, virtual false, abstract: false, final false
static inline void GetRotation_Injected(::ByRef<::UnityEngine::Matrix4x4>  _unity_self, ::ByRef<::UnityEngine::Quaternion>  ret) ;

/// @brief Method GetRow, addr 0x2f7ed0c, size 0xd4, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 GetRow(int32_t  index) ;

/// @brief Method Inverse, addr 0x2f7e184, size 0x6c, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 Inverse(::UnityEngine::Matrix4x4  m) ;

/// @brief Method Inverse3DAffine, addr 0x2f7e0fc, size 0x44, virtual false, abstract: false, final false
static inline bool Inverse3DAffine(::UnityEngine::Matrix4x4  input, ::ByRef<::UnityEngine::Matrix4x4>  result) ;

/// @brief Method Inverse3DAffine_Injected, addr 0x2f7e140, size 0x44, virtual false, abstract: false, final false
static inline bool Inverse3DAffine_Injected(::ByRef<::UnityEngine::Matrix4x4>  input, ::ByRef<::UnityEngine::Matrix4x4>  result) ;

/// @brief Method Inverse_Injected, addr 0x2f7e1f0, size 0x44, virtual false, abstract: false, final false
static inline void Inverse_Injected(::ByRef<::UnityEngine::Matrix4x4>  m, ::ByRef<::UnityEngine::Matrix4x4>  ret) ;

/// @brief Method MultiplyPoint, addr 0x2f7ede0, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 MultiplyPoint(::UnityEngine::Vector3  point) ;

/// @brief Method MultiplyPoint3x4, addr 0x2f7ee60, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 MultiplyPoint3x4(::UnityEngine::Vector3  point) ;

/// @brief Method MultiplyVector, addr 0x2f7eeb8, size 0x48, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 MultiplyVector(::UnityEngine::Vector3  vector) ;

/// @brief Method Perspective, addr 0x2f7e3e4, size 0x94, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 Perspective(float_t  fov, float_t  aspect, float_t  zNear, float_t  zFar) ;

/// @brief Method Perspective_Injected, addr 0x2f7e478, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method Rotate, addr 0x2f7ef2c, size 0x98, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 Rotate(::UnityEngine::Quaternion  q) ;

/// @brief Method Scale, addr 0x2f7ef00, size 0x2c, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 Scale(::UnityEngine::Vector3  vector) ;

/// @brief Method TRS, addr 0x2f7e010, size 0x90, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 TRS(::UnityEngine::Vector3  pos, ::UnityEngine::Quaternion  q, ::UnityEngine::Vector3  s) ;

/// @brief Method TRS_Injected, addr 0x2f7e0a0, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2f7f01c, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2f7f02c, size 0x508, virtual true, abstract: false, final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method Transpose, addr 0x2f7e2b4, size 0x6c, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 Transpose(::UnityEngine::Matrix4x4  m) ;

/// @brief Method Transpose_Injected, addr 0x2f7e320, size 0x44, virtual false, abstract: false, final false
static inline void Transpose_Injected(::ByRef<::UnityEngine::Matrix4x4>  m, ::ByRef<::UnityEngine::Matrix4x4>  ret) ;

/// @brief Method .ctor, addr 0x2f7e4e4, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method get_Item, addr 0x2f7e508, size 0xf0, virtual false, abstract: false, final false
inline float_t get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x2f7e500, size 0x8, virtual false, abstract: false, final false
inline float_t get_Item(int32_t  row, int32_t  column) ;

/// @brief Method get_identity, addr 0x2f7efc4, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 get_identity() ;

/// @brief Method get_inverse, addr 0x2f7e234, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_inverse() ;

/// @brief Method get_lossyScale, addr 0x2f7e00c, size 0x4, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_lossyScale() ;

/// @brief Method get_rotation, addr 0x2f7e008, size 0x4, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_rotation() ;

/// @brief Method get_transpose, addr 0x2f7e364, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method op_Multiply, addr 0x2f7ebe0, size 0xf8, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 op_Multiply(::UnityEngine::Matrix4x4  lhs, ::UnityEngine::Matrix4x4  rhs) ;

/// @brief Method op_Multiply, addr 0x2f7ecd8, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method set_Item, addr 0x2f7e5f8, size 0xf0, virtual false, abstract: false, final false
