...
/// @brief Method Draw, addr 0x2fae438, size 0xd0, virtual false, abstract: false, final false
inline void Draw(::UnityEngine::Rect  position, ::UnityEngine::GUIContent*  content, int32_t  controlID, bool  on, bool  hover) ;

/// @brief Method Draw, addr 0x2fb2e70, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method Draw, addr 0x2fae508, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method Finalize, addr 0x2fb2c20, size 0x110, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetRectOffsetPtr, addr 0x2fb29a8, size 0x44, virtual false, abstract: false, final false
inline ::System::IntPtr GetRectOffsetPtr(int32_t  idx) ;

/// @brief Method GetStyleStatePtr, addr 0x2fb2964, size 0x44, virtual false, abstract: false, final false
inline ::System::IntPtr GetStyleStatePtr(int32_t  idx) ;

/// @brief Method Internal_Create, addr 0x2fb28ec, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr Internal_Create(::UnityEngine::GUIStyle*  self) ;

/// @brief Method Internal_Destroy, addr 0x2fb2928, size 0x3c, virtual false, abstract: false, final false
static inline void Internal_Destroy(::System::IntPtr  self) ;

/// @brief Method Internal_Draw, addr 0x2fb29ec, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Internal_Draw2, addr 0x2fb2afc, size 0x74, virtual false, abstract: false, final false
inline void Internal_Draw2(::UnityEngine::Rect  position, ::UnityEngine::GUIContent*  content, int32_t  controlID, bool  on) ;

/// @brief Method Internal_Draw2_Injected, addr 0x2fb2b70, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method Internal_Draw_Injected, addr 0x2fb2a78, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method IsTooltipActive, addr 0x2fae56c, size 0x3c, virtual false, abstract: false, final false
static inline bool IsTooltipActive(::StringW  tooltip) ;

static inline ::UnityEngine::GUIStyle* New_ctor() ;

/// @brief Method SetDefaultFont, addr 0x2fb0d38, size 0x3c, virtual false, abstract: false, final false
static inline void SetDefaultFont(::UnityEngine::Font*  font) ;

/// @brief Method SetMouseTooltip, addr 0x2fae5a8, size 0x8c, virtual false, abstract: false, final false
static inline void SetMouseTooltip(::StringW  tooltip, ::UnityEngine::Rect  screenRect) ;

/// @brief Method SetMouseTooltip_Injected, addr 0x2fb2bdc, size 0x44, virtual false, abstract: false, final false
static inline void SetMouseTooltip_Injected(::StringW  tooltip, ::ByRef<::UnityEngine::Rect>  screenRect) ;

/// @brief Method ToString, addr 0x2fb2fbc, size 0xe4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fb0fd8, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_fixedHeight, addr 0x2fb27f4, size 0x3c, virtual false, abstract: false, final false
inline float_t get_fixedHeight() ;

/// @brief Method get_fixedWidth, addr 0x2fb27b8, size 0x3c, virtual false, abstract: false, final false
inline float_t get_fixedWidth() ;

/// @brief Method get_margin, addr 0x2fb2d30, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::RectOffset* get_margin() ;

/// @brief Method get_name, addr 0x2fb1f78, size 0x4c, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_none, addr 0x2faee44, size 0x88, virtual false, abstract: false, final false
static inline ::UnityEngine::GUIStyle* get_none() ;

/// @brief Method get_normal, addr 0x2fb2008, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::GUIStyleState* get_normal() ;

/// @brief Method get_padding, addr 0x2fb2dd0, size 0xa0, virtual false, abstract: false, final false
inline ::UnityEngine::RectOffset* get_padding() ;

/// @brief Method get_rawName, addr 0x2fb26f4, size 0x3c, virtual false, abstract: false, final false
inline ::StringW get_rawName() ;

/// @brief Method get_stretchHeight, addr 0x2fb286c, size 0x3c, virtual false, abstract: false, final false
inline bool get_stretchHeight() ;

/// @brief Method get_stretchWidth, addr 0x2fb2830, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method set_alignment, addr 0x2fb2774, size 0x44, virtual false, abstract: false, final false
inline void set_alignment(::UnityEngine::TextAnchor  value) ;

/// @brief Method set_fontSize, addr 0x2fb28a8, size 0x44, virtual false, abstract: false, final false
inline void set_fontSize(int32_t  value) ;

/// @brief Method set_name, addr 0x2fb1060, size 0x48, virtual false, abstract: false, final false
inline void set_name(::StringW  value) ;

/// @brief Method set_rawName, addr 0x2fb2730, size 0x44, virtual false, abstract: false, final false
inline void set_rawName(::StringW  value) ;

/// @brief Method set_stretchHeight, addr 0x2fb1fc4, size 0x44, virtual false, abstract: false, final false
