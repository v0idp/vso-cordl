...
/// @brief Method Internal_Log, addr 0x2f611dc, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method Internal_LogException, addr 0x2f61238, size 0x44, virtual false, abstract: false, final false
static inline void Internal_LogException(::System::Exception*  ex, ::UnityEngine::Object*  obj) ;

/// @brief Method LogException, addr 0x2f61350, size 0x90, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception, ::UnityEngine::Object*  context) ;

/// @brief Method LogFormat, addr 0x2f6127c, size 0x68, virtual true, abstract: false, final true
...
/// @brief Method LogFormat, addr 0x2f612e4, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f613e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
