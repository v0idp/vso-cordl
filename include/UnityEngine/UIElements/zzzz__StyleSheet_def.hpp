...
/// @brief Method CustomStartsWith, addr 0x3150cd8, size 0xc8, virtual false, abstract: false, final false
static inline bool CustomStartsWith(::StringW  originalString, ::StringW  pattern) ;

/// @brief Method FlattenImportedStyleSheetsRecursive, addr 0x3150b18, size 0x7c, virtual false, abstract: false, final false
inline void FlattenImportedStyleSheetsRecursive() ;

/// @brief Method FlattenImportedStyleSheetsRecursive, addr 0x3150b94, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method OnEnable, addr 0x3150b14, size 0x4, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method ReadAssetReference, addr 0x3151490, size 0x60, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> ReadAssetReference(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadColor, addr 0x31510a8, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Color ReadColor(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadDimension, addr 0x3150f10, size 0xbc, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::Dimension ReadDimension(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadEnum, addr 0x3151238, size 0x60, virtual false, abstract: false, final false
inline ::StringW ReadEnum(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadFloat, addr 0x3150da8, size 0xa0, virtual false, abstract: false, final false
inline float_t ReadFloat(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadFunction, addr 0x31515b8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleValueFunction ReadFunction(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadFunctionName, addr 0x31515c0, size 0x18c, virtual false, abstract: false, final false
inline ::StringW ReadFunctionName(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadKeyword, addr 0x3150da0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleValueKeyword ReadKeyword(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadMissingAssetReferenceUrl, addr 0x31514f0, size 0x60, virtual false, abstract: false, final false
inline ::StringW ReadMissingAssetReferenceUrl(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadResourcePath, addr 0x31513c8, size 0x60, virtual false, abstract: false, final false
inline ::StringW ReadResourcePath(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadScalableImage, addr 0x315183c, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::ScalableImage ReadScalableImage(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadString, addr 0x3151170, size 0x60, virtual false, abstract: false, final false
inline ::StringW ReadString(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadVariable, addr 0x3151300, size 0x60, virtual false, abstract: false, final false
inline ::StringW ReadVariable(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method SetupReferences, addr 0x3150444, size 0x540, virtual false, abstract: false, final false
...
/// @brief Method TryReadAssetReference, addr 0x3151550, size 0x68, virtual false, abstract: false, final false
inline bool TryReadAssetReference(::UnityEngine::UIElements::StyleValueHandle  handle, ::ByRef<::UnityEngine::Object*>  value) ;

/// @brief Method TryReadColor, addr 0x3151108, size 0x68, virtual false, abstract: false, final false
inline bool TryReadColor(::UnityEngine::UIElements::StyleValueHandle  handle, ::ByRef<::UnityEngine::Color>  value) ;

/// @brief Method TryReadDimension, addr 0x3150fcc, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method TryReadEnum, addr 0x3151298, size 0x68, virtual false, abstract: false, final false
inline bool TryReadEnum(::UnityEngine::UIElements::StyleValueHandle  handle, ::ByRef<::StringW>  value) ;

/// @brief Method TryReadFloat, addr 0x3150e50, size 0xc0, virtual false, abstract: false, final false
inline bool TryReadFloat(::UnityEngine::UIElements::StyleValueHandle  handle, ::ByRef<float_t>  value) ;

/// @brief Method TryReadResourcePath, addr 0x3151428, size 0x68, virtual false, abstract: false, final false
inline bool TryReadResourcePath(::UnityEngine::UIElements::StyleValueHandle  handle, ::ByRef<::StringW>  value) ;

/// @brief Method TryReadString, addr 0x31511d0, size 0x68, virtual false, abstract: false, final false
inline bool TryReadString(::UnityEngine::UIElements::StyleValueHandle  handle, ::ByRef<::StringW>  value) ;

/// @brief Method TryReadVariable, addr 0x3151360, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x315189c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::StringW getStaticF_kCustomPropertyMarker() ;

/// @brief Method get_complexSelectors, addr 0x3150984, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_contentHash, addr 0x315099c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_contentHash() ;

/// @brief Method get_flattenedRecursiveImports, addr 0x3150994, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::UIElements::StyleSheet>>* get_flattenedRecursiveImports() ;

/// @brief Method get_importedWithErrors, addr 0x315040c, size 0x8, virtual false, abstract: false, final false
inline bool get_importedWithErrors() ;

/// @brief Method get_importedWithWarnings, addr 0x3150420, size 0x8, virtual false, abstract: false, final false
inline bool get_importedWithWarnings() ;

/// @brief Method get_isDefaultStyleSheet, addr 0x31509ac, size 0x8, virtual false, abstract: false, final false
inline bool get_isDefaultStyleSheet() ;

/// @brief Method get_rules, addr 0x3150434, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_complexSelectors, addr 0x315098c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_contentHash, addr 0x31509a4, size 0x8, virtual false, abstract: false, final false
inline void set_contentHash(int32_t  value) ;

/// @brief Method set_importedWithErrors, addr 0x3150414, size 0xc, virtual false, abstract: false, final false
inline void set_importedWithErrors(bool  value) ;

/// @brief Method set_importedWithWarnings, addr 0x3150428, size 0xc, virtual false, abstract: false, final false
inline void set_importedWithWarnings(bool  value) ;

/// @brief Method set_isDefaultStyleSheet, addr 0x31509b4, size 0x160, virtual false, abstract: false, final false
inline void set_isDefaultStyleSheet(bool  value) ;

/// @brief Method set_rules, addr 0x315043c, size 0x8, virtual false, abstract: false, final false
