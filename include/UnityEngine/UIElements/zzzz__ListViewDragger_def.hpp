...
/// @brief Method Equals, addr 0x30e0514, size 0x88, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x30de6a0, size 0x78, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::ListViewDragger_DragPosition  other) ;

/// @brief Method GetHashCode, addr 0x30e059c, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method ApplyDragAndDropUI, addr 0x30dda64, size 0x798, virtual false, abstract: false, final false
inline void ApplyDragAndDropUI(::UnityEngine::UIElements::ListViewDragger_DragPosition  dragPosition) ;

/// @brief Method CanStartDrag, addr 0x30dcad0, size 0x2ec, virtual true, abstract: false, final false
inline bool CanStartDrag(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method ClearDragAndDropUI, addr 0x30dfdc0, size 0x670, virtual true, abstract: false, final false
inline void ClearDragAndDropUI(bool  dragCancelled) ;

/// @brief Method GetHoverBarTopPosition, addr 0x30dfd34, size 0x8c, virtual false, abstract: false, final false
inline float_t GetHoverBarTopPosition(::UnityEngine::UIElements::ReusableCollectionItem*  item) ;

/// @brief Method GetPreviousAndNextItemsIgnoringDraggedItems, addr 0x30dfabc, size 0x278, virtual false, abstract: false, final false
...
/// @brief Method GetRecycledItem, addr 0x30dcdbc, size 0x37c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ReusableCollectionItem* GetRecycledItem(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method GetVisualMode, addr 0x30dd5f0, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method HandleAutoExpansion, addr 0x30dd978, size 0xec, virtual false, abstract: false, final false
inline void HandleAutoExpansion(::UnityEngine::Vector2  pointerPosition) ;

/// @brief Method HandleDragAndScroll, addr 0x30dd780, size 0x1f8, virtual false, abstract: false, final false
inline void HandleDragAndScroll(::UnityEngine::Vector2  pointerPosition) ;

/// @brief Method HandleSiblingInsertionAtAvailableDepthsAndChangeTargetIfNeeded, addr 0x30df5a4, size 0x518, virtual false, abstract: false, final false
...
/// @brief Method HandleTreePosition, addr 0x30df49c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method MakeDragAndDropArgs, addr 0x30de1fc, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method OnDrop, addr 0x30de320, size 0x380, virtual true, abstract: false, final false
inline void OnDrop(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method PlaceHoverBarAt, addr 0x30de718, size 0x660, virtual false, abstract: false, final false
inline void PlaceHoverBarAt(float_t  top, float_t  indentationPadding, float_t  siblingBottom) ;

/// @brief Method PlaceHoverBarAtElement, addr 0x30df0bc, size 0x1c, virtual false, abstract: false, final false
inline void PlaceHoverBarAtElement(::UnityEngine::UIElements::ReusableCollectionItem*  item) ;

/// @brief Method StartDrag, addr 0x30dd138, size 0x2e8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::StartDragArgs StartDrag(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method TryGetDragPosition, addr 0x30df0d8, size 0x3c4, virtual true, abstract: false, final false
...
/// @brief Method UpdateDrag, addr 0x30dd420, size 0x1d0, virtual true, abstract: false, final false
inline void UpdateDrag(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method <ApplyDragAndDropUI>g__GeometryChangedCallback|27_0, addr 0x30e0430, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30dcac4, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView*  listView) ;

/// @brief Method get_dragAndDropController, addr 0x30dcab4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ICollectionDragAndDropController* get_dragAndDropController() ;

/// @brief Method get_targetScrollView, addr 0x30dca98, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ScrollView* get_targetScrollView() ;

/// @brief Method get_targetView, addr 0x30dca1c, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseVerticalCollectionView* get_targetView() ;

/// @brief Method set_dragAndDropController, addr 0x30dcabc, size 0x8, virtual false, abstract: false, final false
