...
/// @brief Method BeginDragMove, addr 0x30a3730, size 0x474, virtual false, abstract: false, final false
inline void BeginDragMove(float_t  pos) ;

/// @brief Method DragMove, addr 0x30a3ba4, size 0x8, virtual false, abstract: false, final false
inline void DragMove(float_t  pos) ;

/// @brief Method EndDragMove, addr 0x30a35a4, size 0x120, virtual false, abstract: false, final false
inline void EndDragMove(bool  cancelled) ;

/// @brief Method IsNotMouseEvent, addr 0x30a34d0, size 0x64, virtual false, abstract: false, final false
static inline bool IsNotMouseEvent(int32_t  pointerId) ;

static inline ::UnityEngine::UIElements::Internal::ColumnMover* New_ctor() ;

/// @brief Method OnKeyDown, addr 0x30a36c4, size 0x6c, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  e) ;

/// @brief Method OnMouseCaptureOut, addr 0x30a2f7c, size 0x7c, virtual false, abstract: false, final false
inline void OnMouseCaptureOut(::UnityEngine::UIElements::MouseCaptureOutEvent*  evt) ;

/// @brief Method OnMouseDown, addr 0x30a29a4, size 0xb4, virtual false, abstract: false, final false
inline void OnMouseDown(::UnityEngine::UIElements::MouseDownEvent*  evt) ;

/// @brief Method OnMouseMove, addr 0x30a2c40, size 0x64, virtual false, abstract: false, final false
inline void OnMouseMove(::UnityEngine::UIElements::MouseMoveEvent*  evt) ;

/// @brief Method OnMouseUp, addr 0x30a2dbc, size 0xa4, virtual false, abstract: false, final false
inline void OnMouseUp(::UnityEngine::UIElements::MouseUpEvent*  evt) ;

/// @brief Method OnPointerCancel, addr 0x30a344c, size 0x84, virtual false, abstract: false, final false
inline void OnPointerCancel(::UnityEngine::UIElements::PointerCancelEvent*  evt) ;

/// @brief Method OnPointerCaptureOut, addr 0x30a3534, size 0x70, virtual false, abstract: false, final false
inline void OnPointerCaptureOut(::UnityEngine::UIElements::PointerCaptureOutEvent*  evt) ;

/// @brief Method OnPointerDown, addr 0x30a30e0, size 0x128, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMove, addr 0x30a3208, size 0x118, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUp, addr 0x30a3320, size 0x12c, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method ProcessCancelEvent, addr 0x30a2ff8, size 0xe8, virtual false, abstract: false, final false
inline void ProcessCancelEvent(::UnityEngine::UIElements::EventBase*  evt, int32_t  pointerId) ;

/// @brief Method ProcessDownEvent, addr 0x30a2a58, size 0x1e8, virtual false, abstract: false, final false
inline void ProcessDownEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method ProcessMoveEvent, addr 0x30a2ca4, size 0x118, virtual false, abstract: false, final false
inline void ProcessMoveEvent(::UnityEngine::UIElements::EventBase*  e, ::UnityEngine::Vector2  localPosition) ;

/// @brief Method ProcessUpEvent, addr 0x30a2e60, size 0x11c, virtual false, abstract: false, final false
inline void ProcessUpEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x30a1eec, size 0x55c, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x30a2448, size 0x55c, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method UpdateMoveLocation, addr 0x30a3bac, size 0x370, virtual false, abstract: false, final false
inline void UpdateMoveLocation() ;

/// @brief Method UpdatePreviewPosition, addr 0x30a3f1c, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30a1e34, size 0xb8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_activeChanged, addr 0x30a1b74, size 0xb0, virtual false, abstract: false, final false
inline void add_activeChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method add_movingChanged, addr 0x30a1cd4, size 0xb0, virtual false, abstract: false, final false
inline void add_movingChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method get_active, addr 0x30a1af4, size 0x8, virtual false, abstract: false, final false
inline bool get_active() ;

/// @brief Method get_columnLayout, addr 0x30a1ae4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout() ;

/// @brief Method get_moving, addr 0x30a1b34, size 0x8, virtual false, abstract: false, final false
inline bool get_moving() ;

/// @brief Method remove_activeChanged, addr 0x30a1c24, size 0xb0, virtual false, abstract: false, final false
inline void remove_activeChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method remove_movingChanged, addr 0x30a1d84, size 0xb0, virtual false, abstract: false, final false
inline void remove_movingChanged(::System::Action_1<::UnityEngine::UIElements::Internal::ColumnMover*>*  value) ;

/// @brief Method set_active, addr 0x30a1afc, size 0x38, virtual false, abstract: false, final false
inline void set_active(bool  value) ;

/// @brief Method set_columnLayout, addr 0x30a1aec, size 0x8, virtual false, abstract: false, final false
inline void set_columnLayout(::UnityEngine::UIElements::ColumnLayout*  value) ;

/// @brief Method set_moving, addr 0x30a1b3c, size 0x38, virtual false, abstract: false, final false
