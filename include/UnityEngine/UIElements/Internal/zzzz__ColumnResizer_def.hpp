...
/// @brief Method BeginDragResize, addr 0x30a4ba0, size 0x48, virtual false, abstract: false, final false
inline void BeginDragResize(float_t  pos) ;

/// @brief Method DragResize, addr 0x30a4ce4, size 0x40, virtual false, abstract: false, final false
inline void DragResize(float_t  pos) ;

/// @brief Method EndDragResize, addr 0x30a493c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method OnKeyDown, addr 0x30a48c8, size 0x74, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  e) ;

/// @brief Method OnPointerDown, addr 0x30a4998, size 0x208, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  e) ;

/// @brief Method OnPointerMove, addr 0x30a4be8, size 0xfc, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  e) ;

/// @brief Method OnPointerUp, addr 0x30a4d24, size 0x130, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  e) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x30a4440, size 0x244, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x30a4684, size 0x244, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method UpdatePreviewPosition, addr 0x30a4e54, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30a4380, size 0xc0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method get_columnLayout, addr 0x30a435c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ColumnLayout* get_columnLayout() ;

/// @brief Method get_preview, addr 0x30a436c, size 0x8, virtual false, abstract: false, final false
inline bool get_preview() ;

/// @brief Method set_columnLayout, addr 0x30a4364, size 0x8, virtual false, abstract: false, final false
inline void set_columnLayout(::UnityEngine::UIElements::ColumnLayout*  value) ;

/// @brief Method set_preview, addr 0x30a4374, size 0xc, virtual false, abstract: false, final false
