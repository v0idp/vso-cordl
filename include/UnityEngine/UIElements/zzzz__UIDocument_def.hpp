...
/// @brief Method AddChildAndInsertContentToVisualTree, addr 0x30ff2ac, size 0x88, virtual false, abstract: false, final false
inline void AddChildAndInsertContentToVisualTree(::UnityEngine::UIElements::UIDocument*  child) ;

/// @brief Method AddRootVisualElementToTree, addr 0x30fee30, size 0xd4, virtual false, abstract: false, final false
inline void AddRootVisualElementToTree() ;

/// @brief Method ApplySortingOrder, addr 0x30fee2c, size 0x4, virtual false, abstract: false, final false
inline void ApplySortingOrder() ;

/// @brief Method Awake, addr 0x30fef74, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method FindUIDocumentParent, addr 0x30ff0d8, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x30ff49c, size 0x20, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x30ff008, size 0xc0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformChildrenChanged, addr 0x30ff4bc, size 0x20c, virtual false, abstract: false, final false
inline void OnTransformChildrenChanged() ;

/// @brief Method OnTransformParentChanged, addr 0x30ff76c, size 0x4, virtual false, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method ReactToHierarchyChanged, addr 0x30ff6c8, size 0xa4, virtual false, abstract: false, final false
inline void ReactToHierarchyChanged() ;

/// @brief Method RecreateUI, addr 0x30fe9f8, size 0x40c, virtual false, abstract: false, final false
inline void RecreateUI() ;

/// @brief Method RemoveChild, addr 0x30ff0c8, size 0x10, virtual false, abstract: false, final false
inline void RemoveChild(::UnityEngine::UIElements::UIDocument*  child) ;

/// @brief Method RemoveFromHierarchy, addr 0x30ff334, size 0xcc, virtual false, abstract: false, final false
inline void RemoveFromHierarchy() ;

/// @brief Method Reset, addr 0x30ff1a8, size 0x104, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetupFromHierarchy, addr 0x30fef78, size 0x90, virtual false, abstract: false, final false
inline void SetupFromHierarchy() ;

/// @brief Method SetupRootClassList, addr 0x30ff400, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30fef04, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF_s_CurrentUIDocumentCounter() ;

/// @brief Method get_firstChildInserIndex, addr 0x30fee04, size 0x8, virtual false, abstract: false, final false
inline int32_t get_firstChildInserIndex() ;

/// @brief Method get_panelSettings, addr 0x30fe72c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UIElements::PanelSettings> get_panelSettings() ;

/// @brief Method get_parentUI, addr 0x30fe9d8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UIElements::UIDocument> get_parentUI() ;

/// @brief Method get_rootVisualElement, addr 0x30fe724, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_rootVisualElement() ;

/// @brief Method get_sortingOrder, addr 0x30fee0c, size 0x8, virtual false, abstract: false, final false
inline float_t get_sortingOrder() ;

/// @brief Method get_visualTreeAsset, addr 0x30fe9e8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_panelSettings, addr 0x30fe734, size 0x2a4, virtual false, abstract: false, final false
inline void set_panelSettings(::UnityEngine::UIElements::PanelSettings*  value) ;

/// @brief Method set_parentUI, addr 0x30fe9e0, size 0x8, virtual false, abstract: false, final false
inline void set_parentUI(::UnityEngine::UIElements::UIDocument*  value) ;

/// @brief Method set_sortingOrder, addr 0x30fee14, size 0x18, virtual false, abstract: false, final false
inline void set_sortingOrder(float_t  value) ;

/// @brief Method set_visualTreeAsset, addr 0x30fe9f0, size 0x8, virtual false, abstract: false, final false
