...
/// @brief Method .ctor, addr 0x3129150, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_hasPainter2D, addr 0x3129140, size 0x10, virtual false, abstract: false, final false
inline bool get_hasPainter2D() ;

/// @brief Method get_painter2D, addr 0x312909c, size 0x64, virtual false, abstract: false, final false
