...
/// @brief Method ExecuteDefaultActionAtTarget, addr 0x3154008, size 0x170, virtual false, abstract: false, final false
inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method InitTextEditorEventHandler, addr 0x3153f3c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method OnFocusInEvent, addr 0x3154178, size 0x2c0, virtual false, abstract: false, final false
inline void OnFocusInEvent(::UnityEngine::UIElements::FocusInEvent*  _) ;

/// @brief Method OnFocusOutEvent, addr 0x3154438, size 0xb4, virtual false, abstract: false, final false
inline void OnFocusOutEvent(::UnityEngine::UIElements::FocusOutEvent*  _) ;

/// @brief Method <OnFocusInEvent>b__10_0, addr 0x31544ec, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3153e78, size 0xc4, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TextElement*  textElement) ;

/// @brief Method get_touchScreenTextFieldChanged, addr 0x3153dc8, size 0xb0, virtual false, abstract: false, final false
