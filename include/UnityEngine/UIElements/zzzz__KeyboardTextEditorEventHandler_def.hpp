...
/// @brief Method ExecuteDefaultActionAtTarget, addr 0x30aebec, size 0x2b0, virtual true, abstract: false, final false
...
/// @brief Method OnBlur, addr 0x30aef84, size 0x54, virtual false, abstract: false, final false
inline void OnBlur(::UnityEngine::UIElements::BlurEvent*  _) ;

/// @brief Method OnExecuteCommandEvent, addr 0x30afbb4, size 0x26c, virtual false, abstract: false, final false
inline void OnExecuteCommandEvent(::UnityEngine::UIElements::ExecuteCommandEvent*  evt) ;

/// @brief Method OnFocus, addr 0x30aeea0, size 0xe4, virtual false, abstract: false, final false
inline void OnFocus(::UnityEngine::UIElements::FocusEvent*  _) ;

/// @brief Method OnKeyDown, addr 0x30aefd8, size 0x9c8, virtual false, abstract: false, final false
...
/// @brief Method OnValidateCommandEvent, addr 0x30af9a0, size 0x214, virtual false, abstract: false, final false
inline void OnValidateCommandEvent(::UnityEngine::UIElements::ValidateCommandEvent*  evt) ;

/// @brief Method UpdateLabel, addr 0x30afe20, size 0x2b8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30aeab4, size 0x10c, virtual false, abstract: false, final false
