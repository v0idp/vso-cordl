...
public:
// Declarations
/// @brief Method CeilToPixelGrid, addr 0x301ae5c, size 0x14, virtual false, abstract: false, final false
static inline float_t CeilToPixelGrid(float_t  v, float_t  pixelsPerPoint, float_t  offset) ;

/// @brief Method RoundToPanelPixelSize, addr 0x301ae70, size 0x48, virtual false, abstract: false, final false
static inline float_t RoundToPanelPixelSize(::UnityEngine::UIElements::VisualElement*  ve, float_t  v) ;

/// @brief Method RoundToPixelGrid, addr 0x301ae40, size 0x1c, virtual false, abstract: false, final false
