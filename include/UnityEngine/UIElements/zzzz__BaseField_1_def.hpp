...
// Dependencies UnityEngine.PropertyName, UnityEngine.UIElements.BindableElement, UnityEngine.UIElements.CustomStyleProperty`1<T>, UnityEngine.UIElements.IEditableElement, UnityEngine.UIElements.INotifyValueChanged`1<T>
namespace UnityEngine::UIElements {
// cpp template
template<typename TValueType>
// Is value type: false
...
/// @brief Field s_LabelExtraContextWidthProperty, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_LabelExtraContextWidthProperty, put=setStaticF_s_LabelExtraContextWidthProperty)) ::UnityEngine::UIElements::CustomStyleProperty_1<float_t>  s_LabelExtraContextWidthProperty;
