...
/// @brief Method AddValue, addr 0x3152484, size 0xa8, virtual false, abstract: false, final false
inline void AddValue(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method Init, addr 0x31522ec, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method ParseVarFunction, addr 0x31525f8, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method PopContext, addr 0x3152408, size 0x7c, virtual false, abstract: false, final false
inline void PopContext() ;

/// @brief Method PushContext, addr 0x315239c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method ResolveFallback, addr 0x3152a78, size 0x280, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleVariableResolver_Result ResolveFallback(::ByRef<int32_t>  index) ;

/// @brief Method ResolveVarFunction, addr 0x31526a8, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method ResolveVarFunction, addr 0x315252c, size 0xcc, virtual false, abstract: false, final false
inline bool ResolveVarFunction(::ByRef<int32_t>  index) ;

/// @brief Method ResolveVariable, addr 0x3152804, size 0x274, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleVariableResolver_Result ResolveVariable(::StringW  variableName) ;

/// @brief Method ValidateResolvedValues, addr 0x3152cf8, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3152e68, size 0x138, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxParser* getStaticF_s_SyntaxParser() ;

/// @brief Method get_currentHandles, addr 0x31522cc, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::UIElements::StyleValueHandle,::Array<::UnityEngine::UIElements::StyleValueHandle>*> get_currentHandles() ;

/// @brief Method get_currentSheet, addr 0x31522c4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UIElements::StyleSheet> get_currentSheet() ;

/// @brief Method get_resolvedValues, addr 0x31522d4, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheets::StylePropertyValue>* get_resolvedValues() ;

/// @brief Method get_variableContext, addr 0x31522dc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_variableContext, addr 0x31522e4, size 0x8, virtual false, abstract: false, final false
