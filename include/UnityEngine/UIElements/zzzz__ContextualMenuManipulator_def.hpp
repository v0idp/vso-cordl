...
/// @brief Method DoDisplayMenu, addr 0x302c088, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method OnContextualMenuEvent, addr 0x302c288, size 0x1c, virtual false, abstract: false, final false
inline void OnContextualMenuEvent(::UnityEngine::UIElements::ContextualMenuPopulateEvent*  evt) ;

/// @brief Method OnKeyUpEvent, addr 0x302c224, size 0x64, virtual false, abstract: false, final false
inline void OnKeyUpEvent(::UnityEngine::UIElements::KeyUpEvent*  evt) ;

/// @brief Method OnMouseDownEventOSX, addr 0x302c124, size 0x88, virtual false, abstract: false, final false
inline void OnMouseDownEventOSX(::UnityEngine::UIElements::MouseDownEvent*  evt) ;

/// @brief Method OnMouseUpDownEvent, addr 0x302bfe8, size 0xa0, virtual false, abstract: false, final false
inline void OnMouseUpDownEvent(::UnityEngine::UIElements::IMouseEvent*  evt) ;

/// @brief Method OnMouseUpEventOSX, addr 0x302c1ac, size 0x78, virtual false, abstract: false, final false
inline void OnMouseUpEventOSX(::UnityEngine::UIElements::MouseUpEvent*  evt) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x302ba58, size 0x2c8, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x302bd20, size 0x2c8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x302b8dc, size 0x17c, virtual false, abstract: false, final false
