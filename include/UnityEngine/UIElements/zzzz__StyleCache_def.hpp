...
/// @brief Field s_ComputedTransitionsCache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_ComputedTransitionsCache, put=setStaticF_s_ComputedTransitionsCache)) ::System::Collections::Generic::Dictionary_2<int32_t,::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty,::Array<::UnityEngine::UIElements::ComputedTransitionProperty>*>>*  s_ComputedTransitionsCache;
...
/// @brief Method SetValue, addr 0x30613cc, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method SetValue, addr 0x30612ac, size 0x90, virtual false, abstract: false, final false
static inline void SetValue(int32_t  hash, ::UnityEngine::UIElements::StyleVariableContext*  data) ;

/// @brief Method SetValue, addr 0x3061158, size 0xc4, virtual false, abstract: false, final false
static inline void SetValue(int64_t  hash, ::ByRef<::UnityEngine::UIElements::ComputedStyle>  data) ;

/// @brief Method TryGetValue, addr 0x306133c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method TryGetValue, addr 0x306121c, size 0x90, virtual false, abstract: false, final false
static inline bool TryGetValue(int32_t  hash, ::ByRef<::UnityEngine::UIElements::StyleVariableContext*>  data) ;

/// @brief Method TryGetValue, addr 0x30610c8, size 0x90, virtual false, abstract: false, final false
