...
public:
// Declarations
/// @brief Method Invoke, addr 0x3106934, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31068ac, size 0x88, virtual false, abstract: false, final false
