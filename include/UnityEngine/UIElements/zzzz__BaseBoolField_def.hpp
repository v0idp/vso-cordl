...
/// @brief Method InitLabel, addr 0x302c5b0, size 0x90, virtual true, abstract: false, final false
inline void InitLabel() ;

static inline ::UnityEngine::UIElements::BaseBoolField* New_ctor(::StringW  label) ;

/// @brief Method OnClickEvent, addr 0x302c720, size 0x288, virtual false, abstract: false, final false
inline void OnClickEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method OnNavigationSubmit, addr 0x302c560, size 0x34, virtual false, abstract: false, final false
inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent*  evt) ;

/// @brief Method RegisterEditingCallbacks, addr 0x302cb64, size 0x118, virtual true, abstract: false, final false
inline void RegisterEditingCallbacks() ;

/// @brief Method SetValueWithoutNotify, addr 0x302c640, size 0xe0, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(bool  newValue) ;

/// @brief Method ToggleValue, addr 0x302c9a8, size 0x38, virtual true, abstract: false, final false
inline void ToggleValue() ;

/// @brief Method UnregisterEditingCallbacks, addr 0x302cc7c, size 0x118, virtual true, abstract: false, final false
inline void UnregisterEditingCallbacks() ;

/// @brief Method UpdateMixedValueContent, addr 0x302c9e0, size 0x184, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x302c2a4, size 0x234, virtual false, abstract: false, final false
inline void _ctor(::StringW  label) ;

/// @brief Method get_text, addr 0x302c594, size 0x1c, virtual false, abstract: false, final false
inline ::StringW get_text() ;

/// @brief Method set_text, addr 0x302c4d8, size 0x88, virtual false, abstract: false, final false
