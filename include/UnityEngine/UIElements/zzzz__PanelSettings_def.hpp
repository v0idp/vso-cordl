...
/// @brief Method CreateRelatedRuntimePanel, addr 0x30fdbb4, size 0xf8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseRuntimePanel* CreateRelatedRuntimePanel() ;

/// @brief Method DisposePanel, addr 0x30fccf4, size 0x20, virtual false, abstract: false, final false
inline void DisposePanel() ;

/// @brief Method DisposeRelatedPanel, addr 0x30fdcac, size 0x5c, virtual false, abstract: false, final false
inline void DisposeRelatedPanel() ;

/// @brief Method MarkPotentiallyEmpty, addr 0x30fdb58, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method SetSortingPriority, addr 0x30fc6c0, size 0x34, virtual false, abstract: false, final false
inline void SetSortingPriority() ;

/// @brief Method SetTargetDisplay, addr 0x30fc730, size 0x28, virtual false, abstract: false, final false
inline void SetTargetDisplay() ;

/// @brief Method SetTargetTexture, addr 0x30fc590, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30fca00, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::PanelSettings*  settings) ;

/// @brief Method get_isInitialized, addr 0x30fc914, size 0x10, virtual false, abstract: false, final false
inline bool get_isInitialized() ;

/// @brief Method get_panel, addr 0x30fc7bc, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method ApplyPanelSettings, addr 0x30fcd50, size 0x5cc, virtual false, abstract: false, final false
inline void ApplyPanelSettings() ;

/// @brief Method ApplySortingOrder, addr 0x30fc6a8, size 0x18, virtual false, abstract: false, final false
inline void ApplySortingOrder() ;

/// @brief Method ApplyThemeStyleSheet, addr 0x30fc3f8, size 0x15c, virtual false, abstract: false, final false
inline void ApplyThemeStyleSheet(::UnityEngine::UIElements::VisualElement*  root) ;

/// @brief Method AttachAndInsertUIDocumentToVisualTree, addr 0x30fd620, size 0x90, virtual false, abstract: false, final false
inline void AttachAndInsertUIDocumentToVisualTree(::UnityEngine::UIElements::UIDocument*  uiDocument) ;

/// @brief Method DetachUIDocument, addr 0x30fdadc, size 0x7c, virtual false, abstract: false, final false
inline void DetachUIDocument(::UnityEngine::UIElements::UIDocument*  uiDocument) ;

/// @brief Method DisposePanel, addr 0x30fcd14, size 0x2c, virtual false, abstract: false, final false
inline void DisposePanel() ;

/// @brief Method GetDisplayRect, addr 0x30fd31c, size 0xf8, virtual false, abstract: false, final false
inline ::UnityEngine::Rect GetDisplayRect() ;

/// @brief Method InitializeShaders, addr 0x30fcb50, size 0x178, virtual false, abstract: false, final false
inline void InitializeShaders() ;

static inline ::UnityEngine::UIElements::PanelSettings* New_ctor() ;

/// @brief Method OnDisable, addr 0x30fccc8, size 0x2c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x30fca2c, size 0x108, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Reset, addr 0x30fca28, size 0x4, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method ResolveScale, addr 0x30fd414, size 0xd0, virtual false, abstract: false, final false
inline float_t ResolveScale(::UnityEngine::Rect  targetRect, float_t  screenDpi) ;

/// @brief Method SetScreenToPanelSpaceFunction, addr 0x30fd5f0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method UpdateScreenDPI, addr 0x30fcb34, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30fc960, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ScreenDPI, addr 0x30fcd40, size 0x8, virtual false, abstract: false, final false
inline float_t get_ScreenDPI() ;

/// @brief Method get_clearColor, addr 0x30fc778, size 0x8, virtual false, abstract: false, final false
inline bool get_clearColor() ;

/// @brief Method get_clearDepthStencil, addr 0x30fc758, size 0x8, virtual false, abstract: false, final false
inline bool get_clearDepthStencil() ;

/// @brief Method get_colorClearValue, addr 0x30fc78c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_colorClearValue() ;

/// @brief Method get_depthClearValue, addr 0x30fc76c, size 0xc, virtual false, abstract: false, final false
inline float_t get_depthClearValue() ;

/// @brief Method get_dynamicAtlasSettings, addr 0x30fc950, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::DynamicAtlasSettings* get_dynamicAtlasSettings() ;

/// @brief Method get_fallbackDpi, addr 0x30fc61c, size 0x8, virtual false, abstract: false, final false
inline float_t get_fallbackDpi() ;

/// @brief Method get_isInitialized, addr 0x30fc8f4, size 0x20, virtual false, abstract: false, final false
inline bool get_isInitialized() ;

/// @brief Method get_match, addr 0x30fc670, size 0x8, virtual false, abstract: false, final false
inline float_t get_match() ;

/// @brief Method get_panel, addr 0x30fc7a4, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseRuntimePanel* get_panel() ;

/// @brief Method get_referenceDpi, addr 0x30fc5e8, size 0x8, virtual false, abstract: false, final false
inline float_t get_referenceDpi() ;

/// @brief Method get_referenceResolution, addr 0x30fc650, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2Int get_referenceResolution() ;

/// @brief Method get_referenceSpritePixelsPerUnit, addr 0x30fc5c8, size 0x8, virtual false, abstract: false, final false
inline float_t get_referenceSpritePixelsPerUnit() ;

/// @brief Method get_scale, addr 0x30fc5d8, size 0x8, virtual false, abstract: false, final false
inline float_t get_scale() ;

/// @brief Method get_scaleMode, addr 0x30fc5b8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::PanelScaleMode get_scaleMode() ;

/// @brief Method get_screenMatchMode, addr 0x30fc660, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::PanelScreenMatchMode get_screenMatchMode() ;

/// @brief Method get_sortingOrder, addr 0x30fc680, size 0x8, virtual false, abstract: false, final false
inline float_t get_sortingOrder() ;

/// @brief Method get_targetDisplay, addr 0x30fc6f4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_targetDisplay() ;

/// @brief Method get_targetTexture, addr 0x30fc554, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_targetTexture() ;

/// @brief Method get_themeStyleSheet, addr 0x30fc3e4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UIElements::ThemeStyleSheet> get_themeStyleSheet() ;

/// @brief Method get_visualTree, addr 0x30fc924, size 0x2c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_visualTree() ;

/// @brief Method set_ScreenDPI, addr 0x30fcd48, size 0x8, virtual false, abstract: false, final false
inline void set_ScreenDPI(float_t  value) ;

/// @brief Method set_clearColor, addr 0x30fc780, size 0xc, virtual false, abstract: false, final false
inline void set_clearColor(bool  value) ;

/// @brief Method set_clearDepthStencil, addr 0x30fc760, size 0xc, virtual false, abstract: false, final false
inline void set_clearDepthStencil(bool  value) ;

/// @brief Method set_colorClearValue, addr 0x30fc798, size 0xc, virtual false, abstract: false, final false
inline void set_colorClearValue(::UnityEngine::Color  value) ;

/// @brief Method set_dynamicAtlasSettings, addr 0x30fc958, size 0x8, virtual false, abstract: false, final false
inline void set_dynamicAtlasSettings(::UnityEngine::UIElements::DynamicAtlasSettings*  value) ;

/// @brief Method set_fallbackDpi, addr 0x30fc624, size 0x2c, virtual false, abstract: false, final false
inline void set_fallbackDpi(float_t  value) ;

/// @brief Method set_match, addr 0x30fc678, size 0x8, virtual false, abstract: false, final false
inline void set_match(float_t  value) ;

/// @brief Method set_referenceDpi, addr 0x30fc5f0, size 0x2c, virtual false, abstract: false, final false
inline void set_referenceDpi(float_t  value) ;

/// @brief Method set_referenceResolution, addr 0x30fc658, size 0x8, virtual false, abstract: false, final false
inline void set_referenceResolution(::UnityEngine::Vector2Int  value) ;

/// @brief Method set_referenceSpritePixelsPerUnit, addr 0x30fc5d0, size 0x8, virtual false, abstract: false, final false
inline void set_referenceSpritePixelsPerUnit(float_t  value) ;

/// @brief Method set_scale, addr 0x30fc5e0, size 0x8, virtual false, abstract: false, final false
inline void set_scale(float_t  value) ;

/// @brief Method set_scaleMode, addr 0x30fc5c0, size 0x8, virtual false, abstract: false, final false
inline void set_scaleMode(::UnityEngine::UIElements::PanelScaleMode  value) ;

/// @brief Method set_screenMatchMode, addr 0x30fc668, size 0x8, virtual false, abstract: false, final false
inline void set_screenMatchMode(::UnityEngine::UIElements::PanelScreenMatchMode  value) ;

/// @brief Method set_sortingOrder, addr 0x30fc688, size 0x20, virtual false, abstract: false, final false
inline void set_sortingOrder(float_t  value) ;

/// @brief Method set_targetDisplay, addr 0x30fc6fc, size 0x34, virtual false, abstract: false, final false
inline void set_targetDisplay(int32_t  value) ;

/// @brief Method set_targetTexture, addr 0x30fc55c, size 0x34, virtual false, abstract: false, final false
inline void set_targetTexture(::UnityEngine::RenderTexture*  value) ;

/// @brief Method set_themeStyleSheet, addr 0x30fc3ec, size 0xc, virtual false, abstract: false, final false
