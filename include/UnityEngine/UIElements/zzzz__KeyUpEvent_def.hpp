...
/// @brief Method <.cctor>b__0_0, addr 0x30ed178, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::KeyUpEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x30ed170, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x30ed0cc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
