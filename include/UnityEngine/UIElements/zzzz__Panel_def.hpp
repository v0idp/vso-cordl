...
/// @brief Method ApplyStyles, addr 0x3107dbc, size 0x20, virtual true, abstract: false, final false
inline void ApplyStyles() ;

/// @brief Method Blur, addr 0x3106dac, size 0x28, virtual false, abstract: false, final false
inline void Blur() ;

/// @brief Method CreateMarkers, addr 0x3106e10, size 0x24c, virtual false, abstract: false, final false
inline void CreateMarkers() ;

/// @brief Method DefaultTimeSinceStartupMs, addr 0x3107640, size 0x38, virtual false, abstract: false, final false
static inline int64_t DefaultTimeSinceStartupMs() ;

/// @brief Method Dispose, addr 0x31074fc, size 0x68, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Focus, addr 0x3106da0, size 0xc, virtual false, abstract: false, final false
inline void Focus() ;

/// @brief Method GetUpdater, addr 0x3108140, size 0x1c, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::IVisualTreeUpdater* GetUpdater(::UnityEngine::UIElements::VisualTreeUpdatePhase  phase) ;

/// @brief Method LoadResource, addr 0x3106c74, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method OnVersionChanged, addr 0x31080f4, size 0x4c, virtual true, abstract: false, final false
inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::VersionChangeType  versionChangeType) ;

/// @brief Method PerformPick, addr 0x31076fc, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method Pick, addr 0x3107ad8, size 0x178, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* Pick(::UnityEngine::Vector2  point) ;

/// @brief Method PickAll, addr 0x31079fc, size 0xdc, virtual true, abstract: false, final false
...
/// @brief Method PickAll, addr 0x3107678, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method Repaint, addr 0x3107e50, size 0x2a4, virtual true, abstract: false, final false
inline void Repaint(::UnityEngine::Event*  e) ;

/// @brief Method TimeSinceStartupMs, addr 0x3107564, size 0xdc, virtual false, abstract: false, final false
static inline int64_t TimeSinceStartupMs() ;

/// @brief Method UpdateAnimations, addr 0x3107d7c, size 0x20, virtual true, abstract: false, final false
inline void UpdateAnimations() ;

/// @brief Method UpdateBindings, addr 0x3107d9c, size 0x20, virtual true, abstract: false, final false
inline void UpdateBindings() ;

/// @brief Method UpdateForRepaint, addr 0x3107ddc, size 0x74, virtual false, abstract: false, final false
inline void UpdateForRepaint() ;

/// @brief Method ValidateFocus, addr 0x3106dd4, size 0x34, virtual true, abstract: false, final false
inline void ValidateFocus() ;

/// @brief Method ValidateLayout, addr 0x3107d18, size 0x64, virtual true, abstract: false, final false
inline void ValidateLayout() ;

/// @brief Method <Pick>g__PixelOf|101_0, addr 0x3107c50, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3107160, size 0x39c, virtual false, abstract: false, final false
...
/// @brief Method get_IMGUIContainersCount, addr 0x31070b4, size 0x8, virtual true, abstract: false, final false
inline int32_t get_IMGUIContainersCount() ;

/// @brief Method get_IMGUIEventInterests, addr 0x3106bfc, size 0x10, virtual true, abstract: false, final false
inline ::UnityEngine::EventInterests get_IMGUIEventInterests() ;

/// @brief Method get_TimeSinceStartup, addr 0x310705c, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::TimeMsFunction* get_TimeSinceStartup() ;

/// @brief Method get_atlas, addr 0x31070e4, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::AtlasBase* get_atlas() ;

/// @brief Method get_contextType, addr 0x3106bcc, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::ContextType get_contextType() ;

/// @brief Method get_dispatcher, addr 0x3106a88, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::EventDispatcher* get_dispatcher() ;

/// @brief Method get_focusController, addr 0x3106bec, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::FocusController* get_focusController() ;

/// @brief Method get_getViewDataDictionary, addr 0x3106be4, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::GetViewDataDictionary* get_getViewDataDictionary() ;

/// @brief Method get_hierarchyVersion, addr 0x31070d4, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_hierarchyVersion() ;

/// @brief Method get_loadResourceFunc, addr 0x3106c1c, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::LoadResourceFunction* get_loadResourceFunc() ;

/// @brief Method get_name, addr 0x3106e08, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_ownerObject, addr 0x3106bbc, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::ScriptableObject> get_ownerObject() ;

/// @brief Method get_rootIMGUIContainer, addr 0x31070c4, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::IMGUIContainer* get_rootIMGUIContainer() ;

/// @brief Method get_saveViewData, addr 0x3106bdc, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::SavePersistentViewData* get_saveViewData() ;

/// @brief Method get_scheduler, addr 0x3106afc, size 0x4, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::IScheduler* get_scheduler() ;

/// @brief Method get_standardShader, addr 0x31070dc, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_standardShader() ;

/// @brief Method get_styleAnimationSystem, addr 0x3106b00, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::IStylePropertyAnimationSystem* get_styleAnimationSystem() ;

/// @brief Method get_timerEventScheduler, addr 0x3106a98, size 0x64, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TimerEventScheduler* get_timerEventScheduler() ;

/// @brief Method get_version, addr 0x31070cc, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_version() ;

/// @brief Method get_visualTree, addr 0x3106a80, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_IMGUIContainersCount, addr 0x31070bc, size 0x8, virtual true, abstract: false, final false
inline void set_IMGUIContainersCount(int32_t  value) ;

/// @brief Method set_IMGUIEventInterests, addr 0x3106c0c, size 0x10, virtual true, abstract: false, final false
inline void set_IMGUIEventInterests(::UnityEngine::EventInterests  value) ;

/// @brief Method set_atlas, addr 0x31070ec, size 0x74, virtual true, abstract: false, final false
inline void set_atlas(::UnityEngine::UIElements::AtlasBase*  value) ;

/// @brief Method set_contextType, addr 0x3106bd4, size 0x8, virtual true, abstract: false, final false
inline void set_contextType(::UnityEngine::UIElements::ContextType  value) ;

/// @brief Method set_dispatcher, addr 0x3106a90, size 0x8, virtual true, abstract: false, final true
inline void set_dispatcher(::UnityEngine::UIElements::EventDispatcher*  value) ;

/// @brief Method set_focusController, addr 0x3106bf4, size 0x8, virtual true, abstract: false, final true
inline void set_focusController(::UnityEngine::UIElements::FocusController*  value) ;

/// @brief Method set_name, addr 0x30fe45c, size 0x8, virtual false, abstract: false, final false
inline void set_name(::StringW  value) ;

/// @brief Method set_ownerObject, addr 0x3106bc4, size 0x8, virtual true, abstract: false, final false
inline void set_ownerObject(::UnityEngine::ScriptableObject*  value) ;

/// @brief Method set_styleAnimationSystem, addr 0x3106b08, size 0xb4, virtual true, abstract: false, final false
