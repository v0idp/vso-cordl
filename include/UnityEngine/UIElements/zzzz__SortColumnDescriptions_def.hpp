...
/// @brief Method Add, addr 0x30c2100, size 0xb4, virtual true, abstract: false, final true
inline void Add(::UnityEngine::UIElements::SortColumnDescription*  item) ;

/// @brief Method Clear, addr 0x30c0968, size 0x140, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method Contains, addr 0x30c24e8, size 0xac, virtual true, abstract: false, final true
inline bool Contains(::UnityEngine::UIElements::SortColumnDescription*  item) ;

/// @brief Method CopyTo, addr 0x30c2594, size 0xbc, virtual true, abstract: false, final true
...
/// @brief Method GetEnumerator, addr 0x30c205c, size 0xa0, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::UIElements::SortColumnDescription*>* GetEnumerator() ;

/// @brief Method Insert, addr 0x30c21b4, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method OnDescriptionChanged, addr 0x30c2650, size 0x1c, virtual false, abstract: false, final false
inline void OnDescriptionChanged(::UnityEngine::UIElements::SortColumnDescription*  desc) ;

/// @brief Method Remove, addr 0x30c2370, size 0x178, virtual true, abstract: false, final true
inline bool Remove(::UnityEngine::UIElements::SortColumnDescription*  desc) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x30c20fc, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x30c0cb0, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_changed, addr 0x30c1f24, size 0x9c, virtual false, abstract: false, final false
inline void add_changed(::System::Action*  value) ;

/// @brief Method get_Count, addr 0x30c266c, size 0xa0, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsReadOnly, addr 0x30c270c, size 0xa4, virtual true, abstract: false, final true
...
/// @brief Method remove_changed, addr 0x30c1fc0, size 0x9c, virtual false, abstract: false, final false
