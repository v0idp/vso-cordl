...
/// @brief Method <.cctor>b__40_0, addr 0x30e665c, size 0x68, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::EventDispatcher_EventRecord>* __cctor_b__40_0() ;

/// @brief Method .ctor, addr 0x30e6654, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <processingEvents>k__BackingField, offset 0x51, size 0x1 
...
/// @brief Field m_CurrentEvent, offset 0x40, size 0x8 
...
/// @brief Field m_DispatchContexts, offset 0x48, size 0x8 
...
/// @brief Field m_DispatchStackFrame, offset 0x38, size 0x4 
...
/// @brief Field s_EditorStrategies, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_EditorStrategies, put=setStaticF_s_EditorStrategies)) ::ArrayW<::UnityEngine::UIElements::IEventDispatchingStrategy*,::Array<::UnityEngine::UIElements::IEventDispatchingStrategy*>*>  s_EditorStrategies;

/// @brief Method ApplyDispatchingStrategies, addr 0x30e5d04, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method CloseGate, addr 0x30e48d0, size 0x14, virtual false, abstract: false, final false
inline void CloseGate() ;

/// @brief Method CreateForRuntime, addr 0x30e4b04, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method Dispatch, addr 0x30e4d3c, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method HandleRecursiveState, addr 0x30e5510, size 0x428, virtual false, abstract: false, final false
...
/// @brief Method OpenGate, addr 0x30e48fc, size 0x160, virtual false, abstract: false, final false
inline void OpenGate() ;

/// @brief Method ProcessEvent, addr 0x30e4f50, size 0x5c0, virtual false, abstract: false, final false
inline void ProcessEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method ProcessEventQueue, addr 0x30e5938, size 0x3b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30e4b5c, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method get_dispatchImmediately, addr 0x30e4d10, size 0x20, virtual false, abstract: false, final false
inline bool get_dispatchImmediately() ;

/// @brief Method get_pointerState, addr 0x30e4afc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_processingEvents, addr 0x30e4d30, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field m_GateDepth, offset: 0x34, size: 0x4, def value: None
 uint32_t  ___m_GateDepth;

/// @brief Field m_DispatchStackFrame, offset: 0x38, size: 0x4, def value: None
 int32_t  ___m_DispatchStackFrame;

/// @brief Field m_CurrentEvent, offset: 0x40, size: 0x8, def value: None
 ::UnityEngine::UIElements::EventBase*  ___m_CurrentEvent;

/// @brief Field m_DispatchContexts, offset: 0x48, size: 0x8, def value: None
 ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::EventDispatcher_DispatchContext>*  ___m_DispatchContexts;

/// @brief Field m_Immediate, offset: 0x50, size: 0x1, def value: None
 bool  ___m_Immediate;

/// @brief Field <processingEvents>k__BackingField, offset: 0x51, size: 0x1, def value: None
...
static_assert(offsetof(::UnityEngine::UIElements::EventDispatcher, ___m_GateDepth) == 0x34, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::EventDispatcher, ___m_DispatchStackFrame) == 0x38, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::EventDispatcher, ___m_CurrentEvent) == 0x40, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::EventDispatcher, ___m_DispatchContexts) == 0x48, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::EventDispatcher, ___m_Immediate) == 0x50, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::EventDispatcher, ____processingEvents_k__BackingField) == 0x51, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::EventDispatcher, 0x58>, "Size mismatch!");
