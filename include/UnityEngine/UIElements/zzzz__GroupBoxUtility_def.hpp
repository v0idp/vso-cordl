...
/// @brief Method FindOrCreateGroupManager, addr 0x30ff770, size 0x46c, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::IGroupManager* FindOrCreateGroupManager(::UnityEngine::UIElements::IGroupBox*  groupBox) ;

/// @brief Method OnGroupBoxDetachedFromPanel, addr 0x30ffd08, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method OnPanelDestroyed, addr 0x30ffdbc, size 0xd4, virtual false, abstract: false, final false
