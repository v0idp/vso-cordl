...
/// @brief Method SliderNormalizeValue, addr 0x30ccb90, size 0x24, virtual true, abstract: false, final false
inline float_t SliderNormalizeValue(float_t  currentValue, float_t  lowerValue, float_t  higherValue) ;

/// @brief Method .ctor, addr 0x30cc6f8, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30ccbc4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x30ccc0c, size 0x1ec, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30ccdf8, size 0x210, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Adjust, addr 0x30cafa4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method OnSliderValueChange, addr 0x30cc788, size 0x9c, virtual false, abstract: false, final false
inline void OnSliderValueChange(::UnityEngine::UIElements::ChangeEvent_1<float_t>*  evt) ;

/// @brief Method ScrollPageDown, addr 0x30cc91c, size 0x8, virtual false, abstract: false, final false
inline void ScrollPageDown() ;

/// @brief Method ScrollPageDown, addr 0x30cc924, size 0xf0, virtual false, abstract: false, final false
inline void ScrollPageDown(float_t  factor) ;

/// @brief Method ScrollPageUp, addr 0x30cc824, size 0x8, virtual false, abstract: false, final false
inline void ScrollPageUp() ;

/// @brief Method ScrollPageUp, addr 0x30cc82c, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30cc6e4, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x30c82b0, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method add_valueChanged, addr 0x30cc324, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method get_highButton, addr 0x30cc4ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::RepeatButton* get_highButton() ;

/// @brief Method get_highValue, addr 0x30c7358, size 0x50, virtual false, abstract: false, final false
inline float_t get_highValue() ;

/// @brief Method get_lowButton, addr 0x30cc49c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::RepeatButton* get_lowButton() ;

/// @brief Method get_lowValue, addr 0x30ca9d8, size 0x50, virtual false, abstract: false, final false
inline float_t get_lowValue() ;

/// @brief Method get_slider, addr 0x30cc48c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Slider* get_slider() ;

/// @brief Method get_value, addr 0x30c61e8, size 0x24, virtual false, abstract: false, final false
inline float_t get_value() ;

/// @brief Method remove_valueChanged, addr 0x30cc3d8, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method set_direction, addr 0x30cc4bc, size 0x228, virtual false, abstract: false, final false
inline void set_direction(::UnityEngine::UIElements::SliderDirection  value) ;

/// @brief Method set_highButton, addr 0x30cc4b4, size 0x8, virtual false, abstract: false, final false
inline void set_highButton(::UnityEngine::UIElements::RepeatButton*  value) ;

/// @brief Method set_highValue, addr 0x30cb07c, size 0x60, virtual false, abstract: false, final false
inline void set_highValue(float_t  value) ;

/// @brief Method set_lowButton, addr 0x30cc4a4, size 0x8, virtual false, abstract: false, final false
inline void set_lowButton(::UnityEngine::UIElements::RepeatButton*  value) ;

/// @brief Method set_lowValue, addr 0x30cb01c, size 0x60, virtual false, abstract: false, final false
inline void set_lowValue(float_t  value) ;

/// @brief Method set_slider, addr 0x30cc494, size 0x8, virtual false, abstract: false, final false
inline void set_slider(::UnityEngine::UIElements::Slider*  value) ;

/// @brief Method set_value, addr 0x30c635c, size 0x24, virtual false, abstract: false, final false
