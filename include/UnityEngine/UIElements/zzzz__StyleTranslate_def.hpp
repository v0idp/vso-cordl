...
/// @brief Method Equals, addr 0x3149410, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x31493cc, size 0x44, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::StyleTranslate  other) ;

/// @brief Method GetHashCode, addr 0x31494b0, size 0x24, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x31494d4, size 0x88, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x3149300, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x31492bc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Translate  v) ;

/// @brief Method .ctor, addr 0x31492e8, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Translate  v, ::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method get_keyword, addr 0x31492b4, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method get_value, addr 0x31491cc, size 0xcc, virtual true, abstract: false, final true
...
/// @brief Method op_Equality, addr 0x3149310, size 0x94, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::StyleTranslate  lhs, ::UnityEngine::UIElements::StyleTranslate  rhs) ;

/// @brief Method op_Implicit, addr 0x31493a4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x31493b4, size 0x18, virtual false, abstract: false, final false
