...
/// @brief Method DetachElement, addr 0x302a614, size 0x8c, virtual true, abstract: false, final false
inline void DetachElement() ;

/// @brief Method Init, addr 0x3021ff4, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method PreAttachElement, addr 0x302a588, size 0x8c, virtual true, abstract: false, final false
inline void PreAttachElement() ;

/// @brief Method SetDragGhost, addr 0x302a6a0, size 0x70, virtual true, abstract: false, final false
inline void SetDragGhost(bool  dragGhost) ;

/// @brief Method UpdateDragHandle, addr 0x30225ec, size 0x144, virtual false, abstract: false, final false
inline void UpdateDragHandle(bool  needsDragHandle) ;

/// @brief Method UpdateHierarchy, addr 0x302a338, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x302a710, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_rootElement, addr 0x302a320, size 0x18, virtual true, abstract: false, final false
