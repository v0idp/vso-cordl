...
/// @brief Method Equals, addr 0x301ca34, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x301cac4, size 0x5c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::BackgroundSize  other) ;

/// @brief Method GetHashCode, addr 0x301cb20, size 0x5c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Initial, addr 0x301c9e4, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::BackgroundSize Initial() ;

/// @brief Method ToString, addr 0x301cbc4, size 0xd8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x301c34c, size 0x54, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BackgroundSizeType  sizeType) ;

/// @brief Method .ctor, addr 0x301c3a0, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Length  sizeX, ::UnityEngine::UIElements::Length  sizeY) ;

/// @brief Method get_sizeType, addr 0x301c960, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BackgroundSizeType get_sizeType() ;

/// @brief Method get_x, addr 0x301c9bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Length get_x() ;

/// @brief Method get_y, addr 0x301c9d0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x301c770, size 0x30, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::BackgroundSize  style1, ::UnityEngine::UIElements::BackgroundSize  style2) ;

/// @brief Method op_Inequality, addr 0x301cb7c, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method set_sizeType, addr 0x301c968, size 0x54, virtual false, abstract: false, final false
inline void set_sizeType(::UnityEngine::UIElements::BackgroundSizeType  value) ;

/// @brief Method set_x, addr 0x301c9c4, size 0xc, virtual false, abstract: false, final false
inline void set_x(::UnityEngine::UIElements::Length  value) ;

/// @brief Method set_y, addr 0x301c9d8, size 0xc, virtual false, abstract: false, final false
