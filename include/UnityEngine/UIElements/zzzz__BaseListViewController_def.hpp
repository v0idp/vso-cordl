...
/// @brief Method AddItems, addr 0x3022810, size 0x778, virtual true, abstract: false, final false
inline void AddItems(int32_t  itemCount) ;

/// @brief Method AddToArray, addr 0x30230dc, size 0x124, virtual false, abstract: false, final false
static inline ::System::Array* AddToArray(::System::Array*  source, int32_t  itemCount) ;

/// @brief Method ClearItems, addr 0x3023de8, size 0x1ac, virtual true, abstract: false, final false
inline void ClearItems() ;

/// @brief Method EnsureItemSourceCanBeResized, addr 0x3022f88, size 0x154, virtual false, abstract: false, final false
inline void EnsureItemSourceCanBeResized() ;

/// @brief Method InvokeBindItem, addr 0x3022500, size 0xec, virtual true, abstract: false, final false
inline void InvokeBindItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem, int32_t  index) ;

/// @brief Method InvokeMakeItem, addr 0x3021f0c, size 0xe8, virtual true, abstract: false, final false
inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem) ;

/// @brief Method Move, addr 0x3023238, size 0x174, virtual true, abstract: false, final false
inline void Move(int32_t  index, int32_t  newIndex) ;

/// @brief Method NeedsDragHandle, addr 0x3022808, size 0x8, virtual true, abstract: false, final false
inline bool NeedsDragHandle(int32_t  index) ;

static inline ::UnityEngine::UIElements::BaseListViewController* New_ctor() ;

/// @brief Method PostInitRegistration, addr 0x30220b8, size 0x448, virtual false, abstract: false, final false
inline void PostInitRegistration(::UnityEngine::UIElements::ReusableListViewItem*  listItem) ;

/// @brief Method RaiseItemsAdded, addr 0x3023200, size 0x1c, virtual false, abstract: false, final false
inline void RaiseItemsAdded(::System::Collections::Generic::IEnumerable_1<int32_t>*  indices) ;

/// @brief Method RaiseItemsRemoved, addr 0x3023a2c, size 0x1c, virtual false, abstract: false, final false
inline void RaiseItemsRemoved(::System::Collections::Generic::IEnumerable_1<int32_t>*  indices) ;

/// @brief Method RaiseOnSizeChanged, addr 0x302321c, size 0x1c, virtual false, abstract: false, final false
inline void RaiseOnSizeChanged() ;

/// @brief Method RemoveFromArray, addr 0x3023a48, size 0x1b0, virtual false, abstract: false, final false
static inline ::System::Array* RemoveFromArray(::System::Array*  source, ::System::Collections::Generic::List_1<int32_t>*  indicesToRemove) ;

/// @brief Method RemoveItem, addr 0x3023608, size 0x1ac, virtual true, abstract: false, final false
inline void RemoveItem(int32_t  index) ;

/// @brief Method RemoveItems, addr 0x30237b4, size 0x278, virtual true, abstract: false, final false
inline void RemoveItems(::System::Collections::Generic::List_1<int32_t>*  indices) ;

/// @brief Method RemoveItems, addr 0x3023bf8, size 0x1f0, virtual true, abstract: false, final false
inline void RemoveItems(int32_t  itemCount) ;

/// @brief Method Swap, addr 0x30233ac, size 0x240, virtual false, abstract: false, final false
inline void Swap(int32_t  lhs, int32_t  rhs) ;

/// @brief Method <AddItems>g__IsGenericList|15_0, addr 0x3023fa4, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3023f94, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_itemsAdded, addr 0x3021bd0, size 0xb0, virtual false, abstract: false, final false
inline void add_itemsAdded(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>*  value) ;

/// @brief Method add_itemsRemoved, addr 0x3021d30, size 0xb0, virtual false, abstract: false, final false
inline void add_itemsRemoved(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>*  value) ;

/// @brief Method add_itemsSourceSizeChanged, addr 0x3021a98, size 0x9c, virtual false, abstract: false, final false
inline void add_itemsSourceSizeChanged(::System::Action*  value) ;

/// @brief Method get_baseListView, addr 0x3021e90, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseListView* get_baseListView() ;

/// @brief Method remove_itemsAdded, addr 0x3021c80, size 0xb0, virtual false, abstract: false, final false
inline void remove_itemsAdded(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>*  value) ;

/// @brief Method remove_itemsRemoved, addr 0x3021de0, size 0xb0, virtual false, abstract: false, final false
inline void remove_itemsRemoved(::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>*  value) ;

/// @brief Method remove_itemsSourceSizeChanged, addr 0x3021b34, size 0x9c, virtual false, abstract: false, final false
