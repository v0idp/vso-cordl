...
/// @brief Method Dispose, addr 0x302801c, size 0xc, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetIdForIndex, addr 0x30280ec, size 0x8, virtual true, abstract: false, final false
inline int32_t GetIdForIndex(int32_t  index) ;

/// @brief Method GetIndexForId, addr 0x30280e4, size 0x8, virtual true, abstract: false, final false
inline int32_t GetIndexForId(int32_t  id) ;

/// @brief Method GetItemForIndex, addr 0x30280f4, size 0x13c, virtual true, abstract: false, final false
inline ::System::Object* GetItemForIndex(int32_t  index) ;

/// @brief Method GetItemsCount, addr 0x3028028, size 0xb0, virtual true, abstract: false, final false
inline int32_t GetItemsCount() ;

/// @brief Method GetItemsMinCount, addr 0x30280d8, size 0xc, virtual true, abstract: false, final false
inline int32_t GetItemsMinCount() ;

/// @brief Method InvokeBindItem, addr 0x3022730, size 0xd8, virtual true, abstract: false, final false
inline void InvokeBindItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem, int32_t  index) ;

/// @brief Method InvokeDestroyItem, addr 0x3024edc, size 0x24, virtual true, abstract: false, final false
inline void InvokeDestroyItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem) ;

/// @brief Method InvokeMakeItem, addr 0x3028230, size 0x3c, virtual true, abstract: false, final false
inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem) ;

/// @brief Method InvokeUnbindItem, addr 0x302826c, size 0x34, virtual true, abstract: false, final false
...
/// @brief Method PrepareView, addr 0x3028018, size 0x4, virtual true, abstract: false, final false
inline void PrepareView() ;

/// @brief Method RaiseItemIndexChanged, addr 0x30235ec, size 0x1c, virtual false, abstract: false, final false
inline void RaiseItemIndexChanged(int32_t  srcIndex, int32_t  dstIndex) ;

/// @brief Method RaiseItemsSourceChanged, addr 0x3027f4c, size 0x1c, virtual false, abstract: false, final false
inline void RaiseItemsSourceChanged() ;

/// @brief Method SetItemsSourceWithoutNotify, addr 0x3027974, size 0x8, virtual false, abstract: false, final false
inline void SetItemsSourceWithoutNotify(::System::Collections::IList*  source) ;

/// @brief Method SetView, addr 0x3027f70, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3023f9c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_itemIndexChanged, addr 0x3027d34, size 0xb0, virtual false, abstract: false, final false
inline void add_itemIndexChanged(::System::Action_2<int32_t,int32_t>*  value) ;

/// @brief Method add_itemsSourceChanged, addr 0x3027bfc, size 0x9c, virtual false, abstract: false, final false
inline void add_itemsSourceChanged(::System::Action*  value) ;

/// @brief Method get_itemsSource, addr 0x3027e94, size 0x8, virtual true, abstract: false, final false
inline ::System::Collections::IList* get_itemsSource() ;

/// @brief Method get_view, addr 0x3027f68, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseVerticalCollectionView* get_view() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_itemIndexChanged, addr 0x3027de4, size 0xb0, virtual false, abstract: false, final false
inline void remove_itemIndexChanged(::System::Action_2<int32_t,int32_t>*  value) ;

/// @brief Method remove_itemsSourceChanged, addr 0x3027c98, size 0x9c, virtual false, abstract: false, final false
inline void remove_itemsSourceChanged(::System::Action*  value) ;

/// @brief Method set_itemsSource, addr 0x3027e9c, size 0xb0, virtual true, abstract: false, final false
