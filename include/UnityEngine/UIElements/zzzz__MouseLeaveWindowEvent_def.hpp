...
/// @brief Method <.cctor>b__0_0, addr 0x30f06d0, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MouseLeaveWindowEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x30f06c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPooled, addr 0x30f001c, size 0xb8, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MouseLeaveWindowEvent* GetPooled(::UnityEngine::Event*  systemEvent) ;

/// @brief Method Init, addr 0x30efed8, size 0x50, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x30eff28, size 0xa4, virtual false, abstract: false, final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::MouseLeaveWindowEvent* New_ctor() ;

/// @brief Method PostDispatch, addr 0x30f00d4, size 0x598, virtual true, abstract: false, final false
inline void PostDispatch(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method .ctor, addr 0x30effcc, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;
