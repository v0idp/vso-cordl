...
// Dependencies UnityEngine.UIElements.BaseUxmlFactory`2<TCreatedType, TTraits>, UnityEngine.UIElements.IBaseUxmlFactory, UnityEngine.UIElements.IBaseUxmlObjectFactory, UnityEngine.UIElements.IUxmlObjectFactory`1<T>
namespace UnityEngine::UIElements {
// cpp template
template<typename TCreatedType,typename TTraits>
// Is value type: false
