...
/// @brief Method get_childIndex, addr 0x30dc8fc, size 0x8, virtual true, abstract: false, final true
inline int32_t get_childIndex() ;

/// @brief Method get_dragAndDropData, addr 0x30dc91c, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::DragAndDropData* get_dragAndDropData() ;

/// @brief Method get_dragAndDropPosition, addr 0x30dc90c, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::DragAndDropPosition get_dragAndDropPosition() ;

/// @brief Method get_insertAtIndex, addr 0x30dc8dc, size 0x8, virtual true, abstract: false, final true
inline int32_t get_insertAtIndex() ;

/// @brief Method get_parentId, addr 0x30dc8ec, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_childIndex, addr 0x30dc904, size 0x8, virtual false, abstract: false, final false
inline void set_childIndex(int32_t  value) ;

/// @brief Method set_dragAndDropData, addr 0x30dc924, size 0x8, virtual false, abstract: false, final false
inline void set_dragAndDropData(::UnityEngine::UIElements::DragAndDropData*  value) ;

/// @brief Method set_dragAndDropPosition, addr 0x30dc914, size 0x8, virtual false, abstract: false, final false
inline void set_dragAndDropPosition(::UnityEngine::UIElements::DragAndDropPosition  value) ;

/// @brief Method set_insertAtIndex, addr 0x30dc8e4, size 0x8, virtual false, abstract: false, final false
inline void set_insertAtIndex(int32_t  value) ;

/// @brief Method set_parentId, addr 0x30dc8f4, size 0x8, virtual false, abstract: false, final false
inline void set_parentId(int32_t  value) ;

/// @brief Method set_target, addr 0x30dc8d4, size 0x8, virtual false, abstract: false, final false
