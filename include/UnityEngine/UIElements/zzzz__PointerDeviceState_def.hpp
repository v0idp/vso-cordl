...
/// @brief Method SetLocation, addr 0x30f3620, size 0x108, virtual false, abstract: false, final false
inline void SetLocation(::UnityEngine::Vector2  position, ::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method get_Flags, addr 0x30f3f04, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::PointerDeviceState_LocationFlag get_Flags() ;

/// @brief Method get_Panel, addr 0x30f3ef4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::IPanel* get_Panel() ;

/// @brief Method get_Position, addr 0x30f3ee4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_Position() ;

/// @brief Method set_Flags, addr 0x30f3f0c, size 0x8, virtual false, abstract: false, final false
inline void set_Flags(::UnityEngine::UIElements::PointerDeviceState_LocationFlag  value) ;

/// @brief Method set_Panel, addr 0x30f3efc, size 0x8, virtual false, abstract: false, final false
inline void set_Panel(::UnityEngine::UIElements::IPanel*  value) ;

/// @brief Method set_Position, addr 0x30f3eec, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetPanel, addr 0x30f3a84, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::IPanel* GetPanel(int32_t  pointerId, ::UnityEngine::UIElements::ContextType  contextType) ;

/// @brief Method GetPlayerPanelWithSoftPointerCapture, addr 0x30f3d64, size 0x7c, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::IPanel* GetPlayerPanelWithSoftPointerCapture(int32_t  pointerId) ;

/// @brief Method GetPointerPosition, addr 0x30f3a04, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 GetPointerPosition(int32_t  pointerId, ::UnityEngine::UIElements::ContextType  contextType) ;

/// @brief Method GetPressedButtons, addr 0x30f3ba4, size 0x7c, virtual false, abstract: false, final false
static inline int32_t GetPressedButtons(int32_t  pointerId) ;

/// @brief Method HasAdditionalPressedButtons, addr 0x30f3c20, size 0x98, virtual false, abstract: false, final false
static inline bool HasAdditionalPressedButtons(int32_t  pointerId, int32_t  exceptButtonId) ;

/// @brief Method HasFlagFast, addr 0x30f3b04, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method HasLocationFlag, addr 0x30f3b10, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method PressButton, addr 0x30f37d0, size 0xdc, virtual false, abstract: false, final false
static inline void PressButton(int32_t  pointerId, int32_t  buttonId) ;

/// @brief Method ReleaseAllButtons, addr 0x30f3988, size 0x7c, virtual false, abstract: false, final false
static inline void ReleaseAllButtons(int32_t  pointerId) ;

/// @brief Method ReleaseButton, addr 0x30f38ac, size 0xdc, virtual false, abstract: false, final false
static inline void ReleaseButton(int32_t  pointerId, int32_t  buttonId) ;

/// @brief Method RemovePanelData, addr 0x30f343c, size 0x1e4, virtual false, abstract: false, final false
static inline void RemovePanelData(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method SavePointerPosition, addr 0x30f3728, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method SetPlayerPanelWithSoftPointerCapture, addr 0x30f3cb8, size 0xac, virtual false, abstract: false, final false
