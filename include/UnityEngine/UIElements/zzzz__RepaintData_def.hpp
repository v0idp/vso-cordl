...
/// @brief Method .ctor, addr 0x3105920, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_currentOffset, addr 0x31058f0, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 get_currentOffset() ;

/// @brief Method get_currentWorldClip, addr 0x3105904, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_currentWorldClip() ;

/// @brief Method get_repaintEvent, addr 0x3105910, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Event* get_repaintEvent() ;

/// @brief Method set_repaintEvent, addr 0x3105918, size 0x8, virtual false, abstract: false, final false
