...
public:
// Declarations
/// @brief Method ToNativeParams, addr 0x31278fc, size 0xb8, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method AdjustSpriteUVsForScaleMode, addr 0x3127b50, size 0x2e8, virtual false, abstract: false, final false
...
/// @brief Method AdjustUVsForScaleMode, addr 0x31279b4, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method ApplyPackingRotation, addr 0x3128070, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect ApplyPackingRotation(::UnityEngine::Rect  uv, ::UnityEngine::SpritePackingRotation  rotation) ;

/// @brief Method ComputeGeomRect, addr 0x3127f10, size 0xb0, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect ComputeGeomRect(::UnityEngine::Sprite*  sprite) ;

/// @brief Method ComputeUVRect, addr 0x3127fc0, size 0xb0, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect ComputeUVRect(::UnityEngine::Sprite*  sprite) ;

/// @brief Method HasRadius, addr 0x3128f40, size 0x74, virtual false, abstract: false, final false
inline bool HasRadius(float_t  epsilon) ;

/// @brief Method HasSlices, addr 0x3128fb4, size 0x4c, virtual false, abstract: false, final false
inline bool HasSlices(float_t  epsilon) ;

/// @brief Method MakeSprite, addr 0x312827c, size 0xb1c, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams MakeSprite(::UnityEngine::Rect  containerRect, ::UnityEngine::Rect  subRect, ::UnityEngine::Sprite*  sprite, ::UnityEngine::ScaleMode  scaleMode, ::UnityEngine::UIElements::ContextType  panelContext, bool  hasRadius, ::ByRef<::UnityEngine::Vector4>  slices, bool  useForRepeat) ;

/// @brief Method MakeTextured, addr 0x31280c0, size 0x1bc, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams MakeTextured(::UnityEngine::Rect  rect, ::UnityEngine::Rect  uv, ::UnityEngine::Texture*  texture, ::UnityEngine::ScaleMode  scaleMode, ::UnityEngine::UIElements::ContextType  panelContext) ;

/// @brief Method MakeVectorTextured, addr 0x3128d98, size 0x1a8, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams MakeVectorTextured(::UnityEngine::Rect  rect, ::UnityEngine::Rect  uv, ::UnityEngine::UIElements::VectorImage*  vectorImage, ::UnityEngine::ScaleMode  scaleMode, ::UnityEngine::UIElements::ContextType  panelContext) ;

/// @brief Method RectIntersection, addr 0x3127e38, size 0xd8, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect RectIntersection(::UnityEngine::Rect  a, ::UnityEngine::Rect  b) ;

/// @brief Method ToNativeParams, addr 0x3129000, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Field backgroundPositionX, offset: 0x50, size: 0xc, def value: None
 ::UnityEngine::UIElements::BackgroundPosition  backgroundPositionX;

/// @brief Field backgroundPositionY, offset: 0x5c, size: 0xc, def value: None
 ::UnityEngine::UIElements::BackgroundPosition  backgroundPositionY;

/// @brief Field backgroundRepeat, offset: 0x68, size: 0x8, def value: None
 ::UnityEngine::UIElements::BackgroundRepeat  backgroundRepeat;

/// @brief Field backgroundSize, offset: 0x70, size: 0x14, def value: None
...
/// @brief Field scaleMode, offset: 0xa8, size: 0x4, def value: None
 ::UnityEngine::ScaleMode  scaleMode;

/// @brief Field playmodeTintColor, offset: 0xac, size: 0x10, def value: None
 ::UnityEngine::Color  playmodeTintColor;

/// @brief Field topLeftRadius, offset: 0xbc, size: 0x8, def value: None
 ::UnityEngine::Vector2  topLeftRadius;

/// @brief Field topRightRadius, offset: 0xc4, size: 0x8, def value: None
 ::UnityEngine::Vector2  topRightRadius;

/// @brief Field bottomRightRadius, offset: 0xcc, size: 0x8, def value: None
 ::UnityEngine::Vector2  bottomRightRadius;

/// @brief Field bottomLeftRadius, offset: 0xd4, size: 0x8, def value: None
 ::UnityEngine::Vector2  bottomLeftRadius;

/// @brief Field contentSize, offset: 0xdc, size: 0x8, def value: None
 ::UnityEngine::Vector2  contentSize;

/// @brief Field textureSize, offset: 0xe4, size: 0x8, def value: None
 ::UnityEngine::Vector2  textureSize;

/// @brief Field leftSlice, offset: 0xec, size: 0x4, def value: None
 int32_t  leftSlice;

/// @brief Field topSlice, offset: 0xf0, size: 0x4, def value: None
 int32_t  topSlice;

/// @brief Field rightSlice, offset: 0xf4, size: 0x4, def value: None
 int32_t  rightSlice;

/// @brief Field bottomSlice, offset: 0xf8, size: 0x4, def value: None
 int32_t  bottomSlice;

/// @brief Field sliceScale, offset: 0xfc, size: 0x4, def value: None
 float_t  sliceScale;

/// @brief Field spriteGeomRect, offset: 0x100, size: 0x10, def value: None
 ::UnityEngine::Rect  spriteGeomRect;

/// @brief Field rectInset, offset: 0x110, size: 0x10, def value: None
 ::UnityEngine::Vector4  rectInset;

/// @brief Field colorPage, offset: 0x120, size: 0x8, def value: None
 ::UnityEngine::UIElements::ColorPage  colorPage;

/// @brief Field meshFlags, offset: 0x128, size: 0x4, def value: None
...
static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, backgroundRepeatRect) == 0x40, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, backgroundPositionX) == 0x50, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, backgroundPositionY) == 0x5c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, backgroundRepeat) == 0x68, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, backgroundSize) == 0x70, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, texture) == 0x88, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, sprite) == 0x90, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, vectorImage) == 0x98, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, material) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, scaleMode) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, playmodeTintColor) == 0xac, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, topLeftRadius) == 0xbc, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, topRightRadius) == 0xc4, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, bottomRightRadius) == 0xcc, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, bottomLeftRadius) == 0xd4, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, contentSize) == 0xdc, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, textureSize) == 0xe4, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, leftSlice) == 0xec, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, topSlice) == 0xf0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, rightSlice) == 0xf4, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, bottomSlice) == 0xf8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, sliceScale) == 0xfc, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, spriteGeomRect) == 0x100, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, rectInset) == 0x110, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, colorPage) == 0x120, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, meshFlags) == 0x128, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams, 0x130>, "Size mismatch!");
...
/// @brief Method AdjustBackgroundSizeForBorders, addr 0x31274dc, size 0x420, virtual false, abstract: false, final false
...
/// @brief Method ConvertBorderRadiusPercentToPoints, addr 0x3127204, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method GetVisualElementRadii, addr 0x3127240, size 0x29c, virtual false, abstract: false, final false
...
/// @brief Method Rectangle, addr 0x312703c, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method Text, addr 0x312713c, size 0xc8, virtual false, abstract: false, final false
