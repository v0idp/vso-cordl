...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x30545e0, size 0x40, virtual false, abstract: false, final false
inline uint32_t _GetValueFromBag_b__3_0(::StringW  s, uint32_t  i) ;

/// @brief Method .ctor, addr 0x30545d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ConvertValueToUInt, addr 0x3054540, size 0x3c, virtual false, abstract: false, final false
static inline uint32_t ConvertValueToUInt(::StringW  v, uint32_t  defaultValue) ;

/// @brief Method GetValueFromBag, addr 0x30543f4, size 0x14c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x305435c, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
