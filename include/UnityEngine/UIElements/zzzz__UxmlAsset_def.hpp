...
/// @brief Method SetAttribute, addr 0x3055168, size 0x4, virtual false, abstract: false, final false
inline void SetAttribute(::StringW  name, ::StringW  value) ;

/// @brief Method SetOrAddProperty, addr 0x305516c, size 0x1f8, virtual false, abstract: false, final false
inline void SetOrAddProperty(::StringW  propertyName, ::StringW  propertyValue) ;

/// @brief Method TryGetAttributeValue, addr 0x3055098, size 0xd0, virtual true, abstract: false, final true
...
/// @brief Method get_fullTypeName, addr 0x3055078, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_fullTypeName() ;

/// @brief Method get_id, addr 0x3055080, size 0x8, virtual false, abstract: false, final false
inline int32_t get_id() ;

/// @brief Method get_orderInDocument, addr 0x3055088, size 0x8, virtual false, abstract: false, final false
inline int32_t get_orderInDocument() ;

/// @brief Method get_parentId, addr 0x3055090, size 0x8, virtual false, abstract: false, final false
