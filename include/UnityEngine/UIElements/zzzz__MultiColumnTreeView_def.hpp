...
/// @brief Method .ctor, addr 0x30c190c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x30c1954, size 0x170, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30c1ac4, size 0x10c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateViewController, addr 0x30c1630, size 0x8c, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::CollectionViewController* CreateViewController() ;

/// @brief Method CreateVirtualizationController, addr 0x30c18a8, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method RaiseColumnSortingChanged, addr 0x30c1428, size 0x1c, virtual false, abstract: false, final false
inline void RaiseColumnSortingChanged() ;

/// @brief Method RaiseHeaderContextMenuPopulate, addr 0x30c18f0, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method SetViewController, addr 0x30c16bc, size 0x1ec, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30c14a4, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x30c14fc, size 0x134, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Columns*  columns) ;

/// @brief Method get_columns, addr 0x30c133c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Columns* get_columns() ;

/// @brief Method get_sortColumnDescriptions, addr 0x30c1390, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::SortColumnDescriptions* get_sortColumnDescriptions() ;

/// @brief Method get_viewController, addr 0x30c12b8, size 0x84, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MultiColumnTreeViewController* get_viewController() ;

/// @brief Method set_columns, addr 0x30c1344, size 0x4c, virtual false, abstract: false, final false
inline void set_columns(::UnityEngine::UIElements::Columns*  value) ;

/// @brief Method set_sortColumnDescriptions, addr 0x30c1398, size 0x90, virtual false, abstract: false, final false
inline void set_sortColumnDescriptions(::UnityEngine::UIElements::SortColumnDescriptions*  value) ;

/// @brief Method set_sortingEnabled, addr 0x30c1444, size 0x60, virtual false, abstract: false, final false
