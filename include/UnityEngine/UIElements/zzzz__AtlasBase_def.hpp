...
/// @brief Method InvokeAssignedToPanel, addr 0x301af40, size 0xc, virtual false, abstract: false, final false
inline void InvokeAssignedToPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method InvokeRemovedFromPanel, addr 0x301af4c, size 0xc, virtual false, abstract: false, final false
inline void InvokeRemovedFromPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method InvokeUpdateDynamicTextures, addr 0x301af58, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method OnAssignedToPanel, addr 0x301af34, size 0x4, virtual true, abstract: false, final false
inline void OnAssignedToPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method OnRemovedFromPanel, addr 0x301af38, size 0x4, virtual true, abstract: false, final false
inline void OnRemovedFromPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method OnUpdateDynamicTextures, addr 0x301af3c, size 0x4, virtual true, abstract: false, final false
inline void OnUpdateDynamicTextures(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method RepaintTexturedElements, addr 0x301af64, size 0xec, virtual false, abstract: false, final false
static inline void RepaintTexturedElements(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method Reset, addr 0x301af30, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ReturnAtlas, addr 0x301af2c, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method SetDynamicTexture, addr 0x301b050, size 0x20, virtual false, abstract: false, final false
inline void SetDynamicTexture(::UnityEngine::UIElements::TextureId  id, ::UnityEngine::Texture*  texture) ;

/// @brief Method TryGetAtlas, addr 0x301aeb8, size 0x74, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x301b070, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
