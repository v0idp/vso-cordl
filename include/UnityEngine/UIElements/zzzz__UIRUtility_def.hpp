...
/// @brief Method Destroy, addr 0x312509c, size 0xcc, virtual false, abstract: false, final false
static inline void Destroy(::UnityEngine::Object*  obj) ;

/// @brief Method GetNextPow2, addr 0x31256b8, size 0x1c, virtual false, abstract: false, final false
static inline int32_t GetNextPow2(int32_t  n) ;

/// @brief Method GetNextPow2Exp, addr 0x312b250, size 0x30, virtual false, abstract: false, final false
static inline int32_t GetNextPow2Exp(int32_t  n) ;

/// @brief Method GetPrevPow2, addr 0x312b21c, size 0x34, virtual false, abstract: false, final false
static inline int32_t GetPrevPow2(int32_t  n) ;

/// @brief Method IsElementSelfHidden, addr 0x312b15c, size 0xc0, virtual false, abstract: false, final false
static inline bool IsElementSelfHidden(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method IsRoundRect, addr 0x312aec0, size 0x204, virtual false, abstract: false, final false
static inline bool IsRoundRect(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method IsVectorImageBackground, addr 0x312b0c4, size 0x90, virtual false, abstract: false, final false
static inline bool IsVectorImageBackground(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method ShapeWindingIsClockwise, addr 0x312ae40, size 0x80, virtual false, abstract: false, final false
