...
/// @brief Method PrivateUnSchedule, addr 0x312badc, size 0xa0, virtual false, abstract: false, final false
inline bool PrivateUnSchedule(::UnityEngine::UIElements::ScheduledItem*  sItem) ;

/// @brief Method RemovedScheduledItemAt, addr 0x312b8d0, size 0x7c, virtual false, abstract: false, final false
inline bool RemovedScheduledItemAt(int32_t  index) ;

/// @brief Method Schedule, addr 0x312b718, size 0x1b8, virtual true, abstract: false, final true
inline void Schedule(::UnityEngine::UIElements::ScheduledItem*  item) ;

/// @brief Method Unschedule, addr 0x312b94c, size 0x190, virtual true, abstract: false, final true
inline void Unschedule(::UnityEngine::UIElements::ScheduledItem*  item) ;

/// @brief Method UpdateScheduledEvents, addr 0x312bb7c, size 0x314, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x312be90, size 0xe8, virtual false, abstract: false, final false
inline void _ctor() ;
