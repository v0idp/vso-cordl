...
/// @brief Method ActivateCompatibilityMouseEvents, addr 0x31227f8, size 0x34, virtual false, abstract: false, final false
inline void ActivateCompatibilityMouseEvents(int32_t  pointerId) ;

/// @brief Method CapturePointer, addr 0x31223a8, size 0x12c, virtual false, abstract: false, final false
inline void CapturePointer(::UnityEngine::UIElements::IEventHandler*  handler, int32_t  pointerId) ;

/// @brief Method GetCapturingElement, addr 0x3122610, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::IEventHandler* GetCapturingElement(int32_t  pointerId) ;

/// @brief Method HasPointerCapture, addr 0x3122338, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method PreventCompatibilityMouseEvents, addr 0x31228f0, size 0x30, virtual false, abstract: false, final false
inline void PreventCompatibilityMouseEvents(int32_t  pointerId) ;

/// @brief Method ProcessPointerCapture, addr 0x3122c3c, size 0x998, virtual false, abstract: false, final false
inline void ProcessPointerCapture(int32_t  pointerId) ;

/// @brief Method ReleasePointer, addr 0x312250c, size 0x3c, virtual false, abstract: false, final false
inline void ReleasePointer(::UnityEngine::UIElements::IEventHandler*  handler, int32_t  pointerId) ;

/// @brief Method ReleasePointer, addr 0x3122704, size 0x30, virtual false, abstract: false, final false
inline void ReleasePointer(int32_t  pointerId) ;

/// @brief Method Reset, addr 0x31236ac, size 0x90, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method ShouldSendCompatibilityMouseEvents, addr 0x3122a44, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31235d4, size 0xd8, virtual false, abstract: false, final false
inline void _ctor() ;
