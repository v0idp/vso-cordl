...
/// @brief Method Equals, addr 0x304c2e0, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x304c370, size 0x7c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::TextShadow  other) ;

/// @brief Method GetHashCode, addr 0x304c3ec, size 0xd8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method LerpUnclamped, addr 0x304c630, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x304c53c, size 0xf4, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x304c4c4, size 0x30, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::TextShadow  style1, ::UnityEngine::UIElements::TextShadow  style2) ;

/// @brief Method op_Inequality, addr 0x304c4f4, size 0x48, virtual false, abstract: false, final false
