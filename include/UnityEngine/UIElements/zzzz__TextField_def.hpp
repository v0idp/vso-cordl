...
/// @brief Method .ctor, addr 0x30b0bf4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x30b0c3c, size 0x1b8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30b0df4, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method StringToValue, addr 0x30b0ff4, size 0x8, virtual true, abstract: false, final false
inline ::StringW StringToValue(::StringW  str) ;

/// @brief Method .ctor, addr 0x30b05b8, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_isPasswordField, addr 0x30b0f7c, size 0x78, virtual true, abstract: false, final false
inline void set_isPasswordField(bool  value) ;

/// @brief Method set_multiline, addr 0x30b017c, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method ExecuteDefaultAction, addr 0x30b0904, size 0x15c, virtual true, abstract: false, final false
...
/// @brief Method OnViewDataReady, addr 0x30b0a60, size 0xb4, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method SetValueWithoutNotify, addr 0x30b0790, size 0x114, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(::StringW  newValue) ;

/// @brief Method StringToValue, addr 0x30b0b1c, size 0x8, virtual true, abstract: false, final false
inline ::StringW StringToValue(::StringW  str) ;

/// @brief Method UpdateTextFromValue, addr 0x30b08a4, size 0x60, virtual true, abstract: false, final false
inline void UpdateTextFromValue() ;

/// @brief Method ValueToString, addr 0x30b0b14, size 0x8, virtual true, abstract: false, final false
inline ::StringW ValueToString(::StringW  value) ;

/// @brief Method .ctor, addr 0x30b03ac, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x30b03c4, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::StringW  label) ;

/// @brief Method .ctor, addr 0x30b03d8, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method get_textInput, addr 0x30b00d8, size 0x84, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TextField_TextInput* get_textInput() ;

/// @brief Method get_value, addr 0x30b0624, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method set_multiline, addr 0x30b015c, size 0x20, virtual false, abstract: false, final false
inline void set_multiline(bool  value) ;

/// @brief Method set_value, addr 0x30b066c, size 0x124, virtual true, abstract: false, final false
