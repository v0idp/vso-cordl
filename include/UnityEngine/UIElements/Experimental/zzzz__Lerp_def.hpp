...
public:
// Declarations
/// @brief Method Interpolate, addr 0x30a13e4, size 0x38, virtual false, abstract: false, final false
static inline ::UnityEngine::Color Interpolate(::UnityEngine::Color  start, ::UnityEngine::Color  end, float_t  ratio) ;

/// @brief Method Interpolate, addr 0x30a141c, size 0x3bc, virtual false, abstract: false, final false
...
/// @brief Method Interpolate, addr 0x30a13d4, size 0x10, virtual false, abstract: false, final false
