...
/// @brief Method DestroyElement, addr 0x302a050, size 0x20, virtual true, abstract: false, final false
inline void DestroyElement() ;

/// @brief Method DetachElement, addr 0x3029f44, size 0x10c, virtual true, abstract: false, final false
inline void DetachElement() ;

/// @brief Method Init, addr 0x3029e80, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method OnGeometryChanged, addr 0x302a300, size 0x20, virtual false, abstract: false, final false
inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method PreAttachElement, addr 0x3029e88, size 0xbc, virtual true, abstract: false, final false
inline void PreAttachElement() ;

/// @brief Method SetDragGhost, addr 0x302a160, size 0x1a0, virtual true, abstract: false, final false
inline void SetDragGhost(bool  dragGhost) ;

/// @brief Method SetSelected, addr 0x302a070, size 0xf0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3029df0, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_onDestroy, addr 0x3029c90, size 0xb0, virtual false, abstract: false, final false
inline void add_onDestroy(::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*  value) ;

/// @brief Method add_onGeometryChanged, addr 0x3029b30, size 0xb0, virtual false, abstract: false, final false
inline void add_onGeometryChanged(::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*  value) ;

/// @brief Method get_animator, addr 0x3029aec, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Experimental::ValueAnimation_1<::UnityEngine::UIElements::Experimental::StyleValues>* get_animator() ;

/// @brief Method get_bindableElement, addr 0x3029adc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_bindableElement() ;

/// @brief Method get_id, addr 0x3029b0c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_id() ;

/// @brief Method get_index, addr 0x3029afc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_index() ;

/// @brief Method get_isDragGhost, addr 0x3029b1c, size 0x8, virtual false, abstract: false, final false
inline bool get_isDragGhost() ;

/// @brief Method get_rootElement, addr 0x3029ad4, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_rootElement() ;

/// @brief Method remove_onDestroy, addr 0x3029d40, size 0xb0, virtual false, abstract: false, final false
inline void remove_onDestroy(::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*  value) ;

/// @brief Method remove_onGeometryChanged, addr 0x3029be0, size 0xb0, virtual false, abstract: false, final false
inline void remove_onGeometryChanged(::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*  value) ;

/// @brief Method set_animator, addr 0x3029af4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_bindableElement, addr 0x3029ae4, size 0x8, virtual false, abstract: false, final false
inline void set_bindableElement(::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method set_id, addr 0x3029b14, size 0x8, virtual false, abstract: false, final false
inline void set_id(int32_t  value) ;

/// @brief Method set_index, addr 0x3029b04, size 0x8, virtual false, abstract: false, final false
inline void set_index(int32_t  value) ;

/// @brief Method set_isDragGhost, addr 0x3029b24, size 0xc, virtual false, abstract: false, final false
