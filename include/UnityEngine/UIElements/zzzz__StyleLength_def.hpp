...
/// @brief Method Equals, addr 0x31489ec, size 0xa4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x31489ac, size 0x40, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::StyleLength  other) ;

/// @brief Method GetHashCode, addr 0x3148a90, size 0x30, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x3148ac0, size 0x88, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x3148920, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x3148900, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Length  v) ;

/// @brief Method .ctor, addr 0x3146c5c, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Length  v, ::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x31488d4, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(float_t  v) ;

/// @brief Method get_keyword, addr 0x31488cc, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method get_value, addr 0x31488a8, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method op_Equality, addr 0x314892c, size 0x38, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::StyleLength  lhs, ::UnityEngine::UIElements::StyleLength  rhs) ;

/// @brief Method op_Implicit, addr 0x3146c7c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x314898c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x3148964, size 0x28, virtual false, abstract: false, final false
