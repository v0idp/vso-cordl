...
public:
// Declarations
/// @brief Method Invoke, addr 0x304f1dc, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x304f0dc, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method <SortPanels>b__48_0, addr 0x304f2bc, size 0x160, virtual false, abstract: false, final false
inline int32_t _SortPanels_b__48_0(::UnityEngine::UIElements::Panel*  a, ::UnityEngine::UIElements::Panel*  b) ;

/// @brief Method <.cctor>b__9_0, addr 0x304f254, size 0x4, virtual false, abstract: false, final false
inline void __cctor_b__9_0() ;

/// @brief Method <.cctor>b__9_1, addr 0x304f258, size 0x64, virtual false, abstract: false, final false
inline void __cctor_b__9_1(int32_t  displayIndex, int32_t  sortOrder) ;

/// @brief Method .ctor, addr 0x304f24c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method BeginRenderOverlays, addr 0x304de40, size 0x58, virtual false, abstract: false, final false
static inline void BeginRenderOverlays(int32_t  displayIndex) ;

/// @brief Method CreateEvent, addr 0x304ce20, size 0x74, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::EventBase* CreateEvent(::UnityEngine::Event*  systemEvent) ;

/// @brief Method DisposeRuntimePanel, addr 0x304d60c, size 0xd0, virtual false, abstract: false, final false
static inline void DisposeRuntimePanel(::UnityEngine::ScriptableObject*  ownerObject) ;

/// @brief Method EndRenderOverlays, addr 0x304e048, size 0x70, virtual false, abstract: false, final false
static inline void EndRenderOverlays(int32_t  displayIndex) ;

/// @brief Method FindOrCreateRuntimePanel, addr 0x304d188, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method GetSortedPlayerPanels, addr 0x304dc48, size 0x88, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::Panel*>* GetSortedPlayerPanels() ;

/// @brief Method MarkPotentiallyEmpty, addr 0x304ea2c, size 0x110, virtual false, abstract: false, final false
static inline void MarkPotentiallyEmpty(::UnityEngine::UIElements::PanelSettings*  settings) ;

/// @brief Method MultiDisplayBottomLeftToPanelPosition, addr 0x304ee1c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method MultiDisplayToLocalScreenPosition, addr 0x304ee9c, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method RegisterCachedPanelInternal, addr 0x304d4e8, size 0x124, virtual false, abstract: false, final false
static inline void RegisterCachedPanelInternal(int32_t  instanceID, ::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method RegisterEventSystem, addr 0x304e228, size 0x218, virtual false, abstract: false, final false
static inline void RegisterEventSystem(::UnityEngine::Object*  eventSystem) ;

/// @brief Method RegisterPlayerloopCallback, addr 0x304d76c, size 0x9c, virtual false, abstract: false, final false
static inline void RegisterPlayerloopCallback() ;

/// @brief Method RemoveCachedPanelInternal, addr 0x304d3b8, size 0x130, virtual false, abstract: false, final false
static inline void RemoveCachedPanelInternal(int32_t  instanceID) ;

/// @brief Method RemoveUnusedPanels, addr 0x304e828, size 0x204, virtual false, abstract: false, final false
static inline void RemoveUnusedPanels() ;

/// @brief Method RenderOverlaysBeforePriority, addr 0x304de98, size 0x1b0, virtual false, abstract: false, final false
static inline void RenderOverlaysBeforePriority(int32_t  displayIndex, float_t  maxPriority) ;

/// @brief Method RepaintOffscreenPanels, addr 0x304da2c, size 0x21c, virtual false, abstract: false, final false
static inline void RepaintOffscreenPanels() ;

/// @brief Method RepaintOverlayPanel, addr 0x304dcd0, size 0x170, virtual false, abstract: false, final false
static inline void RepaintOverlayPanel(::UnityEngine::UIElements::BaseRuntimePanel*  panel) ;

/// @brief Method ScreenBottomLeftToPanelDelta, addr 0x304f0d4, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 ScreenBottomLeftToPanelDelta(::UnityEngine::Vector2  delta) ;

/// @brief Method ScreenBottomLeftToPanelPosition, addr 0x304eff0, size 0xe4, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 ScreenBottomLeftToPanelPosition(::UnityEngine::Vector2  position, int32_t  targetDisplay) ;

/// @brief Method SetPanelOrderingDirty, addr 0x304eb3c, size 0x5c, virtual false, abstract: false, final false
static inline void SetPanelOrderingDirty() ;

/// @brief Method SortPanels, addr 0x304eb98, size 0x284, virtual false, abstract: false, final false
static inline void SortPanels() ;

/// @brief Method UnregisterEventSystem, addr 0x304e440, size 0x114, virtual false, abstract: false, final false
static inline void UnregisterEventSystem(::UnityEngine::Object*  eventSystem) ;

/// @brief Method UnregisterPlayerloopCallback, addr 0x304d9dc, size 0x50, virtual false, abstract: false, final false
static inline void UnregisterPlayerloopCallback() ;

/// @brief Method UpdateRuntimePanels, addr 0x304e5f8, size 0x230, virtual false, abstract: false, final false
static inline void UpdateRuntimePanels() ;

/// @brief Method add_onCreatePanel, addr 0x304c8d8, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method get_activeEventSystem, addr 0x304e0b8, size 0x58, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Object> get_activeEventSystem() ;

/// @brief Method get_defaultEventSystem, addr 0x304e554, size 0xa4, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::DefaultEventSystem* get_defaultEventSystem() ;

/// @brief Method get_useDefaultEventSystem, addr 0x304e16c, size 0xbc, virtual false, abstract: false, final false
static inline bool get_useDefaultEventSystem() ;

/// @brief Method remove_onCreatePanel, addr 0x304c9c8, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method set_activeEventSystem, addr 0x304e110, size 0x5c, virtual false, abstract: false, final false
