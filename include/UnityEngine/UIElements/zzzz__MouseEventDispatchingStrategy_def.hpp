...
/// @brief Method CanDispatchEvent, addr 0x30edc44, size 0x54, virtual true, abstract: false, final true
inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method DispatchEvent, addr 0x30edc98, size 0x108, virtual true, abstract: false, final true
inline void DispatchEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::IPanel*  iPanel) ;

/// @brief Method IsDone, addr 0x30ee0f8, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method SendEventToIMGUIContainer, addr 0x30edf30, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method SendEventToRegularTarget, addr 0x30ede7c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method SendEventToTarget, addr 0x30ede40, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method SetBestTargetForEvent, addr 0x30edda0, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method UpdateElementUnderMouse, addr 0x30ee140, size 0x300, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30e65d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
