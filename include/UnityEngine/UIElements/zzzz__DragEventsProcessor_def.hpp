...
/// @brief Method GetDropTarget, addr 0x30dc1e8, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method OnPointerCancelEvent, addr 0x30dc2f0, size 0x130, virtual false, abstract: false, final false
inline void OnPointerCancelEvent(::UnityEngine::UIElements::PointerCancelEvent*  evt) ;

/// @brief Method OnPointerCapturedOut, addr 0x30dc420, size 0x10c, virtual false, abstract: false, final false
inline void OnPointerCapturedOut(::UnityEngine::UIElements::PointerCaptureOutEvent*  evt) ;

/// @brief Method OnPointerDownEvent, addr 0x30dbf5c, size 0xe8, virtual false, abstract: false, final false
inline void OnPointerDownEvent(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerLeaveEvent, addr 0x30dc2e0, size 0x10, virtual false, abstract: false, final false
inline void OnPointerLeaveEvent(::UnityEngine::UIElements::PointerLeaveEvent*  evt) ;

/// @brief Method OnPointerMoveEvent, addr 0x30dc52c, size 0x3a8, virtual false, abstract: false, final false
inline void OnPointerMoveEvent(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUpEvent, addr 0x30dc044, size 0x1a4, virtual false, abstract: false, final false
inline void OnPointerUpEvent(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method RegisterCallbacksFromTarget, addr 0x30db854, size 0x300, virtual false, abstract: false, final false
inline void RegisterCallbacksFromTarget() ;

/// @brief Method RegisterCallbacksFromTarget, addr 0x30dbb54, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method UnregisterCallbacksFromTarget, addr 0x30dbb58, size 0x8, virtual false, abstract: false, final false
inline void UnregisterCallbacksFromTarget(::UnityEngine::UIElements::DetachFromPanelEvent*  evt) ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x30dbb60, size 0x3fc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30db720, size 0x134, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::VisualElement*  target) ;

/// @brief Method get_dragAndDrop, addr 0x30db5e0, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::IDragAndDrop* get_dragAndDrop() ;

/// @brief Method get_isEditorContext, addr 0x30db600, size 0x120, virtual true, abstract: false, final false
inline bool get_isEditorContext() ;

/// @brief Method get_supportsDragEvents, addr 0x30db5a0, size 0x8, virtual true, abstract: false, final false
inline bool get_supportsDragEvents() ;

/// @brief Method get_useDragEvents, addr 0x30db5a8, size 0x38, virtual false, abstract: false, final false
