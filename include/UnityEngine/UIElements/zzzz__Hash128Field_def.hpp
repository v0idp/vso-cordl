...
/// @brief Method .ctor, addr 0x3046664, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x30466ac, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AcceptCharacter, addr 0x3046734, size 0xb8, virtual true, abstract: false, final false
inline bool AcceptCharacter(char16_t  c) ;

static inline ::UnityEngine::UIElements::Hash128Field_Hash128Input* New_ctor() ;

/// @brief Method Parse, addr 0x3046334, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::Hash128 Parse(::StringW  str) ;

/// @brief Method StringToValue, addr 0x30467ec, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Hash128 StringToValue(::StringW  str) ;

/// @brief Method .ctor, addr 0x3045e5c, size 0x150, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x30466f4, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method ExecuteDefaultAction, addr 0x30463a4, size 0x1f0, virtual true, abstract: false, final false
...
/// @brief Method SetValueWithoutNotify, addr 0x3046240, size 0xc8, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(::UnityEngine::Hash128  newValue) ;

/// @brief Method StringToValue, addr 0x304632c, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Hash128 StringToValue(::StringW  str) ;

/// @brief Method UpdateTextFromValue, addr 0x30461a8, size 0x98, virtual true, abstract: false, final false
inline void UpdateTextFromValue() ;

/// @brief Method UpdateValueFromText, addr 0x30460bc, size 0xec, virtual true, abstract: false, final false
inline void UpdateValueFromText() ;

/// @brief Method ValueToString, addr 0x3046308, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3045cd4, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3045ce0, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method get_value, addr 0x3045fac, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method set_value, addr 0x3045ff4, size 0xc8, virtual true, abstract: false, final false
