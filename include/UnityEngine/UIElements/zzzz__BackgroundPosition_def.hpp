...
/// @brief Method Equals, addr 0x301c020, size 0x7c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x301c09c, size 0x54, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::BackgroundPosition  other) ;

/// @brief Method GetHashCode, addr 0x301c0f0, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Initial, addr 0x301bfb8, size 0x34, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::BackgroundPosition Initial() ;

/// @brief Method ToString, addr 0x301c1dc, size 0xbc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x301bf74, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BackgroundPositionKeyword  keyword) ;

/// @brief Method .ctor, addr 0x301bfac, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x301c138, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x301c188, size 0x54, virtual false, abstract: false, final false
