...
/// @brief Method AddHash, addr 0x30d6168, size 0x94, virtual false, abstract: false, final false
inline void AddHash(int32_t  hash) ;

/// @brief Method IsCandidate, addr 0x30d61fc, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method PopElement, addr 0x30d6484, size 0xf0, virtual false, abstract: false, final false
inline void PopElement() ;

/// @brief Method PushElement, addr 0x30d6254, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30d60e8, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
