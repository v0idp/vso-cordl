...
/// @brief Method Equals, addr 0x3147918, size 0xbc, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x31478c4, size 0x54, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::Scale  other) ;

/// @brief Method GetHashCode, addr 0x3145d5c, size 0x50, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Initial, addr 0x31477f0, size 0x5c, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::Scale Initial() ;

/// @brief Method None, addr 0x314784c, size 0x18, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::Scale None() ;

/// @brief Method ToString, addr 0x31479d4, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x31476e4, size 0x10c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector3  scale) ;

/// @brief Method get_value, addr 0x3147864, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x3145a24, size 0x54, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::Scale  lhs, ::UnityEngine::UIElements::Scale  rhs) ;

/// @brief Method op_Inequality, addr 0x3147870, size 0x54, virtual false, abstract: false, final false
