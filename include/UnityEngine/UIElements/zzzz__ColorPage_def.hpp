...
public:
// Declarations
/// @brief Method Init, addr 0x3126f5c, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method ToNativeColorPage, addr 0x3127028, size 0x14, virtual false, abstract: false, final false
