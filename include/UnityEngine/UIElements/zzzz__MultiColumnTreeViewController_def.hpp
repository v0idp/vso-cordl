...
/// @brief Method BindItem, addr 0x30295cc, size 0x88, virtual true, abstract: false, final false
inline void BindItem(::UnityEngine::UIElements::VisualElement*  element, int32_t  index) ;

/// @brief Method DestroyItem, addr 0x3029670, size 0x1c, virtual true, abstract: false, final false
inline void DestroyItem(::UnityEngine::UIElements::VisualElement*  element) ;

/// @brief Method Dispose, addr 0x30296b0, size 0x30, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method InvokeMakeItem, addr 0x302910c, size 0xc8, virtual true, abstract: false, final false
inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem) ;

/// @brief Method MakeItem, addr 0x30295b0, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method PrepareView, addr 0x302968c, size 0x24, virtual true, abstract: false, final false
inline void PrepareView() ;

/// @brief Method UnbindItem, addr 0x3029654, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3029060, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method get_columnController, addr 0x3029040, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MultiColumnController* get_columnController() ;

/// @brief Method get_header, addr 0x3029048, size 0x18, virtual false, abstract: false, final false
