...
/// @brief Method Init, addr 0x30c32b0, size 0x204, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30c34b4, size 0x18c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CalculateProgressWidth, addr 0x30c30bc, size 0x84, virtual false, abstract: false, final false
inline float_t CalculateProgressWidth(float_t  width) ;

static inline ::UnityEngine::UIElements::AbstractProgressBar* New_ctor() ;

/// @brief Method OnGeometryChanged, addr 0x30c2dec, size 0x24, virtual false, abstract: false, final false
inline void OnGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  e) ;

/// @brief Method SetProgress, addr 0x30c2a10, size 0x124, virtual false, abstract: false, final false
inline void SetProgress(float_t  p) ;

/// @brief Method SetValueWithoutNotify, addr 0x30c3094, size 0x28, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x30c2b4c, size 0x2a0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_highValue, addr 0x30c2b34, size 0x8, virtual false, abstract: false, final false
inline float_t get_highValue() ;

/// @brief Method get_lowValue, addr 0x30c29f8, size 0x8, virtual false, abstract: false, final false
inline float_t get_lowValue() ;

/// @brief Method get_value, addr 0x30c2e10, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_highValue, addr 0x30c2b3c, size 0x10, virtual false, abstract: false, final false
inline void set_highValue(float_t  value) ;

/// @brief Method set_lowValue, addr 0x30c2a00, size 0x10, virtual false, abstract: false, final false
inline void set_lowValue(float_t  value) ;

/// @brief Method set_title, addr 0x30c29d4, size 0x24, virtual false, abstract: false, final false
inline void set_title(::StringW  value) ;

/// @brief Method set_value, addr 0x30c2e18, size 0x27c, virtual true, abstract: false, final false
