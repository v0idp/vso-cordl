...
/// @brief Method CanStartDrag, addr 0x30da154, size 0x10, virtual true, abstract: false, final false
inline bool CanStartDrag(::System::Collections::Generic::IEnumerable_1<int32_t>*  itemIds) ;

/// @brief Method CompareId, addr 0x30daa6c, size 0x20, virtual true, abstract: false, final false
inline int32_t CompareId(int32_t  id1, int32_t  id2) ;

/// @brief Method DragCleanup, addr 0x30daa8c, size 0x4, virtual true, abstract: false, final false
inline void DragCleanup() ;

/// @brief Method GetSortedSelectedIds, addr 0x30da0a8, size 0x8, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* GetSortedSelectedIds() ;

/// @brief Method HandleAutoExpand, addr 0x30daa90, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method SetupDragAndDrop, addr 0x30da164, size 0x5b4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30da0b0, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView*  view) ;

/// @brief Method get_enableReordering, addr 0x30da140, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_enableReordering, addr 0x30da148, size 0xc, virtual true, abstract: false, final false
