...
/// @brief Method <UpdateVisibleColumns>b__76_0, addr 0x30be074, size 0x18, virtual false, abstract: false, final false
inline bool _UpdateVisibleColumns_b__76_0(::UnityEngine::UIElements::Column*  c) ;

/// @brief Method .ctor, addr 0x30be06c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Add, addr 0x30bce78, size 0xb4, virtual true, abstract: false, final true
inline void Add(::UnityEngine::UIElements::Column*  item) ;

/// @brief Method Clear, addr 0x30bd18c, size 0x19c, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method Contains, addr 0x30bd538, size 0xac, virtual true, abstract: false, final true
inline bool Contains(::UnityEngine::UIElements::Column*  item) ;

/// @brief Method Contains, addr 0x30bd5e4, size 0x328, virtual false, abstract: false, final false
inline bool Contains(::StringW  name) ;

/// @brief Method CopyTo, addr 0x30bd90c, size 0xbc, virtual true, abstract: false, final true
inline void CopyTo(::ArrayW<::UnityEngine::UIElements::Column*,::Array<::UnityEngine::UIElements::Column*>*>  array, int32_t  arrayIndex) ;

/// @brief Method DirtyVisibleColumns, addr 0x30bda20, size 0x74, virtual false, abstract: false, final false
inline void DirtyVisibleColumns() ;

/// @brief Method GetEnumerator, addr 0x30ba448, size 0xa0, virtual true, abstract: false, final true
inline ::System::Collections::Generic::IEnumerator_1<::UnityEngine::UIElements::Column*>* GetEnumerator() ;

/// @brief Method IndexOf, addr 0x30b756c, size 0xac, virtual false, abstract: false, final false
inline int32_t IndexOf(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method InitOrderColumns, addr 0x30bc520, size 0x78, virtual false, abstract: false, final false
inline void InitOrderColumns() ;

/// @brief Method Insert, addr 0x30bcf2c, size 0x260, virtual false, abstract: false, final false
inline void Insert(int32_t  index, ::UnityEngine::UIElements::Column*  column) ;

/// @brief Method IsPrimary, addr 0x30bce0c, size 0x68, virtual false, abstract: false, final false
inline bool IsPrimary(::UnityEngine::UIElements::Column*  column) ;

static inline ::UnityEngine::UIElements::Columns* New_ctor() ;

/// @brief Method NotifyChange, addr 0x30bc450, size 0x1c, virtual false, abstract: false, final false
inline void NotifyChange(::UnityEngine::UIElements::ColumnsDataType  type) ;

/// @brief Method OnColumnChanged, addr 0x30bd9c8, size 0x58, virtual false, abstract: false, final false
inline void OnColumnChanged(::UnityEngine::UIElements::Column*  column, ::UnityEngine::UIElements::ColumnDataType  type) ;

/// @brief Method OnColumnResized, addr 0x30bda94, size 0x1c, virtual false, abstract: false, final false
inline void OnColumnResized(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method Remove, addr 0x30bd328, size 0x210, virtual true, abstract: false, final true
inline bool Remove(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method ReorderDisplay, addr 0x30bde7c, size 0x104, virtual false, abstract: false, final false
inline void ReorderDisplay(int32_t  from, int32_t  to) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x30bce74, size 0x4, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method UpdateVisibleColumns, addr 0x30bc598, size 0x20c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30bdf80, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_changed, addr 0x30bc7a4, size 0xb0, virtual false, abstract: false, final false
inline void add_changed(::System::Action_1<::UnityEngine::UIElements::ColumnsDataType>*  value) ;

/// @brief Method add_columnAdded, addr 0x30b8958, size 0xb0, virtual false, abstract: false, final false
inline void add_columnAdded(::System::Action_2<::UnityEngine::UIElements::Column*,int32_t>*  value) ;

/// @brief Method add_columnChanged, addr 0x30bca9c, size 0xb0, virtual false, abstract: false, final false
inline void add_columnChanged(::System::Action_2<::UnityEngine::UIElements::Column*,::UnityEngine::UIElements::ColumnDataType>*  value) ;

/// @brief Method add_columnRemoved, addr 0x30b8a08, size 0xb0, virtual false, abstract: false, final false
inline void add_columnRemoved(::System::Action_1<::UnityEngine::UIElements::Column*>*  value) ;

/// @brief Method add_columnReordered, addr 0x30b8ab8, size 0xb0, virtual false, abstract: false, final false
inline void add_columnReordered(::System::Action_3<::UnityEngine::UIElements::Column*,int32_t,int32_t>*  value) ;

/// @brief Method add_columnResized, addr 0x30bcbfc, size 0xb0, virtual false, abstract: false, final false
inline void add_columnResized(::System::Action_1<::UnityEngine::UIElements::Column*>*  value) ;

/// @brief Method get_Count, addr 0x30b88b8, size 0xa0, virtual true, abstract: false, final true
inline int32_t get_Count() ;

/// @brief Method get_IsReadOnly, addr 0x30bdab0, size 0xa4, virtual true, abstract: false, final true
inline bool get_IsReadOnly() ;

/// @brief Method get_Item, addr 0x30b872c, size 0xa8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Column* get_Item(int32_t  index) ;

/// @brief Method get_Item, addr 0x30bdb54, size 0x328, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Column* get_Item(::StringW  name) ;

/// @brief Method get_displayList, addr 0x30b76c8, size 0x18, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::Column*>* get_displayList() ;

/// @brief Method get_primaryColumnName, addr 0x30bc3f4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_primaryColumnName() ;

/// @brief Method get_reorderable, addr 0x30bc46c, size 0x8, virtual false, abstract: false, final false
inline bool get_reorderable() ;

/// @brief Method get_resizable, addr 0x30bc4a8, size 0x8, virtual false, abstract: false, final false
inline bool get_resizable() ;

/// @brief Method get_resizePreview, addr 0x30bc4e4, size 0x8, virtual false, abstract: false, final false
inline bool get_resizePreview() ;

/// @brief Method get_stretchMode, addr 0x30bc904, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Columns_StretchMode get_stretchMode() ;

/// @brief Method get_visibleList, addr 0x30b7790, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method remove_changed, addr 0x30bc854, size 0xb0, virtual false, abstract: false, final false
inline void remove_changed(::System::Action_1<::UnityEngine::UIElements::ColumnsDataType>*  value) ;

/// @brief Method remove_columnAdded, addr 0x30bc93c, size 0xb0, virtual false, abstract: false, final false
inline void remove_columnAdded(::System::Action_2<::UnityEngine::UIElements::Column*,int32_t>*  value) ;

/// @brief Method remove_columnChanged, addr 0x30bcb4c, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method remove_columnRemoved, addr 0x30bc9ec, size 0xb0, virtual false, abstract: false, final false
inline void remove_columnRemoved(::System::Action_1<::UnityEngine::UIElements::Column*>*  value) ;

/// @brief Method remove_columnReordered, addr 0x30bcd5c, size 0xb0, virtual false, abstract: false, final false
inline void remove_columnReordered(::System::Action_3<::UnityEngine::UIElements::Column*,int32_t,int32_t>*  value) ;

/// @brief Method remove_columnResized, addr 0x30bccac, size 0xb0, virtual false, abstract: false, final false
inline void remove_columnResized(::System::Action_1<::UnityEngine::UIElements::Column*>*  value) ;

/// @brief Method set_primaryColumnName, addr 0x30bc3fc, size 0x54, virtual false, abstract: false, final false
inline void set_primaryColumnName(::StringW  value) ;

/// @brief Method set_reorderable, addr 0x30bc474, size 0x34, virtual false, abstract: false, final false
inline void set_reorderable(bool  value) ;

/// @brief Method set_resizable, addr 0x30bc4b0, size 0x34, virtual false, abstract: false, final false
inline void set_resizable(bool  value) ;

/// @brief Method set_resizePreview, addr 0x30bc4ec, size 0x34, virtual false, abstract: false, final false
inline void set_resizePreview(bool  value) ;

/// @brief Method set_stretchMode, addr 0x30bc90c, size 0x30, virtual false, abstract: false, final false
