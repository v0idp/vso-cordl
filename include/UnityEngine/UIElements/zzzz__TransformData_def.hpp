...
// Dependencies System.IEquatable`1<T>, UnityEngine.UIElements.IStyleDataGroup`1<T>, UnityEngine.UIElements.Rotate, UnityEngine.UIElements.Scale, UnityEngine.UIElements.TransformOrigin, UnityEngine.UIElements.Translate
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Method Copy, addr 0x31457e8, size 0x1c, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::TransformData Copy() ;

/// @brief Method CopyFrom, addr 0x3145804, size 0x14, virtual true, abstract: false, final true
inline void CopyFrom(::ByRef<::UnityEngine::UIElements::TransformData>  other) ;

/// @brief Method Equals, addr 0x3145b98, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x3145b54, size 0x44, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::TransformData  other) ;

/// @brief Method GetHashCode, addr 0x3145c38, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x3145818, size 0x184, virtual false, abstract: false, final false
