...
/// @brief Method .ctor, addr 0x30b3224, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x30b326c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x30b338c, size 0x250, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x30b3628, size 0xa8, virtual true, abstract: false, final false
inline int32_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x30b35dc, size 0x4c, virtual true, abstract: false, final false
inline ::StringW ValueToString(int32_t  v) ;

/// @brief Method .ctor, addr 0x30b3038, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x30b3334, size 0x58, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentIntegerField, addr 0x30b32b4, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x30b30f0, size 0x64, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, int32_t  startValue) ;

/// @brief Method CanTryParse, addr 0x30b30cc, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x30b2e00, size 0xdc, virtual true, abstract: false, final false
inline int32_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x30b2d48, size 0xb8, virtual true, abstract: false, final false
inline ::StringW ValueToString(int32_t  v) ;

/// @brief Method .ctor, addr 0x30b2edc, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x30b2ee8, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_integerInput, addr 0x30b2cc4, size 0x84, virtual false, abstract: false, final false
