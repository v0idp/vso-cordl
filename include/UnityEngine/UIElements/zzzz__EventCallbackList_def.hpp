...
/// @brief Method Add, addr 0x30ea044, size 0xd4, virtual false, abstract: false, final false
inline void Add(::UnityEngine::UIElements::EventCallbackFunctorBase*  item) ;

/// @brief Method AddRange, addr 0x30e9b28, size 0x190, virtual false, abstract: false, final false
inline void AddRange(::UnityEngine::UIElements::EventCallbackList*  list) ;

/// @brief Method Clear, addr 0x30e9d1c, size 0x6c, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x30e9e24, size 0x18, virtual false, abstract: false, final false
inline bool Contains(int64_t  eventTypeId, ::System::Delegate*  callback, ::UnityEngine::UIElements::CallbackPhase  phase) ;

/// @brief Method Find, addr 0x30e9e3c, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x30e9f24, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30e9aa8, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x30e9a1c, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::EventCallbackList*  source) ;

/// @brief Method get_Count, addr 0x30ea118, size 0x48, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x30ea160, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::EventCallbackFunctorBase* get_Item(int32_t  i) ;

/// @brief Method get_bubbleUpCallbackCount, addr 0x30e9e14, size 0x8, virtual false, abstract: false, final false
inline int32_t get_bubbleUpCallbackCount() ;

/// @brief Method get_trickleDownCallbackCount, addr 0x30e9e04, size 0x8, virtual false, abstract: false, final false
inline int32_t get_trickleDownCallbackCount() ;

/// @brief Method set_bubbleUpCallbackCount, addr 0x30e9e1c, size 0x8, virtual false, abstract: false, final false
inline void set_bubbleUpCallbackCount(int32_t  value) ;

/// @brief Method set_trickleDownCallbackCount, addr 0x30e9e0c, size 0x8, virtual false, abstract: false, final false
