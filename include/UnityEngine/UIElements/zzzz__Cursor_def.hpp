...
/// @brief Method Equals, addr 0x30d65a4, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x30d6634, size 0xb0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::Cursor  other) ;

/// @brief Method GetHashCode, addr 0x30d66e4, size 0xd4, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x30d67e8, size 0x8c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_defaultCursorId, addr 0x30d6594, size 0x8, virtual false, abstract: false, final false
inline int32_t get_defaultCursorId() ;

/// @brief Method get_hotspot, addr 0x30d6584, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_hotspot() ;

/// @brief Method get_texture, addr 0x30d6574, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x30d67b8, size 0x30, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::Cursor  style1, ::UnityEngine::UIElements::Cursor  style2) ;

/// @brief Method set_defaultCursorId, addr 0x30d659c, size 0x8, virtual false, abstract: false, final false
inline void set_defaultCursorId(int32_t  value) ;

/// @brief Method set_hotspot, addr 0x30d658c, size 0x8, virtual false, abstract: false, final false
inline void set_hotspot(::UnityEngine::Vector2  value) ;

/// @brief Method set_texture, addr 0x30d657c, size 0x8, virtual false, abstract: false, final false
