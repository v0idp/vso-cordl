...
/// @brief Method ComputeDefaultEventInterests, addr 0x305d19c, size 0x204, virtual false, abstract: false, final false
static inline int32_t ComputeDefaultEventInterests(::System::Type*  elementType, ::StringW  methodName) ;

/// @brief Method GetDefaultEventInterests, addr 0x305cf70, size 0x22c, virtual false, abstract: false, final false
...
/// @brief Method GetEventCategory, addr 0x305d3a0, size 0x208, virtual false, abstract: false, final false
