...
/// @brief Method Equals, addr 0x31499c0, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x3149934, size 0x8c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::StyleTransformOrigin  other) ;

/// @brief Method GetHashCode, addr 0x3149a50, size 0x24, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x3149a74, size 0x88, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x3149888, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method .ctor, addr 0x3149894, size 0x18, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TransformOrigin  v, ::UnityEngine::UIElements::StyleKeyword  keyword) ;

/// @brief Method get_keyword, addr 0x3149880, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method get_value, addr 0x31497ec, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Method op_Equality, addr 0x31498ac, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x3149928, size 0xc, virtual false, abstract: false, final false
