...
/// @brief Method .ctor, addr 0x30cd898, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x30cd8e0, size 0x2b4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30cdb94, size 0x228, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x30cd16c, size 0x124, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, float_t  startValue) ;

/// @brief Method ComputeValueFromKey, addr 0x30cd5c8, size 0x200, virtual true, abstract: false, final false
...
/// @brief Method ParseStringToValue, addr 0x30cd544, size 0x84, virtual true, abstract: false, final false
inline float_t ParseStringToValue(::StringW  previousValue, ::StringW  newValue) ;

/// @brief Method SliderLerpUnclamped, addr 0x30cd290, size 0x2b4, virtual true, abstract: false, final false
inline float_t SliderLerpUnclamped(float_t  a, float_t  b, float_t  interpolant) ;

/// @brief Method SliderNormalizeValue, addr 0x30ccbb4, size 0x10, virtual true, abstract: false, final false
inline float_t SliderNormalizeValue(float_t  currentValue, float_t  lowerValue, float_t  higherValue) ;

/// @brief Method .ctor, addr 0x30cd008, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x30cd020, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30ccb84, size 0xc, virtual false, abstract: false, final false
