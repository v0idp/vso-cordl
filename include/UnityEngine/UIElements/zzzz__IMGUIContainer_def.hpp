...
/// @brief Method .ctor, addr 0x3103c6c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x3103cb4, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
...
constexpr IMGUIContainer_GUIGlobals(::UnityEngine::Matrix4x4  matrix, ::UnityEngine::Color  color, ::UnityEngine::Color  contentColor, ::UnityEngine::Color  backgroundColor, bool  enabled, bool  changed, int32_t  displayIndex) noexcept;
...
// Dependencies System.IDisposable, Unity.Profiling.ProfilerMarker, UnityEngine.Matrix4x4, UnityEngine.Rect, UnityEngine.UIElements.ContextType, UnityEngine.UIElements.IMGUIContainer::GUIGlobals, UnityEngine.UIElements.VisualElement
namespace UnityEngine::UIElements {
// Is value type: false
...
/// @brief Method Dispose, addr 0x3103bd8, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x3103c48, size 0x18, virtual true, abstract: false, final false
inline void Dispose(bool  disposeManaged) ;

/// @brief Method DoIMGUIRepaint, addr 0x31024ec, size 0x2e0, virtual false, abstract: false, final false
inline void DoIMGUIRepaint() ;

/// @brief Method DoMeasure, addr 0x310399c, size 0x23c, virtual true, abstract: false, final false
...
/// @brief Method DoOnGUI, addr 0x31012e8, size 0xdb4, virtual false, abstract: false, final false
...
/// @brief Method ExecuteDefaultAction, addr 0x3103548, size 0x2e8, virtual true, abstract: false, final false
inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method GetCurrentClipRect, addr 0x3103288, size 0x38, virtual false, abstract: false, final false
inline ::UnityEngine::Rect GetCurrentClipRect() ;

/// @brief Method GetCurrentTransformAndClip, addr 0x3103388, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method HandleIMGUIEvent, addr 0x3102c88, size 0x10, virtual false, abstract: false, final false
inline bool HandleIMGUIEvent(::UnityEngine::Event*  e, bool  canAffectFocus) ;

/// @brief Method HandleIMGUIEvent, addr 0x31032c0, size 0xc8, virtual false, abstract: false, final false
inline bool HandleIMGUIEvent(::UnityEngine::Event*  e, ::System::Action*  onGUIHandler, bool  canAffectFocus) ;

/// @brief Method HandleIMGUIEvent, addr 0x31027cc, size 0x32c, virtual false, abstract: false, final false
...
/// @brief Method IsContainerCapturingTheMouse, addr 0x3102c98, size 0x114, virtual false, abstract: false, final false
inline bool IsContainerCapturingTheMouse() ;

/// @brief Method IsDockAreaMouseUp, addr 0x3103164, size 0x124, virtual false, abstract: false, final false
static inline bool IsDockAreaMouseUp(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method IsEventInsideLocalWindow, addr 0x3102fb0, size 0x1b4, virtual false, abstract: false, final false
inline bool IsEventInsideLocalWindow(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method IsLocalEvent, addr 0x3102dac, size 0x204, virtual false, abstract: false, final false
inline bool IsLocalEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method MarkDirtyLayout, addr 0x310209c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method OnGenerateVisualContent, addr 0x3100fa0, size 0x128, virtual false, abstract: false, final false
inline void OnGenerateVisualContent(::UnityEngine::UIElements::MeshGenerationContext*  mgc) ;

/// @brief Method ProcessEvent, addr 0x31020b0, size 0x1a0, virtual false, abstract: false, final false
inline void ProcessEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method RestoreGlobals, addr 0x31011d8, size 0x110, virtual false, abstract: false, final false
inline void RestoreGlobals() ;

/// @brief Method SaveGlobals, addr 0x31010c8, size 0x110, virtual false, abstract: false, final false
inline void SaveGlobals() ;

/// @brief Method SendEventToIMGUI, addr 0x3102250, size 0x29c, virtual false, abstract: false, final false
inline bool SendEventToIMGUI(::UnityEngine::UIElements::EventBase*  evt, bool  canAffectFocus, bool  verifyBounds) ;

/// @brief Method SendEventToIMGUIRaw, addr 0x3102af8, size 0x100, virtual false, abstract: false, final false
inline bool SendEventToIMGUIRaw(::UnityEngine::UIElements::EventBase*  evt, bool  canAffectFocus, bool  verifyBounds) ;

/// @brief Method SetFoldoutDepthClass, addr 0x3103830, size 0x16c, virtual false, abstract: false, final false
inline void SetFoldoutDepthClass() ;

/// @brief Method VerifyBounds, addr 0x3102bf8, size 0x90, virtual false, abstract: false, final false
inline bool VerifyBounds(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method <DoOnGUI>b__56_0, addr 0x3103c60, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3100d44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3100d4c, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method get_cache, addr 0x3100894, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::GUILayoutUtility_LayoutCache* get_cache() ;

/// @brief Method get_canGrabFocus, addr 0x3100964, size 0x20, virtual true, abstract: false, final false
inline bool get_canGrabFocus() ;

/// @brief Method get_contextType, addr 0x310094c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ContextType get_contextType() ;

/// @brief Method get_cullingEnabled, addr 0x310088c, size 0x8, virtual false, abstract: false, final false
inline bool get_cullingEnabled() ;

/// @brief Method get_focusOnlyIfHasFocusableControls, addr 0x310095c, size 0x8, virtual false, abstract: false, final false
inline bool get_focusOnlyIfHasFocusableControls() ;

/// @brief Method get_guiState, addr 0x31007c8, size 0x9c, virtual false, abstract: false, final false
inline ::UnityEngine::ObjectGUIState* get_guiState() ;

/// @brief Method get_lastWorldClip, addr 0x3100864, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_lastWorldClip() ;

/// @brief Method get_layoutMeasuredHeight, addr 0x3100924, size 0x28, virtual false, abstract: false, final false
inline float_t get_layoutMeasuredHeight() ;

/// @brief Method get_layoutMeasuredWidth, addr 0x31008fc, size 0x28, virtual false, abstract: false, final false
inline float_t get_layoutMeasuredWidth() ;

/// @brief Method get_onGUIHandler, addr 0x3100768, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_contextType, addr 0x3100954, size 0x8, virtual false, abstract: false, final false
inline void set_contextType(::UnityEngine::UIElements::ContextType  value) ;

/// @brief Method set_lastWorldClip, addr 0x3100878, size 0x14, virtual false, abstract: false, final false
inline void set_lastWorldClip(::UnityEngine::Rect  value) ;

/// @brief Method set_onGUIHandler, addr 0x3100770, size 0x58, virtual false, abstract: false, final false
