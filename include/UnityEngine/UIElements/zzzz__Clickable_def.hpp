...
/// @brief Method ContainsPointer, addr 0x301ff6c, size 0x80, virtual false, abstract: false, final false
inline bool ContainsPointer(int32_t  pointerId) ;

/// @brief Method Invoke, addr 0x301ffec, size 0x58, virtual false, abstract: false, final false
inline void Invoke(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method IsNotMouseEvent, addr 0x302109c, size 0x64, virtual false, abstract: false, final false
static inline bool IsNotMouseEvent(int32_t  pointerId) ;

/// @brief Method IsRepeatable, addr 0x301ff48, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method OnMouseCaptureOut, addr 0x3020c04, size 0x84, virtual false, abstract: false, final false
inline void OnMouseCaptureOut(::UnityEngine::UIElements::MouseCaptureOutEvent*  evt) ;

/// @brief Method OnMouseDown, addr 0x3020a18, size 0xbc, virtual false, abstract: false, final false
inline void OnMouseDown(::UnityEngine::UIElements::MouseDownEvent*  evt) ;

/// @brief Method OnMouseMove, addr 0x3020ad4, size 0x6c, virtual false, abstract: false, final false
inline void OnMouseMove(::UnityEngine::UIElements::MouseMoveEvent*  evt) ;

/// @brief Method OnMouseUp, addr 0x3020b40, size 0xc4, virtual false, abstract: false, final false
inline void OnMouseUp(::UnityEngine::UIElements::MouseUpEvent*  evt) ;

/// @brief Method OnPointerCancel, addr 0x3021010, size 0x8c, virtual false, abstract: false, final false
inline void OnPointerCancel(::UnityEngine::UIElements::PointerCancelEvent*  evt) ;

/// @brief Method OnPointerCaptureOut, addr 0x3021100, size 0x78, virtual false, abstract: false, final false
inline void OnPointerCaptureOut(::UnityEngine::UIElements::PointerCaptureOutEvent*  evt) ;

/// @brief Method OnPointerDown, addr 0x3020c88, size 0x130, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMove, addr 0x3020db8, size 0x120, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUp, addr 0x3020ed8, size 0x138, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnTimer, addr 0x301fe78, size 0xd0, virtual false, abstract: false, final false
inline void OnTimer(::UnityEngine::UIElements::TimerState  timerState) ;

/// @brief Method ProcessCancelEvent, addr 0x30218f0, size 0x174, virtual true, abstract: false, final false
inline void ProcessCancelEvent(::UnityEngine::UIElements::EventBase*  evt, int32_t  pointerId) ;

/// @brief Method ProcessDownEvent, addr 0x3021344, size 0x388, virtual true, abstract: false, final false
inline void ProcessDownEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method ProcessMoveEvent, addr 0x30216cc, size 0x6c, virtual true, abstract: false, final false
inline void ProcessMoveEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition) ;

/// @brief Method ProcessUpEvent, addr 0x3021738, size 0x1b8, virtual true, abstract: false, final false
inline void ProcessUpEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::Vector2  localPosition, int32_t  pointerId) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x3020044, size 0x4fc, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method SimulateSingleClick, addr 0x3021178, size 0x1cc, virtual false, abstract: false, final false
inline void SimulateSingleClick(::UnityEngine::UIElements::EventBase*  evt, int32_t  delayMs) ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x3020540, size 0x4d8, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method <SimulateSingleClick>b__43_0, addr 0x3021a64, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x301fce8, size 0xc8, virtual false, abstract: false, final false
inline void _ctor(::System::Action*  handler) ;

/// @brief Method .ctor, addr 0x301fcbc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::Action*  handler, int64_t  delay, int64_t  interval) ;

/// @brief Method .ctor, addr 0x301fdb0, size 0xc8, virtual false, abstract: false, final false
inline void _ctor(::System::Action_1<::UnityEngine::UIElements::EventBase*>*  handler) ;

/// @brief Method add_clicked, addr 0x301fb00, size 0x9c, virtual false, abstract: false, final false
inline void add_clicked(::System::Action*  value) ;

/// @brief Method add_clickedWithEventInfo, addr 0x301f9a0, size 0xb0, virtual false, abstract: false, final false
inline void add_clickedWithEventInfo(::System::Action_1<::UnityEngine::UIElements::EventBase*>*  value) ;

/// @brief Method get_acceptClicksIfDisabled, addr 0x301fc5c, size 0x8, virtual false, abstract: false, final false
inline bool get_acceptClicksIfDisabled() ;

/// @brief Method get_active, addr 0x301fc38, size 0x8, virtual false, abstract: false, final false
inline bool get_active() ;

/// @brief Method get_invokePolicy, addr 0x301fcb4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::InvokePolicy get_invokePolicy() ;

/// @brief Method get_lastMousePosition, addr 0x301fc4c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_lastMousePosition() ;

/// @brief Method remove_clicked, addr 0x301fb9c, size 0x9c, virtual false, abstract: false, final false
inline void remove_clicked(::System::Action*  value) ;

/// @brief Method remove_clickedWithEventInfo, addr 0x301fa50, size 0xb0, virtual false, abstract: false, final false
inline void remove_clickedWithEventInfo(::System::Action_1<::UnityEngine::UIElements::EventBase*>*  value) ;

/// @brief Method set_acceptClicksIfDisabled, addr 0x301fc64, size 0x50, virtual false, abstract: false, final false
inline void set_acceptClicksIfDisabled(bool  value) ;

/// @brief Method set_active, addr 0x301fc40, size 0xc, virtual false, abstract: false, final false
inline void set_active(bool  value) ;

/// @brief Method set_lastMousePosition, addr 0x301fc54, size 0x8, virtual false, abstract: false, final false
