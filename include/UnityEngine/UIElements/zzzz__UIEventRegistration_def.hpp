...
/// @brief Method <.cctor>b__1_0, addr 0x3050568, size 0x4c, virtual false, abstract: false, final false
inline void __cctor_b__1_0() ;

/// @brief Method <.cctor>b__1_1, addr 0x30505b4, size 0x4c, virtual false, abstract: false, final false
inline void __cctor_b__1_1() ;

/// @brief Method <.cctor>b__1_2, addr 0x3050600, size 0x64, virtual false, abstract: false, final false
inline bool __cctor_b__1_2(int32_t  i, ::System::IntPtr  ptr) ;

/// @brief Method <.cctor>b__1_3, addr 0x3050664, size 0x4c, virtual false, abstract: false, final false
inline void __cctor_b__1_3() ;

/// @brief Method <.cctor>b__1_4, addr 0x30506b0, size 0x54, virtual false, abstract: false, final false
inline bool __cctor_b__1_4(::System::Exception*  exception) ;

/// @brief Method <.cctor>b__1_5, addr 0x3050704, size 0x4c, virtual false, abstract: false, final false
inline void __cctor_b__1_5() ;

/// @brief Method .ctor, addr 0x3050560, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CleanupRoots, addr 0x305014c, size 0x1dc, virtual false, abstract: false, final false
static inline void CleanupRoots() ;

/// @brief Method EndContainerGUIFromException, addr 0x304fcf4, size 0x244, virtual false, abstract: false, final false
static inline bool EndContainerGUIFromException(::System::Exception*  exception) ;

/// @brief Method MakeCurrentIMGUIContainerDirty, addr 0x3050328, size 0x1dc, virtual false, abstract: false, final false
static inline void MakeCurrentIMGUIContainerDirty() ;

/// @brief Method ProcessEvent, addr 0x304ff38, size 0x214, virtual false, abstract: false, final false
static inline bool ProcessEvent(int32_t  instanceID, ::System::IntPtr  nativeEventPtr) ;

/// @brief Method RegisterUIElementSystem, addr 0x304f8bc, size 0x84, virtual false, abstract: false, final false
static inline void RegisterUIElementSystem(::UnityEngine::UIElements::IUIElementsUtility*  utility) ;

/// @brief Method ReleaseCapture, addr 0x304fb18, size 0x1dc, virtual false, abstract: false, final false
static inline void ReleaseCapture() ;

/// @brief Method TakeCapture, addr 0x304f940, size 0x1d8, virtual false, abstract: false, final false
