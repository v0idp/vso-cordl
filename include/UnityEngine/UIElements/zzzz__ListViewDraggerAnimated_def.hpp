...
/// @brief Method Animate, addr 0x30e0d94, size 0x340, virtual false, abstract: false, final false
inline void Animate(::UnityEngine::UIElements::ReusableCollectionItem*  element, float_t  paddingTop) ;

/// @brief Method ClearDragAndDropUI, addr 0x30e1d98, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method OnDrop, addr 0x30e19ac, size 0x3ec, virtual true, abstract: false, final false
inline void OnDrop(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method StartDrag, addr 0x30e0630, size 0x764, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::StartDragArgs StartDrag(::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method TryGetDragPosition, addr 0x30e1d9c, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method UpdateDrag, addr 0x30e10d4, size 0x8d8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30e0624, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::BaseVerticalCollectionView*  listView) ;

/// @brief Method get_draggedItem, addr 0x30e0614, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ReusableCollectionItem* get_draggedItem() ;

/// @brief Method get_isDragging, addr 0x30e0600, size 0x8, virtual false, abstract: false, final false
inline bool get_isDragging() ;

/// @brief Method get_supportsDragEvents, addr 0x30e061c, size 0x8, virtual true, abstract: false, final false
inline bool get_supportsDragEvents() ;

/// @brief Method set_isDragging, addr 0x30e0608, size 0xc, virtual false, abstract: false, final false
