...
/// @brief Method CanDispatchEvent, addr 0x30ebf44, size 0x54, virtual true, abstract: false, final true
inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method DispatchEvent, addr 0x30ebf98, size 0x274, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x30e65d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
