...
/// @brief Method .ctor, addr 0x30cf998, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  id, int32_t  parentId, ::System::Collections::Generic::IEnumerable_1<int32_t>*  childrenIds) ;

/// @brief Method get_childrenIds, addr 0x30cf938, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* get_childrenIds() ;

/// @brief Method get_hasChildren, addr 0x30cf940, size 0x58, virtual false, abstract: false, final false
inline bool get_hasChildren() ;

/// @brief Method get_id, addr 0x30cf928, size 0x8, virtual false, abstract: false, final false
inline int32_t get_id() ;

/// @brief Method get_parentId, addr 0x30cf930, size 0x8, virtual false, abstract: false, final false
