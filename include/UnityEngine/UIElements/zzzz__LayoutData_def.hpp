...
// Dependencies System.IEquatable`1<T>, UnityEngine.UIElements.Align, UnityEngine.UIElements.DisplayStyle, UnityEngine.UIElements.FlexDirection, UnityEngine.UIElements.IStyleDataGroup`1<T>, UnityEngine.UIElements.Justify, UnityEngine.UIElements.Length, UnityEngine.UIElements.Position, UnityEngine.UIElements.Wrap
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Method Copy, addr 0x3144c68, size 0x1c, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::LayoutData Copy() ;

/// @brief Method CopyFrom, addr 0x3144c84, size 0x14, virtual true, abstract: false, final true
inline void CopyFrom(::ByRef<::UnityEngine::UIElements::LayoutData>  other) ;

/// @brief Method Equals, addr 0x31450a8, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x314505c, size 0x4c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::LayoutData  other) ;

/// @brief Method GetHashCode, addr 0x3145150, size 0x338, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x3144c98, size 0x39c, virtual false, abstract: false, final false
