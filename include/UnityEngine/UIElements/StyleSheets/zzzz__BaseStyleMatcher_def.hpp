...
/// @brief Method DropContext, addr 0x309bd18, size 0x50, virtual false, abstract: false, final false
inline void DropContext() ;

/// @brief Method Initialize, addr 0x309bbd4, size 0x54, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method Match, addr 0x309bd68, size 0xb4, virtual false, abstract: false, final false
inline bool Match(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchAndAnd, addr 0x309c3e0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method MatchCombinator, addr 0x309c080, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method MatchDataType, addr 0x309c14c, size 0xfc, virtual false, abstract: false, final false
inline bool MatchDataType(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchExpression, addr 0x309be24, size 0x114, virtual false, abstract: false, final false
inline bool MatchExpression(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchExpressionWithMultiplier, addr 0x309bf38, size 0x148, virtual false, abstract: false, final false
inline bool MatchExpressionWithMultiplier(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchGroup, addr 0x309c248, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method MatchJuxtaposition, addr 0x309c410, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method MatchMany, addr 0x309c488, size 0x174, virtual false, abstract: false, final false
inline int32_t MatchMany(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchManyByOrder, addr 0x309c5fc, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method MatchOr, addr 0x309c2fc, size 0xcc, virtual false, abstract: false, final false
inline bool MatchOr(::UnityEngine::UIElements::StyleSheets::Syntax::Expression*  exp) ;

/// @brief Method MatchOrOr, addr 0x309c3c8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x309bc28, size 0x44, virtual false, abstract: false, final false
inline void MoveNext() ;

static inline ::UnityEngine::UIElements::StyleSheets::BaseStyleMatcher* New_ctor() ;

/// @brief Method RestoreContext, addr 0x309bcc0, size 0x58, virtual false, abstract: false, final false
inline void RestoreContext() ;

/// @brief Method SaveContext, addr 0x309bc6c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x309c790, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Text::RegularExpressions::Regex* getStaticF_s_CustomIdentRegex() ;

/// @brief Method get_currentIndex, addr 0x309bbb4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_currentIndex() ;

/// @brief Method get_hasCurrent, addr 0x309bb8c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_matchedVariableCount, addr 0x309bbc4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_currentIndex, addr 0x309bbbc, size 0x8, virtual false, abstract: false, final false
inline void set_currentIndex(int32_t  value) ;

/// @brief Method set_matchedVariableCount, addr 0x309bbcc, size 0x8, virtual false, abstract: false, final false
