...
public:
// Declarations
/// @brief Method Invoke, addr 0x30990fc, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3098ff8, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method GetValue, addr 0x3095278, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::StylePropertyValue GetValue(int32_t  index) ;

/// @brief Method GetValueType, addr 0x30952d4, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleValueType GetValueType(int32_t  index) ;

/// @brief Method IsKeyword, addr 0x30953e8, size 0xa4, virtual false, abstract: false, final false
inline bool IsKeyword(int32_t  index, ::UnityEngine::UIElements::StyleValueKeyword  keyword) ;

/// @brief Method IsValueType, addr 0x3095354, size 0x94, virtual false, abstract: false, final false
inline bool IsValueType(int32_t  index, ::UnityEngine::UIElements::StyleValueType  type) ;

/// @brief Method LoadProperties, addr 0x3094d64, size 0x428, virtual false, abstract: false, final false
inline void LoadProperties() ;

/// @brief Method MoveNextProperty, addr 0x309519c, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method ReadAngle, addr 0x3098dc8, size 0x78, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::Angle ReadAngle(::UnityEngine::UIElements::StyleSheets::StylePropertyValue  value) ;

/// @brief Method ReadAsString, addr 0x309548c, size 0x60, virtual false, abstract: false, final false
inline ::StringW ReadAsString(int32_t  index) ;

/// @brief Method ReadBackground, addr 0x30970f4, size 0x26c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Background ReadBackground(int32_t  index) ;

/// @brief Method ReadBackgroundPosition, addr 0x3097f64, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method ReadBackgroundPosition, addr 0x309804c, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method ReadBackgroundPositionX, addr 0x3097f4c, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BackgroundPosition ReadBackgroundPositionX(int32_t  index) ;

/// @brief Method ReadBackgroundPositionY, addr 0x3098034, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BackgroundPosition ReadBackgroundPositionY(int32_t  index) ;

/// @brief Method ReadBackgroundRepeat, addr 0x30981c4, size 0xb8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BackgroundRepeat ReadBackgroundRepeat(int32_t  index) ;

/// @brief Method ReadBackgroundRepeat, addr 0x309827c, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method ReadBackgroundSize, addr 0x3098344, size 0xec, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BackgroundSize ReadBackgroundSize(int32_t  index) ;

/// @brief Method ReadBackgroundSize, addr 0x3098430, size 0x234, virtual false, abstract: false, final false
...
/// @brief Method ReadColor, addr 0x30965c4, size 0xf4, virtual false, abstract: false, final false
inline ::UnityEngine::Color ReadColor(int32_t  index) ;

/// @brief Method ReadCursor, addr 0x3097a30, size 0x2a4, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Cursor ReadCursor(int32_t  index) ;

/// @brief Method ReadEnum, addr 0x3096790, size 0xf8, virtual false, abstract: false, final false
inline int32_t ReadEnum(::UnityEngine::UIElements::StyleSheets::StyleEnumType  enumType, int32_t  index) ;

/// @brief Method ReadEnum, addr 0x3098d00, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method ReadFloat, addr 0x30964d8, size 0x68, virtual false, abstract: false, final false
inline float_t ReadFloat(int32_t  index) ;

/// @brief Method ReadFont, addr 0x3096db8, size 0x33c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Font> ReadFont(int32_t  index) ;

/// @brief Method ReadFontDefinition, addr 0x3096888, size 0x530, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::FontDefinition ReadFontDefinition(int32_t  index) ;

/// @brief Method ReadInt, addr 0x3096540, size 0x84, virtual false, abstract: false, final false
inline int32_t ReadInt(int32_t  index) ;

/// @brief Method ReadLength, addr 0x30957c4, size 0xf4, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Length ReadLength(int32_t  index) ;

/// @brief Method ReadListEasingFunction, addr 0x3098664, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method ReadListStylePropertyName, addr 0x30989e0, size 0x194, virtual false, abstract: false, final false
...
/// @brief Method ReadListTimeValue, addr 0x3098850, size 0x190, virtual false, abstract: false, final false
inline void ReadListTimeValue(::System::Collections::Generic::List_1<::UnityEngine::UIElements::TimeValue>*  list, int32_t  index) ;

/// @brief Method ReadRotate, addr 0x3095ff4, size 0x124, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Rotate ReadRotate(int32_t  index) ;

/// @brief Method ReadRotate, addr 0x3096118, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method ReadScale, addr 0x30961dc, size 0x100, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Scale ReadScale(int32_t  index) ;

/// @brief Method ReadScale, addr 0x30962dc, size 0x1fc, virtual false, abstract: false, final false
...
/// @brief Method ReadTextShadow, addr 0x3097cd4, size 0x278, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TextShadow ReadTextShadow(int32_t  index) ;

/// @brief Method ReadTimeValue, addr 0x30958b8, size 0x98, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TimeValue ReadTimeValue(int32_t  index) ;

/// @brief Method ReadTransformOrigin, addr 0x3095d04, size 0x134, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TransformOrigin ReadTransformOrigin(int32_t  index) ;

/// @brief Method ReadTransformOrigin, addr 0x3095e38, size 0x1bc, virtual false, abstract: false, final false
...
/// @brief Method ReadTransformOriginEnum, addr 0x3098ba8, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method ReadTranslate, addr 0x3095950, size 0x130, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Translate ReadTranslate(int32_t  index) ;

/// @brief Method ReadTranslate, addr 0x3095a80, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method SetContext, addr 0x3094af0, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method SetCurrentProperty, addr 0x30951c8, size 0xb0, virtual false, abstract: false, final false
inline void SetCurrentProperty() ;

/// @brief Method SetInlineContext, addr 0x309518c, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method TryGetImageSourceFromValue, addr 0x3097360, size 0x6d0, virtual false, abstract: false, final false
...
/// @brief Method TryReadEnum, addr 0x3098e40, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3098f08, size 0xf0, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::UIElements::StyleSheets::StylePropertyReader_GetCursorIdFunction* getStaticF_getCursorIdFunc() ;

/// @brief Method get_dpiScaling, addr 0x3094ae0, size 0x8, virtual false, abstract: false, final false
inline float_t get_dpiScaling() ;

/// @brief Method get_property, addr 0x3094ab0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleProperty* get_property() ;

/// @brief Method get_propertyId, addr 0x3094ac0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::StylePropertyId get_propertyId() ;

/// @brief Method get_valueCount, addr 0x3094ad0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_dpiScaling, addr 0x3094ae8, size 0x8, virtual false, abstract: false, final false
inline void set_dpiScaling(float_t  value) ;

/// @brief Method set_property, addr 0x3094ab8, size 0x8, virtual false, abstract: false, final false
inline void set_property(::UnityEngine::UIElements::StyleProperty*  value) ;

/// @brief Method set_propertyId, addr 0x3094ac8, size 0x8, virtual false, abstract: false, final false
inline void set_propertyId(::UnityEngine::UIElements::StyleSheets::StylePropertyId  value) ;

/// @brief Method set_valueCount, addr 0x3094ad8, size 0x8, virtual false, abstract: false, final false
