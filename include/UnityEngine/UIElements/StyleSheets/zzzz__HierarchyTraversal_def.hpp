...
/// @brief Method Recurse, addr 0x308a4cc, size 0xd0, virtual false, abstract: false, final false
inline void Recurse(::UnityEngine::UIElements::VisualElement*  element, int32_t  depth) ;

/// @brief Method Traverse, addr 0x308a4bc, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x308a59c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
