...
public:
// Declarations
/// @brief Method .ctor, addr 0x309fad4, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType  t) ;

/// @brief Method .ctor, addr 0x309faf4, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType  type, int32_t  number) ;

/// @brief Method .ctor, addr 0x309fae4, size 0x10, virtual false, abstract: false, final false
