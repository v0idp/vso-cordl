...
/// @brief Method GlobCharacter, addr 0x309fb04, size 0x3c, virtual false, abstract: false, final false
static inline int32_t GlobCharacter(::StringW  s, int32_t  index, char16_t  c) ;

/// @brief Method IsNextCharacter, addr 0x309fb40, size 0x44, virtual false, abstract: false, final false
static inline bool IsNextCharacter(::StringW  s, int32_t  index, char16_t  c) ;

/// @brief Method IsNextLetterOrDash, addr 0x309fc1c, size 0xc0, virtual false, abstract: false, final false
static inline bool IsNextLetterOrDash(::StringW  s, int32_t  index) ;

/// @brief Method IsNextNumber, addr 0x309fb84, size 0x98, virtual false, abstract: false, final false
static inline bool IsNextNumber(::StringW  s, int32_t  index) ;

/// @brief Method MoveNext, addr 0x309f090, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method PeekNext, addr 0x309f308, size 0xb0, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken PeekNext() ;

/// @brief Method Tokenize, addr 0x309d544, size 0xc70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x309d4c0, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_current, addr 0x309e42c, size 0xac, virtual false, abstract: false, final false
