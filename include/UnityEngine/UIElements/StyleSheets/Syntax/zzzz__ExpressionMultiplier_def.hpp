...
/// @brief Method SetType, addr 0x309d2d8, size 0x54, virtual false, abstract: false, final false
inline void SetType(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType  value) ;

/// @brief Method .ctor, addr 0x309d2c4, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType  type) ;

/// @brief Method get_type, addr 0x309be1c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType get_type() ;

/// @brief Method set_type, addr 0x309d2d4, size 0x4, virtual false, abstract: false, final false
