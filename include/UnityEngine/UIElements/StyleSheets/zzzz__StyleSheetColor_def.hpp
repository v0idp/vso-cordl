...
/// @brief Method HexToColor32, addr 0x309a114, size 0x14, virtual false, abstract: false, final false
static inline ::UnityEngine::Color32 HexToColor32(uint32_t  color) ;

/// @brief Method TryGetColor, addr 0x30966b8, size 0xd8, virtual false, abstract: false, final false
