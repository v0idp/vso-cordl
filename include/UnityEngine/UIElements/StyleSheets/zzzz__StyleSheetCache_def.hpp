...
public:
// Declarations
/// @brief Method .ctor, addr 0x3099ddc, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x309a0b8, size 0x20, virtual true, abstract: false, final true
...
/// @brief Method GetHashCode, addr 0x309a0d8, size 0x3c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x309a0b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
constexpr ::System::Collections::Generic::IEqualityComparer_1<::UnityEngine::UIElements::StyleSheets::StyleSheetCache_SheetHandleKey>* i___System__Collections__Generic__IEqualityComparer_1___UnityEngine__UIElements__StyleSheets__StyleSheetCache_SheetHandleKey_() noexcept;
...
/// @brief Field s_RulePropertyIdsCache, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_RulePropertyIdsCache, put=setStaticF_s_RulePropertyIdsCache)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::StyleSheets::StyleSheetCache_SheetHandleKey,::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::Array<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*>>*  s_RulePropertyIdsCache;

/// @brief Method GetPropertyId, addr 0x3099e10, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method GetPropertyIds, addr 0x3099f00, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method GetPropertyIds, addr 0x3094ba8, size 0x1bc, virtual false, abstract: false, final false
...
static inline ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::StyleSheets::StyleSheetCache_SheetHandleKey,::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::Array<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*>>* getStaticF_s_RulePropertyIdsCache() ;

static inline void setStaticF_s_Comparer(::UnityEngine::UIElements::StyleSheets::StyleSheetCache_SheetHandleKeyComparer*  value) ;

static inline void setStaticF_s_RulePropertyIdsCache(::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::StyleSheets::StyleSheetCache_SheetHandleKey,::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::Array<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*>>*  value) ;
