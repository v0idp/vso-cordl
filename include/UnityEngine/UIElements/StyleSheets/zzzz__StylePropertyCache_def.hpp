...
/// @brief Method TryGetNonTerminalValue, addr 0x3090b60, size 0x90, virtual false, abstract: false, final false
static inline bool TryGetNonTerminalValue(::StringW  name, ::ByRef<::StringW>  syntax) ;

/// @brief Method TryGetSyntax, addr 0x3090ad0, size 0x90, virtual false, abstract: false, final false
