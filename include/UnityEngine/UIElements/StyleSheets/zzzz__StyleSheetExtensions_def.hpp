...
public:
// Declarations
/// @brief Method IsVarFunction, addr 0x3098b74, size 0x34, virtual false, abstract: false, final false
static inline bool IsVarFunction(::UnityEngine::UIElements::StyleValueHandle  handle) ;

/// @brief Method ReadAsString, addr 0x30954ec, size 0x2d8, virtual false, abstract: false, final false
