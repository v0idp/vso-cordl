...
/// @brief Method Match, addr 0x309ca20, size 0x170, virtual false, abstract: false, final false
...
/// @brief Method MatchAngle, addr 0x309d130, size 0xfc, virtual true, abstract: false, final false
inline bool MatchAngle() ;

/// @brief Method MatchColor, addr 0x309ce9c, size 0xd4, virtual true, abstract: false, final false
inline bool MatchColor() ;

/// @brief Method MatchCustomIdent, addr 0x309d050, size 0xe0, virtual true, abstract: false, final false
inline bool MatchCustomIdent() ;

/// @brief Method MatchInteger, addr 0x309cc7c, size 0x38, virtual true, abstract: false, final false
inline bool MatchInteger() ;

/// @brief Method MatchKeyword, addr 0x309cb90, size 0xb4, virtual true, abstract: false, final false
inline bool MatchKeyword(::StringW  keyword) ;

/// @brief Method MatchLength, addr 0x309ccb4, size 0xf4, virtual true, abstract: false, final false
inline bool MatchLength() ;

/// @brief Method MatchNumber, addr 0x309cc44, size 0x38, virtual true, abstract: false, final false
inline bool MatchNumber() ;

/// @brief Method MatchPercentage, addr 0x309cda8, size 0xf4, virtual true, abstract: false, final false
inline bool MatchPercentage() ;

/// @brief Method MatchResource, addr 0x309cf70, size 0x38, virtual true, abstract: false, final false
inline bool MatchResource() ;

/// @brief Method MatchTime, addr 0x309cfec, size 0x64, virtual true, abstract: false, final false
inline bool MatchTime() ;

/// @brief Method MatchUrl, addr 0x309cfa8, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x309d22c, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_current, addr 0x309c8a0, size 0x84, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleSheets::StylePropertyValue get_current() ;

/// @brief Method get_isCurrentComma, addr 0x309c974, size 0xac, virtual true, abstract: false, final false
inline bool get_isCurrentComma() ;

/// @brief Method get_isCurrentVariable, addr 0x309c96c, size 0x8, virtual true, abstract: false, final false
inline bool get_isCurrentVariable() ;

/// @brief Method get_valueCount, addr 0x309c924, size 0x48, virtual true, abstract: false, final false
