...
public:
// Declarations
/// @brief Method GetHashCode, addr 0x3151a34, size 0x78, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x3151a28, size 0xc, virtual false, abstract: false, final false
