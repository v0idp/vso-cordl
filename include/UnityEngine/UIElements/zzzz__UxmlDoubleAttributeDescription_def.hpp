...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x3053ef0, size 0x8, virtual false, abstract: false, final false
inline double_t _GetValueFromBag_b__3_0(::StringW  s, double_t  d) ;

/// @brief Method .ctor, addr 0x3053ee8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ConvertValueToDouble, addr 0x3053df0, size 0x9c, virtual false, abstract: false, final false
static inline double_t ConvertValueToDouble(::StringW  v, double_t  defaultValue) ;

/// @brief Method GetValueFromBag, addr 0x3053ca4, size 0x14c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3053c0c, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
