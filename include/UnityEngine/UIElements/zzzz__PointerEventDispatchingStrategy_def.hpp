...
/// @brief Method CanDispatchEvent, addr 0x30f3f14, size 0x54, virtual true, abstract: false, final true
inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method DispatchEvent, addr 0x30f3f68, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method SendEventToTarget, addr 0x30f4210, size 0xac, virtual false, abstract: false, final false
static inline void SendEventToTarget(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method SetBestTargetForEvent, addr 0x30f3fb0, size 0x260, virtual false, abstract: false, final false
static inline void SetBestTargetForEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method UpdateElementUnderPointer, addr 0x30f42bc, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30f4588, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
