...
/// @brief Method OnPanelDestroyed, addr 0x318404c, size 0x8, virtual false, abstract: false, final false
inline void OnPanelDestroyed() ;

/// @brief Method Raycast, addr 0x318415c, size 0x498, virtual true, abstract: false, final false
inline void Raycast(::UnityEngine::EventSystems::PointerEventData*  eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>*  resultAppendList) ;

/// @brief Method RegisterCallbacks, addr 0x3183fbc, size 0x90, virtual false, abstract: false, final false
inline void RegisterCallbacks() ;

/// @brief Method UnregisterCallbacks, addr 0x3183f2c, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31845fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_eventCamera, addr 0x31845f4, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_panel, addr 0x3183e80, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::IPanel* get_panel() ;

/// @brief Method get_renderOrderPriority, addr 0x31840e8, size 0x74, virtual true, abstract: false, final false
inline int32_t get_renderOrderPriority() ;

/// @brief Method get_selectableGameObject, addr 0x3184054, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_selectableGameObject() ;

/// @brief Method get_sortOrderPriority, addr 0x318406c, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method set_panel, addr 0x3183e88, size 0xa4, virtual true, abstract: false, final true
