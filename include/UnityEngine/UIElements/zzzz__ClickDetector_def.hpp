...
/// @brief Method Reset, addr 0x301ec00, size 0x64, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x301e990, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CancelClickTracking, addr 0x301f1b8, size 0xfc, virtual false, abstract: false, final false
inline void CancelClickTracking(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method Cleanup, addr 0x301f7d0, size 0x184, virtual false, abstract: false, final false
inline void Cleanup(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>*  elements) ;

/// @brief Method ContainsPointer, addr 0x301f078, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method ProcessEvent, addr 0x301f2b4, size 0x51c, virtual false, abstract: false, final false
inline void ProcessEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method SendClickEvent, addr 0x301ec64, size 0x414, virtual false, abstract: false, final false
inline void SendClickEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method StartClickTracking, addr 0x301e998, size 0x268, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x301e73c, size 0x254, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF__s_DoubleClickTime_k__BackingField() ;

/// @brief Method get_s_DoubleClickTime, addr 0x301e688, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method set_s_DoubleClickTime, addr 0x301e6e0, size 0x5c, virtual false, abstract: false, final false
