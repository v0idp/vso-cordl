...
/// @brief Method <.cctor>b__0_0, addr 0x30f1568, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ContextualMenuPopulateEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x30f1560, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPooled, addr 0x30f0be8, size 0x770, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x30f1358, size 0x70, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x30f13c8, size 0x34, virtual false, abstract: false, final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::ContextualMenuPopulateEvent* New_ctor() ;

/// @brief Method PostDispatch, addr 0x30f146c, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30f13fc, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_menu, addr 0x30f0bc8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::DropdownMenu* get_menu() ;

/// @brief Method get_triggerEvent, addr 0x30f0bd8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::EventBase* get_triggerEvent() ;

/// @brief Method set_menu, addr 0x30f0bd0, size 0x8, virtual false, abstract: false, final false
inline void set_menu(::UnityEngine::UIElements::DropdownMenu*  value) ;

/// @brief Method set_triggerEvent, addr 0x30f0be0, size 0x8, virtual false, abstract: false, final false
