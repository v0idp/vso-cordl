...
public:
// Declarations
/// @brief Method Invoke, addr 0x3106a6c, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;

static inline ::UnityEngine::UIElements::SavePersistentViewData* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x31069e4, size 0x88, virtual false, abstract: false, final false
