...
/// @brief Method .ctor, addr 0x30b70bc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x30b728c, size 0x1d4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30b7104, size 0x188, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ClampValues, addr 0x30b4588, size 0x38, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 ClampValues(::UnityEngine::Vector2  valueToClamp) ;

/// @brief Method ComputeValueFromDraggingThumb, addr 0x30b68a0, size 0x1a4, virtual false, abstract: false, final false
inline void ComputeValueFromDraggingThumb(float_t  dragElementStartPos, float_t  dragElementEndPos) ;

/// @brief Method ComputeValueFromPosition, addr 0x30b6560, size 0x1a0, virtual false, abstract: false, final false
inline float_t ComputeValueFromPosition(float_t  positionToConvert) ;

/// @brief Method ExecuteDefaultAction, addr 0x30b6700, size 0x10c, virtual true, abstract: false, final false
...
/// @brief Method RegisterEditingCallbacks, addr 0x30b6c6c, size 0x158, virtual true, abstract: false, final false
inline void RegisterEditingCallbacks() ;

/// @brief Method SetSliderValueFromClick, addr 0x30b6a44, size 0x224, virtual false, abstract: false, final false
inline void SetSliderValueFromClick() ;

/// @brief Method SetSliderValueFromDrag, addr 0x30b680c, size 0x94, virtual false, abstract: false, final false
inline void SetSliderValueFromDrag() ;

/// @brief Method SetValueWithoutNotify, addr 0x30b475c, size 0x94, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(::UnityEngine::Vector2  newValue) ;

/// @brief Method SliderLerpUnclamped, addr 0x30b5ec8, size 0x10, virtual false, abstract: false, final false
inline float_t SliderLerpUnclamped(float_t  a, float_t  b, float_t  interpolant) ;

/// @brief Method SliderNormalizeValue, addr 0x30b5eb8, size 0x10, virtual false, abstract: false, final false
inline float_t SliderNormalizeValue(float_t  currentValue, float_t  lowerValue, float_t  higherValue) ;

/// @brief Method UnregisterEditingCallbacks, addr 0x30b6dc4, size 0x158, virtual true, abstract: false, final false
inline void UnregisterEditingCallbacks() ;

/// @brief Method UpdateDragElementPosition, addr 0x30b47f0, size 0xe18, virtual false, abstract: false, final false
inline void UpdateDragElementPosition() ;

/// @brief Method UpdateDragElementPosition, addr 0x30b5e78, size 0x40, virtual false, abstract: false, final false
inline void UpdateDragElementPosition(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method UpdateDragThumbsRect, addr 0x30b5ed8, size 0x688, virtual false, abstract: false, final false
inline void UpdateDragThumbsRect() ;

/// @brief Method UpdateMixedValueContent, addr 0x30b6c68, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30b58e0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x30b5900, size 0x578, virtual false, abstract: false, final false
...
/// @brief Method get_clampedDragger, addr 0x30b44c0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::ClampedDragger_1<float_t>* get_clampedDragger() ;

/// @brief Method get_dragElement, addr 0x30b4490, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_dragElement() ;

/// @brief Method get_dragMaxThumb, addr 0x30b44b0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_dragMaxThumb() ;

/// @brief Method get_dragMinThumb, addr 0x30b44a0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_dragMinThumb() ;

/// @brief Method get_highLimit, addr 0x30b5774, size 0x8, virtual false, abstract: false, final false
inline float_t get_highLimit() ;

/// @brief Method get_lowLimit, addr 0x30b5608, size 0x8, virtual false, abstract: false, final false
inline float_t get_lowLimit() ;

/// @brief Method get_maxValue, addr 0x30b45c0, size 0x20, virtual false, abstract: false, final false
inline float_t get_maxValue() ;

/// @brief Method get_minValue, addr 0x30b44d0, size 0x10, virtual false, abstract: false, final false
inline float_t get_minValue() ;

/// @brief Method get_value, addr 0x30b4688, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method set_clampedDragger, addr 0x30b44c8, size 0x8, virtual false, abstract: false, final false
inline void set_clampedDragger(::UnityEngine::UIElements::ClampedDragger_1<float_t>*  value) ;

/// @brief Method set_dragElement, addr 0x30b4498, size 0x8, virtual false, abstract: false, final false
inline void set_dragElement(::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method set_dragMaxThumb, addr 0x30b44b8, size 0x8, virtual false, abstract: false, final false
inline void set_dragMaxThumb(::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method set_dragMinThumb, addr 0x30b44a8, size 0x8, virtual false, abstract: false, final false
inline void set_dragMinThumb(::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method set_highLimit, addr 0x30b577c, size 0x164, virtual false, abstract: false, final false
inline void set_highLimit(float_t  value) ;

/// @brief Method set_lowLimit, addr 0x30b5610, size 0x164, virtual false, abstract: false, final false
inline void set_lowLimit(float_t  value) ;

/// @brief Method set_maxValue, addr 0x30b45e0, size 0xa8, virtual false, abstract: false, final false
inline void set_maxValue(float_t  value) ;

/// @brief Method set_minValue, addr 0x30b44e0, size 0xa8, virtual false, abstract: false, final false
inline void set_minValue(float_t  value) ;

/// @brief Method set_value, addr 0x30b46d0, size 0x8c, virtual true, abstract: false, final false
