...
/// @brief Method Acquire, addr 0x312ab6c, size 0x168, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TextureId Acquire(::UnityEngine::Texture*  tex) ;

/// @brief Method AllocAndAcquire, addr 0x312a68c, size 0x28c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TextureId AllocAndAcquire(::UnityEngine::Texture*  texture, bool  dynamic) ;

/// @brief Method AllocAndAcquireDynamic, addr 0x3124e2c, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::TextureId AllocAndAcquireDynamic() ;

/// @brief Method GetTexture, addr 0x312a4d8, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x3125168, size 0x280, virtual false, abstract: false, final false
inline void Release(::UnityEngine::UIElements::TextureId  id) ;

/// @brief Method UpdateDynamic, addr 0x312a918, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x312acd4, size 0x114, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::UIElements::TextureRegistry* getStaticF__instance_k__BackingField() ;

/// @brief Method get_instance, addr 0x312a480, size 0x58, virtual false, abstract: false, final false
