...
/// @brief Method Commit, addr 0x31258fc, size 0x44, virtual false, abstract: false, final false
inline void Commit() ;

/// @brief Method CreateAtlasTexture, addr 0x3125ca8, size 0x130, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> CreateAtlasTexture() ;

/// @brief Method Dispose, addr 0x3124e5c, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x3124ec8, size 0x1d4, virtual true, abstract: false, final false
...
/// @brief Method Remove, addr 0x312581c, size 0xe0, virtual false, abstract: false, final false
inline void Remove(::UnityEngine::UIElements::UIR::Allocator2D_Alloc2D  alloc) ;

/// @brief Method TryAdd, addr 0x31253e8, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x31256d4, size 0x148, virtual false, abstract: false, final false
inline void Update(::UnityEngine::Texture2D*  image, ::UnityEngine::RectInt  rect) ;

/// @brief Method UpdateAtlasTexture, addr 0x3125940, size 0x368, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3124cdc, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_atlas, addr 0x3124cbc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_atlas() ;

/// @brief Method get_disposed, addr 0x3124e48, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_filterMode, addr 0x3124cd4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::FilterMode get_filterMode() ;

/// @brief Method get_format, addr 0x3124ccc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::RenderTextureFormat get_format() ;

/// @brief Method get_textureId, addr 0x3124cac, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_atlas, addr 0x3124cc4, size 0x8, virtual false, abstract: false, final false
inline void set_atlas(::UnityEngine::RenderTexture*  value) ;

/// @brief Method set_disposed, addr 0x3124e50, size 0xc, virtual false, abstract: false, final false
inline void set_disposed(bool  value) ;

/// @brief Method set_textureId, addr 0x3124cb4, size 0x8, virtual false, abstract: false, final false
