...
/// @brief Method Equals, addr 0x312b33c, size 0x88, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x312b3c4, size 0x24, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::TimerState  other) ;

/// @brief Method GetHashCode, addr 0x312b3e8, size 0x7c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_deltaTime, addr 0x312b330, size 0xc, virtual false, abstract: false, final false
inline int64_t get_deltaTime() ;

/// @brief Method get_now, addr 0x312b320, size 0x8, virtual false, abstract: false, final false
inline int64_t get_now() ;

/// @brief Method get_start, addr 0x312b310, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_now, addr 0x312b328, size 0x8, virtual false, abstract: false, final false
inline void set_now(int64_t  value) ;

/// @brief Method set_start, addr 0x312b318, size 0x8, virtual false, abstract: false, final false
