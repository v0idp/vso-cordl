...
/// @brief Method .ctor, addr 0x3044868, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddItem, addr 0x3044450, size 0x334, virtual false, abstract: false, final false
...
/// @brief Method AddItem, addr 0x3044428, size 0x28, virtual true, abstract: false, final true
inline void AddItem(::StringW  itemName, bool  isChecked, ::System::Action*  action) ;

/// @brief Method AddItem, addr 0x3044784, size 0x24, virtual true, abstract: false, final true
inline void AddItem(::StringW  itemName, bool  isChecked, ::System::Action_1<::System::Object*>*  action, ::System::Object*  data) ;

/// @brief Method AddSeparator, addr 0x30447a8, size 0xc0, virtual true, abstract: false, final true
inline void AddSeparator(::StringW  path) ;

/// @brief Method Apply, addr 0x3043920, size 0x19c, virtual false, abstract: false, final false
inline bool Apply(::UnityEngine::UIElements::KeyboardNavigationOperation  op) ;

/// @brief Method Apply, addr 0x30438e4, size 0x3c, virtual false, abstract: false, final false
inline void Apply(::UnityEngine::UIElements::KeyboardNavigationOperation  op, ::UnityEngine::UIElements::EventBase*  sourceEvent) ;

/// @brief Method ChangeSelectedIndex, addr 0x30442ec, size 0x13c, virtual false, abstract: false, final false
inline void ChangeSelectedIndex(int32_t  newIndex, int32_t  previousIndex) ;

/// @brief Method DropDown, addr 0x3044870, size 0x928, virtual true, abstract: false, final true
inline void DropDown(::UnityEngine::Rect  position, ::UnityEngine::UIElements::VisualElement*  targetElement, bool  anchored) ;

/// @brief Method EnsureVisibilityInParent, addr 0x3045198, size 0x57c, virtual false, abstract: false, final false
inline void EnsureVisibilityInParent() ;

/// @brief Method GetSelectedIndex, addr 0x3043abc, size 0xa0, virtual false, abstract: false, final false
inline int32_t GetSelectedIndex() ;

/// @brief Method Hide, addr 0x3043854, size 0x90, virtual false, abstract: false, final false
inline void Hide(bool  giveFocusBack) ;

static inline ::UnityEngine::UIElements::GenericDropdownMenu* New_ctor() ;

/// @brief Method OnAttachToPanel, addr 0x30430a4, size 0x418, virtual false, abstract: false, final false
inline void OnAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent*  evt) ;

/// @brief Method OnContainerGeometryChanged, addr 0x304571c, size 0x4, virtual false, abstract: false, final false
inline void OnContainerGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnDetachFromPanel, addr 0x30434bc, size 0x398, virtual false, abstract: false, final false
inline void OnDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent*  evt) ;

/// @brief Method OnFocusOut, addr 0x3044190, size 0x148, virtual false, abstract: false, final false
inline void OnFocusOut(::UnityEngine::UIElements::FocusOutEvent*  evt) ;

/// @brief Method OnParentResized, addr 0x30442d8, size 0x14, virtual false, abstract: false, final false
inline void OnParentResized(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnPointerDown, addr 0x3043cc0, size 0x12c, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMove, addr 0x3043f1c, size 0x12c, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUp, addr 0x3044048, size 0x148, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnTargetElementDetachFromPanel, addr 0x3045714, size 0x8, virtual false, abstract: false, final false
inline void OnTargetElementDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent*  evt) ;

/// @brief Method UpdateSelection, addr 0x3043dec, size 0x130, virtual false, abstract: false, final false
inline void UpdateSelection(::UnityEngine::UIElements::VisualElement*  target) ;

/// @brief Method <Apply>g__UpdateSelectionDown|39_0, addr 0x3043c04, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method <Apply>g__UpdateSelectionUp|39_1, addr 0x3043b5c, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3040d7c, size 0x2e8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_closeOnParentResize, addr 0x304306c, size 0x8, virtual false, abstract: false, final false
inline bool get_closeOnParentResize() ;

/// @brief Method get_contentContainer, addr 0x3043080, size 0x24, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_contentContainer() ;

/// @brief Method get_isSingleSelectionDropdown, addr 0x3043058, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_closeOnParentResize, addr 0x3043074, size 0xc, virtual false, abstract: false, final false
inline void set_closeOnParentResize(bool  value) ;

/// @brief Method set_isSingleSelectionDropdown, addr 0x3043060, size 0xc, virtual false, abstract: false, final false
