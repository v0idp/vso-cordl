...
// Dependencies UnityEngine.UIElements.DynamicHeightVirtualizationController`1::ScrollDirection<T>, UnityEngine.UIElements.DynamicHeightVirtualizationController`1::VirtualizationChange<T>, UnityEngine.UIElements.VerticalVirtualizationController`1<T>, UnityEngine.Vector2
namespace UnityEngine::UIElements {
// cpp template
template<typename T>
// Is value type: false
