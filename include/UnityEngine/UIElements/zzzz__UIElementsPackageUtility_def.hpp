...
/// @brief Method Refresh, addr 0x304c800, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method get_EditorResourcesBasePath, addr 0x304c748, size 0x58, virtual false, abstract: false, final false
static inline ::StringW get_EditorResourcesBasePath() ;

/// @brief Method get_IsUIEPackageLoaded, addr 0x304c690, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method set_EditorResourcesBasePath, addr 0x304c7a0, size 0x5c, virtual false, abstract: false, final false
static inline void set_EditorResourcesBasePath(::StringW  value) ;

/// @brief Method set_IsUIEPackageLoaded, addr 0x304c6e8, size 0x60, virtual false, abstract: false, final false
