...
public:
// Declarations
/// @brief Method ExecuteDefaultAction, addr 0x30e6028, size 0x168, virtual false, abstract: false, final false
static inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HandleEventAcrossPropagationPath, addr 0x30eb380, size 0x77c, virtual false, abstract: false, final false
static inline void HandleEventAcrossPropagationPath(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method PropagateEvent, addr 0x30e7650, size 0x138, virtual false, abstract: false, final false
static inline void PropagateEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method PropagateToIMGUIContainer, addr 0x30e7204, size 0x44c, virtual false, abstract: false, final false
