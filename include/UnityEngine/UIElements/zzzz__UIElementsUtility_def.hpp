...
/// @brief Method BeginContainerGUI, addr 0x30511d8, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method CreateEvent, addr 0x3051638, size 0x74, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::EventBase* CreateEvent(::UnityEngine::Event*  systemEvent) ;

/// @brief Method CreateEvent, addr 0x304ce94, size 0x2f4, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::EventBase* CreateEvent(::UnityEngine::Event*  systemEvent, ::UnityEngine::EventType  eventType) ;

/// @brief Method DoDispatch, addr 0x3050a60, size 0x634, virtual false, abstract: false, final false
static inline bool DoDispatch(::UnityEngine::UIElements::BaseVisualElementPanel*  panel) ;

/// @brief Method EndContainerGUI, addr 0x3051408, size 0x230, virtual false, abstract: false, final false
static inline void EndContainerGUI(::UnityEngine::Event*  evt, ::UnityEngine::Rect  layoutSize) ;

/// @brief Method GetAllPanels, addr 0x304d888, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method GetPanelsIterator, addr 0x30516ac, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method ParseMenuName, addr 0x3051808, size 0x140, virtual false, abstract: false, final false
static inline ::StringW ParseMenuName(::StringW  menuName) ;

/// @brief Method PixelsPerUnitScaleForElement, addr 0x3051754, size 0xb4, virtual false, abstract: false, final false
static inline float_t PixelsPerUnitScaleForElement(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::Sprite*  sprite) ;

/// @brief Method RegisterCachedPanel, addr 0x304d6dc, size 0x90, virtual false, abstract: false, final false
static inline void RegisterCachedPanel(int32_t  instanceID, ::UnityEngine::UIElements::Panel*  panel) ;

/// @brief Method RemoveCachedPanel, addr 0x304d808, size 0x80, virtual false, abstract: false, final false
static inline void RemoveCachedPanel(int32_t  instanceID) ;

/// @brief Method TryGetPanel, addr 0x304d328, size 0x90, virtual false, abstract: false, final false
static inline bool TryGetPanel(int32_t  instanceID, ::ByRef<::UnityEngine::UIElements::Panel*>  panel) ;

/// @brief Method UnityEngine.UIElements.IUIElementsUtility.CleanupRoots, addr 0x3051094, size 0x60, virtual true, abstract: false, final true
inline bool UnityEngine_UIElements_IUIElementsUtility_CleanupRoots() ;

/// @brief Method UnityEngine.UIElements.IUIElementsUtility.EndContainerGUIFromException, addr 0x30510f4, size 0xe4, virtual true, abstract: false, final true
inline bool UnityEngine_UIElements_IUIElementsUtility_EndContainerGUIFromException(::System::Exception*  exception) ;

/// @brief Method UnityEngine.UIElements.IUIElementsUtility.MakeCurrentIMGUIContainerDirty, addr 0x30507b0, size 0xc8, virtual true, abstract: false, final true
inline bool UnityEngine_UIElements_IUIElementsUtility_MakeCurrentIMGUIContainerDirty() ;

/// @brief Method UnityEngine.UIElements.IUIElementsUtility.ProcessEvent, addr 0x3050944, size 0x11c, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.UIElements.IUIElementsUtility.ReleaseCapture, addr 0x305093c, size 0x8, virtual true, abstract: false, final true
inline bool UnityEngine_UIElements_IUIElementsUtility_ReleaseCapture() ;

/// @brief Method UnityEngine.UIElements.IUIElementsUtility.TakeCapture, addr 0x3050878, size 0xc4, virtual true, abstract: false, final true
inline bool UnityEngine_UIElements_IUIElementsUtility_TakeCapture() ;

/// @brief Method .ctor, addr 0x3050750, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
