...
/// @brief Method RegisterPlayerloopCallback, addr 0x3105878, size 0x28, virtual false, abstract: false, final false
static inline void RegisterPlayerloopCallback() ;

/// @brief Method RepaintOffscreenPanels, addr 0x3105814, size 0x64, virtual false, abstract: false, final false
static inline void RepaintOffscreenPanels() ;

/// @brief Method RepaintOverlayPanels, addr 0x310574c, size 0x64, virtual false, abstract: false, final false
static inline void RepaintOverlayPanels() ;

/// @brief Method UnregisterPlayerloopCallback, addr 0x31058a0, size 0x28, virtual false, abstract: false, final false
static inline void UnregisterPlayerloopCallback() ;

/// @brief Method UpdateRuntimePanels, addr 0x31057b0, size 0x64, virtual false, abstract: false, final false
static inline void UpdateRuntimePanels() ;

/// @brief Method VisualElementCreation, addr 0x31058c8, size 0x28, virtual false, abstract: false, final false
