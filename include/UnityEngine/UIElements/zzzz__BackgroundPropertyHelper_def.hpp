...
public:
// Declarations
/// @brief Method ConvertScaleModeToBackgroundPosition, addr 0x301bfec, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method ConvertScaleModeToBackgroundRepeat, addr 0x301c298, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::BackgroundRepeat ConvertScaleModeToBackgroundRepeat(::UnityEngine::ScaleMode  scaleMode) ;

/// @brief Method ConvertScaleModeToBackgroundSize, addr 0x301c2a8, size 0xa4, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::BackgroundSize ConvertScaleModeToBackgroundSize(::UnityEngine::ScaleMode  scaleMode) ;

/// @brief Method ResolveUnityBackgroundScaleMode, addr 0x301c3b0, size 0x3a0, virtual false, abstract: false, final false
