...
/// @brief Method <.cctor>b__0_0, addr 0x30eefe0, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MouseMoveEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x30eefd8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPooled, addr 0x30eef34, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MouseMoveEvent* GetPooled(::UnityEngine::UIElements::PointerMoveEvent*  pointerEvent) ;

/// @brief Method Init, addr 0x30eee80, size 0x54, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x30eeed4, size 0xc, virtual false, abstract: false, final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::MouseMoveEvent* New_ctor() ;

/// @brief Method .ctor, addr 0x30eeee0, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;
