...
public:
// Declarations
/// @brief Method ShouldSendNavigationMoveEvent, addr 0x30ecdc0, size 0xe8, virtual false, abstract: false, final false
static inline bool ShouldSendNavigationMoveEvent(::UnityEngine::UIElements::KeyDownEvent*  e) ;

/// @brief Method ShouldSendNavigationMoveEventRuntime, addr 0x30ecfa4, size 0x44, virtual false, abstract: false, final false
