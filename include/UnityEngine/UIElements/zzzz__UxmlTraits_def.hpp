...
public:
// Declarations
/// @brief Method Init, addr 0x3055074, size 0x4, virtual true, abstract: false, final false
inline void Init(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::IUxmlAttributes*  bag, ::UnityEngine::UIElements::CreationContext  cc) ;

static inline ::UnityEngine::UIElements::UxmlTraits* New_ctor() ;

/// @brief Method .ctor, addr 0x3052a14, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
