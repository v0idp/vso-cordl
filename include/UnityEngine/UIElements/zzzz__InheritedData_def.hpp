...
// Dependencies System.IEquatable`1<T>, UnityEngine.Color, UnityEngine.FontStyle, UnityEngine.TextAnchor, UnityEngine.UIElements.FontDefinition, UnityEngine.UIElements.IStyleDataGroup`1<T>, UnityEngine.UIElements.Length, UnityEngine.UIElements.TextShadow, UnityEngine.UIElements.Visibility, UnityEngine.UIElements.WhiteSpace
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Method Copy, addr 0x3144584, size 0x1c, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::InheritedData Copy() ;

/// @brief Method CopyFrom, addr 0x31445a0, size 0x14, virtual true, abstract: false, final true
inline void CopyFrom(::ByRef<::UnityEngine::UIElements::InheritedData>  other) ;

/// @brief Method Equals, addr 0x3144808, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x31447bc, size 0x4c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::InheritedData  other) ;

/// @brief Method GetHashCode, addr 0x31448b0, size 0x3b8, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x31445b4, size 0x208, virtual false, abstract: false, final false
