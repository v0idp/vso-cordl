...
public:
// Declarations
/// @brief Method ConvertPixelUnitsToTextCoreRelativeUnits, addr 0x3047188, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method GetFontAsset, addr 0x3046f04, size 0x1bc, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::TextCore::Text::FontAsset> GetFontAsset(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetTextCoreSettingsForElement, addr 0x3047240, size 0x3dc, virtual false, abstract: false, final false
...
/// @brief Method GetTextSettingsFrom, addr 0x30470c0, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method IsFontAssigned, addr 0x3046e40, size 0xc4, virtual false, abstract: false, final false
static inline bool IsFontAssigned(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method MeasureVisualElementTextSize, addr 0x3046cbc, size 0x184, virtual false, abstract: false, final false
