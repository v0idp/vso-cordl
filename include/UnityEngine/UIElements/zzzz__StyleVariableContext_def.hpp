...
/// @brief Method Add, addr 0x3151aac, size 0x310, virtual false, abstract: false, final false
inline void Add(::UnityEngine::UIElements::StyleVariable  sv) ;

/// @brief Method AddInitialRange, addr 0x3151dcc, size 0x10c, virtual false, abstract: false, final false
inline void AddInitialRange(::UnityEngine::UIElements::StyleVariableContext*  other) ;

/// @brief Method Clear, addr 0x3151ed8, size 0xb0, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method GetVariableHash, addr 0x3152264, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method TryFindVariable, addr 0x3152178, size 0xec, virtual false, abstract: false, final false
inline bool TryFindVariable(::StringW  name, ::ByRef<::UnityEngine::UIElements::StyleVariable>  v) ;

/// @brief Method <Add>g__ComputeOrderSensitiveHash|7_0, addr 0x3151dbc, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3151f88, size 0xe4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x315206c, size 0x10c, virtual false, abstract: false, final false
