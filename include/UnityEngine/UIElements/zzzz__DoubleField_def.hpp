...
/// @brief Method .ctor, addr 0x303f420, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x303f468, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x303f588, size 0x194, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x303f768, size 0xa8, virtual true, abstract: false, final false
inline double_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x303f71c, size 0x4c, virtual true, abstract: false, final false
inline ::StringW ValueToString(double_t  v) ;

/// @brief Method .ctor, addr 0x303f23c, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x303f530, size 0x58, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentDoubleField, addr 0x303f4b0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x303f2f4, size 0x5c, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, double_t  startValue) ;

/// @brief Method CanTryParse, addr 0x303f2d0, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x303f004, size 0xdc, virtual true, abstract: false, final false
inline double_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x303ef4c, size 0xb8, virtual true, abstract: false, final false
inline ::StringW ValueToString(double_t  v) ;

/// @brief Method .ctor, addr 0x303f0e0, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x303f0ec, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_doubleInput, addr 0x303eec8, size 0x84, virtual false, abstract: false, final false
