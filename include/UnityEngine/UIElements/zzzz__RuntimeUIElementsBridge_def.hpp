...
/// @brief Method SetWantsMouseJumping, addr 0x304c684, size 0x4, virtual true, abstract: false, final false
inline void SetWantsMouseJumping(int32_t  value) ;

/// @brief Method .ctor, addr 0x304c688, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
