...
/// @brief Method Equals, addr 0x30700e8, size 0x38, virtual false, abstract: false, final false
inline bool Equals(::UnityEngine::UIElements::UIR::BMPAlloc  other) ;

/// @brief Method IsValid, addr 0x306de88, size 0x10, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method ToString, addr 0x3070120, size 0xf4, virtual true, abstract: false, final false
