...
/// @brief Method Allocate, addr 0x307052c, size 0x48c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::BMPAlloc Allocate(::UnityEngine::UIElements::UIR::BaseShaderInfoStorage*  storage) ;

/// @brief Method Construct, addr 0x3070260, size 0x10c, virtual false, abstract: false, final false
inline void Construct(int32_t  pageHeight, int32_t  entryWidth, int32_t  entryHeight) ;

/// @brief Method CountTrailingZeroes, addr 0x30709b8, size 0x64, virtual false, abstract: false, final false
static inline uint8_t CountTrailingZeroes(uint32_t  val) ;

/// @brief Method ForceFirstAlloc, addr 0x307036c, size 0x1c0, virtual false, abstract: false, final false
inline void ForceFirstAlloc(uint16_t  firstPageX, uint16_t  firstPageY) ;

/// @brief Method Free, addr 0x3070a1c, size 0x144, virtual false, abstract: false, final false
inline void Free(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method GetAllocPageAtlasLocation, addr 0x3070b70, size 0x78, virtual false, abstract: false, final false
inline void GetAllocPageAtlasLocation(int32_t  page, ::ByRef<uint16_t>  x, ::ByRef<uint16_t>  y) ;

/// @brief Method get_entryHeight, addr 0x3070b68, size 0x8, virtual false, abstract: false, final false
inline int32_t get_entryHeight() ;

/// @brief Method get_entryWidth, addr 0x3070b60, size 0x8, virtual false, abstract: false, final false
