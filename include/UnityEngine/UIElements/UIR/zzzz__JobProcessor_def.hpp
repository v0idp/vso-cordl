...
public:
// Declarations
/// @brief Method ScheduleConvertMeshJobs, addr 0x3065efc, size 0x5c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleConvertMeshJobs(::System::IntPtr  buffer, int32_t  jobCount) ;

/// @brief Method ScheduleConvertMeshJobs_Injected, addr 0x3065f58, size 0x54, virtual false, abstract: false, final false
static inline void ScheduleConvertMeshJobs_Injected(::System::IntPtr  buffer, int32_t  jobCount, ::ByRef<::Unity::Jobs::JobHandle>  ret) ;

/// @brief Method ScheduleCopyClosingMeshJobs, addr 0x3065fac, size 0x5c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleCopyClosingMeshJobs(::System::IntPtr  buffer, int32_t  jobCount) ;

/// @brief Method ScheduleCopyClosingMeshJobs_Injected, addr 0x3066008, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method ScheduleNudgeJobs, addr 0x3065e4c, size 0x5c, virtual false, abstract: false, final false
static inline ::Unity::Jobs::JobHandle ScheduleNudgeJobs(::System::IntPtr  buffer, int32_t  jobCount) ;

/// @brief Method ScheduleNudgeJobs_Injected, addr 0x3065ea8, size 0x54, virtual false, abstract: false, final false
