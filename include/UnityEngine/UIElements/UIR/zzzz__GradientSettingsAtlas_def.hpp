...
public:
// Declarations
/// @brief Method WriteRawFloat4Packed, addr 0x30677b8, size 0xa8, virtual false, abstract: false, final false
inline void WriteRawFloat4Packed(float_t  f0, float_t  f1, float_t  f2, float_t  f3, int32_t  destX, int32_t  destY) ;

/// @brief Method WriteRawInt2Packed, addr 0x3067860, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method Add, addr 0x3067338, size 0xdc, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Alloc Add(int32_t  count) ;

/// @brief Method Commit, addr 0x3067904, size 0x64, virtual false, abstract: false, final false
inline void Commit() ;

/// @brief Method Dispose, addr 0x3067164, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x30671d0, size 0x78, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

static inline ::UnityEngine::UIElements::UIR::GradientSettingsAtlas* New_ctor(int32_t  length) ;

/// @brief Method PrepareAtlas, addr 0x3067968, size 0x15c, virtual false, abstract: false, final false
inline void PrepareAtlas() ;

/// @brief Method Reset, addr 0x3067278, size 0xb8, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method Write, addr 0x3067414, size 0x3a4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3067248, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_MustCommit, addr 0x30678f0, size 0x8, virtual false, abstract: false, final false
inline bool get_MustCommit() ;

/// @brief Method get_atlas, addr 0x3067330, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture2D> get_atlas() ;

/// @brief Method get_disposed, addr 0x3067150, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_length, addr 0x3067148, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_MustCommit, addr 0x30678f8, size 0xc, virtual false, abstract: false, final false
inline void set_MustCommit(bool  value) ;

/// @brief Method set_disposed, addr 0x3067158, size 0xc, virtual false, abstract: false, final false
