...
// Dependencies UnityEngine.Color, UnityEngine.Matrix4x4, UnityEngine.UIElements.UIR.BMPAlloc, UnityEngine.UIElements.UIR.Implementation.ClipMethod, UnityEngine.UIElements.UIR.RenderDataDirtyTypes, UnityEngine.UIElements.UIR.RenderDataFlags
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
/// @brief Method AllocatesID, addr 0x306de1c, size 0x6c, virtual false, abstract: false, final false
static inline bool AllocatesID(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method InheritsID, addr 0x306de98, size 0x68, virtual false, abstract: false, final false
static inline bool InheritsID(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method get_isIgnoringDynamicColorHint, addr 0x306df00, size 0xc, virtual false, abstract: false, final false
inline bool get_isIgnoringDynamicColorHint() ;

/// @brief Method get_lastClosingOrLastCommand, addr 0x306de04, size 0x18, virtual false, abstract: false, final false
