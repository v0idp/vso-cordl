...
// Dependencies Unity.Collections.NativeArray`1<T>, UnityEngine.Matrix4x4, UnityEngine.UIElements.UIR.BMPAlloc, UnityEngine.UIElements.UIR.BitmapAllocator32, UnityEngine.UIElements.UIR.TextCoreSettings, UnityEngine.UIElements.UIR.Transform3x4, UnityEngine.Vector2Int, UnityEngine.Vector4
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
/// @brief Method AllocClipRect, addr 0x3071c0c, size 0x100, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::BMPAlloc AllocClipRect() ;

/// @brief Method AllocColor, addr 0x3071d74, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::BMPAlloc AllocColor() ;

/// @brief Method AllocOpacity, addr 0x3071d0c, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::BMPAlloc AllocOpacity() ;

/// @brief Method AllocTextCoreSettings, addr 0x3071ddc, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::BMPAlloc AllocTextCoreSettings(::UnityEngine::UIElements::UIR::TextCoreSettings  settings) ;

/// @brief Method AllocToConstantBufferIndex, addr 0x3070c48, size 0x60, virtual false, abstract: false, final false
static inline int32_t AllocToConstantBufferIndex(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method AllocToTexelCoord, addr 0x3070bf8, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method AllocTransform, addr 0x3071b0c, size 0x100, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::BMPAlloc AllocTransform() ;

/// @brief Method AtlasRectMatchesPage, addr 0x3070ca8, size 0x168, virtual false, abstract: false, final false
...
/// @brief Method ClipRectAllocToVertexData, addr 0x307224c, size 0x110, virtual false, abstract: false, final false
inline ::UnityEngine::Color32 ClipRectAllocToVertexData(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method ColorAllocToVertexData, addr 0x3072458, size 0xfc, virtual false, abstract: false, final false
inline ::UnityEngine::Color32 ColorAllocToVertexData(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method Construct, addr 0x3069fc4, size 0x27c, virtual false, abstract: false, final false
inline void Construct() ;

/// @brief Method Dispose, addr 0x306a7e8, size 0xa8, virtual false, abstract: false, final false
inline void Dispose() ;

/// @brief Method FreeClipRect, addr 0x3071edc, size 0x98, virtual false, abstract: false, final false
inline void FreeClipRect(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method FreeColor, addr 0x307200c, size 0x98, virtual false, abstract: false, final false
inline void FreeColor(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method FreeOpacity, addr 0x3071f74, size 0x98, virtual false, abstract: false, final false
inline void FreeOpacity(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method FreeTextCoreSettings, addr 0x30720a4, size 0x98, virtual false, abstract: false, final false
inline void FreeTextCoreSettings(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method FreeTransform, addr 0x3071e44, size 0x98, virtual false, abstract: false, final false
inline void FreeTransform(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method IssuePendingStorageChanges, addr 0x306b100, size 0x18, virtual false, abstract: false, final false
inline void IssuePendingStorageChanges() ;

/// @brief Method OpacityAllocToVertexData, addr 0x307235c, size 0xfc, virtual false, abstract: false, final false
inline ::UnityEngine::Color32 OpacityAllocToVertexData(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method ReallyCreateStorage, addr 0x3070e10, size 0x404, virtual false, abstract: false, final false
inline void ReallyCreateStorage() ;

/// @brief Method SetClipRectValue, addr 0x3071450, size 0x15c, virtual false, abstract: false, final false
inline void SetClipRectValue(::UnityEngine::UIElements::UIR::BMPAlloc  alloc, ::UnityEngine::Vector4  clipRect) ;

/// @brief Method SetColorValue, addr 0x30716ac, size 0x188, virtual false, abstract: false, final false
inline void SetColorValue(::UnityEngine::UIElements::UIR::BMPAlloc  alloc, ::UnityEngine::Color  color, bool  isEditorContext) ;

/// @brief Method SetOpacityValue, addr 0x30715ac, size 0x100, virtual false, abstract: false, final false
inline void SetOpacityValue(::UnityEngine::UIElements::UIR::BMPAlloc  alloc, float_t  opacity) ;

/// @brief Method SetTextCoreSettingValue, addr 0x3071834, size 0x2d8, virtual false, abstract: false, final false
...
/// @brief Method SetTransformValue, addr 0x3071214, size 0x23c, virtual false, abstract: false, final false
inline void SetTransformValue(::UnityEngine::UIElements::UIR::BMPAlloc  alloc, ::UnityEngine::Matrix4x4  xform) ;

/// @brief Method TextCoreSettingsToVertexData, addr 0x3072554, size 0xfc, virtual false, abstract: false, final false
inline ::UnityEngine::Color32 TextCoreSettingsToVertexData(::UnityEngine::UIElements::UIR::BMPAlloc  alloc) ;

/// @brief Method TransformAllocToVertexData, addr 0x307213c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method get_atlas, addr 0x306b520, size 0x90, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_atlas() ;

/// @brief Method get_clipRectConstants, addr 0x306b5f8, size 0x48, virtual false, abstract: false, final false
inline ::Unity::Collections::NativeSlice_1<::UnityEngine::Vector4> get_clipRectConstants() ;

/// @brief Method get_pageHeight, addr 0x3070bf0, size 0x8, virtual false, abstract: false, final false
static inline int32_t get_pageHeight() ;

/// @brief Method get_pageWidth, addr 0x3070be8, size 0x8, virtual false, abstract: false, final false
static inline int32_t get_pageWidth() ;

/// @brief Method get_transformConstants, addr 0x306b5b0, size 0x48, virtual false, abstract: false, final false
