...
public:
// Declarations
/// @brief Method CreateBlock, addr 0x307a9b8, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method ResetBlock, addr 0x307aa50, size 0x4, virtual false, abstract: false, final false
static inline void ResetBlock(::UnityEngine::UIElements::UIR::BestFitAllocator_Block*  block) ;

/// @brief Method .ctor, addr 0x307a284, size 0xec, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x307aa08, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_size, addr 0x307a55c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Allocate, addr 0x307a380, size 0x198, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t  size) ;

/// @brief Method BestFitFindAvailableBlock, addr 0x307a518, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::BestFitAllocator_Block* BestFitFindAvailableBlock(uint32_t  size) ;

/// @brief Method CoalesceBlockWithPrevious, addr 0x307a8b0, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method Free, addr 0x307a654, size 0x25c, virtual false, abstract: false, final false
...
/// @brief Method SplitBlock, addr 0x307a568, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x307a1e0, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(uint32_t  size) ;

/// @brief Method get_highWatermark, addr 0x307a378, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_highWatermark() ;

/// @brief Method get_totalSize, addr 0x307a370, size 0x8, virtual false, abstract: false, final false
