...
public:
// Declarations
/// @brief Method Dispose, addr 0x30751c4, size 0x2c, virtual false, abstract: false, final false
inline void Dispose() ;
...
constexpr UIRenderDevice_EvaluationState(::UnityEngine::MaterialPropertyBlock*  stateMatProps, ::UnityW<::UnityEngine::Material>  defaultMat, ::UnityEngine::UIElements::UIR::State  curState, ::UnityEngine::UIElements::UIR::Page*  curPage, bool  mustApplyMaterial, bool  mustApplyCommonBlock, bool  mustApplyStateBlock, bool  mustApplyStencil) noexcept;
...
constexpr UIRenderDevice_DrawStatistics(int32_t  currentFrameIndex, uint32_t  totalIndices, uint32_t  commandCount, uint32_t  drawCommandCount, uint32_t  materialSetCount, uint32_t  drawRangeCount, uint32_t  drawRangeCallCount, uint32_t  immediateDraws, uint32_t  stencilRefChanges) noexcept;
...
/// @brief Method <.ctor>b__50_0, addr 0x307a18c, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::MeshHandle* __ctor_b__50_0() ;

/// @brief Method <.ctor>b__50_1, addr 0x307a1dc, size 0x4, virtual false, abstract: false, final false
inline void __ctor_b__50_1(::UnityEngine::UIElements::UIR::MeshHandle*  mh) ;

/// @brief Method .ctor, addr 0x307a184, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ActiveUpdatesForMeshHandle, addr 0x30767c0, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method AdvanceFrame, addr 0x3077530, size 0x9a4, virtual false, abstract: false, final false
inline void AdvanceFrame() ;

/// @brief Method Allocate, addr 0x3075594, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method Allocate, addr 0x3075654, size 0x620, virtual false, abstract: false, final false
...
/// @brief Method ApplyBatchState, addr 0x3078070, size 0x194, virtual false, abstract: false, final false
inline void ApplyBatchState(::ByRef<::UnityEngine::UIElements::UIR::UIRenderDevice_EvaluationState>  st, bool  allowMaterialChange) ;

/// @brief Method ApplyDrawCommandState, addr 0x3077ed4, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method CompleteCreation, addr 0x3074e54, size 0x194, virtual false, abstract: false, final false
inline void CompleteCreation() ;

/// @brief Method Dispose, addr 0x307500c, size 0x6c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x3075078, size 0x14c, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method DrawRanges, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename I,typename T>
inline void DrawRanges(::UnityEngine::UIElements::UIR::Utility_GPUBuffer_1<I>*  ib, ::UnityEngine::UIElements::UIR::Utility_GPUBuffer_1<T>*  vb, ::Unity::Collections::NativeSlice_1<::UnityEngine::UIElements::UIR::DrawBufferRange>  ranges) ;

/// @brief Method EvaluateChain, addr 0x3078204, size 0xa9c, virtual false, abstract: false, final false
...
/// @brief Method FlushAllPendingDeviceDisposes, addr 0x3079ff0, size 0x78, virtual false, abstract: false, final false
static inline void FlushAllPendingDeviceDisposes() ;

/// @brief Method Free, addr 0x3076c80, size 0x80c, virtual false, abstract: false, final false
inline void Free(::UnityEngine::UIElements::UIR::MeshHandle*  mesh) ;

/// @brief Method GatherDrawStatistics, addr 0x307a068, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::UIRenderDevice_DrawStatistics GatherDrawStatistics() ;

/// @brief Method InitVertexDeclaration, addr 0x3074bb8, size 0x29c, virtual false, abstract: false, final false
inline void InitVertexDeclaration() ;

/// @brief Method KickRanges, addr 0x3078e68, size 0x248, virtual false, abstract: false, final false
...
/// @brief Method OnEngineUpdateGlobal, addr 0x307a080, size 0x4c, virtual false, abstract: false, final false
static inline void OnEngineUpdateGlobal() ;

/// @brief Method OnFlushPendingResources, addr 0x307a0cc, size 0x5c, virtual false, abstract: false, final false
static inline void OnFlushPendingResources() ;

/// @brief Method OnFrameRenderingBegin, addr 0x307748c, size 0xa4, virtual false, abstract: false, final false
inline void OnFrameRenderingBegin() ;

/// @brief Method PrepareForGfxDeviceRecreate, addr 0x3079e08, size 0x188, virtual false, abstract: false, final false
static inline void PrepareForGfxDeviceRecreate() ;

/// @brief Method ProcessDeviceFreeQueue, addr 0x30751f0, size 0x3a4, virtual false, abstract: false, final false
static inline void ProcessDeviceFreeQueue() ;

/// @brief Method PruneUnusedPages, addr 0x3079cc0, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method TryAllocFromPage, addr 0x3076834, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x3076524, size 0x198, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x3075c74, size 0x1c8, virtual false, abstract: false, final false
...
/// @brief Method UpdateAfterGPUUsedData, addr 0x3075e3c, size 0x6e8, virtual false, abstract: false, final false
...
/// @brief Method UpdateCopyBackIndices, addr 0x30766bc, size 0x104, virtual false, abstract: false, final false
inline void UpdateCopyBackIndices(::UnityEngine::UIElements::UIR::MeshHandle*  mesh, bool  copyBackIndices) ;

/// @brief Method UpdateFenceValue, addr 0x3079b70, size 0xc8, virtual false, abstract: false, final false
inline void UpdateFenceValue() ;

/// @brief Method WaitOnCpuFence, addr 0x3079c38, size 0x88, virtual false, abstract: false, final false
inline void WaitOnCpuFence(uint32_t  fence) ;

/// @brief Method WrapUpGfxDeviceRecreate, addr 0x3079f90, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3073aa4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint32_t  initialVertexCapacity, uint32_t  initialIndexCapacity) ;

/// @brief Method .ctor, addr 0x3073aac, size 0x590, virtual false, abstract: false, final false
...
/// @brief Method get_breakBatches, addr 0x307376c, size 0x8, virtual false, abstract: false, final false
inline bool get_breakBatches() ;

/// @brief Method get_defaultShaderInfoTexARGB8, addr 0x3074534, size 0x2cc, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Texture2D> get_defaultShaderInfoTexARGB8() ;

/// @brief Method get_defaultShaderInfoTexFloat, addr 0x30741a0, size 0x394, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Texture2D> get_defaultShaderInfoTexFloat() ;

/// @brief Method get_disposed, addr 0x3074ff8, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_fullyCreated, addr 0x3074fe8, size 0x10, virtual false, abstract: false, final false
inline bool get_fullyCreated() ;

/// @brief Method get_maxVerticesPerPage, addr 0x3073764, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_maxVerticesPerPage() ;

/// @brief Method get_shaderModelIs35, addr 0x30749dc, size 0x1dc, virtual false, abstract: false, final false
static inline bool get_shaderModelIs35() ;

/// @brief Method get_vertexTexturingIsAvailable, addr 0x3074800, size 0x1dc, virtual false, abstract: false, final false
...
/// @brief Method set_breakBatches, addr 0x3073774, size 0xc, virtual false, abstract: false, final false
inline void set_breakBatches(bool  value) ;

/// @brief Method set_disposed, addr 0x3075000, size 0xc, virtual false, abstract: false, final false
