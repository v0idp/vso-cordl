...
/// @brief Method Allocate, addr 0x3076938, size 0x12c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t  size, bool  shortLived) ;

/// @brief Method Free, addr 0x3076a64, size 0x84, virtual false, abstract: false, final false
inline void Free(::UnityEngine::UIElements::UIR::Alloc  alloc) ;

/// @brief Method HighLowCollide, addr 0x307aadc, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x307aa54, size 0x88, virtual false, abstract: false, final false
inline void _ctor(uint32_t  maxSize) ;

/// @brief Method get_isEmpty, addr 0x307ab14, size 0x3c, virtual false, abstract: false, final false
