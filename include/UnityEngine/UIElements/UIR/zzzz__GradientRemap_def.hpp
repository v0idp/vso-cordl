...
/// @brief Method Reset, addr 0x3072d58, size 0x68, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x3072cfc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
