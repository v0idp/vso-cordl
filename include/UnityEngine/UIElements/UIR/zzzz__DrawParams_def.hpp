...
/// @brief Method Reset, addr 0x3078ca0, size 0x1c8, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x307403c, size 0x164, virtual false, abstract: false, final false
inline void _ctor() ;
