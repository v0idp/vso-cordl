...
/// @brief Field RegisterIntermediateRenderers, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_RegisterIntermediateRenderers, put=setStaticF_RegisterIntermediateRenderers)) ::System::Action_1<::UnityW<::UnityEngine::Camera>>*  RegisterIntermediateRenderers;
...
/// @brief Method AllocateBuffer, addr 0x30654ec, size 0x54, virtual false, abstract: false, final false
static inline ::System::IntPtr AllocateBuffer(int32_t  elementCount, int32_t  elementStride, bool  vertexBuffer) ;

/// @brief Method CPUFencePassed, addr 0x3065b14, size 0x3c, virtual false, abstract: false, final false
static inline bool CPUFencePassed(uint32_t  fence) ;

/// @brief Method CreateStencilState, addr 0x30659c0, size 0x84, virtual false, abstract: false, final false
static inline ::System::IntPtr CreateStencilState(::UnityEngine::Rendering::StencilState  stencilState) ;

/// @brief Method CreateStencilState_Injected, addr 0x3065a44, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr CreateStencilState_Injected(::ByRef<::UnityEngine::Rendering::StencilState>  stencilState) ;

/// @brief Method DisableScissor, addr 0x3065998, size 0x28, virtual false, abstract: false, final false
static inline void DisableScissor() ;

/// @brief Method DrawRanges, addr 0x306582c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method FreeBuffer, addr 0x3065540, size 0x3c, virtual false, abstract: false, final false
static inline void FreeBuffer(::System::IntPtr  buffer) ;

/// @brief Method GetActiveViewport, addr 0x3065bb4, size 0x84, virtual false, abstract: false, final false
static inline ::UnityEngine::RectInt GetActiveViewport() ;

/// @brief Method GetActiveViewport_Injected, addr 0x3065c38, size 0x3c, virtual false, abstract: false, final false
static inline void GetActiveViewport_Injected(::ByRef<::UnityEngine::RectInt>  ret) ;

/// @brief Method GetUnityProjectionMatrix, addr 0x3065d00, size 0x9c, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 GetUnityProjectionMatrix() ;

/// @brief Method GetUnityProjectionMatrix_Injected, addr 0x3065d9c, size 0x3c, virtual false, abstract: false, final false
static inline void GetUnityProjectionMatrix_Injected(::ByRef<::UnityEngine::Matrix4x4>  ret) ;

/// @brief Method GetVertexDeclaration, addr 0x3065644, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method HasMappedBufferRange, addr 0x3065ac4, size 0x28, virtual false, abstract: false, final false
static inline bool HasMappedBufferRange() ;

/// @brief Method InsertCPUFence, addr 0x3065aec, size 0x28, virtual false, abstract: false, final false
static inline uint32_t InsertCPUFence() ;

/// @brief Method NotifyOfUIREvents, addr 0x3065cc4, size 0x3c, virtual false, abstract: false, final false
static inline void NotifyOfUIREvents(bool  subscribe) ;

/// @brief Method ProfileDrawChainBegin, addr 0x3065c74, size 0x28, virtual false, abstract: false, final false
static inline void ProfileDrawChainBegin() ;

/// @brief Method ProfileDrawChainEnd, addr 0x3065c9c, size 0x28, virtual false, abstract: false, final false
static inline void ProfileDrawChainEnd() ;

/// @brief Method RaiseEngineUpdate, addr 0x30651f4, size 0x94, virtual false, abstract: false, final false
static inline void RaiseEngineUpdate() ;

/// @brief Method RaiseFlushPendingResources, addr 0x3065288, size 0x74, virtual false, abstract: false, final false
static inline void RaiseFlushPendingResources() ;

/// @brief Method RaiseGraphicsResourcesRecreate, addr 0x3065178, size 0x7c, virtual false, abstract: false, final false
static inline void RaiseGraphicsResourcesRecreate(bool  recreate) ;

/// @brief Method RaiseRegisterIntermediateRenderers, addr 0x30652fc, size 0x7c, virtual false, abstract: false, final false
static inline void RaiseRegisterIntermediateRenderers(::UnityEngine::Camera*  camera) ;

/// @brief Method RaiseRenderNodeAdd, addr 0x3065378, size 0x7c, virtual false, abstract: false, final false
static inline void RaiseRenderNodeAdd(::System::IntPtr  userData) ;

/// @brief Method RaiseRenderNodeCleanup, addr 0x3065470, size 0x7c, virtual false, abstract: false, final false
static inline void RaiseRenderNodeCleanup(::System::IntPtr  userData) ;

/// @brief Method RaiseRenderNodeExecute, addr 0x30653f4, size 0x7c, virtual false, abstract: false, final false
static inline void RaiseRenderNodeExecute(::System::IntPtr  userData) ;

/// @brief Method RegisterIntermediateRenderer, addr 0x3065680, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method RegisterIntermediateRenderer_Injected, addr 0x306576c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method SetPropertyBlock, addr 0x30658a0, size 0x3c, virtual false, abstract: false, final false
static inline void SetPropertyBlock(::UnityEngine::MaterialPropertyBlock*  props) ;

/// @brief Method SetScissorRect, addr 0x30658dc, size 0x80, virtual false, abstract: false, final false
static inline void SetScissorRect(::UnityEngine::RectInt  scissorRect) ;

/// @brief Method SetScissorRect_Injected, addr 0x306595c, size 0x3c, virtual false, abstract: false, final false
static inline void SetScissorRect_Injected(::ByRef<::UnityEngine::RectInt>  scissorRect) ;

/// @brief Method SetStencilState, addr 0x3065a80, size 0x44, virtual false, abstract: false, final false
static inline void SetStencilState(::System::IntPtr  stencilState, int32_t  stencilRef) ;

/// @brief Method SetVectorArray, addr 0x30655e8, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method SyncRenderThread, addr 0x3065b8c, size 0x28, virtual false, abstract: false, final false
static inline void SyncRenderThread() ;

/// @brief Method UpdateBufferRanges, addr 0x306557c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method WaitForCPUFencePassed, addr 0x3065b50, size 0x3c, virtual false, abstract: false, final false
static inline void WaitForCPUFencePassed(uint32_t  fence) ;

/// @brief Method add_EngineUpdate, addr 0x3064a38, size 0xdc, virtual false, abstract: false, final false
static inline void add_EngineUpdate(::System::Action*  value) ;

/// @brief Method add_FlushPendingResources, addr 0x3064bf0, size 0xdc, virtual false, abstract: false, final false
static inline void add_FlushPendingResources(::System::Action*  value) ;

/// @brief Method add_GraphicsResourcesRecreate, addr 0x3064858, size 0xf0, virtual false, abstract: false, final false
static inline void add_GraphicsResourcesRecreate(::System::Action_1<bool>*  value) ;

/// @brief Method add_RegisterIntermediateRenderers, addr 0x3064da8, size 0xf4, virtual false, abstract: false, final false
static inline void add_RegisterIntermediateRenderers(::System::Action_1<::UnityW<::UnityEngine::Camera>>*  value) ;

/// @brief Method add_RenderNodeExecute, addr 0x3064f90, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method remove_EngineUpdate, addr 0x3064b14, size 0xdc, virtual false, abstract: false, final false
static inline void remove_EngineUpdate(::System::Action*  value) ;

/// @brief Method remove_FlushPendingResources, addr 0x3064ccc, size 0xdc, virtual false, abstract: false, final false
static inline void remove_FlushPendingResources(::System::Action*  value) ;

/// @brief Method remove_GraphicsResourcesRecreate, addr 0x3064948, size 0xf0, virtual false, abstract: false, final false
static inline void remove_GraphicsResourcesRecreate(::System::Action_1<bool>*  value) ;

/// @brief Method remove_RegisterIntermediateRenderers, addr 0x3064e9c, size 0xf4, virtual false, abstract: false, final false
static inline void remove_RegisterIntermediateRenderers(::System::Action_1<::UnityW<::UnityEngine::Camera>>*  value) ;

/// @brief Method remove_RenderNodeExecute, addr 0x3065084, size 0xf4, virtual false, abstract: false, final false
