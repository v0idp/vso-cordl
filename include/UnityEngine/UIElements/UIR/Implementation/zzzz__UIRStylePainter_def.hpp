...
constexpr UIRStylePainter_Entry(::Unity::Collections::NativeSlice_1<::UnityEngine::UIElements::Vertex>  vertices, ::Unity::Collections::NativeSlice_1<uint16_t>  indices, ::UnityW<::UnityEngine::Material>  material, float_t  fontTexSDFScale, ::UnityEngine::UIElements::TextureId  texture, ::UnityEngine::UIElements::UIR::RenderChainCommand*  customCommand, ::UnityEngine::UIElements::UIR::BMPAlloc  clipRectID, ::UnityEngine::UIElements::UIR::VertexFlags  addFlags, bool  uvIsDisplacement, bool  isTextEntry, bool  isClipRegisterEntry, int32_t  stencilRef, int32_t  maskDepth) noexcept;
...
// Dependencies System.Object, UnityEngine.UIElements.IStylePainter, UnityEngine.UIElements.UIR.BMPAlloc, UnityEngine.UIElements.UIR.Implementation.UIRStylePainter::ClosingInfo, UnityEngine.UIElements.UIR.Implementation.UIRStylePainter::Entry
namespace UnityEngine::UIElements::UIR::Implementation {
// Is value type: false
...
/// @brief Field m_AllocRawVertsIndicesDelegate, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AllocRawVertsIndicesDelegate, put=__cordl_internal_set_m_AllocRawVertsIndicesDelegate)) ::UnityEngine::UIElements::UIR::AllocMeshData_MeshBuilder_Allocator*  m_AllocRawVertsIndicesDelegate;

/// @brief Field m_AllocThroughDrawMeshDelegate, offset 0x100, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_AllocThroughDrawMeshDelegate, put=__cordl_internal_set_m_AllocThroughDrawMeshDelegate)) ::UnityEngine::UIElements::UIR::AllocMeshData_MeshBuilder_Allocator*  m_AllocThroughDrawMeshDelegate;
...
/// @brief Field m_Entries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_Entries, put=__cordl_internal_set_m_Entries)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_Entry>*  m_Entries;
...
/// @brief Field m_RepeatRectUVList, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_RepeatRectUVList, put=__cordl_internal_set_m_RepeatRectUVList)) ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_RepeatRectUV>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_RepeatRectUV>*>*>  m_RepeatRectUVList;
...
/// @brief Method AdjustSpriteWinding, addr 0x3089900, size 0x320, virtual false, abstract: false, final false
...
/// @brief Method AllocRawVertsIndices, addr 0x30826ec, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method AllocThroughDrawMesh, addr 0x30827ac, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method ApplyInset, addr 0x3085178, size 0x21c, virtual false, abstract: false, final false
...
/// @brief Method ApplyVisualElementClipping, addr 0x3088a14, size 0x238, virtual false, abstract: false, final false
inline void ApplyVisualElementClipping() ;

/// @brief Method Begin, addr 0x3082f98, size 0x510, virtual false, abstract: false, final false
inline void Begin(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method BuildEntryFromNativeMesh, addr 0x3083770, size 0x458, virtual false, abstract: false, final false
...
/// @brief Method BuildGradientEntryFromNativeMesh, addr 0x3083bc8, size 0x3f4, virtual false, abstract: false, final false
...
/// @brief Method BuildRawEntryFromNativeMesh, addr 0x3083fbc, size 0x1e0, virtual false, abstract: false, final false
inline void BuildRawEntryFromNativeMesh(::UnityEngine::UIElements::MeshWriteDataInterface  meshData) ;

/// @brief Method DrawBorder, addr 0x3085394, size 0x90, virtual true, abstract: false, final true
inline void DrawBorder(::UnityEngine::UIElements::MeshGenerationContextUtils_BorderParams  borderParams) ;

/// @brief Method DrawImmediate, addr 0x3085424, size 0x168, virtual true, abstract: false, final true
inline void DrawImmediate(::System::Action*  callback, bool  cullingEnabled) ;

/// @brief Method DrawMesh, addr 0x30827c0, size 0x4a4, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::MeshWriteData* DrawMesh(int32_t  vertexCount, int32_t  indexCount, ::UnityEngine::Texture*  texture, ::UnityEngine::Material*  material, ::UnityEngine::UIElements::MeshGenerationContext_MeshFlags  flags) ;

/// @brief Method DrawRectangle, addr 0x3084824, size 0x22c, virtual true, abstract: false, final true
inline void DrawRectangle(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams  rectParams) ;

/// @brief Method DrawRectangleRepeat, addr 0x3086994, size 0x1454, virtual false, abstract: false, final false
...
/// @brief Method DrawSprite, addr 0x3084e14, size 0x364, virtual false, abstract: false, final false
inline void DrawSprite(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams  rectParams) ;

/// @brief Method DrawText, addr 0x308419c, size 0x98, virtual true, abstract: false, final true
inline void DrawText(::UnityEngine::UIElements::TextElement*  te) ;

/// @brief Method DrawTextInfo, addr 0x3084234, size 0x5f0, virtual false, abstract: false, final false
inline void DrawTextInfo(::UnityEngine::TextCore::Text::TextInfo*  textInfo, ::UnityEngine::Vector2  offset, bool  useHints) ;

/// @brief Method DrawVectorImage, addr 0x3084a50, size 0x3c4, virtual false, abstract: false, final false
inline void DrawVectorImage(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams  rectParams) ;

/// @brief Method DrawVisualElementBackground, addr 0x3085594, size 0x1400, virtual false, abstract: false, final false
inline void DrawVisualElementBackground() ;

/// @brief Method DrawVisualElementBorder, addr 0x30880dc, size 0x938, virtual false, abstract: false, final false
inline void DrawVisualElementBorder() ;

/// @brief Method GenerateStencilClipEntryForRoundedRectBackground, addr 0x3088fcc, size 0x934, virtual false, abstract: false, final false
inline void GenerateStencilClipEntryForRoundedRectBackground() ;

/// @brief Method GenerateStencilClipEntryForSVGBackground, addr 0x3088c4c, size 0x380, virtual false, abstract: false, final false
inline void GenerateStencilClipEntryForSVGBackground() ;

/// @brief Method GetPooledMeshWriteData, addr 0x30825dc, size 0x110, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MeshWriteData* GetPooledMeshWriteData() ;

/// @brief Method LandClipRegisterMesh, addr 0x308351c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method LandClipUnregisterMeshDrawCommand, addr 0x30834a8, size 0x74, virtual false, abstract: false, final false
inline void LandClipUnregisterMeshDrawCommand(::UnityEngine::UIElements::UIR::RenderChainCommand*  cmd) ;

/// @brief Method MakeVectorGraphics, addr 0x3089c20, size 0x3d0, virtual false, abstract: false, final false
inline void MakeVectorGraphics(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams  rectParams, bool  isUsingGradients, ::UnityEngine::UIElements::TextureId  svgTexture, int32_t  settingIndexOffset, ::ByRef<int32_t>  finalVertexCount, ::ByRef<int32_t>  finalIndexCount) ;
...
/// @brief Method Reset, addr 0x3089ff0, size 0x88, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method StampRectangleWithSubRect, addr 0x3087de8, size 0x2f4, virtual false, abstract: false, final false
inline void StampRectangleWithSubRect(::UnityEngine::UIElements::MeshGenerationContextUtils_RectangleParams  rectParams, ::UnityEngine::Rect  targetRect, ::UnityEngine::Rect  totalRect, ::UnityEngine::Rect  targetUV) ;

/// @brief Method TryAtlasTexture, addr 0x30835b8, size 0x1b8, virtual false, abstract: false, final false
inline void TryAtlasTexture(::UnityEngine::Texture*  texture, ::UnityEngine::UIElements::MeshGenerationContext_MeshFlags  flags, ::ByRef<::UnityEngine::Rect>  outUVRegion, ::ByRef<bool>  outIsAtlas, ::ByRef<::UnityEngine::UIElements::TextureId>  outTextureId, ::ByRef<::UnityEngine::UIElements::UIR::VertexFlags>  outAddFlags) ;

/// @brief Method ValidateMeshWriteData, addr 0x308a078, size 0x444, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_RepeatRectUV>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_RepeatRectUV>*>*> const& __cordl_internal_get_m_RepeatRectUVList() const;

constexpr ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_RepeatRectUV>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_RepeatRectUV>*>*>& __cordl_internal_get_m_RepeatRectUVList() ;
...
constexpr void __cordl_internal_set_m_RepeatRectUVList(::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_RepeatRectUV>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_RepeatRectUV>*>*>  value) ;
...
/// @brief Method .ctor, addr 0x3082c64, size 0x2d8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::UIR::RenderChain*  renderChain) ;

/// @brief Method get_closingInfo, addr 0x3082f5c, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_ClosingInfo get_closingInfo() ;

/// @brief Method get_currentElement, addr 0x3082f44, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_currentElement() ;

/// @brief Method get_entries, addr 0x3082f54, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_Entry>* get_entries() ;

/// @brief Method get_meshGenerationContext, addr 0x3082f3c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MeshGenerationContext* get_meshGenerationContext() ;

/// @brief Method get_totalIndices, addr 0x3082f88, size 0x8, virtual false, abstract: false, final false
inline int32_t get_totalIndices() ;

/// @brief Method get_totalVertices, addr 0x3082f78, size 0x8, virtual false, abstract: false, final false
inline int32_t get_totalVertices() ;

/// @brief Method get_visualElement, addr 0x308558c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_currentElement, addr 0x3082f4c, size 0x8, virtual false, abstract: false, final false
inline void set_currentElement(::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method set_totalIndices, addr 0x3082f90, size 0x8, virtual false, abstract: false, final false
inline void set_totalIndices(int32_t  value) ;

/// @brief Method set_totalVertices, addr 0x3082f80, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field m_RepeatRectUVList, offset: 0xf0, size: 0x8, def value: None
 ::ArrayW<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_RepeatRectUV>*,::Array<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::Implementation::UIRStylePainter_RepeatRectUV>*>*>  ___m_RepeatRectUVList;
