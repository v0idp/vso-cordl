...
/// @brief Method Blit, addr 0x307b0ec, size 0x16c, virtual false, abstract: false, final false
inline void Blit(::UnityEngine::Texture*  source, ::UnityEngine::RenderTexture*  destination, float_t  depth) ;

/// @brief Method CombineScissorRects, addr 0x307afe4, size 0x108, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect CombineScissorRects(::UnityEngine::Rect  r0, ::UnityEngine::Rect  r1) ;

/// @brief Method ExecuteNonDrawMesh, addr 0x30790b0, size 0xac0, virtual false, abstract: false, final false
...
/// @brief Method RectPointsToPixelsAndFlipYAxis, addr 0x307ac7c, size 0x368, virtual false, abstract: false, final false
static inline ::UnityEngine::RectInt RectPointsToPixelsAndFlipYAxis(::UnityEngine::Rect  rect, float_t  pixelsPerPoint) ;

/// @brief Method Reset, addr 0x307ac58, size 0x24, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x307b258, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
