...
/// @brief Method Reset, addr 0x3072ab4, size 0x10, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x3072a4c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
