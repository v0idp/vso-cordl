...
public:
// Declarations
/// @brief Method Invoke, addr 0x3069120, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3069094, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Allocate, addr 0x3068f38, size 0x28, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "alloc", ty: "::UnityEngine::UIElements::UIR::AllocMeshData_MeshBuilder_Allocator*", modifiers: "", def_value: None }, CppParam { name: "texture", ty: "::UnityW<::UnityEngine::Texture>", modifiers: "", def_value: None }, CppParam { name: "svgTexture", ty: "::UnityEngine::UIElements::TextureId", modifiers: "", def_value: None }, CppParam { name: "material", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "::UnityEngine::UIElements::MeshGenerationContext_MeshFlags", modifiers: "", def_value: None }, CppParam { name: "colorAlloc", ty: "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value: None }]
constexpr MeshBuilder_AllocMeshData(::UnityEngine::UIElements::UIR::AllocMeshData_MeshBuilder_Allocator*  alloc, ::UnityW<::UnityEngine::Texture>  texture, ::UnityEngine::UIElements::TextureId  svgTexture, ::UnityW<::UnityEngine::Material>  material, ::UnityEngine::UIElements::MeshGenerationContext_MeshFlags  flags, ::UnityEngine::UIElements::UIR::BMPAlloc  colorAlloc) noexcept;
...
/// @brief Method ConvertTextVertexToUIRVertex, addr 0x3068838, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method LimitTextVertices, addr 0x3068938, size 0x130, virtual false, abstract: false, final false
static inline int32_t LimitTextVertices(int32_t  vertexCount, bool  logTruncation) ;

/// @brief Method MakeText, addr 0x3068a68, size 0x4d0, virtual false, abstract: false, final false
static inline void MakeText(::UnityEngine::TextCore::Text::MeshInfo  meshInfo, ::UnityEngine::Vector2  offset, ::UnityEngine::UIElements::UIR::MeshBuilder_AllocMeshData  meshAlloc, ::UnityEngine::UIElements::UIR::VertexFlags  flags, bool  isDynamicColor) ;
