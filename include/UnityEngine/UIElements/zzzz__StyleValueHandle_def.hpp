...
/// @brief Method get_valueType, addr 0x3150e48, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::StyleValueType get_valueType() ;

/// @brief Method set_valueType, addr 0x3151904, size 0x8, virtual false, abstract: false, final false
