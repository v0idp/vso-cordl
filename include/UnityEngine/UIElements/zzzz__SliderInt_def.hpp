...
/// @brief Method .ctor, addr 0x30ceaec, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x30ceb34, size 0x2c0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30cedf4, size 0x228, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x30ce080, size 0x1cc, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, int32_t  startValue) ;

/// @brief Method ComputeValueAndDirectionFromClick, addr 0x30ce3d4, size 0x368, virtual true, abstract: false, final false
...
/// @brief Method ComputeValueFromKey, addr 0x30ce73c, size 0x2e0, virtual true, abstract: false, final false
...
/// @brief Method ParseStringToValue, addr 0x30ce354, size 0x80, virtual true, abstract: false, final false
inline int32_t ParseStringToValue(::StringW  previousValue, ::StringW  newValue) ;

/// @brief Method SliderLerpUnclamped, addr 0x30ce24c, size 0xec, virtual true, abstract: false, final false
inline int32_t SliderLerpUnclamped(int32_t  a, int32_t  b, float_t  interpolant) ;

/// @brief Method SliderNormalizeValue, addr 0x30ce338, size 0x1c, virtual true, abstract: false, final false
inline float_t SliderNormalizeValue(int32_t  currentValue, int32_t  lowerValue, int32_t  higherValue) ;

/// @brief Method .ctor, addr 0x30cddbc, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x30cddd4, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method get_pageSize, addr 0x30cdf20, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method set_pageSize, addr 0x30cdf68, size 0x118, virtual true, abstract: false, final false
