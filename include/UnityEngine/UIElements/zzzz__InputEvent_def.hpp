...
/// @brief Method <.cctor>b__0_0, addr 0x30ebef4, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::InputEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x30ebeec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPooled, addr 0x30ebd90, size 0x84, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::InputEvent* GetPooled(::StringW  previousData, ::StringW  newData) ;

/// @brief Method Init, addr 0x30ebd28, size 0x58, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x30ebd80, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30ebe14, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_newData, addr 0x30ebd20, size 0x8, virtual false, abstract: false, final false
inline void set_newData(::StringW  value) ;

/// @brief Method set_previousData, addr 0x30ebd18, size 0x8, virtual false, abstract: false, final false
