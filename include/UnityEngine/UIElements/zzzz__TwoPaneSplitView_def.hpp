...
/// @brief Method .ctor, addr 0x30d2e38, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x30d2e80, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30d2fec, size 0x144, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field m_CollapseChildCalledBeforeSetupComplete, offset 0x401, size 0x1 
 __declspec(property(get=__cordl_internal_get_m_CollapseChildCalledBeforeSetupComplete, put=__cordl_internal_set_m_CollapseChildCalledBeforeSetupComplete)) bool  m_CollapseChildCalledBeforeSetupComplete;
...
/// @brief Field m_CollapsedChildIndex, offset 0x404, size 0x4 
...
/// @brief Method CollapseChild, addr 0x30cfc48, size 0x5ec, virtual false, abstract: false, final false
inline void CollapseChild(int32_t  index) ;

/// @brief Method IdentifyLeftAndRightPane, addr 0x30d1c68, size 0x74, virtual false, abstract: false, final false
inline void IdentifyLeftAndRightPane() ;

/// @brief Method Init, addr 0x30d0234, size 0x318, virtual false, abstract: false, final false
...
/// @brief Method OnAnchorPostDisplaySetup, addr 0x30d1b7c, size 0xec, virtual false, abstract: false, final false
inline void OnAnchorPostDisplaySetup(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnPostDisplaySetup, addr 0x30d1900, size 0x12c, virtual false, abstract: false, final false
inline void OnPostDisplaySetup(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnSizeChange, addr 0x30d1dac, size 0xc, virtual false, abstract: false, final false
inline void OnSizeChange(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnViewDataReady, addr 0x30d2c60, size 0x3c, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method PostDisplaySetup, addr 0x30d054c, size 0x13b4, virtual false, abstract: false, final false
inline void PostDisplaySetup() ;

/// @brief Method ReplacePanesBasedOnAnchor, addr 0x30d1a2c, size 0x150, virtual false, abstract: false, final false
inline void ReplacePanesBasedOnAnchor() ;

/// @brief Method SetDragLineOffset, addr 0x30d2a08, size 0x128, virtual false, abstract: false, final false
inline void SetDragLineOffset(float_t  offset) ;

/// @brief Method SetFixedPaneDimension, addr 0x30d2b30, size 0x128, virtual false, abstract: false, final false
inline void SetFixedPaneDimension(float_t  dimension) ;

/// @brief Method UpdateLayout, addr 0x30d1db8, size 0xc50, virtual false, abstract: false, final false
inline void UpdateLayout(bool  updateFixedPane, bool  updateDragLine) ;

constexpr bool const& __cordl_internal_get_m_CollapseChildCalledBeforeSetupComplete() const;

constexpr bool& __cordl_internal_get_m_CollapseChildCalledBeforeSetupComplete() ;
...
constexpr void __cordl_internal_set_m_CollapseChildCalledBeforeSetupComplete(bool  value) ;
...
/// @brief Method .ctor, addr 0x30cfa38, size 0x210, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_contentContainer, addr 0x30d2c58, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_contentContainer() ;

/// @brief Method get_dragLine, addr 0x30cf9d4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_dragLine() ;

/// @brief Method get_fixedPane, addr 0x30cf9c4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_fixedPane() ;

/// @brief Method get_fixedPaneDimension, addr 0x30cf9ec, size 0x30, virtual false, abstract: false, final false
inline float_t get_fixedPaneDimension() ;

/// @brief Method get_fixedPaneIndex, addr 0x30cf9dc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_fixedPaneIndex() ;

/// @brief Method get_flexedPane, addr 0x30cf9cc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_flexedPane() ;

/// @brief Method get_orientation, addr 0x30cf9e4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_fixedPaneDimension, addr 0x30cfa1c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Field m_CollapseChildCalledBeforeSetupComplete, offset: 0x401, size: 0x1, def value: None
 bool  ___m_CollapseChildCalledBeforeSetupComplete;

/// @brief Field m_CollapsedChildIndex, offset: 0x404, size: 0x4, def value: None
...
static_assert(offsetof(::UnityEngine::UIElements::TwoPaneSplitView, ___m_CollapseChildCalledBeforeSetupComplete) == 0x401, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::TwoPaneSplitView, ___m_CollapsedChildIndex) == 0x404, "Offset mismatch!");
