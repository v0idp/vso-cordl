...
/// @brief Method <.cctor>b__0_0, addr 0x30f6fd4, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::PointerEnterEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x30f6fcc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x30f6ebc, size 0x54, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x30f6f10, size 0xc, virtual false, abstract: false, final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::PointerEnterEvent* New_ctor() ;

/// @brief Method .ctor, addr 0x30f6f1c, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;
