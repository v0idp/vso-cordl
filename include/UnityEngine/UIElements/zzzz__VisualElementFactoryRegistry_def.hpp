...
/// @brief Method GetMovedUIControlTypeName, addr 0x30562e0, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method RegisterEngineFactories, addr 0x3056520, size 0x10c8, virtual false, abstract: false, final false
static inline void RegisterEngineFactories() ;

/// @brief Method RegisterFactory, addr 0x30578b8, size 0x5d0, virtual false, abstract: false, final false
static inline void RegisterFactory(::UnityEngine::UIElements::IUxmlFactory*  factory) ;

/// @brief Method RegisterUserFactories, addr 0x30575e8, size 0x2d0, virtual false, abstract: false, final false
static inline void RegisterUserFactories() ;

/// @brief Method TryGetValue, addr 0x3057e88, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method get_factories, addr 0x3056440, size 0xe0, virtual false, abstract: false, final false
