...
/// @brief Field Default, offset 0xffffffff, size 0x20 
 ...
 __declspec(property(get=get_attributeOverrides, put=set_attributeOverrides)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset_AttributeOverride>*  attributeOverrides;
...
/// @brief Method Equals, addr 0x305c01c, size 0xb8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x305c0d4, size 0x158, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::CreationContext  other) ;

/// @brief Method GetHashCode, addr 0x305c22c, size 0x128, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x3059a48, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3058d34, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_attributeOverrides, addr 0x305c00c, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset_AttributeOverride>* get_attributeOverrides() ;

/// @brief Method get_slotInsertionPoints, addr 0x305bffc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::VisualElement*>* get_slotInsertionPoints() ;

/// @brief Method get_target, addr 0x305bfdc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_target() ;

/// @brief Method get_visualTreeAsset, addr 0x305bfec, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_attributeOverrides, addr 0x305c014, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_slotInsertionPoints, addr 0x305c004, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_target, addr 0x305bfe4, size 0x8, virtual false, abstract: false, final false
inline void set_target(::UnityEngine::UIElements::VisualElement*  value) ;

/// @brief Method set_visualTreeAsset, addr 0x305bff4, size 0x8, virtual false, abstract: false, final false
