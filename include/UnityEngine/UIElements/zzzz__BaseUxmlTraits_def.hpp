...
/// @brief Method .ctor, addr 0x3055048, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_canHaveAnyAttribute, addr 0x3055068, size 0xc, virtual false, abstract: false, final false
