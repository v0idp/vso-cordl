...
/// @brief Method .ctor, addr 0x30fb0b8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_activeFilters, addr 0x30fb010, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::DynamicAtlasFilters get_activeFilters() ;

/// @brief Method get_customFilter, addr 0x30fb028, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::DynamicAtlasCustomFilter* get_customFilter() ;

/// @brief Method get_defaultFilters, addr 0x30fb020, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::DynamicAtlasFilters get_defaultFilters() ;

/// @brief Method get_defaults, addr 0x30fb038, size 0x80, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::DynamicAtlasSettings* get_defaults() ;

/// @brief Method get_maxAtlasSize, addr 0x30faff0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxAtlasSize() ;

/// @brief Method get_maxSubTextureSize, addr 0x30fb000, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxSubTextureSize() ;

/// @brief Method get_minAtlasSize, addr 0x30fafe0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_minAtlasSize() ;

/// @brief Method set_activeFilters, addr 0x30fb018, size 0x8, virtual false, abstract: false, final false
inline void set_activeFilters(::UnityEngine::UIElements::DynamicAtlasFilters  value) ;

/// @brief Method set_customFilter, addr 0x30fb030, size 0x8, virtual false, abstract: false, final false
inline void set_customFilter(::UnityEngine::UIElements::DynamicAtlasCustomFilter*  value) ;

/// @brief Method set_maxAtlasSize, addr 0x30faff8, size 0x8, virtual false, abstract: false, final false
inline void set_maxAtlasSize(int32_t  value) ;

/// @brief Method set_maxSubTextureSize, addr 0x30fb008, size 0x8, virtual false, abstract: false, final false
inline void set_maxSubTextureSize(int32_t  value) ;

/// @brief Method set_minAtlasSize, addr 0x30fafe8, size 0x8, virtual false, abstract: false, final false
