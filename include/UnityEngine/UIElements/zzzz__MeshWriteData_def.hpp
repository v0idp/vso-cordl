...
/// @brief Method Reset, addr 0x3126f28, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x3126f44, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method SetAllIndices, addr 0x3126e54, size 0xd4, virtual false, abstract: false, final false
inline void SetAllIndices(::ArrayW<uint16_t,::Array<uint16_t>*>  indices) ;

/// @brief Method SetAllVertices, addr 0x3126d80, size 0xd4, virtual false, abstract: false, final false
inline void SetAllVertices(::ArrayW<::UnityEngine::UIElements::Vertex,::Array<::UnityEngine::UIElements::Vertex>*>  vertices) ;

/// @brief Method SetNextIndex, addr 0x3126d1c, size 0x64, virtual false, abstract: false, final false
inline void SetNextIndex(uint16_t  index) ;

/// @brief Method SetNextVertex, addr 0x3126c94, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3126bf0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_indexCount, addr 0x3126c40, size 0x48, virtual false, abstract: false, final false
inline int32_t get_indexCount() ;

/// @brief Method get_uvRegion, addr 0x3126c88, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_uvRegion() ;

/// @brief Method get_vertexCount, addr 0x3126bf8, size 0x48, virtual false, abstract: false, final false
