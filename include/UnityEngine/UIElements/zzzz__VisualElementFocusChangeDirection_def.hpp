...
/// @brief Method .ctor, addr 0x305d7b4, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method get_left, addr 0x305d704, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::FocusChangeDirection* get_left() ;

/// @brief Method get_right, addr 0x305d75c, size 0x58, virtual false, abstract: false, final false
