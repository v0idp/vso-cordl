...
/// @brief Method ExecuteDefaultActionAtTarget, addr 0x3154b04, size 0x24c, virtual false, abstract: false, final false
inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HasFocus, addr 0x3154ae8, size 0x1c, virtual false, abstract: false, final false
inline bool HasFocus() ;

/// @brief Method HasSelection, addr 0x3154958, size 0x1c, virtual false, abstract: false, final false
inline bool HasSelection() ;

/// @brief Method MoveDistanceQualifiesForDrag, addr 0x3155a6c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method OnBlurEvent, addr 0x3154fa4, size 0xc0, virtual false, abstract: false, final false
inline void OnBlurEvent(::UnityEngine::UIElements::BlurEvent*  evt) ;

/// @brief Method OnCursorIndexChange, addr 0x3154974, size 0x158, virtual false, abstract: false, final false
inline void OnCursorIndexChange() ;

/// @brief Method OnExecuteCommandEvent, addr 0x3155950, size 0x11c, virtual false, abstract: false, final false
inline void OnExecuteCommandEvent(::UnityEngine::UIElements::ExecuteCommandEvent*  evt) ;

/// @brief Method OnFocusEvent, addr 0x3154d50, size 0x254, virtual false, abstract: false, final false
inline void OnFocusEvent(::UnityEngine::UIElements::FocusEvent*  evt) ;

/// @brief Method OnKeyDown, addr 0x3155470, size 0x74, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  evt) ;

/// @brief Method OnPointerDownEvent, addr 0x3155064, size 0x40c, virtual false, abstract: false, final false
inline void OnPointerDownEvent(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMoveEvent, addr 0x31554e4, size 0x22c, virtual false, abstract: false, final false
inline void OnPointerMoveEvent(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUpEvent, addr 0x3155710, size 0xbc, virtual false, abstract: false, final false
inline void OnPointerUpEvent(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnRevealCursor, addr 0x31547e0, size 0x20, virtual false, abstract: false, final false
inline void OnRevealCursor() ;

/// @brief Method OnSelectIndexChange, addr 0x3154800, size 0x158, virtual false, abstract: false, final false
inline void OnSelectIndexChange() ;

/// @brief Method OnValidateCommandEvent, addr 0x31557cc, size 0x184, virtual false, abstract: false, final false
inline void OnValidateCommandEvent(::UnityEngine::UIElements::ValidateCommandEvent*  evt) ;

/// @brief Method RevealCursor, addr 0x3154acc, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x315454c, size 0x22c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TextElement*  textElement) ;

/// @brief Method get_cursorIndex, addr 0x3154778, size 0x18, virtual false, abstract: false, final false
inline int32_t get_cursorIndex() ;

/// @brief Method get_isClicking, addr 0x315452c, size 0x8, virtual false, abstract: false, final false
inline bool get_isClicking() ;

/// @brief Method get_selectIndex, addr 0x31547ac, size 0x18, virtual false, abstract: false, final false
inline int32_t get_selectIndex() ;

/// @brief Method set_cursorIndex, addr 0x3154790, size 0x1c, virtual false, abstract: false, final false
inline void set_cursorIndex(int32_t  value) ;

/// @brief Method set_isClicking, addr 0x3154534, size 0x18, virtual false, abstract: false, final false
inline void set_isClicking(bool  value) ;

/// @brief Method set_selectIndex, addr 0x31547c4, size 0x1c, virtual false, abstract: false, final false
