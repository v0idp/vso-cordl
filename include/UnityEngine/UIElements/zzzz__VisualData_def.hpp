...
// Dependencies System.IEquatable`1<T>, UnityEngine.Color, UnityEngine.UIElements.Background, UnityEngine.UIElements.BackgroundPosition, UnityEngine.UIElements.BackgroundRepeat, UnityEngine.UIElements.BackgroundSize, UnityEngine.UIElements.IStyleDataGroup`1<T>, UnityEngine.UIElements.Length, UnityEngine.UIElements.OverflowInternal
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Method Copy, addr 0x3146318, size 0x1c, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::VisualData Copy() ;

/// @brief Method CopyFrom, addr 0x3146334, size 0x14, virtual true, abstract: false, final true
inline void CopyFrom(::ByRef<::UnityEngine::UIElements::VisualData>  other) ;

/// @brief Method Equals, addr 0x3146688, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x314663c, size 0x4c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::VisualData  other) ;

/// @brief Method GetHashCode, addr 0x3146730, size 0x300, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x3146348, size 0x2f4, virtual false, abstract: false, final false
