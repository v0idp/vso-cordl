...
/// @brief Method DetachElement, addr 0x302af9c, size 0x1b4, virtual true, abstract: false, final false
inline void DetachElement() ;

/// @brief Method Indent, addr 0x3024aa8, size 0x14, virtual false, abstract: false, final false
inline void Indent(int32_t  depth) ;

/// @brief Method Init, addr 0x302ad1c, size 0xcc, virtual true, abstract: false, final false
inline void Init(::UnityEngine::UIElements::VisualElement*  item) ;

/// @brief Method InitExpandHierarchy, addr 0x302a730, size 0x4ac, virtual false, abstract: false, final false
...
/// @brief Method OnPointerUp, addr 0x302b49c, size 0x1c, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnToggleGeometryChanged, addr 0x302b284, size 0x218, virtual false, abstract: false, final false
inline void OnToggleGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnToggleValueChanged, addr 0x302b4b8, size 0x1c, virtual false, abstract: false, final false
inline void OnToggleValueChanged(::UnityEngine::UIElements::ChangeEvent_1<bool>*  evt) ;

/// @brief Method PreAttachElement, addr 0x302ade8, size 0x1b4, virtual true, abstract: false, final false
inline void PreAttachElement() ;

/// @brief Method SetExpandedWithoutNotify, addr 0x3024b70, size 0x20, virtual false, abstract: false, final false
inline void SetExpandedWithoutNotify(bool  expanded) ;

/// @brief Method SetToggleVisibility, addr 0x3024c38, size 0x18, virtual false, abstract: false, final false
inline void SetToggleVisibility(bool  visible) ;

/// @brief Method UpdateIndentLayout, addr 0x302b150, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x302abe0, size 0x124, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_onPointerUp, addr 0x3024f08, size 0xb0, virtual false, abstract: false, final false
inline void add_onPointerUp(::System::Action_1<::UnityEngine::UIElements::PointerUpEvent*>*  value) ;

/// @brief Method add_onToggleValueChanged, addr 0x3024fb8, size 0xb0, virtual false, abstract: false, final false
inline void add_onToggleValueChanged(::System::Action_1<::UnityEngine::UIElements::ChangeEvent_1<bool>*>*  value) ;

/// @brief Method get_rootElement, addr 0x302ad04, size 0x18, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_rootElement() ;

/// @brief Method remove_onPointerUp, addr 0x3024d7c, size 0xb0, virtual false, abstract: false, final false
inline void remove_onPointerUp(::System::Action_1<::UnityEngine::UIElements::PointerUpEvent*>*  value) ;

/// @brief Method remove_onToggleValueChanged, addr 0x3024e2c, size 0xb0, virtual false, abstract: false, final false
