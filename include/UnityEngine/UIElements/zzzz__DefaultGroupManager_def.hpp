...
/// @brief Method Init, addr 0x3100370, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method OnOptionSelectionChanged, addr 0x3100378, size 0x1d0, virtual true, abstract: false, final true
inline void OnOptionSelectionChanged(::UnityEngine::UIElements::IGroupBoxOption*  selectedOption) ;

/// @brief Method RegisterOption, addr 0x3100548, size 0x14c, virtual true, abstract: false, final true
inline void RegisterOption(::UnityEngine::UIElements::IGroupBoxOption*  option) ;

/// @brief Method UnregisterOption, addr 0x3100694, size 0xd4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x30ffbdc, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
