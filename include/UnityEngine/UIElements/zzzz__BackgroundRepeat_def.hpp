...
/// @brief Method Equals, addr 0x301c7a8, size 0x88, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x301c830, size 0x28, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::BackgroundRepeat  other) ;

/// @brief Method GetHashCode, addr 0x301c858, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Initial, addr 0x301c7a0, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::BackgroundRepeat Initial() ;

/// @brief Method ToString, addr 0x301c8c0, size 0xa0, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x301c2a0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x301c750, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x301c8a0, size 0x20, virtual false, abstract: false, final false
