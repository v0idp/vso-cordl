...
/// @brief Method DefaultMakeCellItem, addr 0x30be768, size 0x94, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::VisualElement* DefaultMakeCellItem() ;

/// @brief Method DestroyItem, addr 0x30bf0a8, size 0x468, virtual false, abstract: false, final false
inline void DestroyItem(::UnityEngine::UIElements::VisualElement*  element) ;

/// @brief Method Dispose, addr 0x30bf7c8, size 0x4fc, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method MakeItem, addr 0x30be7fc, size 0x48c, virtual false, abstract: false, final false
...
/// @brief Method OnColumnAdded, addr 0x30c053c, size 0x1c, virtual false, abstract: false, final false
inline void OnColumnAdded(::UnityEngine::UIElements::Column*  column, int32_t  index) ;

/// @brief Method OnColumnChanged, addr 0x30c05e4, size 0x38, virtual false, abstract: false, final false
inline void OnColumnChanged(::UnityEngine::UIElements::ColumnsDataType  type) ;

/// @brief Method OnColumnContainerGeometryChanged, addr 0x30c0128, size 0x8, virtual false, abstract: false, final false
inline void OnColumnContainerGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method OnColumnRemoved, addr 0x30c0558, size 0x1c, virtual false, abstract: false, final false
inline void OnColumnRemoved(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnColumnReordered, addr 0x30c0574, size 0x34, virtual false, abstract: false, final false
inline void OnColumnReordered(::UnityEngine::UIElements::Column*  column, int32_t  from, int32_t  to) ;

/// @brief Method OnColumnResized, addr 0x30c0168, size 0x3d4, virtual false, abstract: false, final false
inline void OnColumnResized(int32_t  index, float_t  width) ;

/// @brief Method OnColumnSortingChanged, addr 0x30c0130, size 0x1c, virtual false, abstract: false, final false
inline void OnColumnSortingChanged() ;

/// @brief Method OnColumnsChanged, addr 0x30c05a8, size 0x3c, virtual false, abstract: false, final false
inline void OnColumnsChanged(::UnityEngine::UIElements::Column*  column, ::UnityEngine::UIElements::ColumnDataType  type) ;

/// @brief Method OnContextMenuPopulateEvent, addr 0x30c014c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnHorizontalScrollerValueChanged, addr 0x30bfcc4, size 0x1c, virtual false, abstract: false, final false
inline void OnHorizontalScrollerValueChanged(float_t  v) ;

/// @brief Method OnViewDataRestored, addr 0x30c061c, size 0x1c, virtual false, abstract: false, final false
inline void OnViewDataRestored() ;

/// @brief Method OnViewportGeometryChanged, addr 0x30bfce0, size 0x2a0, virtual false, abstract: false, final false
inline void OnViewportGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method PrepareView, addr 0x30bf510, size 0x2b8, virtual false, abstract: false, final false
inline void PrepareView(::UnityEngine::UIElements::BaseVerticalCollectionView*  collectionView) ;

/// @brief Method UnbindCellItem, addr 0x30be72c, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method UnbindItem, addr 0x30bec88, size 0x420, virtual false, abstract: false, final false
inline void UnbindItem(::UnityEngine::UIElements::VisualElement*  element, int32_t  index) ;

/// @brief Method UpdateContentContainer, addr 0x30bff80, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30be32c, size 0x400, virtual false, abstract: false, final false
...
/// @brief Method add_columnSortingChanged, addr 0x30be08c, size 0x9c, virtual false, abstract: false, final false
inline void add_columnSortingChanged(::System::Action*  value) ;

/// @brief Method add_headerContextMenuPopulateEvent, addr 0x30be1c4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method get_header, addr 0x30be324, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Internal::MultiColumnCollectionHeader* get_header() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method remove_columnSortingChanged, addr 0x30be128, size 0x9c, virtual false, abstract: false, final false
inline void remove_columnSortingChanged(::System::Action*  value) ;

/// @brief Method remove_headerContextMenuPopulateEvent, addr 0x30be274, size 0xb0, virtual false, abstract: false, final false
