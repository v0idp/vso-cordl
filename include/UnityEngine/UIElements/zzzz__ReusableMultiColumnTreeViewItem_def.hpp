...
/// @brief Method Init, addr 0x30291d4, size 0x3dc, virtual false, abstract: false, final false
inline void Init(::UnityEngine::UIElements::VisualElement*  container, ::UnityEngine::UIElements::Columns*  columns) ;

/// @brief Method Init, addr 0x302a72c, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x302abdc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_rootElement, addr 0x302a724, size 0x8, virtual true, abstract: false, final false
