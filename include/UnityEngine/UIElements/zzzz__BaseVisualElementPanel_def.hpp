...
/// @brief Method ClearCachedElementUnderPointer, addr 0x30f63a0, size 0x28, virtual false, abstract: false, final false
inline void ClearCachedElementUnderPointer(int32_t  pointerId, ::UnityEngine::UIElements::EventBase*  triggerEvent) ;

/// @brief Method CommitElementUnderPointers, addr 0x3106044, size 0x5c, virtual false, abstract: false, final false
inline void CommitElementUnderPointers() ;

/// @brief Method Dispose, addr 0x3105c1c, size 0x70, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x3105c8c, size 0x140, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method GetTopElementUnderPointer, addr 0x30f456c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method InvokeAtlasChanged, addr 0x3106450, size 0x1c, virtual false, abstract: false, final false
inline void InvokeAtlasChanged() ;

/// @brief Method InvokeBeforeUpdate, addr 0x31065dc, size 0x20, virtual false, abstract: false, final false
inline void InvokeBeforeUpdate() ;

/// @brief Method InvokeHierarchyChanged, addr 0x31065c0, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method InvokeUpdateMaterial, addr 0x310646c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method RecomputeTopElementUnderPointer, addr 0x30f3308, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method SendEvent, addr 0x3105f6c, size 0xc4, virtual false, abstract: false, final false
inline void SendEvent(::UnityEngine::UIElements::EventBase*  e, ::UnityEngine::UIElements::DispatchMode  dispatchMode) ;

/// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionAdded, addr 0x31067f0, size 0x4, virtual true, abstract: false, final true
inline void UnityEngine_UIElements_IGroupBox_OnOptionAdded(::UnityEngine::UIElements::IGroupBoxOption*  option) ;

/// @brief Method UnityEngine.UIElements.IGroupBox.OnOptionRemoved, addr 0x31067f4, size 0x4, virtual true, abstract: false, final true
inline void UnityEngine_UIElements_IGroupBox_OnOptionRemoved(::UnityEngine::UIElements::IGroupBoxOption*  option) ;

/// @brief Method Update, addr 0x30fe4e0, size 0x108, virtual true, abstract: false, final false
inline void Update() ;
...
/// @brief Method UpdateElementUnderPointers, addr 0x31065fc, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3105af4, size 0x128, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_atlasChanged, addr 0x3106318, size 0x9c, virtual false, abstract: false, final false
inline void add_atlasChanged(::System::Action*  value) ;

/// @brief Method add_hierarchyChanged, addr 0x3106488, size 0x9c, virtual false, abstract: false, final false
inline void add_hierarchyChanged(::UnityEngine::UIElements::HierarchyEvent*  value) ;

/// @brief Method add_panelDisposed, addr 0x30ffc58, size 0xb0, virtual false, abstract: false, final false
inline void add_panelDisposed(::System::Action_1<::UnityEngine::UIElements::BaseVisualElementPanel*>*  value) ;

/// @brief Method add_standardShaderChanged, addr 0x31060a8, size 0x9c, virtual false, abstract: false, final false
inline void add_standardShaderChanged(::System::Action*  value) ;

/// @brief Method add_standardWorldSpaceShaderChanged, addr 0x31061e0, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method get_clearSettings, addr 0x3105f00, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method get_contextualMenuManager, addr 0x3105f5c, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::ContextualMenuManager* get_contextualMenuManager() ;

/// @brief Method get_cursorManager, addr 0x3105f4c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_disposed, addr 0x3106030, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_duringLayoutPhase, addr 0x3105f28, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_referenceSpritePixelsPerUnit, addr 0x3105ef0, size 0x8, virtual false, abstract: false, final false
inline float_t get_referenceSpritePixelsPerUnit() ;

/// @brief Method get_repaintData, addr 0x3105f3c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_scale, addr 0x3105dcc, size 0x8, virtual false, abstract: false, final false
inline float_t get_scale() ;

/// @brief Method get_scaledPixelsPerPoint, addr 0x3105dd4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_standardWorldSpaceShader, addr 0x31060a0, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method get_uiElementsBridge, addr 0x3105a98, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method remove_atlasChanged, addr 0x31063b4, size 0x9c, virtual false, abstract: false, final false
inline void remove_atlasChanged(::System::Action*  value) ;

/// @brief Method remove_hierarchyChanged, addr 0x3106524, size 0x9c, virtual false, abstract: false, final false
inline void remove_hierarchyChanged(::UnityEngine::UIElements::HierarchyEvent*  value) ;

/// @brief Method remove_panelDisposed, addr 0x30ffe90, size 0xb0, virtual false, abstract: false, final false
inline void remove_panelDisposed(::System::Action_1<::UnityEngine::UIElements::BaseVisualElementPanel*>*  value) ;

/// @brief Method remove_standardShaderChanged, addr 0x3106144, size 0x9c, virtual false, abstract: false, final false
inline void remove_standardShaderChanged(::System::Action*  value) ;

/// @brief Method remove_standardWorldSpaceShaderChanged, addr 0x310627c, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method set_clearSettings, addr 0x3105f14, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method set_contextualMenuManager, addr 0x3105f64, size 0x8, virtual false, abstract: false, final false
inline void set_contextualMenuManager(::UnityEngine::UIElements::ContextualMenuManager*  value) ;

/// @brief Method set_cursorManager, addr 0x3105f54, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_disposed, addr 0x3106038, size 0xc, virtual false, abstract: false, final false
inline void set_disposed(bool  value) ;

/// @brief Method set_duringLayoutPhase, addr 0x3105f30, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_pixelsPerPoint, addr 0x3105de4, size 0x10c, virtual false, abstract: false, final false
inline void set_pixelsPerPoint(float_t  value) ;

/// @brief Method set_referenceSpritePixelsPerUnit, addr 0x3105ef8, size 0x8, virtual false, abstract: false, final false
inline void set_referenceSpritePixelsPerUnit(float_t  value) ;

/// @brief Method set_repaintData, addr 0x3105f44, size 0x8, virtual true, abstract: false, final false
inline void set_repaintData(::UnityEngine::UIElements::RepaintData*  value) ;

/// @brief Method set_scale, addr 0x30fd4e4, size 0x10c, virtual false, abstract: false, final false
