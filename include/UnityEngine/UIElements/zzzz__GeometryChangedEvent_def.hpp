...
/// @brief Method <.cctor>b__0_0, addr 0x30ed508, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::GeometryChangedEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x30ed500, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPooled, addr 0x30ed2ac, size 0xc0, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::GeometryChangedEvent* GetPooled(::UnityEngine::Rect  oldRect, ::UnityEngine::Rect  newRect) ;

/// @brief Method Init, addr 0x30ed36c, size 0x50, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x30ed3bc, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30ed430, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_layoutPass, addr 0x30ed420, size 0x8, virtual false, abstract: false, final false
inline int32_t get_layoutPass() ;

/// @brief Method get_newRect, addr 0x30ed408, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_newRect() ;

/// @brief Method get_oldRect, addr 0x30ed3f0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_oldRect() ;

/// @brief Method set_layoutPass, addr 0x30ed428, size 0x8, virtual false, abstract: false, final false
inline void set_layoutPass(int32_t  value) ;

/// @brief Method set_newRect, addr 0x30ed414, size 0xc, virtual false, abstract: false, final false
inline void set_newRect(::UnityEngine::Rect  value) ;

/// @brief Method set_oldRect, addr 0x30ed3fc, size 0xc, virtual false, abstract: false, final false
