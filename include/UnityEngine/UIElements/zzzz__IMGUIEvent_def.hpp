...
/// @brief Method <.cctor>b__0_0, addr 0x30f8e90, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::IMGUIEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x30f8e88, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPooled, addr 0x30f8ccc, size 0x88, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::IMGUIEvent* GetPooled(::UnityEngine::Event*  systemEvent) ;

/// @brief Method Init, addr 0x30f8d54, size 0x54, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x30f8da8, size 0xc, virtual false, abstract: false, final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::IMGUIEvent* New_ctor() ;

/// @brief Method .ctor, addr 0x30f8db4, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;
