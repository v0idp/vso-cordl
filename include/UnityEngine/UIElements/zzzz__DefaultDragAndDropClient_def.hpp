...
/// @brief Method AcceptDrag, addr 0x30db544, size 0x4, virtual true, abstract: false, final true
inline void AcceptDrag() ;

/// @brief Method DragCleanup, addr 0x30db550, size 0x44, virtual true, abstract: false, final true
inline void DragCleanup() ;

/// @brief Method GetGenericData, addr 0x30dac94, size 0x64, virtual true, abstract: false, final false
inline ::System::Object* GetGenericData(::StringW  key) ;

static inline ::UnityEngine::UIElements::DefaultDragAndDropClient* New_ctor() ;

/// @brief Method SetVisualMode, addr 0x30db548, size 0x8, virtual true, abstract: false, final true
inline void SetVisualMode(::UnityEngine::UIElements::DragVisualMode  mode) ;

/// @brief Method StartDrag, addr 0x30dacf8, size 0x6b8, virtual true, abstract: false, final true
inline void StartDrag(::UnityEngine::UIElements::StartDragArgs  args, ::UnityEngine::Vector3  pointerPosition) ;

/// @brief Method UpdateDrag, addr 0x30db3b0, size 0x194, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x30dabe4, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_data, addr 0x30db594, size 0x4, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::DragAndDropData* get_data() ;

/// @brief Method get_source, addr 0x30dac44, size 0x50, virtual true, abstract: false, final false
