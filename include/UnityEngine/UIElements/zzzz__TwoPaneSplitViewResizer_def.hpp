...
/// @brief Method ApplyDelta, addr 0x30d3b54, size 0xb3c, virtual false, abstract: false, final false
inline void ApplyDelta(float_t  delta) ;

/// @brief Method InterruptPointerMove, addr 0x30d4a5c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method OnPointerDown, addr 0x30d4690, size 0xc8, virtual false, abstract: false, final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  e) ;

/// @brief Method OnPointerMove, addr 0x30d4758, size 0x304, virtual false, abstract: false, final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  e) ;

/// @brief Method OnPointerUp, addr 0x30d4ae4, size 0xac, virtual false, abstract: false, final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  e) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x30d37d4, size 0x1c0, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x30d3994, size 0x1c0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30d1cdc, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TwoPaneSplitView*  splitView, int32_t  dir) ;

/// @brief Method get_fixedPane, addr 0x30d314c, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_fixedPane() ;

/// @brief Method get_fixedPaneMargins, addr 0x30d3298, size 0x214, virtual false, abstract: false, final false
inline float_t get_fixedPaneMargins() ;

/// @brief Method get_fixedPaneMinDimension, addr 0x30d3184, size 0x114, virtual false, abstract: false, final false
inline float_t get_fixedPaneMinDimension() ;

/// @brief Method get_flexedPane, addr 0x30d3168, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElement* get_flexedPane() ;

/// @brief Method get_flexedPaneMargin, addr 0x30d35c0, size 0x214, virtual false, abstract: false, final false
inline float_t get_flexedPaneMargin() ;

/// @brief Method get_flexedPaneMinDimension, addr 0x30d34ac, size 0x114, virtual false, abstract: false, final false
inline float_t get_flexedPaneMinDimension() ;

/// @brief Method get_orientation, addr 0x30d3130, size 0x1c, virtual false, abstract: false, final false
