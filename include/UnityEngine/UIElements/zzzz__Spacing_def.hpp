...
/// @brief Method .ctor, addr 0x312bf98, size 0xc, virtual false, abstract: false, final false
inline void _ctor(float_t  left, float_t  top, float_t  right, float_t  bottom) ;

/// @brief Method get_horizontal, addr 0x312bf78, size 0x10, virtual false, abstract: false, final false
inline float_t get_horizontal() ;

/// @brief Method get_vertical, addr 0x312bf88, size 0x10, virtual false, abstract: false, final false
inline float_t get_vertical() ;

/// @brief Method op_Subtraction, addr 0x312bfa4, size 0x28, virtual false, abstract: false, final false
