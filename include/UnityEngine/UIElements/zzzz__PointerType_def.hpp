...
/// @brief Method GetPointerType, addr 0x30f4590, size 0xdc, virtual false, abstract: false, final false
static inline ::StringW GetPointerType(int32_t  pointerId) ;

/// @brief Method IsDirectManipulationDevice, addr 0x30f466c, size 0x8c, virtual false, abstract: false, final false
