...
/// @brief Method <.cctor>b__0_0, addr 0x30eed4c, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MouseUpEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x30eed44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPooled, addr 0x30eec94, size 0x54, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MouseUpEvent* GetPooled(::UnityEngine::UIElements::PointerCancelEvent*  pointerEvent) ;

/// @brief Method GetPooled, addr 0x30eec40, size 0x54, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MouseUpEvent* GetPooled(::UnityEngine::UIElements::PointerMoveEvent*  pointerEvent) ;

/// @brief Method GetPooled, addr 0x30eebec, size 0x54, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::MouseUpEvent* GetPooled(::UnityEngine::UIElements::PointerUpEvent*  pointerEvent) ;

/// @brief Method Init, addr 0x30ee9a8, size 0x54, virtual true, abstract: false, final false
inline void Init() ;

/// @brief Method LocalInit, addr 0x30ee9fc, size 0xc, virtual false, abstract: false, final false
inline void LocalInit() ;

/// @brief Method MakeFromPointerEvent, addr 0x30eea5c, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30eea08, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;
