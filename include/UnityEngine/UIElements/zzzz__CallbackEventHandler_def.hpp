...
/// @brief Method ExecuteDefaultAction, addr 0x30ea9ec, size 0x4, virtual true, abstract: false, final false
inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method ExecuteDefaultActionAtTarget, addr 0x30ea9e8, size 0x4, virtual true, abstract: false, final false
inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method ExecuteDefaultActionDisabled, addr 0x30ea9f4, size 0x4, virtual true, abstract: false, final false
inline void ExecuteDefaultActionDisabled(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method ExecuteDefaultActionDisabledAtTarget, addr 0x30ea9f0, size 0x4, virtual true, abstract: false, final false
inline void ExecuteDefaultActionDisabledAtTarget(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HandleEvent, addr 0x30ea6f8, size 0x2a0, virtual true, abstract: false, final false
inline void HandleEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HandleEventAtCurrentTargetAndPhase, addr 0x30ea6a0, size 0xc, virtual false, abstract: false, final false
inline void HandleEventAtCurrentTargetAndPhase(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HandleEventAtTargetAndDefaultPhase, addr 0x30ea6ac, size 0x40, virtual false, abstract: false, final false
inline void HandleEventAtTargetAndDefaultPhase(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HandleEventAtTargetPhase, addr 0x30ea634, size 0x6c, virtual false, abstract: false, final false
inline void HandleEventAtTargetPhase(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method HasBubbleUpHandlers, addr 0x30ea9c0, size 0x28, virtual true, abstract: false, final true
inline bool HasBubbleUpHandlers() ;

/// @brief Method HasTrickleDownHandlers, addr 0x30ea998, size 0x28, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.UIElements.IEventHandler.HandleEvent, addr 0x30ea6ec, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x30ea9f8, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
