...
/// @brief Method .ctor, addr 0x3041c5c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x3041ca4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x3041dc4, size 0x1ac, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x3041fbc, size 0xa8, virtual true, abstract: false, final false
inline float_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x3041f70, size 0x4c, virtual true, abstract: false, final false
inline ::StringW ValueToString(float_t  v) ;

/// @brief Method .ctor, addr 0x3041a78, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x3041d6c, size 0x58, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentFloatField, addr 0x3041cec, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x3041b30, size 0x5c, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, float_t  startValue) ;

/// @brief Method CanTryParse, addr 0x3041b0c, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x3041840, size 0xdc, virtual true, abstract: false, final false
inline float_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x3041788, size 0xb8, virtual true, abstract: false, final false
inline ::StringW ValueToString(float_t  v) ;

/// @brief Method .ctor, addr 0x304191c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3041928, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_floatInput, addr 0x3041704, size 0x84, virtual false, abstract: false, final false
