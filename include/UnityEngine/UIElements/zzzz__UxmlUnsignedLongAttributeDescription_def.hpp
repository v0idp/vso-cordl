...
/// @brief Method <GetValueFromBag>b__3_0, addr 0x30548a4, size 0x40, virtual false, abstract: false, final false
inline uint64_t _GetValueFromBag_b__3_0(::StringW  s, uint64_t  l) ;

/// @brief Method .ctor, addr 0x305489c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ConvertValueToUlong, addr 0x3054804, size 0x3c, virtual false, abstract: false, final false
static inline uint64_t ConvertValueToUlong(::StringW  v, uint64_t  defaultValue) ;

/// @brief Method GetValueFromBag, addr 0x30546b8, size 0x14c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3054620, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
