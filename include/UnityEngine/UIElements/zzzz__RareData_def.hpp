...
// Dependencies System.IEquatable`1<T>, UnityEngine.Color, UnityEngine.UIElements.Cursor, UnityEngine.UIElements.IStyleDataGroup`1<T>, UnityEngine.UIElements.OverflowClipBox, UnityEngine.UIElements.TextOverflow, UnityEngine.UIElements.TextOverflowPosition
namespace UnityEngine::UIElements {
// Is value type: true
...
/// @brief Method Copy, addr 0x31454b0, size 0x1c, virtual true, abstract: false, final true
inline ::UnityEngine::UIElements::RareData Copy() ;

/// @brief Method CopyFrom, addr 0x31454cc, size 0x14, virtual true, abstract: false, final true
inline void CopyFrom(::ByRef<::UnityEngine::UIElements::RareData>  other) ;

/// @brief Method Equals, addr 0x3145648, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x3145604, size 0x44, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::RareData  other) ;

/// @brief Method GetHashCode, addr 0x31456e8, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x31454e0, size 0x124, virtual false, abstract: false, final false
