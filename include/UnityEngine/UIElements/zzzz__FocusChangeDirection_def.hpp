...
/// @brief Method ApplyTo, addr 0x30f98d0, size 0x28, virtual true, abstract: false, final false
inline void ApplyTo(::UnityEngine::UIElements::FocusController*  focusController, ::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method Dispose, addr 0x30f98cc, size 0x4, virtual true, abstract: false, final false
inline void Dispose() ;

static inline ::UnityEngine::UIElements::FocusChangeDirection* New_ctor(int32_t  value) ;

/// @brief Method System.IDisposable.Dispose, addr 0x30f98c0, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x30f988c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_lastValue, addr 0x30f9834, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::FocusChangeDirection* get_lastValue() ;

/// @brief Method get_none, addr 0x30f97dc, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::FocusChangeDirection* get_none() ;

/// @brief Method get_unspecified, addr 0x30f9784, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::FocusChangeDirection* get_unspecified() ;

/// @brief Convert to "::System::IDisposable"
constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

/// @brief Method op_Implicit, addr 0x30f98b4, size 0xc, virtual false, abstract: false, final false
