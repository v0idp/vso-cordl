...
/// @brief Method .ctor, addr 0x30cf9b8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TreeItem  item, int32_t  depth) ;

/// @brief Method get_childrenIds, addr 0x30cf9ac, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* get_childrenIds() ;

/// @brief Method get_hasChildren, addr 0x30cf9b4, size 0x4, virtual false, abstract: false, final false
inline bool get_hasChildren() ;

/// @brief Method get_id, addr 0x30cf9a4, size 0x8, virtual false, abstract: false, final false
