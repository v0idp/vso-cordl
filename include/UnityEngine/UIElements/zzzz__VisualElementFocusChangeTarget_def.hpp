...
/// @brief Method <.cctor>b__9_0, addr 0x305dcc4, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::VisualElementFocusChangeTarget* __cctor_b__9_0() ;

/// @brief Method .ctor, addr 0x305dcbc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyTo, addr 0x305da64, size 0x3c, virtual true, abstract: false, final false
inline void ApplyTo(::UnityEngine::UIElements::FocusController*  focusController, ::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method Dispose, addr 0x305d9e0, size 0x84, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetPooled, addr 0x305d958, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x305daa0, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::UIElements::ObjectPool_1<::UnityEngine::UIElements::VisualElementFocusChangeTarget*>* getStaticF_Pool() ;

/// @brief Method get_target, addr 0x305db40, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_target, addr 0x305db48, size 0x8, virtual false, abstract: false, final false
