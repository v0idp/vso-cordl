...
/// @brief Method .ctor, addr 0x30c40a0, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Init, addr 0x30c40e8, size 0x11c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30c4204, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method InitLabel, addr 0x30c3c5c, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method OnOptionAttachToPanel, addr 0x30c3b84, size 0x6c, virtual false, abstract: false, final false
inline void OnOptionAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent*  evt) ;

/// @brief Method OnOptionDetachFromPanel, addr 0x30c3bf0, size 0x6c, virtual false, abstract: false, final false
inline void OnOptionDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent*  evt) ;

/// @brief Method SetValueWithoutNotify, addr 0x30c3d2c, size 0x20, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(bool  newValue) ;

/// @brief Method ToggleValue, addr 0x30c3cd8, size 0x40, virtual true, abstract: false, final false
inline void ToggleValue() ;

/// @brief Method UnityEngine.UIElements.IGroupBoxOption.SetSelected, addr 0x30c3d18, size 0x14, virtual true, abstract: false, final true
inline void UnityEngine_UIElements_IGroupBoxOption_SetSelected(bool  selected) ;

/// @brief Method UpdateCheckmark, addr 0x30c3808, size 0xf4, virtual false, abstract: false, final false
inline void UpdateCheckmark() ;

/// @brief Method UpdateMixedValueContent, addr 0x30c3d4c, size 0xa4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30c38fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x30c3904, size 0x280, virtual false, abstract: false, final false
...
/// @brief Method get_value, addr 0x30c36dc, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method set_value, addr 0x30c3724, size 0xe4, virtual true, abstract: false, final false
