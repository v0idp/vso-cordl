...
/// @brief Method .ctor, addr 0x30e22b0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CompareId, addr 0x30e22c0, size 0x644, virtual true, abstract: false, final false
inline int32_t CompareId(int32_t  id1, int32_t  id2) ;

/// @brief Method DelayExpandDropItem, addr 0x30e3814, size 0x21c, virtual false, abstract: false, final false
inline void DelayExpandDropItem() ;

/// @brief Method DragCleanup, addr 0x30e323c, size 0x148, virtual true, abstract: false, final false
inline void DragCleanup() ;

/// @brief Method ExpandDropItem, addr 0x30e3a30, size 0x1a4, virtual false, abstract: false, final false
inline void ExpandDropItem() ;

/// @brief Method HandleAutoExpand, addr 0x30e36e0, size 0x134, virtual true, abstract: false, final false
inline void HandleAutoExpand(::UnityEngine::UIElements::ReusableCollectionItem*  item, ::UnityEngine::Vector2  pointerPosition) ;

/// @brief Method HandleDragAndDrop, addr 0x30e29a8, size 0xe8, virtual true, abstract: false, final false
...
/// @brief Method OnDrop, addr 0x30e2a90, size 0x7ac, virtual true, abstract: false, final false
inline void OnDrop(::UnityEngine::UIElements::IListDragAndDropArgs*  args) ;

/// @brief Method RestoreExpanded, addr 0x30e3384, size 0x35c, virtual false, abstract: false, final false
inline void RestoreExpanded(::System::Collections::Generic::List_1<int32_t>*  ids) ;

/// @brief Method SetupDragAndDrop, addr 0x30e2904, size 0xa4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30e21e4, size 0xcc, virtual false, abstract: false, final false
