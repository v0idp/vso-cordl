...
/// @brief Method Equals, addr 0x31475ac, size 0xa0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x3147568, size 0x44, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::Rotate  other) ;

/// @brief Method GetHashCode, addr 0x3145c8c, size 0xd0, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Initial, addr 0x3147404, size 0xa0, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::Rotate Initial() ;

/// @brief Method None, addr 0x31474a4, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::Rotate None() ;

/// @brief Method ToQuaternion, addr 0x31476c0, size 0x24, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion ToQuaternion() ;

/// @brief Method ToString, addr 0x314764c, size 0x74, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x31473a4, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Angle  angle) ;

/// @brief Method get_angle, addr 0x3147504, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Angle get_angle() ;

/// @brief Method get_axis, addr 0x3147514, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x314599c, size 0x88, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::Rotate  lhs, ::UnityEngine::UIElements::Rotate  rhs) ;

/// @brief Method op_Inequality, addr 0x3147520, size 0x48, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::UIElements::Rotate  lhs, ::UnityEngine::UIElements::Rotate  rhs) ;

/// @brief Method set_angle, addr 0x314750c, size 0x8, virtual false, abstract: false, final false
