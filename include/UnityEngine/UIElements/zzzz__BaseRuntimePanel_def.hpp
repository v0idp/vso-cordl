...
/// @brief Method <.cctor>b__47_0, addr 0x31221e4, size 0x4, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 __cctor_b__47_0(::UnityEngine::Vector2  p) ;

/// @brief Method .ctor, addr 0x31221dc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AssignPanelToComponents, addr 0x3121148, size 0x334, virtual false, abstract: false, final false
inline void AssignPanelToComponents(::UnityEngine::UIElements::BaseRuntimePanel*  panel) ;

/// @brief Method Dispose, addr 0x31217d4, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method PointerEntersPanel, addr 0x3122010, size 0xa0, virtual false, abstract: false, final false
inline void PointerEntersPanel(int32_t  pointerId, ::UnityEngine::Vector2  position) ;

/// @brief Method PointerLeavesPanel, addr 0x3121f50, size 0xc0, virtual false, abstract: false, final false
inline void PointerLeavesPanel(int32_t  pointerId, ::UnityEngine::Vector2  position) ;

/// @brief Method Repaint, addr 0x3121b74, size 0x1e4, virtual true, abstract: false, final false
inline void Repaint(::UnityEngine::Event*  e) ;

/// @brief Method ScreenToPanel, addr 0x3121dd8, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 ScreenToPanel(::UnityEngine::Vector2  screen) ;

/// @brief Method ScreenToPanel, addr 0x3121e2c, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31216c0, size 0x114, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ScriptableObject*  ownerObject, ::UnityEngine::UIElements::EventDispatcher*  dispatcher) ;

/// @brief Method add_destroyed, addr 0x3121580, size 0xa0, virtual false, abstract: false, final false
inline void add_destroyed(::System::Action*  value) ;

/// @brief Method getScreenRenderingHeight, addr 0x3121ab4, size 0xc0, virtual false, abstract: false, final false
static inline int32_t getScreenRenderingHeight(int32_t  display) ;

/// @brief Method getScreenRenderingWidth, addr 0x312199c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_drawToCameras, addr 0x3121834, size 0x8, virtual false, abstract: false, final false
inline bool get_drawToCameras() ;

/// @brief Method get_screenRenderingHeight, addr 0x3121a5c, size 0x58, virtual false, abstract: false, final false
inline int32_t get_screenRenderingHeight() ;

/// @brief Method get_screenRenderingWidth, addr 0x3121944, size 0x58, virtual false, abstract: false, final false
inline int32_t get_screenRenderingWidth() ;

/// @brief Method get_screenToPanelSpace, addr 0x3121d58, size 0x8, virtual false, abstract: false, final false
inline ::System::Func_2<::UnityEngine::Vector2,::UnityEngine::Vector2>* get_screenToPanelSpace() ;

/// @brief Method get_selectableGameObject, addr 0x31210a4, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::GameObject> get_selectableGameObject() ;

/// @brief Method get_sortingPriority, addr 0x312147c, size 0x8, virtual false, abstract: false, final false
inline float_t get_sortingPriority() ;

/// @brief Method get_standardWorldSpaceShader, addr 0x312182c, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_standardWorldSpaceShader() ;

/// @brief Method get_targetDisplay, addr 0x3121934, size 0x8, virtual false, abstract: false, final false
inline int32_t get_targetDisplay() ;

/// @brief Method remove_destroyed, addr 0x3121620, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method set_drawToCameras, addr 0x312183c, size 0xa8, virtual false, abstract: false, final false
inline void set_drawToCameras(bool  value) ;

/// @brief Method set_screenToPanelSpace, addr 0x3121d60, size 0x78, virtual false, abstract: false, final false
inline void set_screenToPanelSpace(::System::Func_2<::UnityEngine::Vector2,::UnityEngine::Vector2>*  value) ;

/// @brief Method set_selectableGameObject, addr 0x31210ac, size 0x9c, virtual true, abstract: false, final true
inline void set_selectableGameObject(::UnityEngine::GameObject*  value) ;

/// @brief Method set_sortingPriority, addr 0x3121484, size 0xfc, virtual false, abstract: false, final false
inline void set_sortingPriority(float_t  value) ;

/// @brief Method set_targetDisplay, addr 0x312193c, size 0x8, virtual false, abstract: false, final false
