...
/// @brief Method ATagOnPointerMove, addr 0x3156b6c, size 0x2b8, virtual false, abstract: false, final false
inline void ATagOnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  pme) ;

/// @brief Method ATagOnPointerOut, addr 0x3156e24, size 0x8, virtual false, abstract: false, final false
inline void ATagOnPointerOut(::UnityEngine::UIElements::PointerOutEvent*  _) ;

/// @brief Method ATagOnPointerOver, addr 0x3156b64, size 0x8, virtual false, abstract: false, final false
inline void ATagOnPointerOver(::UnityEngine::UIElements::PointerOverEvent*  _) ;

/// @brief Method ATagOnPointerUp, addr 0x31569c8, size 0x19c, virtual false, abstract: false, final false
inline void ATagOnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  pue) ;

/// @brief Method ComputeTextHeight, addr 0x3155efc, size 0xac, virtual false, abstract: false, final false
inline float_t ComputeTextHeight(::StringW  textToMeasure, float_t  width, float_t  height) ;

/// @brief Method ComputeTextWidth, addr 0x3155b2c, size 0xbc, virtual false, abstract: false, final false
inline float_t ComputeTextWidth(::StringW  textToMeasure, bool  wordWrap, float_t  width, float_t  height) ;

/// @brief Method ConvertUssToTextGenerationSettings, addr 0x3155be8, size 0x314, virtual false, abstract: false, final false
inline void ConvertUssToTextGenerationSettings(::UnityEngine::TextCore::Text::TextGenerationSettings*  tgs) ;

/// @brief Method GetTextEffectPadding, addr 0x3157d48, size 0x1b4, virtual false, abstract: false, final false
inline float_t GetTextEffectPadding(::UnityEngine::TextCore::Text::FontAsset*  fontAsset) ;

/// @brief Method GetTextOverflowMode, addr 0x3157c74, size 0xa4, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextOverflowMode GetTextOverflowMode() ;

/// @brief Method HandleATag, addr 0x3156090, size 0x528, virtual false, abstract: false, final false
inline void HandleATag() ;

/// @brief Method HandleLinkTag, addr 0x31565b8, size 0x410, virtual false, abstract: false, final false
inline void HandleLinkTag() ;

/// @brief Method LinkTagOnPointerDown, addr 0x3156e2c, size 0x2f8, virtual false, abstract: false, final false
inline void LinkTagOnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  pde) ;

/// @brief Method LinkTagOnPointerMove, addr 0x315741c, size 0x648, virtual false, abstract: false, final false
inline void LinkTagOnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  pme) ;

/// @brief Method LinkTagOnPointerOut, addr 0x3157a64, size 0x210, virtual false, abstract: false, final false
inline void LinkTagOnPointerOut(::UnityEngine::UIElements::PointerOutEvent*  poe) ;

/// @brief Method LinkTagOnPointerUp, addr 0x3157124, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method TextLibraryCanElide, addr 0x3157d18, size 0x30, virtual false, abstract: false, final false
inline bool TextLibraryCanElide() ;

/// @brief Method Update, addr 0x3155fa8, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3155a90, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::TextElement*  te) ;

static inline float_t getStaticF_k_MinPadding() ;

/// @brief Method get_MeasuredSizes, addr 0x3155b0c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_MeasuredSizes() ;

/// @brief Method get_RoundedSizes, addr 0x3155b1c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_RoundedSizes() ;

static inline void setStaticF_k_MinPadding(float_t  value) ;

/// @brief Method set_MeasuredSizes, addr 0x3155b14, size 0x8, virtual false, abstract: false, final false
inline void set_MeasuredSizes(::UnityEngine::Vector2  value) ;

/// @brief Method set_RoundedSizes, addr 0x3155b24, size 0x8, virtual false, abstract: false, final false
