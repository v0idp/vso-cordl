...
/// @brief Method CloseTouchScreenKeyboard, addr 0x30b1aac, size 0xe4, virtual false, abstract: false, final false
inline void CloseTouchScreenKeyboard() ;

/// @brief Method DoPollTouchScreenKeyboard, addr 0x30b126c, size 0x840, virtual false, abstract: false, final false
inline void DoPollTouchScreenKeyboard() ;

/// @brief Method ExecuteDefaultActionAtTarget, addr 0x30b2308, size 0x1dc, virtual true, abstract: false, final false
...
/// @brief Method OnFocusInEvent, addr 0x30b26c4, size 0x180, virtual false, abstract: false, final false
inline void OnFocusInEvent() ;

/// @brief Method OnFocusOutEvent, addr 0x30b2844, size 0x480, virtual false, abstract: false, final false
inline void OnFocusOutEvent(::UnityEngine::UIElements::FocusOutEvent*  evt) ;

/// @brief Method OnPointerDownEvent, addr 0x30b24e4, size 0x1c0, virtual false, abstract: false, final false
inline void OnPointerDownEvent() ;

/// @brief Method OnPointerUpEvent, addr 0x30b26a4, size 0x20, virtual false, abstract: false, final false
inline void OnPointerUpEvent(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OpenTouchScreenKeyboard, addr 0x30b1e00, size 0x508, virtual false, abstract: false, final false
inline void OpenTouchScreenKeyboard() ;

/// @brief Method PollTouchScreenKeyboard, addr 0x30b1030, size 0x23c, virtual false, abstract: false, final false
inline void PollTouchScreenKeyboard() ;

/// @brief Method UpdateStringPositionFromKeyboard, addr 0x30b1b90, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30b0ffc, size 0x34, virtual false, abstract: false, final false
