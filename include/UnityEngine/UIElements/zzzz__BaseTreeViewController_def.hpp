...
/// @brief Method <PostInitRegistration>b__0, addr 0x3027bd0, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3024f00, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CanChangeExpandedState, addr 0x3026f7c, size 0x8, virtual true, abstract: false, final false
inline bool CanChangeExpandedState(int32_t  id) ;

/// @brief Method CollapseItem, addr 0x3027800, size 0x174, virtual false, abstract: false, final false
inline void CollapseItem(int32_t  id, bool  collapseAllChildren) ;

/// @brief Method CollapseItemByIndex, addr 0x3025874, size 0x530, virtual false, abstract: false, final false
inline void CollapseItemByIndex(int32_t  index, bool  collapseAllChildren) ;

/// @brief Method CreateWrappers, addr 0x3026fe8, size 0x630, virtual false, abstract: false, final false
...
/// @brief Method Exists, addr 0x3026b3c, size 0x58, virtual false, abstract: false, final false
inline bool Exists(int32_t  id) ;

/// @brief Method ExpandItem, addr 0x3027618, size 0x1e8, virtual false, abstract: false, final false
inline void ExpandItem(int32_t  id, bool  expandAllChildren, bool  refresh) ;

/// @brief Method ExpandItemByIndex, addr 0x3025da4, size 0xb14, virtual false, abstract: false, final false
...
/// @brief Method GetChildIndexForId, addr 0x3026b94, size 0x380, virtual false, abstract: false, final false
...
/// @brief Method GetChildrenIdsByIndex, addr 0x3025688, size 0xa4, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* GetChildrenIdsByIndex(int32_t  index) ;

/// @brief Method GetIdForIndex, addr 0x30269b0, size 0xa4, virtual true, abstract: false, final false
inline int32_t GetIdForIndex(int32_t  index) ;

/// @brief Method GetIndentationDepth, addr 0x3026f14, size 0x68, virtual false, abstract: false, final false
inline int32_t GetIndentationDepth(int32_t  id) ;

/// @brief Method GetIndentationDepthByIndex, addr 0x3024a84, size 0x24, virtual false, abstract: false, final false
inline int32_t GetIndentationDepthByIndex(int32_t  index) ;

/// @brief Method GetIndexForId, addr 0x30268b8, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method GetRootItemIds, addr 0x3024664, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<int32_t>* GetRootItemIds() ;

/// @brief Method HasChildren, addr 0x3026ab4, size 0x88, virtual true, abstract: false, final false
inline bool HasChildren(int32_t  id) ;

/// @brief Method HasChildrenByIndex, addr 0x3024b90, size 0xa8, virtual false, abstract: false, final false
inline bool HasChildrenByIndex(int32_t  index) ;

/// @brief Method InvokeBindItem, addr 0x3024974, size 0x110, virtual true, abstract: false, final false
inline void InvokeBindItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem, int32_t  index) ;

/// @brief Method InvokeDestroyItem, addr 0x3024c50, size 0x12c, virtual true, abstract: false, final false
inline void InvokeDestroyItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem) ;

/// @brief Method InvokeMakeItem, addr 0x302466c, size 0xb0, virtual true, abstract: false, final false
inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem) ;

/// @brief Method IsExpanded, addr 0x3026f84, size 0x64, virtual false, abstract: false, final false
inline bool IsExpanded(int32_t  id) ;

/// @brief Method IsExpandedByIndex, addr 0x3024abc, size 0xb4, virtual false, abstract: false, final false
inline bool IsExpandedByIndex(int32_t  index) ;

/// @brief Method IsIndexValid, addr 0x3026a54, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method OnItemPointerUp, addr 0x3025068, size 0x620, virtual false, abstract: false, final false
inline void OnItemPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnToggleValueChanged, addr 0x302572c, size 0x148, virtual false, abstract: false, final false
inline void OnToggleValueChanged(::UnityEngine::UIElements::ChangeEvent_1<bool>*  evt) ;

/// @brief Method PostInitRegistration, addr 0x302471c, size 0x258, virtual false, abstract: false, final false
inline void PostInitRegistration(::UnityEngine::UIElements::ReusableTreeViewItem*  treeItem) ;

/// @brief Method RaiseItemParentChanged, addr 0x302797c, size 0x1c, virtual false, abstract: false, final false
inline void RaiseItemParentChanged(int32_t  id, int32_t  newParentId) ;

/// @brief Method RebuildTree, addr 0x3024140, size 0x474, virtual false, abstract: false, final false
inline void RebuildTree() ;

/// @brief Method RegenerateWrappers, addr 0x30245b4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3027998, size 0x16c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_baseTreeView, addr 0x3024070, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::BaseTreeView* get_baseTreeView() ;

/// @brief Method get_itemsSource, addr 0x30240ec, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_itemsSource, addr 0x30240f4, size 0x4c, virtual true, abstract: false, final false
