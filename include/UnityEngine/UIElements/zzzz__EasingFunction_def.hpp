...
/// @brief Method Equals, addr 0x312ea50, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x312ea40, size 0x10, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::EasingFunction  other) ;

/// @brief Method GetHashCode, addr 0x312d78c, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x312eac8, size 0x68, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x312ea2c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::EasingMode  mode) ;

/// @brief Method get_mode, addr 0x312ea24, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x312ea34, size 0xc, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::EasingFunction  lhs, ::UnityEngine::UIElements::EasingFunction  rhs) ;

/// @brief Method op_Implicit, addr 0x312dbac, size 0x8, virtual false, abstract: false, final false
