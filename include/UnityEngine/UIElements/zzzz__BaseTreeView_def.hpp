...
/// @brief Method Init, addr 0x303141c, size 0xf4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3031510, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CollapseItem, addr 0x30311f4, size 0x40, virtual false, abstract: false, final false
inline void CollapseItem(int32_t  id, bool  collapseAllChildren) ;

/// @brief Method CollapseItemByIndex, addr 0x30308c4, size 0x74, virtual false, abstract: false, final false
inline void CollapseItemByIndex(int32_t  index, bool  collapseAll) ;

/// @brief Method CreateDragAndDropController, addr 0x302ff84, size 0x5c, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::ICollectionDragAndDropController* CreateDragAndDropController() ;

/// @brief Method CreateVirtualizationController, addr 0x302fb7c, size 0x48, virtual true, abstract: false, final false
inline void CreateVirtualizationController() ;

/// @brief Method ExpandItem, addr 0x3031234, size 0x38, virtual false, abstract: false, final false
inline void ExpandItem(int32_t  id, bool  expandAllChildren) ;

/// @brief Method ExpandItemByIndex, addr 0x303084c, size 0x78, virtual false, abstract: false, final false
inline void ExpandItemByIndex(int32_t  index, bool  expandAll) ;

/// @brief Method GetItemIndex, addr 0x30310d0, size 0x100, virtual false, abstract: false, final false
inline int32_t GetItemIndex(int32_t  id, bool  expand) ;

/// @brief Method HandleItemNavigation, addr 0x30302cc, size 0x540, virtual true, abstract: false, final false
inline bool HandleItemNavigation(bool  moveIn, bool  altPressed) ;

/// @brief Method IsExpanded, addr 0x30311d0, size 0x24, virtual false, abstract: false, final false
inline bool IsExpanded(int32_t  id) ;

/// @brief Method IsExpandedByIndex, addr 0x3030828, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method OnItemIndexChanged, addr 0x302fd88, size 0x4, virtual false, abstract: false, final false
inline void OnItemIndexChanged(int32_t  srcIndex, int32_t  dstIndex) ;

/// @brief Method OnTreeViewPointerUp, addr 0x303126c, size 0x38, virtual false, abstract: false, final false
inline void OnTreeViewPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnViewDataReady, addr 0x3030240, size 0x44, virtual true, abstract: false, final false
inline void OnViewDataReady() ;

/// @brief Method SetSelectionById, addr 0x3030970, size 0x7c, virtual false, abstract: false, final false
inline void SetSelectionById(int32_t  id) ;

/// @brief Method SetSelectionById, addr 0x3030b7c, size 0x8, virtual false, abstract: false, final false
inline void SetSelectionById(::System::Collections::Generic::IEnumerable_1<int32_t>*  ids) ;

/// @brief Method SetSelectionInternalById, addr 0x3030b84, size 0xec, virtual false, abstract: false, final false
inline void SetSelectionInternalById(::System::Collections::Generic::IEnumerable_1<int32_t>*  ids, bool  sendNotification) ;

/// @brief Method SetViewController, addr 0x302fbc4, size 0x120, virtual true, abstract: false, final false
inline void SetViewController(::UnityEngine::UIElements::CollectionViewController*  controller) ;

/// @brief Method <SetSelectionInternalById>b__47_0, addr 0x3031414, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3030024, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x303002c, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method get_autoExpand, addr 0x302ffe0, size 0x8, virtual false, abstract: false, final false
inline bool get_autoExpand() ;

/// @brief Method get_expandedItemIds, addr 0x3030014, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<int32_t>* get_expandedItemIds() ;

/// @brief Method get_itemsSource, addr 0x302fae0, size 0x20, virtual false, abstract: false, final false
inline ::System::Collections::IList* get_itemsSource() ;

/// @brief Method get_viewController, addr 0x302fb00, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method set_autoExpand, addr 0x302ffe8, size 0x2c, virtual false, abstract: false, final false
inline void set_autoExpand(bool  value) ;

/// @brief Method set_expandedItemIds, addr 0x303001c, size 0x8, virtual false, abstract: false, final false
