...
#include "UnityEngine/UIElements/zzzz__PopupField_1_def.hpp"
template<typename T>
constexpr T& UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>::__cordl_internal_get_item()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___item;
}
template<typename T>
constexpr T const& UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>::__cordl_internal_get_item() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___item;
}
template<typename T>
constexpr void UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>::__cordl_internal_set_item(T  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->___item, value);
}
template<typename T>
constexpr ::UnityEngine::UIElements::PopupField_1<T>*& UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>::__cordl_internal_get___4__this()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->_____4__this;
}
template<typename T>
constexpr ::UnityEngine::UIElements::PopupField_1<T>* const& UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>::__cordl_internal_get___4__this() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->_____4__this;
}
template<typename T>
constexpr void UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>::__cordl_internal_set___4__this(::UnityEngine::UIElements::PopupField_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->_____4__this, value);
}
template<typename T>
inline void UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>*>::get(),
                        ".ctor",
...
template<typename T>
inline void UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>::_AddMenuItems_b__0()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>*>::get(),
                        "<AddMenuItems>b__0",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename T>
inline ::UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>* UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>*>());
}
// Ctor Parameters []
template<typename T>
constexpr ::UnityEngine::UIElements::PopupField_1___c__DisplayClass26_0<T>::PopupField_1___c__DisplayClass26_0()   {
}
template<typename T>
