...
public:
// Declarations
/// @brief Method CaptureMouse, addr 0x3104cb8, size 0xe0, virtual false, abstract: false, final false
static inline void CaptureMouse(::UnityEngine::UIElements::IEventHandler*  handler) ;

/// @brief Method HasMouseCapture, addr 0x3103498, size 0xb0, virtual false, abstract: false, final false
static inline bool HasMouseCapture(::UnityEngine::UIElements::IEventHandler*  handler) ;

/// @brief Method ReleaseMouse, addr 0x3104d98, size 0xe0, virtual false, abstract: false, final false
