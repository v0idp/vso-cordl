...
/// @brief Method <.cctor>b__0_0, addr 0x30f2ab4, size 0x50, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::AttachToPanelEvent* __cctor_b__0_0() ;

/// @brief Method .ctor, addr 0x30f2aac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x30f2a08, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
