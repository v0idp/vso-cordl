...
/// @brief Method .ctor, addr 0x30d50f0, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x30d5138, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyInputDeviceDelta, addr 0x30d5258, size 0x250, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x30d54f4, size 0xa8, virtual true, abstract: false, final false
inline uint32_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x30d54a8, size 0x4c, virtual true, abstract: false, final false
inline ::StringW ValueToString(uint32_t  v) ;

/// @brief Method .ctor, addr 0x30d4f04, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowedCharacters, addr 0x30d5200, size 0x58, virtual true, abstract: false, final false
inline ::StringW get_allowedCharacters() ;

/// @brief Method get_parentUnsignedIntegerField, addr 0x30d5180, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ApplyInputDeviceDelta, addr 0x30d4fbc, size 0x64, virtual true, abstract: false, final false
inline void ApplyInputDeviceDelta(::UnityEngine::Vector3  delta, ::UnityEngine::UIElements::DeltaSpeed  speed, uint32_t  startValue) ;

/// @brief Method CanTryParse, addr 0x30d4f98, size 0x24, virtual true, abstract: false, final false
...
/// @brief Method StringToValue, addr 0x30d4ccc, size 0xdc, virtual true, abstract: false, final false
inline uint32_t StringToValue(::StringW  str) ;

/// @brief Method ValueToString, addr 0x30d4c14, size 0xb8, virtual true, abstract: false, final false
inline ::StringW ValueToString(uint32_t  v) ;

/// @brief Method .ctor, addr 0x30d4da8, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x30d4db4, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method get_integerInput, addr 0x30d4b90, size 0x84, virtual false, abstract: false, final false
