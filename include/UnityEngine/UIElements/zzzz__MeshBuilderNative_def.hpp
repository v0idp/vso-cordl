...
// Ctor Parameters [CppParam { name: "rect", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "subRect", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "uv", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "uvRegion", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "color", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "scaleMode", ty: "::UnityEngine::ScaleMode", modifiers: "", def_value: None }, CppParam { name: "topLeftRadius", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "topRightRadius", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "bottomRightRadius", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "bottomLeftRadius", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "backgroundRepeatRect", ty: "::UnityEngine::Rect", modifiers: "", def_value: None }, CppParam { name: "contentSize", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "textureSize", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "texturePixelsPerPoint", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "leftSlice", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "topSlice", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "rightSlice", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "bottomSlice", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "sliceScale", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "rectInset", ty: "::UnityEngine::Vector4", modifiers: "", def_value: None }, CppParam { name: "colorPage", ty: "::UnityEngine::UIElements::MeshBuilderNative_NativeColorPage", modifiers: "", def_value: None }]
...
/// @brief Field backgroundRepeatRect, offset: 0x74, size: 0x10, def value: None
 ::UnityEngine::Rect  backgroundRepeatRect;

/// @brief Field contentSize, offset: 0x84, size: 0x8, def value: None
 ::UnityEngine::Vector2  contentSize;

/// @brief Field textureSize, offset: 0x8c, size: 0x8, def value: None
 ::UnityEngine::Vector2  textureSize;

/// @brief Field texturePixelsPerPoint, offset: 0x94, size: 0x4, def value: None
 float_t  texturePixelsPerPoint;

/// @brief Field leftSlice, offset: 0x98, size: 0x4, def value: None
 int32_t  leftSlice;

/// @brief Field topSlice, offset: 0x9c, size: 0x4, def value: None
 int32_t  topSlice;

/// @brief Field rightSlice, offset: 0xa0, size: 0x4, def value: None
 int32_t  rightSlice;

/// @brief Field bottomSlice, offset: 0xa4, size: 0x4, def value: None
 int32_t  bottomSlice;

/// @brief Field sliceScale, offset: 0xa8, size: 0x4, def value: None
 float_t  sliceScale;

/// @brief Field rectInset, offset: 0xac, size: 0x10, def value: None
 ::UnityEngine::Vector4  rectInset;

/// @brief Field colorPage, offset: 0xbc, size: 0x8, def value: None
...
static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, backgroundRepeatRect) == 0x74, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, contentSize) == 0x84, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, textureSize) == 0x8c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, texturePixelsPerPoint) == 0x94, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, leftSlice) == 0x98, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, topSlice) == 0x9c, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, rightSlice) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, bottomSlice) == 0xa4, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, sliceScale) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, rectInset) == 0xac, "Offset mismatch!");

static_assert(offsetof(::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, colorPage) == 0xbc, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::UnityEngine::UIElements::MeshBuilderNative_NativeRectParams, 0xc4>, "Size mismatch!");
...
/// @brief Method MakeBorder, addr 0x31051e8, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method MakeBorder_Injected, addr 0x3105260, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method MakeSolidRect, addr 0x31052b4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method MakeSolidRect_Injected, addr 0x310532c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method MakeTexturedRect, addr 0x3105380, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method MakeTexturedRect_Injected, addr 0x31053f8, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method MakeVectorGraphics9SliceBackground, addr 0x31055f0, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method MakeVectorGraphics9SliceBackground_Injected, addr 0x31056a8, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method MakeVectorGraphicsStretchBackground, addr 0x310544c, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method MakeVectorGraphicsStretchBackground_Injected, addr 0x310552c, size 0xc4, virtual false, abstract: false, final false
