...
/// @brief Method Dispose, addr 0x30ea628, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x30ea624, size 0x4, virtual false, abstract: false, final false
