...
/// @brief Method BindItem, addr 0x3028c30, size 0x88, virtual true, abstract: false, final false
inline void BindItem(::UnityEngine::UIElements::VisualElement*  element, int32_t  index) ;

/// @brief Method DestroyItem, addr 0x3028cd4, size 0x1c, virtual true, abstract: false, final false
inline void DestroyItem(::UnityEngine::UIElements::VisualElement*  element) ;

/// @brief Method Dispose, addr 0x3028e34, size 0xb8, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method InvokeMakeItem, addr 0x3028740, size 0xf0, virtual true, abstract: false, final false
inline void InvokeMakeItem(::UnityEngine::UIElements::ReusableCollectionItem*  reusableItem) ;

/// @brief Method MakeItem, addr 0x3028c14, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method PrepareView, addr 0x3028cf0, size 0xa4, virtual true, abstract: false, final false
inline void PrepareView() ;

/// @brief Method UnbindItem, addr 0x3028cb8, size 0x1c, virtual true, abstract: false, final false
inline void UnbindItem(::UnityEngine::UIElements::VisualElement*  element, int32_t  index) ;

/// @brief Method UpdateReorderClassList, addr 0x3028f8c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30286b4, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method get_columnController, addr 0x3028694, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MultiColumnController* get_columnController() ;

/// @brief Method get_header, addr 0x302869c, size 0x18, virtual false, abstract: false, final false
