...
public:
// Declarations
/// @brief Method Invoke, addr 0x301b1a8, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x301b108, size 0xa0, virtual false, abstract: false, final false
