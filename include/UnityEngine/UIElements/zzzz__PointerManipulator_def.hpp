...
/// @brief Method CanStartManipulation, addr 0x312373c, size 0x1f0, virtual false, abstract: false, final false
inline bool CanStartManipulation(::UnityEngine::UIElements::IPointerEvent*  e) ;

/// @brief Method CanStopManipulation, addr 0x312392c, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31239e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
