...
public:
// Declarations
/// @brief Method Create, addr 0x3105134, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr Create(bool  computeBBox) ;

/// @brief Method Destroy, addr 0x3105170, size 0x3c, virtual false, abstract: false, final false
static inline void Destroy(::System::IntPtr  handle) ;

/// @brief Method Reset, addr 0x31051ac, size 0x3c, virtual false, abstract: false, final false
