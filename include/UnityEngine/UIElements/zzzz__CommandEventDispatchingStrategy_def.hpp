...
/// @brief Method CanDispatchEvent, addr 0x30e6e44, size 0x54, virtual true, abstract: false, final true
inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method DispatchEvent, addr 0x30e6e98, size 0x2f0, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x30e65e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
