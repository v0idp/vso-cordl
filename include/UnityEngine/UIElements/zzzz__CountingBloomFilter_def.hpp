...
/// @brief Method AdjustSlot, addr 0x30d600c, size 0x2c, virtual false, abstract: false, final false
inline void AdjustSlot(uint32_t  index, bool  increment) ;

/// @brief Method ContainsHash, addr 0x30d60c0, size 0x28, virtual false, abstract: false, final false
inline bool ContainsHash(uint32_t  hash) ;

/// @brief Method Hash1, addr 0x30d6038, size 0x8, virtual false, abstract: false, final false
inline uint32_t Hash1(uint32_t  hash) ;

/// @brief Method Hash2, addr 0x30d6040, size 0x8, virtual false, abstract: false, final false
inline uint32_t Hash2(uint32_t  hash) ;

/// @brief Method InsertHash, addr 0x30d6058, size 0x38, virtual false, abstract: false, final false
inline void InsertHash(uint32_t  hash) ;

/// @brief Method IsSlotEmpty, addr 0x30d6048, size 0x10, virtual false, abstract: false, final false
inline bool IsSlotEmpty(uint32_t  index) ;

/// @brief Method RemoveHash, addr 0x30d6090, size 0x30, virtual false, abstract: false, final false
