...
/// @brief Method AttachToPanel, addr 0x3129c88, size 0x1e4, virtual false, abstract: false, final false
inline void AttachToPanel() ;

/// @brief Method CreateRenderChain, addr 0x3129790, size 0x70, virtual true, abstract: false, final false
inline ::UnityEngine::UIElements::UIR::RenderChain* CreateRenderChain() ;

/// @brief Method DestroyRenderChain, addr 0x31218e4, size 0x50, virtual false, abstract: false, final false
inline void DestroyRenderChain() ;

/// @brief Method DetachFromPanel, addr 0x3129af4, size 0x194, virtual false, abstract: false, final false
inline void DetachFromPanel() ;

/// @brief Method Dispose, addr 0x312a278, size 0x2c, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method InitRenderChain, addr 0x31296d4, size 0xbc, virtual false, abstract: false, final false
inline void InitRenderChain() ;

static inline ::UnityEngine::UIElements::UIRRepaintUpdater* New_ctor() ;

/// @brief Method OnGraphicsResourcesRecreate, addr 0x312990c, size 0x1d0, virtual false, abstract: false, final false
static inline void OnGraphicsResourcesRecreate(bool  recreate) ;

/// @brief Method OnPanelAtlasChanged, addr 0x312a228, size 0x4, virtual false, abstract: false, final false
inline void OnPanelAtlasChanged() ;

/// @brief Method OnPanelChanged, addr 0x3129adc, size 0x18, virtual false, abstract: false, final false
inline void OnPanelChanged(::UnityEngine::UIElements::BaseVisualElementPanel*  obj) ;

/// @brief Method OnPanelHierarchyChanged, addr 0x312a22c, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method OnPanelStandardShaderChanged, addr 0x3129e6c, size 0x198, virtual false, abstract: false, final false
inline void OnPanelStandardShaderChanged() ;

/// @brief Method OnPanelStandardWorldSpaceShaderChanged, addr 0x312a004, size 0x198, virtual false, abstract: false, final false
inline void OnPanelStandardWorldSpaceShaderChanged() ;

/// @brief Method OnVersionChanged, addr 0x3129520, size 0xf8, virtual true, abstract: false, final false
inline void OnVersionChanged(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::VersionChangeType  versionChangeType) ;

/// @brief Method ResetAllElementsDataRecursive, addr 0x312a19c, size 0x8c, virtual false, abstract: false, final false
inline void ResetAllElementsDataRecursive(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method Update, addr 0x3129618, size 0xbc, virtual true, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x3129428, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_breakBatches, addr 0x3129518, size 0x8, virtual false, abstract: false, final false
inline bool get_breakBatches() ;

/// @brief Method get_disposed, addr 0x312a264, size 0x8, virtual false, abstract: false, final false
inline bool get_disposed() ;

/// @brief Method get_drawStats, addr 0x3129510, size 0x8, virtual false, abstract: false, final false
inline bool get_drawStats() ;

/// @brief Method get_profilerMarker, addr 0x31294b8, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method set_disposed, addr 0x312a26c, size 0xc, virtual false, abstract: false, final false
