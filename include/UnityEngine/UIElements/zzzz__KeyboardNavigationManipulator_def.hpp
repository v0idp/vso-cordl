...
/// @brief Method Invoke, addr 0x31042f8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method OnKeyDown, addr 0x31041e4, size 0x4c, virtual false, abstract: false, final false
inline void OnKeyDown(::UnityEngine::UIElements::KeyDownEvent*  evt) ;

/// @brief Method OnNavigationCancel, addr 0x3104314, size 0x24, virtual false, abstract: false, final false
inline void OnNavigationCancel(::UnityEngine::UIElements::NavigationCancelEvent*  evt) ;

/// @brief Method OnNavigationMove, addr 0x310435c, size 0xb4, virtual false, abstract: false, final false
inline void OnNavigationMove(::UnityEngine::UIElements::NavigationMoveEvent*  evt) ;

/// @brief Method OnNavigationSubmit, addr 0x3104338, size 0x24, virtual false, abstract: false, final false
inline void OnNavigationSubmit(::UnityEngine::UIElements::NavigationSubmitEvent*  evt) ;

/// @brief Method RegisterCallbacksOnTarget, addr 0x3103dd4, size 0x204, virtual true, abstract: false, final false
inline void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget, addr 0x3103fe0, size 0x204, virtual true, abstract: false, final false
inline void UnregisterCallbacksFromTarget() ;

/// @brief Method <OnKeyDown>g__GetOperation|4_0, addr 0x3104230, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3103da4, size 0x28, virtual false, abstract: false, final false
