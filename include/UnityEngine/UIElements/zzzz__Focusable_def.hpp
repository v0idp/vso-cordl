...
/// @brief Method Blur, addr 0x30f9248, size 0x38, virtual true, abstract: false, final false
inline void Blur() ;

/// @brief Method BlurImmediately, addr 0x30f92d8, size 0x38, virtual false, abstract: false, final false
inline void BlurImmediately() ;

/// @brief Method ExecuteDefaultAction, addr 0x30f942c, size 0x2c, virtual true, abstract: false, final false
inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method ExecuteDefaultActionDisabled, addr 0x30f94b8, size 0x2c, virtual true, abstract: false, final false
inline void ExecuteDefaultActionDisabled(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method Focus, addr 0x30f9050, size 0xb0, virtual true, abstract: false, final false
inline void Focus() ;

/// @brief Method GetFirstFocusableChild, addr 0x30f9310, size 0x11c, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::Focusable* GetFirstFocusableChild(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetFocusDelegate, addr 0x30f9100, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Focusable* GetFocusDelegate() ;

static inline ::UnityEngine::UIElements::Focusable* New_ctor() ;

/// @brief Method ProcessEvent, addr 0x30f9458, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30f8f04, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_canGrabFocus, addr 0x30f9048, size 0x8, virtual true, abstract: false, final false
inline bool get_canGrabFocus() ;

/// @brief Method get_delegatesFocus, addr 0x30f8f4c, size 0x8, virtual false, abstract: false, final false
inline bool get_delegatesFocus() ;

/// @brief Method get_excludeFromFocusRing, addr 0x30f8f60, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_focusable, addr 0x30f8f28, size 0x8, virtual false, abstract: false, final false
inline bool get_focusable() ;

/// @brief Method get_tabIndex, addr 0x30f8f3c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_tabIndex() ;

/// @brief Method set_delegatesFocus, addr 0x30f8f54, size 0xc, virtual false, abstract: false, final false
inline void set_delegatesFocus(bool  value) ;

/// @brief Method set_excludeFromFocusRing, addr 0x30f8f68, size 0xe0, virtual false, abstract: false, final false
inline void set_excludeFromFocusRing(bool  value) ;

/// @brief Method set_focusable, addr 0x30f8f30, size 0xc, virtual false, abstract: false, final false
inline void set_focusable(bool  value) ;

/// @brief Method set_tabIndex, addr 0x30f8f44, size 0x8, virtual false, abstract: false, final false
