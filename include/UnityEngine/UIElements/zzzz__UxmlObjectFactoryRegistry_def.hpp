...
/// @brief Method RegisterEngineFactories, addr 0x305540c, size 0x230, virtual false, abstract: false, final false
static inline void RegisterEngineFactories() ;

/// @brief Method RegisterFactory, addr 0x305590c, size 0x49c, virtual false, abstract: false, final false
static inline void RegisterFactory(::UnityEngine::UIElements::IBaseUxmlObjectFactory*  factory) ;

/// @brief Method RegisterUserFactories, addr 0x305563c, size 0x2d0, virtual false, abstract: false, final false
static inline void RegisterUserFactories() ;

/// @brief Method TryGetFactories, addr 0x3055da8, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method get_factories, addr 0x3055364, size 0xa8, virtual false, abstract: false, final false
