...
/// @brief Method Add, addr 0x305f844, size 0x1c4, virtual false, abstract: false, final false
inline void Add(::UnityEngine::UIElements::StyleSheet*  styleSheet) ;

/// @brief Method Equals, addr 0x305fb44, size 0x7c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x305fb38, size 0xc, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::VisualElementStyleSheetSet  other) ;

/// @brief Method GetHashCode, addr 0x305fbc0, size 0x18, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Remove, addr 0x305fa08, size 0x130, virtual false, abstract: false, final false
inline bool Remove(::UnityEngine::UIElements::StyleSheet*  styleSheet) ;

/// @brief Method .ctor, addr 0x305f83c, size 0x8, virtual false, abstract: false, final false
