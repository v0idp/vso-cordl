...
/// @brief Method <RecomputeToMaxWidthProportionally>b__1, addr 0x30bc38c, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30bb314, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <RecomputeToMinWidthProportionally>b__1, addr 0x30bc3c0, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30bb438, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method BeginDragResize, addr 0x30bb910, size 0x328, virtual false, abstract: false, final false
inline void BeginDragResize(::UnityEngine::UIElements::Column*  column, float_t  pos, bool  previewMode) ;

/// @brief Method ClearCache, addr 0x30b8ba8, size 0xcc, virtual false, abstract: false, final false
inline void ClearCache() ;

/// @brief Method Dirty, addr 0x30b8b68, size 0x40, virtual false, abstract: false, final false
inline void Dirty() ;

/// @brief Method DistributeExcess, addr 0x30ba7e8, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method DistributeOverflow, addr 0x30ba670, size 0x178, virtual false, abstract: false, final false
inline void DistributeOverflow(::System::Collections::Generic::List_1<::UnityEngine::UIElements::Column*>*  stretchableColumns, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::Column*>*  fixedColumns, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::Column*>*  relativeWidthColumns, ::ByRef<float_t>  delta, bool  resizeToFit, bool  dragResize) ;

/// @brief Method DoLayout, addr 0x30b8dd0, size 0xdf8, virtual false, abstract: false, final false
inline void DoLayout(float_t  width) ;

/// @brief Method DragResize, addr 0x30bbd2c, size 0x27c, virtual false, abstract: false, final false
inline void DragResize(::UnityEngine::UIElements::Column*  column, float_t  pos) ;

/// @brief Method EndDragResize, addr 0x30bbfa8, size 0x254, virtual false, abstract: false, final false
inline void EndDragResize(::UnityEngine::UIElements::Column*  column, bool  cancelled) ;

/// @brief Method GetDesiredPosition, addr 0x30bbc38, size 0xf4, virtual false, abstract: false, final false
inline float_t GetDesiredPosition(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method GetDesiredWidth, addr 0x30ba4e8, size 0xa0, virtual false, abstract: false, final false
inline float_t GetDesiredWidth(::UnityEngine::UIElements::Column*  c) ;

/// @brief Method IsClamped, addr 0x30b8db8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method OnColumnAdded, addr 0x30b87d4, size 0xe4, virtual false, abstract: false, final false
inline void OnColumnAdded(::UnityEngine::UIElements::Column*  column, int32_t  index) ;

/// @brief Method OnColumnChanged, addr 0x30b8d80, size 0x2c, virtual false, abstract: false, final false
inline void OnColumnChanged(::UnityEngine::UIElements::Column*  column, ::UnityEngine::UIElements::ColumnDataType  type) ;

/// @brief Method OnColumnRemoved, addr 0x30b8c74, size 0xe4, virtual false, abstract: false, final false
inline void OnColumnRemoved(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method OnColumnReordered, addr 0x30b8d58, size 0x4, virtual false, abstract: false, final false
inline void OnColumnReordered(::UnityEngine::UIElements::Column*  column, int32_t  from, int32_t  to) ;

/// @brief Method OnColumnResized, addr 0x30b8dac, size 0xc, virtual false, abstract: false, final false
inline void OnColumnResized(::UnityEngine::UIElements::Column*  column) ;

/// @brief Method RecomputeToDesiredWidth, addr 0x30bb440, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method RecomputeToDesiredWidth, addr 0x30ba938, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method RecomputeToMaxWidth, addr 0x30bb190, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method RecomputeToMaxWidthProportionally, addr 0x30baecc, size 0x2c4, virtual false, abstract: false, final false
...
/// @brief Method RecomputeToMinWidth, addr 0x30bad3c, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method RecomputeToMinWidthProportionally, addr 0x30baa5c, size 0x2e0, virtual false, abstract: false, final false
...
/// @brief Method RequiresLayoutUpdate, addr 0x30b8d5c, size 0x24, virtual false, abstract: false, final false
inline bool RequiresLayoutUpdate(::UnityEngine::UIElements::ColumnDataType  type) ;

/// @brief Method ResizeColumn, addr 0x30bb31c, size 0x11c, virtual false, abstract: false, final false
inline void ResizeColumn(::UnityEngine::UIElements::Column*  column, float_t  width, bool  setDesiredWidthOnly) ;

/// @brief Method ResizeToFit, addr 0x30bb5f4, size 0x31c, virtual false, abstract: false, final false
inline void ResizeToFit(float_t  width) ;

/// @brief Method StretchResizeColumns, addr 0x30ba588, size 0xe8, virtual false, abstract: false, final false
inline void StretchResizeColumns(::System::Collections::Generic::List_1<::UnityEngine::UIElements::Column*>*  stretchableColumns, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::Column*>*  fixedColumns, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::Column*>*  relativeWidthColumns, ::ByRef<float_t>  delta, bool  resizeToFit, bool  dragResize) ;

/// @brief Method UpdateCache, addr 0x30b9bc8, size 0x54c, virtual false, abstract: false, final false
inline void UpdateCache() ;

/// @brief Method UpdateMinAndMaxColumnsWidth, addr 0x30ba114, size 0x334, virtual false, abstract: false, final false
inline void UpdateMinAndMaxColumnsWidth() ;

/// @brief Method <DoLayout>b__49_0, addr 0x30bc1fc, size 0x64, virtual false, abstract: false, final false
inline int32_t _DoLayout_b__49_0(::UnityEngine::UIElements::Column*  c1, ::UnityEngine::UIElements::Column*  c2) ;

/// @brief Method <DoLayout>b__49_1, addr 0x30bc260, size 0x64, virtual false, abstract: false, final false
inline int32_t _DoLayout_b__49_1(::UnityEngine::UIElements::Column*  c1, ::UnityEngine::UIElements::Column*  c2) ;

/// @brief Method <RecomputeToMaxWidthProportionally>b__53_0, addr 0x30bc2c4, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method <RecomputeToMinWidthProportionally>b__54_0, addr 0x30bc328, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30b84ac, size 0x280, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::Columns*  columns) ;

/// @brief Method add_layoutRequested, addr 0x30b8374, size 0x9c, virtual false, abstract: false, final false
inline void add_layoutRequested(::System::Action*  value) ;

/// @brief Method get_columns, addr 0x30b7f78, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Columns* get_columns() ;

/// @brief Method get_columnsWidth, addr 0x30b7f80, size 0x320, virtual false, abstract: false, final false
inline float_t get_columnsWidth() ;

/// @brief Method get_hasRelativeWidthColumns, addr 0x30b8308, size 0x6c, virtual false, abstract: false, final false
inline bool get_hasRelativeWidthColumns() ;

/// @brief Method get_hasStretchableColumns, addr 0x30b82b8, size 0x50, virtual false, abstract: false, final false
inline bool get_hasStretchableColumns() ;

/// @brief Method get_layoutWidth, addr 0x30b82a0, size 0x8, virtual false, abstract: false, final false
inline float_t get_layoutWidth() ;

/// @brief Method get_maxColumnsWidth, addr 0x30b82b0, size 0x8, virtual false, abstract: false, final false
inline float_t get_maxColumnsWidth() ;

/// @brief Method get_minColumnsWidth, addr 0x30b82a8, size 0x8, virtual false, abstract: false, final false
inline float_t get_minColumnsWidth() ;

/// @brief Method remove_layoutRequested, addr 0x30b8410, size 0x9c, virtual false, abstract: false, final false
