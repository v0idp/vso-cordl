...
/// @brief Method AboutToGrabFocus, addr 0x30fa9b8, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method AboutToReleaseFocus, addr 0x30fa638, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method Blur, addr 0x30f9280, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method BlurLastFocusedElement, addr 0x30fa324, size 0x94, virtual false, abstract: false, final false
inline void BlurLastFocusedElement() ;

/// @brief Method DoFocusChange, addr 0x30fa3b8, size 0x178, virtual false, abstract: false, final false
inline void DoFocusChange(::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method FocusNextInDirection, addr 0x30fa54c, size 0xec, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Focusable* FocusNextInDirection(::UnityEngine::UIElements::FocusChangeDirection*  direction) ;

/// @brief Method GetFocusableParentForPointerEvent, addr 0x30fadfc, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method GetLeafFocusedElement, addr 0x30f1e68, size 0xa4, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Focusable* GetLeafFocusedElement() ;

/// @brief Method GetRetargetedFocusedElement, addr 0x30f9df4, size 0x214, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Focusable* GetRetargetedFocusedElement(::UnityEngine::UIElements::VisualElement*  retargetAgainst) ;

/// @brief Method GrabFocus, addr 0x30fab78, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method IsFocused, addr 0x30fa044, size 0x18c, virtual false, abstract: false, final false
inline bool IsFocused(::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method IsLocalElement, addr 0x30fa008, size 0x3c, virtual false, abstract: false, final false
inline bool IsLocalElement(::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method IsPendingFocus, addr 0x30fa1d0, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method ProcessPendingFocusChange, addr 0x30fa530, size 0x1c, virtual false, abstract: false, final false
inline void ProcessPendingFocusChange(::UnityEngine::UIElements::Focusable*  f) ;

/// @brief Method ReevaluateFocus, addr 0x30fad44, size 0xb8, virtual false, abstract: false, final false
inline void ReevaluateFocus() ;

/// @brief Method ReleaseFocus, addr 0x30fa7f8, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method SetFocusToLastFocusedElement, addr 0x30fa29c, size 0x88, virtual false, abstract: false, final false
inline void SetFocusToLastFocusedElement() ;

/// @brief Method SwitchFocus, addr 0x30f9190, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method SwitchFocus, addr 0x30f98f8, size 0x294, virtual false, abstract: false, final false
...
/// @brief Method SwitchFocusOnEvent, addr 0x30f94e4, size 0x2a0, virtual false, abstract: false, final false
inline void SwitchFocusOnEvent(::UnityEngine::UIElements::EventBase*  e) ;

/// @brief Method SyncIMGUIFocus, addr 0x30faf14, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x30f9c50, size 0x90, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::UIElements::IFocusRing*  focusRing) ;

/// @brief Method get_focusRing, addr 0x30f9ce0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::IFocusRing* get_focusRing() ;

/// @brief Method get_focusedElement, addr 0x30f9db0, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::Focusable* get_focusedElement() ;

/// @brief Method get_imguiKeyboardControl, addr 0x30faf04, size 0x8, virtual false, abstract: false, final false
inline int32_t get_imguiKeyboardControl() ;

/// @brief Method set_imguiKeyboardControl, addr 0x30faf0c, size 0x8, virtual false, abstract: false, final false
inline void set_imguiKeyboardControl(int32_t  value) ;

/// @brief Method set_selectedTextElement, addr 0x30f9ce8, size 0xc8, virtual false, abstract: false, final false
