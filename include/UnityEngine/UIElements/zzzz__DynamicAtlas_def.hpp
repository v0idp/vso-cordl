...
/// @brief Method Create, addr 0x301bd7c, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x301be14, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x301bdcc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method DestroyPages, addr 0x301b340, size 0x78, virtual false, abstract: false, final false
inline void DestroyPages() ;

/// @brief Method InitPages, addr 0x301b464, size 0xfc, virtual false, abstract: false, final false
inline void InitPages() ;

/// @brief Method IsTextureFormatSupported, addr 0x301ba68, size 0x34, virtual false, abstract: false, final false
static inline bool IsTextureFormatSupported(::UnityEngine::TextureFormat  format) ;

/// @brief Method IsTextureValid, addr 0x301ba9c, size 0x138, virtual true, abstract: false, final false
...
/// @brief Method OnAssignedToPanel, addr 0x301b1dc, size 0xcc, virtual true, abstract: false, final false
inline void OnAssignedToPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method OnRemovedFromPanel, addr 0x301b2a8, size 0x98, virtual true, abstract: false, final false
inline void OnRemovedFromPanel(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method OnUpdateDynamicTextures, addr 0x301ba00, size 0x68, virtual true, abstract: false, final false
inline void OnUpdateDynamicTextures(::UnityEngine::UIElements::IPanel*  panel) ;

/// @brief Method Reset, addr 0x301b3b8, size 0xac, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method ReturnAtlas, addr 0x301b8c4, size 0x13c, virtual true, abstract: false, final false
...
/// @brief Method TryGetAtlas, addr 0x301b560, size 0x364, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x301bcac, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_defaultFilters, addr 0x301bc1c, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::UIElements::DynamicAtlasFilters get_defaultFilters() ;

/// @brief Method get_isInitialized, addr 0x301b1bc, size 0x20, virtual false, abstract: false, final false
inline bool get_isInitialized() ;

/// @brief Method get_maxSubTextureSize, addr 0x301bbd4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxSubTextureSize() ;

/// @brief Method set_activeFilters, addr 0x301bc24, size 0x20, virtual false, abstract: false, final false
inline void set_activeFilters(::UnityEngine::UIElements::DynamicAtlasFilters  value) ;

/// @brief Method set_customFilter, addr 0x301bc64, size 0x48, virtual false, abstract: false, final false
inline void set_customFilter(::UnityEngine::UIElements::DynamicAtlasCustomFilter*  value) ;

/// @brief Method set_maxAtlasSize, addr 0x301bbfc, size 0x20, virtual false, abstract: false, final false
inline void set_maxAtlasSize(int32_t  value) ;

/// @brief Method set_maxSubTextureSize, addr 0x301bc44, size 0x20, virtual false, abstract: false, final false
inline void set_maxSubTextureSize(int32_t  value) ;

/// @brief Method set_minAtlasSize, addr 0x301bbdc, size 0x20, virtual false, abstract: false, final false
