...
/// @brief Method .ctor, addr 0x31500d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_properties, addr 0x31500c8, size 0x8, virtual false, abstract: false, final false
