...
/// @brief Method ConvertToGpu, addr 0x312a2bc, size 0x5c, virtual false, abstract: false, final false
inline float_t ConvertToGpu() ;

/// @brief Method Equals, addr 0x312a318, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x312a3c0, size 0x8, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x312a2a4, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  index) ;

static inline ::UnityEngine::UIElements::TextureId getStaticF_invalid() ;

/// @brief Method get_index, addr 0x312a2b0, size 0xc, virtual false, abstract: false, final false
inline int32_t get_index() ;

/// @brief Method op_Equality, addr 0x312a3c8, size 0xc, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UIElements::TextureId  left, ::UnityEngine::UIElements::TextureId  right) ;

/// @brief Method op_Inequality, addr 0x312a3d4, size 0x64, virtual false, abstract: false, final false
