...
public:
// Declarations
/// @brief Method AddManipulator, addr 0x305cb4c, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method ChangeCoordinatesTo, addr 0x305cf58, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method LocalToWorld, addr 0x305cd88, size 0xe8, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 LocalToWorld(::UnityEngine::UIElements::VisualElement*  ele, ::UnityEngine::Vector2  p) ;

/// @brief Method RemoveManipulator, addr 0x305cbf8, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method StretchToParentSize, addr 0x305c830, size 0x31c, virtual false, abstract: false, final false
static inline void StretchToParentSize(::UnityEngine::UIElements::VisualElement*  elem) ;

/// @brief Method WorldToLocal, addr 0x305ce70, size 0xe8, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect WorldToLocal(::UnityEngine::UIElements::VisualElement*  ele, ::UnityEngine::Rect  r) ;

/// @brief Method WorldToLocal, addr 0x305cca0, size 0xe8, virtual false, abstract: false, final false
