...
/// @brief Method <AssignInspectorStyleIfNecessary>b__5_0, addr 0x3060034, size 0x6c, virtual false, abstract: false, final false
inline bool _AssignInspectorStyleIfNecessary_b__5_0(::UnityEngine::UIElements::VisualElement*  i) ;

/// @brief Method .ctor, addr 0x306002c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AssignInspectorStyleIfNecessary, addr 0x305fdd0, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method GetFoldoutDepth, addr 0x305fcec, size 0xe4, virtual false, abstract: false, final false
static inline int32_t GetFoldoutDepth(::UnityEngine::UIElements::VisualElement*  element) ;

/// @brief Method GetUniqueName, addr 0x305fbd8, size 0x114, virtual false, abstract: false, final false
