...
/// @brief Method Equals, addr 0x3104438, size 0x98, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x31044d0, size 0x34, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UIElements::ManipulatorActivationFilter  other) ;

/// @brief Method GetHashCode, addr 0x3104504, size 0x84, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method HasModifiers, addr 0x31046d8, size 0x1f4, virtual false, abstract: false, final false
inline bool HasModifiers(::UnityEngine::UIElements::IMouseEvent*  e) ;

/// @brief Method HasModifiers, addr 0x3104a70, size 0x1f4, virtual false, abstract: false, final false
inline bool HasModifiers(::UnityEngine::UIElements::IPointerEvent*  e) ;

/// @brief Method MatchModifiers, addr 0x31048cc, size 0x54, virtual false, abstract: false, final false
inline bool MatchModifiers(bool  alt, bool  ctrl, bool  shift, bool  command) ;

/// @brief Method Matches, addr 0x3104588, size 0x150, virtual false, abstract: false, final false
inline bool Matches(::UnityEngine::UIElements::IMouseEvent*  e) ;

/// @brief Method Matches, addr 0x3104920, size 0x150, virtual false, abstract: false, final false
inline bool Matches(::UnityEngine::UIElements::IPointerEvent*  e) ;

/// @brief Method get_button, addr 0x3104410, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UIElements::MouseButton get_button() ;

/// @brief Method get_clickCount, addr 0x3104430, size 0x8, virtual false, abstract: false, final false
inline int32_t get_clickCount() ;

/// @brief Method get_modifiers, addr 0x3104420, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_button, addr 0x3104418, size 0x8, virtual false, abstract: false, final false
inline void set_button(::UnityEngine::UIElements::MouseButton  value) ;

/// @brief Method set_modifiers, addr 0x3104428, size 0x8, virtual false, abstract: false, final false
