...
/// @brief Method FlipLayoutAxes, addr 0x3159bb8, size 0x258, virtual false, abstract: false, final false
static inline void FlipLayoutAxes(::UnityEngine::RectTransform*  rect, bool  keepPositioning, bool  recursive) ;

/// @brief Method FlipLayoutOnAxis, addr 0x31598f8, size 0x2c0, virtual false, abstract: false, final false
static inline void FlipLayoutOnAxis(::UnityEngine::RectTransform*  rect, int32_t  axis, bool  keepPositioning, bool  recursive) ;

/// @brief Method GetTransposed, addr 0x3159e10, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 GetTransposed(::UnityEngine::Vector2  input) ;

/// @brief Method PixelAdjustPoint, addr 0x3158cf8, size 0xa4, virtual false, abstract: false, final false
...
/// @brief Method PixelAdjustPoint_Injected, addr 0x3158d9c, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method PixelAdjustRect, addr 0x3158df8, size 0xa0, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect PixelAdjustRect(::UnityEngine::RectTransform*  rectTransform, ::UnityEngine::Canvas*  canvas) ;

/// @brief Method PixelAdjustRect_Injected, addr 0x3158e98, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method PointInRectangle, addr 0x3158eec, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method PointInRectangle_Injected, addr 0x3158f94, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method RectangleContainsScreenPoint, addr 0x3158ff0, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method RectangleContainsScreenPoint, addr 0x31590c4, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method ScreenPointToLocalPointInRectangle, addr 0x315974c, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method ScreenPointToRay, addr 0x3159594, size 0x1b8, virtual false, abstract: false, final false
static inline ::UnityEngine::Ray ScreenPointToRay(::UnityEngine::Camera*  cam, ::UnityEngine::Vector2  screenPos) ;

/// @brief Method ScreenPointToWorldPointInRectangle, addr 0x3159170, size 0x424, virtual false, abstract: false, final false
...
/// @brief Method WorldToScreenPoint, addr 0x3159848, size 0xb0, virtual false, abstract: false, final false
