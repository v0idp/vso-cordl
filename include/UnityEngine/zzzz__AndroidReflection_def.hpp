...
/// @brief Method CreateInvocationError, addr 0x2f4d8e8, size 0xec, virtual false, abstract: false, final false
static inline ::System::IntPtr CreateInvocationError(::System::Exception*  ex, bool  methodNotFound) ;

/// @brief Method GetConstructorMember, addr 0x2f500ec, size 0x188, virtual false, abstract: false, final false
static inline ::System::IntPtr GetConstructorMember(::System::IntPtr  jclass, ::StringW  signature) ;

/// @brief Method GetFieldClass, addr 0x2f5066c, size 0x64, virtual false, abstract: false, final false
static inline ::System::IntPtr GetFieldClass(::System::IntPtr  field) ;

/// @brief Method GetFieldMember, addr 0x2f50470, size 0x1fc, virtual false, abstract: false, final false
static inline ::System::IntPtr GetFieldMember(::System::IntPtr  jclass, ::StringW  fieldName, ::StringW  signature, bool  isStatic) ;

/// @brief Method GetFieldSignature, addr 0x2f506d0, size 0xa8, virtual false, abstract: false, final false
static inline ::StringW GetFieldSignature(::System::IntPtr  field) ;

/// @brief Method GetMethodID, addr 0x2f50050, size 0x9c, virtual false, abstract: false, final false
static inline ::System::IntPtr GetMethodID(::StringW  clazz, ::StringW  methodName, ::StringW  signature) ;

/// @brief Method GetMethodMember, addr 0x2f50274, size 0x1fc, virtual false, abstract: false, final false
static inline ::System::IntPtr GetMethodMember(::System::IntPtr  jclass, ::StringW  methodName, ::StringW  signature, bool  isStatic) ;

/// @brief Method GetStaticMethodID, addr 0x2f4ffb4, size 0x9c, virtual false, abstract: false, final false
static inline ::System::IntPtr GetStaticMethodID(::StringW  clazz, ::StringW  methodName, ::StringW  signature) ;

/// @brief Method IsAssignableFrom, addr 0x2f4ff94, size 0x20, virtual false, abstract: false, final false
static inline bool IsAssignableFrom(::System::Type*  t, ::System::Type*  from) ;

/// @brief Method IsPrimitive, addr 0x2f4ff80, size 0x14, virtual false, abstract: false, final false
static inline bool IsPrimitive(::System::Type*  t) ;

/// @brief Method NewProxyInstance, addr 0x2f50778, size 0xe4, virtual false, abstract: false, final false
