...
/// @brief Method MoveNext, addr 0x2f88bd0, size 0xc, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::UnityEngine::CustomYieldInstruction* New_ctor() ;

/// @brief Method Reset, addr 0x2f88bdc, size 0x4, virtual true, abstract: false, final false
inline void Reset() ;

/// @brief Method .ctor, addr 0x2f88be0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Current, addr 0x2f88bc8, size 0x8, virtual true, abstract: false, final true
