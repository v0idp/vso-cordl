...
public:
// Declarations
/// @brief Method CreateInstance, addr 0x2f8ce28, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method CreateScriptableObject, addr 0x2f8cdec, size 0x3c, virtual false, abstract: false, final false
static inline void CreateScriptableObject(::UnityEngine::ScriptableObject*  self) ;

/// @brief Method CreateScriptableObjectInstanceFromType, addr 0x2f8ce68, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f8cd64, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
