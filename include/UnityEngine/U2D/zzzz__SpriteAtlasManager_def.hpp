...
/// @brief Method PostRegisteredAtlas, addr 0x2f97080, size 0x6c, virtual false, abstract: false, final false
static inline void PostRegisteredAtlas(::UnityEngine::U2D::SpriteAtlas*  spriteAtlas) ;

/// @brief Method Register, addr 0x2f970ec, size 0x3c, virtual false, abstract: false, final false
static inline void Register(::UnityEngine::U2D::SpriteAtlas*  spriteAtlas) ;

/// @brief Method RequestAtlas, addr 0x2f96e2c, size 0xb4, virtual false, abstract: false, final false
static inline bool RequestAtlas(::StringW  tag) ;

/// @brief Method add_atlasRegistered, addr 0x2f96ee0, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method remove_atlasRegistered, addr 0x2f96fb0, size 0xd0, virtual false, abstract: false, final false
