...
/// @brief Method Backspace, addr 0x2fb9f04, size 0xbc, virtual false, abstract: false, final false
inline bool Backspace() ;

/// @brief Method CanPaste, addr 0x2fbaa40, size 0x84, virtual false, abstract: false, final false
inline bool CanPaste() ;

/// @brief Method Cut, addr 0x2fb9fc0, size 0x24, virtual false, abstract: false, final false
inline bool Cut() ;

/// @brief Method Delete, addr 0x2fb9e48, size 0xbc, virtual false, abstract: false, final false
inline bool Delete() ;

/// @brief Method DeleteLineBack, addr 0x2fba16c, size 0xf8, virtual false, abstract: false, final false
inline bool DeleteLineBack() ;

/// @brief Method DeleteSelection, addr 0x2fba3ac, size 0x1a8, virtual false, abstract: false, final false
inline bool DeleteSelection() ;

/// @brief Method DeleteWordBack, addr 0x2fba0b0, size 0xbc, virtual false, abstract: false, final false
inline bool DeleteWordBack() ;

/// @brief Method DeleteWordForward, addr 0x2fba264, size 0xbc, virtual false, abstract: false, final false
inline bool DeleteWordForward() ;

/// @brief Method EnableCursorPreviewState, addr 0x2fb8394, size 0xc8, virtual false, abstract: false, final false
inline void EnableCursorPreviewState() ;

/// @brief Method GeneratePreviewString, addr 0x2fb8238, size 0x11c, virtual false, abstract: false, final false
inline ::StringW GeneratePreviewString(bool  richText) ;

/// @brief Method HandleKeyEvent, addr 0x2fb845c, size 0x188, virtual false, abstract: false, final false
inline bool HandleKeyEvent(::UnityEngine::Event*  e) ;

/// @brief Method InitKeyActions, addr 0x2fb85e4, size 0x638, virtual false, abstract: false, final false
inline void InitKeyActions() ;

/// @brief Method Insert, addr 0x2fba9cc, size 0x74, virtual false, abstract: false, final false
inline void Insert(char16_t  c) ;

/// @brief Method MapKey, addr 0x2fba320, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method OnBlur, addr 0x2fbac0c, size 0x24, virtual false, abstract: false, final false
inline void OnBlur() ;

/// @brief Method Paste, addr 0x2fb9fe4, size 0xcc, virtual false, abstract: false, final false
inline bool Paste() ;

/// @brief Method PerformOperation, addr 0x2fb8c1c, size 0x308, virtual false, abstract: false, final false
inline void PerformOperation(::UnityEngine::TextEditOp  operation) ;

/// @brief Method ReplaceNewlinesWithSpaces, addr 0x2fbab78, size 0x94, virtual false, abstract: false, final false
static inline ::StringW ReplaceNewlinesWithSpaces(::StringW  value) ;

/// @brief Method ReplaceSelection, addr 0x2fb8108, size 0x88, virtual false, abstract: false, final false
inline void ReplaceSelection(::StringW  replace) ;

/// @brief Method RestoreCursorState, addr 0x2fb8354, size 0x40, virtual false, abstract: false, final false
inline void RestoreCursorState() ;

/// @brief Method SetImeWindowPosition, addr 0x2fb8198, size 0xa0, virtual false, abstract: false, final false
inline void SetImeWindowPosition(::UnityEngine::Vector2  worldPosition) ;

/// @brief Method ShouldUpdateImeWindowPosition, addr 0x2fb8190, size 0x8, virtual false, abstract: false, final false
inline bool ShouldUpdateImeWindowPosition() ;

/// @brief Method TouchScreenKeyboardShouldBeUsed, addr 0x2fbac7c, size 0x84, virtual false, abstract: false, final false
inline bool TouchScreenKeyboardShouldBeUsed() ;

/// @brief Method UpdateImeState, addr 0x2fb8034, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fb7fec, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method get_cursorIndex, addr 0x2fb7e50, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_cursorIndex() ;

/// @brief Method get_hasSelection, addr 0x2fb7d5c, size 0x44, virtual false, abstract: false, final false
inline bool get_hasSelection() ;

/// @brief Method get_selectIndex, addr 0x2fb7ee4, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_selectIndex() ;

/// @brief Method get_text, addr 0x2fb7f78, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_cursorIndex, addr 0x2fb7e74, size 0x44, virtual false, abstract: false, final false
inline void set_cursorIndex(int32_t  value) ;

/// @brief Method set_revealCursor, addr 0x2fb7dd8, size 0x48, virtual false, abstract: false, final false
inline void set_revealCursor(bool  value) ;

/// @brief Method set_selectIndex, addr 0x2fb7f08, size 0x44, virtual false, abstract: false, final false
inline void set_selectIndex(int32_t  value) ;

/// @brief Method set_text, addr 0x2fb7f80, size 0x6c, virtual false, abstract: false, final false
