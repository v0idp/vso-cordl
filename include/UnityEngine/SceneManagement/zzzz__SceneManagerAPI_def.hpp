...
/// @brief Method LoadFirstScene, addr 0x2f99ffc, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::AsyncOperation* LoadFirstScene(bool  mustLoadAsync) ;

/// @brief Method LoadSceneAsyncByNameOrIndex, addr 0x2f99f9c, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f99f94, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ActiveAPI, addr 0x2f99e94, size 0xa8, virtual false, abstract: false, final false
static inline ::UnityEngine::SceneManagement::SceneManagerAPI* get_ActiveAPI() ;

/// @brief Method get_overrideAPI, addr 0x2f99f3c, size 0x58, virtual false, abstract: false, final false
