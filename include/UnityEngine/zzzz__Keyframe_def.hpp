...
/// @brief Method .ctor, addr 0x2f5c480, size 0x10, virtual false, abstract: false, final false
inline void _ctor(float_t  time, float_t  value) ;

/// @brief Method .ctor, addr 0x2f5c490, size 0x14, virtual false, abstract: false, final false
inline void _ctor(float_t  time, float_t  value, float_t  inTangent, float_t  outTangent) ;

/// @brief Method get_time, addr 0x2f5c4a4, size 0x8, virtual false, abstract: false, final false
