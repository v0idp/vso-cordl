...
/// @brief Method Equals, addr 0x2f839bc, size 0x9c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x2f83a58, size 0x38, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Vector3Int  other) ;

/// @brief Method GetHashCode, addr 0x2f83a90, size 0x78, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x2f83b08, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2f83b18, size 0x1c0, virtual true, abstract: false, final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method .ctor, addr 0x2f83980, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_x, addr 0x2f83950, size 0x8, virtual false, abstract: false, final false
inline int32_t get_x() ;

/// @brief Method get_y, addr 0x2f83960, size 0x8, virtual false, abstract: false, final false
inline int32_t get_y() ;

/// @brief Method get_z, addr 0x2f83970, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2f8398c, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method set_x, addr 0x2f83958, size 0x8, virtual false, abstract: false, final false
inline void set_x(int32_t  value) ;

/// @brief Method set_y, addr 0x2f83968, size 0x8, virtual false, abstract: false, final false
inline void set_y(int32_t  value) ;

/// @brief Method set_z, addr 0x2f83978, size 0x8, virtual false, abstract: false, final false
