...
/// @brief Method .ctor, addr 0x2f875b8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  order) ;

/// @brief Method get_order, addr 0x2f872dc, size 0x8, virtual false, abstract: false, final false
