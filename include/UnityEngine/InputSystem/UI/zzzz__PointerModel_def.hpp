...
/// @brief Method CopyPressStateFrom, addr 0x2e53944, size 0x74, virtual false, abstract: false, final false
inline void CopyPressStateFrom(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method CopyPressStateTo, addr 0x2e5222c, size 0xac, virtual false, abstract: false, final false
inline void CopyPressStateTo(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnEndFrame, addr 0x2e57f1c, size 0xc, virtual false, abstract: false, final false
inline void OnEndFrame() ;

/// @brief Method get_clickedOnSameGameObject, addr 0x2e57f54, size 0x8, virtual false, abstract: false, final false
inline bool get_clickedOnSameGameObject() ;

/// @brief Method get_ignoreNextClick, addr 0x2e57f30, size 0x8, virtual false, abstract: false, final false
inline bool get_ignoreNextClick() ;

/// @brief Method get_isPressed, addr 0x2e57f28, size 0x8, virtual false, abstract: false, final false
inline bool get_isPressed() ;

/// @brief Method get_pressTime, addr 0x2e57f44, size 0x8, virtual false, abstract: false, final false
inline float_t get_pressTime() ;

/// @brief Method get_wasPressedThisFrame, addr 0x2e53934, size 0x10, virtual false, abstract: false, final false
inline bool get_wasPressedThisFrame() ;

/// @brief Method get_wasReleasedThisFrame, addr 0x2e53120, size 0x14, virtual false, abstract: false, final false
inline bool get_wasReleasedThisFrame() ;

/// @brief Method set_clickedOnSameGameObject, addr 0x2e57f5c, size 0xc, virtual false, abstract: false, final false
inline void set_clickedOnSameGameObject(bool  value) ;

/// @brief Method set_ignoreNextClick, addr 0x2e57f38, size 0xc, virtual false, abstract: false, final false
inline void set_ignoreNextClick(bool  value) ;

/// @brief Method set_isPressed, addr 0x2e56dc4, size 0x54, virtual false, abstract: false, final false
inline void set_isPressed(bool  value) ;

/// @brief Method set_pressTime, addr 0x2e57f4c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CopyTouchOrPenStateFrom, addr 0x2e57504, size 0xc8, virtual false, abstract: false, final false
inline void CopyTouchOrPenStateFrom(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnFrameFinished, addr 0x2e57768, size 0x48, virtual false, abstract: false, final false
inline void OnFrameFinished() ;

/// @brief Method .ctor, addr 0x2e56748, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::UI::ExtendedPointerEventData*  eventData) ;

/// @brief Method get_altitudeAngle, addr 0x2e57e80, size 0x8, virtual false, abstract: false, final false
inline float_t get_altitudeAngle() ;

/// @brief Method get_azimuthAngle, addr 0x2e57e58, size 0x8, virtual false, abstract: false, final false
inline float_t get_azimuthAngle() ;

/// @brief Method get_pointerType, addr 0x2e52324, size 0x1c, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::UI::UIPointerType get_pointerType() ;

/// @brief Method get_pressure, addr 0x2e57e30, size 0x8, virtual false, abstract: false, final false
inline float_t get_pressure() ;

/// @brief Method get_radius, addr 0x2e57ed0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_radius() ;

/// @brief Method get_screenPosition, addr 0x2e57df4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_screenPosition() ;

/// @brief Method get_scrollDelta, addr 0x2e57e24, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_scrollDelta() ;

/// @brief Method get_twist, addr 0x2e57ea8, size 0x8, virtual false, abstract: false, final false
inline float_t get_twist() ;

/// @brief Method get_worldOrientation, addr 0x2e57e10, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_worldOrientation() ;

/// @brief Method get_worldPosition, addr 0x2e57e00, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_worldPosition() ;

/// @brief Method set_altitudeAngle, addr 0x2e57e88, size 0x20, virtual false, abstract: false, final false
inline void set_altitudeAngle(float_t  value) ;

/// @brief Method set_azimuthAngle, addr 0x2e57e60, size 0x20, virtual false, abstract: false, final false
inline void set_azimuthAngle(float_t  value) ;

/// @brief Method set_pressure, addr 0x2e57e38, size 0x20, virtual false, abstract: false, final false
inline void set_pressure(float_t  value) ;

/// @brief Method set_radius, addr 0x2e57edc, size 0x40, virtual false, abstract: false, final false
inline void set_radius(::UnityEngine::Vector2  value) ;

/// @brief Method set_screenPosition, addr 0x2e56708, size 0x40, virtual false, abstract: false, final false
inline void set_screenPosition(::UnityEngine::Vector2  value) ;

/// @brief Method set_scrollDelta, addr 0x2e570d0, size 0x40, virtual false, abstract: false, final false
inline void set_scrollDelta(::UnityEngine::Vector2  value) ;

/// @brief Method set_twist, addr 0x2e57eb0, size 0x20, virtual false, abstract: false, final false
inline void set_twist(float_t  value) ;

/// @brief Method set_worldOrientation, addr 0x2e57218, size 0x58, virtual false, abstract: false, final false
inline void set_worldOrientation(::UnityEngine::Quaternion  value) ;

/// @brief Method set_worldPosition, addr 0x2e57318, size 0x54, virtual false, abstract: false, final false
