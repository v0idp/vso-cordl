...
/// @brief Method ToString, addr 0x2e50424, size 0xbc, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2e5041c, size 0x8, virtual false, abstract: false, final false
