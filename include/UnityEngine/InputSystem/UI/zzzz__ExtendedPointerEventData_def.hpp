...
/// @brief Method GetPenPointerId, addr 0x2e50dec, size 0x250, virtual false, abstract: false, final false
static inline int32_t GetPenPointerId(::UnityEngine::InputSystem::Pen*  pen) ;

/// @brief Method GetTouchPointerId, addr 0x2e5103c, size 0xf8, virtual false, abstract: false, final false
static inline int32_t GetTouchPointerId(::UnityEngine::InputSystem::Controls::TouchControl*  touchControl) ;

/// @brief Method MakePointerIdForTouch, addr 0x2e50b24, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ReadDeviceState, addr 0x2e50b34, size 0x2b8, virtual false, abstract: false, final false
inline void ReadDeviceState() ;

/// @brief Method ToString, addr 0x2e50580, size 0x5a4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TouchIdFromPointerId, addr 0x2e50b2c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e504e0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::EventSystems::EventSystem*  eventSystem) ;

/// @brief Method get_control, addr 0x2e504e8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputControl* get_control() ;

/// @brief Method get_device, addr 0x2e504f8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputDevice* get_device() ;

/// @brief Method get_pointerType, addr 0x2e50518, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::UI::UIPointerType get_pointerType() ;

/// @brief Method get_touchId, addr 0x2e50508, size 0x8, virtual false, abstract: false, final false
inline int32_t get_touchId() ;

/// @brief Method get_trackedDeviceOrientation, addr 0x2e50558, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_trackedDeviceOrientation() ;

/// @brief Method get_trackedDevicePosition, addr 0x2e50538, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_trackedDevicePosition() ;

/// @brief Method get_uiToolkitPointerId, addr 0x2e50528, size 0x8, virtual false, abstract: false, final false
inline int32_t get_uiToolkitPointerId() ;

/// @brief Method set_control, addr 0x2e504f0, size 0x8, virtual false, abstract: false, final false
inline void set_control(::UnityEngine::InputSystem::InputControl*  value) ;

/// @brief Method set_device, addr 0x2e50500, size 0x8, virtual false, abstract: false, final false
inline void set_device(::UnityEngine::InputSystem::InputDevice*  value) ;

/// @brief Method set_pointerType, addr 0x2e50520, size 0x8, virtual false, abstract: false, final false
inline void set_pointerType(::UnityEngine::InputSystem::UI::UIPointerType  value) ;

/// @brief Method set_touchId, addr 0x2e50510, size 0x8, virtual false, abstract: false, final false
inline void set_touchId(int32_t  value) ;

/// @brief Method set_trackedDeviceOrientation, addr 0x2e5056c, size 0x14, virtual false, abstract: false, final false
inline void set_trackedDeviceOrientation(::UnityEngine::Quaternion  value) ;

/// @brief Method set_trackedDevicePosition, addr 0x2e50548, size 0x10, virtual false, abstract: false, final false
inline void set_trackedDevicePosition(::UnityEngine::Vector3  value) ;

/// @brief Method set_uiToolkitPointerId, addr 0x2e50530, size 0x8, virtual false, abstract: false, final false
