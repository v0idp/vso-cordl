...
/// @brief Method InitializePlayerRoot, addr 0x2e57bac, size 0xc4, virtual false, abstract: false, final false
inline void InitializePlayerRoot() ;

static inline ::UnityEngine::InputSystem::UI::MultiplayerEventSystem* New_ctor() ;

/// @brief Method OnDisable, addr 0x2e57c8c, size 0x8, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x2e57c70, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Update, addr 0x2e57c94, size 0x108, virtual true, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x2e57d9c, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_playerRoot, addr 0x2e57b9c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_playerRoot() ;

/// @brief Method set_playerRoot, addr 0x2e57ba4, size 0x8, virtual false, abstract: false, final false
