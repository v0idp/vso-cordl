...
/// @brief Method .ctor, addr 0x2e50414, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_compositionString, addr 0x2e5040c, size 0x8, virtual true, abstract: false, final false
