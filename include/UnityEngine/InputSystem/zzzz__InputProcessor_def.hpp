...
/// @brief Method GetValueTypeFromType, addr 0x2de10a0, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2de1198, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::Utilities::TypeTable getStaticF_s_Processors() ;

/// @brief Method get_cachingPolicy, addr 0x2de1190, size 0x8, virtual true, abstract: false, final false
