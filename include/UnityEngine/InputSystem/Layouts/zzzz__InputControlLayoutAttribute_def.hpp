...
/// @brief Method .ctor, addr 0x2e85a84, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_canRunInBackground, addr 0x2e858dc, size 0x48, virtual false, abstract: false, final false
inline bool get_canRunInBackground() ;

/// @brief Method get_commonUsages, addr 0x2e858a8, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_commonUsages() ;

/// @brief Method get_description, addr 0x2e85a60, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_description() ;

/// @brief Method get_displayName, addr 0x2e85a50, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_displayName() ;

/// @brief Method get_hideInUI, addr 0x2e85a70, size 0x8, virtual false, abstract: false, final false
inline bool get_hideInUI() ;

/// @brief Method get_isGenericTypeOfDevice, addr 0x2e85a3c, size 0x8, virtual false, abstract: false, final false
inline bool get_isGenericTypeOfDevice() ;

/// @brief Method get_isNoisy, addr 0x2e858c8, size 0x8, virtual false, abstract: false, final false
inline bool get_isNoisy() ;

/// @brief Method get_stateFormat, addr 0x2e85898, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_stateFormat() ;

/// @brief Method get_stateType, addr 0x2e85888, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_stateType() ;

/// @brief Method get_updateBeforeRender, addr 0x2e8598c, size 0x48, virtual false, abstract: false, final false
inline bool get_updateBeforeRender() ;

/// @brief Method get_variants, addr 0x2e858b8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_variants() ;

/// @brief Method set_canRunInBackground, addr 0x2e85924, size 0x68, virtual false, abstract: false, final false
inline void set_canRunInBackground(bool  value) ;

/// @brief Method set_commonUsages, addr 0x2e858b0, size 0x8, virtual false, abstract: false, final false
inline void set_commonUsages(::ArrayW<::StringW,::Array<::StringW>*>  value) ;

/// @brief Method set_description, addr 0x2e85a68, size 0x8, virtual false, abstract: false, final false
inline void set_description(::StringW  value) ;

/// @brief Method set_displayName, addr 0x2e85a58, size 0x8, virtual false, abstract: false, final false
inline void set_displayName(::StringW  value) ;

/// @brief Method set_hideInUI, addr 0x2e85a78, size 0xc, virtual false, abstract: false, final false
inline void set_hideInUI(bool  value) ;

/// @brief Method set_isGenericTypeOfDevice, addr 0x2e85a44, size 0xc, virtual false, abstract: false, final false
inline void set_isGenericTypeOfDevice(bool  value) ;

/// @brief Method set_isNoisy, addr 0x2e858d0, size 0xc, virtual false, abstract: false, final false
inline void set_isNoisy(bool  value) ;

/// @brief Method set_stateFormat, addr 0x2e858a0, size 0x8, virtual false, abstract: false, final false
inline void set_stateFormat(::StringW  value) ;

/// @brief Method set_stateType, addr 0x2e85890, size 0x8, virtual false, abstract: false, final false
inline void set_stateType(::System::Type*  value) ;

/// @brief Method set_updateBeforeRender, addr 0x2e859d4, size 0x68, virtual false, abstract: false, final false
inline void set_updateBeforeRender(bool  value) ;

/// @brief Method set_variants, addr 0x2e858c0, size 0x8, virtual false, abstract: false, final false
