...
/// @brief Method ComparePropertyToDeviceDescriptor, addr 0x2dbbfb8, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x2dbbc3c, size 0x98, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2dbbb8c, size 0xb0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::Layouts::InputDeviceDescription  other) ;

/// @brief Method FromJson, addr 0x2dbbef4, size 0xc4, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Layouts::InputDeviceDescription FromJson(::StringW  json) ;

/// @brief Method GetHashCode, addr 0x2dbbcd4, size 0x130, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToJson, addr 0x2dbbe78, size 0x7c, virtual false, abstract: false, final false
inline ::StringW ToJson() ;

/// @brief Method ToString, addr 0x2dbb940, size 0x24c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_capabilities, addr 0x2dbb8ac, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_capabilities() ;

/// @brief Method get_deviceClass, addr 0x2dbb85c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_deviceClass() ;

/// @brief Method get_empty, addr 0x2dbb8bc, size 0x84, virtual false, abstract: false, final false
inline bool get_empty() ;

/// @brief Method get_interfaceName, addr 0x2dbb84c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_interfaceName() ;

/// @brief Method get_manufacturer, addr 0x2dbb86c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_manufacturer() ;

/// @brief Method get_product, addr 0x2dbb87c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_product() ;

/// @brief Method get_serial, addr 0x2dbb88c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_serial() ;

/// @brief Method get_version, addr 0x2dbb89c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2dbbe04, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x2dbbe3c, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method set_capabilities, addr 0x2dbb8b4, size 0x8, virtual false, abstract: false, final false
inline void set_capabilities(::StringW  value) ;

/// @brief Method set_deviceClass, addr 0x2dbb864, size 0x8, virtual false, abstract: false, final false
inline void set_deviceClass(::StringW  value) ;

/// @brief Method set_interfaceName, addr 0x2dbb854, size 0x8, virtual false, abstract: false, final false
inline void set_interfaceName(::StringW  value) ;

/// @brief Method set_manufacturer, addr 0x2dbb874, size 0x8, virtual false, abstract: false, final false
inline void set_manufacturer(::StringW  value) ;

/// @brief Method set_product, addr 0x2dbb884, size 0x8, virtual false, abstract: false, final false
inline void set_product(::StringW  value) ;

/// @brief Method set_serial, addr 0x2dbb894, size 0x8, virtual false, abstract: false, final false
inline void set_serial(::StringW  value) ;

/// @brief Method set_version, addr 0x2dbb8a4, size 0x8, virtual false, abstract: false, final false
