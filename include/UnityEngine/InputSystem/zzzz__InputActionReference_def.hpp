...
/// @brief Method Create, addr 0x2dab0a8, size 0x6c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::InputSystem::InputActionReference> Create(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method GetDisplayName, addr 0x2daad3c, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method ResetCachedAction, addr 0x2dab114, size 0x10c, virtual false, abstract: false, final false
static inline void ResetCachedAction() ;

/// @brief Method Set, addr 0x2daa8bc, size 0x100, virtual false, abstract: false, final false
inline void Set(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method Set, addr 0x2daab2c, size 0x210, virtual false, abstract: false, final false
inline void Set(::UnityEngine::InputSystem::InputActionAsset*  asset, ::StringW  mapName, ::StringW  actionName) ;

/// @brief Method SetInternal, addr 0x2daa9bc, size 0x170, virtual false, abstract: false, final false
inline void SetInternal(::UnityEngine::InputSystem::InputActionAsset*  asset, ::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method ToDisplayName, addr 0x2dab060, size 0x3c, virtual false, abstract: false, final false
inline ::StringW ToDisplayName() ;

/// @brief Method ToInputAction, addr 0x2dab220, size 0x4, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputAction* ToInputAction() ;

/// @brief Method ToString, addr 0x2daae18, size 0x248, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dab224, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_action, addr 0x2daa4cc, size 0xac, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputAction* get_action() ;

/// @brief Method get_asset, addr 0x2daa8b4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::InputSystem::InputActionAsset> get_asset() ;

/// @brief Method op_Implicit, addr 0x2dab09c, size 0xc, virtual false, abstract: false, final false
