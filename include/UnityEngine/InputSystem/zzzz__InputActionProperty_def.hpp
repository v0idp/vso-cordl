...
/// @brief Method Equals, addr 0x2daa6e8, size 0xcc, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2daa660, size 0x1c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::InputAction*  other) ;

/// @brief Method Equals, addr 0x2daa5bc, size 0xa4, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::InputActionProperty  other) ;

/// @brief Method Equals, addr 0x2daa67c, size 0x6c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::InputActionReference*  other) ;

/// @brief Method GetHashCode, addr 0x2daa7b4, size 0x9c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x2daa5a0, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method .ctor, addr 0x2daa5ac, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::InputActionReference*  reference) ;

/// @brief Method get_action, addr 0x2daa438, size 0x94, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputAction* get_action() ;

/// @brief Method get_reference, addr 0x2daa578, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::InputSystem::InputActionReference> get_reference() ;

/// @brief Method get_serializedAction, addr 0x2daa590, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputAction* get_serializedAction() ;

/// @brief Method get_serializedReference, addr 0x2daa598, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2daa850, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x2daa880, size 0x34, virtual false, abstract: false, final false
