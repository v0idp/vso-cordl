...
/// @brief Method FinishSetup, addr 0x2de6be4, size 0x1a8, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x2de6b0c, size 0x54, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::Pointer* New_ctor() ;

/// @brief Method OnNextUpdate, addr 0x2de6d8c, size 0x88, virtual false, abstract: false, final false
inline void OnNextUpdate() ;

/// @brief Method OnRemoved, addr 0x2de6b60, size 0x84, virtual true, abstract: false, final false
inline void OnRemoved() ;

/// @brief Method OnStateEvent, addr 0x2de6e14, size 0x4c, virtual false, abstract: false, final false
inline void OnStateEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr  eventPtr) ;

/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.GetStateOffsetForEvent, addr 0x2de6e68, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnNextUpdate, addr 0x2de6e60, size 0x4, virtual true, abstract: false, final true
inline void UnityEngine_InputSystem_LowLevel_IInputStateCallbackReceiver_OnNextUpdate() ;

/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnStateEvent, addr 0x2de6e64, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2de6e70, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::Pointer* getStaticF__current_k__BackingField() ;

/// @brief Method get_current, addr 0x2de6a78, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Pointer* get_current() ;

/// @brief Method get_delta, addr 0x2de6a28, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::DeltaControl* get_delta() ;

/// @brief Method get_displayIndex, addr 0x2de6a68, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_displayIndex() ;

/// @brief Method get_position, addr 0x2de6a18, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::Vector2Control* get_position() ;

/// @brief Method get_press, addr 0x2de6a58, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_press() ;

/// @brief Method get_pressure, addr 0x2de6a48, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_pressure() ;

/// @brief Method get_radius, addr 0x2de6a38, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_current, addr 0x2de6ac0, size 0x4c, virtual false, abstract: false, final false
static inline void set_current(::UnityEngine::InputSystem::Pointer*  value) ;

/// @brief Method set_delta, addr 0x2de6a30, size 0x8, virtual false, abstract: false, final false
inline void set_delta(::UnityEngine::InputSystem::Controls::DeltaControl*  value) ;

/// @brief Method set_displayIndex, addr 0x2de6a70, size 0x8, virtual false, abstract: false, final false
inline void set_displayIndex(::UnityEngine::InputSystem::Controls::IntegerControl*  value) ;

/// @brief Method set_position, addr 0x2de6a20, size 0x8, virtual false, abstract: false, final false
inline void set_position(::UnityEngine::InputSystem::Controls::Vector2Control*  value) ;

/// @brief Method set_press, addr 0x2de6a60, size 0x8, virtual false, abstract: false, final false
inline void set_press(::UnityEngine::InputSystem::Controls::ButtonControl*  value) ;

/// @brief Method set_pressure, addr 0x2de6a50, size 0x8, virtual false, abstract: false, final false
inline void set_pressure(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

/// @brief Method set_radius, addr 0x2de6a40, size 0x8, virtual false, abstract: false, final false
