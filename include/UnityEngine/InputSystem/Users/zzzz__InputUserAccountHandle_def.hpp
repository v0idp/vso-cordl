...
/// @brief Method Equals, addr 0x2e50220, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2e50170, size 0xb0, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::Users::InputUserAccountHandle  other) ;

/// @brief Method GetHashCode, addr 0x2e502c8, size 0x58, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x2e500ac, size 0xc4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2e50030, size 0x7c, virtual false, abstract: false, final false
inline void _ctor(::StringW  apiName, uint64_t  handle) ;

/// @brief Method get_apiName, addr 0x2e50020, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_apiName() ;

/// @brief Method get_handle, addr 0x2e50028, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2e4feb8, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x2e50298, size 0x30, virtual false, abstract: false, final false
