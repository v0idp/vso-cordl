...
/// @brief Method Process, addr 0x2e7b3f4, size 0x68, virtual true, abstract: false, final false
inline float_t Process(float_t  value, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToString, addr 0x2e7b45c, size 0xa8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e7b504, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_maxOrDefault, addr 0x2e7b384, size 0x70, virtual false, abstract: false, final false
inline float_t get_maxOrDefault() ;

/// @brief Method get_minOrDefault, addr 0x2e7b314, size 0x70, virtual false, abstract: false, final false
