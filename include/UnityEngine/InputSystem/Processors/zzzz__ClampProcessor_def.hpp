...
/// @brief Method Process, addr 0x2e7b54c, size 0x18, virtual true, abstract: false, final false
inline float_t Process(float_t  value, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToString, addr 0x2e7b564, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e7b604, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
