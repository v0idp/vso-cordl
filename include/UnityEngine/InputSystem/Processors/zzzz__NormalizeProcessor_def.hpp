...
/// @brief Method Denormalize, addr 0x2e7bf3c, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method Normalize, addr 0x2e7be6c, size 0xd0, virtual false, abstract: false, final false
static inline float_t Normalize(float_t  value, float_t  min, float_t  max, float_t  zero) ;

/// @brief Method Process, addr 0x2e7be60, size 0xc, virtual true, abstract: false, final false
inline float_t Process(float_t  value, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToString, addr 0x2e7bf84, size 0xc4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e7c048, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
