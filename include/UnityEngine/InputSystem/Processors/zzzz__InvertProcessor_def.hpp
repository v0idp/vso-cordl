...
/// @brief Method Process, addr 0x2e7bb6c, size 0x8, virtual true, abstract: false, final false
inline float_t Process(float_t  value, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToString, addr 0x2e7bb74, size 0x40, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2e7bbb4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
