...
/// @brief Method Process, addr 0x2e7bd10, size 0x34, virtual true, abstract: false, final false
inline ::UnityEngine::Vector3 Process(::UnityEngine::Vector3  value, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToString, addr 0x2e7bd44, size 0xc4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e7be08, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
