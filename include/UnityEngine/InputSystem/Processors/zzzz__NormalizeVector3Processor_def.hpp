...
/// @brief Method Process, addr 0x2e7c1cc, size 0xd0, virtual true, abstract: false, final false
inline ::UnityEngine::Vector3 Process(::UnityEngine::Vector3  value, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ToString, addr 0x2e7c29c, size 0x40, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2e7c2dc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
