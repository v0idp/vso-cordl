...
/// @brief Method PauseHaptics, addr 0x2e6a0b8, size 0x10c, virtual false, abstract: false, final false
inline void PauseHaptics(::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method ResetHaptics, addr 0x2e6a3dc, size 0x8c, virtual false, abstract: false, final false
inline void ResetHaptics(::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method ResumeHaptics, addr 0x2e6a214, size 0x88, virtual false, abstract: false, final false
inline void ResumeHaptics(::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method SetMotorSpeeds, addr 0x2e6a29c, size 0x140, virtual false, abstract: false, final false
inline void SetMotorSpeeds(::UnityEngine::InputSystem::InputDevice*  device, float_t  lowFrequency, float_t  highFrequency) ;

/// @brief Method get_highFrequencyMotorSpeed, addr 0x2e69ff0, size 0x8, virtual false, abstract: false, final false
inline float_t get_highFrequencyMotorSpeed() ;

/// @brief Method get_isRumbling, addr 0x2e6a000, size 0xb8, virtual false, abstract: false, final false
inline bool get_isRumbling() ;

/// @brief Method get_lowFrequencyMotorSpeed, addr 0x2e69fe0, size 0x8, virtual false, abstract: false, final false
inline float_t get_lowFrequencyMotorSpeed() ;

/// @brief Method set_highFrequencyMotorSpeed, addr 0x2e69ff8, size 0x8, virtual false, abstract: false, final false
inline void set_highFrequencyMotorSpeed(float_t  value) ;

/// @brief Method set_lowFrequencyMotorSpeed, addr 0x2e69fe8, size 0x8, virtual false, abstract: false, final false
