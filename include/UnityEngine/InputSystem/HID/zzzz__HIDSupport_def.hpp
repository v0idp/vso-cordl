...
public:
// Declarations
/// @brief Method .ctor, addr 0x2e62844, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::HID::HID_UsagePage  page, int32_t  usage) ;

/// @brief Method .ctor, addr 0x2e62994, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x2e6284c, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method get_supportedHIDUsages, addr 0x2e625b8, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method set_supportedHIDUsages, addr 0x2e62618, size 0x22c, virtual false, abstract: false, final false
