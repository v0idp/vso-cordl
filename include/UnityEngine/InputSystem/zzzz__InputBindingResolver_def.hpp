...
/// @brief Method AddActionMap, addr 0x2db9870, size 0x15a4, virtual false, abstract: false, final false
inline void AddActionMap(::UnityEngine::InputSystem::InputActionMap*  actionMap) ;

/// @brief Method ApplyParameters, addr 0x2dbb2d0, size 0x4f0, virtual false, abstract: false, final false
...
/// @brief Method AssignCompositePartIndex, addr 0x2dbb0a0, size 0x230, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x2db9740, size 0x48, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method InstantiateBindingComposite, addr 0x2dbae14, size 0x28c, virtual false, abstract: false, final false
...
/// @brief Method StartWithPreviousResolve, addr 0x2db9788, size 0xe8, virtual false, abstract: false, final false
inline void StartWithPreviousResolve(::UnityEngine::InputSystem::InputActionState*  state, bool  isFullResolve) ;

/// @brief Method get_totalActionCount, addr 0x2db9728, size 0x8, virtual false, abstract: false, final false
inline int32_t get_totalActionCount() ;

/// @brief Method get_totalBindingCount, addr 0x2db9730, size 0x8, virtual false, abstract: false, final false
inline int32_t get_totalBindingCount() ;

/// @brief Method get_totalControlCount, addr 0x2db9738, size 0x8, virtual false, abstract: false, final false
inline int32_t get_totalControlCount() ;

/// @brief Method get_totalMapCount, addr 0x2db9720, size 0x8, virtual false, abstract: false, final false
