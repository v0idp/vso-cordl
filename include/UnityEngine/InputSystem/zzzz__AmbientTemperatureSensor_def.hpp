...
/// @brief Method FinishSetup, addr 0x2e26d68, size 0x78, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x2e26c90, size 0x54, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::AmbientTemperatureSensor* New_ctor() ;

/// @brief Method OnRemoved, addr 0x2e26ce4, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e26de0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::AmbientTemperatureSensor* getStaticF__current_k__BackingField() ;

/// @brief Method get_ambientTemperature, addr 0x2e26bec, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_ambientTemperature() ;

/// @brief Method get_current, addr 0x2e26bfc, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method set_ambientTemperature, addr 0x2e26bf4, size 0x8, virtual false, abstract: false, final false
inline void set_ambientTemperature(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

/// @brief Method set_current, addr 0x2e26c44, size 0x4c, virtual false, abstract: false, final false
