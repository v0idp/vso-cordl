...
/// @brief Method AddProcessor, addr 0x2dda68c, size 0x4, virtual true, abstract: false, final false
inline void AddProcessor(::System::Object*  first) ;

/// @brief Method ApplyParameterChanges, addr 0x2dd9b04, size 0xac, virtual false, abstract: false, final false
inline void ApplyParameterChanges() ;

/// @brief Method BakeOffsetIntoStateBlockRecursive, addr 0x2dda508, size 0xdc, virtual false, abstract: false, final false
inline void BakeOffsetIntoStateBlockRecursive(uint32_t  offset) ;

/// @brief Method CalculateOptimizedControlDataType, addr 0x2dd9afc, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::FourCC CalculateOptimizedControlDataType() ;

/// @brief Method CallFinishSetupRecursive, addr 0x2dda44c, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method DebuggerDisplay, addr 0x2dd934c, size 0x124, virtual false, abstract: false, final false
inline ::StringW DebuggerDisplay() ;

/// @brief Method EnsureOptimizationTypeHasNotChanged, addr 0x2dda000, size 0x37c, virtual false, abstract: false, final false
inline void EnsureOptimizationTypeHasNotChanged() ;

/// @brief Method EvaluateMagnitude, addr 0x2dd92b8, size 0x2c, virtual false, abstract: false, final false
inline float_t EvaluateMagnitude() ;

/// @brief Method EvaluateMagnitude, addr 0x2dd94fc, size 0x8, virtual true, abstract: false, final false
inline float_t EvaluateMagnitude(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method FinishSetup, addr 0x2dd9870, size 0x4, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method GetChildControl, addr 0x2dd9644, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method GetDeviceIndex, addr 0x2dd9894, size 0x154, virtual false, abstract: false, final false
inline int32_t GetDeviceIndex() ;

/// @brief Method IsValueConsideredPressed, addr 0x2dda5e4, size 0xa8, virtual false, abstract: false, final false
inline bool IsValueConsideredPressed(float_t  value) ;

/// @brief Method MakeChildPath, addr 0x2dd9758, size 0xac, virtual false, abstract: false, final false
inline ::StringW MakeChildPath(::StringW  path) ;

/// @brief Method MarkAsStale, addr 0x2dda690, size 0xc, virtual false, abstract: false, final false
inline void MarkAsStale() ;

/// @brief Method MarkAsStaleRecursively, addr 0x2dd9bb0, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method RefreshConfiguration, addr 0x2dd9890, size 0x4, virtual true, abstract: false, final false
inline void RefreshConfiguration() ;

/// @brief Method RefreshConfigurationIfNeeded, addr 0x2dd8d88, size 0x34, virtual false, abstract: false, final false
inline void RefreshConfigurationIfNeeded() ;

/// @brief Method SetOptimizedControlDataType, addr 0x2dd9d74, size 0x90, virtual false, abstract: false, final false
inline void SetOptimizedControlDataType() ;

/// @brief Method SetOptimizedControlDataTypeRecursively, addr 0x2dd9e04, size 0x1fc, virtual false, abstract: false, final false
inline void SetOptimizedControlDataTypeRecursively() ;

/// @brief Method ToString, addr 0x2dd92e4, size 0x68, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TryGetChildControl, addr 0x2dd95c4, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method WriteValueFromBufferIntoState, addr 0x2dd9504, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method WriteValueFromObjectIntoState, addr 0x2dd9564, size 0x60, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dd9804, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Item, addr 0x2dd91d4, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputControl* get_Item(::StringW  path) ;

/// @brief Method get_aliases, addr 0x2dd904c, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Utilities::InternedString> get_aliases() ;

/// @brief Method get_children, addr 0x2dd8f6c, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputControl*> get_children() ;

/// @brief Method get_currentStatePtr, addr 0x2dd94e8, size 0x14, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> get_currentStatePtr() ;

/// @brief Method get_defaultStatePtr, addr 0x2dd99fc, size 0x48, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> get_defaultStatePtr() ;

/// @brief Method get_device, addr 0x2dd8f5c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputDevice* get_device() ;

/// @brief Method get_displayName, addr 0x2dd8d30, size 0x58, virtual false, abstract: false, final false
inline ::StringW get_displayName() ;

/// @brief Method get_dontReset, addr 0x2dda3d4, size 0xc, virtual false, abstract: false, final false
inline bool get_dontReset() ;

/// @brief Method get_hasDefaultState, addr 0x2dda42c, size 0x20, virtual false, abstract: false, final false
inline bool get_hasDefaultState() ;

/// @brief Method get_isButton, addr 0x2dda3a8, size 0xc, virtual false, abstract: false, final false
inline bool get_isButton() ;

/// @brief Method get_isConfigUpToDate, addr 0x2dd9874, size 0xc, virtual false, abstract: false, final false
inline bool get_isConfigUpToDate() ;

/// @brief Method get_isSetupFinished, addr 0x2dda37c, size 0xc, virtual false, abstract: false, final false
inline bool get_isSetupFinished() ;

/// @brief Method get_layout, addr 0x2dd8f3c, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_layout() ;

/// @brief Method get_magnitude, addr 0x2dd92b4, size 0x4, virtual false, abstract: false, final false
inline float_t get_magnitude() ;

/// @brief Method get_name, addr 0x2dd8d20, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_noiseMaskPtr, addr 0x2dd9a44, size 0x48, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> get_noiseMaskPtr() ;

/// @brief Method get_noisy, addr 0x2dd90c8, size 0xc, virtual false, abstract: false, final false
inline bool get_noisy() ;

/// @brief Method get_optimizedControlDataType, addr 0x2dd9af4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::FourCC get_optimizedControlDataType() ;

/// @brief Method get_parent, addr 0x2dd8f64, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputControl* get_parent() ;

/// @brief Method get_path, addr 0x2dd8e10, size 0x40, virtual false, abstract: false, final false
inline ::StringW get_path() ;

/// @brief Method get_previousFrameStatePtr, addr 0x2dd99e8, size 0x14, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> get_previousFrameStatePtr() ;

/// @brief Method get_shortDisplayName, addr 0x2dd8dc4, size 0x44, virtual false, abstract: false, final false
inline ::StringW get_shortDisplayName() ;

/// @brief Method get_stateBlock, addr 0x2dd90bc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputStateBlock get_stateBlock() ;

/// @brief Method get_stateOffsetRelativeToDeviceRoot, addr 0x2dd9a8c, size 0x68, virtual false, abstract: false, final false
inline uint32_t get_stateOffsetRelativeToDeviceRoot() ;

/// @brief Method get_synthetic, addr 0x2dd91a8, size 0xc, virtual false, abstract: false, final false
inline bool get_synthetic() ;

/// @brief Method get_usages, addr 0x2dd8fdc, size 0x70, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Utilities::InternedString> get_usages() ;

/// @brief Method get_usesStateFromOtherControl, addr 0x2dda400, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_variants, addr 0x2dd8f4c, size 0x10, virtual false, abstract: false, final false
inline ::StringW get_variants() ;

/// @brief Method set_displayName, addr 0x2dd8dbc, size 0x8, virtual false, abstract: false, final false
inline void set_displayName(::StringW  value) ;

/// @brief Method set_dontReset, addr 0x2dda3e0, size 0x20, virtual false, abstract: false, final false
inline void set_dontReset(bool  value) ;

/// @brief Method set_isButton, addr 0x2dda3b4, size 0x20, virtual false, abstract: false, final false
inline void set_isButton(bool  value) ;

/// @brief Method set_isConfigUpToDate, addr 0x2dd9880, size 0x10, virtual false, abstract: false, final false
inline void set_isConfigUpToDate(bool  value) ;

/// @brief Method set_isSetupFinished, addr 0x2dda388, size 0x20, virtual false, abstract: false, final false
inline void set_isSetupFinished(bool  value) ;

/// @brief Method set_noisy, addr 0x2dd90d4, size 0xd4, virtual false, abstract: false, final false
inline void set_noisy(bool  value) ;

/// @brief Method set_shortDisplayName, addr 0x2dd8e08, size 0x8, virtual false, abstract: false, final false
inline void set_shortDisplayName(::StringW  value) ;

/// @brief Method set_synthetic, addr 0x2dd91b4, size 0x20, virtual false, abstract: false, final false
inline void set_synthetic(bool  value) ;

/// @brief Method set_usesStateFromOtherControl, addr 0x2dda40c, size 0x20, virtual false, abstract: false, final false
