...
/// @brief Method EnqueueRumble, addr 0x2e4a40c, size 0xa8, virtual false, abstract: false, final false
inline void EnqueueRumble(::ArrayW<uint8_t,::Array<uint8_t>*>  samples) ;

/// @brief Method .ctor, addr 0x2e4a274, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method get_capabilities, addr 0x2e4a23c, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::XR::Haptics::HapticCapabilities get_capabilities() ;

/// @brief Method get_device, addr 0x2e4a264, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputDevice* get_device() ;

/// @brief Method set_capabilities, addr 0x2e4a250, size 0x14, virtual false, abstract: false, final false
inline void set_capabilities(::UnityEngine::InputSystem::XR::Haptics::HapticCapabilities  value) ;

/// @brief Method set_device, addr 0x2e4a26c, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::XR::Haptics::BufferedRumble, 0x20>, "Size mismatch!");
