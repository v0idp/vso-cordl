...
/// @brief Method .ctor, addr 0x2e4a618, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint32_t  samplesQueued, uint32_t  samplesAvailable) ;

/// @brief Method get_samplesAvailable, addr 0x2e4a630, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_samplesAvailable() ;

/// @brief Method get_samplesQueued, addr 0x2e4a620, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_samplesQueued() ;

/// @brief Method set_samplesAvailable, addr 0x2e4a638, size 0x8, virtual false, abstract: false, final false
inline void set_samplesAvailable(uint32_t  value) ;

/// @brief Method set_samplesQueued, addr 0x2e4a628, size 0x8, virtual false, abstract: false, final false
