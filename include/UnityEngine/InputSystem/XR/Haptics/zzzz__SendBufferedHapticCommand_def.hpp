...
// Dependencies UnityEngine.InputSystem.LowLevel.IInputDeviceCommandInfo, UnityEngine.InputSystem.LowLevel.InputDeviceCommand, UnityEngine.InputSystem.XR.Haptics.SendBufferedHapticCommand::<buffer>e__FixedBuffer
namespace UnityEngine::InputSystem::XR::Haptics {
// Is value type: true
...
/// @brief Method Create, addr 0x2e4a4b4, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x2e4a7bc, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic, addr 0x2e4a7ec, size 0x30, virtual true, abstract: false, final true
