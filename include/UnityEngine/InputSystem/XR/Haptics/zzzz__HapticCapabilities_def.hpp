...
/// @brief Method .ctor, addr 0x2e4a718, size 0x14, virtual false, abstract: false, final false
inline void _ctor(uint32_t  numChannels, uint32_t  frequencyHz, uint32_t  maxBufferSize) ;

/// @brief Method .ctor, addr 0x2e4a6f8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method get_frequencyHz, addr 0x2e4a744, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_frequencyHz() ;

/// @brief Method get_maxBufferSize, addr 0x2e4a74c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_maxBufferSize() ;

/// @brief Method get_numChannels, addr 0x2e4a72c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_numChannels() ;

/// @brief Method get_optimalBufferSize, addr 0x2e4a754, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_optimalBufferSize() ;

/// @brief Method get_supportsBuffer, addr 0x2e4a73c, size 0x8, virtual false, abstract: false, final false
inline bool get_supportsBuffer() ;

/// @brief Method get_supportsImpulse, addr 0x2e4a734, size 0x8, virtual false, abstract: false, final false
