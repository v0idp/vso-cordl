...
/// @brief Method <OnFindLayoutForDevice>b__0, addr 0x2e49090, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e480f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Build, addr 0x2e48424, size 0xad0, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Layouts::InputControlLayout* Build() ;

/// @brief Method ConvertPotentialAliasToName, addr 0x2e48100, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method GetParentControlName, addr 0x2e48298, size 0x38, virtual false, abstract: false, final false
inline ::StringW GetParentControlName(::StringW  name) ;

/// @brief Method GetSizeOfFeature, addr 0x2e47b54, size 0x78, virtual false, abstract: false, final false
static inline uint32_t GetSizeOfFeature(::UnityEngine::InputSystem::XR::XRFeatureDescriptor  featureDescriptor) ;

/// @brief Method IsPoseControl, addr 0x2e482d0, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method IsSubControl, addr 0x2e4827c, size 0x1c, virtual false, abstract: false, final false
inline bool IsSubControl(::StringW  name) ;

static inline ::UnityEngine::InputSystem::XR::XRLayoutBuilder* New_ctor() ;

/// @brief Method OnFindLayoutForDevice, addr 0x2e47d28, size 0x3c8, virtual false, abstract: false, final false
...
/// @brief Method SanitizeString, addr 0x2e47bcc, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e480f8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
