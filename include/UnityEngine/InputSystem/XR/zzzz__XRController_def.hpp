...
public:
// Declarations
/// @brief Method FinishSetup, addr 0x2e46160, size 0xf8, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::InputSystem::XR::XRController* New_ctor() ;

/// @brief Method .ctor, addr 0x2e462a0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_leftHand, addr 0x2e46020, size 0xa0, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::XR::XRController* get_leftHand() ;

/// @brief Method get_rightHand, addr 0x2e460c0, size 0xa0, virtual false, abstract: false, final false
