...
/// @brief Method get_fixationPoint, addr 0x2e49158, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_fixationPoint() ;

/// @brief Method get_leftEyeOpenAmount, addr 0x2e49170, size 0x8, virtual false, abstract: false, final false
inline float_t get_leftEyeOpenAmount() ;

/// @brief Method get_leftEyePosition, addr 0x2e490f8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_leftEyePosition() ;

/// @brief Method get_leftEyeRotation, addr 0x2e49110, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_leftEyeRotation() ;

/// @brief Method get_rightEyeOpenAmount, addr 0x2e49180, size 0x8, virtual false, abstract: false, final false
inline float_t get_rightEyeOpenAmount() ;

/// @brief Method get_rightEyePosition, addr 0x2e49128, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_rightEyePosition() ;

/// @brief Method get_rightEyeRotation, addr 0x2e49140, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_rightEyeRotation() ;

/// @brief Method set_fixationPoint, addr 0x2e49164, size 0xc, virtual false, abstract: false, final false
inline void set_fixationPoint(::UnityEngine::Vector3  value) ;

/// @brief Method set_leftEyeOpenAmount, addr 0x2e49178, size 0x8, virtual false, abstract: false, final false
inline void set_leftEyeOpenAmount(float_t  value) ;

/// @brief Method set_leftEyePosition, addr 0x2e49104, size 0xc, virtual false, abstract: false, final false
inline void set_leftEyePosition(::UnityEngine::Vector3  value) ;

/// @brief Method set_leftEyeRotation, addr 0x2e4911c, size 0xc, virtual false, abstract: false, final false
inline void set_leftEyeRotation(::UnityEngine::Quaternion  value) ;

/// @brief Method set_rightEyeOpenAmount, addr 0x2e49188, size 0x8, virtual false, abstract: false, final false
inline void set_rightEyeOpenAmount(float_t  value) ;

/// @brief Method set_rightEyePosition, addr 0x2e49134, size 0xc, virtual false, abstract: false, final false
inline void set_rightEyePosition(::UnityEngine::Vector3  value) ;

/// @brief Method set_rightEyeRotation, addr 0x2e4914c, size 0xc, virtual false, abstract: false, final false
