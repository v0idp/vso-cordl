...
/// @brief Method FinishSetup, addr 0x2e491c0, size 0x114, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::InputSystem::XR::BoneControl* New_ctor() ;

/// @brief Method ReadUnprocessedValueFromState, addr 0x2e492d4, size 0xf0, virtual true, abstract: false, final false
inline ::UnityEngine::InputSystem::XR::Bone ReadUnprocessedValueFromState(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x2e493c4, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e49448, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_parentBoneIndex, addr 0x2e49190, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::IntegerControl* get_parentBoneIndex() ;

/// @brief Method get_position, addr 0x2e491a0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_position() ;

/// @brief Method get_rotation, addr 0x2e491b0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::QuaternionControl* get_rotation() ;

/// @brief Method set_parentBoneIndex, addr 0x2e49198, size 0x8, virtual false, abstract: false, final false
inline void set_parentBoneIndex(::UnityEngine::InputSystem::Controls::IntegerControl*  value) ;

/// @brief Method set_position, addr 0x2e491a8, size 0x8, virtual false, abstract: false, final false
inline void set_position(::UnityEngine::InputSystem::Controls::Vector3Control*  value) ;

/// @brief Method set_rotation, addr 0x2e491b8, size 0x8, virtual false, abstract: false, final false
