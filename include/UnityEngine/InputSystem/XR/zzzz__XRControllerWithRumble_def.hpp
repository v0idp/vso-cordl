...
/// @brief Method SendImpulse, addr 0x2e462a8, size 0xac, virtual false, abstract: false, final false
inline void SendImpulse(float_t  amplitude, float_t  duration) ;

/// @brief Method .ctor, addr 0x2e463d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
