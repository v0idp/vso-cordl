...
/// @brief Method FinishSetup, addr 0x2e25990, size 0x78, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x2e258b8, size 0x54, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::Accelerometer* New_ctor() ;

/// @brief Method OnRemoved, addr 0x2e2590c, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e25a08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::Accelerometer* getStaticF__current_k__BackingField() ;

/// @brief Method get_acceleration, addr 0x2e25814, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::Vector3Control* get_acceleration() ;

/// @brief Method get_current, addr 0x2e25824, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method set_acceleration, addr 0x2e2581c, size 0x8, virtual false, abstract: false, final false
inline void set_acceleration(::UnityEngine::InputSystem::Controls::Vector3Control*  value) ;

/// @brief Method set_current, addr 0x2e2586c, size 0x4c, virtual false, abstract: false, final false
