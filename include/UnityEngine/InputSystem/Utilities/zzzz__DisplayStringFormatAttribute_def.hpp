...
/// @brief Method .ctor, addr 0x2dc5bbc, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  formatString) ;

/// @brief Method get_formatString, addr 0x2dc5bac, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_formatString() ;

/// @brief Method set_formatString, addr 0x2dc5bb4, size 0x8, virtual false, abstract: false, final false
