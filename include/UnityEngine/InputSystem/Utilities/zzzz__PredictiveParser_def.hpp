...
public:
// Declarations
/// @brief Method AcceptInt, addr 0x2dcc054, size 0x5c, virtual false, abstract: false, final false
inline void AcceptInt(::System::ReadOnlySpan_1<char16_t>  str) ;

/// @brief Method AcceptSingleChar, addr 0x2dcbeec, size 0x38, virtual false, abstract: false, final false
inline bool AcceptSingleChar(::System::ReadOnlySpan_1<char16_t>  str, char16_t  c) ;

/// @brief Method AcceptString, addr 0x2dcbf24, size 0x130, virtual false, abstract: false, final false
inline bool AcceptString(::System::ReadOnlySpan_1<char16_t>  input, ::ByRef<::System::ReadOnlySpan_1<char16_t>>  output) ;

/// @brief Method ExpectInt, addr 0x2dcbba0, size 0x124, virtual false, abstract: false, final false
inline int32_t ExpectInt(::System::ReadOnlySpan_1<char16_t>  str) ;

/// @brief Method ExpectSingleChar, addr 0x2dcbaa0, size 0x100, virtual false, abstract: false, final false
inline void ExpectSingleChar(::System::ReadOnlySpan_1<char16_t>  str, char16_t  c) ;

/// @brief Method ExpectString, addr 0x2dcbcc4, size 0x228, virtual false, abstract: false, final false
