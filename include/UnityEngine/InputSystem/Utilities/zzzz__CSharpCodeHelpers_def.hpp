...
public:
// Declarations
/// @brief Method IsEmptyOrProperIdentifier, addr 0x2dc54a4, size 0x2c, virtual false, abstract: false, final false
static inline bool IsEmptyOrProperIdentifier(::StringW  name) ;

/// @brief Method IsEmptyOrProperNamespaceName, addr 0x2dc54d0, size 0xd4, virtual false, abstract: false, final false
static inline bool IsEmptyOrProperNamespaceName(::StringW  name) ;

/// @brief Method IsProperIdentifier, addr 0x2dc5390, size 0x114, virtual false, abstract: false, final false
static inline bool IsProperIdentifier(::StringW  name) ;

/// @brief Method MakeIdentifier, addr 0x2dc55a4, size 0x244, virtual false, abstract: false, final false
static inline ::StringW MakeIdentifier(::StringW  name, ::StringW  suffix) ;

/// @brief Method MakeTypeName, addr 0x2dc57e8, size 0x108, virtual false, abstract: false, final false
