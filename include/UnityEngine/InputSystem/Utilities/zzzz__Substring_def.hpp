...
/// @brief Method Compare, addr 0x2dcf29c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method CompareTo, addr 0x2dcf200, size 0x1c, virtual true, abstract: false, final true
inline int32_t CompareTo(::UnityEngine::InputSystem::Utilities::Substring  other) ;

/// @brief Method Equals, addr 0x2dcf054, size 0xb4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2dcf138, size 0xc8, virtual false, abstract: false, final false
inline bool Equals(::StringW  other) ;

/// @brief Method Equals, addr 0x2dcf21c, size 0x80, virtual false, abstract: false, final false
inline bool Equals(::UnityEngine::InputSystem::Utilities::InternedString  other) ;

/// @brief Method Equals, addr 0x2dcf108, size 0x30, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::Utilities::Substring  other) ;

/// @brief Method GetHashCode, addr 0x2dcf400, size 0x50, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method StartsWith, addr 0x2dcf2c4, size 0xa0, virtual false, abstract: false, final false
inline bool StartsWith(::StringW  str) ;

/// @brief Method Substr, addr 0x2dcf364, size 0x34, virtual false, abstract: false, final false
inline ::StringW Substr(int32_t  index, int32_t  length) ;

/// @brief Method ToString, addr 0x2dcf398, size 0x68, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2dcf00c, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  str) ;

/// @brief Method .ctor, addr 0x2dcf02c, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  str, int32_t  index) ;

/// @brief Method .ctor, addr 0x2dceeb0, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  str, int32_t  index, int32_t  length) ;

/// @brief Method get_Item, addr 0x2dcf570, size 0x80, virtual false, abstract: false, final false
inline char16_t get_Item(int32_t  index) ;

/// @brief Method get_index, addr 0x2dcf568, size 0x8, virtual false, abstract: false, final false
inline int32_t get_index() ;

/// @brief Method get_isEmpty, addr 0x2dceffc, size 0x10, virtual false, abstract: false, final false
inline bool get_isEmpty() ;

/// @brief Method get_length, addr 0x2dcf560, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2dcf4e4, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2dcf488, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2dcf450, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x2dcf548, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x2dcf514, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x2dcf4b4, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x2dcf46c, size 0x1c, virtual false, abstract: false, final false
