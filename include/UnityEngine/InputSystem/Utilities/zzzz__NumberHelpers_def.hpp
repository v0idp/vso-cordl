...
public:
// Declarations
/// @brief Method AlignToMultipleOf, addr 0x2dcb448, size 0x1c, virtual false, abstract: false, final false
static inline int32_t AlignToMultipleOf(int32_t  number, int32_t  alignment) ;

/// @brief Method AlignToMultipleOf, addr 0x2dcb464, size 0x1c, virtual false, abstract: false, final false
static inline int64_t AlignToMultipleOf(int64_t  number, int64_t  alignment) ;

/// @brief Method AlignToMultipleOf, addr 0x2dcb480, size 0x1c, virtual false, abstract: false, final false
static inline uint32_t AlignToMultipleOf(uint32_t  number, uint32_t  alignment) ;

/// @brief Method Approximately, addr 0x2dcb49c, size 0x9c, virtual false, abstract: false, final false
static inline bool Approximately(double_t  a, double_t  b) ;

/// @brief Method IntToNormalizedFloat, addr 0x2dcb538, size 0x38, virtual false, abstract: false, final false
static inline float_t IntToNormalizedFloat(int32_t  value, int32_t  minValue, int32_t  maxValue) ;

/// @brief Method NormalizedFloatToInt, addr 0x2dcb570, size 0x50, virtual false, abstract: false, final false
static inline int32_t NormalizedFloatToInt(float_t  value, int32_t  intMinValue, int32_t  intMaxValue) ;

/// @brief Method NormalizedFloatToUInt, addr 0x2dcb5f8, size 0x48, virtual false, abstract: false, final false
static inline uint32_t NormalizedFloatToUInt(float_t  value, uint32_t  uintMinValue, uint32_t  uintMaxValue) ;

/// @brief Method RemapUIntBitsToNormalizeFloatToUIntBits, addr 0x2dcb640, size 0x6c, virtual false, abstract: false, final false
static inline uint32_t RemapUIntBitsToNormalizeFloatToUIntBits(uint32_t  value, uint32_t  inBitSize, uint32_t  outBitSize) ;

/// @brief Method UIntToNormalizedFloat, addr 0x2dcb5c0, size 0x38, virtual false, abstract: false, final false
