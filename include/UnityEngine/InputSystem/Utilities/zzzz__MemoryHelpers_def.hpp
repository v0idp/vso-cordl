...
/// @brief Method Overlap, addr 0x2dc980c, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dc97f8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(uint32_t  bitOffset, uint32_t  sizeInBits) ;

/// @brief Method .ctor, addr 0x2dc9800, size 0xc, virtual false, abstract: false, final false
inline void _ctor(uint32_t  byteOffset, uint32_t  bitOffset, uint32_t  sizeInBits) ;

/// @brief Method get_isEmpty, addr 0x2dc97e8, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method AlignNatural, addr 0x2dc9764, size 0x84, virtual false, abstract: false, final false
static inline uint32_t AlignNatural(uint32_t  offset, uint32_t  sizeInBytes) ;

/// @brief Method Compare, addr 0x2dc8f2c, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method ComputeFollowingByteOffset, addr 0x2dc90d4, size 0x10, virtual false, abstract: false, final false
static inline uint32_t ComputeFollowingByteOffset(uint32_t  byteOffset, uint32_t  sizeInBits) ;

/// @brief Method MemCmpBitRegion, addr 0x2dc8f8c, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method MemCpyBitRegion, addr 0x2dc9114, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method MemCpyMasked, addr 0x2dc92a0, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method MemSet, addr 0x2dc9204, size 0x9c, virtual false, abstract: false, final false
static inline void MemSet(::cordl_internals::Ptr<void>  destination, int32_t  numBytes, uint8_t  value) ;

/// @brief Method ReadExcessKMultipleBitsAsInt, addr 0x2dc94d0, size 0x24, virtual false, abstract: false, final false
static inline int32_t ReadExcessKMultipleBitsAsInt(::cordl_internals::Ptr<void>  ptr, uint32_t  bitOffset, uint32_t  bitCount) ;

/// @brief Method ReadMultipleBitsAsNormalizedUInt, addr 0x2dc9508, size 0x48, virtual false, abstract: false, final false
static inline float_t ReadMultipleBitsAsNormalizedUInt(::cordl_internals::Ptr<void>  ptr, uint32_t  bitOffset, uint32_t  bitCount) ;

/// @brief Method ReadMultipleBitsAsUInt, addr 0x2dc1b20, size 0x164, virtual false, abstract: false, final false
static inline uint32_t ReadMultipleBitsAsUInt(::cordl_internals::Ptr<void>  ptr, uint32_t  bitOffset, uint32_t  bitCount) ;

/// @brief Method ReadSingleBit, addr 0x2dc8f70, size 0x1c, virtual false, abstract: false, final false
static inline bool ReadSingleBit(::cordl_internals::Ptr<void>  ptr, uint32_t  bitOffset) ;

/// @brief Method ReadTwosComplementMultipleBitsAsInt, addr 0x2dbfb8c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method SetBitsInBuffer, addr 0x2dc95a0, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method WriteIntAsExcessKMultipleBits, addr 0x2dc94f4, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method WriteIntAsTwosComplementMultipleBits, addr 0x2dbfcc0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method WriteNormalizedUIntAsMultipleBits, addr 0x2dc9550, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method WriteSingleBit, addr 0x2dc90e4, size 0x30, virtual false, abstract: false, final false
static inline void WriteSingleBit(::cordl_internals::Ptr<void>  ptr, uint32_t  bitOffset, bool  value) ;

/// @brief Method WriteUIntAsMultipleBits, addr 0x2dc9324, size 0x1ac, virtual false, abstract: false, final false
