...
/// @brief Method FindTouch, addr 0x2e640cc, size 0x334, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::EnhancedTouch::Touch FindTouch(uint32_t  uniqueId) ;

/// @brief Method GetTouchHistory, addr 0x2e64400, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method OnTouchRecorded, addr 0x2e63e18, size 0x28c, virtual false, abstract: false, final false
inline void OnTouchRecorded(::UnityEngine::InputSystem::LowLevel::InputStateHistory_Record  record) ;

/// @brief Method ShouldRecordTouch, addr 0x2e63d30, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e639e0, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method get_currentTouch, addr 0x2e635e4, size 0xfc, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_currentTouch() ;

/// @brief Method get_index, addr 0x2e63564, size 0x8, virtual false, abstract: false, final false
inline int32_t get_index() ;

/// @brief Method get_isActive, addr 0x2e6356c, size 0x78, virtual false, abstract: false, final false
inline bool get_isActive() ;

/// @brief Method get_lastTouch, addr 0x2e637c0, size 0x78, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_lastTouch() ;

/// @brief Method get_screen, addr 0x2e6355c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Touchscreen* get_screen() ;

/// @brief Method get_screenPosition, addr 0x2e63728, size 0x98, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_screenPosition() ;

/// @brief Method get_touchHistory, addr 0x2e63970, size 0x34, virtual false, abstract: false, final false
