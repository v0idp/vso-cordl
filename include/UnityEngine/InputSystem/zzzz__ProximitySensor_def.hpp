...
/// @brief Method FinishSetup, addr 0x2e26970, size 0x78, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x2e26898, size 0x54, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::ProximitySensor* New_ctor() ;

/// @brief Method OnRemoved, addr 0x2e268ec, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e269e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::ProximitySensor* getStaticF__current_k__BackingField() ;

/// @brief Method get_current, addr 0x2e26804, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::ProximitySensor* get_current() ;

/// @brief Method get_distance, addr 0x2e267f4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_current, addr 0x2e2684c, size 0x4c, virtual false, abstract: false, final false
static inline void set_current(::UnityEngine::InputSystem::ProximitySensor*  value) ;

/// @brief Method set_distance, addr 0x2e267fc, size 0x8, virtual false, abstract: false, final false
