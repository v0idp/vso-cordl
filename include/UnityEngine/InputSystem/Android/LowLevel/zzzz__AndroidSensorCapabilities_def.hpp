...
public:
// Declarations
/// @brief Method FromJson, addr 0x2e69c6c, size 0x9c, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorCapabilities FromJson(::StringW  json) ;

/// @brief Method ToJson, addr 0x2e69c08, size 0x64, virtual false, abstract: false, final false
inline ::StringW ToJson() ;

/// @brief Method ToString, addr 0x2e69d08, size 0x98, virtual true, abstract: false, final false
