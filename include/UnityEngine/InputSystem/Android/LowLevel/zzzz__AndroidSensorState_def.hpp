...
/// @brief Method WithData, addr 0x2e69da0, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method get_format, addr 0x2e69ebc, size 0x58, virtual true, abstract: false, final true
