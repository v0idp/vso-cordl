...
/// @brief Method Process, addr 0x2e69fa4, size 0x34, virtual true, abstract: false, final false
inline ::UnityEngine::Quaternion Process(::UnityEngine::Quaternion  value, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method .ctor, addr 0x2e69fd8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
