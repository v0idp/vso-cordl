...
/// @brief Method Process, addr 0x2e69f80, size 0x1c, virtual true, abstract: false, final false
inline ::UnityEngine::Vector3 Process(::UnityEngine::Vector3  vector, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method .ctor, addr 0x2e69f9c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
