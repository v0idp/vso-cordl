...
/// @brief Method <MaskByGroups>b__45_0, addr 0x2db8b78, size 0x20, virtual false, abstract: false, final false
inline bool _MaskByGroups_b__45_0(::StringW  x) ;

/// @brief Method .ctor, addr 0x2db8b70, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Equals, addr 0x2db8274, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2db81a8, size 0xcc, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::InputBinding  other) ;

/// @brief Method GenerateId, addr 0x2dac910, size 0x34, virtual false, abstract: false, final false
inline void GenerateId() ;

/// @brief Method GetHashCode, addr 0x2db8350, size 0x104, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetNameOfComposite, addr 0x2db7f6c, size 0x44, virtual false, abstract: false, final false
inline ::StringW GetNameOfComposite() ;

/// @brief Method MaskByGroup, addr 0x2db7fbc, size 0x18, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::InputBinding MaskByGroup(::StringW  group) ;

/// @brief Method MaskByGroups, addr 0x2db7fd4, size 0x158, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::InputBinding MaskByGroups(::ArrayW<::StringW,::Array<::StringW>*>  groups) ;

/// @brief Method Matches, addr 0x2db8a0c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method Matches, addr 0x2db8a04, size 0x8, virtual false, abstract: false, final false
inline bool Matches(::UnityEngine::InputSystem::InputBinding  binding) ;

/// @brief Method RemoveOverrides, addr 0x2db7fb0, size 0xc, virtual false, abstract: false, final false
inline void RemoveOverrides() ;

/// @brief Method ToDisplayString, addr 0x2db8594, size 0x470, virtual false, abstract: false, final false
...
/// @brief Method ToDisplayString, addr 0x2db8568, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2db8454, size 0x114, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method TriggersAction, addr 0x2dad0a8, size 0x58, virtual false, abstract: false, final false
inline bool TriggersAction(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method .ctor, addr 0x2db7f4c, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, ::StringW  action, ::StringW  groups, ::StringW  processors, ::StringW  interactions, ::StringW  name) ;

/// @brief Method get_action, addr 0x2db7f14, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_action() ;

/// @brief Method get_effectiveInteractions, addr 0x2db812c, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_effectiveInteractions() ;

/// @brief Method get_effectivePath, addr 0x2db0a24, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_effectivePath() ;

/// @brief Method get_effectiveProcessors, addr 0x2db8144, size 0x18, virtual false, abstract: false, final false
inline ::StringW get_effectiveProcessors() ;

/// @brief Method get_groups, addr 0x2db7f04, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_groups() ;

/// @brief Method get_hasOverrides, addr 0x2db7f24, size 0x28, virtual false, abstract: false, final false
inline bool get_hasOverrides() ;

/// @brief Method get_id, addr 0x2db7e5c, size 0x48, virtual false, abstract: false, final false
inline ::System::Guid get_id() ;

/// @brief Method get_interactions, addr 0x2db7ec4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_interactions() ;

/// @brief Method get_isComposite, addr 0x2dad09c, size 0xc, virtual false, abstract: false, final false
inline bool get_isComposite() ;

/// @brief Method get_isEmpty, addr 0x2db815c, size 0x4c, virtual false, abstract: false, final false
inline bool get_isEmpty() ;

/// @brief Method get_isPartOfComposite, addr 0x2daf350, size 0xc, virtual false, abstract: false, final false
inline bool get_isPartOfComposite() ;

/// @brief Method get_name, addr 0x2db7e4c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_overrideInteractions, addr 0x2db7ed4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_overrideInteractions() ;

/// @brief Method get_overridePath, addr 0x2db7eb4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_overridePath() ;

/// @brief Method get_overrideProcessors, addr 0x2db7ef4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_overrideProcessors() ;

/// @brief Method get_path, addr 0x2db7ea4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_path() ;

/// @brief Method get_processors, addr 0x2db7ee4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2dafb38, size 0x34, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::InputSystem::InputBinding  left, ::UnityEngine::InputSystem::InputBinding  right) ;

/// @brief Method op_Inequality, addr 0x2db8304, size 0x4c, virtual false, abstract: false, final false
static inline bool op_Inequality(::UnityEngine::InputSystem::InputBinding  left, ::UnityEngine::InputSystem::InputBinding  right) ;

/// @brief Method set_action, addr 0x2db7f1c, size 0x8, virtual false, abstract: false, final false
inline void set_action(::StringW  value) ;

/// @brief Method set_groups, addr 0x2db7f0c, size 0x8, virtual false, abstract: false, final false
inline void set_groups(::StringW  value) ;

/// @brief Method set_id, addr 0x2dacd94, size 0x2c, virtual false, abstract: false, final false
inline void set_id(::System::Guid  value) ;

/// @brief Method set_interactions, addr 0x2db7ecc, size 0x8, virtual false, abstract: false, final false
inline void set_interactions(::StringW  value) ;

/// @brief Method set_isComposite, addr 0x2dac8e4, size 0x20, virtual false, abstract: false, final false
inline void set_isComposite(bool  value) ;

/// @brief Method set_isPartOfComposite, addr 0x2daf66c, size 0x20, virtual false, abstract: false, final false
inline void set_isPartOfComposite(bool  value) ;

/// @brief Method set_name, addr 0x2db7e54, size 0x8, virtual false, abstract: false, final false
inline void set_name(::StringW  value) ;

/// @brief Method set_overrideInteractions, addr 0x2db7edc, size 0x8, virtual false, abstract: false, final false
inline void set_overrideInteractions(::StringW  value) ;

/// @brief Method set_overridePath, addr 0x2db7ebc, size 0x8, virtual false, abstract: false, final false
inline void set_overridePath(::StringW  value) ;

/// @brief Method set_overrideProcessors, addr 0x2db7efc, size 0x8, virtual false, abstract: false, final false
inline void set_overrideProcessors(::StringW  value) ;

/// @brief Method set_path, addr 0x2db7eac, size 0x8, virtual false, abstract: false, final false
inline void set_path(::StringW  value) ;

/// @brief Method set_processors, addr 0x2db7eec, size 0x8, virtual false, abstract: false, final false
