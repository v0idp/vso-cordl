...
/// @brief Method .ctor, addr 0x2e43ff0, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x2e44098, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CheckIfPlayerCanJoin, addr 0x2e44444, size 0x2ec, virtual false, abstract: false, final false
inline bool CheckIfPlayerCanJoin(int32_t  playerIndex) ;

/// @brief Method DisableJoining, addr 0x2e43c0c, size 0xe4, virtual false, abstract: false, final false
inline void DisableJoining() ;

/// @brief Method EnableJoining, addr 0x2e43cf0, size 0x1d8, virtual false, abstract: false, final false
inline void EnableJoining() ;

/// @brief Method IsDeviceUsableWithPlayerActions, addr 0x2e44b34, size 0x3c4, virtual false, abstract: false, final false
inline bool IsDeviceUsableWithPlayerActions(::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method JoinPlayer, addr 0x2e44784, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method JoinPlayer, addr 0x2e44928, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method JoinPlayerFromAction, addr 0x2e44730, size 0x54, virtual false, abstract: false, final false
inline void JoinPlayerFromAction(::UnityEngine::InputSystem::InputAction_CallbackContext  context) ;

/// @brief Method JoinPlayerFromActionIfNotAlreadyJoined, addr 0x2e44840, size 0xe8, virtual false, abstract: false, final false
inline void JoinPlayerFromActionIfNotAlreadyJoined(::UnityEngine::InputSystem::InputAction_CallbackContext  context) ;

/// @brief Method JoinPlayerFromUI, addr 0x2e443f8, size 0x4c, virtual false, abstract: false, final false
inline void JoinPlayerFromUI() ;

static inline ::UnityEngine::InputSystem::PlayerInputManager* New_ctor() ;

/// @brief Method NotifyPlayerJoined, addr 0x2e41664, size 0x130, virtual false, abstract: false, final false
inline void NotifyPlayerJoined(::UnityEngine::InputSystem::PlayerInput*  player) ;

/// @brief Method NotifyPlayerLeft, addr 0x2e420f0, size 0x130, virtual false, abstract: false, final false
inline void NotifyPlayerLeft(::UnityEngine::InputSystem::PlayerInput*  player) ;

/// @brief Method OnDisable, addr 0x2e45238, size 0xdc, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x2e44ef8, size 0x340, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnUnpairedDeviceUsed, addr 0x2e44a80, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method UpdateSplitScreen, addr 0x2e435cc, size 0x564, virtual false, abstract: false, final false
inline void UpdateSplitScreen() ;

/// @brief Method ValidateInputActionAsset, addr 0x2e443f4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e45314, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_onPlayerJoined, addr 0x2e440e0, size 0x9c, virtual false, abstract: false, final false
inline void add_onPlayerJoined(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>*  value) ;

/// @brief Method add_onPlayerLeft, addr 0x2e44218, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method get_fixedNumberOfSplitScreens, addr 0x2e43b38, size 0x8, virtual false, abstract: false, final false
inline int32_t get_fixedNumberOfSplitScreens() ;

/// @brief Method get_instance, addr 0x2e44360, size 0x48, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::InputSystem::PlayerInputManager> get_instance() ;

/// @brief Method get_joinAction, addr 0x2e43ec8, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::InputActionProperty get_joinAction() ;

/// @brief Method get_joinBehavior, addr 0x2e43bb4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::PlayerJoinBehavior get_joinBehavior() ;

/// @brief Method get_joiningEnabled, addr 0x2e43bac, size 0x8, virtual false, abstract: false, final false
inline bool get_joiningEnabled() ;

/// @brief Method get_maintainAspectRatioInSplitScreen, addr 0x2e43b30, size 0x8, virtual false, abstract: false, final false
inline bool get_maintainAspectRatioInSplitScreen() ;

/// @brief Method get_maxPlayerCount, addr 0x2e43ba4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxPlayerCount() ;

/// @brief Method get_messages, addr 0x2e449e4, size 0x9c, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> get_messages() ;

/// @brief Method get_notificationBehavior, addr 0x2e43f80, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::PlayerNotifications get_notificationBehavior() ;

/// @brief Method get_playerCount, addr 0x2e43b4c, size 0x58, virtual false, abstract: false, final false
inline int32_t get_playerCount() ;

/// @brief Method get_playerJoinedEvent, addr 0x2e43f90, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::PlayerInputManager_PlayerJoinedEvent* get_playerJoinedEvent() ;

/// @brief Method get_playerLeftEvent, addr 0x2e44038, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::PlayerInputManager_PlayerLeftEvent* get_playerLeftEvent() ;

/// @brief Method get_playerPrefab, addr 0x2e44350, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_playerPrefab() ;

/// @brief Method get_splitScreen, addr 0x2e43390, size 0x8, virtual false, abstract: false, final false
inline bool get_splitScreen() ;

/// @brief Method get_splitScreenArea, addr 0x2e43b40, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_splitScreenArea() ;

/// @brief Method remove_onPlayerJoined, addr 0x2e4417c, size 0x9c, virtual false, abstract: false, final false
inline void remove_onPlayerJoined(::System::Action_1<::UnityW<::UnityEngine::InputSystem::PlayerInput>>*  value) ;

/// @brief Method remove_onPlayerLeft, addr 0x2e442b4, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method set_instance, addr 0x2e443a8, size 0x4c, virtual false, abstract: false, final false
static inline void set_instance(::UnityEngine::InputSystem::PlayerInputManager*  value) ;

/// @brief Method set_joinAction, addr 0x2e43edc, size 0xa4, virtual false, abstract: false, final false
inline void set_joinAction(::UnityEngine::InputSystem::InputActionProperty  value) ;

/// @brief Method set_joinBehavior, addr 0x2e43bbc, size 0x50, virtual false, abstract: false, final false
inline void set_joinBehavior(::UnityEngine::InputSystem::PlayerJoinBehavior  value) ;

/// @brief Method set_notificationBehavior, addr 0x2e43f88, size 0x8, virtual false, abstract: false, final false
inline void set_notificationBehavior(::UnityEngine::InputSystem::PlayerNotifications  value) ;

/// @brief Method set_playerPrefab, addr 0x2e44358, size 0x8, virtual false, abstract: false, final false
inline void set_playerPrefab(::UnityEngine::GameObject*  value) ;

/// @brief Method set_splitScreen, addr 0x2e43398, size 0x234, virtual false, abstract: false, final false
