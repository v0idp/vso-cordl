...
/// @brief Method FinishSetup, addr 0x2e26b6c, size 0x78, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x2e26a94, size 0x54, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::HumiditySensor* New_ctor() ;

/// @brief Method OnRemoved, addr 0x2e26ae8, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e26be4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::HumiditySensor* getStaticF__current_k__BackingField() ;

/// @brief Method get_current, addr 0x2e26a00, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::HumiditySensor* get_current() ;

/// @brief Method get_relativeHumidity, addr 0x2e269f0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_current, addr 0x2e26a48, size 0x4c, virtual false, abstract: false, final false
static inline void set_current(::UnityEngine::InputSystem::HumiditySensor*  value) ;

/// @brief Method set_relativeHumidity, addr 0x2e269f8, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::HumiditySensor, 0x190>, "Size mismatch!");
