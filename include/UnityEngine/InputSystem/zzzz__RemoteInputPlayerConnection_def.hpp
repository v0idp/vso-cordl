...
/// @brief Method Dispose, addr 0x2e25628, size 0x58, virtual true, abstract: false, final true
inline void Dispose() ;
...
/// @brief Method .ctor, addr 0x2e24f58, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Bind, addr 0x2e2462c, size 0x6b4, virtual false, abstract: false, final false
...
/// @brief Method OnChangeUsages, addr 0x2e2516c, size 0xc, virtual false, abstract: false, final false
inline void OnChangeUsages(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnConnected, addr 0x2e24ce0, size 0xdc, virtual false, abstract: false, final false
inline void OnConnected(int32_t  id) ;

/// @brief Method OnDisconnected, addr 0x2e2506c, size 0xd0, virtual false, abstract: false, final false
inline void OnDisconnected(int32_t  id) ;

/// @brief Method OnNewDevice, addr 0x2e2513c, size 0xc, virtual false, abstract: false, final false
inline void OnNewDevice(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnNewEvents, addr 0x2e25154, size 0xc, virtual false, abstract: false, final false
inline void OnNewEvents(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnNewLayout, addr 0x2e25148, size 0xc, virtual false, abstract: false, final false
inline void OnNewLayout(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnRemoveDevice, addr 0x2e25160, size 0xc, virtual false, abstract: false, final false
inline void OnRemoveDevice(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnStartSending, addr 0x2e25178, size 0xc, virtual false, abstract: false, final false
inline void OnStartSending(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method OnStopSending, addr 0x2e25184, size 0xc, virtual false, abstract: false, final false
inline void OnStopSending(::UnityEngine::Networking::PlayerConnection::MessageEventArgs*  args) ;

/// @brief Method SendToSubscribers, addr 0x2e24f60, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method Subscribe, addr 0x2e24dbc, size 0x19c, virtual true, abstract: false, final true
inline ::System::IDisposable* Subscribe(::System::IObserver_1<::UnityEngine::InputSystem::InputRemoting_Message>*  observer) ;

/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnCompleted, addr 0x2e25438, size 0x4, virtual true, abstract: false, final true
inline void System_IObserver_UnityEngine_InputSystem_InputRemoting_Message__OnCompleted() ;

/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnError, addr 0x2e25434, size 0x4, virtual true, abstract: false, final true
inline void System_IObserver_UnityEngine_InputSystem_InputRemoting_Message__OnError(::System::Exception*  error) ;

/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnNext, addr 0x2e25190, size 0x2a4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2e2543c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
