...
/// @brief Method FinishSetup, addr 0x2e26578, size 0x78, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x2e264a0, size 0x54, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::LightSensor* New_ctor() ;

/// @brief Method OnRemoved, addr 0x2e264f4, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e265f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::LightSensor* getStaticF__current_k__BackingField() ;

/// @brief Method get_current, addr 0x2e2640c, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LightSensor* get_current() ;

/// @brief Method get_lightLevel, addr 0x2e263fc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_current, addr 0x2e26454, size 0x4c, virtual false, abstract: false, final false
static inline void set_current(::UnityEngine::InputSystem::LightSensor*  value) ;

/// @brief Method set_lightLevel, addr 0x2e26404, size 0x8, virtual false, abstract: false, final false
