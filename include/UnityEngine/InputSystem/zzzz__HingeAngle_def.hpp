...
/// @brief Method FinishSetup, addr 0x2e27160, size 0x78, virtual true, abstract: false, final false
inline void FinishSetup() ;

/// @brief Method MakeCurrent, addr 0x2e27088, size 0x54, virtual true, abstract: false, final false
inline void MakeCurrent() ;

static inline ::UnityEngine::InputSystem::HingeAngle* New_ctor() ;

/// @brief Method OnRemoved, addr 0x2e270dc, size 0x84, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e271d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::HingeAngle* getStaticF__current_k__BackingField() ;

/// @brief Method get_angle, addr 0x2e26fe4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_angle() ;

/// @brief Method get_current, addr 0x2e26ff4, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method set_angle, addr 0x2e26fec, size 0x8, virtual false, abstract: false, final false
inline void set_angle(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

/// @brief Method set_current, addr 0x2e2703c, size 0x4c, virtual false, abstract: false, final false
