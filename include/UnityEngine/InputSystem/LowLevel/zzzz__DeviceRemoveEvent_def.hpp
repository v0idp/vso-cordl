...
/// @brief Method Create, addr 0x2e6caa4, size 0x70, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::DeviceRemoveEvent Create(int32_t  deviceId, double_t  time) ;

/// @brief Method ToEventPtr, addr 0x2e6caa0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_typeStatic, addr 0x2e6ca94, size 0xc, virtual true, abstract: false, final true
