...
/// @brief Method Create, addr 0x2e6b400, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x2e6b398, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_position, addr 0x2e6b3c8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_position() ;

/// @brief Method get_typeStatic, addr 0x2e6b3d0, size 0x30, virtual true, abstract: false, final true
