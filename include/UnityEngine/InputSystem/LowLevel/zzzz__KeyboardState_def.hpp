...
/// @brief Method Press, addr 0x2e6b8b0, size 0xc, virtual false, abstract: false, final false
inline void Press(::UnityEngine::InputSystem::Key  key) ;

/// @brief Method Release, addr 0x2e6b8bc, size 0xc, virtual false, abstract: false, final false
inline void Release(::UnityEngine::InputSystem::Key  key) ;

/// @brief Method Set, addr 0x2e6b8a4, size 0xc, virtual false, abstract: false, final false
inline void Set(::UnityEngine::InputSystem::Key  key, bool  state) ;

/// @brief Method .ctor, addr 0x2e6b7e0, size 0xc4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<::UnityEngine::InputSystem::Key,::Array<::UnityEngine::InputSystem::Key>*>  pressedKeys) ;

/// @brief Method get_Format, addr 0x2e6b7b0, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method get_format, addr 0x2e6b8c8, size 0x30, virtual true, abstract: false, final true
