...
/// @brief Method Create, addr 0x2e6cb20, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method get_typeStatic, addr 0x2e6cb14, size 0xc, virtual true, abstract: false, final true
