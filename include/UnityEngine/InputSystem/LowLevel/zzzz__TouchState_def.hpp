...
/// @brief Method ToString, addr 0x2e6bda8, size 0x2c0, virtual true, abstract: false, final false
...
/// @brief Method get_Format, addr 0x2e6bc60, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method get_beganInSameFrame, addr 0x2e640a4, size 0xc, virtual false, abstract: false, final false
inline bool get_beganInSameFrame() ;

/// @brief Method get_format, addr 0x2e6bd78, size 0x30, virtual true, abstract: false, final true
inline ::UnityEngine::InputSystem::Utilities::FourCC get_format() ;

/// @brief Method get_isInProgress, addr 0x2e6bcbc, size 0x28, virtual false, abstract: false, final false
inline bool get_isInProgress() ;

/// @brief Method get_isIndirectTouch, addr 0x2e6bd10, size 0xc, virtual false, abstract: false, final false
inline bool get_isIndirectTouch() ;

/// @brief Method get_isNoneEndedOrCanceled, addr 0x2e6bc98, size 0x24, virtual false, abstract: false, final false
inline bool get_isNoneEndedOrCanceled() ;

/// @brief Method get_isOrphanedPrimaryTouch, addr 0x2e6bce4, size 0xc, virtual false, abstract: false, final false
inline bool get_isOrphanedPrimaryTouch() ;

/// @brief Method get_isPrimaryTouch, addr 0x2e68484, size 0xc, virtual false, abstract: false, final false
inline bool get_isPrimaryTouch() ;

/// @brief Method get_isTap, addr 0x2e64c44, size 0xc, virtual false, abstract: false, final false
inline bool get_isTap() ;

/// @brief Method get_isTapPress, addr 0x2e6bd2c, size 0xc, virtual false, abstract: false, final false
inline bool get_isTapPress() ;

/// @brief Method get_isTapRelease, addr 0x2e63e0c, size 0xc, virtual false, abstract: false, final false
inline bool get_isTapRelease() ;

/// @brief Method get_phase, addr 0x2e6bc90, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::TouchPhase get_phase() ;

/// @brief Convert to "::UnityEngine::InputSystem::LowLevel::IInputStateTypeInfo"
constexpr ::UnityEngine::InputSystem::LowLevel::IInputStateTypeInfo* i___UnityEngine__InputSystem__LowLevel__IInputStateTypeInfo() ;

/// @brief Method set_beganInSameFrame, addr 0x2e640b0, size 0x1c, virtual false, abstract: false, final false
inline void set_beganInSameFrame(bool  value) ;

/// @brief Method set_isIndirectTouch, addr 0x2e6bd1c, size 0x10, virtual false, abstract: false, final false
inline void set_isIndirectTouch(bool  value) ;

/// @brief Method set_isOrphanedPrimaryTouch, addr 0x2e6bcf0, size 0x20, virtual false, abstract: false, final false
inline void set_isOrphanedPrimaryTouch(bool  value) ;

/// @brief Method set_isPrimaryTouch, addr 0x2e68464, size 0x20, virtual false, abstract: false, final false
inline void set_isPrimaryTouch(bool  value) ;

/// @brief Method set_isTap, addr 0x2e68490, size 0x20, virtual false, abstract: false, final false
inline void set_isTap(bool  value) ;

/// @brief Method set_isTapPress, addr 0x2e6bd38, size 0x20, virtual false, abstract: false, final false
inline void set_isTapPress(bool  value) ;

/// @brief Method set_isTapRelease, addr 0x2e6bd58, size 0x20, virtual false, abstract: false, final false
inline void set_isTapRelease(bool  value) ;

/// @brief Method set_phase, addr 0x2e66580, size 0x8, virtual false, abstract: false, final false
