...
// Dependencies UnityEngine.InputSystem.LowLevel.IInputEventTypeInfo, UnityEngine.InputSystem.LowLevel.InputEvent, UnityEngine.InputSystem.LowLevel.StateEvent::<stateData>e__FixedBuffer, UnityEngine.InputSystem.Utilities.FourCC
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
/// @brief Method From, addr 0x2e73030, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method From, addr 0x2e73038, size 0x334, virtual false, abstract: false, final false
...
/// @brief Method From, addr 0x2e6e898, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method FromDefaultStateFor, addr 0x2e7336c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method FromUnchecked, addr 0x2e6e6f4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ToEventPtr, addr 0x2e73020, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_state, addr 0x2e73018, size 0x8, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> get_state() ;

/// @brief Method get_stateSizeInBytes, addr 0x2e6e9bc, size 0xc, virtual false, abstract: false, final false
inline uint32_t get_stateSizeInBytes() ;

/// @brief Method get_typeStatic, addr 0x2e73024, size 0xc, virtual true, abstract: false, final true
