...
/// @brief Method Equals, addr 0x2e6eae8, size 0x88, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2e6ead0, size 0x18, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::InputSystem::LowLevel::InputEventPtr  other) ;

/// @brief Method From, addr 0x2e6eb90, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method FromInputEventPtr, addr 0x2e6eb94, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method GetHashCode, addr 0x2e6eb70, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method Next, addr 0x2e6ea9c, size 0x2c, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventPtr Next() ;

/// @brief Method ToPointer, addr 0x2e6eac8, size 0x8, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent> ToPointer() ;

/// @brief Method ToString, addr 0x2e6e6f8, size 0x90, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2e6e3e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent>  eventPtr) ;

/// @brief Method get_data, addr 0x2e6e644, size 0x8, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent> get_data() ;

/// @brief Method get_deviceId, addr 0x2e6e4a8, size 0x18, virtual false, abstract: false, final false
inline int32_t get_deviceId() ;

/// @brief Method get_handled, addr 0x2e6e3ec, size 0x1c, virtual false, abstract: false, final false
inline bool get_handled() ;

/// @brief Method get_id, addr 0x2e6e408, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_id() ;

/// @brief Method get_internalTime, addr 0x2e6e5cc, size 0x18, virtual false, abstract: false, final false
inline double_t get_internalTime() ;

/// @brief Method get_sizeInBytes, addr 0x2e6e490, size 0x18, virtual false, abstract: false, final false
inline uint32_t get_sizeInBytes() ;

/// @brief Method get_stateFormat, addr 0x2e6e64c, size 0xa8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::FourCC get_stateFormat() ;

/// @brief Method get_stateOffset, addr 0x2e6e9c8, size 0xd4, virtual false, abstract: false, final false
inline uint32_t get_stateOffset() ;

/// @brief Method get_stateSizeInBytes, addr 0x2e6e788, size 0x110, virtual false, abstract: false, final false
inline uint32_t get_stateSizeInBytes() ;

/// @brief Method get_time, addr 0x2e68404, size 0x60, virtual false, abstract: false, final false
inline double_t get_time() ;

/// @brief Method get_type, addr 0x2e63df4, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::FourCC get_type() ;

/// @brief Method get_valid, addr 0x2e63de4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2e6eb78, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x2e6d59c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x2e6def0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x2e6eb84, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_deviceId, addr 0x2e6e4c0, size 0x60, virtual false, abstract: false, final false
inline void set_deviceId(int32_t  value) ;

/// @brief Method set_handled, addr 0x2e67a5c, size 0x74, virtual false, abstract: false, final false
inline void set_handled(bool  value) ;

/// @brief Method set_id, addr 0x2e6e424, size 0x6c, virtual false, abstract: false, final false
inline void set_id(int32_t  value) ;

/// @brief Method set_internalTime, addr 0x2e6e5e4, size 0x60, virtual false, abstract: false, final false
inline void set_internalTime(double_t  value) ;

/// @brief Method set_time, addr 0x2e6e520, size 0xac, virtual false, abstract: false, final false
