...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x2e6a908, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x2e6a994, size 0x2c, virtual true, abstract: false, final false
inline int64_t EndInvoke(::ByRef<::UnityEngine::InputSystem::LowLevel::InputDeviceCommand>  command, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x2e6a8f4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e6a858, size 0x9c, virtual false, abstract: false, final false
