...
// Dependencies UnityEngine.InputSystem.LowLevel.DeltaStateEvent::<stateData>e__FixedBuffer, UnityEngine.InputSystem.LowLevel.IInputEventTypeInfo, UnityEngine.InputSystem.LowLevel.InputEvent, UnityEngine.InputSystem.Utilities.FourCC
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
/// @brief Method From, addr 0x2e6c5a8, size 0x368, virtual false, abstract: false, final false
...
/// @brief Method From, addr 0x2e6c480, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method FromUnchecked, addr 0x2e6c5a4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ToEventPtr, addr 0x2e6c47c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method get_deltaState, addr 0x2e6c468, size 0x8, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> get_deltaState() ;

/// @brief Method get_deltaStateSizeInBytes, addr 0x2e6c45c, size 0xc, virtual false, abstract: false, final false
inline uint32_t get_deltaStateSizeInBytes() ;

/// @brief Method get_typeStatic, addr 0x2e6c470, size 0xc, virtual true, abstract: false, final true
