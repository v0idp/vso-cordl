...
/// @brief Method GetBackBuffer, addr 0x2e785b8, size 0x14, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> GetBackBuffer(int32_t  deviceIndex) ;

/// @brief Method GetFrontBuffer, addr 0x2e78550, size 0x10, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> GetFrontBuffer(int32_t  deviceIndex) ;

/// @brief Method SetBackBuffer, addr 0x2e787c0, size 0x14, virtual false, abstract: false, final false
inline void SetBackBuffer(int32_t  deviceIndex, ::cordl_internals::Ptr<void>  ptr) ;

/// @brief Method SetFrontBuffer, addr 0x2e787b0, size 0x10, virtual false, abstract: false, final false
inline void SetFrontBuffer(int32_t  deviceIndex, ::cordl_internals::Ptr<void>  ptr) ;

/// @brief Method SwapBuffers, addr 0x2e78d54, size 0x28, virtual false, abstract: false, final false
inline void SwapBuffers(int32_t  deviceIndex) ;

/// @brief Method get_valid, addr 0x2e78d44, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method AllocateAll, addr 0x2e78630, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method ComputeSizeOfSingleStateBuffer, addr 0x2e786e4, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method FreeAll, addr 0x2e787d4, size 0xc0, virtual false, abstract: false, final false
inline void FreeAll() ;

/// @brief Method GetBackBufferForDevice, addr 0x2e78560, size 0x58, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> GetBackBufferForDevice(int32_t  deviceIndex) ;

/// @brief Method GetDoubleBuffersFor, addr 0x2e78428, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method GetFrontBufferForDevice, addr 0x2e784fc, size 0x54, virtual false, abstract: false, final false
static inline ::cordl_internals::Ptr<void> GetFrontBufferForDevice(int32_t  deviceIndex) ;

/// @brief Method MigrateAll, addr 0x2e78894, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method MigrateDoubleBuffer, addr 0x2e789ec, size 0x16c, virtual false, abstract: false, final false
...
/// @brief Method MigrateSingleBuffer, addr 0x2e78b58, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method NextDeviceOffset, addr 0x2e78c5c, size 0xe8, virtual false, abstract: false, final false
static inline uint32_t NextDeviceOffset(uint32_t  currentOffset, ::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method SetUpDeviceToBufferMappings, addr 0x2e78750, size 0x60, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers SetUpDeviceToBufferMappings(int32_t  deviceCount, ::ByRef<::cordl_internals::Ptr<uint8_t>>  bufferPtr, uint32_t  sizePerBuffer, uint32_t  mappingTableSizePerBuffer) ;

/// @brief Method SwitchTo, addr 0x2e785cc, size 0x64, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "sizePerBuffer", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "totalSize", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "defaultStateBuffer", ty: "::cordl_internals::Ptr<void>", modifiers: "", def_value: None }, CppParam { name: "noiseMaskBuffer", ty: "::cordl_internals::Ptr<void>", modifiers: "", def_value: None }, CppParam { name: "resetMaskBuffer", ty: "::cordl_internals::Ptr<void>", modifiers: "", def_value: None }, CppParam { name: "m_AllBuffers", ty: "::cordl_internals::Ptr<void>", modifiers: "", def_value: None }, CppParam { name: "m_PlayerStateBuffers", ty: "::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers", modifiers: "", def_value: None }]
