...
/// @brief Method WithButton, addr 0x2e6b9bc, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method get_Format, addr 0x2e6b98c, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method get_format, addr 0x2e6b9f0, size 0x30, virtual true, abstract: false, final true
