...
/// @brief Method OnBeforeUpdate, addr 0x2e73878, size 0x18, virtual false, abstract: false, final false
inline void OnBeforeUpdate() ;

/// @brief Method OnUpdate, addr 0x2e73918, size 0x1c, virtual false, abstract: false, final false
inline void OnUpdate() ;

/// @brief Method get_value, addr 0x2e73a58, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_value() ;

/// @brief Method set_value, addr 0x2e73a60, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method GetUpdateTypeForPlayer, addr 0x2e73a2c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method IsPlayerUpdate, addr 0x2e73a4c, size 0xc, virtual false, abstract: false, final false
static inline bool IsPlayerUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType  updateType) ;

/// @brief Method OnBeforeUpdate, addr 0x2e737f8, size 0x80, virtual false, abstract: false, final false
static inline void OnBeforeUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType  type) ;

/// @brief Method OnUpdate, addr 0x2e73890, size 0x88, virtual false, abstract: false, final false
static inline void OnUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateType  type) ;

/// @brief Method Restore, addr 0x2e73998, size 0x94, virtual false, abstract: false, final false
static inline void Restore(::UnityEngine::InputSystem::LowLevel::InputUpdate_SerializedState  state) ;

/// @brief Method Save, addr 0x2e73934, size 0x64, virtual false, abstract: false, final false
