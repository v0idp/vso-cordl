...
/// @brief Method AllocateNative, addr 0x2e6a9d4, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e6a4fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::Utilities::FourCC  type, int32_t  sizeInBytes) ;

/// @brief Method get_payloadPtr, addr 0x2e6a9cc, size 0x8, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<void> get_payloadPtr() ;

/// @brief Method get_payloadSizeInBytes, addr 0x2e6a9c0, size 0xc, virtual false, abstract: false, final false
inline int32_t get_payloadSizeInBytes() ;

/// @brief Method get_typeStatic, addr 0x2e6aa84, size 0x8, virtual true, abstract: false, final true
