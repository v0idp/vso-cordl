...
// Dependencies UnityEngine.InputSystem.LowLevel.IInputDeviceCommandInfo, UnityEngine.InputSystem.LowLevel.InputDeviceCommand, UnityEngine.InputSystem.LowLevel.QueryUserIdCommand::<idBuffer>e__FixedBuffer
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
/// @brief Method Create, addr 0x2e6b218, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::QueryUserIdCommand Create() ;

/// @brief Method ReadId, addr 0x2e6b1d8, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x2e6b1a8, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic, addr 0x2e6b1e8, size 0x30, virtual true, abstract: false, final true
