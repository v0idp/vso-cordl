...
/// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::LowLevel::InputStateHistory_1<TValue>*  owner, int32_t  index, ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputStateHistory_RecordHeader>  header) ;
...
// Dependencies System.Collections.Generic.IEnumerable`1<T>, System.Collections.Generic.IReadOnlyCollection`1<T>, System.Collections.Generic.IReadOnlyList`1<T>, System.Collections.IEnumerable, UnityEngine.InputSystem.LowLevel.InputStateHistory, UnityEngine.InputSystem.LowLevel.InputStateHistory`1::Record<TValue>
namespace UnityEngine::InputSystem::LowLevel {
// cpp template
template<typename TValue>
// Is value type: false
