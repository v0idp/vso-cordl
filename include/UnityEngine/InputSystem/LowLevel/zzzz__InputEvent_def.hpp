...
/// @brief Method Equals, addr 0x2e6d498, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method GetNextInMemory, addr 0x2e6d310, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method GetNextInMemoryChecked, addr 0x2e6d32c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2e6d0ac, size 0x264, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e6c910, size 0x104, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::InputSystem::Utilities::FourCC  type, int32_t  sizeInBytes, int32_t  deviceId, double_t  time) ;

/// @brief Method get_deviceId, addr 0x2e6cfb0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_deviceId() ;

/// @brief Method get_eventId, addr 0x2e6cf90, size 0xc, virtual false, abstract: false, final false
inline int32_t get_eventId() ;

/// @brief Method get_handled, addr 0x2e6d084, size 0xc, virtual false, abstract: false, final false
inline bool get_handled() ;

/// @brief Method get_internalTime, addr 0x2e6d074, size 0x8, virtual false, abstract: false, final false
inline double_t get_internalTime() ;

/// @brief Method get_sizeInBytes, addr 0x2e6c138, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_sizeInBytes() ;

/// @brief Method get_time, addr 0x2e6cfc0, size 0x54, virtual false, abstract: false, final false
inline double_t get_time() ;

/// @brief Method get_type, addr 0x2e6cee0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::FourCC get_type() ;

/// @brief Method set_deviceId, addr 0x2e6cfb8, size 0x8, virtual false, abstract: false, final false
inline void set_deviceId(int32_t  value) ;

/// @brief Method set_eventId, addr 0x2e6cf9c, size 0x14, virtual false, abstract: false, final false
inline void set_eventId(int32_t  value) ;

/// @brief Method set_handled, addr 0x2e6d090, size 0x1c, virtual false, abstract: false, final false
inline void set_handled(bool  value) ;

/// @brief Method set_internalTime, addr 0x2e6d07c, size 0x8, virtual false, abstract: false, final false
inline void set_internalTime(double_t  value) ;

/// @brief Method set_sizeInBytes, addr 0x2e6cef0, size 0xa0, virtual false, abstract: false, final false
inline void set_sizeInBytes(uint32_t  value) ;

/// @brief Method set_time, addr 0x2e6d014, size 0x60, virtual false, abstract: false, final false
inline void set_time(double_t  value) ;

/// @brief Method set_type, addr 0x2e6cee8, size 0x8, virtual false, abstract: false, final false
