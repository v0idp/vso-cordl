...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x2e73630, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x2e736ec, size 0x1c, virtual true, abstract: false, final false
inline void EndInvoke(::ByRef<::UnityEngine::InputSystem::LowLevel::InputEventBuffer>  eventBuffer, ::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x2e7361c, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e73590, size 0x8c, virtual false, abstract: false, final false
