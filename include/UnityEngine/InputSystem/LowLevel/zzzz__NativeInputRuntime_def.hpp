...
/// @brief Method .ctor, addr 0x2e7477c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <set_onBeforeUpdate>b__0, addr 0x2e74784, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e747a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <set_onShouldRunUpdate>b__0, addr 0x2e747b0, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e747d4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <set_onUpdate>b__0, addr 0x2e747dc, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method AllocateDeviceId, addr 0x2e73a68, size 0x50, virtual true, abstract: false, final true
inline int32_t AllocateDeviceId() ;

/// @brief Method DeviceCommand, addr 0x2e73b7c, size 0xc0, virtual true, abstract: false, final true
...
/// @brief Method OnFocusChanged, addr 0x2e744b4, size 0x28, virtual false, abstract: false, final false
inline void OnFocusChanged(bool  focus) ;

/// @brief Method OnShutdown, addr 0x2e74450, size 0x24, virtual false, abstract: false, final false
inline void OnShutdown() ;

/// @brief Method OnWantsToShutdown, addr 0x2e74474, size 0x40, virtual false, abstract: false, final false
inline bool OnWantsToShutdown() ;

/// @brief Method QueueEvent, addr 0x2e73b10, size 0x6c, virtual true, abstract: false, final true
inline void QueueEvent(::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent>  ptr) ;

/// @brief Method SendAnalytic, addr 0x2e7455c, size 0x1ac, virtual true, abstract: false, final true
inline void SendAnalytic(::UnityEngine::InputSystem::InputAnalytics_IInputAnalytic*  analytic) ;

/// @brief Method Update, addr 0x2e73ab8, size 0x58, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2e74708, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::LowLevel::NativeInputRuntime* getStaticF_instance() ;

/// @brief Method get_currentTime, addr 0x2e74300, size 0x50, virtual true, abstract: false, final true
inline double_t get_currentTime() ;

/// @brief Method get_currentTimeForFixedUpdate, addr 0x2e74350, size 0x2c, virtual true, abstract: false, final true
inline double_t get_currentTimeForFixedUpdate() ;

/// @brief Method get_currentTimeOffsetToRealtimeSinceStartup, addr 0x2e7437c, size 0x50, virtual true, abstract: false, final true
inline double_t get_currentTimeOffsetToRealtimeSinceStartup() ;

/// @brief Method get_isInBatchMode, addr 0x2e7450c, size 0x50, virtual true, abstract: false, final true
inline bool get_isInBatchMode() ;

/// @brief Method get_isPlayerFocused, addr 0x2e74240, size 0x50, virtual true, abstract: false, final true
inline bool get_isPlayerFocused() ;

/// @brief Method get_onBeforeUpdate, addr 0x2e73d50, size 0x8, virtual true, abstract: false, final true
inline ::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>* get_onBeforeUpdate() ;

/// @brief Method get_onDeviceDiscovered, addr 0x2e73f78, size 0x50, virtual true, abstract: false, final true
inline ::System::Action_2<int32_t,::StringW>* get_onDeviceDiscovered() ;

/// @brief Method get_onPlayerFocusChanged, addr 0x2e74130, size 0x8, virtual true, abstract: false, final true
inline ::System::Action_1<bool>* get_onPlayerFocusChanged() ;

/// @brief Method get_onShouldRunUpdate, addr 0x2e73e64, size 0x8, virtual true, abstract: false, final true
inline ::System::Func_2<::UnityEngine::InputSystem::LowLevel::InputUpdateType,bool>* get_onShouldRunUpdate() ;

/// @brief Method get_onShutdown, addr 0x2e74020, size 0x8, virtual true, abstract: false, final true
inline ::System::Action* get_onShutdown() ;

/// @brief Method get_onUpdate, addr 0x2e73c3c, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate* get_onUpdate() ;

/// @brief Method get_pollingFrequency, addr 0x2e74290, size 0x8, virtual true, abstract: false, final true
inline float_t get_pollingFrequency() ;

/// @brief Method get_runInBackground, addr 0x2e743d4, size 0x70, virtual true, abstract: false, final true
inline bool get_runInBackground() ;

/// @brief Method get_screenOrientation, addr 0x2e74504, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::ScreenOrientation get_screenOrientation() ;

/// @brief Method get_screenSize, addr 0x2e744dc, size 0x28, virtual true, abstract: false, final true
inline ::UnityEngine::Vector2 get_screenSize() ;

/// @brief Method get_unscaledGameTime, addr 0x2e743cc, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_onBeforeUpdate, addr 0x2e73d58, size 0x10c, virtual true, abstract: false, final true
inline void set_onBeforeUpdate(::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>*  value) ;

/// @brief Method set_onDeviceDiscovered, addr 0x2e73fc8, size 0x58, virtual true, abstract: false, final true
inline void set_onDeviceDiscovered(::System::Action_2<int32_t,::StringW>*  value) ;

/// @brief Method set_onPlayerFocusChanged, addr 0x2e74138, size 0x108, virtual true, abstract: false, final true
inline void set_onPlayerFocusChanged(::System::Action_1<bool>*  value) ;

/// @brief Method set_onShouldRunUpdate, addr 0x2e73e6c, size 0x10c, virtual true, abstract: false, final true
inline void set_onShouldRunUpdate(::System::Func_2<::UnityEngine::InputSystem::LowLevel::InputUpdateType,bool>*  value) ;

/// @brief Method set_onShutdown, addr 0x2e74028, size 0x108, virtual true, abstract: false, final true
inline void set_onShutdown(::System::Action*  value) ;

/// @brief Method set_onUpdate, addr 0x2e73c44, size 0x10c, virtual true, abstract: false, final true
inline void set_onUpdate(::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate*  value) ;

/// @brief Method set_pollingFrequency, addr 0x2e74298, size 0x68, virtual true, abstract: false, final true
inline void set_pollingFrequency(float_t  value) ;

/// @brief Method set_runInBackground, addr 0x2e74444, size 0xc, virtual true, abstract: false, final true
