...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x2e6a804, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x2e6a82c, size 0x2c, virtual true, abstract: false, final false
inline ::System::Nullable_1<int64_t> EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x2e6a7f0, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2e6a6ec, size 0x104, virtual false, abstract: false, final false
