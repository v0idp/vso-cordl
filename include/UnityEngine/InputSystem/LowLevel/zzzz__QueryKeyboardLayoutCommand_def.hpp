...
// Dependencies UnityEngine.InputSystem.LowLevel.IInputDeviceCommandInfo, UnityEngine.InputSystem.LowLevel.InputDeviceCommand, UnityEngine.InputSystem.LowLevel.QueryKeyboardLayoutCommand::<nameBuffer>e__FixedBuffer
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
/// @brief Method Create, addr 0x2e6acf0, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::QueryKeyboardLayoutCommand Create() ;

/// @brief Method ReadLayoutName, addr 0x2e6ac8c, size 0x10, virtual false, abstract: false, final false
inline ::StringW ReadLayoutName() ;

/// @brief Method WriteLayoutName, addr 0x2e6ac9c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method get_Type, addr 0x2e6ac5c, size 0x30, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic, addr 0x2e6acc0, size 0x30, virtual true, abstract: false, final true
