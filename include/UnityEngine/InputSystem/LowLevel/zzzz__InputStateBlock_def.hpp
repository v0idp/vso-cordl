...
/// @brief Method CopyToFrom, addr 0x2e77f18, size 0x100, virtual false, abstract: false, final false
inline void CopyToFrom(::cordl_internals::Ptr<void>  toStatePtr, ::cordl_internals::Ptr<void>  fromStatePtr) ;

/// @brief Method FloatToPrimitiveValue, addr 0x2e76d18, size 0x560, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::PrimitiveValue FloatToPrimitiveValue(float_t  value) ;

/// @brief Method GetPrimitiveFormatFromType, addr 0x2e75820, size 0x53c, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC GetPrimitiveFormatFromType(::System::Type*  type) ;

/// @brief Method GetSizeOfPrimitiveFormatInBits, addr 0x2e75538, size 0x2e8, virtual false, abstract: false, final false
static inline int32_t GetSizeOfPrimitiveFormatInBits(::UnityEngine::InputSystem::Utilities::FourCC  type) ;

/// @brief Method ReadDouble, addr 0x2e77278, size 0x3e4, virtual false, abstract: false, final false
inline double_t ReadDouble(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method ReadFloat, addr 0x2e76420, size 0x3e8, virtual false, abstract: false, final false
inline float_t ReadFloat(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method ReadInt, addr 0x2e75ea8, size 0x2b8, virtual false, abstract: false, final false
inline int32_t ReadInt(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method Write, addr 0x2e77b84, size 0x394, virtual false, abstract: false, final false
inline void Write(::cordl_internals::Ptr<void>  statePtr, ::UnityEngine::InputSystem::Utilities::PrimitiveValue  value) ;

/// @brief Method WriteDouble, addr 0x2e7765c, size 0x528, virtual false, abstract: false, final false
inline void WriteDouble(::cordl_internals::Ptr<void>  statePtr, double_t  value) ;

/// @brief Method WriteFloat, addr 0x2e76808, size 0x510, virtual false, abstract: false, final false
inline void WriteFloat(::cordl_internals::Ptr<void>  statePtr, float_t  value) ;

/// @brief Method WriteInt, addr 0x2e76160, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method get_alignedSizeInBytes, addr 0x2e75d9c, size 0x5c, virtual false, abstract: false, final false
inline uint32_t get_alignedSizeInBytes() ;

/// @brief Method get_bitOffset, addr 0x2e75d7c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_bitOffset() ;

/// @brief Method get_byteOffset, addr 0x2e75d6c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_byteOffset() ;

/// @brief Method get_effectiveBitOffset, addr 0x2e75e50, size 0x58, virtual false, abstract: false, final false
inline uint32_t get_effectiveBitOffset() ;

/// @brief Method get_effectiveByteOffset, addr 0x2e75df8, size 0x58, virtual false, abstract: false, final false
inline uint32_t get_effectiveByteOffset() ;

/// @brief Method get_format, addr 0x2e75d5c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::FourCC get_format() ;

/// @brief Method get_sizeInBits, addr 0x2e75d8c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_bitOffset, addr 0x2e75d84, size 0x8, virtual false, abstract: false, final false
inline void set_bitOffset(uint32_t  value) ;

/// @brief Method set_byteOffset, addr 0x2e75d74, size 0x8, virtual false, abstract: false, final false
inline void set_byteOffset(uint32_t  value) ;

/// @brief Method set_format, addr 0x2e75d64, size 0x8, virtual false, abstract: false, final false
inline void set_format(::UnityEngine::InputSystem::Utilities::FourCC  value) ;

/// @brief Method set_sizeInBits, addr 0x2e75d94, size 0x8, virtual false, abstract: false, final false
