...
/// @brief Method Create, addr 0x2e734a4, size 0x78, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::TextEvent Create(int32_t  deviceId, char16_t  character, double_t  time) ;

/// @brief Method Create, addr 0x2e7351c, size 0x74, virtual false, abstract: false, final false
static inline ::UnityEngine::InputSystem::LowLevel::TextEvent Create(int32_t  deviceId, int32_t  character, double_t  time) ;

/// @brief Method From, addr 0x2e73380, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method get_typeStatic, addr 0x2e73374, size 0xc, virtual true, abstract: false, final true
