...
/// @brief Method Create, addr 0x2e6cbb8, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method get_typeStatic, addr 0x2e6cbac, size 0xc, virtual true, abstract: false, final true
