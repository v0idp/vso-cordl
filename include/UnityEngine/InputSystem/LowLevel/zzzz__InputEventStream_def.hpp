...
/// @brief Method Advance, addr 0x2e6efe0, size 0xa4, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent> Advance(bool  leaveEventInBuffer) ;

/// @brief Method CleanUpAfterException, addr 0x2e6ede8, size 0x68, virtual false, abstract: false, final false
inline void CleanUpAfterException() ;

/// @brief Method Close, addr 0x2e6eccc, size 0x11c, virtual false, abstract: false, final false
inline void Close(::ByRef<::UnityEngine::InputSystem::LowLevel::InputEventBuffer>  eventBuffer) ;

/// @brief Method Peek, addr 0x2e6f084, size 0x60, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent> Peek() ;

/// @brief Method Write, addr 0x2e6ee50, size 0x190, virtual false, abstract: false, final false
inline void Write(::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent>  eventPtr) ;

/// @brief Method .ctor, addr 0x2e6ec40, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::UnityEngine::InputSystem::LowLevel::InputEventBuffer>  eventBuffer, int32_t  maxAppendedEvents) ;

/// @brief Method get_currentEventPtr, addr 0x2e6ebb8, size 0x34, virtual false, abstract: false, final false
inline ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent> get_currentEventPtr() ;

/// @brief Method get_isOpen, addr 0x2e6eb98, size 0x8, virtual false, abstract: false, final false
inline bool get_isOpen() ;

/// @brief Method get_numBytesRetainedInBuffer, addr 0x2e6ebec, size 0x54, virtual false, abstract: false, final false
inline uint32_t get_numBytesRetainedInBuffer() ;

/// @brief Method get_numEventsRetainedInBuffer, addr 0x2e6ebb0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_numEventsRetainedInBuffer() ;

/// @brief Method get_remainingEventCount, addr 0x2e6eba0, size 0x10, virtual false, abstract: false, final false
