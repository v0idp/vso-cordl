...
/// @brief Method get_format, addr 0x2e6bab0, size 0x30, virtual true, abstract: false, final true
inline ::UnityEngine::InputSystem::Utilities::FourCC get_format() ;

/// @brief Method get_kFormat, addr 0x2e6ba80, size 0x30, virtual false, abstract: false, final false
