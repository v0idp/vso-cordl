...
/// @brief Method CalculateOptimizedControlDataType, addr 0x2dbee98, size 0x170, virtual true, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::FourCC CalculateOptimizedControlDataType() ;

/// @brief Method CompareValue, addr 0x2dbec98, size 0xec, virtual true, abstract: false, final false
inline bool CompareValue(::cordl_internals::Ptr<void>  firstStatePtr, ::cordl_internals::Ptr<void>  secondStatePtr) ;

/// @brief Method EvaluateMagnitude, addr 0x2dbed84, size 0x60, virtual true, abstract: false, final false
inline float_t EvaluateMagnitude(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method EvaluateMagnitude, addr 0x2dbede4, size 0x90, virtual false, abstract: false, final false
inline float_t EvaluateMagnitude(float_t  value) ;

/// @brief Method FinishSetup, addr 0x2dbe954, size 0xe8, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::InputSystem::Controls::AxisControl* New_ctor() ;

/// @brief Method Preprocess, addr 0x2dbe7ac, size 0xd4, virtual false, abstract: false, final false
inline float_t Preprocess(float_t  value) ;

/// @brief Method ReadUnprocessedValueFromState, addr 0x2dbea3c, size 0x180, virtual true, abstract: false, final false
inline float_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method Unpreprocess, addr 0x2dbe880, size 0x4c, virtual false, abstract: false, final false
inline float_t Unpreprocess(float_t  value) ;

/// @brief Method WriteValueIntoState, addr 0x2dbebbc, size 0xdc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dbe8cc, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
