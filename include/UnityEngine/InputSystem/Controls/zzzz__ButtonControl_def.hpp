...
/// @brief Method BeginTestingForFramePresses, addr 0x2dbf1ac, size 0xf8, virtual false, abstract: false, final false
inline void BeginTestingForFramePresses(bool  currentlyPressed, bool  pressedLastFrame) ;

/// @brief Method IsValueConsideredPressed, addr 0x2dbf088, size 0x6c, virtual false, abstract: false, final false
inline bool IsValueConsideredPressed(float_t  value) ;

static inline ::UnityEngine::InputSystem::Controls::ButtonControl* New_ctor() ;

/// @brief Method UpdateWasPressed, addr 0x2dbf59c, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dbe6f4, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_isPressed, addr 0x2dbf0f4, size 0xb8, virtual false, abstract: false, final false
inline bool get_isPressed() ;

/// @brief Method get_needsToCheckFramePress, addr 0x2dbf008, size 0x8, virtual false, abstract: false, final false
inline bool get_needsToCheckFramePress() ;

/// @brief Method get_pressPointOrDefault, addr 0x2dbf01c, size 0x58, virtual false, abstract: false, final false
inline float_t get_pressPointOrDefault() ;

/// @brief Method get_wasPressedThisFrame, addr 0x2dbf2a4, size 0x17c, virtual false, abstract: false, final false
inline bool get_wasPressedThisFrame() ;

/// @brief Method get_wasReleasedThisFrame, addr 0x2dbf420, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method set_needsToCheckFramePress, addr 0x2dbf010, size 0xc, virtual false, abstract: false, final false
