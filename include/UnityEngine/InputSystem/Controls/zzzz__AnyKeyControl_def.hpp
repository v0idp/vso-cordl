...
/// @brief Method ReadUnprocessedValueFromState, addr 0x2dbe784, size 0x28, virtual true, abstract: false, final false
inline float_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method .ctor, addr 0x2dbe684, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
