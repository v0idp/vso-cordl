...
public:
// Declarations
/// @brief Method CalculateOptimizedControlDataType, addr 0x2dc0760, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method ReadUnprocessedValueFromState, addr 0x2dc0630, size 0x94, virtual true, abstract: false, final false
inline int32_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x2dc06c4, size 0x9c, virtual true, abstract: false, final false
inline void WriteValueIntoState(int32_t  value, ::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method .ctor, addr 0x2dc05a8, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
