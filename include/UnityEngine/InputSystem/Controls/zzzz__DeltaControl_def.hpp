...
/// @brief Method FinishSetup, addr 0x2dbf6b0, size 0xf8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dbf864, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_down, addr 0x2dbf680, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_down() ;

/// @brief Method get_left, addr 0x2dbf690, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_left() ;

/// @brief Method get_right, addr 0x2dbf6a0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_right() ;

/// @brief Method get_up, addr 0x2dbf670, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_up() ;

/// @brief Method set_down, addr 0x2dbf688, size 0x8, virtual false, abstract: false, final false
inline void set_down(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

/// @brief Method set_left, addr 0x2dbf698, size 0x8, virtual false, abstract: false, final false
inline void set_left(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

/// @brief Method set_right, addr 0x2dbf6a8, size 0x8, virtual false, abstract: false, final false
inline void set_right(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

/// @brief Method set_up, addr 0x2dbf678, size 0x8, virtual false, abstract: false, final false
