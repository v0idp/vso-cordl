...
/// @brief Method ReadUnprocessedValueFromState, addr 0x2dbfd50, size 0x68, virtual true, abstract: false, final false
inline double_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x2dbfdb8, size 0x78, virtual true, abstract: false, final false
inline void WriteValueIntoState(double_t  value, ::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method .ctor, addr 0x2dbfcc8, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
