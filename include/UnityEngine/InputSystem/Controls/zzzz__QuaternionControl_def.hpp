...
/// @brief Method CalculateOptimizedControlDataType, addr 0x2dc0e08, size 0x230, virtual true, abstract: false, final false
inline ::UnityEngine::InputSystem::Utilities::FourCC CalculateOptimizedControlDataType() ;

/// @brief Method FinishSetup, addr 0x2dc0aa4, size 0x114, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::InputSystem::Controls::QuaternionControl* New_ctor() ;

/// @brief Method ReadUnprocessedValueFromState, addr 0x2dc0bb8, size 0x124, virtual true, abstract: false, final false
inline ::UnityEngine::Quaternion ReadUnprocessedValueFromState(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x2dc0cdc, size 0x12c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dc0a14, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_w, addr 0x2dc0a04, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_w() ;

/// @brief Method get_x, addr 0x2dc09d4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_x() ;

/// @brief Method get_y, addr 0x2dc09e4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_y() ;

/// @brief Method get_z, addr 0x2dc09f4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::AxisControl* get_z() ;

/// @brief Method set_w, addr 0x2dc0a0c, size 0x8, virtual false, abstract: false, final false
inline void set_w(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

/// @brief Method set_x, addr 0x2dc09dc, size 0x8, virtual false, abstract: false, final false
inline void set_x(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

/// @brief Method set_y, addr 0x2dc09ec, size 0x8, virtual false, abstract: false, final false
inline void set_y(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

/// @brief Method set_z, addr 0x2dc09fc, size 0x8, virtual false, abstract: false, final false
