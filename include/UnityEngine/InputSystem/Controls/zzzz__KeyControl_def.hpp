...
/// @brief Method RefreshConfiguration, addr 0x2dc0860, size 0x170, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dc09d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_keyCode, addr 0x2dc0834, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Key get_keyCode() ;

/// @brief Method get_scanCode, addr 0x2dc0844, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_scanCode() ;

/// @brief Method set_keyCode, addr 0x2dc083c, size 0x8, virtual false, abstract: false, final false
