...
/// @brief Method ReadUnprocessedValueFromState, addr 0x2dc17f4, size 0x7c, virtual true, abstract: false, final false
inline ::UnityEngine::InputSystem::TouchPhase ReadUnprocessedValueFromState(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x2dc1870, size 0x68, virtual true, abstract: false, final false
inline void WriteValueIntoState(::UnityEngine::InputSystem::TouchPhase  value, ::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method .ctor, addr 0x2dc176c, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
