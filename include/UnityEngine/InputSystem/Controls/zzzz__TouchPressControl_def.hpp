...
public:
// Declarations
/// @brief Method FinishSetup, addr 0x2dc18d8, size 0xfc, virtual true, abstract: false, final false
inline void FinishSetup() ;

static inline ::UnityEngine::InputSystem::Controls::TouchPressControl* New_ctor() ;

/// @brief Method ReadUnprocessedValueFromState, addr 0x2dc19d4, size 0x14c, virtual true, abstract: false, final false
inline float_t ReadUnprocessedValueFromState(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteValueIntoState, addr 0x2dc1c84, size 0x38, virtual true, abstract: false, final false
inline void WriteValueIntoState(float_t  value, ::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method .ctor, addr 0x2dc1cbc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
