...
/// @brief Method EvaluateMagnitude, addr 0x2dd0bb4, size 0xc, virtual true, abstract: false, final false
inline float_t EvaluateMagnitude(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method FinishSetup, addr 0x2dd0bc0, size 0x74, virtual true, abstract: false, final false
inline void FinishSetup(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method ModifiersArePressed, addr 0x2dd0b00, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method ReadValue, addr 0x2dd0a90, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dd0c34, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
