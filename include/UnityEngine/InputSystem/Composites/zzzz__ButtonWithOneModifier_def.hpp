...
/// @brief Method EvaluateMagnitude, addr 0x2dd09c8, size 0xc, virtual true, abstract: false, final false
inline float_t EvaluateMagnitude(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method FinishSetup, addr 0x2dd09d4, size 0x74, virtual true, abstract: false, final false
inline void FinishSetup(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method ModifierIsPressed, addr 0x2dd0948, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method ReadValue, addr 0x2dd08d8, size 0x70, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dd0a48, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
