...
/// @brief Method EvaluateMagnitude, addr 0x2dd137c, size 0x40, virtual true, abstract: false, final false
inline float_t EvaluateMagnitude(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method FinishSetup, addr 0x2dd14dc, size 0x90, virtual true, abstract: false, final false
inline void FinishSetup(::ByRef<::UnityEngine::InputSystem::InputBindingCompositeContext>  context) ;

/// @brief Method ModifiersArePressed, addr 0x2dd13bc, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method ReadValue, addr 0x2dd1478, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method ReadValueAsObject, addr 0x2dd156c, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2dd15d0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_valueSizeInBytes, addr 0x2dd1374, size 0x8, virtual true, abstract: false, final false
inline int32_t get_valueSizeInBytes() ;

/// @brief Method get_valueType, addr 0x2dd136c, size 0x8, virtual true, abstract: false, final false
