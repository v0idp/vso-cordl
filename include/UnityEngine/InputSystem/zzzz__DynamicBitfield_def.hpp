...
public:
// Declarations
/// @brief Method AnyBitIsSet, addr 0x2e4545c, size 0x84, virtual false, abstract: false, final false
inline bool AnyBitIsSet() ;

/// @brief Method BitCountToULongCount, addr 0x2e4533c, size 0x18, virtual false, abstract: false, final false
static inline int32_t BitCountToULongCount(int32_t  bitCount) ;

/// @brief Method ClearBit, addr 0x2e3670c, size 0x98, virtual false, abstract: false, final false
inline void ClearBit(int32_t  bitIndex) ;

/// @brief Method SetBit, addr 0x2e45354, size 0x98, virtual false, abstract: false, final false
inline void SetBit(int32_t  bitIndex) ;

/// @brief Method SetLength, addr 0x2e365e4, size 0x74, virtual false, abstract: false, final false
inline void SetLength(int32_t  newLength) ;

/// @brief Method TestBit, addr 0x2e453ec, size 0x70, virtual false, abstract: false, final false
