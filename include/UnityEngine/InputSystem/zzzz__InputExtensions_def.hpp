...
public:
// Declarations
/// @brief Method IsActive, addr 0x2e28608, size 0x1c, virtual false, abstract: false, final false
static inline bool IsActive(::UnityEngine::InputSystem::TouchPhase  phase) ;

/// @brief Method IsEndedOrCanceled, addr 0x2e29878, size 0x10, virtual false, abstract: false, final false
static inline bool IsEndedOrCanceled(::UnityEngine::InputSystem::TouchPhase  phase) ;

/// @brief Method IsInProgress, addr 0x2e29868, size 0x10, virtual false, abstract: false, final false
static inline bool IsInProgress(::UnityEngine::InputSystem::InputActionPhase  phase) ;

/// @brief Method IsModifierKey, addr 0x2e29888, size 0x10, virtual false, abstract: false, final false
static inline bool IsModifierKey(::UnityEngine::InputSystem::Key  key) ;

/// @brief Method IsTextInputKey, addr 0x2e29898, size 0x2c, virtual false, abstract: false, final false
