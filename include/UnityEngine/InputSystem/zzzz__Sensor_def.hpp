...
/// @brief Method .ctor, addr 0x2e2580c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_samplingFrequency, addr 0x2e25680, size 0xec, virtual false, abstract: false, final false
inline float_t get_samplingFrequency() ;

/// @brief Method set_samplingFrequency, addr 0x2e2576c, size 0xa0, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::Sensor, 0x188>, "Size mismatch!");
