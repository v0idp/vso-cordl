...
/// @brief Method Byte2Hex, addr 0x3194b60, size 0x54, virtual false, abstract: false, final false
static inline void Byte2Hex(uint8_t  b, ::ArrayW<uint8_t,::Array<uint8_t>*>  hexChars, ::ByRef<uint8_t>  byte0, ::ByRef<uint8_t>  byte1) ;

/// @brief Method ByteArrayContains, addr 0x3195158, size 0x68, virtual false, abstract: false, final false
static inline bool ByteArrayContains(::ArrayW<uint8_t,::Array<uint8_t>*>  array, uint8_t  b) ;

/// @brief Method ByteSubArrayEquals, addr 0x31954d8, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method DataEncode, addr 0x3194814, size 0x68, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> DataEncode(::ArrayW<uint8_t,::Array<uint8_t>*>  toEncode) ;

/// @brief Method DataEncode, addr 0x3194ffc, size 0x68, virtual false, abstract: false, final false
static inline ::StringW DataEncode(::StringW  toEncode) ;

/// @brief Method DataEncode, addr 0x3195064, size 0xf4, virtual false, abstract: false, final false
static inline ::StringW DataEncode(::StringW  toEncode, ::System::Text::Encoding*  e) ;

/// @brief Method Decode, addr 0x31951c0, size 0x318, virtual false, abstract: false, final false
...
/// @brief Method Encode, addr 0x3194c20, size 0x3dc, virtual false, abstract: false, final false
...
/// @brief Method Hex2Byte, addr 0x3194ab4, size 0xac, virtual false, abstract: false, final false
static inline uint8_t Hex2Byte(::ArrayW<uint8_t,::Array<uint8_t>*>  b, int32_t  offset) ;

/// @brief Method QPEncode, addr 0x3194720, size 0xf4, virtual false, abstract: false, final false
static inline ::StringW QPEncode(::StringW  toEncode, ::System::Text::Encoding*  e) ;

/// @brief Method SevenBitClean, addr 0x3195568, size 0x5c, virtual false, abstract: false, final false
static inline bool SevenBitClean(::cordl_internals::Ptr<uint8_t>  input, int32_t  inputLength) ;

/// @brief Method SevenBitClean, addr 0x31945ac, size 0x174, virtual false, abstract: false, final false
static inline bool SevenBitClean(::StringW  s, ::System::Text::Encoding*  e) ;

/// @brief Method URLDecode, addr 0x3193610, size 0x64, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> URLDecode(::ArrayW<uint8_t,::Array<uint8_t>*>  toEncode) ;

/// @brief Method URLEncode, addr 0x3194bb4, size 0x6c, virtual false, abstract: false, final false
