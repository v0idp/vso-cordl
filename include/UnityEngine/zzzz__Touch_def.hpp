...
/// @brief Method get_altitudeAngle, addr 0x2fbd1cc, size 0x8, virtual false, abstract: false, final false
inline float_t get_altitudeAngle() ;

/// @brief Method get_azimuthAngle, addr 0x2fbd1d4, size 0x8, virtual false, abstract: false, final false
inline float_t get_azimuthAngle() ;

/// @brief Method get_deltaPosition, addr 0x2fbd18c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_deltaPosition() ;

/// @brief Method get_deltaTime, addr 0x2fbd19c, size 0x8, virtual false, abstract: false, final false
inline float_t get_deltaTime() ;

/// @brief Method get_fingerId, addr 0x2fbd164, size 0x8, virtual false, abstract: false, final false
inline int32_t get_fingerId() ;

/// @brief Method get_maximumPossiblePressure, addr 0x2fbd1bc, size 0x8, virtual false, abstract: false, final false
inline float_t get_maximumPossiblePressure() ;

/// @brief Method get_phase, addr 0x2fbd1ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::TouchPhase get_phase() ;

/// @brief Method get_position, addr 0x2fbd16c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_position() ;

/// @brief Method get_pressure, addr 0x2fbd1b4, size 0x8, virtual false, abstract: false, final false
inline float_t get_pressure() ;

/// @brief Method get_radius, addr 0x2fbd1dc, size 0x8, virtual false, abstract: false, final false
inline float_t get_radius() ;

/// @brief Method get_radiusVariance, addr 0x2fbd1e4, size 0x8, virtual false, abstract: false, final false
inline float_t get_radiusVariance() ;

/// @brief Method get_rawPosition, addr 0x2fbd17c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_rawPosition() ;

/// @brief Method get_tapCount, addr 0x2fbd1a4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_tapCount() ;

/// @brief Method get_type, addr 0x2fbd1c4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::TouchType get_type() ;

/// @brief Method set_deltaPosition, addr 0x2fbd194, size 0x8, virtual false, abstract: false, final false
inline void set_deltaPosition(::UnityEngine::Vector2  value) ;

/// @brief Method set_position, addr 0x2fbd174, size 0x8, virtual false, abstract: false, final false
inline void set_position(::UnityEngine::Vector2  value) ;

/// @brief Method set_rawPosition, addr 0x2fbd184, size 0x8, virtual false, abstract: false, final false
