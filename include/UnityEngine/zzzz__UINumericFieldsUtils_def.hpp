...
/// @brief Method TryConvertStringToDouble, addr 0x2f92088, size 0x108, virtual false, abstract: false, final false
static inline bool TryConvertStringToDouble(::StringW  str, ::StringW  initialValueAsString, ::ByRef<double_t>  value) ;

/// @brief Method TryConvertStringToDouble, addr 0x2f91ef8, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method TryConvertStringToFloat, addr 0x2f92190, size 0x94, virtual false, abstract: false, final false
static inline bool TryConvertStringToFloat(::StringW  str, ::StringW  initialValueAsString, ::ByRef<float_t>  value) ;

/// @brief Method TryConvertStringToInt, addr 0x2f92534, size 0x9c, virtual false, abstract: false, final false
static inline bool TryConvertStringToInt(::StringW  str, ::StringW  initialValueAsString, ::ByRef<int32_t>  value) ;

/// @brief Method TryConvertStringToLong, addr 0x2f922a8, size 0x104, virtual false, abstract: false, final false
static inline bool TryConvertStringToLong(::StringW  str, ::StringW  initialValueAsString, ::ByRef<int64_t>  value) ;

/// @brief Method TryConvertStringToLong, addr 0x2f92224, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method TryConvertStringToUInt, addr 0x2f925d0, size 0x9c, virtual false, abstract: false, final false
static inline bool TryConvertStringToUInt(::StringW  str, ::StringW  initialValueAsString, ::ByRef<uint32_t>  value) ;

/// @brief Method TryConvertStringToULong, addr 0x2f92430, size 0x104, virtual false, abstract: false, final false
static inline bool TryConvertStringToULong(::StringW  str, ::StringW  initialValueAsString, ::ByRef<uint64_t>  value) ;

/// @brief Method TryConvertStringToULong, addr 0x2f923ac, size 0x84, virtual false, abstract: false, final false
