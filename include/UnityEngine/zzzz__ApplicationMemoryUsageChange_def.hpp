...
/// @brief Method .ctor, addr 0x2f5d698, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ApplicationMemoryUsage  usage) ;

/// @brief Method set_memoryUsage, addr 0x2f5ee94, size 0x8, virtual false, abstract: false, final false
