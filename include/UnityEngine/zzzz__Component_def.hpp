...
/// @brief Method BroadcastMessage, addr 0x2f8884c, size 0x5c, virtual false, abstract: false, final false
inline void BroadcastMessage(::StringW  methodName, ::System::Object*  parameter, ::UnityEngine::SendMessageOptions  options) ;

/// @brief Method CompareTag, addr 0x2f88734, size 0x78, virtual false, abstract: false, final false
inline bool CompareTag(::StringW  tag) ;

/// @brief Method GetComponent, addr 0x2f88328, size 0x44, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Component> GetComponent(::StringW  type) ;

/// @brief Method GetComponent, addr 0x2f88118, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method GetComponentFastPath, addr 0x2f881d4, size 0x54, virtual false, abstract: false, final false
inline void GetComponentFastPath(::System::Type*  type, ::System::IntPtr  oneFurtherThanResultValue) ;

/// @brief Method GetComponentInChildren, addr 0x2f8836c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method GetComponentInParent, addr 0x2f88448, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method GetComponents, addr 0x2f88578, size 0x54, virtual false, abstract: false, final false
inline void GetComponents(::System::Type*  type, ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Component>>*  results) ;

/// @brief Method GetComponentsForListInternal, addr 0x2f88524, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SendMessage, addr 0x2f887f0, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method TryGetComponent, addr 0x2f88228, size 0x60, virtual false, abstract: false, final false
inline bool TryGetComponent(::System::Type*  type, ::ByRef<::UnityEngine::Component*>  component) ;

/// @brief Method .ctor, addr 0x2f876a8, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gameObject, addr 0x2f880dc, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_gameObject() ;

/// @brief Method get_tag, addr 0x2f885cc, size 0x70, virtual false, abstract: false, final false
inline ::StringW get_tag() ;

/// @brief Method get_transform, addr 0x2f880a0, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_transform() ;

/// @brief Method set_tag, addr 0x2f88678, size 0x78, virtual false, abstract: false, final false
