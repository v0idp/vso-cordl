...
/// @brief Method get_bakingOutput, addr 0x2f6ea20, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::LightBakingOutput get_bakingOutput() ;

/// @brief Method get_bakingOutput_Injected, addr 0x2f6ea88, size 0x44, virtual false, abstract: false, final false
inline void get_bakingOutput_Injected(::ByRef<::UnityEngine::LightBakingOutput>  ret) ;

/// @brief Method get_bounceIntensity, addr 0x2f6e9a8, size 0x3c, virtual false, abstract: false, final false
inline float_t get_bounceIntensity() ;

/// @brief Method get_color, addr 0x2f6e774, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_colorTemperature, addr 0x2f6e8a8, size 0x3c, virtual false, abstract: false, final false
inline float_t get_colorTemperature() ;

/// @brief Method get_color_Injected, addr 0x2f6e7cc, size 0x44, virtual false, abstract: false, final false
inline void get_color_Injected(::ByRef<::UnityEngine::Color>  ret) ;

/// @brief Method get_cookie, addr 0x2f6ebcc, size 0x3c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_cookie() ;

/// @brief Method get_cookieSize, addr 0x2f6eb90, size 0x3c, virtual false, abstract: false, final false
inline float_t get_cookieSize() ;

/// @brief Method get_intensity, addr 0x2f6e920, size 0x3c, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method get_range, addr 0x2f6e9e4, size 0x3c, virtual false, abstract: false, final false
inline float_t get_range() ;

/// @brief Method get_shadowStrength, addr 0x2f6eb08, size 0x3c, virtual false, abstract: false, final false
inline float_t get_shadowStrength() ;

/// @brief Method get_shadows, addr 0x2f6eacc, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::LightShadows get_shadows() ;

/// @brief Method get_spotAngle, addr 0x2f6e738, size 0x3c, virtual false, abstract: false, final false
inline float_t get_spotAngle() ;

/// @brief Method get_type, addr 0x2f6e6fc, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::LightType get_type() ;

/// @brief Method get_useColorTemperature, addr 0x2f6e8e4, size 0x3c, virtual false, abstract: false, final false
inline bool get_useColorTemperature() ;

/// @brief Method set_color, addr 0x2f6e810, size 0x54, virtual false, abstract: false, final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_color_Injected, addr 0x2f6e864, size 0x44, virtual false, abstract: false, final false
inline void set_color_Injected(::ByRef<::UnityEngine::Color>  value) ;

/// @brief Method set_intensity, addr 0x2f6e95c, size 0x4c, virtual false, abstract: false, final false
inline void set_intensity(float_t  value) ;

/// @brief Method set_shadowStrength, addr 0x2f6eb44, size 0x4c, virtual false, abstract: false, final false
