...
/// @brief Method ExtractFormattedStackTrace, addr 0x2f8d11c, size 0x70c, virtual false, abstract: false, final false
static inline ::StringW ExtractFormattedStackTrace(::System::Diagnostics::StackTrace*  stackTrace) ;

/// @brief Method ExtractStackTrace, addr 0x2f8cfc0, size 0x15c, virtual false, abstract: false, final false
static inline ::StringW ExtractStackTrace() ;

/// @brief Method ExtractStringFromExceptionInternal, addr 0x2f8d828, size 0x35c, virtual false, abstract: false, final false
...
/// @brief Method SetProjectFolder, addr 0x2f8cee4, size 0xdc, virtual false, abstract: false, final false
