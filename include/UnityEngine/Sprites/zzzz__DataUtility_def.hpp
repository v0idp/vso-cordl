...
public:
// Declarations
/// @brief Method GetInnerUV, addr 0x2f96dac, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetInnerUV(::UnityEngine::Sprite*  sprite) ;

/// @brief Method GetMinSize, addr 0x2f96ddc, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 GetMinSize(::UnityEngine::Sprite*  sprite) ;

/// @brief Method GetOuterUV, addr 0x2f96dbc, size 0x10, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 GetOuterUV(::UnityEngine::Sprite*  sprite) ;

/// @brief Method GetPadding, addr 0x2f96dcc, size 0x10, virtual false, abstract: false, final false
