...
/// @brief Method .ctor, addr 0x2f4889c, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::StringW  javaStackTrace) ;

/// @brief Method get_StackTrace, addr 0x2f4bdcc, size 0x24, virtual true, abstract: false, final false
