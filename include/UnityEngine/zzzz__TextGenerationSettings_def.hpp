...
public:
// Declarations
/// @brief Method CompareColors, addr 0x3000eec, size 0x138, virtual false, abstract: false, final false
inline bool CompareColors(::UnityEngine::Color  left, ::UnityEngine::Color  right) ;

/// @brief Method CompareVector2, addr 0x3001024, size 0xc8, virtual false, abstract: false, final false
inline bool CompareVector2(::UnityEngine::Vector2  left, ::UnityEngine::Vector2  right) ;

/// @brief Method Equals, addr 0x30010ec, size 0x220, virtual false, abstract: false, final false
