...
/// @brief Method ClearSubsystems, addr 0x2fcdff0, size 0x24c, virtual false, abstract: false, final false
...
/// @brief Method GetIntegratedSubsystemByPtr, addr 0x2fce3ac, size 0x184, virtual false, abstract: false, final false
...
/// @brief Method InitializeIntegratedSubsystem, addr 0x2fcdeec, size 0x104, virtual false, abstract: false, final false
static inline void InitializeIntegratedSubsystem(::System::IntPtr  ptr, ::UnityEngine::IntegratedSubsystem*  subsystem) ;

/// @brief Method ReloadSubsystemsCompleted, addr 0x2fcde0c, size 0xe0, virtual false, abstract: false, final false
static inline void ReloadSubsystemsCompleted() ;

/// @brief Method ReloadSubsystemsStarted, addr 0x2fcdd2c, size 0xe0, virtual false, abstract: false, final false
static inline void ReloadSubsystemsStarted() ;

/// @brief Method RemoveDeprecatedSubsystem, addr 0x2fcdbbc, size 0x80, virtual false, abstract: false, final false
static inline bool RemoveDeprecatedSubsystem(::UnityEngine::Subsystem*  subsystem) ;

/// @brief Method RemoveIntegratedSubsystemByPtr, addr 0x2fcd838, size 0x158, virtual false, abstract: false, final false
static inline void RemoveIntegratedSubsystemByPtr(::System::IntPtr  ptr) ;

/// @brief Method RemoveStandaloneSubsystem, addr 0x2fce530, size 0x80, virtual false, abstract: false, final false
static inline bool RemoveStandaloneSubsystem(::UnityEngine::SubsystemsImplementation::SubsystemWithProvider*  subsystem) ;

/// @brief Method StaticConstructScriptingClassMap, addr 0x2fce23c, size 0x28, virtual false, abstract: false, final false
