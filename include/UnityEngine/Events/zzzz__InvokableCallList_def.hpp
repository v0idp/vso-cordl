...
/// @brief Method AddListener, addr 0x2f985f8, size 0xa8, virtual false, abstract: false, final false
inline void AddListener(::UnityEngine::Events::BaseInvokableCall*  call) ;

/// @brief Method AddPersistentInvokableCall, addr 0x2f98550, size 0xa8, virtual false, abstract: false, final false
inline void AddPersistentInvokableCall(::UnityEngine::Events::BaseInvokableCall*  call) ;

/// @brief Method ClearPersistent, addr 0x2f98910, size 0xbc, virtual false, abstract: false, final false
inline void ClearPersistent() ;

static inline ::UnityEngine::Events::InvokableCallList* New_ctor() ;

/// @brief Method PrepareInvoke, addr 0x2f989cc, size 0xb4, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>* PrepareInvoke() ;

/// @brief Method RemoveListener, addr 0x2f986a0, size 0x270, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f98a80, size 0xb4, virtual false, abstract: false, final false
inline void _ctor() ;
