...
/// @brief Method OnAfterDeserialize, addr 0x2f973e4, size 0x1c, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x2f973c8, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2f97400, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_boolArgument, addr 0x2f973c0, size 0x8, virtual false, abstract: false, final false
inline bool get_boolArgument() ;

/// @brief Method get_floatArgument, addr 0x2f973b0, size 0x8, virtual false, abstract: false, final false
inline float_t get_floatArgument() ;

/// @brief Method get_intArgument, addr 0x2f973a8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_intArgument() ;

/// @brief Method get_stringArgument, addr 0x2f973b8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_stringArgument() ;

/// @brief Method get_unityObjectArgument, addr 0x2f97398, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> get_unityObjectArgument() ;

/// @brief Method get_unityObjectArgumentAssemblyTypeName, addr 0x2f973a0, size 0x8, virtual false, abstract: false, final false
