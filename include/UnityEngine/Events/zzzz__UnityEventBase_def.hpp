...
/// @brief Method AddCall, addr 0x2f990e4, size 0x18, virtual false, abstract: false, final false
inline void AddCall(::UnityEngine::Events::BaseInvokableCall*  call) ;

/// @brief Method DirtyPersistentCalls, addr 0x2f98bd0, size 0x28, virtual false, abstract: false, final false
inline void DirtyPersistentCalls() ;

/// @brief Method FindMethod, addr 0x2f97ca4, size 0x1cc, virtual false, abstract: false, final false
inline ::System::Reflection::MethodInfo* FindMethod(::UnityEngine::Events::PersistentCall*  call) ;

/// @brief Method FindMethod, addr 0x2f98bfc, size 0x2cc, virtual false, abstract: false, final false
...
/// @brief Method GetValidMethodInfo, addr 0x2f98ec8, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method PrepareInvoke, addr 0x2f99114, size 0x20, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Events::BaseInvokableCall*>* PrepareInvoke() ;

/// @brief Method RebuildPersistentCallsIfNeeded, addr 0x2f990b0, size 0x34, virtual false, abstract: false, final false
inline void RebuildPersistentCallsIfNeeded() ;

/// @brief Method RemoveListener, addr 0x2f990fc, size 0x18, virtual false, abstract: false, final false
inline void RemoveListener(::System::Object*  targetObj, ::System::Reflection::MethodInfo*  method) ;

/// @brief Method ToString, addr 0x2f99134, size 0x84, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x2f98bf8, size 0x4, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x2f98bcc, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2f98b34, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
