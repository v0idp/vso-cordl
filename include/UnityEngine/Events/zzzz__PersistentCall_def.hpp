...
/// @brief Method GetObjectCall, addr 0x2f97e70, size 0x42c, virtual false, abstract: false, final false
...
/// @brief Method GetRuntimeCall, addr 0x2f979bc, size 0x2e8, virtual false, abstract: false, final false
inline ::UnityEngine::Events::BaseInvokableCall* GetRuntimeCall(::UnityEngine::Events::UnityEventBase*  theEvent) ;

/// @brief Method IsValid, addr 0x2f97980, size 0x3c, virtual false, abstract: false, final false
inline bool IsValid() ;

static inline ::UnityEngine::Events::PersistentCall* New_ctor() ;

/// @brief Method OnAfterDeserialize, addr 0x2f982b8, size 0x1c, virtual true, abstract: false, final true
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x2f9829c, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2f982d4, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_arguments, addr 0x2f97978, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Events::ArgumentCache* get_arguments() ;

/// @brief Method get_methodName, addr 0x2f97968, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_methodName() ;

/// @brief Method get_mode, addr 0x2f97970, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Events::PersistentListenerMode get_mode() ;

/// @brief Method get_target, addr 0x2f978b8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Object> get_target() ;

/// @brief Method get_targetAssemblyTypeName, addr 0x2f978c0, size 0xa8, virtual false, abstract: false, final false
