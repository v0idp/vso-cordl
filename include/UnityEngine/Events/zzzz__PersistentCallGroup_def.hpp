...
/// @brief Method Initialize, addr 0x2f983c0, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f98340, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;
