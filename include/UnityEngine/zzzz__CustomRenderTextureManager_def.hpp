...
/// @brief Method InvokeOnTextureLoaded_Internal, addr 0x2f6810c, size 0x6c, virtual false, abstract: false, final false
static inline void InvokeOnTextureLoaded_Internal(::UnityEngine::CustomRenderTexture*  source) ;

/// @brief Method InvokeOnTextureUnloaded_Internal, addr 0x2f68178, size 0x6c, virtual false, abstract: false, final false
