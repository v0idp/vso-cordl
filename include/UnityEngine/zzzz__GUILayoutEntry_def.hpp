...
/// @brief Method ApplyOptions, addr 0x2fb4bd8, size 0x2d4, virtual true, abstract: false, final false
inline void ApplyOptions(::ArrayW<::UnityEngine::GUILayoutOption*,::Array<::UnityEngine::GUILayoutOption*>*>  options) ;

/// @brief Method ApplyStyleSettings, addr 0x2fb4adc, size 0xfc, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::UnityEngine::GUIStyle*  style) ;

/// @brief Method CalcHeight, addr 0x2fb4ac0, size 0x4, virtual true, abstract: false, final false
inline void CalcHeight() ;

/// @brief Method CalcWidth, addr 0x2fb4abc, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method SetHorizontal, addr 0x2fb4ac4, size 0xc, virtual true, abstract: false, final false
inline void SetHorizontal(float_t  x, float_t  width) ;

/// @brief Method SetVertical, addr 0x2fb4ad0, size 0xc, virtual true, abstract: false, final false
inline void SetVertical(float_t  y, float_t  height) ;

/// @brief Method ToString, addr 0x2fb4eac, size 0x4a0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fb49e8, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method get_marginBottom, addr 0x2fb494c, size 0x24, virtual true, abstract: false, final false
inline int32_t get_marginBottom() ;

/// @brief Method get_marginHorizontal, addr 0x2fb4970, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_marginHorizontal() ;

/// @brief Method get_marginLeft, addr 0x2fb48e0, size 0x24, virtual true, abstract: false, final false
inline int32_t get_marginLeft() ;

/// @brief Method get_marginRight, addr 0x2fb4904, size 0x24, virtual true, abstract: false, final false
inline int32_t get_marginRight() ;

/// @brief Method get_marginTop, addr 0x2fb4928, size 0x24, virtual true, abstract: false, final false
inline int32_t get_marginTop() ;

/// @brief Method get_marginVertical, addr 0x2fb49ac, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_marginVertical() ;

/// @brief Method get_style, addr 0x2fb48d8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_style, addr 0x2faffc0, size 0x10, virtual false, abstract: false, final false
