...
/// @brief Method BuiltinUpdate, addr 0x2fa6f2c, size 0x28, virtual false, abstract: false, final false
static inline bool BuiltinUpdate() ;

/// @brief Method Dispose, addr 0x2fa6f54, size 0x4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x2fa6f58, size 0x4, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Internal_BuiltinRuntimeReflectionSystem_New, addr 0x2fa6f5c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method TickRealtimeProbes, addr 0x2fa6f04, size 0x28, virtual true, abstract: false, final true
inline bool TickRealtimeProbes() ;

/// @brief Method .ctor, addr 0x2fa6fb0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
