...
/// @brief Method Internal_ScriptableRuntimeReflectionSystemWrapper_TickRealtimeProbes, addr 0x2fa7208, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fa71f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_implementation, addr 0x2fa71f8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem* get_implementation() ;

/// @brief Method set_implementation, addr 0x2fa7200, size 0x8, virtual false, abstract: false, final false
