...
/// @brief Method Black, addr 0x2fa5930, size 0x14, virtual false, abstract: false, final false
static inline ::UnityEngine::Experimental::GlobalIllumination::LinearColor Black() ;

/// @brief Method Convert, addr 0x2fa566c, size 0x2c4, virtual false, abstract: false, final false
static inline ::UnityEngine::Experimental::GlobalIllumination::LinearColor Convert(::UnityEngine::Color  color, float_t  intensity) ;

/// @brief Method get_blue, addr 0x2fa55b8, size 0x8, virtual false, abstract: false, final false
inline float_t get_blue() ;

/// @brief Method get_green, addr 0x2fa5504, size 0x8, virtual false, abstract: false, final false
inline float_t get_green() ;

/// @brief Method get_red, addr 0x2fa5450, size 0x8, virtual false, abstract: false, final false
inline float_t get_red() ;

/// @brief Method set_blue, addr 0x2fa55c0, size 0xac, virtual false, abstract: false, final false
inline void set_blue(float_t  value) ;

/// @brief Method set_green, addr 0x2fa550c, size 0xac, virtual false, abstract: false, final false
inline void set_green(float_t  value) ;

/// @brief Method set_red, addr 0x2fa5458, size 0xac, virtual false, abstract: false, final false
