...
/// @brief Method Equals, addr 0x2fa6dfc, size 0x78, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Experimental::Playables::MaterialEffectPlayable  other) ;

/// @brief Method GetHandle, addr 0x2fa6df0, size 0xc, virtual true, abstract: false, final true
