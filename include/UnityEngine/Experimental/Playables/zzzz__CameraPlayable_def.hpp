...
/// @brief Method Equals, addr 0x2fa6d78, size 0x78, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Experimental::Playables::CameraPlayable  other) ;

/// @brief Method GetHandle, addr 0x2fa6d6c, size 0xc, virtual true, abstract: false, final true
