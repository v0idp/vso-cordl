...
/// @brief Method Equals, addr 0x2fa6e80, size 0x78, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Experimental::Playables::TextureMixerPlayable  other) ;

/// @brief Method GetHandle, addr 0x2fa6e74, size 0xc, virtual true, abstract: false, final true
