...
/// @brief Method Equals, addr 0x3199594, size 0x78, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Experimental::Video::VideoClipPlayable  other) ;

/// @brief Method GetHandle, addr 0x3199588, size 0xc, virtual true, abstract: false, final true
