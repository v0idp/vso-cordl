...
/// @brief Method .ctor, addr 0x2f87408, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  menuName) ;

/// @brief Method .ctor, addr 0x2f87434, size 0x30, virtual false, abstract: false, final false
