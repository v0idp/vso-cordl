...
public:
// Declarations
/// @brief Method Invoke, addr 0x2f901f0, size 0xac, virtual false, abstract: false, final false
inline void Invoke() ;

/// @brief Method .ctor, addr 0x2f8fe24, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method CreateCopy, addr 0x2f8ffac, size 0x64, virtual true, abstract: false, final false
inline ::System::Threading::SynchronizationContext* CreateCopy() ;

/// @brief Method Exec, addr 0x2f90010, size 0x1e0, virtual false, abstract: false, final false
inline void Exec() ;

/// @brief Method ExecutePendingTasks, addr 0x2f903cc, size 0xec, virtual false, abstract: false, final false
static inline bool ExecutePendingTasks(int64_t  millisecondsTimeout) ;

/// @brief Method ExecuteTasks, addr 0x2f90374, size 0x58, virtual false, abstract: false, final false
static inline void ExecuteTasks() ;

/// @brief Method HasPendingTasks, addr 0x2f9029c, size 0x60, virtual false, abstract: false, final false
inline bool HasPendingTasks() ;

/// @brief Method InitializeSynchronizationContext, addr 0x2f902fc, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method OperationCompleted, addr 0x2f8fe3c, size 0xc, virtual true, abstract: false, final false
inline void OperationCompleted() ;

/// @brief Method OperationStarted, addr 0x2f8fe30, size 0xc, virtual true, abstract: false, final false
inline void OperationStarted() ;

/// @brief Method Post, addr 0x2f8fe48, size 0x164, virtual true, abstract: false, final false
inline void Post(::System::Threading::SendOrPostCallback*  callback, ::System::Object*  state) ;

/// @brief Method Send, addr 0x2f8fb08, size 0x31c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f8f9bc, size 0xac, virtual false, abstract: false, final false
inline void _ctor(int32_t  mainThreadID) ;

/// @brief Method .ctor, addr 0x2f8fa68, size 0xa0, virtual false, abstract: false, final false
