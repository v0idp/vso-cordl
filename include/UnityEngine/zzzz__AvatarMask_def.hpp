...
/// @brief Method GetHumanoidBodyPartActive, addr 0x2f53a90, size 0x44, virtual false, abstract: false, final false
inline bool GetHumanoidBodyPartActive(::UnityEngine::AvatarMaskBodyPart  index) ;

/// @brief Method GetTransformActive, addr 0x2f53b98, size 0x54, virtual false, abstract: false, final false
inline bool GetTransformActive(int32_t  index) ;

/// @brief Method GetTransformPath, addr 0x2f53b10, size 0x44, virtual false, abstract: false, final false
inline ::StringW GetTransformPath(int32_t  index) ;

/// @brief Method GetTransformWeight, addr 0x2f53b54, size 0x44, virtual false, abstract: false, final false
inline float_t GetTransformWeight(int32_t  index) ;

/// @brief Method get_transformCount, addr 0x2f53ad4, size 0x3c, virtual false, abstract: false, final false
