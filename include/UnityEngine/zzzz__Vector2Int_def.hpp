...
/// @brief Method Equals, addr 0x2f83600, size 0x88, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x2f83688, size 0x28, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Vector2Int  other) ;

/// @brief Method FloorToInt, addr 0x2f83518, size 0xc8, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2Int FloorToInt(::UnityEngine::Vector2  v) ;

/// @brief Method GetHashCode, addr 0x2f836b0, size 0x48, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x2f836f8, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2f83708, size 0x178, virtual true, abstract: false, final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method .ctor, addr 0x2f834e8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_magnitude, addr 0x2f834f0, size 0x18, virtual false, abstract: false, final false
inline float_t get_magnitude() ;

/// @brief Method get_x, addr 0x2f834c8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_x() ;

/// @brief Method get_y, addr 0x2f834d8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_y() ;

/// @brief Method get_zero, addr 0x2f83880, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2f835e0, size 0x20, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::Vector2Int  lhs, ::UnityEngine::Vector2Int  rhs) ;

/// @brief Method op_Implicit, addr 0x2f83508, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method set_x, addr 0x2f834d0, size 0x8, virtual false, abstract: false, final false
inline void set_x(int32_t  value) ;

/// @brief Method set_y, addr 0x2f834e0, size 0x8, virtual false, abstract: false, final false
