...
/// @brief Method GetString, addr 0x2f7b390, size 0x120, virtual false, abstract: false, final false
static inline ::StringW GetString(::System::Object*  message) ;

/// @brief Method IsLogTypeAllowed, addr 0x2f7b358, size 0x38, virtual true, abstract: false, final true
inline bool IsLogTypeAllowed(::UnityEngine::LogType  logType) ;

/// @brief Method Log, addr 0x2f7b4b0, size 0x178, virtual true, abstract: false, final true
inline void Log(::UnityEngine::LogType  logType, ::System::Object*  message) ;

/// @brief Method Log, addr 0x2f7b628, size 0x17c, virtual true, abstract: false, final true
inline void Log(::UnityEngine::LogType  logType, ::System::Object*  message, ::UnityEngine::Object*  context) ;

/// @brief Method Log, addr 0x2f7b7a4, size 0x1a4, virtual true, abstract: false, final true
inline void Log(::UnityEngine::LogType  logType, ::StringW  tag, ::System::Object*  message) ;

/// @brief Method Log, addr 0x2f7b948, size 0x194, virtual true, abstract: false, final true
inline void Log(::StringW  tag, ::System::Object*  message) ;

/// @brief Method LogError, addr 0x2f7bc70, size 0x190, virtual true, abstract: false, final true
inline void LogError(::StringW  tag, ::System::Object*  message) ;

/// @brief Method LogException, addr 0x2f7be00, size 0xd4, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception, ::UnityEngine::Object*  context) ;

/// @brief Method LogFormat, addr 0x2f7bfd0, size 0x10c, virtual true, abstract: false, final true
...
/// @brief Method LogFormat, addr 0x2f7bed4, size 0xfc, virtual true, abstract: false, final true
inline void LogFormat(::UnityEngine::LogType  logType, ::StringW  format, ::ArrayW<::System::Object*,::Array<::System::Object*>*>  args) ;

/// @brief Method LogWarning, addr 0x2f7badc, size 0x194, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2f7b2ec, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::ILogHandler*  logHandler) ;

/// @brief Method get_filterLogType, addr 0x2f7b348, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::LogType get_filterLogType() ;

/// @brief Method get_logEnabled, addr 0x2f7b334, size 0x8, virtual true, abstract: false, final true
inline bool get_logEnabled() ;

/// @brief Method get_logHandler, addr 0x2f7b324, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_filterLogType, addr 0x2f7b350, size 0x8, virtual true, abstract: false, final true
inline void set_filterLogType(::UnityEngine::LogType  value) ;

/// @brief Method set_logEnabled, addr 0x2f7b33c, size 0xc, virtual true, abstract: false, final true
inline void set_logEnabled(bool  value) ;

/// @brief Method set_logHandler, addr 0x2f7b32c, size 0x8, virtual true, abstract: false, final true
