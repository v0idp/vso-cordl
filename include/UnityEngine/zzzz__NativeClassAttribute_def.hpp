...
/// @brief Method .ctor, addr 0x2fccd5c, size 0x70, virtual false, abstract: false, final false
inline void _ctor(::StringW  qualifiedCppName) ;

/// @brief Method .ctor, addr 0x2fccdcc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  qualifiedCppName, ::StringW  declaration) ;

/// @brief Method set_Declaration, addr 0x2fccd54, size 0x8, virtual false, abstract: false, final false
inline void set_Declaration(::StringW  value) ;

/// @brief Method set_QualifiedNativeName, addr 0x2fccd4c, size 0x8, virtual false, abstract: false, final false
