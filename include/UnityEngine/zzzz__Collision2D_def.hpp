...
public:
// Declarations
 __declspec(property(get=get_contacts)) ::ArrayW<::UnityEngine::ContactPoint2D,::Array<::UnityEngine::ContactPoint2D>*>  contacts;
...
/// @brief Method get_contacts, addr 0x2fc1fe4, size 0x74, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::ContactPoint2D,::Array<::UnityEngine::ContactPoint2D>*> get_contacts() ;

/// @brief Method get_relativeVelocity, addr 0x2fc1fdc, size 0x8, virtual false, abstract: false, final false
