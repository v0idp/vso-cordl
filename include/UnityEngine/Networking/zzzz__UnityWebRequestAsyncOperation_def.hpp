...
/// @brief Method .ctor, addr 0x31960fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_webRequest, addr 0x31960ec, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Networking::UnityWebRequest* get_webRequest() ;

/// @brief Method set_webRequest, addr 0x31960f4, size 0x8, virtual false, abstract: false, final false
