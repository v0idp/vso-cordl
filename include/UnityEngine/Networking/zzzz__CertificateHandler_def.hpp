...
/// @brief Method Dispose, addr 0x3195838, size 0x58, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Release, addr 0x31957e8, size 0x3c, virtual false, abstract: false, final false
inline void Release() ;

/// @brief Method ValidateCertificate, addr 0x3195824, size 0x8, virtual true, abstract: false, final false
inline bool ValidateCertificate(::ArrayW<uint8_t,::Array<uint8_t>*>  certificateData) ;

/// @brief Method ValidateCertificateNative, addr 0x319582c, size 0xc, virtual false, abstract: false, final false
