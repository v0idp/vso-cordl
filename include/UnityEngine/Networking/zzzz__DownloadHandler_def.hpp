...
/// @brief Method CompleteContent, addr 0x3195df8, size 0x4, virtual true, abstract: false, final false
inline void CompleteContent() ;

/// @brief Method CreateNativeArrayForNativeData, addr 0x3195f64, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x3195970, size 0x58, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method DisposeNativeArray, addr 0x3195f20, size 0x44, virtual false, abstract: false, final false
static inline void DisposeNativeArray(::ByRef<::Unity::Collections::NativeArray_1<uint8_t>>  data) ;

/// @brief Method Finalize, addr 0x31958d4, size 0x9c, virtual true, abstract: false, final false
...
/// @brief Method GetContentType, addr 0x3195da4, size 0x3c, virtual false, abstract: false, final false
inline ::StringW GetContentType() ;

/// @brief Method GetData, addr 0x31959ec, size 0x4, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetData() ;

/// @brief Method GetNativeData, addr 0x31959e0, size 0xc, virtual true, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData() ;

/// @brief Method GetProgress, addr 0x3195dfc, size 0x8, virtual true, abstract: false, final false
inline float_t GetProgress() ;

/// @brief Method GetText, addr 0x3195a74, size 0xc0, virtual true, abstract: false, final false
inline ::StringW GetText() ;

/// @brief Method GetTextEncoder, addr 0x3195b34, size 0x270, virtual false, abstract: false, final false
inline ::System::Text::Encoding* GetTextEncoder() ;

/// @brief Method InternalGetByteArray, addr 0x31959f0, size 0x84, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> InternalGetByteArray(::UnityEngine::Networking::DownloadHandler*  dh) ;

/// @brief Method InternalGetByteArray, addr 0x3195e04, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method InternalGetNativeArray, addr 0x3195e48, size 0xd8, virtual false, abstract: false, final false
...
/// @brief Method ReceiveContentLength, addr 0x3195df4, size 0x4, virtual true, abstract: false, final false
inline void ReceiveContentLength(int32_t  contentLength) ;

/// @brief Method ReceiveContentLengthHeader, addr 0x3195de8, size 0xc, virtual true, abstract: false, final false
inline void ReceiveContentLengthHeader(uint64_t  contentLength) ;

/// @brief Method ReceiveData, addr 0x3195de0, size 0x8, virtual true, abstract: false, final false
inline bool ReceiveData(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  dataLength) ;

/// @brief Method Release, addr 0x3195890, size 0x3c, virtual false, abstract: false, final false
inline void Release() ;
...
/// @brief Method .ctor, addr 0x31958cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_data, addr 0x31959c8, size 0xc, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_data() ;

/// @brief Method get_text, addr 0x31959d4, size 0xc, virtual false, abstract: false, final false
