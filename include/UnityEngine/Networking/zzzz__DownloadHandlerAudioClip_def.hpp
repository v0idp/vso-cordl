...
/// @brief Method Create, addr 0x3192a30, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x3192b50, size 0x24, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetContent, addr 0x3192bfc, size 0x7c, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::AudioClip> GetContent(::UnityEngine::Networking::UnityWebRequest*  www) ;

/// @brief Method GetNativeData, addr 0x3192b44, size 0xc, virtual true, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData() ;

/// @brief Method GetText, addr 0x3192b74, size 0x4c, virtual true, abstract: false, final false
inline ::StringW GetText() ;

/// @brief Method InternalCreateAudioClip, addr 0x3192a84, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3192ae0, size 0x64, virtual false, abstract: false, final false
inline void _ctor(::StringW  url, ::UnityEngine::AudioType  audioType) ;

/// @brief Method get_audioClip, addr 0x3192bc0, size 0x3c, virtual false, abstract: false, final false
