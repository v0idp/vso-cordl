...
public:
// Declarations
/// @brief Method GetTexture, addr 0x31994c4, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::Networking::UnityWebRequest* GetTexture(::StringW  uri) ;

/// @brief Method GetTexture, addr 0x31994cc, size 0xbc, virtual false, abstract: false, final false
