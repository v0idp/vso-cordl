...
/// @brief Method Create, addr 0x319932c, size 0x44, virtual false, abstract: false, final false
static inline ::System::IntPtr Create(::UnityEngine::Networking::DownloadHandlerTexture*  obj, bool  readable) ;

/// @brief Method Dispose, addr 0x3199428, size 0x24, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetNativeData, addr 0x319941c, size 0xc, virtual true, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData() ;

/// @brief Method InternalCreateTexture, addr 0x3199370, size 0x4c, virtual false, abstract: false, final false
inline void InternalCreateTexture(bool  readable) ;

/// @brief Method InternalGetTextureNative, addr 0x3199488, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31993bc, size 0x60, virtual false, abstract: false, final false
inline void _ctor(bool  readable) ;

/// @brief Method get_texture, addr 0x319944c, size 0x3c, virtual false, abstract: false, final false
