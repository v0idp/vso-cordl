...
/// @brief Method Create, addr 0x3195fcc, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr Create(::UnityEngine::Networking::DownloadHandlerBuffer*  obj) ;

/// @brief Method Dispose, addr 0x31960a0, size 0x4c, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method GetNativeData, addr 0x3196098, size 0x8, virtual true, abstract: false, final false
inline ::Unity::Collections::NativeArray_1<uint8_t> GetNativeData() ;

/// @brief Method InternalCreateBuffer, addr 0x3196008, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x319604c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
