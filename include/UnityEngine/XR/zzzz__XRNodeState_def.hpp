...
/// @brief Method TryGet, addr 0x319a700, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method TryGet, addr 0x319a67c, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method TryGetAcceleration, addr 0x319a798, size 0x14, virtual false, abstract: false, final false
inline bool TryGetAcceleration(::ByRef<::UnityEngine::Vector3>  acceleration) ;

/// @brief Method TryGetAngularAcceleration, addr 0x319a7ac, size 0x14, virtual false, abstract: false, final false
inline bool TryGetAngularAcceleration(::ByRef<::UnityEngine::Vector3>  angularAcceleration) ;

/// @brief Method TryGetAngularVelocity, addr 0x319a784, size 0x14, virtual false, abstract: false, final false
inline bool TryGetAngularVelocity(::ByRef<::UnityEngine::Vector3>  angularVelocity) ;

/// @brief Method TryGetPosition, addr 0x319a668, size 0x14, virtual false, abstract: false, final false
inline bool TryGetPosition(::ByRef<::UnityEngine::Vector3>  position) ;

/// @brief Method TryGetRotation, addr 0x319a6ec, size 0x14, virtual false, abstract: false, final false
inline bool TryGetRotation(::ByRef<::UnityEngine::Quaternion>  rotation) ;

/// @brief Method TryGetVelocity, addr 0x319a770, size 0x14, virtual false, abstract: false, final false
inline bool TryGetVelocity(::ByRef<::UnityEngine::Vector3>  velocity) ;

/// @brief Method get_nodeType, addr 0x319a660, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::XR::XRNode get_nodeType() ;

/// @brief Method set_nodeType, addr 0x319a55c, size 0x8, virtual false, abstract: false, final false
inline void set_nodeType(::UnityEngine::XR::XRNode  value) ;

/// @brief Method set_tracked, addr 0x319a564, size 0xc, virtual false, abstract: false, final false
inline void set_tracked(bool  value) ;

/// @brief Method set_uniqueID, addr 0x319a554, size 0x8, virtual false, abstract: false, final false
