...
/// @brief Method FinishSetup, addr 0x2d9884c, size 0x7c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2d988c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_userPresence, addr 0x2d9883c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::InputSystem::Controls::ButtonControl* get_userPresence() ;

/// @brief Method set_userPresence, addr 0x2d98844, size 0x8, virtual false, abstract: false, final false
