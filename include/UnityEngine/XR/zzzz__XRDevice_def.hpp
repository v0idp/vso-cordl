...
/// @brief Method DisableAutoXRCameraTracking, addr 0x319a2fc, size 0x44, virtual false, abstract: false, final false
static inline void DisableAutoXRCameraTracking(::UnityEngine::Camera*  camera, bool  disabled) ;

/// @brief Method InvokeDeviceLoaded, addr 0x319a340, size 0x6c, virtual false, abstract: false, final false
