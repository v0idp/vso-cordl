...
public:
// Declarations
/// @brief Method TryGetStat, addr 0x319c150, size 0x5c, virtual false, abstract: false, final false
static inline bool TryGetStat(::UnityEngine::IntegratedSubsystem*  xrSubsystem, ::StringW  tag, ::ByRef<float_t>  value) ;

/// @brief Method TryGetStat_Internal, addr 0x319c1ac, size 0x54, virtual false, abstract: false, final false
