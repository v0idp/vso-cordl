...
/// @brief Method Equals, addr 0x319acd0, size 0x88, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x319ad58, size 0x24, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::XR::Hand  other) ;

/// @brief Method GetHashCode, addr 0x319ad7c, size 0x50, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_deviceId, addr 0x319acc0, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_deviceId() ;

/// @brief Method get_featureIndex, addr 0x319acc8, size 0x8, virtual false, abstract: false, final false
