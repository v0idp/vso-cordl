...
/// @brief Method Equals, addr 0x319bb5c, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x319bbec, size 0x1c4, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::XR::MeshGenerationResult  other) ;

/// @brief Method GetHashCode, addr 0x319bdb0, size 0x240, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_Attributes, addr 0x319bb30, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::XR::MeshVertexAttributes get_Attributes() ;

/// @brief Method get_Mesh, addr 0x319bb18, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_Mesh() ;

/// @brief Method get_MeshCollider, addr 0x319bb20, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::MeshCollider> get_MeshCollider() ;

/// @brief Method get_MeshId, addr 0x319bb0c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::XR::MeshId get_MeshId() ;

/// @brief Method get_Position, addr 0x319bb38, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_Position() ;

/// @brief Method get_Rotation, addr 0x319bb44, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Quaternion get_Rotation() ;

/// @brief Method get_Scale, addr 0x319bb50, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_Scale() ;

/// @brief Method get_Status, addr 0x319bb28, size 0x8, virtual false, abstract: false, final false
