...
/// @brief Method .ctor, addr 0x2f3626c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2f36274, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  displayName, ::StringW  buildSettingsKey) ;

/// @brief Method get_buildSettingsKey, addr 0x2f3625c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_buildSettingsKey() ;

/// @brief Method get_displayName, addr 0x2f3624c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_displayName() ;

/// @brief Method set_buildSettingsKey, addr 0x2f36264, size 0x8, virtual false, abstract: false, final false
inline void set_buildSettingsKey(::StringW  value) ;

/// @brief Method set_displayName, addr 0x2f36254, size 0x8, virtual false, abstract: false, final false
