...
public:
// Declarations
/// @brief Method Deinitialize, addr 0x2f37120, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method GetSupportedGraphicsDeviceTypes, addr 0x2f37128, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method Initialize, addr 0x2f37108, size 0x8, virtual true, abstract: false, final false
inline bool Initialize() ;

static inline ::UnityEngine::XR::Management::XRLoader* New_ctor() ;

/// @brief Method Start, addr 0x2f37110, size 0x8, virtual true, abstract: false, final false
inline bool Start() ;

/// @brief Method Stop, addr 0x2f37118, size 0x8, virtual true, abstract: false, final false
inline bool Stop() ;

/// @brief Method .ctor, addr 0x2f37190, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
