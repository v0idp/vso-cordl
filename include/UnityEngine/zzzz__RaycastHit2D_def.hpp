...
/// @brief Method get_collider, addr 0x2fc2080, size 0xac, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Collider2D> get_collider() ;

/// @brief Method get_distance, addr 0x2fc2070, size 0x8, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_fraction, addr 0x2fc2078, size 0x8, virtual false, abstract: false, final false
inline float_t get_fraction() ;

/// @brief Method get_normal, addr 0x2fc2068, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_normal() ;

/// @brief Method get_point, addr 0x2fc2060, size 0x8, virtual false, abstract: false, final false
