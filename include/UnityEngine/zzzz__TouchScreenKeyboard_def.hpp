...
/// @brief Method Destroy, addr 0x2f91548, size 0xa4, virtual false, abstract: false, final false
inline void Destroy() ;

/// @brief Method Finalize, addr 0x2f915ec, size 0x94, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetSelection, addr 0x2f91d7c, size 0x44, virtual false, abstract: false, final false
static inline void GetSelection(::ByRef<int32_t>  start, ::ByRef<int32_t>  length) ;

/// @brief Method Internal_Destroy, addr 0x2f9150c, size 0x3c, virtual false, abstract: false, final false
static inline void Internal_Destroy(::System::IntPtr  ptr) ;

/// @brief Method IsInPlaceEditingAllowed, addr 0x2f91990, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method Open, addr 0x2f91a70, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method Open, addr 0x2f919b8, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method SetSelection, addr 0x2f91eb4, size 0x44, virtual false, abstract: false, final false
static inline void SetSelection(int32_t  start, int32_t  length) ;

/// @brief Method TouchScreenKeyboard_InternalConstructorHelper, addr 0x2f917dc, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f91680, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method get_active, addr 0x2f91bb8, size 0x3c, virtual false, abstract: false, final false
inline bool get_active() ;

/// @brief Method get_canGetSelection, addr 0x2f91cb8, size 0x3c, virtual false, abstract: false, final false
inline bool get_canGetSelection() ;

/// @brief Method get_canSetSelection, addr 0x2f91cf4, size 0x3c, virtual false, abstract: false, final false
inline bool get_canSetSelection() ;

/// @brief Method get_disableInPlaceEditing, addr 0x2f918dc, size 0x48, virtual false, abstract: false, final false
static inline bool get_disableInPlaceEditing() ;

/// @brief Method get_isInPlaceEditingAllowed, addr 0x2f91924, size 0x6c, virtual false, abstract: false, final false
static inline bool get_isInPlaceEditingAllowed() ;

/// @brief Method get_isSupported, addr 0x2f91830, size 0xac, virtual false, abstract: false, final false
static inline bool get_isSupported() ;

/// @brief Method get_selection, addr 0x2f91d30, size 0x4c, virtual false, abstract: false, final false
inline ::UnityEngine::RangeInt get_selection() ;

/// @brief Method get_status, addr 0x2f91c38, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::TouchScreenKeyboard_Status get_status() ;

/// @brief Method get_text, addr 0x2f91afc, size 0x3c, virtual false, abstract: false, final false
inline ::StringW get_text() ;

static inline void setStaticF__disableInPlaceEditing_k__BackingField(bool  value) ;

/// @brief Method set_active, addr 0x2f91bf4, size 0x44, virtual false, abstract: false, final false
inline void set_active(bool  value) ;

/// @brief Method set_characterLimit, addr 0x2f91c74, size 0x44, virtual false, abstract: false, final false
inline void set_characterLimit(int32_t  value) ;

/// @brief Method set_hideInput, addr 0x2f91b7c, size 0x3c, virtual false, abstract: false, final false
static inline void set_hideInput(bool  value) ;

/// @brief Method set_selection, addr 0x2f91dc0, size 0xf4, virtual false, abstract: false, final false
inline void set_selection(::UnityEngine::RangeInt  value) ;

/// @brief Method set_text, addr 0x2f91b38, size 0x44, virtual false, abstract: false, final false
