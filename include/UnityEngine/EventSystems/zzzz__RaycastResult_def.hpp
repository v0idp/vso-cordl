...
/// @brief Method Clear, addr 0x31907b4, size 0xa8, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ToString, addr 0x318563c, size 0x430, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_gameObject, addr 0x319070c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_gameObject() ;

/// @brief Method get_isValid, addr 0x319071c, size 0x98, virtual false, abstract: false, final false
inline bool get_isValid() ;

/// @brief Method set_gameObject, addr 0x3190714, size 0x8, virtual false, abstract: false, final false
