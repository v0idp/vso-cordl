...
/// @brief Method .ctor, addr 0x318462c, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::EventSystems::EventSystem*  eventSystem) ;

/// @brief Method get_moveDir, addr 0x318461c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::MoveDirection get_moveDir() ;

/// @brief Method get_moveVector, addr 0x318460c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_moveVector() ;

/// @brief Method set_moveDir, addr 0x3184624, size 0x8, virtual false, abstract: false, final false
inline void set_moveDir(::UnityEngine::EventSystems::MoveDirection  value) ;

/// @brief Method set_moveVector, addr 0x3184614, size 0x8, virtual false, abstract: false, final false
