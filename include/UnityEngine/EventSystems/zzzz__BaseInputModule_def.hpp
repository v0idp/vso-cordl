...
/// @brief Method ActivateModule, addr 0x318ac4c, size 0x4, virtual true, abstract: false, final false
inline void ActivateModule() ;

/// @brief Method ConvertUIToolkitPointerId, addr 0x318ac5c, size 0x7c, virtual true, abstract: false, final false
inline int32_t ConvertUIToolkitPointerId(::UnityEngine::EventSystems::PointerEventData*  sourcePointerData) ;

/// @brief Method DeactivateModule, addr 0x318ac48, size 0x4, virtual true, abstract: false, final false
inline void DeactivateModule() ;

/// @brief Method DetermineMoveDirection, addr 0x3189de8, size 0x54, virtual false, abstract: false, final false
static inline ::UnityEngine::EventSystems::MoveDirection DetermineMoveDirection(float_t  x, float_t  y) ;

/// @brief Method DetermineMoveDirection, addr 0x3189e3c, size 0x50, virtual false, abstract: false, final false
static inline ::UnityEngine::EventSystems::MoveDirection DetermineMoveDirection(float_t  x, float_t  y, float_t  deadZone) ;

/// @brief Method FindCommonRoot, addr 0x3189e8c, size 0x174, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::GameObject> FindCommonRoot(::UnityEngine::GameObject*  g1, ::UnityEngine::GameObject*  g2) ;

/// @brief Method FindFirstRaycast, addr 0x3189cd4, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method GetAxisEventData, addr 0x318aa84, size 0x100, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::AxisEventData* GetAxisEventData(float_t  x, float_t  y, float_t  moveDeadZone) ;

/// @brief Method GetBaseEventData, addr 0x318ab84, size 0x7c, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::BaseEventData* GetBaseEventData() ;

/// @brief Method HandlePointerExitAndEnter, addr 0x318a000, size 0xa84, virtual false, abstract: false, final false
...
/// @brief Method IsModuleSupported, addr 0x318ac54, size 0x8, virtual true, abstract: false, final false
inline bool IsModuleSupported() ;

/// @brief Method IsPointerOverGameObject, addr 0x318ac00, size 0x8, virtual true, abstract: false, final false
inline bool IsPointerOverGameObject(int32_t  pointerId) ;

static inline ::UnityEngine::EventSystems::BaseInputModule* New_ctor() ;

/// @brief Method OnDisable, addr 0x3189cbc, size 0x18, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3189c64, size 0x58, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Process, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
inline void Process() ;

/// @brief Method ShouldActivateModule, addr 0x318ac08, size 0x40, virtual true, abstract: false, final false
inline bool ShouldActivateModule() ;

/// @brief Method UpdateModule, addr 0x318ac50, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x318acd8, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_eventSystem, addr 0x3189c5c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::EventSystem> get_eventSystem() ;

/// @brief Method get_input, addr 0x3189a34, size 0x218, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseInput> get_input() ;

/// @brief Method get_inputOverride, addr 0x3189c4c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseInput> get_inputOverride() ;

/// @brief Method get_sendPointerHoverToParent, addr 0x3189a20, size 0x8, virtual false, abstract: false, final false
inline bool get_sendPointerHoverToParent() ;

/// @brief Method set_inputOverride, addr 0x3189c54, size 0x8, virtual false, abstract: false, final false
inline void set_inputOverride(::UnityEngine::EventSystems::BaseInput*  value) ;

/// @brief Method set_sendPointerHoverToParent, addr 0x3189a28, size 0xc, virtual false, abstract: false, final false
