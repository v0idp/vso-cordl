...
/// @brief Method Compare, addr 0x3190668, size 0x40, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x31906a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ComputeRayAndDistance, addr 0x318fcf4, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x3190264, size 0x404, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x318f5e0, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_depth, addr 0x3190180, size 0xc4, virtual true, abstract: false, final false
inline int32_t get_depth() ;

/// @brief Method get_eventCamera, addr 0x31900b0, size 0xd0, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_eventMask, addr 0x3190244, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_eventMask() ;

/// @brief Method get_finalEventMask, addr 0x318ffec, size 0xc4, virtual false, abstract: false, final false
inline int32_t get_finalEventMask() ;

/// @brief Method get_maxRayIntersections, addr 0x3190254, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxRayIntersections() ;

/// @brief Method set_eventMask, addr 0x319024c, size 0x8, virtual false, abstract: false, final false
inline void set_eventMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_maxRayIntersections, addr 0x319025c, size 0x8, virtual false, abstract: false, final false
