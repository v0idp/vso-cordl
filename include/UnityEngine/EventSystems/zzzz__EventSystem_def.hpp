...
/// @brief Method <CreateUIToolkitPanelGameObject>b__0, addr 0x3187860, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3186f54, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ChangeEventModule, addr 0x318751c, size 0xf8, virtual false, abstract: false, final false
inline void ChangeEventModule(::UnityEngine::EventSystems::BaseInputModule*  _cordl_module) ;

/// @brief Method CreateUIToolkitPanelGameObject, addr 0x3186c10, size 0x298, virtual false, abstract: false, final false
inline void CreateUIToolkitPanelGameObject(::UnityEngine::UIElements::BaseRuntimePanel*  panel) ;

/// @brief Method IsPointerOverGameObject, addr 0x31865b8, size 0x8, virtual false, abstract: false, final false
inline bool IsPointerOverGameObject() ;

/// @brief Method IsPointerOverGameObject, addr 0x31865c0, size 0xa4, virtual false, abstract: false, final false
inline bool IsPointerOverGameObject(int32_t  pointerId) ;

static inline ::UnityEngine::EventSystems::EventSystem* New_ctor() ;

/// @brief Method OnApplicationFocus, addr 0x31872a0, size 0x14, virtual true, abstract: false, final false
inline void OnApplicationFocus(bool  hasFocus) ;

/// @brief Method OnDisable, addr 0x3187090, size 0x110, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3186f6c, size 0x124, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RaycastAll, addr 0x31863c8, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method RaycastComparer, addr 0x3185f58, size 0x3b8, virtual false, abstract: false, final false
...
/// @brief Method SetSelectedGameObject, addr 0x3181968, size 0x2c, virtual false, abstract: false, final false
inline void SetSelectedGameObject(::UnityEngine::GameObject*  selected) ;

/// @brief Method SetSelectedGameObject, addr 0x3184734, size 0x224, virtual false, abstract: false, final false
inline void SetSelectedGameObject(::UnityEngine::GameObject*  selected, ::UnityEngine::EventSystems::BaseEventData*  pointer) ;

/// @brief Method SetUITookitEventSystemOverride, addr 0x318683c, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x3186f5c, size 0xc, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method StartTrackingUIToolkitPanels, addr 0x31869d8, size 0x238, virtual false, abstract: false, final false
inline void StartTrackingUIToolkitPanels() ;

/// @brief Method StopTrackingUIToolkitPanels, addr 0x3186ea8, size 0xac, virtual false, abstract: false, final false
inline void StopTrackingUIToolkitPanels() ;

/// @brief Method TickModules, addr 0x31871a0, size 0x100, virtual false, abstract: false, final false
inline void TickModules() ;

/// @brief Method ToString, addr 0x3187614, size 0x158, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method Update, addr 0x31872b4, size 0x268, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateModules, addr 0x3185da8, size 0x140, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3185d18, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_alreadySelecting, addr 0x3185ee8, size 0x8, virtual false, abstract: false, final false
inline bool get_alreadySelecting() ;

/// @brief Method get_baseEventDataCache, addr 0x3185ef0, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::BaseEventData* get_baseEventDataCache() ;

/// @brief Method get_createUIToolkitPanelGameObjectsOnStart, addr 0x31867c8, size 0x74, virtual false, abstract: false, final false
inline bool get_createUIToolkitPanelGameObjectsOnStart() ;

/// @brief Method get_current, addr 0x3185a6c, size 0xc4, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::EventSystems::EventSystem> get_current() ;

/// @brief Method get_currentInputModule, addr 0x3185ce8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseInputModule> get_currentInputModule() ;

/// @brief Method get_currentSelectedGameObject, addr 0x3185d00, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_currentSelectedGameObject() ;

/// @brief Method get_firstSelectedGameObject, addr 0x3185cf0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_firstSelectedGameObject() ;

/// @brief Method get_isFocused, addr 0x3185d10, size 0x8, virtual false, abstract: false, final false
inline bool get_isFocused() ;

/// @brief Method get_isUIToolkitActiveEventSystem, addr 0x3186664, size 0xf0, virtual false, abstract: false, final false
inline bool get_isUIToolkitActiveEventSystem() ;

/// @brief Method get_lastSelectedGameObject, addr 0x3185d08, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_lastSelectedGameObject() ;

/// @brief Method get_pixelDragThreshold, addr 0x3185cd8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_pixelDragThreshold() ;

/// @brief Method get_sendNavigationEvents, addr 0x3185cc4, size 0x8, virtual false, abstract: false, final false
inline bool get_sendNavigationEvents() ;

/// @brief Method get_sendUIToolkitEvents, addr 0x3186754, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method set_current, addr 0x3185b30, size 0x194, virtual false, abstract: false, final false
static inline void set_current(::UnityEngine::EventSystems::EventSystem*  value) ;

/// @brief Method set_firstSelectedGameObject, addr 0x3185cf8, size 0x8, virtual false, abstract: false, final false
inline void set_firstSelectedGameObject(::UnityEngine::GameObject*  value) ;

/// @brief Method set_pixelDragThreshold, addr 0x3185ce0, size 0x8, virtual false, abstract: false, final false
inline void set_pixelDragThreshold(int32_t  value) ;

/// @brief Method set_sendNavigationEvents, addr 0x3185ccc, size 0xc, virtual false, abstract: false, final false
