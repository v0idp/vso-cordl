...
public:
// Declarations
/// @brief Method GetRay, addr 0x28bb070, size 0x88, virtual false, abstract: false, final false
static inline ::UnityEngine::Ray GetRay(::UnityEngine::EventSystems::PointerEventData*  pointerEventData) ;

/// @brief Method GetSwipeStart, addr 0x28ba4e4, size 0x7c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 GetSwipeStart(::UnityEngine::EventSystems::PointerEventData*  pointerEventData) ;

/// @brief Method IsVRPointer, addr 0x28b89b0, size 0x78, virtual false, abstract: false, final false
static inline bool IsVRPointer(::UnityEngine::EventSystems::PointerEventData*  pointerEventData) ;

/// @brief Method SetSwipeStart, addr 0x28b8a28, size 0x8c, virtual false, abstract: false, final false
