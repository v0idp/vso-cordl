...
/// @brief Method DeactivateModule, addr 0x318ee08, size 0x4, virtual true, abstract: false, final false
inline void DeactivateModule() ;

/// @brief Method FakeTouches, addr 0x318e514, size 0x128, virtual false, abstract: false, final false
inline void FakeTouches() ;

/// @brief Method IsModuleSupported, addr 0x318e3e0, size 0x38, virtual true, abstract: false, final false
inline bool IsModuleSupported() ;

static inline ::UnityEngine::EventSystems::TouchInputModule* New_ctor() ;

/// @brief Method Process, addr 0x318e4ec, size 0x28, virtual true, abstract: false, final false
inline void Process() ;

/// @brief Method ProcessTouchEvents, addr 0x318e63c, size 0x148, virtual false, abstract: false, final false
inline void ProcessTouchEvents() ;

/// @brief Method ProcessTouchPress, addr 0x318e784, size 0x684, virtual false, abstract: false, final false
inline void ProcessTouchPress(::UnityEngine::EventSystems::PointerEventData*  pointerEvent, bool  pressed, bool  released) ;

/// @brief Method ShouldActivateModule, addr 0x318e418, size 0xa4, virtual true, abstract: false, final false
inline bool ShouldActivateModule() ;

/// @brief Method ToString, addr 0x318ee0c, size 0x248, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method UpdateModule, addr 0x318e290, size 0x150, virtual true, abstract: false, final false
inline void UpdateModule() ;

/// @brief Method UseFakeInput, addr 0x318e4bc, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x318e264, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowActivationOnStandalone, addr 0x318e268, size 0x8, virtual false, abstract: false, final false
inline bool get_allowActivationOnStandalone() ;

/// @brief Method get_forceModuleActive, addr 0x318e27c, size 0x8, virtual false, abstract: false, final false
inline bool get_forceModuleActive() ;

/// @brief Method set_allowActivationOnStandalone, addr 0x318e270, size 0xc, virtual false, abstract: false, final false
inline void set_allowActivationOnStandalone(bool  value) ;

/// @brief Method set_forceModuleActive, addr 0x318e284, size 0xc, virtual false, abstract: false, final false
