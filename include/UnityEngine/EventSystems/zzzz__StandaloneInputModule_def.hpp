...
/// @brief Method ActivateModule, addr 0x318cbc8, size 0x100, virtual true, abstract: false, final false
inline void ActivateModule() ;

/// @brief Method DeactivateModule, addr 0x318ccc8, size 0x4, virtual true, abstract: false, final false
inline void DeactivateModule() ;

/// @brief Method ForceAutoSelect, addr 0x318dee0, size 0x8, virtual true, abstract: false, final false
inline bool ForceAutoSelect() ;

/// @brief Method GetCurrentFocusedGameObject, addr 0x318e25c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> GetCurrentFocusedGameObject() ;

/// @brief Method GetRawMoveVector, addr 0x318db2c, size 0x10c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetRawMoveVector() ;

static inline ::UnityEngine::EventSystems::StandaloneInputModule* New_ctor() ;

/// @brief Method Process, addr 0x318cccc, size 0xa4, virtual true, abstract: false, final false
inline void Process() ;

/// @brief Method ProcessMouseEvent, addr 0x318d01c, size 0x8, virtual false, abstract: false, final false
inline void ProcessMouseEvent() ;

/// @brief Method ProcessMouseEvent, addr 0x318dc38, size 0x2a8, virtual false, abstract: false, final false
inline void ProcessMouseEvent(int32_t  id) ;

/// @brief Method ProcessMousePress, addr 0x318dee8, size 0x374, virtual false, abstract: false, final false
inline void ProcessMousePress(::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData*  data) ;

/// @brief Method ProcessTouchEvents, addr 0x318ceb8, size 0x164, virtual false, abstract: false, final false
inline bool ProcessTouchEvents() ;

/// @brief Method ProcessTouchPress, addr 0x318d498, size 0x694, virtual false, abstract: false, final false
inline void ProcessTouchPress(::UnityEngine::EventSystems::PointerEventData*  pointerEvent, bool  pressed, bool  released) ;

/// @brief Method ReleaseMouse, addr 0x318c624, size 0x36c, virtual false, abstract: false, final false
inline void ReleaseMouse(::UnityEngine::EventSystems::PointerEventData*  pointerEvent, ::UnityEngine::GameObject*  currentOverGo) ;

/// @brief Method SendMoveEventToSelectedObject, addr 0x318d024, size 0x260, virtual false, abstract: false, final false
inline bool SendMoveEventToSelectedObject() ;

/// @brief Method SendSubmitEventToSelectedObject, addr 0x318d284, size 0x214, virtual false, abstract: false, final false
inline bool SendSubmitEventToSelectedObject() ;

/// @brief Method SendUpdateEventToSelectedObject, addr 0x318cd70, size 0x148, virtual false, abstract: false, final false
inline bool SendUpdateEventToSelectedObject() ;

/// @brief Method ShouldActivateModule, addr 0x318c990, size 0x238, virtual true, abstract: false, final false
inline bool ShouldActivateModule() ;

/// @brief Method ShouldIgnoreEventsOnNoFocus, addr 0x318c54c, size 0x8, virtual false, abstract: false, final false
inline bool ShouldIgnoreEventsOnNoFocus() ;

/// @brief Method UpdateModule, addr 0x318c554, size 0xd0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x318c408, size 0xb4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowActivationOnMobileDevice, addr 0x318c4c4, size 0x8, virtual false, abstract: false, final false
inline bool get_allowActivationOnMobileDevice() ;

/// @brief Method get_cancelButton, addr 0x318c53c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_cancelButton() ;

/// @brief Method get_forceModuleActive, addr 0x318c4d8, size 0x8, virtual false, abstract: false, final false
inline bool get_forceModuleActive() ;

/// @brief Method get_horizontalAxis, addr 0x318c50c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_horizontalAxis() ;

/// @brief Method get_inputActionsPerSecond, addr 0x318c4ec, size 0x8, virtual false, abstract: false, final false
inline float_t get_inputActionsPerSecond() ;

/// @brief Method get_inputMode, addr 0x318c4bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::StandaloneInputModule_InputMode get_inputMode() ;

/// @brief Method get_repeatDelay, addr 0x318c4fc, size 0x8, virtual false, abstract: false, final false
inline float_t get_repeatDelay() ;

/// @brief Method get_submitButton, addr 0x318c52c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_submitButton() ;

/// @brief Method get_verticalAxis, addr 0x318c51c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_verticalAxis() ;

/// @brief Method set_allowActivationOnMobileDevice, addr 0x318c4cc, size 0xc, virtual false, abstract: false, final false
inline void set_allowActivationOnMobileDevice(bool  value) ;

/// @brief Method set_cancelButton, addr 0x318c544, size 0x8, virtual false, abstract: false, final false
inline void set_cancelButton(::StringW  value) ;

/// @brief Method set_forceModuleActive, addr 0x318c4e0, size 0xc, virtual false, abstract: false, final false
inline void set_forceModuleActive(bool  value) ;

/// @brief Method set_horizontalAxis, addr 0x318c514, size 0x8, virtual false, abstract: false, final false
inline void set_horizontalAxis(::StringW  value) ;

/// @brief Method set_inputActionsPerSecond, addr 0x318c4f4, size 0x8, virtual false, abstract: false, final false
inline void set_inputActionsPerSecond(float_t  value) ;

/// @brief Method set_repeatDelay, addr 0x318c504, size 0x8, virtual false, abstract: false, final false
inline void set_repeatDelay(float_t  value) ;

/// @brief Method set_submitButton, addr 0x318c534, size 0x8, virtual false, abstract: false, final false
inline void set_submitButton(::StringW  value) ;

/// @brief Method set_verticalAxis, addr 0x318c524, size 0x8, virtual false, abstract: false, final false
