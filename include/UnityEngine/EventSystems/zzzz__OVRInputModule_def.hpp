...
/// @brief Method ActivateModule, addr 0x28b7918, size 0xcc, virtual true, abstract: false, final false
inline void ActivateModule() ;

/// @brief Method AllowMoveEventProcessing, addr 0x28b7ee8, size 0x5c, virtual false, abstract: false, final false
inline bool AllowMoveEventProcessing(float_t  time) ;

/// @brief Method ClearSelection, addr 0x28b7a00, size 0x2f8, virtual false, abstract: false, final false
inline void ClearSelection() ;

/// @brief Method CopyFromTo, addr 0x28b8e54, size 0x70, virtual false, abstract: false, final false
inline void CopyFromTo(::UnityEngine::EventSystems::OVRPointerEventData*  from, ::UnityEngine::EventSystems::OVRPointerEventData*  to) ;

/// @brief Method CopyFromTo, addr 0x28b8ec4, size 0x60, virtual false, abstract: false, final false
inline void CopyFromTo(::UnityEngine::EventSystems::PointerEventData*  from, ::UnityEngine::EventSystems::PointerEventData*  to) ;

/// @brief Method DeactivateModule, addr 0x28b79e4, size 0x1c, virtual true, abstract: false, final false
inline void DeactivateModule() ;

/// @brief Method GetCanvasPointerData, addr 0x28b9e14, size 0x388, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetCanvasPointerData() ;

/// @brief Method GetExtraScrollDelta, addr 0x28b98e8, size 0x94, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetExtraScrollDelta() ;

/// @brief Method GetGazeButtonState, addr 0x28ba900, size 0x110, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerEventData_FramePressState GetGazeButtonState() ;

/// @brief Method GetGazePointerData, addr 0x28b91c0, size 0x728, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetGazePointerData() ;

/// @brief Method GetPointerData, addr 0x28b8f24, size 0xf0, virtual false, abstract: false, final false
inline bool GetPointerData(int32_t  id, ::ByRef<::UnityEngine::EventSystems::OVRPointerEventData*>  data, bool  create) ;

/// @brief Method GetRawMoveVector, addr 0x28b7f44, size 0xb8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetRawMoveVector() ;

/// @brief Method GetRectTransformNormal, addr 0x28b901c, size 0x1a4, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetRectTransformNormal(::UnityEngine::RectTransform*  rectTransform) ;

/// @brief Method IsModuleSupported, addr 0x28b7778, size 0x18, virtual true, abstract: false, final false
inline bool IsModuleSupported() ;

/// @brief Method IsPointerMoving, addr 0x28b8e20, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method Process, addr 0x28b8dbc, size 0x64, virtual true, abstract: false, final false
inline void Process() ;

/// @brief Method ProcessDrag, addr 0x28ba5e8, size 0x318, virtual true, abstract: false, final false
inline void ProcessDrag(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method ProcessMouseEvent, addr 0x28b8ab4, size 0x2c8, virtual false, abstract: false, final false
inline void ProcessMouseEvent(::UnityEngine::EventSystems::PointerInputModule_MouseState*  mouseData) ;

/// @brief Method ProcessMousePress, addr 0x28b8348, size 0x668, virtual false, abstract: false, final false
inline void ProcessMousePress(::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData*  data) ;

/// @brief Method SendMoveEventToSelectedObject, addr 0x28b7ffc, size 0x204, virtual false, abstract: false, final false
inline bool SendMoveEventToSelectedObject() ;

/// @brief Method SendSubmitEventToSelectedObject, addr 0x28b7cf8, size 0x1f0, virtual false, abstract: false, final false
inline bool SendSubmitEventToSelectedObject() ;

/// @brief Method SendUpdateEventToSelectedObject, addr 0x28b8200, size 0x148, virtual false, abstract: false, final false
inline bool SendUpdateEventToSelectedObject() ;

/// @brief Method ShouldActivateModule, addr 0x28b7790, size 0x188, virtual true, abstract: false, final false
inline bool ShouldActivateModule() ;

/// @brief Method ShouldStartDrag, addr 0x28ba19c, size 0x348, virtual false, abstract: false, final false
inline bool ShouldStartDrag(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method SwipeAdjustedPosition, addr 0x28ba560, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method UpdateModule, addr 0x28b7754, size 0x24, virtual true, abstract: false, final false
inline void UpdateModule() ;

/// @brief Method UseMouse, addr 0x28b8d7c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28b7588, size 0x160, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowActivationOnMobileDevice, addr 0x28b76f0, size 0x8, virtual false, abstract: false, final false
inline bool get_allowActivationOnMobileDevice() ;

/// @brief Method get_cancelButton, addr 0x28b7744, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_cancelButton() ;

/// @brief Method get_horizontalAxis, addr 0x28b7714, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_horizontalAxis() ;

/// @brief Method get_inputActionsPerSecond, addr 0x28b7704, size 0x8, virtual false, abstract: false, final false
inline float_t get_inputActionsPerSecond() ;

/// @brief Method get_inputMode, addr 0x28b76e8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::OVRInputModule_InputMode get_inputMode() ;

/// @brief Method get_submitButton, addr 0x28b7734, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_submitButton() ;

/// @brief Method get_verticalAxis, addr 0x28b7724, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_verticalAxis() ;

/// @brief Method set_allowActivationOnMobileDevice, addr 0x28b76f8, size 0xc, virtual false, abstract: false, final false
inline void set_allowActivationOnMobileDevice(bool  value) ;

/// @brief Method set_cancelButton, addr 0x28b774c, size 0x8, virtual false, abstract: false, final false
inline void set_cancelButton(::StringW  value) ;

/// @brief Method set_horizontalAxis, addr 0x28b771c, size 0x8, virtual false, abstract: false, final false
inline void set_horizontalAxis(::StringW  value) ;

/// @brief Method set_inputActionsPerSecond, addr 0x28b770c, size 0x8, virtual false, abstract: false, final false
inline void set_inputActionsPerSecond(float_t  value) ;

/// @brief Method set_submitButton, addr 0x28b773c, size 0x8, virtual false, abstract: false, final false
inline void set_submitButton(::StringW  value) ;

/// @brief Method set_verticalAxis, addr 0x28b772c, size 0x8, virtual false, abstract: false, final false
