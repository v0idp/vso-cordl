...
/// @brief Method GetAxisRaw, addr 0x3189a00, size 0xc, virtual true, abstract: false, final false
inline float_t GetAxisRaw(::StringW  axisName) ;

/// @brief Method GetButtonDown, addr 0x3189a0c, size 0xc, virtual true, abstract: false, final false
inline bool GetButtonDown(::StringW  buttonName) ;

/// @brief Method GetMouseButton, addr 0x318999c, size 0xc, virtual true, abstract: false, final false
inline bool GetMouseButton(int32_t  button) ;

/// @brief Method GetMouseButtonDown, addr 0x3189984, size 0xc, virtual true, abstract: false, final false
inline bool GetMouseButtonDown(int32_t  button) ;

/// @brief Method GetMouseButtonUp, addr 0x3189990, size 0xc, virtual true, abstract: false, final false
inline bool GetMouseButtonUp(int32_t  button) ;

/// @brief Method GetTouch, addr 0x31899c8, size 0x38, virtual true, abstract: false, final false
inline ::UnityEngine::Touch GetTouch(int32_t  index) ;

static inline ::UnityEngine::EventSystems::BaseInput* New_ctor() ;

/// @brief Method .ctor, addr 0x3189a18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_compositionCursorPos, addr 0x318996c, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Vector2 get_compositionCursorPos() ;

/// @brief Method get_compositionString, addr 0x3189950, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_compositionString() ;

/// @brief Method get_imeCompositionMode, addr 0x3189958, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::IMECompositionMode get_imeCompositionMode() ;

/// @brief Method get_mousePosition, addr 0x31899a8, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Vector2 get_mousePosition() ;

/// @brief Method get_mousePresent, addr 0x318997c, size 0x8, virtual true, abstract: false, final false
inline bool get_mousePresent() ;

/// @brief Method get_mouseScrollDelta, addr 0x31899b0, size 0x8, virtual true, abstract: false, final false
inline ::UnityEngine::Vector2 get_mouseScrollDelta() ;

/// @brief Method get_touchCount, addr 0x31899c0, size 0x8, virtual true, abstract: false, final false
inline int32_t get_touchCount() ;

/// @brief Method get_touchSupported, addr 0x31899b8, size 0x8, virtual true, abstract: false, final false
inline bool get_touchSupported() ;

/// @brief Method set_compositionCursorPos, addr 0x3189974, size 0x8, virtual true, abstract: false, final false
inline void set_compositionCursorPos(::UnityEngine::Vector2  value) ;

/// @brief Method set_imeCompositionMode, addr 0x3189960, size 0xc, virtual true, abstract: false, final false
