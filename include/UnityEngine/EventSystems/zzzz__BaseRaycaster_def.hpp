...
/// @brief Method OnCanvasHierarchyChanged, addr 0x318f5a0, size 0x8, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnDisable, addr 0x318f54c, size 0x54, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x318f4f8, size 0x54, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x318f5ac, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x318f330, size 0x1c8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3184604, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_priority, addr 0x318f318, size 0x8, virtual true, abstract: false, final false
inline int32_t get_priority() ;

/// @brief Method get_renderOrderPriority, addr 0x318f328, size 0x8, virtual true, abstract: false, final false
inline int32_t get_renderOrderPriority() ;

/// @brief Method get_rootRaycaster, addr 0x3186310, size 0xb8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseRaycaster> get_rootRaycaster() ;

/// @brief Method get_sortOrderPriority, addr 0x318f320, size 0x8, virtual true, abstract: false, final false
