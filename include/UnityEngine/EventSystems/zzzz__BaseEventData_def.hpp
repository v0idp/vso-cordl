...
/// @brief Method .ctor, addr 0x3184694, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::EventSystems::EventSystem*  eventSystem) ;

/// @brief Method get_currentInputModule, addr 0x31846e0, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::EventSystems::BaseInputModule> get_currentInputModule() ;

/// @brief Method get_selectedObject, addr 0x31846fc, size 0x1c, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::GameObject> get_selectedObject() ;

/// @brief Method set_selectedObject, addr 0x3184718, size 0x1c, virtual false, abstract: false, final false
