...
/// @brief Method <Raycast>b__15_0, addr 0x28bb15c, size 0x40, virtual false, abstract: false, final false
inline int32_t _Raycast_b__15_0(::UnityEngine::RaycastHit  r1, ::UnityEngine::RaycastHit  r2) ;

/// @brief Method <Spherecast>b__16_0, addr 0x28bb19c, size 0x40, virtual false, abstract: false, final false
inline int32_t _Spherecast_b__16_0(::UnityEngine::RaycastHit  r1, ::UnityEngine::RaycastHit  r2) ;

/// @brief Method .ctor, addr 0x28bb154, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetScreenPos, addr 0x28b9dc4, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x28bac30, size 0x440, virtual true, abstract: false, final false
inline void Raycast(::UnityEngine::EventSystems::PointerEventData*  eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>*  resultAppendList) ;

/// @brief Method Spherecast, addr 0x28b997c, size 0x448, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x28baa10, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_depth, addr 0x28baa90, size 0xc4, virtual true, abstract: false, final false
inline int32_t get_depth() ;

/// @brief Method get_eventCamera, addr 0x28baa38, size 0x58, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_eventMask, addr 0x28bac20, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_eventMask() ;

/// @brief Method get_finalEventMask, addr 0x28bab5c, size 0xc4, virtual false, abstract: false, final false
inline int32_t get_finalEventMask() ;

/// @brief Method get_sortOrderPriority, addr 0x28bab54, size 0x8, virtual true, abstract: false, final false
inline int32_t get_sortOrderPriority() ;

/// @brief Method set_eventMask, addr 0x28bac28, size 0x8, virtual false, abstract: false, final false
