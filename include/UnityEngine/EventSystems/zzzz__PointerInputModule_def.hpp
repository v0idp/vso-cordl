...
/// @brief Method .ctor, addr 0x318c0c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_button, addr 0x318c0b8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerEventData_InputButton get_button() ;

/// @brief Method get_eventData, addr 0x318c0a8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerInputModule_MouseButtonEventData* get_eventData() ;

/// @brief Method set_button, addr 0x318c0c0, size 0x8, virtual false, abstract: false, final false
inline void set_button(::UnityEngine::EventSystems::PointerEventData_InputButton  value) ;

/// @brief Method set_eventData, addr 0x318c0b0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AnyPressesThisFrame, addr 0x318c0d0, size 0xbc, virtual false, abstract: false, final false
inline bool AnyPressesThisFrame() ;

/// @brief Method AnyReleasesThisFrame, addr 0x318c19c, size 0xc0, virtual false, abstract: false, final false
inline bool AnyReleasesThisFrame() ;

/// @brief Method GetButtonState, addr 0x318c270, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method SetButtonState, addr 0x318b650, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x318c02c, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method PressedThisFrame, addr 0x318c18c, size 0x10, virtual false, abstract: false, final false
inline bool PressedThisFrame() ;

/// @brief Method ReleasedThisFrame, addr 0x318c25c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x318c400, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ClearSelection, addr 0x318ba78, size 0x1c0, virtual false, abstract: false, final false
inline void ClearSelection() ;

/// @brief Method CopyFromTo, addr 0x318b220, size 0x88, virtual false, abstract: false, final false
inline void CopyFromTo(::UnityEngine::EventSystems::PointerEventData*  from, ::UnityEngine::EventSystems::PointerEventData*  to) ;

/// @brief Method DeselectIfSelectionChanged, addr 0x318bea0, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method GetLastPointerEventData, addr 0x318b688, size 0x20, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerEventData* GetLastPointerEventData(int32_t  id) ;

/// @brief Method GetMousePointerEventData, addr 0x318b324, size 0x14, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetMousePointerEventData() ;

/// @brief Method GetMousePointerEventData, addr 0x318b338, size 0x318, virtual true, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerInputModule_MouseState* GetMousePointerEventData(int32_t  id) ;

/// @brief Method GetPointerData, addr 0x318ad5c, size 0xec, virtual false, abstract: false, final false
inline bool GetPointerData(int32_t  id, ::ByRef<::UnityEngine::EventSystems::PointerEventData*>  data, bool  create) ;

/// @brief Method GetTouchPointerEventData, addr 0x318aea4, size 0x37c, virtual false, abstract: false, final false
...
/// @brief Method IsPointerOverGameObject, addr 0x318b9dc, size 0x9c, virtual true, abstract: false, final false
inline bool IsPointerOverGameObject(int32_t  pointerId) ;

static inline ::UnityEngine::EventSystems::PointerInputModule* New_ctor() ;

/// @brief Method ProcessDrag, addr 0x318b71c, size 0x2c0, virtual true, abstract: false, final false
inline void ProcessDrag(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method ProcessMove, addr 0x318b6d8, size 0x44, virtual true, abstract: false, final false
inline void ProcessMove(::UnityEngine::EventSystems::PointerEventData*  pointerEvent) ;

/// @brief Method RemovePointerData, addr 0x318ae48, size 0x5c, virtual false, abstract: false, final false
inline void RemovePointerData(::UnityEngine::EventSystems::PointerEventData*  data) ;

/// @brief Method ShouldStartDrag, addr 0x318b6a8, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method StateForMouseButton, addr 0x318b2a8, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::EventSystems::PointerEventData_FramePressState StateForMouseButton(int32_t  buttonId) ;

/// @brief Method ToString, addr 0x318bc38, size 0x268, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x318bf8c, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;
