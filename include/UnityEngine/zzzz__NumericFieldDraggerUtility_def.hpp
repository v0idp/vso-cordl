...
/// @brief Method Acceleration, addr 0x2f84b20, size 0x24, virtual false, abstract: false, final false
static inline float_t Acceleration(bool  shiftPressed, bool  altPressed) ;

/// @brief Method CalculateFloatDragSensitivity, addr 0x2f84c9c, size 0x90, virtual false, abstract: false, final false
static inline double_t CalculateFloatDragSensitivity(double_t  value) ;

/// @brief Method CalculateFloatDragSensitivity, addr 0x2f84d2c, size 0x90, virtual false, abstract: false, final false
static inline double_t CalculateFloatDragSensitivity(double_t  value, double_t  minValue, double_t  maxValue) ;

/// @brief Method CalculateIntDragSensitivity, addr 0x2f84de8, size 0x7c, virtual false, abstract: false, final false
static inline double_t CalculateIntDragSensitivity(double_t  value) ;

/// @brief Method CalculateIntDragSensitivity, addr 0x2f84dbc, size 0x2c, virtual false, abstract: false, final false
static inline int64_t CalculateIntDragSensitivity(int64_t  value) ;

/// @brief Method CalculateIntDragSensitivity, addr 0x2f84e88, size 0xa0, virtual false, abstract: false, final false
static inline int64_t CalculateIntDragSensitivity(int64_t  value, int64_t  minValue, int64_t  maxValue) ;

/// @brief Method CalculateIntDragSensitivity, addr 0x2f84e64, size 0x24, virtual false, abstract: false, final false
static inline uint64_t CalculateIntDragSensitivity(uint64_t  value) ;

/// @brief Method NiceDelta, addr 0x2f84b44, size 0x158, virtual false, abstract: false, final false
