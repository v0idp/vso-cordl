...
/// @brief Method CheckIsEditorScript, addr 0x2f87154, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method GetDefaultExecutionOrderFor, addr 0x2f87264, size 0x78, virtual false, abstract: false, final false
static inline int32_t GetDefaultExecutionOrderFor(::System::Type*  klass) ;

/// @brief Method GetExecuteMode, addr 0x2f87040, size 0x114, virtual false, abstract: false, final false
static inline int32_t GetExecuteMode(::System::Type*  klass) ;

/// @brief Method GetParentTypeDisallowingMultipleInclusion, addr 0x2f86a38, size 0x134, virtual false, abstract: false, final false
static inline ::System::Type* GetParentTypeDisallowingMultipleInclusion(::System::Type*  type) ;

/// @brief Method GetRequiredComponents, addr 0x2f86b6c, size 0x4d4, virtual false, abstract: false, final false
