...
public:
// Declarations
/// @brief Method PushDestroyUndo, addr 0x2f340b4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method PushUndo, addr 0x2f34140, size 0x4, virtual false, abstract: false, final false
static inline void PushUndo(::UnityEngine::Object*  thingToDirty, ::StringW  operation) ;

/// @brief Method PushUndo, addr 0x2f3413c, size 0x4, virtual false, abstract: false, final false
static inline void PushUndo(::ArrayW<::UnityEngine::Object*,::Array<::UnityEngine::Object*>*>  thingsToDirty, ::StringW  operation) ;

/// @brief Method RegisterCreatedObjectUndo, addr 0x2f34144, size 0x4, virtual false, abstract: false, final false
static inline void RegisterCreatedObjectUndo(::UnityEngine::Object*  thingCreated, ::StringW  operation) ;

/// @brief Method UndoName, addr 0x2f34148, size 0x4c, virtual false, abstract: false, final false
static inline ::StringW UndoName(::StringW  name) ;

/// @brief Method get_undoEnabled, addr 0x2f340ac, size 0x8, virtual false, abstract: false, final false
