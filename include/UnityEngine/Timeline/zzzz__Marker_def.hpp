...
/// @brief Method OnInitialize, addr 0x2f2b0b0, size 0x4, virtual true, abstract: false, final false
inline void OnInitialize(::UnityEngine::Timeline::TrackAsset*  aPent) ;

/// @brief Method UnityEngine.Timeline.IMarker.Initialize, addr 0x2f2af64, size 0x14c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2f2b0b4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_parent, addr 0x2f2aedc, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::Timeline::TrackAsset> get_parent() ;

/// @brief Method get_time, addr 0x2f2aeec, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_parent, addr 0x2f2aee4, size 0x8, virtual false, abstract: false, final false
inline void set_parent(::UnityEngine::Timeline::TrackAsset*  value) ;

/// @brief Method set_time, addr 0x2f2aef4, size 0x70, virtual true, abstract: false, final true
