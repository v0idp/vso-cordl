...
/// @brief Method .ctor, addr 0x2f2ff78, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  clipClass) ;

/// @brief Method .ctor, addr 0x2f2ffa8, size 0x28, virtual false, abstract: false, final false
