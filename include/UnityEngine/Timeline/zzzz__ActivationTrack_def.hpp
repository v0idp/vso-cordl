...
/// @brief Method CanCompileClips, addr 0x2f11984, size 0x5c, virtual true, abstract: false, final false
inline bool CanCompileClips() ;

/// @brief Method CreateTrackMixer, addr 0x2f11ac0, size 0xdc, virtual true, abstract: false, final false
...
/// @brief Method GatherProperties, addr 0x2f11b9c, size 0x12c, virtual true, abstract: false, final false
...
/// @brief Method OnCreateClip, addr 0x2f11e40, size 0x50, virtual true, abstract: false, final false
inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip*  clip) ;

/// @brief Method UpdateTrackMode, addr 0x2f11aac, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f11e94, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_postPlaybackState, addr 0x2f11a90, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Timeline::ActivationTrack_PostPlaybackState get_postPlaybackState() ;

/// @brief Method set_postPlaybackState, addr 0x2f11a98, size 0x14, virtual false, abstract: false, final false
