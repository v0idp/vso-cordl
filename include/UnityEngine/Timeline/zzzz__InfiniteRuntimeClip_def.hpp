...
/// @brief Method DisableAt, addr 0x2f2a120, size 0x6c, virtual true, abstract: false, final false
inline void DisableAt(double_t  localTime, double_t  rootDuration, ::UnityEngine::Playables::FrameData  frameData) ;

/// @brief Method EvaluateAt, addr 0x2f2a0c8, size 0x58, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f16c5c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Playables::Playable  playable) ;

static inline int64_t getStaticF_kIntervalEnd() ;

/// @brief Method get_intervalEnd, addr 0x2f29ffc, size 0x58, virtual true, abstract: false, final false
inline int64_t get_intervalEnd() ;

/// @brief Method get_intervalStart, addr 0x2f29ff4, size 0x8, virtual true, abstract: false, final false
inline int64_t get_intervalStart() ;

static inline void setStaticF_kIntervalEnd(int64_t  value) ;

/// @brief Method set_enable, addr 0x2f2a054, size 0x74, virtual true, abstract: false, final false
