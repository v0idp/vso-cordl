...
/// @brief Method CanCompileClips, addr 0x2f2caf4, size 0x8, virtual true, abstract: false, final false
inline bool CanCompileClips() ;

static inline ::UnityEngine::Timeline::GroupTrack* New_ctor() ;

/// @brief Method .ctor, addr 0x2f2cb54, size 0x54, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_outputs, addr 0x2f2cafc, size 0x58, virtual true, abstract: false, final false
