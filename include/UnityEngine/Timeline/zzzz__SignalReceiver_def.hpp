...
/// @brief Method Append, addr 0x2f2bc80, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x2f2c30c, size 0x94, virtual false, abstract: false, final false
inline void Remove(int32_t  idx) ;

/// @brief Method Remove, addr 0x2f2bec8, size 0xc0, virtual false, abstract: false, final false
inline void Remove(::UnityEngine::Timeline::SignalAsset*  key) ;

/// @brief Method TryGetValue, addr 0x2f2ba94, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f2c62c, size 0xc4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_events, addr 0x2f2c6f8, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityEngine::Events::UnityEvent*>* get_events() ;

/// @brief Method get_signals, addr 0x2f2c6f0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method AddEmptyReaction, addr 0x2f2bda0, size 0x6c, virtual false, abstract: false, final false
inline int32_t AddEmptyReaction(::UnityEngine::Events::UnityEvent*  reaction) ;

/// @brief Method AddReaction, addr 0x2f2bb48, size 0x138, virtual false, abstract: false, final false
inline void AddReaction(::UnityEngine::Timeline::SignalAsset*  asset, ::UnityEngine::Events::UnityEvent*  reaction) ;

/// @brief Method ChangeReactionAtIndex, addr 0x2f2c3a0, size 0xc4, virtual false, abstract: false, final false
inline void ChangeReactionAtIndex(int32_t  idx, ::UnityEngine::Events::UnityEvent*  reaction) ;

/// @brief Method ChangeSignalAtIndex, addr 0x2f2c024, size 0x24c, virtual false, abstract: false, final false
inline void ChangeSignalAtIndex(int32_t  idx, ::UnityEngine::Timeline::SignalAsset*  newKey) ;

/// @brief Method Count, addr 0x2f2bfd4, size 0x50, virtual false, abstract: false, final false
inline int32_t Count() ;

/// @brief Method GetReaction, addr 0x2f2bfa4, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::Events::UnityEvent* GetReaction(::UnityEngine::Timeline::SignalAsset*  key) ;

/// @brief Method GetReactionAtIndex, addr 0x2f2c464, size 0xb4, virtual false, abstract: false, final false
inline ::UnityEngine::Events::UnityEvent* GetReactionAtIndex(int32_t  idx) ;

/// @brief Method GetRegisteredSignals, addr 0x2f2bf88, size 0x1c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::Timeline::SignalAsset>>* GetRegisteredSignals() ;

/// @brief Method GetSignalAssetAtIndex, addr 0x2f2c518, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method OnEnable, addr 0x2f2c5cc, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnNotify, addr 0x2f2b97c, size 0x118, virtual true, abstract: false, final true
...
/// @brief Method Remove, addr 0x2f2be0c, size 0xbc, virtual false, abstract: false, final false
inline void Remove(::UnityEngine::Timeline::SignalAsset*  asset) ;

/// @brief Method RemoveAtIndex, addr 0x2f2c270, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f2c5d0, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
