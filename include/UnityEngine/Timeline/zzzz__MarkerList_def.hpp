...
/// @brief Method Add, addr 0x2f2084c, size 0xe8, virtual false, abstract: false, final false
inline void Add(::UnityEngine::ScriptableObject*  item) ;

/// @brief Method BuildCache, addr 0x2f2b0d4, size 0x2d0, virtual false, abstract: false, final false
inline void BuildCache() ;

/// @brief Method Clear, addr 0x2f207d4, size 0x70, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Contains, addr 0x2f2b3a4, size 0x58, virtual false, abstract: false, final false
inline bool Contains(::UnityEngine::ScriptableObject*  item) ;

/// @brief Method CreateMarker, addr 0x2f1f614, size 0x2f8, virtual false, abstract: false, final false
inline ::UnityEngine::Timeline::IMarker* CreateMarker(::System::Type*  type, double_t  time, ::UnityEngine::Timeline::TrackAsset*  owner) ;

/// @brief Method GetMarkers, addr 0x2f1faf4, size 0x18, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::Timeline::IMarker*>* GetMarkers() ;

/// @brief Method GetRawMarkerList, addr 0x2f2b3fc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::ScriptableObject>>* GetRawMarkerList() ;

/// @brief Method HasNotifications, addr 0x2f23bdc, size 0x18, virtual false, abstract: false, final false
inline bool HasNotifications() ;

/// @brief Method Remove, addr 0x2f20968, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method Remove, addr 0x2f1f914, size 0x1e0, virtual false, abstract: false, final false
inline bool Remove(::UnityEngine::Timeline::IMarker*  item) ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x2f2b408, size 0xc, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x2f2b404, size 0x4, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize() ;

/// @brief Method .ctor, addr 0x2f23bf4, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(int32_t  capacity) ;

/// @brief Method get_Count, addr 0x2f1fb0c, size 0x50, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x2f1fb64, size 0x60, virtual false, abstract: false, final false
inline ::UnityEngine::Timeline::IMarker* get_Item(int32_t  idx) ;

/// @brief Method get_markers, addr 0x2f2b0bc, size 0x18, virtual false, abstract: false, final false
