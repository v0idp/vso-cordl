...
/// @brief Method PrepareFrame, addr 0x2f2433c, size 0x2a8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f245e4, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
