...
/// @brief Method <ParseTimeCode>b__19_0, addr 0x2f35f20, size 0x58, virtual false, abstract: false, final false
inline bool _ParseTimeCode_b__19_0(char16_t  c) ;

/// @brief Method <ParseTimeCode>b__19_1, addr 0x2f35f78, size 0x1c, virtual false, abstract: false, final false
inline bool _ParseTimeCode_b__19_1(char16_t  c) ;

/// @brief Method <ParseTimeSeconds>b__20_0, addr 0x2f35f94, size 0x58, virtual false, abstract: false, final false
inline bool _ParseTimeSeconds_b__20_0(char16_t  c) ;

/// @brief Method .ctor, addr 0x2f35f18, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method FromFrames, addr 0x2f344d8, size 0x68, virtual false, abstract: false, final false
static inline double_t FromFrames(double_t  frames, double_t  frameRate) ;

/// @brief Method FromFrames, addr 0x2f3446c, size 0x6c, virtual false, abstract: false, final false
static inline double_t FromFrames(int32_t  frames, double_t  frameRate) ;

/// @brief Method GetAnimationClipLength, addr 0x2f357cc, size 0x164, virtual false, abstract: false, final false
static inline double_t GetAnimationClipLength(::UnityEngine::AnimationClip*  clip) ;

/// @brief Method GetClosestFrameRate, addr 0x2f35930, size 0xec, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::FrameRate GetClosestFrameRate(double_t  frameRate) ;

/// @brief Method GetEpsilon, addr 0x2f3435c, size 0xa8, virtual false, abstract: false, final false
static inline double_t GetEpsilon(double_t  time, double_t  frameRate) ;

/// @brief Method NextFrame, addr 0x2f34774, size 0x6c, virtual false, abstract: false, final false
static inline int32_t NextFrame(double_t  time, double_t  frameRate) ;

/// @brief Method NextFrameTime, addr 0x2f3484c, size 0x6c, virtual false, abstract: false, final false
static inline double_t NextFrameTime(double_t  time, double_t  frameRate) ;

/// @brief Method OnFrameBoundary, addr 0x2f34540, size 0x74, virtual false, abstract: false, final false
static inline bool OnFrameBoundary(double_t  time, double_t  frameRate) ;

/// @brief Method OnFrameBoundary, addr 0x2f345b4, size 0x120, virtual false, abstract: false, final false
static inline bool OnFrameBoundary(double_t  time, double_t  frameRate, double_t  epsilon) ;

/// @brief Method ParseTimeCode, addr 0x2f34e7c, size 0x508, virtual false, abstract: false, final false
static inline double_t ParseTimeCode(::StringW  timeCode, double_t  frameRate, double_t  defaultValue) ;

/// @brief Method ParseTimeSeconds, addr 0x2f35454, size 0x378, virtual false, abstract: false, final false
static inline double_t ParseTimeSeconds(::StringW  timeCode, double_t  frameRate, double_t  defaultValue) ;

/// @brief Method PreviousFrame, addr 0x2f346d4, size 0xa0, virtual false, abstract: false, final false
static inline int32_t PreviousFrame(double_t  time, double_t  frameRate) ;

/// @brief Method PreviousFrameTime, addr 0x2f347e0, size 0x6c, virtual false, abstract: false, final false
static inline double_t PreviousFrameTime(double_t  time, double_t  frameRate) ;

/// @brief Method RemoveChar, addr 0x2f35384, size 0xd0, virtual false, abstract: false, final false
static inline ::StringW RemoveChar(::StringW  str, ::System::Func_2<char16_t,bool>*  charToRemoveFunc) ;

/// @brief Method RoundToFrame, addr 0x2f348b8, size 0xdc, virtual false, abstract: false, final false
static inline double_t RoundToFrame(double_t  time, double_t  frameRate) ;

/// @brief Method TimeAsFrames, addr 0x2f34994, size 0xd0, virtual false, abstract: false, final false
static inline ::StringW TimeAsFrames(double_t  timeValue, double_t  frameRate, ::StringW  format) ;

/// @brief Method TimeAsTimeCode, addr 0x2f34a64, size 0x418, virtual false, abstract: false, final false
static inline ::StringW TimeAsTimeCode(double_t  timeValue, double_t  frameRate, ::StringW  format) ;

/// @brief Method ToExactFrames, addr 0x2f34404, size 0x68, virtual false, abstract: false, final false
static inline double_t ToExactFrames(double_t  time, double_t  frameRate) ;

/// @brief Method ToFrameRate, addr 0x2f35a1c, size 0x1a0, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::FrameRate ToFrameRate(::UnityEngine::Timeline::StandardFrameRates  enumValue) ;

/// @brief Method ToFrames, addr 0x2f34248, size 0x114, virtual false, abstract: false, final false
static inline int32_t ToFrames(double_t  time, double_t  frameRate) ;

/// @brief Method ToStandardFrameRate, addr 0x2f35bbc, size 0x2a8, virtual false, abstract: false, final false
...
/// @brief Method ValidateFrameRate, addr 0x2f34194, size 0xb4, virtual false, abstract: false, final false
