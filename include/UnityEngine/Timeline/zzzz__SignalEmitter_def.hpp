...
/// @brief Method UnityEngine.Playables.INotification.get_id, addr 0x2f2b898, size 0xc0, virtual true, abstract: false, final true
inline ::UnityEngine::PropertyName UnityEngine_Playables_INotification_get_id() ;

/// @brief Method UnityEngine.Timeline.INotificationOptionProvider.get_flags, addr 0x2f2b958, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2f2b974, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_asset, addr 0x2f2b888, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Timeline::SignalAsset> get_asset() ;

/// @brief Method get_emitOnce, addr 0x2f2b874, size 0x8, virtual false, abstract: false, final false
inline bool get_emitOnce() ;

/// @brief Method get_retroactive, addr 0x2f2b860, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_asset, addr 0x2f2b890, size 0x8, virtual false, abstract: false, final false
inline void set_asset(::UnityEngine::Timeline::SignalAsset*  value) ;

/// @brief Method set_emitOnce, addr 0x2f2b87c, size 0xc, virtual false, abstract: false, final false
inline void set_emitOnce(bool  value) ;

/// @brief Method set_retroactive, addr 0x2f2b868, size 0xc, virtual false, abstract: false, final false
