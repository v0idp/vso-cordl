...
/// @brief Method Create, addr 0x2f2aaa0, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method DisableAt, addr 0x2f2aecc, size 0x10, virtual true, abstract: false, final false
inline void DisableAt(double_t  localTime, double_t  rootDuration, ::UnityEngine::Playables::FrameData  frameData) ;

/// @brief Method EvaluateAt, addr 0x2f2ac3c, size 0x290, virtual true, abstract: false, final false
...
/// @brief Method SetTime, addr 0x2f2aa28, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f252fc, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method get_clip, addr 0x2f2aa80, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Timeline::TimelineClip* get_clip() ;

/// @brief Method get_duration, addr 0x2f2a9dc, size 0x4c, virtual true, abstract: false, final false
inline double_t get_duration() ;

/// @brief Method get_mixer, addr 0x2f2aa88, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::Playable get_mixer() ;

/// @brief Method get_playable, addr 0x2f2aa94, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::Playable get_playable() ;

/// @brief Method get_start, addr 0x2f2a964, size 0x78, virtual true, abstract: false, final false
inline double_t get_start() ;

/// @brief Method set_enable, addr 0x2f2ab38, size 0x104, virtual true, abstract: false, final false
