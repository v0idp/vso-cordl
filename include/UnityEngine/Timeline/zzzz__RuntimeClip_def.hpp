...
/// @brief Method Create, addr 0x2f2a288, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method DisableAt, addr 0x2f2a708, size 0x158, virtual true, abstract: false, final false
inline void DisableAt(double_t  localTime, double_t  rootDuration, ::UnityEngine::Playables::FrameData  frameData) ;

/// @brief Method EvaluateAt, addr 0x2f2a510, size 0x1f8, virtual true, abstract: false, final false
...
/// @brief Method SetDuration, addr 0x2f2a4b8, size 0x58, virtual false, abstract: false, final false
inline void SetDuration(double_t  duration) ;

/// @brief Method SetTime, addr 0x2f2a460, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f14dac, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method get_clip, addr 0x2f2a30c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Timeline::TimelineClip* get_clip() ;

/// @brief Method get_duration, addr 0x2f2a268, size 0x18, virtual true, abstract: false, final false
inline double_t get_duration() ;

/// @brief Method get_mixer, addr 0x2f2a314, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::Playable get_mixer() ;

/// @brief Method get_playable, addr 0x2f2a320, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::Playable get_playable() ;

/// @brief Method get_start, addr 0x2f2a23c, size 0x2c, virtual true, abstract: false, final false
inline double_t get_start() ;

/// @brief Method set_enable, addr 0x2f2a32c, size 0x134, virtual true, abstract: false, final false
