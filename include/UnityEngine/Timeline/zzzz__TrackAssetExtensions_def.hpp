...
public:
// Declarations
/// @brief Method GetGroup, addr 0x2f2c704, size 0xc4, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Timeline::GroupTrack> GetGroup(::UnityEngine::Timeline::TrackAsset*  asset) ;

/// @brief Method SetGroup, addr 0x2f2c7c8, size 0x32c, virtual false, abstract: false, final false
