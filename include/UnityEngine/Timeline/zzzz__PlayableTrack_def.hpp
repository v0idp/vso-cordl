...
/// @brief Method OnCreateClip, addr 0x2f2fe64, size 0x94, virtual true, abstract: false, final false
inline void OnCreateClip(::UnityEngine::Timeline::TimelineClip*  clip) ;

/// @brief Method .ctor, addr 0x2f2fef8, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
