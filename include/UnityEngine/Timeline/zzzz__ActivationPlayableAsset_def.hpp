...
/// @brief Method CreatePlayable, addr 0x2f11910, size 0x6c, virtual true, abstract: false, final false
inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph  graph, ::UnityEngine::GameObject*  go) ;

static inline ::UnityEngine::Timeline::ActivationPlayableAsset* New_ctor() ;

/// @brief Method .ctor, addr 0x2f1197c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_clipCaps, addr 0x2f11908, size 0x8, virtual true, abstract: false, final true
