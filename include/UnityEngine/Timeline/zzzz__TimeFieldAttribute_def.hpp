...
/// @brief Method .ctor, addr 0x2f30078, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Timeline::TimeFieldAttribute_UseEditMode  useEditMode) ;

/// @brief Method get_useEditMode, addr 0x2f30070, size 0x8, virtual false, abstract: false, final false
