...
/// @brief Method CompareTo, addr 0x2f68a88, size 0x50, virtual true, abstract: false, final true
inline int32_t CompareTo(::UnityEngine::RefreshRate  other) ;

/// @brief Method Equals, addr 0x2f68a4c, size 0x3c, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::RefreshRate  other) ;

/// @brief Method ToString, addr 0x2f68ad8, size 0x9c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method get_value, addr 0x2f68a38, size 0x14, virtual false, abstract: false, final false
