...
/// @brief Method GetMask, addr 0x2f8bb00, size 0x104, virtual false, abstract: false, final false
static inline int32_t GetMask(::ArrayW<::StringW,::Array<::StringW>*>  layerNames) ;

/// @brief Method NameToLayer, addr 0x2f8bac4, size 0x3c, virtual false, abstract: false, final false
static inline int32_t NameToLayer(::StringW  layerName) ;

/// @brief Method get_value, addr 0x2f8babc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_value() ;

/// @brief Method op_Implicit, addr 0x2f8bab4, size 0x8, virtual false, abstract: false, final false
static inline ::UnityEngine::LayerMask op_Implicit___UnityEngine__LayerMask(int32_t  intVal) ;

/// @brief Method op_Implicit, addr 0x2f8bab0, size 0x4, virtual false, abstract: false, final false
