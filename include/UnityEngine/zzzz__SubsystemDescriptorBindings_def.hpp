...
public:
// Declarations
/// @brief Method Create, addr 0x2fcdb0c, size 0x3c, virtual false, abstract: false, final false
static inline ::System::IntPtr Create(::System::IntPtr  descriptorPtr) ;

/// @brief Method GetId, addr 0x2fcdabc, size 0x3c, virtual false, abstract: false, final false
