...
/// @brief Method Reset, addr 0x2f905fc, size 0xc, virtual true, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x2f905cc, size 0x30, virtual false, abstract: false, final false
inline void _ctor(float_t  time) ;

/// @brief Method get_keepWaiting, addr 0x2f90508, size 0x9c, virtual true, abstract: false, final false
inline bool get_keepWaiting() ;

/// @brief Method get_waitTime, addr 0x2f904f8, size 0x8, virtual false, abstract: false, final false
inline float_t get_waitTime() ;

/// @brief Method set_waitTime, addr 0x2f90500, size 0x8, virtual false, abstract: false, final false
