...
/// @brief Method Lerp, addr 0x2f7d19c, size 0xdc, virtual false, abstract: false, final false
static inline ::UnityEngine::Color32 Lerp(::UnityEngine::Color32  a, ::UnityEngine::Color32  b, float_t  t) ;

/// @brief Method ToString, addr 0x2f7d348, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2f7d358, size 0x1dc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2f7ce88, size 0x14, virtual false, abstract: false, final false
inline void _ctor(uint8_t  r, uint8_t  g, uint8_t  b, uint8_t  a) ;

/// @brief Method get_Item, addr 0x2f7d278, size 0xd0, virtual false, abstract: false, final false
inline uint8_t get_Item(int32_t  index) ;

/// @brief Convert to "::System::IFormattable"
constexpr ::System::IFormattable* i___System__IFormattable() ;

/// @brief Method op_Implicit, addr 0x2f7d160, size 0x3c, virtual false, abstract: false, final false
static inline ::UnityEngine::Color op_Implicit___UnityEngine__Color(::UnityEngine::Color32  c) ;

/// @brief Method op_Implicit, addr 0x2f7ce9c, size 0x2c4, virtual false, abstract: false, final false
