...
/// @brief Method CalcHeight, addr 0x2fb78b0, size 0xfc, virtual true, abstract: false, final false
inline void CalcHeight() ;

/// @brief Method CalcWidth, addr 0x2fb7738, size 0x7c, virtual true, abstract: false, final false
inline void CalcWidth() ;

static inline ::UnityEngine::GUIScrollGroup* New_ctor() ;

/// @brief Method SetHorizontal, addr 0x2fb77b4, size 0xfc, virtual true, abstract: false, final false
inline void SetHorizontal(float_t  x, float_t  width) ;

/// @brief Method SetVertical, addr 0x2fb79ac, size 0x1a4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fb76dc, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
