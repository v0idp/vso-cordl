...
/// @brief Method Create, addr 0x2fa1d90, size 0xa4, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::Playable Create(::UnityEngine::Playables::PlayableGraph  graph, int32_t  inputCount) ;

/// @brief Method Equals, addr 0x2fa1f9c, size 0x98, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Playables::Playable  other) ;

/// @brief Method GetHandle, addr 0x2fa1e90, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableHandle GetHandle() ;

/// @brief Method GetPlayableType, addr 0x2fa1e9c, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fa1e88, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Playables::PlayableHandle  handle) ;

static inline ::UnityEngine::Playables::Playable getStaticF_m_NullPlayable() ;

/// @brief Method get_Null, addr 0x2fa1d38, size 0x58, virtual false, abstract: false, final false
