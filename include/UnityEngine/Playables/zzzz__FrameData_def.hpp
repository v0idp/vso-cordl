...
/// @brief Method HasFlags, addr 0x2fa17b0, size 0x10, virtual false, abstract: false, final false
inline bool HasFlags(::UnityEngine::Playables::FrameData_Flags  flag) ;

/// @brief Method get_deltaTime, addr 0x2fa17c0, size 0xc, virtual false, abstract: false, final false
inline float_t get_deltaTime() ;

/// @brief Method get_effectivePlayState, addr 0x2fa1814, size 0x18, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayState get_effectivePlayState() ;

/// @brief Method get_effectiveSpeed, addr 0x2fa17cc, size 0x8, virtual false, abstract: false, final false
inline float_t get_effectiveSpeed() ;

/// @brief Method get_evaluationType, addr 0x2fa17d4, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::FrameData_EvaluationType get_evaluationType() ;

/// @brief Method get_output, addr 0x2fa1808, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayableOutput get_output() ;

/// @brief Method get_seekOccurred, addr 0x2fa17e4, size 0xc, virtual false, abstract: false, final false
inline bool get_seekOccurred() ;

/// @brief Method get_timeHeld, addr 0x2fa17fc, size 0xc, virtual false, abstract: false, final false
inline bool get_timeHeld() ;

/// @brief Method get_timeLooped, addr 0x2fa17f0, size 0xc, virtual false, abstract: false, final false
