...
/// @brief Method Create, addr 0x2fa5264, size 0x78, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::ScriptPlayableOutput Create(::UnityEngine::Playables::PlayableGraph  graph, ::StringW  name) ;

/// @brief Method GetHandle, addr 0x2fa5444, size 0xc, virtual true, abstract: false, final true
inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle() ;

/// @brief Method .ctor, addr 0x2fa5358, size 0xec, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle  handle) ;

/// @brief Method get_Null, addr 0x2fa52e0, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x2fa52dc, size 0x4, virtual false, abstract: false, final false
