...
/// @brief Method ConnectInternal, addr 0x2fa2bec, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method ConnectInternal_Injected, addr 0x2fa2c60, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method CreatePlayableHandle, addr 0x2fa1e34, size 0x54, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayableHandle CreatePlayableHandle() ;

/// @brief Method CreatePlayableHandle_Injected, addr 0x2fa29a4, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method CreateScriptOutputInternal, addr 0x2fa29e8, size 0x54, virtual false, abstract: false, final false
inline bool CreateScriptOutputInternal(::StringW  name, ::ByRef<::UnityEngine::Playables::PlayableOutputHandle>  handle) ;

/// @brief Method CreateScriptOutputInternal_Injected, addr 0x2fa2a3c, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method Evaluate, addr 0x2fa25e0, size 0x40, virtual false, abstract: false, final false
inline void Evaluate() ;

/// @brief Method Evaluate, addr 0x2fa2620, size 0x4c, virtual false, abstract: false, final false
inline void Evaluate(float_t  deltaTime) ;

/// @brief Method Evaluate_Injected, addr 0x2fa275c, size 0x4c, virtual false, abstract: false, final false
static inline void Evaluate_Injected(::ByRef<::UnityEngine::Playables::PlayableGraph>  _unity_self, float_t  deltaTime) ;

/// @brief Method GetFrameRate, addr 0x2fa2b5c, size 0x4c, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::FrameRate GetFrameRate() ;

/// @brief Method GetFrameRate_Injected, addr 0x2fa2ba8, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method GetPlayableCount, addr 0x2fa2820, size 0x3c, virtual false, abstract: false, final false
inline int32_t GetPlayableCount() ;

/// @brief Method GetPlayableCount_Injected, addr 0x2fa285c, size 0x3c, virtual false, abstract: false, final false
static inline int32_t GetPlayableCount_Injected(::ByRef<::UnityEngine::Playables::PlayableGraph>  _unity_self) ;

/// @brief Method GetResolver, addr 0x2fa27a8, size 0x3c, virtual false, abstract: false, final false
inline ::UnityEngine::IExposedPropertyTable* GetResolver() ;

/// @brief Method GetResolver_Injected, addr 0x2fa27e4, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method GetRootPlayable, addr 0x2fa2580, size 0x4, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::Playable GetRootPlayable(int32_t  index) ;

/// @brief Method GetRootPlayableCount, addr 0x2fa2898, size 0x3c, virtual false, abstract: false, final false
inline int32_t GetRootPlayableCount() ;

/// @brief Method GetRootPlayableCount_Injected, addr 0x2fa28d4, size 0x3c, virtual false, abstract: false, final false
static inline int32_t GetRootPlayableCount_Injected(::ByRef<::UnityEngine::Playables::PlayableGraph>  _unity_self) ;

/// @brief Method GetRootPlayableInternal, addr 0x2fa2584, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayableHandle GetRootPlayableInternal(int32_t  index) ;

/// @brief Method GetRootPlayableInternal_Injected, addr 0x2fa2a90, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method IsMatchFrameRateEnabled, addr 0x2fa2ae4, size 0x3c, virtual false, abstract: false, final false
inline bool IsMatchFrameRateEnabled() ;

/// @brief Method IsMatchFrameRateEnabled_Injected, addr 0x2fa2b20, size 0x3c, virtual false, abstract: false, final false
static inline bool IsMatchFrameRateEnabled_Injected(::ByRef<::UnityEngine::Playables::PlayableGraph>  _unity_self) ;

/// @brief Method IsPlaying, addr 0x2fa26e4, size 0x3c, virtual false, abstract: false, final false
inline bool IsPlaying() ;

/// @brief Method IsPlaying_Injected, addr 0x2fa2720, size 0x3c, virtual false, abstract: false, final false
static inline bool IsPlaying_Injected(::ByRef<::UnityEngine::Playables::PlayableGraph>  _unity_self) ;

/// @brief Method IsValid, addr 0x2fa266c, size 0x3c, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method IsValid_Injected, addr 0x2fa26a8, size 0x3c, virtual false, abstract: false, final false
static inline bool IsValid_Injected(::ByRef<::UnityEngine::Playables::PlayableGraph>  _unity_self) ;

/// @brief Method SynchronizeEvaluation, addr 0x2fa2910, size 0x50, virtual false, abstract: false, final false
inline void SynchronizeEvaluation(::UnityEngine::Playables::PlayableGraph  playable) ;

/// @brief Method SynchronizeEvaluation_Injected, addr 0x2fa2960, size 0x44, virtual false, abstract: false, final false
