...
/// @brief Method AddNotificationReceiver, addr 0x2fa5094, size 0x84, virtual false, abstract: false, final false
inline void AddNotificationReceiver(::UnityEngine::Playables::INotificationReceiver*  receiver) ;

/// @brief Method AddNotificationReceiver_Injected, addr 0x2fa5118, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method CompareVersion, addr 0x2fa4810, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method Equals, addr 0x2fa48ec, size 0x80, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Playables::PlayableOutputHandle  other) ;

/// @brief Method Equals, addr 0x2fa4844, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  p) ;

/// @brief Method GetHashCode, addr 0x2fa47dc, size 0x34, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetPlayableOutputType, addr 0x2fa4a1c, size 0x74, virtual false, abstract: false, final false
inline ::System::Type* GetPlayableOutputType() ;

/// @brief Method GetPlayableOutputType_Injected, addr 0x2fa4a90, size 0x3c, virtual false, abstract: false, final false
static inline ::System::Type* GetPlayableOutputType_Injected(::ByRef<::UnityEngine::Playables::PlayableOutputHandle>  _unity_self) ;

/// @brief Method GetSourceOutputPort, addr 0x2fa4e18, size 0x74, virtual false, abstract: false, final false
inline int32_t GetSourceOutputPort() ;

/// @brief Method GetSourceOutputPort_Injected, addr 0x2fa4e8c, size 0x3c, virtual false, abstract: false, final false
static inline int32_t GetSourceOutputPort_Injected(::ByRef<::UnityEngine::Playables::PlayableOutputHandle>  _unity_self) ;

/// @brief Method GetSourcePlayable, addr 0x2fa4c5c, size 0x8c, virtual false, abstract: false, final false
inline ::UnityEngine::Playables::PlayableHandle GetSourcePlayable() ;

/// @brief Method GetSourcePlayable_Injected, addr 0x2fa4ce8, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method IsValid, addr 0x2fa496c, size 0x74, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method IsValid_Injected, addr 0x2fa49e0, size 0x3c, virtual false, abstract: false, final false
static inline bool IsValid_Injected(::ByRef<::UnityEngine::Playables::PlayableOutputHandle>  _unity_self) ;

/// @brief Method PushNotification, addr 0x2fa4f98, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method PushNotification_Injected, addr 0x2fa5038, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method SetReferenceObject, addr 0x2fa4acc, size 0x84, virtual false, abstract: false, final false
inline void SetReferenceObject(::UnityEngine::Object*  target) ;

/// @brief Method SetReferenceObject_Injected, addr 0x2fa4b50, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method SetSourcePlayable, addr 0x2fa4d2c, size 0x98, virtual false, abstract: false, final false
inline void SetSourcePlayable(::UnityEngine::Playables::PlayableHandle  target, int32_t  port) ;

/// @brief Method SetSourcePlayable_Injected, addr 0x2fa4dc4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SetUserData, addr 0x2fa4b94, size 0x84, virtual false, abstract: false, final false
inline void SetUserData(::UnityEngine::Object*  target) ;

/// @brief Method SetUserData_Injected, addr 0x2fa4c18, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method SetWeight, addr 0x2fa4ec8, size 0x84, virtual false, abstract: false, final false
inline void SetWeight(float_t  weight) ;

/// @brief Method SetWeight_Injected, addr 0x2fa4f4c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method get_Null, addr 0x2fa4784, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x2fa468c, size 0x88, virtual false, abstract: false, final false
