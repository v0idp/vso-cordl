...
public:
// Declarations
/// @brief Method Create, addr 0x2fa51a4, size 0xbc, virtual false, abstract: false, final false
static inline ::UnityEngine::Playables::PlayableBinding Create(::StringW  name, ::UnityEngine::Object*  key, ::System::Type*  type) ;

/// @brief Method CreateScriptOutput, addr 0x2fa5260, size 0x4, virtual false, abstract: false, final false
