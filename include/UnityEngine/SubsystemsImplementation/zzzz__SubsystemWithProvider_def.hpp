...
/// @brief Method Destroy, addr 0x2fcea3c, size 0x7c, virtual true, abstract: false, final true
inline void Destroy() ;
...
/// @brief Method Start, addr 0x2fce9c8, size 0x3c, virtual true, abstract: false, final true
inline void Start() ;

/// @brief Method Stop, addr 0x2fcea04, size 0x38, virtual true, abstract: false, final true
inline void Stop() ;
...
/// @brief Method .ctor, addr 0x2fcead4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_providerBase, addr 0x2fceacc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::SubsystemsImplementation::SubsystemProvider* get_providerBase() ;

/// @brief Method get_running, addr 0x2fceab8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_running, addr 0x2fceac0, size 0xc, virtual false, abstract: false, final false
