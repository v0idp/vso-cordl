...
/// @brief Method FindObjectsOfTypeAll, addr 0x2f86414, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method FindShaderByName, addr 0x2f86450, size 0x3c, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> FindShaderByName(::StringW  name) ;

/// @brief Method Load, addr 0x2f8648c, size 0x44, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f8640c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ActiveAPI, addr 0x2f8630c, size 0xa8, virtual false, abstract: false, final false
static inline ::UnityEngine::ResourcesAPI* get_ActiveAPI() ;

/// @brief Method get_overrideAPI, addr 0x2f863b4, size 0x58, virtual false, abstract: false, final false
