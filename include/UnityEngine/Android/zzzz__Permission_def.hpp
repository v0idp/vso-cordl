...
/// @brief Method GetUnityPermissions, addr 0x2f5276c, size 0xb0, virtual false, abstract: false, final false
static inline ::UnityEngine::AndroidJavaObject* GetUnityPermissions() ;

/// @brief Method HasUserAuthorizedPermission, addr 0x2f5281c, size 0x120, virtual false, abstract: false, final false
static inline bool HasUserAuthorizedPermission(::StringW  permission) ;

/// @brief Method RequestUserPermission, addr 0x2f5293c, size 0x78, virtual false, abstract: false, final false
static inline void RequestUserPermission(::StringW  permission) ;

/// @brief Method RequestUserPermission, addr 0x2f52aec, size 0x7c, virtual false, abstract: false, final false
static inline void RequestUserPermission(::StringW  permission, ::UnityEngine::Android::PermissionCallbacks*  callbacks) ;

/// @brief Method RequestUserPermissions, addr 0x2f529b4, size 0x138, virtual false, abstract: false, final false
