...
/// @brief Method AcquireContextAndActivity, addr 0x2f51498, size 0x244, virtual false, abstract: false, final false
...
/// @brief Method get_Activity, addr 0x2f516dc, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::AndroidJavaObject* get_Activity() ;

/// @brief Method get_Context, addr 0x2f5144c, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::AndroidJavaObject* get_Context() ;

/// @brief Method get_UnityPlayerRaw, addr 0x2f40410, size 0x28, virtual false, abstract: false, final false
