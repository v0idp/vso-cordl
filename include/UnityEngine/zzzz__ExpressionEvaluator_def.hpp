...
/// @brief Method .ctor, addr 0x2f64d50, size 0x84, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method GetUInt, addr 0x2f64740, size 0x38, virtual false, abstract: false, final false
inline uint32_t GetUInt() ;

/// @brief Method RotateRight, addr 0x2f64e0c, size 0x8, virtual false, abstract: false, final false
static inline uint32_t RotateRight(uint32_t  v, int32_t  rot) ;

/// @brief Method Step, addr 0x2f64dd4, size 0x20, virtual false, abstract: false, final false
inline void Step() ;

/// @brief Method XshRr, addr 0x2f64df4, size 0x18, virtual false, abstract: false, final false
static inline uint32_t XshRr(uint64_t  s) ;

/// @brief Method .ctor, addr 0x2f64ce8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f64d10, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method <ExpressionToTokens>b__14_0, addr 0x2f64e78, size 0x80, virtual false, abstract: false, final false
inline bool _ExpressionToTokens_b__14_0(::StringW  f) ;

/// @brief Method .ctor, addr 0x2f64e70, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method EvaluateDouble, addr 0x2f62fec, size 0x4d0, virtual false, abstract: false, final false
static inline bool EvaluateDouble(::ArrayW<::StringW,::Array<::StringW>*>  tokens, ::ByRef<double_t>  value, int32_t  index, int32_t  count) ;

/// @brief Method EvaluateOp, addr 0x2f63688, size 0x354, virtual false, abstract: false, final false
...
/// @brief Method ExpressionToTokens, addr 0x2f63f98, size 0x43c, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> ExpressionToTokens(::StringW  expression, ::ByRef<bool>  hasVariables) ;

/// @brief Method FixUnaryOperators, addr 0x2f645c4, size 0x17c, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> FixUnaryOperators(::ArrayW<::StringW,::Array<::StringW>*>  tokens) ;

/// @brief Method InfixToRPN, addr 0x2f63a44, size 0x400, virtual false, abstract: false, final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> InfixToRPN(::ArrayW<::StringW,::Array<::StringW>*>  tokens) ;

/// @brief Method IsCommand, addr 0x2f635dc, size 0xac, virtual false, abstract: false, final false
static inline bool IsCommand(::StringW  token) ;

/// @brief Method IsDelayedFunction, addr 0x2f63e44, size 0x6c, virtual false, abstract: false, final false
static inline bool IsDelayedFunction(::StringW  token) ;

/// @brief Method IsOperator, addr 0x2f634bc, size 0x80, virtual false, abstract: false, final false
static inline bool IsOperator(::StringW  token) ;

/// @brief Method IsVariable, addr 0x2f639dc, size 0x68, virtual false, abstract: false, final false
static inline bool IsVariable(::StringW  token) ;

/// @brief Method NeedToPop, addr 0x2f63eb0, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method PreFormatExpression, addr 0x2f643d4, size 0x1f0, virtual false, abstract: false, final false
static inline ::StringW PreFormatExpression(::StringW  expression) ;

/// @brief Method TokenToOperator, addr 0x2f6353c, size 0xa0, virtual false, abstract: false, final false
