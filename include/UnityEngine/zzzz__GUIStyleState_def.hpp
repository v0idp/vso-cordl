...
/// @brief Method Cleanup, addr 0x2fb2518, size 0x3c, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Finalize, addr 0x2fb2630, size 0xc4, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetGUIStyleState, addr 0x2fb25c8, size 0x68, virtual false, abstract: false, final false
static inline ::UnityEngine::GUIStyleState* GetGUIStyleState(::UnityEngine::GUIStyle*  sourceStyle, ::System::IntPtr  source) ;

/// @brief Method Init, addr 0x2fb24f0, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fb2554, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2fb259c, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::GUIStyle*  sourceStyle, ::System::IntPtr  source) ;

/// @brief Method set_textColor, addr 0x2fb2064, size 0x54, virtual false, abstract: false, final false
inline void set_textColor(::UnityEngine::Color  value) ;

/// @brief Method set_textColor_Injected, addr 0x2fb24ac, size 0x44, virtual false, abstract: false, final false
