...
/// @brief Method ApplyOptions, addr 0x2fb53c8, size 0x120, virtual true, abstract: false, final false
inline void ApplyOptions(::ArrayW<::UnityEngine::GUILayoutOption*,::Array<::UnityEngine::GUILayoutOption*>*>  options) ;

/// @brief Method ApplyStyleSettings, addr 0x2fb54e8, size 0x74, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::UnityEngine::GUIStyle*  style) ;

/// @brief Method CalcHeight, addr 0x2fb6444, size 0x5fc, virtual true, abstract: false, final false
inline void CalcHeight() ;

/// @brief Method CalcWidth, addr 0x2fb555c, size 0x6ac, virtual true, abstract: false, final false
inline void CalcWidth() ;

static inline ::UnityEngine::GUILayoutGroup* New_ctor() ;

/// @brief Method ResetCursor, addr 0x2fb06c4, size 0x8, virtual false, abstract: false, final false
inline void ResetCursor() ;

/// @brief Method SetHorizontal, addr 0x2fb5c08, size 0x83c, virtual true, abstract: false, final false
inline void SetHorizontal(float_t  x, float_t  width) ;

/// @brief Method SetVertical, addr 0x2fb6a40, size 0x848, virtual true, abstract: false, final false
inline void SetVertical(float_t  y, float_t  height) ;

/// @brief Method ToString, addr 0x2fb7288, size 0x38c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fafd58, size 0x10c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::GUILayoutEntry* getStaticF_none() ;

/// @brief Method get_marginBottom, addr 0x2fb53c0, size 0x8, virtual true, abstract: false, final false
inline int32_t get_marginBottom() ;

/// @brief Method get_marginLeft, addr 0x2fb53a8, size 0x8, virtual true, abstract: false, final false
inline int32_t get_marginLeft() ;

/// @brief Method get_marginRight, addr 0x2fb53b0, size 0x8, virtual true, abstract: false, final false
inline int32_t get_marginRight() ;

/// @brief Method get_marginTop, addr 0x2fb53b8, size 0x8, virtual true, abstract: false, final false
