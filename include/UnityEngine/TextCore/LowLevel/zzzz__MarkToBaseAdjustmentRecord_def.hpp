...
/// @brief Method get_baseGlyphAnchorPoint, addr 0x2fd1434, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::LowLevel::GlyphAnchorPoint get_baseGlyphAnchorPoint() ;

/// @brief Method get_baseGlyphID, addr 0x2fd142c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_baseGlyphID() ;

/// @brief Method get_markGlyphID, addr 0x2fd143c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_markGlyphID() ;

/// @brief Method get_markPositionAdjustment, addr 0x2fd1444, size 0x8, virtual false, abstract: false, final false
