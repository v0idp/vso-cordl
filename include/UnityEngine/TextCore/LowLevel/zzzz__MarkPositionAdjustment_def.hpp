...
/// @brief Method get_xPositionAdjustment, addr 0x2fd141c, size 0x8, virtual false, abstract: false, final false
inline float_t get_xPositionAdjustment() ;

/// @brief Method get_yPositionAdjustment, addr 0x2fd1424, size 0x8, virtual false, abstract: false, final false
