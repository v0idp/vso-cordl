...
/// @brief Method get_componentGlyphIDs, addr 0x2fd146c, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint32_t,::Array<uint32_t>*> get_componentGlyphIDs() ;

/// @brief Method get_ligatureGlyphID, addr 0x2fd1474, size 0x8, virtual false, abstract: false, final false
