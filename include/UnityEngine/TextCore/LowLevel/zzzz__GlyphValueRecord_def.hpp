...
/// @brief Method Equals, addr 0x2fd0f88, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2fd1000, size 0xa8, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::TextCore::LowLevel::GlyphValueRecord  other) ;

/// @brief Method GetHashCode, addr 0x2fd0f24, size 0x64, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method get_xAdvance, addr 0x2fd0f00, size 0x8, virtual false, abstract: false, final false
inline float_t get_xAdvance() ;

/// @brief Method get_xPlacement, addr 0x2fd0ee0, size 0x8, virtual false, abstract: false, final false
inline float_t get_xPlacement() ;

/// @brief Method get_yAdvance, addr 0x2fd0f08, size 0x8, virtual false, abstract: false, final false
inline float_t get_yAdvance() ;

/// @brief Method get_yPlacement, addr 0x2fd0ef0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method op_Addition, addr 0x2fd0f10, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method set_xPlacement, addr 0x2fd0ee8, size 0x8, virtual false, abstract: false, final false
inline void set_xPlacement(float_t  value) ;

/// @brief Method set_yPlacement, addr 0x2fd0ef8, size 0x8, virtual false, abstract: false, final false
