...
/// @brief Method get_xCoordinate, addr 0x2fd140c, size 0x8, virtual false, abstract: false, final false
inline float_t get_xCoordinate() ;

/// @brief Method get_yCoordinate, addr 0x2fd1414, size 0x8, virtual false, abstract: false, final false
