...
/// @brief Method get_baseMarkGlyphAnchorPoint, addr 0x2fd1454, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::LowLevel::GlyphAnchorPoint get_baseMarkGlyphAnchorPoint() ;

/// @brief Method get_baseMarkGlyphID, addr 0x2fd144c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_baseMarkGlyphID() ;

/// @brief Method get_combiningMarkGlyphID, addr 0x2fd145c, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_combiningMarkGlyphID() ;

/// @brief Method get_combiningMarkPositionAdjustment, addr 0x2fd1464, size 0x8, virtual false, abstract: false, final false
