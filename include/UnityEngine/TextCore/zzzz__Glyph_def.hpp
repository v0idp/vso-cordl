...
/// @brief Method .ctor, addr 0x2fcf07c, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2fcf0a4, size 0x8c, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct  glyphStruct) ;

/// @brief Method .ctor, addr 0x2fcf130, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_atlasIndex, addr 0x2fcf06c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_atlasIndex() ;

/// @brief Method get_glyphRect, addr 0x2fcf048, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::GlyphRect get_glyphRect() ;

/// @brief Method get_index, addr 0x2fcf010, size 0x8, virtual false, abstract: false, final false
inline uint32_t get_index() ;

/// @brief Method get_metrics, addr 0x2fcf020, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::GlyphMetrics get_metrics() ;

/// @brief Method get_scale, addr 0x2fcf05c, size 0x8, virtual false, abstract: false, final false
inline float_t get_scale() ;

/// @brief Method set_atlasIndex, addr 0x2fcf074, size 0x8, virtual false, abstract: false, final false
inline void set_atlasIndex(int32_t  value) ;

/// @brief Method set_glyphRect, addr 0x2fcf054, size 0x8, virtual false, abstract: false, final false
inline void set_glyphRect(::UnityEngine::TextCore::GlyphRect  value) ;

/// @brief Method set_index, addr 0x2fcf018, size 0x8, virtual false, abstract: false, final false
inline void set_index(uint32_t  value) ;

/// @brief Method set_metrics, addr 0x2fcf034, size 0x14, virtual false, abstract: false, final false
inline void set_metrics(::UnityEngine::TextCore::GlyphMetrics  value) ;

/// @brief Method set_scale, addr 0x2fcf064, size 0x8, virtual false, abstract: false, final false
