...
public:
// Declarations
/// @brief Method Equals, addr 0x2ff8414, size 0x80, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x2ff83a8, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method .ctor, addr 0x2ff825c, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Color32  color, ::UnityEngine::TextCore::Text::Offset  padding) ;

/// @brief Method op_Equality, addr 0x2ff826c, size 0xf4, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::TextCore::Text::HighlightState  lhs, ::UnityEngine::TextCore::Text::HighlightState  rhs) ;

/// @brief Method op_Inequality, addr 0x2ff8360, size 0x48, virtual false, abstract: false, final false
