...
/// @brief Method Clear, addr 0x2ffdd58, size 0x60, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method ClearLineInfo, addr 0x2ffde74, size 0x170, virtual false, abstract: false, final false
inline void ClearLineInfo() ;

/// @brief Method ClearMeshInfo, addr 0x2ffddb8, size 0xbc, virtual false, abstract: false, final false
inline void ClearMeshInfo(bool  updateMesh) ;

/// @brief Method ClearPageInfo, addr 0x2ffdfe4, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ffc4ac, size 0x138, virtual false, abstract: false, final false
inline void _ctor() ;
