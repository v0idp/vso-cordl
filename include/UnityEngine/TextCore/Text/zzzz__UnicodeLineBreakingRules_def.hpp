...
/// @brief Method GetCharacters, addr 0x3000e04, size 0xe8, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::HashSet_1<uint32_t>* GetCharacters(::UnityEngine::TextAsset*  file) ;

/// @brief Method LoadLineBreakingRules, addr 0x2ffebe0, size 0x1e4, virtual false, abstract: false, final false
inline void LoadLineBreakingRules() ;

/// @brief Method LoadLineBreakingRules, addr 0x3000c00, size 0x1d4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2ffebd8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_followingCharacters, addr 0x3000bd0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::TextAsset> get_followingCharacters() ;

/// @brief Method get_followingCharactersLookup, addr 0x3000dd4, size 0x28, virtual false, abstract: false, final false
inline ::System::Collections::Generic::HashSet_1<uint32_t>* get_followingCharactersLookup() ;

/// @brief Method get_leadingCharacters, addr 0x3000bc8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::TextAsset> get_leadingCharacters() ;

/// @brief Method get_leadingCharactersLookup, addr 0x3000bd8, size 0x28, virtual false, abstract: false, final false
inline ::System::Collections::Generic::HashSet_1<uint32_t>* get_leadingCharactersLookup() ;

/// @brief Method get_useModernHangulLineBreakingRules, addr 0x3000dfc, size 0x8, virtual false, abstract: false, final false
