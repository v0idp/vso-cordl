...
/// @brief Method RefreshStyle, addr 0x30004c8, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x300047c, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method get_hashCode, addr 0x2ff90bc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_hashCode() ;

/// @brief Method get_styleClosingTagArray, addr 0x2ff9658, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint32_t,::Array<uint32_t>*> get_styleClosingTagArray() ;

/// @brief Method get_styleOpeningTagArray, addr 0x2ff90c4, size 0x8, virtual false, abstract: false, final false
