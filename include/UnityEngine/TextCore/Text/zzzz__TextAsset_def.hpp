...
/// @brief Method .ctor, addr 0x2fda6f0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_hashCode, addr 0x2fdcb78, size 0x30, virtual false, abstract: false, final false
inline int32_t get_hashCode() ;

/// @brief Method get_instanceID, addr 0x2fd5eb4, size 0x28, virtual false, abstract: false, final false
inline int32_t get_instanceID() ;

/// @brief Method get_material, addr 0x2fdf2b0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_material() ;

/// @brief Method get_materialHashCode, addr 0x2fdcba8, size 0x98, virtual false, abstract: false, final false
inline int32_t get_materialHashCode() ;

/// @brief Method get_version, addr 0x2fdf298, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_version() ;

/// @brief Method set_hashCode, addr 0x2fdf2a8, size 0x8, virtual false, abstract: false, final false
inline void set_hashCode(int32_t  value) ;

/// @brief Method set_material, addr 0x2fdf2b8, size 0x8, virtual false, abstract: false, final false
inline void set_material(::UnityEngine::Material*  value) ;

/// @brief Method set_materialHashCode, addr 0x2fdf2c0, size 0x8, virtual false, abstract: false, final false
inline void set_materialHashCode(int32_t  value) ;

/// @brief Method set_version, addr 0x2fdf2a0, size 0x8, virtual false, abstract: false, final false
