...
public:
// Declarations
/// @brief Method CompareColors, addr 0x2fd1574, size 0x10, virtual false, abstract: false, final false
static inline bool CompareColors(::UnityEngine::Color32  a, ::UnityEngine::Color32  b) ;

/// @brief Method MultiplyColors, addr 0x2fd1584, size 0xb8, virtual false, abstract: false, final false
