...
/// @brief Method GetStyle, addr 0x2ffa220, size 0x88, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextStyle* GetStyle(int32_t  hashCode) ;

/// @brief Method GetStyle, addr 0x3000964, size 0x94, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextStyle* GetStyle(::StringW  name) ;

/// @brief Method LoadStyleDictionaryInternal, addr 0x3000688, size 0x2dc, virtual false, abstract: false, final false
inline void LoadStyleDictionaryInternal() ;

static inline ::UnityEngine::TextCore::Text::TextStyleSheet* New_ctor() ;

/// @brief Method RefreshStyles, addr 0x30009f8, size 0x4, virtual false, abstract: false, final false
inline void RefreshStyles() ;

/// @brief Method Reset, addr 0x3000684, size 0x4, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x30009fc, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_styles, addr 0x300067c, size 0x8, virtual false, abstract: false, final false
