...
public:
// Declarations
/// @brief Method GetHashCodeCaseInSensitive, addr 0x2ffea0c, size 0x70, virtual false, abstract: false, final false
static inline int32_t GetHashCodeCaseInSensitive(::StringW  s) ;

/// @brief Method ToUpperFast, addr 0x3000a7c, size 0x74, virtual false, abstract: false, final false
static inline char16_t ToUpperFast(char16_t  c) ;

/// @brief Method UintToString, addr 0x3000af0, size 0xd8, virtual false, abstract: false, final false
