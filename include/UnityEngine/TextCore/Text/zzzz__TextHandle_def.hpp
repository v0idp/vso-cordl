...
/// @brief Field m_LayoutTextInfo, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_m_LayoutTextInfo, put=setStaticF_m_LayoutTextInfo)) ::UnityEngine::TextCore::Text::TextInfo*  m_LayoutTextInfo;
...
/// @brief Field s_LayoutSettings, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_LayoutSettings, put=setStaticF_s_LayoutSettings)) ::UnityEngine::TextCore::Text::TextGenerationSettings*  s_LayoutSettings;
...
/// @brief Method ComputeTextHeight, addr 0x2ffdc64, size 0x18, virtual false, abstract: false, final false
inline float_t ComputeTextHeight(::UnityEngine::TextCore::Text::TextGenerationSettings*  tgs) ;

/// @brief Method ComputeTextWidth, addr 0x2ffdbd8, size 0x18, virtual false, abstract: false, final false
inline float_t ComputeTextWidth(::UnityEngine::TextCore::Text::TextGenerationSettings*  tgs) ;

/// @brief Method DistanceToLine, addr 0x2ffd2d4, size 0xc8, virtual false, abstract: false, final false
static inline float_t DistanceToLine(::UnityEngine::Vector3  a, ::UnityEngine::Vector3  b, ::UnityEngine::Vector3  point) ;

/// @brief Method FindIntersectingLink, addr 0x2ffd39c, size 0x2c4, virtual false, abstract: false, final false
inline int32_t FindIntersectingLink(::UnityEngine::Vector3  position, bool  inverseYAxis) ;

/// @brief Method FindNearestCharacterOnLine, addr 0x2ffcbb0, size 0x2c0, virtual false, abstract: false, final false
inline int32_t FindNearestCharacterOnLine(::UnityEngine::Vector2  position, int32_t  line, bool  visibleOnly) ;

/// @brief Method FindNearestLine, addr 0x2ffcae0, size 0xd0, virtual false, abstract: false, final false
inline int32_t FindNearestLine(::UnityEngine::Vector2  position) ;

/// @brief Method GetCharacterHeightFromIndex, addr 0x2ffd814, size 0x98, virtual false, abstract: false, final false
inline float_t GetCharacterHeightFromIndex(int32_t  index) ;

/// @brief Method GetCursorIndexFromPosition, addr 0x2ffc9c8, size 0x118, virtual false, abstract: false, final false
inline int32_t GetCursorIndexFromPosition(::UnityEngine::Vector2  position, bool  inverseYAxis) ;

/// @brief Method GetCursorPositionFromStringIndexUsingCharacterHeight, addr 0x2ffc6ec, size 0x150, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetCursorPositionFromStringIndexUsingCharacterHeight(int32_t  index, bool  inverseYAxis) ;

/// @brief Method GetCursorPositionFromStringIndexUsingLineHeight, addr 0x2ffc83c, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method GetLineHeight, addr 0x2ffd6f0, size 0x90, virtual false, abstract: false, final false
inline float_t GetLineHeight(int32_t  lineNumber) ;

/// @brief Method GetLineHeightFromCharacterIndex, addr 0x2ffd780, size 0x94, virtual false, abstract: false, final false
inline float_t GetLineHeightFromCharacterIndex(int32_t  index) ;

/// @brief Method GetLineNumber, addr 0x2ffd660, size 0x90, virtual false, abstract: false, final false
inline int32_t GetLineNumber(int32_t  index) ;

/// @brief Method IndexOf, addr 0x2ffda24, size 0xe8, virtual false, abstract: false, final false
inline int32_t IndexOf(char16_t  value, int32_t  startIndex) ;

/// @brief Method IsDirty, addr 0x2ffc69c, size 0x50, virtual false, abstract: false, final false
inline bool IsDirty() ;

/// @brief Method IsElided, addr 0x2ffd8ac, size 0x40, virtual false, abstract: false, final false
inline bool IsElided() ;

/// @brief Method LastIndexOf, addr 0x2ffdb0c, size 0xcc, virtual false, abstract: false, final false
inline int32_t LastIndexOf(char16_t  value, int32_t  startIndex) ;

/// @brief Method LineDownCharacterPosition, addr 0x2ffce70, size 0x1dc, virtual false, abstract: false, final false
inline int32_t LineDownCharacterPosition(int32_t  originalPos) ;

/// @brief Method LineUpCharacterPosition, addr 0x2ffd04c, size 0x1c8, virtual false, abstract: false, final false
inline int32_t LineUpCharacterPosition(int32_t  originalPos) ;

static inline ::UnityEngine::TextCore::Text::TextHandle* New_ctor() ;

/// @brief Method PointIntersectRectangle, addr 0x2ffd214, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method Substring, addr 0x2ffd8ec, size 0x138, virtual false, abstract: false, final false
inline ::StringW Substring(int32_t  startIndex, int32_t  length) ;

/// @brief Method Update, addr 0x2ffdc7c, size 0x6c, virtual false, abstract: false, final false
inline ::UnityEngine::TextCore::Text::TextInfo* Update(::UnityEngine::TextCore::Text::TextGenerationSettings*  tgs) ;

/// @brief Method UpdatePreferredValues, addr 0x2ffdbf0, size 0x74, virtual false, abstract: false, final false
...
constexpr ::UnityEngine::TextCore::Text::TextGenerationSettings* const& __cordl_internal_get_textGenerationSettings() const;
...
/// @brief Method .ctor, addr 0x2ffc3e8, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_layoutTextInfo, addr 0x2ffc5e4, size 0xb8, virtual false, abstract: false, final false
static inline ::UnityEngine::TextCore::Text::TextInfo* get_layoutTextInfo() ;

/// @brief Method get_textInfo, addr 0x2ffc44c, size 0x60, virtual false, abstract: false, final false
