...
public:
// Declarations
/// @brief Method Add, addr 0x2ffe0f4, size 0xfc, virtual false, abstract: false, final false
inline uint8_t Add(::UnityEngine::TextCore::Text::FontStyles  style) ;

/// @brief Method Clear, addr 0x2ffe0e8, size 0xc, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Remove, addr 0x2ffe1f0, size 0x144, virtual false, abstract: false, final false
