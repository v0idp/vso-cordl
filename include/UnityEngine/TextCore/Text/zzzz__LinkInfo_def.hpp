...
public:
// Declarations
/// @brief Method GetLinkId, addr 0x2fdbb0c, size 0x44, virtual false, abstract: false, final false
inline ::StringW GetLinkId() ;

/// @brief Method GetLinkText, addr 0x2fdba14, size 0xf8, virtual false, abstract: false, final false
inline ::StringW GetLinkText(::UnityEngine::TextCore::Text::TextInfo*  textInfo) ;

/// @brief Method SetLinkId, addr 0x2fdb938, size 0xdc, virtual false, abstract: false, final false
