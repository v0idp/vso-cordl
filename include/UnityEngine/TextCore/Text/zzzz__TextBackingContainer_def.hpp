...
/// @brief Method Resize, addr 0x2ff7fa0, size 0x64, virtual false, abstract: false, final false
inline void Resize(int32_t  size) ;

/// @brief Method .ctor, addr 0x2ff8004, size 0x60, virtual false, abstract: false, final false
inline void _ctor(int32_t  size) ;

/// @brief Method get_Capacity, addr 0x2ff7ee4, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_Capacity() ;

/// @brief Method get_Count, addr 0x2ff7f00, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Item, addr 0x2ff7f10, size 0x30, virtual false, abstract: false, final false
inline uint32_t get_Item(int32_t  index) ;

/// @brief Method set_Count, addr 0x2ff7f08, size 0x8, virtual false, abstract: false, final false
inline void set_Count(int32_t  value) ;

/// @brief Method set_Item, addr 0x2ff7f40, size 0x60, virtual false, abstract: false, final false
