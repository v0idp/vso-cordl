...
/// @brief Method AddColorGradientPreset, addr 0x2fdcddc, size 0x30, virtual false, abstract: false, final false
static inline void AddColorGradientPreset(int32_t  hashCode, ::UnityEngine::TextCore::Text::TextColorGradient*  spriteAsset) ;

/// @brief Method AddColorGradientPreset_Internal, addr 0x2fdce0c, size 0xa4, virtual false, abstract: false, final false
inline void AddColorGradientPreset_Internal(int32_t  hashCode, ::UnityEngine::TextCore::Text::TextColorGradient*  spriteAsset) ;

/// @brief Method AddFontAsset, addr 0x2fdca70, size 0x20, virtual false, abstract: false, final false
static inline void AddFontAsset(::UnityEngine::TextCore::Text::FontAsset*  fontAsset) ;

/// @brief Method AddFontAssetInternal, addr 0x2fdca90, size 0xe8, virtual false, abstract: false, final false
inline void AddFontAssetInternal(::UnityEngine::TextCore::Text::FontAsset*  fontAsset) ;

/// @brief Method AddFontMaterial, addr 0x2fdcd44, size 0x30, virtual false, abstract: false, final false
static inline void AddFontMaterial(int32_t  hashCode, ::UnityEngine::Material*  material) ;

/// @brief Method AddFontMaterialInternal, addr 0x2fdcd74, size 0x68, virtual false, abstract: false, final false
inline void AddFontMaterialInternal(int32_t  hashCode, ::UnityEngine::Material*  material) ;

/// @brief Method AddSpriteAsset, addr 0x2fdcc40, size 0x30, virtual false, abstract: false, final false
static inline void AddSpriteAsset(int32_t  hashCode, ::UnityEngine::TextCore::Text::SpriteAsset*  spriteAsset) ;

/// @brief Method AddSpriteAssetInternal, addr 0x2fdcc70, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method TryGetColorGradientPreset, addr 0x2fdcfe8, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method TryGetColorGradientPresetInternal, addr 0x2fdd018, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method TryGetFontAsset, addr 0x2fdceb0, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetFontAsset(int32_t  hashCode, ::ByRef<::UnityEngine::TextCore::Text::FontAsset*>  fontAsset) ;

/// @brief Method TryGetFontAssetInternal, addr 0x2fdcee0, size 0x6c, virtual false, abstract: false, final false
inline bool TryGetFontAssetInternal(int32_t  hashCode, ::ByRef<::UnityEngine::TextCore::Text::FontAsset*>  fontAsset) ;

/// @brief Method TryGetMaterial, addr 0x2fdd084, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetMaterial(int32_t  hashCode, ::ByRef<::UnityEngine::Material*>  material) ;

/// @brief Method TryGetMaterialInternal, addr 0x2fdd0b4, size 0x6c, virtual false, abstract: false, final false
inline bool TryGetMaterialInternal(int32_t  hashCode, ::ByRef<::UnityEngine::Material*>  material) ;

/// @brief Method TryGetSpriteAsset, addr 0x2fdcf4c, size 0x30, virtual false, abstract: false, final false
static inline bool TryGetSpriteAsset(int32_t  hashCode, ::ByRef<::UnityEngine::TextCore::Text::SpriteAsset*>  spriteAsset) ;

/// @brief Method TryGetSpriteAssetInternal, addr 0x2fdcf7c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2fdc91c, size 0x154, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::TextCore::Text::MaterialReferenceManager* getStaticF_s_Instance() ;

/// @brief Method get_instance, addr 0x2fdc8ac, size 0x70, virtual false, abstract: false, final false
