...
/// @brief Method Clear, addr 0x2fdd734, size 0x2c, virtual false, abstract: false, final false
inline void Clear(bool  uploadChanges) ;

/// @brief Method ClearUnusedVertices, addr 0x2fdd760, size 0x3c, virtual false, abstract: false, final false
inline void ClearUnusedVertices() ;

/// @brief Method ResizeMeshInfo, addr 0x2fdd53c, size 0x1f8, virtual false, abstract: false, final false
inline void ResizeMeshInfo(int32_t  size) ;

/// @brief Method SortGeometry, addr 0x2fdd79c, size 0xb4, virtual false, abstract: false, final false
inline void SortGeometry(::UnityEngine::TextCore::Text::VertexSortingOrder  order) ;

/// @brief Method SwapVertexData, addr 0x2fdd850, size 0x58c, virtual false, abstract: false, final false
inline void SwapVertexData(int32_t  src, int32_t  dst) ;

/// @brief Method .ctor, addr 0x2fdd120, size 0x41c, virtual false, abstract: false, final false
