...
/// @brief Method Auto, addr 0x301adf4, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::Yoga::YogaValue Auto() ;

/// @brief Method Equals, addr 0x301ad40, size 0x78, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x301ace0, size 0x60, virtual false, abstract: false, final false
inline bool Equals(::UnityEngine::Yoga::YogaValue  other) ;

/// @brief Method GetHashCode, addr 0x301adb8, size 0x3c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Percent, addr 0x301ae00, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::Yoga::YogaValue Percent(float_t  value) ;

/// @brief Method Point, addr 0x301acc0, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::Yoga::YogaValue Point(float_t  value) ;

/// @brief Method get_Unit, addr 0x30193d4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Yoga::YogaUnit get_Unit() ;

/// @brief Method get_Value, addr 0x30193dc, size 0x8, virtual false, abstract: false, final false
inline float_t get_Value() ;

/// @brief Method op_Implicit, addr 0x301ae20, size 0x20, virtual false, abstract: false, final false
