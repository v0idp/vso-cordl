...
/// @brief Method Finalize, addr 0x3017c60, size 0x108, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3017bf4, size 0x44, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3017b70, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  ygConfig) ;

static inline ::UnityEngine::Yoga::YogaConfig* getStaticF_Default() ;

/// @brief Method get_Handle, addr 0x3017d68, size 0x8, virtual false, abstract: false, final false
inline ::System::IntPtr get_Handle() ;

/// @brief Method get_UseWebDefaults, addr 0x3017dc8, size 0x3c, virtual false, abstract: false, final false
inline bool get_UseWebDefaults() ;

static inline void setStaticF_Default(::UnityEngine::Yoga::YogaConfig*  value) ;

/// @brief Method set_PointScaleFactor, addr 0x3017ec8, size 0x4c, virtual false, abstract: false, final false
inline void set_PointScaleFactor(float_t  value) ;

/// @brief Method set_UseWebDefaults, addr 0x3017e40, size 0x44, virtual false, abstract: false, final false
