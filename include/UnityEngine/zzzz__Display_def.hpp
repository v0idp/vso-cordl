...
public:
// Declarations
/// @brief Method Invoke, addr 0x2f68a24, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;

static inline ::UnityEngine::Display_DisplaysUpdatedDelegate* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x2f6899c, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method FireDisplaysUpdated, addr 0x2f687fc, size 0x94, virtual false, abstract: false, final false
static inline void FireDisplaysUpdated() ;

/// @brief Method GetRenderingExtImpl, addr 0x2f682dc, size 0x54, virtual false, abstract: false, final false
static inline void GetRenderingExtImpl(::System::IntPtr  nativeDisplay, ::ByRef<int32_t>  w, ::ByRef<int32_t>  h) ;

/// @brief Method GetSystemExtImpl, addr 0x2f68458, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method RecreateDisplayList, addr 0x2f686b4, size 0x148, virtual false, abstract: false, final false
static inline void RecreateDisplayList(::ArrayW<::System::IntPtr,::Array<::System::IntPtr>*>  nativeDisplay) ;

/// @brief Method RelativeMouseAt, addr 0x2f68540, size 0xc0, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 RelativeMouseAt(::UnityEngine::Vector3  inputMouseCoordinates) ;

/// @brief Method RelativeMouseAtImpl, addr 0x2f68600, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f681e4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2f68220, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method get_main, addr 0x2f6865c, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::Display* get_main() ;

/// @brief Method get_renderingHeight, addr 0x2f68330, size 0x94, virtual false, abstract: false, final false
inline int32_t get_renderingHeight() ;

/// @brief Method get_renderingWidth, addr 0x2f68248, size 0x94, virtual false, abstract: false, final false
inline int32_t get_renderingWidth() ;

/// @brief Method get_systemHeight, addr 0x2f684ac, size 0x94, virtual false, abstract: false, final false
inline int32_t get_systemHeight() ;

/// @brief Method get_systemWidth, addr 0x2f683c4, size 0x94, virtual false, abstract: false, final false
