...
/// @brief Method .ctor, addr 0x2f85ba8, size 0x3c, virtual false, abstract: false, final false
inline void _ctor(bool  showAlpha) ;

/// @brief Method .ctor, addr 0x2f85be4, size 0x44, virtual false, abstract: false, final false
