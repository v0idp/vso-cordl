...
/// @brief Method .ctor, addr 0x2f8cd24, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  start, int32_t  length) ;

/// @brief Method get_end, addr 0x2f8cd18, size 0xc, virtual false, abstract: false, final false
