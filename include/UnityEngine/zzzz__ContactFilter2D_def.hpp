...
public:
// Declarations
/// @brief Method CheckConsistency, addr 0x2fc1f0c, size 0x3c, virtual false, abstract: false, final false
inline void CheckConsistency() ;

/// @brief Method CheckConsistency_Injected, addr 0x2fc1f48, size 0x3c, virtual false, abstract: false, final false
static inline void CheckConsistency_Injected(::ByRef<::UnityEngine::ContactFilter2D>  _unity_self) ;

/// @brief Method CreateLegacyFilter, addr 0x2fc0b58, size 0x100, virtual false, abstract: false, final false
static inline ::UnityEngine::ContactFilter2D CreateLegacyFilter(int32_t  layerMask, float_t  minDepth, float_t  maxDepth) ;

/// @brief Method SetDepth, addr 0x2fc1f94, size 0x48, virtual false, abstract: false, final false
inline void SetDepth(float_t  minDepth, float_t  maxDepth) ;

/// @brief Method SetLayerMask, addr 0x2fc1f84, size 0x10, virtual false, abstract: false, final false
