...
/// @brief Method Cleanup, addr 0x2f7d95c, size 0x3c, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Equals, addr 0x2f7dcec, size 0x10c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method Equals, addr 0x2f7ddf8, size 0xc8, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Gradient*  other) ;

/// @brief Method Evaluate, addr 0x2f7dadc, size 0x68, virtual false, abstract: false, final false
inline ::UnityEngine::Color Evaluate(float_t  time) ;

/// @brief Method Evaluate_Injected, addr 0x2f7db44, size 0x54, virtual false, abstract: false, final false
inline void Evaluate_Injected(float_t  time, ::ByRef<::UnityEngine::Color>  ret) ;

/// @brief Method Finalize, addr 0x2f7da24, size 0xb8, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetHashCode, addr 0x2f7dec0, size 0xc, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method Init, addr 0x2f7d934, size 0x28, virtual false, abstract: false, final false
static inline ::System::IntPtr Init() ;

/// @brief Method Internal_Equals, addr 0x2f7d998, size 0x44, virtual false, abstract: false, final false
inline bool Internal_Equals(::System::IntPtr  other) ;

static inline ::UnityEngine::Gradient* New_ctor() ;

/// @brief Method SetKeys, addr 0x2f7dc98, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f7d9dc, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_alphaKeys, addr 0x2f7dc18, size 0x3c, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::GradientAlphaKey,::Array<::UnityEngine::GradientAlphaKey>*> get_alphaKeys() ;

/// @brief Method get_colorKeys, addr 0x2f7db98, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method set_alphaKeys, addr 0x2f7dc54, size 0x44, virtual false, abstract: false, final false
inline void set_alphaKeys(::ArrayW<::UnityEngine::GradientAlphaKey,::Array<::UnityEngine::GradientAlphaKey>*>  value) ;

/// @brief Method set_colorKeys, addr 0x2f7dbd4, size 0x44, virtual false, abstract: false, final false
