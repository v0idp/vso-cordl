...
/// @brief Method AreEqual, addr 0x2fa7f58, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method AreEqual, addr 0x2fa84f4, size 0x8c, virtual false, abstract: false, final false
static inline void AreEqual(int32_t  expected, int32_t  actual) ;

/// @brief Method Fail, addr 0x2fa7ba4, size 0x120, virtual false, abstract: false, final false
static inline void Fail(::StringW  message, ::StringW  userMessage) ;

/// @brief Method IsFalse, addr 0x2fa7ed8, size 0x80, virtual false, abstract: false, final false
static inline void IsFalse(bool  condition, ::StringW  message) ;

/// @brief Method IsNotNull, addr 0x2fa8438, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method IsNull, addr 0x2fa8214, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method IsTrue, addr 0x2fa7d38, size 0x6c, virtual false, abstract: false, final false
static inline void IsTrue(bool  condition) ;

/// @brief Method IsTrue, addr 0x2fa7da4, size 0x80, virtual false, abstract: false, final false
