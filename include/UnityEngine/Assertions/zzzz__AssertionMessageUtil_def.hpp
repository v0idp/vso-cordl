...
public:
// Declarations
/// @brief Method BooleanFailureMessage, addr 0x2fa7e24, size 0xb4, virtual false, abstract: false, final false
static inline ::StringW BooleanFailureMessage(bool  expected) ;

/// @brief Method GetEqualityMessage, addr 0x2fa8020, size 0x1f4, virtual false, abstract: false, final false
static inline ::StringW GetEqualityMessage(::System::Object*  actual, ::System::Object*  expected, bool  expectEqual) ;

/// @brief Method GetMessage, addr 0x2fa8640, size 0xec, virtual false, abstract: false, final false
static inline ::StringW GetMessage(::StringW  failureMessage) ;

/// @brief Method GetMessage, addr 0x2fa872c, size 0x158, virtual false, abstract: false, final false
static inline ::StringW GetMessage(::StringW  failureMessage, ::StringW  expected) ;

/// @brief Method NullFailureMessage, addr 0x2fa82d0, size 0x168, virtual false, abstract: false, final false
