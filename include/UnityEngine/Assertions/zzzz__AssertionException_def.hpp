...
/// @brief Method .ctor, addr 0x2fa7cc4, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::StringW  message, ::StringW  userMessage) ;

/// @brief Method get_Message, addr 0x2fa85cc, size 0x74, virtual true, abstract: false, final false
