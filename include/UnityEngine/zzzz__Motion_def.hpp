...
/// @brief Method .ctor, addr 0x2f52e20, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isLooping, addr 0x2f53bec, size 0x3c, virtual false, abstract: false, final false
