...
public:
// Declarations
/// @brief Method Invoke, addr 0x2f4bdb8, size 0x14, virtual true, abstract: false, final false
inline void Invoke() ;

static inline ::UnityEngine::AndroidJavaRunnable* New_ctor(::System::Object*  object, ::System::IntPtr  method) ;

/// @brief Method .ctor, addr 0x2f4bd30, size 0x88, virtual false, abstract: false, final false
