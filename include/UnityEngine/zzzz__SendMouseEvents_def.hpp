...
public:
// Declarations
/// @brief Method Compare, addr 0x2fbf03c, size 0xb4, virtual false, abstract: false, final false
static inline bool Compare(::UnityEngine::SendMouseEvents_HitInfo  lhs, ::UnityEngine::SendMouseEvents_HitInfo  rhs) ;

/// @brief Method SendMessage, addr 0x2fbf018, size 0x24, virtual false, abstract: false, final false
inline void SendMessage(::StringW  name) ;

/// @brief Method op_Implicit, addr 0x2fbef78, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method DoSendMouseEvents, addr 0x2fbe1e8, size 0x968, virtual false, abstract: false, final false
static inline void DoSendMouseEvents(int32_t  skipRTCameras) ;

/// @brief Method SendEvents, addr 0x2fbeb50, size 0x428, virtual false, abstract: false, final false
static inline void SendEvents(int32_t  i, ::UnityEngine::SendMouseEvents_HitInfo  hit) ;

/// @brief Method SetMouseMoved, addr 0x2fbe18c, size 0x5c, virtual false, abstract: false, final false
static inline void SetMouseMoved() ;

/// @brief Method UpdateMouse, addr 0x2fbdfc8, size 0x1c4, virtual false, abstract: false, final false
