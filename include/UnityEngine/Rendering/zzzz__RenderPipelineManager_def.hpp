...
/// @brief Method CleanupRenderPipeline, addr 0x2f9f288, size 0x1b4, virtual false, abstract: false, final false
static inline void CleanupRenderPipeline() ;

/// @brief Method DoRenderLoop_Internal, addr 0x2f9fb58, size 0x284, virtual false, abstract: false, final false
...
/// @brief Method GetCurrentPipelineAssetType, addr 0x2f9fb00, size 0x58, virtual false, abstract: false, final false
static inline ::StringW GetCurrentPipelineAssetType() ;

/// @brief Method HandleRenderPipelineChange, addr 0x2f9f9a0, size 0x80, virtual false, abstract: false, final false
static inline void HandleRenderPipelineChange(::UnityEngine::Rendering::RenderPipelineAsset*  pipelineAsset) ;

/// @brief Method IsPipelineRequireCreation, addr 0x2f9fe9c, size 0x148, virtual false, abstract: false, final false
static inline bool IsPipelineRequireCreation() ;

/// @brief Method OnActiveRenderPipelineAssetChanged, addr 0x2f9f894, size 0x10c, virtual false, abstract: false, final false
static inline void OnActiveRenderPipelineAssetChanged(::UnityEngine::ScriptableObject*  from, ::UnityEngine::ScriptableObject*  to) ;

/// @brief Method OnActiveRenderPipelineTypeChanged, addr 0x2f9f820, size 0x74, virtual false, abstract: false, final false
static inline void OnActiveRenderPipelineTypeChanged() ;

/// @brief Method PrepareRenderPipeline, addr 0x2f9f43c, size 0xb4, virtual false, abstract: false, final false
static inline void PrepareRenderPipeline(::UnityEngine::Rendering::RenderPipelineAsset*  pipelineAsset) ;

/// @brief Method add_beginCameraRendering, addr 0x2f9f638, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method get_currentPipeline, addr 0x2f9f540, size 0x58, virtual false, abstract: false, final false
static inline ::UnityEngine::Rendering::RenderPipeline* get_currentPipeline() ;

/// @brief Method remove_beginCameraRendering, addr 0x2f9f72c, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method set_currentPipeline, addr 0x2f9f598, size 0xa0, virtual false, abstract: false, final false
