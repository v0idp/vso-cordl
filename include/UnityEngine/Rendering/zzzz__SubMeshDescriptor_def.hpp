...
/// @brief Method ToString, addr 0x2f9d1ac, size 0x29c, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2f9d10c, size 0x18, virtual false, abstract: false, final false
inline void _ctor(int32_t  indexStart, int32_t  indexCount, ::UnityEngine::MeshTopology  topology) ;

/// @brief Method get_baseVertex, addr 0x2f9d17c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_baseVertex() ;

/// @brief Method get_bounds, addr 0x2f9d124, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Bounds get_bounds() ;

/// @brief Method get_firstVertex, addr 0x2f9d18c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_firstVertex() ;

/// @brief Method get_indexCount, addr 0x2f9d16c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_indexCount() ;

/// @brief Method get_indexStart, addr 0x2f9d15c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_indexStart() ;

/// @brief Method get_topology, addr 0x2f9d14c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::MeshTopology get_topology() ;

/// @brief Method get_vertexCount, addr 0x2f9d19c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_vertexCount() ;

/// @brief Method set_baseVertex, addr 0x2f9d184, size 0x8, virtual false, abstract: false, final false
inline void set_baseVertex(int32_t  value) ;

/// @brief Method set_bounds, addr 0x2f9d138, size 0x14, virtual false, abstract: false, final false
inline void set_bounds(::UnityEngine::Bounds  value) ;

/// @brief Method set_firstVertex, addr 0x2f9d194, size 0x8, virtual false, abstract: false, final false
inline void set_firstVertex(int32_t  value) ;

/// @brief Method set_indexCount, addr 0x2f9d174, size 0x8, virtual false, abstract: false, final false
inline void set_indexCount(int32_t  value) ;

/// @brief Method set_indexStart, addr 0x2f9d164, size 0x8, virtual false, abstract: false, final false
inline void set_indexStart(int32_t  value) ;

/// @brief Method set_topology, addr 0x2f9d154, size 0x8, virtual false, abstract: false, final false
inline void set_topology(::UnityEngine::MeshTopology  value) ;

/// @brief Method set_vertexCount, addr 0x2f9d1a4, size 0x8, virtual false, abstract: false, final false
