...
/// @brief Method Equals, addr 0x2f9dca8, size 0x90, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x2f9dc10, size 0x98, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::RenderTargetIdentifier  rhs) ;

/// @brief Method GetHashCode, addr 0x2f9dbc4, size 0x4c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x2f9d91c, size 0x2a8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2f9d79c, size 0x114, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Texture*  tex) ;

/// @brief Method .ctor, addr 0x2f9d77c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x2f9d8d4, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method op_Implicit, addr 0x2f9d8b0, size 0x24, virtual false, abstract: false, final false
