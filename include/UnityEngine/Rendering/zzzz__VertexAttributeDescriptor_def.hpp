...
/// @brief Method Equals, addr 0x2f9d690, size 0xa8, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  other) ;

/// @brief Method Equals, addr 0x2f9d738, size 0x44, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::Rendering::VertexAttributeDescriptor  other) ;

/// @brief Method GetHashCode, addr 0x2f9d668, size 0x28, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method ToString, addr 0x2f9d494, size 0x1d4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x2f9d488, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_attribute, addr 0x2f9d448, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::VertexAttribute get_attribute() ;

/// @brief Method get_dimension, addr 0x2f9d468, size 0x8, virtual false, abstract: false, final false
inline int32_t get_dimension() ;

/// @brief Method get_format, addr 0x2f9d458, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Rendering::VertexAttributeFormat get_format() ;

/// @brief Method get_stream, addr 0x2f9d478, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_attribute, addr 0x2f9d450, size 0x8, virtual false, abstract: false, final false
inline void set_attribute(::UnityEngine::Rendering::VertexAttribute  value) ;

/// @brief Method set_dimension, addr 0x2f9d470, size 0x8, virtual false, abstract: false, final false
inline void set_dimension(int32_t  value) ;

/// @brief Method set_format, addr 0x2f9d460, size 0x8, virtual false, abstract: false, final false
inline void set_format(::UnityEngine::Rendering::VertexAttributeFormat  value) ;

/// @brief Method set_stream, addr 0x2f9d480, size 0x8, virtual false, abstract: false, final false
