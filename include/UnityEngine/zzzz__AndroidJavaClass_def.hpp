...
/// @brief Method _AndroidJavaClass, addr 0x2f4fec4, size 0xbc, virtual false, abstract: false, final false
inline void _AndroidJavaClass(::StringW  className) ;

/// @brief Method .ctor, addr 0x2f4c510, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  className) ;

/// @brief Method .ctor, addr 0x2f4f954, size 0xc4, virtual false, abstract: false, final false
