...
/// @brief Method .ctor, addr 0x318107c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Dependencies UnityEngine.Color, UnityEngine.UI.CoroutineTween.ColorTween::ColorTweenMode, UnityEngine.UI.CoroutineTween.ITweenValue
namespace UnityEngine::UI::CoroutineTween {
// Is value type: true
...
/// @brief Method AddOnChangedCallback, addr 0x3180ff4, size 0x88, virtual false, abstract: false, final false
inline void AddOnChangedCallback(::UnityEngine::Events::UnityAction_1<::UnityEngine::Color>*  callback) ;

/// @brief Method GetDuration, addr 0x31810cc, size 0x8, virtual false, abstract: false, final false
inline float_t GetDuration() ;

/// @brief Method GetIgnoreTimescale, addr 0x31810c4, size 0x8, virtual false, abstract: false, final false
inline bool GetIgnoreTimescale() ;

/// @brief Method TweenValue, addr 0x3180f08, size 0xdc, virtual true, abstract: false, final true
inline void TweenValue(float_t  floatPercentage) ;

/// @brief Method ValidTarget, addr 0x3180fe4, size 0x10, virtual true, abstract: false, final true
inline bool ValidTarget() ;

/// @brief Method get_duration, addr 0x3180ee4, size 0x8, virtual true, abstract: false, final true
inline float_t get_duration() ;

/// @brief Method get_ignoreTimeScale, addr 0x3180ef4, size 0x8, virtual true, abstract: false, final true
inline bool get_ignoreTimeScale() ;

/// @brief Method get_startColor, addr 0x3180ea4, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_startColor() ;

/// @brief Method get_targetColor, addr 0x3180ebc, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_targetColor() ;

/// @brief Method get_tweenMode, addr 0x3180ed4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_duration, addr 0x3180eec, size 0x8, virtual false, abstract: false, final false
inline void set_duration(float_t  value) ;

/// @brief Method set_ignoreTimeScale, addr 0x3180efc, size 0xc, virtual false, abstract: false, final false
inline void set_ignoreTimeScale(bool  value) ;

/// @brief Method set_startColor, addr 0x3180eb0, size 0xc, virtual false, abstract: false, final false
inline void set_startColor(::UnityEngine::Color  value) ;

/// @brief Method set_targetColor, addr 0x3180ec8, size 0xc, virtual false, abstract: false, final false
inline void set_targetColor(::UnityEngine::Color  value) ;

/// @brief Method set_tweenMode, addr 0x3180edc, size 0x8, virtual false, abstract: false, final false
