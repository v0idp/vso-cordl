...
/// @brief Method GetModifiedMaterial, addr 0x316c708, size 0x294, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> GetModifiedMaterial(::UnityEngine::Material*  baseMaterial) ;

/// @brief Method IsRaycastLocationValid, addr 0x316c65c, size 0xac, virtual true, abstract: false, final false
inline bool IsRaycastLocationValid(::UnityEngine::Vector2  sp, ::UnityEngine::Camera*  eventCamera) ;

/// @brief Method MaskEnabled, addr 0x316c034, size 0x90, virtual true, abstract: false, final false
inline bool MaskEnabled() ;

static inline ::UnityEngine::UI::Mask* New_ctor() ;

/// @brief Method OnDisable, addr 0x316c498, size 0x1c4, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x316c0c8, size 0x160, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnSiblingGraphicEnabledDisabled, addr 0x316c0c4, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x316c024, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_graphic, addr 0x316bfcc, size 0x58, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Graphic> get_graphic() ;

/// @brief Method get_rectTransform, addr 0x316bebc, size 0x58, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_showMaskGraphic, addr 0x316bf14, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_showMaskGraphic, addr 0x316bf1c, size 0xb0, virtual false, abstract: false, final false
