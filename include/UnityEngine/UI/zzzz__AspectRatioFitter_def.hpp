...
// Dependencies UnityEngine.DrivenRectTransformTracker, UnityEngine.EventSystems.UIBehaviour, UnityEngine.UI.AspectRatioFitter::AspectMode, UnityEngine.UI.ILayoutController, UnityEngine.UI.ILayoutSelfController
namespace UnityEngine::UI {
// Is value type: false
...
/// @brief Method DoesParentExists, addr 0x3165844, size 0x8, virtual false, abstract: false, final false
inline bool DoesParentExists() ;

/// @brief Method GetParentSize, addr 0x3165650, size 0xf8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 GetParentSize() ;

/// @brief Method GetSizeDeltaToProduceSize, addr 0x3165748, size 0xf4, virtual false, abstract: false, final false
inline float_t GetSizeDeltaToProduceSize(float_t  size, int32_t  axis) ;

/// @brief Method IsAspectModeValid, addr 0x3164e10, size 0x28, virtual false, abstract: false, final false
inline bool IsAspectModeValid() ;

/// @brief Method IsComponentValidOnObject, addr 0x3164d44, size 0xcc, virtual false, abstract: false, final false
inline bool IsComponentValidOnObject() ;

static inline ::UnityEngine::UI::AspectRatioFitter* New_ctor() ;

/// @brief Method OnDisable, addr 0x3164e38, size 0x7c, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3164c5c, size 0x98, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x3165360, size 0x4, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnTransformParentChanged, addr 0x31652b4, size 0x98, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method SetDirty, addr 0x3164b38, size 0x4, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method SetLayoutHorizontal, addr 0x316583c, size 0x4, virtual true, abstract: false, final false
inline void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical, addr 0x3165840, size 0x4, virtual true, abstract: false, final false
inline void SetLayoutVertical() ;

/// @brief Method Start, addr 0x3164cf4, size 0x50, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x316534c, size 0x14, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateRect, addr 0x3165364, size 0x2ec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3164c4c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_aspectMode, addr 0x3164abc, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::AspectRatioFitter_AspectMode get_aspectMode() ;

/// @brief Method get_aspectRatio, addr 0x3164b3c, size 0x8, virtual false, abstract: false, final false
inline float_t get_aspectRatio() ;

/// @brief Method get_rectTransform, addr 0x3164bb8, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method set_aspectMode, addr 0x3164ac4, size 0x74, virtual false, abstract: false, final false
inline void set_aspectMode(::UnityEngine::UI::AspectRatioFitter_AspectMode  value) ;

/// @brief Method set_aspectRatio, addr 0x3164b44, size 0x74, virtual false, abstract: false, final false
