...
/// @brief Method Equals, addr 0x316eaf4, size 0x118, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UI::Navigation  other) ;

/// @brief Method get_defaultNavigation, addr 0x316ead4, size 0x20, virtual false, abstract: false, final false
static inline ::UnityEngine::UI::Navigation get_defaultNavigation() ;

/// @brief Method get_mode, addr 0x316ea70, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Navigation_Mode get_mode() ;

/// @brief Method get_selectOnDown, addr 0x316eaa4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> get_selectOnDown() ;

/// @brief Method get_selectOnLeft, addr 0x316eab4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> get_selectOnLeft() ;

/// @brief Method get_selectOnRight, addr 0x316eac4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> get_selectOnRight() ;

/// @brief Method get_selectOnUp, addr 0x316ea94, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> get_selectOnUp() ;

/// @brief Method get_wrapAround, addr 0x316ea80, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_mode, addr 0x316ea78, size 0x8, virtual false, abstract: false, final false
inline void set_mode(::UnityEngine::UI::Navigation_Mode  value) ;

/// @brief Method set_selectOnDown, addr 0x316eaac, size 0x8, virtual false, abstract: false, final false
inline void set_selectOnDown(::UnityEngine::UI::Selectable*  value) ;

/// @brief Method set_selectOnLeft, addr 0x316eabc, size 0x8, virtual false, abstract: false, final false
inline void set_selectOnLeft(::UnityEngine::UI::Selectable*  value) ;

/// @brief Method set_selectOnRight, addr 0x316eacc, size 0x8, virtual false, abstract: false, final false
inline void set_selectOnRight(::UnityEngine::UI::Selectable*  value) ;

/// @brief Method set_selectOnUp, addr 0x316ea9c, size 0x8, virtual false, abstract: false, final false
inline void set_selectOnUp(::UnityEngine::UI::Selectable*  value) ;

/// @brief Method set_wrapAround, addr 0x316ea88, size 0xc, virtual false, abstract: false, final false
