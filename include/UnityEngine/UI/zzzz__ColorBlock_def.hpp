...
/// @brief Method Equals, addr 0x3004db8, size 0xc0, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x3004e78, size 0x1f8, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UI::ColorBlock  other) ;

/// @brief Method GetHashCode, addr 0x300519c, size 0x6c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

static inline ::UnityEngine::UI::ColorBlock getStaticF_defaultColorBlock() ;

/// @brief Method get_colorMultiplier, addr 0x3004d20, size 0x8, virtual false, abstract: false, final false
inline float_t get_colorMultiplier() ;

/// @brief Method get_disabledColor, addr 0x3004d08, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_disabledColor() ;

/// @brief Method get_fadeDuration, addr 0x3004d30, size 0x8, virtual false, abstract: false, final false
inline float_t get_fadeDuration() ;

/// @brief Method get_highlightedColor, addr 0x3004cc0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_highlightedColor() ;

/// @brief Method get_normalColor, addr 0x3004ca8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_normalColor() ;

/// @brief Method get_pressedColor, addr 0x3004cd8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_pressedColor() ;

/// @brief Method get_selectedColor, addr 0x3004cf0, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x3005070, size 0x94, virtual false, abstract: false, final false
static inline bool op_Equality(::UnityEngine::UI::ColorBlock  point1, ::UnityEngine::UI::ColorBlock  point2) ;

/// @brief Method op_Inequality, addr 0x3005104, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method set_colorMultiplier, addr 0x3004d28, size 0x8, virtual false, abstract: false, final false
inline void set_colorMultiplier(float_t  value) ;

/// @brief Method set_disabledColor, addr 0x3004d14, size 0xc, virtual false, abstract: false, final false
inline void set_disabledColor(::UnityEngine::Color  value) ;

/// @brief Method set_fadeDuration, addr 0x3004d38, size 0x8, virtual false, abstract: false, final false
inline void set_fadeDuration(float_t  value) ;

/// @brief Method set_highlightedColor, addr 0x3004ccc, size 0xc, virtual false, abstract: false, final false
inline void set_highlightedColor(::UnityEngine::Color  value) ;

/// @brief Method set_normalColor, addr 0x3004cb4, size 0xc, virtual false, abstract: false, final false
inline void set_normalColor(::UnityEngine::Color  value) ;

/// @brief Method set_pressedColor, addr 0x3004ce4, size 0xc, virtual false, abstract: false, final false
inline void set_pressedColor(::UnityEngine::Color  value) ;

/// @brief Method set_selectedColor, addr 0x3004cfc, size 0xc, virtual false, abstract: false, final false
