...
/// @brief Method CleanInvalidItems, addr 0x3003554, size 0x2e4, virtual false, abstract: false, final false
inline void CleanInvalidItems() ;

/// @brief Method DisableCanvasElementForRebuild, addr 0x3004824, size 0x70, virtual false, abstract: false, final false
static inline void DisableCanvasElementForRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalDisableCanvasElementForGraphicRebuild, addr 0x30049f8, size 0x164, virtual false, abstract: false, final false
inline void InternalDisableCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalDisableCanvasElementForLayoutRebuild, addr 0x3004894, size 0x164, virtual false, abstract: false, final false
inline void InternalDisableCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalRegisterCanvasElementForGraphicRebuild, addr 0x30043bc, size 0xd0, virtual false, abstract: false, final false
inline bool InternalRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalRegisterCanvasElementForLayoutRebuild, addr 0x3004264, size 0x98, virtual false, abstract: false, final false
inline bool InternalRegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalUnRegisterCanvasElementForGraphicRebuild, addr 0x30046c0, size 0x164, virtual false, abstract: false, final false
inline void InternalUnRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method InternalUnRegisterCanvasElementForLayoutRebuild, addr 0x300455c, size 0x164, virtual false, abstract: false, final false
inline void InternalUnRegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method IsRebuildingGraphics, addr 0x3004bb8, size 0x5c, virtual false, abstract: false, final false
static inline bool IsRebuildingGraphics() ;

/// @brief Method IsRebuildingLayout, addr 0x3004b5c, size 0x5c, virtual false, abstract: false, final false
static inline bool IsRebuildingLayout() ;

static inline ::UnityEngine::UI::CanvasUpdateRegistry* New_ctor() ;

/// @brief Method ObjectValidForUpdate, addr 0x3003484, size 0xd0, virtual false, abstract: false, final false
inline bool ObjectValidForUpdate(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method ParentCount, addr 0x3003ff8, size 0xbc, virtual false, abstract: false, final false
static inline int32_t ParentCount(::UnityEngine::Transform*  child) ;

/// @brief Method PerformUpdate, addr 0x3003838, size 0x640, virtual false, abstract: false, final false
inline void PerformUpdate() ;

/// @brief Method RegisterCanvasElementForGraphicRebuild, addr 0x300435c, size 0x60, virtual false, abstract: false, final false
static inline void RegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method RegisterCanvasElementForLayoutRebuild, addr 0x3004204, size 0x60, virtual false, abstract: false, final false
static inline void RegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method SortLayoutList, addr 0x30040b4, size 0x150, virtual false, abstract: false, final false
static inline int32_t SortLayoutList(::UnityEngine::UI::ICanvasElement*  x, ::UnityEngine::UI::ICanvasElement*  y) ;

/// @brief Method TryRegisterCanvasElementForGraphicRebuild, addr 0x300448c, size 0x60, virtual false, abstract: false, final false
static inline bool TryRegisterCanvasElementForGraphicRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method TryRegisterCanvasElementForLayoutRebuild, addr 0x30042fc, size 0x60, virtual false, abstract: false, final false
static inline bool TryRegisterCanvasElementForLayoutRebuild(::UnityEngine::UI::ICanvasElement*  element) ;

/// @brief Method UnRegisterCanvasElementForRebuild, addr 0x30044ec, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3003214, size 0x1d0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_instance, addr 0x30033e4, size 0xa0, virtual false, abstract: false, final false
