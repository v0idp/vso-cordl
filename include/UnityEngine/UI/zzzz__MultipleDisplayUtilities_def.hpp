...
public:
// Declarations
/// @brief Method GetRelativeMousePositionForDrag, addr 0x316e4c4, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method GetRelativeMousePositionForRaycast, addr 0x316e99c, size 0xd4, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector3 GetRelativeMousePositionForRaycast(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method RelativeMouseAtScaled, addr 0x316e530, size 0x46c, virtual false, abstract: false, final false
