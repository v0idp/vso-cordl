...
/// @brief Method AddClippable, addr 0x31709b8, size 0x114, virtual false, abstract: false, final false
inline void AddClippable(::UnityEngine::UI::IClippable*  clippable) ;

/// @brief Method IsRaycastLocationValid, addr 0x316fccc, size 0xdc, virtual true, abstract: false, final false
...
/// @brief Method OnCanvasHierarchyChanged, addr 0x3170c90, size 0x24, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnDestroy, addr 0x316fcac, size 0x20, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x316fbdc, size 0xd0, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x316fba8, size 0x34, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x3170c6c, size 0x24, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method PerformClipping, addr 0x316fea4, size 0x81c, virtual true, abstract: false, final false
inline void PerformClipping() ;

/// @brief Method RemoveClippable, addr 0x3170acc, size 0x1a0, virtual false, abstract: false, final false
inline void RemoveClippable(::UnityEngine::UI::IClippable*  clippable) ;

/// @brief Method UpdateClipSoftness, addr 0x31706c0, size 0x2f8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x316fa44, size 0x164, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Canvas, addr 0x316f848, size 0x160, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_Canvas() ;

/// @brief Method get_canvasRect, addr 0x316f9a8, size 0x44, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_canvasRect() ;

/// @brief Method get_padding, addr 0x316f80c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_padding() ;

/// @brief Method get_rectTransform, addr 0x316f9ec, size 0x58, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_rootCanvasRect, addr 0x316fda8, size 0xfc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_rootCanvasRect() ;

/// @brief Method get_softness, addr 0x316f828, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_padding, addr 0x316f818, size 0x10, virtual false, abstract: false, final false
inline void set_padding(::UnityEngine::Vector4  value) ;

/// @brief Method set_softness, addr 0x316f830, size 0x18, virtual false, abstract: false, final false
