...
/// @brief Method .ctor, addr 0x3002dac, size 0xc8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledTrigger, addr 0x3002d9c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_disabledTrigger() ;

/// @brief Method get_highlightedTrigger, addr 0x3002d6c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_highlightedTrigger() ;

/// @brief Method get_normalTrigger, addr 0x3002d5c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_normalTrigger() ;

/// @brief Method get_pressedTrigger, addr 0x3002d7c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_pressedTrigger() ;

/// @brief Method get_selectedTrigger, addr 0x3002d8c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_selectedTrigger() ;

/// @brief Method set_disabledTrigger, addr 0x3002da4, size 0x8, virtual false, abstract: false, final false
inline void set_disabledTrigger(::StringW  value) ;

/// @brief Method set_highlightedTrigger, addr 0x3002d74, size 0x8, virtual false, abstract: false, final false
inline void set_highlightedTrigger(::StringW  value) ;

/// @brief Method set_normalTrigger, addr 0x3002d64, size 0x8, virtual false, abstract: false, final false
inline void set_normalTrigger(::StringW  value) ;

/// @brief Method set_pressedTrigger, addr 0x3002d84, size 0x8, virtual false, abstract: false, final false
inline void set_pressedTrigger(::StringW  value) ;

/// @brief Method set_selectedTrigger, addr 0x3002d94, size 0x8, virtual false, abstract: false, final false
