...
public:
// Declarations
/// @brief Method FindRootSortOverrideCanvas, addr 0x316c99c, size 0x1a0, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Transform> FindRootSortOverrideCanvas(::UnityEngine::Transform*  start) ;

/// @brief Method GetRectMaskForClippable, addr 0x316d618, size 0x414, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::UI::RectMask2D> GetRectMaskForClippable(::UnityEngine::UI::IClippable*  clippable) ;

/// @brief Method GetRectMasksForClip, addr 0x316df6c, size 0x360, virtual false, abstract: false, final false
...
/// @brief Method GetStencilDepth, addr 0x316cb3c, size 0x288, virtual false, abstract: false, final false
static inline int32_t GetStencilDepth(::UnityEngine::Transform*  transform, ::UnityEngine::Transform*  stopAfter) ;

/// @brief Method IsDescendantOrSelf, addr 0x316de14, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method Notify2DMaskStateChanged, addr 0x316dbb8, size 0x25c, virtual false, abstract: false, final false
static inline void Notify2DMaskStateChanged(::UnityEngine::Component*  mask) ;

/// @brief Method NotifyStencilStateChanged, addr 0x316c240, size 0x258, virtual false, abstract: false, final false
static inline void NotifyStencilStateChanged(::UnityEngine::Component*  mask) ;

/// @brief Method .ctor, addr 0x316e2cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
