...
public:
// Declarations
/// @brief Method CalculateLayoutInputHorizontal, addr 0x3167990, size 0x20, virtual true, abstract: false, final false
inline void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical, addr 0x3167c50, size 0xc, virtual true, abstract: false, final false
inline void CalculateLayoutInputVertical() ;

static inline ::UnityEngine::UI::HorizontalLayoutGroup* New_ctor() ;

/// @brief Method SetLayoutHorizontal, addr 0x3167c5c, size 0xc, virtual true, abstract: false, final false
inline void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical, addr 0x31682b8, size 0xc, virtual true, abstract: false, final false
inline void SetLayoutVertical() ;

/// @brief Method .ctor, addr 0x3167978, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
