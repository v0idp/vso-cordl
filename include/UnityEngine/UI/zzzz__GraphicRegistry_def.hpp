...
/// @brief Method DisableGraphicForCanvas, addr 0x300f024, size 0x180, virtual false, abstract: false, final false
static inline void DisableGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method DisableRaycastGraphicForCanvas, addr 0x30126ac, size 0x180, virtual false, abstract: false, final false
static inline void DisableRaycastGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method GetGraphicsForCanvas, addr 0x301282c, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method GetRaycastableGraphicsForCanvas, addr 0x3011c40, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method RegisterGraphicForCanvas, addr 0x300e78c, size 0x1ec, virtual false, abstract: false, final false
static inline void RegisterGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method RegisterRaycastGraphicForCanvas, addr 0x300dc40, size 0x1ec, virtual false, abstract: false, final false
static inline void RegisterRaycastGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method UnregisterGraphicForCanvas, addr 0x300e3c4, size 0x1a4, virtual false, abstract: false, final false
static inline void UnregisterGraphicForCanvas(::UnityEngine::Canvas*  c, ::UnityEngine::UI::Graphic*  graphic) ;

/// @brief Method UnregisterRaycastGraphicForCanvas, addr 0x300dac4, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3012464, size 0x1a8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_instance, addr 0x301260c, size 0xa0, virtual false, abstract: false, final false
