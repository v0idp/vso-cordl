...
/// @brief Method <Raycast>b__27_0, addr 0x301241c, size 0x48, virtual false, abstract: false, final false
inline int32_t _Raycast_b__27_0(::UnityEngine::UI::Graphic*  g1, ::UnityEngine::UI::Graphic*  g2) ;

/// @brief Method .ctor, addr 0x3012414, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Raycast, addr 0x3011cfc, size 0x568, virtual false, abstract: false, final false
...
/// @brief Method Raycast, addr 0x3011028, size 0xc18, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3010f94, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::UI::Graphic>>* getStaticF_s_SortedGraphics() ;

/// @brief Method get_blockingMask, addr 0x3010f84, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_blockingMask() ;

/// @brief Method get_blockingObjects, addr 0x3010f74, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::GraphicRaycaster_BlockingObjects get_blockingObjects() ;

/// @brief Method get_canvas, addr 0x3010e78, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_canvas() ;

/// @brief Method get_eventCamera, addr 0x3012264, size 0xc8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Camera> get_eventCamera() ;

/// @brief Method get_ignoreReversedGraphics, addr 0x3010f60, size 0x8, virtual false, abstract: false, final false
inline bool get_ignoreReversedGraphics() ;

/// @brief Method get_renderOrderPriority, addr 0x3010f0c, size 0x54, virtual true, abstract: false, final false
inline int32_t get_renderOrderPriority() ;

/// @brief Method get_sortOrderPriority, addr 0x3010e30, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method set_blockingMask, addr 0x3010f8c, size 0x8, virtual false, abstract: false, final false
inline void set_blockingMask(::UnityEngine::LayerMask  value) ;

/// @brief Method set_blockingObjects, addr 0x3010f7c, size 0x8, virtual false, abstract: false, final false
inline void set_blockingObjects(::UnityEngine::UI::GraphicRaycaster_BlockingObjects  value) ;

/// @brief Method set_ignoreReversedGraphics, addr 0x3010f68, size 0xc, virtual false, abstract: false, final false
