...
/// @brief Method .ctor, addr 0x317110c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x3172a60, size 0x258, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::UnityEngine::UI::Scrollbar__ClickRepeat_d__58* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3172cb8, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x3172cc0, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3172cf8, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x3172a5c, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3172188, size 0x28, virtual false, abstract: false, final false
...
// Dependencies UnityEngine.DrivenRectTransformTracker, UnityEngine.EventSystems.IBeginDragHandler, UnityEngine.EventSystems.IDragHandler, UnityEngine.EventSystems.IEventSystemHandler, UnityEngine.EventSystems.IInitializePotentialDragHandler, UnityEngine.UI.ICanvasElement, UnityEngine.UI.Scrollbar::Direction, UnityEngine.UI.Selectable, UnityEngine.Vector2
namespace UnityEngine::UI {
// Is value type: false
...
/// @brief Method ClickRepeat, addr 0x3172148, size 0x40, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* ClickRepeat(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method ClickRepeat, addr 0x31720c4, size 0x84, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* ClickRepeat(::UnityEngine::Vector2  screenPosition, ::UnityEngine::Camera*  camera) ;

/// @brief Method DoUpdateDrag, addr 0x3171c04, size 0x68, virtual false, abstract: false, final false
inline void DoUpdateDrag(::UnityEngine::Vector2  handleCorner, float_t  remainingSize) ;

/// @brief Method FindSelectableOnDown, addr 0x31727b8, size 0x24, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnDown() ;

/// @brief Method FindSelectableOnLeft, addr 0x31724c4, size 0x24, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnLeft() ;

/// @brief Method FindSelectableOnRight, addr 0x31725c0, size 0x24, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnRight() ;

/// @brief Method FindSelectableOnUp, addr 0x31726bc, size 0x24, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnUp() ;

/// @brief Method GraphicUpdateComplete, addr 0x3171550, size 0x4, virtual true, abstract: false, final false
inline void GraphicUpdateComplete() ;

/// @brief Method LayoutComplete, addr 0x317154c, size 0x4, virtual true, abstract: false, final false
inline void LayoutComplete() ;

/// @brief Method MayDrag, addr 0x3171c6c, size 0x64, virtual false, abstract: false, final false
inline bool MayDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

static inline ::UnityEngine::UI::Scrollbar* New_ctor() ;

/// @brief Method OnBeginDrag, addr 0x3171cd0, size 0x1b4, virtual true, abstract: false, final false
inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnDisable, addr 0x317183c, size 0x20, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnDrag, addr 0x3171e84, size 0x90, virtual true, abstract: false, final false
inline void OnDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnEnable, addr 0x3171554, size 0x30, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnInitializePotentialDrag, addr 0x31728b4, size 0x18, virtual true, abstract: false, final false
inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnMove, addr 0x31721f0, size 0x248, virtual true, abstract: false, final false
inline void OnMove(::UnityEngine::EventSystems::AxisEventData*  eventData) ;

/// @brief Method OnPointerDown, addr 0x3171f14, size 0x80, virtual true, abstract: false, final false
inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnPointerUp, addr 0x31721b0, size 0x18, virtual true, abstract: false, final false
inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x3171998, size 0x38, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method Rebuild, addr 0x3171548, size 0x4, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  executing) ;

/// @brief Method Set, addr 0x3171328, size 0xc4, virtual false, abstract: false, final false
inline void Set(float_t  input, bool  sendCallback) ;

/// @brief Method SetDirection, addr 0x31728cc, size 0x188, virtual false, abstract: false, final false
inline void SetDirection(::UnityEngine::UI::Scrollbar_Direction  direction, bool  includeRectLayouts) ;

/// @brief Method SetValueWithoutNotify, addr 0x31713ec, size 0x8, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(float_t  input) ;

/// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x3172a54, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform() ;

/// @brief Method Update, addr 0x3171984, size 0x14, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateCachedReferences, addr 0x3170d38, size 0xe0, virtual false, abstract: false, final false
inline void UpdateCachedReferences() ;

/// @brief Method UpdateDrag, addr 0x31719f4, size 0x210, virtual false, abstract: false, final false
inline void UpdateDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method UpdateVisuals, addr 0x3170e18, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x317104c, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_axis, addr 0x31719d0, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Scrollbar_Axis get_axis() ;

/// @brief Method get_direction, addr 0x3170fd0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Scrollbar_Direction get_direction() ;

/// @brief Method get_handleRect, addr 0x3170cb4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_handleRect() ;

/// @brief Method get_numberOfSteps, addr 0x3171480, size 0x8, virtual false, abstract: false, final false
inline int32_t get_numberOfSteps() ;

/// @brief Method get_onValueChanged, addr 0x317150c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Scrollbar_ScrollEvent* get_onValueChanged() ;

/// @brief Method get_reverseValue, addr 0x31719e0, size 0x14, virtual false, abstract: false, final false
inline bool get_reverseValue() ;

/// @brief Method get_size, addr 0x31713f4, size 0x8, virtual false, abstract: false, final false
inline float_t get_size() ;

/// @brief Method get_stepSize, addr 0x317151c, size 0x2c, virtual false, abstract: false, final false
inline float_t get_stepSize() ;

/// @brief Method get_value, addr 0x3171268, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method set_direction, addr 0x3170fd8, size 0x74, virtual false, abstract: false, final false
inline void set_direction(::UnityEngine::UI::Scrollbar_Direction  value) ;

/// @brief Method set_handleRect, addr 0x3170cbc, size 0x7c, virtual false, abstract: false, final false
inline void set_handleRect(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_numberOfSteps, addr 0x3171488, size 0x84, virtual false, abstract: false, final false
inline void set_numberOfSteps(int32_t  value) ;

/// @brief Method set_onValueChanged, addr 0x3171514, size 0x8, virtual false, abstract: false, final false
inline void set_onValueChanged(::UnityEngine::UI::Scrollbar_ScrollEvent*  value) ;

/// @brief Method set_size, addr 0x31713fc, size 0x84, virtual false, abstract: false, final false
inline void set_size(float_t  value) ;

/// @brief Method set_value, addr 0x3171320, size 0x8, virtual false, abstract: false, final false
