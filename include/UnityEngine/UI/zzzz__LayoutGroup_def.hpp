...
/// @brief Method MoveNext, addr 0x316975c, size 0x88, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::UnityEngine::UI::LayoutGroup__DelayedSetDirty_d__56* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x31697e4, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x31697ec, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3169824, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x3169758, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3169730, size 0x28, virtual false, abstract: false, final false
...
// Dependencies UnityEngine.DrivenRectTransformTracker, UnityEngine.EventSystems.UIBehaviour, UnityEngine.TextAnchor, UnityEngine.UI.ILayoutController, UnityEngine.UI.ILayoutElement, UnityEngine.UI.ILayoutGroup, UnityEngine.Vector2
namespace UnityEngine::UI {
// Is value type: false
...
/// @brief Method CalculateLayoutInputHorizontal, addr 0x3166910, size 0x3b8, virtual true, abstract: false, final false
...
/// @brief Method DelayedSetDirty, addr 0x31696d0, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* DelayedSetDirty(::UnityEngine::RectTransform*  rectTransform) ;

/// @brief Method GetAlignmentOnAxis, addr 0x31686f8, size 0x4c, virtual false, abstract: false, final false
inline float_t GetAlignmentOnAxis(int32_t  axis) ;

/// @brief Method GetStartOffset, addr 0x3167780, size 0x148, virtual false, abstract: false, final false
inline float_t GetStartOffset(int32_t  axis, float_t  requiredSpaceWithoutPadding) ;

/// @brief Method GetTotalFlexibleSize, addr 0x3168c54, size 0x70, virtual false, abstract: false, final false
inline float_t GetTotalFlexibleSize(int32_t  axis) ;

/// @brief Method GetTotalMinSize, addr 0x3168cc4, size 0x70, virtual false, abstract: false, final false
inline float_t GetTotalMinSize(int32_t  axis) ;

/// @brief Method GetTotalPreferredSize, addr 0x3168be4, size 0x70, virtual false, abstract: false, final false
inline float_t GetTotalPreferredSize(int32_t  axis) ;

static inline ::UnityEngine::UI::LayoutGroup* New_ctor() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x31694b8, size 0x4, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x316943c, size 0x7c, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x316934c, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x316969c, size 0x30, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnTransformChildrenChanged, addr 0x31696cc, size 0x4, virtual true, abstract: false, final false
inline void OnTransformChildrenChanged() ;

/// @brief Method SetChildAlongAxis, addr 0x31694bc, size 0xa8, virtual false, abstract: false, final false
inline void SetChildAlongAxis(::UnityEngine::RectTransform*  rect, int32_t  axis, float_t  pos) ;

/// @brief Method SetChildAlongAxis, addr 0x31678c8, size 0xb0, virtual false, abstract: false, final false
inline void SetChildAlongAxis(::UnityEngine::RectTransform*  rect, int32_t  axis, float_t  pos, float_t  size) ;

/// @brief Method SetChildAlongAxisWithScale, addr 0x31689b8, size 0x22c, virtual false, abstract: false, final false
inline void SetChildAlongAxisWithScale(::UnityEngine::RectTransform*  rect, int32_t  axis, float_t  pos, float_t  scaleFactor) ;

/// @brief Method SetChildAlongAxisWithScale, addr 0x3168744, size 0x274, virtual false, abstract: false, final false
...
/// @brief Method SetDirty, addr 0x3169368, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method SetLayoutInputForAxis, addr 0x3166cc8, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3166628, size 0x11c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_childAlignment, addr 0x31692a8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::TextAnchor get_childAlignment() ;

/// @brief Method get_flexibleHeight, addr 0x316933c, size 0x8, virtual true, abstract: false, final false
inline float_t get_flexibleHeight() ;

/// @brief Method get_flexibleWidth, addr 0x3169324, size 0x8, virtual true, abstract: false, final false
inline float_t get_flexibleWidth() ;

/// @brief Method get_isRootLayoutGroup, addr 0x3169564, size 0x138, virtual false, abstract: false, final false
inline bool get_isRootLayoutGroup() ;

/// @brief Method get_layoutPriority, addr 0x3169344, size 0x8, virtual true, abstract: false, final false
inline int32_t get_layoutPriority() ;

/// @brief Method get_minHeight, addr 0x316932c, size 0x8, virtual true, abstract: false, final false
inline float_t get_minHeight() ;

/// @brief Method get_minWidth, addr 0x3169314, size 0x8, virtual true, abstract: false, final false
inline float_t get_minWidth() ;

/// @brief Method get_padding, addr 0x3169244, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::RectOffset* get_padding() ;

/// @brief Method get_preferredHeight, addr 0x3169334, size 0x8, virtual true, abstract: false, final false
inline float_t get_preferredHeight() ;

/// @brief Method get_preferredWidth, addr 0x316931c, size 0x8, virtual true, abstract: false, final false
inline float_t get_preferredWidth() ;

/// @brief Method get_rectChildren, addr 0x316930c, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::RectTransform>>* get_rectChildren() ;

/// @brief Method get_rectTransform, addr 0x3166f50, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method set_childAlignment, addr 0x31692b0, size 0x5c, virtual false, abstract: false, final false
inline void set_childAlignment(::UnityEngine::TextAnchor  value) ;

/// @brief Method set_padding, addr 0x316924c, size 0x5c, virtual false, abstract: false, final false
