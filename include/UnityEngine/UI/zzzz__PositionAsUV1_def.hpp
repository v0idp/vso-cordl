...
public:
// Declarations
/// @brief Method ModifyMesh, addr 0x31806f4, size 0xbc, virtual true, abstract: false, final false
inline void ModifyMesh(::UnityEngine::UI::VertexHelper*  vh) ;

static inline ::UnityEngine::UI::PositionAsUV1* New_ctor() ;

/// @brief Method .ctor, addr 0x31806ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
