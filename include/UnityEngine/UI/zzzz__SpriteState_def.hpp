...
/// @brief Method Equals, addr 0x3179970, size 0x108, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::UI::SpriteState  other) ;

/// @brief Method get_disabledSprite, addr 0x3179960, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_disabledSprite() ;

/// @brief Method get_highlightedSprite, addr 0x3179930, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_highlightedSprite() ;

/// @brief Method get_pressedSprite, addr 0x3179940, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_pressedSprite() ;

/// @brief Method get_selectedSprite, addr 0x3179950, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_disabledSprite, addr 0x3179968, size 0x8, virtual false, abstract: false, final false
inline void set_disabledSprite(::UnityEngine::Sprite*  value) ;

/// @brief Method set_highlightedSprite, addr 0x3179938, size 0x8, virtual false, abstract: false, final false
inline void set_highlightedSprite(::UnityEngine::Sprite*  value) ;

/// @brief Method set_pressedSprite, addr 0x3179948, size 0x8, virtual false, abstract: false, final false
inline void set_pressedSprite(::UnityEngine::Sprite*  value) ;

/// @brief Method set_selectedSprite, addr 0x3179958, size 0x8, virtual false, abstract: false, final false
