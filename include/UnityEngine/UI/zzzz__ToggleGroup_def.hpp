...
/// @brief Method <ActiveToggles>b__14_0, addr 0x317d648, size 0x18, virtual false, abstract: false, final false
inline bool _ActiveToggles_b__14_0(::UnityEngine::UI::Toggle*  x) ;

/// @brief Method <AnyTogglesOn>b__13_0, addr 0x317d630, size 0x18, virtual false, abstract: false, final false
inline bool _AnyTogglesOn_b__13_0(::UnityEngine::UI::Toggle*  x) ;

/// @brief Method .ctor, addr 0x317d628, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ActiveToggles, addr 0x317d358, size 0xf4, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::UI::Toggle>>* ActiveToggles() ;

/// @brief Method AnyTogglesOn, addr 0x317cf7c, size 0x138, virtual false, abstract: false, final false
inline bool AnyTogglesOn() ;

/// @brief Method EnsureValidState, addr 0x317c61c, size 0x3f0, virtual false, abstract: false, final false
inline void EnsureValidState() ;

/// @brief Method GetFirstActiveToggle, addr 0x317d44c, size 0x88, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Toggle> GetFirstActiveToggle() ;

static inline ::UnityEngine::UI::ToggleGroup* New_ctor() ;

/// @brief Method NotifyToggleOn, addr 0x317ce50, size 0x10c, virtual false, abstract: false, final false
inline void NotifyToggleOn(::UnityEngine::UI::Toggle*  toggle, bool  sendCallback) ;

/// @brief Method OnEnable, addr 0x317d1ec, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RegisterToggle, addr 0x317cd80, size 0xd0, virtual false, abstract: false, final false
inline void RegisterToggle(::UnityEngine::UI::Toggle*  toggle) ;

/// @brief Method SetAllTogglesOff, addr 0x317d4d4, size 0xf8, virtual false, abstract: false, final false
inline void SetAllTogglesOff(bool  sendCallback) ;

/// @brief Method Start, addr 0x317d1d0, size 0x1c, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method UnregisterToggle, addr 0x317ccf0, size 0x90, virtual false, abstract: false, final false
inline void UnregisterToggle(::UnityEngine::UI::Toggle*  toggle) ;

/// @brief Method ValidateToggleIsInGroup, addr 0x317d208, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x317d154, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allowSwitchOff, addr 0x317d140, size 0x8, virtual false, abstract: false, final false
inline bool get_allowSwitchOff() ;

/// @brief Method set_allowSwitchOff, addr 0x317d148, size 0xc, virtual false, abstract: false, final false
