...
/// @brief Method .ctor, addr 0x317c548, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Dependencies UnityEngine.EventSystems.IEventSystemHandler, UnityEngine.EventSystems.IPointerClickHandler, UnityEngine.EventSystems.ISubmitHandler, UnityEngine.UI.ICanvasElement, UnityEngine.UI.Selectable, UnityEngine.UI.Toggle::ToggleTransition
namespace UnityEngine::UI {
// Is value type: false
...
/// @brief Method GraphicUpdateComplete, addr 0x317c598, size 0x4, virtual true, abstract: false, final false
inline void GraphicUpdateComplete() ;

/// @brief Method InternalToggle, addr 0x317d0bc, size 0x54, virtual false, abstract: false, final false
inline void InternalToggle() ;

/// @brief Method LayoutComplete, addr 0x317c594, size 0x4, virtual true, abstract: false, final false
inline void LayoutComplete() ;

static inline ::UnityEngine::UI::Toggle* New_ctor() ;

/// @brief Method OnDestroy, addr 0x317c59c, size 0x80, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x317ca58, size 0x124, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x317ca38, size 0x20, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x317ca0c, size 0x2c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPointerClick, addr 0x317d110, size 0x24, virtual true, abstract: false, final false
inline void OnPointerClick(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnSubmit, addr 0x317d134, size 0x4, virtual true, abstract: false, final false
inline void OnSubmit(::UnityEngine::EventSystems::BaseEventData*  eventData) ;

/// @brief Method PlayEffect, addr 0x317c3f8, size 0xc4, virtual false, abstract: false, final false
inline void PlayEffect(bool  instant) ;

/// @brief Method Rebuild, addr 0x317c590, size 0x4, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  executing) ;

/// @brief Method Set, addr 0x317cb7c, size 0x174, virtual false, abstract: false, final false
inline void Set(bool  value, bool  sendCallback) ;

/// @brief Method SetIsOnWithoutNotify, addr 0x317cf70, size 0xc, virtual false, abstract: false, final false
inline void SetIsOnWithoutNotify(bool  value) ;

/// @brief Method SetToggleGroup, addr 0x317c2bc, size 0x13c, virtual false, abstract: false, final false
inline void SetToggleGroup(::UnityEngine::UI::ToggleGroup*  newGroup, bool  setMemberValue) ;

/// @brief Method Start, addr 0x317d0b4, size 0x8, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x317d138, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x317c4bc, size 0x8c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_group, addr 0x317c294, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::ToggleGroup> get_group() ;

/// @brief Method get_isOn, addr 0x317cf5c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_group, addr 0x317c29c, size 0x20, virtual false, abstract: false, final false
inline void set_group(::UnityEngine::UI::ToggleGroup*  value) ;

/// @brief Method set_isOn, addr 0x317cf64, size 0xc, virtual false, abstract: false, final false
