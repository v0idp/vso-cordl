...
/// @brief Method CalculateLayoutInputHorizontal, addr 0x3168e74, size 0x4, virtual true, abstract: false, final false
inline void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical, addr 0x3168e78, size 0x4, virtual true, abstract: false, final false
inline void CalculateLayoutInputVertical() ;

static inline ::UnityEngine::UI::LayoutElement* New_ctor() ;

/// @brief Method OnBeforeTransformParentChanged, addr 0x3169240, size 0x4, virtual true, abstract: false, final false
inline void OnBeforeTransformParentChanged() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x316923c, size 0x4, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x3169220, size 0x1c, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3169200, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x316921c, size 0x4, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method SetDirty, addr 0x3168dbc, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31691e0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_flexibleHeight, addr 0x31690e8, size 0x8, virtual true, abstract: false, final false
inline float_t get_flexibleHeight() ;

/// @brief Method get_flexibleWidth, addr 0x316906c, size 0x8, virtual true, abstract: false, final false
inline float_t get_flexibleWidth() ;

/// @brief Method get_ignoreLayout, addr 0x3168d40, size 0x8, virtual true, abstract: false, final false
inline bool get_ignoreLayout() ;

/// @brief Method get_layoutPriority, addr 0x3169164, size 0x8, virtual true, abstract: false, final false
inline int32_t get_layoutPriority() ;

/// @brief Method get_minHeight, addr 0x3168ef8, size 0x8, virtual true, abstract: false, final false
inline float_t get_minHeight() ;

/// @brief Method get_minWidth, addr 0x3168e7c, size 0x8, virtual true, abstract: false, final false
inline float_t get_minWidth() ;

/// @brief Method get_preferredHeight, addr 0x3168ff0, size 0x8, virtual true, abstract: false, final false
inline float_t get_preferredHeight() ;

/// @brief Method get_preferredWidth, addr 0x3168f74, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method set_flexibleHeight, addr 0x31690f0, size 0x74, virtual true, abstract: false, final false
inline void set_flexibleHeight(float_t  value) ;

/// @brief Method set_flexibleWidth, addr 0x3169074, size 0x74, virtual true, abstract: false, final false
inline void set_flexibleWidth(float_t  value) ;

/// @brief Method set_ignoreLayout, addr 0x3168d48, size 0x74, virtual true, abstract: false, final false
inline void set_ignoreLayout(bool  value) ;

/// @brief Method set_layoutPriority, addr 0x316916c, size 0x74, virtual true, abstract: false, final false
inline void set_layoutPriority(int32_t  value) ;

/// @brief Method set_minHeight, addr 0x3168f00, size 0x74, virtual true, abstract: false, final false
inline void set_minHeight(float_t  value) ;

/// @brief Method set_minWidth, addr 0x3168e84, size 0x74, virtual true, abstract: false, final false
inline void set_minWidth(float_t  value) ;

/// @brief Method set_preferredHeight, addr 0x3168ff8, size 0x74, virtual true, abstract: false, final false
inline void set_preferredHeight(float_t  value) ;

/// @brief Method set_preferredWidth, addr 0x3168f7c, size 0x74, virtual true, abstract: false, final false
