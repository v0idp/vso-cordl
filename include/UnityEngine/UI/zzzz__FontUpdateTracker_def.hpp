...
/// @brief Method RebuildForFont, addr 0x300d414, size 0x1a4, virtual false, abstract: false, final false
static inline void RebuildForFont(::UnityEngine::Font*  f) ;

/// @brief Method TrackText, addr 0x300d1cc, size 0x248, virtual false, abstract: false, final false
static inline void TrackText(::UnityEngine::UI::Text*  t) ;

/// @brief Method UntrackText, addr 0x300d5b8, size 0x208, virtual false, abstract: false, final false
