...
/// @brief Method Cull, addr 0x3003eec, size 0x10c, virtual false, abstract: false, final false
inline void Cull() ;

/// @brief Method Disable, addr 0x3005350, size 0x5c, virtual false, abstract: false, final false
static inline void Disable(::UnityEngine::UI::IClipper*  c) ;

static inline ::UnityEngine::UI::ClipperRegistry* New_ctor() ;

/// @brief Method Register, addr 0x3005284, size 0x70, virtual false, abstract: false, final false
static inline void Register(::UnityEngine::UI::IClipper*  c) ;

/// @brief Method Unregister, addr 0x30052f4, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3005208, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::UI::ClipperRegistry* getStaticF_s_Instance() ;

/// @brief Method get_instance, addr 0x3003e78, size 0x74, virtual false, abstract: false, final false
