...
/// @brief Method .ctor, addr 0x31734c4, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Dependencies UnityEngine.Bounds, UnityEngine.DrivenRectTransformTracker, UnityEngine.EventSystems.IBeginDragHandler, UnityEngine.EventSystems.IDragHandler, UnityEngine.EventSystems.IEndDragHandler, UnityEngine.EventSystems.IEventSystemHandler, UnityEngine.EventSystems.IInitializePotentialDragHandler, UnityEngine.EventSystems.IScrollHandler, UnityEngine.EventSystems.UIBehaviour, UnityEngine.UI.ICanvasElement, UnityEngine.UI.ILayoutController, UnityEngine.UI.ILayoutElement, UnityEngine.UI.ILayoutGroup, UnityEngine.UI.ScrollRect::MovementType, UnityEngine.UI.ScrollRect::ScrollbarVisibility, UnityEngine.Vector2
namespace UnityEngine::UI {
// Is value type: false
...
/// @brief Method AdjustBounds, addr 0x31760b8, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method CalculateLayoutInputHorizontal, addr 0x3175690, size 0x4, virtual true, abstract: false, final false
inline void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical, addr 0x3175694, size 0x4, virtual true, abstract: false, final false
inline void CalculateLayoutInputVertical() ;

/// @brief Method CalculateOffset, addr 0x3174540, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 CalculateOffset(::UnityEngine::Vector2  delta) ;

/// @brief Method EnsureLayoutHasRebuilt, addr 0x3174310, size 0x74, virtual false, abstract: false, final false
inline void EnsureLayoutHasRebuilt() ;

/// @brief Method GetBounds, addr 0x3175bb4, size 0xf4, virtual false, abstract: false, final false
inline ::UnityEngine::Bounds GetBounds() ;

/// @brief Method GraphicUpdateComplete, addr 0x3173ea0, size 0x4, virtual true, abstract: false, final false
inline void GraphicUpdateComplete() ;

/// @brief Method InternalCalculateOffset, addr 0x31762c4, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method InternalGetBounds, addr 0x3176134, size 0x190, virtual false, abstract: false, final false
...
/// @brief Method IsActive, addr 0x3174290, size 0x80, virtual true, abstract: false, final false
inline bool IsActive() ;

/// @brief Method LateUpdate, addr 0x3174a04, size 0x5d8, virtual true, abstract: false, final false
inline void LateUpdate() ;

/// @brief Method LayoutComplete, addr 0x3173e9c, size 0x4, virtual true, abstract: false, final false
inline void LayoutComplete() ;

static inline ::UnityEngine::UI::ScrollRect* New_ctor() ;

/// @brief Method OnBeginDrag, addr 0x31745d0, size 0x12c, virtual true, abstract: false, final false
inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnDisable, addr 0x3174060, size 0x230, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnDrag, addr 0x317471c, size 0x1fc, virtual true, abstract: false, final false
inline void OnDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnEnable, addr 0x3173ea4, size 0x1bc, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnEndDrag, addr 0x31746fc, size 0x20, virtual true, abstract: false, final false
inline void OnEndDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnInitializePotentialDrag, addr 0x3174570, size 0x60, virtual true, abstract: false, final false
inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x317557c, size 0x4, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnScroll, addr 0x31743d4, size 0x16c, virtual true, abstract: false, final false
inline void OnScroll(::UnityEngine::EventSystems::PointerEventData*  data) ;

/// @brief Method Rebuild, addr 0x317350c, size 0x88, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  executing) ;

/// @brief Method RubberDelta, addr 0x3174918, size 0x38, virtual false, abstract: false, final false
static inline float_t RubberDelta(float_t  overStretching, float_t  viewSize) ;

/// @brief Method SetContentAnchoredPosition, addr 0x3174950, size 0xb4, virtual true, abstract: false, final false
inline void SetContentAnchoredPosition(::UnityEngine::Vector2  position) ;

/// @brief Method SetDirty, addr 0x3173188, size 0x88, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method SetDirtyCaching, addr 0x3172d9c, size 0xb4, virtual false, abstract: false, final false
inline void SetDirtyCaching() ;

/// @brief Method SetHorizontalNormalizedPosition, addr 0x31752bc, size 0x14, virtual false, abstract: false, final false
inline void SetHorizontalNormalizedPosition(float_t  value) ;

/// @brief Method SetLayoutHorizontal, addr 0x31756d0, size 0x4e4, virtual true, abstract: false, final false
inline void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical, addr 0x3175ca8, size 0xb8, virtual true, abstract: false, final false
inline void SetLayoutVertical() ;

/// @brief Method SetNormalizedPosition, addr 0x31752e4, size 0x298, virtual true, abstract: false, final false
inline void SetNormalizedPosition(float_t  value, int32_t  axis) ;

/// @brief Method SetVerticalNormalizedPosition, addr 0x31752d0, size 0x14, virtual false, abstract: false, final false
inline void SetVerticalNormalizedPosition(float_t  value) ;

/// @brief Method StopMovement, addr 0x3174384, size 0x50, virtual true, abstract: false, final false
inline void StopMovement() ;

/// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x3176408, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform() ;

/// @brief Method UpdateBounds, addr 0x31738ec, size 0x358, virtual false, abstract: false, final false
inline void UpdateBounds() ;

/// @brief Method UpdateCachedData, addr 0x3173594, size 0x358, virtual false, abstract: false, final false
inline void UpdateCachedData() ;

/// @brief Method UpdateOneScrollbarVisibility, addr 0x3175fb4, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method UpdatePrevData, addr 0x3173dc4, size 0xd8, virtual false, abstract: false, final false
inline void UpdatePrevData() ;

/// @brief Method UpdateScrollbarLayout, addr 0x3175d60, size 0x254, virtual false, abstract: false, final false
inline void UpdateScrollbarLayout() ;

/// @brief Method UpdateScrollbarVisibility, addr 0x317500c, size 0x40, virtual false, abstract: false, final false
inline void UpdateScrollbarVisibility() ;

/// @brief Method UpdateScrollbars, addr 0x3173c44, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31733c4, size 0x100, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_content, addr 0x3172d00, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_content() ;

/// @brief Method get_decelerationRate, addr 0x3172d6c, size 0x8, virtual false, abstract: false, final false
inline float_t get_decelerationRate() ;

/// @brief Method get_elasticity, addr 0x3172d48, size 0x8, virtual false, abstract: false, final false
inline float_t get_elasticity() ;

/// @brief Method get_flexibleHeight, addr 0x31756c0, size 0x8, virtual true, abstract: false, final false
inline float_t get_flexibleHeight() ;

/// @brief Method get_flexibleWidth, addr 0x31756a8, size 0x8, virtual true, abstract: false, final false
inline float_t get_flexibleWidth() ;

/// @brief Method get_hScrollingNeeded, addr 0x3175580, size 0x88, virtual false, abstract: false, final false
inline bool get_hScrollingNeeded() ;

/// @brief Method get_horizontal, addr 0x3172d10, size 0x8, virtual false, abstract: false, final false
inline bool get_horizontal() ;

/// @brief Method get_horizontalNormalizedPosition, addr 0x317504c, size 0x100, virtual false, abstract: false, final false
inline float_t get_horizontalNormalizedPosition() ;

/// @brief Method get_horizontalScrollbar, addr 0x3172e50, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Scrollbar> get_horizontalScrollbar() ;

/// @brief Method get_horizontalScrollbarSpacing, addr 0x3173178, size 0x8, virtual false, abstract: false, final false
inline float_t get_horizontalScrollbarSpacing() ;

/// @brief Method get_horizontalScrollbarVisibility, addr 0x3173158, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::ScrollRect_ScrollbarVisibility get_horizontalScrollbarVisibility() ;

/// @brief Method get_inertia, addr 0x3172d58, size 0x8, virtual false, abstract: false, final false
inline bool get_inertia() ;

/// @brief Method get_layoutPriority, addr 0x31756c8, size 0x8, virtual true, abstract: false, final false
inline int32_t get_layoutPriority() ;

/// @brief Method get_minHeight, addr 0x31756b0, size 0x8, virtual true, abstract: false, final false
inline float_t get_minHeight() ;

/// @brief Method get_minWidth, addr 0x3175698, size 0x8, virtual true, abstract: false, final false
inline float_t get_minWidth() ;

/// @brief Method get_movementType, addr 0x3172d38, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::ScrollRect_MovementType get_movementType() ;

/// @brief Method get_normalizedPosition, addr 0x3174fdc, size 0x30, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_normalizedPosition() ;

/// @brief Method get_onValueChanged, addr 0x3173220, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::ScrollRect_ScrollRectEvent* get_onValueChanged() ;

/// @brief Method get_preferredHeight, addr 0x31756b8, size 0x8, virtual true, abstract: false, final false
inline float_t get_preferredHeight() ;

/// @brief Method get_preferredWidth, addr 0x31756a0, size 0x8, virtual true, abstract: false, final false
inline float_t get_preferredWidth() ;

/// @brief Method get_rectTransform, addr 0x3173330, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_scrollSensitivity, addr 0x3172d7c, size 0x8, virtual false, abstract: false, final false
inline float_t get_scrollSensitivity() ;

/// @brief Method get_vScrollingNeeded, addr 0x3175608, size 0x88, virtual false, abstract: false, final false
inline bool get_vScrollingNeeded() ;

/// @brief Method get_velocity, addr 0x3173320, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_velocity() ;

/// @brief Method get_vertical, addr 0x3172d24, size 0x8, virtual false, abstract: false, final false
inline bool get_vertical() ;

/// @brief Method get_verticalNormalizedPosition, addr 0x317514c, size 0x100, virtual false, abstract: false, final false
inline float_t get_verticalNormalizedPosition() ;

/// @brief Method get_verticalScrollbar, addr 0x3172fd4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Scrollbar> get_verticalScrollbar() ;

/// @brief Method get_verticalScrollbarSpacing, addr 0x3173210, size 0x8, virtual false, abstract: false, final false
inline float_t get_verticalScrollbarSpacing() ;

/// @brief Method get_verticalScrollbarVisibility, addr 0x3173168, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::ScrollRect_ScrollbarVisibility get_verticalScrollbarVisibility() ;

/// @brief Method get_viewRect, addr 0x3173230, size 0xf0, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_viewRect() ;

/// @brief Method get_viewport, addr 0x3172d8c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_content, addr 0x3172d08, size 0x8, virtual false, abstract: false, final false
inline void set_content(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_decelerationRate, addr 0x3172d74, size 0x8, virtual false, abstract: false, final false
inline void set_decelerationRate(float_t  value) ;

/// @brief Method set_elasticity, addr 0x3172d50, size 0x8, virtual false, abstract: false, final false
inline void set_elasticity(float_t  value) ;

/// @brief Method set_horizontal, addr 0x3172d18, size 0xc, virtual false, abstract: false, final false
inline void set_horizontal(bool  value) ;

/// @brief Method set_horizontalNormalizedPosition, addr 0x3175294, size 0x14, virtual false, abstract: false, final false
inline void set_horizontalNormalizedPosition(float_t  value) ;

/// @brief Method set_horizontalScrollbar, addr 0x3172e58, size 0x17c, virtual false, abstract: false, final false
inline void set_horizontalScrollbar(::UnityEngine::UI::Scrollbar*  value) ;

/// @brief Method set_horizontalScrollbarSpacing, addr 0x3173180, size 0x8, virtual false, abstract: false, final false
inline void set_horizontalScrollbarSpacing(float_t  value) ;

/// @brief Method set_horizontalScrollbarVisibility, addr 0x3173160, size 0x8, virtual false, abstract: false, final false
inline void set_horizontalScrollbarVisibility(::UnityEngine::UI::ScrollRect_ScrollbarVisibility  value) ;

/// @brief Method set_inertia, addr 0x3172d60, size 0xc, virtual false, abstract: false, final false
inline void set_inertia(bool  value) ;

/// @brief Method set_movementType, addr 0x3172d40, size 0x8, virtual false, abstract: false, final false
inline void set_movementType(::UnityEngine::UI::ScrollRect_MovementType  value) ;

/// @brief Method set_normalizedPosition, addr 0x317524c, size 0x48, virtual false, abstract: false, final false
inline void set_normalizedPosition(::UnityEngine::Vector2  value) ;

/// @brief Method set_onValueChanged, addr 0x3173228, size 0x8, virtual false, abstract: false, final false
inline void set_onValueChanged(::UnityEngine::UI::ScrollRect_ScrollRectEvent*  value) ;

/// @brief Method set_scrollSensitivity, addr 0x3172d84, size 0x8, virtual false, abstract: false, final false
inline void set_scrollSensitivity(float_t  value) ;

/// @brief Method set_velocity, addr 0x3173328, size 0x8, virtual false, abstract: false, final false
inline void set_velocity(::UnityEngine::Vector2  value) ;

/// @brief Method set_vertical, addr 0x3172d2c, size 0xc, virtual false, abstract: false, final false
inline void set_vertical(bool  value) ;

/// @brief Method set_verticalNormalizedPosition, addr 0x31752a8, size 0x14, virtual false, abstract: false, final false
inline void set_verticalNormalizedPosition(float_t  value) ;

/// @brief Method set_verticalScrollbar, addr 0x3172fdc, size 0x17c, virtual false, abstract: false, final false
inline void set_verticalScrollbar(::UnityEngine::UI::Scrollbar*  value) ;

/// @brief Method set_verticalScrollbarSpacing, addr 0x3173218, size 0x8, virtual false, abstract: false, final false
inline void set_verticalScrollbarSpacing(float_t  value) ;

/// @brief Method set_verticalScrollbarVisibility, addr 0x3173170, size 0x8, virtual false, abstract: false, final false
inline void set_verticalScrollbarVisibility(::UnityEngine::UI::ScrollRect_ScrollbarVisibility  value) ;

/// @brief Method set_viewport, addr 0x3172d94, size 0x8, virtual false, abstract: false, final false
