...
/// @brief Method AddTriangle, addr 0x316f660, size 0x170, virtual false, abstract: false, final false
inline void AddTriangle(int32_t  idx0, int32_t  idx1, int32_t  idx2) ;

/// @brief Method AddUIVertexQuad, addr 0x317bfc0, size 0x110, virtual false, abstract: false, final false
inline void AddUIVertexQuad(::ArrayW<::UnityEngine::UIVertex,::Array<::UnityEngine::UIVertex>*>  verts) ;

/// @brief Method AddUIVertexStream, addr 0x317fe8c, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method AddUIVertexTriangleStream, addr 0x317ff38, size 0x50, virtual false, abstract: false, final false
inline void AddUIVertexTriangleStream(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>*  verts) ;

/// @brief Method AddVert, addr 0x316f530, size 0x130, virtual false, abstract: false, final false
inline void AddVert(::UnityEngine::Vector3  position, ::UnityEngine::Color32  color, ::UnityEngine::Vector4  uv0) ;

/// @brief Method AddVert, addr 0x317fd00, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method AddVert, addr 0x317f864, size 0x49c, virtual false, abstract: false, final false
...
/// @brief Method AddVert, addr 0x317fdf8, size 0x94, virtual false, abstract: false, final false
inline void AddVert(::UnityEngine::UIVertex  v) ;

/// @brief Method Clear, addr 0x316f414, size 0x11c, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method Dispose, addr 0x317f1fc, size 0x1b4, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method FillMesh, addr 0x317f704, size 0x160, virtual false, abstract: false, final false
inline void FillMesh(::UnityEngine::Mesh*  mesh) ;

/// @brief Method GetUIVertexStream, addr 0x317ff88, size 0x50, virtual false, abstract: false, final false
inline void GetUIVertexStream(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>*  stream) ;

/// @brief Method InitializeListIfRequired, addr 0x317f074, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method PopulateUIVertex, addr 0x317f448, size 0x160, virtual false, abstract: false, final false
inline void PopulateUIVertex(::ByRef<::UnityEngine::UIVertex>  vertex, int32_t  i) ;

/// @brief Method SetUIVertex, addr 0x317f5a8, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x317ee30, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x317ee38, size 0x23c, virtual false, abstract: false, final false
...
/// @brief Method get_currentIndexCount, addr 0x317f3fc, size 0x4c, virtual false, abstract: false, final false
inline int32_t get_currentIndexCount() ;

/// @brief Method get_currentVertCount, addr 0x317f3b0, size 0x4c, virtual false, abstract: false, final false
