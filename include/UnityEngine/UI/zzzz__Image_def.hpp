...
// Dependencies UnityEngine.ICanvasRaycastFilter, UnityEngine.ISerializationCallbackReceiver, UnityEngine.UI.ILayoutElement, UnityEngine.UI.Image::FillMethod, UnityEngine.UI.Image::Type, UnityEngine.UI.MaskableGraphic
namespace UnityEngine::UI {
// Is value type: false
...
/// @brief Method AddQuad, addr 0x30164c8, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method AddQuad, addr 0x301661c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method CalculateLayoutInputHorizontal, addr 0x3016c4c, size 0x4, virtual true, abstract: false, final false
inline void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical, addr 0x3016c50, size 0x4, virtual true, abstract: false, final false
inline void CalculateLayoutInputVertical() ;

/// @brief Method DisableSpriteOptimizations, addr 0x3012af8, size 0x8, virtual false, abstract: false, final false
inline void DisableSpriteOptimizations() ;

/// @brief Method GenerateFilledSprite, addr 0x30156bc, size 0x8e8, virtual false, abstract: false, final false
inline void GenerateFilledSprite(::UnityEngine::UI::VertexHelper*  toFill, bool  preserveAspect) ;

/// @brief Method GenerateSimpleSprite, addr 0x3013e00, size 0x2c4, virtual false, abstract: false, final false
inline void GenerateSimpleSprite(::UnityEngine::UI::VertexHelper*  vh, bool  lPreserveAspect) ;

/// @brief Method GenerateSlicedSprite, addr 0x30143a4, size 0x5c0, virtual false, abstract: false, final false
inline void GenerateSlicedSprite(::UnityEngine::UI::VertexHelper*  toFill) ;

/// @brief Method GenerateSprite, addr 0x30140c4, size 0x2e0, virtual false, abstract: false, final false
inline void GenerateSprite(::UnityEngine::UI::VertexHelper*  vh, bool  lPreserveAspect) ;

/// @brief Method GenerateTiledSprite, addr 0x3014964, size 0xd58, virtual false, abstract: false, final false
inline void GenerateTiledSprite(::UnityEngine::UI::VertexHelper*  toFill) ;

/// @brief Method GetAdjustedBorders, addr 0x3016408, size 0xc0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 GetAdjustedBorders(::UnityEngine::Vector4  border, ::UnityEngine::Rect  adjustedRect) ;

/// @brief Method GetDrawingDimensions, addr 0x30137cc, size 0x3b0, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 GetDrawingDimensions(bool  shouldPreserveAspect) ;

/// @brief Method IsRaycastLocationValid, addr 0x3016e0c, size 0x38c, virtual true, abstract: false, final false
inline bool IsRaycastLocationValid(::UnityEngine::Vector2  screenPoint, ::UnityEngine::Camera*  eventCamera) ;

/// @brief Method MapCoordinate, addr 0x3017198, size 0x258, virtual false, abstract: false, final false
...
/// @brief Method OnAfterDeserialize, addr 0x30136e8, size 0x50, virtual true, abstract: false, final false
inline void OnAfterDeserialize() ;

/// @brief Method OnBeforeSerialize, addr 0x30136e4, size 0x4, virtual true, abstract: false, final false
inline void OnBeforeSerialize() ;

/// @brief Method OnCanvasHierarchyChanged, addr 0x3016300, size 0x108, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x3017598, size 0x38, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x3016118, size 0x74, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x30160fc, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPopulateMesh, addr 0x3013cbc, size 0x144, virtual true, abstract: false, final false
inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper*  toFill) ;

/// @brief Method PreserveSpriteAspectRatio, addr 0x3013738, size 0x94, virtual false, abstract: false, final false
inline void PreserveSpriteAspectRatio(::ByRef<::UnityEngine::Rect>  rect, ::UnityEngine::Vector2  spriteSize) ;

/// @brief Method RadialCut, addr 0x3016700, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method RadialCut, addr 0x3016820, size 0x42c, virtual false, abstract: false, final false
...
/// @brief Method RebuildImage, addr 0x30173f0, size 0x1a8, virtual false, abstract: false, final false
static inline void RebuildImage(::UnityEngine::U2D::SpriteAtlas*  spriteAtlas) ;

/// @brief Method SetNativeSize, addr 0x3013b7c, size 0x140, virtual true, abstract: false, final false
inline void SetNativeSize() ;

/// @brief Method TrackImage, addr 0x3015fa4, size 0x158, virtual false, abstract: false, final false
static inline void TrackImage(::UnityEngine::UI::Image*  g) ;

/// @brief Method TrackSprite, addr 0x3012a0c, size 0xec, virtual false, abstract: false, final false
inline void TrackSprite() ;

/// @brief Method UnTrackImage, addr 0x301618c, size 0x80, virtual false, abstract: false, final false
static inline void UnTrackImage(::UnityEngine::UI::Image*  g) ;

/// @brief Method UpdateMaterial, addr 0x301620c, size 0xf4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3013130, size 0x40, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <set_sprite>g__ResetAlphaHitThresholdIfNeeded|11_0, addr 0x301297c, size 0x90, virtual false, abstract: false, final false
inline void _set_sprite_g__ResetAlphaHitThresholdIfNeeded_11_0() ;

/// @brief Method <set_sprite>g__SpriteSupportsAlphaHitTest|11_1, addr 0x30176f8, size 0x12c, virtual false, abstract: false, final false
...
/// @brief Method get_activeSprite, addr 0x3012b04, size 0x78, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_activeSprite() ;

/// @brief Method get_alphaHitTestMinimumThreshold, addr 0x30130a0, size 0x8, virtual false, abstract: false, final false
inline float_t get_alphaHitTestMinimumThreshold() ;

/// @brief Method get_defaultETC1GraphicMaterial, addr 0x3013170, size 0xdc, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_defaultETC1GraphicMaterial() ;

/// @brief Method get_eventAlphaThreshold, addr 0x3012f44, size 0x10, virtual false, abstract: false, final false
inline float_t get_eventAlphaThreshold() ;

/// @brief Method get_fillAmount, addr 0x3012d9c, size 0x8, virtual false, abstract: false, final false
inline float_t get_fillAmount() ;

/// @brief Method get_fillCenter, addr 0x3012c94, size 0x8, virtual false, abstract: false, final false
inline bool get_fillCenter() ;

/// @brief Method get_fillClockwise, addr 0x3012e34, size 0x8, virtual false, abstract: false, final false
inline bool get_fillClockwise() ;

/// @brief Method get_fillMethod, addr 0x3012d1c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Image_FillMethod get_fillMethod() ;

/// @brief Method get_fillOrigin, addr 0x3012ebc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_fillOrigin() ;

/// @brief Method get_flexibleHeight, addr 0x3016dfc, size 0x8, virtual true, abstract: false, final false
inline float_t get_flexibleHeight() ;

/// @brief Method get_flexibleWidth, addr 0x3016d24, size 0x8, virtual true, abstract: false, final false
inline float_t get_flexibleWidth() ;

/// @brief Method get_hasBorder, addr 0x30133c4, size 0xb8, virtual false, abstract: false, final false
inline bool get_hasBorder() ;

/// @brief Method get_layoutPriority, addr 0x3016e04, size 0x8, virtual true, abstract: false, final false
inline int32_t get_layoutPriority() ;

/// @brief Method get_mainTexture, addr 0x301324c, size 0x178, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_mainTexture() ;

/// @brief Method get_material, addr 0x30135b4, size 0x12c, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_material() ;

/// @brief Method get_minHeight, addr 0x3016d2c, size 0x8, virtual true, abstract: false, final false
inline float_t get_minHeight() ;

/// @brief Method get_minWidth, addr 0x3016c54, size 0x8, virtual true, abstract: false, final false
inline float_t get_minWidth() ;

/// @brief Method get_multipliedPixelsPerUnit, addr 0x3013598, size 0x1c, virtual false, abstract: false, final false
inline float_t get_multipliedPixelsPerUnit() ;

/// @brief Method get_overrideSprite, addr 0x3012b00, size 0x4, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_overrideSprite() ;

/// @brief Method get_pixelsPerUnit, addr 0x30134a4, size 0xf4, virtual false, abstract: false, final false
inline float_t get_pixelsPerUnit() ;

/// @brief Method get_pixelsPerUnitMultiplier, addr 0x301347c, size 0x8, virtual false, abstract: false, final false
inline float_t get_pixelsPerUnitMultiplier() ;

/// @brief Method get_preferredHeight, addr 0x3016d34, size 0xc8, virtual true, abstract: false, final false
inline float_t get_preferredHeight() ;

/// @brief Method get_preferredWidth, addr 0x3016c5c, size 0xc8, virtual true, abstract: false, final false
inline float_t get_preferredWidth() ;

/// @brief Method get_preserveAspect, addr 0x3012c0c, size 0x8, virtual false, abstract: false, final false
inline bool get_preserveAspect() ;

/// @brief Method get_sprite, addr 0x3012974, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_sprite() ;

/// @brief Method get_type, addr 0x3012c04, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Image_Type get_type() ;

/// @brief Method get_useSpriteMesh, addr 0x30130a8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_alphaHitTestMinimumThreshold, addr 0x3012f60, size 0x140, virtual false, abstract: false, final false
inline void set_alphaHitTestMinimumThreshold(float_t  value) ;

/// @brief Method set_eventAlphaThreshold, addr 0x3012f54, size 0xc, virtual false, abstract: false, final false
inline void set_eventAlphaThreshold(float_t  value) ;

/// @brief Method set_fillAmount, addr 0x3012da4, size 0x90, virtual false, abstract: false, final false
inline void set_fillAmount(float_t  value) ;

/// @brief Method set_fillCenter, addr 0x3012c9c, size 0x80, virtual false, abstract: false, final false
inline void set_fillCenter(bool  value) ;

/// @brief Method set_fillClockwise, addr 0x3012e3c, size 0x80, virtual false, abstract: false, final false
inline void set_fillClockwise(bool  value) ;

/// @brief Method set_fillMethod, addr 0x3012d24, size 0x78, virtual false, abstract: false, final false
inline void set_fillMethod(::UnityEngine::UI::Image_FillMethod  value) ;

/// @brief Method set_fillOrigin, addr 0x3012ec4, size 0x80, virtual false, abstract: false, final false
inline void set_fillOrigin(int32_t  value) ;

/// @brief Method set_material, addr 0x30136e0, size 0x4, virtual true, abstract: false, final false
inline void set_material(::UnityEngine::Material*  value) ;

/// @brief Method set_overrideSprite, addr 0x3012b7c, size 0x88, virtual false, abstract: false, final false
inline void set_overrideSprite(::UnityEngine::Sprite*  value) ;

/// @brief Method set_pixelsPerUnitMultiplier, addr 0x3013484, size 0x20, virtual false, abstract: false, final false
inline void set_pixelsPerUnitMultiplier(float_t  value) ;

/// @brief Method set_preserveAspect, addr 0x3012c14, size 0x80, virtual false, abstract: false, final false
inline void set_preserveAspect(bool  value) ;

/// @brief Method set_sprite, addr 0x3006000, size 0x2b4, virtual false, abstract: false, final false
inline void set_sprite(::UnityEngine::Sprite*  value) ;

/// @brief Method set_type, addr 0x30062b4, size 0x80, virtual false, abstract: false, final false
inline void set_type(::UnityEngine::UI::Image_Type  value) ;

/// @brief Method set_useSpriteMesh, addr 0x30130b0, size 0x80, virtual false, abstract: false, final false
