...
/// @brief Method .ctor, addr 0x316db68, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Cull, addr 0x316cf14, size 0xd0, virtual true, abstract: false, final false
inline void Cull(::UnityEngine::Rect  clipRect, bool  validRect) ;

/// @brief Method GetModifiedMaterial, addr 0x316ce14, size 0x100, virtual true, abstract: false, final false
...
/// @brief Method OnCanvasHierarchyChanged, addr 0x316d5c8, size 0x50, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnDisable, addr 0x316d4c8, size 0xac, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x316d324, size 0x50, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnTransformParentChanged, addr 0x316d574, size 0x50, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method ParentMaskStateChanged, addr 0x316d5c4, size 0x4, virtual true, abstract: false, final false
inline void ParentMaskStateChanged() ;

/// @brief Method RecalculateClipping, addr 0x316da2c, size 0x4, virtual true, abstract: false, final false
inline void RecalculateClipping() ;

/// @brief Method RecalculateMasking, addr 0x316da30, size 0x7c, virtual true, abstract: false, final false
inline void RecalculateMasking() ;

/// @brief Method SetClipRect, addr 0x316d280, size 0x6c, virtual true, abstract: false, final false
inline void SetClipRect(::UnityEngine::Rect  clipRect, bool  validRect) ;

/// @brief Method SetClipSoftness, addr 0x316d2ec, size 0x38, virtual true, abstract: false, final false
inline void SetClipSoftness(::UnityEngine::Vector2  clipSoftness) ;

/// @brief Method UnityEngine.UI.IClippable.get_gameObject, addr 0x316dbb0, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::GameObject> UnityEngine_UI_IClippable_get_gameObject() ;

/// @brief Method UpdateClipParent, addr 0x316d374, size 0x154, virtual false, abstract: false, final false
inline void UpdateClipParent() ;

/// @brief Method UpdateCull, addr 0x316d19c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x316daac, size 0xbc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isMaskingGraphic, addr 0x316ce0c, size 0x8, virtual false, abstract: false, final false
inline bool get_isMaskingGraphic() ;

/// @brief Method get_maskable, addr 0x316cdd4, size 0x8, virtual false, abstract: false, final false
inline bool get_maskable() ;

/// @brief Method get_onCullStateChanged, addr 0x316cdc4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::MaskableGraphic_CullStateChangedEvent* get_onCullStateChanged() ;

/// @brief Method get_rootCanvasRect, addr 0x316cfe4, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method set_isMaskingGraphic, addr 0x316c228, size 0x18, virtual false, abstract: false, final false
inline void set_isMaskingGraphic(bool  value) ;

/// @brief Method set_maskable, addr 0x316cddc, size 0x30, virtual false, abstract: false, final false
inline void set_maskable(bool  value) ;

/// @brief Method set_onCullStateChanged, addr 0x316cdcc, size 0x8, virtual false, abstract: false, final false
