...
/// @brief Method .ctor, addr 0x3178b9c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Dependencies UnityEngine.DrivenRectTransformTracker, UnityEngine.EventSystems.IDragHandler, UnityEngine.EventSystems.IEventSystemHandler, UnityEngine.EventSystems.IInitializePotentialDragHandler, UnityEngine.UI.ICanvasElement, UnityEngine.UI.Selectable, UnityEngine.UI.Slider::Direction, UnityEngine.Vector2
namespace UnityEngine::UI {
// Is value type: false
...
/// @brief Method ClampValue, addr 0x3178e74, size 0xb4, virtual false, abstract: false, final false
inline float_t ClampValue(float_t  input) ;

/// @brief Method FindSelectableOnDown, addr 0x3179764, size 0x24, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnDown() ;

/// @brief Method FindSelectableOnLeft, addr 0x31796f8, size 0x24, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnLeft() ;

/// @brief Method FindSelectableOnRight, addr 0x317971c, size 0x24, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnRight() ;

/// @brief Method FindSelectableOnUp, addr 0x3179740, size 0x24, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::Selectable> FindSelectableOnUp() ;

/// @brief Method GraphicUpdateComplete, addr 0x3178bec, size 0x4, virtual true, abstract: false, final false
inline void GraphicUpdateComplete() ;

/// @brief Method LayoutComplete, addr 0x3178be8, size 0x4, virtual true, abstract: false, final false
inline void LayoutComplete() ;

/// @brief Method MayDrag, addr 0x3179240, size 0x64, virtual false, abstract: false, final false
inline bool MayDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

static inline ::UnityEngine::UI::Slider* New_ctor() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x3178c8c, size 0x1e8, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x3178c2c, size 0x20, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnDrag, addr 0x317945c, size 0x50, virtual true, abstract: false, final false
inline void OnDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnEnable, addr 0x3178bf0, size 0x3c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnInitializePotentialDrag, addr 0x3179788, size 0x18, virtual true, abstract: false, final false
inline void OnInitializePotentialDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnMove, addr 0x31794ac, size 0x24c, virtual true, abstract: false, final false
inline void OnMove(::UnityEngine::EventSystems::AxisEventData*  eventData) ;

/// @brief Method OnPointerDown, addr 0x31792a4, size 0x1b8, virtual true, abstract: false, final false
inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x3179010, size 0x38, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method Rebuild, addr 0x3178be4, size 0x4, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  executing) ;

/// @brief Method Set, addr 0x3178f4c, size 0xc4, virtual true, abstract: false, final false
inline void Set(float_t  input, bool  sendCallback) ;

/// @brief Method SetDirection, addr 0x31797a0, size 0x188, virtual false, abstract: false, final false
inline void SetDirection(::UnityEngine::UI::Slider_Direction  direction, bool  includeRectLayouts) ;

/// @brief Method SetValueWithoutNotify, addr 0x3178974, size 0x14, virtual true, abstract: false, final false
inline void SetValueWithoutNotify(float_t  input) ;

/// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x3179928, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform() ;

/// @brief Method Update, addr 0x3178c4c, size 0x40, virtual true, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateCachedReferences, addr 0x3178070, size 0x2a4, virtual false, abstract: false, final false
inline void UpdateCachedReferences() ;

/// @brief Method UpdateDrag, addr 0x3179048, size 0x1f8, virtual false, abstract: false, final false
inline void UpdateDrag(::UnityEngine::EventSystems::PointerEventData*  eventData, ::UnityEngine::Camera*  cam) ;

/// @brief Method UpdateVisuals, addr 0x3178314, size 0x2e4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3178ae0, size 0xbc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_axis, addr 0x3178f3c, size 0x10, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Slider_Axis get_axis() ;

/// @brief Method get_direction, addr 0x317867c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Slider_Direction get_direction() ;

/// @brief Method get_fillRect, addr 0x3177fec, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_fillRect() ;

/// @brief Method get_handleRect, addr 0x31785f8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_handleRect() ;

/// @brief Method get_maxValue, addr 0x3178790, size 0x8, virtual false, abstract: false, final false
inline float_t get_maxValue() ;

/// @brief Method get_minValue, addr 0x31786f8, size 0x8, virtual false, abstract: false, final false
inline float_t get_minValue() ;

/// @brief Method get_normalizedValue, addr 0x3178988, size 0xe4, virtual false, abstract: false, final false
inline float_t get_normalizedValue() ;

/// @brief Method get_onValueChanged, addr 0x3178aa4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::Slider_SliderEvent* get_onValueChanged() ;

/// @brief Method get_reverseValue, addr 0x3178f28, size 0x14, virtual false, abstract: false, final false
inline bool get_reverseValue() ;

/// @brief Method get_stepSize, addr 0x3178ab4, size 0x2c, virtual false, abstract: false, final false
inline float_t get_stepSize() ;

/// @brief Method get_value, addr 0x31788c0, size 0xa0, virtual true, abstract: false, final false
inline float_t get_value() ;

/// @brief Method get_wholeNumbers, addr 0x3178828, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_direction, addr 0x3178684, size 0x74, virtual false, abstract: false, final false
inline void set_direction(::UnityEngine::UI::Slider_Direction  value) ;

/// @brief Method set_fillRect, addr 0x3177ff4, size 0x7c, virtual false, abstract: false, final false
inline void set_fillRect(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_handleRect, addr 0x3178600, size 0x7c, virtual false, abstract: false, final false
inline void set_handleRect(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_maxValue, addr 0x3178798, size 0x90, virtual false, abstract: false, final false
inline void set_maxValue(float_t  value) ;

/// @brief Method set_minValue, addr 0x3178700, size 0x90, virtual false, abstract: false, final false
inline void set_minValue(float_t  value) ;

/// @brief Method set_normalizedValue, addr 0x3178a6c, size 0x38, virtual false, abstract: false, final false
inline void set_normalizedValue(float_t  value) ;

/// @brief Method set_onValueChanged, addr 0x3178aac, size 0x8, virtual false, abstract: false, final false
inline void set_onValueChanged(::UnityEngine::UI::Slider_SliderEvent*  value) ;

/// @brief Method set_value, addr 0x3178960, size 0x14, virtual true, abstract: false, final false
inline void set_value(float_t  value) ;

/// @brief Method set_wholeNumbers, addr 0x3178830, size 0x90, virtual false, abstract: false, final false
