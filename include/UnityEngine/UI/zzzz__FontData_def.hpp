...
/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x300d188, size 0x44, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x300d184, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x300d0b0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_alignByGeometry, addr 0x300d12c, size 0x8, virtual false, abstract: false, final false
inline bool get_alignByGeometry() ;

/// @brief Method get_alignment, addr 0x300d11c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::TextAnchor get_alignment() ;

/// @brief Method get_bestFit, addr 0x300d0e8, size 0x8, virtual false, abstract: false, final false
inline bool get_bestFit() ;

/// @brief Method get_defaultFontData, addr 0x300d020, size 0x90, virtual false, abstract: false, final false
static inline ::UnityEngine::UI::FontData* get_defaultFontData() ;

/// @brief Method get_font, addr 0x300d0b8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Font> get_font() ;

/// @brief Method get_fontSize, addr 0x300d0c8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_fontSize() ;

/// @brief Method get_fontStyle, addr 0x300d0d8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::FontStyle get_fontStyle() ;

/// @brief Method get_horizontalOverflow, addr 0x300d154, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::HorizontalWrapMode get_horizontalOverflow() ;

/// @brief Method get_lineSpacing, addr 0x300d174, size 0x8, virtual false, abstract: false, final false
inline float_t get_lineSpacing() ;

/// @brief Method get_maxSize, addr 0x300d10c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxSize() ;

/// @brief Method get_minSize, addr 0x300d0fc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_minSize() ;

/// @brief Method get_richText, addr 0x300d140, size 0x8, virtual false, abstract: false, final false
inline bool get_richText() ;

/// @brief Method get_verticalOverflow, addr 0x300d164, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::VerticalWrapMode get_verticalOverflow() ;

/// @brief Convert to "::UnityEngine::ISerializationCallbackReceiver"
constexpr ::UnityEngine::ISerializationCallbackReceiver* i___UnityEngine__ISerializationCallbackReceiver() noexcept;

/// @brief Method set_alignByGeometry, addr 0x300d134, size 0xc, virtual false, abstract: false, final false
inline void set_alignByGeometry(bool  value) ;

/// @brief Method set_alignment, addr 0x300d124, size 0x8, virtual false, abstract: false, final false
inline void set_alignment(::UnityEngine::TextAnchor  value) ;

/// @brief Method set_bestFit, addr 0x300d0f0, size 0xc, virtual false, abstract: false, final false
inline void set_bestFit(bool  value) ;

/// @brief Method set_font, addr 0x300d0c0, size 0x8, virtual false, abstract: false, final false
inline void set_font(::UnityEngine::Font*  value) ;

/// @brief Method set_fontSize, addr 0x300d0d0, size 0x8, virtual false, abstract: false, final false
inline void set_fontSize(int32_t  value) ;

/// @brief Method set_fontStyle, addr 0x300d0e0, size 0x8, virtual false, abstract: false, final false
inline void set_fontStyle(::UnityEngine::FontStyle  value) ;

/// @brief Method set_horizontalOverflow, addr 0x300d15c, size 0x8, virtual false, abstract: false, final false
inline void set_horizontalOverflow(::UnityEngine::HorizontalWrapMode  value) ;

/// @brief Method set_lineSpacing, addr 0x300d17c, size 0x8, virtual false, abstract: false, final false
inline void set_lineSpacing(float_t  value) ;

/// @brief Method set_maxSize, addr 0x300d114, size 0x8, virtual false, abstract: false, final false
inline void set_maxSize(int32_t  value) ;

/// @brief Method set_minSize, addr 0x300d104, size 0x8, virtual false, abstract: false, final false
inline void set_minSize(int32_t  value) ;

/// @brief Method set_richText, addr 0x300d148, size 0xc, virtual false, abstract: false, final false
inline void set_richText(bool  value) ;

/// @brief Method set_verticalOverflow, addr 0x300d16c, size 0x8, virtual false, abstract: false, final false
