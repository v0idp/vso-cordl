...
/// @brief Method CreateGameObject, addr 0x3009ffc, size 0x6c, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::GameObject> CreateGameObject(::StringW  name, ::ArrayW<::System::Type*,::Array<::System::Type*>*>  components) ;

static inline ::UnityEngine::UI::DefaultControls_DefaultRuntimeFactory* New_ctor() ;

/// @brief Method .ctor, addr 0x300a068, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateUIObject, addr 0x30058fc, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method SetDefaultColorTransitionValues, addr 0x3005c00, size 0x60, virtual false, abstract: false, final false
static inline void SetDefaultColorTransitionValues(::UnityEngine::UI::Selectable*  slider) ;

/// @brief Method SetDefaultTextValues, addr 0x3005b24, size 0xdc, virtual false, abstract: false, final false
static inline void SetDefaultTextValues(::UnityEngine::UI::Text*  lbl) ;

/// @brief Method SetLayerRecursively, addr 0x3005c60, size 0xe4, virtual false, abstract: false, final false
static inline void SetLayerRecursively(::UnityEngine::GameObject*  go, int32_t  layer) ;

/// @brief Method SetParentAndAlign, addr 0x3005a24, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method get_factory, addr 0x3005744, size 0x58, virtual false, abstract: false, final false
