...
/// @brief Method CacheCanvas, addr 0x300e61c, size 0x170, virtual false, abstract: false, final false
inline void CacheCanvas() ;

/// @brief Method CreateColorFromAlpha, addr 0x30109f0, size 0x14, virtual false, abstract: false, final false
static inline ::UnityEngine::Color CreateColorFromAlpha(float_t  alpha) ;

/// @brief Method CrossFadeAlpha, addr 0x3010a04, size 0x9c, virtual true, abstract: false, final false
inline void CrossFadeAlpha(float_t  alpha, float_t  duration, bool  ignoreTimeScale) ;

/// @brief Method CrossFadeColor, addr 0x3010748, size 0x1c, virtual true, abstract: false, final false
inline void CrossFadeColor(::UnityEngine::Color  targetColor, float_t  duration, bool  ignoreTimeScale, bool  useAlpha) ;

/// @brief Method CrossFadeColor, addr 0x3010764, size 0x28c, virtual true, abstract: false, final false
inline void CrossFadeColor(::UnityEngine::Color  targetColor, float_t  duration, bool  ignoreTimeScale, bool  useAlpha, bool  useRGB) ;

/// @brief Method DoLegacyMeshGeneration, addr 0x300f620, size 0x368, virtual false, abstract: false, final false
inline void DoLegacyMeshGeneration() ;

/// @brief Method DoMeshGeneration, addr 0x300f988, size 0x39c, virtual false, abstract: false, final false
inline void DoMeshGeneration() ;

/// @brief Method GetPixelAdjustedRect, addr 0x301003c, size 0x12c, virtual false, abstract: false, final false
inline ::UnityEngine::Rect GetPixelAdjustedRect() ;

/// @brief Method GraphicUpdateComplete, addr 0x300f554, size 0x4, virtual true, abstract: false, final false
inline void GraphicUpdateComplete() ;

/// @brief Method LayoutComplete, addr 0x300f550, size 0x4, virtual true, abstract: false, final false
inline void LayoutComplete() ;

static inline ::UnityEngine::UI::Graphic* New_ctor() ;

/// @brief Method OnBeforeTransformParentChanged, addr 0x300e31c, size 0xa8, virtual true, abstract: false, final false
inline void OnBeforeTransformParentChanged() ;

/// @brief Method OnCanvasHierarchyChanged, addr 0x300f2a8, size 0x138, virtual true, abstract: false, final false
inline void OnCanvasHierarchyChanged() ;

/// @brief Method OnCullingChanged, addr 0x300f3e0, size 0x8c, virtual true, abstract: false, final false
inline void OnCullingChanged() ;

/// @brief Method OnDestroy, addr 0x300f1a4, size 0x104, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDidApplyAnimationProperties, addr 0x3010168, size 0x10, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnDisable, addr 0x300eedc, size 0x148, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x300edac, size 0x130, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnFillVBO, addr 0x300fe44, size 0x4, virtual true, abstract: false, final false
inline void OnFillVBO(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>*  vbo) ;

/// @brief Method OnPopulateMesh, addr 0x300fe48, size 0x98, virtual true, abstract: false, final false
inline void OnPopulateMesh(::UnityEngine::Mesh*  m) ;

/// @brief Method OnPopulateMesh, addr 0x300fee0, size 0x15c, virtual true, abstract: false, final false
inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper*  vh) ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x300e270, size 0xac, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method OnTransformParentChanged, addr 0x300e568, size 0xb4, virtual true, abstract: false, final false
inline void OnTransformParentChanged() ;

/// @brief Method PixelAdjustPoint, addr 0x3010608, size 0x140, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 PixelAdjustPoint(::UnityEngine::Vector2  point) ;

/// @brief Method Raycast, addr 0x301017c, size 0x48c, virtual true, abstract: false, final false
inline bool Raycast(::UnityEngine::Vector2  sp, ::UnityEngine::Camera*  eventCamera) ;

/// @brief Method Rebuild, addr 0x300f46c, size 0xe4, virtual true, abstract: false, final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  update) ;

/// @brief Method RegisterDirtyLayoutCallback, addr 0x3010aa0, size 0x80, virtual false, abstract: false, final false
inline void RegisterDirtyLayoutCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method RegisterDirtyMaterialCallback, addr 0x3010ca0, size 0x80, virtual false, abstract: false, final false
inline void RegisterDirtyMaterialCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method RegisterDirtyVerticesCallback, addr 0x3010ba0, size 0x80, virtual false, abstract: false, final false
inline void RegisterDirtyVerticesCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method SetAllDirty, addr 0x300df08, size 0x70, virtual true, abstract: false, final false
inline void SetAllDirty() ;

/// @brief Method SetLayoutDirty, addr 0x300e050, size 0xa0, virtual true, abstract: false, final false
inline void SetLayoutDirty() ;

/// @brief Method SetMaterialDirty, addr 0x300e1dc, size 0x94, virtual true, abstract: false, final false
inline void SetMaterialDirty() ;

/// @brief Method SetNativeSize, addr 0x3010178, size 0x4, virtual true, abstract: false, final false
inline void SetNativeSize() ;

/// @brief Method SetRaycastDirty, addr 0x300df78, size 0xd8, virtual false, abstract: false, final false
inline void SetRaycastDirty() ;

/// @brief Method SetVerticesDirty, addr 0x300e148, size 0x94, virtual true, abstract: false, final false
inline void SetVerticesDirty() ;

/// @brief Method UnityEngine.UI.ICanvasElement.get_transform, addr 0x3010e28, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::Transform> UnityEngine_UI_ICanvasElement_get_transform() ;

/// @brief Method UnregisterDirtyLayoutCallback, addr 0x3010b20, size 0x80, virtual false, abstract: false, final false
inline void UnregisterDirtyLayoutCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method UnregisterDirtyMaterialCallback, addr 0x3010d20, size 0x80, virtual false, abstract: false, final false
inline void UnregisterDirtyMaterialCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method UnregisterDirtyVerticesCallback, addr 0x3010c20, size 0x80, virtual false, abstract: false, final false
inline void UnregisterDirtyVerticesCallback(::UnityEngine::Events::UnityAction*  action) ;

/// @brief Method UpdateGeometry, addr 0x300f610, size 0x10, virtual true, abstract: false, final false
inline void UpdateGeometry() ;

/// @brief Method UpdateMaterial, addr 0x300f558, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x300de58, size 0xb0, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_canvas, addr 0x300da50, size 0x74, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Canvas> get_canvas() ;

/// @brief Method get_canvasRenderer, addr 0x300e994, size 0x90, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::CanvasRenderer> get_canvasRenderer() ;

/// @brief Method get_color, addr 0x300d928, size 0xc, virtual true, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_defaultGraphicMaterial, addr 0x300d84c, size 0xdc, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Material> get_defaultGraphicMaterial() ;

/// @brief Method get_defaultMaterial, addr 0x300ea24, size 0x4c, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_defaultMaterial() ;

/// @brief Method get_depth, addr 0x300e978, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_depth() ;

/// @brief Method get_mainTexture, addr 0x300ed54, size 0x58, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_mainTexture() ;

/// @brief Method get_material, addr 0x300ea70, size 0x88, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_material() ;

/// @brief Method get_materialForRendering, addr 0x300eb90, size 0x1c4, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_materialForRendering() ;

/// @brief Method get_raycastPadding, addr 0x300de2c, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector4 get_raycastPadding() ;

/// @brief Method get_raycastTarget, addr 0x300d96c, size 0x8, virtual true, abstract: false, final false
inline bool get_raycastTarget() ;

/// @brief Method get_rectTransform, addr 0x300e0f0, size 0x58, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_useLegacyMeshGeneration, addr 0x300de44, size 0x8, virtual false, abstract: false, final false
inline bool get_useLegacyMeshGeneration() ;

/// @brief Method get_workerMesh, addr 0x300fd24, size 0x120, virtual false, abstract: false, final false
...
/// @brief Method set_color, addr 0x300d934, size 0x38, virtual true, abstract: false, final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_material, addr 0x300eaf8, size 0x98, virtual true, abstract: false, final false
inline void set_material(::UnityEngine::Material*  value) ;

/// @brief Method set_raycastPadding, addr 0x300de38, size 0xc, virtual false, abstract: false, final false
inline void set_raycastPadding(::UnityEngine::Vector4  value) ;

/// @brief Method set_raycastTarget, addr 0x300d974, size 0xdc, virtual true, abstract: false, final false
inline void set_raycastTarget(bool  value) ;

/// @brief Method set_useLegacyMeshGeneration, addr 0x300de4c, size 0xc, virtual false, abstract: false, final false
