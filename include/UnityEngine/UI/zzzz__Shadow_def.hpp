...
/// @brief Method ApplyShadow, addr 0x3180d7c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ApplyShadowZeroAlloc, addr 0x3180a84, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method ModifyMesh, addr 0x3180d84, size 0x120, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31807b0, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_effectColor, addr 0x31807d8, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_effectColor() ;

/// @brief Method get_effectDistance, addr 0x31808b8, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_effectDistance() ;

/// @brief Method get_useGraphicAlpha, addr 0x31809c4, size 0x8, virtual false, abstract: false, final false
inline bool get_useGraphicAlpha() ;

/// @brief Method set_effectColor, addr 0x31807e4, size 0xd4, virtual false, abstract: false, final false
inline void set_effectColor(::UnityEngine::Color  value) ;

/// @brief Method set_effectDistance, addr 0x31808c0, size 0x104, virtual false, abstract: false, final false
inline void set_effectDistance(::UnityEngine::Vector2  value) ;

/// @brief Method set_useGraphicAlpha, addr 0x31809cc, size 0xb8, virtual false, abstract: false, final false
