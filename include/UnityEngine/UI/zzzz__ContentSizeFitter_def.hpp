...
// Dependencies UnityEngine.DrivenRectTransformTracker, UnityEngine.EventSystems.UIBehaviour, UnityEngine.UI.ContentSizeFitter::FitMode, UnityEngine.UI.ILayoutController, UnityEngine.UI.ILayoutSelfController
namespace UnityEngine::UI {
// Is value type: false
...
/// @brief Method HandleSelfFittingAlongAxis, addr 0x316622c, size 0xe4, virtual false, abstract: false, final false
inline void HandleSelfFittingAlongAxis(int32_t  axis) ;

static inline ::UnityEngine::UI::ContentSizeFitter* New_ctor() ;

/// @brief Method OnDisable, addr 0x31661ac, size 0x7c, virtual true, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x3166190, size 0x1c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnRectTransformDimensionsChange, addr 0x3166228, size 0x4, virtual true, abstract: false, final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method SetDirty, addr 0x3165ff4, size 0x84, virtual false, abstract: false, final false
inline void SetDirty() ;

/// @brief Method SetLayoutHorizontal, addr 0x3166328, size 0x24, virtual true, abstract: false, final false
inline void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical, addr 0x316634c, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3166188, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_horizontalFit, addr 0x3165f78, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::UI::ContentSizeFitter_FitMode get_horizontalFit() ;

/// @brief Method get_rectTransform, addr 0x31660f4, size 0x94, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RectTransform> get_rectTransform() ;

/// @brief Method get_verticalFit, addr 0x3166078, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_horizontalFit, addr 0x3165f80, size 0x74, virtual false, abstract: false, final false
inline void set_horizontalFit(::UnityEngine::UI::ContentSizeFitter_FitMode  value) ;

/// @brief Method set_verticalFit, addr 0x3166080, size 0x74, virtual false, abstract: false, final false
