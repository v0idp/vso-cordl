...
/// @brief Method OnDidApplyAnimationProperties, addr 0x316f7d0, size 0x3c, virtual true, abstract: false, final false
inline void OnDidApplyAnimationProperties() ;

/// @brief Method OnPopulateMesh, addr 0x316f14c, size 0x2c8, virtual true, abstract: false, final false
inline void OnPopulateMesh(::UnityEngine::UI::VertexHelper*  vh) ;

/// @brief Method SetNativeSize, addr 0x316ee98, size 0x2b4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x316ec0c, size 0x28, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_mainTexture, addr 0x316ec34, size 0x158, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_mainTexture() ;

/// @brief Method get_texture, addr 0x316ed8c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Texture> get_texture() ;

/// @brief Method get_uvRect, addr 0x316ee40, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_uvRect() ;

/// @brief Method set_texture, addr 0x316ed94, size 0xac, virtual false, abstract: false, final false
inline void set_texture(::UnityEngine::Texture*  value) ;

/// @brief Method set_uvRect, addr 0x316ee4c, size 0x4c, virtual false, abstract: false, final false
