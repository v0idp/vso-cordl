...
public:
// Declarations
/// @brief Method ModifyMesh, addr 0x31804ac, size 0x240, virtual true, abstract: false, final false
inline void ModifyMesh(::UnityEngine::UI::VertexHelper*  vh) ;

static inline ::UnityEngine::UI::Outline* New_ctor() ;

/// @brief Method .ctor, addr 0x31804a4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
