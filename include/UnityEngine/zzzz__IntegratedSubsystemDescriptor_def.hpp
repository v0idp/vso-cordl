...
/// @brief Method UnityEngine.ISubsystemDescriptor.Create, addr 0x2fcdaf8, size 0xc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2fcdb04, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x2fcda80, size 0x3c, virtual true, abstract: false, final true
