...
/// @brief Method Equals, addr 0x2f67448, size 0x44, virtual true, abstract: false, final true
inline bool Equals(::UnityEngine::RectInt  other) ;

/// @brief Method Overlaps, addr 0x2f66f90, size 0x2a0, virtual false, abstract: false, final false
inline bool Overlaps(::UnityEngine::RectInt  other) ;

/// @brief Method ToString, addr 0x2f67230, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2f67240, size 0x208, virtual true, abstract: false, final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method .ctor, addr 0x2f66f84, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int32_t  xMin, int32_t  yMin, int32_t  width, int32_t  height) ;

/// @brief Method get_height, addr 0x2f66de4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_height() ;

/// @brief Method get_width, addr 0x2f66dd4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_width() ;

/// @brief Method get_x, addr 0x2f66db4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_x() ;

/// @brief Method get_xMax, addr 0x2f66ebc, size 0x64, virtual false, abstract: false, final false
inline int32_t get_xMax() ;

/// @brief Method get_xMin, addr 0x2f66df4, size 0x64, virtual false, abstract: false, final false
inline int32_t get_xMin() ;

/// @brief Method get_y, addr 0x2f66dc4, size 0x8, virtual false, abstract: false, final false
inline int32_t get_y() ;

/// @brief Method get_yMax, addr 0x2f66f20, size 0x64, virtual false, abstract: false, final false
inline int32_t get_yMax() ;

/// @brief Method get_yMin, addr 0x2f66e58, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method set_height, addr 0x2f66dec, size 0x8, virtual false, abstract: false, final false
inline void set_height(int32_t  value) ;

/// @brief Method set_width, addr 0x2f66ddc, size 0x8, virtual false, abstract: false, final false
inline void set_width(int32_t  value) ;

/// @brief Method set_x, addr 0x2f66dbc, size 0x8, virtual false, abstract: false, final false
inline void set_x(int32_t  value) ;

/// @brief Method set_y, addr 0x2f66dcc, size 0x8, virtual false, abstract: false, final false
