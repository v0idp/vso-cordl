...
public:
// Declarations
/// @brief Method Add, addr 0x2f92b44, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method Clear, addr 0x2f92b48, size 0x4, virtual false, abstract: false, final false
inline void Clear() ;
