...
public:
// Declarations
/// @brief Method PropertyNameFromString, addr 0x2f85c5c, size 0x4c, virtual false, abstract: false, final false
static inline ::UnityEngine::PropertyName PropertyNameFromString(::StringW  name) ;

/// @brief Method PropertyNameFromString_Injected, addr 0x2f85ca8, size 0x44, virtual false, abstract: false, final false
