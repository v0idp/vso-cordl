...
/// @brief Method WantsEvent, addr 0x2facc7c, size 0x30, virtual false, abstract: false, final false
inline bool WantsEvent(::UnityEngine::EventType  type) ;

/// @brief Method WantsLayoutPass, addr 0x2faccac, size 0xdc, virtual false, abstract: false, final false
inline bool WantsLayoutPass(::UnityEngine::EventType  type) ;

/// @brief Method get_wantsLessLayoutEvents, addr 0x2facc74, size 0x8, virtual false, abstract: false, final false
inline bool get_wantsLessLayoutEvents() ;

/// @brief Method get_wantsMouseEnterLeaveWindow, addr 0x2facc60, size 0x8, virtual false, abstract: false, final false
inline bool get_wantsMouseEnterLeaveWindow() ;

/// @brief Method get_wantsMouseMove, addr 0x2facc4c, size 0x8, virtual false, abstract: false, final false
inline bool get_wantsMouseMove() ;

/// @brief Method set_wantsMouseEnterLeaveWindow, addr 0x2facc68, size 0xc, virtual false, abstract: false, final false
inline void set_wantsMouseEnterLeaveWindow(bool  value) ;

/// @brief Method set_wantsMouseMove, addr 0x2facc54, size 0xc, virtual false, abstract: false, final false
