...
/// @brief Method Invoke, addr 0x2f4c070, size 0xc0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2f4bf4c, size 0x80, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::AndroidJavaRunnable*  runnable) ;

/// @brief Method run, addr 0x2f4c04c, size 0x24, virtual false, abstract: false, final false
inline void run() ;
