...
/// @brief Method Finalize, addr 0x3001488, size 0x110, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetCharacters, addr 0x30019a4, size 0x44, virtual false, abstract: false, final false
inline void GetCharacters(::System::Collections::Generic::List_1<::UnityEngine::UICharInfo>*  characters) ;

/// @brief Method GetCharactersInternal, addr 0x30019e8, size 0x44, virtual false, abstract: false, final false
inline void GetCharactersInternal(::System::Object*  characters) ;

/// @brief Method GetLines, addr 0x3001a2c, size 0x44, virtual false, abstract: false, final false
inline void GetLines(::System::Collections::Generic::List_1<::UnityEngine::UILineInfo>*  lines) ;

/// @brief Method GetLinesInternal, addr 0x3001a70, size 0x44, virtual false, abstract: false, final false
inline void GetLinesInternal(::System::Object*  lines) ;

/// @brief Method GetPreferredHeight, addr 0x3001c48, size 0x60, virtual false, abstract: false, final false
inline float_t GetPreferredHeight(::StringW  str, ::UnityEngine::TextGenerationSettings  settings) ;

/// @brief Method GetPreferredWidth, addr 0x3001b3c, size 0x64, virtual false, abstract: false, final false
inline float_t GetPreferredWidth(::StringW  str, ::UnityEngine::TextGenerationSettings  settings) ;

/// @brief Method GetVertices, addr 0x3001ab4, size 0x44, virtual false, abstract: false, final false
inline void GetVertices(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>*  vertices) ;

/// @brief Method GetVerticesInternal, addr 0x3001af8, size 0x44, virtual false, abstract: false, final false
inline void GetVerticesInternal(::System::Object*  vertices) ;

/// @brief Method Internal_Create, addr 0x3001460, size 0x28, virtual false, abstract: false, final false
static inline ::System::IntPtr Internal_Create() ;

/// @brief Method Internal_Destroy, addr 0x30015f4, size 0x3c, virtual false, abstract: false, final false
static inline void Internal_Destroy(::System::IntPtr  ptr) ;

/// @brief Method Invalidate, addr 0x300199c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Populate, addr 0x3001ba0, size 0x50, virtual false, abstract: false, final false
inline bool Populate(::StringW  str, ::UnityEngine::TextGenerationSettings  settings) ;

/// @brief Method PopulateAlways, addr 0x3001ef0, size 0x108, virtual false, abstract: false, final false
inline ::UnityEngine::TextGenerationError PopulateAlways(::StringW  str, ::UnityEngine::TextGenerationSettings  settings) ;

/// @brief Method PopulateWithError, addr 0x3001e60, size 0x90, virtual false, abstract: false, final false
inline ::UnityEngine::TextGenerationError PopulateWithError(::StringW  str, ::UnityEngine::TextGenerationSettings  settings) ;

/// @brief Method PopulateWithErrors, addr 0x3001ca8, size 0x1b8, virtual false, abstract: false, final false
inline bool PopulateWithErrors(::StringW  str, ::UnityEngine::TextGenerationSettings  settings, ::UnityEngine::GameObject*  context) ;

/// @brief Method Populate_Internal, addr 0x3001ff8, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method Populate_Internal, addr 0x3002334, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method Populate_Internal_Injected, addr 0x3002480, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method System.IDisposable.Dispose, addr 0x3001598, size 0x5c, virtual true, abstract: false, final true
inline void System_IDisposable_Dispose() ;

/// @brief Method ValidatedSettings, addr 0x30016b0, size 0x2b0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x300130c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x3001314, size 0x14c, virtual false, abstract: false, final false
inline void _ctor(int32_t  initialCapacity) ;

/// @brief Method get_characterCount, addr 0x3001674, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_characterCount() ;

/// @brief Method get_characterCountVisible, addr 0x3001630, size 0x44, virtual false, abstract: false, final false
inline int32_t get_characterCountVisible() ;

/// @brief Method get_characters, addr 0x30021fc, size 0x5c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IList_1<::UnityEngine::UICharInfo>* get_characters() ;

/// @brief Method get_lineCount, addr 0x30022f8, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_lineCount() ;

/// @brief Method get_lines, addr 0x3002258, size 0x5c, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IList_1<::UnityEngine::UILineInfo>* get_lines() ;

/// @brief Method get_rectExtents, addr 0x3001bf0, size 0x58, virtual false, abstract: false, final false
inline ::UnityEngine::Rect get_rectExtents() ;

/// @brief Method get_rectExtents_Injected, addr 0x30022b4, size 0x44, virtual false, abstract: false, final false
inline void get_rectExtents_Injected(::ByRef<::UnityEngine::Rect>  ret) ;

/// @brief Method get_verts, addr 0x30021a0, size 0x5c, virtual false, abstract: false, final false
