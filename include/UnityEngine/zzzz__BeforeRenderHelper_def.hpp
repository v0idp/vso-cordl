...
/// @brief Method GetUpdateOrder, addr 0x2f67f68, size 0x118, virtual false, abstract: false, final false
static inline int32_t GetUpdateOrder(::UnityEngine::Events::UnityAction*  callback) ;

/// @brief Method Invoke, addr 0x2f5e93c, size 0x1a8, virtual false, abstract: false, final false
static inline void Invoke() ;

/// @brief Method RegisterCallback, addr 0x2f5d9e8, size 0x34c, virtual false, abstract: false, final false
static inline void RegisterCallback(::UnityEngine::Events::UnityAction*  callback) ;

/// @brief Method UnregisterCallback, addr 0x2f5dd88, size 0x304, virtual false, abstract: false, final false
