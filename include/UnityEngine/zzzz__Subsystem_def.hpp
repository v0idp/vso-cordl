...
/// @brief Method Destroy, addr 0x2fcdb48, size 0x74, virtual true, abstract: false, final true
inline void Destroy() ;
...
/// @brief Method .ctor, addr 0x2fcdc3c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
