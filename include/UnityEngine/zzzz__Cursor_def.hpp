...
public:
// Declarations
/// @brief Method SetCursor, addr 0x2f7b1a0, size 0x58, virtual false, abstract: false, final false
static inline void SetCursor(::UnityEngine::Texture2D*  texture, ::UnityEngine::Vector2  hotspot, ::UnityEngine::CursorMode  cursorMode) ;

/// @brief Method SetCursor_Injected, addr 0x2f7b1f8, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method get_lockState, addr 0x2f7b288, size 0x28, virtual false, abstract: false, final false
static inline ::UnityEngine::CursorLockMode get_lockState() ;

/// @brief Method set_lockState, addr 0x2f7b2b0, size 0x3c, virtual false, abstract: false, final false
static inline void set_lockState(::UnityEngine::CursorLockMode  value) ;

/// @brief Method set_visible, addr 0x2f7b24c, size 0x3c, virtual false, abstract: false, final false
