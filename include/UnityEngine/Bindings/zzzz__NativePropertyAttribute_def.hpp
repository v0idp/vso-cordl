...
/// @brief Method .ctor, addr 0x2fcd2e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2fcd2ec, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method .ctor, addr 0x2fcd2f0, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  isFree, ::UnityEngine::Bindings::TargetType  targetType) ;

/// @brief Method .ctor, addr 0x2fcd320, size 0x44, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  isFree, ::UnityEngine::Bindings::TargetType  targetType, bool  isThreadSafe) ;

/// @brief Method set_TargetType, addr 0x2fcd2dc, size 0x8, virtual false, abstract: false, final false
