...
/// @brief Method .ctor, addr 0x2fcd384, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2fcd3a0, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Bindings::CodegenOptions  codegenOptions) ;

/// @brief Method .ctor, addr 0x2fcd4c8, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Bindings::CodegenOptions  codegenOptions, ::StringW  intermediateStructName) ;

/// @brief Method .ctor, addr 0x2fcd3c8, size 0x100, virtual false, abstract: false, final false
inline void _ctor(::StringW  header) ;

/// @brief Method set_CodegenOptions, addr 0x2fcd37c, size 0x8, virtual true, abstract: false, final true
inline void set_CodegenOptions(::UnityEngine::Bindings::CodegenOptions  value) ;

/// @brief Method set_Header, addr 0x2fcd36c, size 0x8, virtual true, abstract: false, final true
inline void set_Header(::StringW  value) ;

/// @brief Method set_IntermediateScriptingStructName, addr 0x2fcd374, size 0x8, virtual false, abstract: false, final false
