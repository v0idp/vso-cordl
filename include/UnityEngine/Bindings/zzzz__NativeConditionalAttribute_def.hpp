...
/// @brief Method .ctor, addr 0x2fcceac, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  condition) ;

/// @brief Method .ctor, addr 0x2fccedc, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::StringW  condition, ::StringW  stubReturnStatement) ;

/// @brief Method set_Condition, addr 0x2fcce90, size 0x8, virtual false, abstract: false, final false
inline void set_Condition(::StringW  value) ;

/// @brief Method set_Enabled, addr 0x2fccea0, size 0xc, virtual false, abstract: false, final false
inline void set_Enabled(bool  value) ;

/// @brief Method set_StubReturnStatement, addr 0x2fcce98, size 0x8, virtual false, abstract: false, final false
