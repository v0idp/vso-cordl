...
/// @brief Method .ctor, addr 0x2fcd65c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_DoesNotContributeToSize, addr 0x2fcd650, size 0xc, virtual false, abstract: false, final false
