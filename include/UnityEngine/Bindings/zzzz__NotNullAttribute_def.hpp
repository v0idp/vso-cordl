...
/// @brief Method .ctor, addr 0x2fcd500, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  exception) ;

/// @brief Method set_Exception, addr 0x2fcd4f8, size 0x8, virtual false, abstract: false, final false
