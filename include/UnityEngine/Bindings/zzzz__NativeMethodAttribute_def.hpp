...
/// @brief Method .ctor, addr 0x2fcd17c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2fcd184, size 0xfc, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method .ctor, addr 0x2fcd280, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  isFreeFunction) ;

/// @brief Method .ctor, addr 0x2fcd2a8, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, bool  isFreeFunction, bool  isThreadSafe) ;

/// @brief Method set_HasExplicitThis, addr 0x2fcd170, size 0xc, virtual true, abstract: false, final true
inline void set_HasExplicitThis(bool  value) ;

/// @brief Method set_IsFreeFunction, addr 0x2fcd158, size 0xc, virtual true, abstract: false, final true
inline void set_IsFreeFunction(bool  value) ;

/// @brief Method set_IsThreadSafe, addr 0x2fcd14c, size 0xc, virtual true, abstract: false, final true
inline void set_IsThreadSafe(bool  value) ;

/// @brief Method set_Name, addr 0x2fcd144, size 0x8, virtual true, abstract: false, final true
inline void set_Name(::StringW  value) ;

/// @brief Method set_ThrowsException, addr 0x2fcd164, size 0xc, virtual true, abstract: false, final true
