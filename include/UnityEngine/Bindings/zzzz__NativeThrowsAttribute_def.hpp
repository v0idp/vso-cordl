...
/// @brief Method .ctor, addr 0x2fcd630, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_ThrowsException, addr 0x2fcd624, size 0xc, virtual true, abstract: false, final true
