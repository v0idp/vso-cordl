...
/// @brief Method .ctor, addr 0x2fccf18, size 0xfc, virtual false, abstract: false, final false
inline void _ctor(::StringW  header) ;

/// @brief Method set_Header, addr 0x2fccf10, size 0x8, virtual true, abstract: false, final true
