...
/// @brief Method .ctor, addr 0x2fcd01c, size 0xfc, virtual false, abstract: false, final false
inline void _ctor(::StringW  name) ;

/// @brief Method set_Name, addr 0x2fcd014, size 0x8, virtual true, abstract: false, final true
