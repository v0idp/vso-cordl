...
/// @brief Method .ctor, addr 0x2fcd124, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_WritableSelf, addr 0x2fcd118, size 0xc, virtual true, abstract: false, final true
