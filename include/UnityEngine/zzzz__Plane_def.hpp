...
/// @brief Method Raycast, addr 0x2f65fb4, size 0x100, virtual false, abstract: false, final false
inline bool Raycast(::UnityEngine::Ray  ray, ::ByRef<float_t>  enter) ;

/// @brief Method ToString, addr 0x2f660b4, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2f660c4, size 0x188, virtual true, abstract: false, final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  formatProvider) ;

/// @brief Method .ctor, addr 0x2f65e3c, size 0x178, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector3  a, ::UnityEngine::Vector3  b, ::UnityEngine::Vector3  c) ;

/// @brief Method .ctor, addr 0x2f65d2c, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Vector3  inNormal, ::UnityEngine::Vector3  inPoint) ;

/// @brief Method get_distance, addr 0x2f65d24, size 0x8, virtual false, abstract: false, final false
inline float_t get_distance() ;

/// @brief Method get_normal, addr 0x2f65d18, size 0xc, virtual false, abstract: false, final false
