...
/// @brief Method Destroy, addr 0x2f675c8, size 0x5c, virtual false, abstract: false, final false
inline void Destroy() ;

/// @brief Method Finalize, addr 0x2f67528, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method InternalCreate, addr 0x2f674d4, size 0x28, virtual false, abstract: false, final false
static inline ::System::IntPtr InternalCreate() ;

/// @brief Method InternalDestroy, addr 0x2f67be0, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method ToString, addr 0x2f67848, size 0x10, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method ToString, addr 0x2f67858, size 0x298, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2f6748c, size 0x48, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x2f67624, size 0x114, virtual false, abstract: false, final false
inline void _ctor(int32_t  left, int32_t  right, int32_t  top, int32_t  bottom) ;

/// @brief Method .ctor, addr 0x2f674fc, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  sourceStyle, ::System::IntPtr  source) ;

/// @brief Method get_bottom, addr 0x2f67ba4, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_bottom() ;

/// @brief Method get_horizontal, addr 0x2f67c1c, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_horizontal() ;

/// @brief Method get_left, addr 0x2f67af0, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_left() ;

/// @brief Method get_right, addr 0x2f67b2c, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_right() ;

/// @brief Method get_top, addr 0x2f67b68, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_top() ;

/// @brief Method get_vertical, addr 0x2f67c58, size 0x3c, virtual false, abstract: false, final false
inline int32_t get_vertical() ;

/// @brief Convert to "::System::IFormattable"
constexpr ::System::IFormattable* i___System__IFormattable() noexcept;

/// @brief Method set_bottom, addr 0x2f67804, size 0x44, virtual false, abstract: false, final false
inline void set_bottom(int32_t  value) ;

/// @brief Method set_left, addr 0x2f67738, size 0x44, virtual false, abstract: false, final false
inline void set_left(int32_t  value) ;

/// @brief Method set_right, addr 0x2f6777c, size 0x44, virtual false, abstract: false, final false
inline void set_right(int32_t  value) ;

/// @brief Method set_top, addr 0x2f677c0, size 0x44, virtual false, abstract: false, final false
