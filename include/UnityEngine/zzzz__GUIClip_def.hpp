...
/// @brief Method Dispose, addr 0x2faf3f8, size 0x40, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method .ctor, addr 0x2faf3a4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method GetMatrix, addr 0x2fada58, size 0x64, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 GetMatrix() ;

/// @brief Method GetMatrix_Injected, addr 0x2faf214, size 0x3c, virtual false, abstract: false, final false
static inline void GetMatrix_Injected(::ByRef<::UnityEngine::Matrix4x4>  ret) ;

/// @brief Method Internal_GetCount, addr 0x2faf1ec, size 0x28, virtual false, abstract: false, final false
static inline int32_t Internal_GetCount() ;

/// @brief Method Internal_Pop, addr 0x2faf1c4, size 0x28, virtual false, abstract: false, final false
static inline void Internal_Pop() ;

/// @brief Method Internal_PopParentClip, addr 0x2faf37c, size 0x28, virtual false, abstract: false, final false
static inline void Internal_PopParentClip() ;

/// @brief Method Internal_PushParentClip, addr 0x2faf28c, size 0x40, virtual false, abstract: false, final false
static inline void Internal_PushParentClip(::UnityEngine::Matrix4x4  objectTransform, ::UnityEngine::Rect  clipRect) ;

/// @brief Method Internal_PushParentClip, addr 0x2faf2cc, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method Internal_PushParentClip_Injected, addr 0x2faf328, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SetMatrix, addr 0x2fadb08, size 0x3c, virtual false, abstract: false, final false
static inline void SetMatrix(::UnityEngine::Matrix4x4  m) ;

/// @brief Method SetMatrix_Injected, addr 0x2faf250, size 0x3c, virtual false, abstract: false, final false
static inline void SetMatrix_Injected(::ByRef<::UnityEngine::Matrix4x4>  m) ;

/// @brief Method get_visibleRect, addr 0x2fae524, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::Rect get_visibleRect() ;

/// @brief Method get_visibleRect_Injected, addr 0x2faf188, size 0x3c, virtual false, abstract: false, final false
