...
/// @brief Method Clone, addr 0x2bfcc3c, size 0x74, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathNavigator* Clone() ;

/// @brief Method GetPositionHashCode, addr 0x2bfd568, size 0xc, virtual false, abstract: false, final false
inline int32_t GetPositionHashCode() ;

/// @brief Method HasLineInfo, addr 0x2bfd384, size 0x44, virtual true, abstract: false, final true
inline bool HasLineInfo() ;

/// @brief Method IsSamePosition, addr 0x2bfd2d0, size 0xa4, virtual true, abstract: false, final false
inline bool IsSamePosition(::System::Xml::XPath::XPathNavigator*  other) ;

/// @brief Method MoveToFirstNamespace, addr 0x2bfce5c, size 0xf0, virtual true, abstract: false, final false
inline bool MoveToFirstNamespace(::System::Xml::XPath::XPathNamespaceScope  namespaceScope) ;

/// @brief Method MoveToNextNamespace, addr 0x2bfd118, size 0x114, virtual true, abstract: false, final false
inline bool MoveToNextNamespace(::System::Xml::XPath::XPathNamespaceScope  scope) ;

/// @brief Method MoveToParent, addr 0x2bfd250, size 0x2c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bfc7e8, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method get_LineNumber, addr 0x2bfd3c8, size 0x84, virtual true, abstract: false, final true
inline int32_t get_LineNumber() ;

/// @brief Method get_LinePosition, addr 0x2bfd474, size 0xa4, virtual true, abstract: false, final true
inline int32_t get_LinePosition() ;

/// @brief Method get_LocalName, addr 0x2bfccf4, size 0x3c, virtual true, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NameTable, addr 0x2bfcdfc, size 0x44, virtual true, abstract: false, final false
inline ::System::Xml::XmlNameTable* get_NameTable() ;

/// @brief Method get_NamespaceURI, addr 0x2bfcd4c, size 0x3c, virtual true, abstract: false, final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_NodeType, addr 0x2bfccb0, size 0x38, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathNodeType get_NodeType() ;

/// @brief Method get_Prefix, addr 0x2bfcda4, size 0x3c, virtual true, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_UnderlyingObject, addr 0x2bfd374, size 0x10, virtual true, abstract: false, final false
inline ::System::Object* get_UnderlyingObject() ;

/// @brief Method get_Value, addr 0x2bfc86c, size 0x1f0, virtual true, abstract: false, final false
