...
/// @brief Method get_Document, addr 0x2bfd6c8, size 0x8, virtual false, abstract: false, final false
inline ::System::Xml::XPath::XPathDocument* get_Document() ;

/// @brief Method get_LineNumberBase, addr 0x2bfd6d0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LineNumberBase() ;

/// @brief Method get_LinePositionBase, addr 0x2bfd6d8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_LinePositionBase() ;

/// @brief Method get_LocalName, addr 0x2bfd6a0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NamespaceUri, addr 0x2bfd6a8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_NamespaceUri() ;

/// @brief Method get_PageInfo, addr 0x2bfd698, size 0x8, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::Cache::XPathNodePageInfo* get_PageInfo() ;

/// @brief Method get_ParentPage, addr 0x2bfd6c0, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::MS::Internal::Xml::Cache::XPathNode,::Array<::MS::Internal::Xml::Cache::XPathNode>*> get_ParentPage() ;

/// @brief Method get_Prefix, addr 0x2bfd6b0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SiblingPage, addr 0x2bfd6b8, size 0x8, virtual false, abstract: false, final false
