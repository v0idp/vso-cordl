...
/// @brief Method .ctor, addr 0x2bf9298, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  name, ::StringW  prefix) ;

/// @brief Method get_ReturnType, addr 0x2bf92cc, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathResultType get_ReturnType() ;

/// @brief Method get_Type, addr 0x2bf92c4, size 0x8, virtual true, abstract: false, final false
