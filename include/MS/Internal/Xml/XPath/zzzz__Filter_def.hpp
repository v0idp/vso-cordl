...
/// @brief Method .ctor, addr 0x2bf8cf8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::MS::Internal::Xml::XPath::AstNode*  input, ::MS::Internal::Xml::XPath::AstNode*  condition) ;

/// @brief Method get_ReturnType, addr 0x2bf8d2c, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathResultType get_ReturnType() ;

/// @brief Method get_Type, addr 0x2bf8d24, size 0x8, virtual true, abstract: false, final false
