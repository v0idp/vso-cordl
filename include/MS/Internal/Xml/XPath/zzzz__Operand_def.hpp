...
/// @brief Method .ctor, addr 0x2bf90d4, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  val) ;

/// @brief Method .ctor, addr 0x2bf9104, size 0x70, virtual false, abstract: false, final false
inline void _ctor(double_t  val) ;

/// @brief Method get_ReturnType, addr 0x2bf917c, size 0x8, virtual true, abstract: false, final false
inline ::System::Xml::XPath::XPathResultType get_ReturnType() ;

/// @brief Method get_Type, addr 0x2bf9174, size 0x8, virtual true, abstract: false, final false
