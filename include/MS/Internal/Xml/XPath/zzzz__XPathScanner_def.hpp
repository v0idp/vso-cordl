...
/// @brief Method NextChar, addr 0x2bfc45c, size 0x60, virtual false, abstract: false, final false
inline bool NextChar() ;

/// @brief Method NextLex, addr 0x2bfb0a0, size 0x3bc, virtual false, abstract: false, final false
inline bool NextLex() ;

/// @brief Method ScanFraction, addr 0x2bfc538, size 0xb0, virtual false, abstract: false, final false
inline double_t ScanFraction() ;

/// @brief Method ScanName, addr 0x2bfc770, size 0x78, virtual false, abstract: false, final false
inline ::StringW ScanName() ;

/// @brief Method ScanNumber, addr 0x2bfc698, size 0xd8, virtual false, abstract: false, final false
inline double_t ScanNumber() ;

/// @brief Method ScanString, addr 0x2bfc5e8, size 0xb0, virtual false, abstract: false, final false
inline ::StringW ScanString() ;

/// @brief Method SkipSpace, addr 0x2bfc4fc, size 0x3c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2bf93e4, size 0x98, virtual false, abstract: false, final false
inline void _ctor(::StringW  xpathExpr) ;

/// @brief Method get_CanBeFunction, addr 0x2bfc4f4, size 0x8, virtual false, abstract: false, final false
inline bool get_CanBeFunction() ;

/// @brief Method get_CurrentChar, addr 0x2bfc4c4, size 0x8, virtual false, abstract: false, final false
inline char16_t get_CurrentChar() ;

/// @brief Method get_Kind, addr 0x2bfc4cc, size 0x8, virtual false, abstract: false, final false
inline ::MS::Internal::Xml::XPath::XPathScanner_LexKind get_Kind() ;

/// @brief Method get_Name, addr 0x2bfc4d4, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_NumberValue, addr 0x2bfc4ec, size 0x8, virtual false, abstract: false, final false
inline double_t get_NumberValue() ;

/// @brief Method get_Prefix, addr 0x2bfc4dc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Prefix() ;

/// @brief Method get_SourceText, addr 0x2bfc4bc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_SourceText() ;

/// @brief Method get_StringValue, addr 0x2bfc4e4, size 0x8, virtual false, abstract: false, final false
