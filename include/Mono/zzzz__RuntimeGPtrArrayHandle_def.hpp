...
/// @brief Method DestroyAndFree, addr 0x25ca3c8, size 0x1c, virtual false, abstract: false, final false
static inline void DestroyAndFree(::ByRef<::Mono::RuntimeGPtrArrayHandle>  h) ;

/// @brief Method GPtrArrayFree, addr 0x25ca3c4, size 0x4, virtual false, abstract: false, final false
static inline void GPtrArrayFree(::cordl_internals::Ptr<::Mono::RuntimeStructs_GPtrArray>  value) ;

/// @brief Method Lookup, addr 0x25ca360, size 0x64, virtual false, abstract: false, final false
inline ::System::IntPtr Lookup(int32_t  i) ;

/// @brief Method .ctor, addr 0x25ca320, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  ptr) ;

/// @brief Method get_Item, addr 0x25ca35c, size 0x4, virtual false, abstract: false, final false
inline ::System::IntPtr get_Item(int32_t  i) ;

/// @brief Method get_Length, addr 0x25ca340, size 0x1c, virtual false, abstract: false, final false
