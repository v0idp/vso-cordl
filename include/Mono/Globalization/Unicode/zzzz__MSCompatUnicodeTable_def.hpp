...
/// @brief Method <BuildTailoringTables>b__17_0, addr 0x25ceb4c, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25ceb44, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method BuildTailoringTables, addr 0x25cceac, size 0x750, virtual false, abstract: false, final false
...
/// @brief Method Category, addr 0x25cd85c, size 0xa4, virtual false, abstract: false, final false
static inline uint8_t Category(int32_t  cp) ;

/// @brief Method FillCJK, addr 0x25ce504, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method FillCJKCore, addr 0x25ce664, size 0x484, virtual false, abstract: false, final false
...
/// @brief Method GetResource, addr 0x25cdfec, size 0xb8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetResource(::StringW  name) ;

/// @brief Method GetTailoringInfo, addr 0x25ccda8, size 0x104, virtual false, abstract: false, final false
static inline ::Mono::Globalization::Unicode::TailoringInfo* GetTailoringInfo(int32_t  lcid) ;

/// @brief Method HasSpecialWeight, addr 0x25cde00, size 0x80, virtual false, abstract: false, final false
static inline bool HasSpecialWeight(char16_t  c) ;

/// @brief Method IsHalfWidthKana, addr 0x25cde80, size 0x14, virtual false, abstract: false, final false
static inline bool IsHalfWidthKana(char16_t  c) ;

/// @brief Method IsHiragana, addr 0x25cde94, size 0x18, virtual false, abstract: false, final false
static inline bool IsHiragana(char16_t  c) ;

/// @brief Method IsIgnorable, addr 0x25cdaec, size 0x118, virtual false, abstract: false, final false
static inline bool IsIgnorable(int32_t  cp, uint8_t  flag) ;

/// @brief Method IsIgnorableNonSpacing, addr 0x25cdc04, size 0x58, virtual false, abstract: false, final false
static inline bool IsIgnorableNonSpacing(int32_t  cp) ;

/// @brief Method IsJapaneseSmallLetter, addr 0x25cdeac, size 0xe8, virtual false, abstract: false, final false
static inline bool IsJapaneseSmallLetter(char16_t  c) ;

/// @brief Method Level1, addr 0x25cd900, size 0xa4, virtual false, abstract: false, final false
static inline uint8_t Level1(int32_t  cp) ;

/// @brief Method Level2, addr 0x25cd9a4, size 0xa4, virtual false, abstract: false, final false
static inline uint8_t Level2(int32_t  cp) ;

/// @brief Method Level3, addr 0x25cda48, size 0xa4, virtual false, abstract: false, final false
static inline uint8_t Level3(int32_t  cp) ;

/// @brief Method SetCJKReferences, addr 0x25cd5fc, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method ToKanaTypeInsensitive, addr 0x25cdc5c, size 0x18, virtual false, abstract: false, final false
static inline int32_t ToKanaTypeInsensitive(int32_t  i) ;

/// @brief Method ToWidthCompat, addr 0x25cdc74, size 0x18c, virtual false, abstract: false, final false
static inline int32_t ToWidthCompat(int32_t  i) ;

/// @brief Method UInt32FromBytePtr, addr 0x25ce0a4, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method get_IsReady, addr 0x25cdf94, size 0x58, virtual false, abstract: false, final false
