...
/// @brief Method MapIdx, addr 0x25cf354, size 0x68, virtual false, abstract: false, final false
static inline int32_t MapIdx(int32_t  cp) ;

/// @brief Method PropIdx, addr 0x25cf2ec, size 0x68, virtual false, abstract: false, final false
