...
/// @brief Method Compare, addr 0x25ccc80, size 0x94, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x25ccd14, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
