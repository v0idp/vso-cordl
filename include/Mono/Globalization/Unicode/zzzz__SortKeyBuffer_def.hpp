...
/// @brief Method AppendBufferPrimitive, addr 0x25d4ac8, size 0xc8, virtual false, abstract: false, final false
inline void AppendBufferPrimitive(uint8_t  value, ::ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  buf, ::ByRef<int32_t>  bidx) ;

/// @brief Method AppendCJKExtension, addr 0x25d0fdc, size 0x94, virtual false, abstract: false, final false
inline void AppendCJKExtension(uint8_t  lv1msb, uint8_t  lv1lsb) ;

/// @brief Method AppendKana, addr 0x25d1128, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method AppendLevel5, addr 0x25d4b90, size 0x98, virtual false, abstract: false, final false
inline void AppendLevel5(uint8_t  category, uint8_t  lv1) ;

/// @brief Method AppendNormal, addr 0x25d0e98, size 0x144, virtual false, abstract: false, final false
inline void AppendNormal(uint8_t  category, uint8_t  lv1, uint8_t  lv2, uint8_t  lv3) ;

/// @brief Method GetOptimizedLength, addr 0x25d5100, size 0x60, virtual false, abstract: false, final false
inline int32_t GetOptimizedLength(::ArrayW<uint8_t,::Array<uint8_t>*>  data, int32_t  len, uint8_t  defaultValue) ;

/// @brief Method GetResult, addr 0x25d4c28, size 0x4d8, virtual false, abstract: false, final false
inline ::System::Globalization::SortKey* GetResult() ;

/// @brief Method GetResultAndReset, addr 0x25d0a60, size 0x24, virtual false, abstract: false, final false
inline ::System::Globalization::SortKey* GetResultAndReset() ;

/// @brief Method Initialize, addr 0x25d0570, size 0x178, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x25d4ab4, size 0x14, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x25d0568, size 0x8, virtual false, abstract: false, final false
