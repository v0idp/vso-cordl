...
public:
// Declarations
/// @brief Method .ctor, addr 0x25d0ae4, size 0x1c, virtual false, abstract: false, final false
...
constexpr SimpleCollator_Context(::System::Globalization::CompareOptions  Option, ::cordl_internals::Ptr<uint8_t>  NeverMatchFlags, ::cordl_internals::Ptr<uint8_t>  AlwaysMatchFlags, ::cordl_internals::Ptr<uint8_t>  Buffer1, ::cordl_internals::Ptr<uint8_t>  Buffer2, int32_t  PrevCode, ::cordl_internals::Ptr<uint8_t>  PrevSortKey) noexcept;
...
public:
// Declarations
/// @brief Method .ctor, addr 0x25d27ec, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Category, addr 0x25cf834, size 0x94, virtual false, abstract: false, final false
inline uint8_t Category(int32_t  cp) ;

/// @brief Method ClearBuffer, addr 0x25d0a84, size 0x60, virtual false, abstract: false, final false
inline void ClearBuffer(::cordl_internals::Ptr<uint8_t>  buffer, int32_t  size) ;

/// @brief Method Compare, addr 0x25d11c0, size 0xb0, virtual false, abstract: false, final false
...
/// @brief Method CompareFlagPair, addr 0x25d27fc, size 0x1c, virtual false, abstract: false, final false
inline int32_t CompareFlagPair(bool  b1, bool  b2) ;

/// @brief Method CompareInternal, addr 0x25d1270, size 0x157c, virtual false, abstract: false, final false
inline int32_t CompareInternal(::StringW  s1, int32_t  idx1, int32_t  len1, ::StringW  s2, int32_t  idx2, int32_t  len2, ::ByRef<bool>  targetConsumed, ::ByRef<bool>  sourceConsumed, bool  skipHeadingExtenders, bool  immediateBreakup, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method FillSortKeyRaw, addr 0x25d0b00, size 0x398, virtual false, abstract: false, final false
...
/// @brief Method FillSurrogateSortKeyRaw, addr 0x25d1070, size 0xb8, virtual false, abstract: false, final false
inline void FillSurrogateSortKeyRaw(int32_t  i, ::Mono::Globalization::Unicode::SortKeyBuffer*  buf) ;

/// @brief Method FilterExtender, addr 0x25d0198, size 0x210, virtual false, abstract: false, final false
...
/// @brief Method FilterOptions, addr 0x25cff94, size 0xe4, virtual false, abstract: false, final false
inline int32_t FilterOptions(int32_t  i, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method GetContraction, addr 0x25cfb04, size 0xc0, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::Contraction* GetContraction(::StringW  s, int32_t  start, int32_t  end) ;

/// @brief Method GetContraction, addr 0x25cfbc4, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method GetExtenderType, addr 0x25d0078, size 0x100, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType GetExtenderType(int32_t  i) ;

/// @brief Method GetNeutralCulture, addr 0x25cf7c4, size 0x70, virtual false, abstract: false, final false
static inline ::System::Globalization::CultureInfo* GetNeutralCulture(::System::Globalization::CultureInfo*  info) ;

/// @brief Method GetSortKey, addr 0x25d0480, size 0x20, virtual true, abstract: false, final true
inline ::System::Globalization::SortKey* GetSortKey(::StringW  s, ::System::Globalization::CompareOptions  options) ;

/// @brief Method GetSortKey, addr 0x25d04a0, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method GetSortKey, addr 0x25d06e8, size 0x378, virtual false, abstract: false, final false
...
/// @brief Method GetTailContraction, addr 0x25cfcec, size 0xc0, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::Contraction* GetTailContraction(::StringW  s, int32_t  start, int32_t  end) ;

/// @brief Method GetTailContraction, addr 0x25cfdac, size 0x1e8, virtual false, abstract: false, final false
...
/// @brief Method IndexOf, addr 0x25d2cf0, size 0x1f0, virtual true, abstract: false, final true
inline int32_t IndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IndexOf, addr 0x25d2ee0, size 0x4a8, virtual false, abstract: false, final false
inline int32_t IndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::cordl_internals::Ptr<uint8_t>  targetSortKey, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method IndexOfOrdinal, addr 0x25d3388, size 0xd8, virtual false, abstract: false, final false
inline int32_t IndexOfOrdinal(::StringW  s, ::StringW  target, int32_t  start, int32_t  length) ;

/// @brief Method IndexOfOrdinal, addr 0x25d3460, size 0x70, virtual false, abstract: false, final false
inline int32_t IndexOfOrdinal(::StringW  s, char16_t  target, int32_t  start, int32_t  length) ;

/// @brief Method IndexOfSortKey, addr 0x25d34d0, size 0x9c, virtual false, abstract: false, final false
inline int32_t IndexOfSortKey(::StringW  s, int32_t  start, int32_t  length, ::cordl_internals::Ptr<uint8_t>  sortkey, char16_t  target, int32_t  ti, bool  noLv4, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method IsHalfKana, addr 0x25cfa90, size 0x74, virtual false, abstract: false, final false
static inline bool IsHalfKana(int32_t  cp, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsIgnorable, addr 0x25d03a8, size 0x7c, virtual false, abstract: false, final false
static inline bool IsIgnorable(int32_t  i, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsPrefix, addr 0x25d2838, size 0xac, virtual false, abstract: false, final false
inline bool IsPrefix(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsPrefix, addr 0x25d28e4, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method IsPrefix, addr 0x25d2818, size 0x20, virtual true, abstract: false, final true
inline bool IsPrefix(::StringW  src, ::StringW  target, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsSafe, addr 0x25d0424, size 0x5c, virtual false, abstract: false, final false
inline bool IsSafe(int32_t  i) ;

/// @brief Method IsSuffix, addr 0x25d296c, size 0x94, virtual false, abstract: false, final false
inline bool IsSuffix(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsSuffix, addr 0x25d294c, size 0x20, virtual true, abstract: false, final true
inline bool IsSuffix(::StringW  src, ::StringW  target, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method LastIndexOf, addr 0x25d2a00, size 0x188, virtual true, abstract: false, final true
inline int32_t LastIndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method LastIndexOf, addr 0x25d3738, size 0x52c, virtual false, abstract: false, final false
inline int32_t LastIndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::cordl_internals::Ptr<uint8_t>  targetSortKey, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method LastIndexOfOrdinal, addr 0x25d3c64, size 0x134, virtual false, abstract: false, final false
inline int32_t LastIndexOfOrdinal(::StringW  s, ::StringW  target, int32_t  start, int32_t  length) ;

/// @brief Method LastIndexOfSortKey, addr 0x25d3d98, size 0xa4, virtual false, abstract: false, final false
inline int32_t LastIndexOfSortKey(::StringW  s, int32_t  start, int32_t  orgStart, int32_t  length, ::cordl_internals::Ptr<uint8_t>  sortkey, int32_t  ti, bool  noLv4, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method Level1, addr 0x25cf8c8, size 0x94, virtual false, abstract: false, final false
inline uint8_t Level1(int32_t  cp) ;

/// @brief Method Level2, addr 0x25cf95c, size 0x134, virtual false, abstract: false, final false
inline uint8_t Level2(int32_t  cp, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext) ;

/// @brief Method MatchesBackward, addr 0x25d3e3c, size 0x1d8, virtual false, abstract: false, final false
inline bool MatchesBackward(::StringW  s, ::ByRef<int32_t>  idx, int32_t  end, int32_t  orgStart, int32_t  ti, ::cordl_internals::Ptr<uint8_t>  sortkey, bool  noLv4, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method MatchesBackwardCore, addr 0x25d45a0, size 0x484, virtual false, abstract: false, final false
...
/// @brief Method MatchesForward, addr 0x25d356c, size 0x1cc, virtual false, abstract: false, final false
inline bool MatchesForward(::StringW  s, ::ByRef<int32_t>  idx, int32_t  end, int32_t  ti, ::cordl_internals::Ptr<uint8_t>  sortkey, bool  noLv4, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method MatchesForwardCore, addr 0x25d4014, size 0x364, virtual false, abstract: false, final false
inline bool MatchesForwardCore(::StringW  s, ::ByRef<int32_t>  idx, int32_t  end, int32_t  ti, ::cordl_internals::Ptr<uint8_t>  sortkey, bool  noLv4, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext, ::ByRef<::Mono::Globalization::Unicode::Contraction*>  ct, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method MatchesPrimitive, addr 0x25d4378, size 0x228, virtual false, abstract: false, final false
inline bool MatchesPrimitive(::System::Globalization::CompareOptions  opt, ::cordl_internals::Ptr<uint8_t>  source, int32_t  si, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext, ::cordl_internals::Ptr<uint8_t>  target, int32_t  ti, bool  noLv4) ;

static inline ::Mono::Globalization::Unicode::SimpleCollator* New_ctor(::System::Globalization::CultureInfo*  culture) ;

/// @brief Method QuickIndexOf, addr 0x25d2b88, size 0x168, virtual false, abstract: false, final false
inline int32_t QuickIndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::ByRef<bool>  testWasUnable) ;

/// @brief Method SetCJKTable, addr 0x25cf6e8, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method System.Globalization.ISimpleCollator.Compare, addr 0x25d11bc, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method ToDashTypeValue, addr 0x25d0178, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25cf3bc, size 0x32c, virtual false, abstract: false, final false
