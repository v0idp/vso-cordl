...
// Dependencies Mono.ISystemDependencyProvider, System.Object
namespace Mono {
// Is value type: false
...
/// @brief Method Initialize, addr 0x2a02f1c, size 0x144, virtual false, abstract: false, final false
static inline void Initialize() ;

/// @brief Method Mono.ISystemDependencyProvider.get_CertificateProvider, addr 0x2a030f8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x2a03060, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_CertificateProvider, addr 0x2a03100, size 0x8, virtual false, abstract: false, final false
inline ::Mono::SystemCertificateProvider* get_CertificateProvider() ;

/// @brief Method get_Instance, addr 0x2a02ec0, size 0x5c, virtual false, abstract: false, final false
static inline ::Mono::SystemDependencyProvider* get_Instance() ;

/// @brief Method get_X509Pal, addr 0x2a03108, size 0x18, virtual false, abstract: false, final false
