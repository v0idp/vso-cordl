...
/// @brief Method Add, addr 0x25cc698, size 0x10c, virtual false, abstract: false, final false
inline void Add(::StringW  name, ::StringW  value) ;

/// @brief Method Clear, addr 0x25cc1d4, size 0x9c, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method GetName, addr 0x25cc7ec, size 0x58, virtual true, abstract: false, final true
inline ::StringW GetName(int32_t  i) ;

/// @brief Method GetValue, addr 0x25cc844, size 0x58, virtual true, abstract: false, final true
inline ::StringW GetValue(int32_t  i) ;

/// @brief Method GetValue, addr 0x25cc89c, size 0xc0, virtual true, abstract: false, final true
inline ::StringW GetValue(::StringW  name) ;
...
/// @brief Method .ctor, addr 0x25cae6c, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Length, addr 0x25cc7a4, size 0x48, virtual true, abstract: false, final true
inline int32_t get_Length() ;

/// @brief Method get_Names, addr 0x25cc95c, size 0x50, virtual true, abstract: false, final true
inline ::ArrayW<::StringW,::Array<::StringW>*> get_Names() ;

/// @brief Method get_Values, addr 0x25cc9ac, size 0x50, virtual true, abstract: false, final true
inline ::ArrayW<::StringW,::Array<::StringW>*> get_Values() ;
...
/// @brief Method Cleanup, addr 0x25cc158, size 0x7c, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method Error, addr 0x25caf00, size 0x70, virtual false, abstract: false, final false
inline ::System::Exception* Error(::StringW  msg) ;

/// @brief Method Expect, addr 0x25cb43c, size 0xc0, virtual false, abstract: false, final false
inline void Expect(int32_t  c) ;

/// @brief Method HandleBufferedContent, addr 0x25cc020, size 0x138, virtual false, abstract: false, final false
inline void HandleBufferedContent() ;

/// @brief Method HandleWhitespaces, addr 0x25cb300, size 0xc0, virtual false, abstract: false, final false
inline void HandleWhitespaces() ;

/// @brief Method IsNameChar, addr 0x25cb128, size 0xfc, virtual false, abstract: false, final false
inline bool IsNameChar(char16_t  c, bool  start) ;

/// @brief Method IsWhitespace, addr 0x25cb224, size 0x28, virtual false, abstract: false, final false
inline bool IsWhitespace(int32_t  c) ;

static inline ::Mono::Xml::SmallXmlParser* New_ctor() ;

/// @brief Method Parse, addr 0x25ca90c, size 0x1c8, virtual false, abstract: false, final false
inline void Parse(::System::IO::TextReader*  input, ::Mono::Xml::SmallXmlParser_IContentHandler*  handler) ;

/// @brief Method Peek, addr 0x25cb41c, size 0x20, virtual false, abstract: false, final false
inline int32_t Peek() ;

/// @brief Method Read, addr 0x25cb3c0, size 0x5c, virtual false, abstract: false, final false
inline int32_t Read() ;

/// @brief Method ReadAttribute, addr 0x25cc3f0, size 0x164, virtual false, abstract: false, final false
inline void ReadAttribute(::Mono::Xml::SmallXmlParser_AttrListImpl*  a) ;

/// @brief Method ReadCDATASection, addr 0x25cc270, size 0xf8, virtual false, abstract: false, final false
inline void ReadCDATASection() ;

/// @brief Method ReadCharacterReference, addr 0x25cc5dc, size 0xbc, virtual false, abstract: false, final false
inline int32_t ReadCharacterReference() ;

/// @brief Method ReadCharacters, addr 0x25cc554, size 0x88, virtual false, abstract: false, final false
inline void ReadCharacters() ;

/// @brief Method ReadComment, addr 0x25cc368, size 0x88, virtual false, abstract: false, final false
inline void ReadComment() ;

/// @brief Method ReadContent, addr 0x25cb944, size 0x6dc, virtual false, abstract: false, final false
inline void ReadContent() ;

/// @brief Method ReadName, addr 0x25cb7a0, size 0x1a4, virtual false, abstract: false, final false
inline ::StringW ReadName() ;

/// @brief Method ReadReference, addr 0x25cb5d8, size 0x1c8, virtual false, abstract: false, final false
inline void ReadReference() ;

/// @brief Method ReadUntil, addr 0x25cb4fc, size 0xdc, virtual false, abstract: false, final false
inline ::StringW ReadUntil(char16_t  until, bool  handleReferences) ;

/// @brief Method SkipWhitespaces, addr 0x25cb24c, size 0x8, virtual false, abstract: false, final false
inline void SkipWhitespaces() ;

/// @brief Method SkipWhitespaces, addr 0x25cb254, size 0xac, virtual false, abstract: false, final false
inline void SkipWhitespaces(bool  expected) ;

/// @brief Method UnexpectedEndError, addr 0x25cb03c, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25ca778, size 0x10c, virtual false, abstract: false, final false
inline void _ctor() ;
