...
/// @brief Method LoadXml, addr 0x25ca884, size 0x88, virtual false, abstract: false, final false
inline void LoadXml(::StringW  xml) ;

static inline ::Mono::Xml::SecurityParser* New_ctor() ;

/// @brief Method OnChars, addr 0x25cade8, size 0x80, virtual true, abstract: false, final true
inline void OnChars(::StringW  ch) ;

/// @brief Method OnEndElement, addr 0x25cad60, size 0x88, virtual true, abstract: false, final true
inline void OnEndElement(::StringW  name) ;

/// @brief Method OnEndParsing, addr 0x25cae68, size 0x4, virtual true, abstract: false, final true
inline void OnEndParsing(::Mono::Xml::SmallXmlParser*  parser) ;

/// @brief Method OnIgnorableWhitespace, addr 0x25caae4, size 0x4, virtual true, abstract: false, final true
inline void OnIgnorableWhitespace(::StringW  s) ;

/// @brief Method OnProcessingInstruction, addr 0x25caae0, size 0x4, virtual true, abstract: false, final true
inline void OnProcessingInstruction(::StringW  name, ::StringW  text) ;

/// @brief Method OnStartElement, addr 0x25caae8, size 0x278, virtual true, abstract: false, final true
inline void OnStartElement(::StringW  name, ::Mono::Xml::SmallXmlParser_IAttrList*  attrs) ;

/// @brief Method OnStartParsing, addr 0x25caadc, size 0x4, virtual true, abstract: false, final true
inline void OnStartParsing(::Mono::Xml::SmallXmlParser*  parser) ;

/// @brief Method ToXml, addr 0x25caad4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25ca718, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
