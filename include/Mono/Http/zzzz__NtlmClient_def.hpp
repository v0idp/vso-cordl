...
/// @brief Method <Authenticate>b__1_0, addr 0x2a12104, size 0x54, virtual false, abstract: false, final false
inline ::Mono::Http::NtlmSession* _Authenticate_b__1_0(::System::Net::HttpWebRequest*  x) ;

/// @brief Method .ctor, addr 0x2a120fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Authenticate, addr 0x2a11c60, size 0x364, virtual true, abstract: false, final true
...
/// @brief Method PreAuthenticate, addr 0x2a11fc4, size 0x8, virtual true, abstract: false, final true
inline ::System::Net::Authorization* PreAuthenticate(::System::Net::WebRequest*  webRequest, ::System::Net::ICredentials*  credentials) ;

/// @brief Method .ctor, addr 0x2a1200c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_AuthenticationType, addr 0x2a11fcc, size 0x40, virtual true, abstract: false, final true
