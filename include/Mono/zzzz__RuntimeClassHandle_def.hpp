...
/// @brief Method Equals, addr 0x25c9dd8, size 0x104, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode, addr 0x25c9edc, size 0x28, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetTypeFromClass, addr 0x25c9f04, size 0x4, virtual false, abstract: false, final false
static inline ::System::IntPtr GetTypeFromClass(::cordl_internals::Ptr<::Mono::RuntimeStructs_MonoClass>  klass) ;

/// @brief Method GetTypeHandle, addr 0x25c9f08, size 0x8, virtual false, abstract: false, final false
inline ::System::RuntimeTypeHandle GetTypeHandle() ;

/// @brief Method .ctor, addr 0x25c9db0, size 0x20, virtual false, abstract: false, final false
inline void _ctor(::System::IntPtr  ptr) ;

/// @brief Method .ctor, addr 0x25c9da8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::cordl_internals::Ptr<::Mono::RuntimeStructs_MonoClass>  value) ;

/// @brief Method get_Value, addr 0x25c9dd0, size 0x8, virtual false, abstract: false, final false
