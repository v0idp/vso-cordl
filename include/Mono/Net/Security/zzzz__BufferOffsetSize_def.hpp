...
/// @brief Method ToString, addr 0x2a09988, size 0xa0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a09890, size 0xf8, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method get_EndOffset, addr 0x2a0985c, size 0xc, virtual false, abstract: false, final false
inline int32_t get_EndOffset() ;

/// @brief Method get_Remaining, addr 0x2a09868, size 0x28, virtual false, abstract: false, final false
