...
/// @brief Method CreateDefaultProviderImpl, addr 0x2a101d0, size 0x188, virtual false, abstract: false, final false
static inline ::Mono::Net::Security::MobileTlsProvider* CreateDefaultProviderImpl() ;

/// @brief Method GetProvider, addr 0x2a10a48, size 0x4c, virtual false, abstract: false, final false
static inline ::Mono::Net::Security::MobileTlsProvider* GetProvider() ;

/// @brief Method GetProviderInternal, addr 0x2a0beec, size 0x118, virtual false, abstract: false, final false
static inline ::Mono::Net::Security::MobileTlsProvider* GetProviderInternal() ;

/// @brief Method InitializeInternal, addr 0x2a0fc48, size 0x398, virtual false, abstract: false, final false
static inline void InitializeInternal() ;

/// @brief Method InitializeProviderRegistration, addr 0x2a0ffe0, size 0x1f0, virtual false, abstract: false, final false
static inline void InitializeProviderRegistration() ;

/// @brief Method LookupProvider, addr 0x2a10358, size 0x560, virtual false, abstract: false, final false
static inline ::Mono::Net::Security::MobileTlsProvider* LookupProvider(::StringW  name, bool  throwOnError) ;

/// @brief Method PopulateProviders, addr 0x2a109f8, size 0x50, virtual false, abstract: false, final false
static inline void PopulateProviders() ;

/// @brief Method PopulateUnityProviders, addr 0x2a108b8, size 0x140, virtual false, abstract: false, final false
