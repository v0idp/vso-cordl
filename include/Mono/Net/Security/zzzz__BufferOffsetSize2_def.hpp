...
/// @brief Method AppendData, addr 0x2a09ba8, size 0x60, virtual false, abstract: false, final false
inline void AppendData(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method MakeRoom, addr 0x2a09af4, size 0xb4, virtual false, abstract: false, final false
inline void MakeRoom(int32_t  size) ;

static inline ::Mono::Net::Security::BufferOffsetSize2* New_ctor(int32_t  size) ;

/// @brief Method Reset, addr 0x2a09a98, size 0x5c, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x2a09a28, size 0x70, virtual false, abstract: false, final false
