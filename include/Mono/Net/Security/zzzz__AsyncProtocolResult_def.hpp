...
/// @brief Method .ctor, addr 0x2a09c40, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::System::Runtime::ExceptionServices::ExceptionDispatchInfo*  error) ;

/// @brief Method .ctor, addr 0x2a09c18, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  result) ;

/// @brief Method get_Error, addr 0x2a09c10, size 0x8, virtual false, abstract: false, final false
inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* get_Error() ;

/// @brief Method get_UserResult, addr 0x2a09c08, size 0x8, virtual false, abstract: false, final false
