...
/// @brief Method Run, addr 0x2a0b27c, size 0x1c, virtual true, abstract: false, final false
inline ::Mono::Net::Security::AsyncOperationStatus Run(::Mono::Net::Security::AsyncOperationStatus  status) ;

/// @brief Method .ctor, addr 0x2a0b274, size 0x8, virtual false, abstract: false, final false
