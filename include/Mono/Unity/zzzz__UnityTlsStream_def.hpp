...
public:
// Declarations
/// @brief Method CreateContext, addr 0x2a09338, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a08788, size 0x94, virtual false, abstract: false, final false
