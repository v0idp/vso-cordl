...
public:
// Declarations
/// @brief Method ConvertProtocolVersion, addr 0x2a070a0, size 0x20, virtual false, abstract: false, final false
static inline ::Mono::Security::Interface::TlsProtocols ConvertProtocolVersion(::Mono::Unity::UnityTls_unitytls_protocol  protocol) ;

/// @brief Method GetMaxProtocol, addr 0x2a06370, size 0x38, virtual false, abstract: false, final false
static inline ::Mono::Unity::UnityTls_unitytls_protocol GetMaxProtocol(::System::Security::Authentication::SslProtocols  protocols) ;

/// @brief Method GetMinProtocol, addr 0x2a06338, size 0x38, virtual false, abstract: false, final false
static inline ::Mono::Unity::UnityTls_unitytls_protocol GetMinProtocol(::System::Security::Authentication::SslProtocols  protocols) ;

/// @brief Method VerifyResultToAlertDescription, addr 0x2a03ea4, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method VerifyResultToChainStatus, addr 0x2a0859c, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method VerifyResultToPolicyErrror, addr 0x2a0856c, size 0x30, virtual false, abstract: false, final false
