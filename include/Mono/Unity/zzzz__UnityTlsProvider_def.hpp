...
/// @brief Method CreateSslStream, addr 0x2a08700, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method ValidateCertificate, addr 0x2a0881c, size 0x92c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x2a09204, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_ID, addr 0x2a08680, size 0x58, virtual true, abstract: false, final false
inline ::System::Guid get_ID() ;

/// @brief Method get_Name, addr 0x2a08640, size 0x40, virtual true, abstract: false, final false
inline ::StringW get_Name() ;

/// @brief Method get_SupportedProtocols, addr 0x2a086f8, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Authentication::SslProtocols get_SupportedProtocols() ;

/// @brief Method get_SupportsCleanShutdown, addr 0x2a086f0, size 0x8, virtual true, abstract: false, final false
inline bool get_SupportsCleanShutdown() ;

/// @brief Method get_SupportsConnectionInfo, addr 0x2a086e8, size 0x8, virtual true, abstract: false, final false
inline bool get_SupportsConnectionInfo() ;

/// @brief Method get_SupportsMonoExtensions, addr 0x2a086e0, size 0x8, virtual true, abstract: false, final false
inline bool get_SupportsMonoExtensions() ;

/// @brief Method get_SupportsSslStream, addr 0x2a086d8, size 0x8, virtual true, abstract: false, final false
inline bool get_SupportsSslStream() ;

/// @brief Method x509verify_callback, addr 0x2a085dc, size 0x64, virtual false, abstract: false, final false
static inline ::Mono::Unity::UnityTls_unitytls_x509verify_result x509verify_callback(::cordl_internals::Ptr<void>  userData, ::Mono::Unity::UnityTls_unitytls_x509_ref  cert, ::Mono::Unity::UnityTls_unitytls_x509verify_result  result, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>  errorState) ;
