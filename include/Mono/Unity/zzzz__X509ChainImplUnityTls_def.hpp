...
/// @brief Field ownedList, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_ownedList, put=__cordl_internal_set_ownedList)) ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list>  ownedList;
...
/// @brief Method AddStatus, addr 0x2a096a0, size 0x104, virtual true, abstract: false, final false
inline void AddStatus(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags  error) ;

/// @brief Method Build, addr 0x2a097ac, size 0x8, virtual true, abstract: false, final false
inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2*  certificate) ;

/// @brief Method Dispose, addr 0x2a09824, size 0x38, virtual true, abstract: false, final false
...
static inline ::Mono::Unity::X509ChainImplUnityTls* New_ctor(::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list>  ownedList, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>  errorState, bool  reverseOrder) ;

/// @brief Method Reset, addr 0x2a097b4, size 0x70, virtual true, abstract: false, final false
inline void Reset() ;
...
constexpr ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list> const& __cordl_internal_get_ownedList() const;

constexpr ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list>& __cordl_internal_get_ownedList() ;
...
constexpr void __cordl_internal_set_ownedList(::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list>  value) ;
...
/// @brief Method .ctor, addr 0x2a07d30, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::Mono::Unity::UnityTls_unitytls_x509list_ref  nativeCertificateChain, bool  reverseOrder) ;

/// @brief Method .ctor, addr 0x2a09148, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list>  ownedList, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>  errorState, bool  reverseOrder) ;

/// @brief Method get_ChainElements, addr 0x2a093d0, size 0x2d0, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements() ;

/// @brief Method get_ChainPolicy, addr 0x2a097a4, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy() ;

/// @brief Method get_IsValid, addr 0x2a093a0, size 0x28, virtual true, abstract: false, final false
inline bool get_IsValid() ;

/// @brief Method get_NativeCertificateChain, addr 0x2a093c8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field ownedList, offset: 0x18, size: 0x8, def value: None
 ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list>  ___ownedList;
