...
/// @brief Field requestedClientCertChain, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_requestedClientCertChain, put=__cordl_internal_set_requestedClientCertChain)) ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list>  requestedClientCertChain;
...
/// @brief Method CertificateCallback, addr 0x2a07db4, size 0x2c4, virtual false, abstract: false, final false
inline void CertificateCallback(::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_tlsctx>  ctx, ::cordl_internals::Ptr<uint8_t>  cn, ::System::IntPtr  cnLen, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509name>  caList, ::System::IntPtr  caListLen, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list_ref>  chain, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_key_ref>  key, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>  errorState) ;

/// @brief Method CertificateCallback, addr 0x2a05a68, size 0xc8, virtual false, abstract: false, final false
static inline void CertificateCallback(::cordl_internals::Ptr<void>  userData, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_tlsctx>  ctx, ::cordl_internals::Ptr<uint8_t>  cn, ::System::IntPtr  cnLen, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509name>  caList, ::System::IntPtr  caListLen, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list_ref>  chain, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_key_ref>  key, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>  errorState) ;

/// @brief Method Dispose, addr 0x2a06bc8, size 0x78, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method ExtractNativeKeyAndChainFromManagedCertificate, addr 0x2a063a8, size 0x354, virtual false, abstract: false, final false
...
/// @brief Method FinishHandshake, addr 0x2a06f7c, size 0x124, virtual true, abstract: false, final false
...
/// @brief Method PendingRenegotiation, addr 0x2a06aac, size 0x8, virtual true, abstract: false, final false
inline bool PendingRenegotiation() ;

/// @brief Method ProcessHandshake, addr 0x2a06dc0, size 0x16c, virtual true, abstract: false, final false
inline bool ProcessHandshake() ;

/// @brief Method Read, addr 0x2a06714, size 0x1b4, virtual true, abstract: false, final false
inline ::System::ValueTuple_2<int32_t,bool> Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadCallback, addr 0x2a07508, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method ReadCallback, addr 0x2a058f0, size 0xc8, virtual false, abstract: false, final false
static inline ::System::IntPtr ReadCallback(::cordl_internals::Ptr<void>  userData, ::cordl_internals::Ptr<uint8_t>  buffer, ::System::IntPtr  bufferLen, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>  errorState) ;

/// @brief Method Renegotiate, addr 0x2a06a74, size 0x38, virtual true, abstract: false, final false
inline void Renegotiate() ;

/// @brief Method Shutdown, addr 0x2a06ab4, size 0xf8, virtual true, abstract: false, final false
inline void Shutdown() ;

/// @brief Method StartHandshake, addr 0x2a06c40, size 0x180, virtual true, abstract: false, final false
inline void StartHandshake() ;

/// @brief Method VerifyCallback, addr 0x2a0790c, size 0x424, virtual false, abstract: false, final false
inline ::Mono::Unity::UnityTls_unitytls_x509verify_result VerifyCallback(::Mono::Unity::UnityTls_unitytls_x509list_ref  chain, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>  errorState) ;

/// @brief Method VerifyCallback, addr 0x2a059b8, size 0xb0, virtual false, abstract: false, final false
static inline ::Mono::Unity::UnityTls_unitytls_x509verify_result VerifyCallback(::cordl_internals::Ptr<void>  userData, ::Mono::Unity::UnityTls_unitytls_x509list_ref  chain, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>  errorState) ;

/// @brief Method Write, addr 0x2a068c8, size 0x1ac, virtual true, abstract: false, final false
inline ::System::ValueTuple_2<int32_t,bool> Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteCallback, addr 0x2a070c0, size 0x260, virtual false, abstract: false, final false
...
/// @brief Method WriteCallback, addr 0x2a05828, size 0xc8, virtual false, abstract: false, final false
static inline ::System::IntPtr WriteCallback(::cordl_internals::Ptr<void>  userData, ::cordl_internals::Ptr<uint8_t>  data, ::System::IntPtr  bufferLen, ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>  errorState) ;
...
/// @brief Method .ctor, addr 0x2a05b30, size 0x6d0, virtual false, abstract: false, final false
...
/// @brief Method get_IsAuthenticated, addr 0x2a066fc, size 0x8, virtual true, abstract: false, final false
inline bool get_IsAuthenticated() ;

/// @brief Method get_LocalClientCertificate, addr 0x2a06704, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalClientCertificate() ;

/// @brief Method get_RemoteCertificate, addr 0x2a0670c, size 0x8, virtual true, abstract: false, final false
