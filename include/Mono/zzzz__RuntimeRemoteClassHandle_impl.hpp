...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Mono::RuntimeClassHandle (::Mono::RuntimeRemoteClassHandle::*)()>(&::Mono::RuntimeRemoteClassHandle::get_ProxyClass)> {
  ...
  constexpr static std::size_t addrs = 0x25c9f10;
...
// Ctor Parameters [CppParam { name: "value", ty: "::cordl_internals::Ptr<::Mono::RuntimeStructs_RemoteClass>", modifiers: "", def_value: Some("{}") }]
constexpr ::Mono::RuntimeRemoteClassHandle::RuntimeRemoteClassHandle(::cordl_internals::Ptr<::Mono::RuntimeStructs_RemoteClass>  value) noexcept  {
this->value = value;
}
// Ctor Parameters []
