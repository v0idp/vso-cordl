...
/// @brief Method .ctor, addr 0x25bcc4c, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::Interface::Alert*  alert, ::StringW  message) ;

/// @brief Method .ctor, addr 0x25bccc0, size 0x74, virtual false, abstract: false, final false
