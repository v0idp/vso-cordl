...
/// @brief Method ToString, addr 0x25bc5f0, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25bc6ac, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CipherSuiteCode, addr 0x25bc5c8, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::CipherSuiteCode get_CipherSuiteCode() ;

/// @brief Method get_ProtocolVersion, addr 0x25bc5d8, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::TlsProtocols get_ProtocolVersion() ;

/// @brief Method set_CipherSuiteCode, addr 0x25bc5d0, size 0x8, virtual false, abstract: false, final false
inline void set_CipherSuiteCode(::Mono::Security::Interface::CipherSuiteCode  value) ;

/// @brief Method set_PeerDomainName, addr 0x25bc5e8, size 0x8, virtual false, abstract: false, final false
inline void set_PeerDomainName(::StringW  value) ;

/// @brief Method set_ProtocolVersion, addr 0x25bc5e0, size 0x8, virtual false, abstract: false, final false
