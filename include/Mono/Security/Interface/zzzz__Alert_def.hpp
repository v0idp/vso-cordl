...
/// @brief Method ToString, addr 0x25bc4b4, size 0xbc, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25bc408, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::Interface::AlertDescription  description) ;

/// @brief Method get_Description, addr 0x25bc400, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::AlertDescription get_Description() ;

/// @brief Method get_Level, addr 0x25bc3f8, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::Interface::AlertLevel get_Level() ;

/// @brief Method inferAlertLevel, addr 0x25bc474, size 0x40, virtual false, abstract: false, final false
