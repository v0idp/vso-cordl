...
public:
// Declarations
/// @brief Method Invoke, addr 0x25bc808, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25bc768, size 0xa0, virtual false, abstract: false, final false
