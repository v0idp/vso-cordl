...
/// @brief Method BuildCertificatesCollection, addr 0x25b7130, size 0x1dc, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* BuildCertificatesCollection(::StringW  storeName) ;

/// @brief Method BuildCrlsCollection, addr 0x25b7394, size 0x1c8, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* BuildCrlsCollection(::StringW  storeName) ;

/// @brief Method CheckStore, addr 0x25b7834, size 0xdc, virtual false, abstract: false, final false
inline bool CheckStore(::StringW  path, bool  throwException) ;

/// @brief Method Load, addr 0x25b755c, size 0x208, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Load(::StringW  filename) ;

/// @brief Method LoadCertificate, addr 0x25b7764, size 0x68, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* LoadCertificate(::StringW  filename) ;

/// @brief Method LoadCrl, addr 0x25b77cc, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25b70c8, size 0x40, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, bool  crl, bool  newFormat) ;

/// @brief Method get_Certificates, addr 0x25b7108, size 0x28, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates() ;

/// @brief Method get_Crls, addr 0x25b730c, size 0x88, virtual false, abstract: false, final false
