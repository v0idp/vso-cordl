...
/// @brief Method .ctor, addr 0x25b2c44, size 0xd4, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  entry) ;

/// @brief Method get_Extensions, addr 0x25b3858, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions() ;

/// @brief Method get_RevocationDate, addr 0x25b3850, size 0x8, virtual false, abstract: false, final false
inline ::System::DateTime get_RevocationDate() ;

/// @brief Method get_SerialNumber, addr 0x25b32cc, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method Compare, addr 0x25b307c, size 0x90, virtual false, abstract: false, final false
inline bool Compare(::ArrayW<uint8_t,::Array<uint8_t>*>  array1, ::ArrayW<uint8_t,::Array<uint8_t>*>  array2) ;

/// @brief Method GetCrlEntry, addr 0x25b3188, size 0x144, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Crl_X509CrlEntry* GetCrlEntry(::ArrayW<uint8_t,::Array<uint8_t>*>  serialNumber) ;

/// @brief Method GetCrlEntry, addr 0x25b310c, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x25b25f0, size 0x654, virtual false, abstract: false, final false
inline void Parse(::ArrayW<uint8_t,::Array<uint8_t>*>  crl) ;

/// @brief Method VerifySignature, addr 0x25b36dc, size 0x174, virtual false, abstract: false, final false
inline bool VerifySignature(::System::Security::Cryptography::AsymmetricAlgorithm*  aa) ;

/// @brief Method VerifySignature, addr 0x25b3344, size 0x2c4, virtual false, abstract: false, final false
inline bool VerifySignature(::System::Security::Cryptography::DSA*  dsa) ;

/// @brief Method VerifySignature, addr 0x25b3608, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25b24fc, size 0xf4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  crl) ;

/// @brief Method get_Extensions, addr 0x25b2e4c, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions() ;

/// @brief Method get_Hash, addr 0x25b2e54, size 0x218, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Hash() ;

/// @brief Method get_IssuerName, addr 0x25b306c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_IssuerName() ;

/// @brief Method get_NextUpdate, addr 0x25b3074, size 0x8, virtual false, abstract: false, final false
