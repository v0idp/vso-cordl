...
/// @brief Method Decode, addr 0x25b7e34, size 0x114, virtual true, abstract: false, final false
inline void Decode() ;

/// @brief Method Encode, addr 0x25b7f48, size 0x110, virtual true, abstract: false, final false
inline void Encode() ;
...
/// @brief Method ToString, addr 0x25b80cc, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25b7e30, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::X509::X509Extension*  extension) ;

/// @brief Method get_Identifier, addr 0x25b8058, size 0x74, virtual false, abstract: false, final false
