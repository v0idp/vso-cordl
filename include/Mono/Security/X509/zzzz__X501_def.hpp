...
/// @brief Method AppendEntry, addr 0x25b1744, size 0x7c8, virtual false, abstract: false, final false
static inline void AppendEntry(::System::Text::StringBuilder*  sb, ::Mono::Security::ASN1*  entry, bool  quotes) ;

/// @brief Method ToString, addr 0x25aa04c, size 0x13c, virtual false, abstract: false, final false
static inline ::StringW ToString(::Mono::Security::ASN1*  seq) ;

/// @brief Method ToString, addr 0x25b1f0c, size 0x1c0, virtual false, abstract: false, final false
