...
/// @brief Method Open, addr 0x25b7d1c, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25b7b80, size 0x30, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, bool  newFormat) ;

/// @brief Method get_TrustedRoot, addr 0x25b7c48, size 0xd4, virtual false, abstract: false, final false
