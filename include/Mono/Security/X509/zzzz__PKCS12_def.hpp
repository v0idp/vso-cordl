...
/// @brief Method Adjust, addr 0x25b1140, size 0xc0, virtual false, abstract: false, final false
inline void Adjust(::ArrayW<uint8_t,::Array<uint8_t>*>  a, int32_t  aOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  b) ;

/// @brief Method Derive, addr 0x25b1200, size 0x430, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Derive(::ArrayW<uint8_t,::Array<uint8_t>*>  diversifier, int32_t  n) ;

/// @brief Method DeriveIV, addr 0x25acae0, size 0x70, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> DeriveIV(int32_t  size) ;

/// @brief Method DeriveKey, addr 0x25aca70, size 0x70, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> DeriveKey(int32_t  size) ;

/// @brief Method DeriveMAC, addr 0x25ae2dc, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25ac904, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method set_HashName, addr 0x25b1130, size 0x8, virtual false, abstract: false, final false
inline void set_HashName(::StringW  value) ;

/// @brief Method set_IterationCount, addr 0x25b1138, size 0x8, virtual false, abstract: false, final false
inline void set_IterationCount(int32_t  value) ;

/// @brief Method set_Password, addr 0x25ac90c, size 0xbc, virtual false, abstract: false, final false
inline void set_Password(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method set_Salt, addr 0x25ac9c8, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method AddCertificate, addr 0x25b0574, size 0x8, virtual false, abstract: false, final false
inline void AddCertificate(::Mono::Security::X509::X509Certificate*  cert) ;

/// @brief Method AddCertificate, addr 0x25b086c, size 0x24c, virtual false, abstract: false, final false
inline void AddCertificate(::Mono::Security::X509::X509Certificate*  cert, ::System::Collections::IDictionary*  attributes) ;

/// @brief Method AddPrivateKey, addr 0x25ad4a8, size 0x25c, virtual false, abstract: false, final false
inline void AddPrivateKey(::Mono::Security::Cryptography::PKCS8_PrivateKeyInfo*  pki) ;

/// @brief Method CertificateSafeBag, addr 0x25ad704, size 0xbd8, virtual false, abstract: false, final false
...
/// @brief Method Clone, addr 0x25b0fc4, size 0xc8, virtual true, abstract: false, final true
inline ::System::Object* Clone() ;

/// @brief Method Compare, addr 0x25aadb4, size 0x88, virtual false, abstract: false, final false
inline bool Compare(::ArrayW<uint8_t,::Array<uint8_t>*>  expected, ::ArrayW<uint8_t,::Array<uint8_t>*>  actual) ;

/// @brief Method Decode, addr 0x25aa5a4, size 0x684, virtual false, abstract: false, final false
inline void Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method Decrypt, addr 0x25abd60, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method Decrypt, addr 0x25ab510, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Decrypt(::Mono::Security::PKCS7_EncryptedData*  ed) ;

/// @brief Method Encrypt, addr 0x25acb50, size 0x250, virtual false, abstract: false, final false
...
/// @brief Method EncryptedContentInfo, addr 0x25b057c, size 0x2f0, virtual false, abstract: false, final false
inline ::Mono::Security::PKCS7_ContentInfo* EncryptedContentInfo(::Mono::Security::ASN1*  safeBags, ::StringW  algorithmOid) ;

/// @brief Method Finalize, addr 0x25ab5a0, size 0xac, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetBytes, addr 0x25ae34c, size 0x2220, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetBytes() ;

/// @brief Method GetExistingParameters, addr 0x25acda0, size 0x288, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::DSAParameters GetExistingParameters(::ByRef<bool>  found) ;

/// @brief Method GetSymmetricAlgorithm, addr 0x25ac370, size 0x594, virtual false, abstract: false, final false
...
/// @brief Method MAC, addr 0x25aac60, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method ReadSafeBag, addr 0x25aae3c, size 0x6d4, virtual false, abstract: false, final false
inline void ReadSafeBag(::Mono::Security::ASN1*  safeBag) ;

/// @brief Method RemoveCertificate, addr 0x25b056c, size 0x8, virtual false, abstract: false, final false
inline void RemoveCertificate(::Mono::Security::X509::X509Certificate*  cert) ;

/// @brief Method RemoveCertificate, addr 0x25b0ab8, size 0x50c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25aa2dc, size 0xd8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25aa3b4, size 0x34, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method .ctor, addr 0x25aac28, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data, ::StringW  password) ;

static inline int32_t getStaticF_password_max_length() ;

/// @brief Method get_Certificates, addr 0x25abf10, size 0x440, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates() ;

/// @brief Method get_IterationCount, addr 0x25ab64c, size 0x8, virtual false, abstract: false, final false
inline int32_t get_IterationCount() ;

/// @brief Method get_Keys, addr 0x25ab65c, size 0x704, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_Keys() ;

/// @brief Method get_MaximumPasswordLength, addr 0x25b108c, size 0x58, virtual false, abstract: false, final false
static inline int32_t get_MaximumPasswordLength() ;

/// @brief Method get_RNG, addr 0x25ac350, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method set_IterationCount, addr 0x25ab654, size 0x8, virtual false, abstract: false, final false
inline void set_IterationCount(int32_t  value) ;

/// @brief Method set_Password, addr 0x25aa3e8, size 0x1bc, virtual false, abstract: false, final false
