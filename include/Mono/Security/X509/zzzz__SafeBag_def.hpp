...
/// @brief Method .ctor, addr 0x25aa2a0, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::StringW  bagOID, ::Mono::Security::ASN1*  asn1) ;

/// @brief Method get_ASN1, addr 0x25aa2d4, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::ASN1* get_ASN1() ;

/// @brief Method get_BagOID, addr 0x25aa2cc, size 0x8, virtual false, abstract: false, final false
