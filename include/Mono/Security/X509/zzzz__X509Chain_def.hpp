...
/// @brief Method Build, addr 0x25b5bd8, size 0x3ac, virtual false, abstract: false, final false
inline bool Build(::Mono::Security::X509::X509Certificate*  leaf) ;

/// @brief Method FindCertificateParent, addr 0x25b5f84, size 0x1dc, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* FindCertificateParent(::Mono::Security::X509::X509Certificate*  child) ;

/// @brief Method FindCertificateRoot, addr 0x25b6160, size 0x248, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* FindCertificateRoot(::Mono::Security::X509::X509Certificate*  potentialRoot) ;

/// @brief Method IsParent, addr 0x25b63a8, size 0x144, virtual false, abstract: false, final false
inline bool IsParent(::Mono::Security::X509::X509Certificate*  child, ::Mono::Security::X509::X509Certificate*  parent) ;

/// @brief Method IsTrusted, addr 0x25b65d8, size 0x2c, virtual false, abstract: false, final false
inline bool IsTrusted(::Mono::Security::X509::X509Certificate*  potentialTrusted) ;

/// @brief Method IsValid, addr 0x25b64ec, size 0xac, virtual false, abstract: false, final false
inline bool IsValid(::Mono::Security::X509::X509Certificate*  cert) ;

/// @brief Method LoadCertificates, addr 0x25b5bc0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x25b6598, size 0x40, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x25b5a14, size 0x64, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_TrustAnchors, addr 0x25b5a78, size 0x7c, virtual false, abstract: false, final false
