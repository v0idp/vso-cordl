...
/// @brief Method get_CurrentUser, addr 0x25b7ae8, size 0x98, virtual false, abstract: false, final false
static inline ::Mono::Security::X509::X509Stores* get_CurrentUser() ;

/// @brief Method get_CurrentUserPath, addr 0x25b7910, size 0xf8, virtual false, abstract: false, final false
static inline ::StringW get_CurrentUserPath() ;

/// @brief Method get_LocalMachine, addr 0x25b7bb0, size 0x98, virtual false, abstract: false, final false
static inline ::Mono::Security::X509::X509Stores* get_LocalMachine() ;

/// @brief Method get_LocalMachinePath, addr 0x25b7a08, size 0xe0, virtual false, abstract: false, final false
static inline ::StringW get_LocalMachinePath() ;

/// @brief Method get_TrustedRootCertificates, addr 0x25b5af4, size 0xcc, virtual false, abstract: false, final false
