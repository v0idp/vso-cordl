...
/// @brief Method GetASN1, addr 0x25a8f88, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25a8d0c, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25a8e08, size 0x17c, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  asn1) ;

/// @brief Method .ctor, addr 0x25a8da0, size 0x68, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method .ctor, addr 0x25a8d7c, size 0x24, virtual false, abstract: false, final false
inline void _ctor(::StringW  oid) ;

/// @brief Method get_ASN1, addr 0x25a8f84, size 0x4, virtual false, abstract: false, final false
inline ::Mono::Security::ASN1* get_ASN1() ;

/// @brief Method get_Content, addr 0x25a9034, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::ASN1* get_Content() ;

/// @brief Method get_ContentType, addr 0x25a9044, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_ContentType() ;

/// @brief Method set_Content, addr 0x25a903c, size 0x8, virtual false, abstract: false, final false
inline void set_Content(::Mono::Security::ASN1*  value) ;

/// @brief Method set_ContentType, addr 0x25a904c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25a9054, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25a9070, size 0x2b8, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  asn1) ;

/// @brief Method get_EncryptedContent, addr 0x25a9330, size 0x74, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_EncryptedContent() ;

/// @brief Method get_EncryptionAlgorithm, addr 0x25a9328, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method OidToName, addr 0x25a9e60, size 0x1b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25a93a4, size 0x4c4, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  asn1) ;

/// @brief Method get_Certificates, addr 0x25aa034, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates() ;

/// @brief Method get_ContentInfo, addr 0x25aa03c, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::PKCS7_ContentInfo* get_ContentInfo() ;

/// @brief Method get_SignerInfo, addr 0x25aa044, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::PKCS7_SignerInfo* get_SignerInfo() ;

/// @brief Method set_HashName, addr 0x25aa014, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25a9ddc, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25a9a6c, size 0x370, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::ASN1*  asn1) ;

/// @brief Method get_AuthenticatedAttributes, addr 0x25aa204, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_AuthenticatedAttributes() ;

/// @brief Method get_HashName, addr 0x25aa20c, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_HashName() ;

/// @brief Method get_IssuerName, addr 0x25aa188, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_IssuerName() ;

/// @brief Method get_SerialNumber, addr 0x25aa190, size 0x74, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_SerialNumber() ;

/// @brief Method get_Signature, addr 0x25aa21c, size 0x74, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Signature() ;

/// @brief Method get_UnauthenticatedAttributes, addr 0x25aa290, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* get_UnauthenticatedAttributes() ;

/// @brief Method get_Version, addr 0x25aa298, size 0x8, virtual false, abstract: false, final false
inline uint8_t get_Version() ;

/// @brief Method set_HashName, addr 0x25aa214, size 0x8, virtual false, abstract: false, final false
inline void set_HashName(::StringW  value) ;
