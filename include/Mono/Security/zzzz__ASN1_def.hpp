...
/// @brief Method Add, addr 0x25d54e8, size 0x8c, virtual false, abstract: false, final false
inline ::Mono::Security::ASN1* Add(::Mono::Security::ASN1*  asn1) ;

/// @brief Method Decode, addr 0x25d5320, size 0x11c, virtual false, abstract: false, final false
inline void Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  asn1, ::ByRef<int32_t>  anPos, int32_t  anLength) ;

/// @brief Method DecodeTLV, addr 0x25d5bf8, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method GetBytes, addr 0x25d5574, size 0x684, virtual true, abstract: false, final false
...
/// @brief Method ToString, addr 0x25d5d1c, size 0x294, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25d51bc, size 0x164, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method .ctor, addr 0x25d5160, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(uint8_t  tag) ;

/// @brief Method .ctor, addr 0x25d518c, size 0x30, virtual false, abstract: false, final false
inline void _ctor(uint8_t  tag, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method get_Count, addr 0x25d543c, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_Count() ;

/// @brief Method get_Value, addr 0x25d5458, size 0x90, virtual false, abstract: false, final false
