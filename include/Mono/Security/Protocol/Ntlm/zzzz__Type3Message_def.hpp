...
/// @brief Method Decode, addr 0x25bbab0, size 0x220, virtual true, abstract: false, final false
inline void Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  message) ;

/// @brief Method DecodeString, addr 0x25bbcd0, size 0x58, virtual false, abstract: false, final false
inline ::StringW DecodeString(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  len) ;

/// @brief Method EncodeString, addr 0x25bbd28, size 0x90, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncodeString(::StringW  text) ;

/// @brief Method Finalize, addr 0x25bb93c, size 0xe0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetBytes, addr 0x25bbdb8, size 0x640, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25bb750, size 0x1ec, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::Protocol::Ntlm::Type2Message*  type2) ;

/// @brief Method set_Domain, addr 0x25bba1c, size 0x84, virtual false, abstract: false, final false
inline void set_Domain(::StringW  value) ;

/// @brief Method set_Password, addr 0x25bbaa0, size 0x8, virtual false, abstract: false, final false
inline void set_Password(::StringW  value) ;

/// @brief Method set_Username, addr 0x25bbaa8, size 0x8, virtual false, abstract: false, final false
