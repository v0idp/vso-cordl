...
/// @brief Method Decode, addr 0x25bb518, size 0x180, virtual true, abstract: false, final false
inline void Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  message) ;

/// @brief Method Finalize, addr 0x25bb468, size 0xa8, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetBytes, addr 0x25bb698, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25bb3c4, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  message) ;

/// @brief Method get_Nonce, addr 0x25ba4a0, size 0x78, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Nonce() ;

/// @brief Method get_TargetInfo, addr 0x25ba428, size 0x78, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_TargetInfo() ;

/// @brief Method get_TargetName, addr 0x25bb510, size 0x8, virtual false, abstract: false, final false
