...
/// @brief Method Decode, addr 0x25bb088, size 0xf0, virtual true, abstract: false, final false
inline void Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  message) ;

/// @brief Method GetBytes, addr 0x25bb178, size 0x24c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25baefc, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_Domain, addr 0x25baf80, size 0x84, virtual false, abstract: false, final false
inline void set_Domain(::StringW  value) ;

/// @brief Method set_Host, addr 0x25bb004, size 0x84, virtual false, abstract: false, final false
