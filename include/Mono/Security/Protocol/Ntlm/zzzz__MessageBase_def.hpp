...
/// @brief Method CheckHeader, addr 0x25bacb0, size 0x114, virtual false, abstract: false, final false
inline bool CheckHeader(::ArrayW<uint8_t,::Array<uint8_t>*>  message) ;

/// @brief Method Decode, addr 0x25bab18, size 0x198, virtual true, abstract: false, final false
...
/// @brief Method PrepareMessage, addr 0x25baa18, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25ba9d8, size 0x28, virtual false, abstract: false, final false
inline void _ctor(int32_t  messageType) ;

static inline ::ArrayW<uint8_t,::Array<uint8_t>*> getStaticF_header() ;

/// @brief Method get_Flags, addr 0x25baa00, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::Protocol::Ntlm::NtlmFlags get_Flags() ;

/// @brief Method get_Type, addr 0x25baa10, size 0x8, virtual false, abstract: false, final false
inline int32_t get_Type() ;

static inline void setStaticF_header(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method set_Flags, addr 0x25baa08, size 0x8, virtual false, abstract: false, final false
