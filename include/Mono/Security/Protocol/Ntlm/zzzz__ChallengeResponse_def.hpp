...
/// @brief Method Dispose, addr 0x25b8cb8, size 0x64, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method Dispose, addr 0x25b91fc, size 0x6c, virtual false, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method Finalize, addr 0x25b8c18, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetResponse, addr 0x25b8ec0, size 0x2dc, virtual false, abstract: false, final false
...
/// @brief Method PasswordToKey, addr 0x25b8d1c, size 0x144, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> PasswordToKey(::StringW  password, int32_t  position) ;

/// @brief Method PrepareDESKey, addr 0x25b9268, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25b863c, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25b86ac, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method get_LM, addr 0x25b8e60, size 0x60, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_LM() ;

/// @brief Method get_NT, addr 0x25b919c, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method set_Challenge, addr 0x25b8aec, size 0x12c, virtual false, abstract: false, final false
inline void set_Challenge(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method set_Password, addr 0x25b86e4, size 0x408, virtual false, abstract: false, final false
