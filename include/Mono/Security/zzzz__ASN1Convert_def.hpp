...
public:
// Declarations
/// @brief Method FromInt32, addr 0x25a7dd0, size 0x16c, virtual false, abstract: false, final false
static inline ::Mono::Security::ASN1* FromInt32(int32_t  value) ;

/// @brief Method FromOid, addr 0x25a7f54, size 0xdc, virtual false, abstract: false, final false
static inline ::Mono::Security::ASN1* FromOid(::StringW  oid) ;

/// @brief Method FromUnsignedBigInteger, addr 0x25a8030, size 0x110, virtual false, abstract: false, final false
static inline ::Mono::Security::ASN1* FromUnsignedBigInteger(::ArrayW<uint8_t,::Array<uint8_t>*>  big) ;

/// @brief Method ToDateTime, addr 0x25a84d8, size 0x570, virtual false, abstract: false, final false
static inline ::System::DateTime ToDateTime(::Mono::Security::ASN1*  time) ;

/// @brief Method ToInt32, addr 0x25a8140, size 0x110, virtual false, abstract: false, final false
static inline int32_t ToInt32(::Mono::Security::ASN1*  asn1) ;

/// @brief Method ToOid, addr 0x25a8250, size 0x288, virtual false, abstract: false, final false
