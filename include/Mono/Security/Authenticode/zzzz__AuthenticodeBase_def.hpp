...
/// @brief Method Close, addr 0x25c28ec, size 0x2c, virtual false, abstract: false, final false
inline void Close() ;

/// @brief Method GetHash, addr 0x25c2ca4, size 0x488, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetHash(::System::Security::Cryptography::HashAlgorithm*  hash) ;

/// @brief Method GetSecurityEntry, addr 0x25c2bd4, size 0xd0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSecurityEntry() ;

static inline ::Mono::Security::Authenticode::AuthenticodeBase* New_ctor() ;

/// @brief Method Open, addr 0x25c2860, size 0x8c, virtual false, abstract: false, final false
inline void Open(::StringW  filename) ;

/// @brief Method Open, addr 0x25c2918, size 0x84, virtual false, abstract: false, final false
inline void Open(::ArrayW<uint8_t,::Array<uint8_t>*>  rawdata) ;

/// @brief Method ProcessFirstBlock, addr 0x25c299c, size 0x238, virtual false, abstract: false, final false
inline int32_t ProcessFirstBlock() ;

/// @brief Method ReadFirstBlock, addr 0x25c2790, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25c270c, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_PEOffset, addr 0x25c2768, size 0x28, virtual false, abstract: false, final false
