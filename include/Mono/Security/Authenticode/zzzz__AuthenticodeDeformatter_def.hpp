...
/// @brief Method CheckSignature, addr 0x25c3348, size 0x2f4, virtual false, abstract: false, final false
inline bool CheckSignature() ;

/// @brief Method CompareIssuerSerial, addr 0x25c4078, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x25c32a4, size 0xa4, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method VerifyCounterSignature, addr 0x25c4174, size 0x9ec, virtual false, abstract: false, final false
inline bool VerifyCounterSignature(::Mono::Security::PKCS7_SignerInfo*  cs, ::ArrayW<uint8_t,::Array<uint8_t>*>  signature) ;

/// @brief Method VerifySignature, addr 0x25c3644, size 0xa34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25c312c, size 0x80, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25c31ac, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  rawData) ;

/// @brief Method get_SigningCertificate, addr 0x25c363c, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_SigningCertificate() ;

/// @brief Method set_RawData, addr 0x25c31d4, size 0xd0, virtual false, abstract: false, final false
