...
public:
// Declarations
/// @brief Method Invoke, addr 0x25dc4fc, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25dc3f8, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x25dba34, size 0x204, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EncryptValue, addr 0x25dad0c, size 0x108, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncryptValue(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb) ;

/// @brief Method ExportParameters, addr 0x25db19c, size 0x328, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::RSAParameters ExportParameters(bool  includePrivateParameters) ;

/// @brief Method Finalize, addr 0x25da238, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GenerateKeyPair, addr 0x25da2d8, size 0x268, virtual false, abstract: false, final false
inline void GenerateKeyPair() ;

/// @brief Method GetPaddedValue, addr 0x25db09c, size 0xb0, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPaddedValue(::Mono::Math::BigInteger*  value, int32_t  length) ;

/// @brief Method ImportParameters, addr 0x25db5f8, size 0x43c, virtual true, abstract: false, final false
...
/// @brief Method ToXmlString, addr 0x25dbd70, size 0x688, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25da16c, size 0xcc, virtual false, abstract: false, final false
inline void _ctor(int32_t  keySize) ;

/// @brief Method add_KeyGenerated, addr 0x25dbc38, size 0x9c, virtual false, abstract: false, final false
inline void add_KeyGenerated(::Mono::Security::Cryptography::RSAManaged_KeyGeneratedEventHandler*  value) ;

/// @brief Method get_KeySize, addr 0x25dab20, size 0x9c, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Method get_PublicOnly, addr 0x25dabbc, size 0xa0, virtual false, abstract: false, final false
inline bool get_PublicOnly() ;

/// @brief Method remove_KeyGenerated, addr 0x25dbcd4, size 0x9c, virtual false, abstract: false, final false
