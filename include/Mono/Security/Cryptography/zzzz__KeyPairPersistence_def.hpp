...
/// @brief Method CanSecure, addr 0x25d7b90, size 0xa0, virtual false, abstract: false, final false
static inline bool CanSecure(::StringW  path) ;

/// @brief Method Copy, addr 0x25d6440, size 0x98, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::CspParameters* Copy(::System::Security::Cryptography::CspParameters*  p) ;

/// @brief Method FromXml, addr 0x25d73b4, size 0x11c, virtual false, abstract: false, final false
inline void FromXml(::StringW  xml) ;

/// @brief Method IsMachineProtected, addr 0x25d7aec, size 0x90, virtual false, abstract: false, final false
static inline bool IsMachineProtected(::StringW  path) ;

/// @brief Method IsUserProtected, addr 0x25d7a5c, size 0x90, virtual false, abstract: false, final false
static inline bool IsUserProtected(::StringW  path) ;

/// @brief Method Load, addr 0x25d71fc, size 0x1b8, virtual false, abstract: false, final false
inline bool Load() ;
...
/// @brief Method ProtectMachine, addr 0x25d7928, size 0x90, virtual false, abstract: false, final false
static inline bool ProtectMachine(::StringW  path) ;

/// @brief Method ProtectUser, addr 0x25d79b8, size 0x90, virtual false, abstract: false, final false
static inline bool ProtectUser(::StringW  path) ;

/// @brief Method Remove, addr 0x25d7a48, size 0x14, virtual false, abstract: false, final false
inline void Remove() ;

/// @brief Method Save, addr 0x25d74d0, size 0x244, virtual false, abstract: false, final false
inline void Save() ;

/// @brief Method ToXml, addr 0x25d7714, size 0x214, virtual false, abstract: false, final false
inline ::StringW ToXml() ;

/// @brief Method _CanSecure, addr 0x25d7b7c, size 0x4, virtual false, abstract: false, final false
static inline bool _CanSecure(::cordl_internals::Ptr<char16_t>  root) ;

/// @brief Method _IsMachineProtected, addr 0x25d7b8c, size 0x4, virtual false, abstract: false, final false
static inline bool _IsMachineProtected(::cordl_internals::Ptr<char16_t>  path) ;

/// @brief Method _IsUserProtected, addr 0x25d7b88, size 0x4, virtual false, abstract: false, final false
static inline bool _IsUserProtected(::cordl_internals::Ptr<char16_t>  path) ;

/// @brief Method _ProtectMachine, addr 0x25d7b84, size 0x4, virtual false, abstract: false, final false
static inline bool _ProtectMachine(::cordl_internals::Ptr<char16_t>  path) ;

/// @brief Method _ProtectUser, addr 0x25d7b80, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25d63b8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::CspParameters*  parameters) ;

/// @brief Method .ctor, addr 0x25d63c0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method get_CanChange, addr 0x25d71ec, size 0x10, virtual false, abstract: false, final false
inline bool get_CanChange() ;

/// @brief Method get_ContainerName, addr 0x25d6668, size 0x100, virtual false, abstract: false, final false
inline ::StringW get_ContainerName() ;

/// @brief Method get_Filename, addr 0x25d64d8, size 0x190, virtual false, abstract: false, final false
inline ::StringW get_Filename() ;

/// @brief Method get_KeyValue, addr 0x25d71d0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_KeyValue() ;

/// @brief Method get_MachinePath, addr 0x25d6788, size 0x524, virtual false, abstract: false, final false
static inline ::StringW get_MachinePath() ;

/// @brief Method get_UseDefaultKeyContainer, addr 0x25d7c30, size 0x20, virtual false, abstract: false, final false
inline bool get_UseDefaultKeyContainer() ;

/// @brief Method get_UseMachineKeyStore, addr 0x25d6768, size 0x20, virtual false, abstract: false, final false
inline bool get_UseMachineKeyStore() ;

/// @brief Method get_UserPath, addr 0x25d6cac, size 0x524, virtual false, abstract: false, final false
...
/// @brief Method set_KeyValue, addr 0x25d71d8, size 0x14, virtual false, abstract: false, final false
