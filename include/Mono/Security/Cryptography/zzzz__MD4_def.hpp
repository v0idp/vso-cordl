...
public:
// Declarations
/// @brief Method Create, addr 0x25bd564, size 0x50, virtual false, abstract: false, final false
static inline ::Mono::Security::Cryptography::MD4* Create() ;

static inline ::Mono::Security::Cryptography::MD4* New_ctor() ;

/// @brief Method .ctor, addr 0x25bd544, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
