...
public:
// Declarations
/// @brief Method Create, addr 0x25bce90, size 0x50, virtual false, abstract: false, final false
static inline ::Mono::Security::Cryptography::MD2* Create() ;

static inline ::Mono::Security::Cryptography::MD2* New_ctor() ;

/// @brief Method .ctor, addr 0x25bce70, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
