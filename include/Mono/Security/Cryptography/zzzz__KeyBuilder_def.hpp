...
/// @brief Method IV, addr 0x25d6348, size 0x70, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> IV(int32_t  size) ;

/// @brief Method Key, addr 0x25d62d8, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_Rng, addr 0x25d6270, size 0x68, virtual false, abstract: false, final false
