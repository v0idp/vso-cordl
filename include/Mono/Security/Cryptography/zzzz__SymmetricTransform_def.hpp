...
/// @brief Method CBC, addr 0x25dcb74, size 0x164, virtual true, abstract: false, final false
inline void CBC(::ArrayW<uint8_t,::Array<uint8_t>*>  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method CFB, addr 0x25dccd8, size 0x1c8, virtual true, abstract: false, final false
inline void CFB(::ArrayW<uint8_t,::Array<uint8_t>*>  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method CTS, addr 0x25dceec, size 0x4c, virtual true, abstract: false, final false
inline void CTS(::ArrayW<uint8_t,::Array<uint8_t>*>  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method CheckInput, addr 0x25dcf38, size 0x144, virtual false, abstract: false, final false
inline void CheckInput(::ArrayW<uint8_t,::Array<uint8_t>*>  inputBuffer, int32_t  inputOffset, int32_t  inputCount) ;

/// @brief Method Dispose, addr 0x25dc8dc, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method FinalDecrypt, addr 0x25dd988, size 0x298, virtual true, abstract: false, final false
...
/// @brief Method FinalEncrypt, addr 0x25dd6f4, size 0x294, virtual true, abstract: false, final false
...
/// @brief Method Finalize, addr 0x25dc7d0, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method InternalTransformBlock, addr 0x25dd2a8, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method OFB, addr 0x25dcea0, size 0x4c, virtual true, abstract: false, final false
inline void OFB(::ArrayW<uint8_t,::Array<uint8_t>*>  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method Random, addr 0x25dd460, size 0xb0, virtual false, abstract: false, final false
inline void Random(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  start, int32_t  length) ;

/// @brief Method System.IDisposable.Dispose, addr 0x25dc870, size 0x6c, virtual true, abstract: false, final true
inline void System_IDisposable_Dispose() ;

/// @brief Method ThrowBadPaddingException, addr 0x25dd510, size 0x1a0, virtual false, abstract: false, final false
inline void ThrowBadPaddingException(::System::Security::Cryptography::PaddingMode  padding, int32_t  length, int32_t  position) ;

/// @brief Method Transform, addr 0x25dc948, size 0x15c, virtual true, abstract: false, final false
inline void Transform(::ArrayW<uint8_t,::Array<uint8_t>*>  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method TransformBlock, addr 0x25dd07c, size 0x208, virtual true, abstract: false, final false
...
/// @brief Method TransformFinalBlock, addr 0x25ddc20, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25dc510, size 0x2c0, virtual false, abstract: false, final false
...
/// @brief Method get_CanTransformMultipleBlocks, addr 0x25dc930, size 0x8, virtual true, abstract: false, final false
inline bool get_CanTransformMultipleBlocks() ;

/// @brief Method get_InputBlockSize, addr 0x25dc938, size 0x8, virtual true, abstract: false, final false
inline int32_t get_InputBlockSize() ;

/// @brief Method get_KeepLastBlock, addr 0x25dd284, size 0x24, virtual false, abstract: false, final false
inline bool get_KeepLastBlock() ;

/// @brief Method get_OutputBlockSize, addr 0x25dc940, size 0x8, virtual true, abstract: false, final false
