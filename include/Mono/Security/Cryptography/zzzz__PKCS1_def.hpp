...
/// @brief Method Compare, addr 0x25be2d4, size 0x8c, virtual false, abstract: false, final false
static inline bool Compare(::ArrayW<uint8_t,::Array<uint8_t>*>  array1, ::ArrayW<uint8_t,::Array<uint8_t>*>  array2) ;

/// @brief Method CreateFromName, addr 0x25bee38, size 0x404, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::HashAlgorithm* CreateFromName(::StringW  name) ;

/// @brief Method CreateFromOid, addr 0x25beddc, size 0x5c, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::HashAlgorithm* CreateFromOid(::StringW  oid) ;

/// @brief Method Encode_v15, addr 0x25be6a0, size 0x334, virtual false, abstract: false, final false
...
/// @brief Method HashNameFromOid, addr 0x25be9d4, size 0x38c, virtual false, abstract: false, final false
static inline ::StringW HashNameFromOid(::StringW  oid, bool  throwOnError) ;

/// @brief Method I2OSP, addr 0x25be360, size 0x8c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> I2OSP(::ArrayW<uint8_t,::Array<uint8_t>*>  x, int32_t  size) ;

/// @brief Method OS2IP, addr 0x25be3ec, size 0xc0, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> OS2IP(::ArrayW<uint8_t,::Array<uint8_t>*>  x) ;

/// @brief Method RSAVP1, addr 0x25be4ac, size 0x1c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> RSAVP1(::System::Security::Cryptography::RSA*  rsa, ::ArrayW<uint8_t,::Array<uint8_t>*>  s) ;

/// @brief Method Verify_v15, addr 0x25be4c8, size 0x1d8, virtual false, abstract: false, final false
