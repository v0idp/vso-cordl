...
public:
// Declarations
/// @brief Method Invoke, addr 0x25df8bc, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25df7b8, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x25df4b0, size 0x1d0, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method ExportParameters, addr 0x25dead0, size 0x26c, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::DSAParameters ExportParameters(bool  includePrivateParameters) ;

/// @brief Method Finalize, addr 0x25ddd8c, size 0xa0, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method Generate, addr 0x25dde2c, size 0x4c, virtual false, abstract: false, final false
inline void Generate() ;

/// @brief Method GenerateKeyPair, addr 0x25de3a0, size 0xe0, virtual false, abstract: false, final false
inline void GenerateKeyPair() ;

/// @brief Method GenerateParams, addr 0x25dde78, size 0x528, virtual false, abstract: false, final false
inline void GenerateParams(int32_t  keyLength) ;

/// @brief Method ImportParameters, addr 0x25deda8, size 0x27c, virtual true, abstract: false, final false
...
/// @brief Method NormalizeArray, addr 0x25dea2c, size 0xa4, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> NormalizeArray(::ArrayW<uint8_t,::Array<uint8_t>*>  array) ;

/// @brief Method VerifySignature, addr 0x25df024, size 0x48c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25ddcd0, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(int32_t  dwKeySize) ;

/// @brief Method add, addr 0x25de5bc, size 0x9c, virtual false, abstract: false, final false
inline void add(::ArrayW<uint8_t,::Array<uint8_t>*>  a, ::ArrayW<uint8_t,::Array<uint8_t>*>  b, int32_t  value) ;

/// @brief Method add_KeyGenerated, addr 0x25df680, size 0x9c, virtual false, abstract: false, final false
inline void add_KeyGenerated(::Mono::Security::Cryptography::DSAManaged_KeyGeneratedEventHandler*  value) ;

/// @brief Method get_KeySize, addr 0x25de98c, size 0x2c, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Method get_PublicOnly, addr 0x25de9b8, size 0x74, virtual false, abstract: false, final false
inline bool get_PublicOnly() ;

/// @brief Method get_Random, addr 0x25de658, size 0x20, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::RandomNumberGenerator* get_Random() ;

/// @brief Method remove_KeyGenerated, addr 0x25df71c, size 0x9c, virtual false, abstract: false, final false
