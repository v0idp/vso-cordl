...
/// @brief Method Decode, addr 0x25bf41c, size 0x258, virtual false, abstract: false, final false
inline void Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method DecodeDSA, addr 0x25bfde8, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method DecodeRSA, addr 0x25bf82c, size 0x3c4, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::RSA* DecodeRSA(::ArrayW<uint8_t,::Array<uint8_t>*>  keypair) ;

/// @brief Method Encode, addr 0x25bff5c, size 0x124, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encode(::System::Security::Cryptography::AsymmetricAlgorithm*  aa) ;

/// @brief Method Encode, addr 0x25bff10, size 0x4c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encode(::System::Security::Cryptography::DSA*  dsa) ;

/// @brief Method Encode, addr 0x25bfbf0, size 0x1f8, virtual false, abstract: false, final false
...
/// @brief Method Normalize, addr 0x25bf78c, size 0xa0, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Normalize(::ArrayW<uint8_t,::Array<uint8_t>*>  bigInt, int32_t  length) ;

/// @brief Method RemoveLeadingZero, addr 0x25bf6f0, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25bf38c, size 0x68, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25bf3f4, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method get_Algorithm, addr 0x25bf674, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Algorithm() ;

/// @brief Method get_PrivateKey, addr 0x25bf67c, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method Decode, addr 0x25c00b4, size 0x2ac, virtual false, abstract: false, final false
inline void Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;
...
/// @brief Method .ctor, addr 0x25c0080, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x25c0088, size 0x2c, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method get_Algorithm, addr 0x25c0360, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Algorithm() ;

/// @brief Method get_EncryptedData, addr 0x25c0368, size 0x74, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_EncryptedData() ;

/// @brief Method get_IterationCount, addr 0x25c0490, size 0x8, virtual false, abstract: false, final false
inline int32_t get_IterationCount() ;

/// @brief Method get_Salt, addr 0x25c03dc, size 0xb4, virtual false, abstract: false, final false
