...
// Ctor Parameters [CppParam { name: "default_vtable", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "xdomain_vtable", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "proxy_class", ty: "::cordl_internals::Ptr<::Mono::RuntimeStructs_MonoClass>", modifiers: "", def_value: None }, CppParam { name: "proxy_class_name", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "interface_count", ty: "uint32_t", modifiers: "", def_value: None }]
constexpr RuntimeStructs_RemoteClass(::System::IntPtr  default_vtable, ::System::IntPtr  xdomain_vtable, ::cordl_internals::Ptr<::Mono::RuntimeStructs_MonoClass>  proxy_class, ::System::IntPtr  proxy_class_name, uint32_t  interface_count) noexcept;
...
constexpr RuntimeStructs_GenericParamInfo(::cordl_internals::Ptr<::Mono::RuntimeStructs_MonoClass>  pklass, ::System::IntPtr  name, uint16_t  flags, uint32_t  token, ::cordl_internals::Ptr<::cordl_internals::Ptr<::Mono::RuntimeStructs_MonoClass>>  constraints) noexcept;
