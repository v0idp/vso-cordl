...
public:
// Declarations
/// @brief Method GetSPPRounds, addr 0x25c7984, size 0x18c, virtual false, abstract: false, final false
static inline int32_t GetSPPRounds(::Mono::Math::BigInteger*  bi, ::Mono::Math::Prime::ConfidenceFactor  confidence) ;

/// @brief Method RabinMillerTest, addr 0x25c7b10, size 0x298, virtual false, abstract: false, final false
