...
/// @brief Method .ctor, addr 0x25c7e24, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Confidence, addr 0x25c7da8, size 0x8, virtual true, abstract: false, final false
inline ::Mono::Math::Prime::ConfidenceFactor get_Confidence() ;

/// @brief Method get_PrimalityTest, addr 0x25c7db0, size 0x6c, virtual true, abstract: false, final false
inline ::Mono::Math::Prime::PrimalityTest* get_PrimalityTest() ;

/// @brief Method get_TrialDivisionBounds, addr 0x25c7e1c, size 0x8, virtual true, abstract: false, final false
