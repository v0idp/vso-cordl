...
public:
// Declarations
/// @brief Method GenerateNewPrime, addr 0x25c7ea0, size 0x10, virtual true, abstract: false, final false
inline ::Mono::Math::BigInteger* GenerateNewPrime(int32_t  bits) ;

/// @brief Method GenerateNewPrime, addr 0x25c7eb0, size 0x2e4, virtual true, abstract: false, final false
inline ::Mono::Math::BigInteger* GenerateNewPrime(int32_t  bits, ::System::Object*  context) ;

/// @brief Method GenerateSearchBase, addr 0x25c7e2c, size 0x74, virtual true, abstract: false, final false
inline ::Mono::Math::BigInteger* GenerateSearchBase(int32_t  bits, ::System::Object*  context) ;

/// @brief Method IsPrimeAcceptable, addr 0x25c8194, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x25c6b0c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
