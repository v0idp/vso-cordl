...
public:
// Declarations
/// @brief Method AsciHexDigitValue, addr 0x25ca5f0, size 0x2c, virtual false, abstract: false, final false
static inline int32_t AsciHexDigitValue(int32_t  c) ;

/// @brief Method DecodeBlobArray, addr 0x25ca538, size 0xb8, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> DecodeBlobArray(::System::IntPtr  ptr) ;

/// @brief Method DecodeBlobSize, addr 0x25ca4bc, size 0x7c, virtual false, abstract: false, final false
static inline int32_t DecodeBlobSize(::System::IntPtr  in_ptr, ::ByRef<::System::IntPtr>  out_ptr) ;

/// @brief Method FreeAssemblyName, addr 0x25ca61c, size 0x8, virtual false, abstract: false, final false
static inline void FreeAssemblyName(::ByRef<::Mono::MonoAssemblyName>  name, bool  freeStruct) ;

/// @brief Method MarshalString, addr 0x25ca4ac, size 0x8, virtual false, abstract: false, final false
static inline ::Mono::SafeStringMarshal MarshalString(::StringW  str) ;

/// @brief Method PtrToUtf8String, addr 0x25ca3e4, size 0xc8, virtual false, abstract: false, final false
